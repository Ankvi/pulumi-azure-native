...
export class GatewayCustomDomain extends pulumi.CustomResource {
    ...
    constructor(name: string, args: GatewayCustomDomainArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:appplatform/v20220101preview:GatewayCustomDomain" }, { type: "azure-native:appplatform/v20220301preview:GatewayCustomDomain" }, { type: "azure-native:appplatform/v20220501preview:GatewayCustomDomain" }, { type: "azure-native:appplatform/v20220901preview:GatewayCustomDomain" }, { type: "azure-native:appplatform/v20221101preview:GatewayCustomDomain" }, { type: "azure-native:appplatform/v20221201:GatewayCustomDomain" }, { type: "azure-native:appplatform/v20230101preview:GatewayCustomDomain" }, { type: "azure-native:appplatform/v20230301preview:GatewayCustomDomain" }, { type: "azure-native:appplatform/v20230501preview:GatewayCustomDomain" }, { type: "azure-native:appplatform/v20230701preview:GatewayCustomDomain" }, { type: "azure-native:appplatform/v20230901preview:GatewayCustomDomain" }] };

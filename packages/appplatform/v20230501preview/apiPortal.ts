...
export class ApiPortal extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:appplatform/v20230501preview:ApiPortal';
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.appplatform.v20230501preview.ApiPortalPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ApiPortalArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(types.inputs.appplatform.v20230501preview.apiPortalPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface ApiPortalArgs {
     ...
     * API portal properties payload
     */
    properties?: pulumi.Input<types.inputs.appplatform.v20230501preview.ApiPortalPropertiesArgs>;
    /**

...
export function getMonitoringSetting(args: GetMonitoringSettingArgs, opts?: pulumi.InvokeOptions): Promise<GetMonitoringSettingResult> {
    ...
    return pulumi.runtime.invoke("azure-native:appplatform/v20230501preview:getMonitoringSetting", {
...
export interface GetMonitoringSettingResult {
     ...
     */
    readonly properties: types.outputs.appplatform.v20230501preview.MonitoringSettingPropertiesResponse;
    /**

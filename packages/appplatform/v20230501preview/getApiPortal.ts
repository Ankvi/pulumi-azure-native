...
export function getApiPortal(args: GetApiPortalArgs, opts?: pulumi.InvokeOptions): Promise<GetApiPortalResult> {
    ...
    return pulumi.runtime.invoke("azure-native:appplatform/v20230501preview:getApiPortal", {
...
export interface GetApiPortalResult {
     ...
     */
    readonly properties: types.outputs.appplatform.v20230501preview.ApiPortalPropertiesResponse;
    /**

...
export class ApiPortalCustomDomain extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:appplatform/v20230501preview:ApiPortalCustomDomain';
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.appplatform.v20230501preview.ApiPortalCustomDomainPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ApiPortalCustomDomainArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:appplatform:ApiPortalCustomDomain" }, { type: "azure-native:appplatform/v20220101preview:ApiPortalCustomDomain" }, { type: "azure-native:appplatform/v20220301preview:ApiPortalCustomDomain" }, { type: "azure-native:appplatform/v20220501preview:ApiPortalCustomDomain" }, { type: "azure-native:appplatform/v20220901preview:ApiPortalCustomDomain" }, { type: "azure-native:appplatform/v20221101preview:ApiPortalCustomDomain" }, { type: "azure-native:appplatform/v20221201:ApiPortalCustomDomain" }, { type: "azure-native:appplatform/v20230101preview:ApiPortalCustomDomain" }, { type: "azure-native:appplatform/v20230301preview:ApiPortalCustomDomain" }, { type: "azure-native:appplatform/v20230701preview:ApiPortalCustomDomain" }, { type: "azure-native:appplatform/v20230901preview:ApiPortalCustomDomain" }] };
...
export interface ApiPortalCustomDomainArgs {
     ...
     * The properties of custom domain for API portal
     */
    properties?: pulumi.Input<types.inputs.appplatform.v20230501preview.ApiPortalCustomDomainPropertiesArgs>;
    /**

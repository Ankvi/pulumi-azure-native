...
export function getCustomDomain(args: GetCustomDomainArgs, opts?: pulumi.InvokeOptions): Promise<GetCustomDomainResult> {
    ...
    return pulumi.runtime.invoke("azure-native:appplatform/v20230501preview:getCustomDomain", {
...
export interface GetCustomDomainResult {
     ...
     */
    readonly properties: types.outputs.appplatform.v20230501preview.CustomDomainPropertiesResponse;
    /**

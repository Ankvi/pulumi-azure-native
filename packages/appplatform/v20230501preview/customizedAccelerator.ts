...
export class CustomizedAccelerator extends pulumi.CustomResource {
    ...
    constructor(name: string, args: CustomizedAcceleratorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:appplatform:CustomizedAccelerator" }, { type: "azure-native:appplatform/v20221101preview:CustomizedAccelerator" }, { type: "azure-native:appplatform/v20230101preview:CustomizedAccelerator" }, { type: "azure-native:appplatform/v20230301preview:CustomizedAccelerator" }, { type: "azure-native:appplatform/v20230701preview:CustomizedAccelerator" }, { type: "azure-native:appplatform/v20230901preview:CustomizedAccelerator" }, { type: "azure-native:appplatform/v20231101preview:CustomizedAccelerator" }] };

...
export class CustomizedAccelerator extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:appplatform/v20230501preview:CustomizedAccelerator';
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.appplatform.v20230501preview.CustomizedAcceleratorPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: CustomizedAcceleratorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:appplatform:CustomizedAccelerator" }, { type: "azure-native:appplatform/v20221101preview:CustomizedAccelerator" }, { type: "azure-native:appplatform/v20230101preview:CustomizedAccelerator" }, { type: "azure-native:appplatform/v20230301preview:CustomizedAccelerator" }, { type: "azure-native:appplatform/v20230701preview:CustomizedAccelerator" }, { type: "azure-native:appplatform/v20230901preview:CustomizedAccelerator" }] };
...
export interface CustomizedAcceleratorArgs {
     ...
     * Customized accelerator properties payload
     */
    properties?: pulumi.Input<types.inputs.appplatform.v20230501preview.CustomizedAcceleratorPropertiesArgs>;
    /**

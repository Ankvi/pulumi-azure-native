...
export function getGatewayCustomDomain(args: GetGatewayCustomDomainArgs, opts?: pulumi.InvokeOptions): Promise<GetGatewayCustomDomainResult> {
    ...
    return pulumi.runtime.invoke("azure-native:appplatform/v20230501preview:getGatewayCustomDomain", {
...
export interface GetGatewayCustomDomainResult {
     ...
     */
    readonly properties: types.outputs.appplatform.v20230501preview.GatewayCustomDomainPropertiesResponse;
    /**

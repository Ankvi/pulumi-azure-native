...
export function getConfigurationService(args: GetConfigurationServiceArgs, opts?: pulumi.InvokeOptions): Promise<GetConfigurationServiceResult> {
    ...
    return pulumi.runtime.invoke("azure-native:appplatform/v20230501preview:getConfigurationService", {
...
export interface GetConfigurationServiceResult {
     ...
     */
    readonly properties: types.outputs.appplatform.v20230501preview.ConfigurationServicePropertiesResponse;
    /**

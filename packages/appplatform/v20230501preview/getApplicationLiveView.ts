...
export function getApplicationLiveView(args: GetApplicationLiveViewArgs, opts?: pulumi.InvokeOptions): Promise<GetApplicationLiveViewResult> {
    ...
    return pulumi.runtime.invoke("azure-native:appplatform/v20230501preview:getApplicationLiveView", {
...
export interface GetApplicationLiveViewResult {
     ...
     */
    readonly properties: types.outputs.appplatform.v20230501preview.ApplicationLiveViewPropertiesResponse;
    /**

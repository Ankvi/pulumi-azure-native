...
export function getApiPortalCustomDomain(args: GetApiPortalCustomDomainArgs, opts?: pulumi.InvokeOptions): Promise<GetApiPortalCustomDomainResult> {
    ...
    return pulumi.runtime.invoke("azure-native:appplatform/v20230501preview:getApiPortalCustomDomain", {
...
export interface GetApiPortalCustomDomainResult {
     ...
     */
    readonly properties: types.outputs.appplatform.v20230501preview.ApiPortalCustomDomainPropertiesResponse;
    /**

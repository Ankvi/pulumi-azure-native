...
export class MonitoringSetting extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.appplatform.v20230501preview.MonitoringSettingPropertiesResponse>;
    /**
...
export interface MonitoringSettingArgs {
     ...
     * Properties of the Monitoring Setting resource
     */
    properties?: pulumi.Input<types.inputs.appplatform.v20230501preview.MonitoringSettingPropertiesArgs>;
    /**

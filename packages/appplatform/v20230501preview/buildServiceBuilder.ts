...
export class BuildServiceBuilder extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:appplatform/v20230501preview:BuildServiceBuilder';
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.appplatform.v20230501preview.BuilderPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: BuildServiceBuilderArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:appplatform:BuildServiceBuilder" }, { type: "azure-native:appplatform/v20220101preview:BuildServiceBuilder" }, { type: "azure-native:appplatform/v20220301preview:BuildServiceBuilder" }, { type: "azure-native:appplatform/v20220401:BuildServiceBuilder" }, { type: "azure-native:appplatform/v20220501preview:BuildServiceBuilder" }, { type: "azure-native:appplatform/v20220901preview:BuildServiceBuilder" }, { type: "azure-native:appplatform/v20221101preview:BuildServiceBuilder" }, { type: "azure-native:appplatform/v20221201:BuildServiceBuilder" }, { type: "azure-native:appplatform/v20230101preview:BuildServiceBuilder" }, { type: "azure-native:appplatform/v20230301preview:BuildServiceBuilder" }, { type: "azure-native:appplatform/v20230701preview:BuildServiceBuilder" }, { type: "azure-native:appplatform/v20230901preview:BuildServiceBuilder" }] };
...
export interface BuildServiceBuilderArgs {
     ...
     * Property of the Builder resource.
     */
    properties?: pulumi.Input<types.inputs.appplatform.v20230501preview.BuilderPropertiesArgs>;
    /**

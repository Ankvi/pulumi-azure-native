...
export class ContainerRegistry extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.appplatform.v20230501preview.ContainerRegistryPropertiesResponse>;
    /**
...
export interface ContainerRegistryArgs {
     ...
     * Properties of the container registry resource payload.
     */
    properties?: pulumi.Input<types.inputs.appplatform.v20230501preview.ContainerRegistryPropertiesArgs>;
    /**

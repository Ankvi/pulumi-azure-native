...
export function getApm(args: GetApmArgs, opts?: pulumi.InvokeOptions): Promise<GetApmResult> {
    ...
    return pulumi.runtime.invoke("azure-native:appplatform/v20230501preview:getApm", {
...
export interface GetApmResult {
     ...
     */
    readonly properties: types.outputs.appplatform.v20230501preview.ApmPropertiesResponse;
    /**

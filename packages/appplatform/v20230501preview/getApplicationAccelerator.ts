...
export function getApplicationAccelerator(args: GetApplicationAcceleratorArgs, opts?: pulumi.InvokeOptions): Promise<GetApplicationAcceleratorResult> {
    ...
    return pulumi.runtime.invoke("azure-native:appplatform/v20230501preview:getApplicationAccelerator", {
...
export interface GetApplicationAcceleratorResult {
     ...
     */
    readonly properties: types.outputs.appplatform.v20230501preview.ApplicationAcceleratorPropertiesResponse;
    /**
     * Sku of the application accelerator resource
     */
    readonly sku?: types.outputs.appplatform.v20230501preview.SkuResponse;
    /**

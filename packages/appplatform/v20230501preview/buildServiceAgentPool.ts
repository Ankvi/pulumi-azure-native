...
export class BuildServiceAgentPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:appplatform/v20230501preview:BuildServiceAgentPool';
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.appplatform.v20230501preview.BuildServiceAgentPoolPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: BuildServiceAgentPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:appplatform:BuildServiceAgentPool" }, { type: "azure-native:appplatform/v20220101preview:BuildServiceAgentPool" }, { type: "azure-native:appplatform/v20220301preview:BuildServiceAgentPool" }, { type: "azure-native:appplatform/v20220401:BuildServiceAgentPool" }, { type: "azure-native:appplatform/v20220501preview:BuildServiceAgentPool" }, { type: "azure-native:appplatform/v20220901preview:BuildServiceAgentPool" }, { type: "azure-native:appplatform/v20221101preview:BuildServiceAgentPool" }, { type: "azure-native:appplatform/v20221201:BuildServiceAgentPool" }, { type: "azure-native:appplatform/v20230101preview:BuildServiceAgentPool" }, { type: "azure-native:appplatform/v20230301preview:BuildServiceAgentPool" }, { type: "azure-native:appplatform/v20230701preview:BuildServiceAgentPool" }, { type: "azure-native:appplatform/v20230901preview:BuildServiceAgentPool" }] };
...
export interface BuildServiceAgentPoolArgs {
     ...
     * build service agent pool properties
     */
    properties?: pulumi.Input<types.inputs.appplatform.v20230501preview.BuildServiceAgentPoolPropertiesArgs>;
    /**

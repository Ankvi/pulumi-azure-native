...
export class ApplicationAccelerator extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:appplatform:ApplicationAccelerator';
     ...
     */
    declare public /*out*/ readonly properties: pulumi.Output<types.outputs.ApplicationAcceleratorPropertiesResponse>;
    /**

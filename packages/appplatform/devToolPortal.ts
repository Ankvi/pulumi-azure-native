...
export class DevToolPortal extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.DevToolPortalPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: DevToolPortalArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["devToolPortalName"] = args?.devToolPortalName;

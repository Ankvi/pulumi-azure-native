...
export class ServiceRegistry extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly properties!: pulumi.Output<types.outputs.appplatform.ServiceRegistryPropertiesResponse>;
    /**

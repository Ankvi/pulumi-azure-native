...
export class MonitoringSetting extends pulumi.CustomResource {
    ...
    constructor(name: string, args: MonitoringSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:appplatform:MonitoringSetting" }, { type: "azure-native:appplatform/v20200701:MonitoringSetting" }, { type: "azure-native:appplatform/v20201101preview:MonitoringSetting" }, { type: "azure-native:appplatform/v20210601preview:MonitoringSetting" }, { type: "azure-native:appplatform/v20210901preview:MonitoringSetting" }, { type: "azure-native:appplatform/v20220101preview:MonitoringSetting" }, { type: "azure-native:appplatform/v20220301preview:MonitoringSetting" }, { type: "azure-native:appplatform/v20220401:MonitoringSetting" }, { type: "azure-native:appplatform/v20220501preview:MonitoringSetting" }, { type: "azure-native:appplatform/v20220901preview:MonitoringSetting" }, { type: "azure-native:appplatform/v20221101preview:MonitoringSetting" }, { type: "azure-native:appplatform/v20221201:MonitoringSetting" }, { type: "azure-native:appplatform/v20230101preview:MonitoringSetting" }, { type: "azure-native:appplatform/v20230301preview:MonitoringSetting" }, { type: "azure-native:appplatform/v20230501preview:MonitoringSetting" }, { type: "azure-native:appplatform/v20230701preview:MonitoringSetting" }, { type: "azure-native:appplatform/v20230901preview:MonitoringSetting" }] };

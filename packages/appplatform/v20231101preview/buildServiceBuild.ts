...
export class BuildServiceBuild extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:appplatform/v20231101preview:BuildServiceBuild';
    ...
    constructor(name: string, args: BuildServiceBuildArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:appplatform:BuildServiceBuild" }, { type: "azure-native:appplatform/v20230301preview:BuildServiceBuild" }, { type: "azure-native:appplatform/v20230501preview:BuildServiceBuild" }, { type: "azure-native:appplatform/v20230701preview:BuildServiceBuild" }, { type: "azure-native:appplatform/v20230901preview:BuildServiceBuild" }, { type: "azure-native:appplatform/v20231201:BuildServiceBuild" }, { type: "azure-native:appplatform/v20240101preview:BuildServiceBuild" }] };

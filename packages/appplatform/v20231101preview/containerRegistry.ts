...
export class ContainerRegistry extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:appplatform/v20231101preview:ContainerRegistry';
    ...
    constructor(name: string, args: ContainerRegistryArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:appplatform:ContainerRegistry" }, { type: "azure-native:appplatform/v20230501preview:ContainerRegistry" }, { type: "azure-native:appplatform/v20230701preview:ContainerRegistry" }, { type: "azure-native:appplatform/v20230901preview:ContainerRegistry" }, { type: "azure-native:appplatform/v20231201:ContainerRegistry" }, { type: "azure-native:appplatform/v20240101preview:ContainerRegistry" }] };

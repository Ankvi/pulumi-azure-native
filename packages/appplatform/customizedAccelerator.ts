...
export class CustomizedAccelerator extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.CustomizedAcceleratorPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: CustomizedAcceleratorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["customizedAcceleratorName"] = args?.customizedAcceleratorName;

...
export function getBuildpackBinding(args: GetBuildpackBindingArgs, opts?: pulumi.InvokeOptions): Promise<GetBuildpackBindingResult> {
    ...
    return pulumi.runtime.invoke("azure-native:appplatform/v20230901preview:getBuildpackBinding", {
...
export interface GetBuildpackBindingResult {
     ...
     */
    readonly properties: types.outputs.appplatform.v20230901preview.BuildpackBindingPropertiesResponse;
    /**

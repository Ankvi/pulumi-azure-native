...
export function getMonitoringSetting(args: GetMonitoringSettingArgs, opts?: pulumi.InvokeOptions): Promise<GetMonitoringSettingResult> {
    ...
    return pulumi.runtime.invoke("azure-native:appplatform/v20230901preview:getMonitoringSetting", {
...
export interface GetMonitoringSettingResult {
     ...
     */
    readonly properties: types.outputs.appplatform.v20230901preview.MonitoringSettingPropertiesResponse;
    /**

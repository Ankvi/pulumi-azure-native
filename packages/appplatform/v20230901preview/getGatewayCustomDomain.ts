...
export function getGatewayCustomDomain(args: GetGatewayCustomDomainArgs, opts?: pulumi.InvokeOptions): Promise<GetGatewayCustomDomainResult> {
    ...
    return pulumi.runtime.invoke("azure-native:appplatform/v20230901preview:getGatewayCustomDomain", {
...
export interface GetGatewayCustomDomainResult {
     ...
     */
    readonly properties: types.outputs.appplatform.v20230901preview.GatewayCustomDomainPropertiesResponse;
    /**

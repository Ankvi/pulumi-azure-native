...
export class GatewayRouteConfig extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:appplatform/v20230901preview:GatewayRouteConfig';
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.appplatform.v20230901preview.GatewayRouteConfigPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: GatewayRouteConfigArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(types.inputs.appplatform.v20230901preview.gatewayRouteConfigPropertiesArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:appplatform:GatewayRouteConfig" }, { type: "azure-native:appplatform/v20220101preview:GatewayRouteConfig" }, { type: "azure-native:appplatform/v20220301preview:GatewayRouteConfig" }, { type: "azure-native:appplatform/v20220501preview:GatewayRouteConfig" }, { type: "azure-native:appplatform/v20220901preview:GatewayRouteConfig" }, { type: "azure-native:appplatform/v20221101preview:GatewayRouteConfig" }, { type: "azure-native:appplatform/v20221201:GatewayRouteConfig" }, { type: "azure-native:appplatform/v20230101preview:GatewayRouteConfig" }, { type: "azure-native:appplatform/v20230301preview:GatewayRouteConfig" }, { type: "azure-native:appplatform/v20230501preview:GatewayRouteConfig" }, { type: "azure-native:appplatform/v20230701preview:GatewayRouteConfig" }] };
...
export interface GatewayRouteConfigArgs {
     ...
     * API route config of the Spring Cloud Gateway
     */
    properties?: pulumi.Input<types.inputs.appplatform.v20230901preview.GatewayRouteConfigPropertiesArgs>;
    /**

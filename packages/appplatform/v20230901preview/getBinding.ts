...
export function getBinding(args: GetBindingArgs, opts?: pulumi.InvokeOptions): Promise<GetBindingResult> {
    ...
    return pulumi.runtime.invoke("azure-native:appplatform/v20230901preview:getBinding", {
...
export interface GetBindingResult {
     ...
     */
    readonly properties: types.outputs.appplatform.v20230901preview.BindingResourcePropertiesResponse;
    /**

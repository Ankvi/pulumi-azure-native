...
export function getDevToolPortal(args: GetDevToolPortalArgs, opts?: pulumi.InvokeOptions): Promise<GetDevToolPortalResult> {
    ...
    return pulumi.runtime.invoke("azure-native:appplatform/v20230901preview:getDevToolPortal", {
...
export interface GetDevToolPortalResult {
     ...
     */
    readonly properties: types.outputs.appplatform.v20230901preview.DevToolPortalPropertiesResponse;
    /**

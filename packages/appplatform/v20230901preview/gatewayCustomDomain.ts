...
export class GatewayCustomDomain extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.appplatform.v20230901preview.GatewayCustomDomainPropertiesResponse>;
    /**
...
export interface GatewayCustomDomainArgs {
     ...
     * The properties of custom domain for Spring Cloud Gateway
     */
    properties?: pulumi.Input<types.inputs.appplatform.v20230901preview.GatewayCustomDomainPropertiesArgs>;
    /**

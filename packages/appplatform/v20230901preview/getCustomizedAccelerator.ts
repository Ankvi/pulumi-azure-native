...
export function getCustomizedAccelerator(args: GetCustomizedAcceleratorArgs, opts?: pulumi.InvokeOptions): Promise<GetCustomizedAcceleratorResult> {
    ...
    return pulumi.runtime.invoke("azure-native:appplatform/v20230901preview:getCustomizedAccelerator", {
...
export interface GetCustomizedAcceleratorResult {
     ...
     */
    readonly properties: types.outputs.appplatform.v20230901preview.CustomizedAcceleratorPropertiesResponse;
    /**

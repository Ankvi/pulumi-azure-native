...
export class BuildServiceBuilder extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:appplatform/v20240101preview:BuildServiceBuilder';

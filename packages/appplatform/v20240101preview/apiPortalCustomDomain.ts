...
export class ApiPortalCustomDomain extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:appplatform/v20240101preview:ApiPortalCustomDomain';

...
export class ApplicationLiveView extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly properties: pulumi.Output<types.outputs.ApplicationLiveViewPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ApplicationLiveViewArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["applicationLiveViewName"] = args?.applicationLiveViewName;

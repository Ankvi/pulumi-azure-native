...
export class ConfigurationService extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.appplatform.ConfigurationServicePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ConfigurationServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(types.inputs.appplatform.configurationServicePropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface ConfigurationServiceArgs {
     ...
     * Application Configuration Service properties payload
     */
    properties?: pulumi.Input<types.inputs.appplatform.ConfigurationServicePropertiesArgs>;
    /**

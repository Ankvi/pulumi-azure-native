...
export class Apm extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ApmArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:appplatform:Apm" }, { type: "azure-native:appplatform/v20230501preview:Apm" }, { type: "azure-native:appplatform/v20230901preview:Apm" }, { type: "azure-native:appplatform/v20231101preview:Apm" }, { type: "azure-native:appplatform/v20231201:Apm" }, { type: "azure-native:appplatform/v20240101preview:Apm" }] };

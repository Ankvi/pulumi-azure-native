...
export function getBuildServiceAgentPool(args: GetBuildServiceAgentPoolArgs, opts?: pulumi.InvokeOptions): Promise<GetBuildServiceAgentPoolResult> {
    ...
    return pulumi.runtime.invoke("azure-native:appplatform/v20230701preview:getBuildServiceAgentPool", {
...
export interface GetBuildServiceAgentPoolResult {
     ...
     */
    readonly properties: types.outputs.appplatform.v20230701preview.BuildServiceAgentPoolPropertiesResponse;
    /**

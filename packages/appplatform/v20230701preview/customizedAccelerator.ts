...
export class CustomizedAccelerator extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:appplatform/v20230701preview:CustomizedAccelerator';
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.appplatform.v20230701preview.CustomizedAcceleratorPropertiesResponse>;
    /**
...
export interface CustomizedAcceleratorArgs {
     ...
     * Customized accelerator properties payload
     */
    properties?: pulumi.Input<types.inputs.appplatform.v20230701preview.CustomizedAcceleratorPropertiesArgs>;
    /**

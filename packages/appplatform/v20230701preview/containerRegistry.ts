...
export class ContainerRegistry extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:appplatform/v20230701preview:ContainerRegistry';
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.appplatform.v20230701preview.ContainerRegistryPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ContainerRegistryArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:appplatform:ContainerRegistry" }, { type: "azure-native:appplatform/v20230501preview:ContainerRegistry" }, { type: "azure-native:appplatform/v20230901preview:ContainerRegistry" }] };
...
export interface ContainerRegistryArgs {
     ...
     * Properties of the container registry resource payload.
     */
    properties?: pulumi.Input<types.inputs.appplatform.v20230701preview.ContainerRegistryPropertiesArgs>;
    /**

...
export function getGatewayRouteConfig(args: GetGatewayRouteConfigArgs, opts?: pulumi.InvokeOptions): Promise<GetGatewayRouteConfigResult> {
    ...
    return pulumi.runtime.invoke("azure-native:appplatform/v20230701preview:getGatewayRouteConfig", {
...
export interface GetGatewayRouteConfigResult {
     ...
     */
    readonly properties: types.outputs.appplatform.v20230701preview.GatewayRouteConfigPropertiesResponse;
    /**

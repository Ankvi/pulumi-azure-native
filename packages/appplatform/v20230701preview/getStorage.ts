...
export function getStorage(args: GetStorageArgs, opts?: pulumi.InvokeOptions): Promise<GetStorageResult> {
    ...
    return pulumi.runtime.invoke("azure-native:appplatform/v20230701preview:getStorage", {
...
export interface GetStorageResult {
     ...
     */
    readonly properties: types.outputs.appplatform.v20230701preview.StorageAccountResponse;
    /**

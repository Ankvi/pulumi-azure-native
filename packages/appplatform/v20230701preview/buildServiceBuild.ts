...
export class BuildServiceBuild extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:appplatform/v20230701preview:BuildServiceBuild';
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.appplatform.v20230701preview.BuildPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: BuildServiceBuildArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(types.inputs.appplatform.v20230701preview.buildPropertiesArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:appplatform:BuildServiceBuild" }, { type: "azure-native:appplatform/v20230301preview:BuildServiceBuild" }, { type: "azure-native:appplatform/v20230501preview:BuildServiceBuild" }, { type: "azure-native:appplatform/v20230901preview:BuildServiceBuild" }] };
...
export interface BuildServiceBuildArgs {
     ...
     * Properties of the build resource
     */
    properties?: pulumi.Input<types.inputs.appplatform.v20230701preview.BuildPropertiesArgs>;
    /**

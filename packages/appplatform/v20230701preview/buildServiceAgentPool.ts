...
export class BuildServiceAgentPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:appplatform/v20230701preview:BuildServiceAgentPool';
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.appplatform.v20230701preview.BuildServiceAgentPoolPropertiesResponse>;
    /**
...
export interface BuildServiceAgentPoolArgs {
     ...
     * build service agent pool properties
     */
    properties?: pulumi.Input<types.inputs.appplatform.v20230701preview.BuildServiceAgentPoolPropertiesArgs>;
    /**

...
export function getContainerRegistry(args: GetContainerRegistryArgs, opts?: pulumi.InvokeOptions): Promise<GetContainerRegistryResult> {
    ...
    return pulumi.runtime.invoke("azure-native:appplatform/v20230701preview:getContainerRegistry", {
...
export interface GetContainerRegistryResult {
     ...
     */
    readonly properties: types.outputs.appplatform.v20230701preview.ContainerRegistryPropertiesResponse;
    /**

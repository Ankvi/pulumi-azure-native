...
export function getApplicationAccelerator(args: GetApplicationAcceleratorArgs, opts?: pulumi.InvokeOptions): Promise<GetApplicationAcceleratorResult> {
    ...
    return pulumi.runtime.invoke("azure-native:appplatform/v20230701preview:getApplicationAccelerator", {
...
export interface GetApplicationAcceleratorResult {
     ...
     */
    readonly properties: types.outputs.appplatform.v20230701preview.ApplicationAcceleratorPropertiesResponse;
    /**

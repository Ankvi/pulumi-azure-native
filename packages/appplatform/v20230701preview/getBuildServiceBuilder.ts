...
export function getBuildServiceBuilder(args: GetBuildServiceBuilderArgs, opts?: pulumi.InvokeOptions): Promise<GetBuildServiceBuilderResult> {
    ...
    return pulumi.runtime.invoke("azure-native:appplatform/v20230701preview:getBuildServiceBuilder", {
...
export interface GetBuildServiceBuilderResult {
     ...
     */
    readonly properties: types.outputs.appplatform.v20230701preview.BuilderPropertiesResponse;
    /**

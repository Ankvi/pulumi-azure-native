...
export function getGateway(args: GetGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetGatewayResult> {
    ...
    return pulumi.runtime.invoke("azure-native:appplatform/v20230701preview:getGateway", {
...
export interface GetGatewayResult {
     ...
     */
    readonly properties: types.outputs.appplatform.v20230701preview.GatewayPropertiesResponse;
    /**

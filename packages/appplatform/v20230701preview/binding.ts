...
export class Binding extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:appplatform/v20230701preview:Binding';
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.appplatform.v20230701preview.BindingResourcePropertiesResponse>;
    /**
...
export interface BindingArgs {
     ...
     * Properties of the Binding resource
     */
    properties?: pulumi.Input<types.inputs.appplatform.v20230701preview.BindingResourcePropertiesArgs>;
    /**

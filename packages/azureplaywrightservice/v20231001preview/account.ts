...
export class Account extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azureplaywrightservice/v20231001preview:Account';
    ...
    constructor(name: string, args: AccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azureplaywrightservice:Account" }, { type: "azure-native:azureplaywrightservice/v20240201preview:Account" }] };

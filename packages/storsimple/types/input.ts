...
export namespace storsimple {
    ...
    export namespace v20170601 {
        ...
        export interface AsymmetricEncryptedSecretArgs {
             ...
             * The algorithm used to encrypt "Value".
             */
            encryptionAlgorithm: pulumi.Input<enums.v20170601.EncryptionAlgorithm>;
            /**
             * Thumbprint certificate that was used to encrypt "Value". If the value in unencrypted, it will be null.
             */
            encryptionCertThumbprint?: pulumi.Input<string>;
        ...
        export interface BandwidthScheduleArgs {
             ...
             * The days of the week when this schedule is applicable.
             */
            days: pulumi.Input<pulumi.Input<enums.v20170601.DayOfWeek>[]>;
            /**
             * The rate in Mbps.
             */
            rateInMbps: pulumi.Input<number>;
             ...
             * The start time of the schedule.
             */
            start: pulumi.Input<v20170601.TimeArgs>;
            /**
             * The stop time of the schedule.
             */
            stop: pulumi.Input<v20170601.TimeArgs>;
        }
        ...
        export interface ManagerIntrinsicSettingsArgs {
             ...
             * The type of StorSimple Manager.
             */
            type: pulumi.Input<enums.v20170601.ManagerType>;
        }
        ...
        export interface ManagerSkuArgs {
             ...
             * Refers to the sku name which should be "Standard"
             */
            name: pulumi.Input<enums.v20170601.ManagerSkuType>;
        }
        ...
        export interface ScheduleRecurrenceArgs {
             ...
             * The recurrence type.
             */
            recurrenceType: pulumi.Input<enums.v20170601.RecurrenceType>;
            /**
             * The recurrence value.
             */
            recurrenceValue: pulumi.Input<number>;
             ...
             * The week days list. Applicable only for schedules of recurrence type 'weekly'.
             */
            weeklyDaysList?: pulumi.Input<pulumi.Input<enums.v20170601.DayOfWeek>[]>;
        }

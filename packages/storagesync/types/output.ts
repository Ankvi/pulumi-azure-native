...
export namespace storagesync {
    ...
    export namespace v20220601 {
        ...
        export interface CloudEndpointChangeEnumerationStatusResponse {
             ...
             * Change enumeration activity
             */
            activity: v20220601.CloudEndpointChangeEnumerationActivityResponse;
            /**
             * Status of last completed change enumeration
             */
            lastEnumerationStatus: v20220601.CloudEndpointLastChangeEnumerationStatusResponse;
            /**
             * Last updated timestamp
             */
            lastUpdatedTimestamp: string;
        ...
        export interface CloudTieringFilesNotTieringResponse {
             ...
             * Array of tiering errors
             */
            errors: v20220601.FilesNotTieringErrorResponse[];
            /**
             * Last updated timestamp
             */
            lastUpdatedTimestamp: string;
        ...
        export interface PrivateEndpointConnectionResponse {
             ...
             * The resource of private end point.
             */
            privateEndpoint?: v20220601.PrivateEndpointResponse;
            /**
             * A collection of information about the state of the connection between service consumer and provider.
             */
            privateLinkServiceConnectionState: v20220601.PrivateLinkServiceConnectionStateResponse;
            /**
             * The provisioning state of the private endpoint connection resource.
             */
            provisioningState: string;
             ...
             * Azure Resource Manager metadata containing createdBy and modifiedBy information.
             */
            systemData: v20220601.SystemDataResponse;
            /**
             * The type of the resource. E.g. "Microsoft.Compute/virtualMachines" or "Microsoft.Storage/storageAccounts"
             */
            type: string;
        ...
        export interface ServerEndpointCloudTieringStatusResponse {
             ...
             * Information regarding how well the local cache on the server is performing.
             */
            cachePerformance: v20220601.CloudTieringCachePerformanceResponse;
            /**
             * Status of the date policy
             */
            datePolicyStatus: v20220601.CloudTieringDatePolicyStatusResponse;
            /**
             * Information regarding files that failed to be tiered
             */
            filesNotTiering: v20220601.CloudTieringFilesNotTieringResponse;
            /**
             * Cloud tiering health state.
             */
            health: string;
             ...
             * Information regarding the low disk mode state
             */
            lowDiskMode: v20220601.CloudTieringLowDiskModeResponse;
            /**
             * Information regarding how much local space cloud tiering is saving.
             */
            spaceSavings: v20220601.CloudTieringSpaceSavingsResponse;
            /**
             * Status of the volume free space policy
             */
            volumeFreeSpacePolicyStatus: v20220601.CloudTieringVolumeFreeSpacePolicyStatusResponse;
        }
        ...
        export interface ServerEndpointRecallStatusResponse {
             ...
             * Array of recall errors
             */
            recallErrors: v20220601.ServerEndpointRecallErrorResponse[];
            /**
             * Total count of recall errors.
             */
            totalRecallErrorsCount: number;
        ...
        export interface ServerEndpointSyncSessionStatusResponse {
             ...
             * Array of per-item errors coming from the last sync session.
             */
            filesNotSyncingErrors: v20220601.ServerEndpointFilesNotSyncingErrorResponse[];
            /**
             * Sync mode
             */
            lastSyncMode: string;
        ...
        export interface ServerEndpointSyncStatusResponse {
             ...
             * Background data download activity
             */
            backgroundDataDownloadActivity: v20220601.ServerEndpointBackgroundDataDownloadActivityResponse;
            /**
             * Combined Health Status.
             */
            combinedHealth: string;
             ...
             * Download sync activity
             */
            downloadActivity: v20220601.ServerEndpointSyncActivityStatusResponse;
            /**
             * Download Health Status.
             */
            downloadHealth: string;
             ...
             * Download Status
             */
            downloadStatus: v20220601.ServerEndpointSyncSessionStatusResponse;
            /**
             * Last Updated Timestamp
             */
            lastUpdatedTimestamp: string;
             ...
             * Upload sync activity
             */
            uploadActivity: v20220601.ServerEndpointSyncActivityStatusResponse;
            /**
             * Upload Health Status.
             */
            uploadHealth: string;
             ...
             * Upload Status
             */
            uploadStatus: v20220601.ServerEndpointSyncSessionStatusResponse;
        }

...
export class ServerEndpoint extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly cloudTieringStatus: pulumi.Output<types.outputs.ServerEndpointCloudTieringStatusResponse>;
    /**
     * Friendly Name
     */
     ...
     */
    declare public /*out*/ readonly recallStatus: pulumi.Output<types.outputs.ServerEndpointRecallStatusResponse>;
    /**
     * Server Endpoint provisioning status
     */
    declare public /*out*/ readonly serverEndpointProvisioningStatus: pulumi.Output<types.outputs.ServerEndpointProvisioningStatusResponse | undefined>;
    /**
     * Server Local path.
     */
     ...
     */
    declare public /*out*/ readonly syncStatus: pulumi.Output<types.outputs.ServerEndpointSyncStatusResponse>;
    /**

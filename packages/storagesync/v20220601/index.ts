...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:storagesync/v20220601:CloudEndpoint":
                return new CloudEndpoint(name, <any>undefined, { urn })
            case "azure-native:storagesync/v20220601:PrivateEndpointConnection":
                return new PrivateEndpointConnection(name, <any>undefined, { urn })
            case "azure-native:storagesync/v20220601:RegisteredServer":
                return new RegisteredServer(name, <any>undefined, { urn })
            case "azure-native:storagesync/v20220601:ServerEndpoint":
                return new ServerEndpoint(name, <any>undefined, { urn })
            case "azure-native:storagesync/v20220601:StorageSyncService":
                return new StorageSyncService(name, <any>undefined, { urn })
            case "azure-native:storagesync/v20220601:SyncGroup":
...
pulumi.runtime.registerResourceModule("azure-native", "storagesync/v20220601", _module)
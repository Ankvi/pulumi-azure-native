...
export class CloudEndpoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:storagesync/v20220601:CloudEndpoint';

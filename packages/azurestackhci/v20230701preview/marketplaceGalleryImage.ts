...
export class MarketplaceGalleryImage extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly status!: pulumi.Output<types.outputs.azurestackhci.v20230701preview.MarketplaceGalleryImageStatusResponse>;
    /**
    ...
    constructor(name: string, args: MarketplaceGalleryImageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci:MarketplaceGalleryImage" }, { type: "azure-native:azurestackhci/v20210901preview:MarketplaceGalleryImage" }, { type: "azure-native:azurestackhci/v20221215preview:MarketplaceGalleryImage" }] };

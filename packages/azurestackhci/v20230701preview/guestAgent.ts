...
export class GuestAgent extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurestackhci/v20230701preview:GuestAgent';
     ...
     */
    public readonly credentials!: pulumi.Output<types.outputs.azurestackhci.v20230701preview.GuestCredentialResponse | undefined>;
    /**
     * HTTP Proxy configuration for the VM.
     */
    public readonly httpProxyConfig!: pulumi.Output<types.outputs.azurestackhci.v20230701preview.HttpProxyConfigurationResponse | undefined>;
    /**
...
export interface GuestAgentArgs {
     ...
     * Username / Password Credentials to provision guest agent.
     */
    credentials?: pulumi.Input<types.inputs.azurestackhci.v20230701preview.GuestCredentialArgs>;
    /**
     * HTTP Proxy configuration for the VM.
     */
    httpProxyConfig?: pulumi.Input<types.inputs.azurestackhci.v20230701preview.HttpProxyConfigurationArgs>;
    /**
     * The guest agent provisioning action.
     */
    provisioningAction?: pulumi.Input<string | types.enums.v20230701preview.ProvisioningAction>;
    /**

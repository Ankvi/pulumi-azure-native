...
export function getVirtualNetwork(args: GetVirtualNetworkArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkResult> {
    ...
    return pulumi.runtime.invoke("azure-native:azurestackhci/v20230701preview:getVirtualNetwork", {
...
export interface GetVirtualNetworkResult {
     ...
     */
    readonly dhcpOptions?: types.outputs.azurestackhci.v20230701preview.VirtualNetworkPropertiesResponseDhcpOptions;
    /**
     ...
     */
    readonly status: types.outputs.azurestackhci.v20230701preview.VirtualNetworkStatusResponse;
    /**
     * Subnet - list of subnets under the virtual network
     */
    readonly subnets?: types.outputs.azurestackhci.v20230701preview.VirtualNetworkPropertiesResponseSubnets[];
    /**

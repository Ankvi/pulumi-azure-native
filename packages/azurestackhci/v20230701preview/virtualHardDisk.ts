...
export class VirtualHardDisk extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurestackhci/v20230701preview:VirtualHardDisk';
     ...
     */
    public /*out*/ readonly status!: pulumi.Output<types.outputs.azurestackhci.v20230701preview.VirtualHardDiskStatusResponse>;
    /**
...
export interface VirtualHardDiskArgs {
     ...
     * The format of the actual VHD file [vhd, vhdx]
     */
    diskFileFormat?: pulumi.Input<string | types.enums.v20230701preview.DiskFileFormat>;
    /**
     * Size of the disk in GB
     */

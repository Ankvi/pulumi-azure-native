...
export function getGuestAgent(args: GetGuestAgentArgs, opts?: pulumi.InvokeOptions): Promise<GetGuestAgentResult> {
    ...
    return pulumi.runtime.invoke("azure-native:azurestackhci/v20230701preview:getGuestAgent", {
...
export interface GetGuestAgentResult {
     ...
     */
    readonly credentials?: types.outputs.azurestackhci.v20230701preview.GuestCredentialResponse;
    /**
     * HTTP Proxy configuration for the VM.
     */
    readonly httpProxyConfig?: types.outputs.azurestackhci.v20230701preview.HttpProxyConfigurationResponse;
    /**

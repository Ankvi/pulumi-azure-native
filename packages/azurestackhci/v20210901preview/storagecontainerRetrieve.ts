...
export class StoragecontainerRetrieve extends pulumi.CustomResource {
    ...
    constructor(name: string, args: StoragecontainerRetrieveArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci/v20210901preview:storagecontainerRetrieve" }, { type: "azure-native:azurestackhci:StoragecontainerRetrieve" }, { type: "azure-native:azurestackhci:storagecontainerRetrieve" }, { type: "azure-native:azurestackhci/v20221215preview:StoragecontainerRetrieve" }, { type: "azure-native:azurestackhci/v20221215preview:storagecontainerRetrieve" }, { type: "azure-native:azurestackhci/v20230701preview:StoragecontainerRetrieve" }, { type: "azure-native:azurestackhci/v20230701preview:storagecontainerRetrieve" }, { type: "azure-native:azurestackhci/v20230901preview:StoragecontainerRetrieve" }, { type: "azure-native:azurestackhci/v20230901preview:storagecontainerRetrieve" }] };

...
export class Marketplacegalleryimage extends pulumi.CustomResource {
    ...
    constructor(name: string, args: MarketplacegalleryimageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci/v20210901preview:marketplacegalleryimage" }, { type: "azure-native:azurestackhci:Marketplacegalleryimage" }, { type: "azure-native:azurestackhci:marketplacegalleryimage" }, { type: "azure-native:azurestackhci/v20221215preview:Marketplacegalleryimage" }, { type: "azure-native:azurestackhci/v20221215preview:marketplacegalleryimage" }, { type: "azure-native:azurestackhci/v20230701preview:Marketplacegalleryimage" }, { type: "azure-native:azurestackhci/v20230701preview:marketplacegalleryimage" }] };

...
export class LogicalNetwork extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurestackhci/v20240101:LogicalNetwork';
    ...
    constructor(name: string, args: LogicalNetworkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci:LogicalNetwork" }, { type: "azure-native:azurestackhci/v20230901preview:LogicalNetwork" }] };

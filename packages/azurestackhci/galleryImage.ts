...
export class GalleryImage extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurestackhci:GalleryImage';
     ...
     */
    declare public readonly identifier: pulumi.Output<types.outputs.GalleryImageIdentifierResponse | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly status: pulumi.Output<types.outputs.GalleryImageStatusResponse>;
    /**
     ...
     */
    declare public readonly version: pulumi.Output<types.outputs.GalleryImageVersionResponse | undefined>;
    /**
     * The credentials used to login to the image repository that has access to the specified image
     */
    declare public readonly vmImageRepositoryCredentials: pulumi.Output<types.outputs.VmImageRepositoryCredentialsResponse | undefined>;
...
export interface GalleryImageArgs {
     ...
     * The credentials used to login to the image repository that has access to the specified image
     */
    vmImageRepositoryCredentials?: pulumi.Input<types.inputs.VmImageRepositoryCredentialsArgs>;
}
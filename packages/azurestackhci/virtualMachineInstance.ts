...
export class VirtualMachineInstance extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly guestAgentInstallStatus: pulumi.Output<types.outputs.GuestAgentInstallStatusResponse | undefined>;
    /**
     * HardwareProfile - Specifies the hardware settings for the virtual machine instance.
     */
    declare public readonly hardwareProfile: pulumi.Output<types.outputs.VirtualMachineInstancePropertiesHardwareProfileResponse | undefined>;
    /**
     * HTTP Proxy configuration for the VM.
     */
    declare public readonly httpProxyConfig: pulumi.Output<types.outputs.HttpProxyConfigurationResponse | undefined>;
    /**
     ...
     */
    declare public readonly networkProfile: pulumi.Output<types.outputs.VirtualMachineInstancePropertiesNetworkProfileResponse | undefined>;
    /**
     * OsProfile - describes the configuration of the operating system and sets login data
     */
    declare public readonly osProfile: pulumi.Output<types.outputs.VirtualMachineInstancePropertiesOsProfileResponse | undefined>;
    /**
     ...
     */
    declare public readonly securityProfile: pulumi.Output<types.outputs.VirtualMachineInstancePropertiesSecurityProfileResponse | undefined>;
    /**
     * The observed state of virtual machine instances
     */
    declare public /*out*/ readonly status: pulumi.Output<types.outputs.VirtualMachineInstanceStatusResponse>;
    /**
     * StorageProfile - contains information about the disks and storage information for the virtual machine instance
     */
    declare public readonly storageProfile: pulumi.Output<types.outputs.VirtualMachineInstancePropertiesStorageProfileResponse | undefined>;
    /**
    ...
    constructor(name: string, args: VirtualMachineInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci/v20230701preview:VirtualMachineInstance" }, { type: "azure-native:azurestackhci/v20230901preview:VirtualMachineInstance" }, { type: "azure-native:azurestackhci/v20240101:VirtualMachineInstance" }, { type: "azure-native:azurestackhci/v20240201preview:VirtualMachineInstance" }, { type: "azure-native:azurestackhci/v20240501preview:VirtualMachineInstance" }, { type: "azure-native:azurestackhci/v20240715preview:VirtualMachineInstance" }, { type: "azure-native:azurestackhci/v20240801preview:VirtualMachineInstance" }, { type: "azure-native:azurestackhci/v20241001preview:VirtualMachineInstance" }, { type: "azure-native:azurestackhci/v20250201preview:VirtualMachineInstance" }, { type: "azure-native:azurestackhci/v20250401preview:VirtualMachineInstance" }, { type: "azure-native:azurestackhci/v20250601preview:VirtualMachineInstance" }] };

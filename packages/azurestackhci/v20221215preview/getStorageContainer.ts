...
export function getStorageContainer(args: GetStorageContainerArgs, opts?: pulumi.InvokeOptions): Promise<GetStorageContainerResult> {
    ...
    return pulumi.runtime.invoke("azure-native:azurestackhci/v20221215preview:getStorageContainer", {
...
export interface GetStorageContainerResult {
     ...
     */
    readonly status: types.outputs.azurestackhci.v20221215preview.StorageContainerStatusResponse;
    /**

...
export class HybridIdentityMetadatum extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurestackhci/v20221215preview:HybridIdentityMetadatum';
     ...
     */
    public /*out*/ readonly identity!: pulumi.Output<types.outputs.azurestackhci.v20221215preview.IdentityResponse>;
    /**
    ...
    constructor(name: string, args: HybridIdentityMetadatumArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci:HybridIdentityMetadatum" }, { type: "azure-native:azurestackhci/v20210901preview:HybridIdentityMetadatum" }] };

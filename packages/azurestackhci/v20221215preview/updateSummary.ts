...
export class UpdateSummary extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurestackhci/v20221215preview:UpdateSummary';
    ...
    constructor(name: string, args: UpdateSummaryArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci:UpdateSummary" }, { type: "azure-native:azurestackhci/v20221201:UpdateSummary" }, { type: "azure-native:azurestackhci/v20230201:UpdateSummary" }, { type: "azure-native:azurestackhci/v20230301:UpdateSummary" }, { type: "azure-native:azurestackhci/v20230601:UpdateSummary" }] };
...
export interface UpdateSummaryArgs {
     ...
     * Overall update state of the stamp.
     */
    state?: pulumi.Input<string | types.enums.v20221215preview.UpdateSummariesPropertiesState>;
}

...
export class GuestAgent extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurestackhci/v20221215preview:GuestAgent';
     ...
     */
    public readonly credentials!: pulumi.Output<types.outputs.azurestackhci.v20221215preview.GuestCredentialResponse | undefined>;
    /**
     * HTTP Proxy configuration for the VM.
     */
    public readonly httpProxyConfig!: pulumi.Output<types.outputs.azurestackhci.v20221215preview.HttpProxyConfigurationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: GuestAgentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci:GuestAgent" }, { type: "azure-native:azurestackhci/v20210901preview:GuestAgent" }] };
...
export interface GuestAgentArgs {
     ...
     * Username / Password Credentials to provision guest agent.
     */
    credentials?: pulumi.Input<types.inputs.azurestackhci.v20221215preview.GuestCredentialArgs>;
    /**
     * HTTP Proxy configuration for the VM.
     */
    httpProxyConfig?: pulumi.Input<types.inputs.azurestackhci.v20221215preview.HttpProxyConfigurationArgs>;
    /**
     ...
     * The guest agent provisioning action.
     */
    provisioningAction?: pulumi.Input<string | types.enums.v20221215preview.ProvisioningAction>;
    /**

...
export class VirtualHardDisk extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly status!: pulumi.Output<types.outputs.azurestackhci.v20221215preview.VirtualHardDiskStatusResponse>;
    /**
    ...
    constructor(name: string, args: VirtualHardDiskArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci:VirtualHardDisk" }, { type: "azure-native:azurestackhci/v20210701preview:VirtualHardDisk" }, { type: "azure-native:azurestackhci/v20210901preview:VirtualHardDisk" }, { type: "azure-native:azurestackhci/v20230701preview:VirtualHardDisk" }] };
...
export interface VirtualHardDiskArgs {
     ...
     * The format of the actual VHD file [vhd, vhdx]
     */
    diskFileFormat?: pulumi.Input<string | types.enums.v20221215preview.DiskFileFormat>;
    /**
     * Size of the disk in GB
     */

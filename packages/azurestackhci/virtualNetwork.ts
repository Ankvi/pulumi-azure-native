...
export class VirtualNetwork extends pulumi.CustomResource {
     ...
     */
    declare public readonly dhcpOptions: pulumi.Output<types.outputs.VirtualNetworkPropertiesResponseDhcpOptions | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly status: pulumi.Output<types.outputs.VirtualNetworkStatusResponse>;
    /**
     * Subnet - list of subnets under the virtual network
     */
    declare public readonly subnets: pulumi.Output<types.outputs.VirtualNetworkPropertiesResponseSubnets[] | undefined>;
    /**

...
export class NetworkInterface extends pulumi.CustomResource {
     ...
     */
    public readonly dnsSettings!: pulumi.Output<types.outputs.azurestackhci.InterfaceDNSSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly ipConfigurations!: pulumi.Output<types.outputs.azurestackhci.IPConfigurationResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly status!: pulumi.Output<types.outputs.azurestackhci.NetworkInterfaceStatusResponse>;
    /**
    ...
    constructor(name: string, args: NetworkInterfaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci/v20210701preview:NetworkInterface" }, { type: "azure-native:azurestackhci/v20210901preview:NetworkInterface" }, { type: "azure-native:azurestackhci/v20221215preview:NetworkInterface" }, { type: "azure-native:azurestackhci/v20230701preview:NetworkInterface" }] };
...
export interface NetworkInterfaceArgs {
     ...
     * DNS Settings for the interface
     */
    dnsSettings?: pulumi.Input<types.inputs.azurestackhci.InterfaceDNSSettingsArgs>;
    /**
     * The extendedLocation of the resource.
     */
     ...
     * IPConfigurations - A list of IPConfigurations of the network interface.
     */
    ipConfigurations?: pulumi.Input<pulumi.Input<types.inputs.azurestackhci.IPConfigurationArgs>[]>;
    /**
     * The geo-location where the resource lives
     */

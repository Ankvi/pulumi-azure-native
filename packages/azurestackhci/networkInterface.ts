...
export class NetworkInterface extends pulumi.CustomResource {
     ...
     */
    declare public readonly dnsSettings: pulumi.Output<types.outputs.InterfaceDNSSettingsResponse | undefined>;
    /**
     ...
     */
    declare public readonly ipConfigurations: pulumi.Output<types.outputs.IPConfigurationResponse[] | undefined>;
    /**
     ...
     */
    declare public readonly networkSecurityGroup: pulumi.Output<types.outputs.NetworkSecurityGroupArmReferenceResponse | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly status: pulumi.Output<types.outputs.NetworkInterfaceStatusResponse>;
    /**

...
export class NetworkSecurityGroup extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly networkInterfaces: pulumi.Output<types.outputs.NetworkInterfaceArmReferenceResponse[]>;
    /**
     ...
     */
    declare public /*out*/ readonly status: pulumi.Output<types.outputs.NetworkSecurityGroupStatusResponse>;
    /**
     * A collection of references to logical networks that are currently using this NSG
     */
    declare public /*out*/ readonly subnets: pulumi.Output<types.outputs.LogicalNetworkArmReferenceResponse[]>;
    /**
    ...
    constructor(name: string, args: NetworkSecurityGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci/v20240201preview:NetworkSecurityGroup" }, { type: "azure-native:azurestackhci/v20240501preview:NetworkSecurityGroup" }, { type: "azure-native:azurestackhci/v20240715preview:NetworkSecurityGroup" }, { type: "azure-native:azurestackhci/v20240801preview:NetworkSecurityGroup" }, { type: "azure-native:azurestackhci/v20241001preview:NetworkSecurityGroup" }, { type: "azure-native:azurestackhci/v20250201preview:NetworkSecurityGroup" }, { type: "azure-native:azurestackhci/v20250401preview:NetworkSecurityGroup" }, { type: "azure-native:azurestackhci/v20250601preview:NetworkSecurityGroup" }] };

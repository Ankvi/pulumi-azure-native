...
export class EdgeDevice extends pulumi.CustomResource {
    ...
    constructor(name: string, args: EdgeDeviceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci/v20230801preview:EdgeDevice" }, { type: "azure-native:azurestackhci/v20231101preview:EdgeDevice" }, { type: "azure-native:azurestackhci/v20240101:EdgeDevice" }, { type: "azure-native:azurestackhci/v20240215preview:EdgeDevice" }] };

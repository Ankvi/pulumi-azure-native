...
export class HciEdgeDevice extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurestackhci:HciEdgeDevice';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.HciEdgeDevicePropertiesResponse>;
    /**

...
export class EdgeDevice extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurestackhci/v20230801preview:EdgeDevice';
    ...
    constructor(name: string, args: EdgeDeviceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci:EdgeDevice" }, { type: "azure-native:azurestackhci/v20231101preview:EdgeDevice" }, { type: "azure-native:azurestackhci/v20240101:EdgeDevice" }, { type: "azure-native:azurestackhci/v20240215preview:EdgeDevice" }] };

...
export function getExtension(args: GetExtensionArgs, opts?: pulumi.InvokeOptions): Promise<GetExtensionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:azurestackhci/v20230301:getExtension", {
...
export interface GetExtensionResult {
     ...
     */
    readonly perNodeExtensionDetails: types.outputs.azurestackhci.v20230301.PerNodeExtensionStateResponse[];
    /**

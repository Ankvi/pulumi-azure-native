...
export class Update extends pulumi.CustomResource {
     ...
     */
    public readonly prerequisites!: pulumi.Output<types.outputs.azurestackhci.v20230301.UpdatePrerequisiteResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: UpdateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestackhci:Update" }, { type: "azure-native:azurestackhci/v20221201:Update" }, { type: "azure-native:azurestackhci/v20221215preview:Update" }, { type: "azure-native:azurestackhci/v20230201:Update" }, { type: "azure-native:azurestackhci/v20230601:Update" }] };
...
export interface UpdateArgs {
     ...
     * Indicates the way the update content can be downloaded.
     */
    availabilityType?: pulumi.Input<string | types.enums.v20230301.AvailabilityType>;
    /**
     ...
     * If update State is HasPrerequisite, this property contains an array of objects describing prerequisite updates before installing this update. Otherwise, it is empty.
     */
    prerequisites?: pulumi.Input<pulumi.Input<types.inputs.azurestackhci.v20230301.UpdatePrerequisiteArgs>[]>;
    /**
     * Progress percentage of ongoing operation. Currently this property is only valid when the update is in the Downloading state, where it maps to how much of the update content has been downloaded.
     */
     ...
     * State of the update as it relates to this stamp.
     */
    state?: pulumi.Input<string | types.enums.v20230301.State>;
    /**

...
export interface GetArcSettingResult {
     ...
     */
    readonly connectivityProperties?: types.outputs.azurestackhci.v20230301.ArcConnectivityPropertiesResponse[];
    /**
     * Properties for each of the default extensions category
     */
    readonly defaultExtensions: types.outputs.azurestackhci.v20230301.DefaultExtensionDetailsResponse[];
    /**
     ...
     */
    readonly perNodeDetails: types.outputs.azurestackhci.v20230301.PerNodeStateResponse[];
    /**

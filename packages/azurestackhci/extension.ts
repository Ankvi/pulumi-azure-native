...
export class Extension extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly perNodeExtensionDetails: pulumi.Output<types.outputs.PerNodeExtensionStateResponse[]>;
    /**

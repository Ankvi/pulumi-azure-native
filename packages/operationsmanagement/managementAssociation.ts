...
export class ManagementAssociation extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.ManagementAssociationPropertiesResponse>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: ManagementAssociationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["managementAssociationName"] = args?.managementAssociationName;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:operationsmanagement/v20151101preview:ManagementAssociation" }] };

...
// Export enums:
export * from "../types/enums/v20230607";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:labservices/v20230607:Lab":
                return new Lab(name, <any>undefined, { urn })
            case "azure-native:labservices/v20230607:LabPlan":
                return new LabPlan(name, <any>undefined, { urn })
            case "azure-native:labservices/v20230607:Schedule":
                return new Schedule(name, <any>undefined, { urn })
            case "azure-native:labservices/v20230607:User":
...
pulumi.runtime.registerResourceModule("azure-native", "labservices/v20230607", _module)

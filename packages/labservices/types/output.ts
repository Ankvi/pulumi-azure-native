...
export namespace labservices {
    ...
    export namespace v20181015 {
        ...
        export interface EnvironmentDetailsResponse {
             ...
             * The details of the latest operation. ex: status, error
             */
            latestOperationResult: v20181015.LatestOperationResultResponse;
            /**
             * Name of the Environment
             */
            name: string;
             ...
             * Details of backing DTL virtual machine with compute and network details.
             */
            virtualMachineDetails: v20181015.VirtualMachineDetailsResponse;
        }
        ...
        export interface EnvironmentSizeResponse {
             ...
             * Represents a set of compute sizes that can serve this given size type
             */
            vmSizes?: v20181015.SizeInfoResponse[];
        }
        ...
        export interface ReferenceVmResponse {
             ...
             * The state details for the reference virtual machine.
             */
            vmStateDetails: v20181015.VmStateDetailsResponse;
        }
        ...
        export interface RegionalAvailabilityResponse {
             ...
             * List of all the size information for the region
             */
            sizeAvailabilities?: v20181015.SizeAvailabilityResponse[];
        }
        ...
        export interface ResourceSettingsResponse {
             ...
             * Details specific to Reference Vm
             */
            referenceVm: v20181015.ReferenceVmResponse;
            /**
             * The size of the virtual machine
             */
            size?: string;
        ...
        export interface SizeConfigurationPropertiesResponse {
             ...
             * Represents a list of size categories supported by this Lab Account (Small, Medium, Large)
             */
            environmentSizes?: v20181015.EnvironmentSizeResponse[];
        }
    ...
    export namespace v20220801 {
        ...
        export interface VirtualMachineProfileResponse {
             ...
             * Additional VM capabilities.
             */
            additionalCapabilities?: v20220801.VirtualMachineAdditionalCapabilitiesResponse;
            /**
             * Credentials for the admin user on the VM.
             */
            adminUser: v20220801.CredentialsResponse;
            /**
             * Indicates what lab virtual machines are created from.
             */
            createOption: string;
             ...
             * The image configuration for lab virtual machines.
             */
            imageReference: v20220801.ImageReferenceResponse;
            /**
             * Credentials for the non-admin user on the VM, if one exists.
             */
            nonAdminUser?: v20220801.CredentialsResponse;
            /**
             * The OS type of the image
             */
            osType: string;
        ...
        export function virtualMachineProfileResponseProvideDefaults(val: VirtualMachineProfileResponse): VirtualMachineProfileResponse {
            return {
                ...val,
                additionalCapabilities: (val.additionalCapabilities ? v20220801.virtualMachineAdditionalCapabilitiesResponseProvideDefaults(val.additionalCapabilities) : undefined),
                useSharedPassword: (val.useSharedPassword) ?? "Disabled",
            };
        }
    ...
    export namespace v20230607 {
        ...
        export interface VirtualMachineProfileResponse {
             ...
             * Additional VM capabilities.
             */
            additionalCapabilities?: v20230607.VirtualMachineAdditionalCapabilitiesResponse;
            /**
             * Credentials for the admin user on the VM.
             */
            adminUser: v20230607.CredentialsResponse;
            /**
             * Indicates what lab virtual machines are created from.
             */
            createOption: string;
             ...
             * The image configuration for lab virtual machines.
             */
            imageReference: v20230607.ImageReferenceResponse;
            /**
             * Credentials for the non-admin user on the VM, if one exists.
             */
            nonAdminUser?: v20230607.CredentialsResponse;
            /**
             * The OS type of the image
             */
            osType: string;
        ...
        export function virtualMachineProfileResponseProvideDefaults(val: VirtualMachineProfileResponse): VirtualMachineProfileResponse {
            return {
                ...val,
                additionalCapabilities: (val.additionalCapabilities ? v20230607.virtualMachineAdditionalCapabilitiesResponseProvideDefaults(val.additionalCapabilities) : undefined),
                useSharedPassword: (val.useSharedPassword) ?? "Disabled",
            };
        }

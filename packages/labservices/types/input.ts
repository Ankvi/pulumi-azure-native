...
export namespace labservices {
    ...
    export namespace v20181015 {
        ...
        export interface ResourceSettingsArgs {
             ...
             * Details specific to Reference Vm
             */
            referenceVm: pulumi.Input<v20181015.ReferenceVmArgs>;
            /**
             * The size of the virtual machine
             */
            size?: pulumi.Input<string | enums.v20181015.ManagedLabVmSize>;
        }
    ...
    export namespace v20220801 {
        ...
        export interface AutoShutdownProfileArgs {
             ...
             * Whether shutdown on disconnect is enabled
             */
            shutdownOnDisconnect?: pulumi.Input<enums.v20220801.EnableState>;
            /**
             * Whether a VM will get shutdown when it has idled for a period of time.
             */
            shutdownOnIdle?: pulumi.Input<enums.v20220801.ShutdownOnIdleMode>;
            /**
             * Whether a VM will get shutdown when it hasn't been connected to after a period of time.
             */
            shutdownWhenNotConnected?: pulumi.Input<enums.v20220801.EnableState>;
        }
        /**
         * autoShutdownProfileArgsProvideDefaults sets the appropriate defaults for AutoShutdownProfileArgs
         */
        ...
        export interface ConnectionProfileArgs {
             ...
             * The enabled access level for Client Access over RDP.
             */
            clientRdpAccess?: pulumi.Input<enums.v20220801.ConnectionType>;
            /**
             * The enabled access level for Client Access over SSH.
             */
            clientSshAccess?: pulumi.Input<enums.v20220801.ConnectionType>;
            /**
             * The enabled access level for Web Access over RDP.
             */
            webRdpAccess?: pulumi.Input<enums.v20220801.ConnectionType>;
            /**
             * The enabled access level for Web Access over SSH.
             */
            webSshAccess?: pulumi.Input<enums.v20220801.ConnectionType>;
        }
        /**
         * connectionProfileArgsProvideDefaults sets the appropriate defaults for ConnectionProfileArgs
         */
        ...
        export interface IdentityArgs {
             ...
             * The identity type.
             */
            type?: pulumi.Input<enums.v20220801.ResourceIdentityType>;
        }
        ...
        export interface RecurrencePatternArgs {
             ...
             * The frequency of the recurrence.
             */
            frequency: pulumi.Input<enums.v20220801.RecurrenceFrequency>;
            /**
             * The interval to invoke the schedule on. For example, interval = 2 and RecurrenceFrequency.Daily will run every 2 days. When no interval is supplied, an interval of 1 is used.
             */
            interval?: pulumi.Input<number>;
             ...
             * The week days the schedule runs. Used for when the Frequency is set to Weekly.
             */
            weekDays?: pulumi.Input<pulumi.Input<enums.v20220801.WeekDay>[]>;
        }
        ...
        export interface SecurityProfileArgs {
             ...
             * Whether any user or only specified users can register to a lab.
             */
            openAccess?: pulumi.Input<enums.v20220801.EnableState>;
        }
        ...
        export interface SkuArgs {
             ...
             * This field is required to be implemented by the Resource Provider if the service has more than one tier, but is not required on a PUT.
             */
            tier?: pulumi.Input<enums.v20220801.SkuTier>;
        }
        ...
        export interface VirtualMachineAdditionalCapabilitiesArgs {
             ...
             * Flag to pre-install dedicated GPU drivers.
             */
            installGpuDrivers?: pulumi.Input<enums.v20220801.EnableState>;
        }
        /**
         * virtualMachineAdditionalCapabilitiesArgsProvideDefaults sets the appropriate defaults for VirtualMachineAdditionalCapabilitiesArgs
         */
        ...
        export interface VirtualMachineProfileArgs {
             ...
             * Additional VM capabilities.
             */
            additionalCapabilities?: pulumi.Input<v20220801.VirtualMachineAdditionalCapabilitiesArgs>;
            /**
             * Credentials for the admin user on the VM.
             */
            adminUser: pulumi.Input<v20220801.CredentialsArgs>;
            /**
             * Indicates what lab virtual machines are created from.
             */
            createOption: pulumi.Input<enums.v20220801.CreateOption>;
            /**
             * The image configuration for lab virtual machines.
             */
            imageReference: pulumi.Input<v20220801.ImageReferenceArgs>;
            /**
             * Credentials for the non-admin user on the VM, if one exists.
             */
            nonAdminUser?: pulumi.Input<v20220801.CredentialsArgs>;
            /**
             * The SKU for the lab. Defines the type of virtual machines used in the lab.
             */
            sku: pulumi.Input<v20220801.SkuArgs>;
            /**
             * The initial quota alloted to each lab user. Must be a time span between 0 and 9999 hours.
             */
            usageQuota: pulumi.Input<string>;
             ...
             * Enabling this option will use the same password for all user VMs.
             */
            useSharedPassword?: pulumi.Input<enums.v20220801.EnableState>;
        }
        /**
         * virtualMachineProfileArgsProvideDefaults sets the appropriate defaults for VirtualMachineProfileArgs
         */
        export function virtualMachineProfileArgsProvideDefaults(val: VirtualMachineProfileArgs): VirtualMachineProfileArgs {
            return {
                ...val,
                additionalCapabilities: (val.additionalCapabilities ? pulumi.output(val.additionalCapabilities).apply(v20220801.virtualMachineAdditionalCapabilitiesArgsProvideDefaults) : undefined),
                useSharedPassword: (val.useSharedPassword) ?? "Disabled",
            };
        }
    ...
    export namespace v20230607 {
        ...
        export interface AutoShutdownProfileArgs {
             ...
             * Whether shutdown on disconnect is enabled
             */
            shutdownOnDisconnect?: pulumi.Input<enums.v20230607.EnableState>;
            /**
             * Whether a VM will get shutdown when it has idled for a period of time.
             */
            shutdownOnIdle?: pulumi.Input<enums.v20230607.ShutdownOnIdleMode>;
            /**
             * Whether a VM will get shutdown when it hasn't been connected to after a period of time.
             */
            shutdownWhenNotConnected?: pulumi.Input<enums.v20230607.EnableState>;
        }
        /**
         * autoShutdownProfileArgsProvideDefaults sets the appropriate defaults for AutoShutdownProfileArgs
         */
        ...
        export interface ConnectionProfileArgs {
             ...
             * The enabled access level for Client Access over RDP.
             */
            clientRdpAccess?: pulumi.Input<enums.v20230607.ConnectionType>;
            /**
             * The enabled access level for Client Access over SSH.
             */
            clientSshAccess?: pulumi.Input<enums.v20230607.ConnectionType>;
            /**
             * The enabled access level for Web Access over RDP.
             */
            webRdpAccess?: pulumi.Input<enums.v20230607.ConnectionType>;
            /**
             * The enabled access level for Web Access over SSH.
             */
            webSshAccess?: pulumi.Input<enums.v20230607.ConnectionType>;
        }
        /**
         * connectionProfileArgsProvideDefaults sets the appropriate defaults for ConnectionProfileArgs
         */
        ...
        export interface IdentityArgs {
             ...
             * The identity type.
             */
            type?: pulumi.Input<enums.v20230607.ResourceIdentityType>;
        }
        ...
        export interface RecurrencePatternArgs {
             ...
             * The frequency of the recurrence.
             */
            frequency: pulumi.Input<enums.v20230607.RecurrenceFrequency>;
            /**
             * The interval to invoke the schedule on. For example, interval = 2 and RecurrenceFrequency.Daily will run every 2 days. When no interval is supplied, an interval of 1 is used.
             */
            interval?: pulumi.Input<number>;
             ...
             * The week days the schedule runs. Used for when the Frequency is set to Weekly.
             */
            weekDays?: pulumi.Input<pulumi.Input<enums.v20230607.WeekDay>[]>;
        }
        ...
        export interface SecurityProfileArgs {
             ...
             * Whether any user or only specified users can register to a lab.
             */
            openAccess?: pulumi.Input<enums.v20230607.EnableState>;
        }
        ...
        export interface SkuArgs {
             ...
             * This field is required to be implemented by the Resource Provider if the service has more than one tier, but is not required on a PUT.
             */
            tier?: pulumi.Input<enums.v20230607.SkuTier>;
        }
        ...
        export interface VirtualMachineAdditionalCapabilitiesArgs {
             ...
             * Flag to pre-install dedicated GPU drivers.
             */
            installGpuDrivers?: pulumi.Input<enums.v20230607.EnableState>;
        }
        /**
         * virtualMachineAdditionalCapabilitiesArgsProvideDefaults sets the appropriate defaults for VirtualMachineAdditionalCapabilitiesArgs
         */
        ...
        export interface VirtualMachineProfileArgs {
             ...
             * Additional VM capabilities.
             */
            additionalCapabilities?: pulumi.Input<v20230607.VirtualMachineAdditionalCapabilitiesArgs>;
            /**
             * Credentials for the admin user on the VM.
             */
            adminUser: pulumi.Input<v20230607.CredentialsArgs>;
            /**
             * Indicates what lab virtual machines are created from.
             */
            createOption: pulumi.Input<enums.v20230607.CreateOption>;
            /**
             * The image configuration for lab virtual machines.
             */
            imageReference: pulumi.Input<v20230607.ImageReferenceArgs>;
            /**
             * Credentials for the non-admin user on the VM, if one exists.
             */
            nonAdminUser?: pulumi.Input<v20230607.CredentialsArgs>;
            /**
             * The SKU for the lab. Defines the type of virtual machines used in the lab.
             */
            sku: pulumi.Input<v20230607.SkuArgs>;
            /**
             * The initial quota alloted to each lab user. Must be a time span between 0 and 9999 hours.
             */
            usageQuota: pulumi.Input<string>;
             ...
             * Enabling this option will use the same password for all user VMs.
             */
            useSharedPassword?: pulumi.Input<enums.v20230607.EnableState>;
        }
        /**
         * virtualMachineProfileArgsProvideDefaults sets the appropriate defaults for VirtualMachineProfileArgs
         */
        export function virtualMachineProfileArgsProvideDefaults(val: VirtualMachineProfileArgs): VirtualMachineProfileArgs {
            return {
                ...val,
                additionalCapabilities: (val.additionalCapabilities ? pulumi.output(val.additionalCapabilities).apply(v20230607.virtualMachineAdditionalCapabilitiesArgsProvideDefaults) : undefined),
                useSharedPassword: (val.useSharedPassword) ?? "Disabled",
            };
        }

...
export class AppServiceCertificateOrder extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:certificateregistration/v20220901:AppServiceCertificateOrder';

...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:certificateregistration/v20230101:AppServiceCertificateOrder":
                return new AppServiceCertificateOrder(name, <any>undefined, { urn })
            case "azure-native:certificateregistration/v20230101:AppServiceCertificateOrderCertificate":
...
pulumi.runtime.registerResourceModule("azure-native", "certificateregistration/v20230101", _module)

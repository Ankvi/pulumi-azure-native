...
export interface GetAppServiceCertificateOrderResult {
     ...
     */
    readonly certificates?: {[key: string]: types.outputs.certificateregistration.AppServiceCertificateResponse};
    /**
     * Contact info
     */
    readonly contact: types.outputs.certificateregistration.CertificateOrderContactResponse;
    /**
     ...
     */
    readonly intermediate: types.outputs.certificateregistration.CertificateDetailsResponse;
    /**
     ...
     * Root certificate.
     */
    readonly root: types.outputs.certificateregistration.CertificateDetailsResponse;
    /**
     ...
     * Signed certificate.
     */
    readonly signedCertificate: types.outputs.certificateregistration.CertificateDetailsResponse;
    /**

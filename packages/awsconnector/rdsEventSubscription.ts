...
export class RdsEventSubscription extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RdsEventSubscription {
        return new RdsEventSubscription(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector:RdsEventSubscription';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.RdsEventSubscriptionPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: RdsEventSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(types.inputs.rdsEventSubscriptionPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface RdsEventSubscriptionArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.RdsEventSubscriptionPropertiesArgs>;
    /**

...
export class SecretsManagerSecret extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SecretsManagerSecret {
        return new SecretsManagerSecret(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector:SecretsManagerSecret';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.SecretsManagerSecretPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: SecretsManagerSecretArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:awsconnector/v20241201:SecretsManagerSecret" }] };
        opts = pulumi.mergeOptions(opts, aliasOpts);
        super(SecretsManagerSecret.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface SecretsManagerSecretArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.SecretsManagerSecretPropertiesArgs>;
    /**

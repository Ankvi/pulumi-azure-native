...
export class NetworkFirewallRuleGroup extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NetworkFirewallRuleGroup {
        return new NetworkFirewallRuleGroup(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector:NetworkFirewallRuleGroup';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.NetworkFirewallRuleGroupPropertiesResponse>;
    /**
...
export interface NetworkFirewallRuleGroupArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.NetworkFirewallRuleGroupPropertiesArgs>;
    /**

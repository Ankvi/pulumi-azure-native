...
export class CloudFormationStackSet extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CloudFormationStackSet {
        return new CloudFormationStackSet(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector:CloudFormationStackSet';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.CloudFormationStackSetPropertiesResponse>;
    /**
...
export interface CloudFormationStackSetArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.CloudFormationStackSetPropertiesArgs>;
    /**

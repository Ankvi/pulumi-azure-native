...
export class CloudWatchAlarm extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.CloudWatchAlarmPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: CloudWatchAlarmArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(types.inputs.cloudWatchAlarmPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface CloudWatchAlarmArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.CloudWatchAlarmPropertiesArgs>;
    /**

...
export class EcrRepository extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EcrRepository {
        return new EcrRepository(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector:EcrRepository';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.EcrRepositoryPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: EcrRepositoryArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:awsconnector/v20241201:EcrRepository" }] };
        opts = pulumi.mergeOptions(opts, aliasOpts);
        super(EcrRepository.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface EcrRepositoryArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.EcrRepositoryPropertiesArgs>;
    /**

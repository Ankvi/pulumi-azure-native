...
export class KmsKey extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.KmsKeyPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: KmsKeyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(types.inputs.kmsKeyPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface KmsKeyArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.KmsKeyPropertiesArgs>;
    /**

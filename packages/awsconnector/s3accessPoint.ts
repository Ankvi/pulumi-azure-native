...
export class S3AccessPoint extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): S3AccessPoint {
        return new S3AccessPoint(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector:S3AccessPoint';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.S3AccessPointPropertiesResponse>;
    /**
...
export interface S3AccessPointArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.S3AccessPointPropertiesArgs>;
    /**

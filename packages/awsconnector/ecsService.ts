...
export class EcsService extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.EcsServicePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: EcsServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(types.inputs.ecsServicePropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface EcsServiceArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.EcsServicePropertiesArgs>;
    /**

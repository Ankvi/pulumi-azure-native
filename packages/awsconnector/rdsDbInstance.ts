...
export class RdsDbInstance extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RdsDbInstance {
        return new RdsDbInstance(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector:RdsDbInstance';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.RdsDBInstancePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: RdsDbInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(types.inputs.rdsDBInstancePropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface RdsDbInstanceArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.RdsDBInstancePropertiesArgs>;
    /**

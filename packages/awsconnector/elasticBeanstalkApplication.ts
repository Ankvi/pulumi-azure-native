...
export class ElasticBeanstalkApplication extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ElasticBeanstalkApplication {
        return new ElasticBeanstalkApplication(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector:ElasticBeanstalkApplication';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.ElasticBeanstalkApplicationPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ElasticBeanstalkApplicationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ElasticBeanstalkApplication.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface ElasticBeanstalkApplicationArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.ElasticBeanstalkApplicationPropertiesArgs>;
    /**

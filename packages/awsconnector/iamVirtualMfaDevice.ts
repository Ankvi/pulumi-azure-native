...
export class IamVirtualMfaDevice extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IamVirtualMfaDevice {
        return new IamVirtualMfaDevice(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector:IamVirtualMfaDevice';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.IamVirtualMFADevicePropertiesResponse>;
    /**
...
export interface IamVirtualMfaDeviceArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.IamVirtualMFADevicePropertiesArgs>;
    /**

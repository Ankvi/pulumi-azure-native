...
export class EcsTaskDefinition extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.EcsTaskDefinitionPropertiesResponse>;
    /**
...
export interface EcsTaskDefinitionArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.EcsTaskDefinitionPropertiesArgs>;
    /**

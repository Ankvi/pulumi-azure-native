...
export class CloudFormationStack extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CloudFormationStack {
        return new CloudFormationStack(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector:CloudFormationStack';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.CloudFormationStackPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: CloudFormationStackArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:awsconnector/v20241201:CloudFormationStack" }] };
...
export interface CloudFormationStackArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.CloudFormationStackPropertiesArgs>;
    /**

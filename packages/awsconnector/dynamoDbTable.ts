...
export class DynamoDbTable extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.DynamoDBTablePropertiesResponse>;
    /**
...
export interface DynamoDbTableArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.DynamoDBTablePropertiesArgs>;
    /**

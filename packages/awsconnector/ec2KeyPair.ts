...
export class Ec2KeyPair extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector:Ec2KeyPair';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.Ec2KeyPairPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: Ec2KeyPairArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(types.inputs.ec2KeyPairPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface Ec2KeyPairArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.Ec2KeyPairPropertiesArgs>;
    /**

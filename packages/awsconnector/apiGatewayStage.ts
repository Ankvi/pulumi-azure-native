...
export class ApiGatewayStage extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ApiGatewayStage {
        return new ApiGatewayStage(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector:ApiGatewayStage';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.ApiGatewayStagePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ApiGatewayStageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:awsconnector/v20241201:ApiGatewayStage" }] };
        opts = pulumi.mergeOptions(opts, aliasOpts);
        super(ApiGatewayStage.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface ApiGatewayStageArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.ApiGatewayStagePropertiesArgs>;
    /**

...
export class SqsQueue extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SqsQueue {
        return new SqsQueue(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector:SqsQueue';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.SqsQueuePropertiesResponse>;
    /**
...
export interface SqsQueueArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.SqsQueuePropertiesArgs>;
    /**

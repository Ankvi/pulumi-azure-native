...
export function getIamInstanceProfile(args: GetIamInstanceProfileArgs, opts?: pulumi.InvokeOptions): Promise<GetIamInstanceProfileResult> {
    ...
    return pulumi.runtime.invoke("azure-native:awsconnector:getIamInstanceProfile", {
        "name": args.name,
...
export interface GetIamInstanceProfileResult {
     ...
     */
    readonly properties: types.outputs.IamInstanceProfilePropertiesResponse;
    /**
...
export function getIamInstanceProfileOutput(args: GetIamInstanceProfileOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIamInstanceProfileResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:awsconnector:getIamInstanceProfile", {
        "name": args.name,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}

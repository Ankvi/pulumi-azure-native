...
export class ElasticBeanstalkConfigurationTemplate extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ElasticBeanstalkConfigurationTemplate {
        return new ElasticBeanstalkConfigurationTemplate(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector:ElasticBeanstalkConfigurationTemplate';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.ElasticBeanstalkConfigurationTemplatePropertiesResponse>;
    /**
...
export interface ElasticBeanstalkConfigurationTemplateArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.ElasticBeanstalkConfigurationTemplatePropertiesArgs>;
    /**

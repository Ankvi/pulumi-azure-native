...
export class Ec2Ipam extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Ec2Ipam {
        return new Ec2Ipam(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector:Ec2Ipam';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.Ec2IpamPropertiesResponse>;
    /**
...
export interface Ec2IpamArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.Ec2IpamPropertiesArgs>;
    /**

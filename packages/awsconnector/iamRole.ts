...
export class IamRole extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IamRole {
        return new IamRole(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector:IamRole';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.IamRolePropertiesResponse>;
    /**
...
export interface IamRoleArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.IamRolePropertiesArgs>;
    /**

...
export class IamServerCertificate extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IamServerCertificate {
        return new IamServerCertificate(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector:IamServerCertificate';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.IamServerCertificatePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: IamServerCertificateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:awsconnector/v20241201:IamServerCertificate" }] };
        opts = pulumi.mergeOptions(opts, aliasOpts);
        super(IamServerCertificate.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface IamServerCertificateArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.IamServerCertificatePropertiesArgs>;
    /**

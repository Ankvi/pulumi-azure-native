...
export class S3Bucket extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.S3BucketPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: S3BucketArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(types.inputs.s3bucketPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface S3BucketArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.S3BucketPropertiesArgs>;
    /**

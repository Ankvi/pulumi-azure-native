...
export class LogsMetricFilter extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.LogsMetricFilterPropertiesResponse>;
    /**
...
export interface LogsMetricFilterArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.LogsMetricFilterPropertiesArgs>;
    /**

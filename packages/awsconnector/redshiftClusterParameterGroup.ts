...
export class RedshiftClusterParameterGroup extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RedshiftClusterParameterGroup {
        return new RedshiftClusterParameterGroup(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector:RedshiftClusterParameterGroup';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.RedshiftClusterParameterGroupPropertiesResponse>;
    /**
...
export interface RedshiftClusterParameterGroupArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.RedshiftClusterParameterGroupPropertiesArgs>;
    /**

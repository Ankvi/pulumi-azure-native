...
export class Ec2NetworkInterface extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector:Ec2NetworkInterface';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.Ec2NetworkInterfacePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: Ec2NetworkInterfaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:awsconnector/v20241201:Ec2NetworkInterface" }] };
...
export interface Ec2NetworkInterfaceArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.Ec2NetworkInterfacePropertiesArgs>;
    /**

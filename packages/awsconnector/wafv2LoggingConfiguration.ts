...
export class Wafv2LoggingConfiguration extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Wafv2LoggingConfiguration {
        return new Wafv2LoggingConfiguration(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector:Wafv2LoggingConfiguration';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.Wafv2LoggingConfigurationPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: Wafv2LoggingConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:awsconnector/v20241201:Wafv2LoggingConfiguration" }] };
        opts = pulumi.mergeOptions(opts, aliasOpts);
        super(Wafv2LoggingConfiguration.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface Wafv2LoggingConfigurationArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.Wafv2LoggingConfigurationPropertiesArgs>;
    /**

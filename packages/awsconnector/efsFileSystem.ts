...
export class EfsFileSystem extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EfsFileSystem {
        return new EfsFileSystem(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector:EfsFileSystem';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.EfsFileSystemPropertiesResponse>;
    /**
...
export interface EfsFileSystemArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.EfsFileSystemPropertiesArgs>;
    /**

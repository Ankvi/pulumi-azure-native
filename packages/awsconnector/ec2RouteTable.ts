...
export class Ec2RouteTable extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Ec2RouteTable {
        return new Ec2RouteTable(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector:Ec2RouteTable';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.Ec2RouteTablePropertiesResponse>;
    /**
...
export interface Ec2RouteTableArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.Ec2RouteTablePropertiesArgs>;
    /**

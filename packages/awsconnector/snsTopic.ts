...
export class SnsTopic extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SnsTopic {
        return new SnsTopic(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector:SnsTopic';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.SnsTopicPropertiesResponse>;
    /**
...
export interface SnsTopicArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.SnsTopicPropertiesArgs>;
    /**

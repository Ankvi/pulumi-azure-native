...
export class SsmParameter extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SsmParameter {
        return new SsmParameter(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector:SsmParameter';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.SsmParameterPropertiesResponse>;
    /**
...
export interface SsmParameterArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.SsmParameterPropertiesArgs>;
    /**

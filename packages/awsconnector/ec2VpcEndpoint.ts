...
export class Ec2VpcEndpoint extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Ec2VpcEndpoint {
        return new Ec2VpcEndpoint(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector:Ec2VpcEndpoint';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.Ec2VPCEndpointPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: Ec2VpcEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:awsconnector/v20241201:Ec2VpcEndpoint" }] };
        opts = pulumi.mergeOptions(opts, aliasOpts);
        super(Ec2VpcEndpoint.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface Ec2VpcEndpointArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.Ec2VPCEndpointPropertiesArgs>;
    /**

...
export class AccessAnalyzerAnalyzer extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AccessAnalyzerAnalyzer {
        return new AccessAnalyzerAnalyzer(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector:AccessAnalyzerAnalyzer';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.AccessAnalyzerAnalyzerPropertiesResponse>;
    /**
...
export interface AccessAnalyzerAnalyzerArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.AccessAnalyzerAnalyzerPropertiesArgs>;
    /**

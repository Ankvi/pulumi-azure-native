...
export class LambdaFunction extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.LambdaFunctionPropertiesResponse>;
    /**
...
export interface LambdaFunctionArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.LambdaFunctionPropertiesArgs>;
    /**

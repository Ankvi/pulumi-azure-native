...
export class SecretsManagerResourcePolicy extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SecretsManagerResourcePolicy {
        return new SecretsManagerResourcePolicy(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector:SecretsManagerResourcePolicy';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.SecretsManagerResourcePolicyPropertiesResponse>;
    /**
...
export interface SecretsManagerResourcePolicyArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.SecretsManagerResourcePolicyPropertiesArgs>;
    /**

...
export class Ec2SecurityGroup extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Ec2SecurityGroup {
        return new Ec2SecurityGroup(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector:Ec2SecurityGroup';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.Ec2SecurityGroupPropertiesResponse>;
    /**
...
export interface Ec2SecurityGroupArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.Ec2SecurityGroupPropertiesArgs>;
    /**

...
export class S3BucketPolicy extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): S3BucketPolicy {
        return new S3BucketPolicy(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector:S3BucketPolicy';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.S3BucketPolicyPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: S3BucketPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:awsconnector/v20241201:S3BucketPolicy" }] };
...
export interface S3BucketPolicyArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.S3BucketPolicyPropertiesArgs>;
    /**

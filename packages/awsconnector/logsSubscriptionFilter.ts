...
export class LogsSubscriptionFilter extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): LogsSubscriptionFilter {
        return new LogsSubscriptionFilter(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector:LogsSubscriptionFilter';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.LogsSubscriptionFilterPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: LogsSubscriptionFilterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:awsconnector/v20241201:LogsSubscriptionFilter" }] };
        opts = pulumi.mergeOptions(opts, aliasOpts);
        super(LogsSubscriptionFilter.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface LogsSubscriptionFilterArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.LogsSubscriptionFilterPropertiesArgs>;
    /**

...
export class RdsExportTask extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RdsExportTask {
        return new RdsExportTask(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector:RdsExportTask';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.RdsExportTaskPropertiesResponse>;
    /**
...
export interface RdsExportTaskArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.RdsExportTaskPropertiesArgs>;
    /**

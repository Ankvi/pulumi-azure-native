...
export class OrganizationsOrganization extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): OrganizationsOrganization {
        return new OrganizationsOrganization(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector:OrganizationsOrganization';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.OrganizationsOrganizationPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: OrganizationsOrganizationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:awsconnector/v20241201:OrganizationsOrganization" }] };
        opts = pulumi.mergeOptions(opts, aliasOpts);
        super(OrganizationsOrganization.__pulumiType, name, resourceInputs, opts);
    }
}

...
export class IamGroup extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IamGroup {
        return new IamGroup(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector:IamGroup';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.IamGroupPropertiesResponse>;
    /**
...
export interface IamGroupArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.IamGroupPropertiesArgs>;
    /**

...
export class NetworkFirewallFirewall extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NetworkFirewallFirewall {
        return new NetworkFirewallFirewall(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector:NetworkFirewallFirewall';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.NetworkFirewallFirewallPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: NetworkFirewallFirewallArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:awsconnector/v20241201:NetworkFirewallFirewall" }] };
        opts = pulumi.mergeOptions(opts, aliasOpts);
        super(NetworkFirewallFirewall.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface NetworkFirewallFirewallArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.NetworkFirewallFirewallPropertiesArgs>;
    /**

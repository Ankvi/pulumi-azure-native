...
export class ElasticLoadBalancingV2TargetGroup extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ElasticLoadBalancingV2TargetGroup {
        return new ElasticLoadBalancingV2TargetGroup(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:awsconnector:ElasticLoadBalancingV2TargetGroup';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.ElasticLoadBalancingV2TargetGroupPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ElasticLoadBalancingV2TargetGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:awsconnector/v20241201:ElasticLoadBalancingV2TargetGroup" }] };
        opts = pulumi.mergeOptions(opts, aliasOpts);
        super(ElasticLoadBalancingV2TargetGroup.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface ElasticLoadBalancingV2TargetGroupArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.ElasticLoadBalancingV2TargetGroupPropertiesArgs>;
    /**

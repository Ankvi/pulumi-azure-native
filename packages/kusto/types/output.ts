...
export namespace kusto {
    ...
    export namespace v20180907preview {
        export interface DatabaseStatisticsResponse {
            /**
             * The database size - the total size of compressed data and index in bytes.
             */
    ...
    export namespace v20220707 {
        ...
        export interface FollowerDatabaseDefinitionResponse {
             ...
             * Table level sharing specifications
             */
            tableLevelSharingProperties: v20220707.TableLevelSharingPropertiesResponse;
        }
        ...
        export interface IdentityResponse {
             ...
             * The list of user identities associated with the Kusto cluster. The user identity dictionary key references will be ARM resource ids in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}'.
             */
            userAssignedIdentities?: {[key: string]: v20220707.IdentityResponseUserAssignedIdentities};
        }
        ...
        export interface LanguageExtensionsListResponse {
             ...
             * The list of language extensions.
             */
            value?: v20220707.LanguageExtensionResponse[];
        }
        ...
        export interface PrivateEndpointConnectionResponse {
             ...
             * Private endpoint which the connection belongs to.
             */
            privateEndpoint: v20220707.PrivateEndpointPropertyResponse;
            /**
             * Connection State of the Private Endpoint Connection.
             */
            privateLinkServiceConnectionState: v20220707.PrivateLinkServiceConnectionStatePropertyResponse;
            /**
             * Provisioning state of the private endpoint.
             */
            provisioningState: string;
             ...
             * Metadata pertaining to creation and last modification of the resource.
             */
            systemData: v20220707.SystemDataResponse;
            /**
             * The type of the resource. E.g. "Microsoft.Compute/virtualMachines" or "Microsoft.Storage/storageAccounts"
             */
            type: string;
    ...
    export namespace v20221229 {
        ...
        export interface FollowerDatabaseDefinitionResponse {
             ...
             * Table level sharing specifications
             */
            tableLevelSharingProperties: v20221229.TableLevelSharingPropertiesResponse;
        }
        ...
        export interface IdentityResponse {
             ...
             * The list of user identities associated with the Kusto cluster. The user identity dictionary key references will be ARM resource ids in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}'.
             */
            userAssignedIdentities?: {[key: string]: v20221229.IdentityResponseUserAssignedIdentities};
        }
        ...
        export interface LanguageExtensionsListResponse {
             ...
             * The list of language extensions.
             */
            value?: v20221229.LanguageExtensionResponse[];
        }
        ...
        export interface PrivateEndpointConnectionResponse {
             ...
             * Private endpoint which the connection belongs to.
             */
            privateEndpoint: v20221229.PrivateEndpointPropertyResponse;
            /**
             * Connection State of the Private Endpoint Connection.
             */
            privateLinkServiceConnectionState: v20221229.PrivateLinkServiceConnectionStatePropertyResponse;
            /**
             * Provisioning state of the private endpoint.
             */
            provisioningState: string;
             ...
             * Metadata pertaining to creation and last modification of the resource.
             */
            systemData: v20221229.SystemDataResponse;
            /**
             * The type of the resource. E.g. "Microsoft.Compute/virtualMachines" or "Microsoft.Storage/storageAccounts"
             */
            type: string;
    ...
    export namespace v20230502 {
        ...
        export interface FollowerDatabaseDefinitionResponse {
             ...
             * Table level sharing specifications
             */
            tableLevelSharingProperties: v20230502.TableLevelSharingPropertiesResponse;
        }
        ...
        export interface IdentityResponse {
             ...
             * The list of user identities associated with the Kusto cluster. The user identity dictionary key references will be ARM resource ids in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}'.
             */
            userAssignedIdentities?: {[key: string]: v20230502.IdentityResponseUserAssignedIdentities};
        }
        ...
        export interface LanguageExtensionsListResponse {
             ...
             * The list of language extensions.
             */
            value?: v20230502.LanguageExtensionResponse[];
        }
        ...
        export interface PrivateEndpointConnectionResponse {
             ...
             * Private endpoint which the connection belongs to.
             */
            privateEndpoint: v20230502.PrivateEndpointPropertyResponse;
            /**
             * Connection State of the Private Endpoint Connection.
             */
            privateLinkServiceConnectionState: v20230502.PrivateLinkServiceConnectionStatePropertyResponse;
            /**
             * Provisioning state of the private endpoint.
             */
            provisioningState: string;
             ...
             * Metadata pertaining to creation and last modification of the resource.
             */
            systemData: v20230502.SystemDataResponse;
            /**
             * The type of the resource. E.g. "Microsoft.Compute/virtualMachines" or "Microsoft.Storage/storageAccounts"
             */
            type: string;

...
export namespace kusto {
    ...
    export namespace v20220707 {
        ...
        export interface AzureSkuArgs {
             ...
             * SKU name.
             */
            name: pulumi.Input<string | enums.v20220707.AzureSkuName>;
            /**
             * SKU tier.
             */
            tier: pulumi.Input<string | enums.v20220707.AzureSkuTier>;
        }
        ...
        export interface IdentityArgs {
             ...
             * The type of managed identity used. The type 'SystemAssigned, UserAssigned' includes both an implicitly created identity and a set of user-assigned identities. The type 'None' will remove all identities.
             */
            type: pulumi.Input<string | enums.v20220707.IdentityType>;
            /**
             * The list of user identities associated with the Kusto cluster. The user identity dictionary key references will be ARM resource ids in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}'.
             */
            userAssignedIdentities?: pulumi.Input<pulumi.Input<string>[]>;
    ...
    export namespace v20221229 {
        ...
        export interface AzureSkuArgs {
             ...
             * SKU name.
             */
            name: pulumi.Input<string | enums.v20221229.AzureSkuName>;
            /**
             * SKU tier.
             */
            tier: pulumi.Input<string | enums.v20221229.AzureSkuTier>;
        }
        ...
        export interface IdentityArgs {
             ...
             * The type of managed identity used. The type 'SystemAssigned, UserAssigned' includes both an implicitly created identity and a set of user-assigned identities. The type 'None' will remove all identities.
             */
            type: pulumi.Input<string | enums.v20221229.IdentityType>;
            /**
             * The list of user identities associated with the Kusto cluster. The user identity dictionary key references will be ARM resource ids in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}'.
             */
            userAssignedIdentities?: pulumi.Input<pulumi.Input<string>[]>;
        ...
        export interface LanguageExtensionArgs {
             ...
             * The language extension image name.
             */
            languageExtensionImageName?: pulumi.Input<string | enums.v20221229.LanguageExtensionImageName>;
            /**
             * The language extension name.
             */
            languageExtensionName?: pulumi.Input<string | enums.v20221229.LanguageExtensionName>;
        }
        ...
        export interface LanguageExtensionsListArgs {
             ...
             * The list of language extensions.
             */
            value?: pulumi.Input<pulumi.Input<v20221229.LanguageExtensionArgs>[]>;
        }
    ...
    export namespace v20230502 {
        ...
        export interface AzureSkuArgs {
             ...
             * SKU name.
             */
            name: pulumi.Input<string | enums.v20230502.AzureSkuName>;
            /**
             * SKU tier.
             */
            tier: pulumi.Input<string | enums.v20230502.AzureSkuTier>;
        }
        ...
        export interface IdentityArgs {
             ...
             * The type of managed identity used. The type 'SystemAssigned, UserAssigned' includes both an implicitly created identity and a set of user-assigned identities. The type 'None' will remove all identities.
             */
            type: pulumi.Input<string | enums.v20230502.IdentityType>;
            /**
             * The list of user identities associated with the Kusto cluster. The user identity dictionary key references will be ARM resource ids in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}'.
             */
            userAssignedIdentities?: pulumi.Input<pulumi.Input<string>[]>;
        ...
        export interface LanguageExtensionArgs {
             ...
             * The language extension image name.
             */
            languageExtensionImageName?: pulumi.Input<string | enums.v20230502.LanguageExtensionImageName>;
            /**
             * The language extension name.
             */
            languageExtensionName?: pulumi.Input<string | enums.v20230502.LanguageExtensionName>;
        }
        ...
        export interface LanguageExtensionsListArgs {
             ...
             * The list of language extensions.
             */
            value?: pulumi.Input<pulumi.Input<v20230502.LanguageExtensionArgs>[]>;
        }

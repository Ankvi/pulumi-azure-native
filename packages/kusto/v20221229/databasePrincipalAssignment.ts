...
export interface DatabasePrincipalAssignmentArgs {
     ...
     * Database principal role.
     */
    role: pulumi.Input<string | types.enums.v20221229.DatabasePrincipalRole>;
    /**
     * The tenant id of the principal
     */

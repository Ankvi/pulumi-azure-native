...
export class ManagedPrivateEndpoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:kusto/v20221229:ManagedPrivateEndpoint';

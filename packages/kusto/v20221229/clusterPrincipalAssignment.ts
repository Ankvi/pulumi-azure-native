...
export class ClusterPrincipalAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:kusto/v20221229:ClusterPrincipalAssignment';
...
export interface ClusterPrincipalAssignmentArgs {
     ...
     * Principal type.
     */
    principalType: pulumi.Input<string | types.enums.v20221229.PrincipalType>;
    /**
     ...
     * Cluster principal role.
     */
    role: pulumi.Input<string | types.enums.v20221229.ClusterPrincipalRole>;
    /**
     * The tenant id of the principal
     */

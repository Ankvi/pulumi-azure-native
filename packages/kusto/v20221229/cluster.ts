...
export class Cluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:kusto/v20221229:Cluster';
     ...
     */
    public readonly acceptedAudiences!: pulumi.Output<types.outputs.kusto.v20221229.AcceptedAudiencesResponse[] | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<types.outputs.kusto.v20221229.IdentityResponse | undefined>;
    /**
     * KeyVault properties for the cluster encryption.
     */
    public readonly keyVaultProperties!: pulumi.Output<types.outputs.kusto.v20221229.KeyVaultPropertiesResponse | undefined>;
    /**
     * List of the cluster's language extensions.
     */
    public readonly languageExtensions!: pulumi.Output<types.outputs.kusto.v20221229.LanguageExtensionsListResponse | undefined>;
    /**
     ...
     */
    public readonly optimizedAutoscale!: pulumi.Output<types.outputs.kusto.v20221229.OptimizedAutoscaleResponse | undefined>;
    /**
     * A list of private endpoint connections.
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<types.outputs.kusto.v20221229.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<types.outputs.kusto.v20221229.AzureSkuResponse>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<types.outputs.kusto.v20221229.SystemDataResponse>;
    /**
     * Resource tags.
     */
     ...
     */
    public readonly trustedExternalTenants!: pulumi.Output<types.outputs.kusto.v20221229.TrustedExternalTenantResponse[] | undefined>;
    /**
     ...
     */
    public readonly virtualNetworkConfiguration!: pulumi.Output<types.outputs.kusto.v20221229.VirtualNetworkConfigurationResponse | undefined>;
    /**
...
export interface ClusterArgs {
     ...
     * The cluster's accepted audiences.
     */
    acceptedAudiences?: pulumi.Input<pulumi.Input<types.inputs.kusto.v20221229.AcceptedAudiencesArgs>[]>;
    /**
     * List of allowed FQDNs(Fully Qualified Domain Name) for egress from Cluster.
     */
     ...
     * The engine type
     */
    engineType?: pulumi.Input<string | types.enums.v20221229.EngineType>;
    /**
     * The identity of the cluster, if configured.
     */
    identity?: pulumi.Input<types.inputs.kusto.v20221229.IdentityArgs>;
    /**
     * KeyVault properties for the cluster encryption.
     */
    keyVaultProperties?: pulumi.Input<types.inputs.kusto.v20221229.KeyVaultPropertiesArgs>;
    /**
     * List of the cluster's language extensions.
     */
    languageExtensions?: pulumi.Input<types.inputs.kusto.v20221229.LanguageExtensionsListArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Optimized auto scale definition.
     */
    optimizedAutoscale?: pulumi.Input<types.inputs.kusto.v20221229.OptimizedAutoscaleArgs>;
    /**
     * Indicates what public IP type to create - IPv4 (default), or DualStack (both IPv4 and IPv6)
     */
    publicIPType?: pulumi.Input<string | types.enums.v20221229.PublicIPType>;
    /**
     * Public network access to the cluster is enabled by default. When disabled, only private endpoint connection to the cluster is allowed
     */
    publicNetworkAccess?: pulumi.Input<string | types.enums.v20221229.PublicNetworkAccess>;
    /**
     ...
     * Whether or not to restrict outbound network access.  Value is optional but if passed in, must be 'Enabled' or 'Disabled'
     */
    restrictOutboundNetworkAccess?: pulumi.Input<string | types.enums.v20221229.ClusterNetworkAccessFlag>;
    /**
     * The SKU of the cluster.
     */
    sku: pulumi.Input<types.inputs.kusto.v20221229.AzureSkuArgs>;
    /**
     * Resource tags.
     */
     ...
     * The cluster's external tenants.
     */
    trustedExternalTenants?: pulumi.Input<pulumi.Input<types.inputs.kusto.v20221229.TrustedExternalTenantArgs>[]>;
    /**
     ...
     * Virtual network definition.
     */
    virtualNetworkConfiguration?: pulumi.Input<types.inputs.kusto.v20221229.VirtualNetworkConfigurationArgs>;
    /**
     * The availability zones of the cluster.
     */

...
export class AttachedDatabaseConfiguration extends pulumi.CustomResource {
     ...
     */
    public readonly tableLevelSharingProperties!: pulumi.Output<types.outputs.kusto.v20221229.TableLevelSharingPropertiesResponse | undefined>;
    /**
...
export interface AttachedDatabaseConfigurationArgs {
     ...
     * The default principals modification kind
     */
    defaultPrincipalsModificationKind: pulumi.Input<string | types.enums.v20221229.DefaultPrincipalsModificationKind>;
    /**
     * Resource location.
     */
     ...
     * Table level sharing specifications
     */
    tableLevelSharingProperties?: pulumi.Input<types.inputs.kusto.v20221229.TableLevelSharingPropertiesArgs>;
}

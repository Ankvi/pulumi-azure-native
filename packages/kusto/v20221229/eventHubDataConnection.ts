...
export class EventHubDataConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:kusto/v20221229:EventHubDataConnection';

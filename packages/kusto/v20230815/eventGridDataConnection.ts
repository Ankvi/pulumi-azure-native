...
export class EventGridDataConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:kusto/v20230815:EventGridDataConnection';

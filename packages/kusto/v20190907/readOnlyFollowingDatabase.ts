...
export class ReadOnlyFollowingDatabase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:kusto/v20190907:ReadOnlyFollowingDatabase';
     ...
     */
    public readonly kind!: pulumi.Output<"ReadOnlyFollowing" | undefined>;
    /**

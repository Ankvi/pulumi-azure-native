...
export class Script extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<types.outputs.kusto.v20210827.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: ScriptArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:kusto:Script" }, { type: "azure-native:kusto/v20210101:Script" }, { type: "azure-native:kusto/v20220201:Script" }, { type: "azure-native:kusto/v20220707:Script" }, { type: "azure-native:kusto/v20221111:Script" }, { type: "azure-native:kusto/v20221229:Script" }, { type: "azure-native:kusto/v20230502:Script" }] };

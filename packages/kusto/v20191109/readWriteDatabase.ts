...
export class ReadWriteDatabase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:kusto/v20191109:ReadWriteDatabase';
     ...
     */
    public /*out*/ readonly isFollowed!: pulumi.Output<string>;
    /**
     ...
     */
    public /*out*/ readonly statistics!: pulumi.Output<types.outputs.kusto.v20191109.DatabaseStatisticsResponse>;
    /**

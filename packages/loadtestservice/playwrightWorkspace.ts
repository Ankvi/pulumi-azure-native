...
export class PlaywrightWorkspace extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PlaywrightWorkspace {
        return new PlaywrightWorkspace(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:loadtestservice:PlaywrightWorkspace';

    /**
     * Returns true if the given object is an instance of PlaywrightWorkspace.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PlaywrightWorkspace {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PlaywrightWorkspace.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: PlaywrightWorkspaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:loadtestservice/v20250701preview:PlaywrightWorkspace" }] };
 ...
 */
export interface PlaywrightWorkspaceArgs {
    /**
     * When enabled, this feature allows the workspace to use local auth (through service access token) for executing operations.
     */

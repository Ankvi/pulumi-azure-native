...
export class LoadTest extends pulumi.CustomResource {
     ...
     */
    declare public readonly encryption: pulumi.Output<types.outputs.EncryptionPropertiesResponse | undefined>;
    /**
    ...
    constructor(name: string, args: LoadTestArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["loadTestName"] = args?.loadTestName;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:loadtestservice/v20211201preview:LoadTest" }, { type: "azure-native:loadtestservice/v20221201:LoadTest" }, { type: "azure-native:loadtestservice/v20231201preview:LoadTest" }, { type: "azure-native:loadtestservice/v20241201preview:LoadTest" }] };

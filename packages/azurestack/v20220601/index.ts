...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:azurestack/v20220601:CustomerSubscription":
                return new CustomerSubscription(name, <any>undefined, { urn })
            case "azure-native:azurestack/v20220601:Registration":
...
pulumi.runtime.registerResourceModule("azure-native", "azurestack/v20220601", _module)
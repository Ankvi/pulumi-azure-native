...
export class Registration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurestack/v20220601:Registration';
    ...
    constructor(name: string, args: RegistrationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurestack:Registration" }, { type: "azure-native:azurestack/v20160101:Registration" }, { type: "azure-native:azurestack/v20170601:Registration" }, { type: "azure-native:azurestack/v20200601preview:Registration" }] };

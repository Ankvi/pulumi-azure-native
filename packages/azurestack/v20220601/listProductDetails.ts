...
export function listProductDetails(args: ListProductDetailsArgs, opts?: pulumi.InvokeOptions): Promise<ListProductDetailsResult> {
    ...
    return pulumi.runtime.invoke("azure-native:azurestack/v20220601:listProductDetails", {
...
export interface ListProductDetailsResult {
     ...
     */
    readonly dataDiskImages: types.outputs.azurestack.v20220601.DataDiskImageResponse[];
    /**
     ...
     */
    readonly osDiskImage: types.outputs.azurestack.v20220601.OsDiskImageResponse;
    /**

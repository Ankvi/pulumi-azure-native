...
export class QueryPack extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:operationalinsights/v20190901:QueryPack';
    ...
    constructor(name: string, args: QueryPackArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:operationalinsights:QueryPack" }, { type: "azure-native:operationalinsights/v20190901preview:QueryPack" }] };

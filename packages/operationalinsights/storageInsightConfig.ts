...
export class StorageInsightConfig extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly status: pulumi.Output<types.outputs.StorageInsightStatusResponse>;
    /**
     * The storage account connection details
     */
    declare public readonly storageAccount: pulumi.Output<types.outputs.StorageAccountResponse>;
    /**

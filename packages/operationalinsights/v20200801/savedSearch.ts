...
export class SavedSearch extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:operationalinsights/v20200801:SavedSearch';
     ...
     */
    public readonly tags!: pulumi.Output<types.outputs.operationalinsights.v20200801.TagResponse[] | undefined>;
    /**
...
export interface SavedSearchArgs {
     ...
     * The tags attached to the saved search.
     */
    tags?: pulumi.Input<pulumi.Input<types.inputs.operationalinsights.v20200801.TagArgs>[]>;
    /**
     * The version number of the query language. The current version is 2 and is the default.
     */

...
export class CapacityDetails extends pulumi.CustomResource {
     ...
     */
    declare public readonly administration: pulumi.Output<types.outputs.DedicatedCapacityAdministratorsResponse | undefined>;
    /**
     ...
     */
    declare public readonly sku: pulumi.Output<types.outputs.CapacitySkuResponse>;
    /**
    ...
    constructor(name: string, args: CapacityDetailsArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["dedicatedCapacityName"] = args?.dedicatedCapacityName;

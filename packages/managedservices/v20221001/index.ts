...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:managedservices/v20221001:RegistrationAssignment":
                return new RegistrationAssignment(name, <any>undefined, { urn })
            case "azure-native:managedservices/v20221001:RegistrationDefinition":
...
pulumi.runtime.registerResourceModule("azure-native", "managedservices/v20221001", _module)
...
export namespace managedservices {
    ...
    export namespace v20221001 {
        ...
        export interface EligibleAuthorizationArgs {
             ...
             * The just-in-time access policy setting.
             */
            justInTimeAccessPolicy?: pulumi.Input<v20221001.JustInTimeAccessPolicyArgs>;
            /**
             * The identifier of the Azure Active Directory principal.
             */
            principalId: pulumi.Input<string>;
        ...
        export function eligibleAuthorizationArgsProvideDefaults(val: EligibleAuthorizationArgs): EligibleAuthorizationArgs {
            return {
                ...val,
                justInTimeAccessPolicy: (val.justInTimeAccessPolicy ? pulumi.output(val.justInTimeAccessPolicy).apply(v20221001.justInTimeAccessPolicyArgsProvideDefaults) : undefined),
            };
        }
        ...
        export interface JustInTimeAccessPolicyArgs {
             ...
             * The list of managedByTenant approvers for the eligible authorization.
             */
            managedByTenantApprovers?: pulumi.Input<pulumi.Input<v20221001.EligibleApproverArgs>[]>;
            /**
             * The maximum access duration in ISO 8601 format for just-in-time access requests.
             */
            maximumActivationDuration?: pulumi.Input<string>;
             ...
             * The multi-factor authorization provider to be used for just-in-time access requests.
             */
            multiFactorAuthProvider: pulumi.Input<string | enums.v20221001.MultiFactorAuthProvider>;
        }
        /**
         * justInTimeAccessPolicyArgsProvideDefaults sets the appropriate defaults for JustInTimeAccessPolicyArgs
         */
        ...
        export interface RegistrationDefinitionPropertiesArgs {
             ...
             * The collection of authorization objects describing the access Azure Active Directory principals in the managedBy tenant will receive on the delegated resource in the managed tenant.
             */
            authorizations: pulumi.Input<pulumi.Input<v20221001.AuthorizationArgs>[]>;
            /**
             * The description of the registration definition.
             */
            description?: pulumi.Input<string>;
             ...
             * The collection of eligible authorization objects describing the just-in-time access Azure Active Directory principals in the managedBy tenant will receive on the delegated resource in the managed tenant.
             */
            eligibleAuthorizations?: pulumi.Input<pulumi.Input<v20221001.EligibleAuthorizationArgs>[]>;
            /**
             * The identifier of the managedBy tenant.
             */
            managedByTenantId: pulumi.Input<string>;

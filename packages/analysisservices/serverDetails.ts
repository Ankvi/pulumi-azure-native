...
export class ServerDetails extends pulumi.CustomResource {
     ...
     */
    declare public readonly asAdministrators: pulumi.Output<types.outputs.ServerAdministratorsResponse | undefined>;
    /**
     ...
     */
    declare public readonly gatewayDetails: pulumi.Output<types.outputs.GatewayDetailsResponse | undefined>;
    /**
     * The firewall settings for the AS server.
     */
    declare public readonly ipV4FirewallSettings: pulumi.Output<types.outputs.IPv4FirewallSettingsResponse | undefined>;
    /**
     ...
     */
    declare public readonly sku: pulumi.Output<types.outputs.ResourceSkuResponse>;
    /**

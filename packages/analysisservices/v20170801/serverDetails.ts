...
export class ServerDetails extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:analysisservices/v20170801:ServerDetails';
     ...
     */
    public readonly asAdministrators!: pulumi.Output<types.outputs.analysisservices.v20170801.ServerAdministratorsResponse | undefined>;
    /**
     ...
     */
    public readonly gatewayDetails!: pulumi.Output<types.outputs.analysisservices.v20170801.GatewayDetailsResponse | undefined>;
    /**
     * The firewall settings for the AS server.
     */
    public readonly ipV4FirewallSettings!: pulumi.Output<types.outputs.analysisservices.v20170801.IPv4FirewallSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<types.outputs.analysisservices.v20170801.ResourceSkuResponse>;
    /**
    ...
    constructor(name: string, args: ServerDetailsArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["sku"] = args ? (args.sku ? pulumi.output(args.sku).apply(types.inputs.analysisservices.v20170801.resourceSkuArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:analysisservices:ServerDetails" }, { type: "azure-native:analysisservices/v20160516:ServerDetails" }, { type: "azure-native:analysisservices/v20170714:ServerDetails" }, { type: "azure-native:analysisservices/v20170801beta:ServerDetails" }] };
...
export interface ServerDetailsArgs {
     ...
     * A collection of AS server administrators
     */
    asAdministrators?: pulumi.Input<types.inputs.analysisservices.v20170801.ServerAdministratorsArgs>;
    /**
     * The SAS container URI to the backup container.
     */
     ...
     * The gateway details configured for the AS server.
     */
    gatewayDetails?: pulumi.Input<types.inputs.analysisservices.v20170801.GatewayDetailsArgs>;
    /**
     * The firewall settings for the AS server.
     */
    ipV4FirewallSettings?: pulumi.Input<types.inputs.analysisservices.v20170801.IPv4FirewallSettingsArgs>;
    /**
     * Location of the Analysis Services resource.
     */
     ...
     * How the read-write server's participation in the query pool is controlled.<br/>It can have the following values: <ul><li>readOnly - indicates that the read-write server is intended not to participate in query operations</li><li>all - indicates that the read-write server can participate in query operations</li></ul>Specifying readOnly when capacity is 1 results in error.
     */
    querypoolConnectionMode?: pulumi.Input<types.enums.v20170801.ConnectionMode>;
    /**
     ...
     * The SKU of the Analysis Services resource.
     */
    sku: pulumi.Input<types.inputs.analysisservices.v20170801.ResourceSkuArgs>;
    /**
     * Key-value pairs of additional resource provisioning properties.
     */

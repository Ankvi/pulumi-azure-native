...
// Export enums:
export * from "../types/enums/v20170801beta";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:analysisservices/v20170801beta:ServerDetails":
...
pulumi.runtime.registerResourceModule("azure-native", "analysisservices/v20170801beta", _module)

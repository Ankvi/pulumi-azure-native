...
export class CIAMTenant extends pulumi.CustomResource {
     ...
     */
    declare public readonly createTenantProperties: pulumi.Output<types.outputs.CreateCIAMTenantPropertiesResponse>;
    /**
     ...
     */
    declare public readonly sku: pulumi.Output<types.outputs.CIAMResourceSKUResponse>;
    /**

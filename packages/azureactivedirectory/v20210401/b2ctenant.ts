...
export class B2CTenant extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azureactivedirectory/v20210401:B2CTenant';
     ...
     */
    public /*out*/ readonly billingConfig!: pulumi.Output<types.outputs.azureactivedirectory.v20210401.B2CTenantResourcePropertiesResponseBillingConfig | undefined>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<types.outputs.azureactivedirectory.v20210401.B2CResourceSKUResponse>;
    /**
     * Metadata pertaining to creation and last modification of the resource.
     */
    public /*out*/ readonly systemData!: pulumi.Output<types.outputs.azureactivedirectory.v20210401.SystemDataResponse>;
    /**
     * Resource Tags
     */
    ...
    constructor(name: string, args: B2CTenantArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azureactivedirectory:B2CTenant" }, { type: "azure-native:azureactivedirectory/v20190101preview:B2CTenant" }, { type: "azure-native:azureactivedirectory/v20230118preview:B2CTenant" }] };
...
export interface B2CTenantArgs {
     ...
     * SKU properties of the Azure AD B2C tenant. Learn more about Azure AD B2C billing at [aka.ms/b2cBilling](https://aka.ms/b2cBilling).
     */
    sku: pulumi.Input<types.inputs.azureactivedirectory.v20210401.B2CResourceSKUArgs>;
    /**
     * Resource Tags
     */

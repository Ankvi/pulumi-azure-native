...
export class B2CTenant extends pulumi.CustomResource {
    ...
    constructor(name: string, args: B2CTenantArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azureactivedirectory:B2CTenant" }, { type: "azure-native:azureactivedirectory/v20190101preview:B2CTenant" }, { type: "azure-native:azureactivedirectory/v20230118preview:B2CTenant" }, { type: "azure-native:azureactivedirectory/v20230517preview:B2CTenant" }] };

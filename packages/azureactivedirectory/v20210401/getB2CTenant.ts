...
export interface GetB2CTenantResult {
     ...
     */
    readonly billingConfig?: types.outputs.azureactivedirectory.v20210401.B2CTenantResourcePropertiesResponseBillingConfig;
    /**
     ...
     */
    readonly sku: types.outputs.azureactivedirectory.v20210401.B2CResourceSKUResponse;
    /**

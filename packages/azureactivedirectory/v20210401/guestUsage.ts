...
export class GuestUsage extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azureactivedirectory/v20210401:GuestUsage';
    ...
    constructor(name: string, args: GuestUsageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azureactivedirectory:GuestUsage" }, { type: "azure-native:azureactivedirectory/v20200501preview:GuestUsage" }, { type: "azure-native:azureactivedirectory/v20230118preview:GuestUsage" }] };

...
export class CIAMTenant extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azureactivedirectory/v20230517preview:CIAMTenant';
    ...
    constructor(name: string, args: CIAMTenantArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azureactivedirectory:CIAMTenant" }] };

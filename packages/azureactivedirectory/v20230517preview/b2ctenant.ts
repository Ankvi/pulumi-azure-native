...
export class B2CTenant extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azureactivedirectory/v20230517preview:B2CTenant';
    ...
    constructor(name: string, args: B2CTenantArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azureactivedirectory:B2CTenant" }, { type: "azure-native:azureactivedirectory/v20190101preview:B2CTenant" }, { type: "azure-native:azureactivedirectory/v20210401:B2CTenant" }, { type: "azure-native:azureactivedirectory/v20230118preview:B2CTenant" }] };

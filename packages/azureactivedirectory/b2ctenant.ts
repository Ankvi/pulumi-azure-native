...
export class B2CTenant extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly billingConfig: pulumi.Output<types.outputs.B2CTenantResourcePropertiesResponseBillingConfig | undefined>;
    /**
     ...
     */
    declare public readonly isGoLocalTenant: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    declare public readonly sku: pulumi.Output<types.outputs.B2CResourceSKUResponse>;
    /**
    ...
    constructor(name: string, args: B2CTenantArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["isGoLocalTenant"] = args?.isGoLocalTenant;

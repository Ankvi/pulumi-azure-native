...
export class CustomLocation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:extendedlocation/v20210815:CustomLocation';
     ...
     */
    public readonly authentication!: pulumi.Output<types.outputs.extendedlocation.v20210815.CustomLocationPropertiesResponseAuthentication | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<types.outputs.extendedlocation.v20210815.IdentityResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<types.outputs.extendedlocation.v20210815.SystemDataResponse>;
    /**
     * Resource tags.
     */
...
export interface CustomLocationArgs {
     ...
     * This is optional input that contains the authentication that should be used to generate the namespace.
     */
    authentication?: pulumi.Input<types.inputs.extendedlocation.v20210815.CustomLocationPropertiesAuthenticationArgs>;
    /**
     * Contains the reference to the add-on that contains charts to deploy CRDs and operators.
     */
     ...
     * Type of host the Custom Locations is referencing (Kubernetes, etc...).
     */
    hostType?: pulumi.Input<string | types.enums.v20210815.HostType>;
    /**
     * Identity for the resource.
     */
    identity?: pulumi.Input<types.inputs.extendedlocation.v20210815.IdentityArgs>;
    /**
     * The geo-location where the resource lives
     */

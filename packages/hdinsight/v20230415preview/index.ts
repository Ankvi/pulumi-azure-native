...
// Export enums:
export * from "../types/enums/v20230415preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:hdinsight/v20230415preview:Application":
                return new Application(name, <any>undefined, { urn })
            case "azure-native:hdinsight/v20230415preview:Cluster":
                return new Cluster(name, <any>undefined, { urn })
            case "azure-native:hdinsight/v20230415preview:PrivateEndpointConnection":
...
pulumi.runtime.registerResourceModule("azure-native", "hdinsight/v20230415preview", _module)

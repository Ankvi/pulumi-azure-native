...
export class ClusterPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:hdinsight:ClusterPool';
     ...
     */
    declare public /*out*/ readonly aksClusterProfile: pulumi.Output<types.outputs.ClusterPoolResourcePropertiesResponseAksClusterProfile>;
    /**
     ...
     */
    declare public /*out*/ readonly aksManagedResourceGroupName: pulumi.Output<string>;
    /**
     ...
     */
    declare public readonly clusterPoolProfile: pulumi.Output<types.outputs.ClusterPoolResourcePropertiesResponseClusterPoolProfile | undefined>;
    /**
     * CLuster pool compute profile.
     */
    declare public readonly computeProfile: pulumi.Output<types.outputs.ClusterPoolResourcePropertiesResponseComputeProfile>;
    /**
     ...
     */
    declare public readonly logAnalyticsProfile: pulumi.Output<types.outputs.ClusterPoolResourcePropertiesResponseLogAnalyticsProfile | undefined>;
    /**
     ...
     */
    declare public readonly networkProfile: pulumi.Output<types.outputs.ClusterPoolResourcePropertiesResponseNetworkProfile | undefined>;
    /**
    ...
    constructor(name: string, args: ClusterPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["networkProfile"] = args ? (args.networkProfile ? pulumi.output(args.networkProfile).apply(types.inputs.clusterPoolResourcePropertiesNetworkProfileArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hdinsight/v20230601preview:ClusterPool" }, { type: "azure-native:hdinsight/v20231101preview:ClusterPool" }, { type: "azure-native:hdinsight/v20240501preview:ClusterPool" }] };
...
export interface ClusterPoolArgs {
     ...
     * CLuster pool profile.
     */
    clusterPoolProfile?: pulumi.Input<types.inputs.ClusterPoolResourcePropertiesClusterPoolProfileArgs>;
    /**
     * CLuster pool compute profile.
     */
    computeProfile: pulumi.Input<types.inputs.ClusterPoolResourcePropertiesComputeProfileArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Cluster pool log analytics profile to enable OMS agent for AKS cluster.
     */
    logAnalyticsProfile?: pulumi.Input<types.inputs.ClusterPoolResourcePropertiesLogAnalyticsProfileArgs>;
    /**
     * A resource group created by RP, to hold the resources created by RP on-behalf of customers. It will also be used to generate aksManagedResourceGroupName by pattern: MC_{managedResourceGroupName}_{clusterPoolName}_{region}. Please make sure it meets resource group name restriction.
     */
     ...
     * Cluster pool network profile.
     */
    networkProfile?: pulumi.Input<types.inputs.ClusterPoolResourcePropertiesNetworkProfileArgs>;
    /**

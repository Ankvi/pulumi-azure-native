...
export class ClusterPool extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly aksClusterProfile!: pulumi.Output<types.outputs.hdinsight.ClusterPoolResourcePropertiesResponseAksClusterProfile>;
    /**
     ...
     */
    public readonly clusterPoolProfile!: pulumi.Output<types.outputs.hdinsight.ClusterPoolResourcePropertiesResponseClusterPoolProfile | undefined>;
    /**
     * CLuster pool compute profile.
     */
    public readonly computeProfile!: pulumi.Output<types.outputs.hdinsight.ClusterPoolResourcePropertiesResponseComputeProfile>;
    /**
     ...
     */
    public readonly logAnalyticsProfile!: pulumi.Output<types.outputs.hdinsight.ClusterPoolResourcePropertiesResponseLogAnalyticsProfile | undefined>;
    /**
     ...
     */
    public readonly networkProfile!: pulumi.Output<types.outputs.hdinsight.ClusterPoolResourcePropertiesResponseNetworkProfile | undefined>;
    /**
...
export interface ClusterPoolArgs {
     ...
     * CLuster pool profile.
     */
    clusterPoolProfile?: pulumi.Input<types.inputs.hdinsight.ClusterPoolResourcePropertiesClusterPoolProfileArgs>;
    /**
     * CLuster pool compute profile.
     */
    computeProfile: pulumi.Input<types.inputs.hdinsight.ClusterPoolResourcePropertiesComputeProfileArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Cluster pool log analytics profile to enable OMS agent for AKS cluster.
     */
    logAnalyticsProfile?: pulumi.Input<types.inputs.hdinsight.ClusterPoolResourcePropertiesLogAnalyticsProfileArgs>;
    /**
     * A resource group created by RP, to hold the resources created by RP on-behalf of customers. It will also be used to generate aksManagedResourceGroupName by pattern: MC_{managedResourceGroupName}_{clusterPoolName}_{region}. Please make sure it meets resource group name restriction.
     */
     ...
     * Cluster pool network profile.
     */
    networkProfile?: pulumi.Input<types.inputs.hdinsight.ClusterPoolResourcePropertiesNetworkProfileArgs>;
    /**

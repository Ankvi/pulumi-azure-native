...
export class ClusterPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:hdinsight/v20240501:ClusterPool';
    ...
    constructor(name: string, args: ClusterPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hdinsight:ClusterPool" }, { type: "azure-native:hdinsight/v20230601preview:ClusterPool" }, { type: "azure-native:hdinsight/v20231101preview:ClusterPool" }] };

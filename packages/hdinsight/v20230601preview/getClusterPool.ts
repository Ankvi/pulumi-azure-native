...
export function getClusterPool(args: GetClusterPoolArgs, opts?: pulumi.InvokeOptions): Promise<GetClusterPoolResult> {
    ...
    return pulumi.runtime.invoke("azure-native:hdinsight/v20230601preview:getClusterPool", {
...
export interface GetClusterPoolResult {
     ...
     */
    readonly aksClusterProfile: types.outputs.hdinsight.v20230601preview.ClusterPoolResourcePropertiesResponseAksClusterProfile;
    /**
     ...
     */
    readonly clusterPoolProfile?: types.outputs.hdinsight.v20230601preview.ClusterPoolResourcePropertiesResponseClusterPoolProfile;
    /**
     * CLuster pool compute profile.
     */
    readonly computeProfile: types.outputs.hdinsight.v20230601preview.ClusterPoolResourcePropertiesResponseComputeProfile;
    /**
     ...
     */
    readonly logAnalyticsProfile?: types.outputs.hdinsight.v20230601preview.ClusterPoolResourcePropertiesResponseLogAnalyticsProfile;
    /**
     ...
     */
    readonly networkProfile?: types.outputs.hdinsight.v20230601preview.ClusterPoolResourcePropertiesResponseNetworkProfile;
    /**
     ...
     */
    readonly systemData: types.outputs.hdinsight.v20230601preview.SystemDataResponse;
    /**
     * Resource tags.
     */

...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:hdinsight/v20231101preview:Cluster":
                return new Cluster(name, <any>undefined, { urn })
            case "azure-native:hdinsight/v20231101preview:ClusterPool":
...
pulumi.runtime.registerResourceModule("azure-native", "hdinsight/v20231101preview", _module)
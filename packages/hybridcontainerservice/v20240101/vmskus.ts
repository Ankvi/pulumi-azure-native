...
export class VMSkus extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:hybridcontainerservice/v20240101:VMSkus';
    ...
    constructor(name: string, args: VMSkusArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hybridcontainerservice/v20231115preview:VMSkus" }] };

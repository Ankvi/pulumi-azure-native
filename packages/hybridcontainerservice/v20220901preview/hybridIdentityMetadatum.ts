...
export class HybridIdentityMetadatum extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:hybridcontainerservice/v20220901preview:HybridIdentityMetadatum';
    ...
    constructor(name: string, args: HybridIdentityMetadatumArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hybridcontainerservice:HybridIdentityMetadatum" }, { type: "azure-native:hybridcontainerservice/v20220501preview:HybridIdentityMetadatum" }] };

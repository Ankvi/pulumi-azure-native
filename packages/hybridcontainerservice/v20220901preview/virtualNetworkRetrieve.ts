...
export class VirtualNetworkRetrieve extends pulumi.CustomResource {
    ...
    constructor(name: string, args: VirtualNetworkRetrieveArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hybridcontainerservice/v20220901preview:virtualNetworkRetrieve" }, { type: "azure-native:hybridcontainerservice:VirtualNetworkRetrieve" }, { type: "azure-native:hybridcontainerservice:virtualNetworkRetrieve" }, { type: "azure-native:hybridcontainerservice/v20220501preview:VirtualNetworkRetrieve" }, { type: "azure-native:hybridcontainerservice/v20220501preview:virtualNetworkRetrieve" }] };

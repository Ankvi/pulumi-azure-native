...
export class StorageSpaceRetrieve extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:hybridcontainerservice/v20220901preview:StorageSpaceRetrieve';
    ...
    constructor(name: string, args: StorageSpaceRetrieveArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hybridcontainerservice/v20220901preview:storageSpaceRetrieve" }, { type: "azure-native:hybridcontainerservice:StorageSpaceRetrieve" }, { type: "azure-native:hybridcontainerservice:storageSpaceRetrieve" }, { type: "azure-native:hybridcontainerservice/v20220501preview:StorageSpaceRetrieve" }, { type: "azure-native:hybridcontainerservice/v20220501preview:storageSpaceRetrieve" }] };

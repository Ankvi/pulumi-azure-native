...
export class AgentPool extends pulumi.CustomResource {
     ...
     */
    declare public readonly cloudProviderProfile: pulumi.Output<types.outputs.CloudProviderProfileResponse | undefined>;
    /**
     * Count - Number of agents to host docker containers. Allowed values must be in the range of 1 to 100 (inclusive). The default value is 1.
     */
    declare public readonly count: pulumi.Output<number | undefined>;
    declare public readonly extendedLocation: pulumi.Output<types.outputs.AgentPoolResponseExtendedLocation | undefined>;
    /**
     ...
     */
    declare public readonly status: pulumi.Output<types.outputs.AgentPoolProvisioningStatusResponseStatus | undefined>;
    /**

...
export namespace hybridcontainerservice {
    ...
    export namespace v20220501preview {
         ...
         */
        export interface AgentPoolProvisioningStatusResponseProvisioningStatus {
            error?: v20220501preview.AgentPoolProvisioningStatusResponseError;
            operationId?: string;
            /**
             * Phase represents the current phase of cluster actuation. E.g. Pending, Running, Terminating, Failed etc.
             */
        ...
        export interface AgentPoolProvisioningStatusResponseStatus {
             ...
             * Contains Provisioning errors
             */
            provisioningStatus?: v20220501preview.AgentPoolProvisioningStatusResponseProvisioningStatus;
            /**
             * Total number of ready machines targeted by this deployment.
             */
            readyReplicas?: number;
        ...
        export interface CloudProviderProfileResponse {
             ...
             * InfraNetworkProfile - List of infra network profiles for the provisioned cluster
             */
            infraNetworkProfile?: v20220501preview.CloudProviderProfileResponseInfraNetworkProfile;
            /**
             * InfraStorageProfile - List of infra storage profiles for the provisioned cluster
             */
            infraStorageProfile?: v20220501preview.CloudProviderProfileResponseInfraStorageProfile;
        }
        ...
        export interface ControlPlaneProfileResponse {
             ...
             * The underlying cloud infra provider properties.
             */
            cloudProviderProfile?: v20220501preview.CloudProviderProfileResponse;
            /**
             * API server endpoint for the control plane
             */
            controlPlaneEndpoint?: v20220501preview.ControlPlaneEndpointProfileResponseControlPlaneEndpoint;
            /**
             * Count - Number of agents to host docker containers. Allowed values must be in the range of 1 to 100 (inclusive). The default value is 1.
             */
            count?: number;
             ...
             * Profile for Linux VMs in the container service cluster.
             */
            linuxProfile?: v20220501preview.LinuxProfilePropertiesResponse;
            /**
             * The maximum number of nodes for auto-scaling
             */
            maxCount?: number;
        ...
        export interface LinuxProfilePropertiesResponse {
             ...
             * SSH - SSH configuration for Linux-based VMs running on Azure.
             */
            ssh?: v20220501preview.LinuxProfilePropertiesResponseSsh;
        }
        ...
        export interface LinuxProfilePropertiesResponseSsh {
             ...
             * PublicKeys - The list of SSH public keys used to authenticate with Linux-based VMs. Only expect one key specified.
             */
            publicKeys?: v20220501preview.LinuxProfilePropertiesResponsePublicKeys[];
        }
        ...
        export interface NetworkProfileResponse {
             ...
             * LoadBalancerProfile - Profile of the cluster load balancer.
             */
            loadBalancerProfile?: v20220501preview.LoadBalancerProfileResponse;
            /**
             * LoadBalancerSku - The load balancer sku for the provisioned cluster. Possible values: 'unstacked-haproxy', 'stacked-kube-vip', 'stacked-metallb', 'unmanaged'. The default is 'unmanaged'.
             */
            loadBalancerSku?: string;
        ...
        export function networkProfileResponseProvideDefaults(val: NetworkProfileResponse): NetworkProfileResponse {
            return {
                ...val,
                loadBalancerProfile: (val.loadBalancerProfile ? v20220501preview.loadBalancerProfileResponseProvideDefaults(val.loadBalancerProfile) : undefined),
                loadBalancerSku: (val.loadBalancerSku) ?? "unmanaged",
                networkPolicy: (val.networkPolicy) ?? "calico",
            };
        }
        ...
        export interface ProvisionedClustersCommonPropertiesResponseFeatures {
             ...
             * Arc agentry configuration for the provisioned cluster.
             */
            arcAgentProfile?: v20220501preview.ArcAgentProfileResponse;
        }
        /**
         * provisionedClustersCommonPropertiesResponseFeaturesProvideDefaults sets the appropriate defaults for ProvisionedClustersCommonPropertiesResponseFeatures
         */
        export function provisionedClustersCommonPropertiesResponseFeaturesProvideDefaults(val: ProvisionedClustersCommonPropertiesResponseFeatures): ProvisionedClustersCommonPropertiesResponseFeatures {
            return {
                ...val,
                arcAgentProfile: (val.arcAgentProfile ? v20220501preview.arcAgentProfileResponseProvideDefaults(val.arcAgentProfile) : undefined),
            };
        }
        ...
        export interface ProvisionedClustersCommonPropertiesResponseFeaturesStatus {
             ...
             * Defines the observed Arc Agent status that is resourceSynced back to the ARM resource.
             */
            arcAgentStatus?: v20220501preview.ArcAgentStatusResponse;
        }
         ...
         */
        export interface ProvisionedClustersCommonPropertiesResponseProvisioningStatus {
            error?: v20220501preview.ProvisionedClustersCommonPropertiesResponseError;
            operationId?: string;
            /**
             * Phase represents the current phase of cluster actuation. E.g. Pending, Running, Terminating, Failed etc.
             */
        ...
        export interface ProvisionedClustersCommonPropertiesResponseStatus {
             ...
             * AddonStatus - Status of Addons
             */
            addonStatus?: {[key: string]: v20220501preview.AddonStatusResponse};
            /**
             * ErrorMessage - Error messages during creation of cluster
             */
            errorMessage?: string;
             ...
             * Additional features status like Arc Agent Onboarding.
             */
            featuresStatus?: v20220501preview.ProvisionedClustersCommonPropertiesResponseFeaturesStatus;
            /**
             * Contains Provisioning errors
             */
            provisioningStatus?: v20220501preview.ProvisionedClustersCommonPropertiesResponseProvisioningStatus;
        }
        ...
        export interface ProvisionedClustersResponsePropertiesResponse {
             ...
             * AAD profile for the provisioned cluster.
             */
            aadProfile?: v20220501preview.AADProfileResponseResponse;
            /**
             * AddonProfiles - Profile of managed cluster add-on.
             */
            addonProfiles?: {[key: string]: v20220501preview.AddonProfilesResponse};
            /**
             * The agent pools of the cluster.
             */
            agentPoolProfiles?: v20220501preview.NamedAgentPoolProfileResponse[];
            /**
             * The underlying cloud infra provider properties.
             */
            cloudProviderProfile?: v20220501preview.CloudProviderProfileResponse;
             ...
             * ControlPlane - ControlPlane Configuration
             */
            controlPlane?: v20220501preview.ControlPlaneProfileResponse;
            /**
             * EnableRBAC - Whether to enable Kubernetes Role-Based Access Control.
             */
            enableRbac?: boolean;
             ...
             * Additional features specs like Arc Agent Onboarding.
             */
            features?: v20220501preview.ProvisionedClustersCommonPropertiesResponseFeatures;
            /**
             * HttpProxyConfig - Configurations for provisioning the cluster with HTTP proxy servers.
             */
            httpProxyConfig?: v20220501preview.HttpProxyConfigResponseResponse;
            /**
             * KubernetesVersion - Version of Kubernetes specified when creating the managed cluster.
             */
            kubernetesVersion?: string;
             ...
             * NetworkProfile - Profile of network configuration.
             */
            networkProfile?: v20220501preview.NetworkProfileResponse;
            /**
             * NodeResourceGroup - Name of the resource group containing agent pool nodes.
             */
            nodeResourceGroup?: string;
             ...
             * HybridAKSClusterStatus defines the observed state of HybridAKSCluster
             */
            status: v20220501preview.ProvisionedClustersCommonPropertiesResponseStatus;
            /**
             * WindowsProfile - Profile for Windows VMs in the Provisioned Cluster.
             */
            windowsProfile?: v20220501preview.WindowsProfileResponseResponse;
        }
        /**
         * provisionedClustersResponsePropertiesResponseProvideDefaults sets the appropriate defaults for ProvisionedClustersResponsePropertiesResponse
         */
        export function provisionedClustersResponsePropertiesResponseProvideDefaults(val: ProvisionedClustersResponsePropertiesResponse): ProvisionedClustersResponsePropertiesResponse {
            return {
                ...val,
                controlPlane: (val.controlPlane ? v20220501preview.controlPlaneProfileResponseProvideDefaults(val.controlPlane) : undefined),
                features: (val.features ? v20220501preview.provisionedClustersCommonPropertiesResponseFeaturesProvideDefaults(val.features) : undefined),
                networkProfile: (val.networkProfile ? v20220501preview.networkProfileResponseProvideDefaults(val.networkProfile) : undefined),
            };
        }
    ...
    export namespace v20220901preview {
         ...
         */
        export interface AgentPoolProvisioningStatusResponseProvisioningStatus {
            error?: v20220901preview.AgentPoolProvisioningStatusResponseError;
            operationId?: string;
            /**
             * Phase represents the current phase of cluster actuation. E.g. Pending, Running, Terminating, Failed etc.
             */
        ...
        export interface AgentPoolProvisioningStatusResponseStatus {
             ...
             * Contains Provisioning errors
             */
            provisioningStatus?: v20220901preview.AgentPoolProvisioningStatusResponseProvisioningStatus;
            /**
             * Total number of ready machines targeted by this deployment.
             */
            readyReplicas?: number;
        ...
        export interface CloudProviderProfileResponse {
             ...
             * InfraNetworkProfile - List of infra network profiles for the provisioned cluster
             */
            infraNetworkProfile?: v20220901preview.CloudProviderProfileResponseInfraNetworkProfile;
            /**
             * InfraStorageProfile - List of infra storage profiles for the provisioned cluster
             */
            infraStorageProfile?: v20220901preview.CloudProviderProfileResponseInfraStorageProfile;
        }
        ...
        export interface ControlPlaneProfileResponse {
             ...
             * The underlying cloud infra provider properties.
             */
            cloudProviderProfile?: v20220901preview.CloudProviderProfileResponse;
            /**
             * API server endpoint for the control plane
             */
            controlPlaneEndpoint?: v20220901preview.ControlPlaneEndpointProfileResponseControlPlaneEndpoint;
            /**
             * Count - Number of agents to host docker containers. Allowed values must be in the range of 1 to 100 (inclusive). The default value is 1.
             */
            count?: number;
             ...
             * Profile for Linux VMs in the container service cluster.
             */
            linuxProfile?: v20220901preview.LinuxProfilePropertiesResponse;
            /**
             * The maximum number of nodes for auto-scaling
             */
            maxCount?: number;
        ...
        export interface LinuxProfilePropertiesResponse {
             ...
             * SSH - SSH configuration for Linux-based VMs running on Azure.
             */
            ssh?: v20220901preview.LinuxProfilePropertiesResponseSsh;
        }
        ...
        export interface LinuxProfilePropertiesResponseSsh {
             ...
             * PublicKeys - The list of SSH public keys used to authenticate with Linux-based VMs. Only expect one key specified.
             */
            publicKeys?: v20220901preview.LinuxProfilePropertiesResponsePublicKeys[];
        }
        ...
        export interface NetworkProfileResponse {
             ...
             * LoadBalancerProfile - Profile of the cluster load balancer.
             */
            loadBalancerProfile?: v20220901preview.LoadBalancerProfileResponse;
            /**
             * LoadBalancerSku - The load balancer sku for the provisioned cluster. Possible values: 'unstacked-haproxy', 'stacked-kube-vip', 'stacked-metallb', 'unmanaged'. The default is 'unmanaged'.
             */
            loadBalancerSku?: string;
        ...
        export function networkProfileResponseProvideDefaults(val: NetworkProfileResponse): NetworkProfileResponse {
            return {
                ...val,
                loadBalancerProfile: (val.loadBalancerProfile ? v20220901preview.loadBalancerProfileResponseProvideDefaults(val.loadBalancerProfile) : undefined),
                loadBalancerSku: (val.loadBalancerSku) ?? "unmanaged",
                networkPolicy: (val.networkPolicy) ?? "calico",
            };
        }
        ...
        export interface ProvisionedClustersCommonPropertiesResponseFeatures {
             ...
             * Arc agentry configuration for the provisioned cluster.
             */
            arcAgentProfile?: v20220901preview.ArcAgentProfileResponse;
        }
        /**
         * provisionedClustersCommonPropertiesResponseFeaturesProvideDefaults sets the appropriate defaults for ProvisionedClustersCommonPropertiesResponseFeatures
         */
        export function provisionedClustersCommonPropertiesResponseFeaturesProvideDefaults(val: ProvisionedClustersCommonPropertiesResponseFeatures): ProvisionedClustersCommonPropertiesResponseFeatures {
            return {
                ...val,
                arcAgentProfile: (val.arcAgentProfile ? v20220901preview.arcAgentProfileResponseProvideDefaults(val.arcAgentProfile) : undefined),
            };
        }
        ...
        export interface ProvisionedClustersCommonPropertiesResponseFeaturesStatus {
             ...
             * Defines the observed Arc Agent status that is resourceSynced back to the ARM resource.
             */
            arcAgentStatus?: v20220901preview.ArcAgentStatusResponse;
        }
         ...
         */
        export interface ProvisionedClustersCommonPropertiesResponseProvisioningStatus {
            error?: v20220901preview.ProvisionedClustersCommonPropertiesResponseError;
            operationId?: string;
            /**
             * Phase represents the current phase of cluster actuation. E.g. Pending, Running, Terminating, Failed etc.
             */
        ...
        export interface ProvisionedClustersCommonPropertiesResponseStatus {
             ...
             * AddonStatus - Status of Addons
             */
            addonStatus?: {[key: string]: v20220901preview.AddonStatusResponse};
            /**
             * ErrorMessage - Error messages during creation of cluster
             */
            errorMessage?: string;
             ...
             * Additional features status like Arc Agent Onboarding.
             */
            featuresStatus?: v20220901preview.ProvisionedClustersCommonPropertiesResponseFeaturesStatus;
            /**
             * Contains Provisioning errors
             */
            provisioningStatus?: v20220901preview.ProvisionedClustersCommonPropertiesResponseProvisioningStatus;
        }
        ...
        export interface ProvisionedClustersResponsePropertiesResponse {
             ...
             * AAD profile for the provisioned cluster.
             */
            aadProfile?: v20220901preview.AADProfileResponseResponse;
            /**
             * AddonProfiles - Profile of managed cluster add-on.
             */
            addonProfiles?: {[key: string]: v20220901preview.AddonProfilesResponse};
            /**
             * The agent pools of the cluster.
             */
            agentPoolProfiles?: v20220901preview.NamedAgentPoolProfileResponse[];
            /**
             * The underlying cloud infra provider properties.
             */
            cloudProviderProfile?: v20220901preview.CloudProviderProfileResponse;
             ...
             * ControlPlane - ControlPlane Configuration
             */
            controlPlane?: v20220901preview.ControlPlaneProfileResponse;
            /**
             * EnableRBAC - Whether to enable Kubernetes Role-Based Access Control.
             */
            enableRbac?: boolean;
             ...
             * Additional features specs like Arc Agent Onboarding.
             */
            features?: v20220901preview.ProvisionedClustersCommonPropertiesResponseFeatures;
            /**
             * HttpProxyConfig - Configurations for provisioning the cluster with HTTP proxy servers.
             */
            httpProxyConfig?: v20220901preview.HttpProxyConfigResponseResponse;
            /**
             * KubernetesVersion - Version of Kubernetes specified when creating the managed cluster.
             */
            kubernetesVersion?: string;
             ...
             * NetworkProfile - Profile of network configuration.
             */
            networkProfile?: v20220901preview.NetworkProfileResponse;
            /**
             * NodeResourceGroup - Name of the resource group containing agent pool nodes.
             */
            nodeResourceGroup?: string;
             ...
             * HybridAKSClusterStatus defines the observed state of HybridAKSCluster
             */
            status: v20220901preview.ProvisionedClustersCommonPropertiesResponseStatus;
            /**
             * WindowsProfile - Profile for Windows VMs in the Provisioned Cluster.
             */
            windowsProfile?: v20220901preview.WindowsProfileResponseResponse;
        }
        /**
         * provisionedClustersResponsePropertiesResponseProvideDefaults sets the appropriate defaults for ProvisionedClustersResponsePropertiesResponse
         */
        export function provisionedClustersResponsePropertiesResponseProvideDefaults(val: ProvisionedClustersResponsePropertiesResponse): ProvisionedClustersResponsePropertiesResponse {
            return {
                ...val,
                controlPlane: (val.controlPlane ? v20220901preview.controlPlaneProfileResponseProvideDefaults(val.controlPlane) : undefined),
                features: (val.features ? v20220901preview.provisionedClustersCommonPropertiesResponseFeaturesProvideDefaults(val.features) : undefined),
                networkProfile: (val.networkProfile ? v20220901preview.networkProfileResponseProvideDefaults(val.networkProfile) : undefined),
            };
        }
         ...
         */
        export interface StorageSpacesPropertiesResponse {
            hciStorageProfile?: v20220901preview.StorageSpacesPropertiesResponseHciStorageProfile;
            provisioningState: string;
            /**
             * HybridAKSStorageStatus defines the observed state of HybridAKSStorage
             */
            status?: v20220901preview.StorageSpacesPropertiesResponseStatus;
            vmwareStorageProfile?: v20220901preview.StorageSpacesPropertiesResponseVmwareStorageProfile;
        }
         ...
         */
        export interface StorageSpacesPropertiesResponseProvisioningStatus {
            error?: v20220901preview.StorageSpacesPropertiesResponseError;
            operationId?: string;
            /**
             * Phase represents the current phase of cluster actuation. E.g. Pending, Running, Terminating, Failed etc.
             */
        ...
        export interface StorageSpacesPropertiesResponseStatus {
             ...
             * Contains Provisioning errors
             */
            provisioningStatus?: v20220901preview.StorageSpacesPropertiesResponseProvisioningStatus;
        }
        ...
        export interface VirtualNetworksPropertiesResponse {
             ...
             */
            gateway?: string;
            infraVnetProfile?: v20220901preview.VirtualNetworksPropertiesResponseInfraVnetProfile;
            /**
             * IP Address Prefix of the network
             */
            ipAddressPrefix?: string;
             ...
             * HybridAKSNetworkStatus defines the observed state of HybridAKSNetwork
             */
            status: v20220901preview.VirtualNetworksPropertiesResponseStatus;
            /**
             * Virtual IP Pool for Kubernetes
             */
            vipPool?: v20220901preview.VirtualNetworksPropertiesResponseVipPool[];
            /**
             * VLAN Id used by the network
             */
            vlanID: string;
             ...
             * IP Pool for Virtual Machines
             */
            vmipPool?: v20220901preview.VirtualNetworksPropertiesResponseVmipPool[];
        }
        ...
        export interface VirtualNetworksPropertiesResponseInfraVnetProfile {
             ...
             * Infra network profile for HCI platform
             */
            hci?: v20220901preview.VirtualNetworksPropertiesResponseHci;
            /**
             * Infra network profile for the NetworkCloud platform
             */
            networkCloud?: v20220901preview.VirtualNetworksPropertiesResponseNetworkCloud;
            /**
             * Infra network profile for VMware platform
             */
            vmware?: v20220901preview.VirtualNetworksPropertiesResponseVmware;
        }
         ...
         */
        export interface VirtualNetworksPropertiesResponseProvisioningStatus {
            error?: v20220901preview.VirtualNetworksPropertiesResponseError;
            operationId?: string;
            /**
             * Phase represents the current phase of cluster actuation. E.g. Pending, Running, Terminating, Failed etc.
             */
        ...
        export interface VirtualNetworksPropertiesResponseStatus {
             ...
             * Contains Provisioning errors
             */
            provisioningStatus?: v20220901preview.VirtualNetworksPropertiesResponseProvisioningStatus;
        }

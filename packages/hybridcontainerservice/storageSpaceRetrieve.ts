...
export class StorageSpaceRetrieve extends pulumi.CustomResource {
    ...
    declare public readonly extendedLocation: pulumi.Output<types.outputs.StorageSpacesResponseExtendedLocation | undefined>;
    /**
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.StorageSpacesPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: StorageSpaceRetrieveArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["storageSpacesName"] = args?.storageSpacesName;

...
export class ProvisionedClusterInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:hybridcontainerservice/v20231115preview:ProvisionedClusterInstance';
    ...
    constructor(name: string, args: ProvisionedClusterInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hybridcontainerservice/v20231115preview:provisionedClusterInstance" }, { type: "azure-native:hybridcontainerservice/v20240101:ProvisionedClusterInstance" }, { type: "azure-native:hybridcontainerservice/v20240101:provisionedClusterInstance" }] };

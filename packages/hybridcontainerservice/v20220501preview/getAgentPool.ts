...
export interface GetAgentPoolResult {
     ...
     */
    readonly cloudProviderProfile?: types.outputs.hybridcontainerservice.v20220501preview.CloudProviderProfileResponse;
    /**
     * Count - Number of agents to host docker containers. Allowed values must be in the range of 1 to 100 (inclusive). The default value is 1.
     */
    readonly count?: number;
    readonly extendedLocation?: types.outputs.hybridcontainerservice.v20220501preview.AgentPoolResponseExtendedLocation;
    /**
     * Resource Id
     */
    readonly id: string;
     ...
     */
    readonly status?: types.outputs.hybridcontainerservice.v20220501preview.AgentPoolProvisioningStatusResponseStatus;
    /**

...
export class Map extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:dependencymap:Map';
    ...
    constructor(name: string, args: MapArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:dependencymap/v20250131preview:Map" }, { type: "azure-native:dependencymap/v20250501preview:Map" }, { type: "azure-native:dependencymap/v20250701preview:Map" }] };

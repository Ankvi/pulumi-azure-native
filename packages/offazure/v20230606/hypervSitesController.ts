...
export class HypervSitesController extends pulumi.CustomResource {
    ...
    constructor(name: string, args: HypervSitesControllerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:offazure:HypervSitesController" }, { type: "azure-native:offazure/v20200101:HypervSitesController" }, { type: "azure-native:offazure/v20200707:HypervSitesController" }] };

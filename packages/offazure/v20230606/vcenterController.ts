...
export class VcenterController extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:offazure/v20230606:VcenterController';
    ...
    constructor(name: string, args: VcenterControllerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:offazure:VcenterController" }, { type: "azure-native:offazure/v20200101:VcenterController" }, { type: "azure-native:offazure/v20200707:VcenterController" }, { type: "azure-native:offazure/v20231001preview:VcenterController" }] };

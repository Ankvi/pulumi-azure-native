...
export class VcenterController extends pulumi.CustomResource {
    ...
    constructor(name: string, args: VcenterControllerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:offazure:VcenterController" }, { type: "azure-native:offazure/v20200101:VcenterController" }, { type: "azure-native:offazure/v20200707:VcenterController" }] };

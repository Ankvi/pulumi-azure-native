...
export class WebAppSitesController extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:offazure/v20230606:WebAppSitesController';
    ...
    constructor(name: string, args: WebAppSitesControllerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:offazure:WebAppSitesController" }] };
...
export interface WebAppSitesControllerArgs {
     ...
     * Gets or sets the discovery scenario.
     */
    discoveryScenario?: pulumi.Input<string | types.enums.v20230606.WebAppSitePropertiesDiscoveryScenario>;
    /**

...
export function getWebAppSitesController(args: GetWebAppSitesControllerArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppSitesControllerResult> {
    ...
    return pulumi.runtime.invoke("azure-native:offazure/v20230606:getWebAppSitesController", {
...
export interface GetWebAppSitesControllerResult {
     ...
     * to the appliance.
     */
    readonly siteAppliancePropertiesCollection?: types.outputs.offazure.v20230606.SiteAppliancePropertiesResponse[];
    /**

...
export class ServerSitesController extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:offazure/v20230606:ServerSitesController';
    ...
    constructor(name: string, args: ServerSitesControllerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:offazure:ServerSitesController" }, { type: "azure-native:offazure/v20231001preview:ServerSitesController" }] };

...
export class Site extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:offazure/v20200101:Site" }, { type: "azure-native:offazure/v20200707:Site" }, { type: "azure-native:offazure/v20230606:Site" }, { type: "azure-native:offazure/v20231001preview:Site" }] };

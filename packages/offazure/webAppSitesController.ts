...
export class WebAppSitesController extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WebAppSitesControllerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:offazure/v20230606:WebAppSitesController" }, { type: "azure-native:offazure/v20231001preview:WebAppSitesController" }, { type: "azure-native:offazure/v20240501preview:WebAppSitesController" }, { type: "azure-native:offazure/v20240701preview:WebAppSitesController" }] };

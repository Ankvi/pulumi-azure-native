...
export class PrivateEndpointConnectionController extends pulumi.CustomResource {
     ...
     * private endpoints
     */
    declare public /*out*/ readonly privateEndpoint: pulumi.Output<types.outputs.ResourceIdResponse>;
    /**

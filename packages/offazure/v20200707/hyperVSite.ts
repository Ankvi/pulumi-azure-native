...
export class HyperVSite extends pulumi.CustomResource {
    ...
    constructor(name: string, args: HyperVSiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:offazure:HyperVSite" }, { type: "azure-native:offazure/v20200101:HyperVSite" }, { type: "azure-native:offazure/v20230606:HyperVSite" }] };

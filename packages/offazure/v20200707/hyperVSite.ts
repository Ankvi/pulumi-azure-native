...
export class HyperVSite extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:offazure/v20200707:HyperVSite';
    ...
    constructor(name: string, args: HyperVSiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:offazure:HyperVSite" }, { type: "azure-native:offazure/v20200101:HyperVSite" }, { type: "azure-native:offazure/v20230606:HyperVSite" }, { type: "azure-native:offazure/v20231001preview:HyperVSite" }] };

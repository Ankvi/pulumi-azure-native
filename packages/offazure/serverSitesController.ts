...
export class ServerSitesController extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ServerSitesControllerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:offazure/v20230606:ServerSitesController" }, { type: "azure-native:offazure/v20231001preview:ServerSitesController" }, { type: "azure-native:offazure/v20240501preview:ServerSitesController" }, { type: "azure-native:offazure/v20240701preview:ServerSitesController" }] };

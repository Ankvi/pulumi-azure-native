...
export class SqlDiscoverySiteDataSourceController extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:offazure/v20231001preview:SqlDiscoverySiteDataSourceController';
    ...
    constructor(name: string, args: SqlDiscoverySiteDataSourceControllerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:offazure:SqlDiscoverySiteDataSourceController" }, { type: "azure-native:offazure/v20230606:SqlDiscoverySiteDataSourceController" }] };

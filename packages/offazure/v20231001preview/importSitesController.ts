...
export class ImportSitesController extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:offazure/v20231001preview:ImportSitesController';
    ...
    constructor(name: string, args: ImportSitesControllerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:offazure:ImportSitesController" }, { type: "azure-native:offazure/v20230606:ImportSitesController" }] };

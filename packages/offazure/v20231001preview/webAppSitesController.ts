...
export class WebAppSitesController extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:offazure/v20231001preview:WebAppSitesController';
    ...
    constructor(name: string, args: WebAppSitesControllerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:offazure:WebAppSitesController" }, { type: "azure-native:offazure/v20230606:WebAppSitesController" }] };

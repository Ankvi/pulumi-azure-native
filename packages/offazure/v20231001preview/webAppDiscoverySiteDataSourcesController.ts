...
export class WebAppDiscoverySiteDataSourcesController extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:offazure/v20231001preview:WebAppDiscoverySiteDataSourcesController';
    ...
    constructor(name: string, args: WebAppDiscoverySiteDataSourcesControllerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:offazure:WebAppDiscoverySiteDataSourcesController" }, { type: "azure-native:offazure/v20230606:WebAppDiscoverySiteDataSourcesController" }] };

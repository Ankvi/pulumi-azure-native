...
export class HypervClusterControllerCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:offazure/v20231001preview:HypervClusterControllerCluster';
    ...
    constructor(name: string, args: HypervClusterControllerClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:offazure:HypervClusterControllerCluster" }, { type: "azure-native:offazure/v20230606:HypervClusterControllerCluster" }] };

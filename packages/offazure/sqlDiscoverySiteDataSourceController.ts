...
export class SqlDiscoverySiteDataSourceController extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SqlDiscoverySiteDataSourceControllerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:offazure/v20230606:SqlDiscoverySiteDataSourceController" }, { type: "azure-native:offazure/v20231001preview:SqlDiscoverySiteDataSourceController" }, { type: "azure-native:offazure/v20240501preview:SqlDiscoverySiteDataSourceController" }, { type: "azure-native:offazure/v20240701preview:SqlDiscoverySiteDataSourceController" }] };

...
export class WebAppDiscoverySiteDataSourcesController extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WebAppDiscoverySiteDataSourcesControllerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:offazure/v20230606:WebAppDiscoverySiteDataSourcesController" }, { type: "azure-native:offazure/v20231001preview:WebAppDiscoverySiteDataSourcesController" }, { type: "azure-native:offazure/v20240501preview:WebAppDiscoverySiteDataSourcesController" }, { type: "azure-native:offazure/v20240701preview:WebAppDiscoverySiteDataSourcesController" }] };

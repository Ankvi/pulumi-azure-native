...
export class Bot extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:botservice:Bot" }, { type: "azure-native:botservice/v20171201:Bot" }, { type: "azure-native:botservice/v20180712:Bot" }, { type: "azure-native:botservice/v20200602:Bot" }, { type: "azure-native:botservice/v20210301:Bot" }, { type: "azure-native:botservice/v20210501preview:Bot" }, { type: "azure-native:botservice/v20220615preview:Bot" }] };

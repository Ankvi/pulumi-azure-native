...
// Export enums:
export * from "../types/enums/v20220915";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:botservice/v20220915:Bot":
                return new Bot(name, <any>undefined, { urn })
            case "azure-native:botservice/v20220915:BotConnection":
                return new BotConnection(name, <any>undefined, { urn })
            case "azure-native:botservice/v20220915:Channel":
                return new Channel(name, <any>undefined, { urn })
            case "azure-native:botservice/v20220915:PrivateEndpointConnection":
...
pulumi.runtime.registerResourceModule("azure-native", "botservice/v20220915", _module)

...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:botservice/v20230915preview:Bot":
                return new Bot(name, <any>undefined, { urn })
            case "azure-native:botservice/v20230915preview:BotConnection":
                return new BotConnection(name, <any>undefined, { urn })
            case "azure-native:botservice/v20230915preview:Channel":
                return new Channel(name, <any>undefined, { urn })
            case "azure-native:botservice/v20230915preview:PrivateEndpointConnection":
...
pulumi.runtime.registerResourceModule("azure-native", "botservice/v20230915preview", _module)
...
export class MonitoredResource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:scom/v20230707preview:MonitoredResource';
     ...
     */
    public /*out*/ readonly properties!: pulumi.Output<types.outputs.scom.v20230707preview.MonitoredResourcePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: MonitoredResourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:scom:MonitoredResource" }] };

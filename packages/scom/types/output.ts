...
export namespace scom {
    ...
    export namespace v20230707preview {
        ...
        export interface ManagedIdentityResponse {
             ...
             * The resource ids of the user assigned identities to use
             */
            userAssignedIdentities?: {[key: string]: v20230707preview.UserIdentityResponse};
        }
        ...
        export interface MonitoringInstancePropertiesResponse {
             ...
             * The properties to enable Azure Hybrid benefit for various SCOM infrastructure license.
             */
            azureHybridBenefit?: v20230707preview.AzureHybridBenefitPropertiesResponse;
            /**
             * The database instance where the SCOM Operational and Warehouse databases will be stored.
             */
            databaseInstance?: v20230707preview.DatabaseInstancePropertiesResponse;
            /**
             * Domain controller details
             */
            domainController?: v20230707preview.DomainControllerPropertiesResponse;
            /**
             * Domain user which will be used to join VMs to domain and login to VMs.
             */
            domainUserCredentials?: v20230707preview.DomainUserCredentialsResponse;
            /**
             * Gmsa Details for load balancer and vmss
             */
            gmsaDetails?: v20230707preview.GmsaDetailsResponse;
            /**
             * Details of Log Analytics workspace and data being ingested.
             */
            logAnalyticsProperties: v20230707preview.LogAnalyticsConfigurationResponse;
            /**
             * List of management server endpoints
             */
            managementEndpoints: v20230707preview.ManagementServerPropertiesResponse[];
            /**
             * Gets status of current and latest SCOM managed instance operations.
             */
            operationsStatus: v20230707preview.ManagedInstanceOperationStatusResponse[];
            /**
             * SCOM product version to be installed on instance
             */
            productVersion: string;
        ...
        export function monitoringInstancePropertiesResponseProvideDefaults(val: MonitoringInstancePropertiesResponse): MonitoringInstancePropertiesResponse {
            return {
                ...val,
                domainController: (val.domainController ? v20230707preview.domainControllerPropertiesResponseProvideDefaults(val.domainController) : undefined),
                logAnalyticsProperties: v20230707preview.logAnalyticsConfigurationResponseProvideDefaults(val.logAnalyticsProperties),
            };
        }

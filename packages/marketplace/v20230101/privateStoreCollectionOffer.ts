...
export class PrivateStoreCollectionOffer extends pulumi.CustomResource {
     ...
     * Offer plans
     */
    public readonly plans!: pulumi.Output<types.outputs.marketplace.v20230101.PlanResponse[] | undefined>;
    /**
...
export interface PrivateStoreCollectionOfferArgs {
     ...
     * Offer plans
     */
    plans?: pulumi.Input<pulumi.Input<types.inputs.marketplace.v20230101.PlanArgs>[]>;
    /**

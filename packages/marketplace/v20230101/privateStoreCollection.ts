...
export class PrivateStoreCollection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:marketplace/v20230101:PrivateStoreCollection';
     ...
     */
    public /*out*/ readonly appliedRules!: pulumi.Output<types.outputs.marketplace.v20230101.RuleResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<types.outputs.marketplace.v20230101.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: PrivateStoreCollectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:marketplace:PrivateStoreCollection" }, { type: "azure-native:marketplace/v20210601:PrivateStoreCollection" }, { type: "azure-native:marketplace/v20211201:PrivateStoreCollection" }, { type: "azure-native:marketplace/v20220301:PrivateStoreCollection" }, { type: "azure-native:marketplace/v20220901:PrivateStoreCollection" }] };

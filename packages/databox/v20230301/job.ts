...
export class Job extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:databox/v20230301:Job';
     ...
     */
    public readonly deliveryInfo!: pulumi.Output<types.outputs.databox.v20230301.JobDeliveryInfoResponse | undefined>;
    /**
     ...
     */
    public readonly details!: pulumi.Output<types.outputs.databox.v20230301.DataBoxCustomerDiskJobDetailsResponse | types.outputs.databox.v20230301.DataBoxDiskJobDetailsResponse | types.outputs.databox.v20230301.DataBoxHeavyJobDetailsResponse | types.outputs.databox.v20230301.DataBoxJobDetailsResponse | undefined>;
    /**
     * Top level error for the job.
     */
    public /*out*/ readonly error!: pulumi.Output<types.outputs.databox.v20230301.CloudErrorResponse>;
    /**
     * Msi identity of the resource
     */
    public readonly identity!: pulumi.Output<types.outputs.databox.v20230301.ResourceIdentityResponse | undefined>;
    /**
     ...
     * The sku type.
     */
    public readonly sku!: pulumi.Output<types.outputs.databox.v20230301.SkuResponse>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<types.outputs.databox.v20230301.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: JobArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["identity"] = args ? (args.identity ? pulumi.output(args.identity).apply(types.inputs.databox.v20230301.resourceIdentityArgsProvideDefaults) : undefined) : undefined;
...
export interface JobArgs {
     ...
     * Delivery Info of Job.
     */
    deliveryInfo?: pulumi.Input<types.inputs.databox.v20230301.JobDeliveryInfoArgs>;
    /**
     * Delivery type of Job.
     */
    deliveryType?: pulumi.Input<string | types.enums.v20230301.JobDeliveryType>;
    /**
     * Details of a job run. This field will only be sent for expand details filter.
     */
    details?: pulumi.Input<types.inputs.databox.v20230301.DataBoxCustomerDiskJobDetailsArgs | types.inputs.databox.v20230301.DataBoxDiskJobDetailsArgs | types.inputs.databox.v20230301.DataBoxHeavyJobDetailsArgs | types.inputs.databox.v20230301.DataBoxJobDetailsArgs>;
    /**
     * Msi identity of the resource
     */
    identity?: pulumi.Input<types.inputs.databox.v20230301.ResourceIdentityArgs>;
    /**
     ...
     * The sku type.
     */
    sku: pulumi.Input<types.inputs.databox.v20230301.SkuArgs>;
    /**
     * The list of key value pairs that describe the resource. These tags can be used in viewing and grouping this resource (across resource groups).
     */
     ...
     * Type of the data transfer.
     */
    transferType: pulumi.Input<string | types.enums.v20230301.TransferType>;
}

...
export class Job extends pulumi.CustomResource {
     ...
     */
    declare public readonly deliveryInfo: pulumi.Output<types.outputs.JobDeliveryInfoResponse | undefined>;
    /**
     ...
     */
    declare public readonly details: pulumi.Output<types.outputs.DataBoxCustomerDiskJobDetailsResponse | types.outputs.DataBoxDiskJobDetailsResponse | types.outputs.DataBoxHeavyJobDetailsResponse | types.outputs.DataBoxJobDetailsResponse | undefined>;
    /**
     * Top level error for the job.
     */
    declare public /*out*/ readonly error: pulumi.Output<types.outputs.CloudErrorResponse>;
    /**

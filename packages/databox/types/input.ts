...
export namespace databox {
    ...
    export namespace v20221201 {
        ...
        export interface ContactDetailsArgs {
             ...
             * Notification preference for a job stage.
             */
            notificationPreference?: pulumi.Input<pulumi.Input<v20221201.NotificationPreferenceArgs>[]>;
            /**
             * Phone number of the contact person.
             */
            phone: pulumi.Input<string>;
        ...
        export interface DataBoxCustomerDiskJobDetailsArgs {
             ...
             * Contact details for notification and shipping.
             */
            contactDetails: pulumi.Input<v20221201.ContactDetailsArgs>;
            /**
             * Details of the data to be exported from azure.
             */
            dataExportDetails?: pulumi.Input<pulumi.Input<v20221201.DataExportDetailsArgs>[]>;
            /**
             * Details of the data to be imported into azure.
             */
            dataImportDetails?: pulumi.Input<pulumi.Input<v20221201.DataImportDetailsArgs>[]>;
            /**
             * Flag to indicate if disk manifest should be backed-up in the Storage Account.
             */
            enableManifestBackup?: pulumi.Input<boolean>;
             ...
             * Contains the map of disk serial number to the disk details for import jobs.
             */
            importDiskDetailsCollection?: pulumi.Input<{[key: string]: pulumi.Input<v20221201.ImportDiskDetailsArgs>}>;
            /**
             * Indicates the type of job details.
             * Expected value is 'DataBoxCustomerDisk'.
             */
             ...
             * Details about which key encryption type is being used.
             */
            keyEncryptionKey?: pulumi.Input<v20221201.KeyEncryptionKeyArgs>;
            /**
             * Preferences for the order.
             */
            preferences?: pulumi.Input<v20221201.PreferencesArgs>;
            /**
             * Return package shipping details.
             */
            returnToCustomerPackageDetails: pulumi.Input<v20221201.PackageCarrierDetailsArgs>;
            /**
             * Optional Reverse Shipping details for order.
             */
            reverseShippingDetails?: pulumi.Input<v20221201.ReverseShippingDetailsArgs>;
            /**
             * Shipping address of the customer.
             */
            shippingAddress?: pulumi.Input<v20221201.ShippingAddressArgs>;
        }
        /**
         * dataBoxCustomerDiskJobDetailsArgsProvideDefaults sets the appropriate defaults for DataBoxCustomerDiskJobDetailsArgs
         */
        export function dataBoxCustomerDiskJobDetailsArgsProvideDefaults(val: DataBoxCustomerDiskJobDetailsArgs): DataBoxCustomerDiskJobDetailsArgs {
            return {
                ...val,
                enableManifestBackup: (val.enableManifestBackup) ?? false,
                keyEncryptionKey: (val.keyEncryptionKey ? pulumi.output(val.keyEncryptionKey).apply(v20221201.keyEncryptionKeyArgsProvideDefaults) : undefined),
                preferences: (val.preferences ? pulumi.output(val.preferences).apply(v20221201.preferencesArgsProvideDefaults) : undefined),
                reverseShippingDetails: (val.reverseShippingDetails ? pulumi.output(val.reverseShippingDetails).apply(v20221201.reverseShippingDetailsArgsProvideDefaults) : undefined),
                shippingAddress: (val.shippingAddress ? pulumi.output(val.shippingAddress).apply(v20221201.shippingAddressArgsProvideDefaults) : undefined),
            };
        }
        ...
        export interface DataExportDetailsArgs {
             ...
             * Account details of the data to be transferred
             */
            accountDetails: pulumi.Input<v20221201.ManagedDiskDetailsArgs | v20221201.StorageAccountDetailsArgs>;
            /**
             * Level of the logs to be collected.
             */
            logCollectionLevel?: pulumi.Input<string | enums.v20221201.LogCollectionLevel>;
            /**
             * Configuration for the data transfer.
             */
            transferConfiguration: pulumi.Input<v20221201.TransferConfigurationArgs>;
        }
        /**
         * dataExportDetailsArgsProvideDefaults sets the appropriate defaults for DataExportDetailsArgs
         */
        export function dataExportDetailsArgsProvideDefaults(val: DataExportDetailsArgs): DataExportDetailsArgs {
            return {
                ...val,
                logCollectionLevel: (val.logCollectionLevel) ?? "Error",
                transferConfiguration: pulumi.output(val.transferConfiguration).apply(v20221201.transferConfigurationArgsProvideDefaults),
            };
        }
        ...
        export interface EncryptionPreferencesArgs {
             ...
             * Defines secondary layer of software-based encryption enablement.
             */
            doubleEncryption?: pulumi.Input<string | enums.v20221201.DoubleEncryption>;
            /**
             * Defines Hardware level encryption (Only for disk)
             */
            hardwareEncryption?: pulumi.Input<string | enums.v20221201.HardwareEncryption>;
        }
        /**
         * encryptionPreferencesArgsProvideDefaults sets the appropriate defaults for EncryptionPreferencesArgs
         */
        ...
        export interface FilterFileDetailsArgs {
             ...
             * Type of the filter file.
             */
            filterFileType: pulumi.Input<string | enums.v20221201.FilterFileType>;
        }
        ...
        export interface IdentityPropertiesArgs {
             ...
             * User assigned identity properties.
             */
            userAssigned?: pulumi.Input<v20221201.UserAssignedPropertiesArgs>;
        }
        ...
        export interface KeyEncryptionKeyArgs {
             ...
             * Managed identity properties used for key encryption.
             */
            identityProperties?: pulumi.Input<v20221201.IdentityPropertiesArgs>;
            /**
             * Type of encryption key used for key encryption.
             */
            kekType: pulumi.Input<string | enums.v20221201.KekType>;
            /**
             * Key encryption key. It is required in case of Customer managed KekType.
             */
            kekUrl?: pulumi.Input<string>;
        ...
        export interface NotificationPreferenceArgs {
             ...
             * Name of the stage.
             */
            stageName: pulumi.Input<string | enums.v20221201.NotificationStageName>;
        }
        /**
         * notificationPreferenceArgsProvideDefaults sets the appropriate defaults for NotificationPreferenceArgs
         */
        ...
        export interface PreferencesArgs {
             ...
             * Preferences related to the Encryption.
             */
            encryptionPreferences?: pulumi.Input<v20221201.EncryptionPreferencesArgs>;
            /**
             * Preferred data center region.
             */
            preferredDataCenterRegion?: pulumi.Input<pulumi.Input<string>[]>;
             ...
             * Optional Preferences related to the reverse shipment logistics of the sku.
             */
            reverseTransportPreferences?: pulumi.Input<v20221201.TransportPreferencesArgs>;
            /**
             * Preferences related to the Access Tier of storage accounts.
             */
            storageAccountAccessTierPreferences?: pulumi.Input<pulumi.Input<string | enums.v20221201.StorageAccountAccessTier>[]>;
            /**
             * Preferences related to the shipment logistics of the sku.
             */
            transportPreferences?: pulumi.Input<v20221201.TransportPreferencesArgs>;
        }
        /**
         * preferencesArgsProvideDefaults sets the appropriate defaults for PreferencesArgs
         */
        export function preferencesArgsProvideDefaults(val: PreferencesArgs): PreferencesArgs {
            return {
                ...val,
                encryptionPreferences: (val.encryptionPreferences ? pulumi.output(val.encryptionPreferences).apply(v20221201.encryptionPreferencesArgsProvideDefaults) : undefined),
            };
        }
        ...
        export interface ReverseShippingDetailsArgs {
             ...
             * Contact Info.
             */
            contactDetails?: pulumi.Input<v20221201.ContactInfoArgs>;
            /**
             * Shipping address where customer wishes to receive the device.
             */
            shippingAddress?: pulumi.Input<v20221201.ShippingAddressArgs>;
        ...
        export interface ShippingAddressArgs {
             ...
             * Type of address.
             */
            addressType?: pulumi.Input<string | enums.v20221201.AddressType>;
            /**
             * Name of the City.
             */
            city?: pulumi.Input<string>;
        ...
        export interface TransferAllDetailsArgs {
             ...
             * Type of the account of data
             */
            dataAccountType: pulumi.Input<string | enums.v20221201.DataAccountType>;
            /**
             * To indicate if all Azure blobs have to be transferred
             */
            transferAllBlobs?: pulumi.Input<boolean>;
        ...
        export interface TransferConfigurationArgs {
             ...
             * Map of filter type and the details to transfer all data. This field is required only if the TransferConfigurationType is given as TransferAll
             */
            transferAllDetails?: pulumi.Input<v20221201.TransferConfigurationTransferAllDetailsArgs>;
            /**
             * Type of the configuration for transfer.
             */
            transferConfigurationType: pulumi.Input<string | enums.v20221201.TransferConfigurationType>;
            /**
             * Map of filter type and the details to filter. This field is required only if the TransferConfigurationType is given as TransferUsingFilter.
             */
            transferFilterDetails?: pulumi.Input<v20221201.TransferConfigurationTransferFilterDetailsArgs>;
        }
        /**
         * transferConfigurationArgsProvideDefaults sets the appropriate defaults for TransferConfigurationArgs
         */
        export function transferConfigurationArgsProvideDefaults(val: TransferConfigurationArgs): TransferConfigurationArgs {
            return {
                ...val,
                transferAllDetails: (val.transferAllDetails ? pulumi.output(val.transferAllDetails).apply(v20221201.transferConfigurationTransferAllDetailsArgsProvideDefaults) : undefined),
                transferFilterDetails: (val.transferFilterDetails ? pulumi.output(val.transferFilterDetails).apply(v20221201.transferConfigurationTransferFilterDetailsArgsProvideDefaults) : undefined),
            };
        }
        ...
        export interface TransferConfigurationTransferAllDetailsArgs {
             ...
             * Details to transfer all data.
             */
            include?: pulumi.Input<v20221201.TransferAllDetailsArgs>;
        }
        /**
         * transferConfigurationTransferAllDetailsArgsProvideDefaults sets the appropriate defaults for TransferConfigurationTransferAllDetailsArgs
         */
        export function transferConfigurationTransferAllDetailsArgsProvideDefaults(val: TransferConfigurationTransferAllDetailsArgs): TransferConfigurationTransferAllDetailsArgs {
            return {
                ...val,
                include: (val.include ? pulumi.output(val.include).apply(v20221201.transferAllDetailsArgsProvideDefaults) : undefined),
            };
        }
        ...
        export interface TransferConfigurationTransferFilterDetailsArgs {
             ...
             * Details of the filtering the transfer of data.
             */
            include?: pulumi.Input<v20221201.TransferFilterDetailsArgs>;
        }
        /**
         * transferConfigurationTransferFilterDetailsArgsProvideDefaults sets the appropriate defaults for TransferConfigurationTransferFilterDetailsArgs
         */
        export function transferConfigurationTransferFilterDetailsArgsProvideDefaults(val: TransferConfigurationTransferFilterDetailsArgs): TransferConfigurationTransferFilterDetailsArgs {
            return {
                ...val,
                include: (val.include ? pulumi.output(val.include).apply(v20221201.transferFilterDetailsArgsProvideDefaults) : undefined),
            };
        }
        ...
        export interface TransferFilterDetailsArgs {
             ...
             * Filter details to transfer Azure files.
             */
            azureFileFilterDetails?: pulumi.Input<v20221201.AzureFileFilterDetailsArgs>;
            /**
             * Filter details to transfer blobs.
             */
            blobFilterDetails?: pulumi.Input<v20221201.BlobFilterDetailsArgs>;
            /**
             * Type of the account of data.
             */
            dataAccountType: pulumi.Input<string | enums.v20221201.DataAccountType>;
             ...
             * Details of the filter files to be used for data transfer.
             */
            filterFileDetails?: pulumi.Input<pulumi.Input<v20221201.FilterFileDetailsArgs>[]>;
        }
        /**
         * transferFilterDetailsArgsProvideDefaults sets the appropriate defaults for TransferFilterDetailsArgs
         */
        ...
        export interface TransportPreferencesArgs {
             ...
             * Indicates Shipment Logistics type that the customer preferred.
             */
            preferredShipmentType: pulumi.Input<string | enums.v20221201.TransportShipmentTypes>;
        }
    ...
    export namespace v20230301 {
        ...
        export interface ContactDetailsArgs {
             ...
             * Notification preference for a job stage.
             */
            notificationPreference?: pulumi.Input<pulumi.Input<v20230301.NotificationPreferenceArgs>[]>;
            /**
             * Phone number of the contact person.
             */
            phone: pulumi.Input<string>;
        ...
        export interface DataBoxCustomerDiskJobDetailsArgs {
             ...
             * Contact details for notification and shipping.
             */
            contactDetails: pulumi.Input<v20230301.ContactDetailsArgs>;
            /**
             * Details of the data to be exported from azure.
             */
            dataExportDetails?: pulumi.Input<pulumi.Input<v20230301.DataExportDetailsArgs>[]>;
            /**
             * Details of the data to be imported into azure.
             */
            dataImportDetails?: pulumi.Input<pulumi.Input<v20230301.DataImportDetailsArgs>[]>;
            /**
             * Flag to indicate if disk manifest should be backed-up in the Storage Account.
             */
            enableManifestBackup?: pulumi.Input<boolean>;
             ...
             * Contains the map of disk serial number to the disk details for import jobs.
             */
            importDiskDetailsCollection?: pulumi.Input<{[key: string]: pulumi.Input<v20230301.ImportDiskDetailsArgs>}>;
            /**
             * Indicates the type of job details.
             * Expected value is 'DataBoxCustomerDisk'.
             */
             ...
             * Details about which key encryption type is being used.
             */
            keyEncryptionKey?: pulumi.Input<v20230301.KeyEncryptionKeyArgs>;
            /**
             * Preferences for the order.
             */
            preferences?: pulumi.Input<v20230301.PreferencesArgs>;
            /**
             * Return package shipping details.
             */
            returnToCustomerPackageDetails: pulumi.Input<v20230301.PackageCarrierDetailsArgs>;
            /**
             * Optional Reverse Shipping details for order.
             */
            reverseShippingDetails?: pulumi.Input<v20230301.ReverseShippingDetailsArgs>;
            /**
             * Shipping address of the customer.
             */
            shippingAddress?: pulumi.Input<v20230301.ShippingAddressArgs>;
        }
        /**
         * dataBoxCustomerDiskJobDetailsArgsProvideDefaults sets the appropriate defaults for DataBoxCustomerDiskJobDetailsArgs
         */
        export function dataBoxCustomerDiskJobDetailsArgsProvideDefaults(val: DataBoxCustomerDiskJobDetailsArgs): DataBoxCustomerDiskJobDetailsArgs {
            return {
                ...val,
                enableManifestBackup: (val.enableManifestBackup) ?? false,
                keyEncryptionKey: (val.keyEncryptionKey ? pulumi.output(val.keyEncryptionKey).apply(v20230301.keyEncryptionKeyArgsProvideDefaults) : undefined),
                preferences: (val.preferences ? pulumi.output(val.preferences).apply(v20230301.preferencesArgsProvideDefaults) : undefined),
                reverseShippingDetails: (val.reverseShippingDetails ? pulumi.output(val.reverseShippingDetails).apply(v20230301.reverseShippingDetailsArgsProvideDefaults) : undefined),
                shippingAddress: (val.shippingAddress ? pulumi.output(val.shippingAddress).apply(v20230301.shippingAddressArgsProvideDefaults) : undefined),
            };
        }
        ...
        export interface DataExportDetailsArgs {
             ...
             * Account details of the data to be transferred
             */
            accountDetails: pulumi.Input<v20230301.ManagedDiskDetailsArgs | v20230301.StorageAccountDetailsArgs>;
            /**
             * Level of the logs to be collected.
             */
            logCollectionLevel?: pulumi.Input<string | enums.v20230301.LogCollectionLevel>;
            /**
             * Configuration for the data transfer.
             */
            transferConfiguration: pulumi.Input<v20230301.TransferConfigurationArgs>;
        }
        /**
         * dataExportDetailsArgsProvideDefaults sets the appropriate defaults for DataExportDetailsArgs
         */
        export function dataExportDetailsArgsProvideDefaults(val: DataExportDetailsArgs): DataExportDetailsArgs {
            return {
                ...val,
                logCollectionLevel: (val.logCollectionLevel) ?? "Error",
                transferConfiguration: pulumi.output(val.transferConfiguration).apply(v20230301.transferConfigurationArgsProvideDefaults),
            };
        }
        ...
        export interface EncryptionPreferencesArgs {
             ...
             * Defines secondary layer of software-based encryption enablement.
             */
            doubleEncryption?: pulumi.Input<string | enums.v20230301.DoubleEncryption>;
            /**
             * Defines Hardware level encryption (Only for disk)
             */
            hardwareEncryption?: pulumi.Input<string | enums.v20230301.HardwareEncryption>;
        }
        /**
         * encryptionPreferencesArgsProvideDefaults sets the appropriate defaults for EncryptionPreferencesArgs
         */
        ...
        export interface FilterFileDetailsArgs {
             ...
             * Type of the filter file.
             */
            filterFileType: pulumi.Input<string | enums.v20230301.FilterFileType>;
        }
        ...
        export interface IdentityPropertiesArgs {
             ...
             * User assigned identity properties.
             */
            userAssigned?: pulumi.Input<v20230301.UserAssignedPropertiesArgs>;
        }
        ...
        export interface KeyEncryptionKeyArgs {
             ...
             * Managed identity properties used for key encryption.
             */
            identityProperties?: pulumi.Input<v20230301.IdentityPropertiesArgs>;
            /**
             * Type of encryption key used for key encryption.
             */
            kekType: pulumi.Input<string | enums.v20230301.KekType>;
            /**
             * Key encryption key. It is required in case of Customer managed KekType.
             */
            kekUrl?: pulumi.Input<string>;
        ...
        export interface NotificationPreferenceArgs {
             ...
             * Name of the stage.
             */
            stageName: pulumi.Input<string | enums.v20230301.NotificationStageName>;
        }
        /**
         * notificationPreferenceArgsProvideDefaults sets the appropriate defaults for NotificationPreferenceArgs
         */
        ...
        export interface PreferencesArgs {
             ...
             * Preferences related to the Encryption.
             */
            encryptionPreferences?: pulumi.Input<v20230301.EncryptionPreferencesArgs>;
            /**
             * Preferred data center region.
             */
            preferredDataCenterRegion?: pulumi.Input<pulumi.Input<string>[]>;
             ...
             * Optional Preferences related to the reverse shipment logistics of the sku.
             */
            reverseTransportPreferences?: pulumi.Input<v20230301.TransportPreferencesArgs>;
            /**
             * Preferences related to the Access Tier of storage accounts.
             */
            storageAccountAccessTierPreferences?: pulumi.Input<pulumi.Input<string | enums.v20230301.StorageAccountAccessTier>[]>;
            /**
             * Preferences related to the shipment logistics of the sku.
             */
            transportPreferences?: pulumi.Input<v20230301.TransportPreferencesArgs>;
        }
        /**
         * preferencesArgsProvideDefaults sets the appropriate defaults for PreferencesArgs
         */
        export function preferencesArgsProvideDefaults(val: PreferencesArgs): PreferencesArgs {
            return {
                ...val,
                encryptionPreferences: (val.encryptionPreferences ? pulumi.output(val.encryptionPreferences).apply(v20230301.encryptionPreferencesArgsProvideDefaults) : undefined),
            };
        }
        ...
        export interface ReverseShippingDetailsArgs {
             ...
             * Contact Info.
             */
            contactDetails?: pulumi.Input<v20230301.ContactInfoArgs>;
            /**
             * Shipping address where customer wishes to receive the device.
             */
            shippingAddress?: pulumi.Input<v20230301.ShippingAddressArgs>;
        ...
        export interface ShippingAddressArgs {
             ...
             * Type of address.
             */
            addressType?: pulumi.Input<string | enums.v20230301.AddressType>;
            /**
             * Name of the City.
             */
            city?: pulumi.Input<string>;
        ...
        export interface SkuArgs {
             ...
             * The sku name.
             */
            name: pulumi.Input<string | enums.v20230301.SkuName>;
        }
        ...
        export interface TransferAllDetailsArgs {
             ...
             * Type of the account of data
             */
            dataAccountType: pulumi.Input<string | enums.v20230301.DataAccountType>;
            /**
             * To indicate if all Azure blobs have to be transferred
             */
            transferAllBlobs?: pulumi.Input<boolean>;
        ...
        export interface TransferConfigurationArgs {
             ...
             * Map of filter type and the details to transfer all data. This field is required only if the TransferConfigurationType is given as TransferAll
             */
            transferAllDetails?: pulumi.Input<v20230301.TransferConfigurationTransferAllDetailsArgs>;
            /**
             * Type of the configuration for transfer.
             */
            transferConfigurationType: pulumi.Input<string | enums.v20230301.TransferConfigurationType>;
            /**
             * Map of filter type and the details to filter. This field is required only if the TransferConfigurationType is given as TransferUsingFilter.
             */
            transferFilterDetails?: pulumi.Input<v20230301.TransferConfigurationTransferFilterDetailsArgs>;
        }
        /**
         * transferConfigurationArgsProvideDefaults sets the appropriate defaults for TransferConfigurationArgs
         */
        export function transferConfigurationArgsProvideDefaults(val: TransferConfigurationArgs): TransferConfigurationArgs {
            return {
                ...val,
                transferAllDetails: (val.transferAllDetails ? pulumi.output(val.transferAllDetails).apply(v20230301.transferConfigurationTransferAllDetailsArgsProvideDefaults) : undefined),
                transferFilterDetails: (val.transferFilterDetails ? pulumi.output(val.transferFilterDetails).apply(v20230301.transferConfigurationTransferFilterDetailsArgsProvideDefaults) : undefined),
            };
        }
        ...
        export interface TransferConfigurationTransferAllDetailsArgs {
             ...
             * Details to transfer all data.
             */
            include?: pulumi.Input<v20230301.TransferAllDetailsArgs>;
        }
        /**
         * transferConfigurationTransferAllDetailsArgsProvideDefaults sets the appropriate defaults for TransferConfigurationTransferAllDetailsArgs
         */
        export function transferConfigurationTransferAllDetailsArgsProvideDefaults(val: TransferConfigurationTransferAllDetailsArgs): TransferConfigurationTransferAllDetailsArgs {
            return {
                ...val,
                include: (val.include ? pulumi.output(val.include).apply(v20230301.transferAllDetailsArgsProvideDefaults) : undefined),
            };
        }
        ...
        export interface TransferConfigurationTransferFilterDetailsArgs {
             ...
             * Details of the filtering the transfer of data.
             */
            include?: pulumi.Input<v20230301.TransferFilterDetailsArgs>;
        }
        /**
         * transferConfigurationTransferFilterDetailsArgsProvideDefaults sets the appropriate defaults for TransferConfigurationTransferFilterDetailsArgs
         */
        export function transferConfigurationTransferFilterDetailsArgsProvideDefaults(val: TransferConfigurationTransferFilterDetailsArgs): TransferConfigurationTransferFilterDetailsArgs {
            return {
                ...val,
                include: (val.include ? pulumi.output(val.include).apply(v20230301.transferFilterDetailsArgsProvideDefaults) : undefined),
            };
        }
        ...
        export interface TransferFilterDetailsArgs {
             ...
             * Filter details to transfer Azure files.
             */
            azureFileFilterDetails?: pulumi.Input<v20230301.AzureFileFilterDetailsArgs>;
            /**
             * Filter details to transfer blobs.
             */
            blobFilterDetails?: pulumi.Input<v20230301.BlobFilterDetailsArgs>;
            /**
             * Type of the account of data.
             */
            dataAccountType: pulumi.Input<string | enums.v20230301.DataAccountType>;
             ...
             * Details of the filter files to be used for data transfer.
             */
            filterFileDetails?: pulumi.Input<pulumi.Input<v20230301.FilterFileDetailsArgs>[]>;
        }
        /**
         * transferFilterDetailsArgsProvideDefaults sets the appropriate defaults for TransferFilterDetailsArgs
         */
        ...
        export interface TransportPreferencesArgs {
             ...
             * Indicates Shipment Logistics type that the customer preferred.
             */
            preferredShipmentType: pulumi.Input<string | enums.v20230301.TransportShipmentTypes>;
        }

 ...
 */
export class ServiceGroupMemberRelationship extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ServiceGroupMemberRelationship {
        return new ServiceGroupMemberRelationship(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:relationships:ServiceGroupMemberRelationship';
     ...
     */
    public static isInstance(obj: any): obj is ServiceGroupMemberRelationship {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.ServiceGroupMemberRelationshipPropertiesResponse>;
    /**

...
export class DependencyOfRelationship extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DependencyOfRelationship {
        return new DependencyOfRelationship(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:relationships:DependencyOfRelationship';

    /**
     * Returns true if the given object is an instance of DependencyOfRelationship.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DependencyOfRelationship {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.DependencyOfRelationshipPropertiesResponse>;
    /**

...
export class ProjectEnvironmentType extends pulumi.CustomResource {
     ...
     */
    declare public readonly creatorRoleAssignment: pulumi.Output<types.outputs.ProjectEnvironmentTypeUpdatePropertiesResponseCreatorRoleAssignment | undefined>;
    /**
     ...
     */
    declare public readonly userRoleAssignments: pulumi.Output<{[key: string]: types.outputs.UserRoleAssignmentResponse} | undefined>;

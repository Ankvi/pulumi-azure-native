...
export class DevBoxDefinition extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly activeImageReference: pulumi.Output<types.outputs.ImageReferenceResponse>;
    /**
     ...
     */
    declare public readonly imageReference: pulumi.Output<types.outputs.ImageReferenceResponse>;
    /**
     * Details for image validator error. Populated when the image validation is not successful.
     */
    declare public /*out*/ readonly imageValidationErrorDetails: pulumi.Output<types.outputs.ImageValidationErrorDetailsResponse>;
    /**

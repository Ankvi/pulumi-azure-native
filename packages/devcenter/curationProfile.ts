...
export class CurationProfile extends pulumi.CustomResource {
     ...
     */
    declare public readonly resourcePolicies: pulumi.Output<types.outputs.ResourcePolicyResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: CurationProfileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["curationProfileName"] = args?.curationProfileName;

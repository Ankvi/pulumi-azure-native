...
export namespace devcenter {
    ...
    export namespace v20221111preview {
        /**
         * Image reference information
         */
        export interface ImageReferenceArgs {
        ...
        export interface SkuArgs {
             ...
             * This field is required to be implemented by the Resource Provider if the service has more than one tier, but is not required on a PUT.
             */
            tier?: pulumi.Input<enums.v20221111preview.SkuTier>;
        }
    ...
    export namespace v20230401 {
        ...
        export interface SkuArgs {
             ...
             * This field is required to be implemented by the Resource Provider if the service has more than one tier, but is not required on a PUT.
             */
            tier?: pulumi.Input<enums.v20230401.SkuTier>;
        }
        ...
        export interface StopOnDisconnectConfigurationArgs {
             ...
             * Whether the feature to stop the Dev Box on disconnect once the grace period has lapsed is enabled.
             */
            status?: pulumi.Input<string | enums.v20230401.StopOnDisconnectEnableStatus>;
        }

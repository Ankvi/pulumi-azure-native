...
export function getDevBoxDefinition(args: GetDevBoxDefinitionArgs, opts?: pulumi.InvokeOptions): Promise<GetDevBoxDefinitionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:devcenter/v20221111preview:getDevBoxDefinition", {
...
export interface GetDevBoxDefinitionResult {
     ...
     */
    readonly activeImageReference: types.outputs.devcenter.v20221111preview.ImageReferenceResponse;
    /**
     ...
     */
    readonly imageReference: types.outputs.devcenter.v20221111preview.ImageReferenceResponse;
    /**
     * Details for image validator error. Populated when the image validation is not successful.
     */
    readonly imageValidationErrorDetails: types.outputs.devcenter.v20221111preview.ImageValidationErrorDetailsResponse;
    /**
     ...
     */
    readonly sku: types.outputs.devcenter.v20221111preview.SkuResponse;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    readonly systemData: types.outputs.devcenter.v20221111preview.SystemDataResponse;
    /**
     * Resource tags.
     */

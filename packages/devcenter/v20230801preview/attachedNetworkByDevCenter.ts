...
export class AttachedNetworkByDevCenter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:devcenter/v20230801preview:AttachedNetworkByDevCenter';

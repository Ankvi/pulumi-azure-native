...
export class DevBoxDefinition extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:devcenter/v20240201:DevBoxDefinition';

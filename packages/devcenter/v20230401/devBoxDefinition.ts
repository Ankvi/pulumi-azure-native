...
export class DevBoxDefinition extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:devcenter/v20230401:DevBoxDefinition';
     ...
     */
    public /*out*/ readonly activeImageReference!: pulumi.Output<types.outputs.devcenter.v20230401.ImageReferenceResponse>;
    /**
     ...
     */
    public readonly imageReference!: pulumi.Output<types.outputs.devcenter.v20230401.ImageReferenceResponse>;
    /**
     * Details for image validator error. Populated when the image validation is not successful.
     */
    public /*out*/ readonly imageValidationErrorDetails!: pulumi.Output<types.outputs.devcenter.v20230401.ImageValidationErrorDetailsResponse>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<types.outputs.devcenter.v20230401.SkuResponse>;
    /**
...
export interface DevBoxDefinitionArgs {
     ...
     * Indicates whether Dev Boxes created with this definition are capable of hibernation. Not all images are capable of supporting hibernation. To find out more see https://aka.ms/devbox/hibernate
     */
    hibernateSupport?: pulumi.Input<string | types.enums.v20230401.HibernateSupport>;
    /**
     * Image reference information.
     */
    imageReference: pulumi.Input<types.inputs.devcenter.v20230401.ImageReferenceArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The SKU for Dev Boxes created using this definition.
     */
    sku: pulumi.Input<types.inputs.devcenter.v20230401.SkuArgs>;
    /**
     * Resource tags.
     */

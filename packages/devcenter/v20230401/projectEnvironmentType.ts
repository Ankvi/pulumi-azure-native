...
export class ProjectEnvironmentType extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ProjectEnvironmentTypeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:devcenter:ProjectEnvironmentType" }, { type: "azure-native:devcenter/v20220801preview:ProjectEnvironmentType" }, { type: "azure-native:devcenter/v20220901preview:ProjectEnvironmentType" }, { type: "azure-native:devcenter/v20221012preview:ProjectEnvironmentType" }, { type: "azure-native:devcenter/v20221111preview:ProjectEnvironmentType" }, { type: "azure-native:devcenter/v20230101preview:ProjectEnvironmentType" }, { type: "azure-native:devcenter/v20230801preview:ProjectEnvironmentType" }] };

...
export namespace containerstorage {
    /**
    ...
    export namespace v20230701preview {
        ...
        export interface AzureDiskArgs {
             ...
             * Only required if individual disk selection is desired. Path to disk, e.g. <nodename>:/dev/sda or WWN. Supports specifying multiple disks (same syntax as tags).
             */
            disks?: pulumi.Input<pulumi.Input<v20230701preview.DiskArgs>[]>;
            /**
             * Encryption specifies the encryption configuration for the Azure Disk pool
             */
            encryption?: pulumi.Input<v20230701preview.EncryptionArgs>;
            /**
             * Sku name
             */
            skuName?: pulumi.Input<string | enums.v20230701preview.AzureDiskSkuName>;
        }
        ...
        export interface ElasticSanArgs {
             ...
             * Sku name
             */
            skuName?: pulumi.Input<string | enums.v20230701preview.ElasticSanSkuName>;
        }
        ...
        export interface EncryptionArgs {
             ...
             * The managed service identities assigned to this resource.
             */
            identity?: pulumi.Input<v20230701preview.ManagedServiceIdentityArgs>;
            /**
             * The name of the key vault key.
             */
            keyName: pulumi.Input<string>;
        ...
        export interface PoolTypeArgs {
             ...
             * Disk Pool Properties
             */
            azureDisk?: pulumi.Input<v20230701preview.AzureDiskArgs>;
            /**
             * Elastic San Pool Properties
             */
            elasticSan?: pulumi.Input<v20230701preview.ElasticSanArgs>;
            /**
             * Ephemeral Pool Properties
             */
            ephemeralDisk?: pulumi.Input<v20230701preview.EphemeralDiskArgs>;
        }
        /**
         * poolTypeArgsProvideDefaults sets the appropriate defaults for PoolTypeArgs
         */
        export function poolTypeArgsProvideDefaults(val: PoolTypeArgs): PoolTypeArgs {
            return {
                ...val,
                ephemeralDisk: (val.ephemeralDisk ? pulumi.output(val.ephemeralDisk).apply(v20230701preview.ephemeralDiskArgsProvideDefaults) : undefined),
            };
        }
        ...
        export interface ResourcesArgs {
             ...
             * Requests for capacity for the pool.
             */
            requests?: pulumi.Input<v20230701preview.RequestsArgs>;
        }
        /**
         * resourcesArgsProvideDefaults sets the appropriate defaults for ResourcesArgs
         */
        export function resourcesArgsProvideDefaults(val: ResourcesArgs): ResourcesArgs {
            return {
                ...val,
                requests: (val.requests ? pulumi.output(val.requests).apply(v20230701preview.requestsArgsProvideDefaults) : undefined),
            };
        }

...
export class MetadataSchema extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apicenter/v20240315preview:MetadataSchema';
    ...
    constructor(name: string, args: MetadataSchemaArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apicenter:MetadataSchema" }, { type: "azure-native:apicenter/v20240301:MetadataSchema" }] };

...
export class Environment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apicenter/v20240315preview:Environment';
    ...
    constructor(name: string, args: EnvironmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apicenter:Environment" }, { type: "azure-native:apicenter/v20240301:Environment" }] };

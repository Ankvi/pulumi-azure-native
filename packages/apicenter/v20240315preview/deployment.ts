...
export class Deployment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apicenter/v20240315preview:Deployment';
    ...
    constructor(name: string, args: DeploymentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apicenter:Deployment" }, { type: "azure-native:apicenter/v20240301:Deployment" }] };

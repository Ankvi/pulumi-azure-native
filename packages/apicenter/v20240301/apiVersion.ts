...
export class ApiVersion extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apicenter/v20240301:ApiVersion';
    ...
    constructor(name: string, args: ApiVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apicenter:ApiVersion" }, { type: "azure-native:apicenter/v20240315preview:ApiVersion" }] };

...
export class ApiDefinition extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apicenter/v20240301:ApiDefinition';
     ...
     */
    public /*out*/ readonly specification!: pulumi.Output<types.outputs.ApiDefinitionPropertiesResponseSpecification>;
    /**
    ...
    constructor(name: string, args: ApiDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apicenter:ApiDefinition" }] };

...
export class ApiSource extends pulumi.CustomResource {
     ...
     */
    declare public readonly azureApiManagementSource: pulumi.Output<types.outputs.AzureApiManagementSourceResponse | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly linkState: pulumi.Output<types.outputs.LinkStateResponse>;
    /**

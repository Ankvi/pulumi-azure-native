...
export class MetadataSchema extends pulumi.CustomResource {
     ...
     * The assignees
     */
    declare public readonly assignedTo: pulumi.Output<types.outputs.MetadataAssignmentResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: MetadataSchemaArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["metadataSchemaName"] = args?.metadataSchemaName;

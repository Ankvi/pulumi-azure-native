...
export class FileShare extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:fileshares:FileShare';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.FileSharePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: FileShareArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:fileshares/v20250601preview:FileShare" }] };

...
export class DataLakeConnectorTopicMap extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:iotoperationsmq/v20231004preview:DataLakeConnectorTopicMap';
    ...
    constructor(name: string, args: DataLakeConnectorTopicMapArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:iotoperationsmq:DataLakeConnectorTopicMap" }] };

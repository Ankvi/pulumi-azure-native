...
export class BrokerAuthorization extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:iotoperationsmq/v20231004preview:BrokerAuthorization';
    ...
    constructor(name: string, args: BrokerAuthorizationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:iotoperationsmq:BrokerAuthorization" }] };

...
export class MqttBridgeTopicMap extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:iotoperationsmq/v20231004preview:MqttBridgeTopicMap';
    ...
    constructor(name: string, args: MqttBridgeTopicMapArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:iotoperationsmq:MqttBridgeTopicMap" }] };

...
export class BrokerAuthentication extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:iotoperationsmq/v20231004preview:BrokerAuthentication';
    ...
    constructor(name: string, args: BrokerAuthenticationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:iotoperationsmq:BrokerAuthentication" }] };

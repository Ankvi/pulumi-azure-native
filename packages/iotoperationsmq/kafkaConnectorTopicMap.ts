...
export class KafkaConnectorTopicMap extends pulumi.CustomResource {
     ...
     */
    declare public readonly batching: pulumi.Output<types.outputs.KafkaTopicMapBatchingResponse | undefined>;
    /**
     ...
     */
    declare public readonly routes: pulumi.Output<types.outputs.KafkaRoutesResponse[]>;
    /**

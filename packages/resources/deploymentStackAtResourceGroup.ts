...
export class DeploymentStackAtResourceGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:resources:DeploymentStackAtResourceGroup';
     ...
     */
    public readonly actionOnUnmanage!: pulumi.Output<types.outputs.resources.DeploymentStackPropertiesResponseActionOnUnmanage>;
    /**
     * The debug setting of the deployment.
     */
    public readonly debugSetting!: pulumi.Output<types.outputs.resources.DeploymentStacksDebugSettingResponse | undefined>;
    /**
     * An array of resources that were deleted during the most recent update.
     */
    public /*out*/ readonly deletedResources!: pulumi.Output<types.outputs.resources.ResourceReferenceResponse[]>;
    /**
     * Defines how resources deployed by the stack are locked.
     */
    public readonly denySettings!: pulumi.Output<types.outputs.resources.DenySettingsResponse>;
    /**
     ...
     */
    public /*out*/ readonly detachedResources!: pulumi.Output<types.outputs.resources.ResourceReferenceResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly error!: pulumi.Output<types.outputs.resources.ErrorResponseResponse | undefined>;
    /**
     * An array of resources that failed to reach goal state during the most recent update.
     */
    public /*out*/ readonly failedResources!: pulumi.Output<types.outputs.resources.ResourceReferenceExtendedResponse[]>;
    /**
     ...
     */
    public readonly parametersLink!: pulumi.Output<types.outputs.resources.DeploymentStacksParametersLinkResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly resources!: pulumi.Output<types.outputs.resources.ManagedResourceReferenceResponse[]>;
    /**
    ...
    constructor(name: string, args: DeploymentStackAtResourceGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:resources/v20220801preview:DeploymentStackAtResourceGroup" }] };
...
export interface DeploymentStackAtResourceGroupArgs {
     ...
     * Defines the behavior of resources that are not managed immediately after the stack is updated.
     */
    actionOnUnmanage: pulumi.Input<types.inputs.resources.DeploymentStackPropertiesActionOnUnmanageArgs>;
    /**
     * The debug setting of the deployment.
     */
    debugSetting?: pulumi.Input<types.inputs.resources.DeploymentStacksDebugSettingArgs>;
    /**
     * Defines how resources deployed by the stack are locked.
     */
    denySettings: pulumi.Input<types.inputs.resources.DenySettingsArgs>;
    /**
     * The scope at which the initial deployment should be created. If a scope is not specified, it will default to the scope of the deployment stack. Valid scopes are: management group (format: '/providers/Microsoft.Management/managementGroups/{managementGroupId}'), subscription (format: '/subscriptions/{subscriptionId}'), resource group (format: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}').
     */
     ...
     * The URI of parameters file. Use this element to link to an existing parameters file. Use either the parametersLink property or the parameters property, but not both.
     */
    parametersLink?: pulumi.Input<types.inputs.resources.DeploymentStacksParametersLinkArgs>;
    /**
     ...
     */
    templateLink?: pulumi.Input<types.inputs.resources.DeploymentStacksTemplateLinkArgs>;
}

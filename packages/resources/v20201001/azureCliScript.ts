...
export class AzureCliScript extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:resources/v20201001:AzureCliScript';
    ...
    constructor(name: string, args: AzureCliScriptArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:resources:AzureCliScript" }, { type: "azure-native:resources/v20191001preview:AzureCliScript" }, { type: "azure-native:resources/v20230801:AzureCliScript" }] };

...
export class TagAtScope extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:resources/v20230701:TagAtScope';
     ...
     * The set of tags.
     */
    public readonly properties!: pulumi.Output<types.outputs.resources.v20230701.TagsResponse>;
    /**
...
export interface TagAtScopeArgs {
     ...
     * The set of tags.
     */
    properties: pulumi.Input<types.inputs.resources.v20230701.TagsArgs>;
    /**
     * The resource scope.
     */

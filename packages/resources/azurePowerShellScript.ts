...
export class AzurePowerShellScript extends pulumi.CustomResource {
     ...
     */
    declare public readonly azPowerShellVersion: pulumi.Output<string>;
    /**
     ...
     * Container settings.
     */
    declare public readonly containerSettings: pulumi.Output<types.outputs.ContainerConfigurationResponse | undefined>;
    /**
     * The environment variables to pass over to the script.
     */
    declare public readonly environmentVariables: pulumi.Output<types.outputs.EnvironmentVariableResponse[] | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly status: pulumi.Output<types.outputs.ScriptStatusResponse>;
    /**
     * Storage Account settings.
     */
    declare public readonly storageAccountSettings: pulumi.Output<types.outputs.StorageAccountConfigurationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: AzurePowerShellScriptArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (!opts.id) {
            if (args?.azPowerShellVersion === undefined && !opts.urn) {

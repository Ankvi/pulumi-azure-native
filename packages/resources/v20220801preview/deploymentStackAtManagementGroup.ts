...
export class DeploymentStackAtManagementGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:resources/v20220801preview:DeploymentStackAtManagementGroup';
    ...
    constructor(name: string, args: DeploymentStackAtManagementGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:resources:DeploymentStackAtManagementGroup" }] };

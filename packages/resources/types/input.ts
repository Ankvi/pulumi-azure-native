...
export namespace resources {
    ...
    export namespace v20191001preview {
        ...
        export interface ManagedServiceIdentityArgs {
             ...
             * Type of the managed identity.
             */
            type?: pulumi.Input<string | enums.v20191001preview.ManagedServiceIdentityType>;
            /**
             * The list of user-assigned managed identities associated with the resource. Key is the Azure resource Id of the managed identity.
             */
            userAssignedIdentities?: pulumi.Input<pulumi.Input<string>[]>;
    ...
    export namespace v20201001 {
        ...
        export interface ManagedServiceIdentityArgs {
             ...
             * Type of the managed identity.
             */
            type?: pulumi.Input<string | enums.v20201001.ManagedServiceIdentityType>;
            /**
             * The list of user-assigned managed identities associated with the resource. Key is the Azure resource Id of the managed identity.
             */
            userAssignedIdentities?: pulumi.Input<pulumi.Input<string>[]>;
    ...
    export namespace v20220801preview {
        ...
        export interface DenySettingsArgs {
             ...
             * denySettings Mode.
             */
            mode: pulumi.Input<string | enums.v20220801preview.DenySettingsMode>;
        }
        ...
        export interface DeploymentStackPropertiesActionOnUnmanageArgs {
             ...
             * Specifies the action that should be taken on the resource when the deployment stack is deleted. Delete will attempt to delete the resource from Azure. Detach will leave the resource in it's current state.
             */
            managementGroups?: pulumi.Input<string | enums.v20220801preview.DeploymentStacksDeleteDetachEnum>;
            /**
             * Specifies the action that should be taken on the resource when the deployment stack is deleted. Delete will attempt to delete the resource from Azure. Detach will leave the resource in it's current state.
             */
            resourceGroups?: pulumi.Input<string | enums.v20220801preview.DeploymentStacksDeleteDetachEnum>;
            /**
             * Specifies the action that should be taken on the resource when the deployment stack is deleted. Delete will attempt to delete the resource from Azure. Detach will leave the resource in it's current state.
             */
            resources: pulumi.Input<string | enums.v20220801preview.DeploymentStacksDeleteDetachEnum>;
        }
    ...
    export namespace v20220901 {
        ...
        export interface DeploymentParameterArgs {
             ...
             * Azure Key Vault parameter reference.
             */
            reference?: pulumi.Input<v20220901.KeyVaultParameterReferenceArgs>;
            /**
             * Input value to the parameter .
             */
            value?: any;
        ...
        export interface DeploymentPropertiesArgs {
             ...
             * The debug setting of the deployment.
             */
            debugSetting?: pulumi.Input<v20220901.DebugSettingArgs>;
            /**
             * Specifies whether template expressions are evaluated within the scope of the parent template or nested template. Only applicable to nested templates. If not specified, default value is outer.
             */
            expressionEvaluationOptions?: pulumi.Input<v20220901.ExpressionEvaluationOptionsArgs>;
            /**
             * The mode that is used to deploy resources. This value can be either Incremental or Complete. In Incremental mode, resources are deployed without deleting existing resources that are not included in the template. In Complete mode, resources are deployed and existing resources in the resource group that are not included in the template are deleted. Be careful when using Complete mode as you may unintentionally delete resources.
             */
            mode: pulumi.Input<enums.v20220901.DeploymentMode>;
            /**
             * The deployment on error behavior.
             */
            onErrorDeployment?: pulumi.Input<v20220901.OnErrorDeploymentArgs>;
            /**
             * Name and value pairs that define the deployment parameters for the template. You use this element when you want to provide the parameter values directly in the request rather than link to an existing parameter file. Use either the parametersLink property or the parameters property, but not both. It can be a JObject or a well formed JSON string.
             */
            parameters?: pulumi.Input<{[key: string]: pulumi.Input<v20220901.DeploymentParameterArgs>}>;
            /**
             * The URI of parameters file. You use this element to link to an existing parameters file. Use either the parametersLink property or the parameters property, but not both.
             */
            parametersLink?: pulumi.Input<v20220901.ParametersLinkArgs>;
            /**
             * The template content. You use this element when you want to pass the template syntax directly in the request rather than link to an existing template. It can be a JObject or well-formed JSON string. Use either the templateLink property or the template property, but not both.
             */
            template?: any;
             ...
             * The URI of the template. Use either the templateLink property or the template property, but not both.
             */
            templateLink?: pulumi.Input<v20220901.TemplateLinkArgs>;
        }
        ...
        export interface ExpressionEvaluationOptionsArgs {
             ...
             * The scope to be used for evaluation of parameters, variables and functions in a nested template.
             */
            scope?: pulumi.Input<string | enums.v20220901.ExpressionEvaluationOptionsScopeType>;
        }
        ...
        export interface ExtendedLocationArgs {
             ...
             * The extended location type.
             */
            type?: pulumi.Input<string | enums.v20220901.ExtendedLocationType>;
        }
        ...
        export interface IdentityArgs {
             ...
             * The identity type.
             */
            type?: pulumi.Input<enums.v20220901.ResourceIdentityType>;
            /**
             * The list of user identities associated with the resource. The user identity dictionary key references will be ARM resource ids in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}'.
             */
            userAssignedIdentities?: pulumi.Input<pulumi.Input<string>[]>;
        ...
        export interface KeyVaultParameterReferenceArgs {
             ...
             * Azure Key Vault reference.
             */
            keyVault: pulumi.Input<v20220901.KeyVaultReferenceArgs>;
            /**
             * Azure Key Vault secret name.
             */
            secretName: pulumi.Input<string>;
        ...
        export interface OnErrorDeploymentArgs {
             ...
             * The deployment on error behavior type. Possible values are LastSuccessful and SpecificDeployment.
             */
            type?: pulumi.Input<enums.v20220901.OnErrorDeploymentType>;
        }
    ...
    export namespace v20230701 {
        ...
        export interface DeploymentParameterArgs {
             ...
             * Azure Key Vault parameter reference.
             */
            reference?: pulumi.Input<v20230701.KeyVaultParameterReferenceArgs>;
            /**
             * Input value to the parameter .
             */
            value?: any;
        ...
        export interface DeploymentPropertiesArgs {
             ...
             * The debug setting of the deployment.
             */
            debugSetting?: pulumi.Input<v20230701.DebugSettingArgs>;
            /**
             * Specifies whether template expressions are evaluated within the scope of the parent template or nested template. Only applicable to nested templates. If not specified, default value is outer.
             */
            expressionEvaluationOptions?: pulumi.Input<v20230701.ExpressionEvaluationOptionsArgs>;
            /**
             * The mode that is used to deploy resources. This value can be either Incremental or Complete. In Incremental mode, resources are deployed without deleting existing resources that are not included in the template. In Complete mode, resources are deployed and existing resources in the resource group that are not included in the template are deleted. Be careful when using Complete mode as you may unintentionally delete resources.
             */
            mode: pulumi.Input<enums.v20230701.DeploymentMode>;
            /**
             * The deployment on error behavior.
             */
            onErrorDeployment?: pulumi.Input<v20230701.OnErrorDeploymentArgs>;
            /**
             * Name and value pairs that define the deployment parameters for the template. You use this element when you want to provide the parameter values directly in the request rather than link to an existing parameter file. Use either the parametersLink property or the parameters property, but not both. It can be a JObject or a well formed JSON string.
             */
            parameters?: pulumi.Input<{[key: string]: pulumi.Input<v20230701.DeploymentParameterArgs>}>;
            /**
             * The URI of parameters file. You use this element to link to an existing parameters file. Use either the parametersLink property or the parameters property, but not both.
             */
            parametersLink?: pulumi.Input<v20230701.ParametersLinkArgs>;
            /**
             * The template content. You use this element when you want to pass the template syntax directly in the request rather than link to an existing template. It can be a JObject or well-formed JSON string. Use either the templateLink property or the template property, but not both.
             */
            template?: any;
             ...
             * The URI of the template. Use either the templateLink property or the template property, but not both.
             */
            templateLink?: pulumi.Input<v20230701.TemplateLinkArgs>;
        }
        ...
        export interface ExpressionEvaluationOptionsArgs {
             ...
             * The scope to be used for evaluation of parameters, variables and functions in a nested template.
             */
            scope?: pulumi.Input<string | enums.v20230701.ExpressionEvaluationOptionsScopeType>;
        }
        ...
        export interface ExtendedLocationArgs {
             ...
             * The extended location type.
             */
            type?: pulumi.Input<string | enums.v20230701.ExtendedLocationType>;
        }
        ...
        export interface KeyVaultParameterReferenceArgs {
             ...
             * Azure Key Vault reference.
             */
            keyVault: pulumi.Input<v20230701.KeyVaultReferenceArgs>;
            /**
             * Azure Key Vault secret name.
             */
            secretName: pulumi.Input<string>;
        ...
        export interface OnErrorDeploymentArgs {
             ...
             * The deployment on error behavior type. Possible values are LastSuccessful and SpecificDeployment.
             */
            type?: pulumi.Input<enums.v20230701.OnErrorDeploymentType>;
        }

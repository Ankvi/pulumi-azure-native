...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:resources/v20220901:Deployment":
                return new Deployment(name, <any>undefined, { urn })
            case "azure-native:resources/v20220901:DeploymentAtManagementGroupScope":
                return new DeploymentAtManagementGroupScope(name, <any>undefined, { urn })
            case "azure-native:resources/v20220901:DeploymentAtScope":
                return new DeploymentAtScope(name, <any>undefined, { urn })
            case "azure-native:resources/v20220901:DeploymentAtSubscriptionScope":
                return new DeploymentAtSubscriptionScope(name, <any>undefined, { urn })
            case "azure-native:resources/v20220901:DeploymentAtTenantScope":
                return new DeploymentAtTenantScope(name, <any>undefined, { urn })
            case "azure-native:resources/v20220901:Resource":
                return new Resource(name, <any>undefined, { urn })
            case "azure-native:resources/v20220901:ResourceGroup":
                return new ResourceGroup(name, <any>undefined, { urn })
            case "azure-native:resources/v20220901:TagAtScope":
...
pulumi.runtime.registerResourceModule("azure-native", "resources/v20220901", _module)

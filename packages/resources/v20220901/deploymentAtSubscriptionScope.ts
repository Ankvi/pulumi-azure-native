...
export class DeploymentAtSubscriptionScope extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:resources/v20220901:DeploymentAtSubscriptionScope';

...
export function getResourceGroup(args: GetResourceGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetResourceGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-native:resources/v20220901:getResourceGroup", {
...
export interface GetResourceGroupResult {
     ...
     */
    readonly properties: types.outputs.resources.v20220901.ResourceGroupPropertiesResponse;
    /**

...
export class AzurePowerShellScript extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AzurePowerShellScriptArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:resources:AzurePowerShellScript" }, { type: "azure-native:resources/v20201001:AzurePowerShellScript" }, { type: "azure-native:resources/v20230801:AzurePowerShellScript" }] };

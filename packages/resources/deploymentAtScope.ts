...
export class DeploymentAtScope extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:resources:DeploymentAtScope';

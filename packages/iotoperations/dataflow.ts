...
export class Dataflow extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.DataflowPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: DataflowArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:iotoperations/v20240701preview:DataFlow" }, { type: "azure-native:iotoperations/v20240701preview:Dataflow" }, { type: "azure-native:iotoperations/v20240815preview:Dataflow" }, { type: "azure-native:iotoperations/v20240915preview:Dataflow" }, { type: "azure-native:iotoperations/v20241101:Dataflow" }, { type: "azure-native:iotoperations/v20250401:Dataflow" }, { type: "azure-native:iotoperations/v20250701preview:Dataflow" }, { type: "azure-native:iotoperations:DataFlow" }] };

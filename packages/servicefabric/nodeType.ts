...
export class NodeType extends pulumi.CustomResource {
     ...
     */
    declare public readonly additionalDataDisks: pulumi.Output<types.outputs.VmssDataDiskResponse[] | undefined>;
    /**
     * Specifies the settings for any additional secondary network interfaces to attach to the node type.
     */
    declare public readonly additionalNetworkInterfaceConfigurations: pulumi.Output<types.outputs.AdditionalNetworkInterfaceConfigurationResponse[] | undefined>;
    /**
     * The range of ports from which cluster assigned port to Service Fabric applications.
     */
    declare public readonly applicationPorts: pulumi.Output<types.outputs.EndpointRangeDescriptionResponse | undefined>;
    /**
     ...
     */
    declare public readonly ephemeralPorts: pulumi.Output<types.outputs.EndpointRangeDescriptionResponse | undefined>;
    /**
     ...
     */
    declare public readonly frontendConfigurations: pulumi.Output<types.outputs.FrontendConfigurationResponse[] | undefined>;
    /**
     ...
     */
    declare public readonly natConfigurations: pulumi.Output<types.outputs.NodeTypeNatConfigResponse[] | undefined>;
    /**
     ...
     */
    declare public readonly networkSecurityRules: pulumi.Output<types.outputs.NetworkSecurityRuleResponse[] | undefined>;
    /**
     ...
     * The node type sku.
     */
    declare public readonly sku: pulumi.Output<types.outputs.NodeTypeSkuResponse | undefined>;
    /**
     ...
     */
    declare public readonly vmExtensions: pulumi.Output<types.outputs.VMSSExtensionResponse[] | undefined>;
    /**
     ...
     */
    declare public readonly vmImagePlan: pulumi.Output<types.outputs.VmImagePlanResponse | undefined>;
    /**
     ...
     */
    declare public readonly vmManagedIdentity: pulumi.Output<types.outputs.VmManagedIdentityResponse | undefined>;
    /**
     * The secrets to install in the virtual machines.
     */
    declare public readonly vmSecrets: pulumi.Output<types.outputs.VaultSecretGroupResponse[] | undefined>;
    /**
...
export interface NodeTypeArgs {
     ...
     * Specifies the settings for any additional secondary network interfaces to attach to the node type.
     */
    additionalNetworkInterfaceConfigurations?: pulumi.Input<pulumi.Input<types.inputs.AdditionalNetworkInterfaceConfigurationArgs>[]>;
    /**
     * The range of ports from which cluster assigned port to Service Fabric applications.
     */
     ...
     * Specifies the NAT configuration on default public Load Balancer for the node type. This is only supported for node types use the default public Load Balancer.
     */
    natConfigurations?: pulumi.Input<pulumi.Input<types.inputs.NodeTypeNatConfigArgs>[]>;
    /**
     * Specifies the resource id of a NAT Gateway to attach to the subnet of this node type. Node type must use custom load balancer.
     */

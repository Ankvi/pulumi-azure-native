...
export class NodeType extends pulumi.CustomResource {
     ...
     */
    public readonly additionalNetworkInterfaceConfigurations!: pulumi.Output<types.outputs.AdditionalNetworkInterfaceConfigurationResponse[] | undefined>;
    /**
     ...
     */
    public readonly natConfigurations!: pulumi.Output<types.outputs.NodeTypeNatConfigResponse[] | undefined>;
    /**

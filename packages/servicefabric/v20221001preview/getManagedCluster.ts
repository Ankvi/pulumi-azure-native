...
export function getManagedCluster(args: GetManagedClusterArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedClusterResult> {
    ...
    return pulumi.runtime.invoke("azure-native:servicefabric/v20221001preview:getManagedCluster", {
...
export interface GetManagedClusterResult {
     ...
     */
    readonly applicationTypeVersionsCleanupPolicy?: types.outputs.servicefabric.v20221001preview.ApplicationTypeVersionsCleanupPolicyResponse;
    /**
     * Auxiliary subnets for the cluster.
     */
    readonly auxiliarySubnets?: types.outputs.servicefabric.v20221001preview.SubnetResponse[];
    /**
     * The AAD authentication settings of the cluster.
     */
    readonly azureActiveDirectory?: types.outputs.servicefabric.v20221001preview.AzureActiveDirectoryResponse;
    /**
     ...
     */
    readonly clients?: types.outputs.servicefabric.v20221001preview.ClientCertificateResponse[];
    /**
     ...
     */
    readonly fabricSettings?: types.outputs.servicefabric.v20221001preview.SettingsSectionDescriptionResponse[];
    /**
     ...
     */
    readonly ipTags?: types.outputs.servicefabric.v20221001preview.IPTagResponse[];
    /**
     ...
     */
    readonly loadBalancingRules?: types.outputs.servicefabric.v20221001preview.LoadBalancingRuleResponse[];
    /**
     ...
     */
    readonly networkSecurityRules?: types.outputs.servicefabric.v20221001preview.NetworkSecurityRuleResponse[];
    /**
     ...
     */
    readonly serviceEndpoints?: types.outputs.servicefabric.v20221001preview.ServiceEndpointResponse[];
    /**
     * The sku of the managed cluster
     */
    readonly sku?: types.outputs.servicefabric.v20221001preview.SkuResponse;
    /**
     ...
     */
    readonly systemData: types.outputs.servicefabric.v20221001preview.SystemDataResponse;
    /**
     * Azure resource tags.
     */

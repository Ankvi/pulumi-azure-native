...
export class ManagedClusterApplicationType extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:servicefabric/v20230901preview:ManagedClusterApplicationType';

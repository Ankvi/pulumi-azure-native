...
export class ManagedClusterApplication extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:servicefabric/v20230701preview:ManagedClusterApplication';

...
export interface GetManagedClusterResult {
     ...
     */
    readonly applicationTypeVersionsCleanupPolicy?: types.outputs.servicefabric.ApplicationTypeVersionsCleanupPolicyResponse;
    /**
     * Auxiliary subnets for the cluster.
     */
    readonly auxiliarySubnets?: types.outputs.servicefabric.SubnetResponse[];
    /**
     * The AAD authentication settings of the cluster.
     */
    readonly azureActiveDirectory?: types.outputs.servicefabric.AzureActiveDirectoryResponse;
    /**
     ...
     */
    readonly clients?: types.outputs.servicefabric.ClientCertificateResponse[];
    /**
     ...
     */
    readonly fabricSettings?: types.outputs.servicefabric.SettingsSectionDescriptionResponse[];
    /**
     ...
     */
    readonly ipTags?: types.outputs.servicefabric.IPTagResponse[];
    /**
     ...
     */
    readonly loadBalancingRules?: types.outputs.servicefabric.LoadBalancingRuleResponse[];
    /**
     ...
     */
    readonly serviceEndpoints?: types.outputs.servicefabric.ServiceEndpointResponse[];
    /**
     * The sku of the managed cluster
     */
    readonly sku: types.outputs.servicefabric.SkuResponse;
    /**

...
export class ManagedClusterApplicationType extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:servicefabric/v20231101preview:ManagedClusterApplicationType';

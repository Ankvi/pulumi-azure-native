...
export class ManagedCluster extends pulumi.CustomResource {
     ...
     */
    public readonly applicationTypeVersionsCleanupPolicy!: pulumi.Output<types.outputs.servicefabric.v20230301preview.ApplicationTypeVersionsCleanupPolicyResponse | undefined>;
    /**
     * Auxiliary subnets for the cluster.
     */
    public readonly auxiliarySubnets!: pulumi.Output<types.outputs.servicefabric.v20230301preview.SubnetResponse[] | undefined>;
    /**
     * The AAD authentication settings of the cluster.
     */
    public readonly azureActiveDirectory!: pulumi.Output<types.outputs.servicefabric.v20230301preview.AzureActiveDirectoryResponse | undefined>;
    /**
     ...
     */
    public readonly clients!: pulumi.Output<types.outputs.servicefabric.v20230301preview.ClientCertificateResponse[] | undefined>;
    /**
     ...
     */
    public readonly fabricSettings!: pulumi.Output<types.outputs.servicefabric.v20230301preview.SettingsSectionDescriptionResponse[] | undefined>;
    /**
     ...
     */
    public readonly ipTags!: pulumi.Output<types.outputs.servicefabric.v20230301preview.IPTagResponse[] | undefined>;
    /**
     ...
     */
    public readonly loadBalancingRules!: pulumi.Output<types.outputs.servicefabric.v20230301preview.LoadBalancingRuleResponse[] | undefined>;
    /**
     ...
     */
    public readonly networkSecurityRules!: pulumi.Output<types.outputs.servicefabric.v20230301preview.NetworkSecurityRuleResponse[] | undefined>;
    /**
     ...
     */
    public readonly serviceEndpoints!: pulumi.Output<types.outputs.servicefabric.v20230301preview.ServiceEndpointResponse[] | undefined>;
    /**
     * The sku of the managed cluster
     */
    public readonly sku!: pulumi.Output<types.outputs.servicefabric.v20230301preview.SkuResponse>;
    /**
...
export interface ManagedClusterArgs {
     ...
     * List of add-on features to enable on the cluster.
     */
    addonFeatures?: pulumi.Input<pulumi.Input<string | types.enums.v20230301preview.ManagedClusterAddOnFeature>[]>;
    /**
     * VM admin user password.
     */
     ...
     * The policy used to clean up unused versions.
     */
    applicationTypeVersionsCleanupPolicy?: pulumi.Input<types.inputs.servicefabric.v20230301preview.ApplicationTypeVersionsCleanupPolicyArgs>;
    /**
     * Auxiliary subnets for the cluster.
     */
    auxiliarySubnets?: pulumi.Input<pulumi.Input<types.inputs.servicefabric.v20230301preview.SubnetArgs>[]>;
    /**
     * The AAD authentication settings of the cluster.
     */
    azureActiveDirectory?: pulumi.Input<types.inputs.servicefabric.v20230301preview.AzureActiveDirectoryArgs>;
    /**
     * The port used for client connections to the cluster.
     */
     ...
     * Client certificates that are allowed to manage the cluster.
     */
    clients?: pulumi.Input<pulumi.Input<types.inputs.servicefabric.v20230301preview.ClientCertificateArgs>[]>;
    /**
     * The Service Fabric runtime version of the cluster. This property is required when **clusterUpgradeMode** is set to 'Manual'. To get list of available Service Fabric versions for new clusters use [ClusterVersion API](./ClusterVersion.md). To get the list of available version for existing clusters use **availableClusterVersions**.
     */
     ...
     * Indicates when new cluster runtime version upgrades will be applied after they are released. By default is Wave0. Only applies when **clusterUpgradeMode** is set to 'Automatic'.
     */
    clusterUpgradeCadence?: pulumi.Input<string | types.enums.v20230301preview.ClusterUpgradeCadence>;
    /**
     * The upgrade mode of the cluster when new Service Fabric runtime version is available.
     */
    clusterUpgradeMode?: pulumi.Input<string | types.enums.v20230301preview.ClusterUpgradeMode>;
    /**
     * The cluster dns name.
     */
     ...
     * The list of custom fabric settings to configure the cluster.
     */
    fabricSettings?: pulumi.Input<pulumi.Input<types.inputs.servicefabric.v20230301preview.SettingsSectionDescriptionArgs>[]>;
    /**
     * The port used for HTTP connections to the cluster.
     */
     ...
     * The list of IP tags associated with the default public IP address of the cluster.
     */
    ipTags?: pulumi.Input<pulumi.Input<types.inputs.servicefabric.v20230301preview.IPTagArgs>[]>;
    /**
     * Load balancing rules that are applied to the public load balancer of the cluster.
     */
    loadBalancingRules?: pulumi.Input<pulumi.Input<types.inputs.servicefabric.v20230301preview.LoadBalancingRuleArgs>[]>;
    /**
     * Azure resource location.
     */
     ...
     * Custom Network Security Rules that are applied to the Virtual Network of the cluster.
     */
    networkSecurityRules?: pulumi.Input<pulumi.Input<types.inputs.servicefabric.v20230301preview.NetworkSecurityRuleArgs>[]>;
    /**
     * Specify the resource id of a public IP prefix that the load balancer will allocate a public IP address from. Only supports IPv4.
     */
     ...
     * Service endpoints for subnets in the cluster.
     */
    serviceEndpoints?: pulumi.Input<pulumi.Input<types.inputs.servicefabric.v20230301preview.ServiceEndpointArgs>[]>;
    /**
     * The sku of the managed cluster
     */
    sku: pulumi.Input<types.inputs.servicefabric.v20230301preview.SkuArgs>;
    /**
     * If specified, the node types for the cluster are created in this subnet instead of the default VNet. The **networkSecurityRules** specified for the cluster are also applied to this subnet. This setting cannot be changed once the cluster is created.
     */
     ...
     * Indicates the update mode for Cross Az clusters.
     */
    zonalUpdateMode?: pulumi.Input<string | types.enums.v20230301preview.ZonalUpdateMode>;
}

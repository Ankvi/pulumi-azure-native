...
export class ManagedClusterApplicationTypeVersion extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:servicefabric/v20230301preview:ManagedClusterApplicationTypeVersion';

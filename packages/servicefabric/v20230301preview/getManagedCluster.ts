...
export function getManagedCluster(args: GetManagedClusterArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedClusterResult> {
    ...
    return pulumi.runtime.invoke("azure-native:servicefabric/v20230301preview:getManagedCluster", {
...
export interface GetManagedClusterResult {
     ...
     */
    readonly applicationTypeVersionsCleanupPolicy?: types.outputs.servicefabric.v20230301preview.ApplicationTypeVersionsCleanupPolicyResponse;
    /**
     * Auxiliary subnets for the cluster.
     */
    readonly auxiliarySubnets?: types.outputs.servicefabric.v20230301preview.SubnetResponse[];
    /**
     * The AAD authentication settings of the cluster.
     */
    readonly azureActiveDirectory?: types.outputs.servicefabric.v20230301preview.AzureActiveDirectoryResponse;
    /**
     ...
     */
    readonly clients?: types.outputs.servicefabric.v20230301preview.ClientCertificateResponse[];
    /**
     ...
     */
    readonly fabricSettings?: types.outputs.servicefabric.v20230301preview.SettingsSectionDescriptionResponse[];
    /**
     ...
     */
    readonly ipTags?: types.outputs.servicefabric.v20230301preview.IPTagResponse[];
    /**
     ...
     */
    readonly loadBalancingRules?: types.outputs.servicefabric.v20230301preview.LoadBalancingRuleResponse[];
    /**
     ...
     */
    readonly networkSecurityRules?: types.outputs.servicefabric.v20230301preview.NetworkSecurityRuleResponse[];
    /**
     ...
     */
    readonly serviceEndpoints?: types.outputs.servicefabric.v20230301preview.ServiceEndpointResponse[];
    /**
     * The sku of the managed cluster
     */
    readonly sku: types.outputs.servicefabric.v20230301preview.SkuResponse;
    /**
     ...
     */
    readonly systemData: types.outputs.servicefabric.v20230301preview.SystemDataResponse;
    /**
     * Azure resource tags.
     */

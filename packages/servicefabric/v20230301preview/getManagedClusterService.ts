...
export function getManagedClusterService(args: GetManagedClusterServiceArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedClusterServiceResult> {
    ...
    return pulumi.runtime.invoke("azure-native:servicefabric/v20230301preview:getManagedClusterService", {
...
export interface GetManagedClusterServiceResult {
     ...
     */
    readonly properties: types.outputs.servicefabric.v20230301preview.StatefulServicePropertiesResponse | types.outputs.servicefabric.v20230301preview.StatelessServicePropertiesResponse;
    /**

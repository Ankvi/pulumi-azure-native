...
export class ManagedClusterApplication extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:servicefabric/v20230301preview:ManagedClusterApplication';
     ...
     */
    public readonly identity!: pulumi.Output<types.outputs.servicefabric.v20230301preview.ManagedIdentityResponse | undefined>;
    /**
     ...
     */
    public readonly managedIdentities!: pulumi.Output<types.outputs.servicefabric.v20230301preview.ApplicationUserAssignedIdentityResponse[] | undefined>;
    /**
     * Azure resource name.
     */
     ...
     */
    public readonly upgradePolicy!: pulumi.Output<types.outputs.servicefabric.v20230301preview.ApplicationUpgradePolicyResponse | undefined>;
    /**
...
export interface ManagedClusterApplicationArgs {
     ...
     * Describes the managed identities for an Azure resource.
     */
    identity?: pulumi.Input<types.inputs.servicefabric.v20230301preview.ManagedIdentityArgs>;
    /**
     * Resource location depends on the parent resource.
     */
     ...
     * List of user assigned identities for the application, each mapped to a friendly name.
     */
    managedIdentities?: pulumi.Input<pulumi.Input<types.inputs.servicefabric.v20230301preview.ApplicationUserAssignedIdentityArgs>[]>;
    /**
     * List of application parameters with overridden values from their default values specified in the application manifest.
     */
     ...
     * Describes the policy for a monitored application upgrade.
     */
    upgradePolicy?: pulumi.Input<types.inputs.servicefabric.v20230301preview.ApplicationUpgradePolicyArgs>;
    /**
     * The version of the application type as defined in the application manifest.
     * This name must be the full Arm Resource ID for the referenced application type version.
     */

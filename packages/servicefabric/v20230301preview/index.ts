...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:servicefabric/v20230301preview:ManagedCluster":
                return new ManagedCluster(name, <any>undefined, { urn })
            case "azure-native:servicefabric/v20230301preview:ManagedClusterApplication":
                return new ManagedClusterApplication(name, <any>undefined, { urn })
            case "azure-native:servicefabric/v20230301preview:ManagedClusterApplicationType":
                return new ManagedClusterApplicationType(name, <any>undefined, { urn })
            case "azure-native:servicefabric/v20230301preview:ManagedClusterApplicationTypeVersion":
                return new ManagedClusterApplicationTypeVersion(name, <any>undefined, { urn })
            case "azure-native:servicefabric/v20230301preview:ManagedClusterService":
                return new ManagedClusterService(name, <any>undefined, { urn })
            case "azure-native:servicefabric/v20230301preview:NodeType":
...
pulumi.runtime.registerResourceModule("azure-native", "servicefabric/v20230301preview", _module)

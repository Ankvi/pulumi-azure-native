...
export class Step extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:deploymentmanager:Step';
    ...
    constructor(name: string, args: StepArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:deploymentmanager/v20180901preview:Step" }, { type: "azure-native:deploymentmanager/v20191101preview:Step" }] };

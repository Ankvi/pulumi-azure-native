...
export class AzureBareMetalStorageInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:baremetalinfrastructure/v20230804preview:AzureBareMetalStorageInstance';
    ...
    constructor(name: string, args: AzureBareMetalStorageInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:baremetalinfrastructure:AzureBareMetalStorageInstance" }, { type: "azure-native:baremetalinfrastructure/v20230406:AzureBareMetalStorageInstance" }, { type: "azure-native:baremetalinfrastructure/v20231101preview:AzureBareMetalStorageInstance" }] };

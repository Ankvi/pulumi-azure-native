...
export class AzureBareMetalStorageInstance extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AzureBareMetalStorageInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:baremetalinfrastructure:AzureBareMetalStorageInstance" }, { type: "azure-native:baremetalinfrastructure/v20230406:AzureBareMetalStorageInstance" }] };

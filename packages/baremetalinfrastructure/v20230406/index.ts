...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:baremetalinfrastructure/v20230406:AzureBareMetalStorageInstance":
...
pulumi.runtime.registerResourceModule("azure-native", "baremetalinfrastructure/v20230406", _module)
...
export class AzureBareMetalStorageInstance extends pulumi.CustomResource {
     ...
     */
    declare public readonly identity: pulumi.Output<types.outputs.AzureBareMetalStorageInstanceIdentityResponse | undefined>;
    /**
     ...
     */
    declare public readonly storageProperties: pulumi.Output<types.outputs.StoragePropertiesResponse | undefined>;
    /**

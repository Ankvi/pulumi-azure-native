...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:networkfunction/v20221101:AzureTrafficCollector":
                return new AzureTrafficCollector(name, <any>undefined, { urn })
            case "azure-native:networkfunction/v20221101:CollectorPolicy":
...
pulumi.runtime.registerResourceModule("azure-native", "networkfunction/v20221101", _module)

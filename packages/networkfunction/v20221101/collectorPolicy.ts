...
export class CollectorPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkfunction/v20221101:CollectorPolicy';
     ...
     * Emission policies.
     */
    public readonly emissionPolicies!: pulumi.Output<types.outputs.networkfunction.v20221101.EmissionPoliciesPropertiesFormatResponse[] | undefined>;
    /**
     ...
     * Ingestion policies.
     */
    public readonly ingestionPolicy!: pulumi.Output<types.outputs.networkfunction.v20221101.IngestionPolicyPropertiesFormatResponse | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<types.outputs.networkfunction.v20221101.TrackedResourceResponseSystemData>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: CollectorPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkfunction:CollectorPolicy" }, { type: "azure-native:networkfunction/v20210901preview:CollectorPolicy" }, { type: "azure-native:networkfunction/v20220501:CollectorPolicy" }, { type: "azure-native:networkfunction/v20220801:CollectorPolicy" }] };
...
export interface CollectorPolicyArgs {
     ...
     * Emission policies.
     */
    emissionPolicies?: pulumi.Input<pulumi.Input<types.inputs.networkfunction.v20221101.EmissionPoliciesPropertiesFormatArgs>[]>;
    /**
     * Ingestion policies.
     */
    ingestionPolicy?: pulumi.Input<types.inputs.networkfunction.v20221101.IngestionPolicyPropertiesFormatArgs>;
    /**
     * Resource location.
     */

...
export class AzureTrafficCollector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkfunction/v20221101:AzureTrafficCollector';
     ...
     */
    public /*out*/ readonly collectorPolicies!: pulumi.Output<types.outputs.networkfunction.v20221101.ResourceReferenceResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly virtualHub!: pulumi.Output<types.outputs.networkfunction.v20221101.ResourceReferenceResponse | undefined>;
    ...
    constructor(name: string, args: AzureTrafficCollectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkfunction:AzureTrafficCollector" }, { type: "azure-native:networkfunction/v20210901preview:AzureTrafficCollector" }, { type: "azure-native:networkfunction/v20220501:AzureTrafficCollector" }, { type: "azure-native:networkfunction/v20220801:AzureTrafficCollector" }] };

...
export class AzureTrafficCollector extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly collectorPolicies: pulumi.Output<types.outputs.ResourceReferenceResponse[]>;
    /**
     ...
     */
    declare public /*out*/ readonly virtualHub: pulumi.Output<types.outputs.ResourceReferenceResponse | undefined>;

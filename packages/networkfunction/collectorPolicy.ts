...
export class CollectorPolicy extends pulumi.CustomResource {
     ...
     * Emission policies.
     */
    declare public readonly emissionPolicies: pulumi.Output<types.outputs.EmissionPoliciesPropertiesFormatResponse[] | undefined>;
    /**
     ...
     * Ingestion policies.
     */
    declare public readonly ingestionPolicy: pulumi.Output<types.outputs.IngestionPolicyPropertiesFormatResponse | undefined>;
    /**
     * Resource location.
     */

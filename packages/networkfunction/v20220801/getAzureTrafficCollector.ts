...
export interface GetAzureTrafficCollectorResult {
     ...
     */
    readonly collectorPolicies?: types.outputs.networkfunction.v20220801.CollectorPolicyResponse[];
    /**
     ...
     */
    readonly systemData: types.outputs.networkfunction.v20220801.TrackedResourceResponseSystemData;
    /**
     * Resource tags.
     */
     ...
     */
    readonly virtualHub?: types.outputs.networkfunction.v20220801.ResourceReferenceResponse;
}
/**
 * Gets the specified Azure Traffic Collector in a specified resource group
 */

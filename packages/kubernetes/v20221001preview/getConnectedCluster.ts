...
export function getConnectedCluster(args: GetConnectedClusterArgs, opts?: pulumi.InvokeOptions): Promise<GetConnectedClusterResult> {
    ...
    return pulumi.runtime.invoke("azure-native:kubernetes/v20221001preview:getConnectedCluster", {
...
export interface GetConnectedClusterResult {
     ...
     */
    readonly identity: types.outputs.kubernetes.v20221001preview.ConnectedClusterIdentityResponse;
    /**
     ...
     */
    readonly systemData: types.outputs.kubernetes.v20221001preview.SystemDataResponse;
    /**
     * Resource tags.
     */

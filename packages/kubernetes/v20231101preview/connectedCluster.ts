...
export class ConnectedCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:kubernetes/v20231101preview:ConnectedCluster';

...
export function listConnectedClusterUserCredentials(args: ListConnectedClusterUserCredentialsArgs, opts?: pulumi.InvokeOptions): Promise<ListConnectedClusterUserCredentialsResult> {
    ...
    return pulumi.runtime.invoke("azure-native:kubernetes/v20210401preview:listConnectedClusterUserCredentials", {
...
export interface ListConnectedClusterUserCredentialsArgs {
     ...
     */
    authenticationMethod: string | types.enums.v20210401preview.AuthenticationMethod;
    /**
...
export interface ListConnectedClusterUserCredentialsResult {
     ...
     */
    readonly hybridConnectionConfig: types.outputs.kubernetes.v20210401preview.HybridConnectionConfigResponse;
    /**
     * Base64-encoded Kubernetes configuration file.
     */
    readonly kubeconfigs: types.outputs.kubernetes.v20210401preview.CredentialResultResponse[];
}
/**
 * Gets cluster user credentials of the connected cluster with a specified resource group and name.
 */
...
export interface ListConnectedClusterUserCredentialsOutputArgs {
     ...
     * The mode of client authentication.
     */
    authenticationMethod: pulumi.Input<string | types.enums.v20210401preview.AuthenticationMethod>;
    /**
     * Boolean value to indicate whether the request is for client side proxy or not
     */

...
export class OperatorApiConnection extends pulumi.CustomResource {
     ...
     */
    declare public readonly configuredApplication: pulumi.Output<types.outputs.ApplicationPropertiesResponse | undefined>;
    /**
     ...
     */
    declare public readonly saasProperties: pulumi.Output<types.outputs.SaasPropertiesResponse | undefined>;
    /**

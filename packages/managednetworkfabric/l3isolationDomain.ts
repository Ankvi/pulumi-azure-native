...
export class L3IsolationDomain extends pulumi.CustomResource {
     ...
     */
    declare public readonly aggregateRouteConfiguration: pulumi.Output<types.outputs.AggregateRouteConfigurationResponse | undefined>;
    /**
     ...
     */
    declare public readonly connectedSubnetRoutePolicy: pulumi.Output<types.outputs.ConnectedSubnetRoutePolicyResponse | undefined>;
    /**

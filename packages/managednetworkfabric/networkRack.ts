...
export class NetworkRack extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly networkDevices: pulumi.Output<string[]>;
    /**
     ...
     */
    declare public readonly networkRackType: pulumi.Output<string | undefined>;
    /**
    ...
    constructor(name: string, args: NetworkRackArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["networkRackName"] = args?.networkRackName;
            resourceInputs["networkRackType"] = args?.networkRackType;

...
export class AccessControlList extends pulumi.CustomResource {
     ...
     */
    declare public readonly dynamicMatchConfigurations: pulumi.Output<types.outputs.CommonDynamicMatchConfigurationResponse[] | undefined>;
    /**
     ...
     */
    declare public readonly matchConfigurations: pulumi.Output<types.outputs.AccessControlListMatchConfigurationResponse[] | undefined>;
    /**

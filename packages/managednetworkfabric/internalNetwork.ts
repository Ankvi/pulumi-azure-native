...
export class InternalNetwork extends pulumi.CustomResource {
     ...
     */
    public readonly bgpConfiguration!: pulumi.Output<types.outputs.managednetworkfabric.BgpConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly connectedIPv4Subnets!: pulumi.Output<types.outputs.managednetworkfabric.ConnectedSubnetResponse[] | undefined>;
    /**
     * List with object connected IPv6 Subnets.
     */
    public readonly connectedIPv6Subnets!: pulumi.Output<types.outputs.managednetworkfabric.ConnectedSubnetResponse[] | undefined>;
    /**
     ...
     */
    public readonly staticRouteConfiguration!: pulumi.Output<types.outputs.managednetworkfabric.StaticRouteConfigurationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: InternalNetworkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["bgpConfiguration"] = args ? (args.bgpConfiguration ? pulumi.output(args.bgpConfiguration).apply(types.inputs.managednetworkfabric.bgpConfigurationArgsProvideDefaults) : undefined) : undefined;
...
export interface InternalNetworkArgs {
     ...
     * BGP configuration properties
     */
    bgpConfiguration?: pulumi.Input<types.inputs.managednetworkfabric.BgpConfigurationArgs>;
    /**
     * List with object connected IPv4 Subnets.
     */
    connectedIPv4Subnets?: pulumi.Input<pulumi.Input<types.inputs.managednetworkfabric.ConnectedSubnetArgs>[]>;
    /**
     * List with object connected IPv6 Subnets.
     */
    connectedIPv6Subnets?: pulumi.Input<pulumi.Input<types.inputs.managednetworkfabric.ConnectedSubnetArgs>[]>;
    /**
     * ARM resource ID of importRoutePolicy.
     */
     ...
     * Static Route Configuration properties.
     */
    staticRouteConfiguration?: pulumi.Input<types.inputs.managednetworkfabric.StaticRouteConfigurationArgs>;
    /**
     * Vlan identifier. Example: 1001.
     */

...
export class NetworkFabric extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:managednetworkfabric/v20230201preview:NetworkFabric';
     ...
     */
    public readonly managementNetworkConfiguration!: pulumi.Output<types.outputs.managednetworkfabric.v20230201preview.ManagementNetworkConfigurationResponse>;
    /**
     ...
     */
    public readonly terminalServerConfiguration!: pulumi.Output<types.outputs.managednetworkfabric.v20230201preview.TerminalServerConfigurationResponse>;
    /**
    ...
    constructor(name: string, args: NetworkFabricArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["managementNetworkConfiguration"] = args ? (args.managementNetworkConfiguration ? pulumi.output(args.managementNetworkConfiguration).apply(types.inputs.managednetworkfabric.v20230201preview.managementNetworkConfigurationArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:managednetworkfabric:NetworkFabric" }, { type: "azure-native:managednetworkfabric/v20230615:NetworkFabric" }] };
...
export interface NetworkFabricArgs {
     ...
     * Configuration to be used to setup the management network.
     */
    managementNetworkConfiguration: pulumi.Input<types.inputs.managednetworkfabric.v20230201preview.ManagementNetworkConfigurationArgs>;
    /**
     * Azure resource ID for the NetworkFabricController the NetworkFabric belongs.
     */
     ...
     * Network and credentials configuration currently applied to terminal server.
     */
    terminalServerConfiguration: pulumi.Input<types.inputs.managednetworkfabric.v20230201preview.TerminalServerConfigurationArgs>;
}

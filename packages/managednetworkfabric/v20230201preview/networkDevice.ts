...
export class NetworkDevice extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:managednetworkfabric/v20230201preview:NetworkDevice';
    ...
    constructor(name: string, args: NetworkDeviceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:managednetworkfabric:NetworkDevice" }, { type: "azure-native:managednetworkfabric/v20230615:NetworkDevice" }] };

...
export class NetworkRack extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:managednetworkfabric/v20230201preview:NetworkRack';
    ...
    constructor(name: string, args: NetworkRackArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:managednetworkfabric:NetworkRack" }, { type: "azure-native:managednetworkfabric/v20230615:NetworkRack" }] };

...
export class IpPrefix extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:managednetworkfabric/v20230201preview:IpPrefix';
    ...
    constructor(name: string, args: IpPrefixArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:managednetworkfabric:IpPrefix" }, { type: "azure-native:managednetworkfabric/v20230615:IpPrefix" }] };

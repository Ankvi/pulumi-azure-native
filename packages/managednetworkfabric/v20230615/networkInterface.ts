...
export class NetworkInterface extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:managednetworkfabric/v20230615:NetworkInterface';
    ...
    constructor(name: string, args: NetworkInterfaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:managednetworkfabric:NetworkInterface" }, { type: "azure-native:managednetworkfabric/v20230201preview:NetworkInterface" }] };

...
export class L2IsolationDomain extends pulumi.CustomResource {
    ...
    constructor(name: string, args: L2IsolationDomainArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:managednetworkfabric:L2IsolationDomain" }, { type: "azure-native:managednetworkfabric/v20230201preview:L2IsolationDomain" }] };

...
export class AccessControlList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:managednetworkfabric/v20230615:AccessControlList';
    ...
    constructor(name: string, args: AccessControlListArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:managednetworkfabric:AccessControlList" }, { type: "azure-native:managednetworkfabric/v20230201preview:AccessControlList" }] };

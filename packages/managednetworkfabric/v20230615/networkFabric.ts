...
export class NetworkFabric extends pulumi.CustomResource {
     ...
     */
    public readonly managementNetworkConfiguration!: pulumi.Output<types.outputs.managednetworkfabric.v20230615.ManagementNetworkConfigurationPropertiesResponse>;
    /**
     ...
     */
    public readonly terminalServerConfiguration!: pulumi.Output<types.outputs.managednetworkfabric.v20230615.TerminalServerConfigurationResponse>;
    /**
    ...
    constructor(name: string, args: NetworkFabricArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["managementNetworkConfiguration"] = args ? (args.managementNetworkConfiguration ? pulumi.output(args.managementNetworkConfiguration).apply(types.inputs.managednetworkfabric.v20230615.managementNetworkConfigurationPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface NetworkFabricArgs {
     ...
     * Configuration to be used to setup the management network.
     */
    managementNetworkConfiguration: pulumi.Input<types.inputs.managednetworkfabric.v20230615.ManagementNetworkConfigurationPropertiesArgs>;
    /**
     * Azure resource ID for the NetworkFabricController the NetworkFabric belongs.
     */
     ...
     * Network and credentials configuration currently applied to terminal server.
     */
    terminalServerConfiguration: pulumi.Input<types.inputs.managednetworkfabric.v20230615.TerminalServerConfigurationArgs>;
}

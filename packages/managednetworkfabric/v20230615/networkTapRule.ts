...
export class NetworkTapRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:managednetworkfabric/v20230615:NetworkTapRule';
     ...
     */
    public readonly matchConfigurations!: pulumi.Output<types.outputs.managednetworkfabric.v20230615.NetworkTapRuleMatchConfigurationResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: NetworkTapRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:managednetworkfabric:NetworkTapRule" }] };
...
export interface NetworkTapRuleArgs {
     ...
     * List of match configurations.
     */
    matchConfigurations?: pulumi.Input<pulumi.Input<types.inputs.managednetworkfabric.v20230615.NetworkTapRuleMatchConfigurationArgs>[]>;
    /**

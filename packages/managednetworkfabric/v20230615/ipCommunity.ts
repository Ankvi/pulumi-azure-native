...
export class IpCommunity extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:managednetworkfabric/v20230615:IpCommunity';
    ...
    constructor(name: string, args: IpCommunityArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:managednetworkfabric:IpCommunity" }, { type: "azure-native:managednetworkfabric/v20230201preview:IpCommunity" }] };

...
export class NetworkPacketBroker extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:managednetworkfabric/v20230615:NetworkPacketBroker';
    ...
    constructor(name: string, args: NetworkPacketBrokerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:managednetworkfabric:NetworkPacketBroker" }] };

...
export class ExternalNetwork extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:managednetworkfabric/v20230615:ExternalNetwork';
    ...
    constructor(name: string, args: ExternalNetworkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:managednetworkfabric:ExternalNetwork" }, { type: "azure-native:managednetworkfabric/v20230201preview:ExternalNetwork" }] };

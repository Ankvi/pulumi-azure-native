...
export class IpPrefix extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:managednetworkfabric/v20230615:IpPrefix';
     ...
     */
    public readonly ipPrefixRules!: pulumi.Output<types.outputs.managednetworkfabric.v20230615.IpPrefixRuleResponse[]>;
    /**
    ...
    constructor(name: string, args: IpPrefixArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:managednetworkfabric:IpPrefix" }, { type: "azure-native:managednetworkfabric/v20230201preview:IpPrefix" }] };
...
export interface IpPrefixArgs {
     ...
     * The list of IP Prefix Rules.
     */
    ipPrefixRules: pulumi.Input<pulumi.Input<types.inputs.managednetworkfabric.v20230615.IpPrefixRuleArgs>[]>;
    /**
     * The geo-location where the resource lives
     */

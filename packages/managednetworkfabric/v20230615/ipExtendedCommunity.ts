...
export class IpExtendedCommunity extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:managednetworkfabric/v20230615:IpExtendedCommunity';
    ...
    constructor(name: string, args: IpExtendedCommunityArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:managednetworkfabric:IpExtendedCommunity" }, { type: "azure-native:managednetworkfabric/v20230201preview:IpExtendedCommunity" }] };

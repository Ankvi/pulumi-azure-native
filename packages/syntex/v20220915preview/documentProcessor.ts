...
export class DocumentProcessor extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:syntex/v20220915preview:DocumentProcessor';
    ...
    constructor(name: string, args: DocumentProcessorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:syntex:DocumentProcessor" }] };

...
export class GraphQuery extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:resourcegraph/v20180901preview:GraphQuery';
    ...
    constructor(name: string, args: GraphQueryArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:resourcegraph:GraphQuery" }, { type: "azure-native:resourcegraph/v20200401preview:GraphQuery" }] };

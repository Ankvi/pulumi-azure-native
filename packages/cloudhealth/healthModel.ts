...
export class HealthModel extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cloudhealth:HealthModel';
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.HealthModelPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: HealthModelArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cloudhealth/v20250501preview:HealthModel" }] };

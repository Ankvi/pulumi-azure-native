...
export class AuthenticationSetting extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AuthenticationSetting {
        return new AuthenticationSetting(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:cloudhealth:AuthenticationSetting';
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.ManagedIdentityAuthenticationSettingPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: AuthenticationSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["authenticationSettingName"] = args ? args.authenticationSettingName : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cloudhealth/v20250501preview:AuthenticationSetting" }] };

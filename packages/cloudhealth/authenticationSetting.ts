...
export class AuthenticationSetting extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.ManagedIdentityAuthenticationSettingPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: AuthenticationSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["authenticationSettingName"] = args?.authenticationSettingName;

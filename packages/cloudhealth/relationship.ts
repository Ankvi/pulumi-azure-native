...
export class Relationship extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cloudhealth:Relationship';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.RelationshipPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: RelationshipArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cloudhealth/v20250501preview:Relationship" }] };
...
export interface RelationshipArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.RelationshipPropertiesArgs>;
    /**

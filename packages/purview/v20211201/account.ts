...
export class Account extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:purview/v20211201:Account';
    ...
    constructor(name: string, args: AccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:purview:Account" }, { type: "azure-native:purview/v20201201preview:Account" }, { type: "azure-native:purview/v20210701:Account" }, { type: "azure-native:purview/v20230501preview:Account" }] };

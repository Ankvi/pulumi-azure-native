...
export class Account extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:purview:Account" }, { type: "azure-native:purview/v20201201preview:Account" }, { type: "azure-native:purview/v20210701:Account" }] };

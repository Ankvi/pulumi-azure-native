...
export class KafkaConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:purview/v20230501preview:KafkaConfiguration';
    ...
    constructor(name: string, args: KafkaConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:purview:KafkaConfiguration" }, { type: "azure-native:purview/v20211201:KafkaConfiguration" }] };

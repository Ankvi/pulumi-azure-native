...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:purview/v20230501preview:PrivateEndpointConnection';
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:purview:PrivateEndpointConnection" }, { type: "azure-native:purview/v20201201preview:PrivateEndpointConnection" }, { type: "azure-native:purview/v20210701:PrivateEndpointConnection" }, { type: "azure-native:purview/v20211201:PrivateEndpointConnection" }] };

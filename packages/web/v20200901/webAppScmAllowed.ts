...
export class WebAppScmAllowed extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20200901:WebAppScmAllowed';
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<types.outputs.web.v20200901.SystemDataResponse>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: WebAppScmAllowedArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:web:WebAppScmAllowed" }, { type: "azure-native:web/v20190801:WebAppScmAllowed" }, { type: "azure-native:web/v20200601:WebAppScmAllowed" }, { type: "azure-native:web/v20201001:WebAppScmAllowed" }, { type: "azure-native:web/v20201201:WebAppScmAllowed" }, { type: "azure-native:web/v20210101:WebAppScmAllowed" }, { type: "azure-native:web/v20210115:WebAppScmAllowed" }, { type: "azure-native:web/v20210201:WebAppScmAllowed" }, { type: "azure-native:web/v20210301:WebAppScmAllowed" }, { type: "azure-native:web/v20220301:WebAppScmAllowed" }, { type: "azure-native:web/v20220901:WebAppScmAllowed" }] };

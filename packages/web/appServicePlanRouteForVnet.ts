...
export class AppServicePlanRouteForVnet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web:AppServicePlanRouteForVnet';

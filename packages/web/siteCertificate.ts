...
export class SiteCertificate extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly hostingEnvironmentProfile: pulumi.Output<types.outputs.HostingEnvironmentProfileResponse>;
    /**
    ...
    constructor(name: string, args: SiteCertificateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:web/v20241101:SiteCertificate" }] };

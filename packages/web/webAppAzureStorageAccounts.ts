...
export class WebAppAzureStorageAccounts extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<{[key: string]: types.outputs.AzureStorageInfoValueResponse}>;
    /**
     * Resource type.
     */

...
export class WebAppSlot extends pulumi.CustomResource {
     ...
     */
    public readonly dnsConfiguration!: pulumi.Output<types.outputs.SiteDnsConfigResponse | undefined>;
    /**
     ...
     */
    public readonly functionAppConfig!: pulumi.Output<types.outputs.FunctionAppConfigResponse | undefined>;
    /**
    ...
    constructor(name: string, args: WebAppSlotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["vnetBackupRestoreEnabled"] = args ? args.vnetBackupRestoreEnabled : undefined;

...
export class WebAppConnectionStrings extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web:WebAppConnectionStrings';
     ...
     * Connection strings.
     */
    declare public readonly properties: pulumi.Output<{[key: string]: types.outputs.ConnStringValueTypePairResponse}>;
    /**
     * Resource type.
     */

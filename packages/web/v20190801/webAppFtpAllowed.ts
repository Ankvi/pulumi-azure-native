...
export class WebAppFtpAllowed extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20190801:WebAppFtpAllowed';

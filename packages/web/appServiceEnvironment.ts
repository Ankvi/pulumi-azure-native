...
export class AppServiceEnvironment extends pulumi.CustomResource {
     ...
     */
    declare public readonly clusterSettings: pulumi.Output<types.outputs.NameValuePairResponse[] | undefined>;
    /**
     * Full view of the custom domain suffix configuration for ASEv3.
     */
    declare public readonly customDnsSuffixConfiguration: pulumi.Output<types.outputs.CustomDnsSuffixConfigurationResponse | undefined>;
    /**
     ...
     */
    declare public readonly networkingConfiguration: pulumi.Output<types.outputs.AseV3NetworkingConfigurationResponse | undefined>;
    /**
     ...
     */
    declare public readonly virtualNetwork: pulumi.Output<types.outputs.VirtualNetworkProfileResponse>;
    /**

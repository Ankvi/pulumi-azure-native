...
export class KubeEnvironment extends pulumi.CustomResource {
     ...
     */
    declare public readonly arcConfiguration: pulumi.Output<types.outputs.ArcConfigurationResponse | undefined>;
    /**
     ...
     */
    declare public readonly containerAppsConfiguration: pulumi.Output<types.outputs.ContainerAppsConfigurationResponse | undefined>;
    /**

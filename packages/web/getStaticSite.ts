...
export interface GetStaticSiteResult {
     ...
     */
    readonly buildProperties?: types.outputs.web.StaticSiteBuildPropertiesResponse;
    /**
     ...
     */
    readonly databaseConnections: types.outputs.web.DatabaseConnectionOverviewResponse[];
    /**
     ...
     */
    readonly linkedBackends: types.outputs.web.StaticSiteLinkedBackendResponse[];
    /**
     * Resource Location.
     */
     ...
     */
    readonly privateEndpointConnections: types.outputs.web.ResponseMessageEnvelopeRemotePrivateEndpointConnectionResponse[];
    /**
     ...
     */
    readonly templateProperties?: types.outputs.web.StaticSiteTemplateOptionsResponse;
    /**
     * Resource type.
     */
     ...
     */
    readonly userProvidedFunctionApps: types.outputs.web.StaticSiteUserProvidedFunctionAppResponse[];
}
/**
 * Description for Gets the details of a static site.
 * Azure REST API version: 2022-09-01.

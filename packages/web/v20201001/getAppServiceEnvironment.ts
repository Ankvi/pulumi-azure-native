...
export interface GetAppServiceEnvironmentResult {
     ...
     */
    readonly clusterSettings?: types.outputs.web.v20201001.NameValuePairResponse[];
    /**
     ...
     */
    readonly environmentCapacities: types.outputs.web.v20201001.StampCapacityResponse[];
    /**
     ...
     */
    readonly networkAccessControlList?: types.outputs.web.v20201001.NetworkAccessControlEntryResponse[];
    /**
     ...
     */
    readonly vipMappings: types.outputs.web.v20201001.VirtualIPMappingResponse[];
    /**
     * Description of the Virtual Network.
     */
    readonly virtualNetwork: types.outputs.web.v20201001.VirtualNetworkProfileResponse;
    /**
     ...
     */
    readonly workerPools: types.outputs.web.v20201001.WorkerPoolResponse[];
}
/**
 * Get the properties of an App Service Environment.
 */

...
export class WebAppAzureStorageAccounts extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20201001:WebAppAzureStorageAccounts';
     ...
     */
    public readonly properties!: pulumi.Output<{[key: string]: types.outputs.web.v20201001.AzureStorageInfoValueResponse}>;
    /**
...
export interface WebAppAzureStorageAccountsArgs {
     ...
     * Azure storage accounts.
     */
    properties?: pulumi.Input<{[key: string]: pulumi.Input<types.inputs.web.v20201001.AzureStorageInfoValueArgs>}>;
    /**

...
export class WebAppConnectionStringsSlot extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20201001:WebAppConnectionStringsSlot';
     ...
     * Connection strings.
     */
    public readonly properties!: pulumi.Output<{[key: string]: types.outputs.web.v20201001.ConnStringValueTypePairResponse}>;
    /**
...
export interface WebAppConnectionStringsSlotArgs {
     ...
     * Connection strings.
     */
    properties?: pulumi.Input<{[key: string]: pulumi.Input<types.inputs.web.v20201001.ConnStringValueTypePairArgs>}>;
    /**

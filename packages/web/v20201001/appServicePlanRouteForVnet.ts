...
export class AppServicePlanRouteForVnet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20201001:AppServicePlanRouteForVnet';
    ...
    constructor(name: string, args: AppServicePlanRouteForVnetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:web:AppServicePlanRouteForVnet" }, { type: "azure-native:web/v20150801:AppServicePlanRouteForVnet" }, { type: "azure-native:web/v20160901:AppServicePlanRouteForVnet" }, { type: "azure-native:web/v20180201:AppServicePlanRouteForVnet" }, { type: "azure-native:web/v20190801:AppServicePlanRouteForVnet" }, { type: "azure-native:web/v20200601:AppServicePlanRouteForVnet" }, { type: "azure-native:web/v20200901:AppServicePlanRouteForVnet" }, { type: "azure-native:web/v20201201:AppServicePlanRouteForVnet" }, { type: "azure-native:web/v20210101:AppServicePlanRouteForVnet" }, { type: "azure-native:web/v20210115:AppServicePlanRouteForVnet" }, { type: "azure-native:web/v20210201:AppServicePlanRouteForVnet" }, { type: "azure-native:web/v20210301:AppServicePlanRouteForVnet" }, { type: "azure-native:web/v20220301:AppServicePlanRouteForVnet" }, { type: "azure-native:web/v20220901:AppServicePlanRouteForVnet" }] };
...
export interface AppServicePlanRouteForVnetArgs {
     ...
     * These values will be used for syncing an app's routes with those from a Virtual Network.
     */
    routeType?: pulumi.Input<string | types.enums.v20201001.RouteType>;
    /**
     * The starting address for this route. This may also include a CIDR notation, in which case the end address must not be specified.
     */

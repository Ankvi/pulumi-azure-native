...
export class WebApp extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20201001:WebApp';
     ...
     */
    public readonly hostNameSslStates!: pulumi.Output<types.outputs.web.v20201001.HostNameSslStateResponse[] | undefined>;
    /**
     ...
     */
    public readonly hostingEnvironmentProfile!: pulumi.Output<types.outputs.web.v20201001.HostingEnvironmentProfileResponse | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<types.outputs.web.v20201001.ManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    public readonly siteConfig!: pulumi.Output<types.outputs.web.v20201001.SiteConfigResponse | undefined>;
    /**
     * Status of the last deployment slot swap operation.
     */
    public /*out*/ readonly slotSwapStatus!: pulumi.Output<types.outputs.web.v20201001.SlotSwapStatusResponse>;
    /**
    ...
    constructor(name: string, args: WebAppArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["siteConfig"] = args ? (args.siteConfig ? pulumi.output(args.siteConfig).apply(types.inputs.web.v20201001.siteConfigArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:web:WebApp" }, { type: "azure-native:web/v20150801:WebApp" }, { type: "azure-native:web/v20160801:WebApp" }, { type: "azure-native:web/v20180201:WebApp" }, { type: "azure-native:web/v20181101:WebApp" }, { type: "azure-native:web/v20190801:WebApp" }, { type: "azure-native:web/v20200601:WebApp" }, { type: "azure-native:web/v20200901:WebApp" }, { type: "azure-native:web/v20201201:WebApp" }, { type: "azure-native:web/v20210101:WebApp" }, { type: "azure-native:web/v20210115:WebApp" }, { type: "azure-native:web/v20210201:WebApp" }, { type: "azure-native:web/v20210301:WebApp" }, { type: "azure-native:web/v20220301:WebApp" }, { type: "azure-native:web/v20220901:WebApp" }] };
...
export interface WebAppArgs {
     ...
     * - ClientCertEnabled: true and ClientCertMode: Optional means ClientCert is optional or accepted.
     */
    clientCertMode?: pulumi.Input<types.enums.v20201001.ClientCertMode>;
    /**
     * If specified during app creation, the app is cloned from a source app.
     */
    cloningInfo?: pulumi.Input<types.inputs.web.v20201001.CloningInfoArgs>;
    /**
     * Size of the function container.
     */
     ...
     * Hostname SSL states are used to manage the SSL bindings for app's hostnames.
     */
    hostNameSslStates?: pulumi.Input<pulumi.Input<types.inputs.web.v20201001.HostNameSslStateArgs>[]>;
    /**
     * <code>true</code> to disable the public hostnames of the app; otherwise, <code>false</code>.
     *  If <code>true</code>, the app is only accessible via API management process.
     */
     ...
     * App Service Environment to use for the app.
     */
    hostingEnvironmentProfile?: pulumi.Input<types.inputs.web.v20201001.HostingEnvironmentProfileArgs>;
    /**
     * HttpsOnly: configures a web site to accept only https requests. Issues redirect for
     * http requests
     */
     ...
     * Managed service identity.
     */
    identity?: pulumi.Input<types.inputs.web.v20201001.ManagedServiceIdentityArgs>;
    /**
     * Obsolete: Hyper-V sandbox.
     */
     ...
     * Site redundancy mode
     */
    redundancyMode?: pulumi.Input<types.enums.v20201001.RedundancyMode>;
    /**
     * <code>true</code> if reserved; otherwise, <code>false</code>.
     */
     ...
     * Configuration of the app.
     */
    siteConfig?: pulumi.Input<types.inputs.web.v20201001.SiteConfigArgs>;
    /**
     * Checks if Customer provided storage account is required
     */

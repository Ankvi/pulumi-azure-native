...
export class AppServiceEnvironment extends pulumi.CustomResource {
     ...
     */
    public readonly clusterSettings!: pulumi.Output<types.outputs.web.v20201001.NameValuePairResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly environmentCapacities!: pulumi.Output<types.outputs.web.v20201001.StampCapacityResponse[]>;
    /**
     ...
     */
    public readonly networkAccessControlList!: pulumi.Output<types.outputs.web.v20201001.NetworkAccessControlEntryResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly vipMappings!: pulumi.Output<types.outputs.web.v20201001.VirtualIPMappingResponse[]>;
    /**
     * Description of the Virtual Network.
     */
    public readonly virtualNetwork!: pulumi.Output<types.outputs.web.v20201001.VirtualNetworkProfileResponse>;
    /**
     ...
     */
    public readonly workerPools!: pulumi.Output<types.outputs.web.v20201001.WorkerPoolResponse[]>;
...
export interface AppServiceEnvironmentArgs {
     ...
     * Custom settings for changing the behavior of the App Service Environment.
     */
    clusterSettings?: pulumi.Input<pulumi.Input<types.inputs.web.v20201001.NameValuePairArgs>[]>;
    /**
     * DNS suffix of the App Service Environment.
     */
     ...
     * Specifies which endpoints to serve internally in the Virtual Network for the App Service Environment.
     */
    internalLoadBalancingMode?: pulumi.Input<string | types.enums.v20201001.LoadBalancingMode>;
    /**
     * Number of IP SSL addresses reserved for the App Service Environment.
     */
     ...
     * Access control list for controlling traffic to the App Service Environment.
     */
    networkAccessControlList?: pulumi.Input<pulumi.Input<types.inputs.web.v20201001.NetworkAccessControlEntryArgs>[]>;
    /**
     ...
     * Description of the Virtual Network.
     */
    virtualNetwork: pulumi.Input<types.inputs.web.v20201001.VirtualNetworkProfileArgs>;
    /**
     * Name of the Virtual Network for the App Service Environment.
     */
     ...
     * Description of worker pools with worker size IDs, VM sizes, and number of workers in each pool.
     */
    workerPools: pulumi.Input<pulumi.Input<types.inputs.web.v20201001.WorkerPoolArgs>[]>;
}

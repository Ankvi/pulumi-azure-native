...
export class AppServiceEnvironmentPrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web:AppServiceEnvironmentPrivateEndpointConnection';

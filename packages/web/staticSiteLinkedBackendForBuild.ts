...
export class StaticSiteLinkedBackendForBuild extends pulumi.CustomResource {
     ...
     */
    declare public readonly backendResourceId: pulumi.Output<string | undefined>;
    /**
    ...
    constructor(name: string, args: StaticSiteLinkedBackendForBuildArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["backendResourceId"] = args?.backendResourceId;
            resourceInputs["environmentName"] = args?.environmentName;
            resourceInputs["kind"] = args?.kind;
            resourceInputs["linkedBackendName"] = args?.linkedBackendName;

...
export class WebApp extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20230101:WebApp';
     ...
     */
    public readonly daprConfig!: pulumi.Output<types.outputs.DaprConfigResponse | undefined>;
    /**
     ...
     */
    public readonly resourceConfig!: pulumi.Output<types.outputs.ResourceConfigResponse | undefined>;
    /**
    ...
    constructor(name: string, args: WebAppArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["daprConfig"] = args ? (args.daprConfig ? pulumi.output(args.daprConfig).apply(types.inputs.daprConfigArgsProvideDefaults) : undefined) : undefined;
...
export interface WebAppArgs {
     ...
     * Dapr configuration of the app.
     */
    daprConfig?: pulumi.Input<types.inputs.DaprConfigArgs>;
    /**
     * <code>true</code> if the app is enabled; otherwise, <code>false</code>. Setting this value to false disables the app (takes the app offline).
     */
     ...
     * Function app resource requirements.
     */
    resourceConfig?: pulumi.Input<types.inputs.ResourceConfigArgs>;
    /**

...
export class StaticSiteLinkedBackend extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20230101:StaticSiteLinkedBackend';
    ...
    constructor(name: string, args: StaticSiteLinkedBackendArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:web:StaticSiteLinkedBackend" }, { type: "azure-native:web/v20220301:StaticSiteLinkedBackend" }, { type: "azure-native:web/v20220901:StaticSiteLinkedBackend" }] };

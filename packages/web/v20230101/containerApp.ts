...
export class ContainerApp extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20230101:ContainerApp';
    ...
    constructor(name: string, args: ContainerAppArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:web:ContainerApp" }, { type: "azure-native:web/v20210301:ContainerApp" }, { type: "azure-native:web/v20220301:ContainerApp" }, { type: "azure-native:web/v20220901:ContainerApp" }] };

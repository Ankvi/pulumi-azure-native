...
export function getWebAppSlot(args: GetWebAppSlotArgs, opts?: pulumi.InvokeOptions): Promise<GetWebAppSlotResult> {
    ...
    return pulumi.runtime.invoke("azure-native:web/v20230101:getWebAppSlot", {
        "name": args.name,
...
export interface GetWebAppSlotResult {
     ...
     */
    readonly daprConfig?: types.outputs.DaprConfigResponse;
    /**
     ...
     */
    readonly resourceConfig?: types.outputs.ResourceConfigResponse;
    /**

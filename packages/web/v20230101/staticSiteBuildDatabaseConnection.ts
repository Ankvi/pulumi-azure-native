...
export class StaticSiteBuildDatabaseConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20230101:StaticSiteBuildDatabaseConnection';
    ...
    constructor(name: string, args: StaticSiteBuildDatabaseConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:web:StaticSiteBuildDatabaseConnection" }, { type: "azure-native:web/v20220901:StaticSiteBuildDatabaseConnection" }] };

...
export class StaticSiteUserProvidedFunctionAppForStaticSite extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web:StaticSiteUserProvidedFunctionAppForStaticSite';

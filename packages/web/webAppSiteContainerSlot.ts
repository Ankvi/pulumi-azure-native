...
export class WebAppSiteContainerSlot extends pulumi.CustomResource {
     ...
     */
    declare public readonly volumeMounts: pulumi.Output<types.outputs.VolumeMountResponse[] | undefined>;
    ...
    constructor(name: string, args: WebAppSiteContainerSlotArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:web/v20231201:WebAppSiteContainerSlot" }, { type: "azure-native:web/v20240401:WebAppSiteContainerSlot" }, { type: "azure-native:web/v20241101:WebAppSiteContainerSlot" }] };

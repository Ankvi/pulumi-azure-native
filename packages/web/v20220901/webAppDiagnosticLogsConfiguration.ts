...
export class WebAppDiagnosticLogsConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20220901:WebAppDiagnosticLogsConfiguration';
     ...
     */
    public readonly applicationLogs!: pulumi.Output<types.outputs.web.v20220901.ApplicationLogsConfigResponse | undefined>;
    /**
     * Detailed error messages configuration.
     */
    public readonly detailedErrorMessages!: pulumi.Output<types.outputs.web.v20220901.EnabledConfigResponse | undefined>;
    /**
     * Failed requests tracing configuration.
     */
    public readonly failedRequestsTracing!: pulumi.Output<types.outputs.web.v20220901.EnabledConfigResponse | undefined>;
    /**
     * HTTP logs configuration.
     */
    public readonly httpLogs!: pulumi.Output<types.outputs.web.v20220901.HttpLogsConfigResponse | undefined>;
    /**
     * Kind of resource.
     */
    ...
    constructor(name: string, args: WebAppDiagnosticLogsConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["applicationLogs"] = args ? (args.applicationLogs ? pulumi.output(args.applicationLogs).apply(types.inputs.web.v20220901.applicationLogsConfigArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:web:WebAppDiagnosticLogsConfiguration" }, { type: "azure-native:web/v20150801:WebAppDiagnosticLogsConfiguration" }, { type: "azure-native:web/v20160801:WebAppDiagnosticLogsConfiguration" }, { type: "azure-native:web/v20180201:WebAppDiagnosticLogsConfiguration" }, { type: "azure-native:web/v20181101:WebAppDiagnosticLogsConfiguration" }, { type: "azure-native:web/v20190801:WebAppDiagnosticLogsConfiguration" }, { type: "azure-native:web/v20200601:WebAppDiagnosticLogsConfiguration" }, { type: "azure-native:web/v20200901:WebAppDiagnosticLogsConfiguration" }, { type: "azure-native:web/v20201001:WebAppDiagnosticLogsConfiguration" }, { type: "azure-native:web/v20201201:WebAppDiagnosticLogsConfiguration" }, { type: "azure-native:web/v20210101:WebAppDiagnosticLogsConfiguration" }, { type: "azure-native:web/v20210115:WebAppDiagnosticLogsConfiguration" }, { type: "azure-native:web/v20210201:WebAppDiagnosticLogsConfiguration" }, { type: "azure-native:web/v20210301:WebAppDiagnosticLogsConfiguration" }, { type: "azure-native:web/v20220301:WebAppDiagnosticLogsConfiguration" }] };
...
export interface WebAppDiagnosticLogsConfigurationArgs {
     ...
     * Application logs configuration.
     */
    applicationLogs?: pulumi.Input<types.inputs.web.v20220901.ApplicationLogsConfigArgs>;
    /**
     * Detailed error messages configuration.
     */
    detailedErrorMessages?: pulumi.Input<types.inputs.web.v20220901.EnabledConfigArgs>;
    /**
     * Failed requests tracing configuration.
     */
    failedRequestsTracing?: pulumi.Input<types.inputs.web.v20220901.EnabledConfigArgs>;
    /**
     * HTTP logs configuration.
     */
    httpLogs?: pulumi.Input<types.inputs.web.v20220901.HttpLogsConfigArgs>;
    /**
     * Kind of resource.
     */

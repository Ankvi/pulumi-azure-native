...
export class WebAppBackupConfigurationSlot extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20220901:WebAppBackupConfigurationSlot';

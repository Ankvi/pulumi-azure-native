...
export class StaticSite extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20220901:StaticSite';
     ...
     */
    public readonly buildProperties!: pulumi.Output<types.outputs.web.v20220901.StaticSiteBuildPropertiesResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly databaseConnections!: pulumi.Output<types.outputs.web.v20220901.DatabaseConnectionOverviewResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly linkedBackends!: pulumi.Output<types.outputs.web.v20220901.StaticSiteLinkedBackendResponse[]>;
    /**
     * Resource Location.
     */
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<types.outputs.web.v20220901.ResponseMessageEnvelopeRemotePrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public readonly templateProperties!: pulumi.Output<types.outputs.web.v20220901.StaticSiteTemplateOptionsResponse | undefined>;
    /**
     * Resource type.
     */
     ...
     */
    public /*out*/ readonly userProvidedFunctionApps!: pulumi.Output<types.outputs.web.v20220901.StaticSiteUserProvidedFunctionAppResponse[]>;
    ...
    constructor(name: string, args: StaticSiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:web:StaticSite" }, { type: "azure-native:web/v20190801:StaticSite" }, { type: "azure-native:web/v20200601:StaticSite" }, { type: "azure-native:web/v20200901:StaticSite" }, { type: "azure-native:web/v20201001:StaticSite" }, { type: "azure-native:web/v20201201:StaticSite" }, { type: "azure-native:web/v20210101:StaticSite" }, { type: "azure-native:web/v20210115:StaticSite" }, { type: "azure-native:web/v20210201:StaticSite" }, { type: "azure-native:web/v20210301:StaticSite" }, { type: "azure-native:web/v20220301:StaticSite" }] };
...
export interface StaticSiteArgs {
     ...
     * Build properties to configure on the repository.
     */
    buildProperties?: pulumi.Input<types.inputs.web.v20220901.StaticSiteBuildPropertiesArgs>;
    /**
     * State indicating the status of the enterprise grade CDN serving traffic to the static web app.
     */
    enterpriseGradeCdnStatus?: pulumi.Input<string | types.enums.v20220901.EnterpriseGradeCdnStatus>;
    /**
     * Managed service identity.
     */
     ...
     * State indicating whether staging environments are allowed or not allowed for a static web app.
     */
    stagingEnvironmentPolicy?: pulumi.Input<types.enums.v20220901.StagingEnvironmentPolicy>;
    /**
     * Resource tags.
     */
     ...
     * Template options for generating a new repository.
     */
    templateProperties?: pulumi.Input<types.inputs.web.v20220901.StaticSiteTemplateOptionsArgs>;
}

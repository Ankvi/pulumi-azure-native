...
export function listWebAppBackupStatusSecretsSlot(args: ListWebAppBackupStatusSecretsSlotArgs, opts?: pulumi.InvokeOptions): Promise<ListWebAppBackupStatusSecretsSlotResult> {
    ...
    return pulumi.runtime.invoke("azure-native:web/v20220901:listWebAppBackupStatusSecretsSlot", {
        "backupId": args.backupId,
        "backupName": args.backupName,
        "backupSchedule": args.backupSchedule ? types.inputs.web.v20220901.backupScheduleProvideDefaults(args.backupSchedule) : undefined,
...
export interface ListWebAppBackupStatusSecretsSlotArgs {
     ...
     */
    backupSchedule?: types.inputs.web.v20220901.BackupSchedule;
    /**
     * Databases included in the backup.
     */
    databases?: types.inputs.web.v20220901.DatabaseBackupSetting[];
    /**
...
export interface ListWebAppBackupStatusSecretsSlotResult {
     ...
     */
    readonly databases: types.outputs.web.v20220901.DatabaseBackupSettingResponse[];
    /**

...
export class AppServiceEnvironmentPrivateEndpointConnection extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AppServiceEnvironmentPrivateEndpointConnection {
        return new AppServiceEnvironmentPrivateEndpointConnection(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:web/v20220901:AppServiceEnvironmentPrivateEndpointConnection';
     ...
     */
    public static isInstance(obj: any): obj is AppServiceEnvironmentPrivateEndpointConnection {
     ...
     */
    public /*out*/ readonly privateEndpoint!: pulumi.Output<types.outputs.web.v20220901.ArmIdWrapperResponse | undefined>;
    /**
     * The state of a private link connection
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<types.outputs.web.v20220901.PrivateLinkConnectionStateResponse | undefined>;
...
export interface AppServiceEnvironmentPrivateEndpointConnectionArgs {
     ...
     * The state of a private link connection
     */
    privateLinkServiceConnectionState?: pulumi.Input<types.inputs.web.v20220901.PrivateLinkConnectionStateArgs>;
    /**

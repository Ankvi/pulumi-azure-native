...
export class ConnectionGateway extends pulumi.CustomResource {
    ...
    declare public readonly properties: pulumi.Output<types.outputs.ConnectionGatewayDefinitionResponseProperties>;
    /**
     * Resource tags
     */
    ...
    constructor(name: string, args: ConnectionGatewayArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["connectionGatewayName"] = args?.connectionGatewayName;

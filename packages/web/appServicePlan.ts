...
export class AppServicePlan extends pulumi.CustomResource {
     ...
     */
    declare public readonly hostingEnvironmentProfile: pulumi.Output<types.outputs.HostingEnvironmentProfileResponse | undefined>;
    /**
     ...
     */
    declare public readonly sku: pulumi.Output<types.outputs.SkuDescriptionResponse | undefined>;
    /**

...
export class WebAppSwiftVirtualNetworkConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:web:WebAppSwiftVirtualNetworkConnection';

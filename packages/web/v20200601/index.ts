...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:web/v20200601:WebAppFtpAllowed":
                return new WebAppFtpAllowed(name, <any>undefined, { urn })
            case "azure-native:web/v20200601:WebAppScmAllowed":
...
pulumi.runtime.registerResourceModule("azure-native", "web/v20200601", _module)

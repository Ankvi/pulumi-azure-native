...
export class OrderItemByName extends pulumi.CustomResource {
    ...
    constructor(name: string, args: OrderItemByNameArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:edgeorder/v20201201preview:OrderItemByName" }, { type: "azure-native:edgeorder/v20211201:OrderItemByName" }, { type: "azure-native:edgeorder/v20220501preview:OrderItemByName" }] };

...
export class Address extends pulumi.CustomResource {
     ...
     */
    declare public readonly contactDetails: pulumi.Output<types.outputs.ContactDetailsResponse | undefined>;
    /**
     ...
     */
    declare public readonly shippingAddress: pulumi.Output<types.outputs.ShippingAddressResponse | undefined>;
    /**

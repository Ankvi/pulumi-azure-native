...
export class OrderItemByName extends pulumi.CustomResource {
     ...
     */
    public readonly addressDetails!: pulumi.Output<types.outputs.edgeorder.v20211201.AddressDetailsResponse>;
    /**
     ...
     */
    public readonly orderItemDetails!: pulumi.Output<types.outputs.edgeorder.v20211201.OrderItemDetailsResponse>;
    /**
...
export interface OrderItemByNameArgs {
     ...
     * Represents shipping and return address for order item
     */
    addressDetails: pulumi.Input<types.inputs.edgeorder.v20211201.AddressDetailsArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Represents order item details.
     */
    orderItemDetails: pulumi.Input<types.inputs.edgeorder.v20211201.OrderItemDetailsArgs>;
    /**

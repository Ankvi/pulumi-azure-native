...
export class AddressByName extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:edgeorder/v20211201:AddressByName';
    ...
    constructor(name: string, args: AddressByNameArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:edgeorder:AddressByName" }, { type: "azure-native:edgeorder/v20201201preview:AddressByName" }, { type: "azure-native:edgeorder/v20220501preview:AddressByName" }, { type: "azure-native:edgeorder/v20240201:AddressByName" }] };

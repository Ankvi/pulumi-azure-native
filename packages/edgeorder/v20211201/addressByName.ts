...
export class AddressByName extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AddressByNameArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:edgeorder:AddressByName" }, { type: "azure-native:edgeorder/v20201201preview:AddressByName" }, { type: "azure-native:edgeorder/v20220501preview:AddressByName" }] };

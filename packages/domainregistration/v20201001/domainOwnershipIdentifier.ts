...
export class DomainOwnershipIdentifier extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:domainregistration/v20201001:DomainOwnershipIdentifier';

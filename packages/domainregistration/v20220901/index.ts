...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:domainregistration/v20220901:Domain":
                return new Domain(name, <any>undefined, { urn })
            case "azure-native:domainregistration/v20220901:DomainOwnershipIdentifier":
...
pulumi.runtime.registerResourceModule("azure-native", "domainregistration/v20220901", _module)

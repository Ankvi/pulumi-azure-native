...
export class DomainOwnershipIdentifier extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:domainregistration/v20220901:DomainOwnershipIdentifier';

...
export class Appliance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:resourceconnector:Appliance';
     ...
     */
    declare public readonly infrastructureConfig: pulumi.Output<types.outputs.AppliancePropertiesResponseInfrastructureConfig | undefined>;
    /**

...
export namespace avs {
    ...
    export namespace v20220501 {
        ...
        export interface AvailabilityPropertiesArgs {
             ...
             * The availability strategy for the private cloud
             */
            strategy?: pulumi.Input<string | enums.v20220501.AvailabilityStrategy>;
            /**
             * The primary availability zone for the private cloud
             */
            zone?: pulumi.Input<number>;
        ...
        export interface DiskPoolVolumeArgs {
             ...
             * Mode that describes whether the LUN has to be mounted as a datastore or attached as a LUN
             */
            mountOption?: pulumi.Input<string | enums.v20220501.MountOptionEnum>;
            /**
             * Azure resource ID of the iSCSI target
             */
            targetId: pulumi.Input<string>;
        ...
        export interface EncryptionArgs {
             ...
             * The key vault where the encryption key is stored
             */
            keyVaultProperties?: pulumi.Input<v20220501.EncryptionKeyVaultPropertiesArgs>;
            /**
             * Status of customer managed encryption key
             */
            status?: pulumi.Input<string | enums.v20220501.EncryptionState>;
        }
        ...
        export interface IdentitySourceArgs {
             ...
             * Protect LDAP communication using SSL certificate (LDAPS)
             */
            ssl?: pulumi.Input<string | enums.v20220501.SslEnum>;
            /**
             * The ID of an Active Directory user with a minimum of read-only access to Base DN for users and group
             */
            username?: pulumi.Input<string>;
        ...
        export interface PrivateCloudIdentityArgs {
             ...
             * The type of identity used for the private cloud. The type 'SystemAssigned' refers to an implicitly created identity. The type 'None' will remove any identities from the Private Cloud.
             */
            type?: pulumi.Input<string | enums.v20220501.ResourceIdentityType>;
        }
        ...
        export interface VmHostPlacementPolicyPropertiesArgs {
             ...
             * vm-host placement policy affinity strength (should/must)
             */
            affinityStrength?: pulumi.Input<string | enums.v20220501.AffinityStrength>;
            /**
             * placement policy affinity type
             */
            affinityType: pulumi.Input<string | enums.v20220501.AffinityType>;
            /**
             * placement policy azure hybrid benefit opt-in type
             */
            azureHybridBenefitType?: pulumi.Input<string | enums.v20220501.AzureHybridBenefitType>;
            /**
             * Display name of the placement policy
             */
            displayName?: pulumi.Input<string>;
             ...
             * Whether the placement policy is enabled or disabled
             */
            state?: pulumi.Input<string | enums.v20220501.PlacementPolicyState>;
            /**
             * placement policy type
             * Expected value is 'VmHost'.
             */
    ...
    export namespace v20230301 {
        ...
        export interface AvailabilityPropertiesArgs {
             ...
             * The availability strategy for the private cloud
             */
            strategy?: pulumi.Input<string | enums.v20230301.AvailabilityStrategy>;
            /**
             * The primary availability zone for the private cloud
             */
            zone?: pulumi.Input<number>;
        ...
        export interface DiskPoolVolumeArgs {
             ...
             * Mode that describes whether the LUN has to be mounted as a datastore or attached as a LUN
             */
            mountOption?: pulumi.Input<string | enums.v20230301.MountOptionEnum>;
            /**
             * Azure resource ID of the iSCSI target
             */
            targetId: pulumi.Input<string>;
        ...
        export interface EncryptionArgs {
             ...
             * The key vault where the encryption key is stored
             */
            keyVaultProperties?: pulumi.Input<v20230301.EncryptionKeyVaultPropertiesArgs>;
            /**
             * Status of customer managed encryption key
             */
            status?: pulumi.Input<string | enums.v20230301.EncryptionState>;
        }
        ...
        export interface IdentitySourceArgs {
             ...
             * Protect LDAP communication using SSL certificate (LDAPS)
             */
            ssl?: pulumi.Input<string | enums.v20230301.SslEnum>;
            /**
             * The ID of an Active Directory user with a minimum of read-only access to Base DN for users and group
             */
            username?: pulumi.Input<string>;
        ...
        export interface PrivateCloudIdentityArgs {
             ...
             * The type of identity used for the private cloud. The type 'SystemAssigned' refers to an implicitly created identity. The type 'None' will remove any identities from the Private Cloud.
             */
            type?: pulumi.Input<string | enums.v20230301.ResourceIdentityType>;
        }
        ...
        export interface VmHostPlacementPolicyPropertiesArgs {
             ...
             * vm-host placement policy affinity strength (should/must)
             */
            affinityStrength?: pulumi.Input<string | enums.v20230301.AffinityStrength>;
            /**
             * placement policy affinity type
             */
            affinityType: pulumi.Input<string | enums.v20230301.AffinityType>;
            /**
             * placement policy azure hybrid benefit opt-in type
             */
            azureHybridBenefitType?: pulumi.Input<string | enums.v20230301.AzureHybridBenefitType>;
            /**
             * Display name of the placement policy
             */
            displayName?: pulumi.Input<string>;
             ...
             * Whether the placement policy is enabled or disabled
             */
            state?: pulumi.Input<string | enums.v20230301.PlacementPolicyState>;
            /**
             * placement policy type
             * Expected value is 'VmHost'.
             */

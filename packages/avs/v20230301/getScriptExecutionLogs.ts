...
export interface GetScriptExecutionLogsResult {
     ...
     */
    readonly hiddenParameters?: (types.outputs.avs.v20230301.PSCredentialExecutionParameterResponse | types.outputs.avs.v20230301.ScriptSecureStringExecutionParameterResponse | types.outputs.avs.v20230301.ScriptStringExecutionParameterResponse)[];
    /**
     * Resource ID.
     */
    readonly id: string;
     ...
     */
    readonly parameters?: (types.outputs.avs.v20230301.PSCredentialExecutionParameterResponse | types.outputs.avs.v20230301.ScriptSecureStringExecutionParameterResponse | types.outputs.avs.v20230301.ScriptStringExecutionParameterResponse)[];
    /**

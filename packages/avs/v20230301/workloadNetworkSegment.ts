...
export class WorkloadNetworkSegment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:avs/v20230301:WorkloadNetworkSegment';
     ...
     */
    public /*out*/ readonly portVif!: pulumi.Output<types.outputs.avs.v20230301.WorkloadNetworkSegmentPortVifResponse[]>;
    /**
     ...
     */
    public readonly subnet!: pulumi.Output<types.outputs.avs.v20230301.WorkloadNetworkSegmentSubnetResponse | undefined>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: WorkloadNetworkSegmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:avs:WorkloadNetworkSegment" }, { type: "azure-native:avs/v20200717preview:WorkloadNetworkSegment" }, { type: "azure-native:avs/v20210101preview:WorkloadNetworkSegment" }, { type: "azure-native:avs/v20210601:WorkloadNetworkSegment" }, { type: "azure-native:avs/v20211201:WorkloadNetworkSegment" }, { type: "azure-native:avs/v20220501:WorkloadNetworkSegment" }] };
...
export interface WorkloadNetworkSegmentArgs {
     ...
     * Subnet which to connect segment to.
     */
    subnet?: pulumi.Input<types.inputs.avs.v20230301.WorkloadNetworkSegmentSubnetArgs>;
}

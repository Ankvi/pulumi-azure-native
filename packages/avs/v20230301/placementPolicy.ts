...
export class PlacementPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PlacementPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:avs:PlacementPolicy" }, { type: "azure-native:avs/v20211201:PlacementPolicy" }, { type: "azure-native:avs/v20220501:PlacementPolicy" }, { type: "azure-native:avs/v20230901:PlacementPolicy" }] };

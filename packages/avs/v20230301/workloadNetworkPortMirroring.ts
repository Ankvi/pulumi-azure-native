...
export class WorkloadNetworkPortMirroring extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:avs/v20230301:WorkloadNetworkPortMirroring';

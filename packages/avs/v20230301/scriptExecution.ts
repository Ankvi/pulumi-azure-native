...
export class ScriptExecution extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:avs/v20230301:ScriptExecution';
     ...
     */
    public readonly hiddenParameters!: pulumi.Output<(types.outputs.avs.v20230301.PSCredentialExecutionParameterResponse | types.outputs.avs.v20230301.ScriptSecureStringExecutionParameterResponse | types.outputs.avs.v20230301.ScriptStringExecutionParameterResponse)[] | undefined>;
    /**
     ...
     */
    public readonly parameters!: pulumi.Output<(types.outputs.avs.v20230301.PSCredentialExecutionParameterResponse | types.outputs.avs.v20230301.ScriptSecureStringExecutionParameterResponse | types.outputs.avs.v20230301.ScriptStringExecutionParameterResponse)[] | undefined>;
    /**
...
export interface ScriptExecutionArgs {
     ...
     * Parameters that will be hidden/not visible to ARM, such as passwords and credentials
     */
    hiddenParameters?: pulumi.Input<pulumi.Input<types.inputs.avs.v20230301.PSCredentialExecutionParameterArgs | types.inputs.avs.v20230301.ScriptSecureStringExecutionParameterArgs | types.inputs.avs.v20230301.ScriptStringExecutionParameterArgs>[]>;
    /**
     * User-defined dictionary.
     */
     ...
     * Parameters the script will accept
     */
    parameters?: pulumi.Input<pulumi.Input<types.inputs.avs.v20230301.PSCredentialExecutionParameterArgs | types.inputs.avs.v20230301.ScriptSecureStringExecutionParameterArgs | types.inputs.avs.v20230301.ScriptStringExecutionParameterArgs>[]>;
    /**

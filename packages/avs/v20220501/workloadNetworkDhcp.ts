...
export class WorkloadNetworkDhcp extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:avs/v20220501:WorkloadNetworkDhcp';
     ...
     * DHCP properties.
     */
    public readonly properties!: pulumi.Output<types.outputs.avs.v20220501.WorkloadNetworkDhcpRelayResponse | types.outputs.avs.v20220501.WorkloadNetworkDhcpServerResponse>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: WorkloadNetworkDhcpArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:avs:WorkloadNetworkDhcp" }, { type: "azure-native:avs/v20200717preview:WorkloadNetworkDhcp" }, { type: "azure-native:avs/v20210101preview:WorkloadNetworkDhcp" }, { type: "azure-native:avs/v20210601:WorkloadNetworkDhcp" }, { type: "azure-native:avs/v20211201:WorkloadNetworkDhcp" }, { type: "azure-native:avs/v20230301:WorkloadNetworkDhcp" }] };
...
export interface WorkloadNetworkDhcpArgs {
     ...
     * DHCP properties.
     */
    properties?: pulumi.Input<types.inputs.avs.v20220501.WorkloadNetworkDhcpRelayArgs | types.inputs.avs.v20220501.WorkloadNetworkDhcpServerArgs>;
    /**

...
export function getWorkloadNetworkDhcp(args: GetWorkloadNetworkDhcpArgs, opts?: pulumi.InvokeOptions): Promise<GetWorkloadNetworkDhcpResult> {
    ...
    return pulumi.runtime.invoke("azure-native:avs/v20220501:getWorkloadNetworkDhcp", {
        "dhcpId": args.dhcpId,
...
export interface GetWorkloadNetworkDhcpResult {
     ...
     * DHCP properties.
     */
    readonly properties: types.outputs.avs.v20220501.WorkloadNetworkDhcpRelayResponse | types.outputs.avs.v20220501.WorkloadNetworkDhcpServerResponse;
    /**
     * Resource type.
     */

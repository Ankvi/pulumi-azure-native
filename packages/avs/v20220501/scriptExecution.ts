...
export class ScriptExecution extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:avs/v20220501:ScriptExecution';
     ...
     */
    public readonly hiddenParameters!: pulumi.Output<(types.outputs.avs.v20220501.PSCredentialExecutionParameterResponse | types.outputs.avs.v20220501.ScriptSecureStringExecutionParameterResponse | types.outputs.avs.v20220501.ScriptStringExecutionParameterResponse)[] | undefined>;
    /**
     ...
     */
    public readonly parameters!: pulumi.Output<(types.outputs.avs.v20220501.PSCredentialExecutionParameterResponse | types.outputs.avs.v20220501.ScriptSecureStringExecutionParameterResponse | types.outputs.avs.v20220501.ScriptStringExecutionParameterResponse)[] | undefined>;
    /**
    ...
    constructor(name: string, args: ScriptExecutionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:avs:ScriptExecution" }, { type: "azure-native:avs/v20210601:ScriptExecution" }, { type: "azure-native:avs/v20211201:ScriptExecution" }, { type: "azure-native:avs/v20230301:ScriptExecution" }] };
...
export interface ScriptExecutionArgs {
     ...
     * Parameters that will be hidden/not visible to ARM, such as passwords and credentials
     */
    hiddenParameters?: pulumi.Input<pulumi.Input<types.inputs.avs.v20220501.PSCredentialExecutionParameterArgs | types.inputs.avs.v20220501.ScriptSecureStringExecutionParameterArgs | types.inputs.avs.v20220501.ScriptStringExecutionParameterArgs>[]>;
    /**
     * User-defined dictionary.
     */
     ...
     * Parameters the script will accept
     */
    parameters?: pulumi.Input<pulumi.Input<types.inputs.avs.v20220501.PSCredentialExecutionParameterArgs | types.inputs.avs.v20220501.ScriptSecureStringExecutionParameterArgs | types.inputs.avs.v20220501.ScriptStringExecutionParameterArgs>[]>;
    /**

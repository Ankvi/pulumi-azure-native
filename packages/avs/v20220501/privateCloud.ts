...
export class PrivateCloud extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:avs/v20220501:PrivateCloud';
     ...
     */
    public readonly availability!: pulumi.Output<types.outputs.avs.v20220501.AvailabilityPropertiesResponse | undefined>;
    /**
     * An ExpressRoute Circuit
     */
    public /*out*/ readonly circuit!: pulumi.Output<types.outputs.avs.v20220501.CircuitResponse | undefined>;
    /**
     * Customer managed key encryption, can be enabled or disabled
     */
    public readonly encryption!: pulumi.Output<types.outputs.avs.v20220501.EncryptionResponse | undefined>;
    /**
     * The endpoints
     */
    public /*out*/ readonly endpoints!: pulumi.Output<types.outputs.avs.v20220501.EndpointsResponse>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<types.outputs.avs.v20220501.PrivateCloudIdentityResponse | undefined>;
    /**
     * vCenter Single Sign On Identity Sources
     */
    public readonly identitySources!: pulumi.Output<types.outputs.avs.v20220501.IdentitySourceResponse[] | undefined>;
    /**
     ...
     */
    public readonly managementCluster!: pulumi.Output<types.outputs.avs.v20220501.ManagementClusterResponse>;
    /**
     ...
     */
    public /*out*/ readonly secondaryCircuit!: pulumi.Output<types.outputs.avs.v20220501.CircuitResponse | undefined>;
    /**
     * The private cloud SKU
     */
    public readonly sku!: pulumi.Output<types.outputs.avs.v20220501.SkuResponse>;
    /**
     * Resource tags
     */
    ...
    constructor(name: string, args: PrivateCloudArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:avs:PrivateCloud" }, { type: "azure-native:avs/v20200320:PrivateCloud" }, { type: "azure-native:avs/v20200717preview:PrivateCloud" }, { type: "azure-native:avs/v20210101preview:PrivateCloud" }, { type: "azure-native:avs/v20210601:PrivateCloud" }, { type: "azure-native:avs/v20211201:PrivateCloud" }, { type: "azure-native:avs/v20230301:PrivateCloud" }] };
...
export interface PrivateCloudArgs {
     ...
     * Properties describing how the cloud is distributed across availability zones
     */
    availability?: pulumi.Input<types.inputs.avs.v20220501.AvailabilityPropertiesArgs>;
    /**
     * Customer managed key encryption, can be enabled or disabled
     */
    encryption?: pulumi.Input<types.inputs.avs.v20220501.EncryptionArgs>;
    /**
     * The identity of the private cloud, if configured.
     */
    identity?: pulumi.Input<types.inputs.avs.v20220501.PrivateCloudIdentityArgs>;
    /**
     * vCenter Single Sign On Identity Sources
     */
    identitySources?: pulumi.Input<pulumi.Input<types.inputs.avs.v20220501.IdentitySourceArgs>[]>;
    /**
     * Connectivity to internet is enabled or disabled
     */
    internet?: pulumi.Input<string | types.enums.v20220501.InternetEnum>;
    /**
     * Resource location
     */
     ...
     * The default cluster used for management
     */
    managementCluster: pulumi.Input<types.inputs.avs.v20220501.ManagementClusterArgs>;
    /**
     * The block of addresses should be unique across VNet in your subscription as well as on-premise. Make sure the CIDR format is conformed to (A.B.C.D/X) where A,B,C,D are between 0 and 255, and X is between 0 and 22
     */
     ...
     * The private cloud SKU
     */
    sku: pulumi.Input<types.inputs.avs.v20220501.SkuArgs>;
    /**
     * Resource tags
     */

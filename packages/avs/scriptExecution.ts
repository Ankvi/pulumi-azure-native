...
export class ScriptExecution extends pulumi.CustomResource {
     ...
     * credentials
     */
    declare public readonly hiddenParameters: pulumi.Output<(types.outputs.PSCredentialExecutionParameterResponse | types.outputs.ScriptSecureStringExecutionParameterResponse | types.outputs.ScriptStringExecutionParameterResponse)[] | undefined>;
    /**
     ...
     */
    declare public readonly parameters: pulumi.Output<(types.outputs.PSCredentialExecutionParameterResponse | types.outputs.ScriptSecureStringExecutionParameterResponse | types.outputs.ScriptStringExecutionParameterResponse)[] | undefined>;
    /**
    ...
    constructor(name: string, args: ScriptExecutionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:avs/v20210601:ScriptExecution" }, { type: "azure-native:avs/v20211201:ScriptExecution" }, { type: "azure-native:avs/v20220501:ScriptExecution" }, { type: "azure-native:avs/v20230301:ScriptExecution" }, { type: "azure-native:avs/v20230901:ScriptExecution" }, { type: "azure-native:avs/v20240901:ScriptExecution" }] };

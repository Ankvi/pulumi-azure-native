...
export class IscsiPath extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IscsiPath {
        return new IscsiPath(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:avs/v20230901:IscsiPath';

    /**
     * Returns true if the given object is an instance of IscsiPath.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IscsiPath {
     ...
     */
    constructor(name: string, args: IscsiPathArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:avs:IscsiPath" }] };
 ...
 */
export interface IscsiPathArgs {
    /**
     * CIDR Block for iSCSI path.
     */

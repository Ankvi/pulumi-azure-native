...
export class ScheduledActionByScope extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:costmanagement/v20230901:ScheduledActionByScope';

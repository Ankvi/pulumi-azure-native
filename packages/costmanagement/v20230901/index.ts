...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:costmanagement/v20230901:Budget":
                return new Budget(name, <any>undefined, { urn })
            case "azure-native:costmanagement/v20230901:CostAllocationRule":
                return new CostAllocationRule(name, <any>undefined, { urn })
            case "azure-native:costmanagement/v20230901:Export":
                return new Export(name, <any>undefined, { urn })
            case "azure-native:costmanagement/v20230901:ScheduledAction":
                return new ScheduledAction(name, <any>undefined, { urn })
            case "azure-native:costmanagement/v20230901:ScheduledActionByScope":
                return new ScheduledActionByScope(name, <any>undefined, { urn })
            case "azure-native:costmanagement/v20230901:TagInheritanceSetting":
                return new TagInheritanceSetting(name, <any>undefined, { urn })
            case "azure-native:costmanagement/v20230901:View":
                return new View(name, <any>undefined, { urn })
            case "azure-native:costmanagement/v20230901:ViewByScope":
...
pulumi.runtime.registerResourceModule("azure-native", "costmanagement/v20230901", _module)
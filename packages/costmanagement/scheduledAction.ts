...
export class ScheduledAction extends pulumi.CustomResource {
     ...
     */
    declare public readonly fileDestination: pulumi.Output<types.outputs.FileDestinationResponse | undefined>;
    /**
     ...
     */
    declare public readonly notification: pulumi.Output<types.outputs.NotificationPropertiesResponse>;
    /**
     ...
     */
    declare public readonly schedule: pulumi.Output<types.outputs.SchedulePropertiesResponse>;
    /**

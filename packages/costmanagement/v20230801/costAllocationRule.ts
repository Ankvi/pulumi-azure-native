...
export class CostAllocationRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:costmanagement/v20230801:CostAllocationRule';
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.costmanagement.v20230801.CostAllocationRulePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: CostAllocationRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:costmanagement:CostAllocationRule" }, { type: "azure-native:costmanagement/v20200301preview:CostAllocationRule" }] };
...
export interface CostAllocationRuleArgs {
     ...
     * Cost allocation rule properties
     */
    properties?: pulumi.Input<types.inputs.costmanagement.v20230801.CostAllocationRulePropertiesArgs>;
    /**

...
export class Export extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:costmanagement/v20230801:Export';
     ...
     */
    public readonly definition!: pulumi.Output<types.outputs.costmanagement.v20230801.ExportDefinitionResponse>;
    /**
     * Has delivery information for the export.
     */
    public readonly deliveryInfo!: pulumi.Output<types.outputs.costmanagement.v20230801.ExportDeliveryInfoResponse>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<types.outputs.costmanagement.v20230801.SystemAssignedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly runHistory!: pulumi.Output<types.outputs.costmanagement.v20230801.ExportExecutionListResultResponse | undefined>;
    /**
     * Has schedule information for the export.
     */
    public readonly schedule!: pulumi.Output<types.outputs.costmanagement.v20230801.ExportScheduleResponse | undefined>;
    /**
     * Resource type.
     */
...
export interface ExportArgs {
     ...
     * Has the definition for the export.
     */
    definition: pulumi.Input<types.inputs.costmanagement.v20230801.ExportDefinitionArgs>;
    /**
     * Has delivery information for the export.
     */
    deliveryInfo: pulumi.Input<types.inputs.costmanagement.v20230801.ExportDeliveryInfoArgs>;
    /**
     * eTag of the resource. To handle concurrent update scenario, this field will be used to determine whether the user is updating the latest version or not.
     */
     ...
     * The format of the export being delivered. Currently only 'Csv' is supported.
     */
    format?: pulumi.Input<string | types.enums.v20230801.FormatType>;
    /**
     * The managed identity associated with Export
     */
    identity?: pulumi.Input<types.inputs.costmanagement.v20230801.SystemAssignedServiceIdentityArgs>;
    /**
     * The location of the Export's managed identity. Only required when utilizing managed identity.
     */
     ...
     * Has schedule information for the export.
     */
    schedule?: pulumi.Input<types.inputs.costmanagement.v20230801.ExportScheduleArgs>;
    /**

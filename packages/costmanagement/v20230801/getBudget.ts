...
export function getBudget(args: GetBudgetArgs, opts?: pulumi.InvokeOptions): Promise<GetBudgetResult> {
    ...
    return pulumi.runtime.invoke("azure-native:costmanagement/v20230801:getBudget", {
...
export interface GetBudgetResult {
     ...
     *  Supported for CategoryType(s): Cost.
     */
    readonly currentSpend: types.outputs.costmanagement.v20230801.CurrentSpendResponse;
    /**
     ...
     */
    readonly filter?: types.outputs.costmanagement.v20230801.BudgetFilterResponse;
    /**
     * The forecasted cost which is being tracked for a budget.
     *
     *  Supported for CategoryType(s): Cost.
     */
    readonly forecastSpend: types.outputs.costmanagement.v20230801.ForecastSpendResponse;
    /**
     * Resource Id.
     */
    readonly id: string;
     ...
     */
    readonly notifications?: {[key: string]: types.outputs.costmanagement.v20230801.NotificationResponse};
    /**
     ...
     *  Required for CategoryType(s): Cost, ReservationUtilization.
     */
    readonly timePeriod: types.outputs.costmanagement.v20230801.BudgetTimePeriodResponse;
    /**
     * Resource type.
     */

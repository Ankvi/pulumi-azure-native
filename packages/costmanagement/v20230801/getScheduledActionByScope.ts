...
export function getScheduledActionByScope(args: GetScheduledActionByScopeArgs, opts?: pulumi.InvokeOptions): Promise<GetScheduledActionByScopeResult> {
    ...
    return pulumi.runtime.invoke("azure-native:costmanagement/v20230801:getScheduledActionByScope", {
        "name": args.name,
        "scope": args.scope,
    }, opts);
}
...
export interface GetScheduledActionByScopeResult {
     ...
     */
    readonly fileDestination?: types.outputs.costmanagement.v20230801.FileDestinationResponse;
    /**
     ...
     */
    readonly notification: types.outputs.costmanagement.v20230801.NotificationPropertiesResponse;
    /**
     ...
     */
    readonly schedule: types.outputs.costmanagement.v20230801.SchedulePropertiesResponse;
    /**
     ...
     * Kind of the scheduled action.
     */
    readonly systemData: types.outputs.costmanagement.v20230801.SystemDataResponse;
    /**

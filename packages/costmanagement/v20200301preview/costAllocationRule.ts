...
export class CostAllocationRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: CostAllocationRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:costmanagement:CostAllocationRule" }, { type: "azure-native:costmanagement/v20230801:CostAllocationRule" }, { type: "azure-native:costmanagement/v20231101:CostAllocationRule" }] };

...
export class ReportByDepartment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:costmanagement/v20180801preview:ReportByDepartment';
    ...
    constructor(name: string, args: ReportByDepartmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:costmanagement:ReportByDepartment" }] };

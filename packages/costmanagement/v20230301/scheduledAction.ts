...
export class ScheduledAction extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:costmanagement/v20230301:ScheduledAction';
     ...
     */
    public readonly fileDestination!: pulumi.Output<types.outputs.costmanagement.v20230301.FileDestinationResponse | undefined>;
    /**
     ...
     */
    public readonly notification!: pulumi.Output<types.outputs.costmanagement.v20230301.NotificationPropertiesResponse>;
    /**
     ...
     */
    public readonly schedule!: pulumi.Output<types.outputs.costmanagement.v20230301.SchedulePropertiesResponse>;
    /**
     ...
     * Kind of the scheduled action.
     */
    public /*out*/ readonly systemData!: pulumi.Output<types.outputs.costmanagement.v20230301.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: ScheduledActionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:costmanagement:ScheduledAction" }, { type: "azure-native:costmanagement/v20220401preview:ScheduledAction" }, { type: "azure-native:costmanagement/v20220601preview:ScheduledAction" }, { type: "azure-native:costmanagement/v20221001:ScheduledAction" }, { type: "azure-native:costmanagement/v20230401preview:ScheduledAction" }, { type: "azure-native:costmanagement/v20230801:ScheduledAction" }] };
...
export interface ScheduledActionArgs {
     ...
     * Destination format of the view data. This is optional.
     */
    fileDestination?: pulumi.Input<types.inputs.costmanagement.v20230301.FileDestinationArgs>;
    /**
     * Kind of the scheduled action.
     */
    kind?: pulumi.Input<string | types.enums.v20230301.ScheduledActionKind>;
    /**
     * Scheduled action name.
     */
     ...
     * Notification properties based on scheduled action kind.
     */
    notification: pulumi.Input<types.inputs.costmanagement.v20230301.NotificationPropertiesArgs>;
    /**
     * Email address of the point of contact that should get the unsubscribe requests and notification emails.
     */
     ...
     * Schedule of the scheduled action.
     */
    schedule: pulumi.Input<types.inputs.costmanagement.v20230301.SchedulePropertiesArgs>;
    /**
     * For private scheduled action(Create or Update), scope will be empty.<br /> For shared scheduled action(Create or Update By Scope), Cost Management scope can be 'subscriptions/{subscriptionId}' for subscription scope, 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}' for resourceGroup scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}' for Billing Account scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/departments/{departmentId}' for Department scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/enrollmentAccounts/{enrollmentAccountId}' for EnrollmentAccount scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/billingProfiles/{billingProfileId}' for BillingProfile scope, 'providers/Microsoft.Billing/billingAccounts/{billingAccountId}/invoiceSections/{invoiceSectionId}' for InvoiceSection scope, '/providers/Microsoft.CostManagement/externalBillingAccounts/{externalBillingAccountName}' for ExternalBillingAccount scope, and '/providers/Microsoft.CostManagement/externalSubscriptions/{externalSubscriptionName}' for ExternalSubscription scope.
     */
     ...
     * Status of the scheduled action.
     */
    status: pulumi.Input<string | types.enums.v20230301.ScheduledActionStatus>;
    /**
     * Cost analysis viewId used for scheduled action. For example, '/providers/Microsoft.CostManagement/views/swaggerExample'
     */

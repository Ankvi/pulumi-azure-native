...
export class TagInheritanceSetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:costmanagement/v20221005preview:TagInheritanceSetting';
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.costmanagement.v20221005preview.TagInheritancePropertiesResponse>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: TagInheritanceSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:costmanagement:TagInheritanceSetting" }, { type: "azure-native:costmanagement/v20221001preview:TagInheritanceSetting" }, { type: "azure-native:costmanagement/v20230801:TagInheritanceSetting" }] };
...
export interface TagInheritanceSettingArgs {
     ...
     * The properties of the tag inheritance setting.
     */
    properties?: pulumi.Input<types.inputs.costmanagement.v20221005preview.TagInheritancePropertiesArgs>;
    /**

...
export class Budget extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:costmanagement/v20230401preview:Budget';
     ...
     *  Supported for CategoryType(s): Cost.
     */
    public /*out*/ readonly currentSpend!: pulumi.Output<types.outputs.costmanagement.v20230401preview.CurrentSpendResponse>;
    /**
     ...
     */
    public readonly filter!: pulumi.Output<types.outputs.costmanagement.v20230401preview.BudgetFilterResponse | undefined>;
    /**
     * The forecasted cost which is being tracked for a budget.
     *
     *  Supported for CategoryType(s): Cost.
     */
    public /*out*/ readonly forecastSpend!: pulumi.Output<types.outputs.costmanagement.v20230401preview.ForecastSpendResponse>;
    /**
     ...
     */
    public readonly notifications!: pulumi.Output<{[key: string]: types.outputs.costmanagement.v20230401preview.NotificationResponse} | undefined>;
    /**
     ...
     *  Required for CategoryType(s): Cost, ReservationUtilization.
     */
    public readonly timePeriod!: pulumi.Output<types.outputs.costmanagement.v20230401preview.BudgetTimePeriodResponse>;
    /**
    ...
    constructor(name: string, args: BudgetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:costmanagement:Budget" }, { type: "azure-native:costmanagement/v20190401preview:Budget" }, { type: "azure-native:costmanagement/v20230801:Budget" }] };
...
export interface BudgetArgs {
     ...
     * - 'ReservationUtilization' defines a Reservation Utilization Alert Rule.
     */
    category: pulumi.Input<string | types.enums.v20230401preview.CategoryType>;
    /**
     * eTag of the resource. To handle concurrent update scenario, this field will be used to determine whether the user is updating the latest version or not.
     */
     ...
     *  Supported for CategoryType(s): Cost, ReservationUtilization.
     */
    filter?: pulumi.Input<types.inputs.costmanagement.v20230401preview.BudgetFilterArgs>;
    /**
     * Dictionary of notifications associated with the budget.
     *
     *  Supported for CategoryType(s): Cost, ReservationUtilization.
     ...
     * - Constraints for **CategoryType: ReservationUtilization** - Only one notification allowed. thresholdType is not applicable.
     */
    notifications?: pulumi.Input<{[key: string]: pulumi.Input<types.inputs.costmanagement.v20230401preview.NotificationArgs>}>;
    /**
     ...
     *  Required for CategoryType(s): Cost, ReservationUtilization.
     */
    timeGrain: pulumi.Input<string | types.enums.v20230401preview.TimeGrainType>;
    /**
     * The time period that defines the active period of the budget. The budget will evaluate data on or after the startDate and will expire on the endDate.
     *
     *  Supported for CategoryType(s): Cost, ReservationUtilization.
     ...
     *  Required for CategoryType(s): Cost, ReservationUtilization.
     */
    timePeriod: pulumi.Input<types.inputs.costmanagement.v20230401preview.BudgetTimePeriodArgs>;
}

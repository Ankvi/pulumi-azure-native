...
export class Budget extends pulumi.CustomResource {
     ...
     */
    public readonly filter!: pulumi.Output<types.outputs.ReportConfigFilterResponse | undefined>;
    /**
     * Resource name.
     */
    ...
    constructor(name: string, args: BudgetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:costmanagement:Budget" }, { type: "azure-native:costmanagement/v20230401preview:Budget" }, { type: "azure-native:costmanagement/v20230801:Budget" }, { type: "azure-native:costmanagement/v20231101:Budget" }] };
...
export interface BudgetArgs {
     ...
     * May be used to filter budgets.
     */
    filter?: pulumi.Input<types.inputs.ReportConfigFilterArgs>;
    /**
     * Dictionary of notifications associated with the budget. Budget can have up to five notifications.
     */

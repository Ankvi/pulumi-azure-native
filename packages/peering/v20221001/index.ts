...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:peering/v20221001:ConnectionMonitorTest":
                return new ConnectionMonitorTest(name, <any>undefined, { urn })
            case "azure-native:peering/v20221001:PeerAsn":
                return new PeerAsn(name, <any>undefined, { urn })
            case "azure-native:peering/v20221001:Peering":
                return new Peering(name, <any>undefined, { urn })
            case "azure-native:peering/v20221001:PeeringService":
                return new PeeringService(name, <any>undefined, { urn })
            case "azure-native:peering/v20221001:Prefix":
                return new Prefix(name, <any>undefined, { urn })
            case "azure-native:peering/v20221001:RegisteredAsn":
                return new RegisteredAsn(name, <any>undefined, { urn })
            case "azure-native:peering/v20221001:RegisteredPrefix":
...
pulumi.runtime.registerResourceModule("azure-native", "peering/v20221001", _module)
...
export class Prefix extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly events: pulumi.Output<types.outputs.PeeringServicePrefixEventResponse[]>;
    /**
     * The prefix learned type
     */
    declare public /*out*/ readonly learnedType: pulumi.Output<string>;
    /**
     ...
     */
    declare public readonly peeringServicePrefixKey: pulumi.Output<string | undefined>;
    /**
    ...
    constructor(name: string, args: PrefixArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["peeringServicePrefixKey"] = args?.peeringServicePrefixKey;
            resourceInputs["prefix"] = args?.prefix;
            resourceInputs["prefixName"] = args?.prefixName;

...
export class VirtualMachineTemplate extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly disks!: pulumi.Output<types.outputs.connectedvmwarevsphere.VirtualDiskResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly networkInterfaces!: pulumi.Output<types.outputs.connectedvmwarevsphere.NetworkInterfaceResponse[]>;
    /**

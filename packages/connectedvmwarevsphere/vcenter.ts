...
export class VCenter extends pulumi.CustomResource {
     ...
     */
    public readonly credentials!: pulumi.Output<types.outputs.connectedvmwarevsphere.VICredentialResponse | undefined>;
    /**
    ...
    constructor(name: string, args: VCenterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:connectedvmwarevsphere/v20201001preview:VCenter" }, { type: "azure-native:connectedvmwarevsphere/v20220110preview:VCenter" }, { type: "azure-native:connectedvmwarevsphere/v20220715preview:VCenter" }, { type: "azure-native:connectedvmwarevsphere/v20230301preview:VCenter" }] };
...
export interface VCenterArgs {
     ...
     * Username / Password Credentials to connect to vcenter.
     */
    credentials?: pulumi.Input<types.inputs.connectedvmwarevsphere.VICredentialArgs>;
    /**
     * Gets or sets the extended location.
     */

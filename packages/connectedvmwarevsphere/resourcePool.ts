...
export class ResourcePool extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly datastoreIds: pulumi.Output<string[]>;
    /**
     ...
     */
    declare public /*out*/ readonly memCapacityGB: pulumi.Output<number>;
    /**
     * Gets or sets MemLimitMB specifies a memory usage limit in megabytes.
     * Utilization will not exceed the specified limit even if there are available resources.
     */
    declare public /*out*/ readonly memLimitMB: pulumi.Output<number>;
    /**
     * Gets the used physical memory on the pool in GB.
     */
    declare public /*out*/ readonly memOverallUsageGB: pulumi.Output<number>;
    /**
     * Gets or sets MemReservationMB which specifies the guaranteed available memory in
     * megabytes.
     */
    declare public /*out*/ readonly memReservationMB: pulumi.Output<number>;
    /**
     * Gets or sets CPUSharesLevel which specifies the memory allocation level for this pool.
     * This property is used in relative allocation between resource consumers.
     */
    declare public /*out*/ readonly memSharesLevel: pulumi.Output<string>;
    /**
     ...
     */
    declare public /*out*/ readonly statuses: pulumi.Output<types.outputs.ResourceStatusResponse[]>;
    /**
     * The system data.
     */
    ...
    constructor(name: string, args: ResourcePoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["resourcePoolName"] = args?.resourcePoolName;

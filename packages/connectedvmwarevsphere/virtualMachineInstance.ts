...
export class VirtualMachineInstance extends pulumi.CustomResource {
     ...
     */
    public readonly infrastructureProfile!: pulumi.Output<types.outputs.connectedvmwarevsphere.InfrastructureProfileResponse | undefined>;
    /**
     ...
     * OS properties.
     */
    public readonly osProfile!: pulumi.Output<types.outputs.connectedvmwarevsphere.OsProfileForVMInstanceResponse | undefined>;
    /**
    ...
    constructor(name: string, args: VirtualMachineInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:connectedvmwarevsphere/v20230301preview:VirtualMachineInstance" }] };
...
export interface VirtualMachineInstanceArgs {
     ...
     * Gets the infrastructure profile.
     */
    infrastructureProfile?: pulumi.Input<types.inputs.connectedvmwarevsphere.InfrastructureProfileArgs>;
    /**
     * Network properties.
     */
     ...
     * OS properties.
     */
    osProfile?: pulumi.Input<types.inputs.connectedvmwarevsphere.OsProfileForVMInstanceArgs>;
    /**
     * Placement properties.
     */

...
export class VCenter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:connectedvmwarevsphere/v20230301preview:VCenter';
     ...
     */
    public readonly credentials!: pulumi.Output<types.outputs.connectedvmwarevsphere.v20230301preview.VICredentialResponse | undefined>;
    /**
    ...
    constructor(name: string, args: VCenterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:connectedvmwarevsphere:VCenter" }, { type: "azure-native:connectedvmwarevsphere/v20201001preview:VCenter" }, { type: "azure-native:connectedvmwarevsphere/v20220110preview:VCenter" }, { type: "azure-native:connectedvmwarevsphere/v20220715preview:VCenter" }] };
...
export interface VCenterArgs {
     ...
     * Username / Password Credentials to connect to vcenter.
     */
    credentials?: pulumi.Input<types.inputs.connectedvmwarevsphere.v20230301preview.VICredentialArgs>;
    /**
     * Gets or sets the extended location.
     */

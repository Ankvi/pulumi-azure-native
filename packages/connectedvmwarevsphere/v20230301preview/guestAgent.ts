...
export class GuestAgent extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:connectedvmwarevsphere/v20230301preview:GuestAgent';
     ...
     */
    public readonly credentials!: pulumi.Output<types.outputs.connectedvmwarevsphere.v20230301preview.GuestCredentialResponse | undefined>;
    /**
     ...
     */
    public readonly httpProxyConfig!: pulumi.Output<types.outputs.connectedvmwarevsphere.v20230301preview.HttpProxyConfigurationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: GuestAgentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:connectedvmwarevsphere:GuestAgent" }, { type: "azure-native:connectedvmwarevsphere/v20201001preview:GuestAgent" }, { type: "azure-native:connectedvmwarevsphere/v20220110preview:GuestAgent" }, { type: "azure-native:connectedvmwarevsphere/v20220715preview:GuestAgent" }] };
...
export interface GuestAgentArgs {
     ...
     * Username / Password Credentials to provision guest agent.
     */
    credentials?: pulumi.Input<types.inputs.connectedvmwarevsphere.v20230301preview.GuestCredentialArgs>;
    /**
     * HTTP Proxy configuration for the VM.
     */
    httpProxyConfig?: pulumi.Input<types.inputs.connectedvmwarevsphere.v20230301preview.HttpProxyConfigurationArgs>;
    /**
     ...
     * Gets or sets the guest agent provisioning action.
     */
    provisioningAction?: pulumi.Input<string | types.enums.v20230301preview.ProvisioningAction>;
    /**

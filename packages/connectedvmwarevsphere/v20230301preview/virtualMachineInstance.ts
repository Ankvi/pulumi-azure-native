...
export class VirtualMachineInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:connectedvmwarevsphere/v20230301preview:VirtualMachineInstance';
    ...
    constructor(name: string, args: VirtualMachineInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:connectedvmwarevsphere:VirtualMachineInstance" }, { type: "azure-native:connectedvmwarevsphere/v20231001:VirtualMachineInstance" }] };

...
export class VMInstanceGuestAgent extends pulumi.CustomResource {
    ...
    constructor(name: string, args: VMInstanceGuestAgentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:connectedvmwarevsphere:VMInstanceGuestAgent" }, { type: "azure-native:connectedvmwarevsphere/v20231001:VMInstanceGuestAgent" }] };

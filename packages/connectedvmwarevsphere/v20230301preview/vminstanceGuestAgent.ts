...
export class VMInstanceGuestAgent extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:connectedvmwarevsphere/v20230301preview:VMInstanceGuestAgent';
    ...
    constructor(name: string, args: VMInstanceGuestAgentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:connectedvmwarevsphere:VMInstanceGuestAgent" }] };

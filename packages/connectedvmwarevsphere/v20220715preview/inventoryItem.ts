...
export class InventoryItem extends pulumi.CustomResource {
    ...
    constructor(name: string, args: InventoryItemArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:connectedvmwarevsphere:InventoryItem" }, { type: "azure-native:connectedvmwarevsphere/v20201001preview:InventoryItem" }, { type: "azure-native:connectedvmwarevsphere/v20220110preview:InventoryItem" }, { type: "azure-native:connectedvmwarevsphere/v20230301preview:InventoryItem" }] };
...
export interface InventoryItemArgs {
     ...
     * They inventory type.
     */
    inventoryType: pulumi.Input<string | types.enums.v20220715preview.InventoryType>;
    /**
     * Metadata used by portal/tooling/etc to render different UX experiences for resources of the same type; e.g. ApiApps are a kind of Microsoft.Web/sites type.  If supported, the resource provider must validate and persist this value.
     */

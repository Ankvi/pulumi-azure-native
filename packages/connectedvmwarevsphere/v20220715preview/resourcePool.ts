...
export class ResourcePool extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ResourcePoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:connectedvmwarevsphere:ResourcePool" }, { type: "azure-native:connectedvmwarevsphere/v20201001preview:ResourcePool" }, { type: "azure-native:connectedvmwarevsphere/v20220110preview:ResourcePool" }, { type: "azure-native:connectedvmwarevsphere/v20230301preview:ResourcePool" }] };

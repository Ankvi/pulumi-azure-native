...
export function getGuestAgent(args: GetGuestAgentArgs, opts?: pulumi.InvokeOptions): Promise<GetGuestAgentResult> {
    ...
    return pulumi.runtime.invoke("azure-native:connectedvmwarevsphere/v20220715preview:getGuestAgent", {
        "name": args.name,
...
export interface GetGuestAgentResult {
     ...
     */
    readonly credentials?: types.outputs.connectedvmwarevsphere.v20220715preview.GuestCredentialResponse;
    /**
     ...
     */
    readonly httpProxyConfig?: types.outputs.connectedvmwarevsphere.v20220715preview.HttpProxyConfigurationResponse;
    /**

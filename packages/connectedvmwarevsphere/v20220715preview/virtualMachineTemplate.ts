...
export class VirtualMachineTemplate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:connectedvmwarevsphere/v20220715preview:VirtualMachineTemplate';
     ...
     */
    public /*out*/ readonly disks!: pulumi.Output<types.outputs.connectedvmwarevsphere.v20220715preview.VirtualDiskResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly networkInterfaces!: pulumi.Output<types.outputs.connectedvmwarevsphere.v20220715preview.NetworkInterfaceResponse[]>;
    /**

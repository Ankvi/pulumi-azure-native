...
export class MachineExtension extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:connectedvmwarevsphere/v20220715preview:MachineExtension';
     ...
     */
    public /*out*/ readonly instanceView!: pulumi.Output<types.outputs.connectedvmwarevsphere.v20220715preview.MachineExtensionPropertiesResponseInstanceView | undefined>;
    /**
    ...
    constructor(name: string, args: MachineExtensionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:connectedvmwarevsphere:MachineExtension" }, { type: "azure-native:connectedvmwarevsphere/v20201001preview:MachineExtension" }, { type: "azure-native:connectedvmwarevsphere/v20220110preview:MachineExtension" }, { type: "azure-native:connectedvmwarevsphere/v20230301preview:MachineExtension" }] };

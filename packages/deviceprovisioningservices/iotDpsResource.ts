...
export class IotDpsResource extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.IotDpsPropertiesDescriptionResponse>;
    /**
     ...
     */
    declare public readonly sku: pulumi.Output<types.outputs.IotDpsSkuInfoResponse>;
    /**

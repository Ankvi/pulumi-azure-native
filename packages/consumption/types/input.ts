...
export namespace consumption {
    ...
    export namespace v20230501 {
        ...
        export interface BudgetComparisonExpressionArgs {
             ...
             * The operator to use for comparison.
             */
            operator: pulumi.Input<string | enums.v20230501.BudgetOperatorType>;
            /**
             * Array of values to use for comparison
             */
            values: pulumi.Input<pulumi.Input<string>[]>;
        ...
        export interface BudgetFilterArgs {
             ...
             * The logical "AND" expression. Must have at least 2 items.
             */
            and?: pulumi.Input<pulumi.Input<v20230501.BudgetFilterPropertiesArgs>[]>;
            /**
             * Has comparison expression for a dimension
             */
            dimensions?: pulumi.Input<v20230501.BudgetComparisonExpressionArgs>;
            /**
             * Has comparison expression for a tag
             */
            tags?: pulumi.Input<v20230501.BudgetComparisonExpressionArgs>;
        }
        ...
        export interface NotificationArgs {
             ...
             * Language in which the recipient will receive the notification
             */
            locale?: pulumi.Input<string | enums.v20230501.CultureCode>;
            /**
             * The comparison operator.
             */
            operator: pulumi.Input<string | enums.v20230501.OperatorType>;
            /**
             * Threshold value associated with a notification. Notification is sent when the cost exceeded the threshold. It is always percent and has to be between 0 and 1000.
             */
            threshold: pulumi.Input<number>;
             ...
             * The type of threshold
             */
            thresholdType?: pulumi.Input<string | enums.v20230501.ThresholdType>;
        }
        /**
         * notificationArgsProvideDefaults sets the appropriate defaults for NotificationArgs
         */
    ...
    export namespace v20231101 {
        ...
        export interface BudgetComparisonExpressionArgs {
             ...
             * The operator to use for comparison.
             */
            operator: pulumi.Input<string | enums.v20231101.BudgetOperatorType>;
            /**
             * Array of values to use for comparison
             */
            values: pulumi.Input<pulumi.Input<string>[]>;
        ...
        export interface BudgetFilterArgs {
             ...
             * The logical "AND" expression. Must have at least 2 items.
             */
            and?: pulumi.Input<pulumi.Input<v20231101.BudgetFilterPropertiesArgs>[]>;
            /**
             * Has comparison expression for a dimension
             */
            dimensions?: pulumi.Input<v20231101.BudgetComparisonExpressionArgs>;
            /**
             * Has comparison expression for a tag
             */
            tags?: pulumi.Input<v20231101.BudgetComparisonExpressionArgs>;
        }
        ...
        export interface NotificationArgs {
             ...
             * Language in which the recipient will receive the notification
             */
            locale?: pulumi.Input<string | enums.v20231101.CultureCode>;
            /**
             * The comparison operator.
             */
            operator: pulumi.Input<string | enums.v20231101.OperatorType>;
            /**
             * Threshold value associated with a notification. Notification is sent when the cost exceeded the threshold. It is always percent and has to be between 0 and 1000.
             */
            threshold: pulumi.Input<number>;
             ...
             * The type of threshold
             */
            thresholdType?: pulumi.Input<string | enums.v20231101.ThresholdType>;
        }
        /**
         * notificationArgsProvideDefaults sets the appropriate defaults for NotificationArgs
         */

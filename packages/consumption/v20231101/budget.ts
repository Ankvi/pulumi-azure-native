...
export class Budget extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:consumption/v20231101:Budget';
     ...
     */
    public /*out*/ readonly currentSpend!: pulumi.Output<types.outputs.consumption.v20231101.CurrentSpendResponse>;
    /**
     ...
     */
    public readonly filter!: pulumi.Output<types.outputs.consumption.v20231101.BudgetFilterResponse | undefined>;
    /**
     * The forecasted cost which is being tracked for a budget.
     */
    public /*out*/ readonly forecastSpend!: pulumi.Output<types.outputs.consumption.v20231101.ForecastSpendResponse>;
    /**
     * Resource name.
     */
     ...
     */
    public readonly notifications!: pulumi.Output<{[key: string]: types.outputs.consumption.v20231101.NotificationResponse} | undefined>;
    /**
     ...
     */
    public readonly timePeriod!: pulumi.Output<types.outputs.consumption.v20231101.BudgetTimePeriodResponse>;
    /**
     * Resource type.
     */
...
export interface BudgetArgs {
     ...
     * The category of the budget, whether the budget tracks cost or usage.
     */
    category: pulumi.Input<string | types.enums.v20231101.CategoryType>;
    /**
     * eTag of the resource. To handle concurrent update scenario, this field will be used to determine whether the user is updating the latest version or not.
     */
     ...
     * May be used to filter budgets by user-specified dimensions and/or tags.
     */
    filter?: pulumi.Input<types.inputs.consumption.v20231101.BudgetFilterArgs>;
    /**
     * Dictionary of notifications associated with the budget. Budget can have up to five notifications.
     */
    notifications?: pulumi.Input<{[key: string]: pulumi.Input<types.inputs.consumption.v20231101.NotificationArgs>}>;
    /**
     ...
     * The time covered by a budget. Tracking of the amount will be reset based on the time grain. BillingMonth, BillingQuarter, and BillingAnnual are only supported by WD customers
     */
    timeGrain: pulumi.Input<string | types.enums.v20231101.TimeGrainType>;
    /**
     * Has start and end date of the budget. The start date must be first of the month and should be less than the end date. Budget start date must be on or after June 1, 2017. Future start date should not be more than twelve months. Past start date should  be selected within the timegrain period. There are no restrictions on the end date.
     */
    timePeriod: pulumi.Input<types.inputs.consumption.v20231101.BudgetTimePeriodArgs>;
}

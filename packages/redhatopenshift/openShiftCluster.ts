...
export class OpenShiftCluster extends pulumi.CustomResource {
     ...
     */
    declare public readonly apiserverProfile: pulumi.Output<types.outputs.APIServerProfileResponse | undefined>;
    /**
     ...
     * The cluster profile.
     */
    declare public readonly clusterProfile: pulumi.Output<types.outputs.ClusterProfileResponse | undefined>;
    /**
     * The console profile.
     */
    declare public /*out*/ readonly consoleProfile: pulumi.Output<types.outputs.ConsoleProfileResponse | undefined>;
    /**
     * The cluster ingress profiles.
     */
    declare public readonly ingressProfiles: pulumi.Output<types.outputs.IngressProfileResponse[] | undefined>;
    /**
     ...
     */
    declare public readonly masterProfile: pulumi.Output<types.outputs.MasterProfileResponse | undefined>;
    /**
     ...
     */
    declare public readonly servicePrincipalProfile: pulumi.Output<types.outputs.ServicePrincipalProfileResponse | undefined>;
    /**
     ...
     */
    declare public readonly workerProfiles: pulumi.Output<types.outputs.WorkerProfileResponse[] | undefined>;
    /**
     * The cluster worker profiles status.
     */
    declare public /*out*/ readonly workerProfilesStatus: pulumi.Output<types.outputs.WorkerProfileResponse[]>;

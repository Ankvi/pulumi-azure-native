...
export class SyncSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:redhatopenshift/v20230401:SyncSet';
    ...
    constructor(name: string, args: SyncSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:redhatopenshift:SyncSet" }, { type: "azure-native:redhatopenshift/v20220904:SyncSet" }, { type: "azure-native:redhatopenshift/v20230701preview:SyncSet" }, { type: "azure-native:redhatopenshift/v20230904:SyncSet" }, { type: "azure-native:redhatopenshift/v20231122:SyncSet" }] };

...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:redhatopenshift/v20230401:MachinePool":
                return new MachinePool(name, <any>undefined, { urn })
            case "azure-native:redhatopenshift/v20230401:OpenShiftCluster":
                return new OpenShiftCluster(name, <any>undefined, { urn })
            case "azure-native:redhatopenshift/v20230401:Secret":
                return new Secret(name, <any>undefined, { urn })
            case "azure-native:redhatopenshift/v20230401:SyncIdentityProvider":
                return new SyncIdentityProvider(name, <any>undefined, { urn })
            case "azure-native:redhatopenshift/v20230401:SyncSet":
...
pulumi.runtime.registerResourceModule("azure-native", "redhatopenshift/v20230401", _module)
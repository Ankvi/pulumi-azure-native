...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:redhatopenshift/v20230904:MachinePool":
                return new MachinePool(name, <any>undefined, { urn })
            case "azure-native:redhatopenshift/v20230904:OpenShiftCluster":
                return new OpenShiftCluster(name, <any>undefined, { urn })
            case "azure-native:redhatopenshift/v20230904:Secret":
                return new Secret(name, <any>undefined, { urn })
            case "azure-native:redhatopenshift/v20230904:SyncIdentityProvider":
                return new SyncIdentityProvider(name, <any>undefined, { urn })
            case "azure-native:redhatopenshift/v20230904:SyncSet":
...
pulumi.runtime.registerResourceModule("azure-native", "redhatopenshift/v20230904", _module)
...
export class SyncSet extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SyncSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:redhatopenshift:SyncSet" }, { type: "azure-native:redhatopenshift/v20230401:SyncSet" }, { type: "azure-native:redhatopenshift/v20230701preview:SyncSet" }] };

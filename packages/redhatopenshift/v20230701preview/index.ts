...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:redhatopenshift/v20230701preview:MachinePool":
                return new MachinePool(name, <any>undefined, { urn })
            case "azure-native:redhatopenshift/v20230701preview:OpenShiftCluster":
                return new OpenShiftCluster(name, <any>undefined, { urn })
            case "azure-native:redhatopenshift/v20230701preview:Secret":
                return new Secret(name, <any>undefined, { urn })
            case "azure-native:redhatopenshift/v20230701preview:SyncIdentityProvider":
                return new SyncIdentityProvider(name, <any>undefined, { urn })
            case "azure-native:redhatopenshift/v20230701preview:SyncSet":
...
pulumi.runtime.registerResourceModule("azure-native", "redhatopenshift/v20230701preview", _module)
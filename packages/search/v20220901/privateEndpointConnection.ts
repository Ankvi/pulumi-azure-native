...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:search/v20220901:PrivateEndpointConnection';
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.search.v20220901.PrivateEndpointConnectionPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(types.inputs.search.v20220901.privateEndpointConnectionPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface PrivateEndpointConnectionArgs {
     ...
     * Describes the properties of an existing Private Endpoint connection to the Azure Cognitive Search service.
     */
    properties?: pulumi.Input<types.inputs.search.v20220901.PrivateEndpointConnectionPropertiesArgs>;
    /**

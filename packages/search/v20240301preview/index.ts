...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:search/v20240301preview:PrivateEndpointConnection":
                return new PrivateEndpointConnection(name, <any>undefined, { urn })
            case "azure-native:search/v20240301preview:Service":
                return new Service(name, <any>undefined, { urn })
            case "azure-native:search/v20240301preview:SharedPrivateLinkResource":
...
pulumi.runtime.registerResourceModule("azure-native", "search/v20240301preview", _module)
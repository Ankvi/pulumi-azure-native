...
export class SharedPrivateLinkResource extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.search.SharedPrivateLinkResourcePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: SharedPrivateLinkResourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:search/v20200801:SharedPrivateLinkResource" }, { type: "azure-native:search/v20200801preview:SharedPrivateLinkResource" }, { type: "azure-native:search/v20210401preview:SharedPrivateLinkResource" }, { type: "azure-native:search/v20220901:SharedPrivateLinkResource" }] };
...
export interface SharedPrivateLinkResourceArgs {
     ...
     * Describes the properties of a Shared Private Link Resource managed by the Azure Cognitive Search service.
     */
    properties?: pulumi.Input<types.inputs.search.SharedPrivateLinkResourcePropertiesArgs>;
    /**

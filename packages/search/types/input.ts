...
export namespace search {
    ...
    export namespace v20210401preview {
        ...
        export interface DataPlaneAadOrApiKeyAuthOptionArgs {
             ...
             * Describes what response the data plane API of a Search service would send for requests that failed authentication.
             */
            aadAuthFailureMode?: pulumi.Input<enums.v20210401preview.AadAuthFailureMode>;
        }
        ...
        export interface DataPlaneAuthOptionsArgs {
             ...
             * Indicates that either the API key or an access token from Azure Active Directory can be used for authentication.
             */
            aadOrApiKey?: pulumi.Input<v20210401preview.DataPlaneAadOrApiKeyAuthOptionArgs>;
            /**
             * Indicates that only the API key needs to be used for authentication.
             */
            apiKeyOnly?: any;
        ...
        export interface EncryptionWithCmkArgs {
             ...
             * Describes how a search service should enforce having one or more non customer encrypted resources.
             */
            enforcement?: pulumi.Input<enums.v20210401preview.SearchEncryptionWithCmk>;
        }
        ...
        export interface IdentityArgs {
             ...
             */
            type: pulumi.Input<string | enums.v20210401preview.IdentityType>;
            /**
        ...
        export interface NetworkRuleSetArgs {
             ...
             */
            bypass?: pulumi.Input<string | enums.v20210401preview.SearchBypass>;
            /**
             * A list of IP restriction rules that defines the inbound network(s) with allowing access to the search service endpoint. At the meantime, all other public IP networks are blocked by the firewall. These restriction rules are applied only when the 'publicNetworkAccess' of the search service is 'enabled'; otherwise, traffic over public interface is not allowed even with any public IP rules, and private endpoint connections would be the exclusive access method.
             */
            ipRules?: pulumi.Input<pulumi.Input<v20210401preview.IpRuleArgs>[]>;
        }
        ...
        export interface SkuArgs {
             ...
             * The SKU of the search service. Valid values include: 'free': Shared service. 'basic': Dedicated service with up to 3 replicas. 'standard': Dedicated service with up to 12 partitions and 12 replicas. 'standard2': Similar to standard, but with more capacity per search unit. 'standard3': The largest Standard offering with up to 12 partitions and 12 replicas (or up to 3 partitions with more indexes if you also set the hostingMode property to 'highDensity'). 'storage_optimized_l1': Supports 1TB per partition, up to 12 partitions. 'storage_optimized_l2': Supports 2TB per partition, up to 12 partitions.'
             */
            name?: pulumi.Input<string | enums.v20210401preview.SkuName>;
        }
    ...
    export namespace v20220901 {
        ...
        export interface DataPlaneAadOrApiKeyAuthOptionArgs {
             ...
             * Describes what response the data plane API of a Search service would send for requests that failed authentication.
             */
            aadAuthFailureMode?: pulumi.Input<enums.v20220901.AadAuthFailureMode>;
        }
        ...
        export interface DataPlaneAuthOptionsArgs {
             ...
             * Indicates that either the API key or an access token from Azure Active Directory can be used for authentication.
             */
            aadOrApiKey?: pulumi.Input<v20220901.DataPlaneAadOrApiKeyAuthOptionArgs>;
            /**
             * Indicates that only the API key needs to be used for authentication.
             */
            apiKeyOnly?: any;
        ...
        export interface EncryptionWithCmkArgs {
             ...
             * Describes how a search service should enforce having one or more non customer encrypted resources.
             */
            enforcement?: pulumi.Input<enums.v20220901.SearchEncryptionWithCmk>;
        }
        ...
        export interface IdentityArgs {
             ...
             * The identity type.
             */
            type: pulumi.Input<enums.v20220901.IdentityType>;
        }
        ...
        export interface PrivateEndpointConnectionPropertiesArgs {
             ...
             * The private endpoint resource from Microsoft.Network provider.
             */
            privateEndpoint?: pulumi.Input<v20220901.PrivateEndpointConnectionPropertiesPrivateEndpointArgs>;
            /**
             * Describes the current state of an existing Private Link Service connection to the Azure Private Endpoint.
             */
            privateLinkServiceConnectionState?: pulumi.Input<v20220901.PrivateEndpointConnectionPropertiesPrivateLinkServiceConnectionStateArgs>;
            /**
             * The provisioning state of the private link service connection. Can be Updating, Deleting, Failed, Succeeded, or Incomplete
             */
            provisioningState?: pulumi.Input<string | enums.v20220901.PrivateLinkServiceConnectionProvisioningState>;
        }
        /**
         * privateEndpointConnectionPropertiesArgsProvideDefaults sets the appropriate defaults for PrivateEndpointConnectionPropertiesArgs
         */
        export function privateEndpointConnectionPropertiesArgsProvideDefaults(val: PrivateEndpointConnectionPropertiesArgs): PrivateEndpointConnectionPropertiesArgs {
            return {
                ...val,
                privateLinkServiceConnectionState: (val.privateLinkServiceConnectionState ? pulumi.output(val.privateLinkServiceConnectionState).apply(v20220901.privateEndpointConnectionPropertiesPrivateLinkServiceConnectionStateArgsProvideDefaults) : undefined),
            };
        }
        ...
        export interface PrivateEndpointConnectionPropertiesPrivateLinkServiceConnectionStateArgs {
             ...
             * Status of the the private link service connection. Can be Pending, Approved, Rejected, or Disconnected.
             */
            status?: pulumi.Input<enums.v20220901.PrivateLinkServiceConnectionStatus>;
        }
        /**
         * privateEndpointConnectionPropertiesPrivateLinkServiceConnectionStateArgsProvideDefaults sets the appropriate defaults for PrivateEndpointConnectionPropertiesPrivateLinkServiceConnectionStateArgs
         */
        ...
        export interface SharedPrivateLinkResourcePropertiesArgs {
             ...
             * The provisioning state of the shared private link resource. Can be Updating, Deleting, Failed, Succeeded or Incomplete.
             */
            provisioningState?: pulumi.Input<enums.v20220901.SharedPrivateLinkResourceProvisioningState>;
            /**
             * The request message for requesting approval of the shared private link resource.
             */
            requestMessage?: pulumi.Input<string>;
             ...
             * Status of the shared private link resource. Can be Pending, Approved, Rejected or Disconnected.
             */
            status?: pulumi.Input<enums.v20220901.SharedPrivateLinkResourceStatus>;
        }
        ...
        export interface SkuArgs {
             ...
             * The SKU of the search service. Valid values include: 'free': Shared service. 'basic': Dedicated service with up to 3 replicas. 'standard': Dedicated service with up to 12 partitions and 12 replicas. 'standard2': Similar to standard, but with more capacity per search unit. 'standard3': The largest Standard offering with up to 12 partitions and 12 replicas (or up to 3 partitions with more indexes if you also set the hostingMode property to 'highDensity'). 'storage_optimized_l1': Supports 1TB per partition, up to 12 partitions. 'storage_optimized_l2': Supports 2TB per partition, up to 12 partitions.'
             */
            name?: pulumi.Input<enums.v20220901.SkuName>;
        }

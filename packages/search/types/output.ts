...
export namespace search {
    ...
    export namespace v20210401preview {
        ...
        export interface DataPlaneAuthOptionsResponse {
             ...
             * Indicates that either the API key or an access token from Azure Active Directory can be used for authentication.
             */
            aadOrApiKey?: v20210401preview.DataPlaneAadOrApiKeyAuthOptionResponse;
            /**
             * Indicates that only the API key needs to be used for authentication.
             */
            apiKeyOnly?: any;
        ...
        export interface IdentityResponse {
             ...
             */
            userAssignedIdentities?: {[key: string]: v20210401preview.UserAssignedManagedIdentityResponse};
        }
        ...
        export interface NetworkRuleSetResponse {
             ...
             * A list of IP restriction rules that defines the inbound network(s) with allowing access to the search service endpoint. At the meantime, all other public IP networks are blocked by the firewall. These restriction rules are applied only when the 'publicNetworkAccess' of the search service is 'enabled'; otherwise, traffic over public interface is not allowed even with any public IP rules, and private endpoint connections would be the exclusive access method.
             */
            ipRules?: v20210401preview.IpRuleResponse[];
        }
        ...
        export interface PrivateEndpointConnectionPropertiesResponse {
             ...
             * The private endpoint resource from Microsoft.Network provider.
             */
            privateEndpoint?: v20210401preview.PrivateEndpointConnectionPropertiesResponsePrivateEndpoint;
            /**
             * Describes the current state of an existing Private Link Service connection to the Azure Private Endpoint.
             */
            privateLinkServiceConnectionState?: v20210401preview.PrivateEndpointConnectionPropertiesResponsePrivateLinkServiceConnectionState;
        }
        /**
         * privateEndpointConnectionPropertiesResponseProvideDefaults sets the appropriate defaults for PrivateEndpointConnectionPropertiesResponse
         */
        export function privateEndpointConnectionPropertiesResponseProvideDefaults(val: PrivateEndpointConnectionPropertiesResponse): PrivateEndpointConnectionPropertiesResponse {
            return {
                ...val,
                privateLinkServiceConnectionState: (val.privateLinkServiceConnectionState ? v20210401preview.privateEndpointConnectionPropertiesResponsePrivateLinkServiceConnectionStateProvideDefaults(val.privateLinkServiceConnectionState) : undefined),
            };
        }
        ...
        export interface PrivateEndpointConnectionResponse {
             ...
             * Describes the properties of an existing Private Endpoint connection to the Azure Cognitive Search service.
             */
            properties?: v20210401preview.PrivateEndpointConnectionPropertiesResponse;
            /**
             * The type of the resource. E.g. "Microsoft.Compute/virtualMachines" or "Microsoft.Storage/storageAccounts"
             */
            type: string;
        ...
        export function privateEndpointConnectionResponseProvideDefaults(val: PrivateEndpointConnectionResponse): PrivateEndpointConnectionResponse {
            return {
                ...val,
                properties: (val.properties ? v20210401preview.privateEndpointConnectionPropertiesResponseProvideDefaults(val.properties) : undefined),
            };
        }
        ...
        export interface SharedPrivateLinkResourceResponse {
             ...
             * Describes the properties of a Shared Private Link Resource managed by the Azure Cognitive Search service.
             */
            properties?: v20210401preview.SharedPrivateLinkResourcePropertiesResponse;
            /**
             * The type of the resource. E.g. "Microsoft.Compute/virtualMachines" or "Microsoft.Storage/storageAccounts"
             */
            type: string;
    ...
    export namespace v20220901 {
        ...
        export interface DataPlaneAuthOptionsResponse {
             ...
             * Indicates that either the API key or an access token from Azure Active Directory can be used for authentication.
             */
            aadOrApiKey?: v20220901.DataPlaneAadOrApiKeyAuthOptionResponse;
            /**
             * Indicates that only the API key needs to be used for authentication.
             */
            apiKeyOnly?: any;
        ...
        export interface PrivateEndpointConnectionPropertiesResponse {
             ...
             * The private endpoint resource from Microsoft.Network provider.
             */
            privateEndpoint?: v20220901.PrivateEndpointConnectionPropertiesResponsePrivateEndpoint;
            /**
             * Describes the current state of an existing Private Link Service connection to the Azure Private Endpoint.
             */
            privateLinkServiceConnectionState?: v20220901.PrivateEndpointConnectionPropertiesResponsePrivateLinkServiceConnectionState;
            /**
             * The provisioning state of the private link service connection. Can be Updating, Deleting, Failed, Succeeded, or Incomplete
             */
            provisioningState?: string;
        ...
        export function privateEndpointConnectionPropertiesResponseProvideDefaults(val: PrivateEndpointConnectionPropertiesResponse): PrivateEndpointConnectionPropertiesResponse {
            return {
                ...val,
                privateLinkServiceConnectionState: (val.privateLinkServiceConnectionState ? v20220901.privateEndpointConnectionPropertiesResponsePrivateLinkServiceConnectionStateProvideDefaults(val.privateLinkServiceConnectionState) : undefined),
            };
        }
        ...
        export interface PrivateEndpointConnectionResponse {
             ...
             * Describes the properties of an existing Private Endpoint connection to the Azure Cognitive Search service.
             */
            properties?: v20220901.PrivateEndpointConnectionPropertiesResponse;
            /**
             * The type of the resource. E.g. "Microsoft.Compute/virtualMachines" or "Microsoft.Storage/storageAccounts"
             */
            type: string;
        ...
        export function privateEndpointConnectionResponseProvideDefaults(val: PrivateEndpointConnectionResponse): PrivateEndpointConnectionResponse {
            return {
                ...val,
                properties: (val.properties ? v20220901.privateEndpointConnectionPropertiesResponseProvideDefaults(val.properties) : undefined),
            };
        }
        ...
        export interface SharedPrivateLinkResourceResponse {
             ...
             * Describes the properties of a Shared Private Link Resource managed by the Azure Cognitive Search service.
             */
            properties?: v20220901.SharedPrivateLinkResourcePropertiesResponse;
            /**
             * The type of the resource. E.g. "Microsoft.Compute/virtualMachines" or "Microsoft.Storage/storageAccounts"
             */
            type: string;

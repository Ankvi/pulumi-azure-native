...
export class Replica extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:appconfiguration/v20230801preview:Replica';
    ...
    constructor(name: string, args: ReplicaArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:appconfiguration:Replica" }, { type: "azure-native:appconfiguration/v20220301preview:Replica" }, { type: "azure-native:appconfiguration/v20230301:Replica" }, { type: "azure-native:appconfiguration/v20230901preview:Replica" }] };

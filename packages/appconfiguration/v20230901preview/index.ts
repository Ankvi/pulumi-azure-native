...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            ...
            case "azure-native:appconfiguration/v20230901preview:KeyValue":
                return new KeyValue(name, <any>undefined, { urn })
            case "azure-native:appconfiguration/v20230901preview:PrivateEndpointConnection":
                return new PrivateEndpointConnection(name, <any>undefined, { urn })
            case "azure-native:appconfiguration/v20230901preview:Replica":

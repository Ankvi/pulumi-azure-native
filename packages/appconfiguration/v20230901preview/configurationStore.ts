...
export class ConfigurationStore extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:appconfiguration/v20230901preview:ConfigurationStore';
     ...
     */
    public readonly dataPlaneProxy!: pulumi.Output<types.outputs.DataPlaneProxyPropertiesResponse | undefined>;
    /**
     ...
     */
    public readonly experimentation!: pulumi.Output<types.outputs.ExperimentationPropertiesResponse | undefined>;
    /**
     ...
     */
    public readonly telemetry!: pulumi.Output<types.outputs.TelemetryPropertiesResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ConfigurationStoreArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["experimentation"] = args ? args.experimentation : undefined;
            ...
            resourceInputs["endpoint"] = undefined /*out*/;
            resourceInputs["experimentation"] = undefined /*out*/;
...
export interface ConfigurationStoreArgs {
     ...
     * Property specifying the configuration of experimentation for this configuration store
     */
    experimentation?: pulumi.Input<types.inputs.ExperimentationPropertiesArgs>;
    /**
     * The managed identity information, if configured.
     */
     ...
     * Property specifying the configuration of telemetry for this configuration store
     */
    telemetry?: pulumi.Input<types.inputs.TelemetryPropertiesArgs>;
}
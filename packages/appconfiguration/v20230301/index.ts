...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:appconfiguration/v20230301:ConfigurationStore":
                return new ConfigurationStore(name, <any>undefined, { urn })
            case "azure-native:appconfiguration/v20230301:KeyValue":
                return new KeyValue(name, <any>undefined, { urn })
            case "azure-native:appconfiguration/v20230301:PrivateEndpointConnection":
                return new PrivateEndpointConnection(name, <any>undefined, { urn })
            case "azure-native:appconfiguration/v20230301:Replica":
...
pulumi.runtime.registerResourceModule("azure-native", "appconfiguration/v20230301", _module)
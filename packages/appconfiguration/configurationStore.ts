...
export class ConfigurationStore extends pulumi.CustomResource {
     ...
     */
    declare public readonly dataPlaneProxy: pulumi.Output<types.outputs.DataPlaneProxyPropertiesResponse | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly privateEndpointConnections: pulumi.Output<types.outputs.PrivateEndpointConnectionReferenceResponse[]>;
    /**

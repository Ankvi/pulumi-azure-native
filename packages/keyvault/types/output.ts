...
export namespace keyvault {
    ...
    export namespace v20230201 {
        ...
        export interface AccessPolicyEntryResponse {
             ...
             * Permissions the identity has for keys, secrets and certificates.
             */
            permissions: v20230201.PermissionsResponse;
            /**
             * The Azure Active Directory tenant ID that should be used for authenticating requests to the key vault.
             */
            tenantId: string;
        ...
        export interface LifetimeActionResponse {
             ...
             * The action of key rotation policy lifetimeAction.
             */
            action?: v20230201.ActionResponse;
            /**
             * The trigger of key rotation policy lifetimeAction.
             */
            trigger?: v20230201.TriggerResponse;
        }
        ...
        export interface MHSMNetworkRuleSetResponse {
             ...
             * The list of IP address rules.
             */
            ipRules?: v20230201.MHSMIPRuleResponse[];
            /**
             * The list of virtual network rules.
             */
            virtualNetworkRules?: v20230201.MHSMVirtualNetworkRuleResponse[];
        }
        ...
        export interface MHSMPrivateEndpointConnectionItemResponse {
             ...
             * Properties of the private endpoint object.
             */
            privateEndpoint?: v20230201.MHSMPrivateEndpointResponse;
            /**
             * Approval state of the private link connection.
             */
            privateLinkServiceConnectionState?: v20230201.MHSMPrivateLinkServiceConnectionStateResponse;
            /**
             * Provisioning state of the private endpoint connection.
             */
            provisioningState: string;
        ...
        export interface ManagedHsmPropertiesResponse {
             ...
             * Rules governing the accessibility of the key vault from specific network locations.
             */
            networkAcls?: v20230201.MHSMNetworkRuleSetResponse;
            /**
             * List of private endpoint connections associated with the managed hsm pool.
             */
            privateEndpointConnections: v20230201.MHSMPrivateEndpointConnectionItemResponse[];
            /**
             * Provisioning state.
             */
            provisioningState: string;
             ...
             * List of all regions associated with the managed hsm pool.
             */
            regions?: v20230201.MHSMGeoReplicatedRegionResponse[];
            /**
             * The scheduled purge date in UTC.
             */
            scheduledPurgeDate: string;
             ...
             * Managed HSM security domain properties.
             */
            securityDomainProperties: v20230201.ManagedHSMSecurityDomainPropertiesResponse;
            /**
             * Soft deleted data retention days. When you delete an HSM or a key, it will remain recoverable for the configured retention period or for a default period of 90 days. It accepts values between 7 and 90.
             */
            softDeleteRetentionInDays?: number;
        ...
        export interface NetworkRuleSetResponse {
             ...
             * The list of IP address rules.
             */
            ipRules?: v20230201.IPRuleResponse[];
            /**
             * The list of virtual network rules.
             */
            virtualNetworkRules?: v20230201.VirtualNetworkRuleResponse[];
        }
        ...
        export interface RotationPolicyResponse {
             ...
             * The attributes of key rotation policy.
             */
            attributes?: v20230201.KeyRotationPolicyAttributesResponse;
            /**
             * The lifetimeActions for key rotation action.
             */
            lifetimeActions?: v20230201.LifetimeActionResponse[];
        }
        ...
        export interface SecretPropertiesResponse {
             ...
             * The attributes of the secret.
             */
            attributes?: v20230201.SecretAttributesResponse;
            /**
             * The content type of the secret.
             */
            contentType?: string;
        ...
        export interface VaultPropertiesResponse {
             ...
             * An array of 0 to 1024 identities that have access to the key vault. All identities in the array must use the same tenant ID as the key vault's tenant ID. When `createMode` is set to `recover`, access policies are not required. Otherwise, access policies are required.
             */
            accessPolicies?: v20230201.AccessPolicyEntryResponse[];
            /**
             * Property specifying whether protection against purge is enabled for this vault. Setting this property to true activates protection against purge for this vault and its content - only the Key Vault service may initiate a hard, irrecoverable deletion. The setting is effective only if soft delete is also enabled. Enabling this functionality is irreversible - that is, the property does not accept false as its value.
             */
            enablePurgeProtection?: boolean;
             ...
             * Rules governing the accessibility of the key vault from specific network locations.
             */
            networkAcls?: v20230201.NetworkRuleSetResponse;
            /**
             * List of private endpoint connections associated with the key vault.
             */
            privateEndpointConnections: v20230201.PrivateEndpointConnectionItemResponse[];
            /**
             * Provisioning state of the vault.
             */
            provisioningState?: string;

...
export namespace keyvault {
    ...
    export namespace v20230201 {
        ...
        export interface AccessPolicyEntryArgs {
             ...
             * Permissions the identity has for keys, secrets and certificates.
             */
            permissions: pulumi.Input<v20230201.PermissionsArgs>;
            /**
             * The Azure Active Directory tenant ID that should be used for authenticating requests to the key vault.
             */
            tenantId: pulumi.Input<string>;
        ...
        export interface ActionArgs {
             ...
             * The type of the action.
             */
            type?: pulumi.Input<enums.v20230201.KeyRotationPolicyActionType>;
        }
        ...
        export interface KeyPropertiesArgs {
             ...
             * The attributes of the key.
             */
            attributes?: pulumi.Input<v20230201.KeyAttributesArgs>;
            /**
             * The elliptic curve name. For valid values, see JsonWebKeyCurveName.
             */
            curveName?: pulumi.Input<string | enums.v20230201.JsonWebKeyCurveName>;
            keyOps?: pulumi.Input<pulumi.Input<string | enums.v20230201.JsonWebKeyOperation>[]>;
            /**
             * The key size in bits. For example: 2048, 3072, or 4096 for RSA.
             */
            keySize?: pulumi.Input<number>;
             ...
             * The type of the key. For valid values, see JsonWebKeyType.
             */
            kty?: pulumi.Input<string | enums.v20230201.JsonWebKeyType>;
            /**
             * Key release policy in response. It will be used for both output and input. Omitted if empty
             */
            releasePolicy?: pulumi.Input<v20230201.KeyReleasePolicyArgs>;
            /**
             * Key rotation policy in response. It will be used for both output and input. Omitted if empty
             */
            rotationPolicy?: pulumi.Input<v20230201.RotationPolicyArgs>;
        }
        /**
         * keyPropertiesArgsProvideDefaults sets the appropriate defaults for KeyPropertiesArgs
         */
        export function keyPropertiesArgsProvideDefaults(val: KeyPropertiesArgs): KeyPropertiesArgs {
            return {
                ...val,
                attributes: (val.attributes ? pulumi.output(val.attributes).apply(v20230201.keyAttributesArgsProvideDefaults) : undefined),
                releasePolicy: (val.releasePolicy ? pulumi.output(val.releasePolicy).apply(v20230201.keyReleasePolicyArgsProvideDefaults) : undefined),
            };
        }
        ...
        export interface LifetimeActionArgs {
             ...
             * The action of key rotation policy lifetimeAction.
             */
            action?: pulumi.Input<v20230201.ActionArgs>;
            /**
             * The trigger of key rotation policy lifetimeAction.
             */
            trigger?: pulumi.Input<v20230201.TriggerArgs>;
        }
        ...
        export interface MHSMNetworkRuleSetArgs {
             ...
             * Tells what traffic can bypass network rules. This can be 'AzureServices' or 'None'.  If not specified the default is 'AzureServices'.
             */
            bypass?: pulumi.Input<string | enums.v20230201.NetworkRuleBypassOptions>;
            /**
             * The default action when no rule from ipRules and from virtualNetworkRules match. This is only used after the bypass property has been evaluated.
             */
            defaultAction?: pulumi.Input<string | enums.v20230201.NetworkRuleAction>;
            /**
             * The list of IP address rules.
             */
            ipRules?: pulumi.Input<pulumi.Input<v20230201.MHSMIPRuleArgs>[]>;
            /**
             * The list of virtual network rules.
             */
            virtualNetworkRules?: pulumi.Input<pulumi.Input<v20230201.MHSMVirtualNetworkRuleArgs>[]>;
        }
        ...
        export interface MHSMPrivateLinkServiceConnectionStateArgs {
             ...
             * A message indicating if changes on the service provider require any updates on the consumer.
             */
            actionsRequired?: pulumi.Input<string | enums.v20230201.ActionsRequired>;
            /**
             * The reason for approval or rejection.
             */
            description?: pulumi.Input<string>;
             ...
             * Indicates whether the connection has been approved, rejected or removed by the key vault owner.
             */
            status?: pulumi.Input<string | enums.v20230201.PrivateEndpointServiceConnectionStatus>;
        }
        ...
        export interface ManagedHsmPropertiesArgs {
             ...
             * The create mode to indicate whether the resource is being created or is being recovered from a deleted resource.
             */
            createMode?: pulumi.Input<enums.v20230201.CreateMode>;
            /**
             * Property specifying whether protection against purge is enabled for this managed HSM pool. Setting this property to true activates protection against purge for this managed HSM pool and its content - only the Managed HSM service may initiate a hard, irrecoverable deletion. Enabling this functionality is irreversible.
             */
            enablePurgeProtection?: pulumi.Input<boolean>;
             ...
             * Rules governing the accessibility of the key vault from specific network locations.
             */
            networkAcls?: pulumi.Input<v20230201.MHSMNetworkRuleSetArgs>;
            /**
             * Control permission to the managed HSM from public networks.
             */
            publicNetworkAccess?: pulumi.Input<string | enums.v20230201.PublicNetworkAccess>;
            /**
             * List of all regions associated with the managed hsm pool.
             */
            regions?: pulumi.Input<pulumi.Input<v20230201.MHSMGeoReplicatedRegionArgs>[]>;
            /**
             * Soft deleted data retention days. When you delete an HSM or a key, it will remain recoverable for the configured retention period or for a default period of 90 days. It accepts values between 7 and 90.
             */
            softDeleteRetentionInDays?: pulumi.Input<number>;
        ...
        export interface ManagedHsmSkuArgs {
             ...
             * SKU Family of the managed HSM Pool
             */
            family: pulumi.Input<string | enums.v20230201.ManagedHsmSkuFamily>;
            /**
             * SKU of the managed HSM Pool
             */
            name: pulumi.Input<enums.v20230201.ManagedHsmSkuName>;
        }
        ...
        export interface NetworkRuleSetArgs {
             ...
             * The list of IP address rules.
             */
            ipRules?: pulumi.Input<pulumi.Input<v20230201.IPRuleArgs>[]>;
            /**
             * The list of virtual network rules.
             */
            virtualNetworkRules?: pulumi.Input<pulumi.Input<v20230201.VirtualNetworkRuleArgs>[]>;
        }
        ...
        export interface PermissionsArgs {
             ...
             * Permissions to certificates
             */
            certificates?: pulumi.Input<pulumi.Input<string | enums.v20230201.CertificatePermissions>[]>;
            /**
             * Permissions to keys
             */
            keys?: pulumi.Input<pulumi.Input<string | enums.v20230201.KeyPermissions>[]>;
            /**
             * Permissions to secrets
             */
            secrets?: pulumi.Input<pulumi.Input<string | enums.v20230201.SecretPermissions>[]>;
            /**
             * Permissions to storage accounts
             */
            storage?: pulumi.Input<pulumi.Input<string | enums.v20230201.StoragePermissions>[]>;
        }
        ...
        export interface RotationPolicyArgs {
             ...
             * The attributes of key rotation policy.
             */
            attributes?: pulumi.Input<v20230201.KeyRotationPolicyAttributesArgs>;
            /**
             * The lifetimeActions for key rotation action.
             */
            lifetimeActions?: pulumi.Input<pulumi.Input<v20230201.LifetimeActionArgs>[]>;
        }
        ...
        export interface SecretPropertiesArgs {
             ...
             * The attributes of the secret.
             */
            attributes?: pulumi.Input<v20230201.SecretAttributesArgs>;
            /**
             * The content type of the secret.
             */
            contentType?: pulumi.Input<string>;
        ...
        export interface SkuArgs {
             ...
             * SKU family name
             */
            family: pulumi.Input<string | enums.v20230201.SkuFamily>;
            /**
             * SKU name to specify whether the key vault is a standard vault or a premium vault.
             */
            name: pulumi.Input<enums.v20230201.SkuName>;
        }
        ...
        export interface VaultPropertiesArgs {
             ...
             * An array of 0 to 1024 identities that have access to the key vault. All identities in the array must use the same tenant ID as the key vault's tenant ID. When `createMode` is set to `recover`, access policies are not required. Otherwise, access policies are required.
             */
            accessPolicies?: pulumi.Input<pulumi.Input<v20230201.AccessPolicyEntryArgs>[]>;
            /**
             * The vault's create mode to indicate whether the vault need to be recovered or not.
             */
            createMode?: pulumi.Input<enums.v20230201.CreateMode>;
             ...
             * Rules governing the accessibility of the key vault from specific network locations.
             */
            networkAcls?: pulumi.Input<v20230201.NetworkRuleSetArgs>;
            /**
             * Provisioning state of the vault.
             */
            provisioningState?: pulumi.Input<string | enums.v20230201.VaultProvisioningState>;
            /**
             * Property to specify whether the vault will accept traffic from public internet. If set to 'disabled' all traffic except private endpoint traffic and that that originates from trusted services will be blocked. This will override the set firewall rules, meaning that even if the firewall rules are present we will not honor the rules.
             */
            publicNetworkAccess?: pulumi.Input<string>;
             ...
             * SKU details
             */
            sku: pulumi.Input<v20230201.SkuArgs>;
            /**
             * softDelete data retention days. It accepts >=7 and <=90.
             */
            softDeleteRetentionInDays?: pulumi.Input<number>;

...
export class ManagedHsm extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:keyvault/v20230701:ManagedHsm';

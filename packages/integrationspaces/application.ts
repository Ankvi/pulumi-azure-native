...
export class Application extends pulumi.CustomResource {
     ...
     */
    declare public readonly trackingDataStores: pulumi.Output<{[key: string]: types.outputs.TrackingDataStoreResponse} | undefined>;
    /**
    ...
    constructor(name: string, args: ApplicationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["trackingDataStores"] = args?.trackingDataStores;

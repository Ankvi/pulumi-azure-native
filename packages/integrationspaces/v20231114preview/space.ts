...
export class Space extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:integrationspaces/v20231114preview:Space';
    ...
    constructor(name: string, args: SpaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:integrationspaces:Space" }] };

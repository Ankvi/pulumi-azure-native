...
export class BusinessProcess extends pulumi.CustomResource {
     ...
     */
    declare public readonly businessProcessMapping: pulumi.Output<{[key: string]: types.outputs.BusinessProcessMappingItemResponse} | undefined>;
    /**
     * The business process stages.
     */
    declare public readonly businessProcessStages: pulumi.Output<{[key: string]: types.outputs.BusinessProcessStageResponse} | undefined>;
    /**
     ...
     */
    declare public readonly identifier: pulumi.Output<types.outputs.BusinessProcessIdentifierResponse | undefined>;
    /**

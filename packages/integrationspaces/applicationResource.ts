...
export class ApplicationResource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:integrationspaces:ApplicationResource';
     ...
     */
    declare public readonly resourceKind: pulumi.Output<string | undefined>;
    /**
    ...
    constructor(name: string, args: ApplicationResourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["resourceKind"] = args?.resourceKind;

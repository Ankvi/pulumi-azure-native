...
export class LandingZoneRegistrationOperation extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.LandingZoneRegistrationResourcePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: LandingZoneRegistrationOperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["landingZoneRegistrationName"] = args?.landingZoneRegistrationName;

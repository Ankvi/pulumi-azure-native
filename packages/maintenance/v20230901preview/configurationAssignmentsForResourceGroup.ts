...
export class ConfigurationAssignmentsForResourceGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:maintenance/v20230901preview:ConfigurationAssignmentsForResourceGroup';
    ...
    constructor(name: string, args: ConfigurationAssignmentsForResourceGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:maintenance:ConfigurationAssignmentsForResourceGroup" }, { type: "azure-native:maintenance/v20230401:ConfigurationAssignmentsForResourceGroup" }, { type: "azure-native:maintenance/v20231001preview:ConfigurationAssignmentsForResourceGroup" }] };

...
export class ConfigurationAssignmentsForSubscription extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:maintenance/v20230901preview:ConfigurationAssignmentsForSubscription';
    ...
    constructor(name: string, args?: ConfigurationAssignmentsForSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:maintenance:ConfigurationAssignmentsForSubscription" }, { type: "azure-native:maintenance/v20230401:ConfigurationAssignmentsForSubscription" }, { type: "azure-native:maintenance/v20231001preview:ConfigurationAssignmentsForSubscription" }] };

...
export class ConfigurationAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:maintenance/v20230901preview:ConfigurationAssignment';

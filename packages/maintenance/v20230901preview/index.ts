...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:maintenance/v20230901preview:ConfigurationAssignment":
                return new ConfigurationAssignment(name, <any>undefined, { urn })
            case "azure-native:maintenance/v20230901preview:ConfigurationAssignmentParent":
                return new ConfigurationAssignmentParent(name, <any>undefined, { urn })
            case "azure-native:maintenance/v20230901preview:ConfigurationAssignmentsForResourceGroup":
                return new ConfigurationAssignmentsForResourceGroup(name, <any>undefined, { urn })
            case "azure-native:maintenance/v20230901preview:ConfigurationAssignmentsForSubscription":
                return new ConfigurationAssignmentsForSubscription(name, <any>undefined, { urn })
            case "azure-native:maintenance/v20230901preview:MaintenanceConfiguration":
...
pulumi.runtime.registerResourceModule("azure-native", "maintenance/v20230901preview", _module)

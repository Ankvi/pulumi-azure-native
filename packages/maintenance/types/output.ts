...
export namespace maintenance {
    ...
    export namespace v20221101preview {
        ...
        export interface InputPatchConfigurationResponse {
             ...
             * Input parameters specific to patching Linux machine. For Windows machines, do not pass this property.
             */
            linuxParameters?: v20221101preview.InputLinuxParametersResponse;
            /**
             * List of post tasks. e.g. [{'source' :'runbook', 'taskScope': 'Resource', 'parameters': { 'arg1': 'value1'}}]
             */
            postTasks?: v20221101preview.TaskPropertiesResponse[];
            /**
             * List of pre tasks. e.g. [{'source' :'runbook', 'taskScope': 'Global', 'parameters': { 'arg1': 'value1'}}]
             */
            preTasks?: v20221101preview.TaskPropertiesResponse[];
            /**
             * Possible reboot preference as defined by the user based on which it would be decided to reboot the machine or not after the patch operation is completed.
             */
            rebootSetting?: string;
             ...
             * Input parameters specific to patching a Windows machine. For Linux machines, do not pass this property.
             */
            windowsParameters?: v20221101preview.InputWindowsParametersResponse;
        }
        /**
         * inputPatchConfigurationResponseProvideDefaults sets the appropriate defaults for InputPatchConfigurationResponse
         */
    ...
    export namespace v20230401 {
        ...
        export interface ConfigurationAssignmentFilterPropertiesResponse {
             ...
             * Tag settings for the VM.
             */
            tagSettings?: v20230401.TagSettingsPropertiesResponse;
        }
        ...
        export interface InputPatchConfigurationResponse {
             ...
             * Input parameters specific to patching Linux machine. For Windows machines, do not pass this property.
             */
            linuxParameters?: v20230401.InputLinuxParametersResponse;
            /**
             * Possible reboot preference as defined by the user based on which it would be decided to reboot the machine or not after the patch operation is completed.
             */
            rebootSetting?: string;
             ...
             * Input parameters specific to patching a Windows machine. For Linux machines, do not pass this property.
             */
            windowsParameters?: v20230401.InputWindowsParametersResponse;
        }
        /**
         * inputPatchConfigurationResponseProvideDefaults sets the appropriate defaults for InputPatchConfigurationResponse
         */

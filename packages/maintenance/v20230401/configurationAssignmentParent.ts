...
export class ConfigurationAssignmentParent extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:maintenance/v20230401:ConfigurationAssignmentParent';

...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:maintenance/v20221101preview:ConfigurationAssignment":
                return new ConfigurationAssignment(name, <any>undefined, { urn })
            case "azure-native:maintenance/v20221101preview:ConfigurationAssignmentParent":
                return new ConfigurationAssignmentParent(name, <any>undefined, { urn })
            case "azure-native:maintenance/v20221101preview:MaintenanceConfiguration":
...
pulumi.runtime.registerResourceModule("azure-native", "maintenance/v20221101preview", _module)
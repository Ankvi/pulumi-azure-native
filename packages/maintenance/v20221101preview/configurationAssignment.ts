...
export class ConfigurationAssignment extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ConfigurationAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:maintenance:ConfigurationAssignment" }, { type: "azure-native:maintenance/v20210401preview:ConfigurationAssignment" }, { type: "azure-native:maintenance/v20210901preview:ConfigurationAssignment" }, { type: "azure-native:maintenance/v20220701preview:ConfigurationAssignment" }, { type: "azure-native:maintenance/v20230401:ConfigurationAssignment" }] };

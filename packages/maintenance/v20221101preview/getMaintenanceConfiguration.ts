...
export function getMaintenanceConfiguration(args: GetMaintenanceConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetMaintenanceConfigurationResult> {
    ...
    return pulumi.runtime.invoke("azure-native:maintenance/v20221101preview:getMaintenanceConfiguration", {
...
export interface GetMaintenanceConfigurationResult {
     ...
     */
    readonly installPatches?: types.outputs.maintenance.v20221101preview.InputPatchConfigurationResponse;
    /**
     ...
     */
    readonly overrides?: types.outputs.maintenance.v20221101preview.MaintenanceOverridePropertiesResponse[];
    /**
     ...
     */
    readonly systemData: types.outputs.maintenance.v20221101preview.SystemDataResponse;
    /**

...
export class ConfigurationAssignmentParent extends pulumi.CustomResource {
     ...
     */
    declare public readonly filter: pulumi.Output<types.outputs.ConfigurationAssignmentFilterPropertiesResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ConfigurationAssignmentParentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            if (args?.resourceParentName === undefined && !opts.urn) {
                throw new Error("Missing required property 'resourceParentName'");
            }
            if (args?.resourceParentType === undefined && !opts.urn) {
            ...
            resourceInputs["resourceParentName"] = args?.resourceParentName;
            resourceInputs["resourceParentType"] = args?.resourceParentType;

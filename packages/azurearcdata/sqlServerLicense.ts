...
export class SqlServerLicense extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.SqlServerLicensePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: SqlServerLicenseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["sqlServerLicenseName"] = args?.sqlServerLicenseName;

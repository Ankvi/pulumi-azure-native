...
export class SqlManagedInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurearcdata:SqlManagedInstance';
     ...
     * null
     */
    declare public readonly properties: pulumi.Output<types.outputs.SqlManagedInstancePropertiesResponse>;
    /**
     * Resource sku.
     */
    declare public readonly sku: pulumi.Output<types.outputs.SqlManagedInstanceSkuResponse | undefined>;
    /**

...
export namespace azurearcdata {
    ...
    export namespace v20230115preview {
        ...
        export interface ActiveDirectoryConnectorDomainDetailsResponse {
             ...
             * null
             */
            domainControllers?: v20230115preview.ActiveDirectoryDomainControllersResponse;
            /**
             * NETBIOS name of the Active Directory domain.
             */
            netbiosDomainName?: string;
        ...
        export interface ActiveDirectoryConnectorPropertiesResponse {
             ...
             * Username and password for domain service account authentication.
             */
            domainServiceAccountLoginInformation?: v20230115preview.BasicLoginInformationResponse;
            /**
             * The provisioning state of the Active Directory connector resource.
             */
            provisioningState: string;
             ...
             * null
             */
            spec: v20230115preview.ActiveDirectoryConnectorSpecResponse;
            /**
             * null
             */
            status?: v20230115preview.ActiveDirectoryConnectorStatusResponse;
        }
        /**
         * activeDirectoryConnectorPropertiesResponseProvideDefaults sets the appropriate defaults for ActiveDirectoryConnectorPropertiesResponse
         */
        export function activeDirectoryConnectorPropertiesResponseProvideDefaults(val: ActiveDirectoryConnectorPropertiesResponse): ActiveDirectoryConnectorPropertiesResponse {
            return {
                ...val,
                spec: v20230115preview.activeDirectoryConnectorSpecResponseProvideDefaults(val.spec),
            };
        }
        ...
        export interface ActiveDirectoryConnectorSpecResponse {
             ...
             * null
             */
            activeDirectory: v20230115preview.ActiveDirectoryConnectorDomainDetailsResponse;
            /**
             * null
             */
            dns: v20230115preview.ActiveDirectoryConnectorDNSDetailsResponse;
        }
        /**
         * activeDirectoryConnectorSpecResponseProvideDefaults sets the appropriate defaults for ActiveDirectoryConnectorSpecResponse
         */
        export function activeDirectoryConnectorSpecResponseProvideDefaults(val: ActiveDirectoryConnectorSpecResponse): ActiveDirectoryConnectorSpecResponse {
            return {
                ...val,
                activeDirectory: v20230115preview.activeDirectoryConnectorDomainDetailsResponseProvideDefaults(val.activeDirectory),
                dns: v20230115preview.activeDirectoryConnectorDNSDetailsResponseProvideDefaults(val.dns),
            };
        }
        ...
        export interface ActiveDirectoryDomainControllersResponse {
             ...
             * Information about the Primary Domain Controller (PDC) in the AD domain.
             */
            primaryDomainController?: v20230115preview.ActiveDirectoryDomainControllerResponse;
            /**
             * null
             */
            secondaryDomainControllers?: v20230115preview.ActiveDirectoryDomainControllerResponse[];
        }
        ...
        export interface DataControllerPropertiesResponse {
             ...
             * Deprecated. Azure Arc Data Services data controller no longer expose any endpoint. All traffic are exposed through Kubernetes native API.
             */
            basicLoginInformation?: v20230115preview.BasicLoginInformationResponse;
            /**
             * If a CustomLocation is provided, this contains the ARM id of the connected cluster the custom location belongs to.
             */
            clusterId?: string;
             ...
             * Log analytics workspace id and primary key
             */
            logAnalyticsWorkspaceConfig?: v20230115preview.LogAnalyticsWorkspaceConfigResponse;
            /**
             * Login credential for logs dashboard on the Kubernetes cluster.
             */
            logsDashboardCredential?: v20230115preview.BasicLoginInformationResponse;
            /**
             * Login credential for metrics dashboard on the Kubernetes cluster.
             */
            metricsDashboardCredential?: v20230115preview.BasicLoginInformationResponse;
            /**
             * Properties from the Kubernetes data controller
             */
            onPremiseProperty?: v20230115preview.OnPremisePropertyResponse;
            /**
             * The provisioning state of the Arc Data Controller resource.
             */
            provisioningState: string;
             ...
             * Deprecated. Service principal is deprecated in favor of Arc Kubernetes service extension managed identity.
             */
            uploadServicePrincipal?: v20230115preview.UploadServicePrincipalResponse;
            /**
             * Properties on upload watermark.  Mostly timestamp for each upload data type
             */
            uploadWatermark?: v20230115preview.UploadWatermarkResponse;
        }
        /**
         * dataControllerPropertiesResponseProvideDefaults sets the appropriate defaults for DataControllerPropertiesResponse
         */
        ...
        export interface FailoverGroupPropertiesResponse {
             ...
             * The specifications of the failover group resource.
             */
            spec: v20230115preview.FailoverGroupSpecResponse;
            /**
             * The status of the failover group custom resource.
             */
            status?: any;
        ...
        export function failoverGroupPropertiesResponseProvideDefaults(val: FailoverGroupPropertiesResponse): FailoverGroupPropertiesResponse {
            return {
                ...val,
                spec: v20230115preview.failoverGroupSpecResponseProvideDefaults(val.spec),
            };
        }
        ...
        export interface K8sActiveDirectoryResponse {
             ...
             */
            accountName?: string;
            connector?: v20230115preview.K8sActiveDirectoryResponseConnector;
            /**
             * An array of encryption types
             */
            encryptionTypes?: string[];
        ...
        export interface K8sSchedulingOptionsResponse {
             ...
             * The kubernetes resource limits and requests used to restrict or reserve resource usage.
             */
            resources?: v20230115preview.K8sResourceRequirementsResponse;
        }
        ...
        export interface K8sSchedulingResponse {
             ...
             * The kubernetes scheduling options. It describes restrictions used to help Kubernetes select appropriate nodes to host the database service
             */
            default?: v20230115preview.K8sSchedulingOptionsResponse;
        }
        ...
        export interface K8sSecurityResponse {
             ...
             * The kubernetes active directory information.
             */
            activeDirectory?: v20230115preview.K8sActiveDirectoryResponse;
            /**
             * Admin login secret key
             */
            adminLoginSecret?: string;
             ...
             * Transparent data encryption information.
             */
            transparentDataEncryption?: v20230115preview.K8stransparentDataEncryptionResponse;
        }
        ...
        export interface K8sSettingsResponse {
             ...
             * The kubernetes network settings information.
             */
            network?: v20230115preview.K8sNetworkSettingsResponse;
        }
        ...
        export interface SqlManagedInstanceK8sRawResponse {
             ...
             * The kubernetes spec information.
             */
            spec?: v20230115preview.SqlManagedInstanceK8sSpecResponse;
        }
        ...
        export interface SqlManagedInstanceK8sSpecResponse {
             ...
             * The kubernetes scheduling information.
             */
            scheduling?: v20230115preview.K8sSchedulingResponse;
            /**
             * The kubernetes security information.
             */
            security?: v20230115preview.K8sSecurityResponse;
            /**
             * The kubernetes settings information.
             */
            settings?: v20230115preview.K8sSettingsResponse;
        }
        ...
        export interface SqlManagedInstancePropertiesResponse {
             ...
             * The raw kubernetes information
             */
            k8sRaw?: v20230115preview.SqlManagedInstanceK8sRawResponse;
            /**
             * Last uploaded date from Kubernetes cluster. Defaults to current date time
             */
            lastUploadedDate?: string;
         ...
         */
        export interface SqlServerDatabaseResourcePropertiesResponse {
            backupInformation?: v20230115preview.SqlServerDatabaseResourcePropertiesResponseBackupInformation;
            /**
             * Collation of the database.
             */
            collationName?: string;
             ...
             * List of features that are enabled for the database
             */
            databaseOptions?: v20230115preview.SqlServerDatabaseResourcePropertiesResponseDatabaseOptions;
            /**
             * Whether the database is read only or not.
             */
            isReadOnly?: boolean;

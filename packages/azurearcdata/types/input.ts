...
export namespace azurearcdata {
    ...
    export namespace v20230115preview {
        /**
         * DNS server details
         */
        export interface ActiveDirectoryConnectorDNSDetailsArgs {
        ...
        export interface ActiveDirectoryConnectorDomainDetailsArgs {
             ...
             * null
             */
            domainControllers?: pulumi.Input<v20230115preview.ActiveDirectoryDomainControllersArgs>;
            /**
             * NETBIOS name of the Active Directory domain.
             */
            netbiosDomainName?: pulumi.Input<string>;
             ...
             * The service account provisioning mode for this Active Directory connector.
             */
            serviceAccountProvisioning?: pulumi.Input<string | enums.v20230115preview.AccountProvisioningMode>;
        }
        /**
         * activeDirectoryConnectorDomainDetailsArgsProvideDefaults sets the appropriate defaults for ActiveDirectoryConnectorDomainDetailsArgs
         */
        ...
        export interface ActiveDirectoryConnectorPropertiesArgs {
             ...
             * Username and password for domain service account authentication.
             */
            domainServiceAccountLoginInformation?: pulumi.Input<v20230115preview.BasicLoginInformationArgs>;
            /**
             * null
             */
            spec: pulumi.Input<v20230115preview.ActiveDirectoryConnectorSpecArgs>;
            /**
             * null
             */
            status?: pulumi.Input<v20230115preview.ActiveDirectoryConnectorStatusArgs>;
        }
        /**
         * activeDirectoryConnectorPropertiesArgsProvideDefaults sets the appropriate defaults for ActiveDirectoryConnectorPropertiesArgs
         */
        export function activeDirectoryConnectorPropertiesArgsProvideDefaults(val: ActiveDirectoryConnectorPropertiesArgs): ActiveDirectoryConnectorPropertiesArgs {
            return {
                ...val,
                spec: pulumi.output(val.spec).apply(v20230115preview.activeDirectoryConnectorSpecArgsProvideDefaults),
            };
        }
        ...
        export interface ActiveDirectoryConnectorSpecArgs {
             ...
             * null
             */
            activeDirectory: pulumi.Input<v20230115preview.ActiveDirectoryConnectorDomainDetailsArgs>;
            /**
             * null
             */
            dns: pulumi.Input<v20230115preview.ActiveDirectoryConnectorDNSDetailsArgs>;
        }
        /**
         * activeDirectoryConnectorSpecArgsProvideDefaults sets the appropriate defaults for ActiveDirectoryConnectorSpecArgs
         */
        export function activeDirectoryConnectorSpecArgsProvideDefaults(val: ActiveDirectoryConnectorSpecArgs): ActiveDirectoryConnectorSpecArgs {
            return {
                ...val,
                activeDirectory: pulumi.output(val.activeDirectory).apply(v20230115preview.activeDirectoryConnectorDomainDetailsArgsProvideDefaults),
                dns: pulumi.output(val.dns).apply(v20230115preview.activeDirectoryConnectorDNSDetailsArgsProvideDefaults),
            };
        }
        ...
        export interface ActiveDirectoryDomainControllersArgs {
             ...
             * Information about the Primary Domain Controller (PDC) in the AD domain.
             */
            primaryDomainController?: pulumi.Input<v20230115preview.ActiveDirectoryDomainControllerArgs>;
            /**
             * null
             */
            secondaryDomainControllers?: pulumi.Input<pulumi.Input<v20230115preview.ActiveDirectoryDomainControllerArgs>[]>;
        }
        ...
        export interface ActiveDirectoryInformationArgs {
             ...
             * Keytab information that is used for the Sql Managed Instance when Active Directory authentication is used.
             */
            keytabInformation?: pulumi.Input<v20230115preview.KeytabInformationArgs>;
        }
        ...
        export interface DataControllerPropertiesArgs {
             ...
             * Deprecated. Azure Arc Data Services data controller no longer expose any endpoint. All traffic are exposed through Kubernetes native API.
             */
            basicLoginInformation?: pulumi.Input<v20230115preview.BasicLoginInformationArgs>;
            /**
             * If a CustomLocation is provided, this contains the ARM id of the connected cluster the custom location belongs to.
             */
            clusterId?: pulumi.Input<string>;
             ...
             * The infrastructure the data controller is running on.
             */
            infrastructure?: pulumi.Input<enums.v20230115preview.Infrastructure>;
            /**
             * The raw kubernetes information
             */
            k8sRaw?: any;
             ...
             * Log analytics workspace id and primary key
             */
            logAnalyticsWorkspaceConfig?: pulumi.Input<v20230115preview.LogAnalyticsWorkspaceConfigArgs>;
            /**
             * Login credential for logs dashboard on the Kubernetes cluster.
             */
            logsDashboardCredential?: pulumi.Input<v20230115preview.BasicLoginInformationArgs>;
            /**
             * Login credential for metrics dashboard on the Kubernetes cluster.
             */
            metricsDashboardCredential?: pulumi.Input<v20230115preview.BasicLoginInformationArgs>;
            /**
             * Properties from the Kubernetes data controller
             */
            onPremiseProperty?: pulumi.Input<v20230115preview.OnPremisePropertyArgs>;
            /**
             * Deprecated. Service principal is deprecated in favor of Arc Kubernetes service extension managed identity.
             */
            uploadServicePrincipal?: pulumi.Input<v20230115preview.UploadServicePrincipalArgs>;
            /**
             * Properties on upload watermark.  Mostly timestamp for each upload data type
             */
            uploadWatermark?: pulumi.Input<v20230115preview.UploadWatermarkArgs>;
        }
        /**
         * dataControllerPropertiesArgsProvideDefaults sets the appropriate defaults for DataControllerPropertiesArgs
         */
        ...
        export interface ExtendedLocationArgs {
             ...
             * The type of the extended location.
             */
            type?: pulumi.Input<string | enums.v20230115preview.ExtendedLocationTypes>;
        }
        ...
        export interface FailoverGroupPropertiesArgs {
             ...
             * The specifications of the failover group resource.
             */
            spec: pulumi.Input<v20230115preview.FailoverGroupSpecArgs>;
            /**
             * The status of the failover group custom resource.
             */
            status?: any;
        ...
        export function failoverGroupPropertiesArgsProvideDefaults(val: FailoverGroupPropertiesArgs): FailoverGroupPropertiesArgs {
            return {
                ...val,
                spec: pulumi.output(val.spec).apply(v20230115preview.failoverGroupSpecArgsProvideDefaults),
            };
        }
        ...
        export interface FailoverGroupSpecArgs {
             ...
             * The partner sync mode of the SQL managed instance.
             */
            partnerSyncMode?: pulumi.Input<string | enums.v20230115preview.FailoverGroupPartnerSyncMode>;
            /**
             * The role of the SQL managed instance in this failover group.
             */
            role: pulumi.Input<string | enums.v20230115preview.InstanceFailoverGroupRole>;
            /**
             * The shared name of the failover group for this SQL managed instance. Both SQL managed instance and its partner have to use the same shared name.
             */
            sharedName?: pulumi.Input<string>;
        ...
        export interface K8sActiveDirectoryArgs {
             ...
             */
            accountName?: pulumi.Input<string>;
            connector?: pulumi.Input<v20230115preview.K8sActiveDirectoryConnectorArgs>;
            /**
             * An array of encryption types
             */
            encryptionTypes?: pulumi.Input<pulumi.Input<string>[]>;
        ...
        export interface K8sSchedulingArgs {
             ...
             * The kubernetes scheduling options. It describes restrictions used to help Kubernetes select appropriate nodes to host the database service
             */
            default?: pulumi.Input<v20230115preview.K8sSchedulingOptionsArgs>;
        }
        ...
        export interface K8sSchedulingOptionsArgs {
             ...
             * The kubernetes resource limits and requests used to restrict or reserve resource usage.
             */
            resources?: pulumi.Input<v20230115preview.K8sResourceRequirementsArgs>;
        }
        ...
        export interface K8sSecurityArgs {
             ...
             * The kubernetes active directory information.
             */
            activeDirectory?: pulumi.Input<v20230115preview.K8sActiveDirectoryArgs>;
            /**
             * Admin login secret key
             */
            adminLoginSecret?: pulumi.Input<string>;
             ...
             * Transparent data encryption information.
             */
            transparentDataEncryption?: pulumi.Input<v20230115preview.K8stransparentDataEncryptionArgs>;
        }
        ...
        export interface K8sSettingsArgs {
             ...
             * The kubernetes network settings information.
             */
            network?: pulumi.Input<v20230115preview.K8sNetworkSettingsArgs>;
        }
        ...
        export interface PostgresInstanceSkuArgs {
             ...
             * This field is required to be implemented by the Resource Provider if the service has more than one tier.
             */
            tier?: pulumi.Input<enums.v20230115preview.PostgresInstanceSkuTier>;
        }
        /**
         * postgresInstanceSkuArgsProvideDefaults sets the appropriate defaults for PostgresInstanceSkuArgs
         */
        ...
        export interface SqlManagedInstanceK8sRawArgs {
             ...
             * The kubernetes spec information.
             */
            spec?: pulumi.Input<v20230115preview.SqlManagedInstanceK8sSpecArgs>;
        }
        ...
        export interface SqlManagedInstanceK8sSpecArgs {
             ...
             * The kubernetes scheduling information.
             */
            scheduling?: pulumi.Input<v20230115preview.K8sSchedulingArgs>;
            /**
             * The kubernetes security information.
             */
            security?: pulumi.Input<v20230115preview.K8sSecurityArgs>;
            /**
             * The kubernetes settings information.
             */
            settings?: pulumi.Input<v20230115preview.K8sSettingsArgs>;
        }
        ...
        export interface SqlManagedInstancePropertiesArgs {
             ...
             * Active Directory information related to this SQL Managed Instance.
             */
            activeDirectoryInformation?: pulumi.Input<v20230115preview.ActiveDirectoryInformationArgs>;
            /**
             * The instance admin user
             */
            admin?: pulumi.Input<string>;
             ...
             * The raw kubernetes information
             */
            k8sRaw?: pulumi.Input<v20230115preview.SqlManagedInstanceK8sRawArgs>;
            /**
             * Last uploaded date from Kubernetes cluster. Defaults to current date time
             */
            lastUploadedDate?: pulumi.Input<string>;
             ...
             * The license type to apply for this managed instance.
             */
            licenseType?: pulumi.Input<string | enums.v20230115preview.ArcSqlManagedInstanceLicenseType>;
            /**
             * The instance start time
             */
            startTime?: pulumi.Input<string>;
        ...
        export interface SqlManagedInstanceSkuArgs {
             ...
             * The name of the SKU.
             */
            name: pulumi.Input<enums.v20230115preview.SqlManagedInstanceSkuName>;
            /**
             * The SKU size. When the name field is the combination of tier and some other value, this would be the standalone code. 
             */
            size?: pulumi.Input<string>;
             ...
             * The pricing tier for the instance.
             */
            tier?: pulumi.Input<enums.v20230115preview.SqlManagedInstanceSkuTier>;
        }
        /**
         * sqlManagedInstanceSkuArgsProvideDefaults sets the appropriate defaults for SqlManagedInstanceSkuArgs
         */
         ...
         */
        export interface SqlServerDatabaseResourcePropertiesArgs {
            backupInformation?: pulumi.Input<v20230115preview.SqlServerDatabaseResourcePropertiesBackupInformationArgs>;
            /**
             * Collation of the database.
             */
            collationName?: pulumi.Input<string>;
             ...
             * List of features that are enabled for the database
             */
            databaseOptions?: pulumi.Input<v20230115preview.SqlServerDatabaseResourcePropertiesDatabaseOptionsArgs>;
            /**
             * Whether the database is read only or not.
             */
            isReadOnly?: pulumi.Input<boolean>;
             ...
             * Status of the database.
             */
            recoveryMode?: pulumi.Input<string | enums.v20230115preview.RecoveryMode>;
            /**
             * Size of the database.
             */
            sizeMB?: pulumi.Input<number>;
             ...
             * State of the database.
             */
            state?: pulumi.Input<string | enums.v20230115preview.DatabaseState>;
        }
        ...
        export interface SqlServerInstancePropertiesArgs {
             ...
             * Status of Azure Defender.
             */
            azureDefenderStatus?: pulumi.Input<string | enums.v20230115preview.DefenderStatus>;
            /**
             * Timestamp of last Azure Defender status update.
             */
            azureDefenderStatusLastUpdated?: pulumi.Input<string>;
             ...
             * SQL Server edition.
             */
            edition?: pulumi.Input<string | enums.v20230115preview.EditionType>;
            /**
             * Type of host for Azure Arc SQL Server
             */
            hostType?: pulumi.Input<string | enums.v20230115preview.HostType>;
            /**
             * SQL Server instance name.
             */
            instanceName?: pulumi.Input<string>;
             ...
             * SQL Server license type.
             */
            licenseType?: pulumi.Input<string | enums.v20230115preview.ArcSqlServerLicenseType>;
            /**
             * SQL Server update level.
             */
            patchLevel?: pulumi.Input<string>;
             ...
             * The cloud connectivity status.
             */
            status: pulumi.Input<string | enums.v20230115preview.ConnectionStatus>;
            /**
             * Dynamic TCP ports used by SQL Server.
             */
            tcpDynamicPorts?: pulumi.Input<string>;
             ...
             * SQL Server version.
             */
            version?: pulumi.Input<string | enums.v20230115preview.SqlVersion>;
        }

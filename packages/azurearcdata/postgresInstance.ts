...
export class PostgresInstance extends pulumi.CustomResource {
     ...
     * null
     */
    declare public readonly properties: pulumi.Output<types.outputs.PostgresInstancePropertiesResponse>;
    /**
     * Resource sku.
     */
    declare public readonly sku: pulumi.Output<types.outputs.PostgresInstanceSkuResponse | undefined>;
    /**

...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:azurearcdata/v20230115preview:ActiveDirectoryConnector":
                return new ActiveDirectoryConnector(name, <any>undefined, { urn })
            case "azure-native:azurearcdata/v20230115preview:DataController":
                return new DataController(name, <any>undefined, { urn })
            case "azure-native:azurearcdata/v20230115preview:FailoverGroup":
                return new FailoverGroup(name, <any>undefined, { urn })
            case "azure-native:azurearcdata/v20230115preview:PostgresInstance":
                return new PostgresInstance(name, <any>undefined, { urn })
            case "azure-native:azurearcdata/v20230115preview:SqlManagedInstance":
                return new SqlManagedInstance(name, <any>undefined, { urn })
            case "azure-native:azurearcdata/v20230115preview:SqlServerDatabase":
                return new SqlServerDatabase(name, <any>undefined, { urn })
            case "azure-native:azurearcdata/v20230115preview:SqlServerInstance":
...
pulumi.runtime.registerResourceModule("azure-native", "azurearcdata/v20230115preview", _module)

...
export class SqlServerDatabase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurearcdata/v20230115preview:SqlServerDatabase';
    ...
    constructor(name: string, args: SqlServerDatabaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurearcdata:SqlServerDatabase" }, { type: "azure-native:azurearcdata/v20220615preview:SqlServerDatabase" }] };

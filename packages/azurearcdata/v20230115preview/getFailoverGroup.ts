...
export function getFailoverGroup(args: GetFailoverGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetFailoverGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-native:azurearcdata/v20230115preview:getFailoverGroup", {
...
export interface GetFailoverGroupResult {
     ...
     * null
     */
    readonly properties: types.outputs.azurearcdata.v20230115preview.FailoverGroupPropertiesResponse;
    /**

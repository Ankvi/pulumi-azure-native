...
export class ActiveDirectoryConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azurearcdata/v20230115preview:ActiveDirectoryConnector';
    ...
    constructor(name: string, args: ActiveDirectoryConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azurearcdata:ActiveDirectoryConnector" }, { type: "azure-native:azurearcdata/v20220301preview:ActiveDirectoryConnector" }, { type: "azure-native:azurearcdata/v20220615preview:ActiveDirectoryConnector" }] };

...
export class SqlServerEsuLicense extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.SqlServerEsuLicensePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: SqlServerEsuLicenseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["sqlServerEsuLicenseName"] = args?.sqlServerEsuLicenseName;

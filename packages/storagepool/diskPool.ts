...
export class DiskPool extends pulumi.CustomResource {
     ...
     */
    declare public readonly additionalCapabilities: pulumi.Output<string[] | undefined>;
    /**
     ...
     */
    declare public readonly disks: pulumi.Output<types.outputs.DiskResponse[] | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly systemData: pulumi.Output<types.outputs.SystemMetadataResponse>;
    /**
     * Resource tags.
     */
     ...
     * Sku tier
     */
    declare public /*out*/ readonly tier: pulumi.Output<string | undefined>;
    /**

...
export class IscsiTarget extends pulumi.CustomResource {
     ...
     */
    declare public readonly luns: pulumi.Output<types.outputs.IscsiLunResponse[] | undefined>;
    /**
     ...
     */
    declare public readonly staticAcls: pulumi.Output<types.outputs.AclResponse[] | undefined>;
    /**

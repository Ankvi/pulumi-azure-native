...
export class StorageTaskAssignment extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.StorageTaskAssignmentPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: StorageTaskAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["storageTaskAssignmentName"] = args?.storageTaskAssignmentName;

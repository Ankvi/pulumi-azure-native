...
export class StorageAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:storage:StorageAccount';
     ...
     */
    public readonly azureFilesIdentityBasedAuthentication!: pulumi.Output<types.outputs.storage.AzureFilesIdentityBasedAuthenticationResponse | undefined>;
    /**
     * Blob restore status
     */
    public /*out*/ readonly blobRestoreStatus!: pulumi.Output<types.outputs.storage.BlobRestoreStatusResponse>;
    /**
     ...
     */
    public readonly customDomain!: pulumi.Output<types.outputs.storage.CustomDomainResponse>;
    /**
     ...
     */
    public readonly encryption!: pulumi.Output<types.outputs.storage.EncryptionResponse>;
    /**
     * The extendedLocation of the resource.
     */
    public readonly extendedLocation!: pulumi.Output<types.outputs.storage.ExtendedLocationResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly geoReplicationStats!: pulumi.Output<types.outputs.storage.GeoReplicationStatsResponse>;
    /**
     * The identity of the resource.
     */
    public readonly identity!: pulumi.Output<types.outputs.storage.IdentityResponse | undefined>;
    /**
     * The property is immutable and can only be set to true at the account creation time. When set to true, it enables object level immutability for all the containers in the account by default.
     */
    public readonly immutableStorageWithVersioning!: pulumi.Output<types.outputs.storage.ImmutableStorageAccountResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly keyCreationTime!: pulumi.Output<types.outputs.storage.KeyCreationTimeResponse>;
    /**
     * KeyPolicy assigned to the storage account.
     */
    public readonly keyPolicy!: pulumi.Output<types.outputs.storage.KeyPolicyResponse>;
    /**
     * Gets the Kind.
     */
     ...
     * Network rule set
     */
    public readonly networkRuleSet!: pulumi.Output<types.outputs.storage.NetworkRuleSetResponse>;
    /**
     * Gets the URLs that are used to perform a retrieval of a public blob, queue, or table object. Note that Standard_ZRS and Premium_LRS accounts only return the blob endpoint.
     */
    public /*out*/ readonly primaryEndpoints!: pulumi.Output<types.outputs.storage.EndpointsResponse>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<types.outputs.storage.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public readonly routingPreference!: pulumi.Output<types.outputs.storage.RoutingPreferenceResponse | undefined>;
    /**
     * SasPolicy assigned to the storage account.
     */
    public readonly sasPolicy!: pulumi.Output<types.outputs.storage.SasPolicyResponse>;
    /**
     * Gets the URLs that are used to perform a retrieval of a public blob, queue, or table object from the secondary location of the storage account. Only available if the SKU name is Standard_RAGRS.
     */
    public /*out*/ readonly secondaryEndpoints!: pulumi.Output<types.outputs.storage.EndpointsResponse>;
    /**
     ...
     * Gets the SKU.
     */
    public readonly sku!: pulumi.Output<types.outputs.storage.SkuResponse>;
    /**
     ...
     */
    public /*out*/ readonly storageAccountSkuConversionStatus!: pulumi.Output<types.outputs.storage.StorageAccountSkuConversionStatusResponse | undefined>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: StorageAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["encryption"] = args ? (args.encryption ? pulumi.output(args.encryption).apply(types.inputs.storage.encryptionArgsProvideDefaults) : undefined) : undefined;
            ...
            resourceInputs["networkRuleSet"] = args ? (args.networkRuleSet ? pulumi.output(args.networkRuleSet).apply(types.inputs.storage.networkRuleSetArgsProvideDefaults) : undefined) : undefined;
            resourceInputs["publicNetworkAccess"] = args ? args.publicNetworkAccess : undefined;
            resourceInputs["resourceGroupName"] = args ? args.resourceGroupName : undefined;
            resourceInputs["routingPreference"] = args ? args.routingPreference : undefined;
            resourceInputs["sasPolicy"] = args ? (args.sasPolicy ? pulumi.output(args.sasPolicy).apply(types.inputs.storage.sasPolicyArgsProvideDefaults) : undefined) : undefined;
...
export interface StorageAccountArgs {
     ...
     * Provides the identity based authentication settings for Azure Files.
     */
    azureFilesIdentityBasedAuthentication?: pulumi.Input<types.inputs.storage.AzureFilesIdentityBasedAuthenticationArgs>;
    /**
     * User domain assigned to the storage account. Name is the CNAME source. Only one custom domain is supported per storage account at this time. To clear the existing custom domain, use an empty string for the custom domain name property.
     */
    customDomain?: pulumi.Input<types.inputs.storage.CustomDomainArgs>;
    /**
     * A boolean flag which indicates whether the default authentication is OAuth or not. The default interpretation is false for this property.
     */
     ...
     * Encryption settings to be used for server-side encryption for the storage account.
     */
    encryption?: pulumi.Input<types.inputs.storage.EncryptionArgs>;
    /**
     * Optional. Set the extended location of the resource. If not set, the storage account will be created in Azure main region. Otherwise it will be created in the specified extended location
     */
    extendedLocation?: pulumi.Input<types.inputs.storage.ExtendedLocationArgs>;
    /**
     * The identity of the resource.
     */
    identity?: pulumi.Input<types.inputs.storage.IdentityArgs>;
    /**
     ...
     */
    immutableStorageWithVersioning?: pulumi.Input<types.inputs.storage.ImmutableStorageAccountArgs>;
    /**
     * Account HierarchicalNamespace enabled if sets to true.
     */
     ...
     * KeyPolicy assigned to the storage account.
     */
    keyPolicy?: pulumi.Input<types.inputs.storage.KeyPolicyArgs>;
    /**
     ...
     * Network rule set
     */
    networkRuleSet?: pulumi.Input<types.inputs.storage.NetworkRuleSetArgs>;
    /**
     * Allow or disallow public network access to Storage Account. Value is optional but if passed in, must be 'Enabled' or 'Disabled'.
     */
     ...
     * Maintains information about the network routing choice opted by the user for data transfer
     */
    routingPreference?: pulumi.Input<types.inputs.storage.RoutingPreferenceArgs>;
    /**
     * SasPolicy assigned to the storage account.
     */
    sasPolicy?: pulumi.Input<types.inputs.storage.SasPolicyArgs>;
    /**
     * Required. Gets or sets the SKU name.
     */
    sku: pulumi.Input<types.inputs.storage.SkuArgs>;
    /**

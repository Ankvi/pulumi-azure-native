...
export class BlobContainer extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly immutabilityPolicy: pulumi.Output<types.outputs.ImmutabilityPolicyPropertiesResponse>;
    /**
     * The object level immutability property of the container. The property is immutable and can only be set to true at the container creation time. Existing containers must undergo a migration process.
     */
    declare public readonly immutableStorageWithVersioning: pulumi.Output<types.outputs.ImmutableStorageWithVersioningResponse | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly legalHold: pulumi.Output<types.outputs.LegalHoldPropertiesResponse>;
    /**

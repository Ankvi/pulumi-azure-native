...
export class ObjectReplicationPolicy extends pulumi.CustomResource {
     ...
     */
    declare public readonly metrics: pulumi.Output<types.outputs.ObjectReplicationPolicyPropertiesResponseMetrics | undefined>;
    /**
     ...
     */
    declare public readonly rules: pulumi.Output<types.outputs.ObjectReplicationPolicyRuleResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: ObjectReplicationPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:storage/v20190601:ObjectReplicationPolicy" }, { type: "azure-native:storage/v20200801preview:ObjectReplicationPolicy" }, { type: "azure-native:storage/v20210101:ObjectReplicationPolicy" }, { type: "azure-native:storage/v20210201:ObjectReplicationPolicy" }, { type: "azure-native:storage/v20210401:ObjectReplicationPolicy" }, { type: "azure-native:storage/v20210601:ObjectReplicationPolicy" }, { type: "azure-native:storage/v20210801:ObjectReplicationPolicy" }, { type: "azure-native:storage/v20210901:ObjectReplicationPolicy" }, { type: "azure-native:storage/v20220501:ObjectReplicationPolicy" }, { type: "azure-native:storage/v20220901:ObjectReplicationPolicy" }, { type: "azure-native:storage/v20230101:ObjectReplicationPolicy" }, { type: "azure-native:storage/v20230401:ObjectReplicationPolicy" }, { type: "azure-native:storage/v20230501:ObjectReplicationPolicy" }, { type: "azure-native:storage/v20240101:ObjectReplicationPolicy" }, { type: "azure-native:storage/v20250101:ObjectReplicationPolicy" }] };
...
export interface ObjectReplicationPolicyArgs {
     ...
     * Optional. The object replication policy metrics feature options.
     */
    metrics?: pulumi.Input<types.inputs.ObjectReplicationPolicyPropertiesMetricsArgs>;
    /**

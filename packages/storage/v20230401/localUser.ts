...
export class LocalUser extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:storage/v20230401:LocalUser';
     ...
     */
    public readonly permissionScopes!: pulumi.Output<types.outputs.PermissionScopeResponse[] | undefined>;
    /**
     ...
     */
    public readonly sshAuthorizedKeys!: pulumi.Output<types.outputs.SshPublicKeyResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: LocalUserArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:storage:LocalUser" }, { type: "azure-native:storage/v20210801:LocalUser" }, { type: "azure-native:storage/v20210901:LocalUser" }, { type: "azure-native:storage/v20220501:LocalUser" }, { type: "azure-native:storage/v20220901:LocalUser" }, { type: "azure-native:storage/v20230101:LocalUser" }] };

...
export class LocalUser extends pulumi.CustomResource {
     ...
     */
    public readonly permissionScopes!: pulumi.Output<types.outputs.storage.PermissionScopeResponse[] | undefined>;
    /**
     ...
     */
    public readonly sshAuthorizedKeys!: pulumi.Output<types.outputs.storage.SshPublicKeyResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: LocalUserArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:storage/v20210801:LocalUser" }, { type: "azure-native:storage/v20210901:LocalUser" }, { type: "azure-native:storage/v20220501:LocalUser" }, { type: "azure-native:storage/v20220901:LocalUser" }, { type: "azure-native:storage/v20230101:LocalUser" }] };
...
export interface LocalUserArgs {
     ...
     * The permission scopes of the local user.
     */
    permissionScopes?: pulumi.Input<pulumi.Input<types.inputs.storage.PermissionScopeArgs>[]>;
    /**
     ...
     * Optional, local user ssh authorized keys for SFTP.
     */
    sshAuthorizedKeys?: pulumi.Input<pulumi.Input<types.inputs.storage.SshPublicKeyArgs>[]>;
    /**

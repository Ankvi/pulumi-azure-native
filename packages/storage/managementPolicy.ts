...
export class ManagementPolicy extends pulumi.CustomResource {
     ...
     */
    declare public readonly policy: pulumi.Output<types.outputs.ManagementPolicySchemaResponse>;
    /**
    ...
    constructor(name: string, args: ManagementPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["managementPolicyName"] = args?.managementPolicyName;

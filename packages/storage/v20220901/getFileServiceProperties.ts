...
export function getFileServiceProperties(args: GetFileServicePropertiesArgs, opts?: pulumi.InvokeOptions): Promise<GetFileServicePropertiesResult> {
    ...
    return pulumi.runtime.invoke("azure-native:storage/v20220901:getFileServiceProperties", {
...
export interface GetFileServicePropertiesResult {
     ...
     */
    readonly protocolSettings?: types.outputs.storage.v20220901.ProtocolSettingsResponse;
    /**
     * The file service properties for share soft delete.
     */
    readonly shareDeleteRetentionPolicy?: types.outputs.storage.v20220901.DeleteRetentionPolicyResponse;
    /**
     * Sku name and tier.
     */

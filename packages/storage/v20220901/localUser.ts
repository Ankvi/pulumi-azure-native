...
export class LocalUser extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:storage/v20220901:LocalUser';
     ...
     */
    public readonly permissionScopes!: pulumi.Output<types.outputs.storage.v20220901.PermissionScopeResponse[] | undefined>;
    /**
     ...
     */
    public readonly sshAuthorizedKeys!: pulumi.Output<types.outputs.storage.v20220901.SshPublicKeyResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: LocalUserArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:storage:LocalUser" }, { type: "azure-native:storage/v20210801:LocalUser" }, { type: "azure-native:storage/v20210901:LocalUser" }, { type: "azure-native:storage/v20220501:LocalUser" }, { type: "azure-native:storage/v20230101:LocalUser" }] };
...
export interface LocalUserArgs {
     ...
     * The permission scopes of the local user.
     */
    permissionScopes?: pulumi.Input<pulumi.Input<types.inputs.storage.v20220901.PermissionScopeArgs>[]>;
    /**
     ...
     * Optional, local user ssh authorized keys for SFTP.
     */
    sshAuthorizedKeys?: pulumi.Input<pulumi.Input<types.inputs.storage.v20220901.SshPublicKeyArgs>[]>;
    /**

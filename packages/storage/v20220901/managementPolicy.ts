...
export class ManagementPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:storage/v20220901:ManagementPolicy';
     ...
     */
    public readonly policy!: pulumi.Output<types.outputs.storage.v20220901.ManagementPolicySchemaResponse>;
    /**
...
export interface ManagementPolicyArgs {
     ...
     * The Storage Account ManagementPolicy, in JSON format. See more details in: https://docs.microsoft.com/en-us/azure/storage/common/storage-lifecycle-managment-concepts.
     */
    policy: pulumi.Input<types.inputs.storage.v20220901.ManagementPolicySchemaArgs>;
    /**

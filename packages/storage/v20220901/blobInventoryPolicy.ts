...
export class BlobInventoryPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:storage/v20220901:BlobInventoryPolicy';
     ...
     */
    public readonly policy!: pulumi.Output<types.outputs.storage.v20220901.BlobInventoryPolicySchemaResponse>;
    /**
     * Metadata pertaining to creation and last modification of the resource.
     */
    public /*out*/ readonly systemData!: pulumi.Output<types.outputs.storage.v20220901.SystemDataResponse>;
    /**
...
export interface BlobInventoryPolicyArgs {
     ...
     * The storage account blob inventory policy object. It is composed of policy rules.
     */
    policy: pulumi.Input<types.inputs.storage.v20220901.BlobInventoryPolicySchemaArgs>;
    /**

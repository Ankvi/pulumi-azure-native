...
export class FileServiceProperties extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:storage/v20230101:FileServiceProperties';

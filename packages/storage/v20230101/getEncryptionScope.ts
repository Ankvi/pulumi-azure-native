...
export function getEncryptionScope(args: GetEncryptionScopeArgs, opts?: pulumi.InvokeOptions): Promise<GetEncryptionScopeResult> {
    ...
    return pulumi.runtime.invoke("azure-native:storage/v20230101:getEncryptionScope", {
...
export interface GetEncryptionScopeResult {
     ...
     */
    readonly keyVaultProperties?: types.outputs.storage.v20230101.EncryptionScopeKeyVaultPropertiesResponse;
    /**

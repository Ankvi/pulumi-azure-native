...
export class FileShare extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:storage/v20230101:FileShare';
     ...
     */
    public readonly signedIdentifiers!: pulumi.Output<types.outputs.storage.v20230101.SignedIdentifierResponse[] | undefined>;
    /**
...
export interface FileShareArgs {
     ...
     * Access tier for specific share. GpV2 account can choose between TransactionOptimized (default), Hot, and Cool. FileStorage account can choose Premium.
     */
    accessTier?: pulumi.Input<string | types.enums.v20230101.ShareAccessTier>;
    /**
     ...
     * The authentication protocol that is used for the file share. Can only be specified when creating a share.
     */
    enabledProtocols?: pulumi.Input<string | types.enums.v20230101.EnabledProtocols>;
    /**
     ...
     * The property is for NFS share only. The default is NoRootSquash.
     */
    rootSquash?: pulumi.Input<string | types.enums.v20230101.RootSquashType>;
    /**
     ...
     * List of stored access policies specified on the share.
     */
    signedIdentifiers?: pulumi.Input<pulumi.Input<types.inputs.storage.v20230101.SignedIdentifierArgs>[]>;
}

...
export function getBlobContainer(args: GetBlobContainerArgs, opts?: pulumi.InvokeOptions): Promise<GetBlobContainerResult> {
    ...
    return pulumi.runtime.invoke("azure-native:storage/v20230101:getBlobContainer", {
...
export interface GetBlobContainerResult {
     ...
     */
    readonly immutabilityPolicy: types.outputs.storage.v20230101.ImmutabilityPolicyPropertiesResponse;
    /**
     * The object level immutability property of the container. The property is immutable and can only be set to true at the container creation time. Existing containers must undergo a migration process.
     */
    readonly immutableStorageWithVersioning?: types.outputs.storage.v20230101.ImmutableStorageWithVersioningResponse;
    /**
     ...
     */
    readonly legalHold: types.outputs.storage.v20230101.LegalHoldPropertiesResponse;
    /**

...
export class BlobContainer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:storage/v20230101:BlobContainer';
     ...
     */
    public /*out*/ readonly immutabilityPolicy!: pulumi.Output<types.outputs.storage.v20230101.ImmutabilityPolicyPropertiesResponse>;
    /**
     * The object level immutability property of the container. The property is immutable and can only be set to true at the container creation time. Existing containers must undergo a migration process.
     */
    public readonly immutableStorageWithVersioning!: pulumi.Output<types.outputs.storage.v20230101.ImmutableStorageWithVersioningResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly legalHold!: pulumi.Output<types.outputs.storage.v20230101.LegalHoldPropertiesResponse>;
    /**
...
export interface BlobContainerArgs {
     ...
     * The object level immutability property of the container. The property is immutable and can only be set to true at the container creation time. Existing containers must undergo a migration process.
     */
    immutableStorageWithVersioning?: pulumi.Input<types.inputs.storage.v20230101.ImmutableStorageWithVersioningArgs>;
    /**
     * A name-value pair to associate with the container as metadata.
     */
     ...
     * Specifies whether data in the container may be accessed publicly and the level of access.
     */
    publicAccess?: pulumi.Input<types.enums.v20230101.PublicAccess>;
    /**

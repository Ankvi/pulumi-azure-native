...
export function getLocalUser(args: GetLocalUserArgs, opts?: pulumi.InvokeOptions): Promise<GetLocalUserResult> {
    ...
    return pulumi.runtime.invoke("azure-native:storage/v20230101:getLocalUser", {
...
export interface GetLocalUserResult {
     ...
     */
    readonly permissionScopes?: types.outputs.storage.v20230101.PermissionScopeResponse[];
    /**
     ...
     */
    readonly sshAuthorizedKeys?: types.outputs.storage.v20230101.SshPublicKeyResponse[];
    /**

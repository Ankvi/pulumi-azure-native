...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:storage/v20230101:BlobContainer":
                return new BlobContainer(name, <any>undefined, { urn })
            case "azure-native:storage/v20230101:BlobContainerImmutabilityPolicy":
                return new BlobContainerImmutabilityPolicy(name, <any>undefined, { urn })
            case "azure-native:storage/v20230101:BlobInventoryPolicy":
                return new BlobInventoryPolicy(name, <any>undefined, { urn })
            case "azure-native:storage/v20230101:BlobServiceProperties":
                return new BlobServiceProperties(name, <any>undefined, { urn })
            case "azure-native:storage/v20230101:EncryptionScope":
                return new EncryptionScope(name, <any>undefined, { urn })
            case "azure-native:storage/v20230101:FileServiceProperties":
                return new FileServiceProperties(name, <any>undefined, { urn })
            case "azure-native:storage/v20230101:FileShare":
                return new FileShare(name, <any>undefined, { urn })
            case "azure-native:storage/v20230101:LocalUser":
                return new LocalUser(name, <any>undefined, { urn })
            case "azure-native:storage/v20230101:ManagementPolicy":
                return new ManagementPolicy(name, <any>undefined, { urn })
            case "azure-native:storage/v20230101:ObjectReplicationPolicy":
                return new ObjectReplicationPolicy(name, <any>undefined, { urn })
            case "azure-native:storage/v20230101:PrivateEndpointConnection":
                return new PrivateEndpointConnection(name, <any>undefined, { urn })
            case "azure-native:storage/v20230101:Queue":
                return new Queue(name, <any>undefined, { urn })
            case "azure-native:storage/v20230101:QueueServiceProperties":
                return new QueueServiceProperties(name, <any>undefined, { urn })
            case "azure-native:storage/v20230101:StorageAccount":
                return new StorageAccount(name, <any>undefined, { urn })
            case "azure-native:storage/v20230101:Table":
                return new Table(name, <any>undefined, { urn })
            case "azure-native:storage/v20230101:TableServiceProperties":
...
pulumi.runtime.registerResourceModule("azure-native", "storage/v20230101", _module)

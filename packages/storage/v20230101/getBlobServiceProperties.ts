...
export function getBlobServiceProperties(args: GetBlobServicePropertiesArgs, opts?: pulumi.InvokeOptions): Promise<GetBlobServicePropertiesResult> {
    ...
    return pulumi.runtime.invoke("azure-native:storage/v20230101:getBlobServiceProperties", {
...
export interface GetBlobServicePropertiesResult {
     ...
     */
    readonly changeFeed?: types.outputs.storage.v20230101.ChangeFeedResponse;
    /**
     * The blob service properties for container soft delete.
     */
    readonly containerDeleteRetentionPolicy?: types.outputs.storage.v20230101.DeleteRetentionPolicyResponse;
    /**
     * Specifies CORS rules for the Blob service. You can include up to five CorsRule elements in the request. If no CorsRule elements are included in the request body, all CORS rules will be deleted, and CORS will be disabled for the Blob service.
     */
    readonly cors?: types.outputs.storage.v20230101.CorsRulesResponse;
    /**
     ...
     */
    readonly deleteRetentionPolicy?: types.outputs.storage.v20230101.DeleteRetentionPolicyResponse;
    /**
     ...
     */
    readonly lastAccessTimeTrackingPolicy?: types.outputs.storage.v20230101.LastAccessTimeTrackingPolicyResponse;
    /**
     ...
     */
    readonly restorePolicy?: types.outputs.storage.v20230101.RestorePolicyPropertiesResponse;
    /**
     * Sku name and tier.
     */

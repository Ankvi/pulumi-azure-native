...
export class BlobServiceProperties extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:storage/v20230101:BlobServiceProperties';
     ...
     */
    public readonly changeFeed!: pulumi.Output<types.outputs.storage.v20230101.ChangeFeedResponse | undefined>;
    /**
     * The blob service properties for container soft delete.
     */
    public readonly containerDeleteRetentionPolicy!: pulumi.Output<types.outputs.storage.v20230101.DeleteRetentionPolicyResponse | undefined>;
    /**
     ...
     */
    public readonly deleteRetentionPolicy!: pulumi.Output<types.outputs.storage.v20230101.DeleteRetentionPolicyResponse | undefined>;
    /**
     ...
     */
    public readonly lastAccessTimeTrackingPolicy!: pulumi.Output<types.outputs.storage.v20230101.LastAccessTimeTrackingPolicyResponse | undefined>;
    /**
     ...
     */
    public readonly restorePolicy!: pulumi.Output<types.outputs.storage.v20230101.RestorePolicyPropertiesResponse | undefined>;
    /**
     * Sku name and tier.
     */
...
export interface BlobServicePropertiesArgs {
     ...
     * The blob service properties for change feed events.
     */
    changeFeed?: pulumi.Input<types.inputs.storage.v20230101.ChangeFeedArgs>;
    /**
     * The blob service properties for container soft delete.
     */
    containerDeleteRetentionPolicy?: pulumi.Input<types.inputs.storage.v20230101.DeleteRetentionPolicyArgs>;
    /**
     * Specifies CORS rules for the Blob service. You can include up to five CorsRule elements in the request. If no CorsRule elements are included in the request body, all CORS rules will be deleted, and CORS will be disabled for the Blob service.
     */
     ...
     * The blob service properties for blob soft delete.
     */
    deleteRetentionPolicy?: pulumi.Input<types.inputs.storage.v20230101.DeleteRetentionPolicyArgs>;
    /**
     * Versioning is enabled if set to true.
     */
     ...
     * The blob service property to configure last access time based tracking policy.
     */
    lastAccessTimeTrackingPolicy?: pulumi.Input<types.inputs.storage.v20230101.LastAccessTimeTrackingPolicyArgs>;
    /**
     ...
     * The blob service properties for blob restore policy.
     */
    restorePolicy?: pulumi.Input<types.inputs.storage.v20230101.RestorePolicyPropertiesArgs>;
}

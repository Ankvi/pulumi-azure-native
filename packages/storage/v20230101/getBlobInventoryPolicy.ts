...
export function getBlobInventoryPolicy(args: GetBlobInventoryPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetBlobInventoryPolicyResult> {
    ...
    return pulumi.runtime.invoke("azure-native:storage/v20230101:getBlobInventoryPolicy", {
...
export interface GetBlobInventoryPolicyResult {
     ...
     */
    readonly policy: types.outputs.storage.v20230101.BlobInventoryPolicySchemaResponse;
    /**
     * Metadata pertaining to creation and last modification of the resource.
     */
    readonly systemData: types.outputs.storage.v20230101.SystemDataResponse;
    /**

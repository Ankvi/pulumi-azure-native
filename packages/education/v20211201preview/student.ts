...
export class Student extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:education/v20211201preview:Student';
     ...
     * Student Budget
     */
    public readonly budget!: pulumi.Output<types.outputs.education.v20211201preview.AmountResponse>;
    /**
    ...
    constructor(name: string, args: StudentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:education:Student" }] };
...
export interface StudentArgs {
     ...
     * Student Budget
     */
    budget: pulumi.Input<types.inputs.education.v20211201preview.AmountArgs>;
    /**
     * Student Email
     */
     ...
     * Student Role
     */
    role: pulumi.Input<string | types.enums.v20211201preview.StudentRole>;
    /**
     * Student alias.
     */

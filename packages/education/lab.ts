...
export class Lab extends pulumi.CustomResource {
     ...
     */
    declare public readonly budgetPerStudent: pulumi.Output<types.outputs.AmountResponse>;
    /**
     ...
     * Total budget
     */
    declare public /*out*/ readonly totalBudget: pulumi.Output<types.outputs.AmountResponse>;
    /**

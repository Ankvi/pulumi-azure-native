...
export class NamespaceDiscoveredDevice extends pulumi.CustomResource {
     ...
     */
    public readonly endpoints!: pulumi.Output<types.outputs.DiscoveredMessagingEndpointsResponse | undefined>;
    /**
    ...
    constructor(name: string, args: NamespaceDiscoveredDeviceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:deviceregistry/v20250701preview:NamespaceDiscoveredDevice" }] };

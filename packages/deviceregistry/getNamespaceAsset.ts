...
export interface GetNamespaceAssetResult {
     ...
     */
    readonly datasets?: types.outputs.NamespaceDatasetResponse[];
    /**
     ...
     */
    readonly events?: types.outputs.NamespaceEventResponse[];
    /**
     ...
     */
    readonly managementGroups?: types.outputs.ManagementGroupResponse[];
    /**
     * Asset manufacturer.
     */
     ...
     */
    readonly status: types.outputs.NamespaceAssetStatusResponse;
    /**
     * Array of streams that are part of the asset. Each stream can have a per-stream configuration.
     */
    readonly streams?: types.outputs.NamespaceStreamResponse[];
    /**

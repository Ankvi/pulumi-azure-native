...
export class NamespaceDevice extends pulumi.CustomResource {
     ...
     */
    declare public readonly endpoints: pulumi.Output<types.outputs.MessagingEndpointsResponse | undefined>;
    /**
     * Resource Tag.
     */
     ...
     */
    declare public /*out*/ readonly status: pulumi.Output<types.outputs.DeviceStatusResponse>;
    /**
    ...
    constructor(name: string, args: NamespaceDeviceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:deviceregistry/v20250701preview:NamespaceDevice" }, { type: "azure-native:deviceregistry/v20251001:NamespaceDevice" }, { type: "azure-native:deviceregistry/v20251101preview:NamespaceDevice" }] };

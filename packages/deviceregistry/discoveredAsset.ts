...
export class DiscoveredAsset extends pulumi.CustomResource {
     ...
     */
    declare public readonly datasets: pulumi.Output<types.outputs.DiscoveredDatasetResponse[] | undefined>;
    /**
     ...
     */
    declare public readonly events: pulumi.Output<types.outputs.DiscoveredEventResponse[] | undefined>;
    /**

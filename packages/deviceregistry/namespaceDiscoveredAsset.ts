...
export class NamespaceDiscoveredAsset extends pulumi.CustomResource {
     ...
     */
    declare public readonly datasets: pulumi.Output<types.outputs.NamespaceDiscoveredDatasetResponse[] | undefined>;
    /**
     ...
     */
    declare public readonly defaultDatasetsDestinations: pulumi.Output<(types.outputs.DatasetBrokerStateStoreDestinationResponse | types.outputs.DatasetMqttDestinationResponse | types.outputs.DatasetStorageDestinationResponse)[] | undefined>;
    /**
     ...
     */
    declare public readonly defaultEventsDestinations: pulumi.Output<(types.outputs.EventMqttDestinationResponse | types.outputs.EventStorageDestinationResponse)[] | undefined>;
    /**
     ...
     */
    declare public readonly defaultStreamsDestinations: pulumi.Output<(types.outputs.StreamMqttDestinationResponse | types.outputs.StreamStorageDestinationResponse)[] | undefined>;
    /**
     * Reference to the device that provides data for this asset. Must provide device name & endpoint on the device to use.
     */
    declare public readonly deviceRef: pulumi.Output<types.outputs.DeviceRefResponse>;
    /**
     ...
     */
    declare public readonly events: pulumi.Output<types.outputs.NamespaceDiscoveredEventResponse[] | undefined>;
    /**
     ...
     */
    declare public readonly managementGroups: pulumi.Output<types.outputs.NamespaceDiscoveredManagementGroupResponse[] | undefined>;
    /**
     * Asset manufacturer.
     */
     ...
     */
    declare public readonly streams: pulumi.Output<types.outputs.NamespaceDiscoveredStreamResponse[] | undefined>;
    /**

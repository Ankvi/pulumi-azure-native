...
export class CertificateProfile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:codesigning/v20240205preview:CertificateProfile';
    ...
    constructor(name: string, args: CertificateProfileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:codesigning:CertificateProfile" }] };

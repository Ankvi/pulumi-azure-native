...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:codesigning/v20240205preview:CertificateProfile":
                return new CertificateProfile(name, <any>undefined, { urn })
            case "azure-native:codesigning/v20240205preview:CodeSigningAccount":
...
pulumi.runtime.registerResourceModule("azure-native", "codesigning/v20240205preview", _module)
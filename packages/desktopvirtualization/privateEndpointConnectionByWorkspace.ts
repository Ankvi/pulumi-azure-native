...
export class PrivateEndpointConnectionByWorkspace extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly privateEndpoint!: pulumi.Output<types.outputs.desktopvirtualization.PrivateEndpointResponse | undefined>;
    /**
     * A collection of information about the state of the connection between service consumer and provider.
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<types.outputs.desktopvirtualization.PrivateLinkServiceConnectionStateResponse>;
    /**
...
export interface PrivateEndpointConnectionByWorkspaceArgs {
     ...
     * A collection of information about the state of the connection between service consumer and provider.
     */
    privateLinkServiceConnectionState: pulumi.Input<types.inputs.desktopvirtualization.PrivateLinkServiceConnectionStateArgs>;
    /**

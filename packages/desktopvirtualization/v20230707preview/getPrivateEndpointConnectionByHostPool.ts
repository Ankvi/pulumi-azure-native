...
export function getPrivateEndpointConnectionByHostPool(args: GetPrivateEndpointConnectionByHostPoolArgs, opts?: pulumi.InvokeOptions): Promise<GetPrivateEndpointConnectionByHostPoolResult> {
    ...
    return pulumi.runtime.invoke("azure-native:desktopvirtualization/v20230707preview:getPrivateEndpointConnectionByHostPool", {
...
export interface GetPrivateEndpointConnectionByHostPoolResult {
     ...
     */
    readonly privateEndpoint?: types.outputs.desktopvirtualization.v20230707preview.PrivateEndpointResponse;
    /**
     * A collection of information about the state of the connection between service consumer and provider.
     */
    readonly privateLinkServiceConnectionState: types.outputs.desktopvirtualization.v20230707preview.PrivateLinkServiceConnectionStateResponse;
    /**

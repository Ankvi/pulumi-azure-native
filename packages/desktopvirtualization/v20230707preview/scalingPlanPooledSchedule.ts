...
export class ScalingPlanPooledSchedule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:desktopvirtualization/v20230707preview:ScalingPlanPooledSchedule';
    ...
    constructor(name: string, args: ScalingPlanPooledScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:desktopvirtualization:ScalingPlanPooledSchedule" }, { type: "azure-native:desktopvirtualization/v20220401preview:ScalingPlanPooledSchedule" }, { type: "azure-native:desktopvirtualization/v20220909:ScalingPlanPooledSchedule" }, { type: "azure-native:desktopvirtualization/v20221014preview:ScalingPlanPooledSchedule" }] };
...
export interface ScalingPlanPooledScheduleArgs {
     ...
     * Load balancing algorithm for off-peak period.
     */
    offPeakLoadBalancingAlgorithm?: pulumi.Input<string | types.enums.v20230707preview.SessionHostLoadBalancingAlgorithm>;
    /**
     * Starting time for off-peak period.
     */
     ...
     * Load balancing algorithm for peak period.
     */
    peakLoadBalancingAlgorithm?: pulumi.Input<string | types.enums.v20230707preview.SessionHostLoadBalancingAlgorithm>;
    /**
     * Starting time for peak period.
     */
     ...
     * Load balancing algorithm for ramp down period.
     */
    rampDownLoadBalancingAlgorithm?: pulumi.Input<string | types.enums.v20230707preview.SessionHostLoadBalancingAlgorithm>;
    /**
     * Minimum host percentage for ramp down period.
     */
     ...
     * Specifies when to stop hosts during ramp down period.
     */
    rampDownStopHostsWhen?: pulumi.Input<string | types.enums.v20230707preview.StopHostsWhen>;
    /**
     * Number of minutes to wait to stop hosts during ramp down period.
     */
     ...
     * Load balancing algorithm for ramp up period.
     */
    rampUpLoadBalancingAlgorithm?: pulumi.Input<string | types.enums.v20230707preview.SessionHostLoadBalancingAlgorithm>;
    /**
     * Minimum host percentage for ramp up period.
     */

...
export class ScalingPlan extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:desktopvirtualization/v20230707preview:ScalingPlan';
     ...
     */
    public readonly hostPoolReferences!: pulumi.Output<types.outputs.desktopvirtualization.v20230707preview.ScalingHostPoolReferenceResponse[] | undefined>;
    /**
     ...
     */
    public readonly schedules!: pulumi.Output<types.outputs.desktopvirtualization.v20230707preview.ScalingScheduleResponse[] | undefined>;
...
export interface ScalingPlanArgs {
     ...
     * List of ScalingHostPoolReference definitions.
     */
    hostPoolReferences?: pulumi.Input<pulumi.Input<types.inputs.desktopvirtualization.v20230707preview.ScalingHostPoolReferenceArgs>[]>;
    /**
     * HostPool type for desktop.
     */
    hostPoolType?: pulumi.Input<string | types.enums.v20230707preview.ScalingHostPoolType>;
     ...
     * List of ScalingPlanPooledSchedule definitions.
     */
    schedules?: pulumi.Input<pulumi.Input<types.inputs.desktopvirtualization.v20230707preview.ScalingScheduleArgs>[]>;

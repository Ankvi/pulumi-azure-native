...
export class PrivateEndpointConnectionByHostPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:desktopvirtualization/v20230707preview:PrivateEndpointConnectionByHostPool';
     ...
     */
    public /*out*/ readonly privateEndpoint!: pulumi.Output<types.outputs.desktopvirtualization.v20230707preview.PrivateEndpointResponse | undefined>;
    /**
     * A collection of information about the state of the connection between service consumer and provider.
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<types.outputs.desktopvirtualization.v20230707preview.PrivateLinkServiceConnectionStateResponse>;
    /**
...
export interface PrivateEndpointConnectionByHostPoolArgs {
     ...
     * A collection of information about the state of the connection between service consumer and provider.
     */
    privateLinkServiceConnectionState: pulumi.Input<types.inputs.desktopvirtualization.v20230707preview.PrivateLinkServiceConnectionStateArgs>;
    /**

...
export class MSIXPackage extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:desktopvirtualization/v20230707preview:MSIXPackage';
     ...
     */
    public readonly packageApplications!: pulumi.Output<types.outputs.desktopvirtualization.v20230707preview.MsixPackageApplicationsResponse[] | undefined>;
    /**
     * List of package dependencies. 
     */
    public readonly packageDependencies!: pulumi.Output<types.outputs.desktopvirtualization.v20230707preview.MsixPackageDependenciesResponse[] | undefined>;
    /**
...
export interface MSIXPackageArgs {
     ...
     * List of package applications. 
     */
    packageApplications?: pulumi.Input<pulumi.Input<types.inputs.desktopvirtualization.v20230707preview.MsixPackageApplicationsArgs>[]>;
    /**
     * List of package dependencies. 
     */
    packageDependencies?: pulumi.Input<pulumi.Input<types.inputs.desktopvirtualization.v20230707preview.MsixPackageDependenciesArgs>[]>;
    /**
     * Package Family Name from appxmanifest.xml. Contains Package Name and Publisher name. 
     */

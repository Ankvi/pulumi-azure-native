...
export class HostPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:desktopvirtualization/v20230707preview:HostPool';
     ...
     */
    public readonly agentUpdate!: pulumi.Output<types.outputs.desktopvirtualization.v20230707preview.AgentUpdatePropertiesResponse | undefined>;
    /**
     ...
     */
    public readonly registrationInfo!: pulumi.Output<types.outputs.desktopvirtualization.v20230707preview.RegistrationInfoResponse | undefined>;
    /**
...
export interface HostPoolArgs {
     ...
     * The session host configuration for updating agent, monitoring agent, and stack component.
     */
    agentUpdate?: pulumi.Input<types.inputs.desktopvirtualization.v20230707preview.AgentUpdatePropertiesArgs>;
    /**
     * Custom rdp property of HostPool.
     */
     ...
     * HostPool type for desktop.
     */
    hostPoolType: pulumi.Input<string | types.enums.v20230707preview.HostPoolType>;
     ...
     * The type of the load balancer.
     */
    loadBalancerType: pulumi.Input<string | types.enums.v20230707preview.LoadBalancerType>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * PersonalDesktopAssignment type for HostPool.
     */
    personalDesktopAssignmentType?: pulumi.Input<string | types.enums.v20230707preview.PersonalDesktopAssignmentType>;
    plan?: pulumi.Input<types.inputs.desktopvirtualization.v20230707preview.ResourceModelWithAllowedPropertySetPlanArgs>;
    /**
     * The type of preferred application group type, default to Desktop Application Group
     */
    preferredAppGroupType: pulumi.Input<string | types.enums.v20230707preview.PreferredAppGroupType>;
    /**
     * Enabled allows this resource to be accessed from both public and private networks, Disabled allows this resource to only be accessed via private endpoints
     */
    publicNetworkAccess?: pulumi.Input<string | types.enums.v20230707preview.HostpoolPublicNetworkAccess>;
    /**
     * The registration info of HostPool.
     */
    registrationInfo?: pulumi.Input<types.inputs.desktopvirtualization.v20230707preview.RegistrationInfoArgs>;
    /**
     ...
     * The type of single sign on Secret Type.
     */
    ssoSecretType?: pulumi.Input<string | types.enums.v20230707preview.SSOSecretType>;
    /**
     * URL to customer ADFS server for signing WVD SSO certificates.
     */

...
export function getMSIXPackage(args: GetMSIXPackageArgs, opts?: pulumi.InvokeOptions): Promise<GetMSIXPackageResult> {
    ...
    return pulumi.runtime.invoke("azure-native:desktopvirtualization/v20221014preview:getMSIXPackage", {
...
export interface GetMSIXPackageResult {
     ...
     */
    readonly packageApplications?: types.outputs.desktopvirtualization.v20221014preview.MsixPackageApplicationsResponse[];
    /**
     * List of package dependencies. 
     */
    readonly packageDependencies?: types.outputs.desktopvirtualization.v20221014preview.MsixPackageDependenciesResponse[];
    /**

...
export class HostPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:desktopvirtualization/v20221014preview:HostPool';
     ...
     */
    public readonly agentUpdate!: pulumi.Output<types.outputs.desktopvirtualization.v20221014preview.AgentUpdatePropertiesResponse | undefined>;
    /**
    ...
    public readonly identity!: pulumi.Output<types.outputs.desktopvirtualization.v20221014preview.ResourceModelWithAllowedPropertySetResponseIdentity | undefined>;
    /**
    ...
    public readonly plan!: pulumi.Output<types.outputs.desktopvirtualization.v20221014preview.ResourceModelWithAllowedPropertySetResponsePlan | undefined>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<types.outputs.desktopvirtualization.v20221014preview.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public readonly registrationInfo!: pulumi.Output<types.outputs.desktopvirtualization.v20221014preview.RegistrationInfoResponse | undefined>;
    /**
     * The ring number of HostPool.
     */
    public readonly ring!: pulumi.Output<number | undefined>;
    public readonly sku!: pulumi.Output<types.outputs.desktopvirtualization.v20221014preview.ResourceModelWithAllowedPropertySetResponseSku | undefined>;
    /**
...
export interface HostPoolArgs {
     ...
     * The session host configuration for updating agent, monitoring agent, and stack component.
     */
    agentUpdate?: pulumi.Input<types.inputs.desktopvirtualization.v20221014preview.AgentUpdatePropertiesArgs>;
    /**
     * Custom rdp property of HostPool.
     */
     ...
     * HostPool type for desktop.
     */
    hostPoolType: pulumi.Input<string | types.enums.v20221014preview.HostPoolType>;
    identity?: pulumi.Input<types.inputs.desktopvirtualization.v20221014preview.ResourceModelWithAllowedPropertySetIdentityArgs>;
    /**
     * Metadata used by portal/tooling/etc to render different UX experiences for resources of the same type; e.g. ApiApps are a kind of Microsoft.Web/sites type.  If supported, the resource provider must validate and persist this value.
     */
     ...
     * The type of the load balancer.
     */
    loadBalancerType: pulumi.Input<string | types.enums.v20221014preview.LoadBalancerType>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * PersonalDesktopAssignment type for HostPool.
     */
    personalDesktopAssignmentType?: pulumi.Input<string | types.enums.v20221014preview.PersonalDesktopAssignmentType>;
    plan?: pulumi.Input<types.inputs.desktopvirtualization.v20221014preview.ResourceModelWithAllowedPropertySetPlanArgs>;
    /**
     * The type of preferred application group type, default to Desktop Application Group
     */
    preferredAppGroupType: pulumi.Input<string | types.enums.v20221014preview.PreferredAppGroupType>;
    /**
     * Enabled allows this resource to be accessed from both public and private networks, Disabled allows this resource to only be accessed via private endpoints
     */
    publicNetworkAccess?: pulumi.Input<string | types.enums.v20221014preview.HostpoolPublicNetworkAccess>;
    /**
     * The registration info of HostPool.
     */
    registrationInfo?: pulumi.Input<types.inputs.desktopvirtualization.v20221014preview.RegistrationInfoArgs>;
    /**
    ...
    sku?: pulumi.Input<types.inputs.desktopvirtualization.v20221014preview.ResourceModelWithAllowedPropertySetSkuArgs>;
    /**
     * ClientId for the registered Relying Party used to issue WVD SSO certificates.
     */
     ...
     * The type of single sign on Secret Type.
     */
    ssoSecretType?: pulumi.Input<string | types.enums.v20221014preview.SSOSecretType>;
    /**
     * URL to customer ADFS server for signing WVD SSO certificates.
     */

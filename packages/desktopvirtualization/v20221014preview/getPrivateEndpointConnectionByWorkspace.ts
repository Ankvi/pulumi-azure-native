...
export function getPrivateEndpointConnectionByWorkspace(args: GetPrivateEndpointConnectionByWorkspaceArgs, opts?: pulumi.InvokeOptions): Promise<GetPrivateEndpointConnectionByWorkspaceResult> {
    ...
    return pulumi.runtime.invoke("azure-native:desktopvirtualization/v20221014preview:getPrivateEndpointConnectionByWorkspace", {
...
export interface GetPrivateEndpointConnectionByWorkspaceResult {
     ...
     */
    readonly privateEndpoint?: types.outputs.desktopvirtualization.v20221014preview.PrivateEndpointResponse;
    /**
     * A collection of information about the state of the connection between service consumer and provider.
     */
    readonly privateLinkServiceConnectionState: types.outputs.desktopvirtualization.v20221014preview.PrivateLinkServiceConnectionStateResponse;
    /**

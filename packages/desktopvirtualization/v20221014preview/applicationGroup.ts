...
export class ApplicationGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:desktopvirtualization/v20221014preview:ApplicationGroup';
...
export interface ApplicationGroupArgs {
     ...
     * Resource Type of ApplicationGroup.
     */
    applicationGroupType: pulumi.Input<string | types.enums.v20221014preview.ApplicationGroupType>;
    /**
     * Description of ApplicationGroup.
     */

...
export function getHostPool(args: GetHostPoolArgs, opts?: pulumi.InvokeOptions): Promise<GetHostPoolResult> {
    ...
    return pulumi.runtime.invoke("azure-native:desktopvirtualization/v20221014preview:getHostPool", {
...
export interface GetHostPoolResult {
     ...
     */
    readonly agentUpdate?: types.outputs.desktopvirtualization.v20221014preview.AgentUpdatePropertiesResponse;
    /**
     ...
     */
    readonly id: string;
    readonly identity?: types.outputs.desktopvirtualization.v20221014preview.ResourceModelWithAllowedPropertySetResponseIdentity;
    /**
    ...
    readonly plan?: types.outputs.desktopvirtualization.v20221014preview.ResourceModelWithAllowedPropertySetResponsePlan;
    /**
     ...
     */
    readonly privateEndpointConnections: types.outputs.desktopvirtualization.v20221014preview.PrivateEndpointConnectionResponse[];
    /**
     ...
     */
    readonly registrationInfo?: types.outputs.desktopvirtualization.v20221014preview.RegistrationInfoResponse;
    /**
     * The ring number of HostPool.
     */
    readonly ring?: number;
    readonly sku?: types.outputs.desktopvirtualization.v20221014preview.ResourceModelWithAllowedPropertySetResponseSku;
    /**
     ...
     */
    readonly systemData: types.outputs.desktopvirtualization.v20221014preview.SystemDataResponse;
    /**
     * Resource tags.
     */

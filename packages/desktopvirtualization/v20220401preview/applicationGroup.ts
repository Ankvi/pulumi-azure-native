...
export class ApplicationGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:desktopvirtualization/v20220401preview:ApplicationGroup';
...
export interface ApplicationGroupArgs {
     ...
     * Resource Type of ApplicationGroup.
     */
    applicationGroupType: pulumi.Input<string | types.enums.v20220401preview.ApplicationGroupType>;
    /**
     * Description of ApplicationGroup.
     */

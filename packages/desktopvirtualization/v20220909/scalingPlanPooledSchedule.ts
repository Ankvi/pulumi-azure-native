...
export class ScalingPlanPooledSchedule extends pulumi.CustomResource {
     ...
     */
    public readonly offPeakStartTime!: pulumi.Output<types.outputs.desktopvirtualization.v20220909.TimeResponse | undefined>;
    /**
     ...
     */
    public readonly peakStartTime!: pulumi.Output<types.outputs.desktopvirtualization.v20220909.TimeResponse | undefined>;
    /**
     ...
     */
    public readonly rampDownStartTime!: pulumi.Output<types.outputs.desktopvirtualization.v20220909.TimeResponse | undefined>;
    /**
     ...
     */
    public readonly rampUpStartTime!: pulumi.Output<types.outputs.desktopvirtualization.v20220909.TimeResponse | undefined>;
    /**
...
export interface ScalingPlanPooledScheduleArgs {
     ...
     * Set of days of the week on which this schedule is active.
     */
    daysOfWeek?: pulumi.Input<pulumi.Input<string | types.enums.v20220909.DayOfWeek>[]>;
    /**
     * Load balancing algorithm for off-peak period.
     */
    offPeakLoadBalancingAlgorithm?: pulumi.Input<string | types.enums.v20220909.SessionHostLoadBalancingAlgorithm>;
    /**
     * Starting time for off-peak period.
     */
    offPeakStartTime?: pulumi.Input<types.inputs.desktopvirtualization.v20220909.TimeArgs>;
    /**
     * Load balancing algorithm for peak period.
     */
    peakLoadBalancingAlgorithm?: pulumi.Input<string | types.enums.v20220909.SessionHostLoadBalancingAlgorithm>;
    /**
     * Starting time for peak period.
     */
    peakStartTime?: pulumi.Input<types.inputs.desktopvirtualization.v20220909.TimeArgs>;
    /**
     * Capacity threshold for ramp down period.
     */
     ...
     * Load balancing algorithm for ramp down period.
     */
    rampDownLoadBalancingAlgorithm?: pulumi.Input<string | types.enums.v20220909.SessionHostLoadBalancingAlgorithm>;
    /**
     * Minimum host percentage for ramp down period.
     */
     ...
     * Starting time for ramp down period.
     */
    rampDownStartTime?: pulumi.Input<types.inputs.desktopvirtualization.v20220909.TimeArgs>;
    /**
     * Specifies when to stop hosts during ramp down period.
     */
    rampDownStopHostsWhen?: pulumi.Input<string | types.enums.v20220909.StopHostsWhen>;
    /**
     * Number of minutes to wait to stop hosts during ramp down period.
     */
     ...
     * Load balancing algorithm for ramp up period.
     */
    rampUpLoadBalancingAlgorithm?: pulumi.Input<string | types.enums.v20220909.SessionHostLoadBalancingAlgorithm>;
    /**
     * Minimum host percentage for ramp up period.
     */
     ...
     * Starting time for ramp up period.
     */
    rampUpStartTime?: pulumi.Input<types.inputs.desktopvirtualization.v20220909.TimeArgs>;
    /**

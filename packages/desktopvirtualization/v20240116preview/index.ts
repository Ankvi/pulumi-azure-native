...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:desktopvirtualization/v20240116preview:AppAttachPackage":
                return new AppAttachPackage(name, <any>undefined, { urn })
            case "azure-native:desktopvirtualization/v20240116preview:Application":
                return new Application(name, <any>undefined, { urn })
            case "azure-native:desktopvirtualization/v20240116preview:ApplicationGroup":
                return new ApplicationGroup(name, <any>undefined, { urn })
            case "azure-native:desktopvirtualization/v20240116preview:HostPool":
                return new HostPool(name, <any>undefined, { urn })
            case "azure-native:desktopvirtualization/v20240116preview:MSIXPackage":
                return new MSIXPackage(name, <any>undefined, { urn })
            case "azure-native:desktopvirtualization/v20240116preview:PrivateEndpointConnectionByHostPool":
                return new PrivateEndpointConnectionByHostPool(name, <any>undefined, { urn })
            case "azure-native:desktopvirtualization/v20240116preview:PrivateEndpointConnectionByWorkspace":
                return new PrivateEndpointConnectionByWorkspace(name, <any>undefined, { urn })
            case "azure-native:desktopvirtualization/v20240116preview:ScalingPlan":
                return new ScalingPlan(name, <any>undefined, { urn })
            case "azure-native:desktopvirtualization/v20240116preview:ScalingPlanPersonalSchedule":
                return new ScalingPlanPersonalSchedule(name, <any>undefined, { urn })
            case "azure-native:desktopvirtualization/v20240116preview:ScalingPlanPooledSchedule":
                return new ScalingPlanPooledSchedule(name, <any>undefined, { urn })
            case "azure-native:desktopvirtualization/v20240116preview:Workspace":
...
pulumi.runtime.registerResourceModule("azure-native", "desktopvirtualization/v20240116preview", _module)
...
export class MSIXPackage extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:desktopvirtualization/v20240116preview:MSIXPackage';

...
export class ScalingPlanPersonalSchedule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ScalingPlanPersonalScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:desktopvirtualization/v20230905:ScalingPlanPersonalSchedule" }, { type: "azure-native:desktopvirtualization/v20231004preview:ScalingPlanPersonalSchedule" }, { type: "azure-native:desktopvirtualization/v20231101preview:ScalingPlanPersonalSchedule" }, { type: "azure-native:desktopvirtualization/v20240116preview:ScalingPlanPersonalSchedule" }, { type: "azure-native:desktopvirtualization/v20240306preview:ScalingPlanPersonalSchedule" }, { type: "azure-native:desktopvirtualization/v20240403:ScalingPlanPersonalSchedule" }, { type: "azure-native:desktopvirtualization/v20240408preview:ScalingPlanPersonalSchedule" }, { type: "azure-native:desktopvirtualization/v20240808preview:ScalingPlanPersonalSchedule" }, { type: "azure-native:desktopvirtualization/v20241101preview:ScalingPlanPersonalSchedule" }, { type: "azure-native:desktopvirtualization/v20250301preview:ScalingPlanPersonalSchedule" }, { type: "azure-native:desktopvirtualization/v20250401preview:ScalingPlanPersonalSchedule" }] };

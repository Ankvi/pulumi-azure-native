...
export class ScalingPlan extends pulumi.CustomResource {
     ...
     */
    declare public readonly hostPoolReferences: pulumi.Output<types.outputs.ScalingHostPoolReferenceResponse[] | undefined>;
    /**
     * HostPool type for desktop.
     */
    declare public readonly hostPoolType: pulumi.Output<string | undefined>;
     ...
     */
    declare public readonly schedules: pulumi.Output<types.outputs.ScalingScheduleResponse[] | undefined>;
    ...
    constructor(name: string, args: ScalingPlanArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["hostPoolReferences"] = args?.hostPoolReferences;
            resourceInputs["hostPoolType"] = (args?.hostPoolType) ?? "Pooled";

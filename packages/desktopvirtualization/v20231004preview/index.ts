...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            ...
            case "azure-native:desktopvirtualization/v20231004preview:Application":
                return new Application(name, <any>undefined, { urn })
            case "azure-native:desktopvirtualization/v20231004preview:ApplicationGroup":
                return new ApplicationGroup(name, <any>undefined, { urn })
            case "azure-native:desktopvirtualization/v20231004preview:HostPool":
                return new HostPool(name, <any>undefined, { urn })
            case "azure-native:desktopvirtualization/v20231004preview:MSIXPackage":
                return new MSIXPackage(name, <any>undefined, { urn })
            case "azure-native:desktopvirtualization/v20231004preview:PrivateEndpointConnectionByHostPool":
                return new PrivateEndpointConnectionByHostPool(name, <any>undefined, { urn })
            case "azure-native:desktopvirtualization/v20231004preview:PrivateEndpointConnectionByWorkspace":
                return new PrivateEndpointConnectionByWorkspace(name, <any>undefined, { urn })
            case "azure-native:desktopvirtualization/v20231004preview:ScalingPlan":
                return new ScalingPlan(name, <any>undefined, { urn })
            case "azure-native:desktopvirtualization/v20231004preview:ScalingPlanPersonalSchedule":
                return new ScalingPlanPersonalSchedule(name, <any>undefined, { urn })
            case "azure-native:desktopvirtualization/v20231004preview:ScalingPlanPooledSchedule":
                return new ScalingPlanPooledSchedule(name, <any>undefined, { urn })
            case "azure-native:desktopvirtualization/v20231004preview:Workspace":

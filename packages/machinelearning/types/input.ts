...
export namespace machinelearning {
    ...
    export namespace v20160501preview {
        /**
         * Information about an asset associated with the web service.
         */
        export interface AssetItemArgs {
             ...
             * Information about the asset's input ports.
             */
            inputPorts?: pulumi.Input<{[key: string]: pulumi.Input<v20160501preview.InputPortArgs>}>;
            /**
             * Access information for the asset.
             */
            locationInfo: pulumi.Input<v20160501preview.AssetLocationArgs>;
            /**
             * If the asset is a custom module, this holds the module's metadata.
             */
            metadata?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
             ...
             * Information about the asset's output ports.
             */
            outputPorts?: pulumi.Input<{[key: string]: pulumi.Input<v20160501preview.OutputPortArgs>}>;
            /**
             * If the asset is a custom module, this holds the module's parameters.
             */
            parameters?: pulumi.Input<pulumi.Input<v20160501preview.ModuleAssetParameterArgs>[]>;
            /**
             * Asset's type.
             */
            type: pulumi.Input<string | enums.v20160501preview.AssetType>;
        }

        /**
         * Describes the access location for a web service asset.
         */
        export interface AssetLocationArgs {
            /**
        ...
        export interface ColumnSpecificationArgs {
             ...
             * Additional format information for the data type.
             */
            format?: pulumi.Input<string | enums.v20160501preview.ColumnFormat>;
            /**
             * Data type of the column.
             */
            type: pulumi.Input<string | enums.v20160501preview.ColumnType>;
            /**
             * Flag indicating if the type supports null values or not.
             */
            xMsIsnullable?: pulumi.Input<boolean>;
        ...
        export interface DiagnosticsConfigurationArgs {
             ...
             * Specifies the verbosity of the diagnostic output. Valid values are: None - disables tracing; Error - collects only error (stderr) traces; All - collects all traces (stdout and stderr).
             */
            level: pulumi.Input<string | enums.v20160501preview.DiagnosticsLevel>;
        }
        ...
        export interface GraphPackageArgs {
             ...
             * The list of edges making up the graph.
             */
            edges?: pulumi.Input<pulumi.Input<v20160501preview.GraphEdgeArgs>[]>;
            /**
             * The collection of global parameters for the graph, given as a global parameter name to GraphParameter map. Each parameter here has a 1:1 match with the global parameters values map declared at the WebServiceProperties level.
             */
            graphParameters?: pulumi.Input<{[key: string]: pulumi.Input<v20160501preview.GraphParameterArgs>}>;
            /**
             * The set of nodes making up the graph, provided as a nodeId to GraphNode map
             */
            nodes?: pulumi.Input<{[key: string]: pulumi.Input<v20160501preview.GraphNodeArgs>}>;
        }
        ...
        export interface GraphParameterArgs {
             ...
             * Association links for this parameter to nodes in the graph.
             */
            links: pulumi.Input<pulumi.Input<v20160501preview.GraphParameterLinkArgs>[]>;
            /**
             * Graph parameter's type.
             */
            type: pulumi.Input<string | enums.v20160501preview.ParameterType>;
        }
        ...
        export interface InputPortArgs {
             ...
             * Port data type.
             */
            type?: pulumi.Input<string | enums.v20160501preview.InputPortType>;
        }
        /**
         * inputPortArgsProvideDefaults sets the appropriate defaults for InputPortArgs
         */
        ...
        export interface ModuleAssetParameterArgs {
             ...
             * Definitions for nested interface parameters if this is a complex module parameter.
             */
            modeValuesInfo?: pulumi.Input<{[key: string]: pulumi.Input<v20160501preview.ModeValueInfoArgs>}>;
            /**
             * Parameter name.
             */
            name?: pulumi.Input<string>;
        ...
        export interface OutputPortArgs {
             ...
             * Port data type.
             */
            type?: pulumi.Input<string | enums.v20160501preview.OutputPortType>;
        }
        /**
         * outputPortArgsProvideDefaults sets the appropriate defaults for OutputPortArgs
         */
        ...
        export interface ServiceInputOutputSpecificationArgs {
             ...
             * Specifies a collection that contains the column schema for each input or output of the web service. For more information, see the Swagger specification.
             */
            properties: pulumi.Input<{[key: string]: pulumi.Input<v20160501preview.TableSpecificationArgs>}>;
            /**
             * The title of your Swagger schema.
             */
            title?: pulumi.Input<string>;
        ...
        export interface TableSpecificationArgs {
             ...
             * The set of columns within the data table.
             */
            properties?: pulumi.Input<{[key: string]: pulumi.Input<v20160501preview.ColumnSpecificationArgs>}>;
            /**
             * Swagger schema title.
             */
            title?: pulumi.Input<string>;
        ...
        export interface WebServicePropertiesForGraphArgs {
             ...
             * Contains user defined properties describing web service assets. Properties are expressed as Key/Value pairs.
             */
            assets?: pulumi.Input<{[key: string]: pulumi.Input<v20160501preview.AssetItemArgs>}>;
            /**
             * Contains the commitment plan associated with this web service. Set at creation time. Once set, this value cannot be changed. Note: The commitment plan is not returned from calls to GET operations.
             */
            commitmentPlan?: pulumi.Input<v20160501preview.CommitmentPlanArgs>;
            /**
             * The description of the web service.
             */
            description?: pulumi.Input<string>;
             ...
             * Settings controlling the diagnostics traces collection for the web service.
             */
            diagnostics?: pulumi.Input<v20160501preview.DiagnosticsConfigurationArgs>;
            /**
             * Defines sample input data for one or more of the service's inputs.
             */
            exampleRequest?: pulumi.Input<v20160501preview.ExampleRequestArgs>;
            /**
             * When set to true, sample data is included in the web service's swagger definition. The default value is true.
             */
            exposeSampleData?: pulumi.Input<boolean>;
             ...
             * Contains the Swagger 2.0 schema describing one or more of the web service's inputs. For more information, see the Swagger specification.
             */
            input?: pulumi.Input<v20160501preview.ServiceInputOutputSpecificationArgs>;
            /**
             * Contains the web service provisioning keys. If you do not specify provisioning keys, the Azure Machine Learning system generates them for you. Note: The keys are not returned from calls to GET operations.
             */
            keys?: pulumi.Input<v20160501preview.WebServiceKeysArgs>;
            /**
             * Specifies the Machine Learning workspace containing the experiment that is source for the web service.
             */
            machineLearningWorkspace?: pulumi.Input<v20160501preview.MachineLearningWorkspaceArgs>;
            /**
             * Contains the Swagger 2.0 schema describing one or more of the web service's outputs. For more information, see the Swagger specification.
             */
            output?: pulumi.Input<v20160501preview.ServiceInputOutputSpecificationArgs>;
            /**
             * The definition of the graph package making up this web service.
             */
            package?: pulumi.Input<v20160501preview.GraphPackageArgs>;
            /**
             * Specifies the package type. Valid values are Graph (Specifies a web service published through the Machine Learning Studio) and Code (Specifies a web service published using code such as Python). Note: Code is not supported at this time.
             * Expected value is 'Graph'.
             */
             ...
             * Contains the configuration settings for the web service endpoint.
             */
            realtimeConfiguration?: pulumi.Input<v20160501preview.RealtimeConfigurationArgs>;
            /**
             * Specifies the storage account that Azure Machine Learning uses to store information about the web service. Only the name of the storage account is returned from calls to GET operations. When updating the storage account information, you must ensure that all necessary assets are available in the new storage account or calls to your web service will fail.
             */
            storageAccount?: pulumi.Input<v20160501preview.StorageAccountArgs>;
            /**
             * The title of the web service.
             */
            title?: pulumi.Input<string>;
        ...
        export function webServicePropertiesForGraphArgsProvideDefaults(val: WebServicePropertiesForGraphArgs): WebServicePropertiesForGraphArgs {
            return {
                ...val,
                input: (val.input ? pulumi.output(val.input).apply(v20160501preview.serviceInputOutputSpecificationArgsProvideDefaults) : undefined),
                output: (val.output ? pulumi.output(val.output).apply(v20160501preview.serviceInputOutputSpecificationArgsProvideDefaults) : undefined),
            };
        }

    }

    export namespace v20170101 {
        /**
         * Information about an asset associated with the web service.
         */
        export interface AssetItemArgs {
             ...
             * Information about the asset's input ports.
             */
            inputPorts?: pulumi.Input<{[key: string]: pulumi.Input<v20170101.InputPortArgs>}>;
            /**
             * Access information for the asset.
             */
            locationInfo: pulumi.Input<v20170101.BlobLocationArgs>;
            /**
             * If the asset is a custom module, this holds the module's metadata.
             */
            metadata?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
             ...
             * Information about the asset's output ports.
             */
            outputPorts?: pulumi.Input<{[key: string]: pulumi.Input<v20170101.OutputPortArgs>}>;
            /**
             * If the asset is a custom module, this holds the module's parameters.
             */
            parameters?: pulumi.Input<pulumi.Input<v20170101.ModuleAssetParameterArgs>[]>;
            /**
             * Asset's type.
             */
            type: pulumi.Input<string | enums.v20170101.AssetType>;
        }
        ...
        export interface ColumnSpecificationArgs {
             ...
             * Additional format information for the data type.
             */
            format?: pulumi.Input<string | enums.v20170101.ColumnFormat>;
            /**
             * Data type of the column.
             */
            type: pulumi.Input<string | enums.v20170101.ColumnType>;
            /**
             * Flag indicating if the type supports null values or not.
             */
            xMsIsnullable?: pulumi.Input<boolean>;
        ...
        export interface DiagnosticsConfigurationArgs {
             ...
             * Specifies the verbosity of the diagnostic output. Valid values are: None - disables tracing; Error - collects only error (stderr) traces; All - collects all traces (stdout and stderr).
             */
            level: pulumi.Input<string | enums.v20170101.DiagnosticsLevel>;
        }
        ...
        export interface GraphNodeArgs {
             ...
             * If applicable, parameters of the node. Global graph parameters map into these, with values set at runtime.
             */
            parameters?: pulumi.Input<{[key: string]: pulumi.Input<v20170101.WebServiceParameterArgs>}>;
        }
        ...
        export interface GraphPackageArgs {
             ...
             * The list of edges making up the graph.
             */
            edges?: pulumi.Input<pulumi.Input<v20170101.GraphEdgeArgs>[]>;
            /**
             * The collection of global parameters for the graph, given as a global parameter name to GraphParameter map. Each parameter here has a 1:1 match with the global parameters values map declared at the WebServiceProperties level.
             */
            graphParameters?: pulumi.Input<{[key: string]: pulumi.Input<v20170101.GraphParameterArgs>}>;
            /**
             * The set of nodes making up the graph, provided as a nodeId to GraphNode map
             */
            nodes?: pulumi.Input<{[key: string]: pulumi.Input<v20170101.GraphNodeArgs>}>;
        }
        ...
        export interface GraphParameterArgs {
             ...
             * Association links for this parameter to nodes in the graph.
             */
            links: pulumi.Input<pulumi.Input<v20170101.GraphParameterLinkArgs>[]>;
            /**
             * Graph parameter's type.
             */
            type: pulumi.Input<string | enums.v20170101.ParameterType>;
        }
        ...
        export interface InputPortArgs {
             ...
             * Port data type.
             */
            type?: pulumi.Input<string | enums.v20170101.InputPortType>;
        }
        /**
         * inputPortArgsProvideDefaults sets the appropriate defaults for InputPortArgs
         */
        ...
        export interface ModuleAssetParameterArgs {
             ...
             * Definitions for nested interface parameters if this is a complex module parameter.
             */
            modeValuesInfo?: pulumi.Input<{[key: string]: pulumi.Input<v20170101.ModeValueInfoArgs>}>;
            /**
             * Parameter name.
             */
            name?: pulumi.Input<string>;
        ...
        export interface OutputPortArgs {
             ...
             * Port data type.
             */
            type?: pulumi.Input<string | enums.v20170101.OutputPortType>;
        }
        /**
         * outputPortArgsProvideDefaults sets the appropriate defaults for OutputPortArgs
         */
        ...
        export interface ServiceInputOutputSpecificationArgs {
             ...
             * Specifies a collection that contains the column schema for each input or output of the web service. For more information, see the Swagger specification.
             */
            properties: pulumi.Input<{[key: string]: pulumi.Input<v20170101.TableSpecificationArgs>}>;
            /**
             * The title of your Swagger schema.
             */
            title?: pulumi.Input<string>;
        ...
        export interface TableSpecificationArgs {
             ...
             * The set of columns within the data table.
             */
            properties?: pulumi.Input<{[key: string]: pulumi.Input<v20170101.ColumnSpecificationArgs>}>;
            /**
             * Swagger schema title.
             */
            title?: pulumi.Input<string>;
        ...
        export interface WebServicePropertiesForGraphArgs {
             ...
             * Contains user defined properties describing web service assets. Properties are expressed as Key/Value pairs.
             */
            assets?: pulumi.Input<{[key: string]: pulumi.Input<v20170101.AssetItemArgs>}>;
            /**
             * Contains the commitment plan associated with this web service. Set at creation time. Once set, this value cannot be changed. Note: The commitment plan is not returned from calls to GET operations.
             */
            commitmentPlan?: pulumi.Input<v20170101.CommitmentPlanArgs>;
            /**
             * The description of the web service.
             */
            description?: pulumi.Input<string>;
             ...
             * Settings controlling the diagnostics traces collection for the web service.
             */
            diagnostics?: pulumi.Input<v20170101.DiagnosticsConfigurationArgs>;
            /**
             * Defines sample input data for one or more of the service's inputs.
             */
            exampleRequest?: pulumi.Input<v20170101.ExampleRequestArgs>;
            /**
             * When set to true, sample data is included in the web service's swagger definition. The default value is true.
             */
            exposeSampleData?: pulumi.Input<boolean>;
             ...
             * Contains the Swagger 2.0 schema describing one or more of the web service's inputs. For more information, see the Swagger specification.
             */
            input?: pulumi.Input<v20170101.ServiceInputOutputSpecificationArgs>;
            /**
             * Contains the web service provisioning keys. If you do not specify provisioning keys, the Azure Machine Learning system generates them for you. Note: The keys are not returned from calls to GET operations.
             */
            keys?: pulumi.Input<v20170101.WebServiceKeysArgs>;
            /**
             * Specifies the Machine Learning workspace containing the experiment that is source for the web service.
             */
            machineLearningWorkspace?: pulumi.Input<v20170101.MachineLearningWorkspaceArgs>;
            /**
             * Contains the Swagger 2.0 schema describing one or more of the web service's outputs. For more information, see the Swagger specification.
             */
            output?: pulumi.Input<v20170101.ServiceInputOutputSpecificationArgs>;
            /**
             * The definition of the graph package making up this web service.
             */
            package?: pulumi.Input<v20170101.GraphPackageArgs>;
            /**
             * Specifies the package type. Valid values are Graph (Specifies a web service published through the Machine Learning Studio) and Code (Specifies a web service published using code such as Python). Note: Code is not supported at this time.
             * Expected value is 'Graph'.
             */
             ...
             * The URI of the payload blob. This parameter contains a value only if the payloadsInBlobStorage parameter is set to true. Otherwise is set to null.
             */
            payloadsLocation?: pulumi.Input<v20170101.BlobLocationArgs>;
            /**
             * When set to true, indicates that the web service is read-only and can no longer be updated or patched, only removed. Default, is false. Note: Once set to true, you cannot change its value.
             */
            readOnly?: pulumi.Input<boolean>;
             ...
             * Contains the configuration settings for the web service endpoint.
             */
            realtimeConfiguration?: pulumi.Input<v20170101.RealtimeConfigurationArgs>;
            /**
             * Specifies the storage account that Azure Machine Learning uses to store information about the web service. Only the name of the storage account is returned from calls to GET operations. When updating the storage account information, you must ensure that all necessary assets are available in the new storage account or calls to your web service will fail.
             */
            storageAccount?: pulumi.Input<v20170101.StorageAccountArgs>;
            /**
             * The title of the web service.
             */
            title?: pulumi.Input<string>;
        ...
        export function webServicePropertiesForGraphArgsProvideDefaults(val: WebServicePropertiesForGraphArgs): WebServicePropertiesForGraphArgs {
            return {
                ...val,
                input: (val.input ? pulumi.output(val.input).apply(v20170101.serviceInputOutputSpecificationArgsProvideDefaults) : undefined),
                output: (val.output ? pulumi.output(val.output).apply(v20170101.serviceInputOutputSpecificationArgsProvideDefaults) : undefined),
            };
        }

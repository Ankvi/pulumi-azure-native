...
export class SapVirtualInstance extends pulumi.CustomResource {
     ...
     */
    declare public readonly configuration: pulumi.Output<types.outputs.DeploymentConfigurationResponse | types.outputs.DeploymentWithOSConfigurationResponse | types.outputs.DiscoveryConfigurationResponse>;
    /**
     ...
     */
    declare public readonly identity: pulumi.Output<types.outputs.SAPVirtualInstanceIdentityResponse | undefined>;
    /**
     ...
     */
    declare public readonly managedResourceGroupConfiguration: pulumi.Output<types.outputs.ManagedRGConfigurationResponse | undefined>;
    /**

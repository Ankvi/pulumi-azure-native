...
export class SAPCentralInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:workloads/v20231001preview:SAPCentralInstance';
    ...
    constructor(name: string, args: SAPCentralInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:workloads:SAPCentralInstance" }, { type: "azure-native:workloads/v20211201preview:SAPCentralInstance" }, { type: "azure-native:workloads/v20221101preview:SAPCentralInstance" }, { type: "azure-native:workloads/v20230401:SAPCentralInstance" }] };

...
export class SapDiscoverySite extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:workloads/v20231001preview:SapDiscoverySite';
    ...
    constructor(name: string, args: SapDiscoverySiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:workloads:SapDiscoverySite" }] };

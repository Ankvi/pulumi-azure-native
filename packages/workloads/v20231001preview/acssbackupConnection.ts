...
export class ACSSBackupConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:workloads/v20231001preview:ACSSBackupConnection';
    ...
    constructor(name: string, args: ACSSBackupConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:workloads:ACSSBackupConnection" }] };

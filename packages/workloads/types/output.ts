...
export namespace workloads {
    ...
    export namespace v20211201preview {
        ...
        export interface ErrorDefinitionResponse {
             ...
             * Internal error details.
             */
            details: v20211201preview.ErrorDefinitionResponse[];
            /**
             * Description of the error.
             */
            message: string;
        ...
        export interface NodeProfileResponse {
             ...
             */
            dataDisks?: v20211201preview.DiskInfoResponse[];
            /**
             * VM or VMSS name
             */
            name?: string;
             ...
             * OS disk details
             */
            osDisk: v20211201preview.DiskInfoResponse;
            /**
             * OS image used for creating the nodes
             */
            osImage: v20211201preview.OsImageProfileResponse;
        }
        ...
        export interface PhpWorkloadResourceResponseIdentity {
             ...
             * User assigned identities dictionary
             */
            userAssignedIdentities?: {[key: string]: v20211201preview.UserAssignedIdentityResponse};
        }
        ...
        export interface SAPVirtualInstanceErrorResponse {
             ...
             * The Virtual Instance for SAP error body.
             */
            properties?: v20211201preview.ErrorDefinitionResponse;
        }
    ...
    export namespace v20221101preview {
        ...
        export interface DiskDetailsResponse {
             ...
             * The disk sku.
             */
            sku?: v20221101preview.DiskSkuResponse;
        }
        ...
        export interface SAPDiskConfigurationResponse {
             ...
             * The recommended disk details for a given VM Sku.
             */
            recommendedConfiguration?: v20221101preview.DiskVolumeConfigurationResponse;
            /**
             * The list of supported disks for a given VM Sku.
             */
            supportedConfigurations?: v20221101preview.DiskDetailsResponse[];
        }
    ...
    export namespace v20230401 {
        ...
        export interface ApplicationServerConfigurationResponse {
             ...
             * Gets or sets the virtual machine configuration.
             */
            virtualMachineConfiguration: v20230401.VirtualMachineConfigurationResponse;
        }
        ...
        export interface ApplicationServerFullResourceNamesResponse {
             ...
             * The list of virtual machine naming details.
             */
            virtualMachines?: v20230401.VirtualMachineResourceNamesResponse[];
        }
        ...
        export interface ApplicationServerVmDetailsResponse {
             ...
             * Storage details of all the Storage Accounts attached to the App Virtual Machine. For e.g. NFS on AFS Shared Storage.
             */
            storageDetails: v20230401.StorageInformationResponse[];
            /**
             * Defines the type of application server VM.
             */
            type: string;
        ...
        export interface CentralServerFullResourceNamesResponse {
             ...
             * The resource names object for load balancer and related resources.
             */
            loadBalancer?: v20230401.LoadBalancerResourceNamesResponse;
            /**
             * The list of names for all ASCS virtual machines to be deployed. The number of entries in this list should be equal to the number VMs to be created for ASCS layer. At maximum, there can be two virtual machines at this layer: ASCS and ERS.
             */
            virtualMachines?: v20230401.VirtualMachineResourceNamesResponse[];
        ...
        export interface DatabaseConfigurationResponse {
             ...
             * Gets or sets the disk configuration.
             */
            diskConfiguration?: v20230401.DiskConfigurationResponse;
            /**
             * The number of database VMs.
             */
            instanceCount: number;
        ...
        export interface DeploymentConfigurationResponse {
             ...
             * The infrastructure configuration.
             */
            infrastructureConfiguration?: v20230401.SingleServerConfigurationResponse | v20230401.ThreeTierConfigurationResponse;
            /**
             * The software configuration.
             */
            softwareConfiguration?: v20230401.ExternalInstallationSoftwareConfigurationResponse | v20230401.SAPInstallWithoutOSConfigSoftwareConfigurationResponse | v20230401.ServiceInitiatedSoftwareConfigurationResponse;
        }
        ...
        export interface DeploymentWithOSConfigurationResponse {
             ...
             * The OS and SAP configuration.
             */
            osSapConfiguration?: v20230401.OsSapConfigurationResponse;
            /**
             * The software configuration.
             */
            softwareConfiguration?: v20230401.ExternalInstallationSoftwareConfigurationResponse | v20230401.SAPInstallWithoutOSConfigSoftwareConfigurationResponse | v20230401.ServiceInitiatedSoftwareConfigurationResponse;
        ...
        export interface DiskConfigurationResponse {
             ...
             * The disk configuration for the db volume. For HANA, Required volumes are: ['hana/data', 'hana/log', hana/shared', 'usr/sap', 'os'], Optional volume : ['backup'].
             */
            diskVolumeConfigurations?: {[key: string]: v20230401.DiskVolumeConfigurationResponse};
        }
        ...
        export interface ErrorDefinitionResponse {
             ...
             * Internal error details.
             */
            details: v20230401.ErrorDefinitionResponse[];
            /**
             * Description of the error.
             */
            message: string;
        ...
        export interface ErrorResponse {
             ...
             * Array of details about specific errors that led to this reported error.
             */
            details: v20230401.ErrorResponse[];
            /**
             * Object containing more specific information than  the current object about the error.
             */
            innerError: v20230401.ErrorResponseInnerError;
            /**
             * Human-readable representation of the error.
             */
            message: string;
        ...
        export interface ErrorResponseInnerError {
             ...
             * Standard error object.
             */
            innerError?: v20230401.ErrorResponse;
        }
        ...
        export interface LinuxConfigurationResponse {
             ...
             * Specifies the ssh key configuration for a Linux OS. (This property is deprecated, please use 'sshKeyPair' instead)
             */
            ssh?: v20230401.SshConfigurationResponse;
            /**
             * The SSH Key-pair used to authenticate with the VM's.
             */
            sshKeyPair?: v20230401.SshKeyPairResponse;
        }
        ...
        export interface OSProfileResponse {
             ...
             * Specifies Windows operating system settings on the virtual machine.
             */
            osConfiguration?: v20230401.LinuxConfigurationResponse | v20230401.WindowsConfigurationResponse;
        }
        ...
        export interface OsSapConfigurationResponse {
             ...
             * The url and storage account ID where deployer VM packages are uploaded
             */
            deployerVmPackages?: v20230401.DeployerVmPackagesResponse;
            /**
             * The FQDN to set for the SAP system
             */
            sapFqdn?: string;
        ...
        export interface SAPDiskConfigurationResponse {
             ...
             * The recommended disk details for a given VM Sku.
             */
            recommendedConfiguration?: v20230401.DiskVolumeConfigurationResponse;
            /**
             * The list of supported disks for a given VM Sku.
             */
            supportedConfigurations?: v20230401.DiskDetailsResponse[];
        }
        ...
        export interface SAPInstallWithoutOSConfigSoftwareConfigurationResponse {
             ...
             * Gets or sets the HA software configuration.
             */
            highAvailabilitySoftwareConfiguration?: v20230401.HighAvailabilitySoftwareConfigurationResponse;
            /**
             * The SAP bits storage account id.
             */
            sapBitsStorageAccountId: string;
        ...
        export interface SAPVirtualInstanceErrorResponse {
             ...
             * The Virtual Instance for SAP error body.
             */
            properties?: v20230401.ErrorDefinitionResponse;
        }
        ...
        export interface SapLandscapeMonitorPropertiesResponseGrouping {
             ...
             * Gets or sets the list of landscape to SID mappings.
             */
            landscape?: v20230401.SapLandscapeMonitorSidMappingResponse[];
            /**
             * Gets or sets the list of Sap Applications to SID mappings.
             */
            sapApplication?: v20230401.SapLandscapeMonitorSidMappingResponse[];
        }
        ...
        export interface SingleServerConfigurationResponse {
             ...
             * The set of custom names to be used for underlying azure resources that are part of the SAP system.
             */
            customResourceNames?: v20230401.SingleServerFullResourceNamesResponse;
            /**
             * The database type.
             */
            databaseType?: string;
             ...
             * Gets or sets the disk configuration.
             */
            dbDiskConfiguration?: v20230401.DiskConfigurationResponse;
            /**
             * The type of SAP deployment, single server or Three tier.
             * Expected value is 'SingleServer'.
             */
             ...
             * Network configuration for the server
             */
            networkConfiguration?: v20230401.NetworkConfigurationResponse;
            /**
             * The subnet id.
             */
            subnetId: string;
        ...
        export function singleServerConfigurationResponseProvideDefaults(val: SingleServerConfigurationResponse): SingleServerConfigurationResponse {
            return {
                ...val,
                networkConfiguration: (val.networkConfiguration ? v20230401.networkConfigurationResponseProvideDefaults(val.networkConfiguration) : undefined),
            };
        }
        ...
        export interface SingleServerFullResourceNamesResponse {
             ...
             * The resource names object for virtual machine and related resources.
             */
            virtualMachine?: v20230401.VirtualMachineResourceNamesResponse;
        }
        ...
        export interface SshConfigurationResponse {
             ...
             * The list of SSH public keys used to authenticate with linux based VMs.
             */
            publicKeys?: v20230401.SshPublicKeyResponse[];
        }
        ...
        export interface StorageConfigurationResponse {
             ...
             * The properties of the transport directory attached to the VIS. The default for transportFileShareConfiguration is the createAndMount flow if storage configuration is missing.
             */
            transportFileShareConfiguration?: v20230401.CreateAndMountFileShareConfigurationResponse | v20230401.MountFileShareConfigurationResponse | v20230401.SkipFileShareConfigurationResponse;
        }
        ...
        export interface ThreeTierConfigurationResponse {
             ...
             * The application server configuration.
             */
            applicationServer: v20230401.ApplicationServerConfigurationResponse;
            /**
             * The central server configuration.
             */
            centralServer: v20230401.CentralServerConfigurationResponse;
            /**
             * The set of custom names to be used for underlying azure resources that are part of the SAP system.
             */
            customResourceNames?: v20230401.ThreeTierFullResourceNamesResponse;
            /**
             * The database configuration.
             */
            databaseServer: v20230401.DatabaseConfigurationResponse;
            /**
             * The type of SAP deployment, single server or Three tier.
             * Expected value is 'ThreeTier'.
             */
             ...
             * The high availability configuration.
             */
            highAvailabilityConfig?: v20230401.HighAvailabilityConfigurationResponse;
            /**
             * Network configuration common to all servers
             */
            networkConfiguration?: v20230401.NetworkConfigurationResponse;
             ...
             * The storage configuration.
             */
            storageConfiguration?: v20230401.StorageConfigurationResponse;
        }
        /**
         * threeTierConfigurationResponseProvideDefaults sets the appropriate defaults for ThreeTierConfigurationResponse
         */
        ...
        export interface ThreeTierFullResourceNamesResponse {
             ...
             * The full resource names object for application layer resources. The number of entries in this list should be equal to the number VMs to be created for application layer.
             */
            applicationServer?: v20230401.ApplicationServerFullResourceNamesResponse;
            /**
             * The full resource names object for central server layer resources.
             */
            centralServer?: v20230401.CentralServerFullResourceNamesResponse;
            /**
             * The full resource names object for database layer resources. The number of entries in this list should be equal to the number VMs to be created for database layer.
             */
            databaseServer?: v20230401.DatabaseServerFullResourceNamesResponse;
            /**
             * The pattern type to be used for resource naming.
             * Expected value is 'FullResourceName'.
             */
             ...
             * The resource names object for shared storage.
             */
            sharedStorage?: v20230401.SharedStorageResourceNamesResponse;
        }
        ...
        export interface UserAssignedServiceIdentityResponse {
             ...
             * User assigned identities dictionary
             */
            userAssignedIdentities?: {[key: string]: v20230401.UserAssignedIdentityResponse};
        }
        ...
        export interface VirtualMachineConfigurationResponse {
             ...
             * The image reference.
             */
            imageReference: v20230401.ImageReferenceResponse;
            /**
             * The OS profile.
             */
            osProfile: v20230401.OSProfileResponse;
            /**
             * The virtual machine size.
             */
            vmSize: string;
        ...
        export interface VirtualMachineResourceNamesResponse {
             ...
             * The list of network interface name objects for the selected virtual machine. Currently, only one network interface is supported per virtual machine.
             */
            networkInterfaces?: v20230401.NetworkInterfaceResourceNamesResponse[];
            /**
             * The full name for OS disk attached to the VM. If this value is not provided, it will be named by ARM as per its default naming standards (prefixed with vm name). There is only one OS disk attached per Virtual Machine.
             */
            osDiskName?: string;

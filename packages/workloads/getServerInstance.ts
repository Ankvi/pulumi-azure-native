...
export interface GetServerInstanceResult {
     ...
     */
    readonly configurationData: types.outputs.ConfigurationDataResponse;
    /**
     ...
     * Configuration data for this server instance.
     */
    readonly performanceData: types.outputs.ExcelPerformanceDataResponse | types.outputs.NativePerformanceDataResponse;
    /**

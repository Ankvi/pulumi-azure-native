...
export class SapCentralServerInstance extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SapCentralServerInstance {
        return new SapCentralServerInstance(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:workloads:SapCentralServerInstance';

    /**
     * Returns true if the given object is an instance of SapCentralServerInstance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SapCentralServerInstance {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SapCentralServerInstance.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: SapCentralServerInstanceArgs, opts?: pulumi.CustomResourceOptions) {
 ...
 */
export interface SapCentralServerInstanceArgs {
    /**

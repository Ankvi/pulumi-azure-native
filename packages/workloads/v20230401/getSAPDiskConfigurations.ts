...
export function getSAPDiskConfigurations(args: GetSAPDiskConfigurationsArgs, opts?: pulumi.InvokeOptions): Promise<GetSAPDiskConfigurationsResult> {
    ...
    return pulumi.runtime.invoke("azure-native:workloads/v20230401:getSAPDiskConfigurations", {
...
export interface GetSAPDiskConfigurationsResult {
     ...
     */
    readonly volumeConfigurations?: {[key: string]: types.outputs.workloads.v20230401.SAPDiskConfigurationResponse};
}
/**
 * Get the SAP Disk Configuration Layout prod/non-prod SAP System.
 */

...
export class SAPDatabaseInstance extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SAPDatabaseInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:workloads:SAPDatabaseInstance" }, { type: "azure-native:workloads/v20211201preview:SAPDatabaseInstance" }, { type: "azure-native:workloads/v20221101preview:SAPDatabaseInstance" }] };

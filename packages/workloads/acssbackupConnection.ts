...
export class ACSSBackupConnection extends pulumi.CustomResource {
     ...
     */
    declare public readonly backupData: pulumi.Output<types.outputs.HanaBackupDataResponse | types.outputs.SqlBackupDataResponse | types.outputs.VMBackupDataResponse | undefined>;
    /**

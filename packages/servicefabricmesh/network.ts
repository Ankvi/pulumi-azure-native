...
export class Network extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.NetworkResourcePropertiesResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: NetworkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["networkResourceName"] = args?.networkResourceName;

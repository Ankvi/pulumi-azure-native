...
export namespace servicefabricmesh {
    /**
    ...
    export namespace v20180901preview {
        ...
        export interface ApplicationScopedVolumeArgs {
             ...
             * Describes parameters for creating application-scoped volumes.
             */
            creationParameters: pulumi.Input<v20180901preview.ApplicationScopedVolumeCreationParametersServiceFabricVolumeDiskArgs>;
            /**
             * The path within the container at which the volume should be mounted. Only valid path characters are allowed.
             */
            destinationPath: pulumi.Input<string>;
        ...
        export interface ApplicationScopedVolumeCreationParametersServiceFabricVolumeDiskArgs {
             ...
             * Volume size
             */
            sizeDisk: pulumi.Input<string | enums.v20180901preview.SizeTypes>;
        }
        ...
        export interface AutoScalingPolicyArgs {
             ...
             * The mechanism that is used to scale when auto scaling operation is invoked.
             */
            mechanism: pulumi.Input<v20180901preview.AddRemoveReplicaScalingMechanismArgs>;
            /**
             * The name of the auto scaling policy.
             */
            name: pulumi.Input<string>;
             ...
             * Determines when auto scaling operation will be invoked.
             */
            trigger: pulumi.Input<v20180901preview.AverageLoadScalingTriggerArgs>;
        }
        ...
        export interface AutoScalingResourceMetricArgs {
             ...
             * Name of the resource.
             */
            name: pulumi.Input<string | enums.v20180901preview.AutoScalingResourceMetricName>;
        }
        ...
        export interface AverageLoadScalingTriggerArgs {
             ...
             * Description of the metric that is used for scaling.
             */
            metric: pulumi.Input<v20180901preview.AutoScalingResourceMetricArgs>;
            /**
             * Scale interval that indicates how often will this trigger be checked.
             */
            scaleIntervalInSeconds: pulumi.Input<number>;
        ...
        export interface ContainerCodePackagePropertiesArgs {
             ...
             * Reference to sinks in DiagnosticsDescription.
             */
            diagnostics?: pulumi.Input<v20180901preview.DiagnosticsRefArgs>;
            /**
             * The endpoints exposed by this container.
             */
            endpoints?: pulumi.Input<pulumi.Input<v20180901preview.EndpointPropertiesArgs>[]>;
            /**
             * Override for the default entry point in the container.
             */
            entrypoint?: pulumi.Input<string>;
             ...
             * The environment variables to set in this container
             */
            environmentVariables?: pulumi.Input<pulumi.Input<v20180901preview.EnvironmentVariableArgs>[]>;
            /**
             * The Container image to use.
             */
            image: pulumi.Input<string>;
             ...
             * Image registry credential.
             */
            imageRegistryCredential?: pulumi.Input<v20180901preview.ImageRegistryCredentialArgs>;
            /**
             * The labels to set in this container.
             */
            labels?: pulumi.Input<pulumi.Input<v20180901preview.ContainerLabelArgs>[]>;
            /**
             * The name of the code package.
             */
            name: pulumi.Input<string>;
             ...
             * A list of ReliableCollection resources used by this particular code package. Please refer to ReliableCollectionsRef for more details.
             */
            reliableCollectionsRefs?: pulumi.Input<pulumi.Input<v20180901preview.ReliableCollectionsRefArgs>[]>;
            /**
             * The resources required by this container.
             */
            resources: pulumi.Input<v20180901preview.ResourceRequirementsArgs>;
            /**
             * The settings to set in this container. The setting file path can be fetched from environment variable "Fabric_SettingPath". The path for Windows container is "C:\\secrets". The path for Linux container is "/var/secrets".
             */
            settings?: pulumi.Input<pulumi.Input<v20180901preview.SettingArgs>[]>;
            /**
             * Volumes to be attached to the container. The lifetime of these volumes is independent of the application's lifetime.
             */
            volumeRefs?: pulumi.Input<pulumi.Input<v20180901preview.VolumeReferenceArgs>[]>;
            /**
             * Volumes to be attached to the container. The lifetime of these volumes is scoped to the application's lifetime.
             */
            volumes?: pulumi.Input<pulumi.Input<v20180901preview.ApplicationScopedVolumeArgs>[]>;
        }
        ...
        export interface DiagnosticsDescriptionArgs {
             ...
             * List of supported sinks that can be referenced.
             */
            sinks?: pulumi.Input<pulumi.Input<v20180901preview.AzureInternalMonitoringPipelineSinkDescriptionArgs>[]>;
        }
        ...
        export interface HttpConfigArgs {
             ...
             * description for routing.
             */
            hosts: pulumi.Input<pulumi.Input<v20180901preview.HttpHostConfigArgs>[]>;
            /**
             * http gateway config name.
             */
            name: pulumi.Input<string>;
        ...
        export interface HttpHostConfigArgs {
             ...
             * Route information to use for routing. Routes are processed in the order they are specified. Specify routes that are more specific before routes that can handle general cases.
             */
            routes: pulumi.Input<pulumi.Input<v20180901preview.HttpRouteConfigArgs>[]>;
        }
        ...
        export interface HttpRouteConfigArgs {
             ...
             * Describes destination endpoint for routing traffic.
             */
            destination: pulumi.Input<v20180901preview.GatewayDestinationArgs>;
            /**
             * Describes a rule for http route matching.
             */
            match: pulumi.Input<v20180901preview.HttpRouteMatchRuleArgs>;
            /**
             * http route name.
             */
            name: pulumi.Input<string>;
        ...
        export interface HttpRouteMatchHeaderArgs {
             ...
             * how to match header value
             */
            type?: pulumi.Input<string | enums.v20180901preview.HeaderMatchType>;
            /**
             * Value of header to match in request.
             */
            value?: pulumi.Input<string>;
        ...
        export interface HttpRouteMatchPathArgs {
             ...
             * how to match value in the Uri
             */
            type: pulumi.Input<string | enums.v20180901preview.PathMatchType>;
            /**
             * Uri path to match for request.
             */
            value: pulumi.Input<string>;
        ...
        export interface HttpRouteMatchRuleArgs {
             ...
             * headers and their values to match in request.
             */
            headers?: pulumi.Input<pulumi.Input<v20180901preview.HttpRouteMatchHeaderArgs>[]>;
            /**
             * Path to match for routing.
             */
            path: pulumi.Input<v20180901preview.HttpRouteMatchPathArgs>;
        }
        ...
        export interface NetworkRefArgs {
             ...
             * A list of endpoints that are exposed on this network.
             */
            endpointRefs?: pulumi.Input<pulumi.Input<v20180901preview.EndpointRefArgs>[]>;
            /**
             * Name of the network
             */
            name?: pulumi.Input<string>;
        ...
        export interface ResourceRequirementsArgs {
             ...
             * Describes the maximum limits on the resources for a given container.
             */
            limits?: pulumi.Input<v20180901preview.ResourceLimitsArgs>;
            /**
             * Describes the requested resources for a given container.
             */
            requests: pulumi.Input<v20180901preview.ResourceRequestsArgs>;
        }
        ...
        export interface ServiceResourceDescriptionArgs {
             ...
             * Auto scaling policies
             */
            autoScalingPolicies?: pulumi.Input<pulumi.Input<v20180901preview.AutoScalingPolicyArgs>[]>;
            /**
             * Describes the set of code packages that forms the service. A code package describes the container and the properties for running it. All the code packages are started together on the same host and share the same context (network, process etc.).
             */
            codePackages: pulumi.Input<pulumi.Input<v20180901preview.ContainerCodePackagePropertiesArgs>[]>;
            /**
             * User readable description of the service.
             */
            description?: pulumi.Input<string>;
             ...
             * The names of the private networks that this service needs to be part of.
             */
            networkRefs?: pulumi.Input<pulumi.Input<v20180901preview.NetworkRefArgs>[]>;
            /**
             * The operation system required by the code in service.
             */
            osType: pulumi.Input<string | enums.v20180901preview.OperatingSystemType>;
            /**
             * The number of replicas of the service to create. Defaults to 1 if not specified.
             */
            replicaCount?: pulumi.Input<number>;

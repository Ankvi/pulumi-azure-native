...
export namespace servicefabricmesh {
    ...
    export namespace v20180901preview {
        ...
        export interface ApplicationScopedVolumeResponse {
             ...
             * Describes parameters for creating application-scoped volumes.
             */
            creationParameters: v20180901preview.ApplicationScopedVolumeCreationParametersServiceFabricVolumeDiskResponse;
            /**
             * The path within the container at which the volume should be mounted. Only valid path characters are allowed.
             */
            destinationPath: string;
        ...
        export interface AutoScalingPolicyResponse {
             ...
             * The mechanism that is used to scale when auto scaling operation is invoked.
             */
            mechanism: v20180901preview.AddRemoveReplicaScalingMechanismResponse;
            /**
             * The name of the auto scaling policy.
             */
            name: string;
             ...
             * Determines when auto scaling operation will be invoked.
             */
            trigger: v20180901preview.AverageLoadScalingTriggerResponse;
        }
        ...
        export interface AverageLoadScalingTriggerResponse {
             ...
             * Description of the metric that is used for scaling.
             */
            metric: v20180901preview.AutoScalingResourceMetricResponse;
            /**
             * Scale interval that indicates how often will this trigger be checked.
             */
            scaleIntervalInSeconds: number;
        ...
        export interface ContainerCodePackagePropertiesResponse {
             ...
             * Reference to sinks in DiagnosticsDescription.
             */
            diagnostics?: v20180901preview.DiagnosticsRefResponse;
            /**
             * The endpoints exposed by this container.
             */
            endpoints?: v20180901preview.EndpointPropertiesResponse[];
            /**
             * Override for the default entry point in the container.
             */
            entrypoint?: string;
             ...
             * The environment variables to set in this container
             */
            environmentVariables?: v20180901preview.EnvironmentVariableResponse[];
            /**
             * The Container image to use.
             */
            image: string;
             ...
             * Image registry credential.
             */
            imageRegistryCredential?: v20180901preview.ImageRegistryCredentialResponse;
            /**
             * Runtime information of a container instance.
             */
            instanceView: v20180901preview.ContainerInstanceViewResponse;
            /**
             * The labels to set in this container.
             */
            labels?: v20180901preview.ContainerLabelResponse[];
            /**
             * The name of the code package.
             */
            name: string;
             ...
             * A list of ReliableCollection resources used by this particular code package. Please refer to ReliableCollectionsRef for more details.
             */
            reliableCollectionsRefs?: v20180901preview.ReliableCollectionsRefResponse[];
            /**
             * The resources required by this container.
             */
            resources: v20180901preview.ResourceRequirementsResponse;
            /**
             * The settings to set in this container. The setting file path can be fetched from environment variable "Fabric_SettingPath". The path for Windows container is "C:\\secrets". The path for Linux container is "/var/secrets".
             */
            settings?: v20180901preview.SettingResponse[];
            /**
             * Volumes to be attached to the container. The lifetime of these volumes is independent of the application's lifetime.
             */
            volumeRefs?: v20180901preview.VolumeReferenceResponse[];
            /**
             * Volumes to be attached to the container. The lifetime of these volumes is scoped to the application's lifetime.
             */
            volumes?: v20180901preview.ApplicationScopedVolumeResponse[];
        }
        ...
        export interface ContainerInstanceViewResponse {
             ...
             * Current container instance state.
             */
            currentState?: v20180901preview.ContainerStateResponse;
            /**
             * The events of this container instance.
             */
            events?: v20180901preview.ContainerEventResponse[];
            /**
             * Previous container instance state.
             */
            previousState?: v20180901preview.ContainerStateResponse;
            /**
             * The number of times the container has been restarted.
             */
            restartCount?: number;
        ...
        export interface DiagnosticsDescriptionResponse {
             ...
             * List of supported sinks that can be referenced.
             */
            sinks?: v20180901preview.AzureInternalMonitoringPipelineSinkDescriptionResponse[];
        }
        ...
        export interface HttpConfigResponse {
             ...
             * description for routing.
             */
            hosts: v20180901preview.HttpHostConfigResponse[];
            /**
             * http gateway config name.
             */
            name: string;
        ...
        export interface HttpHostConfigResponse {
             ...
             * Route information to use for routing. Routes are processed in the order they are specified. Specify routes that are more specific before routes that can handle general cases.
             */
            routes: v20180901preview.HttpRouteConfigResponse[];
        }
        ...
        export interface HttpRouteConfigResponse {
             ...
             * Describes destination endpoint for routing traffic.
             */
            destination: v20180901preview.GatewayDestinationResponse;
            /**
             * Describes a rule for http route matching.
             */
            match: v20180901preview.HttpRouteMatchRuleResponse;
            /**
             * http route name.
             */
            name: string;
        ...
        export interface HttpRouteMatchRuleResponse {
             ...
             * headers and their values to match in request.
             */
            headers?: v20180901preview.HttpRouteMatchHeaderResponse[];
            /**
             * Path to match for routing.
             */
            path: v20180901preview.HttpRouteMatchPathResponse;
        }
        ...
        export interface NetworkRefResponse {
             ...
             * A list of endpoints that are exposed on this network.
             */
            endpointRefs?: v20180901preview.EndpointRefResponse[];
            /**
             * Name of the network
             */
            name?: string;
        ...
        export interface ResourceRequirementsResponse {
             ...
             * Describes the maximum limits on the resources for a given container.
             */
            limits?: v20180901preview.ResourceLimitsResponse;
            /**
             * Describes the requested resources for a given container.
             */
            requests: v20180901preview.ResourceRequestsResponse;
        }
        ...
        export interface ServiceResourceDescriptionResponse {
             ...
             * Auto scaling policies
             */
            autoScalingPolicies?: v20180901preview.AutoScalingPolicyResponse[];
            /**
             * Describes the set of code packages that forms the service. A code package describes the container and the properties for running it. All the code packages are started together on the same host and share the same context (network, process etc.).
             */
            codePackages: v20180901preview.ContainerCodePackagePropertiesResponse[];
            /**
             * User readable description of the service.
             */
            description?: string;
             ...
             * The names of the private networks that this service needs to be part of.
             */
            networkRefs?: v20180901preview.NetworkRefResponse[];
            /**
             * The operation system required by the code in service.
             */
            osType: string;

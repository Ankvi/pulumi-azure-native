...
export class NrtAlertRule extends pulumi.CustomResource {
     ...
     */
    public readonly alertDetailsOverride!: pulumi.Output<types.outputs.securityinsights.v20211001preview.AlertDetailsOverrideResponse | undefined>;
    /**
     ...
     */
    public readonly entityMappings!: pulumi.Output<types.outputs.securityinsights.v20211001preview.EntityMappingResponse[] | undefined>;
    /**
     ...
     */
    public readonly incidentConfiguration!: pulumi.Output<types.outputs.securityinsights.v20211001preview.IncidentConfigurationResponse | undefined>;
    /**
...
export interface NrtAlertRuleArgs {
     ...
     * The alert details override settings
     */
    alertDetailsOverride?: pulumi.Input<types.inputs.securityinsights.v20211001preview.AlertDetailsOverrideArgs>;
    /**
     * The Name of the alert rule template used to create this rule.
     */
     ...
     * Array of the entity mappings of the alert rule
     */
    entityMappings?: pulumi.Input<pulumi.Input<types.inputs.securityinsights.v20211001preview.EntityMappingArgs>[]>;
    /**
     * The settings of the incidents that created from alerts triggered by this analytics rule
     */
    incidentConfiguration?: pulumi.Input<types.inputs.securityinsights.v20211001preview.IncidentConfigurationArgs>;
    /**
     * The kind of the alert rule
     * Expected value is 'NRT'.
     */
     ...
     * The severity for alerts created by this alert rule.
     */
    severity?: pulumi.Input<string | types.enums.v20211001preview.AlertSeverity>;
    /**
     * The suppression (in ISO 8601 duration format) to wait since last time this alert rule been triggered.
     */
     ...
     * The tactics of the alert rule
     */
    tactics?: pulumi.Input<pulumi.Input<string | types.enums.v20211001preview.AttackTactic>[]>;
    /**
     * The techniques of the alert rule
     */

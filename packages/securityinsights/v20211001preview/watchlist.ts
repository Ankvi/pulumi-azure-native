...
export class Watchlist extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20211001preview:Watchlist';
     ...
     */
    public readonly createdBy!: pulumi.Output<types.outputs.securityinsights.v20211001preview.WatchlistUserInfoResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<types.outputs.securityinsights.v20211001preview.SystemDataResponse>;
    /**
     ...
     */
    public readonly updatedBy!: pulumi.Output<types.outputs.securityinsights.v20211001preview.WatchlistUserInfoResponse | undefined>;
    /**
...
export interface WatchlistArgs {
     ...
     * Describes a user that created the watchlist
     */
    createdBy?: pulumi.Input<types.inputs.securityinsights.v20211001preview.WatchlistUserInfoArgs>;
    /**
     * The default duration of a watchlist (in ISO 8601 duration format)
     */
     ...
     * The source of the watchlist
     */
    source: pulumi.Input<string | types.enums.v20211001preview.Source>;
    /**
     * The tenantId where the watchlist belongs to
     */
     ...
     * Describes a user that updated the watchlist
     */
    updatedBy?: pulumi.Input<types.inputs.securityinsights.v20211001preview.WatchlistUserInfoArgs>;
    /**
     * The status of the Watchlist upload : New, InProgress or Complete. Pls note : When a Watchlist upload status is equal to InProgress, the Watchlist cannot be deleted
     */

...
export class FusionAlertRule extends pulumi.CustomResource {
     ...
     */
    public readonly sourceSettings!: pulumi.Output<types.outputs.FusionSourceSettingsResponse[]>;
    /**

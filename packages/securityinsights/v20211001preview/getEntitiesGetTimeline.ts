...
export function getEntitiesGetTimeline(args: GetEntitiesGetTimelineArgs, opts?: pulumi.InvokeOptions): Promise<GetEntitiesGetTimelineResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20211001preview:getEntitiesGetTimeline", {
...
export interface GetEntitiesGetTimelineArgs {
     ...
     */
    kinds?: (string | types.enums.v20211001preview.EntityTimelineKind)[];
    /**
...
export interface GetEntitiesGetTimelineResult {
     ...
     */
    readonly metaData?: types.outputs.securityinsights.v20211001preview.TimelineResultsMetadataResponse;
    /**
     * The timeline result values.
     */
    readonly value?: (types.outputs.securityinsights.v20211001preview.ActivityTimelineItemResponse | types.outputs.securityinsights.v20211001preview.BookmarkTimelineItemResponse | types.outputs.securityinsights.v20211001preview.SecurityAlertTimelineItemResponse)[];
}
/**
 * Timeline for an entity.
 */
...
export interface GetEntitiesGetTimelineOutputArgs {
     ...
     * Array of timeline Item kinds.
     */
    kinds?: pulumi.Input<pulumi.Input<string | types.enums.v20211001preview.EntityTimelineKind>[]>;
    /**
     * The number of bucket for timeline queries aggregation.
     */

...
export function getFusionAlertRule(args: GetFusionAlertRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetFusionAlertRuleResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20211001preview:getFusionAlertRule", {
...
export interface GetFusionAlertRuleResult {
     ...
     */
    readonly scenarioExclusionPatterns?: types.outputs.securityinsights.v20211001preview.FusionScenarioExclusionPatternResponse[];
    /**
     ...
     */
    readonly sourceSettings: types.outputs.securityinsights.v20211001preview.FusionSourceSettingsResponse[];
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    readonly systemData: types.outputs.securityinsights.v20211001preview.SystemDataResponse;
    /**

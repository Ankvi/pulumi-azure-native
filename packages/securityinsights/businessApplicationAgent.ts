...
export class BusinessApplicationAgent extends pulumi.CustomResource {
    ...
    declare public /*out*/ readonly agentSystems: pulumi.Output<types.outputs.AgentSystemResponse[]>;
    /**
     ...
     * Describes the configuration of a Business Application Agent.
     */
    declare public readonly configuration: pulumi.Output<types.outputs.SapAgentConfigurationResponse>;

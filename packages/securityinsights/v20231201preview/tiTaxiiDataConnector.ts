...
export class TiTaxiiDataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20231201preview:TiTaxiiDataConnector';

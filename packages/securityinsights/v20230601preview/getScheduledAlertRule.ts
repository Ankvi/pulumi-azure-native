...
export function getScheduledAlertRule(args: GetScheduledAlertRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetScheduledAlertRuleResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230601preview:getScheduledAlertRule", {
...
export interface GetScheduledAlertRuleResult {
     ...
     */
    readonly alertDetailsOverride?: types.outputs.securityinsights.v20230601preview.AlertDetailsOverrideResponse;
    /**
     ...
     */
    readonly entityMappings?: types.outputs.securityinsights.v20230601preview.EntityMappingResponse[];
    /**
     ...
     */
    readonly eventGroupingSettings?: types.outputs.securityinsights.v20230601preview.EventGroupingSettingsResponse;
    /**
     ...
     */
    readonly incidentConfiguration?: types.outputs.securityinsights.v20230601preview.IncidentConfigurationResponse;
    /**
     ...
     */
    readonly sentinelEntitiesMappings?: types.outputs.securityinsights.v20230601preview.SentinelEntityMappingResponse[];
    /**

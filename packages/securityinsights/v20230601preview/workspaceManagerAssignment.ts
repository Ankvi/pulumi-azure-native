...
export class WorkspaceManagerAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230601preview:WorkspaceManagerAssignment';
     ...
     */
    public readonly items!: pulumi.Output<types.outputs.securityinsights.v20230601preview.AssignmentItemResponse[]>;
    /**
    ...
    constructor(name: string, args: WorkspaceManagerAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:securityinsights:WorkspaceManagerAssignment" }, { type: "azure-native:securityinsights/v20230401preview:WorkspaceManagerAssignment" }, { type: "azure-native:securityinsights/v20230501preview:WorkspaceManagerAssignment" }, { type: "azure-native:securityinsights/v20230701preview:WorkspaceManagerAssignment" }, { type: "azure-native:securityinsights/v20230801preview:WorkspaceManagerAssignment" }] };
...
export interface WorkspaceManagerAssignmentArgs {
     ...
     * List of resources included in this workspace manager assignment
     */
    items: pulumi.Input<pulumi.Input<types.inputs.securityinsights.v20230601preview.AssignmentItemArgs>[]>;
    /**

...
export class ActivityCustomEntityQuery extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230601preview:ActivityCustomEntityQuery';
     ...
     */
    public readonly queryDefinitions!: pulumi.Output<types.outputs.securityinsights.v20230601preview.ActivityEntityQueriesPropertiesResponseQueryDefinitions | undefined>;
    /**
...
export interface ActivityCustomEntityQueryArgs {
     ...
     * The type of the query's source entity
     */
    inputEntityType?: pulumi.Input<string | types.enums.v20230601preview.EntityType>;
    /**
     ...
     * The Activity query definitions
     */
    queryDefinitions?: pulumi.Input<types.inputs.securityinsights.v20230601preview.ActivityEntityQueriesPropertiesQueryDefinitionsArgs>;
    /**
     * List of the fields of the source entity that are required to run the query
     */

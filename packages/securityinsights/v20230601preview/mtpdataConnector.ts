...
export class MTPDataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230601preview:MTPDataConnector';
     ...
     */
    public readonly dataTypes!: pulumi.Output<types.outputs.securityinsights.v20230601preview.MTPDataConnectorDataTypesResponse>;
    /**
     ...
     */
    public readonly filteredProviders!: pulumi.Output<types.outputs.securityinsights.v20230601preview.MtpFilteredProvidersResponse | undefined>;
    /**
...
export interface MTPDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes: pulumi.Input<types.inputs.securityinsights.v20230601preview.MTPDataConnectorDataTypesArgs>;
    /**
     * The available filtered providers for the connector.
     */
    filteredProviders?: pulumi.Input<types.inputs.securityinsights.v20230601preview.MtpFilteredProvidersArgs>;
    /**
     * The kind of the data connector
     * Expected value is 'MicrosoftThreatProtection'.
     */

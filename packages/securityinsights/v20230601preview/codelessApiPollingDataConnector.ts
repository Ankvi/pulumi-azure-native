...
export class CodelessApiPollingDataConnector extends pulumi.CustomResource {
     ...
     */
    public readonly connectorUiConfig!: pulumi.Output<types.outputs.securityinsights.v20230601preview.CodelessUiConnectorConfigPropertiesResponse | undefined>;
    /**
     ...
     */
    public readonly pollingConfig!: pulumi.Output<types.outputs.securityinsights.v20230601preview.CodelessConnectorPollingConfigPropertiesResponse | undefined>;
    /**
...
export interface CodelessApiPollingDataConnectorArgs {
     ...
     * Config to describe the instructions blade
     */
    connectorUiConfig?: pulumi.Input<types.inputs.securityinsights.v20230601preview.CodelessUiConnectorConfigPropertiesArgs>;
    /**
     * Connector ID
     */
     ...
     * Config to describe the polling instructions
     */
    pollingConfig?: pulumi.Input<types.inputs.securityinsights.v20230601preview.CodelessConnectorPollingConfigPropertiesArgs>;
    /**

...
export function getBookmark(args: GetBookmarkArgs, opts?: pulumi.InvokeOptions): Promise<GetBookmarkResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230601preview:getBookmark", {
...
export interface GetBookmarkResult {
     ...
     */
    readonly createdBy?: types.outputs.securityinsights.v20230601preview.UserInfoResponse;
    /**
     ...
     */
    readonly entityMappings?: types.outputs.securityinsights.v20230601preview.BookmarkEntityMappingsResponse[];
    /**
     ...
     */
    readonly incidentInfo?: types.outputs.securityinsights.v20230601preview.IncidentInfoResponse;
    /**
     ...
     */
    readonly updatedBy?: types.outputs.securityinsights.v20230601preview.UserInfoResponse;
}
/**
 * Gets a bookmark.
 */

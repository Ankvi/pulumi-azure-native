...
export class Incident extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly additionalData!: pulumi.Output<types.outputs.securityinsights.v20230601preview.IncidentAdditionalDataResponse>;
    /**
     ...
     */
    public readonly labels!: pulumi.Output<types.outputs.securityinsights.v20230601preview.IncidentLabelResponse[] | undefined>;
    /**
     ...
     */
    public readonly owner!: pulumi.Output<types.outputs.securityinsights.v20230601preview.IncidentOwnerInfoResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly teamInformation!: pulumi.Output<types.outputs.securityinsights.v20230601preview.TeamInformationResponse | undefined>;
    /**
...
export interface IncidentArgs {
     ...
     * The reason the incident was closed
     */
    classification?: pulumi.Input<string | types.enums.v20230601preview.IncidentClassification>;
    /**
     * Describes the reason the incident was closed
     */
     ...
     * The classification reason the incident was closed with
     */
    classificationReason?: pulumi.Input<string | types.enums.v20230601preview.IncidentClassificationReason>;
    /**
     * The description of the incident
     */
     ...
     * List of labels relevant to this incident
     */
    labels?: pulumi.Input<pulumi.Input<types.inputs.securityinsights.v20230601preview.IncidentLabelArgs>[]>;
    /**
     * The time of the last activity in the incident
     */
     ...
     * Describes a user that the incident is assigned to
     */
    owner?: pulumi.Input<types.inputs.securityinsights.v20230601preview.IncidentOwnerInfoArgs>;
    /**
     ...
     * The severity of the incident
     */
    severity: pulumi.Input<string | types.enums.v20230601preview.IncidentSeverity>;
    /**
     * The status of the incident
     */
    status: pulumi.Input<string | types.enums.v20230601preview.IncidentStatus>;
    /**
     * The title of the incident
     */

...
export class AnomalySecurityMLAnalyticsSettings extends pulumi.CustomResource {
     ...
     */
    public readonly requiredDataConnectors!: pulumi.Output<types.outputs.securityinsights.v20230601preview.SecurityMLAnalyticsSettingsDataSourceResponse[] | undefined>;
    /**
...
export interface AnomalySecurityMLAnalyticsSettingsArgs {
     ...
     * The required data sources for this SecurityMLAnalyticsSettings
     */
    requiredDataConnectors?: pulumi.Input<pulumi.Input<types.inputs.securityinsights.v20230601preview.SecurityMLAnalyticsSettingsDataSourceArgs>[]>;
    /**
     ...
     * The anomaly SecurityMLAnalyticsSettings status
     */
    settingsStatus: pulumi.Input<string | types.enums.v20230601preview.SettingsStatus>;
    /**
     * The tactics of the SecurityMLAnalyticsSettings
     */

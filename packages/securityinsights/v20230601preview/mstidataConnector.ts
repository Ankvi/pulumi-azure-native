...
export class MSTIDataConnector extends pulumi.CustomResource {
     ...
     */
    public readonly dataTypes!: pulumi.Output<types.outputs.securityinsights.v20230601preview.MSTIDataConnectorDataTypesResponse>;
    /**
...
export interface MSTIDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes: pulumi.Input<types.inputs.securityinsights.v20230601preview.MSTIDataConnectorDataTypesArgs>;
    /**
     * The kind of the data connector
     * Expected value is 'MicrosoftThreatIntelligence'.
     */

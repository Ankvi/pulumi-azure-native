...
export class Office365ProjectDataConnector extends pulumi.CustomResource {
     ...
     */
    public readonly dataTypes!: pulumi.Output<types.outputs.securityinsights.v20230601preview.Office365ProjectConnectorDataTypesResponse>;
    /**
...
export interface Office365ProjectDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes: pulumi.Input<types.inputs.securityinsights.v20230601preview.Office365ProjectConnectorDataTypesArgs>;
    /**
     * The kind of the data connector
     * Expected value is 'Office365Project'.
     */

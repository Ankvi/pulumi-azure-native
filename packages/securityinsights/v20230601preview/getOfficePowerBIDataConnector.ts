...
export function getOfficePowerBIDataConnector(args: GetOfficePowerBIDataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetOfficePowerBIDataConnectorResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230601preview:getOfficePowerBIDataConnector", {
...
export interface GetOfficePowerBIDataConnectorResult {
     ...
     */
    readonly dataTypes: types.outputs.securityinsights.v20230601preview.OfficePowerBIConnectorDataTypesResponse;
    /**

...
export class FusionAlertRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230601preview:FusionAlertRule';
     ...
     */
    public readonly scenarioExclusionPatterns!: pulumi.Output<types.outputs.securityinsights.v20230601preview.FusionScenarioExclusionPatternResponse[] | undefined>;
    /**
     ...
     */
    public readonly sourceSettings!: pulumi.Output<types.outputs.securityinsights.v20230601preview.FusionSourceSettingsResponse[] | undefined>;
    /**
...
export interface FusionAlertRuleArgs {
     ...
     * Configuration to exclude scenarios in fusion detection.
     */
    scenarioExclusionPatterns?: pulumi.Input<pulumi.Input<types.inputs.securityinsights.v20230601preview.FusionScenarioExclusionPatternArgs>[]>;
    /**
     * Configuration for all supported source signals in fusion detection.
     */
    sourceSettings?: pulumi.Input<pulumi.Input<types.inputs.securityinsights.v20230601preview.FusionSourceSettingsArgs>[]>;
    /**

...
export class OfficePowerBIDataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230601preview:OfficePowerBIDataConnector';
     ...
     */
    public readonly dataTypes!: pulumi.Output<types.outputs.securityinsights.v20230601preview.OfficePowerBIConnectorDataTypesResponse>;
    /**
...
export interface OfficePowerBIDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes: pulumi.Input<types.inputs.securityinsights.v20230601preview.OfficePowerBIConnectorDataTypesArgs>;
    /**
     * The kind of the data connector
     * Expected value is 'OfficePowerBI'.
     */

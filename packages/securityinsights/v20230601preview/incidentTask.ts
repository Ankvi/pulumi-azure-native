...
export class IncidentTask extends pulumi.CustomResource {
     ...
     */
    public readonly createdBy!: pulumi.Output<types.outputs.securityinsights.v20230601preview.ClientInfoResponse | undefined>;
    /**
     ...
     * Information on the client (user or application) that made some action
     */
    public readonly lastModifiedBy!: pulumi.Output<types.outputs.securityinsights.v20230601preview.ClientInfoResponse | undefined>;
    /**
...
export interface IncidentTaskArgs {
     ...
     * Information on the client (user or application) that made some action
     */
    createdBy?: pulumi.Input<types.inputs.securityinsights.v20230601preview.ClientInfoArgs>;
    /**
     * The description of the task
     */
     ...
     * Information on the client (user or application) that made some action
     */
    lastModifiedBy?: pulumi.Input<types.inputs.securityinsights.v20230601preview.ClientInfoArgs>;
    /**
     * The name of the resource group. The name is case insensitive.
     */
    resourceGroupName: pulumi.Input<string>;
    status: pulumi.Input<string | types.enums.v20230601preview.IncidentTaskStatus>;
    /**
     * The title of the task
     */

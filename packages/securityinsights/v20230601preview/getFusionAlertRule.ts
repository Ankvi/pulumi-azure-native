...
export function getFusionAlertRule(args: GetFusionAlertRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetFusionAlertRuleResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230601preview:getFusionAlertRule", {
...
export interface GetFusionAlertRuleResult {
     ...
     */
    readonly scenarioExclusionPatterns?: types.outputs.securityinsights.v20230601preview.FusionScenarioExclusionPatternResponse[];
    /**
     ...
     */
    readonly sourceSettings?: types.outputs.securityinsights.v20230601preview.FusionSourceSettingsResponse[];
    /**

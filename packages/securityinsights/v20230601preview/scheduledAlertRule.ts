...
export class ScheduledAlertRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230601preview:ScheduledAlertRule';
     ...
     */
    public readonly alertDetailsOverride!: pulumi.Output<types.outputs.securityinsights.v20230601preview.AlertDetailsOverrideResponse | undefined>;
    /**
     ...
     */
    public readonly entityMappings!: pulumi.Output<types.outputs.securityinsights.v20230601preview.EntityMappingResponse[] | undefined>;
    /**
     ...
     */
    public readonly eventGroupingSettings!: pulumi.Output<types.outputs.securityinsights.v20230601preview.EventGroupingSettingsResponse | undefined>;
    /**
     * The settings of the incidents that created from alerts triggered by this analytics rule
     */
    public readonly incidentConfiguration!: pulumi.Output<types.outputs.securityinsights.v20230601preview.IncidentConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly sentinelEntitiesMappings!: pulumi.Output<types.outputs.securityinsights.v20230601preview.SentinelEntityMappingResponse[] | undefined>;
    /**
...
export interface ScheduledAlertRuleArgs {
     ...
     * The alert details override settings
     */
    alertDetailsOverride?: pulumi.Input<types.inputs.securityinsights.v20230601preview.AlertDetailsOverrideArgs>;
    /**
     * The Name of the alert rule template used to create this rule.
     */
     ...
     * Array of the entity mappings of the alert rule
     */
    entityMappings?: pulumi.Input<pulumi.Input<types.inputs.securityinsights.v20230601preview.EntityMappingArgs>[]>;
    /**
     * The event grouping settings.
     */
    eventGroupingSettings?: pulumi.Input<types.inputs.securityinsights.v20230601preview.EventGroupingSettingsArgs>;
    /**
     * The settings of the incidents that created from alerts triggered by this analytics rule
     */
    incidentConfiguration?: pulumi.Input<types.inputs.securityinsights.v20230601preview.IncidentConfigurationArgs>;
    /**
     * The kind of the alert rule
     * Expected value is 'Scheduled'.
     */
     ...
     * Array of the sentinel entity mappings of the alert rule
     */
    sentinelEntitiesMappings?: pulumi.Input<pulumi.Input<types.inputs.securityinsights.v20230601preview.SentinelEntityMappingArgs>[]>;
    /**
     * The severity for alerts created by this alert rule.
     */
    severity: pulumi.Input<string | types.enums.v20230601preview.AlertSeverity>;
    /**
     * The suppression (in ISO 8601 duration format) to wait since last time this alert rule been triggered.
     */
     ...
     * The tactics of the alert rule
     */
    tactics?: pulumi.Input<pulumi.Input<string | types.enums.v20230601preview.AttackTactic>[]>;
    /**
     * The techniques of the alert rule
     */
     ...
     * The operation against the threshold that triggers alert rule.
     */
    triggerOperator: pulumi.Input<types.enums.v20230601preview.TriggerOperator>;
    /**
     * The threshold triggers this alert rule.
     */

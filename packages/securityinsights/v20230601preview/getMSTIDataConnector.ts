...
export function getMSTIDataConnector(args: GetMSTIDataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetMSTIDataConnectorResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230601preview:getMSTIDataConnector", {
...
export interface GetMSTIDataConnectorResult {
     ...
     */
    readonly dataTypes: types.outputs.securityinsights.v20230601preview.MSTIDataConnectorDataTypesResponse;
    /**

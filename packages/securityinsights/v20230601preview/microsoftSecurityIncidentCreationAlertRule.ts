...
export class MicrosoftSecurityIncidentCreationAlertRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230601preview:MicrosoftSecurityIncidentCreationAlertRule';
...
export interface MicrosoftSecurityIncidentCreationAlertRuleArgs {
     ...
     * The alerts' productName on which the cases will be generated
     */
    productFilter: pulumi.Input<string | types.enums.v20230601preview.MicrosoftSecurityProductName>;
    /**
     ...
     * the alerts' severities on which the cases will be generated
     */
    severitiesFilter?: pulumi.Input<pulumi.Input<string | types.enums.v20230601preview.AlertSeverity>[]>;
    /**

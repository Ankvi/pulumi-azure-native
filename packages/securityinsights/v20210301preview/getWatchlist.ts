...
export function getWatchlist(args: GetWatchlistArgs, opts?: pulumi.InvokeOptions): Promise<GetWatchlistResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20210301preview:getWatchlist", {
...
export interface GetWatchlistResult {
     ...
     */
    readonly createdBy?: types.outputs.securityinsights.v20210301preview.WatchlistUserInfoResponse;
    /**
     ...
     */
    readonly updatedBy?: types.outputs.securityinsights.v20210301preview.WatchlistUserInfoResponse;
    /**

...
export class Metadata extends pulumi.CustomResource {
     ...
     */
    public readonly author!: pulumi.Output<types.outputs.securityinsights.v20210301preview.MetadataAuthorResponse | undefined>;
    /**
     * Categories for the solution content item
     */
    public readonly categories!: pulumi.Output<types.outputs.securityinsights.v20210301preview.MetadataCategoriesResponse | undefined>;
    /**
     ...
     */
    public readonly dependencies!: pulumi.Output<types.outputs.securityinsights.v20210301preview.MetadataDependenciesResponse | undefined>;
    /**
     ...
     */
    public readonly source!: pulumi.Output<types.outputs.securityinsights.v20210301preview.MetadataSourceResponse | undefined>;
    /**
     * Support information for the metadata - type, name, contact information
     */
    public readonly support!: pulumi.Output<types.outputs.securityinsights.v20210301preview.MetadataSupportResponse | undefined>;
    /**
...
export interface MetadataArgs {
     ...
     * The creator of the content item.
     */
    author?: pulumi.Input<types.inputs.securityinsights.v20210301preview.MetadataAuthorArgs>;
    /**
     * Categories for the solution content item
     */
    categories?: pulumi.Input<types.inputs.securityinsights.v20210301preview.MetadataCategoriesArgs>;
    /**
     * Static ID for the content.  Used to identify dependencies and content from solutions or community.  Hard-coded/static for out of the box content and solutions. Dynamic for user-created.  This is the resource name
     */
     ...
     * Dependencies for the content item, what other content items it requires to work.  Can describe more complex dependencies using a recursive/nested structure. For a single dependency an id/kind/version can be supplied or operator/criteria for complex formats.
     */
    dependencies?: pulumi.Input<types.inputs.securityinsights.v20210301preview.MetadataDependenciesArgs>;
    /**
     * first publish date solution content item
     */
     ...
     * The kind of content the metadata is for.
     */
    kind: pulumi.Input<string | types.enums.v20210301preview.Kind>;
    /**
     * last publish date for the solution content item
     */
     ...
     * Source of the content.  This is where/how it was created.
     */
    source?: pulumi.Input<types.inputs.securityinsights.v20210301preview.MetadataSourceArgs>;
    /**
     * Support information for the metadata - type, name, contact information
     */
    support?: pulumi.Input<types.inputs.securityinsights.v20210301preview.MetadataSupportArgs>;
    /**
     * Version of the content.  Default and recommended format is numeric (e.g. 1, 1.0, 1.0.0, 1.0.0.0), following ARM template best practices.  Can also be any string, but then we cannot guarantee any version checks
     */

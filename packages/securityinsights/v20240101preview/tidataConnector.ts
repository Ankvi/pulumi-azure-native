...
export class TIDataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20240101preview:TIDataConnector';

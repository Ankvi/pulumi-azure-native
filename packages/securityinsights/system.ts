...
export class System extends pulumi.CustomResource {
     ...
     */
    declare public readonly configuration: pulumi.Output<types.outputs.SapSystemsConfigurationResponse>;
    ...
    constructor(name: string, args: SystemArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (!opts.id) {
            if (args?.agentResourceName === undefined && !opts.urn) {
            ...
            resourceInputs["systemResourceName"] = args?.systemResourceName;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:securityinsights/v20240401preview:System" }, { type: "azure-native:securityinsights/v20241001preview:System" }, { type: "azure-native:securityinsights/v20250101preview:System" }, { type: "azure-native:securityinsights/v20250401preview:System" }, { type: "azure-native:securityinsights/v20250701preview:System" }] };

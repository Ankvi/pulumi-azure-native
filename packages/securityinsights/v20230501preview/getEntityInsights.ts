...
export function getEntityInsights(args: GetEntityInsightsArgs, opts?: pulumi.InvokeOptions): Promise<GetEntityInsightsResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230501preview:getEntityInsights", {
...
export interface GetEntityInsightsResult {
     ...
     */
    readonly metaData?: types.outputs.securityinsights.v20230501preview.GetInsightsResultsMetadataResponse;
    /**
     * The insights result values.
     */
    readonly value?: types.outputs.securityinsights.v20230501preview.EntityInsightItemResponse[];
}
/**
 * Execute Insights for an entity.
 */

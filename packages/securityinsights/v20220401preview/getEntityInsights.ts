...
export interface GetEntityInsightsResult {
     ...
     */
    readonly metaData?: types.outputs.securityinsights.v20220401preview.GetInsightsResultsMetadataResponse;
    /**
     * The insights result values.
     */
    readonly value?: types.outputs.securityinsights.v20220401preview.EntityInsightItemResponse[];
}
/**
 * Execute Insights for an entity.
 */

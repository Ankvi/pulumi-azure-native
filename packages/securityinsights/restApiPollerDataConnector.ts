...
export class RestApiPollerDataConnector extends pulumi.CustomResource {
     ...
     */
    declare public readonly dcrConfig: pulumi.Output<types.outputs.DCRConfigurationResponse | undefined>;
    /**
     ...
     */
    declare public readonly paging: pulumi.Output<types.outputs.RestApiPollerRequestPagingConfigResponse | undefined>;
    /**
     * The request configuration.
     */
    declare public readonly request: pulumi.Output<types.outputs.RestApiPollerRequestConfigResponse>;
    /**
     * The response configuration.
     */
    declare public readonly response: pulumi.Output<types.outputs.CcpResponseConfigResponse | undefined>;
    /**

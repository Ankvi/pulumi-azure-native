...
export function getEntityInsights(args: GetEntityInsightsArgs, opts?: pulumi.InvokeOptions): Promise<GetEntityInsightsResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20220601preview:getEntityInsights", {
...
export interface GetEntityInsightsResult {
     ...
     */
    readonly metaData?: types.outputs.securityinsights.v20220601preview.GetInsightsResultsMetadataResponse;
    /**
     * The insights result values.
     */
    readonly value?: types.outputs.securityinsights.v20220601preview.EntityInsightItemResponse[];
}
/**
 * Execute Insights for an entity.
 */

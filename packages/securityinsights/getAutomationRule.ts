...
export interface GetAutomationRuleResult {
     ...
     */
    readonly actions: (types.outputs.securityinsights.AutomationRuleModifyPropertiesActionResponse | types.outputs.securityinsights.AutomationRuleRunPlaybookActionResponse)[];
    /**
     ...
     */
    readonly triggeringLogic: types.outputs.securityinsights.AutomationRuleTriggeringLogicResponse;
    /**

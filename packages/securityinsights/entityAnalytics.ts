...
export class EntityAnalytics extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights:EntityAnalytics';
     ...
     */
    declare public readonly entityProviders: pulumi.Output<string[] | undefined>;
    /**
     ...
     */
    declare public readonly kind: pulumi.Output<"EntityAnalytics">;
    /**
    ...
    constructor(name: string, args: EntityAnalyticsArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["entityProviders"] = args?.entityProviders;

...
export class ContentTemplate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20231001preview:ContentTemplate';
    ...
    constructor(name: string, args: ContentTemplateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:securityinsights:ContentTemplate" }, { type: "azure-native:securityinsights/v20230401preview:ContentTemplate" }, { type: "azure-native:securityinsights/v20230501preview:ContentTemplate" }, { type: "azure-native:securityinsights/v20230601preview:ContentTemplate" }, { type: "azure-native:securityinsights/v20230701preview:ContentTemplate" }, { type: "azure-native:securityinsights/v20230801preview:ContentTemplate" }, { type: "azure-native:securityinsights/v20230901preview:ContentTemplate" }, { type: "azure-native:securityinsights/v20231101:ContentTemplate" }, { type: "azure-native:securityinsights/v20231201preview:ContentTemplate" }, { type: "azure-native:securityinsights/v20240101preview:ContentTemplate" }, { type: "azure-native:securityinsights/v20240301:ContentTemplate" }] };

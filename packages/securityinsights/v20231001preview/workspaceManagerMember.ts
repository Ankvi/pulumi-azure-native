...
export class WorkspaceManagerMember extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20231001preview:WorkspaceManagerMember';
    ...
    constructor(name: string, args: WorkspaceManagerMemberArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:securityinsights:WorkspaceManagerMember" }, { type: "azure-native:securityinsights/v20230401preview:WorkspaceManagerMember" }, { type: "azure-native:securityinsights/v20230501preview:WorkspaceManagerMember" }, { type: "azure-native:securityinsights/v20230601preview:WorkspaceManagerMember" }, { type: "azure-native:securityinsights/v20230701preview:WorkspaceManagerMember" }, { type: "azure-native:securityinsights/v20230801preview:WorkspaceManagerMember" }, { type: "azure-native:securityinsights/v20230901preview:WorkspaceManagerMember" }, { type: "azure-native:securityinsights/v20231201preview:WorkspaceManagerMember" }, { type: "azure-native:securityinsights/v20240101preview:WorkspaceManagerMember" }] };

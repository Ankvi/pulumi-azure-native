...
export class MCASDataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230201:MCASDataConnector';
     ...
     */
    public readonly dataTypes!: pulumi.Output<types.outputs.securityinsights.v20230201.MCASDataConnectorDataTypesResponse | undefined>;
    /**
...
export interface MCASDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes?: pulumi.Input<types.inputs.securityinsights.v20230201.MCASDataConnectorDataTypesArgs>;
    /**
     * The kind of the data connector
     * Expected value is 'MicrosoftCloudAppSecurity'.
     */

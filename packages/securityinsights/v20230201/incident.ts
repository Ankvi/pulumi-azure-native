...
export class Incident extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230201:Incident';
     ...
     */
    public /*out*/ readonly additionalData!: pulumi.Output<types.outputs.securityinsights.v20230201.IncidentAdditionalDataResponse>;
    /**
     ...
     */
    public readonly labels!: pulumi.Output<types.outputs.securityinsights.v20230201.IncidentLabelResponse[] | undefined>;
    /**
     ...
     */
    public readonly owner!: pulumi.Output<types.outputs.securityinsights.v20230201.IncidentOwnerInfoResponse | undefined>;
    /**
...
export interface IncidentArgs {
     ...
     * The reason the incident was closed
     */
    classification?: pulumi.Input<string | types.enums.v20230201.IncidentClassification>;
    /**
     * Describes the reason the incident was closed
     */
     ...
     * The classification reason the incident was closed with
     */
    classificationReason?: pulumi.Input<string | types.enums.v20230201.IncidentClassificationReason>;
    /**
     * The description of the incident
     */
     ...
     * List of labels relevant to this incident
     */
    labels?: pulumi.Input<pulumi.Input<types.inputs.securityinsights.v20230201.IncidentLabelArgs>[]>;
    /**
     * The time of the last activity in the incident
     */
     ...
     * Describes a user that the incident is assigned to
     */
    owner?: pulumi.Input<types.inputs.securityinsights.v20230201.IncidentOwnerInfoArgs>;
    /**
     ...
     * The severity of the incident
     */
    severity: pulumi.Input<string | types.enums.v20230201.IncidentSeverity>;
    /**
     * The status of the incident
     */
    status: pulumi.Input<string | types.enums.v20230201.IncidentStatus>;
    /**
     * The title of the incident
     */

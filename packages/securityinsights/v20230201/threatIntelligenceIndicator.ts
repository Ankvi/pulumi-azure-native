...
export class ThreatIntelligenceIndicator extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230201:ThreatIntelligenceIndicator';
...
export interface ThreatIntelligenceIndicatorArgs {
     ...
     * External References
     */
    externalReferences?: pulumi.Input<pulumi.Input<types.inputs.securityinsights.v20230201.ThreatIntelligenceExternalReferenceArgs>[]>;
    /**
     * Granular Markings
     */
    granularMarkings?: pulumi.Input<pulumi.Input<types.inputs.securityinsights.v20230201.ThreatIntelligenceGranularMarkingModelArgs>[]>;
    /**
     ...
     * Kill chain phases
     */
    killChainPhases?: pulumi.Input<pulumi.Input<types.inputs.securityinsights.v20230201.ThreatIntelligenceKillChainPhaseArgs>[]>;
    /**
     ...
     * Parsed patterns
     */
    parsedPattern?: pulumi.Input<pulumi.Input<types.inputs.securityinsights.v20230201.ThreatIntelligenceParsedPatternArgs>[]>;
    /**

...
export class AutomationRule extends pulumi.CustomResource {
     ...
     */
    public readonly actions!: pulumi.Output<(types.outputs.securityinsights.v20230201.AutomationRuleModifyPropertiesActionResponse | types.outputs.securityinsights.v20230201.AutomationRuleRunPlaybookActionResponse)[]>;
    /**
     * Information on the client (user or application) that made some action
     */
    public /*out*/ readonly createdBy!: pulumi.Output<types.outputs.securityinsights.v20230201.ClientInfoResponse>;
    /**
     ...
     * Information on the client (user or application) that made some action
     */
    public /*out*/ readonly lastModifiedBy!: pulumi.Output<types.outputs.securityinsights.v20230201.ClientInfoResponse>;
    /**
     ...
     */
    public readonly triggeringLogic!: pulumi.Output<types.outputs.securityinsights.v20230201.AutomationRuleTriggeringLogicResponse>;
    /**
...
export interface AutomationRuleArgs {
     ...
     * The actions to execute when the automation rule is triggered.
     */
    actions: pulumi.Input<pulumi.Input<types.inputs.securityinsights.v20230201.AutomationRuleModifyPropertiesActionArgs | types.inputs.securityinsights.v20230201.AutomationRuleRunPlaybookActionArgs>[]>;
    /**
     * Automation rule ID
     */
     ...
     * Describes automation rule triggering logic.
     */
    triggeringLogic: pulumi.Input<types.inputs.securityinsights.v20230201.AutomationRuleTriggeringLogicArgs>;
    /**

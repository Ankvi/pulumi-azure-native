...
export function getWatchlistItem(args: GetWatchlistItemArgs, opts?: pulumi.InvokeOptions): Promise<GetWatchlistItemResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230201:getWatchlistItem", {
...
export interface GetWatchlistItemResult {
     ...
     */
    readonly createdBy?: types.outputs.securityinsights.v20230201.WatchlistUserInfoResponse;
    /**
     ...
     */
    readonly updatedBy?: types.outputs.securityinsights.v20230201.WatchlistUserInfoResponse;
    /**

...
export function getMDATPDataConnector(args: GetMDATPDataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetMDATPDataConnectorResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230201:getMDATPDataConnector", {
...
export interface GetMDATPDataConnectorResult {
     ...
     */
    readonly dataTypes?: types.outputs.securityinsights.v20230201.AlertsDataTypeOfDataConnectorResponse;
    /**

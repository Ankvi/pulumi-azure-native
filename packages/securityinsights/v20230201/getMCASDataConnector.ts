...
export function getMCASDataConnector(args: GetMCASDataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetMCASDataConnectorResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230201:getMCASDataConnector", {
...
export interface GetMCASDataConnectorResult {
     ...
     */
    readonly dataTypes?: types.outputs.securityinsights.v20230201.MCASDataConnectorDataTypesResponse;
    /**

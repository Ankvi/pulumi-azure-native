...
export function getTIDataConnector(args: GetTIDataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetTIDataConnectorResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230201:getTIDataConnector", {
...
export interface GetTIDataConnectorResult {
     ...
     */
    readonly dataTypes?: types.outputs.securityinsights.v20230201.TIDataConnectorDataTypesResponse;
    /**

...
export class Watchlist extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230201:Watchlist';
     ...
     */
    public readonly createdBy!: pulumi.Output<types.outputs.securityinsights.v20230201.WatchlistUserInfoResponse | undefined>;
    /**
     ...
     */
    public readonly updatedBy!: pulumi.Output<types.outputs.securityinsights.v20230201.WatchlistUserInfoResponse | undefined>;
    /**
...
export interface WatchlistArgs {
     ...
     * Describes a user that created the watchlist
     */
    createdBy?: pulumi.Input<types.inputs.securityinsights.v20230201.WatchlistUserInfoArgs>;
    /**
     * The default duration of a watchlist (in ISO 8601 duration format)
     */
     ...
     * The source of the watchlist
     */
    source: pulumi.Input<string | types.enums.v20230201.Source>;
    /**
     * The tenantId where the watchlist belongs to
     */
     ...
     * Describes a user that updated the watchlist
     */
    updatedBy?: pulumi.Input<types.inputs.securityinsights.v20230201.WatchlistUserInfoArgs>;
    /**
     * The status of the Watchlist upload : New, InProgress or Complete. **Note** : When a Watchlist upload status is InProgress, the Watchlist cannot be deleted
     */

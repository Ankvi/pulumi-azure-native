...
export class TIDataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230201:TIDataConnector';
     ...
     */
    public readonly dataTypes!: pulumi.Output<types.outputs.securityinsights.v20230201.TIDataConnectorDataTypesResponse | undefined>;
    /**
...
export interface TIDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes?: pulumi.Input<types.inputs.securityinsights.v20230201.TIDataConnectorDataTypesArgs>;
    /**
     * The kind of the data connector
     * Expected value is 'ThreatIntelligence'.
     */

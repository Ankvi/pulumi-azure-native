...
export class MDATPDataConnector extends pulumi.CustomResource {
     ...
     */
    declare public readonly kind: pulumi.Output<"MicrosoftDefenderAdvancedThreatProtection">;
    /**

...
export class CustomizableConnectorDefinition extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights:CustomizableConnectorDefinition';
     ...
     */
    public readonly connectionsConfig!: pulumi.Output<types.outputs.securityinsights.CustomizableConnectionsConfigResponse | undefined>;
    /**
     * The UiConfig for 'Customizable' connector definition kind.
     */
    public readonly connectorUiConfig!: pulumi.Output<types.outputs.securityinsights.CustomizableConnectorUiConfigResponse>;
    /**
    ...
    constructor(name: string, args: CustomizableConnectorDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:securityinsights/v20230701preview:CustomizableConnectorDefinition" }, { type: "azure-native:securityinsights/v20230801preview:CustomizableConnectorDefinition" }] };
...
export interface CustomizableConnectorDefinitionArgs {
     ...
     * The UiConfig for 'Customizable' connector definition kind.
     */
    connectionsConfig?: pulumi.Input<types.inputs.securityinsights.CustomizableConnectionsConfigArgs>;
    /**
     * The UiConfig for 'Customizable' connector definition kind.
     */
    connectorUiConfig: pulumi.Input<types.inputs.securityinsights.CustomizableConnectorUiConfigArgs>;
    /**
     * Gets or sets the connector definition created date in UTC format.
     */

...
export interface GetEntitiesGetTimelineArgs {
     ...
     */
    kinds?: (string | types.enums.v20210901preview.EntityTimelineKind)[];
    /**
...
export interface GetEntitiesGetTimelineResult {
     ...
     */
    readonly metaData?: types.outputs.securityinsights.v20210901preview.TimelineResultsMetadataResponse;
    /**
     * The timeline result values.
     */
    readonly value?: (types.outputs.securityinsights.v20210901preview.ActivityTimelineItemResponse | types.outputs.securityinsights.v20210901preview.BookmarkTimelineItemResponse | types.outputs.securityinsights.v20210901preview.SecurityAlertTimelineItemResponse)[];
}
/**
 * Timeline for an entity.
 */
...
export interface GetEntitiesGetTimelineOutputArgs {
     ...
     * Array of timeline Item kinds.
     */
    kinds?: pulumi.Input<pulumi.Input<string | types.enums.v20210901preview.EntityTimelineKind>[]>;
    /**
     * The number of bucket for timeline queries aggregation.
     */

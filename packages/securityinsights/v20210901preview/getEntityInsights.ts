...
export interface GetEntityInsightsResult {
     ...
     */
    readonly metaData?: types.outputs.securityinsights.v20210901preview.GetInsightsResultsMetadataResponse;
    /**
     * The insights result values.
     */
    readonly value?: types.outputs.securityinsights.v20210901preview.EntityInsightItemResponse[];
}
/**
 * Execute Insights for an entity.
 */

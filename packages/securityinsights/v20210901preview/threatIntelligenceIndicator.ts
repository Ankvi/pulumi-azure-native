...
export interface ThreatIntelligenceIndicatorArgs {
     ...
     * The kind of the entity.
     */
    kind: pulumi.Input<string | types.enums.ThreatIntelligenceResourceKindEnum>;
    /**

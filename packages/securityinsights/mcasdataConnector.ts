...
export class MCASDataConnector extends pulumi.CustomResource {
     ...
     */
    declare public readonly dataTypes: pulumi.Output<types.outputs.MCASDataConnectorDataTypesResponse | undefined>;
    /**
     ...
     */
    declare public readonly kind: pulumi.Output<"MicrosoftCloudAppSecurity">;
    /**

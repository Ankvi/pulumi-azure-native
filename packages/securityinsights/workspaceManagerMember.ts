...
export class WorkspaceManagerMember extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights:WorkspaceManagerMember';
     ...
     */
    declare public readonly targetWorkspaceResourceId: pulumi.Output<string>;
    /**
     * Tenant id of the target Sentinel workspace joining the given Sentinel workspace manager
     */
    declare public readonly targetWorkspaceTenantId: pulumi.Output<string>;
    /**

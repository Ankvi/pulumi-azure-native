...
export class MSTIDataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights:MSTIDataConnector';
     ...
     */
    declare public readonly dataTypes: pulumi.Output<types.outputs.MSTIDataConnectorDataTypesResponse>;
    /**
     ...
     */
    declare public readonly kind: pulumi.Output<"MicrosoftThreatIntelligence">;
    /**
...
export interface MSTIDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes: pulumi.Input<types.inputs.MSTIDataConnectorDataTypesArgs>;
    /**
     * The kind of the data connector
     * Expected value is 'MicrosoftThreatIntelligence'.
     */

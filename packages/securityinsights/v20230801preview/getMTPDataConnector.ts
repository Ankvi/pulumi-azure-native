...
export function getMTPDataConnector(args: GetMTPDataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetMTPDataConnectorResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230801preview:getMTPDataConnector", {
...
export interface GetMTPDataConnectorResult {
     ...
     */
    readonly dataTypes: types.outputs.securityinsights.v20230801preview.MTPDataConnectorDataTypesResponse;
    /**
     ...
     */
    readonly filteredProviders?: types.outputs.securityinsights.v20230801preview.MtpFilteredProvidersResponse;
    /**

...
export function getWatchlistItem(args: GetWatchlistItemArgs, opts?: pulumi.InvokeOptions): Promise<GetWatchlistItemResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230801preview:getWatchlistItem", {
...
export interface GetWatchlistItemResult {
     ...
     */
    readonly createdBy?: types.outputs.securityinsights.v20230801preview.WatchlistUserInfoResponse;
    /**
     ...
     */
    readonly updatedBy?: types.outputs.securityinsights.v20230801preview.WatchlistUserInfoResponse;
    /**

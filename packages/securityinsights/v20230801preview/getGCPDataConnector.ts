...
export function getGCPDataConnector(args: GetGCPDataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetGCPDataConnectorResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230801preview:getGCPDataConnector", {
...
export interface GetGCPDataConnectorResult {
     ...
     */
    readonly auth: types.outputs.securityinsights.v20230801preview.GCPAuthPropertiesResponse;
    /**
     ...
     */
    readonly dcrConfig?: types.outputs.securityinsights.v20230801preview.DCRConfigurationResponse;
    /**
     ...
     */
    readonly request: types.outputs.securityinsights.v20230801preview.GCPRequestPropertiesResponse;
    /**

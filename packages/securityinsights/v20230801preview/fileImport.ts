...
export class FileImport extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230801preview:FileImport';
     ...
     */
    public /*out*/ readonly errorFile!: pulumi.Output<types.outputs.securityinsights.v20230801preview.FileMetadataResponse>;
    /**
     * An ordered list of some of the errors that were encountered during validation.
     */
    public /*out*/ readonly errorsPreview!: pulumi.Output<types.outputs.securityinsights.v20230801preview.ValidationErrorResponse[]>;
    /**
     ...
     */
    public readonly importFile!: pulumi.Output<types.outputs.securityinsights.v20230801preview.FileMetadataResponse>;
    /**
    ...
    constructor(name: string, args: FileImportArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:securityinsights:FileImport" }, { type: "azure-native:securityinsights/v20220801preview:FileImport" }, { type: "azure-native:securityinsights/v20220901preview:FileImport" }, { type: "azure-native:securityinsights/v20221001preview:FileImport" }, { type: "azure-native:securityinsights/v20221101preview:FileImport" }, { type: "azure-native:securityinsights/v20221201preview:FileImport" }, { type: "azure-native:securityinsights/v20230201preview:FileImport" }, { type: "azure-native:securityinsights/v20230301preview:FileImport" }, { type: "azure-native:securityinsights/v20230401preview:FileImport" }, { type: "azure-native:securityinsights/v20230501preview:FileImport" }, { type: "azure-native:securityinsights/v20230601preview:FileImport" }, { type: "azure-native:securityinsights/v20230701preview:FileImport" }] };
...
export interface FileImportArgs {
     ...
     * The content type of this file.
     */
    contentType: pulumi.Input<string | types.enums.v20230801preview.FileImportContentType>;
    /**
     * File import ID
     */
     ...
     * Represents the imported file.
     */
    importFile: pulumi.Input<types.inputs.securityinsights.v20230801preview.FileMetadataArgs>;
    /**
     * Describes how to ingest the records in the file.
     */
    ingestionMode: pulumi.Input<string | types.enums.v20230801preview.IngestionMode>;
    /**

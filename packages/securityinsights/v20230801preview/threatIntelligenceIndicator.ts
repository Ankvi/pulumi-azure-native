...
export class ThreatIntelligenceIndicator extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230801preview:ThreatIntelligenceIndicator';
...
export interface ThreatIntelligenceIndicatorArgs {
     ...
     * External References
     */
    externalReferences?: pulumi.Input<pulumi.Input<types.inputs.securityinsights.v20230801preview.ThreatIntelligenceExternalReferenceArgs>[]>;
    /**
     * Granular Markings
     */
    granularMarkings?: pulumi.Input<pulumi.Input<types.inputs.securityinsights.v20230801preview.ThreatIntelligenceGranularMarkingModelArgs>[]>;
    /**
     ...
     * Kill chain phases
     */
    killChainPhases?: pulumi.Input<pulumi.Input<types.inputs.securityinsights.v20230801preview.ThreatIntelligenceKillChainPhaseArgs>[]>;
    /**
     ...
     * Parsed patterns
     */
    parsedPattern?: pulumi.Input<pulumi.Input<types.inputs.securityinsights.v20230801preview.ThreatIntelligenceParsedPatternArgs>[]>;
    /**

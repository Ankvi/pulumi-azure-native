...
export class OfficeDataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230801preview:OfficeDataConnector';
     ...
     */
    public readonly dataTypes!: pulumi.Output<types.outputs.OfficeDataConnectorDataTypesResponse>;
    /**

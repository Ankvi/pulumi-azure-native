...
export class CodelessUiDataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230801preview:CodelessUiDataConnector';
     ...
     */
    public readonly connectorUiConfig!: pulumi.Output<types.outputs.securityinsights.v20230801preview.CodelessUiConnectorConfigPropertiesResponse | undefined>;
    /**
...
export interface CodelessUiDataConnectorArgs {
     ...
     * Config to describe the instructions blade
     */
    connectorUiConfig?: pulumi.Input<types.inputs.securityinsights.v20230801preview.CodelessUiConnectorConfigPropertiesArgs>;
    /**
     * Connector ID
     */

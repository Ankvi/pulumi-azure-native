...
export class CodelessApiPollingDataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230801preview:CodelessApiPollingDataConnector';
     ...
     */
    public readonly pollingConfig!: pulumi.Output<types.outputs.securityinsights.v20230801preview.CodelessConnectorPollingConfigPropertiesResponse | undefined>;
    /**
...
export interface CodelessApiPollingDataConnectorArgs {
     ...
     * Config to describe the polling instructions
     */
    pollingConfig?: pulumi.Input<types.inputs.securityinsights.v20230801preview.CodelessConnectorPollingConfigPropertiesArgs>;
    /**

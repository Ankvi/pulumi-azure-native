...
export class WorkspaceManagerConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230801preview:WorkspaceManagerConfiguration';
...
export interface WorkspaceManagerConfigurationArgs {
     ...
     * The current mode of the workspace manager configuration
     */
    mode: pulumi.Input<string | types.enums.v20230801preview.Mode>;
    /**

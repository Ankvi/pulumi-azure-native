...
export function getIncident(args: GetIncidentArgs, opts?: pulumi.InvokeOptions): Promise<GetIncidentResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230801preview:getIncident", {
...
export interface GetIncidentResult {
     ...
     */
    readonly additionalData: types.outputs.securityinsights.v20230801preview.IncidentAdditionalDataResponse;
    /**
     ...
     */
    readonly labels?: types.outputs.securityinsights.v20230801preview.IncidentLabelResponse[];
    /**
     ...
     */
    readonly owner?: types.outputs.securityinsights.v20230801preview.IncidentOwnerInfoResponse;
    /**
     ...
     */
    readonly teamInformation?: types.outputs.securityinsights.v20230801preview.TeamInformationResponse;
    /**

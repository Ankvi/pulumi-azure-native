...
export function getOfficeATPDataConnector(args: GetOfficeATPDataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetOfficeATPDataConnectorResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230801preview:getOfficeATPDataConnector", {
...
export interface GetOfficeATPDataConnectorResult {
     ...
     */
    readonly dataTypes?: types.outputs.securityinsights.v20230801preview.AlertsDataTypeOfDataConnectorResponse;
    /**

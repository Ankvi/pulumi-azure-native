...
export function getActivityCustomEntityQuery(args: GetActivityCustomEntityQueryArgs, opts?: pulumi.InvokeOptions): Promise<GetActivityCustomEntityQueryResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230801preview:getActivityCustomEntityQuery", {
...
export interface GetActivityCustomEntityQueryResult {
     ...
     */
    readonly queryDefinitions?: types.outputs.securityinsights.v20230801preview.ActivityEntityQueriesPropertiesResponseQueryDefinitions;
    /**

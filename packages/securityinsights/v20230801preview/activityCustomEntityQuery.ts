...
export class ActivityCustomEntityQuery extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230801preview:ActivityCustomEntityQuery';
     ...
     */
    public readonly queryDefinitions!: pulumi.Output<types.outputs.securityinsights.v20230801preview.ActivityEntityQueriesPropertiesResponseQueryDefinitions | undefined>;
    /**
...
export interface ActivityCustomEntityQueryArgs {
     ...
     * The type of the query's source entity
     */
    inputEntityType?: pulumi.Input<string | types.enums.v20230801preview.EntityType>;
    /**
     ...
     * The Activity query definitions
     */
    queryDefinitions?: pulumi.Input<types.inputs.securityinsights.v20230801preview.ActivityEntityQueriesPropertiesQueryDefinitionsArgs>;
    /**
     * List of the fields of the source entity that are required to run the query
     */

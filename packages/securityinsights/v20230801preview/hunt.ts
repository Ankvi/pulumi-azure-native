...
export class Hunt extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230801preview:Hunt';
     ...
     */
    public readonly owner!: pulumi.Output<types.outputs.securityinsights.v20230801preview.HuntOwnerResponse | undefined>;
    /**
    ...
    constructor(name: string, args: HuntArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:securityinsights:Hunt" }, { type: "azure-native:securityinsights/v20230401preview:Hunt" }, { type: "azure-native:securityinsights/v20230501preview:Hunt" }, { type: "azure-native:securityinsights/v20230601preview:Hunt" }, { type: "azure-native:securityinsights/v20230701preview:Hunt" }] };
...
export interface HuntArgs {
     ...
     * A list of mitre attack tactics the hunt is associated with
     */
    attackTactics?: pulumi.Input<pulumi.Input<string | types.enums.v20230801preview.AttackTactic>[]>;
    /**
     * A list of a mitre attack techniques the hunt is associated with
     */
     ...
     * The hypothesis status of the hunt.
     */
    hypothesisStatus?: pulumi.Input<string | types.enums.v20230801preview.HypothesisStatus>;
    /**
     * List of labels relevant to this hunt 
     */
     ...
     * Describes a user that the hunt is assigned to
     */
    owner?: pulumi.Input<types.inputs.securityinsights.v20230801preview.HuntOwnerArgs>;
    /**
     ...
     * The status of the hunt.
     */
    status?: pulumi.Input<string | types.enums.v20230801preview.Status>;
    /**

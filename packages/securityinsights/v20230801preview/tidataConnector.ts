...
export class TIDataConnector extends pulumi.CustomResource {
     ...
     */
    public readonly dataTypes!: pulumi.Output<types.outputs.TIDataConnectorDataTypesResponse>;
    /**

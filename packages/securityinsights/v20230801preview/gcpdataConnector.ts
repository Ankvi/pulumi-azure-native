...
export class GCPDataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230801preview:GCPDataConnector';
     ...
     */
    public readonly auth!: pulumi.Output<types.outputs.securityinsights.v20230801preview.GCPAuthPropertiesResponse>;
    /**
     ...
     */
    public readonly dcrConfig!: pulumi.Output<types.outputs.securityinsights.v20230801preview.DCRConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly request!: pulumi.Output<types.outputs.securityinsights.v20230801preview.GCPRequestPropertiesResponse>;
    /**
...
export interface GCPDataConnectorArgs {
     ...
     * The auth section of the connector.
     */
    auth: pulumi.Input<types.inputs.securityinsights.v20230801preview.GCPAuthPropertiesArgs>;
    /**
     * The name of the connector definition that represents the UI config.
     */
     ...
     * The configuration of the destination of the data.
     */
    dcrConfig?: pulumi.Input<types.inputs.securityinsights.v20230801preview.DCRConfigurationArgs>;
    /**
     * The kind of the data connector
     * Expected value is 'GCP'.
     */
     ...
     * The request section of the connector.
     */
    request: pulumi.Input<types.inputs.securityinsights.v20230801preview.GCPRequestPropertiesArgs>;
    /**

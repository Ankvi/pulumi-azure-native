...
export class TiTaxiiDataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230801preview:TiTaxiiDataConnector';
     ...
     */
    public readonly dataTypes!: pulumi.Output<types.outputs.securityinsights.v20230801preview.TiTaxiiDataConnectorDataTypesResponse>;
    /**
...
export interface TiTaxiiDataConnectorArgs {
     ...
     * The available data types for Threat Intelligence TAXII data connector.
     */
    dataTypes: pulumi.Input<types.inputs.securityinsights.v20230801preview.TiTaxiiDataConnectorDataTypesArgs>;
    /**
     * The friendly name for the TAXII server.
     */
     ...
     * The polling frequency for the TAXII server.
     */
    pollingFrequency: pulumi.Input<string | types.enums.v20230801preview.PollingFrequency>;
    /**

...
export class MCASDataConnector extends pulumi.CustomResource {
     ...
     */
    public readonly dataTypes!: pulumi.Output<types.outputs.MCASDataConnectorDataTypesResponse>;
    /**

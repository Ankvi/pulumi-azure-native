...
export class AutomationRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230801preview:AutomationRule';
     ...
     */
    public readonly actions!: pulumi.Output<(types.outputs.securityinsights.v20230801preview.AutomationRuleAddIncidentTaskActionResponse | types.outputs.securityinsights.v20230801preview.AutomationRuleModifyPropertiesActionResponse | types.outputs.securityinsights.v20230801preview.AutomationRuleRunPlaybookActionResponse)[]>;
    /**
     * Information on the client (user or application) that made some action
     */
    public /*out*/ readonly createdBy!: pulumi.Output<types.outputs.securityinsights.v20230801preview.ClientInfoResponse>;
    /**
     ...
     * Information on the client (user or application) that made some action
     */
    public /*out*/ readonly lastModifiedBy!: pulumi.Output<types.outputs.securityinsights.v20230801preview.ClientInfoResponse>;
    /**
     ...
     */
    public readonly triggeringLogic!: pulumi.Output<types.outputs.securityinsights.v20230801preview.AutomationRuleTriggeringLogicResponse>;
    /**
...
export interface AutomationRuleArgs {
     ...
     * The actions to execute when the automation rule is triggered.
     */
    actions: pulumi.Input<pulumi.Input<types.inputs.securityinsights.v20230801preview.AutomationRuleAddIncidentTaskActionArgs | types.inputs.securityinsights.v20230801preview.AutomationRuleModifyPropertiesActionArgs | types.inputs.securityinsights.v20230801preview.AutomationRuleRunPlaybookActionArgs>[]>;
    /**
     * Automation rule ID
     */
     ...
     * Describes automation rule triggering logic.
     */
    triggeringLogic: pulumi.Input<types.inputs.securityinsights.v20230801preview.AutomationRuleTriggeringLogicArgs>;
    /**

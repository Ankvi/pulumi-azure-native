...
export class MTPDataConnector extends pulumi.CustomResource {
     ...
     */
    public readonly dataTypes!: pulumi.Output<types.outputs.securityinsights.v20230801preview.MTPDataConnectorDataTypesResponse>;
    /**
     ...
     */
    public readonly filteredProviders!: pulumi.Output<types.outputs.securityinsights.v20230801preview.MtpFilteredProvidersResponse | undefined>;
    /**
...
export interface MTPDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes: pulumi.Input<types.inputs.securityinsights.v20230801preview.MTPDataConnectorDataTypesArgs>;
    /**
     * The available filtered providers for the connector.
     */
    filteredProviders?: pulumi.Input<types.inputs.securityinsights.v20230801preview.MtpFilteredProvidersArgs>;
    /**
     * The kind of the data connector
     * Expected value is 'MicrosoftThreatProtection'.
     */

...
export function getBookmark(args: GetBookmarkArgs, opts?: pulumi.InvokeOptions): Promise<GetBookmarkResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230801preview:getBookmark", {
...
export interface GetBookmarkResult {
     ...
     */
    readonly createdBy?: types.outputs.securityinsights.v20230801preview.UserInfoResponse;
    /**
     ...
     */
    readonly entityMappings?: types.outputs.securityinsights.v20230801preview.BookmarkEntityMappingsResponse[];
    /**
     ...
     */
    readonly incidentInfo?: types.outputs.securityinsights.v20230801preview.IncidentInfoResponse;
    /**
     ...
     */
    readonly updatedBy?: types.outputs.securityinsights.v20230801preview.UserInfoResponse;
}
/**
 * Gets a bookmark.
 */

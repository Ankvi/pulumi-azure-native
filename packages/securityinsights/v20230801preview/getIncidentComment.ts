...
export function getIncidentComment(args: GetIncidentCommentArgs, opts?: pulumi.InvokeOptions): Promise<GetIncidentCommentResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230801preview:getIncidentComment", {
...
export interface GetIncidentCommentResult {
     ...
     */
    readonly author: types.outputs.securityinsights.v20230801preview.ClientInfoResponse;
    /**

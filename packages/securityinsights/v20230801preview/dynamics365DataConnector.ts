...
export class Dynamics365DataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230801preview:Dynamics365DataConnector';
     ...
     */
    public readonly dataTypes!: pulumi.Output<types.outputs.securityinsights.v20230801preview.Dynamics365DataConnectorDataTypesResponse>;
    /**
...
export interface Dynamics365DataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes: pulumi.Input<types.inputs.securityinsights.v20230801preview.Dynamics365DataConnectorDataTypesArgs>;
    /**
     * The kind of the data connector
     * Expected value is 'Dynamics365'.
     */

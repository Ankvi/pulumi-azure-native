...
export class AnomalySecurityMLAnalyticsSettings extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230801preview:AnomalySecurityMLAnalyticsSettings';
     ...
     */
    public readonly requiredDataConnectors!: pulumi.Output<types.outputs.securityinsights.v20230801preview.SecurityMLAnalyticsSettingsDataSourceResponse[] | undefined>;
    /**
...
export interface AnomalySecurityMLAnalyticsSettingsArgs {
     ...
     * The required data sources for this SecurityMLAnalyticsSettings
     */
    requiredDataConnectors?: pulumi.Input<pulumi.Input<types.inputs.securityinsights.v20230801preview.SecurityMLAnalyticsSettingsDataSourceArgs>[]>;
    /**
     ...
     * The anomaly SecurityMLAnalyticsSettings status
     */
    settingsStatus: pulumi.Input<string | types.enums.v20230801preview.SettingsStatus>;
    /**
     * The tactics of the SecurityMLAnalyticsSettings
     */

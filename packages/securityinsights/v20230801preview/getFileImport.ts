...
export function getFileImport(args: GetFileImportArgs, opts?: pulumi.InvokeOptions): Promise<GetFileImportResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230801preview:getFileImport", {
...
export interface GetFileImportResult {
     ...
     */
    readonly errorFile: types.outputs.securityinsights.v20230801preview.FileMetadataResponse;
    /**
     * An ordered list of some of the errors that were encountered during validation.
     */
    readonly errorsPreview: types.outputs.securityinsights.v20230801preview.ValidationErrorResponse[];
    /**
     ...
     */
    readonly importFile: types.outputs.securityinsights.v20230801preview.FileMetadataResponse;
    /**

...
export function getCodelessApiPollingDataConnector(args: GetCodelessApiPollingDataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetCodelessApiPollingDataConnectorResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230801preview:getCodelessApiPollingDataConnector", {
...
export interface GetCodelessApiPollingDataConnectorResult {
     ...
     */
    readonly connectorUiConfig?: types.outputs.securityinsights.v20230801preview.CodelessUiConnectorConfigPropertiesResponse;
    /**
     ...
     */
    readonly pollingConfig?: types.outputs.securityinsights.v20230801preview.CodelessConnectorPollingConfigPropertiesResponse;
    /**

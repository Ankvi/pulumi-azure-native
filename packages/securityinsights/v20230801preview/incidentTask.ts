...
export class IncidentTask extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230801preview:IncidentTask';
    ...
    constructor(name: string, args: IncidentTaskArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:securityinsights:IncidentTask" }, { type: "azure-native:securityinsights/v20221201preview:IncidentTask" }, { type: "azure-native:securityinsights/v20230201preview:IncidentTask" }, { type: "azure-native:securityinsights/v20230301preview:IncidentTask" }, { type: "azure-native:securityinsights/v20230401preview:IncidentTask" }, { type: "azure-native:securityinsights/v20230501preview:IncidentTask" }, { type: "azure-native:securityinsights/v20230601preview:IncidentTask" }, { type: "azure-native:securityinsights/v20230701preview:IncidentTask" }, { type: "azure-native:securityinsights/v20230901preview:IncidentTask" }] };

...
export class WorkspaceManagerAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230801preview:WorkspaceManagerAssignment';
    ...
    constructor(name: string, args: WorkspaceManagerAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:securityinsights:WorkspaceManagerAssignment" }, { type: "azure-native:securityinsights/v20230401preview:WorkspaceManagerAssignment" }, { type: "azure-native:securityinsights/v20230501preview:WorkspaceManagerAssignment" }, { type: "azure-native:securityinsights/v20230601preview:WorkspaceManagerAssignment" }, { type: "azure-native:securityinsights/v20230701preview:WorkspaceManagerAssignment" }, { type: "azure-native:securityinsights/v20230901preview:WorkspaceManagerAssignment" }, { type: "azure-native:securityinsights/v20231001preview:WorkspaceManagerAssignment" }, { type: "azure-native:securityinsights/v20231201preview:WorkspaceManagerAssignment" }, { type: "azure-native:securityinsights/v20240101preview:WorkspaceManagerAssignment" }] };

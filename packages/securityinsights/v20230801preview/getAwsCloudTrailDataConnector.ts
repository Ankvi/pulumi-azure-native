...
export function getAwsCloudTrailDataConnector(args: GetAwsCloudTrailDataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetAwsCloudTrailDataConnectorResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230801preview:getAwsCloudTrailDataConnector", {
...
export interface GetAwsCloudTrailDataConnectorResult {
     ...
     */
    readonly dataTypes: types.outputs.securityinsights.v20230801preview.AwsCloudTrailDataConnectorDataTypesResponse;
    /**

...
export class EntityAnalytics extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230801preview:EntityAnalytics';
...
export interface EntityAnalyticsArgs {
     ...
     * The relevant entity providers that are synced
     */
    entityProviders?: pulumi.Input<pulumi.Input<string | types.enums.v20230801preview.EntityProviders>[]>;
    /**
     * The kind of the setting
     * Expected value is 'EntityAnalytics'.
     */

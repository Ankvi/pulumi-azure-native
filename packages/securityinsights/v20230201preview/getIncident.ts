...
export function getIncident(args: GetIncidentArgs, opts?: pulumi.InvokeOptions): Promise<GetIncidentResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230201preview:getIncident", {
...
export interface GetIncidentResult {
     ...
     */
    readonly additionalData: types.outputs.securityinsights.v20230201preview.IncidentAdditionalDataResponse;
    /**
     ...
     */
    readonly labels?: types.outputs.securityinsights.v20230201preview.IncidentLabelResponse[];
    /**
     ...
     */
    readonly owner?: types.outputs.securityinsights.v20230201preview.IncidentOwnerInfoResponse;
    /**
     ...
     */
    readonly systemData: types.outputs.securityinsights.v20230201preview.SystemDataResponse;
    /**
     * Describes a team for the incident
     */
    readonly teamInformation?: types.outputs.securityinsights.v20230201preview.TeamInformationResponse;
    /**

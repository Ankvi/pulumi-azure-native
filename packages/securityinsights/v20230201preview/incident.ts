...
export class Incident extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230201preview:Incident';
     ...
     */
    public /*out*/ readonly additionalData!: pulumi.Output<types.outputs.securityinsights.v20230201preview.IncidentAdditionalDataResponse>;
    /**
     ...
     */
    public readonly labels!: pulumi.Output<types.outputs.securityinsights.v20230201preview.IncidentLabelResponse[] | undefined>;
    /**
     ...
     */
    public readonly owner!: pulumi.Output<types.outputs.securityinsights.v20230201preview.IncidentOwnerInfoResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly teamInformation!: pulumi.Output<types.outputs.securityinsights.v20230201preview.TeamInformationResponse | undefined>;
    /**
...
export interface IncidentArgs {
     ...
     * The reason the incident was closed
     */
    classification?: pulumi.Input<string | types.enums.v20230201preview.IncidentClassification>;
    /**
     * Describes the reason the incident was closed
     */
     ...
     * The classification reason the incident was closed with
     */
    classificationReason?: pulumi.Input<string | types.enums.v20230201preview.IncidentClassificationReason>;
    /**
     * The description of the incident
     */
     ...
     * List of labels relevant to this incident
     */
    labels?: pulumi.Input<pulumi.Input<types.inputs.securityinsights.v20230201preview.IncidentLabelArgs>[]>;
    /**
     * The time of the last activity in the incident
     */
     ...
     * Describes a user that the incident is assigned to
     */
    owner?: pulumi.Input<types.inputs.securityinsights.v20230201preview.IncidentOwnerInfoArgs>;
    /**
     * The incident ID assigned by the incident provider
     */
     ...
     * The severity of the incident
     */
    severity: pulumi.Input<string | types.enums.v20230201preview.IncidentSeverity>;
    /**
     * The status of the incident
     */
    status: pulumi.Input<string | types.enums.v20230201preview.IncidentStatus>;
    /**
     * The title of the incident
     */

...
export class AADDataConnector extends pulumi.CustomResource {
     ...
     */
    declare public readonly kind: pulumi.Output<"AzureActiveDirectory">;
    /**

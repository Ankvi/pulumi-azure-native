...
export class AATPDataConnector extends pulumi.CustomResource {
     ...
     */
    declare public readonly dataTypes: pulumi.Output<types.outputs.AlertsDataTypeOfDataConnectorResponse | undefined>;
    /**
     ...
     */
    declare public readonly kind: pulumi.Output<"AzureAdvancedThreatProtection">;
    /**

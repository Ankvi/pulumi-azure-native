...
export class ActivityCustomEntityQuery extends pulumi.CustomResource {
     ...
     */
    declare public readonly queryDefinitions: pulumi.Output<types.outputs.ActivityEntityQueriesPropertiesResponseQueryDefinitions | undefined>;
    /**

...
export class Watchlist extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20220101preview:Watchlist';
     ...
     */
    public readonly createdBy!: pulumi.Output<types.outputs.securityinsights.v20220101preview.WatchlistUserInfoResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<types.outputs.securityinsights.v20220101preview.SystemDataResponse>;
    /**
     ...
     */
    public readonly updatedBy!: pulumi.Output<types.outputs.securityinsights.v20220101preview.WatchlistUserInfoResponse | undefined>;
    /**
...
export interface WatchlistArgs {
     ...
     * Describes a user that created the watchlist
     */
    createdBy?: pulumi.Input<types.inputs.securityinsights.v20220101preview.WatchlistUserInfoArgs>;
    /**
     * The default duration of a watchlist (in ISO 8601 duration format)
     */
     ...
     * The sourceType of the watchlist
     */
    sourceType?: pulumi.Input<string | types.enums.v20220101preview.SourceType>;
    /**
     * The tenantId where the watchlist belongs to
     */
     ...
     * Describes a user that updated the watchlist
     */
    updatedBy?: pulumi.Input<types.inputs.securityinsights.v20220101preview.WatchlistUserInfoArgs>;
    /**
     * The status of the Watchlist upload : New, InProgress or Complete. Pls note : When a Watchlist upload status is equal to InProgress, the Watchlist cannot be deleted
     */

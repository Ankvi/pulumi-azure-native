...
export class ASCDataConnector extends pulumi.CustomResource {
     ...
     */
    declare public readonly kind: pulumi.Output<"AzureSecurityCenter">;
    /**

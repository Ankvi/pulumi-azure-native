...
export class TIDataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230701preview:TIDataConnector';
     ...
     */
    public readonly dataTypes!: pulumi.Output<types.outputs.securityinsights.v20230701preview.TIDataConnectorDataTypesResponse>;
    /**
...
export interface TIDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes: pulumi.Input<types.inputs.securityinsights.v20230701preview.TIDataConnectorDataTypesArgs>;
    /**
     * The kind of the data connector
     * Expected value is 'ThreatIntelligence'.
     */

...
export class ScheduledAlertRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230701preview:ScheduledAlertRule';
     ...
     */
    public readonly alertDetailsOverride!: pulumi.Output<types.outputs.securityinsights.v20230701preview.AlertDetailsOverrideResponse | undefined>;
    /**
     ...
     */
    public readonly entityMappings!: pulumi.Output<types.outputs.securityinsights.v20230701preview.EntityMappingResponse[] | undefined>;
    /**
     ...
     */
    public readonly eventGroupingSettings!: pulumi.Output<types.outputs.securityinsights.v20230701preview.EventGroupingSettingsResponse | undefined>;
    /**
     * The settings of the incidents that created from alerts triggered by this analytics rule
     */
    public readonly incidentConfiguration!: pulumi.Output<types.outputs.securityinsights.v20230701preview.IncidentConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly sentinelEntitiesMappings!: pulumi.Output<types.outputs.securityinsights.v20230701preview.SentinelEntityMappingResponse[] | undefined>;
    /**
...
export interface ScheduledAlertRuleArgs {
     ...
     * The alert details override settings
     */
    alertDetailsOverride?: pulumi.Input<types.inputs.securityinsights.v20230701preview.AlertDetailsOverrideArgs>;
    /**
     * The Name of the alert rule template used to create this rule.
     */
     ...
     * Array of the entity mappings of the alert rule
     */
    entityMappings?: pulumi.Input<pulumi.Input<types.inputs.securityinsights.v20230701preview.EntityMappingArgs>[]>;
    /**
     * The event grouping settings.
     */
    eventGroupingSettings?: pulumi.Input<types.inputs.securityinsights.v20230701preview.EventGroupingSettingsArgs>;
    /**
     * The settings of the incidents that created from alerts triggered by this analytics rule
     */
    incidentConfiguration?: pulumi.Input<types.inputs.securityinsights.v20230701preview.IncidentConfigurationArgs>;
    /**
     * The kind of the alert rule
     * Expected value is 'Scheduled'.
     */
     ...
     * Array of the sentinel entity mappings of the alert rule
     */
    sentinelEntitiesMappings?: pulumi.Input<pulumi.Input<types.inputs.securityinsights.v20230701preview.SentinelEntityMappingArgs>[]>;
    /**
     * The severity for alerts created by this alert rule.
     */
    severity: pulumi.Input<string | types.enums.v20230701preview.AlertSeverity>;
    /**
     * The suppression (in ISO 8601 duration format) to wait since last time this alert rule been triggered.
     */
     ...
     * The operation against the threshold that triggers alert rule.
     */
    triggerOperator: pulumi.Input<types.enums.v20230701preview.TriggerOperator>;
    /**
     * The threshold triggers this alert rule.
     */

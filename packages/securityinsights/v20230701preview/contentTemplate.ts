...
export class ContentTemplate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230701preview:ContentTemplate';
     ...
     */
    public readonly author!: pulumi.Output<types.outputs.securityinsights.v20230701preview.MetadataAuthorResponse | undefined>;
    /**
     * Categories for the item
     */
    public readonly categories!: pulumi.Output<types.outputs.securityinsights.v20230701preview.MetadataCategoriesResponse | undefined>;
    /**
     ...
     */
    public readonly dependencies!: pulumi.Output<types.outputs.securityinsights.v20230701preview.MetadataDependenciesResponse | undefined>;
    /**
     ...
     */
    public readonly source!: pulumi.Output<types.outputs.securityinsights.v20230701preview.MetadataSourceResponse>;
    /**
     * Support information for the template - type, name, contact information
     */
    public readonly support!: pulumi.Output<types.outputs.securityinsights.v20230701preview.MetadataSupportResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ContentTemplateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:securityinsights:ContentTemplate" }, { type: "azure-native:securityinsights/v20230401preview:ContentTemplate" }, { type: "azure-native:securityinsights/v20230501preview:ContentTemplate" }, { type: "azure-native:securityinsights/v20230601preview:ContentTemplate" }, { type: "azure-native:securityinsights/v20230801preview:ContentTemplate" }] };
...
export interface ContentTemplateArgs {
     ...
     * The creator of the content item.
     */
    author?: pulumi.Input<types.inputs.securityinsights.v20230701preview.MetadataAuthorArgs>;
    /**
     * Categories for the item
     */
    categories?: pulumi.Input<types.inputs.securityinsights.v20230701preview.MetadataCategoriesArgs>;
    /**
     * Static ID for the content.  Used to identify dependencies and content from solutions or community.  Hard-coded/static for out of the box content and solutions. Dynamic for user-created.  This is the resource name
     */
     ...
     * The kind of content the template is for.
     */
    contentKind: pulumi.Input<string | types.enums.v20230701preview.Kind>;
    /**
     * Unique ID for the content. It should be generated based on the contentId of the package, contentId of the template, contentKind of the template and the contentVersion of the template
     */
     ...
     * Dependencies for the content item, what other content items it requires to work.  Can describe more complex dependencies using a recursive/nested structure. For a single dependency an id/kind/version can be supplied or operator/criteria for complex formats.
     */
    dependencies?: pulumi.Input<types.inputs.securityinsights.v20230701preview.MetadataDependenciesArgs>;
    /**
     * The display name of the template
     */
     ...
     * the packageKind of the package contains this template
     */
    packageKind?: pulumi.Input<string | types.enums.v20230701preview.PackageKind>;
    /**
     * the name of the package contains this template
     */
     ...
     * Source of the content.  This is where/how it was created.
     */
    source: pulumi.Input<types.inputs.securityinsights.v20230701preview.MetadataSourceArgs>;
    /**
     * Support information for the template - type, name, contact information
     */
    support?: pulumi.Input<types.inputs.securityinsights.v20230701preview.MetadataSupportArgs>;
    /**
     * template Id
     */

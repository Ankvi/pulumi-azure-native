...
export class MicrosoftPurviewInformationProtectionDataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230701preview:MicrosoftPurviewInformationProtectionDataConnector';
     ...
     */
    public readonly dataTypes!: pulumi.Output<types.outputs.MicrosoftPurviewInformationProtectionConnectorDataTypesResponse>;
    /**
...
export interface MicrosoftPurviewInformationProtectionDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes: pulumi.Input<types.inputs.MicrosoftPurviewInformationProtectionConnectorDataTypesArgs>;
    /**
     * The kind of the data connector
     * Expected value is 'MicrosoftPurviewInformationProtection'.
     */

...
export class OfficeDataConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230701preview:OfficeDataConnector';
     ...
     */
    public readonly dataTypes!: pulumi.Output<types.outputs.securityinsights.v20230701preview.OfficeDataConnectorDataTypesResponse>;
    /**
...
export interface OfficeDataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes: pulumi.Input<types.inputs.securityinsights.v20230701preview.OfficeDataConnectorDataTypesArgs>;
    /**
     * The kind of the data connector
     * Expected value is 'Office365'.
     */

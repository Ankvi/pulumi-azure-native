...
export function getAutomationRule(args: GetAutomationRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetAutomationRuleResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230701preview:getAutomationRule", {
...
export interface GetAutomationRuleResult {
     ...
     */
    readonly actions: (types.outputs.securityinsights.v20230701preview.AutomationRuleAddIncidentTaskActionResponse | types.outputs.securityinsights.v20230701preview.AutomationRuleModifyPropertiesActionResponse | types.outputs.securityinsights.v20230701preview.AutomationRuleRunPlaybookActionResponse)[];
    /**
     ...
     */
    readonly triggeringLogic: types.outputs.securityinsights.v20230701preview.AutomationRuleTriggeringLogicResponse;
    /**

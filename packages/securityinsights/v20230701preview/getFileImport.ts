...
export interface GetFileImportResult {
     ...
     */
    readonly errorFile: types.outputs.securityinsights.v20230701preview.FileMetadataResponse;
    /**
     * An ordered list of some of the errors that were encountered during validation.
     */
    readonly errorsPreview: types.outputs.securityinsights.v20230701preview.ValidationErrorResponse[];
    /**
     ...
     */
    readonly importFile: types.outputs.securityinsights.v20230701preview.FileMetadataResponse;
    /**

...
export class Dynamics365DataConnector extends pulumi.CustomResource {
     ...
     */
    public readonly dataTypes!: pulumi.Output<types.outputs.securityinsights.v20230701preview.Dynamics365DataConnectorDataTypesResponse>;
    /**
...
export interface Dynamics365DataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes: pulumi.Input<types.inputs.securityinsights.v20230701preview.Dynamics365DataConnectorDataTypesArgs>;
    /**
     * The kind of the data connector
     * Expected value is 'Dynamics365'.
     */

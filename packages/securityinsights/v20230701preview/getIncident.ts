...
export function getIncident(args: GetIncidentArgs, opts?: pulumi.InvokeOptions): Promise<GetIncidentResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230701preview:getIncident", {
...
export interface GetIncidentResult {
     ...
     */
    readonly additionalData: types.outputs.securityinsights.v20230701preview.IncidentAdditionalDataResponse;
    /**
     ...
     */
    readonly labels?: types.outputs.securityinsights.v20230701preview.IncidentLabelResponse[];
    /**
     ...
     */
    readonly owner?: types.outputs.securityinsights.v20230701preview.IncidentOwnerInfoResponse;
    /**
     ...
     */
    readonly teamInformation?: types.outputs.securityinsights.v20230701preview.TeamInformationResponse;
    /**

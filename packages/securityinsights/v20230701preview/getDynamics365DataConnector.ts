...
export function getDynamics365DataConnector(args: GetDynamics365DataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetDynamics365DataConnectorResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230701preview:getDynamics365DataConnector", {
...
export interface GetDynamics365DataConnectorResult {
     ...
     */
    readonly dataTypes: types.outputs.securityinsights.v20230701preview.Dynamics365DataConnectorDataTypesResponse;
    /**

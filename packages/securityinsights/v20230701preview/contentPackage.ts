...
export class ContentPackage extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230701preview:ContentPackage';
     ...
     */
    public readonly source!: pulumi.Output<types.outputs.securityinsights.v20230701preview.MetadataSourceResponse | undefined>;
    /**
     * The support tier of the package
     */
...
export interface ContentPackageArgs {
     ...
     * The package kind
     */
    contentKind: pulumi.Input<string | types.enums.v20230701preview.PackageKind>;
    /**
     * Unique ID for the content. It should be generated based on the contentId, contentKind and the contentVersion of the package
     */
     ...
     * Flag indicates if this package is among the featured list.
     */
    isFeatured?: pulumi.Input<string | types.enums.v20230701preview.Flag>;
    /**
     * Flag indicates if this is a newly published package.
     */
    isNew?: pulumi.Input<string | types.enums.v20230701preview.Flag>;
    /**
     * Flag indicates if this package is in preview.
     */
    isPreview?: pulumi.Input<string | types.enums.v20230701preview.Flag>;
    /**
     * last publish date for the package item
     */

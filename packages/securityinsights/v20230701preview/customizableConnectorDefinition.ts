...
export class CustomizableConnectorDefinition extends pulumi.CustomResource {
     ...
     */
    public readonly connectionsConfig!: pulumi.Output<types.outputs.securityinsights.v20230701preview.CustomizableConnectionsConfigResponse | undefined>;
    /**
     * The UiConfig for 'Customizable' connector definition kind.
     */
    public readonly connectorUiConfig!: pulumi.Output<types.outputs.securityinsights.v20230701preview.CustomizableConnectorUiConfigResponse>;
    /**
    ...
    constructor(name: string, args: CustomizableConnectorDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:securityinsights:CustomizableConnectorDefinition" }, { type: "azure-native:securityinsights/v20230801preview:CustomizableConnectorDefinition" }] };
...
export interface CustomizableConnectorDefinitionArgs {
     ...
     * The UiConfig for 'Customizable' connector definition kind.
     */
    connectionsConfig?: pulumi.Input<types.inputs.securityinsights.v20230701preview.CustomizableConnectionsConfigArgs>;
    /**
     * The UiConfig for 'Customizable' connector definition kind.
     */
    connectorUiConfig: pulumi.Input<types.inputs.securityinsights.v20230701preview.CustomizableConnectorUiConfigArgs>;
    /**
     * Gets or sets the connector definition created date in UTC format.
     */

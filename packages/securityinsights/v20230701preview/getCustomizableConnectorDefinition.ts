...
export function getCustomizableConnectorDefinition(args: GetCustomizableConnectorDefinitionArgs, opts?: pulumi.InvokeOptions): Promise<GetCustomizableConnectorDefinitionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230701preview:getCustomizableConnectorDefinition", {
...
export interface GetCustomizableConnectorDefinitionResult {
     ...
     */
    readonly connectionsConfig?: types.outputs.securityinsights.v20230701preview.CustomizableConnectionsConfigResponse;
    /**
     * The UiConfig for 'Customizable' connector definition kind.
     */
    readonly connectorUiConfig: types.outputs.securityinsights.v20230701preview.CustomizableConnectorUiConfigResponse;
    /**

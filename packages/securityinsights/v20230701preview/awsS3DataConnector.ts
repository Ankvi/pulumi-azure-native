...
export class AwsS3DataConnector extends pulumi.CustomResource {
     ...
     */
    public readonly dataTypes!: pulumi.Output<types.outputs.securityinsights.v20230701preview.AwsS3DataConnectorDataTypesResponse>;
    /**
...
export interface AwsS3DataConnectorArgs {
     ...
     * The available data types for the connector.
     */
    dataTypes: pulumi.Input<types.inputs.securityinsights.v20230701preview.AwsS3DataConnectorDataTypesArgs>;
    /**
     * The logs destination table name in LogAnalytics.
     */

...
export class Ueba extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230701preview:Ueba';
...
export interface UebaArgs {
     ...
     * The relevant data sources that enriched by ueba
     */
    dataSources?: pulumi.Input<pulumi.Input<string | types.enums.v20230701preview.UebaDataSources>[]>;
    /**
     * The kind of the setting
     * Expected value is 'Ueba'.
     */

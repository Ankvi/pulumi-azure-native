...
export function getTIDataConnector(args: GetTIDataConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetTIDataConnectorResult> {
    ...
    return pulumi.runtime.invoke("azure-native:securityinsights/v20230701preview:getTIDataConnector", {
...
export interface GetTIDataConnectorResult {
     ...
     */
    readonly dataTypes: types.outputs.securityinsights.v20230701preview.TIDataConnectorDataTypesResponse;
    /**

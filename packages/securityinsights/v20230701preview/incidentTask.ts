...
export class IncidentTask extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securityinsights/v20230701preview:IncidentTask';
     ...
     */
    public readonly createdBy!: pulumi.Output<types.outputs.securityinsights.v20230701preview.ClientInfoResponse | undefined>;
    /**
     ...
     * Information on the client (user or application) that made some action
     */
    public readonly lastModifiedBy!: pulumi.Output<types.outputs.securityinsights.v20230701preview.ClientInfoResponse | undefined>;
    /**
...
export interface IncidentTaskArgs {
     ...
     * Information on the client (user or application) that made some action
     */
    createdBy?: pulumi.Input<types.inputs.securityinsights.v20230701preview.ClientInfoArgs>;
    /**
     * The description of the task
     */
     ...
     * Information on the client (user or application) that made some action
     */
    lastModifiedBy?: pulumi.Input<types.inputs.securityinsights.v20230701preview.ClientInfoArgs>;
    /**
     * The name of the resource group. The name is case insensitive.
     */
    resourceGroupName: pulumi.Input<string>;
    status: pulumi.Input<string | types.enums.v20230701preview.IncidentTaskStatus>;
    /**
     * The title of the task
     */

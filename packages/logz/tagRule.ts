...
export class TagRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:logz:TagRule';
    ...
    constructor(name: string, args: TagRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:logz/v20201001:TagRule" }, { type: "azure-native:logz/v20201001preview:TagRule" }, { type: "azure-native:logz/v20220101preview:TagRule" }] };

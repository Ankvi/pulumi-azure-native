...
export namespace logz {
    ...
    export namespace v20220101preview {
        ...
        export interface FilteringTagArgs {
             ...
             * Valid actions for a filtering tag. Exclusion takes priority over inclusion.
             */
            action?: pulumi.Input<string | enums.v20220101preview.TagAction>;
            /**
             * The name (also known as the key) of the tag.
             */
            name?: pulumi.Input<string>;
        ...
        export interface IdentityPropertiesArgs {
            type?: pulumi.Input<string | enums.v20220101preview.ManagedIdentityTypes>;
        }
        ...
        export interface LogRulesArgs {
             ...
             * List of filtering tags to be used for capturing logs. This only takes effect if SendActivityLogs flag is enabled. If empty, all resources will be captured. If only Exclude action is specified, the rules will apply to the list of all available resources. If Include actions are specified, the rules will only include resources with the associated tags.
             */
            filteringTags?: pulumi.Input<pulumi.Input<v20220101preview.FilteringTagArgs>[]>;
            /**
             * Flag specifying if AAD logs should be sent for the Monitor resource.
             */
            sendAadLogs?: pulumi.Input<boolean>;
         ...
         */
        export interface MetricsTagRulesPropertiesArgs {
            metricRules?: pulumi.Input<pulumi.Input<v20220101preview.MetricRulesArgs>[]>;
            /**
             * Flag specifying if metrics from Azure resources should be sent for the Monitor resource.
             */
            sendMetrics?: pulumi.Input<boolean>;
         ...
         */
        export interface MonitorPropertiesArgs {
            logzOrganizationProperties?: pulumi.Input<v20220101preview.LogzOrganizationPropertiesArgs>;
            /**
             * Flag specifying the Marketplace Subscription Status of the resource. If payment is not made in time, the resource will go in Suspended state.
             */
            marketplaceSubscriptionStatus?: pulumi.Input<string | enums.v20220101preview.MarketplaceSubscriptionStatus>;
            /**
             * Flag specifying if the resource monitoring is enabled or disabled.
             */
            monitoringStatus?: pulumi.Input<string | enums.v20220101preview.MonitoringStatus>;
            planData?: pulumi.Input<v20220101preview.PlanDataArgs>;
            userInfo?: pulumi.Input<v20220101preview.UserInfoArgs>;
        }
        ...
        export interface MonitoringTagRulesPropertiesArgs {
             ...
             * Set of rules for sending logs for the Monitor resource.
             */
            logRules?: pulumi.Input<v20220101preview.LogRulesArgs>;
        }

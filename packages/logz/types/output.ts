...
export namespace logz {
    ...
    export namespace v20220101preview {
        ...
        export interface LogRulesResponse {
             ...
             * List of filtering tags to be used for capturing logs. This only takes effect if SendActivityLogs flag is enabled. If empty, all resources will be captured. If only Exclude action is specified, the rules will apply to the list of all available resources. If Include actions are specified, the rules will only include resources with the associated tags.
             */
            filteringTags?: v20220101preview.FilteringTagResponse[];
            /**
             * Flag specifying if AAD logs should be sent for the Monitor resource.
             */
            sendAadLogs?: boolean;
         ...
         */
        export interface MetricsTagRulesPropertiesResponse {
            metricRules?: v20220101preview.MetricRulesResponse[];
            /**
             * Flag specifying if the resource provisioning state as tracked by ARM.
             */
            provisioningState: string;
        ...
        export interface MonitorPropertiesResponse {
             ...
             */
            liftrResourcePreference: number;
            logzOrganizationProperties?: v20220101preview.LogzOrganizationPropertiesResponse;
            /**
             * Flag specifying the Marketplace Subscription Status of the resource. If payment is not made in time, the resource will go in Suspended state.
             */
            marketplaceSubscriptionStatus?: string;
             ...
             */
            monitoringStatus?: string;
            planData?: v20220101preview.PlanDataResponse;
            /**
             * Flag specifying if the resource provisioning state as tracked by ARM.
             */
            provisioningState: string;
            userInfo?: v20220101preview.UserInfoResponse;
        }
        ...
        export interface MonitoringTagRulesPropertiesResponse {
             ...
             * Set of rules for sending logs for the Monitor resource.
             */
            logRules?: v20220101preview.LogRulesResponse;
            /**
             * Flag specifying if the resource provisioning state as tracked by ARM.
             */
            provisioningState: string;

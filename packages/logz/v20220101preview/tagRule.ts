...
export class TagRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:logz/v20220101preview:TagRule';
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.logz.v20220101preview.MonitoringTagRulesPropertiesResponse>;
    /**
...
export interface TagRuleArgs {
     ...
     * Definition of the properties for a TagRules resource.
     */
    properties?: pulumi.Input<types.inputs.logz.v20220101preview.MonitoringTagRulesPropertiesArgs>;
    /**

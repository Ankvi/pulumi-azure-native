...
export class MetricsSourceTagRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:logz/v20220101preview:MetricsSourceTagRule';
    ...
    constructor(name: string, args: MetricsSourceTagRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:logz:MetricsSourceTagRule" }] };

...
export class Deployment extends pulumi.CustomResource {
     ...
     * Images deployed
     */
    declare public readonly deployedImages: pulumi.Output<types.outputs.ImageResponse[] | undefined>;
    /**
     * Deployment date UTC
     */
    declare public /*out*/ readonly deploymentDateUtc: pulumi.Output<string>;
    /**
     * Deployment ID
     */
    ...
    constructor(name: string, args: DeploymentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["deployedImages"] = args?.deployedImages;

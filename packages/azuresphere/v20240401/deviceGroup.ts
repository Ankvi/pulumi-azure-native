...
export class DeviceGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azuresphere/v20240401:DeviceGroup';
    ...
    constructor(name: string, args: DeviceGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azuresphere:DeviceGroup" }, { type: "azure-native:azuresphere/v20220901preview:DeviceGroup" }] };

...
export class Image extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azuresphere/v20240401:Image';
    ...
    constructor(name: string, args: ImageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azuresphere:Image" }, { type: "azure-native:azuresphere/v20220901preview:Image" }] };

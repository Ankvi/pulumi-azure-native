...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:azuresphere/v20220901preview:Catalog":
                return new Catalog(name, <any>undefined, { urn })
            case "azure-native:azuresphere/v20220901preview:Deployment":
                return new Deployment(name, <any>undefined, { urn })
            case "azure-native:azuresphere/v20220901preview:Device":
                return new Device(name, <any>undefined, { urn })
            case "azure-native:azuresphere/v20220901preview:DeviceGroup":
                return new DeviceGroup(name, <any>undefined, { urn })
            case "azure-native:azuresphere/v20220901preview:Image":
                return new Image(name, <any>undefined, { urn })
            case "azure-native:azuresphere/v20220901preview:Product":
...
pulumi.runtime.registerResourceModule("azure-native", "azuresphere/v20220901preview", _module)
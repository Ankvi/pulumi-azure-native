...
export class Product extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azuresphere/v20220901preview:Product';
    ...
    constructor(name: string, args: ProductArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azuresphere:Product" }, { type: "azure-native:azuresphere/v20240401:Product" }] };

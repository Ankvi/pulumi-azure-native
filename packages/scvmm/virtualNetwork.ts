...
export class VirtualNetwork extends pulumi.CustomResource {
    ...
    constructor(name: string, args: VirtualNetworkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:scvmm/v20200605preview:VirtualNetwork" }, { type: "azure-native:scvmm/v20220521preview:VirtualNetwork" }, { type: "azure-native:scvmm/v20230401preview:VirtualNetwork" }, { type: "azure-native:scvmm/v20231007:VirtualNetwork" }] };

...
export class Cloud extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly cloudCapacity: pulumi.Output<types.outputs.CloudCapacityResponse>;
    /**
     ...
     */
    declare public /*out*/ readonly storageQoSPolicies: pulumi.Output<types.outputs.StorageQoSPolicyResponse[]>;
    /**
     * The system data.
     */
    ...
    constructor(name: string, args: CloudArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:scvmm/v20200605preview:Cloud" }, { type: "azure-native:scvmm/v20220521preview:Cloud" }, { type: "azure-native:scvmm/v20230401preview:Cloud" }, { type: "azure-native:scvmm/v20231007:Cloud" }, { type: "azure-native:scvmm/v20240601:Cloud" }, { type: "azure-native:scvmm/v20250313:Cloud" }] };

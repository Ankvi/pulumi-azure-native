...
export class VirtualMachineTemplate extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly disks!: pulumi.Output<types.outputs.scvmm.v20220521preview.VirtualDiskResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly networkInterfaces!: pulumi.Output<types.outputs.scvmm.v20220521preview.NetworkInterfacesResponse[]>;
    /**
    ...
    constructor(name: string, args: VirtualMachineTemplateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:scvmm:VirtualMachineTemplate" }, { type: "azure-native:scvmm/v20200605preview:VirtualMachineTemplate" }, { type: "azure-native:scvmm/v20230401preview:VirtualMachineTemplate" }] };

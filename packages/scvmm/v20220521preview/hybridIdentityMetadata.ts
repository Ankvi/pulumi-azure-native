...
export class HybridIdentityMetadata extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:scvmm/v20220521preview:HybridIdentityMetadata';
     ...
     */
    public /*out*/ readonly identity!: pulumi.Output<types.outputs.scvmm.v20220521preview.IdentityResponse>;
    /**
    ...
    constructor(name: string, args: HybridIdentityMetadataArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:scvmm:HybridIdentityMetadata" }, { type: "azure-native:scvmm/v20230401preview:HybridIdentityMetadata" }] };

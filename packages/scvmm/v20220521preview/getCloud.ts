...
export interface GetCloudResult {
     ...
     */
    readonly cloudCapacity: types.outputs.scvmm.v20220521preview.CloudCapacityResponse;
    /**
     ...
     */
    readonly storageQoSPolicies: types.outputs.scvmm.v20220521preview.StorageQoSPolicyResponse[];
    /**
     * The system data.
     */

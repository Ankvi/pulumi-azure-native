...
export function getVirtualMachineTemplate(args: GetVirtualMachineTemplateArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualMachineTemplateResult> {
    ...
    return pulumi.runtime.invoke("azure-native:scvmm/v20220521preview:getVirtualMachineTemplate", {
...
export interface GetVirtualMachineTemplateResult {
     ...
     */
    readonly disks: types.outputs.scvmm.v20220521preview.VirtualDiskResponse[];
    /**
     ...
     */
    readonly networkInterfaces: types.outputs.scvmm.v20220521preview.NetworkInterfacesResponse[];
    /**

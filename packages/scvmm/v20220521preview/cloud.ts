...
export class Cloud extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:scvmm/v20220521preview:Cloud';
    ...
    constructor(name: string, args: CloudArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:scvmm:Cloud" }, { type: "azure-native:scvmm/v20200605preview:Cloud" }, { type: "azure-native:scvmm/v20230401preview:Cloud" }, { type: "azure-native:scvmm/v20231007:Cloud" }] };

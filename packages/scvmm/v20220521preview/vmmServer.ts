...
export class VmmServer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:scvmm/v20220521preview:VmmServer';
     ...
     */
    public readonly credentials!: pulumi.Output<types.outputs.scvmm.v20220521preview.VMMServerPropertiesResponseCredentials | undefined>;
    /**
    ...
    constructor(name: string, args: VmmServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:scvmm:VmmServer" }, { type: "azure-native:scvmm/v20200605preview:VmmServer" }, { type: "azure-native:scvmm/v20230401preview:VmmServer" }] };
...
export interface VmmServerArgs {
     ...
     * Credentials to connect to VMMServer.
     */
    credentials?: pulumi.Input<types.inputs.scvmm.v20220521preview.VMMServerPropertiesCredentialsArgs>;
    /**
     * The extended location.
     */

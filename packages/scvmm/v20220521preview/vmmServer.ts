...
export class VmmServer extends pulumi.CustomResource {
    ...
    constructor(name: string, args: VmmServerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:scvmm:VmmServer" }, { type: "azure-native:scvmm/v20200605preview:VmmServer" }, { type: "azure-native:scvmm/v20230401preview:VmmServer" }, { type: "azure-native:scvmm/v20231007:VmmServer" }] };

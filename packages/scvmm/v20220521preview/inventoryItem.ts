...
export class InventoryItem extends pulumi.CustomResource {
    ...
    constructor(name: string, args: InventoryItemArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:scvmm:InventoryItem" }, { type: "azure-native:scvmm/v20200605preview:InventoryItem" }, { type: "azure-native:scvmm/v20230401preview:InventoryItem" }, { type: "azure-native:scvmm/v20231007:InventoryItem" }] };

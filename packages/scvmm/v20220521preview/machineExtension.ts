...
export class MachineExtension extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:scvmm/v20220521preview:MachineExtension';
     ...
     */
    public /*out*/ readonly instanceView!: pulumi.Output<types.outputs.scvmm.v20220521preview.MachineExtensionPropertiesResponseInstanceView | undefined>;
    /**
    ...
    constructor(name: string, args: MachineExtensionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:scvmm:MachineExtension" }, { type: "azure-native:scvmm/v20230401preview:MachineExtension" }] };

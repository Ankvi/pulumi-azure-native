...
export class GuestAgent extends pulumi.CustomResource {
     ...
     */
    public readonly credentials!: pulumi.Output<types.outputs.scvmm.v20220521preview.GuestCredentialResponse | undefined>;
    /**
     ...
     */
    public readonly httpProxyConfig!: pulumi.Output<types.outputs.scvmm.v20220521preview.HttpProxyConfigurationResponse | undefined>;
    /**
...
export interface GuestAgentArgs {
     ...
     * Username / Password Credentials to provision guest agent.
     */
    credentials?: pulumi.Input<types.inputs.scvmm.v20220521preview.GuestCredentialArgs>;
    /**
     ...
     * HTTP Proxy configuration for the VM.
     */
    httpProxyConfig?: pulumi.Input<types.inputs.scvmm.v20220521preview.HttpProxyConfigurationArgs>;
    /**
     * Gets or sets the guest agent provisioning action.
     */
    provisioningAction?: pulumi.Input<string | types.enums.v20220521preview.ProvisioningAction>;
    /**

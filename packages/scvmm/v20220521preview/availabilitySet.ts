...
export class AvailabilitySet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:scvmm/v20220521preview:AvailabilitySet';
     ...
     */
    public readonly extendedLocation!: pulumi.Output<types.outputs.scvmm.v20220521preview.ExtendedLocationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: AvailabilitySetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:scvmm:AvailabilitySet" }, { type: "azure-native:scvmm/v20200605preview:AvailabilitySet" }, { type: "azure-native:scvmm/v20230401preview:AvailabilitySet" }] };

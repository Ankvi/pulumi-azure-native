...
export function getMachineExtension(args: GetMachineExtensionArgs, opts?: pulumi.InvokeOptions): Promise<GetMachineExtensionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:scvmm/v20220521preview:getMachineExtension", {
...
export interface GetMachineExtensionResult {
     ...
     */
    readonly instanceView?: types.outputs.scvmm.v20220521preview.MachineExtensionPropertiesResponseInstanceView;
    /**

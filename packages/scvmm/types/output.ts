...
export namespace scvmm {
    ...
    export namespace v20220521preview {
        ...
        export interface ErrorDetailResponse {
             ...
             * The error additional info.
             */
            additionalInfo: v20220521preview.ErrorAdditionalInfoResponse[];
            /**
             * The error code.
             */
            code: string;
             ...
             * The error details.
             */
            details: v20220521preview.ErrorDetailResponse[];
            /**
             * The error message.
             */
            message: string;
        ...
        export interface GuestAgentProfileResponse {
             ...
             * Details about the error state.
             */
            errorDetails: v20220521preview.ErrorDetailResponse[];
            /**
             * The time of the last status change.
             */
            lastStatusChange: string;
        ...
        export interface MachineExtensionPropertiesResponseInstanceView {
             ...
             * Instance view status.
             */
            status?: v20220521preview.MachineExtensionInstanceViewResponseStatus;
            /**
             * Specifies the type of the extension; an example is "CustomScriptExtension".
             */
            type: string;
        ...
        export interface NetworkProfileResponse {
             ...
             * Gets or sets the list of network interfaces associated with the virtual machine.
             */
            networkInterfaces?: v20220521preview.NetworkInterfacesResponse[];
        }
        ...
        export interface StorageProfileResponse {
             ...
             * Gets or sets the list of virtual disks associated with the virtual machine.
             */
            disks?: v20220521preview.VirtualDiskResponse[];
        }
        ...
        export interface VirtualDiskResponse {
             ...
             * The QoS policy for the disk.
             */
            storageQoSPolicy?: v20220521preview.StorageQoSPolicyDetailsResponse;
            /**
             * Gets or sets the disk id in the template.
             */
            templateDiskId?: string;
    ...
    export namespace v20230401preview {
        ...
        export interface ErrorDetailResponse {
             ...
             * The error additional info.
             */
            additionalInfo: v20230401preview.ErrorAdditionalInfoResponse[];
            /**
             * The error code.
             */
            code: string;
             ...
             * The error details.
             */
            details: v20230401preview.ErrorDetailResponse[];
            /**
             * The error message.
             */
            message: string;
        ...
        export interface GuestAgentProfileResponse {
             ...
             * Details about the error state.
             */
            errorDetails: v20230401preview.ErrorDetailResponse[];
            /**
             * The time of the last status change.
             */
            lastStatusChange: string;
        ...
        export interface InfrastructureProfileResponse {
             ...
             * Checkpoints in the vm.
             */
            checkpoints?: v20230401preview.CheckpointResponse[];
            /**
             * ARM Id of the cloud resource to use for deploying the vm.
             */
            cloudId?: string;
             ...
             * Last restored checkpoint in the vm.
             */
            lastRestoredVMCheckpoint: v20230401preview.CheckpointResponse;
            /**
             * ARM Id of the template resource to use for deploying the vm.
             */
            templateId?: string;
        ...
        export interface MachineExtensionPropertiesResponseInstanceView {
             ...
             * Instance view status.
             */
            status?: v20230401preview.MachineExtensionInstanceViewResponseStatus;
            /**
             * Specifies the type of the extension; an example is "CustomScriptExtension".
             */
            type: string;
        ...
        export interface NetworkProfileResponse {
             ...
             * Gets or sets the list of network interfaces associated with the virtual machine.
             */
            networkInterfaces?: v20230401preview.NetworkInterfacesResponse[];
        }
        ...
        export interface StorageProfileResponse {
             ...
             * Gets or sets the list of virtual disks associated with the virtual machine.
             */
            disks?: v20230401preview.VirtualDiskResponse[];
        }
        ...
        export interface VirtualDiskResponse {
             ...
             * The QoS policy for the disk.
             */
            storageQoSPolicy?: v20230401preview.StorageQoSPolicyDetailsResponse;
            /**
             * Gets or sets the disk id in the template.
             */
            templateDiskId?: string;

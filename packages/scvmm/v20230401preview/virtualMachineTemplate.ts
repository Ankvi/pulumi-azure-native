...
export class VirtualMachineTemplate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:scvmm/v20230401preview:VirtualMachineTemplate';
     ...
     */
    public /*out*/ readonly disks!: pulumi.Output<types.outputs.scvmm.v20230401preview.VirtualDiskResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly networkInterfaces!: pulumi.Output<types.outputs.scvmm.v20230401preview.NetworkInterfacesResponse[]>;
    /**
    ...
    constructor(name: string, args: VirtualMachineTemplateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:scvmm:VirtualMachineTemplate" }, { type: "azure-native:scvmm/v20200605preview:VirtualMachineTemplate" }, { type: "azure-native:scvmm/v20220521preview:VirtualMachineTemplate" }] };

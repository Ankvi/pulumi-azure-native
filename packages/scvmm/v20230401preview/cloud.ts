...
export class Cloud extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly cloudCapacity!: pulumi.Output<types.outputs.scvmm.v20230401preview.CloudCapacityResponse>;
    /**
     ...
     */
    public /*out*/ readonly storageQoSPolicies!: pulumi.Output<types.outputs.scvmm.v20230401preview.StorageQoSPolicyResponse[]>;
    /**
     * The system data.
     */
    ...
    constructor(name: string, args: CloudArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:scvmm:Cloud" }, { type: "azure-native:scvmm/v20200605preview:Cloud" }, { type: "azure-native:scvmm/v20220521preview:Cloud" }] };

...
export class Cloud extends pulumi.CustomResource {
    ...
    constructor(name: string, args: CloudArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:scvmm:Cloud" }, { type: "azure-native:scvmm/v20200605preview:Cloud" }, { type: "azure-native:scvmm/v20220521preview:Cloud" }, { type: "azure-native:scvmm/v20231007:Cloud" }] };

...
export function getVmmServer(args: GetVmmServerArgs, opts?: pulumi.InvokeOptions): Promise<GetVmmServerResult> {
    ...
    return pulumi.runtime.invoke("azure-native:scvmm/v20230401preview:getVmmServer", {
...
export interface GetVmmServerResult {
     ...
     */
    readonly credentials?: types.outputs.scvmm.v20230401preview.VMMServerPropertiesResponseCredentials;
    /**

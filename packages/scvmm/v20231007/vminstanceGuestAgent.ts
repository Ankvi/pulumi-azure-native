...
export class VMInstanceGuestAgent extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:scvmm/v20231007:VMInstanceGuestAgent';
    ...
    constructor(name: string, args: VMInstanceGuestAgentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:scvmm:VMInstanceGuestAgent" }, { type: "azure-native:scvmm/v20230401preview:VMInstanceGuestAgent" }] };

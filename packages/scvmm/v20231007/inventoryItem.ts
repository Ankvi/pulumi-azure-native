...
export class InventoryItem extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:scvmm/v20231007:InventoryItem';
    ...
    constructor(name: string, args: InventoryItemArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["inventoryItemResourceName"] = args ? args.inventoryItemResourceName : undefined;

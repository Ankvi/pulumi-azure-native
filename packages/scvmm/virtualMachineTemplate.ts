...
export class VirtualMachineTemplate extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly networkInterfaces: pulumi.Output<types.outputs.NetworkInterfacesResponse[]>;
    /**

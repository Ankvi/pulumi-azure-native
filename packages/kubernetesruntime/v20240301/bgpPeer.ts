...
export class BgpPeer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:kubernetesruntime/v20240301:BgpPeer';
    ...
    constructor(name: string, args: BgpPeerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:kubernetesruntime:BgpPeer" }, { type: "azure-native:kubernetesruntime/v20231001preview:BgpPeer" }] };

...
export class StorageClass extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:kubernetesruntime/v20240301:StorageClass';
    ...
    constructor(name: string, args: StorageClassArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:kubernetesruntime:StorageClass" }, { type: "azure-native:kubernetesruntime/v20231001preview:StorageClass" }] };

...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:kubernetesruntime/v20240301:BgpPeer":
                return new BgpPeer(name, <any>undefined, { urn })
            case "azure-native:kubernetesruntime/v20240301:LoadBalancer":
                return new LoadBalancer(name, <any>undefined, { urn })
            case "azure-native:kubernetesruntime/v20240301:Service":
                return new Service(name, <any>undefined, { urn })
            case "azure-native:kubernetesruntime/v20240301:StorageClass":
...
pulumi.runtime.registerResourceModule("azure-native", "kubernetesruntime/v20240301", _module)
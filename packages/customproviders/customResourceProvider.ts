...
export class CustomResourceProvider extends pulumi.CustomResource {
     ...
     */
    declare public readonly actions: pulumi.Output<types.outputs.CustomRPActionRouteDefinitionResponse[] | undefined>;
    /**
     ...
     */
    declare public readonly resourceTypes: pulumi.Output<types.outputs.CustomRPResourceTypeRouteDefinitionResponse[] | undefined>;
    /**
     * Resource tags
     */
     ...
     */
    declare public readonly validations: pulumi.Output<types.outputs.CustomRPValidationsResponse[] | undefined>;

...
export class BatchAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:batch/v20231101:BatchAccount';

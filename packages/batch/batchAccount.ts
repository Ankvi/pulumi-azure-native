...
export class BatchAccount extends pulumi.CustomResource {
     ...
     */
    declare public readonly autoStorage: pulumi.Output<types.outputs.AutoStoragePropertiesResponse>;
    /**
     ...
     */
    declare public /*out*/ readonly dedicatedCoreQuotaPerVMFamily: pulumi.Output<types.outputs.VirtualMachineFamilyCoreQuotaResponse[]>;
    /**
     ...
     */
    declare public readonly encryption: pulumi.Output<types.outputs.EncryptionPropertiesResponse>;
    /**
     * The identity of the Batch account.
     */
    declare public readonly identity: pulumi.Output<types.outputs.BatchAccountIdentityResponse | undefined>;
    /**
     * Identifies the Azure key vault associated with a Batch account.
     */
    declare public readonly keyVaultReference: pulumi.Output<types.outputs.KeyVaultReferenceResponse>;
    /**

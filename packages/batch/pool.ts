...
export class Pool extends pulumi.CustomResource {
     ...
     */
    declare public readonly applicationLicenses: pulumi.Output<string[] | undefined>;
    /**
     * Changes to application package references affect all new compute nodes joining the pool, but do not affect compute nodes that are already in the pool until they are rebooted or reimaged. There is a maximum of 10 application package references on any given pool.
     */
    declare public readonly applicationPackages: pulumi.Output<types.outputs.ApplicationPackageReferenceResponse[] | undefined>;
    /**
     * This property is set only if the pool automatically scales, i.e. autoScaleSettings are used.
     */
    declare public /*out*/ readonly autoScaleRun: pulumi.Output<types.outputs.AutoScaleRunResponse>;
    /**
     ...
     */
    declare public readonly identity: pulumi.Output<types.outputs.BatchPoolIdentityResponse | undefined>;
    /**
     ...
     */
    declare public readonly metadata: pulumi.Output<types.outputs.MetadataItemResponse[] | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly resizeOperationStatus: pulumi.Output<types.outputs.ResizeOperationStatusResponse>;
    /**
     ...
     */
    declare public readonly scaleSettings: pulumi.Output<types.outputs.ScaleSettingsResponse | undefined>;
    /**
     ...
     */
    declare public readonly taskSchedulingPolicy: pulumi.Output<types.outputs.TaskSchedulingPolicyResponse | undefined>;
    /**

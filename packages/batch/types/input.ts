...
export namespace batch {
    ...
    export interface DeploymentConfigurationArgs {
         ...
         */
        cloudServiceConfiguration?: pulumi.Input<CloudServiceConfigurationArgs>;
        /**
    ...
    export namespace v20220101 {
        ...
        export interface AutoStorageBasePropertiesArgs {
             ...
             * The authentication mode which the Batch service will use to manage the auto-storage account.
             */
            authenticationMode?: pulumi.Input<enums.v20220101.AutoStorageAuthenticationMode>;
            /**
             * The identity referenced here must be assigned to pools which have compute nodes that need access to auto-storage.
             */
            nodeIdentityReference?: pulumi.Input<v20220101.ComputeNodeIdentityReferenceArgs>;
            /**
             * The resource ID of the storage account to be used for auto-storage account.
             */
            storageAccountId: pulumi.Input<string>;
        ...
        export interface BatchAccountIdentityArgs {
             ...
             * The type of identity used for the Batch account.
             */
            type: pulumi.Input<enums.v20220101.ResourceIdentityType>;
            /**
             * The list of user identities associated with the Batch account.
             */
            userAssignedIdentities?: pulumi.Input<pulumi.Input<string>[]>;
        ...
        export interface EncryptionPropertiesArgs {
             ...
             * Type of the key source.
             */
            keySource?: pulumi.Input<enums.v20220101.KeySource>;
            /**
             * Additional details when using Microsoft.KeyVault
             */
            keyVaultProperties?: pulumi.Input<v20220101.KeyVaultPropertiesArgs>;
        }
    ...
    export namespace v20230501 {
        ...
        export interface AutoStorageBasePropertiesArgs {
             ...
             * The authentication mode which the Batch service will use to manage the auto-storage account.
             */
            authenticationMode?: pulumi.Input<enums.v20230501.AutoStorageAuthenticationMode>;
            /**
             * The identity referenced here must be assigned to pools which have compute nodes that need access to auto-storage.
             */
            nodeIdentityReference?: pulumi.Input<v20230501.ComputeNodeIdentityReferenceArgs>;
            /**
             * The resource ID of the storage account to be used for auto-storage account.
             */
            storageAccountId: pulumi.Input<string>;
        ...
        export interface AutoUserSpecificationArgs {
             ...
             * The default value is nonAdmin.
             */
            elevationLevel?: pulumi.Input<enums.v20230501.ElevationLevel>;
            /**
             * The default value is Pool. If the pool is running Windows a value of Task should be specified if stricter isolation between tasks is required. For example, if the task mutates the registry in a way which could impact other tasks, or if certificates have been specified on the pool which should not be accessible by normal tasks but should be accessible by start tasks.
             */
            scope?: pulumi.Input<enums.v20230501.AutoUserScope>;
        }
        ...
        export interface AzureBlobFileSystemConfigurationArgs {
             ...
             * This property is mutually exclusive with both accountKey and sasKey; exactly one must be specified.
             */
            identityReference?: pulumi.Input<v20230501.ComputeNodeIdentityReferenceArgs>;
            /**
             * All file systems are mounted relative to the Batch mounts directory, accessible via the AZ_BATCH_NODE_MOUNTS_DIR environment variable.
             */
            relativeMountPath: pulumi.Input<string>;
        ...
        export interface BatchPoolIdentityArgs {
             ...
             * The type of identity used for the Batch Pool.
             */
            type: pulumi.Input<enums.v20230501.PoolIdentityType>;
            /**
             * The list of user identities associated with the Batch pool.
             */
            userAssignedIdentities?: pulumi.Input<pulumi.Input<string>[]>;
        ...
        export interface CertificateReferenceArgs {
             ...
             * The default value is currentUser. This property is applicable only for pools configured with Windows nodes (that is, created with cloudServiceConfiguration, or with virtualMachineConfiguration using a Windows image reference). For Linux compute nodes, the certificates are stored in a directory inside the task working directory and an environment variable AZ_BATCH_CERTIFICATES_DIR is supplied to the task to query for this location. For certificates with visibility of 'remoteUser', a 'certs' directory is created in the user's home directory (e.g., /home/{user-name}/certs) and certificates are placed in that directory.
             */
            storeLocation?: pulumi.Input<enums.v20230501.CertificateStoreLocation>;
            /**
             * This property is applicable only for pools configured with Windows nodes (that is, created with cloudServiceConfiguration, or with virtualMachineConfiguration using a Windows image reference). Common store names include: My, Root, CA, Trust, Disallowed, TrustedPeople, TrustedPublisher, AuthRoot, AddressBook, but any custom store name can also be used. The default value is My.
             */
            storeName?: pulumi.Input<string>;
            visibility?: pulumi.Input<pulumi.Input<enums.v20230501.CertificateVisibility>[]>;
        }
        ...
        export interface ContainerConfigurationArgs {
             ...
             * If any images must be downloaded from a private registry which requires credentials, then those credentials must be provided here.
             */
            containerRegistries?: pulumi.Input<pulumi.Input<v20230501.ContainerRegistryArgs>[]>;
            type: pulumi.Input<string | enums.v20230501.ContainerType>;
        }
        ...
        export interface DataDiskArgs {
             ...
             *  The default value for caching is none. For information about the caching options see: https://blogs.msdn.microsoft.com/windowsazurestorage/2012/06/27/exploring-windows-azure-drives-disks-and-images/.
             */
            caching?: pulumi.Input<enums.v20230501.CachingType>;
            diskSizeGB: pulumi.Input<number>;
            /**
             * The lun is used to uniquely identify each data disk. If attaching multiple disks, each should have a distinct lun. The value must be between 0 and 63, inclusive.
             */
             ...
             *  Premium_LRS - The data disk should use premium locally redundant storage.
             */
            storageAccountType?: pulumi.Input<enums.v20230501.StorageAccountType>;
        }
        ...
        export interface DeploymentConfigurationArgs {
             ...
             * This property and virtualMachineConfiguration are mutually exclusive and one of the properties must be specified. This property cannot be specified if the Batch account was created with its poolAllocationMode property set to 'UserSubscription'.
             */
            cloudServiceConfiguration?: pulumi.Input<v20230501.CloudServiceConfigurationArgs>;
            /**
             * This property and cloudServiceConfiguration are mutually exclusive and one of the properties must be specified.
             */
            virtualMachineConfiguration?: pulumi.Input<v20230501.VirtualMachineConfigurationArgs>;
        }
        ...
        export interface DiffDiskSettingsArgs {
             ...
             * This property can be used by user in the request to choose which location the operating system should be in. e.g., cache disk space for Ephemeral OS disk provisioning. For more information on Ephemeral OS disk size requirements, please refer to Ephemeral OS disk size requirements for Windows VMs at https://docs.microsoft.com/en-us/azure/virtual-machines/windows/ephemeral-os-disks#size-requirements and Linux VMs at https://docs.microsoft.com/en-us/azure/virtual-machines/linux/ephemeral-os-disks#size-requirements.
             */
            placement?: pulumi.Input<enums.v20230501.DiffDiskPlacement>;
        }
        ...
        export interface DiskEncryptionConfigurationArgs {
             ...
             * On Linux pool, only "TemporaryDisk" is supported; on Windows pool, "OsDisk" and "TemporaryDisk" must be specified.
             */
            targets?: pulumi.Input<pulumi.Input<enums.v20230501.DiskEncryptionTarget>[]>;
        }
        ...
        export interface EncryptionPropertiesArgs {
             ...
             * Type of the key source.
             */
            keySource?: pulumi.Input<enums.v20230501.KeySource>;
            /**
             * Additional details when using Microsoft.KeyVault
             */
        ...
        export interface EndpointAccessProfileArgs {
             ...
             * Default action for endpoint access. It is only applicable when publicNetworkAccess is enabled.
             */
            defaultAction: pulumi.Input<enums.v20230501.EndpointAccessDefaultAction>;
            /**
             * Array of IP ranges to filter client IP address.
             */
        ...
        export interface FixedScaleSettingsArgs {
             ...
             * If omitted, the default value is Requeue.
             */
            nodeDeallocationOption?: pulumi.Input<enums.v20230501.ComputeNodeDeallocationOption>;
            /**
             * The default value is 15 minutes. Timeout values use ISO 8601 format. For example, use PT10M for 10 minutes. The minimum value is 5 minutes. If you specify a value less than 5 minutes, the Batch service rejects the request with an error; if you are calling the REST API directly, the HTTP status code is 400 (Bad Request).
             */
            resizeTimeout?: pulumi.Input<string>;
        ...
        export interface IPRuleArgs {
             ...
             * Action when client IP address is matched.
             */
            action: pulumi.Input<enums.v20230501.IPRuleAction>;
            /**
             * IPv4 address, or IPv4 address range in CIDR format.
             */
            value: pulumi.Input<string>;
        ...
        export interface InboundNatPoolArgs {
             ...
             * The maximum number of rules that can be specified across all the endpoints on a Batch pool is 25. If no network security group rules are specified, a default rule will be created to allow inbound access to the specified backendPort. If the maximum number of network security group rules is exceeded the request fails with HTTP status code 400.
             */
            networkSecurityGroupRules?: pulumi.Input<pulumi.Input<v20230501.NetworkSecurityGroupRuleArgs>[]>;
            protocol: pulumi.Input<enums.v20230501.InboundEndpointProtocol>;
        }
        ...
        export interface MountConfigurationArgs {
             ...
             * This property is mutually exclusive with all other properties.
             */
            azureBlobFileSystemConfiguration?: pulumi.Input<v20230501.AzureBlobFileSystemConfigurationArgs>;
            /**
             * This property is mutually exclusive with all other properties.
             */
            azureFileShareConfiguration?: pulumi.Input<v20230501.AzureFileShareConfigurationArgs>;
            /**
             * This property is mutually exclusive with all other properties.
             */
            cifsMountConfiguration?: pulumi.Input<v20230501.CIFSMountConfigurationArgs>;
            /**
             * This property is mutually exclusive with all other properties.
             */
            nfsMountConfiguration?: pulumi.Input<v20230501.NFSMountConfigurationArgs>;
        }
         ...
         */
        export interface NetworkConfigurationArgs {
            dynamicVnetAssignmentScope?: pulumi.Input<enums.v20230501.DynamicVNetAssignmentScope>;
            /**
             * Accelerated networking enables single root I/O virtualization (SR-IOV) to a VM, which may lead to improved networking performance. For more details, see: https://learn.microsoft.com/azure/virtual-network/accelerated-networking-overview.
             */
            enableAcceleratedNetworking?: pulumi.Input<boolean>;
             ...
             * Pool endpoint configuration is only supported on pools with the virtualMachineConfiguration property.
             */
            endpointConfiguration?: pulumi.Input<v20230501.PoolEndpointConfigurationArgs>;
            /**
             * This property is only supported on Pools with the virtualMachineConfiguration property.
             */
            publicIPAddressConfiguration?: pulumi.Input<v20230501.PublicIPAddressConfigurationArgs>;
            /**
             * The virtual network must be in the same region and subscription as the Azure Batch account. The specified subnet should have enough free IP addresses to accommodate the number of nodes in the pool. If the subnet doesn't have enough free IP addresses, the pool will partially allocate compute nodes and a resize error will occur. The 'MicrosoftAzureBatch' service principal must have the 'Classic Virtual Machine Contributor' Role-Based Access Control (RBAC) role for the specified VNet. The specified subnet must allow communication from the Azure Batch service to be able to schedule tasks on the compute nodes. This can be verified by checking if the specified VNet has any associated Network Security Groups (NSG). If communication to the compute nodes in the specified subnet is denied by an NSG, then the Batch service will set the state of the compute nodes to unusable. If the specified VNet has any associated Network Security Groups (NSG), then a few reserved system ports must be enabled for inbound communication. For pools created with a virtual machine configuration, enable ports 29876 and 29877, as well as port 22 for Linux and port 3389 for Windows. For pools created with a cloud service configuration, enable ports 10100, 20100, and 30100. Also enable outbound connections to Azure Storage on port 443. For cloudServiceConfiguration pools, only 'classic' VNETs are supported. For more details see: https://docs.microsoft.com/en-us/azure/batch/batch-api-basics#virtual-network-vnet-and-firewall-configuration
             */
            subnetId?: pulumi.Input<string>;
        ...
        export interface NetworkProfileArgs {
             ...
             * Network access profile for batchAccount endpoint (Batch account data plane API).
             */
            accountAccess?: pulumi.Input<v20230501.EndpointAccessProfileArgs>;
            /**
             * Network access profile for nodeManagement endpoint (Batch service managing compute nodes for Batch pools).
             */
            nodeManagementAccess?: pulumi.Input<v20230501.EndpointAccessProfileArgs>;
        }

        export interface NetworkSecurityGroupRuleArgs {
            access: pulumi.Input<enums.v20230501.NetworkSecurityGroupRuleAccess>;
            /**
             * Priorities within a pool must be unique and are evaluated in order of priority. The lower the number the higher the priority. For example, rules could be specified with order numbers of 150, 250, and 350. The rule with the order number of 150 takes precedence over the rule that has an order of 250. Allowed priorities are 150 to 4096. If any reserved or duplicate values are provided the request fails with HTTP status code 400.
             */
            priority: pulumi.Input<number>;
        ...
        export interface NodePlacementConfigurationArgs {
             ...
             * Allocation policy used by Batch Service to provision the nodes. If not specified, Batch will use the regional policy.
             */
            policy?: pulumi.Input<enums.v20230501.NodePlacementPolicyType>;
        }

        export interface OSDiskArgs {
            ephemeralOSDiskSettings?: pulumi.Input<v20230501.DiffDiskSettingsArgs>;
        }
        ...
        export interface PoolEndpointConfigurationArgs {
             ...
             * The maximum number of inbound NAT pools per Batch pool is 5. If the maximum number of inbound NAT pools is exceeded the request fails with HTTP status code 400. This cannot be specified if the IPAddressProvisioningType is NoPublicIPAddresses.
             */
            inboundNatPools: pulumi.Input<pulumi.Input<v20230501.InboundNatPoolArgs>[]>;
        }
        ...
        export interface PublicIPAddressConfigurationArgs {
             ...
             * The default value is BatchManaged
             */
            provision?: pulumi.Input<enums.v20230501.IPAddressProvisioningType>;
        }
        ...
        export interface ScaleSettingsArgs {
             ...
             * This property and fixedScale are mutually exclusive and one of the properties must be specified.
             */
            autoScale?: pulumi.Input<v20230501.AutoScaleSettingsArgs>;
            /**
             * This property and autoScale are mutually exclusive and one of the properties must be specified.
             */
            fixedScale?: pulumi.Input<v20230501.FixedScaleSettingsArgs>;
        }
        ...
        export interface StartTaskArgs {
             ...
             * When this is specified, all directories recursively below the AZ_BATCH_NODE_ROOT_DIR (the root of Azure Batch directories on the node) are mapped into the container, all task environment variables are mapped into the container, and the task command line is executed in the container.
             */
            containerSettings?: pulumi.Input<v20230501.TaskContainerSettingsArgs>;
            environmentSettings?: pulumi.Input<pulumi.Input<v20230501.EnvironmentSettingArgs>[]>;
            /**
             * The Batch service retries a task if its exit code is nonzero. Note that this value specifically controls the number of retries. The Batch service will try the task once, and may then retry up to this limit. For example, if the maximum retry count is 3, Batch tries the task up to 4 times (one initial try and 3 retries). If the maximum retry count is 0, the Batch service does not retry the task. If the maximum retry count is -1, the Batch service retries the task without limit.
             */
            maxTaskRetryCount?: pulumi.Input<number>;
            resourceFiles?: pulumi.Input<pulumi.Input<v20230501.ResourceFileArgs>[]>;
            /**
             * If omitted, the task runs as a non-administrative user unique to the task.
             */
            userIdentity?: pulumi.Input<v20230501.UserIdentityArgs>;
            /**
             * If true and the start task fails on a compute node, the Batch service retries the start task up to its maximum retry count (maxTaskRetryCount). If the task has still not completed successfully after all retries, then the Batch service marks the compute node unusable, and will not schedule tasks to it. This condition can be detected via the node state and scheduling error detail. If false, the Batch service will not wait for the start task to complete. In this case, other tasks can start executing on the compute node while the start task is still running; and even if the start task fails, new tasks will continue to be scheduled on the node. The default is true.
             */
            waitForSuccess?: pulumi.Input<boolean>;
        ...
        export interface TaskContainerSettingsArgs {
             ...
             * This setting can be omitted if was already provided at pool creation.
             */
            registry?: pulumi.Input<v20230501.ContainerRegistryArgs>;
            workingDirectory?: pulumi.Input<enums.v20230501.ContainerWorkingDirectory>;
        }

        export interface TaskSchedulingPolicyArgs {
            nodeFillType: pulumi.Input<enums.v20230501.ComputeNodeFillType>;
        }
        ...
        export interface UserAccountArgs {
             ...
             * This property is ignored if specified on a Windows pool. If not specified, the user is created with the default options.
             */
            linuxUserConfiguration?: pulumi.Input<v20230501.LinuxUserConfigurationArgs>;
            name: pulumi.Input<string>;
            password: pulumi.Input<string>;
            /**
             * This property can only be specified if the user is on a Windows pool. If not specified and on a Windows pool, the user is created with the default options.
             */
            windowsUserConfiguration?: pulumi.Input<v20230501.WindowsUserConfigurationArgs>;
        }
        ...
        export interface UserIdentityArgs {
             ...
             * The userName and autoUser properties are mutually exclusive; you must specify one but not both.
             */
            autoUser?: pulumi.Input<v20230501.AutoUserSpecificationArgs>;
            /**
             * The userName and autoUser properties are mutually exclusive; you must specify one but not both.
             */
            userName?: pulumi.Input<string>;
        ...
        export interface VirtualMachineConfigurationArgs {
             ...
             * If specified, setup is performed on each node in the pool to allow tasks to run in containers. All regular tasks and job manager tasks run on this pool must specify the containerSettings property, and all other tasks may specify it.
             */
            containerConfiguration?: pulumi.Input<v20230501.ContainerConfigurationArgs>;
            /**
             * This property must be specified if the compute nodes in the pool need to have empty data disks attached to them.
             */
            dataDisks?: pulumi.Input<pulumi.Input<v20230501.DataDiskArgs>[]>;
            /**
             * If specified, encryption is performed on each node in the pool during node provisioning.
             */
            diskEncryptionConfiguration?: pulumi.Input<v20230501.DiskEncryptionConfigurationArgs>;
            /**
             * If specified, the extensions mentioned in this configuration will be installed on each node.
             */
            extensions?: pulumi.Input<pulumi.Input<v20230501.VMExtensionArgs>[]>;
            imageReference: pulumi.Input<v20230501.ImageReferenceArgs>;
            /**
             * This only applies to images that contain the Windows operating system, and should only be used when you hold valid on-premises licenses for the nodes which will be deployed. If omitted, no on-premises licensing discount is applied. Values are:
             *
             *  Windows_Server - The on-premises license is for Windows Server.
             ...
             * This configuration will specify rules on how nodes in the pool will be physically allocated.
             */
            nodePlacementConfiguration?: pulumi.Input<v20230501.NodePlacementConfigurationArgs>;
            /**
             * Contains configuration for ephemeral OSDisk settings.
             */
            osDisk?: pulumi.Input<v20230501.OSDiskArgs>;
            /**
             * This property must not be specified if the imageReference specifies a Linux OS image.
             */
            windowsConfiguration?: pulumi.Input<v20230501.WindowsConfigurationArgs>;
        }
        ...
        export interface WindowsUserConfigurationArgs {
             ...
             * Specifies login mode for the user. The default value for VirtualMachineConfiguration pools is interactive mode and for CloudServiceConfiguration pools is batch mode.
             */
            loginMode?: pulumi.Input<enums.v20230501.LoginMode>;
        }

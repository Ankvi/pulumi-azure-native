...
export interface GetBatchAccountResult {
     ...
     */
    readonly autoStorage: types.outputs.batch.v20220101.AutoStoragePropertiesResponse;
    /**
     ...
     */
    readonly dedicatedCoreQuotaPerVMFamily: types.outputs.batch.v20220101.VirtualMachineFamilyCoreQuotaResponse[];
    /**
     ...
     */
    readonly encryption: types.outputs.batch.v20220101.EncryptionPropertiesResponse;
    /**
     ...
     */
    readonly identity?: types.outputs.batch.v20220101.BatchAccountIdentityResponse;
    /**
     * Identifies the Azure key vault associated with a Batch account.
     */
    readonly keyVaultReference: types.outputs.batch.v20220101.KeyVaultReferenceResponse;
    /**
     ...
     */
    readonly privateEndpointConnections: types.outputs.batch.v20220101.PrivateEndpointConnectionResponse[];
    /**

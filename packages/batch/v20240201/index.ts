...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:batch/v20240201:Application":
                return new Application(name, <any>undefined, { urn })
            case "azure-native:batch/v20240201:ApplicationPackage":
                return new ApplicationPackage(name, <any>undefined, { urn })
            case "azure-native:batch/v20240201:BatchAccount":
                return new BatchAccount(name, <any>undefined, { urn })
            case "azure-native:batch/v20240201:Pool":
...
pulumi.runtime.registerResourceModule("azure-native", "batch/v20240201", _module)
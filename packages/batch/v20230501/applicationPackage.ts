...
export class ApplicationPackage extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:batch/v20230501:ApplicationPackage';

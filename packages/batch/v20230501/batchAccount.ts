...
export class BatchAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:batch/v20230501:BatchAccount';
     ...
     */
    public readonly autoStorage!: pulumi.Output<types.outputs.batch.v20230501.AutoStoragePropertiesResponse>;
    /**
     ...
     */
    public /*out*/ readonly dedicatedCoreQuotaPerVMFamily!: pulumi.Output<types.outputs.batch.v20230501.VirtualMachineFamilyCoreQuotaResponse[]>;
    /**
     ...
     */
    public readonly encryption!: pulumi.Output<types.outputs.batch.v20230501.EncryptionPropertiesResponse>;
    /**
     * The identity of the Batch account.
     */
    public readonly identity!: pulumi.Output<types.outputs.batch.v20230501.BatchAccountIdentityResponse | undefined>;
    /**
     * Identifies the Azure key vault associated with a Batch account.
     */
    public readonly keyVaultReference!: pulumi.Output<types.outputs.batch.v20230501.KeyVaultReferenceResponse>;
    /**
     ...
     */
    public readonly networkProfile!: pulumi.Output<types.outputs.batch.v20230501.NetworkProfileResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<types.outputs.batch.v20230501.PrivateEndpointConnectionResponse[]>;
    /**
    ...
    constructor(name: string, args: BatchAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["autoStorage"] = args ? (args.autoStorage ? pulumi.output(args.autoStorage).apply(types.inputs.batch.v20230501.autoStorageBasePropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface BatchAccountArgs {
     ...
     * List of allowed authentication modes for the Batch account that can be used to authenticate with the data plane. This does not affect authentication with the control plane.
     */
    allowedAuthenticationModes?: pulumi.Input<pulumi.Input<types.enums.v20230501.AuthenticationMode>[]>;
    /**
     * The properties related to the auto-storage account.
     */
    autoStorage?: pulumi.Input<types.inputs.batch.v20230501.AutoStorageBasePropertiesArgs>;
    /**
     * Configures how customer data is encrypted inside the Batch account. By default, accounts are encrypted using a Microsoft managed key. For additional control, a customer-managed key can be used instead.
     */
    encryption?: pulumi.Input<types.inputs.batch.v20230501.EncryptionPropertiesArgs>;
    /**
     * The identity of the Batch account.
     */
    identity?: pulumi.Input<types.inputs.batch.v20230501.BatchAccountIdentityArgs>;
    /**
     * A reference to the Azure key vault associated with the Batch account.
     */
    keyVaultReference?: pulumi.Input<types.inputs.batch.v20230501.KeyVaultReferenceArgs>;
    /**
     ...
     * The network profile only takes effect when publicNetworkAccess is enabled.
     */
    networkProfile?: pulumi.Input<types.inputs.batch.v20230501.NetworkProfileArgs>;
    /**
     * The pool allocation mode also affects how clients may authenticate to the Batch Service API. If the mode is BatchService, clients may authenticate using access keys or Azure Active Directory. If the mode is UserSubscription, clients must use Azure Active Directory. The default is BatchService.
     */
    poolAllocationMode?: pulumi.Input<types.enums.v20230501.PoolAllocationMode>;
    /**
     * If not specified, the default value is 'enabled'.
     */
    publicNetworkAccess?: pulumi.Input<types.enums.v20230501.PublicNetworkAccessType>;
    /**

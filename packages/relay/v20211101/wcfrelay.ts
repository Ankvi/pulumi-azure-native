...
export class WCFRelay extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:relay/v20211101:WCFRelay';
    ...
    constructor(name: string, args: WCFRelayArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:relay:WCFRelay" }, { type: "azure-native:relay/v20160701:WCFRelay" }, { type: "azure-native:relay/v20170401:WCFRelay" }] };
...
export interface WCFRelayArgs {
     ...
     * WCF relay type.
     */
    relayType?: pulumi.Input<types.enums.v20211101.Relaytype>;
    /**
     * Returns true if client authorization is needed for this relay; otherwise, false.
     */

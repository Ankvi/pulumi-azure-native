...
export class PrivateEndpointConnection extends pulumi.CustomResource {
     ...
     */
    public readonly privateEndpoint!: pulumi.Output<types.outputs.relay.PrivateEndpointResponse | undefined>;
    /**
     * Details about the state of the connection.
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<types.outputs.relay.ConnectionStateResponse | undefined>;
    /**
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:relay/v20180101preview:PrivateEndpointConnection" }, { type: "azure-native:relay/v20211101:PrivateEndpointConnection" }] };
...
export interface PrivateEndpointConnectionArgs {
     ...
     * The Private Endpoint resource for this Connection.
     */
    privateEndpoint?: pulumi.Input<types.inputs.relay.PrivateEndpointArgs>;
    /**
     ...
     * Details about the state of the connection.
     */
    privateLinkServiceConnectionState?: pulumi.Input<types.inputs.relay.ConnectionStateArgs>;
    /**
     * Provisioning state of the Private Endpoint Connection.
     */

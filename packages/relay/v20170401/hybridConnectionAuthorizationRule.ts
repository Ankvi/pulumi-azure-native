...
export class HybridConnectionAuthorizationRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:relay/v20170401:HybridConnectionAuthorizationRule';
    ...
    constructor(name: string, args: HybridConnectionAuthorizationRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:relay:HybridConnectionAuthorizationRule" }, { type: "azure-native:relay/v20160701:HybridConnectionAuthorizationRule" }, { type: "azure-native:relay/v20211101:HybridConnectionAuthorizationRule" }] };

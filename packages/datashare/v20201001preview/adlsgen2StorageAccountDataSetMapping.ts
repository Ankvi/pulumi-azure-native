 ...
 */
export class ADLSGen2StorageAccountDataSetMapping extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ADLSGen2StorageAccountDataSetMapping {
        return new ADLSGen2StorageAccountDataSetMapping(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:datashare/v20201001preview:ADLSGen2StorageAccountDataSetMapping';

    /**
     * Returns true if the given object is an instance of ADLSGen2StorageAccountDataSetMapping.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ADLSGen2StorageAccountDataSetMapping {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ADLSGen2StorageAccountDataSetMapping.__pulumiType;
    }
 ...
 */
export interface ADLSGen2StorageAccountDataSetMappingArgs {
    /**

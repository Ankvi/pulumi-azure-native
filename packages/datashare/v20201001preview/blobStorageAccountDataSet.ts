...
export class BlobStorageAccountDataSet extends pulumi.CustomResource {
     ...
     */
    public readonly paths!: pulumi.Output<types.outputs.datashare.v20201001preview.BlobStorageAccountPathResponse[]>;
    /**
...
export interface BlobStorageAccountDataSetArgs {
     ...
     * A list of storage account paths.
     */
    paths: pulumi.Input<pulumi.Input<types.inputs.datashare.v20201001preview.BlobStorageAccountPathArgs>[]>;
    /**

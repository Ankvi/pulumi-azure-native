...
export class KustoDatabaseDataSetMapping extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:datashare:KustoDatabaseDataSetMapping';

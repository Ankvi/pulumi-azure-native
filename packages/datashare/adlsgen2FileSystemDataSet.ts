...
export class ADLSGen2FileSystemDataSet extends pulumi.CustomResource {
     ...
     */
    declare public readonly kind: pulumi.Output<"AdlsGen2FileSystem">;
    /**

...
export class BlobDataSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:datashare:BlobDataSet';

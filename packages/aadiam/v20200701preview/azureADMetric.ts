...
export class AzureADMetric extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:aadiam/v20200701preview:AzureADMetric';
    ...
    constructor(name: string, args: AzureADMetricArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:aadiam/v20200701preview:azureADMetric" }, { type: "azure-native:aadiam:AzureADMetric" }, { type: "azure-native:aadiam:azureADMetric" }] };

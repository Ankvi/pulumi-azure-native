...
export class DiagnosticSetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:aadiam/v20170401preview:DiagnosticSetting';
     ...
     */
    public readonly logs!: pulumi.Output<types.outputs.aadiam.v20170401preview.LogSettingsResponse[] | undefined>;
    /**
     * Azure resource name
     */
    ...
    constructor(name: string, args?: DiagnosticSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:aadiam:DiagnosticSetting" }, { type: "azure-native:aadiam/v20170401:DiagnosticSetting" }] };
...
export interface DiagnosticSettingArgs {
     ...
     * The list of logs settings.
     */
    logs?: pulumi.Input<pulumi.Input<types.inputs.aadiam.v20170401preview.LogSettingsArgs>[]>;
    /**

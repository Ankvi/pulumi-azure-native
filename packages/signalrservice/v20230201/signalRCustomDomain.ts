...
export class SignalRCustomDomain extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SignalRCustomDomainArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:signalrservice:SignalRCustomDomain" }, { type: "azure-native:signalrservice/v20220201:SignalRCustomDomain" }, { type: "azure-native:signalrservice/v20220801preview:SignalRCustomDomain" }, { type: "azure-native:signalrservice/v20230301preview:SignalRCustomDomain" }, { type: "azure-native:signalrservice/v20230601preview:SignalRCustomDomain" }, { type: "azure-native:signalrservice/v20230801preview:SignalRCustomDomain" }, { type: "azure-native:signalrservice/v20240101preview:SignalRCustomDomain" }] };

...
export class SignalRCustomDomain extends pulumi.CustomResource {
     ...
     */
    public readonly customCertificate!: pulumi.Output<types.outputs.signalrservice.v20230201.ResourceReferenceResponse>;
    /**
...
export interface SignalRCustomDomainArgs {
     ...
     * Reference to a resource.
     */
    customCertificate: pulumi.Input<types.inputs.signalrservice.v20230201.ResourceReferenceArgs>;
    /**
     * The custom domain name.
     */

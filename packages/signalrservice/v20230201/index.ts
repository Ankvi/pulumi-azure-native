...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:signalrservice/v20230201:SignalR":
                return new SignalR(name, <any>undefined, { urn })
            case "azure-native:signalrservice/v20230201:SignalRCustomCertificate":
                return new SignalRCustomCertificate(name, <any>undefined, { urn })
            case "azure-native:signalrservice/v20230201:SignalRCustomDomain":
                return new SignalRCustomDomain(name, <any>undefined, { urn })
            case "azure-native:signalrservice/v20230201:SignalRPrivateEndpointConnection":
                return new SignalRPrivateEndpointConnection(name, <any>undefined, { urn })
            case "azure-native:signalrservice/v20230201:SignalRSharedPrivateLinkResource":
...
pulumi.runtime.registerResourceModule("azure-native", "signalrservice/v20230201", _module)
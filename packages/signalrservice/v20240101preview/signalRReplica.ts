...
export class SignalRReplica extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:signalrservice/v20240101preview:SignalRReplica';
    ...
    constructor(name: string, args: SignalRReplicaArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:signalrservice:SignalRReplica" }, { type: "azure-native:signalrservice/v20230301preview:SignalRReplica" }, { type: "azure-native:signalrservice/v20230601preview:SignalRReplica" }, { type: "azure-native:signalrservice/v20230801preview:SignalRReplica" }] };

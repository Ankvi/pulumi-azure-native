...
export class SignalRSharedPrivateLinkResource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:signalrservice/v20240101preview:SignalRSharedPrivateLinkResource';

...
export class SignalRPrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:signalrservice/v20240101preview:SignalRPrivateEndpointConnection';

...
export namespace signalrservice {
    ...
    export namespace v20230201 {
        ...
        export interface ServerlessUpstreamSettingsResponse {
             ...
             * Gets or sets the list of Upstream URL templates. Order matters, and the first matching template takes effects.
             */
            templates?: v20230201.UpstreamTemplateResponse[];
        }
    ...
    export namespace v20230301preview {
        ...
        export interface ServerlessUpstreamSettingsResponse {
             ...
             * Gets or sets the list of Upstream URL templates. Order matters, and the first matching template takes effects.
             */
            templates?: v20230301preview.UpstreamTemplateResponse[];
        }
    ...
    export namespace v20230601preview {
        ...
        export interface ServerlessUpstreamSettingsResponse {
             ...
             * Gets or sets the list of Upstream URL templates. Order matters, and the first matching template takes effects.
             */
            templates?: v20230601preview.UpstreamTemplateResponse[];
        }
    ...
    export namespace v20230801preview {
        ...
        export interface ServerlessUpstreamSettingsResponse {
             ...
             * Gets or sets the list of Upstream URL templates. Order matters, and the first matching template takes effects.
             */
            templates?: v20230801preview.UpstreamTemplateResponse[];
        }

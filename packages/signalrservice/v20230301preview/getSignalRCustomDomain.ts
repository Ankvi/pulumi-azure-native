...
export function getSignalRCustomDomain(args: GetSignalRCustomDomainArgs, opts?: pulumi.InvokeOptions): Promise<GetSignalRCustomDomainResult> {
    ...
    return pulumi.runtime.invoke("azure-native:signalrservice/v20230301preview:getSignalRCustomDomain", {
        "name": args.name,
...
export interface GetSignalRCustomDomainResult {
     ...
     */
    readonly customCertificate: types.outputs.signalrservice.v20230301preview.ResourceReferenceResponse;
    /**

...
export function getSignalRPrivateEndpointConnection(args: GetSignalRPrivateEndpointConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetSignalRPrivateEndpointConnectionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:signalrservice/v20230601preview:getSignalRPrivateEndpointConnection", {
...
export interface GetSignalRPrivateEndpointConnectionResult {
     ...
     * Private endpoint
     */
    readonly privateEndpoint?: types.outputs.signalrservice.v20230601preview.PrivateEndpointResponse;
    /**
     * Connection state of the private endpoint connection
     */
    readonly privateLinkServiceConnectionState?: types.outputs.signalrservice.v20230601preview.PrivateLinkServiceConnectionStateResponse;
    /**

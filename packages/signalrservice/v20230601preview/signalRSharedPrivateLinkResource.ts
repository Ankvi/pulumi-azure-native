...
export class SignalRSharedPrivateLinkResource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:signalrservice/v20230601preview:SignalRSharedPrivateLinkResource';

...
export class SignalRCustomDomain extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:signalrservice/v20230601preview:SignalRCustomDomain';
     ...
     */
    public readonly customCertificate!: pulumi.Output<types.outputs.signalrservice.v20230601preview.ResourceReferenceResponse>;
    /**
    ...
    constructor(name: string, args: SignalRCustomDomainArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:signalrservice:SignalRCustomDomain" }, { type: "azure-native:signalrservice/v20220201:SignalRCustomDomain" }, { type: "azure-native:signalrservice/v20220801preview:SignalRCustomDomain" }, { type: "azure-native:signalrservice/v20230201:SignalRCustomDomain" }, { type: "azure-native:signalrservice/v20230301preview:SignalRCustomDomain" }, { type: "azure-native:signalrservice/v20230801preview:SignalRCustomDomain" }] };
...
export interface SignalRCustomDomainArgs {
     ...
     * Reference to a resource.
     */
    customCertificate: pulumi.Input<types.inputs.signalrservice.v20230601preview.ResourceReferenceArgs>;
    /**
     * The custom domain name.
     */

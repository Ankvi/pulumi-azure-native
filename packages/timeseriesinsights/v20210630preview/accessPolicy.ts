...
export class AccessPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:timeseriesinsights/v20210630preview:AccessPolicy';
...
export interface AccessPolicyArgs {
     ...
     * The list of roles the principal is assigned on the environment.
     */
    roles?: pulumi.Input<pulumi.Input<string | types.enums.v20210630preview.AccessPolicyRole>[]>;
}

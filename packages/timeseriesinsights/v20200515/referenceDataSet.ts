...
export class ReferenceDataSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:timeseriesinsights/v20200515:ReferenceDataSet';
     ...
     */
    public readonly keyProperties!: pulumi.Output<types.outputs.timeseriesinsights.v20200515.ReferenceDataSetKeyPropertyResponse[]>;
    /**
     * Resource location
     */
...
export interface ReferenceDataSetArgs {
     ...
     * The reference data set key comparison behavior can be set using this property. By default, the value is 'Ordinal' - which means case sensitive key comparison will be performed while joining reference data with events or while adding new reference data. When 'OrdinalIgnoreCase' is set, case insensitive comparison will be used.
     */
    dataStringComparisonBehavior?: pulumi.Input<string | types.enums.v20200515.DataStringComparisonBehavior>;
    /**
     ...
     * The list of key properties for the reference data set.
     */
    keyProperties: pulumi.Input<pulumi.Input<types.inputs.timeseriesinsights.v20200515.ReferenceDataSetKeyPropertyArgs>[]>;
    /**

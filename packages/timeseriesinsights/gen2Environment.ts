...
export class Gen2Environment extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly status: pulumi.Output<types.outputs.EnvironmentStatusResponse>;
    /**
     * The storage configuration provides the connection details that allows the Time Series Insights service to connect to the customer storage account that is used to store the environment's data.
     */
    declare public readonly storageConfiguration: pulumi.Output<types.outputs.Gen2StorageConfigurationOutputResponse>;
    /**
     * Resource tags
     */
     ...
     */
    declare public readonly timeSeriesIdProperties: pulumi.Output<types.outputs.TimeSeriesIdPropertyResponse[]>;
    /**
     * Resource type
     */
     ...
     */
    declare public readonly warmStoreConfiguration: pulumi.Output<types.outputs.WarmStoreConfigurationPropertiesResponse | undefined>;

...
export class SecretSync extends pulumi.CustomResource {
     ...
     */
    declare public readonly forceSynchronization: pulumi.Output<string | undefined>;
    /**
     ...
     */
    declare public readonly kubernetesSecretType: pulumi.Output<string>;
    /**
     ...
     */
    declare public readonly objectSecretMapping: pulumi.Output<types.outputs.KubernetesSecretObjectMappingResponse[]>;
    /**
     ...
     */
    declare public readonly secretProviderClassName: pulumi.Output<string>;
    /**
     ...
     */
    declare public /*out*/ readonly status: pulumi.Output<types.outputs.SecretSyncStatusResponse>;
    /**

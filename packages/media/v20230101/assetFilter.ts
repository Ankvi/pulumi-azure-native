...
export class AssetFilter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:media/v20230101:AssetFilter';
    ...
    constructor(name: string, args: AssetFilterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:media:AssetFilter" }, { type: "azure-native:media/v20180701:AssetFilter" }, { type: "azure-native:media/v20200501:AssetFilter" }, { type: "azure-native:media/v20210601:AssetFilter" }, { type: "azure-native:media/v20211101:AssetFilter" }, { type: "azure-native:media/v20220801:AssetFilter" }] };

...
export interface GetLiveEventResult {
     ...
     */
    readonly crossSiteAccessPolicies?: types.outputs.media.CrossSiteAccessPoliciesResponse;
    /**
     ...
     */
    readonly encoding?: types.outputs.media.LiveEventEncodingResponse;
    /**
     ...
     */
    readonly input: types.outputs.media.LiveEventInputResponse;
    /**
     ...
     */
    readonly preview?: types.outputs.media.LiveEventPreviewResponse;
    /**
     ...
     */
    readonly transcriptions?: types.outputs.media.LiveEventTranscriptionResponse[];
    /**

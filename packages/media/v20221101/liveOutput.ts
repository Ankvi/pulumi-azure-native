...
export class LiveOutput extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:media/v20221101:LiveOutput';

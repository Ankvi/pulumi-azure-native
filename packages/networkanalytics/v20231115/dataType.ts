...
export class DataType extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkanalytics/v20231115:DataType';
    ...
    constructor(name: string, args: DataTypeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkanalytics:DataType" }] };

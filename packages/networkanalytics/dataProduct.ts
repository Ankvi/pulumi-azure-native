...
export class DataProduct extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkanalytics:DataProduct';
     ...
     */
    public /*out*/ readonly consumptionEndpoints!: pulumi.Output<types.outputs.ConsumptionEndpointsPropertiesResponse>;
    /**
     ...
     */
    public readonly customerEncryptionKey!: pulumi.Output<types.outputs.EncryptionKeyDetailsResponse | undefined>;
    /**
     ...
     */
    public readonly networkacls!: pulumi.Output<types.outputs.DataProductNetworkAclsResponse | undefined>;
    /**
    ...
    constructor(name: string, args: DataProductArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkanalytics/v20231115:DataProduct" }] };
...
export interface DataProductArgs {
     ...
     * Customer managed encryption key details for data product.
     */
    customerEncryptionKey?: pulumi.Input<types.inputs.EncryptionKeyDetailsArgs>;
    /**
     * Flag to enable customer managed key encryption for data product.
     */
    customerManagedKeyEncryptionEnabled?: pulumi.Input<string | types.enums.ControlState>;
    /**
     ...
     * Network rule set for data product.
     */
    networkacls?: pulumi.Input<types.inputs.DataProductNetworkAclsArgs>;
    /**
     * List of name or email associated with data product resource deployment.
     */
     ...
     * Flag to enable or disable private link for data product resource.
     */
    privateLinksEnabled?: pulumi.Input<string | types.enums.ControlState>;
    /**
     * Product name of data product.
     */
     ...
     * Flag to enable or disable public access of data product resource.
     */
    publicNetworkAccess?: pulumi.Input<string | types.enums.ControlState>;
    /**
     * Data product publisher name.
     */
     ...
     * Flag to enable or disable redundancy for data product.
     */
    redundancy?: pulumi.Input<string | types.enums.ControlState>;
    /**

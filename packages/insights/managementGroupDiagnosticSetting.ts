...
export class ManagementGroupDiagnosticSetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:insights:ManagementGroupDiagnosticSetting';
     ...
     */
    public readonly logs!: pulumi.Output<types.outputs.insights.ManagementGroupLogSettingsResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: ManagementGroupDiagnosticSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:insights/v20200101preview:ManagementGroupDiagnosticSetting" }, { type: "azure-native:insights/v20210501preview:ManagementGroupDiagnosticSetting" }] };
...
export interface ManagementGroupDiagnosticSettingArgs {
     ...
     * The list of logs settings.
     */
    logs?: pulumi.Input<pulumi.Input<types.inputs.insights.ManagementGroupLogSettingsArgs>[]>;
    /**

...
export class TenantActionGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:insights:TenantActionGroup';
    ...
    constructor(name: string, args: TenantActionGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:insights/v20230301preview:TenantActionGroup" }, { type: "azure-native:insights/v20230501preview:TenantActionGroup" }] };

...
export class ManagementGroupDiagnosticSetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:insights/v20200101preview:ManagementGroupDiagnosticSetting';
     ...
     */
    public readonly logs!: pulumi.Output<types.outputs.insights.v20200101preview.ManagementGroupLogSettingsResponse[] | undefined>;
    /**
     * Azure resource name
     */
...
export interface ManagementGroupDiagnosticSettingArgs {
     ...
     * The list of logs settings.
     */
    logs?: pulumi.Input<pulumi.Input<types.inputs.insights.v20200101preview.ManagementGroupLogSettingsArgs>[]>;
    /**

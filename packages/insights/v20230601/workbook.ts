...
export class Workbook extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:insights/v20230601:Workbook';
     ...
     */
    public readonly identity!: pulumi.Output<types.outputs.insights.v20230601.WorkbookResourceResponseIdentity | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<types.outputs.insights.v20230601.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: WorkbookArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:insights:Workbook" }, { type: "azure-native:insights/v20150501:Workbook" }, { type: "azure-native:insights/v20180617preview:Workbook" }, { type: "azure-native:insights/v20201020:Workbook" }, { type: "azure-native:insights/v20210308:Workbook" }, { type: "azure-native:insights/v20210801:Workbook" }, { type: "azure-native:insights/v20220401:Workbook" }] };
...
export interface WorkbookArgs {
     ...
     * Identity used for BYOS
     */
    identity?: pulumi.Input<types.inputs.insights.v20230601.WorkbookResourceIdentityArgs>;
    /**
     * The kind of workbook. Only valid value is shared.
     */
    kind?: pulumi.Input<string | types.enums.v20230601.WorkbookSharedTypeKind>;
    /**
     * The geo-location where the resource lives
     */

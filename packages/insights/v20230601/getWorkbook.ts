...
export function getWorkbook(args: GetWorkbookArgs, opts?: pulumi.InvokeOptions): Promise<GetWorkbookResult> {
    ...
    return pulumi.runtime.invoke("azure-native:insights/v20230601:getWorkbook", {
...
export interface GetWorkbookResult {
     ...
     */
    readonly identity?: types.outputs.insights.v20230601.WorkbookResourceResponseIdentity;
    /**
     ...
     */
    readonly systemData: types.outputs.insights.v20230601.SystemDataResponse;
    /**
     * Resource tags.
     */

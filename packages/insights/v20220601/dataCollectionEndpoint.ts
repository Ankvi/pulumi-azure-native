...
export class DataCollectionEndpoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:insights/v20220601:DataCollectionEndpoint';
    ...
    constructor(name: string, args: DataCollectionEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:insights:DataCollectionEndpoint" }, { type: "azure-native:insights/v20210401:DataCollectionEndpoint" }, { type: "azure-native:insights/v20210901preview:DataCollectionEndpoint" }] };

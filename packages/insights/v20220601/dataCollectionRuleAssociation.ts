...
export class DataCollectionRuleAssociation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:insights/v20220601:DataCollectionRuleAssociation';
    ...
    constructor(name: string, args: DataCollectionRuleAssociationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:insights:DataCollectionRuleAssociation" }, { type: "azure-native:insights/v20191101preview:DataCollectionRuleAssociation" }, { type: "azure-native:insights/v20210401:DataCollectionRuleAssociation" }, { type: "azure-native:insights/v20210901preview:DataCollectionRuleAssociation" }] };

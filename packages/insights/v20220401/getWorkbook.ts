...
export interface GetWorkbookResult {
     ...
     */
    readonly identity?: types.outputs.insights.v20220401.WorkbookResourceResponseIdentity;
    /**
     ...
     */
    readonly systemData: types.outputs.insights.v20220401.SystemDataResponse;
    /**
     * Resource tags.
     */

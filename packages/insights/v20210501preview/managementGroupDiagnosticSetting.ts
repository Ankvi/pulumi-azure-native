...
export class ManagementGroupDiagnosticSetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:insights/v20210501preview:ManagementGroupDiagnosticSetting';
     ...
     */
    public readonly logs!: pulumi.Output<types.outputs.insights.v20210501preview.ManagementGroupLogSettingsResponse[] | undefined>;
    /**
...
export interface ManagementGroupDiagnosticSettingArgs {
     ...
     * The list of logs settings.
     */
    logs?: pulumi.Input<pulumi.Input<types.inputs.insights.v20210501preview.ManagementGroupLogSettingsArgs>[]>;
    /**

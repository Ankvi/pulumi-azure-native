 ...
 *
 * Uses Azure REST API version 2020-02-02. In version 1.x of the Azure Native provider, it used API version 2015-05-01.
 *
...
export class Component extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:insights:Component';

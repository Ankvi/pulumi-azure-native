...
export function getWebTest(args: GetWebTestArgs, opts?: pulumi.InvokeOptions): Promise<GetWebTestResult> {
    ...
    return pulumi.runtime.invoke("azure-native:insights/v20220615:getWebTest", {
...
export interface GetWebTestResult {
     ...
     */
    readonly configuration?: types.outputs.insights.v20220615.WebTestPropertiesResponseConfiguration;
    /**
     ...
     */
    readonly locations: types.outputs.insights.v20220615.WebTestGeolocationResponse[];
    /**
     * Azure resource name
     */
     ...
     */
    readonly request?: types.outputs.insights.v20220615.WebTestPropertiesResponseRequest;
    /**
     ...
     */
    readonly validationRules?: types.outputs.insights.v20220615.WebTestPropertiesResponseValidationRules;
    /**

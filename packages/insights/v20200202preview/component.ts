...
export class Component extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:insights/v20200202preview:Component';
     ...
     */
    public /*out*/ readonly privateLinkScopedResources!: pulumi.Output<types.outputs.insights.v20200202preview.PrivateLinkScopedResourceResponse[]>;
    /**
...
export interface ComponentArgs {
     ...
     * Type of application being monitored.
     */
    applicationType: pulumi.Input<string | types.enums.v20200202preview.ApplicationType>;
    /**
     * Disable IP masking.
     */
     ...
     * Used by the Application Insights system to determine what kind of flow this component was created by. This is to be set to 'Bluefield' when creating/updating a component via the REST API.
     */
    flowType?: pulumi.Input<string | types.enums.v20200202preview.FlowType>;
    /**
     * Force users to create their own storage account for profiler and debugger.
     */
     ...
     * Indicates the flow of the ingestion.
     */
    ingestionMode?: pulumi.Input<string | types.enums.v20200202preview.IngestionMode>;
    /**
     * The kind of application that this component refers to, used to customize UI. This value is a freeform string, values should typically be one of the following: web, ios, other, store, java, phone.
     */
     ...
     * The network access type for accessing Application Insights ingestion.
     */
    publicNetworkAccessForIngestion?: pulumi.Input<string | types.enums.v20200202preview.PublicNetworkAccessType>;
    /**
     * The network access type for accessing Application Insights query.
     */
    publicNetworkAccessForQuery?: pulumi.Input<string | types.enums.v20200202preview.PublicNetworkAccessType>;
    /**
     * Describes what tool created this Application Insights component. Customers using this API should set this to the default 'rest'.
     */
    requestSource?: pulumi.Input<string | types.enums.v20200202preview.RequestSource>;
    /**

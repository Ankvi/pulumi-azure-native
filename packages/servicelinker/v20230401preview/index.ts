...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:servicelinker/v20230401preview:Connector":
                return new Connector(name, <any>undefined, { urn })
            case "azure-native:servicelinker/v20230401preview:ConnectorDryrun":
                return new ConnectorDryrun(name, <any>undefined, { urn })
            case "azure-native:servicelinker/v20230401preview:Linker":
                return new Linker(name, <any>undefined, { urn })
            case "azure-native:servicelinker/v20230401preview:LinkerDryrun":
...
pulumi.runtime.registerResourceModule("azure-native", "servicelinker/v20230401preview", _module)
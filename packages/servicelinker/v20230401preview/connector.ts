...
export class Connector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:servicelinker/v20230401preview:Connector';
    ...
    constructor(name: string, args: ConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:servicelinker:Connector" }, { type: "azure-native:servicelinker/v20221101preview:Connector" }] };

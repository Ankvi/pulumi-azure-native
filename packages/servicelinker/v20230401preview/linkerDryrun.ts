...
export class LinkerDryrun extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:servicelinker/v20230401preview:LinkerDryrun';
    ...
    constructor(name: string, args: LinkerDryrunArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:servicelinker:LinkerDryrun" }, { type: "azure-native:servicelinker/v20221101preview:LinkerDryrun" }] };

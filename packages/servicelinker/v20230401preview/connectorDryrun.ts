...
export class ConnectorDryrun extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:servicelinker/v20230401preview:ConnectorDryrun';
    ...
    constructor(name: string, args: ConnectorDryrunArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:servicelinker:ConnectorDryrun" }, { type: "azure-native:servicelinker/v20221101preview:ConnectorDryrun" }] };

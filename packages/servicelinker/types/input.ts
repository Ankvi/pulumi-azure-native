...
export namespace servicelinker {
    /**
    ...
    export namespace v20211101preview {
        ...
        export interface VNetSolutionArgs {
             ...
             * Type of VNet solution.
             */
            type?: pulumi.Input<string | enums.v20211101preview.VNetSolutionType>;
        }
    ...
    export namespace v20221101preview {
        ...
        export interface AccessKeyInfoBaseArgs {
             ...
             * Permissions of the accessKey. `Read` and `Write` are for Azure Cosmos DB and Azure App Configuration, `Listen`, `Send` and `Manage` are for Azure Event Hub and Azure Service Bus.
             */
            permissions?: pulumi.Input<pulumi.Input<string | enums.v20221101preview.AccessKeyPermissions>[]>;
        }
        ...
        export interface AzureResourceArgs {
             ...
             * The azure resource connection related properties.
             */
            resourceProperties?: pulumi.Input<v20221101preview.AzureKeyVaultPropertiesArgs>;
            /**
             * The target service type.
             * Expected value is 'AzureResource'.
             */
        ...
        export interface ConfigurationInfoArgs {
             ...
             * Optional, indicate whether to apply configurations on source application. If enable, generate configurations and applied to the source application. Default is enable. If optOut, no configuration change will be made on source.
             */
            action?: pulumi.Input<string | enums.v20221101preview.ActionType>;
            /**
             * A dictionary of additional configurations to be added. Service will auto generate a set of basic configurations and this property is to full fill more customized configurations
             */
            additionalConfigurations?: pulumi.Input<{[key: string]: pulumi.Input<string>}>;
             ...
             * Indicates some additional properties for dapr client type
             */
            daprProperties?: pulumi.Input<v20221101preview.DaprPropertiesArgs>;
            /**
             * Indicates whether to clean up previous operation when Linker is updating or deleting
             */
            deleteOrUpdateBehavior?: pulumi.Input<string | enums.v20221101preview.DeleteOrUpdateBehavior>;
        }
        ...
        export interface CreateOrUpdateDryrunParametersArgs {
             ...
             * The authentication type.
             */
            authInfo?: pulumi.Input<v20221101preview.AccessKeyInfoBaseArgs | v20221101preview.SecretAuthInfoArgs | v20221101preview.ServicePrincipalCertificateAuthInfoArgs | v20221101preview.ServicePrincipalSecretAuthInfoArgs | v20221101preview.SystemAssignedIdentityAuthInfoArgs | v20221101preview.UserAccountAuthInfoArgs | v20221101preview.UserAssignedIdentityAuthInfoArgs>;
            /**
             * The application client type
             */
            clientType?: pulumi.Input<string | enums.v20221101preview.ClientType>;
            /**
             * The connection information consumed by applications, including secrets, connection strings.
             */
            configurationInfo?: pulumi.Input<v20221101preview.ConfigurationInfoArgs>;
            /**
             * The network solution.
             */
            publicNetworkSolution?: pulumi.Input<v20221101preview.PublicNetworkSolutionArgs>;
            /**
             * connection scope in source service.
             */
            scope?: pulumi.Input<string>;
             ...
             * An option to store secret value in secure place
             */
            secretStore?: pulumi.Input<v20221101preview.SecretStoreArgs>;
            /**
             * The target service properties
             */
            targetService?: pulumi.Input<v20221101preview.AzureResourceArgs | v20221101preview.ConfluentBootstrapServerArgs | v20221101preview.ConfluentSchemaRegistryArgs | v20221101preview.SelfHostedServerArgs>;
            /**
             * The VNet solution.
             */
            vNetSolution?: pulumi.Input<v20221101preview.VNetSolutionArgs>;
        }
        ...
        export interface DaprPropertiesArgs {
             ...
             * Additional dapr metadata
             */
            metadata?: pulumi.Input<pulumi.Input<v20221101preview.DaprMetadataArgs>[]>;
            /**
             * The dapr component scopes
             */
            scopes?: pulumi.Input<pulumi.Input<string>[]>;
        ...
        export interface FirewallRulesArgs {
             ...
             * Allow Azure services to access the target service if true.
             */
            azureServices?: pulumi.Input<string | enums.v20221101preview.AllowType>;
            /**
             * Allow caller client IP to access the target service if true. the property is used when connecting local application to target service.
             */
            callerClientIP?: pulumi.Input<string | enums.v20221101preview.AllowType>;
            /**
             * This value specifies the set of IP addresses or IP address ranges in CIDR form to be included as the allowed list of client IPs for a given database account.
             */
            ipRanges?: pulumi.Input<pulumi.Input<string>[]>;
        ...
        export interface PublicNetworkSolutionArgs {
             ...
             * Describe firewall rules of target service to make sure source application could connect to the target.
             */
            firewallRules?: pulumi.Input<v20221101preview.FirewallRulesArgs>;
        }
        ...
        export interface SecretAuthInfoArgs {
             ...
             * Password or key vault secret for secret auth.
             */
            secretInfo?: pulumi.Input<v20221101preview.KeyVaultSecretReferenceSecretInfoArgs | v20221101preview.KeyVaultSecretUriSecretInfoArgs | v20221101preview.ValueSecretInfoArgs>;
        }
        ...
        export interface VNetSolutionArgs {
             ...
             * Type of VNet solution.
             */
            type?: pulumi.Input<string | enums.v20221101preview.VNetSolutionType>;
        }

...
export namespace servicelinker {
    ...
    export namespace v20221101preview {
        ...
        export interface AzureResourceResponse {
             ...
             * The azure resource connection related properties.
             */
            resourceProperties?: v20221101preview.AzureKeyVaultPropertiesResponse;
            /**
             * The target service type.
             * Expected value is 'AzureResource'.
             */
        ...
        export interface ConfigurationInfoResponse {
             ...
             * Indicates some additional properties for dapr client type
             */
            daprProperties?: v20221101preview.DaprPropertiesResponse;
            /**
             * Indicates whether to clean up previous operation when Linker is updating or deleting
             */
            deleteOrUpdateBehavior?: string;
        ...
        export interface CreateOrUpdateDryrunParametersResponse {
             ...
             * The authentication type.
             */
            authInfo?: v20221101preview.AccessKeyInfoBaseResponse | v20221101preview.SecretAuthInfoResponse | v20221101preview.ServicePrincipalCertificateAuthInfoResponse | v20221101preview.ServicePrincipalSecretAuthInfoResponse | v20221101preview.SystemAssignedIdentityAuthInfoResponse | v20221101preview.UserAccountAuthInfoResponse | v20221101preview.UserAssignedIdentityAuthInfoResponse;
            /**
             * The application client type
             */
            clientType?: string;
             ...
             * The connection information consumed by applications, including secrets, connection strings.
             */
            configurationInfo?: v20221101preview.ConfigurationInfoResponse;
            /**
             * The provisioning state. 
             */
            provisioningState: string;
             ...
             * The network solution.
             */
            publicNetworkSolution?: v20221101preview.PublicNetworkSolutionResponse;
            /**
             * connection scope in source service.
             */
            scope?: string;
             ...
             * An option to store secret value in secure place
             */
            secretStore?: v20221101preview.SecretStoreResponse;
            /**
             * The target service properties
             */
            targetService?: v20221101preview.AzureResourceResponse | v20221101preview.ConfluentBootstrapServerResponse | v20221101preview.ConfluentSchemaRegistryResponse | v20221101preview.SelfHostedServerResponse;
            /**
             * The VNet solution.
             */
            vNetSolution?: v20221101preview.VNetSolutionResponse;
        }
        ...
        export interface DaprPropertiesResponse {
             ...
             * Additional dapr metadata
             */
            metadata?: v20221101preview.DaprMetadataResponse[];
            /**
             * The dapr component scopes
             */
            scopes?: string[];
        ...
        export interface PublicNetworkSolutionResponse {
             ...
             * Describe firewall rules of target service to make sure source application could connect to the target.
             */
            firewallRules?: v20221101preview.FirewallRulesResponse;
        }
        ...
        export interface SecretAuthInfoResponse {
             ...
             * Password or key vault secret for secret auth.
             */
            secretInfo?: v20221101preview.KeyVaultSecretReferenceSecretInfoResponse | v20221101preview.KeyVaultSecretUriSecretInfoResponse | v20221101preview.ValueSecretInfoResponse;
        }

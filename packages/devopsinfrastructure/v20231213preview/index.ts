...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:devopsinfrastructure/v20231213preview:Pool":
...
pulumi.runtime.registerResourceModule("azure-native", "devopsinfrastructure/v20231213preview", _module)
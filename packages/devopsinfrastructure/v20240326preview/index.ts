...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:devopsinfrastructure/v20240326preview:Pool":
...
pulumi.runtime.registerResourceModule("azure-native", "devopsinfrastructure/v20240326preview", _module)
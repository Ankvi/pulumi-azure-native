...
export class CloudHsmClusterPrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:hardwaresecuritymodules/v20220831preview:CloudHsmClusterPrivateEndpointConnection';
     ...
     */
    public /*out*/ readonly privateEndpoint!: pulumi.Output<types.outputs.hardwaresecuritymodules.v20220831preview.PrivateEndpointResponse | undefined>;
    /**
     * A collection of information about the state of the connection between service consumer and provider.
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<types.outputs.hardwaresecuritymodules.v20220831preview.PrivateLinkServiceConnectionStateResponse>;
    /**
    ...
    constructor(name: string, args: CloudHsmClusterPrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hardwaresecuritymodules:CloudHsmClusterPrivateEndpointConnection" }] };
...
export interface CloudHsmClusterPrivateEndpointConnectionArgs {
     ...
     * A collection of information about the state of the connection between service consumer and provider.
     */
    privateLinkServiceConnectionState: pulumi.Input<types.inputs.hardwaresecuritymodules.v20220831preview.PrivateLinkServiceConnectionStateArgs>;
    /**

...
export namespace hardwaresecuritymodules {
    /**
    ...
    export namespace v20211130 {
        ...
        export interface NetworkProfileArgs {
             ...
             * Specifies the list of resource Ids for the network interfaces associated with the dedicated HSM.
             */
            networkInterfaces?: pulumi.Input<pulumi.Input<v20211130.NetworkInterfaceArgs>[]>;
            /**
             * Specifies the identifier of the subnet.
             */
            subnet?: pulumi.Input<v20211130.ApiEntityReferenceArgs>;
        }
        ...
        export interface SkuArgs {
             ...
             * SKU of the dedicated HSM
             */
            name?: pulumi.Input<string | enums.v20211130.SkuName>;
        }

    }

    export namespace v20220831preview {
        /**
         * Security domain properties information for Cloud HSM cluster
         */
        export interface CloudHsmClusterSecurityDomainPropertiesArgs {
        ...
        export interface CloudHsmClusterSkuArgs {
             ...
             * Sku family of the Cloud HSM Cluster
             */
            family: pulumi.Input<string | enums.v20220831preview.CloudHsmClusterSkuFamily>;
            /**
             * Sku name of the Cloud HSM Cluster
             */
            name: pulumi.Input<enums.v20220831preview.CloudHsmClusterSkuName>;
        }
        ...
        export interface PrivateEndpointConnectionArgs {
             ...
             * A collection of information about the state of the connection between service consumer and provider.
             */
            privateLinkServiceConnectionState: pulumi.Input<v20220831preview.PrivateLinkServiceConnectionStateArgs>;
        }
        ...
        export interface PrivateLinkServiceConnectionStateArgs {
             ...
             * Indicates whether the connection has been Approved/Rejected/Removed by the owner of the service.
             */
            status?: pulumi.Input<string | enums.v20220831preview.PrivateEndpointServiceConnectionStatus>;
        }

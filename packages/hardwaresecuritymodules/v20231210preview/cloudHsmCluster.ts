...
export class CloudHsmCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:hardwaresecuritymodules/v20231210preview:CloudHsmCluster';
     ...
     */
    public readonly backupProperties!: pulumi.Output<types.outputs.BackupPropertiesResponse | undefined>;
    /**
     ...
     */
    public readonly restoreProperties!: pulumi.Output<types.outputs.RestorePropertiesResponse | undefined>;
    /**
    ...
    constructor(name: string, args: CloudHsmClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["restoreProperties"] = args ? args.restoreProperties : undefined;
            ...
            resourceInputs["backupProperties"] = undefined /*out*/;
            ...
            resourceInputs["restoreProperties"] = undefined /*out*/;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hardwaresecuritymodules:CloudHsmCluster" }, { type: "azure-native:hardwaresecuritymodules/v20220831preview:CloudHsmCluster" }] };
...
export interface CloudHsmClusterArgs {
     ...
     * Cloud Hsm Cluster backup information
     */
    backupProperties?: pulumi.Input<types.inputs.BackupPropertiesArgs>;
    /**
     ...
     * Cloud Hsm Cluster restore information
     */
    restoreProperties?: pulumi.Input<types.inputs.RestorePropertiesArgs>;
    /**
     * Security domain properties information for Cloud HSM cluster
     */

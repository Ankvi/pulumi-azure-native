...
export class CloudHsmClusterPrivateEndpointConnection extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly privateEndpoint!: pulumi.Output<types.outputs.hardwaresecuritymodules.PrivateEndpointResponse | undefined>;
    /**
     * A collection of information about the state of the connection between service consumer and provider.
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<types.outputs.hardwaresecuritymodules.PrivateLinkServiceConnectionStateResponse>;
    /**
...
export interface CloudHsmClusterPrivateEndpointConnectionArgs {
     ...
     * A collection of information about the state of the connection between service consumer and provider.
     */
    privateLinkServiceConnectionState: pulumi.Input<types.inputs.hardwaresecuritymodules.PrivateLinkServiceConnectionStateArgs>;
    /**

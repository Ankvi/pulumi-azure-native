...
export class CloudHsmCluster extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly hsms: pulumi.Output<types.outputs.CloudHsmPropertiesResponse[]>;
    /**
     ...
     * SKU details
     */
    declare public readonly sku: pulumi.Output<types.outputs.CloudHsmClusterSkuResponse | undefined>;
    /**

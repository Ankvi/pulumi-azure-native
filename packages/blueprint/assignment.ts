...
export class Assignment extends pulumi.CustomResource {
     ...
     */
    declare public readonly identity: pulumi.Output<types.outputs.ManagedServiceIdentityResponse>;
    /**
     ...
     */
    declare public readonly locks: pulumi.Output<types.outputs.AssignmentLockSettingsResponse | undefined>;
    /**
     ...
     */
    declare public readonly parameters: pulumi.Output<{[key: string]: types.outputs.ParameterValueResponse}>;
    /**
     ...
     */
    declare public readonly resourceGroups: pulumi.Output<{[key: string]: types.outputs.ResourceGroupValueResponse}>;
    /**
     ...
     */
    declare public /*out*/ readonly status: pulumi.Output<types.outputs.AssignmentStatusResponse>;
    /**

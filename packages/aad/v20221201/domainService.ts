...
export class DomainService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:aad/v20221201:DomainService';

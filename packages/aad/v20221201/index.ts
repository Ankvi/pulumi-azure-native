...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:aad/v20221201:DomainService":
                return new DomainService(name, <any>undefined, { urn })
            case "azure-native:aad/v20221201:OuContainer":
...
pulumi.runtime.registerResourceModule("azure-native", "aad/v20221201", _module)

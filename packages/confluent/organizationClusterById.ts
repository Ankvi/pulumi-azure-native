...
export class OrganizationClusterById extends pulumi.CustomResource {
     ...
     */
    declare public readonly spec: pulumi.Output<types.outputs.SCClusterSpecEntityResponse | undefined>;
    /**
     * Specification of the cluster status
     */
    declare public readonly status: pulumi.Output<types.outputs.ClusterStatusEntityResponse | undefined>;
    /**

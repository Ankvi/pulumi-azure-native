...
export class Diagnostic extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:edge:Diagnostic';
     ...
     */
    public /*out*/ readonly properties!: pulumi.Output<types.outputs.DiagnosticPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: DiagnosticArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["diagnosticName"] = args ? args.diagnosticName : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:edge/v20250601:Diagnostic" }] };

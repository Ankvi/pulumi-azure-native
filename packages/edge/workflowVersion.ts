...
export class WorkflowVersion extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.WorkflowVersionPropertiesResponse>;
    /**
...
export interface WorkflowVersionArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.WorkflowVersionPropertiesArgs>;
    /**

...
export class SchemaVersion extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:edge:SchemaVersion';
    ...
    constructor(name: string, args: SchemaVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:edge/v20250601:SchemaVersion" }, { type: "azure-native:edge/v20250801:SchemaVersion" }] };

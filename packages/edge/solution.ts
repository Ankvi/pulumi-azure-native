...
export class Solution extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly properties!: pulumi.Output<types.outputs.SolutionPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: SolutionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:edge/v20250601:Solution" }] };

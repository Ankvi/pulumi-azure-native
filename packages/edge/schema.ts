...
export class Schema extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly properties: pulumi.Output<types.outputs.SchemaPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: SchemaArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:edge/v20250601:Schema" }, { type: "azure-native:edge/v20250801:Schema" }] };

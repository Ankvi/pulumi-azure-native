...
export class Site extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:edge:Site';
    ...
    constructor(name: string, args: SiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:edge/v20240201preview:Site" }, { type: "azure-native:edge/v20250301preview:Site" }, { type: "azure-native:edge/v20250601:Site" }] };

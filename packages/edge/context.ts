...
export class Context extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:edge:Context';
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.ContextPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ContextArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:edge/v20250601:Context" }] };

...
export function getDiagnostic(args: GetDiagnosticArgs, opts?: pulumi.InvokeOptions): Promise<GetDiagnosticResult> {
    ...
    return pulumi.runtime.invoke("azure-native:edge:getDiagnostic", {
        "diagnosticName": args.diagnosticName,
...
export interface GetDiagnosticResult {
     ...
     */
    readonly properties: types.outputs.DiagnosticPropertiesResponse;
    /**
...
export function getDiagnosticOutput(args: GetDiagnosticOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDiagnosticResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:edge:getDiagnostic", {
        "diagnosticName": args.diagnosticName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}

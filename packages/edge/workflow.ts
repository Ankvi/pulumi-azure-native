...
export class Workflow extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:edge:Workflow';
     ...
     */
    declare public /*out*/ readonly properties: pulumi.Output<types.outputs.WorkflowPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: WorkflowArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:edge/v20250601:Workflow" }, { type: "azure-native:edge/v20250801:Workflow" }] };

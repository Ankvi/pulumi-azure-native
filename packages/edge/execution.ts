...
export class Execution extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:edge:Execution';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.ExecutionPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ExecutionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:edge/v20250601:Execution" }, { type: "azure-native:edge/v20250801:Execution" }] };
...
export interface ExecutionArgs {
     ...
     * The resource-specific properties for this resource.
     */
    properties?: pulumi.Input<types.inputs.ExecutionPropertiesArgs>;
    /**

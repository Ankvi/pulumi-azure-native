...
export class Configuration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:edge:Configuration';
     ...
     */
    declare public /*out*/ readonly properties: pulumi.Output<types.outputs.ConfigurationPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:edge/v20250601:Configuration" }, { type: "azure-native:edge/v20250801:Configuration" }] };

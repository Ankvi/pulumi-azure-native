...
export class FluidRelayServer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:fluidrelay/v20210615preview:FluidRelayServer';

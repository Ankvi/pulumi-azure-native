...
export class MongoDBResourceMongoDBDatabase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cosmosdb:MongoDBResourceMongoDBDatabase';
    ...
    declare public readonly options: pulumi.Output<types.outputs.MongoDBDatabaseGetPropertiesResponseOptions | undefined>;
    declare public readonly resource: pulumi.Output<types.outputs.MongoDBDatabaseGetPropertiesResponseResource | undefined>;
    /**

...
export class TableResourceTableRoleDefinition extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TableResourceTableRoleDefinition {
        return new TableResourceTableRoleDefinition(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:cosmosdb:TableResourceTableRoleDefinition';

    /**
     * Returns true if the given object is an instance of TableResourceTableRoleDefinition.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TableResourceTableRoleDefinition {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TableResourceTableRoleDefinition.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: TableResourceTableRoleDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cosmosdb/v20241201preview:TableResourceTableRoleDefinition" }, { type: "azure-native:cosmosdb/v20250501preview:TableResourceTableRoleDefinition" }, { type: "azure-native:documentdb/v20241201preview:TableResourceTableRoleDefinition" }, { type: "azure-native:documentdb:TableResourceTableRoleDefinition" }] };
 ...
 */
export interface TableResourceTableRoleDefinitionArgs {
    /**

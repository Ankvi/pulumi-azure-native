...
export class GraphResourceGraph extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cosmosdb:GraphResourceGraph';
    ...
    declare public readonly options: pulumi.Output<types.outputs.GraphResourceGetPropertiesResponseOptions | undefined>;
    declare public readonly resource: pulumi.Output<types.outputs.GraphResourceGetPropertiesResponseResource | undefined>;
    /**

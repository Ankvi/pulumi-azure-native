...
export class SqlResourceSqlContainer extends pulumi.CustomResource {
    ...
    declare public readonly options: pulumi.Output<types.outputs.SqlContainerGetPropertiesResponseOptions | undefined>;
    declare public readonly resource: pulumi.Output<types.outputs.SqlContainerGetPropertiesResponseResource | undefined>;
    /**

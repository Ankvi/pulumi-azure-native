...
export class CassandraResourceCassandraKeyspace extends pulumi.CustomResource {
    ...
    declare public readonly options: pulumi.Output<types.outputs.CassandraKeyspaceGetPropertiesResponseOptions | undefined>;
    declare public readonly resource: pulumi.Output<types.outputs.CassandraKeyspaceGetPropertiesResponseResource | undefined>;
    /**

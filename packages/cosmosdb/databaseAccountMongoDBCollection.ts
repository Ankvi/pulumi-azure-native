...
export class DatabaseAccountMongoDBCollection extends pulumi.CustomResource {
     ...
     * List of index keys
     */
    declare public /*out*/ readonly indexes: pulumi.Output<types.outputs.MongoIndexResponse[] | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly shardKey: pulumi.Output<{[key: string]: string} | undefined>;
    /**

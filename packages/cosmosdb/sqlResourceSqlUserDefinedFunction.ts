...
export class SqlResourceSqlUserDefinedFunction extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cosmosdb:SqlResourceSqlUserDefinedFunction';
    ...
    declare public readonly resource: pulumi.Output<types.outputs.SqlUserDefinedFunctionGetPropertiesResponseResource | undefined>;
    /**
    ...
    constructor(name: string, args: SqlResourceSqlUserDefinedFunctionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["userDefinedFunctionName"] = args?.userDefinedFunctionName;

...
export class MongoDBResourceMongoDBCollection extends pulumi.CustomResource {
    ...
    declare public readonly options: pulumi.Output<types.outputs.MongoDBCollectionGetPropertiesResponseOptions | undefined>;
    declare public readonly resource: pulumi.Output<types.outputs.MongoDBCollectionGetPropertiesResponseResource | undefined>;
    /**

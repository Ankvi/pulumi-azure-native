...
export class TableResourceTable extends pulumi.CustomResource {
    ...
    declare public readonly options: pulumi.Output<types.outputs.TableGetPropertiesResponseOptions | undefined>;
    declare public readonly resource: pulumi.Output<types.outputs.TableGetPropertiesResponseResource | undefined>;
    /**

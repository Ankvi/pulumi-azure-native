...
export class SqlResourceSqlTrigger extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cosmosdb:SqlResourceSqlTrigger';
    ...
    declare public readonly resource: pulumi.Output<types.outputs.SqlTriggerGetPropertiesResponseResource | undefined>;
    /**

...
export class FleetspaceAccount extends pulumi.CustomResource {
     ...
     */
    declare public readonly globalDatabaseAccountProperties: pulumi.Output<types.outputs.FleetspaceAccountPropertiesResponseGlobalDatabaseAccountProperties | undefined>;
    /**
    ...
    constructor(name: string, args: FleetspaceAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["fleetspaceAccountName"] = args?.fleetspaceAccountName;
            resourceInputs["fleetspaceName"] = args?.fleetspaceName;
            resourceInputs["globalDatabaseAccountProperties"] = args?.globalDatabaseAccountProperties;

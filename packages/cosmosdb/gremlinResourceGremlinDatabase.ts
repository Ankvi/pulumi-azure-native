...
export class GremlinResourceGremlinDatabase extends pulumi.CustomResource {
    ...
    declare public readonly options: pulumi.Output<types.outputs.GremlinDatabaseGetPropertiesResponseOptions | undefined>;
    declare public readonly resource: pulumi.Output<types.outputs.GremlinDatabaseGetPropertiesResponseResource | undefined>;
    /**

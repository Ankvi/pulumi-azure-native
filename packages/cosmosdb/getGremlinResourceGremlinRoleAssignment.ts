...
export function getGremlinResourceGremlinRoleAssignment(args: GetGremlinResourceGremlinRoleAssignmentArgs, opts?: pulumi.InvokeOptions): Promise<GetGremlinResourceGremlinRoleAssignmentResult> {
    ...
    return pulumi.runtime.invoke("azure-native:cosmosdb:getGremlinResourceGremlinRoleAssignment", {
...
export interface GetGremlinResourceGremlinRoleAssignmentArgs {
    /**
 ...
 */
export interface GetGremlinResourceGremlinRoleAssignmentResult {
    /**
...
export function getGremlinResourceGremlinRoleAssignmentOutput(args: GetGremlinResourceGremlinRoleAssignmentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetGremlinResourceGremlinRoleAssignmentResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:cosmosdb:getGremlinResourceGremlinRoleAssignment", {
        "accountName": args.accountName,
        "resourceGroupName": args.resourceGroupName,
        "roleAssignmentId": args.roleAssignmentId,
    }, opts);
...
export interface GetGremlinResourceGremlinRoleAssignmentOutputArgs {
    /**
     * Cosmos DB database account name.
     */

...
export class CassandraResourceCassandraView extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cosmosdb:CassandraResourceCassandraView';
    ...
    declare public readonly options: pulumi.Output<types.outputs.CassandraViewGetPropertiesResponseOptions | undefined>;
    declare public readonly resource: pulumi.Output<types.outputs.CassandraViewGetPropertiesResponseResource | undefined>;
    /**

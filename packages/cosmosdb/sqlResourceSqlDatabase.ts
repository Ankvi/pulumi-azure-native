...
export class SqlResourceSqlDatabase extends pulumi.CustomResource {
    ...
    declare public readonly options: pulumi.Output<types.outputs.SqlDatabaseGetPropertiesResponseOptions | undefined>;
    declare public readonly resource: pulumi.Output<types.outputs.SqlDatabaseGetPropertiesResponseResource | undefined>;
    /**

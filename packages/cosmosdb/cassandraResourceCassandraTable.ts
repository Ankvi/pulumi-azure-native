...
export class CassandraResourceCassandraTable extends pulumi.CustomResource {
    ...
    declare public readonly options: pulumi.Output<types.outputs.CassandraTableGetPropertiesResponseOptions | undefined>;
    declare public readonly resource: pulumi.Output<types.outputs.CassandraTableGetPropertiesResponseResource | undefined>;
    /**

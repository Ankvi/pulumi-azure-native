...
export class GremlinResourceGremlinGraph extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cosmosdb:GremlinResourceGremlinGraph';
    ...
    declare public readonly options: pulumi.Output<types.outputs.GremlinGraphGetPropertiesResponseOptions | undefined>;
    declare public readonly resource: pulumi.Output<types.outputs.GremlinGraphGetPropertiesResponseResource | undefined>;
    /**

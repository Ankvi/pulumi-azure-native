...
export class DatabaseAccount extends pulumi.CustomResource {
     ...
     */
    declare public readonly analyticalStorageConfiguration: pulumi.Output<types.outputs.AnalyticalStorageConfigurationResponse | undefined>;
    /**
     * API specific properties.
     */
    declare public readonly apiProperties: pulumi.Output<types.outputs.ApiPropertiesResponse | undefined>;
    /**
     ...
     */
    declare public readonly backupPolicy: pulumi.Output<types.outputs.ContinuousModeBackupPolicyResponse | types.outputs.PeriodicModeBackupPolicyResponse | undefined>;
    /**
     * List of Cosmos DB capabilities for the account
     */
    declare public readonly capabilities: pulumi.Output<types.outputs.CapabilityResponse[] | undefined>;
    /**
     * The object that represents all properties related to capacity enforcement on an account.
     */
    declare public readonly capacity: pulumi.Output<types.outputs.CapacityResponse | undefined>;
    /**
     ...
     */
    declare public readonly consistencyPolicy: pulumi.Output<types.outputs.ConsistencyPolicyResponse | undefined>;
    /**
     * The CORS policy for the Cosmos DB database account.
     */
    declare public readonly cors: pulumi.Output<types.outputs.CorsPolicyResponse[] | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly failoverPolicies: pulumi.Output<types.outputs.FailoverPolicyResponse[]>;
    /**
     ...
     * List of IpRules.
     */
    declare public readonly ipRules: pulumi.Output<types.outputs.IpAddressOrRangeResponse[] | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly keysMetadata: pulumi.Output<types.outputs.DatabaseAccountKeysMetadataResponse>;
    /**
     ...
     */
    declare public readonly locations: pulumi.Output<types.outputs.LocationResponse[]>;
    /**
     ...
     */
    declare public /*out*/ readonly readLocations: pulumi.Output<types.outputs.LocationResponse[]>;
    /**
     * Parameters to indicate the information about the restore.
     */
    declare public readonly restoreParameters: pulumi.Output<types.outputs.RestoreParametersResponse | undefined>;
    /**
     ...
     */
    declare public readonly virtualNetworkRules: pulumi.Output<types.outputs.VirtualNetworkRuleResponse[] | undefined>;
    /**
     * An array that contains the write location for the Cosmos DB account.
     */
    declare public /*out*/ readonly writeLocations: pulumi.Output<types.outputs.LocationResponse[]>;

...
export class EdgeModule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:videoanalyzer/v20211101preview:EdgeModule';
    ...
    constructor(name: string, args: EdgeModuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:videoanalyzer:EdgeModule" }, { type: "azure-native:videoanalyzer/v20210501preview:EdgeModule" }] };

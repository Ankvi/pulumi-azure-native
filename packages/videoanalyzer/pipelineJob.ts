...
export class PipelineJob extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly error: pulumi.Output<types.outputs.PipelineJobErrorResponse>;
    /**
     ...
     */
    declare public readonly parameters: pulumi.Output<types.outputs.ParameterDefinitionResponse[] | undefined>;
    /**

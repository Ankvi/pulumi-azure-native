...
export class ReplicationExtension extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:datareplication/v20210216preview:ReplicationExtension';
    ...
    constructor(name: string, args: ReplicationExtensionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:datareplication:ReplicationExtension" }] };

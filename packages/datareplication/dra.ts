...
export class Dra extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.DraModelPropertiesResponse>;
    declare public /*out*/ readonly systemData: pulumi.Output<types.outputs.DraModelResponseSystemData>;
    /**
    ...
    constructor(name: string, args: DraArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["fabricAgentName"] = args?.fabricAgentName;

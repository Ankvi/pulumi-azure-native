...
export class ReplicationExtension extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.ReplicationExtensionModelPropertiesResponse>;
    declare public /*out*/ readonly systemData: pulumi.Output<types.outputs.ReplicationExtensionModelResponseSystemData>;
    /**
    ...
    constructor(name: string, args: ReplicationExtensionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["replicationExtensionName"] = args?.replicationExtensionName;

...
export class ProtectedItem extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.ProtectedItemModelPropertiesResponse>;
    declare public /*out*/ readonly systemData: pulumi.Output<types.outputs.ProtectedItemModelResponseSystemData>;
    /**

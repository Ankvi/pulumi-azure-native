...
export class Fabric extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.FabricModelPropertiesResponse>;
    declare public /*out*/ readonly systemData: pulumi.Output<types.outputs.FabricModelResponseSystemData>;
    /**

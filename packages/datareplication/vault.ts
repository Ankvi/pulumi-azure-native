...
export class Vault extends pulumi.CustomResource {
     ...
     * Vault properties.
     */
    declare public readonly properties: pulumi.Output<types.outputs.VaultModelPropertiesResponse>;
    declare public /*out*/ readonly systemData: pulumi.Output<types.outputs.VaultModelResponseSystemData>;
    /**

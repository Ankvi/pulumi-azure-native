...
export class NotificationHubAuthorizationRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:notificationhubs/v20230901:NotificationHubAuthorizationRule';
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.notificationhubs.v20230901.SharedAccessAuthorizationRulePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: NotificationHubAuthorizationRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:notificationhubs:NotificationHubAuthorizationRule" }, { type: "azure-native:notificationhubs/v20160301:NotificationHubAuthorizationRule" }, { type: "azure-native:notificationhubs/v20170401:NotificationHubAuthorizationRule" }, { type: "azure-native:notificationhubs/v20230101preview:NotificationHubAuthorizationRule" }] };
...
export interface NotificationHubAuthorizationRuleArgs {
     ...
     * SharedAccessAuthorizationRule properties.
     */
    properties?: pulumi.Input<types.inputs.notificationhubs.v20230901.SharedAccessAuthorizationRulePropertiesArgs>;
    /**

...
export function getNotificationHub(args: GetNotificationHubArgs, opts?: pulumi.InvokeOptions): Promise<GetNotificationHubResult> {
    ...
    return pulumi.runtime.invoke("azure-native:notificationhubs/v20230901:getNotificationHub", {
...
export interface GetNotificationHubResult {
     ...
     */
    readonly properties: types.outputs.notificationhubs.v20230901.NotificationHubPropertiesResponse;
    /**

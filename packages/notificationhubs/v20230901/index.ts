...
// Export enums:
export * from "../types/enums/v20230901";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:notificationhubs/v20230901:Namespace":
                return new Namespace(name, <any>undefined, { urn })
            case "azure-native:notificationhubs/v20230901:NamespaceAuthorizationRule":
                return new NamespaceAuthorizationRule(name, <any>undefined, { urn })
            case "azure-native:notificationhubs/v20230901:NotificationHub":
...
pulumi.runtime.registerResourceModule("azure-native", "notificationhubs/v20230901", _module)

...
export function getNamespaceAuthorizationRule(args: GetNamespaceAuthorizationRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetNamespaceAuthorizationRuleResult> {
    ...
    return pulumi.runtime.invoke("azure-native:notificationhubs/v20230101preview:getNamespaceAuthorizationRule", {
...
export interface GetNamespaceAuthorizationRuleResult {
     ...
     */
    readonly properties: types.outputs.notificationhubs.v20230101preview.SharedAccessAuthorizationRulePropertiesResponse;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    readonly systemData: types.outputs.notificationhubs.v20230101preview.SystemDataResponse;
    /**
     * Deprecated - only for compatibility.
     */

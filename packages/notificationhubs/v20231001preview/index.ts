...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:notificationhubs/v20231001preview:Namespace":
                return new Namespace(name, <any>undefined, { urn })
            case "azure-native:notificationhubs/v20231001preview:NamespaceAuthorizationRule":
                return new NamespaceAuthorizationRule(name, <any>undefined, { urn })
            case "azure-native:notificationhubs/v20231001preview:NotificationHub":
                return new NotificationHub(name, <any>undefined, { urn })
            case "azure-native:notificationhubs/v20231001preview:NotificationHubAuthorizationRule":
                return new NotificationHubAuthorizationRule(name, <any>undefined, { urn })
            case "azure-native:notificationhubs/v20231001preview:PrivateEndpointConnection":
...
pulumi.runtime.registerResourceModule("azure-native", "notificationhubs/v20231001preview", _module)
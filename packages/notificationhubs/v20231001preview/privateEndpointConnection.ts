...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:notificationhubs/v20231001preview:PrivateEndpointConnection';
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:notificationhubs:PrivateEndpointConnection" }, { type: "azure-native:notificationhubs/v20230101preview:PrivateEndpointConnection" }, { type: "azure-native:notificationhubs/v20230901:PrivateEndpointConnection" }] };

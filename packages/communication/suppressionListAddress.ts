...
export class SuppressionListAddress extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SuppressionListAddressArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:communication/v20230601preview:SuppressionListAddress" }, { type: "azure-native:communication/v20240901preview:SuppressionListAddress" }, { type: "azure-native:communication/v20250501preview:SuppressionListAddress" }] };

...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:communication/v20230601preview:CommunicationService":
                return new CommunicationService(name, <any>undefined, { urn })
            case "azure-native:communication/v20230601preview:Domain":
                return new Domain(name, <any>undefined, { urn })
            case "azure-native:communication/v20230601preview:EmailService":
                return new EmailService(name, <any>undefined, { urn })
            case "azure-native:communication/v20230601preview:SenderUsername":
                return new SenderUsername(name, <any>undefined, { urn })
            case "azure-native:communication/v20230601preview:SuppressionList":
                return new SuppressionList(name, <any>undefined, { urn })
            case "azure-native:communication/v20230601preview:SuppressionListAddress":
...
pulumi.runtime.registerResourceModule("azure-native", "communication/v20230601preview", _module)
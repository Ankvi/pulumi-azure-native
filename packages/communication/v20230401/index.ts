...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:communication/v20230401:CommunicationService":
                return new CommunicationService(name, <any>undefined, { urn })
            case "azure-native:communication/v20230401:Domain":
                return new Domain(name, <any>undefined, { urn })
            case "azure-native:communication/v20230401:EmailService":
                return new EmailService(name, <any>undefined, { urn })
            case "azure-native:communication/v20230401:SenderUsername":
...
pulumi.runtime.registerResourceModule("azure-native", "communication/v20230401", _module)
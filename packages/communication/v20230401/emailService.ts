...
export class EmailService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:communication/v20230401:EmailService';
    ...
    constructor(name: string, args: EmailServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:communication:EmailService" }, { type: "azure-native:communication/v20211001preview:EmailService" }, { type: "azure-native:communication/v20220701preview:EmailService" }, { type: "azure-native:communication/v20230301preview:EmailService" }, { type: "azure-native:communication/v20230331:EmailService" }, { type: "azure-native:communication/v20230401preview:EmailService" }, { type: "azure-native:communication/v20230601preview:EmailService" }] };

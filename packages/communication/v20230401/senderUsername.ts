...
export class SenderUsername extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:communication/v20230401:SenderUsername';

...
export class CommunicationService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:communication/v20230331:CommunicationService';

...
export class SenderUsername extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SenderUsernameArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:communication:SenderUsername" }, { type: "azure-native:communication/v20230301preview:SenderUsername" }, { type: "azure-native:communication/v20230401:SenderUsername" }, { type: "azure-native:communication/v20230401preview:SenderUsername" }, { type: "azure-native:communication/v20230601preview:SenderUsername" }] };

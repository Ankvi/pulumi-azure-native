...
export class ServerGroupCluster extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ServerGroupCluster {
        return new ServerGroupCluster(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:dbforpostgresql:ServerGroupCluster';

    /**
     * Returns true if the given object is an instance of ServerGroupCluster.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ServerGroupCluster {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ServerGroupCluster.__pulumiType;
    }
     ...
     */
    declare public readonly authConfig: pulumi.Output<types.outputs.ServerGroupClusterAuthConfigResponse | undefined>;
    /**
     ...
     */
    declare public readonly dataEncryption: pulumi.Output<types.outputs.ServerGroupClusterDataEncryptionResponse | undefined>;
    /**
     ...
     */
    declare public readonly maintenanceWindow: pulumi.Output<types.outputs.ServerGroupClusterMaintenanceWindowResponse | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly privateEndpointConnections: pulumi.Output<types.outputs.SimplePrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    declare public /*out*/ readonly serverNames: pulumi.Output<types.outputs.ServerNameItemResponse[]>;
    /**
     ...
     */
    constructor(name: string, args: ServerGroupClusterArgs, opts?: pulumi.CustomResourceOptions) {
 ...
 */
export interface ServerGroupClusterArgs {
    /**

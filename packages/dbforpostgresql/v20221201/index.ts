...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:dbforpostgresql/v20221201:Administrator":
                return new Administrator(name, <any>undefined, { urn })
            case "azure-native:dbforpostgresql/v20221201:Configuration":
                return new Configuration(name, <any>undefined, { urn })
            case "azure-native:dbforpostgresql/v20221201:Database":
                return new Database(name, <any>undefined, { urn })
            case "azure-native:dbforpostgresql/v20221201:FirewallRule":
                return new FirewallRule(name, <any>undefined, { urn })
            case "azure-native:dbforpostgresql/v20221201:Server":
...
pulumi.runtime.registerResourceModule("azure-native", "dbforpostgresql/v20221201", _module)

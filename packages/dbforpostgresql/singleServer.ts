...
export class SingleServer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:dbforpostgresql:SingleServer';
     ...
     */
    declare public /*out*/ readonly privateEndpointConnections: pulumi.Output<types.outputs.ServerPrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    declare public readonly sku: pulumi.Output<types.outputs.SingleServerSkuResponse | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly storageProfile: pulumi.Output<types.outputs.StorageProfileResponse | undefined>;
    /**
     * Resource tags.
     */
...
export interface SingleServerArgs {
     ...
     * The SKU (pricing tier) of the server.
     */
    sku?: pulumi.Input<types.inputs.SingleServerSkuArgs>;
    /**

...
export class ServerSecurityAlertPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:dbforpostgresql/v20171201preview:ServerSecurityAlertPolicy';
    ...
    constructor(name: string, args: ServerSecurityAlertPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:dbforpostgresql/v20171201:ServerSecurityAlertPolicy" }] };
...
export interface ServerSecurityAlertPolicyArgs {
     ...
     * Specifies the state of the policy, whether it is enabled or disabled.
     */
    state: pulumi.Input<types.enums.v20171201preview.ServerSecurityAlertPolicyState>;
    /**
     * Specifies the identifier key of the Threat Detection audit storage account.
     */

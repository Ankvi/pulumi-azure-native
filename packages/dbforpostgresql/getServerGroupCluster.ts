...
export function getServerGroupCluster(args: GetServerGroupClusterArgs, opts?: pulumi.InvokeOptions): Promise<GetServerGroupClusterResult> {
    ...
    return pulumi.runtime.invoke("azure-native:dbforpostgresql:getServerGroupCluster", {
...
export interface GetServerGroupClusterResult {
     ...
     */
    readonly enableGeoBackup?: boolean;
    /**
...
export function getServerGroupClusterOutput(args: GetServerGroupClusterOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetServerGroupClusterResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:dbforpostgresql:getServerGroupCluster", {
        "clusterName": args.clusterName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}

...
export class Migration extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly currentStatus: pulumi.Output<types.outputs.MigrationStatusResponse>;
    /**
     ...
     */
    declare public /*out*/ readonly sourceDbServerMetadata: pulumi.Output<types.outputs.DbServerMetadataResponse>;
    /**
     ...
     */
    declare public /*out*/ readonly targetDbServerMetadata: pulumi.Output<types.outputs.DbServerMetadataResponse>;
    /**

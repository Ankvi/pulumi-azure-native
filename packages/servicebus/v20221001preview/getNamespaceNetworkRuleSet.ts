...
export interface GetNamespaceNetworkRuleSetResult {
     ...
     * List of IpRules
     */
    readonly ipRules?: types.outputs.servicebus.v20221001preview.NWRuleSetIpRulesResponse[];
    /**
     ...
     */
    readonly virtualNetworkRules?: types.outputs.servicebus.v20221001preview.NWRuleSetVirtualNetworkRulesResponse[];
}
/**
 * Gets NetworkRuleSet for a Namespace.
 */

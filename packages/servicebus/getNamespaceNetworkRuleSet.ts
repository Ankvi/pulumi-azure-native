...
export interface GetNamespaceNetworkRuleSetResult {
     ...
     * List of IpRules
     */
    readonly ipRules?: types.outputs.servicebus.NWRuleSetIpRulesResponse[];
    /**
     ...
     */
    readonly virtualNetworkRules?: types.outputs.servicebus.NWRuleSetVirtualNetworkRulesResponse[];
}
/**
 * Gets NetworkRuleSet for a Namespace.
 * Azure REST API version: 2022-01-01-preview.

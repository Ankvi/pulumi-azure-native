...
export class Subscription extends pulumi.CustomResource {
     ...
     */
    public readonly clientAffineProperties!: pulumi.Output<types.outputs.servicebus.v20220101preview.SBClientAffinePropertiesResponse | undefined>;
    /**
...
export interface SubscriptionArgs {
     ...
     * Properties specific to client affine subscriptions.
     */
    clientAffineProperties?: pulumi.Input<types.inputs.servicebus.v20220101preview.SBClientAffinePropertiesArgs>;
    /**
     * Value that indicates whether a subscription has dead letter support on filter evaluation exceptions.
     */

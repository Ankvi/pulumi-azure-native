...
export class NamespaceNetworkRuleSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:servicebus/v20220101preview:NamespaceNetworkRuleSet';
     ...
     * List of IpRules
     */
    public readonly ipRules!: pulumi.Output<types.outputs.servicebus.v20220101preview.NWRuleSetIpRulesResponse[] | undefined>;
    /**
     ...
     */
    public readonly virtualNetworkRules!: pulumi.Output<types.outputs.servicebus.v20220101preview.NWRuleSetVirtualNetworkRulesResponse[] | undefined>;
...
export interface NamespaceNetworkRuleSetArgs {
     ...
     * Default Action for Network Rule Set
     */
    defaultAction?: pulumi.Input<string | types.enums.v20220101preview.DefaultAction>;
    /**
     * List of IpRules
     */
    ipRules?: pulumi.Input<pulumi.Input<types.inputs.servicebus.v20220101preview.NWRuleSetIpRulesArgs>[]>;
    /**
     * The namespace name
     */
     ...
     * This determines if traffic is allowed over public network. By default it is enabled.
     */
    publicNetworkAccess?: pulumi.Input<string | types.enums.v20220101preview.PublicNetworkAccessFlag>;
    /**
     ...
     * List VirtualNetwork Rules
     */
    virtualNetworkRules?: pulumi.Input<pulumi.Input<types.inputs.servicebus.v20220101preview.NWRuleSetVirtualNetworkRulesArgs>[]>;
}

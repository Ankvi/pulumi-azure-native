...
export class NamespaceNetworkRuleSet extends pulumi.CustomResource {
     ...
     * List of IpRules
     */
    public readonly ipRules!: pulumi.Output<types.outputs.servicebus.NWRuleSetIpRulesResponse[] | undefined>;
    /**
     ...
     */
    public readonly virtualNetworkRules!: pulumi.Output<types.outputs.servicebus.NWRuleSetVirtualNetworkRulesResponse[] | undefined>;
...
export interface NamespaceNetworkRuleSetArgs {
     ...
     * List of IpRules
     */
    ipRules?: pulumi.Input<pulumi.Input<types.inputs.servicebus.NWRuleSetIpRulesArgs>[]>;
    /**
     * The namespace name
     */
     ...
     * List VirtualNetwork Rules
     */
    virtualNetworkRules?: pulumi.Input<pulumi.Input<types.inputs.servicebus.NWRuleSetVirtualNetworkRulesArgs>[]>;
}

...
export namespace networkcloud {
    ...
    export namespace v20221212preview {
        export interface AdministrativeCredentialsArgs {
            /**
             * The password of the administrator of the device used during initialization.
             */
        ...
        export interface BareMetalMachineConfigurationDataArgs {
             ...
             * The credentials of the baseboard management controller on this bare metal machine.
             */
            bmcCredentials: pulumi.Input<v20221212preview.AdministrativeCredentialsArgs>;
            /**
             * The MAC address of the BMC for this machine.
             */
            bmcMacAddress: pulumi.Input<string>;
        ...
        export interface CniBgpConfigurationArgs {
             ...
             * The list of BgpPeer entities that the Hybrid AKS cluster will peer with in addition to peering that occurs automatically with the switch fabric.
             */
            bgpPeers?: pulumi.Input<pulumi.Input<v20221212preview.BgpPeerArgs>[]>;
            /**
             * The list of prefix community advertisement properties. Each prefix community specifies a prefix, and the
             * communities that should be associated with that prefix when it is announced.
             */
            communityAdvertisements?: pulumi.Input<pulumi.Input<v20221212preview.CommunityAdvertisementArgs>[]>;
            /**
             * The password of the Calico node mesh. It defaults to a randomly-generated string when not provided.
             */
            nodeMeshPassword?: pulumi.Input<string>;
        ...
        export interface RackDefinitionArgs {
             ...
             * The unordered list of bare metal machine configuration.
             */
            bareMetalMachineConfigurationData?: pulumi.Input<pulumi.Input<v20221212preview.BareMetalMachineConfigurationDataArgs>[]>;
            /**
             * The resource ID of the network rack that matches this rack definition.
             */
            networkRackId: pulumi.Input<string>;
             ...
             * The list of storage appliance configuration data for this rack.
             */
            storageApplianceConfigurationData?: pulumi.Input<pulumi.Input<v20221212preview.StorageApplianceConfigurationDataArgs>[]>;
        }
        ...
        export interface StorageApplianceConfigurationDataArgs {
             ...
             * The credentials of the administrative interface on this storage appliance.
             */
            adminCredentials: pulumi.Input<v20221212preview.AdministrativeCredentialsArgs>;
            /**
             * The slot that storage appliance is in the rack based on the BOM configuration.
             */
            rackSlot: pulumi.Input<number>;
        ...
        export interface ValidationThresholdArgs {
             ...
             * Selection of how the type evaluation is applied to the cluster calculation.
             */
            grouping: pulumi.Input<string | enums.v20221212preview.ValidationThresholdGrouping>;
            /**
             * Selection of how the threshold should be evaluated.
             */
            type: pulumi.Input<string | enums.v20221212preview.ValidationThresholdType>;
            /**
             * The numeric threshold value.
             */
            value: pulumi.Input<number>;
    ...
    export namespace v20230501preview {
        ...
        export interface AdministratorConfigurationArgs {
             ...
             * The SSH configuration for the operating systems that run the nodes in the Kubernetes cluster. In some cases, specification of public keys may be required to produce a working environment.
             */
            sshPublicKeys?: pulumi.Input<pulumi.Input<v20230501preview.SshPublicKeyArgs>[]>;
        }
        ...
        export interface AgentOptionsArgs {
             ...
             * The size of the hugepages to allocate.
             */
            hugepagesSize?: pulumi.Input<string | enums.v20230501preview.HugepagesSize>;
        }
        /**
         * agentOptionsArgsProvideDefaults sets the appropriate defaults for AgentOptionsArgs
         */
        ...
        export interface AttachedNetworkConfigurationArgs {
             ...
             * The list of Layer 2 Networks and related configuration for attachment.
             */
            l2Networks?: pulumi.Input<pulumi.Input<v20230501preview.L2NetworkAttachmentConfigurationArgs>[]>;
            /**
             * The list of Layer 3 Networks and related configuration for attachment.
             */
            l3Networks?: pulumi.Input<pulumi.Input<v20230501preview.L3NetworkAttachmentConfigurationArgs>[]>;
            /**
             * The list of Trunked Networks and related configuration for attachment.
             */
            trunkedNetworks?: pulumi.Input<pulumi.Input<v20230501preview.TrunkedNetworkAttachmentConfigurationArgs>[]>;
        }
        ...
        export interface BareMetalMachineConfigurationDataArgs {
             ...
             * The credentials of the baseboard management controller on this bare metal machine.
             */
            bmcCredentials: pulumi.Input<v20230501preview.AdministrativeCredentialsArgs>;
            /**
             * The MAC address of the BMC for this machine.
             */
            bmcMacAddress: pulumi.Input<string>;
        ...
        export interface BgpAdvertisementArgs {
             ...
             * The indicator of if this advertisement is also made to the network fabric associated with the Network Cloud Cluster. This field is ignored if fabricPeeringEnabled is set to False.
             */
            advertiseToFabric?: pulumi.Input<string | enums.v20230501preview.AdvertiseToFabric>;
            /**
             * The names of the BGP communities to be associated with the announcement, utilizing a BGP community string in 1234:1234 format.
             */
            communities?: pulumi.Input<pulumi.Input<string>[]>;
        ...
        export interface BgpServiceLoadBalancerConfigurationArgs {
             ...
             * The association of IP address pools to the communities and peers, allowing for announcement of IPs.
             */
            bgpAdvertisements?: pulumi.Input<pulumi.Input<v20230501preview.BgpAdvertisementArgs>[]>;
            /**
             * The list of additional BgpPeer entities that the Kubernetes cluster will peer with. All peering must be explicitly defined.
             */
            bgpPeers?: pulumi.Input<pulumi.Input<v20230501preview.ServiceLoadBalancerBgpPeerArgs>[]>;
            /**
             * The indicator to specify if the load balancer peers with the network fabric.
             */
            fabricPeeringEnabled?: pulumi.Input<string | enums.v20230501preview.FabricPeeringEnabled>;
            /**
             * The list of pools of IP addresses that can be allocated to Load Balancer services.
             */
            ipAddressPools?: pulumi.Input<pulumi.Input<v20230501preview.IpAddressPoolArgs>[]>;
        }
        /**
         * bgpServiceLoadBalancerConfigurationArgsProvideDefaults sets the appropriate defaults for BgpServiceLoadBalancerConfigurationArgs
         */
        ...
        export interface ControlPlaneNodeConfigurationArgs {
             ...
             * The administrator credentials to be used for the nodes in the control plane.
             */
            administratorConfiguration?: pulumi.Input<v20230501preview.AdministratorConfigurationArgs>;
            /**
             * The list of availability zones of the Network Cloud cluster to be used for the provisioning of nodes in the control plane. If not specified, all availability zones will be used.
             */
            availabilityZones?: pulumi.Input<pulumi.Input<string>[]>;
        ...
        export interface EgressEndpointArgs {
             ...
             * The list of endpoint dependencies.
             */
            endpoints: pulumi.Input<pulumi.Input<v20230501preview.EndpointDependencyArgs>[]>;
        }
        ...
        export interface InitialAgentPoolConfigurationArgs {
             ...
             * The configurations that will be applied to each agent in this agent pool.
             */
            agentOptions?: pulumi.Input<v20230501preview.AgentOptionsArgs>;
            /**
             * The configuration of networks being attached to the agent pool for use by the workloads that run on this Kubernetes cluster.
             */
            attachedNetworkConfiguration?: pulumi.Input<v20230501preview.AttachedNetworkConfigurationArgs>;
            /**
             * The list of availability zones of the Network Cloud cluster used for the provisioning of nodes in this agent pool. If not specified, all availability zones will be used.
             */
            availabilityZones?: pulumi.Input<pulumi.Input<string>[]>;
             ...
             * The labels applied to the nodes in this agent pool.
             */
            labels?: pulumi.Input<pulumi.Input<v20230501preview.KubernetesLabelArgs>[]>;
            /**
             * The selection of how this agent pool is utilized, either as a system pool or a user pool. System pools run the features and critical services for the Kubernetes Cluster, while user pools are dedicated to user workloads. Every Kubernetes cluster must contain at least one system node pool with at least one node.
             */
            mode: pulumi.Input<string | enums.v20230501preview.AgentPoolMode>;
            /**
             * The name that will be used for the agent pool resource representing this agent pool.
             */
            name: pulumi.Input<string>;
             ...
             * The taints applied to the nodes in this agent pool.
             */
            taints?: pulumi.Input<pulumi.Input<v20230501preview.KubernetesLabelArgs>[]>;
            /**
             * The configuration of the agent pool.
             */
            upgradeSettings?: pulumi.Input<v20230501preview.AgentPoolUpgradeSettingsArgs>;
            /**
             * The name of the VM SKU that determines the size of resources allocated for node VMs.
             */
            vmSkuName: pulumi.Input<string>;
        ...
        export function initialAgentPoolConfigurationArgsProvideDefaults(val: InitialAgentPoolConfigurationArgs): InitialAgentPoolConfigurationArgs {
            return {
                ...val,
                agentOptions: (val.agentOptions ? pulumi.output(val.agentOptions).apply(v20230501preview.agentOptionsArgsProvideDefaults) : undefined),
                upgradeSettings: (val.upgradeSettings ? pulumi.output(val.upgradeSettings).apply(v20230501preview.agentPoolUpgradeSettingsArgsProvideDefaults) : undefined),
            };
        }
        ...
        export interface IpAddressPoolArgs {
             ...
             * The indicator to determine if automatic allocation from the pool should occur.
             */
            autoAssign?: pulumi.Input<string | enums.v20230501preview.BfdEnabled>;
            /**
             * The name used to identify this IP address pool for association with a BGP advertisement.
             */
            name: pulumi.Input<string>;
             ...
             * The indicator to prevent the use of IP addresses ending with .0 and .255 for this pool. Enabling this option will only use IP addresses between .1 and .254 inclusive.
             */
            onlyUseHostIps?: pulumi.Input<string | enums.v20230501preview.BfdEnabled>;
        }
        /**
         * ipAddressPoolArgsProvideDefaults sets the appropriate defaults for IpAddressPoolArgs
         */
        ...
        export interface KeySetUserArgs {
             ...
             * The SSH public key that will be provisioned for user access. The user is expected to have the corresponding SSH private key for logging in.
             */
            sshPublicKey: pulumi.Input<v20230501preview.SshPublicKeyArgs>;
        }
        ...
        export interface L2NetworkAttachmentConfigurationArgs {
             ...
             * The indicator of how this network will be utilized by the Kubernetes cluster.
             */
            pluginType?: pulumi.Input<string | enums.v20230501preview.KubernetesPluginType>;
        }
        /**
         * l2networkAttachmentConfigurationArgsProvideDefaults sets the appropriate defaults for L2NetworkAttachmentConfigurationArgs
         */
        ...
        export interface L3NetworkAttachmentConfigurationArgs {
             ...
             * The indication of whether this network will or will not perform IP address management and allocate IP addresses when attached.
             */
            ipamEnabled?: pulumi.Input<string | enums.v20230501preview.L3NetworkConfigurationIpamEnabled>;
            /**
             * The resource ID of the network that is being configured for attachment.
             */
            networkId: pulumi.Input<string>;
        ...
        export interface NetworkAttachmentArgs {
             ...
             * Only one of the attached networks (including the CloudServicesNetwork attachment) for a single machine may be specified as True.
             */
            defaultGateway?: pulumi.Input<string | enums.v20230501preview.DefaultGateway>;
            /**
             * The IP allocation mechanism for the virtual machine.
             * Dynamic and Static are only valid for l3Network which may also specify Disabled.
             * Otherwise, Disabled is the only permitted value.
             */
            ipAllocationMethod: pulumi.Input<string | enums.v20230501preview.VirtualMachineIPAllocationMethod>;
            /**
             * The IPv4 address of the virtual machine.
             *
             * This field is used only if the attached network has IPAllocationType of IPV4 or DualStack.
        ...
        export interface NetworkConfigurationArgs {
             ...
             * The configuration of the BGP service load balancer for this Kubernetes cluster.
             */
            bgpServiceLoadBalancerConfiguration?: pulumi.Input<v20230501preview.BgpServiceLoadBalancerConfigurationArgs>;
            /**
             * The resource ID of the associated Cloud Services network.
             */
            cloudServicesNetworkId: pulumi.Input<string>;
        ...
        export function networkConfigurationArgsProvideDefaults(val: NetworkConfigurationArgs): NetworkConfigurationArgs {
            return {
                ...val,
                bgpServiceLoadBalancerConfiguration: (val.bgpServiceLoadBalancerConfiguration ? pulumi.output(val.bgpServiceLoadBalancerConfiguration).apply(v20230501preview.bgpServiceLoadBalancerConfigurationArgsProvideDefaults) : undefined),
            };
        }
        ...
        export interface OsDiskArgs {
             ...
             * The strategy for creating the OS disk.
             */
            createOption?: pulumi.Input<string | enums.v20230501preview.OsDiskCreateOption>;
            /**
             * The strategy for deleting the OS disk.
             */
            deleteOption?: pulumi.Input<string | enums.v20230501preview.OsDiskDeleteOption>;
            /**
             * The size of the disk in gigabytes. Required if the createOption is Ephemeral.
             */
            diskSizeGB: pulumi.Input<number>;
        ...
        export interface RackDefinitionArgs {
             ...
             * The unordered list of bare metal machine configuration.
             */
            bareMetalMachineConfigurationData?: pulumi.Input<pulumi.Input<v20230501preview.BareMetalMachineConfigurationDataArgs>[]>;
            /**
             * The resource ID of the network rack that matches this rack definition.
             */
            networkRackId: pulumi.Input<string>;
             ...
             * The list of storage appliance configuration data for this rack.
             */
            storageApplianceConfigurationData?: pulumi.Input<pulumi.Input<v20230501preview.StorageApplianceConfigurationDataArgs>[]>;
        }
        ...
        export interface ServiceLoadBalancerBgpPeerArgs {
             ...
             * The indicator of BFD enablement for this BgpPeer.
             */
            bfdEnabled?: pulumi.Input<string | enums.v20230501preview.BfdEnabled>;
            /**
             * The indicator to enable multi-hop peering support.
             */
            bgpMultiHop?: pulumi.Input<string | enums.v20230501preview.BgpMultiHop>;
            /**
             * The requested BGP hold time value. This field uses ISO 8601 duration format, for example P1H.
             */
            holdTime?: pulumi.Input<string>;
        ...
        export interface StorageApplianceConfigurationDataArgs {
             ...
             * The credentials of the administrative interface on this storage appliance.
             */
            adminCredentials: pulumi.Input<v20230501preview.AdministrativeCredentialsArgs>;
            /**
             * The slot that storage appliance is in the rack based on the BOM configuration.
             */
            rackSlot: pulumi.Input<number>;
        ...
        export interface StorageProfileArgs {
             ...
             * The disk to use with this virtual machine.
             */
            osDisk: pulumi.Input<v20230501preview.OsDiskArgs>;
            /**
             * The resource IDs of volumes that are requested to be attached to the virtual machine.
             */
            volumeAttachments?: pulumi.Input<pulumi.Input<string>[]>;
        ...
        export function storageProfileArgsProvideDefaults(val: StorageProfileArgs): StorageProfileArgs {
            return {
                ...val,
                osDisk: pulumi.output(val.osDisk).apply(v20230501preview.osDiskArgsProvideDefaults),
            };
        }
        ...
        export interface ValidationThresholdArgs {
             ...
             * Selection of how the type evaluation is applied to the cluster calculation.
             */
            grouping: pulumi.Input<string | enums.v20230501preview.ValidationThresholdGrouping>;
            /**
             * Selection of how the threshold should be evaluated.
             */
            type: pulumi.Input<string | enums.v20230501preview.ValidationThresholdType>;
            /**
             * The numeric threshold value.
             */
            value: pulumi.Input<number>;
        ...
        export interface VirtualMachinePlacementHintArgs {
             ...
             * The specification of whether this hint supports affinity or anti-affinity with the referenced resources.
             */
            hintType: pulumi.Input<string | enums.v20230501preview.VirtualMachinePlacementHintType>;
            /**
             * The resource ID of the target object that the placement hints will be checked against, e.g., the bare metal node to host the virtual machine.
             */
            resourceId: pulumi.Input<string>;
             ...
             * The indicator of whether the hint is a hard or soft requirement during scheduling.
             */
            schedulingExecution: pulumi.Input<string | enums.v20230501preview.VirtualMachineSchedulingExecution>;
            /**
             * The scope for the virtual machine affinity or anti-affinity placement hint. It should always be "Machine" in the case of node affinity.
             */
            scope: pulumi.Input<string | enums.v20230501preview.VirtualMachinePlacementHintPodAffinityScope>;
        }
    ...
    export namespace v20230701 {
        ...
        export interface AdministratorConfigurationArgs {
             ...
             * The SSH configuration for the operating systems that run the nodes in the Kubernetes cluster. In some cases, specification of public keys may be required to produce a working environment.
             */
            sshPublicKeys?: pulumi.Input<pulumi.Input<v20230701.SshPublicKeyArgs>[]>;
        }
        ...
        export interface AgentOptionsArgs {
             ...
             * The size of the hugepages to allocate.
             */
            hugepagesSize?: pulumi.Input<string | enums.v20230701.HugepagesSize>;
        }
        /**
         * agentOptionsArgsProvideDefaults sets the appropriate defaults for AgentOptionsArgs
         */
        ...
        export interface AttachedNetworkConfigurationArgs {
             ...
             * The list of Layer 2 Networks and related configuration for attachment.
             */
            l2Networks?: pulumi.Input<pulumi.Input<v20230701.L2NetworkAttachmentConfigurationArgs>[]>;
            /**
             * The list of Layer 3 Networks and related configuration for attachment.
             */
            l3Networks?: pulumi.Input<pulumi.Input<v20230701.L3NetworkAttachmentConfigurationArgs>[]>;
            /**
             * The list of Trunked Networks and related configuration for attachment.
             */
            trunkedNetworks?: pulumi.Input<pulumi.Input<v20230701.TrunkedNetworkAttachmentConfigurationArgs>[]>;
        }
        ...
        export interface BareMetalMachineConfigurationDataArgs {
             ...
             * The credentials of the baseboard management controller on this bare metal machine.
             */
            bmcCredentials: pulumi.Input<v20230701.AdministrativeCredentialsArgs>;
            /**
             * The MAC address of the BMC for this machine.
             */
            bmcMacAddress: pulumi.Input<string>;
        ...
        export interface BgpAdvertisementArgs {
             ...
             * The indicator of if this advertisement is also made to the network fabric associated with the Network Cloud Cluster. This field is ignored if fabricPeeringEnabled is set to False.
             */
            advertiseToFabric?: pulumi.Input<string | enums.v20230701.AdvertiseToFabric>;
            /**
             * The names of the BGP communities to be associated with the announcement, utilizing a BGP community string in 1234:1234 format.
             */
            communities?: pulumi.Input<pulumi.Input<string>[]>;
        ...
        export interface BgpServiceLoadBalancerConfigurationArgs {
             ...
             * The association of IP address pools to the communities and peers, allowing for announcement of IPs.
             */
            bgpAdvertisements?: pulumi.Input<pulumi.Input<v20230701.BgpAdvertisementArgs>[]>;
            /**
             * The list of additional BgpPeer entities that the Kubernetes cluster will peer with. All peering must be explicitly defined.
             */
            bgpPeers?: pulumi.Input<pulumi.Input<v20230701.ServiceLoadBalancerBgpPeerArgs>[]>;
            /**
             * The indicator to specify if the load balancer peers with the network fabric.
             */
            fabricPeeringEnabled?: pulumi.Input<string | enums.v20230701.FabricPeeringEnabled>;
            /**
             * The list of pools of IP addresses that can be allocated to Load Balancer services.
             */
            ipAddressPools?: pulumi.Input<pulumi.Input<v20230701.IpAddressPoolArgs>[]>;
        }
        /**
         * bgpServiceLoadBalancerConfigurationArgsProvideDefaults sets the appropriate defaults for BgpServiceLoadBalancerConfigurationArgs
         */
        ...
        export interface ControlPlaneNodeConfigurationArgs {
             ...
             * The administrator credentials to be used for the nodes in the control plane.
             */
            administratorConfiguration?: pulumi.Input<v20230701.AdministratorConfigurationArgs>;
            /**
             * The list of availability zones of the Network Cloud cluster to be used for the provisioning of nodes in the control plane. If not specified, all availability zones will be used.
             */
            availabilityZones?: pulumi.Input<pulumi.Input<string>[]>;
        ...
        export interface EgressEndpointArgs {
             ...
             * The list of endpoint dependencies.
             */
            endpoints: pulumi.Input<pulumi.Input<v20230701.EndpointDependencyArgs>[]>;
        }
        ...
        export interface InitialAgentPoolConfigurationArgs {
             ...
             * The configurations that will be applied to each agent in this agent pool.
             */
            agentOptions?: pulumi.Input<v20230701.AgentOptionsArgs>;
            /**
             * The configuration of networks being attached to the agent pool for use by the workloads that run on this Kubernetes cluster.
             */
            attachedNetworkConfiguration?: pulumi.Input<v20230701.AttachedNetworkConfigurationArgs>;
            /**
             * The list of availability zones of the Network Cloud cluster used for the provisioning of nodes in this agent pool. If not specified, all availability zones will be used.
             */
            availabilityZones?: pulumi.Input<pulumi.Input<string>[]>;
             ...
             * The labels applied to the nodes in this agent pool.
             */
            labels?: pulumi.Input<pulumi.Input<v20230701.KubernetesLabelArgs>[]>;
            /**
             * The selection of how this agent pool is utilized, either as a system pool or a user pool. System pools run the features and critical services for the Kubernetes Cluster, while user pools are dedicated to user workloads. Every Kubernetes cluster must contain at least one system node pool with at least one node.
             */
             ...
             * The taints applied to the nodes in this agent pool.
             */
            taints?: pulumi.Input<pulumi.Input<v20230701.KubernetesLabelArgs>[]>;
            /**
             * The configuration of the agent pool.
             */
        ...
        export function initialAgentPoolConfigurationArgsProvideDefaults(val: InitialAgentPoolConfigurationArgs): InitialAgentPoolConfigurationArgs {
            return {
                ...val,
                agentOptions: (val.agentOptions ? pulumi.output(val.agentOptions).apply(v20230701.agentOptionsArgsProvideDefaults) : undefined),
                upgradeSettings: (val.upgradeSettings ? pulumi.output(val.upgradeSettings).apply(v20230701.agentPoolUpgradeSettingsArgsProvideDefaults) : undefined),
            };
        }
        ...
        export interface IpAddressPoolArgs {
             ...
             * The indicator to determine if automatic allocation from the pool should occur.
             */
            autoAssign?: pulumi.Input<string | enums.v20230701.BfdEnabled>;
            /**
             * The name used to identify this IP address pool for association with a BGP advertisement.
             */
            name: pulumi.Input<string>;
             ...
             * The indicator to prevent the use of IP addresses ending with .0 and .255 for this pool. Enabling this option will only use IP addresses between .1 and .254 inclusive.
             */
            onlyUseHostIps?: pulumi.Input<string | enums.v20230701.BfdEnabled>;
        }
        /**
         * ipAddressPoolArgsProvideDefaults sets the appropriate defaults for IpAddressPoolArgs
         */
        ...
        export interface KeySetUserArgs {
             ...
             * The SSH public key that will be provisioned for user access. The user is expected to have the corresponding SSH private key for logging in.
             */
            sshPublicKey: pulumi.Input<v20230701.SshPublicKeyArgs>;
        }
        ...
        export interface L2NetworkAttachmentConfigurationArgs {
             ...
             * The indicator of how this network will be utilized by the Kubernetes cluster.
             */
            pluginType?: pulumi.Input<string | enums.v20230701.KubernetesPluginType>;
        }
        /**
         * l2networkAttachmentConfigurationArgsProvideDefaults sets the appropriate defaults for L2NetworkAttachmentConfigurationArgs
         */
        ...
        export interface L3NetworkAttachmentConfigurationArgs {
             ...
             * The indication of whether this network will or will not perform IP address management and allocate IP addresses when attached.
             */
            ipamEnabled?: pulumi.Input<string | enums.v20230701.L3NetworkConfigurationIpamEnabled>;
            /**
             * The resource ID of the network that is being configured for attachment.
             */
            networkId: pulumi.Input<string>;
        ...
        export interface NetworkAttachmentArgs {
             ...
             * Only one of the attached networks (including the CloudServicesNetwork attachment) for a single machine may be specified as True.
             */
            defaultGateway?: pulumi.Input<string | enums.v20230701.DefaultGateway>;
            /**
             * The IP allocation mechanism for the virtual machine.
             * Dynamic and Static are only valid for l3Network which may also specify Disabled.
             * Otherwise, Disabled is the only permitted value.
             */
            ipAllocationMethod: pulumi.Input<string | enums.v20230701.VirtualMachineIPAllocationMethod>;
            /**
             * The IPv4 address of the virtual machine.
             *
             * This field is used only if the attached network has IPAllocationType of IPV4 or DualStack.
        ...
        export interface NetworkConfigurationArgs {
             ...
             * The configuration of the BGP service load balancer for this Kubernetes cluster.
             */
            bgpServiceLoadBalancerConfiguration?: pulumi.Input<v20230701.BgpServiceLoadBalancerConfigurationArgs>;
            /**
             * The resource ID of the associated Cloud Services network.
             */
            cloudServicesNetworkId: pulumi.Input<string>;
        ...
        export function networkConfigurationArgsProvideDefaults(val: NetworkConfigurationArgs): NetworkConfigurationArgs {
            return {
                ...val,
                bgpServiceLoadBalancerConfiguration: (val.bgpServiceLoadBalancerConfiguration ? pulumi.output(val.bgpServiceLoadBalancerConfiguration).apply(v20230701.bgpServiceLoadBalancerConfigurationArgsProvideDefaults) : undefined),
            };
        }
        ...
        export interface OsDiskArgs {
             ...
             * The strategy for creating the OS disk.
             */
            createOption?: pulumi.Input<string | enums.v20230701.OsDiskCreateOption>;
            /**
             * The strategy for deleting the OS disk.
             */
            deleteOption?: pulumi.Input<string | enums.v20230701.OsDiskDeleteOption>;
            /**
             * The size of the disk in gigabytes. Required if the createOption is Ephemeral.
             */
            diskSizeGB: pulumi.Input<number>;
        ...
        export interface RackDefinitionArgs {
             ...
             * The unordered list of bare metal machine configuration.
             */
            bareMetalMachineConfigurationData?: pulumi.Input<pulumi.Input<v20230701.BareMetalMachineConfigurationDataArgs>[]>;
            /**
             * The resource ID of the network rack that matches this rack definition.
             */
            networkRackId: pulumi.Input<string>;
             ...
             * The list of storage appliance configuration data for this rack.
             */
            storageApplianceConfigurationData?: pulumi.Input<pulumi.Input<v20230701.StorageApplianceConfigurationDataArgs>[]>;
        }
        ...
        export interface ServiceLoadBalancerBgpPeerArgs {
             ...
             * The indicator of BFD enablement for this BgpPeer.
             */
            bfdEnabled?: pulumi.Input<string | enums.v20230701.BfdEnabled>;
            /**
             * The indicator to enable multi-hop peering support.
             */
            bgpMultiHop?: pulumi.Input<string | enums.v20230701.BgpMultiHop>;
            /**
             * The requested BGP hold time value. This field uses ISO 8601 duration format, for example P1H.
             */
            holdTime?: pulumi.Input<string>;
        ...
        export interface StorageApplianceConfigurationDataArgs {
             ...
             * The credentials of the administrative interface on this storage appliance.
             */
            adminCredentials: pulumi.Input<v20230701.AdministrativeCredentialsArgs>;
            /**
             * The slot that storage appliance is in the rack based on the BOM configuration.
             */
            rackSlot: pulumi.Input<number>;
        ...
        export function storageProfileArgsProvideDefaults(val: StorageProfileArgs): StorageProfileArgs {
            return {
                ...val,
                osDisk: pulumi.output(val.osDisk).apply(v20230701.osDiskArgsProvideDefaults),
            };
        }
        ...
        export interface ValidationThresholdArgs {
             ...
             * Selection of how the type evaluation is applied to the cluster calculation.
             */
            grouping: pulumi.Input<string | enums.v20230701.ValidationThresholdGrouping>;
            /**
             * Selection of how the threshold should be evaluated.
             */
            type: pulumi.Input<string | enums.v20230701.ValidationThresholdType>;
            /**
             * The numeric threshold value.
             */
            value: pulumi.Input<number>;
        ...
        export interface VirtualMachinePlacementHintArgs {
             ...
             * The specification of whether this hint supports affinity or anti-affinity with the referenced resources.
             */
            hintType: pulumi.Input<string | enums.v20230701.VirtualMachinePlacementHintType>;
            /**
             * The resource ID of the target object that the placement hints will be checked against, e.g., the bare metal node to host the virtual machine.
             */
            resourceId: pulumi.Input<string>;
             ...
             * The indicator of whether the hint is a hard or soft requirement during scheduling.
             */
            schedulingExecution: pulumi.Input<string | enums.v20230701.VirtualMachineSchedulingExecution>;
            /**
             * The scope for the virtual machine affinity or anti-affinity placement hint. It should always be "Machine" in the case of node affinity.
             */
            scope: pulumi.Input<string | enums.v20230701.VirtualMachinePlacementHintPodAffinityScope>;
        }

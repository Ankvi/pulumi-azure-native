...
export namespace networkcloud {
    ...
    export namespace v20221212preview {
        ...
        export interface BareMetalMachineConfigurationDataResponse {
             ...
             * The credentials of the baseboard management controller on this bare metal machine.
             */
            bmcCredentials: v20221212preview.AdministrativeCredentialsResponse;
            /**
             * The MAC address of the BMC for this machine.
             */
            bmcMacAddress: string;
        ...
        export interface CniBgpConfigurationResponse {
             ...
             * The list of BgpPeer entities that the Hybrid AKS cluster will peer with in addition to peering that occurs automatically with the switch fabric.
             */
            bgpPeers?: v20221212preview.BgpPeerResponse[];
            /**
             * The list of prefix community advertisement properties. Each prefix community specifies a prefix, and the
             * communities that should be associated with that prefix when it is announced.
             */
            communityAdvertisements?: v20221212preview.CommunityAdvertisementResponse[];
            /**
             * The subnet blocks in CIDR format for Kubernetes service external IPs to be advertised over BGP.
             */
            serviceExternalPrefixes?: string[];
        ...
        export interface NodeConfigurationResponse {
             ...
             * The list of nodes that utilize this configuration.
             */
            nodes: v20221212preview.NodeResponse[];
            /**
             * The number of virtual machines that use this configuration.
             */
            vmCount: number;
        ...
        export interface NodeResponse {
             ...
             * The list of network attachments to the virtual machine.
             */
            networkAttachments: v20221212preview.NetworkAttachmentResponse[];
            /**
             * The name of this node, as realized in the Hybrid AKS cluster.
             */
            nodeName: string;
        ...
        export interface RackDefinitionResponse {
             ...
             * The unordered list of bare metal machine configuration.
             */
            bareMetalMachineConfigurationData?: v20221212preview.BareMetalMachineConfigurationDataResponse[];
            /**
             * The resource ID of the network rack that matches this rack definition.
             */
            networkRackId: string;
             ...
             * The list of storage appliance configuration data for this rack.
             */
            storageApplianceConfigurationData?: v20221212preview.StorageApplianceConfigurationDataResponse[];
        }
        ...
        export interface StorageApplianceConfigurationDataResponse {
             ...
             * The credentials of the administrative interface on this storage appliance.
             */
            adminCredentials: v20221212preview.AdministrativeCredentialsResponse;
            /**
             * The slot that storage appliance is in the rack based on the BOM configuration.
             */
            rackSlot: number;
    ...
    export namespace v20230501preview {
        ...
        export interface AdministratorConfigurationResponse {
             ...
             * The SSH configuration for the operating systems that run the nodes in the Kubernetes cluster. In some cases, specification of public keys may be required to produce a working environment.
             */
            sshPublicKeys?: v20230501preview.SshPublicKeyResponse[];
        }
        ...
        export interface AttachedNetworkConfigurationResponse {
             ...
             * The list of Layer 2 Networks and related configuration for attachment.
             */
            l2Networks?: v20230501preview.L2NetworkAttachmentConfigurationResponse[];
            /**
             * The list of Layer 3 Networks and related configuration for attachment.
             */
            l3Networks?: v20230501preview.L3NetworkAttachmentConfigurationResponse[];
            /**
             * The list of Trunked Networks and related configuration for attachment.
             */
            trunkedNetworks?: v20230501preview.TrunkedNetworkAttachmentConfigurationResponse[];
        }
        ...
        export interface BareMetalMachineConfigurationDataResponse {
             ...
             * The credentials of the baseboard management controller on this bare metal machine.
             */
            bmcCredentials: v20230501preview.AdministrativeCredentialsResponse;
            /**
             * The MAC address of the BMC for this machine.
             */
            bmcMacAddress: string;
        ...
        export interface BgpServiceLoadBalancerConfigurationResponse {
             ...
             * The association of IP address pools to the communities and peers, allowing for announcement of IPs.
             */
            bgpAdvertisements?: v20230501preview.BgpAdvertisementResponse[];
            /**
             * The list of additional BgpPeer entities that the Kubernetes cluster will peer with. All peering must be explicitly defined.
             */
            bgpPeers?: v20230501preview.ServiceLoadBalancerBgpPeerResponse[];
            /**
             * The indicator to specify if the load balancer peers with the network fabric.
             */
            fabricPeeringEnabled?: string;
             ...
             * The list of pools of IP addresses that can be allocated to Load Balancer services.
             */
            ipAddressPools?: v20230501preview.IpAddressPoolResponse[];
        }
        /**
         * bgpServiceLoadBalancerConfigurationResponseProvideDefaults sets the appropriate defaults for BgpServiceLoadBalancerConfigurationResponse
         */
        ...
        export interface ControlPlaneNodeConfigurationResponse {
             ...
             * The administrator credentials to be used for the nodes in the control plane.
             */
            administratorConfiguration?: v20230501preview.AdministratorConfigurationResponse;
            /**
             * The list of availability zones of the Network Cloud cluster to be used for the provisioning of nodes in the control plane. If not specified, all availability zones will be used.
             */
            availabilityZones?: string[];
        ...
        export interface EgressEndpointResponse {
             ...
             * The list of endpoint dependencies.
             */
            endpoints: v20230501preview.EndpointDependencyResponse[];
        }
        ...
        export interface HardwareInventoryResponse {
             ...
             * The list of network interfaces and associated details for the bare metal machine.
             */
            interfaces: v20230501preview.HardwareInventoryNetworkInterfaceResponse[];
            /**
             * Field Deprecated. Will be removed in an upcoming version. The list of network interface cards and associated details for the bare metal machine.
             */
            nics: v20230501preview.NicResponse[];
        }
        ...
        export interface InitialAgentPoolConfigurationResponse {
             ...
             * The configurations that will be applied to each agent in this agent pool.
             */
            agentOptions?: v20230501preview.AgentOptionsResponse;
            /**
             * The configuration of networks being attached to the agent pool for use by the workloads that run on this Kubernetes cluster.
             */
            attachedNetworkConfiguration?: v20230501preview.AttachedNetworkConfigurationResponse;
            /**
             * The list of availability zones of the Network Cloud cluster used for the provisioning of nodes in this agent pool. If not specified, all availability zones will be used.
             */
            availabilityZones?: string[];
             ...
             * The labels applied to the nodes in this agent pool.
             */
            labels?: v20230501preview.KubernetesLabelResponse[];
            /**
             * The selection of how this agent pool is utilized, either as a system pool or a user pool. System pools run the features and critical services for the Kubernetes Cluster, while user pools are dedicated to user workloads. Every Kubernetes cluster must contain at least one system node pool with at least one node.
             */
            mode: string;
             ...
             * The taints applied to the nodes in this agent pool.
             */
            taints?: v20230501preview.KubernetesLabelResponse[];
            /**
             * The configuration of the agent pool.
             */
            upgradeSettings?: v20230501preview.AgentPoolUpgradeSettingsResponse;
            /**
             * The name of the VM SKU that determines the size of resources allocated for node VMs.
             */
            vmSkuName: string;
        ...
        export function initialAgentPoolConfigurationResponseProvideDefaults(val: InitialAgentPoolConfigurationResponse): InitialAgentPoolConfigurationResponse {
            return {
                ...val,
                agentOptions: (val.agentOptions ? v20230501preview.agentOptionsResponseProvideDefaults(val.agentOptions) : undefined),
                upgradeSettings: (val.upgradeSettings ? v20230501preview.agentPoolUpgradeSettingsResponseProvideDefaults(val.upgradeSettings) : undefined),
            };
        }
        ...
        export interface KeySetUserResponse {
             ...
             * The SSH public key that will be provisioned for user access. The user is expected to have the corresponding SSH private key for logging in.
             */
            sshPublicKey: v20230501preview.SshPublicKeyResponse;
        }
        ...
        export interface KubernetesClusterNodeResponse {
             ...
             * The NetworkAttachments made to this node.
             */
            networkAttachments: v20230501preview.NetworkAttachmentResponse[];
            /**
             * The power state of this node.
             */
            powerState: string;
        ...
        export interface NetworkConfigurationResponse {
             ...
             * The configuration of the BGP service load balancer for this Kubernetes cluster.
             */
            bgpServiceLoadBalancerConfiguration?: v20230501preview.BgpServiceLoadBalancerConfigurationResponse;
            /**
             * The resource ID of the associated Cloud Services network.
             */
            cloudServicesNetworkId: string;
        ...
        export function networkConfigurationResponseProvideDefaults(val: NetworkConfigurationResponse): NetworkConfigurationResponse {
            return {
                ...val,
                bgpServiceLoadBalancerConfiguration: (val.bgpServiceLoadBalancerConfiguration ? v20230501preview.bgpServiceLoadBalancerConfigurationResponseProvideDefaults(val.bgpServiceLoadBalancerConfiguration) : undefined),
            };
        }
        ...
        export interface NicResponse {
             ...
             * The information about the device connected to this NIC.
             */
            lldpNeighbor: v20230501preview.LldpNeighborResponse;
            /**
             * The MAC address associated with this NIC.
             */
            macAddress: string;
        ...
        export interface RackDefinitionResponse {
             ...
             * The unordered list of bare metal machine configuration.
             */
            bareMetalMachineConfigurationData?: v20230501preview.BareMetalMachineConfigurationDataResponse[];
            /**
             * The resource ID of the network rack that matches this rack definition.
             */
            networkRackId: string;
             ...
             * The list of storage appliance configuration data for this rack.
             */
            storageApplianceConfigurationData?: v20230501preview.StorageApplianceConfigurationDataResponse[];
        }
        ...
        export interface StorageApplianceConfigurationDataResponse {
             ...
             * The credentials of the administrative interface on this storage appliance.
             */
            adminCredentials: v20230501preview.AdministrativeCredentialsResponse;
            /**
             * The slot that storage appliance is in the rack based on the BOM configuration.
             */
            rackSlot: number;
        ...
        export interface StorageProfileResponse {
             ...
             * The disk to use with this virtual machine.
             */
            osDisk: v20230501preview.OsDiskResponse;
            /**
             * The resource IDs of volumes that are requested to be attached to the virtual machine.
             */
            volumeAttachments?: string[];
        ...
        export function storageProfileResponseProvideDefaults(val: StorageProfileResponse): StorageProfileResponse {
            return {
                ...val,
                osDisk: v20230501preview.osDiskResponseProvideDefaults(val.osDisk),
            };
        }
    ...
    export namespace v20230701 {
        ...
        export interface AdministratorConfigurationResponse {
             ...
             * The SSH configuration for the operating systems that run the nodes in the Kubernetes cluster. In some cases, specification of public keys may be required to produce a working environment.
             */
            sshPublicKeys?: v20230701.SshPublicKeyResponse[];
        }
        ...
        export interface AttachedNetworkConfigurationResponse {
             ...
             * The list of Layer 2 Networks and related configuration for attachment.
             */
            l2Networks?: v20230701.L2NetworkAttachmentConfigurationResponse[];
            /**
             * The list of Layer 3 Networks and related configuration for attachment.
             */
            l3Networks?: v20230701.L3NetworkAttachmentConfigurationResponse[];
            /**
             * The list of Trunked Networks and related configuration for attachment.
             */
            trunkedNetworks?: v20230701.TrunkedNetworkAttachmentConfigurationResponse[];
        }
        ...
        export interface BareMetalMachineConfigurationDataResponse {
             ...
             * The credentials of the baseboard management controller on this bare metal machine.
             */
            bmcCredentials: v20230701.AdministrativeCredentialsResponse;
            /**
             * The MAC address of the BMC for this machine.
             */
            bmcMacAddress: string;
        ...
        export interface BgpServiceLoadBalancerConfigurationResponse {
             ...
             * The association of IP address pools to the communities and peers, allowing for announcement of IPs.
             */
            bgpAdvertisements?: v20230701.BgpAdvertisementResponse[];
            /**
             * The list of additional BgpPeer entities that the Kubernetes cluster will peer with. All peering must be explicitly defined.
             */
            bgpPeers?: v20230701.ServiceLoadBalancerBgpPeerResponse[];
            /**
             * The indicator to specify if the load balancer peers with the network fabric.
             */
            fabricPeeringEnabled?: string;
             ...
             * The list of pools of IP addresses that can be allocated to Load Balancer services.
             */
            ipAddressPools?: v20230701.IpAddressPoolResponse[];
        }
        /**
         * bgpServiceLoadBalancerConfigurationResponseProvideDefaults sets the appropriate defaults for BgpServiceLoadBalancerConfigurationResponse
         */
        ...
        export interface ControlPlaneNodeConfigurationResponse {
             ...
             * The administrator credentials to be used for the nodes in the control plane.
             */
            administratorConfiguration?: v20230701.AdministratorConfigurationResponse;
            /**
             * The list of availability zones of the Network Cloud cluster to be used for the provisioning of nodes in the control plane. If not specified, all availability zones will be used.
             */
            availabilityZones?: string[];
        ...
        export interface EgressEndpointResponse {
             ...
             * The list of endpoint dependencies.
             */
            endpoints: v20230701.EndpointDependencyResponse[];
        }
        ...
        export interface HardwareInventoryResponse {
             ...
             * The list of network interfaces and associated details for the bare metal machine.
             */
            interfaces: v20230701.HardwareInventoryNetworkInterfaceResponse[];
            /**
             * Field Deprecated. Will be removed in an upcoming version. The list of network interface cards and associated details for the bare metal machine.
             */
            nics: v20230701.NicResponse[];
        }
        ...
        export interface InitialAgentPoolConfigurationResponse {
             ...
             * The configurations that will be applied to each agent in this agent pool.
             */
            agentOptions?: v20230701.AgentOptionsResponse;
            /**
             * The configuration of networks being attached to the agent pool for use by the workloads that run on this Kubernetes cluster.
             */
            attachedNetworkConfiguration?: v20230701.AttachedNetworkConfigurationResponse;
            /**
             * The list of availability zones of the Network Cloud cluster used for the provisioning of nodes in this agent pool. If not specified, all availability zones will be used.
             */
            availabilityZones?: string[];
             ...
             * The labels applied to the nodes in this agent pool.
             */
            labels?: v20230701.KubernetesLabelResponse[];
            /**
             * The selection of how this agent pool is utilized, either as a system pool or a user pool. System pools run the features and critical services for the Kubernetes Cluster, while user pools are dedicated to user workloads. Every Kubernetes cluster must contain at least one system node pool with at least one node.
             */
            mode: string;
             ...
             * The taints applied to the nodes in this agent pool.
             */
            taints?: v20230701.KubernetesLabelResponse[];
            /**
             * The configuration of the agent pool.
             */
        ...
        export function initialAgentPoolConfigurationResponseProvideDefaults(val: InitialAgentPoolConfigurationResponse): InitialAgentPoolConfigurationResponse {
            return {
                ...val,
                agentOptions: (val.agentOptions ? v20230701.agentOptionsResponseProvideDefaults(val.agentOptions) : undefined),
                upgradeSettings: (val.upgradeSettings ? v20230701.agentPoolUpgradeSettingsResponseProvideDefaults(val.upgradeSettings) : undefined),
            };
        }
        ...
        export interface KeySetUserResponse {
             ...
             * The SSH public key that will be provisioned for user access. The user is expected to have the corresponding SSH private key for logging in.
             */
            sshPublicKey: v20230701.SshPublicKeyResponse;
        }
        ...
        export interface KubernetesClusterNodeResponse {
             ...
             * The NetworkAttachments made to this node.
             */
            networkAttachments: v20230701.NetworkAttachmentResponse[];
            /**
             * The power state of this node.
             */
            powerState: string;
        ...
        export interface NetworkConfigurationResponse {
             ...
             * The configuration of the BGP service load balancer for this Kubernetes cluster.
             */
            bgpServiceLoadBalancerConfiguration?: v20230701.BgpServiceLoadBalancerConfigurationResponse;
            /**
             * The resource ID of the associated Cloud Services network.
             */
            cloudServicesNetworkId: string;
        ...
        export function networkConfigurationResponseProvideDefaults(val: NetworkConfigurationResponse): NetworkConfigurationResponse {
            return {
                ...val,
                bgpServiceLoadBalancerConfiguration: (val.bgpServiceLoadBalancerConfiguration ? v20230701.bgpServiceLoadBalancerConfigurationResponseProvideDefaults(val.bgpServiceLoadBalancerConfiguration) : undefined),
            };
        }
        ...
        export interface NicResponse {
             ...
             * The information about the device connected to this NIC.
             */
            lldpNeighbor: v20230701.LldpNeighborResponse;
            /**
             * The MAC address associated with this NIC.
             */
            macAddress: string;
        ...
        export interface RackDefinitionResponse {
             ...
             * The unordered list of bare metal machine configuration.
             */
            bareMetalMachineConfigurationData?: v20230701.BareMetalMachineConfigurationDataResponse[];
            /**
             * The resource ID of the network rack that matches this rack definition.
             */
            networkRackId: string;
             ...
             * The list of storage appliance configuration data for this rack.
             */
            storageApplianceConfigurationData?: v20230701.StorageApplianceConfigurationDataResponse[];
        }
        ...
        export interface StorageApplianceConfigurationDataResponse {
             ...
             * The credentials of the administrative interface on this storage appliance.
             */
            adminCredentials: v20230701.AdministrativeCredentialsResponse;
            /**
             * The slot that storage appliance is in the rack based on the BOM configuration.
             */
            rackSlot: number;
        ...
        export function storageProfileResponseProvideDefaults(val: StorageProfileResponse): StorageProfileResponse {
            return {
                ...val,
                osDisk: v20230701.osDiskResponseProvideDefaults(val.osDisk),
            };
        }

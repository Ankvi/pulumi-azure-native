...
export class VirtualMachine extends pulumi.CustomResource {
    ...
    constructor(name: string, args: VirtualMachineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:VirtualMachine" }, { type: "azure-native:networkcloud/v20230501preview:VirtualMachine" }, { type: "azure-native:networkcloud/v20231001preview:VirtualMachine" }] };

...
export class VirtualMachine extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkcloud/v20230701:VirtualMachine';
     ...
     */
    public readonly cloudServicesNetworkAttachment!: pulumi.Output<types.outputs.networkcloud.v20230701.NetworkAttachmentResponse>;
    /**
     ...
     */
    public readonly networkAttachments!: pulumi.Output<types.outputs.networkcloud.v20230701.NetworkAttachmentResponse[] | undefined>;
    /**
     ...
     */
    public readonly placementHints!: pulumi.Output<types.outputs.networkcloud.v20230701.VirtualMachinePlacementHintResponse[] | undefined>;
    /**
     ...
     */
    public readonly sshPublicKeys!: pulumi.Output<types.outputs.networkcloud.v20230701.SshPublicKeyResponse[] | undefined>;
    /**
     * The storage profile that specifies size and other parameters about the disks related to the virtual machine.
     */
    public readonly storageProfile!: pulumi.Output<types.outputs.networkcloud.v20230701.StorageProfileResponse>;
    /**
     ...
     */
    public readonly vmImageRepositoryCredentials!: pulumi.Output<types.outputs.networkcloud.v20230701.ImageRepositoryCredentialsResponse | undefined>;
    /**
    ...
    constructor(name: string, args: VirtualMachineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["storageProfile"] = args ? (args.storageProfile ? pulumi.output(args.storageProfile).apply(types.inputs.networkcloud.v20230701.storageProfileArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:VirtualMachine" }, { type: "azure-native:networkcloud/v20221212preview:VirtualMachine" }, { type: "azure-native:networkcloud/v20230501preview:VirtualMachine" }] };
...
export interface VirtualMachineArgs {
     ...
     * Selects the boot method for the virtual machine.
     */
    bootMethod?: pulumi.Input<string | types.enums.v20230701.VirtualMachineBootMethod>;
    /**
     * The cloud service network that provides platform-level services for the virtual machine.
     */
    cloudServicesNetworkAttachment: pulumi.Input<types.inputs.networkcloud.v20230701.NetworkAttachmentArgs>;
    /**
     * The number of CPU cores in the virtual machine.
     */
     ...
     * Field Deprecated, the value will be ignored if provided. The indicator of whether one of the specified CPU cores is isolated to run the emulator thread for this virtual machine.
     */
    isolateEmulatorThread?: pulumi.Input<string | types.enums.v20230701.VirtualMachineIsolateEmulatorThread>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The list of network attachments to the virtual machine.
     */
    networkAttachments?: pulumi.Input<pulumi.Input<types.inputs.networkcloud.v20230701.NetworkAttachmentArgs>[]>;
    /**
     * The Base64 encoded cloud-init network data.
     */
     ...
     * The scheduling hints for the virtual machine.
     */
    placementHints?: pulumi.Input<pulumi.Input<types.inputs.networkcloud.v20230701.VirtualMachinePlacementHintArgs>[]>;
    /**
     ...
     * The list of ssh public keys. Each key will be added to the virtual machine using the cloud-init ssh_authorized_keys mechanism for the adminUsername.
     */
    sshPublicKeys?: pulumi.Input<pulumi.Input<types.inputs.networkcloud.v20230701.SshPublicKeyArgs>[]>;
    /**
     * The storage profile that specifies size and other parameters about the disks related to the virtual machine.
     */
    storageProfile: pulumi.Input<types.inputs.networkcloud.v20230701.StorageProfileArgs>;
    /**
     * Resource tags.
     */
     ...
     * Field Deprecated, use virtualizationModel instead. The type of the virtio interface.
     */
    virtioInterface?: pulumi.Input<string | types.enums.v20230701.VirtualMachineVirtioInterfaceType>;
    /**
     ...
     * The type of the device model to use.
     */
    vmDeviceModel?: pulumi.Input<string | types.enums.v20230701.VirtualMachineDeviceModelType>;
    /**
     * The virtual machine image that is currently provisioned to the OS disk, using the full url and tag notation used to pull the image.
     */
     ...
     * The credentials used to login to the image repository that has access to the specified image.
     */
    vmImageRepositoryCredentials?: pulumi.Input<types.inputs.networkcloud.v20230701.ImageRepositoryCredentialsArgs>;
}

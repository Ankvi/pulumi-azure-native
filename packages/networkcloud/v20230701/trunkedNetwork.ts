...
export class TrunkedNetwork extends pulumi.CustomResource {
    ...
    constructor(name: string, args: TrunkedNetworkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:TrunkedNetwork" }, { type: "azure-native:networkcloud/v20221212preview:TrunkedNetwork" }, { type: "azure-native:networkcloud/v20230501preview:TrunkedNetwork" }] };

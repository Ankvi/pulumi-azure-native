...
export function getVirtualMachine(args: GetVirtualMachineArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualMachineResult> {
    ...
    return pulumi.runtime.invoke("azure-native:networkcloud/v20230701:getVirtualMachine", {
...
export interface GetVirtualMachineResult {
     ...
     */
    readonly cloudServicesNetworkAttachment: types.outputs.networkcloud.v20230701.NetworkAttachmentResponse;
    /**
     ...
     */
    readonly networkAttachments?: types.outputs.networkcloud.v20230701.NetworkAttachmentResponse[];
    /**
     ...
     */
    readonly placementHints?: types.outputs.networkcloud.v20230701.VirtualMachinePlacementHintResponse[];
    /**
     ...
     */
    readonly sshPublicKeys?: types.outputs.networkcloud.v20230701.SshPublicKeyResponse[];
    /**
     * The storage profile that specifies size and other parameters about the disks related to the virtual machine.
     */
    readonly storageProfile: types.outputs.networkcloud.v20230701.StorageProfileResponse;
    /**
     ...
     */
    readonly vmImageRepositoryCredentials?: types.outputs.networkcloud.v20230701.ImageRepositoryCredentialsResponse;
    /**

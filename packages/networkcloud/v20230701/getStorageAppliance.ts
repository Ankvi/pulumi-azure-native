...
export function getStorageAppliance(args: GetStorageApplianceArgs, opts?: pulumi.InvokeOptions): Promise<GetStorageApplianceResult> {
    ...
    return pulumi.runtime.invoke("azure-native:networkcloud/v20230701:getStorageAppliance", {
...
export interface GetStorageApplianceResult {
     ...
     */
    readonly administratorCredentials: types.outputs.networkcloud.v20230701.AdministrativeCredentialsResponse;
    /**

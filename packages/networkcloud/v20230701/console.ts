...
export class Console extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkcloud/v20230701:Console';
     ...
     */
    public readonly sshPublicKey!: pulumi.Output<types.outputs.networkcloud.v20230701.SshPublicKeyResponse>;
    /**
    ...
    constructor(name: string, args: ConsoleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:Console" }, { type: "azure-native:networkcloud/v20221212preview:Console" }, { type: "azure-native:networkcloud/v20230501preview:Console" }] };
...
export interface ConsoleArgs {
     ...
     * The indicator of whether the console access is enabled.
     */
    enabled: pulumi.Input<string | types.enums.v20230701.ConsoleEnabled>;
    /**
     * The date and time after which the key will be disallowed access.
     */
     ...
     * The SSH public key that will be provisioned for user access. The user is expected to have the corresponding SSH private key for logging in.
     */
    sshPublicKey: pulumi.Input<types.inputs.networkcloud.v20230701.SshPublicKeyArgs>;
    /**
     * Resource tags.
     */

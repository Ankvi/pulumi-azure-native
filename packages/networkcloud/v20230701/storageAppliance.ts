...
export class StorageAppliance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkcloud/v20230701:StorageAppliance';
     ...
     */
    public readonly administratorCredentials!: pulumi.Output<types.outputs.networkcloud.v20230701.AdministrativeCredentialsResponse>;
    /**
    ...
    constructor(name: string, args: StorageApplianceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:StorageAppliance" }, { type: "azure-native:networkcloud/v20221212preview:StorageAppliance" }, { type: "azure-native:networkcloud/v20230501preview:StorageAppliance" }] };
...
export interface StorageApplianceArgs {
     ...
     * The credentials of the administrative interface on this storage appliance.
     */
    administratorCredentials: pulumi.Input<types.inputs.networkcloud.v20230701.AdministrativeCredentialsArgs>;
    /**
     * The extended location of the cluster associated with the resource.
     */

...
export class StorageAppliance extends pulumi.CustomResource {
    ...
    constructor(name: string, args: StorageApplianceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:StorageAppliance" }, { type: "azure-native:networkcloud/v20230501preview:StorageAppliance" }, { type: "azure-native:networkcloud/v20231001preview:StorageAppliance" }] };

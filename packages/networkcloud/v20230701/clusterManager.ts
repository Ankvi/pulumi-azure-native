...
export class ClusterManager extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ClusterManagerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:ClusterManager" }, { type: "azure-native:networkcloud/v20221212preview:ClusterManager" }, { type: "azure-native:networkcloud/v20230501preview:ClusterManager" }] };

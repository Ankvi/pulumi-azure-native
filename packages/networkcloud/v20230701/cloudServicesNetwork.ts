...
export class CloudServicesNetwork extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkcloud/v20230701:CloudServicesNetwork';
     ...
     */
    public readonly additionalEgressEndpoints!: pulumi.Output<types.outputs.networkcloud.v20230701.EgressEndpointResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly enabledEgressEndpoints!: pulumi.Output<types.outputs.networkcloud.v20230701.EgressEndpointResponse[]>;
    /**
    ...
    constructor(name: string, args: CloudServicesNetworkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:CloudServicesNetwork" }, { type: "azure-native:networkcloud/v20221212preview:CloudServicesNetwork" }, { type: "azure-native:networkcloud/v20230501preview:CloudServicesNetwork" }] };
...
export interface CloudServicesNetworkArgs {
     ...
     * The list of egress endpoints. This allows for connection from a Hybrid AKS cluster to the specified endpoint.
     */
    additionalEgressEndpoints?: pulumi.Input<pulumi.Input<types.inputs.networkcloud.v20230701.EgressEndpointArgs>[]>;
    /**
     ...
     * The indicator of whether the platform default endpoints are allowed for the egress traffic.
     */
    enableDefaultEgressEndpoints?: pulumi.Input<string | types.enums.v20230701.CloudServicesNetworkEnableDefaultEgressEndpoints>;
    /**
     * The extended location of the cluster associated with the resource.
     */

...
export class MetricsConfiguration extends pulumi.CustomResource {
    ...
    constructor(name: string, args: MetricsConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:MetricsConfiguration" }, { type: "azure-native:networkcloud/v20230501preview:MetricsConfiguration" }, { type: "azure-native:networkcloud/v20231001preview:MetricsConfiguration" }] };

...
export class Rack extends pulumi.CustomResource {
    ...
    constructor(name: string, args: RackArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:Rack" }, { type: "azure-native:networkcloud/v20230501preview:Rack" }, { type: "azure-native:networkcloud/v20231001preview:Rack" }] };

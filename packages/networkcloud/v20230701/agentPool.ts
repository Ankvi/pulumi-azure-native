...
export class AgentPool extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AgentPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:AgentPool" }, { type: "azure-native:networkcloud/v20230501preview:AgentPool" }, { type: "azure-native:networkcloud/v20231001preview:AgentPool" }] };

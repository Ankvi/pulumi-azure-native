...
export class BmcKeySet extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BmcKeySetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:BmcKeySet" }, { type: "azure-native:networkcloud/v20230501preview:BmcKeySet" }, { type: "azure-native:networkcloud/v20231001preview:BmcKeySet" }] };

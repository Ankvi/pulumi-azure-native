...
export function getClusterManager(args: GetClusterManagerArgs, opts?: pulumi.InvokeOptions): Promise<GetClusterManagerResult> {
    ...
    return pulumi.runtime.invoke("azure-native:networkcloud/v20230701:getClusterManager", {
...
export interface GetClusterManagerResult {
     ...
     */
    readonly clusterVersions: types.outputs.networkcloud.v20230701.ClusterAvailableVersionResponse[];
    /**
     ...
     */
    readonly managerExtendedLocation: types.outputs.networkcloud.v20230701.ExtendedLocationResponse;
    /**

...
export class Volume extends pulumi.CustomResource {
    ...
    constructor(name: string, args: VolumeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud/v20221212preview:Volume" }, { type: "azure-native:networkcloud/v20230501preview:Volume" }, { type: "azure-native:networkcloud/v20230701:Volume" }] };

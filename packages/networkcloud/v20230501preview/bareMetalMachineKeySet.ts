...
export class BareMetalMachineKeySet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkcloud/v20230501preview:BareMetalMachineKeySet';
     ...
     */
    public readonly userList!: pulumi.Output<types.outputs.networkcloud.v20230501preview.KeySetUserResponse[]>;
    /**
     * The status evaluation of each user.
     */
    public /*out*/ readonly userListStatus!: pulumi.Output<types.outputs.networkcloud.v20230501preview.KeySetUserStatusResponse[]>;
    ...
    constructor(name: string, args: BareMetalMachineKeySetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:BareMetalMachineKeySet" }, { type: "azure-native:networkcloud/v20221212preview:BareMetalMachineKeySet" }, { type: "azure-native:networkcloud/v20230701:BareMetalMachineKeySet" }] };
...
export interface BareMetalMachineKeySetArgs {
     ...
     * The access level allowed for the users in this key set.
     */
    privilegeLevel: pulumi.Input<string | types.enums.v20230501preview.BareMetalMachineKeySetPrivilegeLevel>;
    /**
     ...
     * The unique list of permitted users.
     */
    userList: pulumi.Input<pulumi.Input<types.inputs.networkcloud.v20230501preview.KeySetUserArgs>[]>;
}

...
export function getCloudServicesNetwork(args: GetCloudServicesNetworkArgs, opts?: pulumi.InvokeOptions): Promise<GetCloudServicesNetworkResult> {
    ...
    return pulumi.runtime.invoke("azure-native:networkcloud/v20230501preview:getCloudServicesNetwork", {
...
export interface GetCloudServicesNetworkResult {
     ...
     */
    readonly additionalEgressEndpoints?: types.outputs.networkcloud.v20230501preview.EgressEndpointResponse[];
    /**
     ...
     */
    readonly enabledEgressEndpoints: types.outputs.networkcloud.v20230501preview.EgressEndpointResponse[];
    /**

...
export class BareMetalMachine extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkcloud/v20230501preview:BareMetalMachine';
     ...
     */
    public readonly bmcCredentials!: pulumi.Output<types.outputs.networkcloud.v20230501preview.AdministrativeCredentialsResponse>;
    /**
     ...
     */
    public /*out*/ readonly hardwareInventory!: pulumi.Output<types.outputs.networkcloud.v20230501preview.HardwareInventoryResponse>;
    /**
     * The details of the latest hardware validation performed for this bare metal machine.
     */
    public /*out*/ readonly hardwareValidationStatus!: pulumi.Output<types.outputs.networkcloud.v20230501preview.HardwareValidationStatusResponse>;
    /**
...
export interface BareMetalMachineArgs {
     ...
     * The credentials of the baseboard management controller on this bare metal machine.
     */
    bmcCredentials: pulumi.Input<types.inputs.networkcloud.v20230501preview.AdministrativeCredentialsArgs>;
    /**
     * The MAC address of the BMC device.
     */

...
export interface GetBareMetalMachineResult {
     ...
     */
    readonly bmcCredentials: types.outputs.networkcloud.v20230501preview.AdministrativeCredentialsResponse;
    /**
     ...
     */
    readonly hardwareInventory: types.outputs.networkcloud.v20230501preview.HardwareInventoryResponse;
    /**
     * The details of the latest hardware validation performed for this bare metal machine.
     */
    readonly hardwareValidationStatus: types.outputs.networkcloud.v20230501preview.HardwareValidationStatusResponse;
    /**

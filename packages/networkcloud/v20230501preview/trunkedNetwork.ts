...
export class TrunkedNetwork extends pulumi.CustomResource {
    ...
    constructor(name: string, args: TrunkedNetworkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:TrunkedNetwork" }, { type: "azure-native:networkcloud/v20230701:TrunkedNetwork" }, { type: "azure-native:networkcloud/v20231001preview:TrunkedNetwork" }] };

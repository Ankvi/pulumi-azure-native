...
export class MetricsConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkcloud/v20230501preview:MetricsConfiguration';
    ...
    constructor(name: string, args: MetricsConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:MetricsConfiguration" }, { type: "azure-native:networkcloud/v20221212preview:MetricsConfiguration" }, { type: "azure-native:networkcloud/v20230701:MetricsConfiguration" }] };

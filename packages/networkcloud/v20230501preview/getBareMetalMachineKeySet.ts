...
export function getBareMetalMachineKeySet(args: GetBareMetalMachineKeySetArgs, opts?: pulumi.InvokeOptions): Promise<GetBareMetalMachineKeySetResult> {
    ...
    return pulumi.runtime.invoke("azure-native:networkcloud/v20230501preview:getBareMetalMachineKeySet", {
...
export interface GetBareMetalMachineKeySetResult {
     ...
     */
    readonly userList: types.outputs.networkcloud.v20230501preview.KeySetUserResponse[];
    /**
     * The status evaluation of each user.
     */
    readonly userListStatus: types.outputs.networkcloud.v20230501preview.KeySetUserStatusResponse[];
}
/**
 * Get bare metal machine key set of the provided cluster.
 */

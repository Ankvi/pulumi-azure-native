...
export function getKubernetesCluster(args: GetKubernetesClusterArgs, opts?: pulumi.InvokeOptions): Promise<GetKubernetesClusterResult> {
    ...
    return pulumi.runtime.invoke("azure-native:networkcloud/v20230501preview:getKubernetesCluster", {
...
export interface GetKubernetesClusterResult {
     ...
     */
    readonly aadConfiguration?: types.outputs.networkcloud.v20230501preview.AadConfigurationResponse;
    /**
     ...
     */
    readonly administratorConfiguration?: types.outputs.networkcloud.v20230501preview.AdministratorConfigurationResponse;
    /**
     ...
     */
    readonly availableUpgrades: types.outputs.networkcloud.v20230501preview.AvailableUpgradeResponse[];
    /**
     ...
     */
    readonly controlPlaneNodeConfiguration: types.outputs.networkcloud.v20230501preview.ControlPlaneNodeConfigurationResponse;
    /**
     ...
     */
    readonly featureStatuses: types.outputs.networkcloud.v20230501preview.FeatureStatusResponse[];
    /**
     ...
     */
    readonly initialAgentPoolConfigurations: types.outputs.networkcloud.v20230501preview.InitialAgentPoolConfigurationResponse[];
    /**
     ...
     */
    readonly networkConfiguration: types.outputs.networkcloud.v20230501preview.NetworkConfigurationResponse;
    /**
     * The details of the nodes in this cluster.
     */
    readonly nodes: types.outputs.networkcloud.v20230501preview.KubernetesClusterNodeResponse[];
    /**

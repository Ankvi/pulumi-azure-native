...
export class AgentPool extends pulumi.CustomResource {
     ...
     */
    public readonly agentOptions!: pulumi.Output<types.outputs.networkcloud.v20230501preview.AgentOptionsResponse | undefined>;
    /**
     * The configuration of networks being attached to the agent pool for use by the workloads that run on this Kubernetes cluster.
     */
    public readonly attachedNetworkConfiguration!: pulumi.Output<types.outputs.networkcloud.v20230501preview.AttachedNetworkConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly extendedLocation!: pulumi.Output<types.outputs.networkcloud.v20230501preview.ExtendedLocationResponse | undefined>;
    /**
     ...
     */
    public readonly labels!: pulumi.Output<types.outputs.networkcloud.v20230501preview.KubernetesLabelResponse[] | undefined>;
    /**
     ...
     */
    public readonly taints!: pulumi.Output<types.outputs.networkcloud.v20230501preview.KubernetesLabelResponse[] | undefined>;
    /**
     ...
     */
    public readonly upgradeSettings!: pulumi.Output<types.outputs.networkcloud.v20230501preview.AgentPoolUpgradeSettingsResponse | undefined>;
    /**
    ...
    constructor(name: string, args: AgentPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["agentOptions"] = args ? (args.agentOptions ? pulumi.output(args.agentOptions).apply(types.inputs.networkcloud.v20230501preview.agentOptionsArgsProvideDefaults) : undefined) : undefined;
            ...
            resourceInputs["upgradeSettings"] = args ? (args.upgradeSettings ? pulumi.output(args.upgradeSettings).apply(types.inputs.networkcloud.v20230501preview.agentPoolUpgradeSettingsArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:AgentPool" }, { type: "azure-native:networkcloud/v20230701:AgentPool" }] };
...
export interface AgentPoolArgs {
     ...
     * The configurations that will be applied to each agent in this agent pool.
     */
    agentOptions?: pulumi.Input<types.inputs.networkcloud.v20230501preview.AgentOptionsArgs>;
    /**
     ...
     * The configuration of networks being attached to the agent pool for use by the workloads that run on this Kubernetes cluster.
     */
    attachedNetworkConfiguration?: pulumi.Input<types.inputs.networkcloud.v20230501preview.AttachedNetworkConfigurationArgs>;
    /**
     * The list of availability zones of the Network Cloud cluster used for the provisioning of nodes in this agent pool. If not specified, all availability zones will be used.
     */
     ...
     * The labels applied to the nodes in this agent pool.
     */
    labels?: pulumi.Input<pulumi.Input<types.inputs.networkcloud.v20230501preview.KubernetesLabelArgs>[]>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The selection of how this agent pool is utilized, either as a system pool or a user pool. System pools run the features and critical services for the Kubernetes Cluster, while user pools are dedicated to user workloads. Every Kubernetes cluster must contain at least one system node pool with at least one node.
     */
    mode: pulumi.Input<string | types.enums.v20230501preview.AgentPoolMode>;
    /**
     ...
     * The taints applied to the nodes in this agent pool.
     */
    taints?: pulumi.Input<pulumi.Input<types.inputs.networkcloud.v20230501preview.KubernetesLabelArgs>[]>;
    /**
     * The configuration of the agent pool.
     */
    upgradeSettings?: pulumi.Input<types.inputs.networkcloud.v20230501preview.AgentPoolUpgradeSettingsArgs>;
    /**
     * The name of the VM SKU that determines the size of resources allocated for node VMs.
     */

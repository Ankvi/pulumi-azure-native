...
export class Rack extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkcloud/v20230501preview:Rack';
    ...
    constructor(name: string, args: RackArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:Rack" }, { type: "azure-native:networkcloud/v20221212preview:Rack" }, { type: "azure-native:networkcloud/v20230701:Rack" }] };

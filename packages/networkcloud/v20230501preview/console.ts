...
export class Console extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ConsoleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:Console" }, { type: "azure-native:networkcloud/v20221212preview:Console" }, { type: "azure-native:networkcloud/v20230701:Console" }] };

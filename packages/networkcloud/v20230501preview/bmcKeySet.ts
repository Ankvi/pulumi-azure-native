...
export class BmcKeySet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkcloud/v20230501preview:BmcKeySet';
    ...
    constructor(name: string, args: BmcKeySetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:BmcKeySet" }, { type: "azure-native:networkcloud/v20221212preview:BmcKeySet" }, { type: "azure-native:networkcloud/v20230701:BmcKeySet" }] };
...
export interface BmcKeySetArgs {
     ...
     * The access level allowed for the users in this key set.
     */
    privilegeLevel: pulumi.Input<string | types.enums.v20230501preview.BmcKeySetPrivilegeLevel>;
    /**

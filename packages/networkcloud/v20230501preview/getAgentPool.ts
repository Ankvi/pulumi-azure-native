...
export function getAgentPool(args: GetAgentPoolArgs, opts?: pulumi.InvokeOptions): Promise<GetAgentPoolResult> {
    ...
    return pulumi.runtime.invoke("azure-native:networkcloud/v20230501preview:getAgentPool", {
...
export interface GetAgentPoolResult {
     ...
     */
    readonly agentOptions?: types.outputs.networkcloud.v20230501preview.AgentOptionsResponse;
    /**
     * The configuration of networks being attached to the agent pool for use by the workloads that run on this Kubernetes cluster.
     */
    readonly attachedNetworkConfiguration?: types.outputs.networkcloud.v20230501preview.AttachedNetworkConfigurationResponse;
    /**
     ...
     */
    readonly labels?: types.outputs.networkcloud.v20230501preview.KubernetesLabelResponse[];
    /**
     ...
     */
    readonly taints?: types.outputs.networkcloud.v20230501preview.KubernetesLabelResponse[];
    /**
     ...
     */
    readonly upgradeSettings?: types.outputs.networkcloud.v20230501preview.AgentPoolUpgradeSettingsResponse;
    /**

...
export function getConsole(args: GetConsoleArgs, opts?: pulumi.InvokeOptions): Promise<GetConsoleResult> {
    ...
    return pulumi.runtime.invoke("azure-native:networkcloud/v20230501preview:getConsole", {
...
export interface GetConsoleResult {
     ...
     */
    readonly sshPublicKey: types.outputs.networkcloud.v20230501preview.SshPublicKeyResponse;
    /**

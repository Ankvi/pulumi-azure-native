...
export class ClusterManager extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkcloud/v20230501preview:ClusterManager';
     ...
     */
    public /*out*/ readonly clusterVersions!: pulumi.Output<types.outputs.networkcloud.v20230501preview.ClusterAvailableVersionResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly managerExtendedLocation!: pulumi.Output<types.outputs.networkcloud.v20230501preview.ExtendedLocationResponse>;
    /**
    ...
    constructor(name: string, args: ClusterManagerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:ClusterManager" }, { type: "azure-native:networkcloud/v20221212preview:ClusterManager" }, { type: "azure-native:networkcloud/v20230701:ClusterManager" }] };

...
export class L2Network extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkcloud/v20230501preview:L2Network';
    ...
    constructor(name: string, args: L2NetworkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:L2Network" }, { type: "azure-native:networkcloud/v20221212preview:L2Network" }, { type: "azure-native:networkcloud/v20230701:L2Network" }] };

...
export class BareMetalMachine extends pulumi.CustomResource {
     ...
     */
    declare public readonly bmcCredentials: pulumi.Output<types.outputs.AdministrativeCredentialsResponse>;
    /**
     ...
     */
    declare public /*out*/ readonly hardwareInventory: pulumi.Output<types.outputs.HardwareInventoryResponse>;
    /**
     * The details of the latest hardware validation performed for this bare metal machine.
     */
    declare public /*out*/ readonly hardwareValidationStatus: pulumi.Output<types.outputs.HardwareValidationStatusResponse>;
    /**
     ...
     */
    declare public /*out*/ readonly runtimeProtectionStatus: pulumi.Output<types.outputs.RuntimeProtectionStatusResponse>;
    /**
     * The list of statuses that represent secret rotation activity.
     */
    declare public /*out*/ readonly secretRotationStatus: pulumi.Output<types.outputs.SecretRotationStatusResponse[]>;
    /**
    ...
    constructor(name: string, args: BareMetalMachineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud/v20230701:BareMetalMachine" }, { type: "azure-native:networkcloud/v20231001preview:BareMetalMachine" }, { type: "azure-native:networkcloud/v20240601preview:BareMetalMachine" }, { type: "azure-native:networkcloud/v20240701:BareMetalMachine" }, { type: "azure-native:networkcloud/v20241001preview:BareMetalMachine" }, { type: "azure-native:networkcloud/v20250201:BareMetalMachine" }, { type: "azure-native:networkcloud/v20250701preview:BareMetalMachine" }, { type: "azure-native:networkcloud/v20250901:BareMetalMachine" }] };

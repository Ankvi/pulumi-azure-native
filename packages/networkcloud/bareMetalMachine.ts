...
export class BareMetalMachine extends pulumi.CustomResource {
    ...
    constructor(name: string, args: BareMetalMachineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud/v20221212preview:BareMetalMachine" }, { type: "azure-native:networkcloud/v20230501preview:BareMetalMachine" }, { type: "azure-native:networkcloud/v20230701:BareMetalMachine" }] };

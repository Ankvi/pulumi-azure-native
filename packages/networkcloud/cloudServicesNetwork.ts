...
export class CloudServicesNetwork extends pulumi.CustomResource {
     ...
     */
    declare public readonly additionalEgressEndpoints: pulumi.Output<types.outputs.EgressEndpointResponse[] | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly enabledEgressEndpoints: pulumi.Output<types.outputs.EgressEndpointResponse[]>;
    /**
     * Resource ETag.
     */

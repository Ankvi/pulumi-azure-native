...
export class HybridAksCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkcloud/v20221212preview:HybridAksCluster';
    ...
    constructor(name: string, args: HybridAksClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:HybridAksCluster" }] };

...
export class Cluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkcloud/v20221212preview:Cluster';
     ...
     */
    public readonly aggregatorOrSingleRackDefinition!: pulumi.Output<types.outputs.networkcloud.v20221212preview.RackDefinitionResponse>;
    /**
     ...
     */
    public /*out*/ readonly availableUpgradeVersions!: pulumi.Output<types.outputs.networkcloud.v20221212preview.ClusterAvailableUpgradeVersionResponse[]>;
    /**
     * The capacity supported by this cluster.
     */
    public /*out*/ readonly clusterCapacity!: pulumi.Output<types.outputs.networkcloud.v20221212preview.ClusterCapacityResponse>;
    /**
     ...
     */
    public /*out*/ readonly clusterExtendedLocation!: pulumi.Output<types.outputs.networkcloud.v20221212preview.ExtendedLocationResponse>;
    /**
     ...
     */
    public readonly clusterServicePrincipal!: pulumi.Output<types.outputs.networkcloud.v20221212preview.ServicePrincipalInformationResponse | undefined>;
    /**
     ...
     */
    public readonly computeDeploymentThreshold!: pulumi.Output<types.outputs.networkcloud.v20221212preview.ValidationThresholdResponse | undefined>;
    /**
     * The list of rack definitions for the compute racks in a multi-rack
     * cluster, or an empty list in a single-rack cluster.
     */
    public readonly computeRackDefinitions!: pulumi.Output<types.outputs.networkcloud.v20221212preview.RackDefinitionResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly hybridAksExtendedLocation!: pulumi.Output<types.outputs.networkcloud.v20221212preview.ExtendedLocationResponse>;
    /**
     ...
     */
    public readonly managedResourceGroupConfiguration!: pulumi.Output<types.outputs.networkcloud.v20221212preview.ManagedResourceGroupConfigurationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:Cluster" }, { type: "azure-native:networkcloud/v20230501preview:Cluster" }, { type: "azure-native:networkcloud/v20230701:Cluster" }] };
...
export interface ClusterArgs {
     ...
     * The rack definition that is intended to reflect only a single rack in a single rack cluster, or an aggregator rack in a multi-rack cluster.
     */
    aggregatorOrSingleRackDefinition: pulumi.Input<types.inputs.networkcloud.v20221212preview.RackDefinitionArgs>;
    /**
     * The resource ID of the Log Analytics Workspace that will be used for storing relevant logs.
     */
     ...
     * The service principal to be used by the cluster during Arc Appliance installation.
     */
    clusterServicePrincipal?: pulumi.Input<types.inputs.networkcloud.v20221212preview.ServicePrincipalInformationArgs>;
    /**
     * The type of rack configuration for the cluster.
     */
    clusterType: pulumi.Input<string | types.enums.v20221212preview.ClusterType>;
    /**
     * The current runtime version of the cluster.
     */
     ...
     * The validation threshold indicating the allowable failures of compute machines during environment validation and deployment.
     */
    computeDeploymentThreshold?: pulumi.Input<types.inputs.networkcloud.v20221212preview.ValidationThresholdArgs>;
    /**
     * The list of rack definitions for the compute racks in a multi-rack
     * cluster, or an empty list in a single-rack cluster.
     */
    computeRackDefinitions?: pulumi.Input<pulumi.Input<types.inputs.networkcloud.v20221212preview.RackDefinitionArgs>[]>;
    /**
     * The extended location of the cluster manager associated with the cluster.
     */
     ...
     * The configuration of the managed resource group associated with the resource.
     */
    managedResourceGroupConfiguration?: pulumi.Input<types.inputs.networkcloud.v20221212preview.ManagedResourceGroupConfigurationArgs>;
    /**
     * The resource ID of the Network Fabric associated with the cluster.
     */

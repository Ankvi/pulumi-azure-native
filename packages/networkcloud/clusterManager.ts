...
export class ClusterManager extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkcloud:ClusterManager';
     ...
     */
    public /*out*/ readonly clusterVersions!: pulumi.Output<types.outputs.networkcloud.ClusterAvailableVersionResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly managerExtendedLocation!: pulumi.Output<types.outputs.networkcloud.ExtendedLocationResponse>;
    /**
    ...
    constructor(name: string, args: ClusterManagerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud/v20221212preview:ClusterManager" }, { type: "azure-native:networkcloud/v20230501preview:ClusterManager" }, { type: "azure-native:networkcloud/v20230701:ClusterManager" }] };

...
export class L3Network extends pulumi.CustomResource {
    ...
    constructor(name: string, args: L3NetworkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:L3Network" }, { type: "azure-native:networkcloud/v20230501preview:L3Network" }, { type: "azure-native:networkcloud/v20230701:L3Network" }] };

...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:networkcloud/v20231001preview:AgentPool":
                return new AgentPool(name, <any>undefined, { urn })
            case "azure-native:networkcloud/v20231001preview:BareMetalMachine":
                return new BareMetalMachine(name, <any>undefined, { urn })
            case "azure-native:networkcloud/v20231001preview:BareMetalMachineKeySet":
                return new BareMetalMachineKeySet(name, <any>undefined, { urn })
            case "azure-native:networkcloud/v20231001preview:BmcKeySet":
                return new BmcKeySet(name, <any>undefined, { urn })
            case "azure-native:networkcloud/v20231001preview:CloudServicesNetwork":
                return new CloudServicesNetwork(name, <any>undefined, { urn })
            case "azure-native:networkcloud/v20231001preview:Cluster":
                return new Cluster(name, <any>undefined, { urn })
            case "azure-native:networkcloud/v20231001preview:ClusterManager":
                return new ClusterManager(name, <any>undefined, { urn })
            case "azure-native:networkcloud/v20231001preview:Console":
                return new Console(name, <any>undefined, { urn })
            case "azure-native:networkcloud/v20231001preview:KubernetesCluster":
                return new KubernetesCluster(name, <any>undefined, { urn })
            case "azure-native:networkcloud/v20231001preview:L2Network":
                return new L2Network(name, <any>undefined, { urn })
            case "azure-native:networkcloud/v20231001preview:L3Network":
                return new L3Network(name, <any>undefined, { urn })
            case "azure-native:networkcloud/v20231001preview:MetricsConfiguration":
                return new MetricsConfiguration(name, <any>undefined, { urn })
            case "azure-native:networkcloud/v20231001preview:Rack":
                return new Rack(name, <any>undefined, { urn })
            case "azure-native:networkcloud/v20231001preview:StorageAppliance":
                return new StorageAppliance(name, <any>undefined, { urn })
            case "azure-native:networkcloud/v20231001preview:TrunkedNetwork":
                return new TrunkedNetwork(name, <any>undefined, { urn })
            case "azure-native:networkcloud/v20231001preview:VirtualMachine":
                return new VirtualMachine(name, <any>undefined, { urn })
            case "azure-native:networkcloud/v20231001preview:Volume":
...
pulumi.runtime.registerResourceModule("azure-native", "networkcloud/v20231001preview", _module)

...
export class StorageAppliance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkcloud/v20231001preview:StorageAppliance';
    ...
    constructor(name: string, args: StorageApplianceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:StorageAppliance" }, { type: "azure-native:networkcloud/v20230501preview:StorageAppliance" }, { type: "azure-native:networkcloud/v20230701:StorageAppliance" }] };

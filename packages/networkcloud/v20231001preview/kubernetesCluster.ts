...
export class KubernetesCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkcloud/v20231001preview:KubernetesCluster';
    ...
    constructor(name: string, args: KubernetesClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:KubernetesCluster" }, { type: "azure-native:networkcloud/v20230501preview:KubernetesCluster" }, { type: "azure-native:networkcloud/v20230701:KubernetesCluster" }] };

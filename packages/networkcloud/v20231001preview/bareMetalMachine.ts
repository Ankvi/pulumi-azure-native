...
export class BareMetalMachine extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkcloud/v20231001preview:BareMetalMachine';
    ...
    constructor(name: string, args: BareMetalMachineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:BareMetalMachine" }, { type: "azure-native:networkcloud/v20230501preview:BareMetalMachine" }, { type: "azure-native:networkcloud/v20230701:BareMetalMachine" }] };

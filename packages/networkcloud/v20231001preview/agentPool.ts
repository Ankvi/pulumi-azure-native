...
export class AgentPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:networkcloud/v20231001preview:AgentPool';
    ...
    constructor(name: string, args: AgentPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud:AgentPool" }, { type: "azure-native:networkcloud/v20230501preview:AgentPool" }, { type: "azure-native:networkcloud/v20230701:AgentPool" }] };

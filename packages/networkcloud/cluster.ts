...
export class Cluster extends pulumi.CustomResource {
     ...
     */
    declare public readonly aggregatorOrSingleRackDefinition: pulumi.Output<types.outputs.RackDefinitionResponse>;
    /**
     * The settings for the log analytics workspace used for output of logs from this cluster.
     */
    declare public readonly analyticsOutputSettings: pulumi.Output<types.outputs.AnalyticsOutputSettingsResponse | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly availableUpgradeVersions: pulumi.Output<types.outputs.ClusterAvailableUpgradeVersionResponse[]>;
    /**
     ...
     */
    declare public /*out*/ readonly clusterCapacity: pulumi.Output<types.outputs.ClusterCapacityResponse>;
    /**
     ...
     */
    declare public /*out*/ readonly clusterExtendedLocation: pulumi.Output<types.outputs.ExtendedLocationResponse>;
    /**
     ...
     */
    declare public readonly clusterServicePrincipal: pulumi.Output<types.outputs.ServicePrincipalInformationResponse | undefined>;
    /**
     ...
     */
    declare public readonly commandOutputSettings: pulumi.Output<types.outputs.CommandOutputSettingsResponse | undefined>;
    /**
     * The validation threshold indicating the allowable failures of compute machines during environment validation and deployment.
     */
    declare public readonly computeDeploymentThreshold: pulumi.Output<types.outputs.ValidationThresholdResponse | undefined>;
    /**
     * The list of rack definitions for the compute racks in a multi-rack
     * cluster, or an empty list in a single-rack cluster.
     */
    declare public readonly computeRackDefinitions: pulumi.Output<types.outputs.RackDefinitionResponse[] | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly hybridAksExtendedLocation: pulumi.Output<types.outputs.ExtendedLocationResponse>;
    /**
     ...
     */
    declare public readonly runtimeProtectionConfiguration: pulumi.Output<types.outputs.RuntimeProtectionConfigurationResponse | undefined>;
    /**
     * The configuration for use of a key vault to store secrets for later retrieval by the operator.
     */
    declare public readonly secretArchive: pulumi.Output<types.outputs.ClusterSecretArchiveResponse | undefined>;
    /**
     * The settings for the secret archive used to hold credentials for the cluster.
     */
    declare public readonly secretArchiveSettings: pulumi.Output<types.outputs.SecretArchiveSettingsResponse | undefined>;
    /**
     ...
     */
    declare public readonly updateStrategy: pulumi.Output<types.outputs.ClusterUpdateStrategyResponse | undefined>;
    /**
     * The settings for how security vulnerability scanning is applied to the cluster.
     */
    declare public readonly vulnerabilityScanningSettings: pulumi.Output<types.outputs.VulnerabilityScanningSettingsResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:networkcloud/v20230701:Cluster" }, { type: "azure-native:networkcloud/v20231001preview:Cluster" }, { type: "azure-native:networkcloud/v20240601preview:Cluster" }, { type: "azure-native:networkcloud/v20240701:Cluster" }, { type: "azure-native:networkcloud/v20241001preview:Cluster" }, { type: "azure-native:networkcloud/v20250201:Cluster" }, { type: "azure-native:networkcloud/v20250701preview:Cluster" }, { type: "azure-native:networkcloud/v20250901:Cluster" }] };

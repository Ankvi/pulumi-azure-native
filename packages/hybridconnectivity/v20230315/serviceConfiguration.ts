...
export class ServiceConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:hybridconnectivity/v20230315:ServiceConfiguration';
    ...
    constructor(name: string, args: ServiceConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hybridconnectivity:ServiceConfiguration" }] };

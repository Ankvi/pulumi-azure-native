...
export class IotHubResourceEventHubConsumerGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:devices:IotHubResourceEventHubConsumerGroup';
...
export interface IotHubResourceEventHubConsumerGroupArgs {
     ...
     */
    properties: pulumi.Input<types.inputs.devices.EventHubConsumerGroupNameArgs>;
    /**

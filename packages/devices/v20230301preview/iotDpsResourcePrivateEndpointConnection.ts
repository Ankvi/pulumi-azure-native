...
export class IotDpsResourcePrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:devices/v20230301preview:IotDpsResourcePrivateEndpointConnection';
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.devices.v20230301preview.PrivateEndpointConnectionPropertiesResponse>;
    /**
...
export interface IotDpsResourcePrivateEndpointConnectionArgs {
     ...
     * The properties of a private endpoint connection
     */
    properties: pulumi.Input<types.inputs.devices.v20230301preview.PrivateEndpointConnectionPropertiesArgs>;
    /**

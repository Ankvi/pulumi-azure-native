...
export class IotHubResource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:devices/v20230630preview:IotHubResource';
     ...
     */
    public readonly identity!: pulumi.Output<types.outputs.devices.v20230630preview.ArmIdentityResponse | undefined>;
    /**
     ...
     * IotHub properties
     */
    public readonly properties!: pulumi.Output<types.outputs.devices.v20230630preview.IotHubPropertiesResponse>;
    /**
     * IotHub SKU info
     */
    public readonly sku!: pulumi.Output<types.outputs.devices.v20230630preview.IotHubSkuInfoResponse>;
    /**
     * The system meta data relating to this resource.
     */
    public /*out*/ readonly systemData!: pulumi.Output<types.outputs.devices.v20230630preview.SystemDataResponse>;
    /**
     * The resource tags.
     */
    ...
    constructor(name: string, args: IotHubResourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(types.inputs.devices.v20230630preview.iotHubPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface IotHubResourceArgs {
     ...
     * The managed identities for the IotHub.
     */
    identity?: pulumi.Input<types.inputs.devices.v20230630preview.ArmIdentityArgs>;
    /**
     * The resource location.
     */
     ...
     * IotHub properties
     */
    properties?: pulumi.Input<types.inputs.devices.v20230630preview.IotHubPropertiesArgs>;
    /**
     ...
     * IotHub SKU info
     */
    sku: pulumi.Input<types.inputs.devices.v20230630preview.IotHubSkuInfoArgs>;
    /**
     * The resource tags.
     */

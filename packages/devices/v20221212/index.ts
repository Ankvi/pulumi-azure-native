...
// Export enums:
export * from "../types/enums/v20221212";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:devices/v20221212:DpsCertificate":
                return new DpsCertificate(name, <any>undefined, { urn })
            case "azure-native:devices/v20221212:IotDpsResource":
                return new IotDpsResource(name, <any>undefined, { urn })
            case "azure-native:devices/v20221212:IotDpsResourcePrivateEndpointConnection":
...
pulumi.runtime.registerResourceModule("azure-native", "devices/v20221212", _module)

...
export function getIotHubResource(args: GetIotHubResourceArgs, opts?: pulumi.InvokeOptions): Promise<GetIotHubResourceResult> {
    ...
    return pulumi.runtime.invoke("azure-native:devices/v20221115preview:getIotHubResource", {
...
export interface GetIotHubResourceResult {
     ...
     */
    readonly identity?: types.outputs.devices.v20221115preview.ArmIdentityResponse;
    /**
     ...
     * IotHub properties
     */
    readonly properties: types.outputs.devices.v20221115preview.IotHubPropertiesResponse;
    /**
     * IotHub SKU info
     */
    readonly sku: types.outputs.devices.v20221115preview.IotHubSkuInfoResponse;
    /**
     * The system meta data relating to this resource.
     */
    readonly systemData: types.outputs.devices.v20221115preview.SystemDataResponse;
    /**
     * The resource tags.
     */

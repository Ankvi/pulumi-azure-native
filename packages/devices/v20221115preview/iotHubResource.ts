...
export class IotHubResource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:devices/v20221115preview:IotHubResource';
     ...
     */
    public readonly identity!: pulumi.Output<types.outputs.devices.v20221115preview.ArmIdentityResponse | undefined>;
    /**
     ...
     * IotHub properties
     */
    public readonly properties!: pulumi.Output<types.outputs.devices.v20221115preview.IotHubPropertiesResponse>;
    /**
     * IotHub SKU info
     */
    public readonly sku!: pulumi.Output<types.outputs.devices.v20221115preview.IotHubSkuInfoResponse>;
    /**
     * The system meta data relating to this resource.
     */
    public /*out*/ readonly systemData!: pulumi.Output<types.outputs.devices.v20221115preview.SystemDataResponse>;
    /**
     * The resource tags.
     */
    ...
    constructor(name: string, args: IotHubResourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(types.inputs.devices.v20221115preview.iotHubPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface IotHubResourceArgs {
     ...
     * The managed identities for the IotHub.
     */
    identity?: pulumi.Input<types.inputs.devices.v20221115preview.ArmIdentityArgs>;
    /**
     * The resource location.
     */
     ...
     * IotHub properties
     */
    properties?: pulumi.Input<types.inputs.devices.v20221115preview.IotHubPropertiesArgs>;
    /**
     ...
     * IotHub SKU info
     */
    sku: pulumi.Input<types.inputs.devices.v20221115preview.IotHubSkuInfoArgs>;
    /**
     * The resource tags.
     */

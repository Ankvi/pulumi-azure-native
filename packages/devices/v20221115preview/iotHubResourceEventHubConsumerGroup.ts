...
export class IotHubResourceEventHubConsumerGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:devices/v20221115preview:IotHubResourceEventHubConsumerGroup';
...
export interface IotHubResourceEventHubConsumerGroupArgs {
     ...
     */
    properties: pulumi.Input<types.inputs.devices.v20221115preview.EventHubConsumerGroupNameArgs>;
    /**

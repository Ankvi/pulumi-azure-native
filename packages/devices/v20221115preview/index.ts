...
// Export enums:
export * from "../types/enums/v20221115preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:devices/v20221115preview:Certificate":
                return new Certificate(name, <any>undefined, { urn })
            case "azure-native:devices/v20221115preview:IotHubResource":
                return new IotHubResource(name, <any>undefined, { urn })
            case "azure-native:devices/v20221115preview:IotHubResourceEventHubConsumerGroup":
                return new IotHubResourceEventHubConsumerGroup(name, <any>undefined, { urn })
            case "azure-native:devices/v20221115preview:PrivateEndpointConnection":
...
pulumi.runtime.registerResourceModule("azure-native", "devices/v20221115preview", _module)

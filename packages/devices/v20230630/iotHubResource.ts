...
export class IotHubResource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:devices/v20230630:IotHubResource';
     ...
     */
    public readonly identity!: pulumi.Output<types.outputs.devices.v20230630.ArmIdentityResponse | undefined>;
    /**
     ...
     * IotHub properties
     */
    public readonly properties!: pulumi.Output<types.outputs.devices.v20230630.IotHubPropertiesResponse>;
    /**
     * IotHub SKU info
     */
    public readonly sku!: pulumi.Output<types.outputs.devices.v20230630.IotHubSkuInfoResponse>;
    /**
     * The system meta data relating to this resource.
     */
    public /*out*/ readonly systemData!: pulumi.Output<types.outputs.devices.v20230630.SystemDataResponse>;
    /**
     * The resource tags.
     */
    ...
    constructor(name: string, args: IotHubResourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(types.inputs.devices.v20230630.iotHubPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface IotHubResourceArgs {
     ...
     * The managed identities for the IotHub.
     */
    identity?: pulumi.Input<types.inputs.devices.v20230630.ArmIdentityArgs>;
    /**
     * The resource location.
     */
     ...
     * IotHub properties
     */
    properties?: pulumi.Input<types.inputs.devices.v20230630.IotHubPropertiesArgs>;
    /**
     ...
     * IotHub SKU info
     */
    sku: pulumi.Input<types.inputs.devices.v20230630.IotHubSkuInfoArgs>;
    /**
     * The resource tags.
     */

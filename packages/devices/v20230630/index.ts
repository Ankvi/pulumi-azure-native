...
// Export enums:
export * from "../types/enums/v20230630";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:devices/v20230630:Certificate":
                return new Certificate(name, <any>undefined, { urn })
            case "azure-native:devices/v20230630:IotHubResource":
                return new IotHubResource(name, <any>undefined, { urn })
            case "azure-native:devices/v20230630:IotHubResourceEventHubConsumerGroup":
                return new IotHubResourceEventHubConsumerGroup(name, <any>undefined, { urn })
            case "azure-native:devices/v20230630:PrivateEndpointConnection":
...
pulumi.runtime.registerResourceModule("azure-native", "devices/v20230630", _module)

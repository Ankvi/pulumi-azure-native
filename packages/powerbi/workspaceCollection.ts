...
export class WorkspaceCollection extends pulumi.CustomResource {
     ...
     * Properties
     */
    declare public /*out*/ readonly properties: pulumi.Output<any>;
    declare public readonly sku: pulumi.Output<types.outputs.AzureSkuResponse | undefined>;
    ...
    constructor(name: string, args: WorkspaceCollectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["workspaceCollectionName"] = args?.workspaceCollectionName;

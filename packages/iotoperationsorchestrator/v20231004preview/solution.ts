...
export class Solution extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:iotoperationsorchestrator/v20231004preview:Solution';
    ...
    constructor(name: string, args: SolutionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:iotoperationsorchestrator:Solution" }] };

...
export class FabricCapacity extends pulumi.CustomResource {
     ...
     */
    declare public readonly administration: pulumi.Output<types.outputs.CapacityAdministrationResponse>;
    /**
     ...
     * The SKU details
     */
    declare public readonly sku: pulumi.Output<types.outputs.RpSkuResponse>;
    /**

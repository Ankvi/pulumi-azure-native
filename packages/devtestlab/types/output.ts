...
export namespace devtestlab {
    ...
    export namespace v20180915 {
        ...
        export interface ApplicableScheduleResponse {
             ...
             * The auto-shutdown schedule, if one has been set at the lab or lab resource level.
             */
            labVmsShutdown?: v20180915.ScheduleResponse;
            /**
             * The auto-startup schedule, if one has been set at the lab or lab resource level.
             */
            labVmsStartup?: v20180915.ScheduleResponse;
            /**
             * The location of the resource.
             */
            location?: string;
        ...
        export function applicableScheduleResponseProvideDefaults(val: ApplicableScheduleResponse): ApplicableScheduleResponse {
            return {
                ...val,
                labVmsShutdown: (val.labVmsShutdown ? v20180915.scheduleResponseProvideDefaults(val.labVmsShutdown) : undefined),
                labVmsStartup: (val.labVmsStartup ? v20180915.scheduleResponseProvideDefaults(val.labVmsStartup) : undefined),
            };
        }
        ...
        export interface ArtifactInstallPropertiesResponse {
             ...
             * The parameters of the artifact.
             */
            parameters?: v20180915.ArtifactParameterPropertiesResponse[];
            /**
             * The status of the artifact.
             */
            status?: string;
        ...
        export interface ComputeVmPropertiesResponse {
             ...
             * Gets all data disks attached to the virtual machine.
             */
            dataDisks?: v20180915.ComputeDataDiskResponse[];
            /**
             * Gets the network interface ID of the virtual machine.
             */
            networkInterfaceId?: string;
             ...
             * Gets the statuses of the virtual machine.
             */
            statuses?: v20180915.ComputeVmInstanceViewStatusResponse[];
            /**
             * Gets the size of the virtual machine.
             */
            vmSize?: string;
        ...
        export interface CustomImagePropertiesFromVmResponse {
             ...
             * The Linux OS information of the VM.
             */
            linuxOsInfo?: v20180915.LinuxOsInfoResponse;
            /**
             * The source vm identifier.
             */
            sourceVmId?: string;
             ...
             * The Windows OS information of the VM.
             */
            windowsOsInfo?: v20180915.WindowsOsInfoResponse;
        }
        ...
        export interface DataDiskPropertiesResponse {
             ...
             * Specifies options to attach a new disk to the virtual machine.
             */
            attachNewDataDiskOptions?: v20180915.AttachNewDataDiskOptionsResponse;
            /**
             * Specifies the existing lab disk id to attach to virtual machine.
             */
            existingLabDiskId?: string;
        ...
        export interface EnvironmentDeploymentPropertiesResponse {
             ...
             * The parameters of the Azure Resource Manager template.
             */
            parameters?: v20180915.ArmTemplateParameterPropertiesResponse[];
        }
        ...
        export interface LabVirtualMachineCreationParameterResponse {
             ...
             * The artifacts to be installed on the virtual machine.
             */
            artifacts?: v20180915.ArtifactInstallPropertiesResponse[];
            /**
             * The number of virtual machine instances to create.
             */
            bulkCreationParameters?: v20180915.BulkCreationParametersResponse;
            /**
             * The creation date of the virtual machine.
             */
            createdDate?: string;
             ...
             * New or existing data disks to attach to the virtual machine after creation
             */
            dataDiskParameters?: v20180915.DataDiskPropertiesResponse[];
            /**
             * Indicates whether the virtual machine is to be created without a public IP address.
             */
            disallowPublicIpAddress?: boolean;
             ...
             * The Microsoft Azure Marketplace image reference of the virtual machine.
             */
            galleryImageReference?: v20180915.GalleryImageReferenceResponse;
            /**
             * Indicates whether this virtual machine uses an SSH key for authentication.
             */
            isAuthenticationWithSshKey?: boolean;
             ...
             * The network interface properties.
             */
            networkInterface?: v20180915.NetworkInterfacePropertiesResponse;
            /**
             * The notes of the virtual machine.
             */
            notes?: string;
             ...
             * Virtual Machine schedules to be created
             */
            scheduleParameters?: v20180915.ScheduleCreationParameterResponse[];
            /**
             * The size of the virtual machine.
             */
            size?: string;
        ...
        export interface NetworkInterfacePropertiesResponse {
             ...
             * The configuration for sharing a public IP address across multiple virtual machines.
             */
            sharedPublicIpAddressConfiguration?: v20180915.SharedPublicIpAddressConfigurationResponse;
            /**
             * The SshAuthority property is a server DNS host name or IP address followed by the service port number for SSH.
             */
            sshAuthority?: string;
        ...
        export interface ScheduleCreationParameterResponse {
             ...
             * If the schedule will occur once each day of the week, specify the daily recurrence.
             */
            dailyRecurrence?: v20180915.DayDetailsResponse;
            /**
             * If the schedule will occur multiple times a day, specify the hourly recurrence.
             */
            hourlyRecurrence?: v20180915.HourDetailsResponse;
            /**
             * The location of the new virtual machine or environment
             */
            location: string;
             ...
             * Notification settings.
             */
            notificationSettings?: v20180915.NotificationSettingsResponse;
            /**
             * The status of the schedule (i.e. Enabled, Disabled)
             */
            status?: string;
             ...
             * If the schedule will occur only some days of the week, specify the weekly recurrence.
             */
            weeklyRecurrence?: v20180915.WeekDetailsResponse;
        }
        /**
         * scheduleCreationParameterResponseProvideDefaults sets the appropriate defaults for ScheduleCreationParameterResponse
         */
        export function scheduleCreationParameterResponseProvideDefaults(val: ScheduleCreationParameterResponse): ScheduleCreationParameterResponse {
            return {
                ...val,
                notificationSettings: (val.notificationSettings ? v20180915.notificationSettingsResponseProvideDefaults(val.notificationSettings) : undefined),
                status: (val.status) ?? "Disabled",
            };
        }
        ...
        export interface SharedPublicIpAddressConfigurationResponse {
             ...
             * The incoming NAT rules
             */
            inboundNatRules?: v20180915.InboundNatRuleResponse[];
        }
        ...
        export interface SubnetOverrideResponse {
             ...
             * Properties that virtual machines on this subnet will share.
             */
            sharedPublicIpAddressConfiguration?: v20180915.SubnetSharedPublicIpAddressConfigurationResponse;
            /**
             * Indicates whether this subnet can be used during virtual machine creation (i.e. Allow, Deny).
             */
            useInVmCreationPermission?: string;
        ...
        export interface SubnetSharedPublicIpAddressConfigurationResponse {
             ...
             * Backend ports that virtual machines on this subnet are allowed to expose
             */
            allowedPorts?: v20180915.PortResponse[];
        }

...
export namespace devtestlab {
    ...
    export namespace v20180915 {
        ...
        export interface ArtifactInstallPropertiesArgs {
             ...
             * The parameters of the artifact.
             */
            parameters?: pulumi.Input<pulumi.Input<v20180915.ArtifactParameterPropertiesArgs>[]>;
            /**
             * The status of the artifact.
             */
            status?: pulumi.Input<string>;
        ...
        export interface AttachNewDataDiskOptionsArgs {
             ...
             * The storage type for the disk (i.e. Standard, Premium).
             */
            diskType?: pulumi.Input<string | enums.v20180915.StorageType>;
        }
        ...
        export interface CustomImagePropertiesCustomArgs {
             ...
             * The OS type of the custom image (i.e. Windows, Linux)
             */
            osType: pulumi.Input<string | enums.v20180915.CustomImageOsType>;
            /**
             * Indicates whether sysprep has been run on the VHD.
             */
            sysPrep?: pulumi.Input<boolean>;
        ...
        export interface CustomImagePropertiesFromVmArgs {
             ...
             * The Linux OS information of the VM.
             */
            linuxOsInfo?: pulumi.Input<v20180915.LinuxOsInfoArgs>;
            /**
             * The source vm identifier.
             */
            sourceVmId?: pulumi.Input<string>;
             ...
             * The Windows OS information of the VM.
             */
            windowsOsInfo?: pulumi.Input<v20180915.WindowsOsInfoArgs>;
        }
        ...
        export interface DataDiskPropertiesArgs {
             ...
             * Specifies options to attach a new disk to the virtual machine.
             */
            attachNewDataDiskOptions?: pulumi.Input<v20180915.AttachNewDataDiskOptionsArgs>;
            /**
             * Specifies the existing lab disk id to attach to virtual machine.
             */
            existingLabDiskId?: pulumi.Input<string>;
             ...
             * Caching option for a data disk (i.e. None, ReadOnly, ReadWrite).
             */
            hostCaching?: pulumi.Input<string | enums.v20180915.HostCachingOptions>;
        }
        ...
        export interface DataDiskStorageTypeInfoArgs {
             ...
             * Disk Storage Type
             */
            storageType?: pulumi.Input<string | enums.v20180915.StorageType>;
        }
        ...
        export interface EnvironmentDeploymentPropertiesArgs {
             ...
             * The parameters of the Azure Resource Manager template.
             */
            parameters?: pulumi.Input<pulumi.Input<v20180915.ArmTemplateParameterPropertiesArgs>[]>;
        }
        ...
        export interface EventArgs {
             ...
             * The event type for which this notification is enabled (i.e. AutoShutdown, Cost)
             */
            eventName?: pulumi.Input<string | enums.v20180915.NotificationChannelEventType>;
        }
        ...
        export interface IdentityPropertiesArgs {
             ...
             * Managed identity.
             */
            type?: pulumi.Input<string | enums.v20180915.ManagedIdentityType>;
        }
        ...
        export interface InboundNatRuleArgs {
             ...
             * The transport protocol for the endpoint.
             */
            transportProtocol?: pulumi.Input<string | enums.v20180915.TransportProtocol>;
        }
        ...
        export interface LabAnnouncementPropertiesArgs {
             ...
             * Is the lab announcement active/enabled at this time?
             */
            enabled?: pulumi.Input<string | enums.v20180915.EnableStatus>;
            /**
             * The time at which the announcement expires (null for never)
             */
            expirationDate?: pulumi.Input<string>;
        ...
        export interface LabVirtualMachineCreationParameterArgs {
             ...
             * The artifacts to be installed on the virtual machine.
             */
            artifacts?: pulumi.Input<pulumi.Input<v20180915.ArtifactInstallPropertiesArgs>[]>;
            /**
             * The number of virtual machine instances to create.
             */
            bulkCreationParameters?: pulumi.Input<v20180915.BulkCreationParametersArgs>;
            /**
             * The creation date of the virtual machine.
             */
            createdDate?: pulumi.Input<string>;
             ...
             * New or existing data disks to attach to the virtual machine after creation
             */
            dataDiskParameters?: pulumi.Input<pulumi.Input<v20180915.DataDiskPropertiesArgs>[]>;
            /**
             * Indicates whether the virtual machine is to be created without a public IP address.
             */
            disallowPublicIpAddress?: pulumi.Input<boolean>;
             ...
             * The Microsoft Azure Marketplace image reference of the virtual machine.
             */
            galleryImageReference?: pulumi.Input<v20180915.GalleryImageReferenceArgs>;
            /**
             * Indicates whether this virtual machine uses an SSH key for authentication.
             */
            isAuthenticationWithSshKey?: pulumi.Input<boolean>;
             ...
             * The network interface properties.
             */
            networkInterface?: pulumi.Input<v20180915.NetworkInterfacePropertiesArgs>;
            /**
             * The notes of the virtual machine.
             */
            notes?: pulumi.Input<string>;
             ...
             * Virtual Machine schedules to be created
             */
            scheduleParameters?: pulumi.Input<pulumi.Input<v20180915.ScheduleCreationParameterArgs>[]>;
            /**
             * The size of the virtual machine.
             */
            size?: pulumi.Input<string>;
        ...
        export interface LinuxOsInfoArgs {
             ...
             * The state of the Linux OS (i.e. NonDeprovisioned, DeprovisionRequested, DeprovisionApplied).
             */
            linuxOsState?: pulumi.Input<string | enums.v20180915.LinuxOsState>;
        }
        ...
        export interface NetworkInterfacePropertiesArgs {
             ...
             * The configuration for sharing a public IP address across multiple virtual machines.
             */
            sharedPublicIpAddressConfiguration?: pulumi.Input<v20180915.SharedPublicIpAddressConfigurationArgs>;
            /**
             * The SshAuthority property is a server DNS host name or IP address followed by the service port number for SSH.
             */
            sshAuthority?: pulumi.Input<string>;
        ...
        export interface NotificationSettingsArgs {
             ...
             * If notifications are enabled for this schedule (i.e. Enabled, Disabled).
             */
            status?: pulumi.Input<string | enums.v20180915.EnableStatus>;
            /**
             * Time in minutes before event at which notification will be sent.
             */
            timeInMinutes?: pulumi.Input<number>;
        ...
        export interface ScheduleCreationParameterArgs {
             ...
             * If the schedule will occur once each day of the week, specify the daily recurrence.
             */
            dailyRecurrence?: pulumi.Input<v20180915.DayDetailsArgs>;
            /**
             * If the schedule will occur multiple times a day, specify the hourly recurrence.
             */
            hourlyRecurrence?: pulumi.Input<v20180915.HourDetailsArgs>;
            /**
             * The name of the virtual machine or environment
             */
            name?: pulumi.Input<string>;
             ...
             * Notification settings.
             */
            notificationSettings?: pulumi.Input<v20180915.NotificationSettingsArgs>;
            /**
             * The status of the schedule (i.e. Enabled, Disabled)
             */
            status?: pulumi.Input<string | enums.v20180915.EnableStatus>;
             ...
             * If the schedule will occur only some days of the week, specify the weekly recurrence.
             */
            weeklyRecurrence?: pulumi.Input<v20180915.WeekDetailsArgs>;
        }
        /**
         * scheduleCreationParameterArgsProvideDefaults sets the appropriate defaults for ScheduleCreationParameterArgs
         */
        export function scheduleCreationParameterArgsProvideDefaults(val: ScheduleCreationParameterArgs): ScheduleCreationParameterArgs {
            return {
                ...val,
                notificationSettings: (val.notificationSettings ? pulumi.output(val.notificationSettings).apply(v20180915.notificationSettingsArgsProvideDefaults) : undefined),
                status: (val.status) ?? "Disabled",
            };
        }
        ...
        export interface SharedPublicIpAddressConfigurationArgs {
             ...
             * The incoming NAT rules
             */
            inboundNatRules?: pulumi.Input<pulumi.Input<v20180915.InboundNatRuleArgs>[]>;
        }
        ...
        export interface SubnetArgs {
             ...
             * The permission policy of the subnet for allowing public IP addresses (i.e. Allow, Deny)).
             */
            allowPublicIp?: pulumi.Input<string | enums.v20180915.UsagePermissionType>;
            /**
             * The name of the subnet as seen in the lab.
             */
            labSubnetName?: pulumi.Input<string>;
        ...
        export interface SubnetOverrideArgs {
             ...
             * Properties that virtual machines on this subnet will share.
             */
            sharedPublicIpAddressConfiguration?: pulumi.Input<v20180915.SubnetSharedPublicIpAddressConfigurationArgs>;
            /**
             * Indicates whether this subnet can be used during virtual machine creation (i.e. Allow, Deny).
             */
            useInVmCreationPermission?: pulumi.Input<string | enums.v20180915.UsagePermissionType>;
            /**
             * Indicates whether public IP addresses can be assigned to virtual machines on this subnet (i.e. Allow, Deny).
             */
            usePublicIpAddressPermission?: pulumi.Input<string | enums.v20180915.UsagePermissionType>;
            /**
             * The virtual network pool associated with this subnet.
             */
            virtualNetworkPoolName?: pulumi.Input<string>;
        ...
        export interface SubnetSharedPublicIpAddressConfigurationArgs {
             ...
             * Backend ports that virtual machines on this subnet are allowed to expose
             */
            allowedPorts?: pulumi.Input<pulumi.Input<v20180915.PortArgs>[]>;
        }
        ...
        export interface WindowsOsInfoArgs {
             ...
             * The state of the Windows OS (i.e. NonSysprepped, SysprepRequested, SysprepApplied).
             */
            windowsOsState?: pulumi.Input<string | enums.v20180915.WindowsOsState>;
        }

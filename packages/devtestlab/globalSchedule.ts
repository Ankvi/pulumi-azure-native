...
export class GlobalSchedule extends pulumi.CustomResource {
     ...
     */
    declare public readonly dailyRecurrence: pulumi.Output<types.outputs.DayDetailsResponse | undefined>;
    /**
     ...
     */
    declare public readonly weeklyRecurrence: pulumi.Output<types.outputs.WeekDetailsResponse | undefined>;

...
export class Formula extends pulumi.CustomResource {
     ...
     */
    declare public readonly formulaContent: pulumi.Output<types.outputs.LabVirtualMachineCreationParameterResponse | undefined>;
    /**
     ...
     */
    declare public readonly vm: pulumi.Output<types.outputs.FormulaPropertiesFromVmResponse | undefined>;

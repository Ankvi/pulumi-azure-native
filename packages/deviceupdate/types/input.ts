...
export namespace deviceupdate {
    ...
    export namespace v20230701 {
        ...
        export interface DiagnosticStoragePropertiesArgs {
             ...
             * Authentication Type
             */
            authenticationType: pulumi.Input<string | enums.v20230701.AuthenticationType>;
            /**
             * ConnectionString of the diagnostic storage account
             */
            connectionString?: pulumi.Input<string>;
        ...
        export interface ManagedServiceIdentityArgs {
             ...
             * Type of managed service identity (where both SystemAssigned and UserAssigned types are allowed).
             */
            type: pulumi.Input<string | enums.v20230701.ManagedServiceIdentityType>;
            /**
             * The set of user assigned identities associated with the resource. The userAssignedIdentities dictionary keys will be ARM resource ids in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}. The dictionary values can be empty objects ({}) in requests.
             */
            userAssignedIdentities?: pulumi.Input<pulumi.Input<string>[]>;
        ...
        export interface PrivateEndpointConnectionArgs {
             ...
             * A collection of information about the state of the connection between service consumer and provider.
             */
            privateLinkServiceConnectionState: pulumi.Input<v20230701.PrivateLinkServiceConnectionStateArgs>;
        }
        ...
        export interface PrivateLinkServiceProxyArgs {
             ...
             * Group connectivity information.
             */
            groupConnectivityInformation?: pulumi.Input<pulumi.Input<v20230701.GroupConnectivityInformationArgs>[]>;
            /**
             * NRP resource ID.
             */
            id?: pulumi.Input<string>;
             ...
             * Remote private link service connection state
             */
            remotePrivateLinkServiceConnectionState?: pulumi.Input<v20230701.PrivateLinkServiceConnectionStateArgs>;
        }
        ...
        export interface RemotePrivateEndpointArgs {
             ...
             * List of private link service connections that need manual approval.
             */
            manualPrivateLinkServiceConnections?: pulumi.Input<pulumi.Input<v20230701.PrivateLinkServiceConnectionArgs>[]>;
            /**
             * List of automatically approved private link service connections.
             */
            privateLinkServiceConnections?: pulumi.Input<pulumi.Input<v20230701.PrivateLinkServiceConnectionArgs>[]>;
            /**
             * List of private link service proxies.
             */
            privateLinkServiceProxies?: pulumi.Input<pulumi.Input<v20230701.PrivateLinkServiceProxyArgs>[]>;
            /**
             * Virtual network traffic tag.
             */
            vnetTrafficTag?: pulumi.Input<string>;

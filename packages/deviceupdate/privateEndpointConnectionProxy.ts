...
export class PrivateEndpointConnectionProxy extends pulumi.CustomResource {
     ...
     */
    declare public readonly remotePrivateEndpoint: pulumi.Output<types.outputs.RemotePrivateEndpointResponse | undefined>;
    /**
     * Operation status.
     */
    ...
    constructor(name: string, args: PrivateEndpointConnectionProxyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["privateEndpointConnectionProxyId"] = args?.privateEndpointConnectionProxyId;
            resourceInputs["remotePrivateEndpoint"] = args?.remotePrivateEndpoint;

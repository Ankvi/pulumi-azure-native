...
export interface GetDiskAccessAPrivateEndpointConnectionResult {
     ...
     */
    readonly privateEndpoint: types.outputs.compute.v20220702.PrivateEndpointResponse;
    /**
     * A collection of information about the state of the connection between DiskAccess and Virtual Network.
     */
    readonly privateLinkServiceConnectionState: types.outputs.compute.v20220702.PrivateLinkServiceConnectionStateResponse;
    /**

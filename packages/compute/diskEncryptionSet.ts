...
export class DiskEncryptionSet extends pulumi.CustomResource {
     ...
     */
    declare public readonly activeKey: pulumi.Output<types.outputs.KeyForDiskEncryptionSetResponse | undefined>;
    /**
     * The error that was encountered during auto-key rotation. If an error is present, then auto-key rotation will not be attempted until the error on this disk encryption set is fixed.
     */
    declare public /*out*/ readonly autoKeyRotationError: pulumi.Output<types.outputs.ApiErrorResponse>;
    /**
     ...
     */
    declare public readonly identity: pulumi.Output<types.outputs.EncryptionSetIdentityResponse | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly previousKeys: pulumi.Output<types.outputs.KeyForDiskEncryptionSetResponse[]>;
    /**

...
export class VirtualMachineExtension extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20211101:VirtualMachineExtension';

...
export class CloudService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute:CloudService';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.CloudServicePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: CloudServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["cloudServiceName"] = args?.cloudServiceName;

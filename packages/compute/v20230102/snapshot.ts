...
export class Snapshot extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20230102:Snapshot';
     ...
     */
    public readonly copyCompletionError!: pulumi.Output<types.outputs.compute.v20230102.CopyCompletionErrorResponse | undefined>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<types.outputs.compute.v20230102.SnapshotSkuResponse | undefined>;
    /**
...
export interface SnapshotArgs {
     ...
     * Indicates the error details if the background copy of a resource created via the CopyStart operation fails.
     */
    copyCompletionError?: pulumi.Input<types.inputs.compute.v20230102.CopyCompletionErrorArgs>;
    /**
     * Disk source information. CreationData information cannot be changed after the disk has been created.
     */
     ...
     * The snapshots sku name. Can be Standard_LRS, Premium_LRS, or Standard_ZRS. This is an optional parameter for incremental snapshot and the default behavior is the SKU will be set to the same sku as the previous snapshot
     */
    sku?: pulumi.Input<types.inputs.compute.v20230102.SnapshotSkuArgs>;
    /**

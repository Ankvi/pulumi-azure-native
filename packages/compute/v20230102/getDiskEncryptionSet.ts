...
export interface GetDiskEncryptionSetResult {
     ...
     */
    readonly activeKey?: types.outputs.compute.v20230102.KeyForDiskEncryptionSetResponse;
    /**
     * The error that was encountered during auto-key rotation. If an error is present, then auto-key rotation will not be attempted until the error on this disk encryption set is fixed.
     */
    readonly autoKeyRotationError: types.outputs.compute.v20230102.ApiErrorResponse;
    /**
     ...
     */
    readonly identity?: types.outputs.compute.v20230102.EncryptionSetIdentityResponse;
    /**
     ...
     */
    readonly previousKeys: types.outputs.compute.v20230102.KeyForDiskEncryptionSetResponse[];
    /**

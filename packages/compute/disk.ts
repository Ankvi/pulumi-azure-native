...
export class Disk extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute:Disk';
     ...
     */
    declare public readonly creationData: pulumi.Output<types.outputs.CreationDataResponse>;
    /**
     ...
     */
    declare public readonly encryptionSettingsCollection: pulumi.Output<types.outputs.EncryptionSettingsCollectionResponse | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly propertyUpdatesInProgress: pulumi.Output<types.outputs.PropertyUpdatesInProgressResponse>;
    /**
     ...
     */
    declare public readonly purchasePlan: pulumi.Output<types.outputs.DiskPurchasePlanResponse | undefined>;
    /**
     * Contains the security related information for the resource.
     */
    declare public readonly securityProfile: pulumi.Output<types.outputs.DiskSecurityProfileResponse | undefined>;
    /**
     * Details of the list of all VMs that have the disk attached. maxShares should be set to a value greater than one for disks to allow attaching them to multiple VMs.
     */
    declare public /*out*/ readonly shareInfo: pulumi.Output<types.outputs.ShareInfoElementResponse[]>;
    /**
     * The disks sku name. Can be Standard_LRS, Premium_LRS, StandardSSD_LRS, UltraSSD_LRS, Premium_ZRS, StandardSSD_ZRS, or PremiumV2_LRS.
     */
    declare public readonly sku: pulumi.Output<types.outputs.DiskSkuResponse | undefined>;
    /**
     * List of supported capabilities for the image from which the OS disk was created.
     */
    declare public readonly supportedCapabilities: pulumi.Output<types.outputs.SupportedCapabilitiesResponse | undefined>;
    /**

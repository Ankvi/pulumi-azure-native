...
export class RestorePoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20221101:RestorePoint';
     ...
     */
    public readonly excludeDisks!: pulumi.Output<types.outputs.compute.v20221101.ApiEntityReferenceResponse[] | undefined>;
    /**
     * The restore point instance view.
     */
    public /*out*/ readonly instanceView!: pulumi.Output<types.outputs.compute.v20221101.RestorePointInstanceViewResponse>;
    /**
     * Resource name
     */
     ...
     */
    public /*out*/ readonly sourceMetadata!: pulumi.Output<types.outputs.compute.v20221101.RestorePointSourceMetadataResponse>;
    /**
     * Resource Id of the source restore point from which a copy needs to be created.
     */
    public readonly sourceRestorePoint!: pulumi.Output<types.outputs.compute.v20221101.ApiEntityReferenceResponse | undefined>;
    /**
...
export interface RestorePointArgs {
     ...
     * ConsistencyMode of the RestorePoint. Can be specified in the input while creating a restore point. For now, only CrashConsistent is accepted as a valid input. Please refer to https://aka.ms/RestorePoints for more details.
     */
    consistencyMode?: pulumi.Input<string | types.enums.v20221101.ConsistencyModeTypes>;
    /**
     * List of disk resource ids that the customer wishes to exclude from the restore point. If no disks are specified, all disks will be included.
     */
    excludeDisks?: pulumi.Input<pulumi.Input<types.inputs.compute.v20221101.ApiEntityReferenceArgs>[]>;
    /**
     ...
     * Resource Id of the source restore point from which a copy needs to be created.
     */
    sourceRestorePoint?: pulumi.Input<types.inputs.compute.v20221101.ApiEntityReferenceArgs>;
    /**
     * Gets the creation time of the restore point.
     */

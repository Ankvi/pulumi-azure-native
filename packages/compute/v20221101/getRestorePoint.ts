...
export function getRestorePoint(args: GetRestorePointArgs, opts?: pulumi.InvokeOptions): Promise<GetRestorePointResult> {
    ...
    return pulumi.runtime.invoke("azure-native:compute/v20221101:getRestorePoint", {
        "expand": args.expand,
...
export interface GetRestorePointResult {
     ...
     */
    readonly excludeDisks?: types.outputs.compute.v20221101.ApiEntityReferenceResponse[];
    /**
     * Resource Id
     */
    readonly id: string;
     ...
     */
    readonly instanceView: types.outputs.compute.v20221101.RestorePointInstanceViewResponse;
    /**
     * Resource name
     */
     ...
     */
    readonly sourceMetadata: types.outputs.compute.v20221101.RestorePointSourceMetadataResponse;
    /**
     * Resource Id of the source restore point from which a copy needs to be created.
     */
    readonly sourceRestorePoint?: types.outputs.compute.v20221101.ApiEntityReferenceResponse;
    /**

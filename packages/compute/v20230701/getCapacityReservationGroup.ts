...
export interface GetCapacityReservationGroupResult {
     ...
     */
    readonly capacityReservations: types.outputs.compute.v20230701.SubResourceReadOnlyResponse[];
    /**
     * Resource Id
     */
    readonly id: string;
     ...
     */
    readonly instanceView: types.outputs.compute.v20230701.CapacityReservationGroupInstanceViewResponse;
    /**
     * Resource location
     */
     ...
     */
    readonly virtualMachinesAssociated: types.outputs.compute.v20230701.SubResourceReadOnlyResponse[];
    /**

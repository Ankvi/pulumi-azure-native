...
export class ProximityPlacementGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20230701:ProximityPlacementGroup';
     ...
     */
    public /*out*/ readonly availabilitySets!: pulumi.Output<types.outputs.compute.v20230701.SubResourceWithColocationStatusResponse[]>;
    /**
     * Describes colocation status of the Proximity Placement Group.
     */
    public readonly colocationStatus!: pulumi.Output<types.outputs.compute.v20230701.InstanceViewStatusResponse | undefined>;
    /**
     * Specifies the user intent of the proximity placement group.
     */
    public readonly intent!: pulumi.Output<types.outputs.compute.v20230701.ProximityPlacementGroupPropertiesResponseIntent | undefined>;
    /**
     * Resource location
     */
     ...
     */
    public /*out*/ readonly virtualMachineScaleSets!: pulumi.Output<types.outputs.compute.v20230701.SubResourceWithColocationStatusResponse[]>;
    /**
     * A list of references to all virtual machines in the proximity placement group.
     */
    public /*out*/ readonly virtualMachines!: pulumi.Output<types.outputs.compute.v20230701.SubResourceWithColocationStatusResponse[]>;
    /**
...
export interface ProximityPlacementGroupArgs {
     ...
     * Describes colocation status of the Proximity Placement Group.
     */
    colocationStatus?: pulumi.Input<types.inputs.compute.v20230701.InstanceViewStatusArgs>;
    /**
     * Specifies the user intent of the proximity placement group.
     */
    intent?: pulumi.Input<types.inputs.compute.v20230701.ProximityPlacementGroupPropertiesIntentArgs>;
    /**
     * Resource location
     */
     ...
     * Specifies the type of the proximity placement group. Possible values are: **Standard** : Co-locate resources within an Azure region or Availability Zone. **Ultra** : For future use.
     */
    proximityPlacementGroupType?: pulumi.Input<string | types.enums.v20230701.ProximityPlacementGroupType>;
    /**

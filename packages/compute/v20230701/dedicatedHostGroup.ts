...
export class DedicatedHostGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20230701:DedicatedHostGroup';

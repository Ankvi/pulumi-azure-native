...
export class VirtualMachineScaleSet extends pulumi.CustomResource {
     ...
     */
    public readonly automaticRepairsPolicy!: pulumi.Output<types.outputs.compute.v20230701.AutomaticRepairsPolicyResponse | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<types.outputs.compute.v20230701.VirtualMachineScaleSetIdentityResponse | undefined>;
    /**
     * Resource location
     */
     ...
     */
    public readonly priorityMixPolicy!: pulumi.Output<types.outputs.compute.v20230701.PriorityMixPolicyResponse | undefined>;
    /**
     ...
     */
    public readonly scaleInPolicy!: pulumi.Output<types.outputs.compute.v20230701.ScaleInPolicyResponse | undefined>;
    /**
     ...
     */
    public readonly spotRestorePolicy!: pulumi.Output<types.outputs.compute.v20230701.SpotRestorePolicyResponse | undefined>;
    /**
     * Resource tags
     */
     ...
     * The upgrade policy.
     */
    public readonly upgradePolicy!: pulumi.Output<types.outputs.compute.v20230701.UpgradePolicyResponse | undefined>;
    /**
     * The virtual machine profile.
     */
    public readonly virtualMachineProfile!: pulumi.Output<types.outputs.compute.v20230701.VirtualMachineScaleSetVMProfileResponse | undefined>;
    /**
...
export interface VirtualMachineScaleSetArgs {
     ...
     * Policy for automatic repairs.
     */
    automaticRepairsPolicy?: pulumi.Input<types.inputs.compute.v20230701.AutomaticRepairsPolicyArgs>;
    /**
     * Optional property which must either be set to True or omitted.
     */
     ...
     * The identity of the virtual machine scale set, if configured.
     */
    identity?: pulumi.Input<types.inputs.compute.v20230701.VirtualMachineScaleSetIdentityArgs>;
    /**
     * Resource location
     */
     ...
     * Specifies the orchestration mode for the virtual machine scale set.
     */
    orchestrationMode?: pulumi.Input<string | types.enums.v20230701.OrchestrationMode>;
    /**
     * Specifies whether the Virtual Machine Scale Set should be overprovisioned.
     */
     ...
     * Specifies the desired targets for mixing Spot and Regular priority VMs within the same VMSS Flex instance.
     */
    priorityMixPolicy?: pulumi.Input<types.inputs.compute.v20230701.PriorityMixPolicyArgs>;
    /**
     * Specifies information about the proximity placement group that the virtual machine scale set should be assigned to. Minimum api-version: 2018-04-01.
     */
     ...
     * Specifies the policies applied when scaling in Virtual Machines in the Virtual Machine Scale Set.
     */
    scaleInPolicy?: pulumi.Input<types.inputs.compute.v20230701.ScaleInPolicyArgs>;
    /**
     * When true this limits the scale set to a single placement group, of max size 100 virtual machines. NOTE: If singlePlacementGroup is true, it may be modified to false. However, if singlePlacementGroup is false, it may not be modified to true.
     */
     ...
     * Specifies the Spot Restore properties for the virtual machine scale set.
     */
    spotRestorePolicy?: pulumi.Input<types.inputs.compute.v20230701.SpotRestorePolicyArgs>;
    /**
     * Resource tags
     */
     ...
     * The upgrade policy.
     */
    upgradePolicy?: pulumi.Input<types.inputs.compute.v20230701.UpgradePolicyArgs>;
    /**
     * The virtual machine profile.
     */
    virtualMachineProfile?: pulumi.Input<types.inputs.compute.v20230701.VirtualMachineScaleSetVMProfileArgs>;
    /**

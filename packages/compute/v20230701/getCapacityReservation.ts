...
export function getCapacityReservation(args: GetCapacityReservationArgs, opts?: pulumi.InvokeOptions): Promise<GetCapacityReservationResult> {
    ...
    return pulumi.runtime.invoke("azure-native:compute/v20230701:getCapacityReservation", {
...
export interface GetCapacityReservationResult {
     ...
     */
    readonly instanceView: types.outputs.compute.v20230701.CapacityReservationInstanceViewResponse;
    /**
     * Resource location
     */

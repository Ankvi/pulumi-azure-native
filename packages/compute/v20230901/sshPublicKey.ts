...
export class SshPublicKey extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20230901:SshPublicKey';

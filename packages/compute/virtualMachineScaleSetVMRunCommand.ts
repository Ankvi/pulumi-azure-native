...
export class VirtualMachineScaleSetVMRunCommand extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly instanceView: pulumi.Output<types.outputs.VirtualMachineRunCommandInstanceViewResponse>;
    /**
     ...
     */
    declare public readonly parameters: pulumi.Output<types.outputs.RunCommandInputParameterResponse[] | undefined>;
    /**
     * The parameters used by the script.
     */
    declare public readonly protectedParameters: pulumi.Output<types.outputs.RunCommandInputParameterResponse[] | undefined>;
    /**
     ...
     */
    declare public readonly source: pulumi.Output<types.outputs.VirtualMachineRunCommandScriptSourceResponse | undefined>;
    /**

...
export class VirtualMachineExtension extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20230301:VirtualMachineExtension';

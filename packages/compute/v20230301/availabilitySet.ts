...
export class AvailabilitySet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20230301:AvailabilitySet';
     ...
     */
    public /*out*/ readonly statuses!: pulumi.Output<types.outputs.compute.v20230301.InstanceViewStatusResponse[]>;
    /**
     * Resource tags
     */
     ...
     */
    public readonly virtualMachines!: pulumi.Output<types.outputs.compute.v20230301.SubResourceResponse[] | undefined>;
...
export interface AvailabilitySetArgs {
     ...
     * A list of references to all virtual machines in the availability set.
     */
    virtualMachines?: pulumi.Input<pulumi.Input<types.inputs.compute.v20230301.SubResourceArgs>[]>;
}

...
export function getDedicatedHostGroup(args: GetDedicatedHostGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetDedicatedHostGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-native:compute/v20230301:getDedicatedHostGroup", {
        "expand": args.expand,
...
export interface GetDedicatedHostGroupResult {
     ...
     */
    readonly additionalCapabilities?: types.outputs.compute.v20230301.DedicatedHostGroupPropertiesResponseAdditionalCapabilities;
    /**
     * A list of references to all dedicated hosts in the dedicated host group.
     */
    readonly hosts: types.outputs.compute.v20230301.SubResourceReadOnlyResponse[];
    /**
     * Resource Id
     */
    readonly id: string;
     ...
     */
    readonly instanceView: types.outputs.compute.v20230301.DedicatedHostGroupInstanceViewResponse;
    /**
     * Resource location
     */

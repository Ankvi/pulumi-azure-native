...
export class DedicatedHost extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly instanceView!: pulumi.Output<types.outputs.compute.v20230301.DedicatedHostInstanceViewResponse>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<types.outputs.compute.v20230301.SkuResponse>;
    /**
     * Resource tags
     */
     ...
     */
    public /*out*/ readonly virtualMachines!: pulumi.Output<types.outputs.compute.v20230301.SubResourceReadOnlyResponse[]>;
...
export interface DedicatedHostArgs {
     ...
     * Specifies the software license type that will be applied to the VMs deployed on the dedicated host. Possible values are: **None,** **Windows_Server_Hybrid,** **Windows_Server_Perpetual.** The default value is: **None.**
     */
    licenseType?: pulumi.Input<types.enums.v20230301.DedicatedHostLicenseTypes>;
    /**
     * Resource location
     */

...
export interface GetDedicatedHostResult {
     ...
     */
    readonly instanceView: types.outputs.compute.v20230301.DedicatedHostInstanceViewResponse;
    /**
     ...
     */
    readonly virtualMachines: types.outputs.compute.v20230301.SubResourceReadOnlyResponse[];
}
/**
 * Retrieves information about a dedicated host.
 */

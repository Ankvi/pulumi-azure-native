...
export class DedicatedHostGroup extends pulumi.CustomResource {
     ...
     */
    public readonly additionalCapabilities!: pulumi.Output<types.outputs.compute.v20230301.DedicatedHostGroupPropertiesResponseAdditionalCapabilities | undefined>;
    /**
     * A list of references to all dedicated hosts in the dedicated host group.
     */
    public /*out*/ readonly hosts!: pulumi.Output<types.outputs.compute.v20230301.SubResourceReadOnlyResponse[]>;
    /**
     * The dedicated host group instance view, which has the list of instance view of the dedicated hosts under the dedicated host group.
     */
    public /*out*/ readonly instanceView!: pulumi.Output<types.outputs.compute.v20230301.DedicatedHostGroupInstanceViewResponse>;
    /**
     * Resource location
     */
...
export interface DedicatedHostGroupArgs {
     ...
     * Enables or disables a capability on the dedicated host group. Minimum api-version: 2022-03-01.
     */
    additionalCapabilities?: pulumi.Input<types.inputs.compute.v20230301.DedicatedHostGroupPropertiesAdditionalCapabilitiesArgs>;
    /**

...
export function getVirtualMachineExtension(args: GetVirtualMachineExtensionArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualMachineExtensionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:compute/v20230301:getVirtualMachineExtension", {
        "expand": args.expand,
...
export interface GetVirtualMachineExtensionResult {
     ...
     */
    readonly instanceView?: types.outputs.compute.v20230301.VirtualMachineExtensionInstanceViewResponse;
    /**
     * Resource location
     */

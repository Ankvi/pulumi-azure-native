...
export function getAvailabilitySet(args: GetAvailabilitySetArgs, opts?: pulumi.InvokeOptions): Promise<GetAvailabilitySetResult> {
    ...
    return pulumi.runtime.invoke("azure-native:compute/v20230301:getAvailabilitySet", {
...
export interface GetAvailabilitySetResult {
     ...
     */
    readonly statuses: types.outputs.compute.v20230301.InstanceViewStatusResponse[];
    /**
     * Resource tags
     */
     ...
     */
    readonly virtualMachines?: types.outputs.compute.v20230301.SubResourceResponse[];
}
/**
 * Retrieves information about an availability set.
 */

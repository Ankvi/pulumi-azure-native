...
export class GalleryApplicationVersion extends pulumi.CustomResource {
     ...
     */
    declare public readonly publishingProfile: pulumi.Output<types.outputs.GalleryApplicationVersionPublishingProfileResponse>;
    /**
     ...
     */
    declare public readonly safetyProfile: pulumi.Output<types.outputs.GalleryApplicationVersionSafetyProfileResponse | undefined>;
    /**

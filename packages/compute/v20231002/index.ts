...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:compute/v20231002:Disk":
                return new Disk(name, <any>undefined, { urn })
            case "azure-native:compute/v20231002:DiskAccess":
                return new DiskAccess(name, <any>undefined, { urn })
            case "azure-native:compute/v20231002:DiskAccessAPrivateEndpointConnection":
                return new DiskAccessAPrivateEndpointConnection(name, <any>undefined, { urn })
            case "azure-native:compute/v20231002:DiskEncryptionSet":
                return new DiskEncryptionSet(name, <any>undefined, { urn })
            case "azure-native:compute/v20231002:Snapshot":
...
pulumi.runtime.registerResourceModule("azure-native", "compute/v20231002", _module)
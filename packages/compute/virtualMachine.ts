...
export class VirtualMachine extends pulumi.CustomResource {
     ...
     */
    declare public readonly additionalCapabilities: pulumi.Output<types.outputs.AdditionalCapabilitiesResponse | undefined>;
    /**
     * Specifies the gallery applications that should be made available to the VM/VMSS.
     */
    declare public readonly applicationProfile: pulumi.Output<types.outputs.ApplicationProfileResponse | undefined>;
    /**
     ...
     */
    declare public readonly availabilitySet: pulumi.Output<types.outputs.SubResourceResponse | undefined>;
    /**
     ...
     */
    declare public readonly billingProfile: pulumi.Output<types.outputs.BillingProfileResponse | undefined>;
    /**
     ...
     */
    declare public readonly capacityReservation: pulumi.Output<types.outputs.CapacityReservationProfileResponse | undefined>;
    /**
     * Specifies the boot diagnostic settings state. Minimum api-version: 2015-06-15.
     */
    declare public readonly diagnosticsProfile: pulumi.Output<types.outputs.DiagnosticsProfileResponse | undefined>;
    /**
     ...
     */
    declare public readonly hardwareProfile: pulumi.Output<types.outputs.HardwareProfileResponse | undefined>;
    /**
     * Specifies information about the dedicated host that the virtual machine resides in. Minimum api-version: 2018-10-01.
     */
    declare public readonly host: pulumi.Output<types.outputs.SubResourceResponse | undefined>;
    /**
     ...
     */
    declare public readonly hostGroup: pulumi.Output<types.outputs.SubResourceResponse | undefined>;
    /**
     * The identity of the virtual machine, if configured.
     */
    declare public readonly identity: pulumi.Output<types.outputs.VirtualMachineIdentityResponse | undefined>;
    /**
     * The virtual machine instance view.
     */
    declare public /*out*/ readonly instanceView: pulumi.Output<types.outputs.VirtualMachineInstanceViewResponse>;
    /**
     ...
     */
    declare public readonly networkProfile: pulumi.Output<types.outputs.NetworkProfileResponse | undefined>;
    /**
     ...
     */
    declare public readonly placement: pulumi.Output<types.outputs.PlacementResponse | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly resources: pulumi.Output<types.outputs.VirtualMachineExtensionResponse[]>;
    /**
     ...
     */
    declare public readonly scheduledEventsProfile: pulumi.Output<types.outputs.ScheduledEventsProfileResponse | undefined>;
    /**
     * Specifies the Security related profile settings for the virtual machine.
     */
    declare public readonly securityProfile: pulumi.Output<types.outputs.SecurityProfileResponse | undefined>;
    /**
     * Specifies the storage settings for the virtual machine disks.
     */
    declare public readonly storageProfile: pulumi.Output<types.outputs.StorageProfileResponse | undefined>;
    /**
     ...
     */
    declare public readonly virtualMachineScaleSet: pulumi.Output<types.outputs.SubResourceResponse | undefined>;
    /**

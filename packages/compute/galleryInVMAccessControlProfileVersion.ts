...
export class GalleryInVMAccessControlProfileVersion extends pulumi.CustomResource {
     ...
     */
    declare public readonly rules: pulumi.Output<types.outputs.AccessControlRulesResponse | undefined>;
    /**
     ...
     */
    declare public readonly targetLocations: pulumi.Output<types.outputs.TargetRegionResponse[] | undefined>;
    /**

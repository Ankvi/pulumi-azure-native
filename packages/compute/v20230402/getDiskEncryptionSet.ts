...
export function getDiskEncryptionSet(args: GetDiskEncryptionSetArgs, opts?: pulumi.InvokeOptions): Promise<GetDiskEncryptionSetResult> {
    ...
    return pulumi.runtime.invoke("azure-native:compute/v20230402:getDiskEncryptionSet", {
...
export interface GetDiskEncryptionSetResult {
     ...
     */
    readonly activeKey?: types.outputs.compute.v20230402.KeyForDiskEncryptionSetResponse;
    /**
     * The error that was encountered during auto-key rotation. If an error is present, then auto-key rotation will not be attempted until the error on this disk encryption set is fixed.
     */
    readonly autoKeyRotationError: types.outputs.compute.v20230402.ApiErrorResponse;
    /**
     ...
     */
    readonly identity?: types.outputs.compute.v20230402.EncryptionSetIdentityResponse;
    /**
     ...
     */
    readonly previousKeys: types.outputs.compute.v20230402.KeyForDiskEncryptionSetResponse[];
    /**

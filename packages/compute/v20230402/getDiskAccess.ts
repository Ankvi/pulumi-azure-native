...
export function getDiskAccess(args: GetDiskAccessArgs, opts?: pulumi.InvokeOptions): Promise<GetDiskAccessResult> {
    ...
    return pulumi.runtime.invoke("azure-native:compute/v20230402:getDiskAccess", {
...
export interface GetDiskAccessResult {
     ...
     */
    readonly privateEndpointConnections: types.outputs.compute.v20230402.PrivateEndpointConnectionResponse[];
    /**

...
export class DiskAccessAPrivateEndpointConnection extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly privateEndpoint!: pulumi.Output<types.outputs.compute.v20230402.PrivateEndpointResponse>;
    /**
     * A collection of information about the state of the connection between DiskAccess and Virtual Network.
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<types.outputs.compute.v20230402.PrivateLinkServiceConnectionStateResponse>;
    /**
...
export interface DiskAccessAPrivateEndpointConnectionArgs {
     ...
     * A collection of information about the state of the connection between DiskAccess and Virtual Network.
     */
    privateLinkServiceConnectionState: pulumi.Input<types.inputs.compute.v20230402.PrivateLinkServiceConnectionStateArgs>;
    /**

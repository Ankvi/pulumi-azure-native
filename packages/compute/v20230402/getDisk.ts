...
export function getDisk(args: GetDiskArgs, opts?: pulumi.InvokeOptions): Promise<GetDiskResult> {
    ...
    return pulumi.runtime.invoke("azure-native:compute/v20230402:getDisk", {
...
export interface GetDiskResult {
     ...
     */
    readonly propertyUpdatesInProgress: types.outputs.compute.v20230402.PropertyUpdatesInProgressResponse;
    /**
     ...
     */
    readonly shareInfo: types.outputs.compute.v20230402.ShareInfoElementResponse[];
    /**
     * The disks sku name. Can be Standard_LRS, Premium_LRS, StandardSSD_LRS, UltraSSD_LRS, Premium_ZRS, StandardSSD_ZRS, or PremiumV2_LRS.
     */
    readonly sku?: types.outputs.compute.v20230402.DiskSkuResponse;
    /**

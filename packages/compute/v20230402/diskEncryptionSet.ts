...
export class DiskEncryptionSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:compute/v20230402:DiskEncryptionSet';
     ...
     */
    public readonly activeKey!: pulumi.Output<types.outputs.compute.v20230402.KeyForDiskEncryptionSetResponse | undefined>;
    /**
     * The error that was encountered during auto-key rotation. If an error is present, then auto-key rotation will not be attempted until the error on this disk encryption set is fixed.
     */
    public /*out*/ readonly autoKeyRotationError!: pulumi.Output<types.outputs.compute.v20230402.ApiErrorResponse>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<types.outputs.compute.v20230402.EncryptionSetIdentityResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly previousKeys!: pulumi.Output<types.outputs.compute.v20230402.KeyForDiskEncryptionSetResponse[]>;
    /**
...
export interface DiskEncryptionSetArgs {
     ...
     * The key vault key which is currently used by this disk encryption set.
     */
    activeKey?: pulumi.Input<types.inputs.compute.v20230402.KeyForDiskEncryptionSetArgs>;
    /**
     ...
     * The type of key used to encrypt the data of the disk.
     */
    encryptionType?: pulumi.Input<string | types.enums.v20230402.DiskEncryptionSetType>;
    /**
     * Multi-tenant application client id to access key vault in a different tenant. Setting the value to 'None' will clear the property.
     */
     ...
     * The managed identity for the disk encryption set. It should be given permission on the key vault before it can be used to encrypt disks.
     */
    identity?: pulumi.Input<types.inputs.compute.v20230402.EncryptionSetIdentityArgs>;
    /**
     * Resource location
     */

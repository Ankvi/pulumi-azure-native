...
export class PrivateLinkServicesForEDMUpload extends pulumi.CustomResource {
     ...
     */
    declare public readonly identity: pulumi.Output<types.outputs.ServicesResourceResponseIdentity | undefined>;
    /**
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.ServicesPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: PrivateLinkServicesForEDMUploadArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:m365securityandcompliance/v20210325preview:PrivateLinkServicesForEDMUpload" }] };

...
export namespace m365securityandcompliance {
    /**
    ...
    export namespace v20210325preview {
        /**
         * The Private Endpoint Connection resource.
         */
        export interface PrivateEndpointConnectionArgs {
             ...
             * A collection of information about the state of the connection between service consumer and provider.
             */
            privateLinkServiceConnectionState: pulumi.Input<v20210325preview.PrivateLinkServiceConnectionStateArgs>;
        }
        ...
        export interface PrivateLinkServiceConnectionStateArgs {
             ...
             * Indicates whether the connection has been Approved/Rejected/Removed by the owner of the service.
             */
            status?: pulumi.Input<string | enums.v20210325preview.PrivateEndpointServiceConnectionStatus>;
        }
        ...
        export interface ServicesPropertiesArgs {
             ...
             * The access policies of the service instance.
             */
            accessPolicies?: pulumi.Input<pulumi.Input<v20210325preview.ServiceAccessPolicyEntryArgs>[]>;
            /**
             * The authentication configuration for the service instance.
             */
            authenticationConfiguration?: pulumi.Input<v20210325preview.ServiceAuthenticationConfigurationInfoArgs>;
            /**
             * The settings for the CORS configuration of the service instance.
             */
            corsConfiguration?: pulumi.Input<v20210325preview.ServiceCorsConfigurationInfoArgs>;
            /**
             * The settings for the Cosmos DB database backing the service.
             */
            cosmosDbConfiguration?: pulumi.Input<v20210325preview.ServiceCosmosDbConfigurationInfoArgs>;
            /**
             * The settings for the export operation of the service instance.
             */
            exportConfiguration?: pulumi.Input<v20210325preview.ServiceExportConfigurationInfoArgs>;
            /**
             * The list of private endpoint connections that are set up for this resource.
             */
            privateEndpointConnections?: pulumi.Input<pulumi.Input<v20210325preview.PrivateEndpointConnectionArgs>[]>;
            /**
             * Control permission for data plane traffic coming from public networks while private endpoint is enabled.
             */
            publicNetworkAccess?: pulumi.Input<string | enums.v20210325preview.PublicNetworkAccess>;
        }
        ...
        export interface ServicesResourceIdentityArgs {
             ...
             * Type of identity being specified, currently SystemAssigned and None are allowed.
             */
            type?: pulumi.Input<string | enums.v20210325preview.ManagedServiceIdentityType>;
        }

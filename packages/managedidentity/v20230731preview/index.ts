...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:managedidentity/v20230731preview:FederatedIdentityCredential":
                return new FederatedIdentityCredential(name, <any>undefined, { urn })
            case "azure-native:managedidentity/v20230731preview:UserAssignedIdentity":
...
pulumi.runtime.registerResourceModule("azure-native", "managedidentity/v20230731preview", _module)
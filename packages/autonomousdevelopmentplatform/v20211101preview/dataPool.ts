...
export class DataPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:autonomousdevelopmentplatform/v20211101preview:DataPool';
    ...
    constructor(name: string, args: DataPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:autonomousdevelopmentplatform:DataPool" }, { type: "azure-native:autonomousdevelopmentplatform/v20200701preview:DataPool" }, { type: "azure-native:autonomousdevelopmentplatform/v20210201preview:DataPool" }] };

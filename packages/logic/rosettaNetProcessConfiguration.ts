...
export class RosettaNetProcessConfiguration extends pulumi.CustomResource {
     ...
     */
    declare public readonly activitySettings: pulumi.Output<types.outputs.RosettaNetPipActivitySettingsResponse>;
    /**
     ...
     */
    declare public readonly initiatorRoleSettings: pulumi.Output<types.outputs.RosettaNetPipRoleSettingsResponse>;
    /**
     ...
     */
    declare public readonly responderRoleSettings: pulumi.Output<types.outputs.RosettaNetPipRoleSettingsResponse>;
    /**
     * The resource tags.
     */

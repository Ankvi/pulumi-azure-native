...
export class IntegrationAccountAssembly extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:logic:IntegrationAccountAssembly';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.AssemblyPropertiesResponse>;
    /**
     * The resource tags.
     */
    ...
    constructor(name: string, args: IntegrationAccountAssemblyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["assemblyArtifactName"] = args?.assemblyArtifactName;

...
export class IntegrationAccountMap extends pulumi.CustomResource {
     ...
     * The content link.
     */
    declare public /*out*/ readonly contentLink: pulumi.Output<types.outputs.ContentLinkResponse>;
    /**
     * The content type.
     */
     ...
     */
    declare public readonly parametersSchema: pulumi.Output<types.outputs.IntegrationAccountMapPropertiesResponseParametersSchema | undefined>;
    /**
     * The resource tags.
     */

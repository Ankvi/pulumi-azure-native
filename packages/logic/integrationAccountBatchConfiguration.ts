...
export class IntegrationAccountBatchConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:logic:IntegrationAccountBatchConfiguration';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.BatchConfigurationPropertiesResponse>;
    /**
     * The resource tags.
     */
    ...
    constructor(name: string, args: IntegrationAccountBatchConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["batchConfigurationName"] = args?.batchConfigurationName;

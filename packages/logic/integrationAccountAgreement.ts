...
export class IntegrationAccountAgreement extends pulumi.CustomResource {
     ...
     */
    declare public readonly content: pulumi.Output<types.outputs.AgreementContentResponse>;
    /**
     * The created time.
     */
     ...
     */
    declare public readonly guestIdentity: pulumi.Output<types.outputs.BusinessIdentityResponse>;
    /**
     ...
     */
    declare public readonly hostIdentity: pulumi.Output<types.outputs.BusinessIdentityResponse>;
    /**

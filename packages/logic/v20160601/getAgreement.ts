...
export interface GetAgreementResult {
     ...
     */
    readonly content: types.outputs.logic.v20160601.AgreementContentResponse;
    /**
     * The created time.
     */
     ...
     */
    readonly guestIdentity: types.outputs.logic.v20160601.BusinessIdentityResponse;
    /**
     ...
     */
    readonly hostIdentity: types.outputs.logic.v20160601.BusinessIdentityResponse;
    /**

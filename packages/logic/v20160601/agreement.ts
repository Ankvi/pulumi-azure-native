...
export class Agreement extends pulumi.CustomResource {
     ...
     */
    public readonly content!: pulumi.Output<types.outputs.logic.v20160601.AgreementContentResponse>;
    /**
     * The created time.
     */
     ...
     */
    public readonly guestIdentity!: pulumi.Output<types.outputs.logic.v20160601.BusinessIdentityResponse>;
    /**
     ...
     */
    public readonly hostIdentity!: pulumi.Output<types.outputs.logic.v20160601.BusinessIdentityResponse>;
    /**
...
export interface AgreementArgs {
     ...
     * The agreement type.
     */
    agreementType: pulumi.Input<types.enums.v20160601.AgreementType>;
    /**
     * The agreement content.
     */
    content: pulumi.Input<types.inputs.logic.v20160601.AgreementContentArgs>;
    /**
     * The business identity of the guest partner.
     */
    guestIdentity: pulumi.Input<types.inputs.logic.v20160601.BusinessIdentityArgs>;
    /**
     * The integration account partner that is set as guest partner for this agreement.
     */
     ...
     * The business identity of the host partner.
     */
    hostIdentity: pulumi.Input<types.inputs.logic.v20160601.BusinessIdentityArgs>;
    /**
     * The integration account partner that is set as host partner for this agreement.
     */

...
export class IntegrationAccountCertificate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:logic/v20190501:IntegrationAccountCertificate';
     ...
     */
    public readonly key!: pulumi.Output<types.outputs.logic.v20190501.KeyVaultKeyReferenceResponse | undefined>;
    /**
...
export interface IntegrationAccountCertificateArgs {
     ...
     * The key details in the key vault.
     */
    key?: pulumi.Input<types.inputs.logic.v20190501.KeyVaultKeyReferenceArgs>;
    /**
     * The resource location.
     */

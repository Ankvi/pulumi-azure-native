...
export function getIntegrationAccountAgreement(args: GetIntegrationAccountAgreementArgs, opts?: pulumi.InvokeOptions): Promise<GetIntegrationAccountAgreementResult> {
    ...
    return pulumi.runtime.invoke("azure-native:logic/v20190501:getIntegrationAccountAgreement", {
...
export interface GetIntegrationAccountAgreementResult {
     ...
     */
    readonly content: types.outputs.logic.v20190501.AgreementContentResponse;
    /**
     * The created time.
     */
     ...
     */
    readonly guestIdentity: types.outputs.logic.v20190501.BusinessIdentityResponse;
    /**
     ...
     */
    readonly hostIdentity: types.outputs.logic.v20190501.BusinessIdentityResponse;
    /**

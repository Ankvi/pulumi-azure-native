...
export class IntegrationServiceEnvironment extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.IntegrationServiceEnvironmentPropertiesResponse>;
    /**
     * The sku.
     */
    declare public readonly sku: pulumi.Output<types.outputs.IntegrationServiceEnvironmentSkuResponse | undefined>;
    /**
     * The resource tags.
     */

...
export interface GetAttestationProviderResult {
     ...
     */
    readonly privateEndpointConnections: types.outputs.attestation.v20210601.PrivateEndpointConnectionResponse[];
    /**
     ...
     */
    readonly systemData: types.outputs.attestation.v20210601.SystemDataResponse;
    /**
     * Resource tags.
     */

...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:attestation/v20210601:AttestationProvider":
                return new AttestationProvider(name, <any>undefined, { urn })
            case "azure-native:attestation/v20210601:PrivateEndpointConnection":
...
pulumi.runtime.registerResourceModule("azure-native", "attestation/v20210601", _module)

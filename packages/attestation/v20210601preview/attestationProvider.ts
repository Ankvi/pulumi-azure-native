...
export class AttestationProvider extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:attestation/v20210601preview:AttestationProvider';
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<types.outputs.attestation.v20210601preview.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<types.outputs.attestation.v20210601preview.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: AttestationProviderArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:attestation:AttestationProvider" }, { type: "azure-native:attestation/v20180901preview:AttestationProvider" }, { type: "azure-native:attestation/v20201001:AttestationProvider" }, { type: "azure-native:attestation/v20210601:AttestationProvider" }] };
...
export interface AttestationProviderArgs {
     ...
     */
    properties: pulumi.Input<types.inputs.attestation.v20210601preview.AttestationServiceCreationSpecificParamsArgs>;
    /**

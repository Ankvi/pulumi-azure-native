...
export namespace databricks {
    ...
    export namespace v20220401preview {
        ...
        export interface IdentityDataArgs {
             ...
             * The identity type.
             */
            type: pulumi.Input<string | enums.v20220401preview.IdentityType>;
        }
    ...
    export namespace v20230201 {
        ...
        export interface EncryptionArgs {
             ...
             * The encryption keySource (provider). Possible values (case-insensitive):  Default, Microsoft.Keyvault
             */
            keySource?: pulumi.Input<string | enums.v20230201.KeySource>;
            /**
             * The Uri of KeyVault.
             */
            keyVaultUri?: pulumi.Input<string>;
        ...
        export interface EncryptionEntitiesDefinitionArgs {
             ...
             * Encryption properties for the databricks managed disks.
             */
            managedDisk?: pulumi.Input<v20230201.ManagedDiskEncryptionArgs>;
            /**
             * Encryption properties for the databricks managed services.
             */
            managedServices?: pulumi.Input<v20230201.EncryptionV2Args>;
        }
        ...
        export interface EncryptionV2Args {
             ...
             * The encryption keySource (provider). Possible values (case-insensitive):  Microsoft.Keyvault
             */
            keySource: pulumi.Input<string | enums.v20230201.EncryptionKeySource>;
            /**
             * Key Vault input properties for encryption.
             */
            keyVaultProperties?: pulumi.Input<v20230201.EncryptionV2KeyVaultPropertiesArgs>;
        }
        ...
        export interface ManagedDiskEncryptionArgs {
             ...
             * Key Vault input properties for encryption.
             */
            keyVaultProperties: pulumi.Input<v20230201.ManagedDiskEncryptionKeyVaultPropertiesArgs>;
            /**
             * Indicate whether the latest key version should be automatically used for Managed Disk Encryption.
             */
            rotationToLatestKeyVersionEnabled?: pulumi.Input<boolean>;
        ...
        export interface PrivateEndpointConnectionPropertiesArgs {
             ...
             * Private endpoint connection state
             */
            privateLinkServiceConnectionState: pulumi.Input<v20230201.PrivateLinkServiceConnectionStateArgs>;
        }
        ...
        export interface WorkspaceCustomParametersArgs {
             ...
             * The ID of a Azure Machine Learning workspace to link with Databricks workspace
             */
            amlWorkspaceId?: pulumi.Input<v20230201.WorkspaceCustomStringParameterArgs>;
            /**
             * The name of the Private Subnet within the Virtual Network
             */
            customPrivateSubnetName?: pulumi.Input<v20230201.WorkspaceCustomStringParameterArgs>;
            /**
             * The name of a Public Subnet within the Virtual Network
             */
            customPublicSubnetName?: pulumi.Input<v20230201.WorkspaceCustomStringParameterArgs>;
            /**
             * The ID of a Virtual Network where this Databricks Cluster should be created
             */
            customVirtualNetworkId?: pulumi.Input<v20230201.WorkspaceCustomStringParameterArgs>;
            /**
             * Should the Public IP be Disabled?
             */
            enableNoPublicIp?: pulumi.Input<v20230201.WorkspaceCustomBooleanParameterArgs>;
            /**
             * Contains the encryption details for Customer-Managed Key (CMK) enabled workspace.
             */
            encryption?: pulumi.Input<v20230201.WorkspaceEncryptionParameterArgs>;
            /**
             * Name of the outbound Load Balancer Backend Pool for Secure Cluster Connectivity (No Public IP).
             */
            loadBalancerBackendPoolName?: pulumi.Input<v20230201.WorkspaceCustomStringParameterArgs>;
            /**
             * Resource URI of Outbound Load balancer for Secure Cluster Connectivity (No Public IP) workspace.
             */
            loadBalancerId?: pulumi.Input<v20230201.WorkspaceCustomStringParameterArgs>;
            /**
             * Name of the NAT gateway for Secure Cluster Connectivity (No Public IP) workspace subnets.
             */
            natGatewayName?: pulumi.Input<v20230201.WorkspaceCustomStringParameterArgs>;
            /**
             * Prepare the workspace for encryption. Enables the Managed Identity for managed storage account.
             */
            prepareEncryption?: pulumi.Input<v20230201.WorkspaceCustomBooleanParameterArgs>;
            /**
             * Name of the Public IP for No Public IP workspace with managed vNet.
             */
            publicIpName?: pulumi.Input<v20230201.WorkspaceCustomStringParameterArgs>;
            /**
             * A boolean indicating whether or not the DBFS root file system will be enabled with secondary layer of encryption with platform managed keys for data at rest.
             */
            requireInfrastructureEncryption?: pulumi.Input<v20230201.WorkspaceCustomBooleanParameterArgs>;
            /**
             * Default DBFS storage account name.
             */
            storageAccountName?: pulumi.Input<v20230201.WorkspaceCustomStringParameterArgs>;
            /**
             * Storage account SKU name, ex: Standard_GRS, Standard_LRS. Refer https://aka.ms/storageskus for valid inputs.
             */
            storageAccountSkuName?: pulumi.Input<v20230201.WorkspaceCustomStringParameterArgs>;
            /**
             * Address prefix for Managed virtual network. Default value for this input is 10.139.
             */
            vnetAddressPrefix?: pulumi.Input<v20230201.WorkspaceCustomStringParameterArgs>;
        }
        /**
         * workspaceCustomParametersArgsProvideDefaults sets the appropriate defaults for WorkspaceCustomParametersArgs
         */
        export function workspaceCustomParametersArgsProvideDefaults(val: WorkspaceCustomParametersArgs): WorkspaceCustomParametersArgs {
            return {
                ...val,
                encryption: (val.encryption ? pulumi.output(val.encryption).apply(v20230201.workspaceEncryptionParameterArgsProvideDefaults) : undefined),
            };
        }
        ...
        export interface WorkspaceEncryptionParameterArgs {
             ...
             * The value which should be used for this field.
             */
            value?: pulumi.Input<v20230201.EncryptionArgs>;
        }
        /**
         * workspaceEncryptionParameterArgsProvideDefaults sets the appropriate defaults for WorkspaceEncryptionParameterArgs
         */
        export function workspaceEncryptionParameterArgsProvideDefaults(val: WorkspaceEncryptionParameterArgs): WorkspaceEncryptionParameterArgs {
            return {
                ...val,
                value: (val.value ? pulumi.output(val.value).apply(v20230201.encryptionArgsProvideDefaults) : undefined),
            };
        }
        ...
        export interface WorkspacePropertiesEncryptionArgs {
             ...
             * Encryption entities definition for the workspace.
             */
            entities: pulumi.Input<v20230201.EncryptionEntitiesDefinitionArgs>;
        }

...
export namespace databricks {
    ...
    export namespace v20230201 {
        ...
        export interface EncryptionEntitiesDefinitionResponse {
             ...
             * Encryption properties for the databricks managed disks.
             */
            managedDisk?: v20230201.ManagedDiskEncryptionResponse;
            /**
             * Encryption properties for the databricks managed services.
             */
            managedServices?: v20230201.EncryptionV2Response;
        }
        ...
        export interface EncryptionV2Response {
             ...
             * Key Vault input properties for encryption.
             */
            keyVaultProperties?: v20230201.EncryptionV2ResponseKeyVaultProperties;
        }
        ...
        export interface ManagedDiskEncryptionResponse {
             ...
             * Key Vault input properties for encryption.
             */
            keyVaultProperties: v20230201.ManagedDiskEncryptionResponseKeyVaultProperties;
            /**
             * Indicate whether the latest key version should be automatically used for Managed Disk Encryption.
             */
            rotationToLatestKeyVersionEnabled?: boolean;
        ...
        export interface PrivateEndpointConnectionResponse {
             ...
             * The private endpoint connection properties.
             */
            properties: v20230201.PrivateEndpointConnectionPropertiesResponse;
            /**
             * The resource type.
             */
            type: string;
        ...
        export interface WorkspaceCustomParametersResponse {
             ...
             * The ID of a Azure Machine Learning workspace to link with Databricks workspace
             */
            amlWorkspaceId?: v20230201.WorkspaceCustomStringParameterResponse;
            /**
             * The name of the Private Subnet within the Virtual Network
             */
            customPrivateSubnetName?: v20230201.WorkspaceCustomStringParameterResponse;
            /**
             * The name of a Public Subnet within the Virtual Network
             */
            customPublicSubnetName?: v20230201.WorkspaceCustomStringParameterResponse;
            /**
             * The ID of a Virtual Network where this Databricks Cluster should be created
             */
            customVirtualNetworkId?: v20230201.WorkspaceCustomStringParameterResponse;
            /**
             * Should the Public IP be Disabled?
             */
            enableNoPublicIp?: v20230201.WorkspaceCustomBooleanParameterResponse;
            /**
             * Contains the encryption details for Customer-Managed Key (CMK) enabled workspace.
             */
            encryption?: v20230201.WorkspaceEncryptionParameterResponse;
            /**
             * Name of the outbound Load Balancer Backend Pool for Secure Cluster Connectivity (No Public IP).
             */
            loadBalancerBackendPoolName?: v20230201.WorkspaceCustomStringParameterResponse;
            /**
             * Resource URI of Outbound Load balancer for Secure Cluster Connectivity (No Public IP) workspace.
             */
            loadBalancerId?: v20230201.WorkspaceCustomStringParameterResponse;
            /**
             * Name of the NAT gateway for Secure Cluster Connectivity (No Public IP) workspace subnets.
             */
            natGatewayName?: v20230201.WorkspaceCustomStringParameterResponse;
            /**
             * Prepare the workspace for encryption. Enables the Managed Identity for managed storage account.
             */
            prepareEncryption?: v20230201.WorkspaceCustomBooleanParameterResponse;
            /**
             * Name of the Public IP for No Public IP workspace with managed vNet.
             */
            publicIpName?: v20230201.WorkspaceCustomStringParameterResponse;
            /**
             * A boolean indicating whether or not the DBFS root file system will be enabled with secondary layer of encryption with platform managed keys for data at rest.
             */
            requireInfrastructureEncryption?: v20230201.WorkspaceCustomBooleanParameterResponse;
            /**
             * Tags applied to resources under Managed resource group. These can be updated by updating tags at workspace level.
             */
            resourceTags: v20230201.WorkspaceCustomObjectParameterResponse;
            /**
             * Default DBFS storage account name.
             */
            storageAccountName?: v20230201.WorkspaceCustomStringParameterResponse;
            /**
             * Storage account SKU name, ex: Standard_GRS, Standard_LRS. Refer https://aka.ms/storageskus for valid inputs.
             */
            storageAccountSkuName?: v20230201.WorkspaceCustomStringParameterResponse;
            /**
             * Address prefix for Managed virtual network. Default value for this input is 10.139.
             */
            vnetAddressPrefix?: v20230201.WorkspaceCustomStringParameterResponse;
        }
        /**
         * workspaceCustomParametersResponseProvideDefaults sets the appropriate defaults for WorkspaceCustomParametersResponse
         */
        export function workspaceCustomParametersResponseProvideDefaults(val: WorkspaceCustomParametersResponse): WorkspaceCustomParametersResponse {
            return {
                ...val,
                encryption: (val.encryption ? v20230201.workspaceEncryptionParameterResponseProvideDefaults(val.encryption) : undefined),
            };
        }
        ...
        export interface WorkspaceEncryptionParameterResponse {
             ...
             * The value which should be used for this field.
             */
            value?: v20230201.EncryptionResponse;
        }
        /**
         * workspaceEncryptionParameterResponseProvideDefaults sets the appropriate defaults for WorkspaceEncryptionParameterResponse
         */
        export function workspaceEncryptionParameterResponseProvideDefaults(val: WorkspaceEncryptionParameterResponse): WorkspaceEncryptionParameterResponse {
            return {
                ...val,
                value: (val.value ? v20230201.encryptionResponseProvideDefaults(val.value) : undefined),
            };
        }
        ...
        export interface WorkspacePropertiesResponseEncryption {
             ...
             * Encryption entities definition for the workspace.
             */
            entities: v20230201.EncryptionEntitiesDefinitionResponse;
        }

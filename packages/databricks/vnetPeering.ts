...
export class VNetPeering extends pulumi.CustomResource {
     ...
     */
    public readonly databricksAddressSpace!: pulumi.Output<types.outputs.databricks.AddressSpaceResponse | undefined>;
    /**
     *  The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
     */
    public readonly databricksVirtualNetwork!: pulumi.Output<types.outputs.databricks.VirtualNetworkPeeringPropertiesFormatResponseDatabricksVirtualNetwork | undefined>;
    /**
     ...
     */
    public readonly remoteAddressSpace!: pulumi.Output<types.outputs.databricks.AddressSpaceResponse | undefined>;
    /**
     *  The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
     */
    public readonly remoteVirtualNetwork!: pulumi.Output<types.outputs.databricks.VirtualNetworkPeeringPropertiesFormatResponseRemoteVirtualNetwork>;
    /**
...
export interface VNetPeeringArgs {
     ...
     * The reference to the databricks virtual network address space.
     */
    databricksAddressSpace?: pulumi.Input<types.inputs.databricks.AddressSpaceArgs>;
    /**
     *  The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
     */
    databricksVirtualNetwork?: pulumi.Input<types.inputs.databricks.VirtualNetworkPeeringPropertiesFormatDatabricksVirtualNetworkArgs>;
    /**
     ...
     * The reference to the remote virtual network address space.
     */
    remoteAddressSpace?: pulumi.Input<types.inputs.databricks.AddressSpaceArgs>;
    /**
     *  The remote virtual network should be in the same region. See here to learn more (https://docs.microsoft.com/en-us/azure/databricks/administration-guide/cloud-configurations/azure/vnet-peering).
     */
    remoteVirtualNetwork: pulumi.Input<types.inputs.databricks.VirtualNetworkPeeringPropertiesFormatRemoteVirtualNetworkArgs>;
    /**

...
export class AccessConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:databricks/v20220401preview:AccessConnector';
    ...
    constructor(name: string, args: AccessConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:databricks:AccessConnector" }, { type: "azure-native:databricks/v20221001preview:AccessConnector" }, { type: "azure-native:databricks/v20230501:AccessConnector" }] };

...
export class MachineRunCommand extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly instanceView: pulumi.Output<types.outputs.MachineRunCommandInstanceViewResponse>;
    /**
     ...
     */
    declare public readonly source: pulumi.Output<types.outputs.MachineRunCommandScriptSourceResponse | undefined>;
    /**

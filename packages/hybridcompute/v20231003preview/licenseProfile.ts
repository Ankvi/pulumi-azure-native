...
export class LicenseProfile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:hybridcompute/v20231003preview:LicenseProfile';
     ...
     */
    public readonly productFeatures!: pulumi.Output<types.outputs.ProductFeatureResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: LicenseProfileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hybridcompute:LicenseProfile" }, { type: "azure-native:hybridcompute/v20230620preview:LicenseProfile" }] };

...
export class License extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:hybridcompute/v20231003preview:License';
    ...
    constructor(name: string, args: LicenseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hybridcompute:License" }, { type: "azure-native:hybridcompute/v20230620preview:License" }] };

...
export class MachineRunCommand extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:hybridcompute/v20231003preview:MachineRunCommand';
    ...
    constructor(name: string, args: MachineRunCommandArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hybridcompute:MachineRunCommand" }] };

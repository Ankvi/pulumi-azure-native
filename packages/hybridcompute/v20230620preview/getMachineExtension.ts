...
export function getMachineExtension(args: GetMachineExtensionArgs, opts?: pulumi.InvokeOptions): Promise<GetMachineExtensionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:hybridcompute/v20230620preview:getMachineExtension", {
...
export interface GetMachineExtensionResult {
     ...
     */
    readonly properties: types.outputs.hybridcompute.v20230620preview.MachineExtensionPropertiesResponse;
    /**

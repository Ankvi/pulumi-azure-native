...
export class PrivateLinkScope extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:hybridcompute/v20221227:PrivateLinkScope';
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.hybridcompute.v20221227.HybridComputePrivateLinkScopePropertiesResponse>;
    /**
...
export interface PrivateLinkScopeArgs {
     ...
     * Properties that define a Azure Arc PrivateLinkScope resource.
     */
    properties?: pulumi.Input<types.inputs.hybridcompute.v20221227.HybridComputePrivateLinkScopePropertiesArgs>;
    /**

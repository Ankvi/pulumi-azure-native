...
export class Gateway extends pulumi.CustomResource {
     ...
     */
    declare public readonly allowedFeatures: pulumi.Output<string[] | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly gatewayEndpoint: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, args: GatewayArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["allowedFeatures"] = args?.allowedFeatures;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hybridcompute/v20240331preview:Gateway" }, { type: "azure-native:hybridcompute/v20240520preview:Gateway" }, { type: "azure-native:hybridcompute/v20240731preview:Gateway" }, { type: "azure-native:hybridcompute/v20240910preview:Gateway" }, { type: "azure-native:hybridcompute/v20241110preview:Gateway" }, { type: "azure-native:hybridcompute/v20250113:Gateway" }, { type: "azure-native:hybridcompute/v20250219preview:Gateway" }] };

...
export class License extends pulumi.CustomResource {
    ...
    constructor(name: string, args: LicenseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hybridcompute/v20230620preview:License" }, { type: "azure-native:hybridcompute/v20231003preview:License" }, { type: "azure-native:hybridcompute/v20240331preview:License" }, { type: "azure-native:hybridcompute/v20240520preview:License" }, { type: "azure-native:hybridcompute/v20240710:License" }, { type: "azure-native:hybridcompute/v20240731preview:License" }] };

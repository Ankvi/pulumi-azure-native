...
export class LicenseProfile extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly esuKeys: pulumi.Output<types.outputs.EsuKeyResponse[]>;
    /**
     ...
     */
    declare public readonly productFeatures: pulumi.Output<types.outputs.ProductFeatureResponse[] | undefined>;
    /**

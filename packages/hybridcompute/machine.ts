...
export class Machine extends pulumi.CustomResource {
     ...
     */
    public readonly licenseProfile!: pulumi.Output<types.outputs.LicenseProfileMachineInstanceViewResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly networkProfile!: pulumi.Output<types.outputs.NetworkProfileResponse>;
    /**

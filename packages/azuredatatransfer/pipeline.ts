...
export class Pipeline extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.PipelinePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: PipelineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azuredatatransfer/v20231011preview:Pipeline" }, { type: "azure-native:azuredatatransfer/v20240125:Pipeline" }, { type: "azure-native:azuredatatransfer/v20240507:Pipeline" }, { type: "azure-native:azuredatatransfer/v20240911:Pipeline" }] };

...
export class FlowProfile extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.FlowProfilePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: FlowProfileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["flowProfileName"] = args ? args.flowProfileName : undefined;

...
export class Pipeline extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azuredatatransfer/v20231011preview:Pipeline';
    ...
    constructor(name: string, args: PipelineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azuredatatransfer:Pipeline" }, { type: "azure-native:azuredatatransfer/v20240125:Pipeline" }] };

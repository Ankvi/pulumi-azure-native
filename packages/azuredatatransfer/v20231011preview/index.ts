...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:azuredatatransfer/v20231011preview:Connection":
                return new Connection(name, <any>undefined, { urn })
            case "azure-native:azuredatatransfer/v20231011preview:Flow":
                return new Flow(name, <any>undefined, { urn })
            case "azure-native:azuredatatransfer/v20231011preview:Pipeline":
...
pulumi.runtime.registerResourceModule("azure-native", "azuredatatransfer/v20231011preview", _module)
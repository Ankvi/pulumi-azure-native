...
export class Flow extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azuredatatransfer/v20240125:Flow';
    ...
    constructor(name: string, args: FlowArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azuredatatransfer:Flow" }, { type: "azure-native:azuredatatransfer/v20231011preview:Flow" }] };

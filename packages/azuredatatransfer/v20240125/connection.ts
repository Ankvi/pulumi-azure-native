...
export class Connection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:azuredatatransfer/v20240125:Connection';
    ...
    constructor(name: string, args: ConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:azuredatatransfer:Connection" }, { type: "azure-native:azuredatatransfer/v20231011preview:Connection" }] };

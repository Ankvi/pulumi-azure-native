...
export class ADCCatalog extends pulumi.CustomResource {
     ...
     */
    declare public readonly admins: pulumi.Output<types.outputs.PrincipalsResponse[] | undefined>;
    /**
     ...
     */
    declare public readonly users: pulumi.Output<types.outputs.PrincipalsResponse[] | undefined>;

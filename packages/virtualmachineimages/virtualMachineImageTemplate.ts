...
export class VirtualMachineImageTemplate extends pulumi.CustomResource {
     ...
     */
    public readonly autoRun!: pulumi.Output<types.outputs.ImageTemplateAutoRunResponse | undefined>;
    /**
     ...
     */
    public readonly errorHandling!: pulumi.Output<types.outputs.ImageTemplatePropertiesResponseErrorHandling | undefined>;
    /**

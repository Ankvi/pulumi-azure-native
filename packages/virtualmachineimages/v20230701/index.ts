...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:virtualmachineimages/v20230701:Trigger":
                return new Trigger(name, <any>undefined, { urn })
            case "azure-native:virtualmachineimages/v20230701:VirtualMachineImageTemplate":
...
pulumi.runtime.registerResourceModule("azure-native", "virtualmachineimages/v20230701", _module)
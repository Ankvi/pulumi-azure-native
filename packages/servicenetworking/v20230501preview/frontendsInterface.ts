...
export class FrontendsInterface extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:servicenetworking/v20230501preview:FrontendsInterface';
    ...
    constructor(name: string, args: FrontendsInterfaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:servicenetworking:FrontendsInterface" }, { type: "azure-native:servicenetworking/v20221001preview:FrontendsInterface" }, { type: "azure-native:servicenetworking/v20231101:FrontendsInterface" }] };

...
export class AssociationsInterface extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:servicenetworking/v20230501preview:AssociationsInterface';
     ...
     * Association Subnet
     */
    public readonly subnet!: pulumi.Output<types.outputs.servicenetworking.v20230501preview.AssociationSubnetResponse | undefined>;
    /**
    ...
    constructor(name: string, args: AssociationsInterfaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:servicenetworking:AssociationsInterface" }, { type: "azure-native:servicenetworking/v20221001preview:AssociationsInterface" }] };
...
export interface AssociationsInterfaceArgs {
     ...
     * Association Type
     */
    associationType: pulumi.Input<string | types.enums.v20230501preview.AssociationType>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Association Subnet
     */
    subnet?: pulumi.Input<types.inputs.servicenetworking.v20230501preview.AssociationSubnetArgs>;
    /**
     * Resource tags.
     */

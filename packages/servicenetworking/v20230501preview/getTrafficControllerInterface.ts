...
export function getTrafficControllerInterface(args: GetTrafficControllerInterfaceArgs, opts?: pulumi.InvokeOptions): Promise<GetTrafficControllerInterfaceResult> {
    ...
    return pulumi.runtime.invoke("azure-native:servicenetworking/v20230501preview:getTrafficControllerInterface", {
...
export interface GetTrafficControllerInterfaceResult {
     ...
     */
    readonly associations: types.outputs.servicenetworking.v20230501preview.ResourceIdResponse[];
    /**
     ...
     */
    readonly frontends: types.outputs.servicenetworking.v20230501preview.ResourceIdResponse[];
    /**
     ...
     */
    readonly systemData: types.outputs.servicenetworking.v20230501preview.SystemDataResponse;
    /**
     * Resource tags.
     */

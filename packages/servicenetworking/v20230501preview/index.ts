...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:servicenetworking/v20230501preview:AssociationsInterface":
                return new AssociationsInterface(name, <any>undefined, { urn })
            case "azure-native:servicenetworking/v20230501preview:FrontendsInterface":
                return new FrontendsInterface(name, <any>undefined, { urn })
            case "azure-native:servicenetworking/v20230501preview:TrafficControllerInterface":
...
pulumi.runtime.registerResourceModule("azure-native", "servicenetworking/v20230501preview", _module)

...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:servicenetworking/v20231101:AssociationsInterface":
                return new AssociationsInterface(name, <any>undefined, { urn })
            case "azure-native:servicenetworking/v20231101:FrontendsInterface":
                return new FrontendsInterface(name, <any>undefined, { urn })
            case "azure-native:servicenetworking/v20231101:TrafficControllerInterface":
...
pulumi.runtime.registerResourceModule("azure-native", "servicenetworking/v20231101", _module)
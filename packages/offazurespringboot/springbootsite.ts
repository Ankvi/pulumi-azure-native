...
export class Springbootsite extends pulumi.CustomResource {
     ...
     */
    declare public readonly extendedLocation: pulumi.Output<types.outputs.SpringbootsitesModelResponseExtendedLocation | undefined>;
    /**
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.SpringbootsitesPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: SpringbootsiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["springbootsitesName"] = args?.springbootsitesName;

...
export class Springbootserver extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.SpringbootserversPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: SpringbootserverArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["springbootserversName"] = args?.springbootserversName;

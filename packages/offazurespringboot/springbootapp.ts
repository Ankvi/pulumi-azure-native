...
export class Springbootapp extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.SpringbootappsPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: SpringbootappArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["springbootappsName"] = args?.springbootappsName;

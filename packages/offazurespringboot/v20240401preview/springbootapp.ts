...
export class Springbootapp extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:offazurespringboot/v20240401preview:Springbootapp';
    ...
    constructor(name: string, args: SpringbootappArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:offazurespringboot/v20240401preview:springbootapp" }, { type: "azure-native:offazurespringboot:Springbootapp" }, { type: "azure-native:offazurespringboot:springbootapp" }] };

...
export class Springbootserver extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:offazurespringboot/v20240401preview:Springbootserver';
    ...
    constructor(name: string, args: SpringbootserverArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:offazurespringboot/v20240401preview:springbootserver" }, { type: "azure-native:offazurespringboot:Springbootserver" }, { type: "azure-native:offazurespringboot:springbootserver" }, { type: "azure-native:offazurespringboot/v20230101preview:Springbootserver" }, { type: "azure-native:offazurespringboot/v20230101preview:springbootserver" }] };

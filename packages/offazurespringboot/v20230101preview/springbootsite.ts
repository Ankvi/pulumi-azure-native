...
export class Springbootsite extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:offazurespringboot/v20230101preview:Springbootsite';
    ...
    constructor(name: string, args: SpringbootsiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:offazurespringboot/v20230101preview:springbootsite" }, { type: "azure-native:offazurespringboot:Springbootsite" }, { type: "azure-native:offazurespringboot:springbootsite" }, { type: "azure-native:offazurespringboot/v20240401preview:Springbootsite" }, { type: "azure-native:offazurespringboot/v20240401preview:springbootsite" }] };

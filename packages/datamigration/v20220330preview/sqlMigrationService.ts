...
export class SqlMigrationService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:datamigration/v20220330preview:SqlMigrationService';
    ...
    constructor(name: string, args: SqlMigrationServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:datamigration:SqlMigrationService" }, { type: "azure-native:datamigration/v20211030preview:SqlMigrationService" }, { type: "azure-native:datamigration/v20220130preview:SqlMigrationService" }, { type: "azure-native:datamigration/v20230715preview:SqlMigrationService" }] };

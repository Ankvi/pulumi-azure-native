...
export class DatabaseMigrationsMongoToCosmosDbRUMongo extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DatabaseMigrationsMongoToCosmosDbRUMongoArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:datamigration/v20230715preview:DatabaseMigrationsMongoToCosmosDbRUMongo" }, { type: "azure-native:datamigration/v20250315preview:DatabaseMigrationsMongoToCosmosDbRUMongo" }] };

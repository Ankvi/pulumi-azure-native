...
export class File extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:datamigration/v20210630:File';
    ...
    constructor(name: string, args: FileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:datamigration:File" }, { type: "azure-native:datamigration/v20180715preview:File" }, { type: "azure-native:datamigration/v20211030preview:File" }, { type: "azure-native:datamigration/v20220130preview:File" }, { type: "azure-native:datamigration/v20220330preview:File" }] };

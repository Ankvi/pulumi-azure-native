...
export class DatabaseMigrationsMongoToCosmosDbvCoreMongo extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:datamigration/v20230715preview:DatabaseMigrationsMongoToCosmosDbvCoreMongo';
    ...
    constructor(name: string, args: DatabaseMigrationsMongoToCosmosDbvCoreMongoArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:datamigration:DatabaseMigrationsMongoToCosmosDbvCoreMongo" }] };

...
export class DatabaseMigrationsSqlDb extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:datamigration/v20230715preview:DatabaseMigrationsSqlDb';
    ...
    constructor(name: string, args: DatabaseMigrationsSqlDbArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:datamigration:DatabaseMigrationsSqlDb" }, { type: "azure-native:datamigration/v20220330preview:DatabaseMigrationsSqlDb" }] };

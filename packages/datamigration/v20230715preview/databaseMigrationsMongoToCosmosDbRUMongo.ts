...
export class DatabaseMigrationsMongoToCosmosDbRUMongo extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:datamigration/v20230715preview:DatabaseMigrationsMongoToCosmosDbRUMongo';
    ...
    constructor(name: string, args: DatabaseMigrationsMongoToCosmosDbRUMongoArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:datamigration:DatabaseMigrationsMongoToCosmosDbRUMongo" }] };

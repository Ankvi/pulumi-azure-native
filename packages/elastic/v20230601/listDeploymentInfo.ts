...
export function listDeploymentInfo(args: ListDeploymentInfoArgs, opts?: pulumi.InvokeOptions): Promise<ListDeploymentInfoResult> {
    ...
    return pulumi.runtime.invoke("azure-native:elastic/v20230601:listDeploymentInfo", {
...
export interface ListDeploymentInfoResult {
     ...
     */
    readonly marketplaceSaasInfo: types.outputs.elastic.v20230601.MarketplaceSaaSInfoResponse;
    /**

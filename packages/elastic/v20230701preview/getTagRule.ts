...
export function getTagRule(args: GetTagRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetTagRuleResult> {
    ...
    return pulumi.runtime.invoke("azure-native:elastic/v20230701preview:getTagRule", {
...
export interface GetTagRuleResult {
     ...
     */
    readonly properties: types.outputs.elastic.v20230701preview.MonitoringTagRulesPropertiesResponse;
    /**

...
export namespace elastic {
    ...
    export namespace v20230601 {
        ...
        export interface ElasticPropertiesResponse {
             ...
             * Details of the elastic cloud deployment.
             */
            elasticCloudDeployment?: v20230601.ElasticCloudDeploymentResponse;
            /**
             * Details of the user's elastic account.
             */
            elasticCloudUser?: v20230601.ElasticCloudUserResponse;
        }
        ...
        export interface ElasticTrafficFilterResponse {
             ...
             * Rules in the elastic filter
             */
            rules?: v20230601.ElasticTrafficFilterRuleResponse[];
            /**
             * Type of the elastic filter
             */
            type?: string;
        ...
        export interface LogRulesResponse {
             ...
             * List of filtering tags to be used for capturing logs. This only takes effect if SendActivityLogs flag is enabled. If empty, all resources will be captured. If only Exclude action is specified, the rules will apply to the list of all available resources. If Include actions are specified, the rules will only include resources with the associated tags.
             */
            filteringTags?: v20230601.FilteringTagResponse[];
            /**
             * Flag specifying if AAD logs should be sent for the Monitor resource.
             */
            sendAadLogs?: boolean;
        ...
        export interface MarketplaceSaaSInfoResponse {
             ...
             * Marketplace Subscription
             */
            marketplaceSubscription?: v20230601.MarketplaceSaaSInfoResponseMarketplaceSubscription;
        }
        ...
        export interface MonitorPropertiesResponse {
             ...
             * Elastic cloud properties.
             */
            elasticProperties?: v20230601.ElasticPropertiesResponse;
            /**
             * Flag to determine if User API Key has to be generated and shared.
             */
            generateApiKey?: boolean;
        ...
        export interface MonitoringTagRulesPropertiesResponse {
             ...
             * Rules for sending logs.
             */
            logRules?: v20230601.LogRulesResponse;
            /**
             * Provisioning state of the monitoring tag rules.
             */
            provisioningState?: string;
    ...
    export namespace v20230615preview {
        ...
        export interface ElasticOrganizationToAzureSubscriptionMappingResponsePropertiesResponse {
             ...
             * Marketplace SaaS Info of the resource.
             */
            marketplaceSaasInfo: v20230615preview.MarketplaceSaaSInfoResponse;
        }
        ...
        export interface ElasticPropertiesResponse {
             ...
             * Details of the elastic cloud deployment.
             */
            elasticCloudDeployment?: v20230615preview.ElasticCloudDeploymentResponse;
            /**
             * Details of the user's elastic account.
             */
            elasticCloudUser?: v20230615preview.ElasticCloudUserResponse;
        }
        ...
        export interface ElasticTrafficFilterResponse {
             ...
             * Rules in the elastic filter
             */
            rules?: v20230615preview.ElasticTrafficFilterRuleResponse[];
            /**
             * Type of the elastic filter
             */
            type?: string;
        ...
        export interface LogRulesResponse {
             ...
             * List of filtering tags to be used for capturing logs. This only takes effect if SendActivityLogs flag is enabled. If empty, all resources will be captured. If only Exclude action is specified, the rules will apply to the list of all available resources. If Include actions are specified, the rules will only include resources with the associated tags.
             */
            filteringTags?: v20230615preview.FilteringTagResponse[];
            /**
             * Flag specifying if AAD logs should be sent for the Monitor resource.
             */
            sendAadLogs?: boolean;
        ...
        export interface MarketplaceSaaSInfoResponse {
             ...
             * Marketplace Subscription
             */
            marketplaceSubscription?: v20230615preview.MarketplaceSaaSInfoResponseMarketplaceSubscription;
        }
        ...
        export interface MonitorPropertiesResponse {
             ...
             * Elastic cloud properties.
             */
            elasticProperties?: v20230615preview.ElasticPropertiesResponse;
            /**
             * Flag to determine if User API Key has to be generated and shared.
             */
            generateApiKey?: boolean;
        ...
        export interface MonitoringTagRulesPropertiesResponse {
             ...
             * Rules for sending logs.
             */
            logRules?: v20230615preview.LogRulesResponse;
            /**
             * Provisioning state of the monitoring tag rules.
             */
            provisioningState?: string;
    ...
    export namespace v20230701preview {
        ...
        export interface ConnectedPartnerResourcesListFormatResponse {
             ...
             * Connected Partner Resource Properties
             */
            properties?: v20230701preview.ConnectedPartnerResourcePropertiesResponse;
        }
        ...
        export interface ElasticOrganizationToAzureSubscriptionMappingResponsePropertiesResponse {
             ...
             * Marketplace SaaS Info of the resource.
             */
            marketplaceSaasInfo: v20230701preview.MarketplaceSaaSInfoResponse;
        }
        ...
        export interface ElasticPropertiesResponse {
             ...
             * Details of the elastic cloud deployment.
             */
            elasticCloudDeployment?: v20230701preview.ElasticCloudDeploymentResponse;
            /**
             * Details of the user's elastic account.
             */
            elasticCloudUser?: v20230701preview.ElasticCloudUserResponse;
        }
        ...
        export interface ElasticTrafficFilterResponse {
             ...
             * Rules in the elastic filter
             */
            rules?: v20230701preview.ElasticTrafficFilterRuleResponse[];
            /**
             * Type of the elastic filter
             */
            type?: string;
        ...
        export interface LogRulesResponse {
             ...
             * List of filtering tags to be used for capturing logs. This only takes effect if SendActivityLogs flag is enabled. If empty, all resources will be captured. If only Exclude action is specified, the rules will apply to the list of all available resources. If Include actions are specified, the rules will only include resources with the associated tags.
             */
            filteringTags?: v20230701preview.FilteringTagResponse[];
            /**
             * Flag specifying if AAD logs should be sent for the Monitor resource.
             */
            sendAadLogs?: boolean;
        ...
        export interface MarketplaceSaaSInfoResponse {
             ...
             * Marketplace Subscription
             */
            marketplaceSubscription?: v20230701preview.MarketplaceSaaSInfoResponseMarketplaceSubscription;
            /**
             * Flag specifying if the Marketplace status is subscribed or not.
             */
            subscribed?: boolean;
        ...
        export interface MonitorPropertiesResponse {
             ...
             * Elastic cloud properties.
             */
            elasticProperties?: v20230701preview.ElasticPropertiesResponse;
            /**
             * Flag to determine if User API Key has to be generated and shared.
             */
            generateApiKey?: boolean;
        ...
        export interface MonitoringTagRulesPropertiesResponse {
             ...
             * Rules for sending logs.
             */
            logRules?: v20230701preview.LogRulesResponse;
            /**
             * Provisioning state of the monitoring tag rules.
             */
            provisioningState?: string;

...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:elastic/v20240101preview:Monitor":
                return new Monitor(name, <any>undefined, { urn })
            case "azure-native:elastic/v20240101preview:OpenAI":
                return new OpenAI(name, <any>undefined, { urn })
            case "azure-native:elastic/v20240101preview:TagRule":
...
pulumi.runtime.registerResourceModule("azure-native", "elastic/v20240101preview", _module)
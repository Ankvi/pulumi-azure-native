...
export class OpenAI extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:elastic/v20240101preview:OpenAI';
    ...
    constructor(name: string, args: OpenAIArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:elastic:OpenAI" }, { type: "azure-native:elastic/v20240301:OpenAI" }] };

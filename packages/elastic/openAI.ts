...
export class OpenAI extends pulumi.CustomResource {
    ...
    constructor(name: string, args: OpenAIArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:elastic/v20240101preview:OpenAI" }, { type: "azure-native:elastic/v20240301:OpenAI" }, { type: "azure-native:elastic/v20240501preview:OpenAI" }, { type: "azure-native:elastic/v20240615preview:OpenAI" }] };

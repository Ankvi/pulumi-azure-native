...
export function listAllTrafficFilter(args: ListAllTrafficFilterArgs, opts?: pulumi.InvokeOptions): Promise<ListAllTrafficFilterResult> {
    ...
    return pulumi.runtime.invoke("azure-native:elastic/v20230615preview:listAllTrafficFilter", {
...
export interface ListAllTrafficFilterResult {
     ...
     * List of elastic traffic filters in the account
     */
    readonly rulesets?: types.outputs.elastic.v20230615preview.ElasticTrafficFilterResponse[];
}
/**
 * List of elastic traffic filters in the account
 */

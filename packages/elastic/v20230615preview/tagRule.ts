...
export class TagRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:elastic/v20230615preview:TagRule';
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.elastic.v20230615preview.MonitoringTagRulesPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: TagRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:elastic:TagRule" }, { type: "azure-native:elastic/v20200701:TagRule" }, { type: "azure-native:elastic/v20200701preview:TagRule" }, { type: "azure-native:elastic/v20210901preview:TagRule" }, { type: "azure-native:elastic/v20211001preview:TagRule" }, { type: "azure-native:elastic/v20220505preview:TagRule" }, { type: "azure-native:elastic/v20220701preview:TagRule" }, { type: "azure-native:elastic/v20220901preview:TagRule" }, { type: "azure-native:elastic/v20230201preview:TagRule" }, { type: "azure-native:elastic/v20230501preview:TagRule" }, { type: "azure-native:elastic/v20230601:TagRule" }, { type: "azure-native:elastic/v20230701preview:TagRule" }] };
...
export interface TagRuleArgs {
     ...
     * Properties of the monitoring tag rules.
     */
    properties?: pulumi.Input<types.inputs.elastic.v20230615preview.MonitoringTagRulesPropertiesArgs>;
    /**

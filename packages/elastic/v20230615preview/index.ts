...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:elastic/v20230615preview:Monitor":
                return new Monitor(name, <any>undefined, { urn })
            case "azure-native:elastic/v20230615preview:TagRule":
...
pulumi.runtime.registerResourceModule("azure-native", "elastic/v20230615preview", _module)

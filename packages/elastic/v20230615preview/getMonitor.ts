...
export function getMonitor(args: GetMonitorArgs, opts?: pulumi.InvokeOptions): Promise<GetMonitorResult> {
    ...
    return pulumi.runtime.invoke("azure-native:elastic/v20230615preview:getMonitor", {
...
export interface GetMonitorResult {
     ...
     */
    readonly identity?: types.outputs.elastic.v20230615preview.IdentityPropertiesResponse;
    /**
     ...
     */
    readonly properties: types.outputs.elastic.v20230615preview.MonitorPropertiesResponse;
    /**
     * SKU of the monitor resource.
     */
    readonly sku?: types.outputs.elastic.v20230615preview.ResourceSkuResponse;
    /**

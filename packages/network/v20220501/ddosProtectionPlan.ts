...
export class DdosProtectionPlan extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220501:DdosProtectionPlan';
     ...
     */
    public /*out*/ readonly publicIpAddresses!: pulumi.Output<types.outputs.network.v20220501.SubResourceResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly virtualNetworks!: pulumi.Output<types.outputs.network.v20220501.SubResourceResponse[]>;

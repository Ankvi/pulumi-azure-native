...
export interface GetDdosProtectionPlanResult {
     ...
     */
    readonly publicIpAddresses: types.outputs.network.v20220501.SubResourceResponse[];
    /**
     ...
     */
    readonly virtualNetworks: types.outputs.network.v20220501.SubResourceResponse[];
}
/**
 * Gets information about the specified DDoS protection plan.
 */

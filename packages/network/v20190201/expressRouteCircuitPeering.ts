...
export class ExpressRouteCircuitPeering extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20190201:ExpressRouteCircuitPeering';
     ...
     */
    public readonly connections!: pulumi.Output<types.outputs.network.v20190201.ExpressRouteCircuitConnectionResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly expressRouteConnection!: pulumi.Output<types.outputs.network.v20190201.ExpressRouteConnectionIdResponse | undefined>;
    /**
     ...
     */
    public readonly ipv6PeeringConfig!: pulumi.Output<types.outputs.network.v20190201.Ipv6ExpressRouteCircuitPeeringConfigResponse | undefined>;
    /**
     ...
     */
    public readonly microsoftPeeringConfig!: pulumi.Output<types.outputs.network.v20190201.ExpressRouteCircuitPeeringConfigResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly peeredConnections!: pulumi.Output<types.outputs.network.v20190201.PeerExpressRouteCircuitConnectionResponse[]>;
    /**
     * The peering type.
     */
     ...
     */
    public readonly routeFilter!: pulumi.Output<types.outputs.network.v20190201.RouteFilterResponse | undefined>;
    /**
     * The secondary port.
     */
     ...
     * Gets peering stats.
     */
    public readonly stats!: pulumi.Output<types.outputs.network.v20190201.ExpressRouteCircuitStatsResponse | undefined>;
    /**
     * The VLAN ID.
     */
...
export interface ExpressRouteCircuitPeeringArgs {
     ...
     * The list of circuit connections associated with Azure Private Peering for this circuit.
     */
    connections?: pulumi.Input<pulumi.Input<types.inputs.network.v20190201.ExpressRouteCircuitConnectionArgs>[]>;
    /**
     * The GatewayManager Etag.
     */
     ...
     * The IPv6 peering configuration.
     */
    ipv6PeeringConfig?: pulumi.Input<types.inputs.network.v20190201.Ipv6ExpressRouteCircuitPeeringConfigArgs>;
    /**
     * Gets whether the provider or the customer last modified the peering.
     */
     ...
     * The Microsoft peering configuration.
     */
    microsoftPeeringConfig?: pulumi.Input<types.inputs.network.v20190201.ExpressRouteCircuitPeeringConfigArgs>;
    /**
     * Gets name of the resource that is unique within a resource group. This name can be used to access the resource.
     */
     ...
     * The peering type.
     */
    peeringType?: pulumi.Input<string | types.enums.v20190201.ExpressRoutePeeringType>;
    /**
     * The primary port.
     */
     ...
     * The reference of the RouteFilter resource.
     */
    routeFilter?: pulumi.Input<types.inputs.network.v20190201.RouteFilterArgs>;
    /**
     * The secondary port.
     */
     ...
     * The peering state.
     */
    state?: pulumi.Input<string | types.enums.v20190201.ExpressRoutePeeringState>;
    /**
     * Gets peering stats.
     */
    stats?: pulumi.Input<types.inputs.network.v20190201.ExpressRouteCircuitStatsArgs>;
    /**
     * The VLAN ID.
     */

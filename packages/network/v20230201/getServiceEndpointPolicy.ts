...
export function getServiceEndpointPolicy(args: GetServiceEndpointPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetServiceEndpointPolicyResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230201:getServiceEndpointPolicy", {
        "expand": args.expand,
...
export interface GetServiceEndpointPolicyResult {
     ...
     */
    readonly serviceEndpointPolicyDefinitions?: types.outputs.network.v20230201.ServiceEndpointPolicyDefinitionResponse[];
    /**

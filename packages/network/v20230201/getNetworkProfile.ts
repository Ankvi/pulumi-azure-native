...
export function getNetworkProfile(args: GetNetworkProfileArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkProfileResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230201:getNetworkProfile", {
        "expand": args.expand,
...
export interface GetNetworkProfileResult {
     ...
     */
    readonly containerNetworkInterfaceConfigurations?: types.outputs.network.v20230201.ContainerNetworkInterfaceConfigurationResponse[];
    /**
     * List of child container network interfaces.
     */
    readonly containerNetworkInterfaces: types.outputs.network.v20230201.ContainerNetworkInterfaceResponse[];
    /**

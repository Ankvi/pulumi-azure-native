...
export function getNetworkSecurityGroup(args: GetNetworkSecurityGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkSecurityGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230201:getNetworkSecurityGroup", {
        "expand": args.expand,
...
export interface GetNetworkSecurityGroupResult {
     ...
     */
    readonly defaultSecurityRules: types.outputs.network.v20230201.SecurityRuleResponse[];
    /**
     ...
     */
    readonly securityRules?: types.outputs.network.v20230201.SecurityRuleResponse[];
    /**

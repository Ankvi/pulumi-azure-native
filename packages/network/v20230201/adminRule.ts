...
export class AdminRule extends pulumi.CustomResource {
     ...
     */
    public readonly destinations!: pulumi.Output<types.outputs.network.v20230201.AddressPrefixItemResponse[] | undefined>;
    /**
     ...
     */
    public readonly sources!: pulumi.Output<types.outputs.network.v20230201.AddressPrefixItemResponse[] | undefined>;
    /**
...
export interface AdminRuleArgs {
     ...
     * Indicates the access allowed for this particular rule
     */
    access: pulumi.Input<string | types.enums.v20230201.SecurityConfigurationRuleAccess>;
    /**
     ...
     * The destination address prefixes. CIDR or destination IP ranges.
     */
    destinations?: pulumi.Input<pulumi.Input<types.inputs.network.v20230201.AddressPrefixItemArgs>[]>;
    /**
     * Indicates if the traffic matched against the rule in inbound or outbound.
     */
    direction: pulumi.Input<string | types.enums.v20230201.SecurityConfigurationRuleDirection>;
    /**
     * Whether the rule is custom or default.
     * Expected value is 'Custom'.
     */
     ...
     * Network protocol this rule applies to.
     */
    protocol: pulumi.Input<string | types.enums.v20230201.SecurityConfigurationRuleProtocol>;
    /**
     ...
     * The CIDR or source IP ranges.
     */
    sources?: pulumi.Input<pulumi.Input<types.inputs.network.v20230201.AddressPrefixItemArgs>[]>;
}

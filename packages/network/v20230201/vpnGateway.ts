...
export class VpnGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230201:VpnGateway';
     ...
     */
    public readonly connections!: pulumi.Output<types.outputs.network.v20230201.VpnConnectionResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly ipConfigurations!: pulumi.Output<types.outputs.network.v20230201.VpnGatewayIpConfigurationResponse[]>;
    /**
     ...
     */
    public readonly natRules!: pulumi.Output<types.outputs.network.v20230201.VpnGatewayNatRuleResponse[] | undefined>;
    /**
...
export interface VpnGatewayArgs {
     ...
     * List of all vpn connections to the gateway.
     */
    connections?: pulumi.Input<pulumi.Input<types.inputs.network.v20230201.VpnConnectionArgs>[]>;
    /**
     * Enable BGP routes translation for NAT on this VpnGateway.
     */
     ...
     * List of all the nat Rules associated with the gateway.
     */
    natRules?: pulumi.Input<pulumi.Input<types.inputs.network.v20230201.VpnGatewayNatRuleArgs>[]>;
    /**

...
export class Subnet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230201:Subnet';
     ...
     */
    public readonly applicationGatewayIPConfigurations!: pulumi.Output<types.outputs.network.v20230201.ApplicationGatewayIPConfigurationResponse[] | undefined>;
    /**
     * An array of references to the delegations on the subnet.
     */
    public readonly delegations!: pulumi.Output<types.outputs.network.v20230201.DelegationResponse[] | undefined>;
    /**
     ...
     */
    public readonly ipAllocations!: pulumi.Output<types.outputs.network.v20230201.SubResourceResponse[] | undefined>;
    /**
     * Array of IP configuration profiles which reference this subnet.
     */
    public /*out*/ readonly ipConfigurationProfiles!: pulumi.Output<types.outputs.network.v20230201.IPConfigurationProfileResponse[]>;
    /**
     * An array of references to the network interface IP configurations using subnet.
     */
    public /*out*/ readonly ipConfigurations!: pulumi.Output<types.outputs.network.v20230201.IPConfigurationResponse[]>;
    /**
     ...
     */
    public readonly natGateway!: pulumi.Output<types.outputs.network.v20230201.SubResourceResponse | undefined>;
    /**
     * The reference to the NetworkSecurityGroup resource.
     */
    public readonly networkSecurityGroup!: pulumi.Output<types.outputs.network.v20230201.NetworkSecurityGroupResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpoints!: pulumi.Output<types.outputs.network.v20230201.PrivateEndpointResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly resourceNavigationLinks!: pulumi.Output<types.outputs.network.v20230201.ResourceNavigationLinkResponse[]>;
    /**
     * The reference to the RouteTable resource.
     */
    public readonly routeTable!: pulumi.Output<types.outputs.network.v20230201.RouteTableResponse | undefined>;
    /**
     * An array of references to services injecting into this subnet.
     */
    public /*out*/ readonly serviceAssociationLinks!: pulumi.Output<types.outputs.network.v20230201.ServiceAssociationLinkResponse[]>;
    /**
     * An array of service endpoint policies.
     */
    public readonly serviceEndpointPolicies!: pulumi.Output<types.outputs.network.v20230201.ServiceEndpointPolicyResponse[] | undefined>;
    /**
     * An array of service endpoints.
     */
    public readonly serviceEndpoints!: pulumi.Output<types.outputs.network.v20230201.ServiceEndpointPropertiesFormatResponse[] | undefined>;
    /**
     * Resource type.
     */
...
export interface SubnetArgs {
     ...
     * Application gateway IP configurations of virtual network resource.
     */
    applicationGatewayIPConfigurations?: pulumi.Input<pulumi.Input<types.inputs.network.v20230201.ApplicationGatewayIPConfigurationArgs>[]>;
    /**
     * An array of references to the delegations on the subnet.
     */
    delegations?: pulumi.Input<pulumi.Input<types.inputs.network.v20230201.DelegationArgs>[]>;
    /**
     * Resource ID.
     */
     ...
     * Array of IpAllocation which reference this subnet.
     */
    ipAllocations?: pulumi.Input<pulumi.Input<types.inputs.network.v20230201.SubResourceArgs>[]>;
    /**
     * The name of the resource that is unique within a resource group. This name can be used to access the resource.
     */
     ...
     * Nat gateway associated with this subnet.
     */
    natGateway?: pulumi.Input<types.inputs.network.v20230201.SubResourceArgs>;
    /**
     * The reference to the NetworkSecurityGroup resource.
     */
    networkSecurityGroup?: pulumi.Input<types.inputs.network.v20230201.NetworkSecurityGroupArgs>;
    /**
     * Enable or Disable apply network policies on private end point in the subnet.
     */
    privateEndpointNetworkPolicies?: pulumi.Input<string | types.enums.v20230201.VirtualNetworkPrivateEndpointNetworkPolicies>;
    /**
     * Enable or Disable apply network policies on private link service in the subnet.
     */
    privateLinkServiceNetworkPolicies?: pulumi.Input<string | types.enums.v20230201.VirtualNetworkPrivateLinkServiceNetworkPolicies>;
    /**
     ...
     * The reference to the RouteTable resource.
     */
    routeTable?: pulumi.Input<types.inputs.network.v20230201.RouteTableArgs>;
    /**
     * An array of service endpoint policies.
     */
    serviceEndpointPolicies?: pulumi.Input<pulumi.Input<types.inputs.network.v20230201.ServiceEndpointPolicyArgs>[]>;
    /**
     * An array of service endpoints.
     */
    serviceEndpoints?: pulumi.Input<pulumi.Input<types.inputs.network.v20230201.ServiceEndpointPropertiesFormatArgs>[]>;
    /**

...
export class ExpressRouteConnection extends pulumi.CustomResource {
     ...
     */
    public readonly expressRouteCircuitPeering!: pulumi.Output<types.outputs.network.v20230201.ExpressRouteCircuitPeeringIdResponse>;
    /**
...
export interface ExpressRouteConnectionArgs {
     ...
     * The ExpressRoute circuit peering.
     */
    expressRouteCircuitPeering: pulumi.Input<types.inputs.network.v20230201.ExpressRouteCircuitPeeringIdArgs>;
    /**
     * Enable FastPath to vWan Firewall hub.
     */

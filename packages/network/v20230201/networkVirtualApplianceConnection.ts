...
export class NetworkVirtualApplianceConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230201:NetworkVirtualApplianceConnection';
     ...
     */
    public readonly routingConfiguration!: pulumi.Output<types.outputs.network.v20230201.RoutingConfigurationNfvResponse | undefined>;
    /**
    ...
    constructor(name: string, args: NetworkVirtualApplianceConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:NetworkVirtualApplianceConnection" }, { type: "azure-native:network/v20221101:NetworkVirtualApplianceConnection" }, { type: "azure-native:network/v20230401:NetworkVirtualApplianceConnection" }, { type: "azure-native:network/v20230501:NetworkVirtualApplianceConnection" }] };
...
export interface NetworkVirtualApplianceConnectionArgs {
     ...
     * The Routing Configuration indicating the associated and propagated route tables on this connection.
     */
    routingConfiguration?: pulumi.Input<types.inputs.network.v20230201.RoutingConfigurationNfvArgs>;
    /**
     * Unique identifier for the connection.
     */

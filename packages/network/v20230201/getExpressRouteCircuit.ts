...
export function getExpressRouteCircuit(args: GetExpressRouteCircuitArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRouteCircuitResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230201:getExpressRouteCircuit", {
...
export interface GetExpressRouteCircuitResult {
     ...
     */
    readonly authorizations?: types.outputs.network.v20230201.ExpressRouteCircuitAuthorizationResponse[];
    /**
     ...
     */
    readonly expressRoutePort?: types.outputs.network.v20230201.SubResourceResponse;
    /**
     ...
     */
    readonly peerings?: types.outputs.network.v20230201.ExpressRouteCircuitPeeringResponse[];
    /**
     ...
     */
    readonly serviceProviderProperties?: types.outputs.network.v20230201.ExpressRouteCircuitServiceProviderPropertiesResponse;
    /**
     ...
     * The SKU.
     */
    readonly sku?: types.outputs.network.v20230201.ExpressRouteCircuitSkuResponse;
    /**

...
export function getVirtualRouter(args: GetVirtualRouterArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualRouterResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230201:getVirtualRouter", {
        "expand": args.expand,
...
export interface GetVirtualRouterResult {
     ...
     */
    readonly hostedGateway?: types.outputs.network.v20230201.SubResourceResponse;
    /**
     * The Subnet on which VirtualRouter is hosted.
     */
    readonly hostedSubnet?: types.outputs.network.v20230201.SubResourceResponse;
    /**
     * Resource ID.
     */
    readonly id?: string;
     ...
     */
    readonly peerings: types.outputs.network.v20230201.SubResourceResponse[];
    /**

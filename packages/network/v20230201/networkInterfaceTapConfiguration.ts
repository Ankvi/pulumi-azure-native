...
export class NetworkInterfaceTapConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230201:NetworkInterfaceTapConfiguration';
     ...
     */
    public readonly virtualNetworkTap!: pulumi.Output<types.outputs.network.v20230201.VirtualNetworkTapResponse | undefined>;
    ...
    constructor(name: string, args: NetworkInterfaceTapConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["virtualNetworkTap"] = args ? (args.virtualNetworkTap ? pulumi.output(args.virtualNetworkTap).apply(types.inputs.network.v20230201.virtualNetworkTapArgsProvideDefaults) : undefined) : undefined;
...
export interface NetworkInterfaceTapConfigurationArgs {
     ...
     * The reference to the Virtual Network Tap resource.
     */
    virtualNetworkTap?: pulumi.Input<types.inputs.network.v20230201.VirtualNetworkTapArgs>;
}

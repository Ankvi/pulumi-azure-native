...
export class PublicIPPrefix extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230201:PublicIPPrefix';
     ...
     */
    public readonly customIPPrefix!: pulumi.Output<types.outputs.network.v20230201.SubResourceResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly loadBalancerFrontendIpConfiguration!: pulumi.Output<types.outputs.network.v20230201.SubResourceResponse>;
    /**
     * Resource location.
     */
     ...
     */
    public /*out*/ readonly publicIPAddresses!: pulumi.Output<types.outputs.network.v20230201.ReferencedPublicIpAddressResponse[]>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<types.outputs.network.v20230201.PublicIPPrefixSkuResponse | undefined>;
    /**
     * Resource tags.
     */
...
export interface PublicIPPrefixArgs {
     ...
     * The customIpPrefix that this prefix is associated with.
     */
    customIPPrefix?: pulumi.Input<types.inputs.network.v20230201.SubResourceArgs>;
    /**
     * The extended location of the public ip address.
     */
     ...
     * The public IP prefix SKU.
     */
    sku?: pulumi.Input<types.inputs.network.v20230201.PublicIPPrefixSkuArgs>;
    /**
     * Resource tags.
     */

...
export function getVirtualNetworkGateway(args: GetVirtualNetworkGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkGatewayResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230201:getVirtualNetworkGateway", {
...
export interface GetVirtualNetworkGatewayResult {
     ...
     */
    readonly customRoutes?: types.outputs.network.v20230201.AddressSpaceResponse;
    /**
     ...
     */
    readonly gatewayDefaultSite?: types.outputs.network.v20230201.SubResourceResponse;
    /**
     ...
     */
    readonly ipConfigurations?: types.outputs.network.v20230201.VirtualNetworkGatewayIPConfigurationResponse[];
    /**
     * Resource location.
     */
     ...
     */
    readonly natRules?: types.outputs.network.v20230201.VirtualNetworkGatewayNatRuleResponse[];
    /**
     ...
     */
    readonly sku?: types.outputs.network.v20230201.VirtualNetworkGatewaySkuResponse;
    /**
     * Resource tags.
     */
     ...
     */
    readonly virtualNetworkGatewayPolicyGroups?: types.outputs.network.v20230201.VirtualNetworkGatewayPolicyGroupResponse[];
    /**
     * The reference to the VpnClientConfiguration resource which represents the P2S VpnClient configurations.
     */
    readonly vpnClientConfiguration?: types.outputs.network.v20230201.VpnClientConfigurationResponse;
    /**

...
export class FirewallPolicyRuleCollectionGroup extends pulumi.CustomResource {
     ...
     */
    public readonly ruleCollections!: pulumi.Output<(types.outputs.network.v20230201.FirewallPolicyFilterRuleCollectionResponse | types.outputs.network.v20230201.FirewallPolicyNatRuleCollectionResponse)[] | undefined>;
    /**
     * Rule Group type.
     */
...
export interface FirewallPolicyRuleCollectionGroupArgs {
     ...
     * Group of Firewall Policy rule collections.
     */
    ruleCollections?: pulumi.Input<pulumi.Input<types.inputs.network.v20230201.FirewallPolicyFilterRuleCollectionArgs | types.inputs.network.v20230201.FirewallPolicyNatRuleCollectionArgs>[]>;
}

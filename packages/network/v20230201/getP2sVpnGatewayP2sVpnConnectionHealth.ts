...
export function getP2sVpnGatewayP2sVpnConnectionHealth(args: GetP2sVpnGatewayP2sVpnConnectionHealthArgs, opts?: pulumi.InvokeOptions): Promise<GetP2sVpnGatewayP2sVpnConnectionHealthResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230201:getP2sVpnGatewayP2sVpnConnectionHealth", {
...
export interface GetP2sVpnGatewayP2sVpnConnectionHealthResult {
     ...
     */
    readonly p2SConnectionConfigurations?: types.outputs.network.v20230201.P2SConnectionConfigurationResponse[];
    /**
     ...
     */
    readonly vpnClientConnectionHealth: types.outputs.network.v20230201.VpnClientConnectionHealthResponse;
    /**
     ...
     */
    readonly vpnServerConfiguration?: types.outputs.network.v20230201.SubResourceResponse;
}
/**
 * Gets the connection health of P2S clients of the virtual wan P2SVpnGateway in the specified resource group.
 */

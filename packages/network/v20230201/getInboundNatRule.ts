...
export function getInboundNatRule(args: GetInboundNatRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetInboundNatRuleResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230201:getInboundNatRule", {
        "expand": args.expand,
...
export interface GetInboundNatRuleResult {
     ...
     */
    readonly backendAddressPool?: types.outputs.network.v20230201.SubResourceResponse;
    /**
     * A reference to a private IP address defined on a network interface of a VM. Traffic sent to the frontend port of each of the frontend IP configurations is forwarded to the backend IP.
     */
    readonly backendIPConfiguration: types.outputs.network.v20230201.NetworkInterfaceIPConfigurationResponse;
    /**
     ...
     */
    readonly frontendIPConfiguration?: types.outputs.network.v20230201.SubResourceResponse;
    /**

...
export function getNatRule(args: GetNatRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetNatRuleResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230201:getNatRule", {
...
export interface GetNatRuleResult {
     ...
     */
    readonly egressVpnSiteLinkConnections: types.outputs.network.v20230201.SubResourceResponse[];
    /**
     ...
     */
    readonly externalMappings?: types.outputs.network.v20230201.VpnNatRuleMappingResponse[];
    /**
     * Resource ID.
     */
    readonly id?: string;
     ...
     */
    readonly ingressVpnSiteLinkConnections: types.outputs.network.v20230201.SubResourceResponse[];
    /**
     * The private IP address internal mapping for NAT.
     */
    readonly internalMappings?: types.outputs.network.v20230201.VpnNatRuleMappingResponse[];
    /**

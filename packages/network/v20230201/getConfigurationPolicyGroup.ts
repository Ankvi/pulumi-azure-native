...
export function getConfigurationPolicyGroup(args: GetConfigurationPolicyGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetConfigurationPolicyGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230201:getConfigurationPolicyGroup", {
...
export interface GetConfigurationPolicyGroupResult {
     ...
     */
    readonly p2SConnectionConfigurations: types.outputs.network.v20230201.SubResourceResponse[];
    /**
     * Multiple PolicyMembers for VpnServerConfigurationPolicyGroup.
     */
    readonly policyMembers?: types.outputs.network.v20230201.VpnServerConfigurationPolicyGroupMemberResponse[];
    /**

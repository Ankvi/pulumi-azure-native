...
export function getDefaultAdminRule(args: GetDefaultAdminRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetDefaultAdminRuleResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230201:getDefaultAdminRule", {
...
export interface GetDefaultAdminRuleResult {
     ...
     */
    readonly destinations: types.outputs.network.v20230201.AddressPrefixItemResponse[];
    /**
     ...
     */
    readonly sources: types.outputs.network.v20230201.AddressPrefixItemResponse[];
    /**

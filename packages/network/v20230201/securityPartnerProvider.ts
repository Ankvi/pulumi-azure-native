...
export class SecurityPartnerProvider extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230201:SecurityPartnerProvider';
...
export interface SecurityPartnerProviderArgs {
     ...
     * The security provider name.
     */
    securityProviderName?: pulumi.Input<string | types.enums.v20230201.SecurityProviderName>;
    /**
     * Resource tags.
     */

...
export class VirtualNetworkGatewayConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230201:VirtualNetworkGatewayConnection';
     ...
     */
    public readonly egressNatRules!: pulumi.Output<types.outputs.network.v20230201.SubResourceResponse[] | undefined>;
    /**
     * EnableBgp flag.
     */
     ...
     */
    public readonly gatewayCustomBgpIpAddresses!: pulumi.Output<types.outputs.network.v20230201.GatewayCustomBgpIpAddressIpConfigurationResponse[] | undefined>;
    /**
     ...
     */
    public readonly ingressNatRules!: pulumi.Output<types.outputs.network.v20230201.SubResourceResponse[] | undefined>;
    /**
     * The IPSec Policies to be considered by this connection.
     */
    public readonly ipsecPolicies!: pulumi.Output<types.outputs.network.v20230201.IpsecPolicyResponse[] | undefined>;
    /**
     * The reference to local network gateway resource.
     */
    public readonly localNetworkGateway2!: pulumi.Output<types.outputs.network.v20230201.LocalNetworkGatewayResponse | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly peer!: pulumi.Output<types.outputs.network.v20230201.SubResourceResponse | undefined>;
    /**
     ...
     */
    public readonly trafficSelectorPolicies!: pulumi.Output<types.outputs.network.v20230201.TrafficSelectorPolicyResponse[] | undefined>;
    /**
     * Collection of all tunnels' connection health status.
     */
    public /*out*/ readonly tunnelConnectionStatus!: pulumi.Output<types.outputs.network.v20230201.TunnelConnectionHealthResponse[]>;
    /**
     * Resource type.
     */
     ...
     */
    public readonly virtualNetworkGateway1!: pulumi.Output<types.outputs.network.v20230201.VirtualNetworkGatewayResponse>;
    /**
     * The reference to virtual network gateway resource.
     */
    public readonly virtualNetworkGateway2!: pulumi.Output<types.outputs.network.v20230201.VirtualNetworkGatewayResponse | undefined>;
...
export interface VirtualNetworkGatewayConnectionArgs {
     ...
     * The connection mode for this connection.
     */
    connectionMode?: pulumi.Input<string | types.enums.v20230201.VirtualNetworkGatewayConnectionMode>;
    /**
     * Connection protocol used for this connection.
     */
    connectionProtocol?: pulumi.Input<string | types.enums.v20230201.VirtualNetworkGatewayConnectionProtocol>;
    /**
     * Gateway connection type.
     */
    connectionType: pulumi.Input<string | types.enums.v20230201.VirtualNetworkGatewayConnectionType>;
    /**
     * The dead peer detection timeout of this connection in seconds.
     */
     ...
     * List of egress NatRules.
     */
    egressNatRules?: pulumi.Input<pulumi.Input<types.inputs.network.v20230201.SubResourceArgs>[]>;
    /**
     * EnableBgp flag.
     */
     ...
     * GatewayCustomBgpIpAddresses to be used for virtual network gateway Connection.
     */
    gatewayCustomBgpIpAddresses?: pulumi.Input<pulumi.Input<types.inputs.network.v20230201.GatewayCustomBgpIpAddressIpConfigurationArgs>[]>;
    /**
     * Resource ID.
     */
     ...
     * List of ingress NatRules.
     */
    ingressNatRules?: pulumi.Input<pulumi.Input<types.inputs.network.v20230201.SubResourceArgs>[]>;
    /**
     * The IPSec Policies to be considered by this connection.
     */
    ipsecPolicies?: pulumi.Input<pulumi.Input<types.inputs.network.v20230201.IpsecPolicyArgs>[]>;
    /**
     * The reference to local network gateway resource.
     */
    localNetworkGateway2?: pulumi.Input<types.inputs.network.v20230201.LocalNetworkGatewayArgs>;
    /**
     * Resource location.
     */
     ...
     * The reference to peerings resource.
     */
    peer?: pulumi.Input<types.inputs.network.v20230201.SubResourceArgs>;
    /**
     ...
     * The Traffic Selector Policies to be considered by this connection.
     */
    trafficSelectorPolicies?: pulumi.Input<pulumi.Input<types.inputs.network.v20230201.TrafficSelectorPolicyArgs>[]>;
    /**
     * Use private local Azure IP for the connection.
     */
     ...
     * The reference to virtual network gateway resource.
     */
    virtualNetworkGateway1: pulumi.Input<types.inputs.network.v20230201.VirtualNetworkGatewayArgs>;
    /**
     * The reference to virtual network gateway resource.
     */
    virtualNetworkGateway2?: pulumi.Input<types.inputs.network.v20230201.VirtualNetworkGatewayArgs>;
    /**

...
export class RouteMap extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230201:RouteMap';
     ...
     */
    public readonly rules!: pulumi.Output<types.outputs.network.v20230201.RouteMapRuleResponse[] | undefined>;
    /**
     * Resource type.
     */
...
export interface RouteMapArgs {
     ...
     * List of RouteMap rules to be applied.
     */
    rules?: pulumi.Input<pulumi.Input<types.inputs.network.v20230201.RouteMapRuleArgs>[]>;
    /**

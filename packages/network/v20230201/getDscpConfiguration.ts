...
export function getDscpConfiguration(args: GetDscpConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetDscpConfigurationResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230201:getDscpConfiguration", {
...
export interface GetDscpConfigurationResult {
     ...
     */
    readonly associatedNetworkInterfaces: types.outputs.network.v20230201.NetworkInterfaceResponse[];
    /**
     * Destination IP ranges.
     */
    readonly destinationIpRanges?: types.outputs.network.v20230201.QosIpRangeResponse[];
    /**
     * Destination port ranges.
     */
    readonly destinationPortRanges?: types.outputs.network.v20230201.QosPortRangeResponse[];
    /**
     ...
     */
    readonly qosDefinitionCollection?: types.outputs.network.v20230201.QosDefinitionResponse[];
    /**
     ...
     * Source IP ranges.
     */
    readonly sourceIpRanges?: types.outputs.network.v20230201.QosIpRangeResponse[];
    /**
     * Sources port ranges.
     */
    readonly sourcePortRanges?: types.outputs.network.v20230201.QosPortRangeResponse[];
    /**
     * Resource tags.
     */

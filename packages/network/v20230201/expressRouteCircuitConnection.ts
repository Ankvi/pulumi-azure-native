...
export class ExpressRouteCircuitConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230201:ExpressRouteCircuitConnection';

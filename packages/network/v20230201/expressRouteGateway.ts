...
export class ExpressRouteGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230201:ExpressRouteGateway';
     ...
     */
    public readonly autoScaleConfiguration!: pulumi.Output<types.outputs.network.v20230201.ExpressRouteGatewayPropertiesResponseAutoScaleConfiguration | undefined>;
    /**
     ...
     */
    public readonly expressRouteConnections!: pulumi.Output<types.outputs.network.v20230201.ExpressRouteConnectionResponse[] | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly virtualHub!: pulumi.Output<types.outputs.network.v20230201.VirtualHubIdResponse>;
...
export interface ExpressRouteGatewayArgs {
     ...
     * Configuration for auto scaling.
     */
    autoScaleConfiguration?: pulumi.Input<types.inputs.network.v20230201.ExpressRouteGatewayPropertiesAutoScaleConfigurationArgs>;
    /**
     * List of ExpressRoute connections to the ExpressRoute gateway.
     * These are also available as standalone resources. Do not mix inline and standalone resource as they will conflict with each other, leading to resources deletion.
     */
    expressRouteConnections?: pulumi.Input<pulumi.Input<types.inputs.network.v20230201.ExpressRouteConnectionArgs>[]>;
    /**
     ...
     * The Virtual Hub where the ExpressRoute gateway is or will be deployed.
     */
    virtualHub: pulumi.Input<types.inputs.network.v20230201.VirtualHubIdArgs>;
}

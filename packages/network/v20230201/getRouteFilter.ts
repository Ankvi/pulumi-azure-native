...
export interface GetRouteFilterResult {
     ...
     */
    readonly ipv6Peerings: types.outputs.network.v20230201.ExpressRouteCircuitPeeringResponse[];
    /**
     * Resource location.
     */
     ...
     */
    readonly rules?: types.outputs.network.v20230201.RouteFilterRuleResponse[];
    /**
     * Resource tags.
     */

...
export class SecurityAdminConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230201:SecurityAdminConfiguration';
...
export interface SecurityAdminConfigurationArgs {
     ...
     * Enum list of network intent policy based services.
     */
    applyOnNetworkIntentPolicyBasedServices?: pulumi.Input<pulumi.Input<string | types.enums.v20230201.NetworkIntentPolicyBasedService>[]>;
    /**

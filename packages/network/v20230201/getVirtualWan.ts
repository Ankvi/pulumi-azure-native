...
export function getVirtualWan(args: GetVirtualWanArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualWanResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230201:getVirtualWan", {
...
export interface GetVirtualWanResult {
     ...
     */
    readonly virtualHubs: types.outputs.network.v20230201.SubResourceResponse[];
    /**
     * List of VpnSites in the VirtualWAN.
     */
    readonly vpnSites: types.outputs.network.v20230201.SubResourceResponse[];
}
/**
 * Retrieves the details of a VirtualWAN.
 */

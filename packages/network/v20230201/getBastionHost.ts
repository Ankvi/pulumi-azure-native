...
export function getBastionHost(args: GetBastionHostArgs, opts?: pulumi.InvokeOptions): Promise<GetBastionHostResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230201:getBastionHost", {
...
export interface GetBastionHostResult {
     ...
     */
    readonly ipConfigurations?: types.outputs.network.v20230201.BastionHostIPConfigurationResponse[];
    /**
     * Resource location.
     */
     ...
     */
    readonly sku?: types.outputs.network.v20230201.SkuResponse;
    /**
     * Resource tags.
     */

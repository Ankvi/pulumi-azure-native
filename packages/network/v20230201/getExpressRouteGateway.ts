...
export function getExpressRouteGateway(args: GetExpressRouteGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRouteGatewayResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230201:getExpressRouteGateway", {
...
export interface GetExpressRouteGatewayResult {
     ...
     */
    readonly autoScaleConfiguration?: types.outputs.network.v20230201.ExpressRouteGatewayPropertiesResponseAutoScaleConfiguration;
    /**
     ...
     */
    readonly expressRouteConnections?: types.outputs.network.v20230201.ExpressRouteConnectionResponse[];
    /**
     * Resource ID.
     */
    readonly id?: string;
     ...
     */
    readonly virtualHub: types.outputs.network.v20230201.VirtualHubIdResponse;
}
/**
 * Fetches the details of a ExpressRoute gateway in a resource group.
 */

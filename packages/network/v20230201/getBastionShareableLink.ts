...
export function getBastionShareableLink(args: GetBastionShareableLinkArgs, opts?: pulumi.InvokeOptions): Promise<GetBastionShareableLinkResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230201:getBastionShareableLink", {
...
export interface GetBastionShareableLinkArgs {
     ...
     */
    vms?: types.inputs.network.v20230201.BastionShareableLink[];
}
...
export interface GetBastionShareableLinkResult {
     ...
     */
    readonly value?: types.outputs.network.v20230201.BastionShareableLinkResponse[];
}
/**
 * Return the Bastion Shareable Links for all the VMs specified in the request.
 */
...
export interface GetBastionShareableLinkOutputArgs {
     ...
     * List of VM references.
     */
    vms?: pulumi.Input<pulumi.Input<types.inputs.network.v20230201.BastionShareableLinkArgs>[]>;
}

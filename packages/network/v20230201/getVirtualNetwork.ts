...
export function getVirtualNetwork(args: GetVirtualNetworkArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230201:getVirtualNetwork", {
        "expand": args.expand,
...
export interface GetVirtualNetworkResult {
     ...
     */
    readonly bgpCommunities?: types.outputs.network.v20230201.VirtualNetworkBgpCommunitiesResponse;
    /**
     * The DDoS protection plan associated with the virtual network.
     */
    readonly ddosProtectionPlan?: types.outputs.network.v20230201.SubResourceResponse;
    /**
     * The dhcpOptions that contains an array of DNS servers available to VMs deployed in the virtual network.
     */
    readonly dhcpOptions?: types.outputs.network.v20230201.DhcpOptionsResponse;
    /**
     ...
     */
    readonly encryption?: types.outputs.network.v20230201.VirtualNetworkEncryptionResponse;
    /**
     ...
     */
    readonly flowLogs: types.outputs.network.v20230201.FlowLogResponse[];
    /**
     ...
     */
    readonly virtualNetworkPeerings?: types.outputs.network.v20230201.VirtualNetworkPeeringResponse[];
}
/**
 * Gets the specified virtual network by resource group.
 */

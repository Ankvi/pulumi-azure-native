...
export function getVirtualNetworkGatewayConnection(args: GetVirtualNetworkGatewayConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkGatewayConnectionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230201:getVirtualNetworkGatewayConnection", {
...
export interface GetVirtualNetworkGatewayConnectionResult {
     ...
     */
    readonly egressNatRules?: types.outputs.network.v20230201.SubResourceResponse[];
    /**
     * EnableBgp flag.
     */
     ...
     */
    readonly gatewayCustomBgpIpAddresses?: types.outputs.network.v20230201.GatewayCustomBgpIpAddressIpConfigurationResponse[];
    /**
     * Resource ID.
     */
    readonly id?: string;
     ...
     */
    readonly ingressNatRules?: types.outputs.network.v20230201.SubResourceResponse[];
    /**
     ...
     */
    readonly localNetworkGateway2?: types.outputs.network.v20230201.LocalNetworkGatewayResponse;
    /**
     * Resource location.
     */
     ...
     */
    readonly peer?: types.outputs.network.v20230201.SubResourceResponse;
    /**
     ...
     */
    readonly tunnelConnectionStatus: types.outputs.network.v20230201.TunnelConnectionHealthResponse[];
    /**
     * Resource type.
     */
     ...
     */
    readonly virtualNetworkGateway1: types.outputs.network.v20230201.VirtualNetworkGatewayResponse;
    /**
     * The reference to virtual network gateway resource.
     */
    readonly virtualNetworkGateway2?: types.outputs.network.v20230201.VirtualNetworkGatewayResponse;
}
/**
 * Gets the specified virtual network gateway connection by resource group.
 */

...
export function getPublicIPPrefix(args: GetPublicIPPrefixArgs, opts?: pulumi.InvokeOptions): Promise<GetPublicIPPrefixResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230201:getPublicIPPrefix", {
        "expand": args.expand,
...
export interface GetPublicIPPrefixResult {
     ...
     */
    readonly customIPPrefix?: types.outputs.network.v20230201.SubResourceResponse;
    /**
     ...
     */
    readonly loadBalancerFrontendIpConfiguration: types.outputs.network.v20230201.SubResourceResponse;
    /**
     * Resource location.
     */
     ...
     */
    readonly publicIPAddresses: types.outputs.network.v20230201.ReferencedPublicIpAddressResponse[];
    /**
     ...
     */
    readonly sku?: types.outputs.network.v20230201.PublicIPPrefixSkuResponse;
    /**
     * Resource tags.
     */

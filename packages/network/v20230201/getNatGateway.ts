...
export function getNatGateway(args: GetNatGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetNatGatewayResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230201:getNatGateway", {
        "expand": args.expand,
...
export interface GetNatGatewayResult {
     ...
     */
    readonly publicIpAddresses?: types.outputs.network.v20230201.SubResourceResponse[];
    /**
     ...
     * The nat gateway SKU.
     */
    readonly sku?: types.outputs.network.v20230201.NatGatewaySkuResponse;
    /**
     * An array of references to the subnets using this nat gateway resource.
     */
    readonly subnets: types.outputs.network.v20230201.SubResourceResponse[];
    /**
     * Resource tags.
     */

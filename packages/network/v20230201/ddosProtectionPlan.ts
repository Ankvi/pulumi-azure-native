...
export class DdosProtectionPlan extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230201:DdosProtectionPlan';
     ...
     */
    public /*out*/ readonly publicIPAddresses!: pulumi.Output<types.outputs.network.v20230201.SubResourceResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly virtualNetworks!: pulumi.Output<types.outputs.network.v20230201.SubResourceResponse[]>;

...
export class VirtualNetworkPeering extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230201:VirtualNetworkPeering';
     ...
     */
    public readonly remoteAddressSpace!: pulumi.Output<types.outputs.network.v20230201.AddressSpaceResponse | undefined>;
    /**
     * The reference to the remote virtual network's Bgp Communities.
     */
    public readonly remoteBgpCommunities!: pulumi.Output<types.outputs.network.v20230201.VirtualNetworkBgpCommunitiesResponse | undefined>;
    /**
     * The reference to the remote virtual network. The remote virtual network can be in the same or different region (preview). See here to register for the preview and learn more (https://docs.microsoft.com/en-us/azure/virtual-network/virtual-network-create-peering).
     */
    public readonly remoteVirtualNetwork!: pulumi.Output<types.outputs.network.v20230201.SubResourceResponse | undefined>;
    /**
     * The reference to the current address space of the remote virtual network.
     */
    public readonly remoteVirtualNetworkAddressSpace!: pulumi.Output<types.outputs.network.v20230201.AddressSpaceResponse | undefined>;
    /**
     * The reference to the remote virtual network's encryption
     */
    public /*out*/ readonly remoteVirtualNetworkEncryption!: pulumi.Output<types.outputs.network.v20230201.VirtualNetworkEncryptionResponse>;
    /**
...
export interface VirtualNetworkPeeringArgs {
     ...
     * The status of the virtual network peering.
     */
    peeringState?: pulumi.Input<string | types.enums.v20230201.VirtualNetworkPeeringState>;
    /**
     * The peering sync status of the virtual network peering.
     */
    peeringSyncLevel?: pulumi.Input<string | types.enums.v20230201.VirtualNetworkPeeringLevel>;
    /**
     * The reference to the address space peered with the remote virtual network.
     */
    remoteAddressSpace?: pulumi.Input<types.inputs.network.v20230201.AddressSpaceArgs>;
    /**
     * The reference to the remote virtual network's Bgp Communities.
     */
    remoteBgpCommunities?: pulumi.Input<types.inputs.network.v20230201.VirtualNetworkBgpCommunitiesArgs>;
    /**
     * The reference to the remote virtual network. The remote virtual network can be in the same or different region (preview). See here to register for the preview and learn more (https://docs.microsoft.com/en-us/azure/virtual-network/virtual-network-create-peering).
     */
    remoteVirtualNetwork?: pulumi.Input<types.inputs.network.v20230201.SubResourceArgs>;
    /**
     * The reference to the current address space of the remote virtual network.
     */
    remoteVirtualNetworkAddressSpace?: pulumi.Input<types.inputs.network.v20230201.AddressSpaceArgs>;
    /**

...
export class AdminRuleCollection extends pulumi.CustomResource {
     ...
     */
    public readonly appliesToGroups!: pulumi.Output<types.outputs.network.v20230201.NetworkManagerSecurityGroupItemResponse[]>;
    /**
...
export interface AdminRuleCollectionArgs {
     ...
     * Groups for configuration
     */
    appliesToGroups: pulumi.Input<pulumi.Input<types.inputs.network.v20230201.NetworkManagerSecurityGroupItemArgs>[]>;
    /**

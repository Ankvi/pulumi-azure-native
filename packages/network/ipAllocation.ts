...
export class IpAllocation extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly subnet: pulumi.Output<types.outputs.SubResourceResponse>;
    /**
     * Resource tags.
     */
     ...
     */
    declare public /*out*/ readonly virtualNetwork: pulumi.Output<types.outputs.SubResourceResponse>;

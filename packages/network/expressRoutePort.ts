...
export class ExpressRoutePort extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly circuits: pulumi.Output<types.outputs.SubResourceResponse[]>;
    /**
     ...
     */
    declare public readonly links: pulumi.Output<types.outputs.ExpressRouteLinkResponse[] | undefined>;
    /**
     * Resource location.
     */

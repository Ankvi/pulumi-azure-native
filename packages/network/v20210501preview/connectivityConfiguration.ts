...
export class ConnectivityConfiguration extends pulumi.CustomResource {
     ...
     */
    public readonly appliesToGroups!: pulumi.Output<types.outputs.network.v20210501preview.ConnectivityGroupItemResponse[]>;
    /**
     ...
     * List of hubItems
     */
    public readonly hubs!: pulumi.Output<types.outputs.network.v20210501preview.HubResponse[] | undefined>;
    /**
...
export interface ConnectivityConfigurationArgs {
     ...
     * Groups for configuration
     */
    appliesToGroups: pulumi.Input<pulumi.Input<types.inputs.network.v20210501preview.ConnectivityGroupItemArgs>[]>;
    /**
     ...
     * Connectivity topology type.
     */
    connectivityTopology: pulumi.Input<string | types.enums.v20210501preview.ConnectivityTopology>;
    /**
     * Flag if need to remove current existing peerings.
     */
    deleteExistingPeering?: pulumi.Input<string | types.enums.v20210501preview.DeleteExistingPeering>;
    /**
     * A description of the connectivity configuration.
     */
     ...
     * List of hubItems
     */
    hubs?: pulumi.Input<pulumi.Input<types.inputs.network.v20210501preview.HubArgs>[]>;
    /**
     * Flag if global mesh is supported.
     */
    isGlobal?: pulumi.Input<string | types.enums.v20210501preview.IsGlobal>;
    /**

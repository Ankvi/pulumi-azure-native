...
export interface ListNetworkManagerDeploymentStatusArgs {
     ...
     */
    deploymentTypes?: (string | types.enums.v20210501preview.ConfigurationType)[];
    /**
...
export interface ListNetworkManagerDeploymentStatusResult {
     ...
     */
    readonly value?: types.outputs.network.v20210501preview.NetworkManagerDeploymentStatusResponse[];
}
/**
 * Post to List of Network Manager Deployment Status.
 */
...
export interface ListNetworkManagerDeploymentStatusOutputArgs {
     ...
     * List of deployment types.
     */
    deploymentTypes?: pulumi.Input<pulumi.Input<string | types.enums.v20210501preview.ConfigurationType>[]>;
    /**
     * The name of the network manager.
     */

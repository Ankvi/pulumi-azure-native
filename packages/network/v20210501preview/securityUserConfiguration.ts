...
export class SecurityUserConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20210501preview:SecurityUserConfiguration';
    ...
    constructor(name: string, args: SecurityUserConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:SecurityUserConfiguration" }, { type: "azure-native:network/v20210201preview:SecurityUserConfiguration" }, { type: "azure-native:network/v20220201preview:SecurityUserConfiguration" }, { type: "azure-native:network/v20220401preview:SecurityUserConfiguration" }] };

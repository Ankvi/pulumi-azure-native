...
export interface ListNetworkManagerEffectiveSecurityAdminRulesResult {
     ...
     */
    readonly value?: (types.outputs.network.v20210501preview.EffectiveDefaultSecurityAdminRuleResponse | types.outputs.network.v20210501preview.EffectiveSecurityAdminRuleResponse)[];
}
/**
 * List all effective security admin rules applied on a virtual network.
 */

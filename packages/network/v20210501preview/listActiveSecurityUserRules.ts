...
export interface ListActiveSecurityUserRulesResult {
     ...
     */
    readonly value?: (types.outputs.network.v20210501preview.ActiveDefaultSecurityUserRuleResponse | types.outputs.network.v20210501preview.ActiveSecurityUserRuleResponse)[];
}
/**
 * Lists Active Security User Rules in a network manager.
 */

...
export class AzureFirewall extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20200401:AzureFirewall';
     ...
     */
    public readonly applicationRuleCollections!: pulumi.Output<types.outputs.network.v20200401.AzureFirewallApplicationRuleCollectionResponse[] | undefined>;
    /**
     ...
     */
    public readonly firewallPolicy!: pulumi.Output<types.outputs.network.v20200401.SubResourceResponse | undefined>;
    /**
     * IP addresses associated with AzureFirewall.
     */
    public /*out*/ readonly hubIpAddresses!: pulumi.Output<types.outputs.network.v20200401.HubIPAddressesResponse>;
    /**
     * IP configuration of the Azure Firewall resource.
     */
    public readonly ipConfigurations!: pulumi.Output<types.outputs.network.v20200401.AzureFirewallIPConfigurationResponse[] | undefined>;
    /**
     * IpGroups associated with AzureFirewall.
     */
    public /*out*/ readonly ipGroups!: pulumi.Output<types.outputs.network.v20200401.AzureFirewallIpGroupsResponse[]>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly managementIpConfiguration!: pulumi.Output<types.outputs.network.v20200401.AzureFirewallIPConfigurationResponse | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    public readonly natRuleCollections!: pulumi.Output<types.outputs.network.v20200401.AzureFirewallNatRuleCollectionResponse[] | undefined>;
    /**
     * Collection of network rule collections used by Azure Firewall.
     */
    public readonly networkRuleCollections!: pulumi.Output<types.outputs.network.v20200401.AzureFirewallNetworkRuleCollectionResponse[] | undefined>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<types.outputs.network.v20200401.AzureFirewallSkuResponse | undefined>;
    /**
     * Resource tags.
     */
     ...
     */
    public readonly virtualHub!: pulumi.Output<types.outputs.network.v20200401.SubResourceResponse | undefined>;
    /**
...
export interface AzureFirewallArgs {
     ...
     * Collection of application rule collections used by Azure Firewall.
     */
    applicationRuleCollections?: pulumi.Input<pulumi.Input<types.inputs.network.v20200401.AzureFirewallApplicationRuleCollectionArgs>[]>;
    /**
     ...
     * The firewallPolicy associated with this azure firewall.
     */
    firewallPolicy?: pulumi.Input<types.inputs.network.v20200401.SubResourceArgs>;
    /**
     * Resource ID.
     */
     ...
     * IP configuration of the Azure Firewall resource.
     */
    ipConfigurations?: pulumi.Input<pulumi.Input<types.inputs.network.v20200401.AzureFirewallIPConfigurationArgs>[]>;
    /**
     * Resource location.
     */
     ...
     * IP configuration of the Azure Firewall used for management traffic.
     */
    managementIpConfiguration?: pulumi.Input<types.inputs.network.v20200401.AzureFirewallIPConfigurationArgs>;
    /**
     * Collection of NAT rule collections used by Azure Firewall.
     */
    natRuleCollections?: pulumi.Input<pulumi.Input<types.inputs.network.v20200401.AzureFirewallNatRuleCollectionArgs>[]>;
    /**
     * Collection of network rule collections used by Azure Firewall.
     */
    networkRuleCollections?: pulumi.Input<pulumi.Input<types.inputs.network.v20200401.AzureFirewallNetworkRuleCollectionArgs>[]>;
    /**
     ...
     * The Azure Firewall Resource SKU.
     */
    sku?: pulumi.Input<types.inputs.network.v20200401.AzureFirewallSkuArgs>;
    /**
     * Resource tags.
     */
     ...
     * The virtualHub to which the firewall belongs.
     */
    virtualHub?: pulumi.Input<types.inputs.network.v20200401.SubResourceArgs>;
    /**
     * A list of availability zones denoting where the resource needs to come from.
     */

...
export class DnsResolverPolicyVirtualNetworkLink extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network:DnsResolverPolicyVirtualNetworkLink';
    ...
    constructor(name: string, args: DnsResolverPolicyVirtualNetworkLinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20230701preview:DnsResolverPolicyVirtualNetworkLink" }] };

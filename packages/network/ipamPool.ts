...
export class IpamPool extends pulumi.CustomResource {
    ...
    constructor(name: string, args: IpamPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20240101preview:IpamPool" }, { type: "azure-native:network/v20240501:IpamPool" }, { type: "azure-native:network/v20240701:IpamPool" }] };

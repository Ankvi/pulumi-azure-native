...
export class ExpressRouteCircuit extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20181201:ExpressRouteCircuit';
     ...
     */
    public readonly authorizations!: pulumi.Output<types.outputs.network.v20181201.ExpressRouteCircuitAuthorizationResponse[] | undefined>;
    /**
     ...
     */
    public readonly expressRoutePort!: pulumi.Output<types.outputs.network.v20181201.SubResourceResponse | undefined>;
    /**
     ...
     */
    public readonly peerings!: pulumi.Output<types.outputs.network.v20181201.ExpressRouteCircuitPeeringResponse[] | undefined>;
    /**
     ...
     */
    public readonly serviceProviderProperties!: pulumi.Output<types.outputs.network.v20181201.ExpressRouteCircuitServiceProviderPropertiesResponse | undefined>;
    /**
     ...
     * The SKU.
     */
    public readonly sku!: pulumi.Output<types.outputs.network.v20181201.ExpressRouteCircuitSkuResponse | undefined>;
    /**
...
export interface ExpressRouteCircuitArgs {
     ...
     * Flag to enable Global Reach on the circuit.
     */
    allowGlobalReach?: pulumi.Input<boolean>;
    /**
     * The list of authorizations.
     * These are also available as standalone resources. Do not mix inline and standalone resource as they will conflict with each other, leading to resources deletion.
     */
    authorizations?: pulumi.Input<pulumi.Input<types.inputs.network.v20181201.ExpressRouteCircuitAuthorizationArgs>[]>;
    /**
     * The bandwidth of the circuit when the circuit is provisioned on an ExpressRoutePort resource.
     */
     ...
     * The reference to the ExpressRoutePort resource when the circuit is provisioned on an ExpressRoutePort resource.
     */
    expressRoutePort?: pulumi.Input<types.inputs.network.v20181201.SubResourceArgs>;
    /**
     * The GatewayManager Etag.
     */
     ...
     * These are also available as standalone resources. Do not mix inline and standalone resource as they will conflict with each other, leading to resources deletion.
     */
    peerings?: pulumi.Input<pulumi.Input<types.inputs.network.v20181201.ExpressRouteCircuitPeeringArgs>[]>;
    /**
     * Gets the provisioning state of the public IP resource. Possible values are: 'Updating', 'Deleting', and 'Failed'.
     */
     ...
     * The ServiceProviderProperties.
     */
    serviceProviderProperties?: pulumi.Input<types.inputs.network.v20181201.ExpressRouteCircuitServiceProviderPropertiesArgs>;
    /**
     * The ServiceProviderProvisioningState state of the resource. Possible values are 'NotProvisioned', 'Provisioning', 'Provisioned', and 'Deprovisioning'.
     */
    serviceProviderProvisioningState?: pulumi.Input<string | types.enums.v20181201.ServiceProviderProvisioningState>;
    /**
     * The SKU.
     */
    sku?: pulumi.Input<types.inputs.network.v20181201.ExpressRouteCircuitSkuArgs>;
    /**
     * Resource tags.
     */

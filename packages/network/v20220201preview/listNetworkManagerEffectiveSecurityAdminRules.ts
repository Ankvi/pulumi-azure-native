...
export interface ListNetworkManagerEffectiveSecurityAdminRulesResult {
     ...
     */
    readonly value?: (types.outputs.network.v20220201preview.EffectiveDefaultSecurityAdminRuleResponse | types.outputs.network.v20220201preview.EffectiveSecurityAdminRuleResponse)[];
}
/**
 * List all effective security admin rules applied on a virtual network.
 */

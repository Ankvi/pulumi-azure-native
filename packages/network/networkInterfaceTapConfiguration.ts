...
export class NetworkInterfaceTapConfiguration extends pulumi.CustomResource {
     ...
     */
    public readonly virtualNetworkTap!: pulumi.Output<types.outputs.network.VirtualNetworkTapResponse | undefined>;
    ...
    constructor(name: string, args: NetworkInterfaceTapConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["virtualNetworkTap"] = args ? (args.virtualNetworkTap ? pulumi.output(args.virtualNetworkTap).apply(types.inputs.network.virtualNetworkTapArgsProvideDefaults) : undefined) : undefined;
...
export interface NetworkInterfaceTapConfigurationArgs {
     ...
     * The reference to the Virtual Network Tap resource.
     */
    virtualNetworkTap?: pulumi.Input<types.inputs.network.VirtualNetworkTapArgs>;
}

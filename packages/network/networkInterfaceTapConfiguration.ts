...
export class NetworkInterfaceTapConfiguration extends pulumi.CustomResource {
     ...
     */
    declare public readonly virtualNetworkTap: pulumi.Output<types.outputs.VirtualNetworkTapResponse | undefined>;

...
export class FirewallPolicy extends pulumi.CustomResource {
     ...
     */
    public readonly basePolicy!: pulumi.Output<types.outputs.network.SubResourceResponse | undefined>;
    /**
     * List of references to Child Firewall Policies.
     */
    public /*out*/ readonly childPolicies!: pulumi.Output<types.outputs.network.SubResourceResponse[]>;
    /**
     * DNS Proxy Settings definition.
     */
    public readonly dnsSettings!: pulumi.Output<types.outputs.network.DnsSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly explicitProxy!: pulumi.Output<types.outputs.network.ExplicitProxyResponse | undefined>;
    /**
     ...
     */
    public readonly insights!: pulumi.Output<types.outputs.network.FirewallPolicyInsightsResponse | undefined>;
    /**
     * The configuration for Intrusion detection.
     */
    public readonly intrusionDetection!: pulumi.Output<types.outputs.network.FirewallPolicyIntrusionDetectionResponse | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public /*out*/ readonly ruleCollectionGroups!: pulumi.Output<types.outputs.network.SubResourceResponse[]>;
    /**
     * The Firewall Policy SKU.
     */
    public readonly sku!: pulumi.Output<types.outputs.network.FirewallPolicySkuResponse | undefined>;
    /**
     * The private IP addresses/IP ranges to which traffic will not be SNAT.
     */
    public readonly snat!: pulumi.Output<types.outputs.network.FirewallPolicySNATResponse | undefined>;
    /**
     * SQL Settings definition.
     */
    public readonly sql!: pulumi.Output<types.outputs.network.FirewallPolicySQLResponse | undefined>;
    /**
     * Resource tags.
     */
     ...
     */
    public readonly threatIntelWhitelist!: pulumi.Output<types.outputs.network.FirewallPolicyThreatIntelWhitelistResponse | undefined>;
    /**
     * TLS Configuration definition.
     */
    public readonly transportSecurity!: pulumi.Output<types.outputs.network.FirewallPolicyTransportSecurityResponse | undefined>;
    /**
     * Resource type.
     */
...
export interface FirewallPolicyArgs {
     ...
     * The parent firewall policy from which rules are inherited.
     */
    basePolicy?: pulumi.Input<types.inputs.network.SubResourceArgs>;
    /**
     * DNS Proxy Settings definition.
     */
    dnsSettings?: pulumi.Input<types.inputs.network.DnsSettingsArgs>;
    /**
     * Explicit Proxy Settings definition.
     */
    explicitProxy?: pulumi.Input<types.inputs.network.ExplicitProxyArgs>;
    /**
     ...
     * Insights on Firewall Policy.
     */
    insights?: pulumi.Input<types.inputs.network.FirewallPolicyInsightsArgs>;
    /**
     * The configuration for Intrusion detection.
     */
    intrusionDetection?: pulumi.Input<types.inputs.network.FirewallPolicyIntrusionDetectionArgs>;
    /**
     * Resource location.
     */
     ...
     * The Firewall Policy SKU.
     */
    sku?: pulumi.Input<types.inputs.network.FirewallPolicySkuArgs>;
    /**
     * The private IP addresses/IP ranges to which traffic will not be SNAT.
     */
    snat?: pulumi.Input<types.inputs.network.FirewallPolicySNATArgs>;
    /**
     * SQL Settings definition.
     */
    sql?: pulumi.Input<types.inputs.network.FirewallPolicySQLArgs>;
    /**
     * Resource tags.
     */
     ...
     * ThreatIntel Whitelist for Firewall Policy.
     */
    threatIntelWhitelist?: pulumi.Input<types.inputs.network.FirewallPolicyThreatIntelWhitelistArgs>;
    /**
     * TLS Configuration definition.
     */
    transportSecurity?: pulumi.Input<types.inputs.network.FirewallPolicyTransportSecurityArgs>;
}

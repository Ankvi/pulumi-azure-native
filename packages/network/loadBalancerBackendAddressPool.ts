...
export class LoadBalancerBackendAddressPool extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly backendIPConfigurations: pulumi.Output<types.outputs.NetworkInterfaceIPConfigurationResponse[]>;
    /**
     ...
     */
    declare public /*out*/ readonly inboundNatRules: pulumi.Output<types.outputs.SubResourceResponse[]>;
    /**
     * An array of backend addresses.
     */
    declare public readonly loadBalancerBackendAddresses: pulumi.Output<types.outputs.LoadBalancerBackendAddressResponse[] | undefined>;
    /**
     * An array of references to load balancing rules that use this backend address pool.
     */
    declare public /*out*/ readonly loadBalancingRules: pulumi.Output<types.outputs.SubResourceResponse[]>;
    /**
     ...
     */
    declare public /*out*/ readonly outboundRule: pulumi.Output<types.outputs.SubResourceResponse>;
    /**
     * An array of references to outbound rules that use this backend address pool.
     */
    declare public /*out*/ readonly outboundRules: pulumi.Output<types.outputs.SubResourceResponse[]>;
    /**
     ...
     */
    declare public readonly tunnelInterfaces: pulumi.Output<types.outputs.GatewayLoadBalancerTunnelInterfaceResponse[] | undefined>;
    /**
     ...
     */
    declare public readonly virtualNetwork: pulumi.Output<types.outputs.SubResourceResponse | undefined>;

...
export class RouteTable extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network:RouteTable';
     ...
     */
    declare public readonly routes: pulumi.Output<types.outputs.RouteResponse[] | undefined>;
    /**

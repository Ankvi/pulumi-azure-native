 ...
 *
 * Other available API versions: 2020-08-01, 2020-11-01, 2021-02-01, 2021-03-01, 2021-05-01, 2021-08-01, 2022-01-01, 2022-05-01, 2022-07-01, 2022-09-01, 2022-11-01, 2023-02-01, 2023-04-01, 2023-05-01, 2023-06-01, 2023-09-01, 2023-11-01, 2024-01-01, 2024-03-01, 2024-07-01, 2024-10-01. These can be accessed by generating a local SDK package using the CLI command `pulumi package add azure-native network [ApiVersion]`. See the [version guide](../../../version-guide/#accessing-any-api-version-via-local-packages) for details.
 */
export class NatRule extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly egressVpnSiteLinkConnections: pulumi.Output<types.outputs.SubResourceResponse[]>;
    /**
     ...
     */
    declare public readonly externalMappings: pulumi.Output<types.outputs.VpnNatRuleMappingResponse[] | undefined>;
    /**
     * List of ingress VpnSiteLinkConnections.
     */
    declare public /*out*/ readonly ingressVpnSiteLinkConnections: pulumi.Output<types.outputs.SubResourceResponse[]>;
    /**
     * The private IP address internal mapping for NAT.
     */
    declare public readonly internalMappings: pulumi.Output<types.outputs.VpnNatRuleMappingResponse[] | undefined>;
    /**

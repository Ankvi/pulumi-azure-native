...
export class DefaultAdminRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230601:DefaultAdminRule';

...
export class PublicIPPrefix extends pulumi.CustomResource {
     ...
     */
    public readonly customIPPrefix!: pulumi.Output<types.outputs.network.SubResourceResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly loadBalancerFrontendIpConfiguration!: pulumi.Output<types.outputs.network.SubResourceResponse>;
    /**
     * Resource location.
     */
     ...
     */
    public /*out*/ readonly publicIPAddresses!: pulumi.Output<types.outputs.network.ReferencedPublicIpAddressResponse[]>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<types.outputs.network.PublicIPPrefixSkuResponse | undefined>;
    /**
     * Resource tags.
     */
...
export interface PublicIPPrefixArgs {
     ...
     * The customIpPrefix that this prefix is associated with.
     */
    customIPPrefix?: pulumi.Input<types.inputs.network.SubResourceArgs>;
    /**
     * The extended location of the public ip address.
     */
     ...
     * The public IP prefix SKU.
     */
    sku?: pulumi.Input<types.inputs.network.PublicIPPrefixSkuArgs>;
    /**
     * Resource tags.
     */

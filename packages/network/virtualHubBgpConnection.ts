...
export class VirtualHubBgpConnection extends pulumi.CustomResource {
     ...
     */
    declare public readonly hubVirtualNetworkConnection: pulumi.Output<types.outputs.SubResourceResponse | undefined>;
    /**

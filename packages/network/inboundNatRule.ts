...
export class InboundNatRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network:InboundNatRule';
     ...
     */
    declare public readonly backendAddressPool: pulumi.Output<types.outputs.SubResourceResponse | undefined>;
    /**
     * A reference to a private IP address defined on a network interface of a VM. Traffic sent to the frontend port of each of the frontend IP configurations is forwarded to the backend IP.
     */
    declare public /*out*/ readonly backendIPConfiguration: pulumi.Output<types.outputs.NetworkInterfaceIPConfigurationResponse>;
    /**
     ...
     */
    declare public readonly frontendIPConfiguration: pulumi.Output<types.outputs.SubResourceResponse | undefined>;
    /**

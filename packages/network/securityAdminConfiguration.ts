...
export class SecurityAdminConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network:SecurityAdminConfiguration';
...
export interface SecurityAdminConfigurationArgs {
     ...
     * Determine update behavior for changes to network groups referenced within the rules in this configuration.
     */
    networkGroupAddressSpaceAggregationOption?: pulumi.Input<string | types.enums.AddressSpaceAggregationOption>;
    /**

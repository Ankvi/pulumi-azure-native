...
export class Policy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20240201:Policy';
    ...
    constructor(name: string, args: PolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["policySettings"] = args ? (args.policySettings ? pulumi.output(args.policySettings).apply(types.inputs.frontDoorPolicySettingsArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:Policy" }, { type: "azure-native:network/v20190301:Policy" }, { type: "azure-native:network/v20191001:Policy" }, { type: "azure-native:network/v20200401:Policy" }, { type: "azure-native:network/v20201101:Policy" }, { type: "azure-native:network/v20210601:Policy" }, { type: "azure-native:network/v20220501:Policy" }] };

...
export function getNetworkSecurityPerimeterLink(args: GetNetworkSecurityPerimeterLinkArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkSecurityPerimeterLinkResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network:getNetworkSecurityPerimeterLink", {
...
export interface GetNetworkSecurityPerimeterLinkArgs {
    /**
 ...
 */
export interface GetNetworkSecurityPerimeterLinkResult {
    /**
...
export function getNetworkSecurityPerimeterLinkOutput(args: GetNetworkSecurityPerimeterLinkOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNetworkSecurityPerimeterLinkResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:network:getNetworkSecurityPerimeterLink", {
        "linkName": args.linkName,
        "networkSecurityPerimeterName": args.networkSecurityPerimeterName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
...
export interface GetNetworkSecurityPerimeterLinkOutputArgs {
    /**
     * The name of the NSP link.
     */

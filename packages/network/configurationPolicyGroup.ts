...
export class ConfigurationPolicyGroup extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly p2SConnectionConfigurations: pulumi.Output<types.outputs.SubResourceResponse[]>;
    /**
     * Multiple PolicyMembers for VpnServerConfigurationPolicyGroup.
     */
    declare public readonly policyMembers: pulumi.Output<types.outputs.VpnServerConfigurationPolicyGroupMemberResponse[] | undefined>;
    /**

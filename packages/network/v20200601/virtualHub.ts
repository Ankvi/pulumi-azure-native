...
export class VirtualHub extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20200601:VirtualHub';
     ...
     */
    public readonly azureFirewall!: pulumi.Output<types.outputs.network.v20200601.SubResourceResponse | undefined>;
    /**
     * List of references to Bgp Connections.
     */
    public /*out*/ readonly bgpConnections!: pulumi.Output<types.outputs.network.v20200601.SubResourceResponse[]>;
    /**
     ...
     */
    public readonly expressRouteGateway!: pulumi.Output<types.outputs.network.v20200601.SubResourceResponse | undefined>;
    /**
     * List of references to IpConfigurations.
     */
    public /*out*/ readonly ipConfigurations!: pulumi.Output<types.outputs.network.v20200601.SubResourceResponse[]>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly p2SVpnGateway!: pulumi.Output<types.outputs.network.v20200601.SubResourceResponse | undefined>;
    /**
     ...
     */
    public readonly routeTable!: pulumi.Output<types.outputs.network.v20200601.VirtualHubRouteTableResponse | undefined>;
    /**
     * The routing state.
     */
     ...
     */
    public readonly securityPartnerProvider!: pulumi.Output<types.outputs.network.v20200601.SubResourceResponse | undefined>;
    /**
     ...
     */
    public readonly virtualHubRouteTableV2s!: pulumi.Output<types.outputs.network.v20200601.VirtualHubRouteTableV2Response[] | undefined>;
    /**
     * VirtualRouter ASN.
     */
     ...
     */
    public readonly virtualWan!: pulumi.Output<types.outputs.network.v20200601.SubResourceResponse | undefined>;
    /**
     * The VpnGateway associated with this VirtualHub.
     */
    public readonly vpnGateway!: pulumi.Output<types.outputs.network.v20200601.SubResourceResponse | undefined>;
...
export interface VirtualHubArgs {
     ...
     * The azureFirewall associated with this VirtualHub.
     */
    azureFirewall?: pulumi.Input<types.inputs.network.v20200601.SubResourceArgs>;
    /**
     * Flag to control route propogation for VirtualRouter hub.
     */
    enableVirtualRouterRoutePropogation?: pulumi.Input<boolean>;
    /**
     * The expressRouteGateway associated with this VirtualHub.
     */
    expressRouteGateway?: pulumi.Input<types.inputs.network.v20200601.SubResourceArgs>;
    /**
     * Resource ID.
     */
     ...
     * The P2SVpnGateway associated with this VirtualHub.
     */
    p2SVpnGateway?: pulumi.Input<types.inputs.network.v20200601.SubResourceArgs>;
    /**
     ...
     * The routeTable associated with this virtual hub.
     */
    routeTable?: pulumi.Input<types.inputs.network.v20200601.VirtualHubRouteTableArgs>;
    /**
     * The securityPartnerProvider associated with this VirtualHub.
     */
    securityPartnerProvider?: pulumi.Input<types.inputs.network.v20200601.SubResourceArgs>;
    /**
     * The Security Provider name.
     */
     ...
     */
    virtualHubRouteTableV2s?: pulumi.Input<pulumi.Input<types.inputs.network.v20200601.VirtualHubRouteTableV2Args>[]>;
    /**
     * VirtualRouter ASN.
     */
     ...
     * The VirtualWAN to which the VirtualHub belongs.
     */
    virtualWan?: pulumi.Input<types.inputs.network.v20200601.SubResourceArgs>;
    /**
     * The VpnGateway associated with this VirtualHub.
     */
    vpnGateway?: pulumi.Input<types.inputs.network.v20200601.SubResourceArgs>;
}

...
export class NetworkSecurityGroup extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly defaultSecurityRules: pulumi.Output<types.outputs.SecurityRuleResponse[]>;
    /**
     ...
     */
    declare public readonly securityRules: pulumi.Output<types.outputs.SecurityRuleResponse[] | undefined>;
    /**

...
export function getVpnSite(args: GetVpnSiteArgs, opts?: pulumi.InvokeOptions): Promise<GetVpnSiteResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230401:getVpnSite", {
...
export interface GetVpnSiteResult {
     ...
     */
    readonly bgpProperties?: types.outputs.network.v20230401.BgpSettingsResponse;
    /**
     * The device properties.
     */
    readonly deviceProperties?: types.outputs.network.v20230401.DevicePropertiesResponse;
    /**
     ...
     * Office365 Policy.
     */
    readonly o365Policy?: types.outputs.network.v20230401.O365PolicyPropertiesResponse;
    /**
     ...
     */
    readonly vpnSiteLinks?: types.outputs.network.v20230401.VpnSiteLinkResponse[];
}
/**
 * Retrieves the details of a VPN site.
 */

...
export class VpnServerConfiguration extends pulumi.CustomResource {
     ...
     */
    public readonly aadAuthenticationParameters!: pulumi.Output<types.outputs.network.v20230401.AadAuthenticationParametersResponse | undefined>;
    /**
     * List of all VpnServerConfigurationPolicyGroups.
     */
    public readonly configurationPolicyGroups!: pulumi.Output<types.outputs.network.v20230401.VpnServerConfigurationPolicyGroupResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly p2SVpnGateways!: pulumi.Output<types.outputs.network.v20230401.P2SVpnGatewayResponse[]>;
    /**
     ...
     */
    public readonly radiusClientRootCertificates!: pulumi.Output<types.outputs.network.v20230401.VpnServerConfigRadiusClientRootCertificateResponse[] | undefined>;
    /**
     ...
     */
    public readonly radiusServerRootCertificates!: pulumi.Output<types.outputs.network.v20230401.VpnServerConfigRadiusServerRootCertificateResponse[] | undefined>;
    /**
     ...
     */
    public readonly radiusServers!: pulumi.Output<types.outputs.network.v20230401.RadiusServerResponse[] | undefined>;
    /**
     * Resource tags.
     */
     ...
     */
    public readonly vpnClientIpsecPolicies!: pulumi.Output<types.outputs.network.v20230401.IpsecPolicyResponse[] | undefined>;
    /**
     * VPN client revoked certificate of VpnServerConfiguration.
     */
    public readonly vpnClientRevokedCertificates!: pulumi.Output<types.outputs.network.v20230401.VpnServerConfigVpnClientRevokedCertificateResponse[] | undefined>;
    /**
     * VPN client root certificate of VpnServerConfiguration.
     */
    public readonly vpnClientRootCertificates!: pulumi.Output<types.outputs.network.v20230401.VpnServerConfigVpnClientRootCertificateResponse[] | undefined>;
    /**
...
export interface VpnServerConfigurationArgs {
     ...
     * The set of aad vpn authentication parameters.
     */
    aadAuthenticationParameters?: pulumi.Input<types.inputs.network.v20230401.AadAuthenticationParametersArgs>;
    /**
     * List of all VpnServerConfigurationPolicyGroups.
     */
    configurationPolicyGroups?: pulumi.Input<pulumi.Input<types.inputs.network.v20230401.VpnServerConfigurationPolicyGroupArgs>[]>;
    /**
     * Resource ID.
     */
     ...
     * Radius client root certificate of VpnServerConfiguration.
     */
    radiusClientRootCertificates?: pulumi.Input<pulumi.Input<types.inputs.network.v20230401.VpnServerConfigRadiusClientRootCertificateArgs>[]>;
    /**
     * The radius server address property of the VpnServerConfiguration resource for point to site client connection.
     */
     ...
     * Radius Server root certificate of VpnServerConfiguration.
     */
    radiusServerRootCertificates?: pulumi.Input<pulumi.Input<types.inputs.network.v20230401.VpnServerConfigRadiusServerRootCertificateArgs>[]>;
    /**
     * The radius secret property of the VpnServerConfiguration resource for point to site client connection.
     */
     ...
     * Multiple Radius Server configuration for VpnServerConfiguration.
     */
    radiusServers?: pulumi.Input<pulumi.Input<types.inputs.network.v20230401.RadiusServerArgs>[]>;
    /**
     ...
     * VPN authentication types for the VpnServerConfiguration.
     */
    vpnAuthenticationTypes?: pulumi.Input<pulumi.Input<string | types.enums.v20230401.VpnAuthenticationType>[]>;
    /**
     * VpnClientIpsecPolicies for VpnServerConfiguration.
     */
    vpnClientIpsecPolicies?: pulumi.Input<pulumi.Input<types.inputs.network.v20230401.IpsecPolicyArgs>[]>;
    /**
     * VPN client revoked certificate of VpnServerConfiguration.
     */
    vpnClientRevokedCertificates?: pulumi.Input<pulumi.Input<types.inputs.network.v20230401.VpnServerConfigVpnClientRevokedCertificateArgs>[]>;
    /**
     * VPN client root certificate of VpnServerConfiguration.
     */
    vpnClientRootCertificates?: pulumi.Input<pulumi.Input<types.inputs.network.v20230401.VpnServerConfigVpnClientRootCertificateArgs>[]>;
    /**
     * VPN protocols for the VpnServerConfiguration.
     */
    vpnProtocols?: pulumi.Input<pulumi.Input<string | types.enums.v20230401.VpnGatewayTunnelingProtocol>[]>;
    /**

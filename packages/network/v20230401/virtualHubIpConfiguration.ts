...
export class VirtualHubIpConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230401:VirtualHubIpConfiguration';
     ...
     */
    public readonly publicIPAddress!: pulumi.Output<types.outputs.network.v20230401.PublicIPAddressResponse | undefined>;
    /**
...
export interface VirtualHubIpConfigurationArgs {
     ...
     * The private IP address allocation method.
     */
    privateIPAllocationMethod?: pulumi.Input<string | types.enums.v20230401.IPAllocationMethod>;
    /**
     * The reference to the public IP resource.
     */
    publicIPAddress?: pulumi.Input<types.inputs.network.v20230401.PublicIPAddressArgs>;
    /**

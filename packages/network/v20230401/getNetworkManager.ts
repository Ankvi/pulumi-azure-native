...
export function getNetworkManager(args: GetNetworkManagerArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkManagerResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230401:getNetworkManager", {
...
export interface GetNetworkManagerResult {
     ...
     */
    readonly networkManagerScopes: types.outputs.network.v20230401.NetworkManagerPropertiesResponseNetworkManagerScopes;
    /**

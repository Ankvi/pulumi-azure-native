...
export function getExpressRouteCircuit(args: GetExpressRouteCircuitArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRouteCircuitResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230401:getExpressRouteCircuit", {
...
export interface GetExpressRouteCircuitResult {
     ...
     */
    readonly authorizations?: types.outputs.network.v20230401.ExpressRouteCircuitAuthorizationResponse[];
    /**
     ...
     */
    readonly expressRoutePort?: types.outputs.network.v20230401.SubResourceResponse;
    /**
     ...
     */
    readonly peerings?: types.outputs.network.v20230401.ExpressRouteCircuitPeeringResponse[];
    /**
     ...
     */
    readonly serviceProviderProperties?: types.outputs.network.v20230401.ExpressRouteCircuitServiceProviderPropertiesResponse;
    /**
     ...
     * The SKU.
     */
    readonly sku?: types.outputs.network.v20230401.ExpressRouteCircuitSkuResponse;
    /**

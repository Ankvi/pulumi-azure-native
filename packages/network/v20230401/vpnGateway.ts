...
export class VpnGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230401:VpnGateway';
     ...
     */
    public readonly connections!: pulumi.Output<types.outputs.network.v20230401.VpnConnectionResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly ipConfigurations!: pulumi.Output<types.outputs.network.v20230401.VpnGatewayIpConfigurationResponse[]>;
    /**
     ...
     */
    public readonly natRules!: pulumi.Output<types.outputs.network.v20230401.VpnGatewayNatRuleResponse[] | undefined>;
    /**
...
export interface VpnGatewayArgs {
     ...
     */
    connections?: pulumi.Input<pulumi.Input<types.inputs.network.v20230401.VpnConnectionArgs>[]>;
    /**
     * Enable BGP routes translation for NAT on this VpnGateway.
     */
     ...
     * These are also available as standalone resources. Do not mix inline and standalone resource as they will conflict with each other, leading to resources deletion.
     */
    natRules?: pulumi.Input<pulumi.Input<types.inputs.network.v20230401.VpnGatewayNatRuleArgs>[]>;
    /**

...
export class WebApplicationFirewallPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230401:WebApplicationFirewallPolicy';
     ...
     */
    public /*out*/ readonly applicationGateways!: pulumi.Output<types.outputs.network.v20230401.ApplicationGatewayResponse[]>;
    /**
     * The custom rules inside the policy.
     */
    public readonly customRules!: pulumi.Output<types.outputs.network.v20230401.WebApplicationFirewallCustomRuleResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly httpListeners!: pulumi.Output<types.outputs.network.v20230401.SubResourceResponse[]>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly managedRules!: pulumi.Output<types.outputs.network.v20230401.ManagedRulesDefinitionResponse>;
    /**
     * Resource name.
     */
     ...
     */
    public /*out*/ readonly pathBasedRules!: pulumi.Output<types.outputs.network.v20230401.SubResourceResponse[]>;
    /**
     * The PolicySettings for policy.
     */
    public readonly policySettings!: pulumi.Output<types.outputs.network.v20230401.PolicySettingsResponse | undefined>;
    /**
    ...
    constructor(name: string, args: WebApplicationFirewallPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["policySettings"] = args ? (args.policySettings ? pulumi.output(args.policySettings).apply(types.inputs.network.v20230401.policySettingsArgsProvideDefaults) : undefined) : undefined;
...
export interface WebApplicationFirewallPolicyArgs {
     ...
     * The custom rules inside the policy.
     */
    customRules?: pulumi.Input<pulumi.Input<types.inputs.network.v20230401.WebApplicationFirewallCustomRuleArgs>[]>;
    /**
     * Resource ID.
     */
     ...
     * Describes the managedRules structure.
     */
    managedRules: pulumi.Input<types.inputs.network.v20230401.ManagedRulesDefinitionArgs>;
    /**
     ...
     * The PolicySettings for policy.
     */
    policySettings?: pulumi.Input<types.inputs.network.v20230401.PolicySettingsArgs>;
    /**

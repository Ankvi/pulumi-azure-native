...
export function getRouteFilter(args: GetRouteFilterArgs, opts?: pulumi.InvokeOptions): Promise<GetRouteFilterResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230401:getRouteFilter", {
        "expand": args.expand,
...
export interface GetRouteFilterResult {
     ...
     */
    readonly ipv6Peerings: types.outputs.network.v20230401.ExpressRouteCircuitPeeringResponse[];
    /**
     * Resource location.
     */
     ...
     */
    readonly rules?: types.outputs.network.v20230401.RouteFilterRuleResponse[];
    /**
     * Resource tags.
     */

...
export interface GetFirewallPolicyRuleCollectionGroupResult {
     ...
     */
    readonly ruleCollections?: (types.outputs.network.v20230401.FirewallPolicyFilterRuleCollectionResponse | types.outputs.network.v20230401.FirewallPolicyNatRuleCollectionResponse)[];
    /**
     * Rule Group type.
     */

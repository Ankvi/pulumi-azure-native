...
export function getExpressRoutePort(args: GetExpressRoutePortArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRoutePortResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230401:getExpressRoutePort", {
...
export interface GetExpressRoutePortResult {
     ...
     */
    readonly circuits: types.outputs.network.v20230401.SubResourceResponse[];
    /**
     ...
     */
    readonly links?: types.outputs.network.v20230401.ExpressRouteLinkResponse[];
    /**
     * Resource location.
     */

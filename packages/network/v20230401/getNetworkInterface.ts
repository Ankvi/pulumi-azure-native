...
export function getNetworkInterface(args: GetNetworkInterfaceArgs, opts?: pulumi.InvokeOptions): Promise<GetNetworkInterfaceResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230401:getNetworkInterface", {
        "expand": args.expand,
...
export interface GetNetworkInterfaceResult {
     ...
     */
    readonly dnsSettings?: types.outputs.network.v20230401.NetworkInterfaceDnsSettingsResponse;
    /**
     * A reference to the dscp configuration to which the network interface is linked.
     */
    readonly dscpConfiguration: types.outputs.network.v20230401.SubResourceResponse;
    /**
     ...
     */
    readonly ipConfigurations?: types.outputs.network.v20230401.NetworkInterfaceIPConfigurationResponse[];
    /**
     * Resource location.
     */
     ...
     */
    readonly privateLinkService?: types.outputs.network.v20230401.PrivateLinkServiceResponse;
    /**
     ...
     */
    readonly tapConfigurations: types.outputs.network.v20230401.NetworkInterfaceTapConfigurationResponse[];
    /**
     * Resource type.
     */
     ...
     */
    readonly virtualMachine: types.outputs.network.v20230401.SubResourceResponse;
    /**

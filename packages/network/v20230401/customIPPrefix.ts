...
export class CustomIPPrefix extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly childCustomIpPrefixes!: pulumi.Output<types.outputs.network.v20230401.SubResourceResponse[]>;
    /**
     ...
     */
    public readonly customIpPrefixParent!: pulumi.Output<types.outputs.network.v20230401.SubResourceResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly publicIpPrefixes!: pulumi.Output<types.outputs.network.v20230401.SubResourceResponse[]>;
    /**
...
export interface CustomIPPrefixArgs {
     ...
     * The commissioned state of the Custom IP Prefix.
     */
    commissionedState?: pulumi.Input<string | types.enums.v20230401.CommissionedState>;
    /**
     ...
     * The Parent CustomIpPrefix for IPv6 /64 CustomIpPrefix.
     */
    customIpPrefixParent?: pulumi.Input<types.inputs.network.v20230401.SubResourceArgs>;
    /**
     * Whether to do express route advertise.
     */
     ...
     * The Geo for CIDR advertising. Should be an Geo code.
     */
    geo?: pulumi.Input<string | types.enums.v20230401.Geo>;
    /**
     * Resource ID.
     */
     ...
     * Type of custom IP prefix. Should be Singular, Parent, or Child.
     */
    prefixType?: pulumi.Input<string | types.enums.v20230401.CustomIpPrefixType>;
    /**

...
export class VirtualApplianceSite extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230401:VirtualApplianceSite';
     ...
     * Office 365 Policy.
     */
    public readonly o365Policy!: pulumi.Output<types.outputs.network.v20230401.Office365PolicyPropertiesResponse | undefined>;
    /**
...
export interface VirtualApplianceSiteArgs {
     ...
     * Office 365 Policy.
     */
    o365Policy?: pulumi.Input<types.inputs.network.v20230401.Office365PolicyPropertiesArgs>;
    /**

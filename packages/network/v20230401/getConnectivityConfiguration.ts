...
export function getConnectivityConfiguration(args: GetConnectivityConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetConnectivityConfigurationResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230401:getConnectivityConfiguration", {
...
export interface GetConnectivityConfigurationResult {
     ...
     */
    readonly appliesToGroups: types.outputs.network.v20230401.ConnectivityGroupItemResponse[];
    /**
     ...
     * List of hubItems
     */
    readonly hubs?: types.outputs.network.v20230401.HubResponse[];
    /**
     * Resource ID.
     */
    readonly id: string;

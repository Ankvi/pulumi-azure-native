...
export class RoutingIntent extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230401:RoutingIntent';
     ...
     */
    public readonly routingPolicies!: pulumi.Output<types.outputs.network.v20230401.RoutingPolicyResponse[] | undefined>;
    /**
     * Resource type.
     */
...
export interface RoutingIntentArgs {
     ...
     * List of routing policies.
     */
    routingPolicies?: pulumi.Input<pulumi.Input<types.inputs.network.v20230401.RoutingPolicyArgs>[]>;
    /**

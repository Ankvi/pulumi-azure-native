...
export class VirtualNetworkGatewayNatRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230401:VirtualNetworkGatewayNatRule';
     ...
     */
    public readonly externalMappings!: pulumi.Output<types.outputs.network.v20230401.VpnNatRuleMappingResponse[] | undefined>;
    /**
     * The private IP address internal mapping for NAT.
     */
    public readonly internalMappings!: pulumi.Output<types.outputs.network.v20230401.VpnNatRuleMappingResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: VirtualNetworkGatewayNatRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:VirtualNetworkGatewayNatRule" }, { type: "azure-native:network/v20210201:VirtualNetworkGatewayNatRule" }, { type: "azure-native:network/v20210301:VirtualNetworkGatewayNatRule" }, { type: "azure-native:network/v20210501:VirtualNetworkGatewayNatRule" }, { type: "azure-native:network/v20210801:VirtualNetworkGatewayNatRule" }, { type: "azure-native:network/v20220101:VirtualNetworkGatewayNatRule" }, { type: "azure-native:network/v20220501:VirtualNetworkGatewayNatRule" }, { type: "azure-native:network/v20220701:VirtualNetworkGatewayNatRule" }, { type: "azure-native:network/v20220901:VirtualNetworkGatewayNatRule" }, { type: "azure-native:network/v20221101:VirtualNetworkGatewayNatRule" }, { type: "azure-native:network/v20230201:VirtualNetworkGatewayNatRule" }, { type: "azure-native:network/v20230501:VirtualNetworkGatewayNatRule" }] };
...
export interface VirtualNetworkGatewayNatRuleArgs {
     ...
     * The private IP address external mapping for NAT.
     */
    externalMappings?: pulumi.Input<pulumi.Input<types.inputs.network.v20230401.VpnNatRuleMappingArgs>[]>;
    /**
     * Resource ID.
     */
     ...
     * The private IP address internal mapping for NAT.
     */
    internalMappings?: pulumi.Input<pulumi.Input<types.inputs.network.v20230401.VpnNatRuleMappingArgs>[]>;
    /**
     * The IP Configuration ID this NAT rule applies to.
     */
     ...
     * The Source NAT direction of a VPN NAT.
     */
    mode?: pulumi.Input<string | types.enums.v20230401.VpnNatRuleMode>;
    /**
     * The name of the resource that is unique within a resource group. This name can be used to access the resource.
     */
     ...
     */
    type?: pulumi.Input<string | types.enums.v20230401.VpnNatRuleType>;
    /**

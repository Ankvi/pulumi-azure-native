...
export function getVirtualApplianceSite(args: GetVirtualApplianceSiteArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualApplianceSiteResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230401:getVirtualApplianceSite", {
...
export interface GetVirtualApplianceSiteResult {
     ...
     * Office 365 Policy.
     */
    readonly o365Policy?: types.outputs.network.v20230401.Office365PolicyPropertiesResponse;
    /**

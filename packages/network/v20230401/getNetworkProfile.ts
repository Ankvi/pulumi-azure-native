...
export interface GetNetworkProfileResult {
     ...
     */
    readonly containerNetworkInterfaceConfigurations?: types.outputs.network.v20230401.ContainerNetworkInterfaceConfigurationResponse[];
    /**
     * List of child container network interfaces.
     */
    readonly containerNetworkInterfaces: types.outputs.network.v20230401.ContainerNetworkInterfaceResponse[];
    /**

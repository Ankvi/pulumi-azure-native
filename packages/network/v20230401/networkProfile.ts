...
export class NetworkProfile extends pulumi.CustomResource {
     ...
     */
    public readonly containerNetworkInterfaceConfigurations!: pulumi.Output<types.outputs.network.v20230401.ContainerNetworkInterfaceConfigurationResponse[] | undefined>;
    /**
     * List of child container network interfaces.
     */
    public /*out*/ readonly containerNetworkInterfaces!: pulumi.Output<types.outputs.network.v20230401.ContainerNetworkInterfaceResponse[]>;
    /**
...
export interface NetworkProfileArgs {
     ...
     * List of chid container network interface configurations.
     */
    containerNetworkInterfaceConfigurations?: pulumi.Input<pulumi.Input<types.inputs.network.v20230401.ContainerNetworkInterfaceConfigurationArgs>[]>;
    /**
     * Resource ID.
     */

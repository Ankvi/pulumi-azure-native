...
export class PrivateLinkServicePrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230401:PrivateLinkServicePrivateEndpointConnection';
     ...
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<types.outputs.network.v20230401.PrivateLinkServiceConnectionStateResponse | undefined>;
    /**
...
export interface PrivateLinkServicePrivateEndpointConnectionArgs {
     ...
     * A collection of information about the state of the connection between service consumer and provider.
     */
    privateLinkServiceConnectionState?: pulumi.Input<types.inputs.network.v20230401.PrivateLinkServiceConnectionStateArgs>;
    /**

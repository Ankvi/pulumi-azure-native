...
export class NetworkVirtualApplianceConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230401:NetworkVirtualApplianceConnection';
     ...
     */
    public readonly routingConfiguration!: pulumi.Output<types.outputs.network.v20230401.RoutingConfigurationNfvResponse | undefined>;
    /**
...
export interface NetworkVirtualApplianceConnectionArgs {
     ...
     * The Routing Configuration indicating the associated and propagated route tables on this connection.
     */
    routingConfiguration?: pulumi.Input<types.inputs.network.v20230401.RoutingConfigurationNfvArgs>;
    /**
     * Unique identifier for the connection.
     */

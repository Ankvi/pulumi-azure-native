...
export function getRoutingIntent(args: GetRoutingIntentArgs, opts?: pulumi.InvokeOptions): Promise<GetRoutingIntentResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230401:getRoutingIntent", {
...
export interface GetRoutingIntentResult {
     ...
     */
    readonly routingPolicies?: types.outputs.network.v20230401.RoutingPolicyResponse[];
    /**
     * Resource type.
     */

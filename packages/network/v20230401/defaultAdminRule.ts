...
export class DefaultAdminRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230401:DefaultAdminRule';
     ...
     */
    public /*out*/ readonly destinations!: pulumi.Output<types.outputs.network.v20230401.AddressPrefixItemResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly sources!: pulumi.Output<types.outputs.network.v20230401.AddressPrefixItemResponse[]>;
    /**

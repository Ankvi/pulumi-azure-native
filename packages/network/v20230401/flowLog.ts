...
export class FlowLog extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230401:FlowLog';
     ...
     */
    public readonly flowAnalyticsConfiguration!: pulumi.Output<types.outputs.network.v20230401.TrafficAnalyticsPropertiesResponse | undefined>;
    /**
     * Parameters that define the flow log format.
     */
    public readonly format!: pulumi.Output<types.outputs.network.v20230401.FlowLogFormatParametersResponse | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly retentionPolicy!: pulumi.Output<types.outputs.network.v20230401.RetentionPolicyParametersResponse | undefined>;
    /**
    ...
    constructor(name: string, args: FlowLogArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["format"] = args ? (args.format ? pulumi.output(args.format).apply(types.inputs.network.v20230401.flowLogFormatParametersArgsProvideDefaults) : undefined) : undefined;
            resourceInputs["id"] = args ? args.id : undefined;
            resourceInputs["location"] = args ? args.location : undefined;
            resourceInputs["networkWatcherName"] = args ? args.networkWatcherName : undefined;
            resourceInputs["resourceGroupName"] = args ? args.resourceGroupName : undefined;
            resourceInputs["retentionPolicy"] = args ? (args.retentionPolicy ? pulumi.output(args.retentionPolicy).apply(types.inputs.network.v20230401.retentionPolicyParametersArgsProvideDefaults) : undefined) : undefined;
...
export interface FlowLogArgs {
     ...
     * Parameters that define the configuration of traffic analytics.
     */
    flowAnalyticsConfiguration?: pulumi.Input<types.inputs.network.v20230401.TrafficAnalyticsPropertiesArgs>;
    /**
     ...
     * Parameters that define the flow log format.
     */
    format?: pulumi.Input<types.inputs.network.v20230401.FlowLogFormatParametersArgs>;
    /**
     * Resource ID.
     */
     ...
     * Parameters that define the retention policy for flow log.
     */
    retentionPolicy?: pulumi.Input<types.inputs.network.v20230401.RetentionPolicyParametersArgs>;
    /**
     * ID of the storage account which is used to store the flow log.
     */

...
export function getNatGateway(args: GetNatGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetNatGatewayResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230401:getNatGateway", {
        "expand": args.expand,
...
export interface GetNatGatewayResult {
     ...
     */
    readonly publicIpAddresses?: types.outputs.network.v20230401.SubResourceResponse[];
    /**
     * An array of public ip prefixes associated with the nat gateway resource.
     */
    readonly publicIpPrefixes?: types.outputs.network.v20230401.SubResourceResponse[];
    /**
     ...
     * The nat gateway SKU.
     */
    readonly sku?: types.outputs.network.v20230401.NatGatewaySkuResponse;
    /**
     * An array of references to the subnets using this nat gateway resource.
     */
    readonly subnets: types.outputs.network.v20230401.SubResourceResponse[];
    /**
     * Resource tags.
     */

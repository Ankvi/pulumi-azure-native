...
export function getVpnGateway(args: GetVpnGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetVpnGatewayResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230401:getVpnGateway", {
...
export interface GetVpnGatewayResult {
     ...
     */
    readonly connections?: types.outputs.network.v20230401.VpnConnectionResponse[];
    /**
     ...
     */
    readonly ipConfigurations: types.outputs.network.v20230401.VpnGatewayIpConfigurationResponse[];
    /**
     ...
     */
    readonly natRules?: types.outputs.network.v20230401.VpnGatewayNatRuleResponse[];
    /**

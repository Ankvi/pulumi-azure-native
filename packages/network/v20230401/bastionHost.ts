...
export class BastionHost extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230401:BastionHost';
     ...
     */
    public readonly ipConfigurations!: pulumi.Output<types.outputs.network.v20230401.BastionHostIPConfigurationResponse[] | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly sku!: pulumi.Output<types.outputs.network.v20230401.SkuResponse | undefined>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: BastionHostArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["sku"] = args ? (args.sku ? pulumi.output(args.sku).apply(types.inputs.network.v20230401.skuArgsProvideDefaults) : undefined) : undefined;
...
export interface BastionHostArgs {
     ...
     * IP configuration of the Bastion Host resource.
     */
    ipConfigurations?: pulumi.Input<pulumi.Input<types.inputs.network.v20230401.BastionHostIPConfigurationArgs>[]>;
    /**
     * Resource location.
     */
     ...
     * The sku of this Bastion Host.
     */
    sku?: pulumi.Input<types.inputs.network.v20230401.SkuArgs>;
    /**
     * Resource tags.
     */

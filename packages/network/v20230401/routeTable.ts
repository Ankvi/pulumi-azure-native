...
export class RouteTable extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230401:RouteTable';
     ...
     */
    public readonly routes!: pulumi.Output<types.outputs.network.v20230401.RouteResponse[] | undefined>;
    /**
...
export interface RouteTableArgs {
     ...
     * Collection of routes contained within a route table.
     */
    routes?: pulumi.Input<pulumi.Input<types.inputs.network.v20230401.RouteArgs>[]>;
    /**
     * Resource tags.
     */

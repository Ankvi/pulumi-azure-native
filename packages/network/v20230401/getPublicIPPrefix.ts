...
export function getPublicIPPrefix(args: GetPublicIPPrefixArgs, opts?: pulumi.InvokeOptions): Promise<GetPublicIPPrefixResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230401:getPublicIPPrefix", {
        "expand": args.expand,
...
export interface GetPublicIPPrefixResult {
     ...
     */
    readonly customIPPrefix?: types.outputs.network.v20230401.SubResourceResponse;
    /**
     ...
     */
    readonly loadBalancerFrontendIpConfiguration: types.outputs.network.v20230401.SubResourceResponse;
    /**
     * Resource location.
     */
     ...
     */
    readonly publicIPAddresses: types.outputs.network.v20230401.ReferencedPublicIpAddressResponse[];
    /**
     ...
     */
    readonly sku?: types.outputs.network.v20230401.PublicIPPrefixSkuResponse;
    /**
     * Resource tags.
     */

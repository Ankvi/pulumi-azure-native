...
export class VirtualHubRouteTableV2 extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230401:VirtualHubRouteTableV2';
     ...
     * List of all routes.
     */
    public readonly routes!: pulumi.Output<types.outputs.network.v20230401.VirtualHubRouteV2Response[] | undefined>;
...
export interface VirtualHubRouteTableV2Args {
     ...
     * List of all routes.
     */
    routes?: pulumi.Input<pulumi.Input<types.inputs.network.v20230401.VirtualHubRouteV2Args>[]>;
    /**

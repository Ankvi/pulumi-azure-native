...
export function getConnectionMonitor(args: GetConnectionMonitorArgs, opts?: pulumi.InvokeOptions): Promise<GetConnectionMonitorResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230401:getConnectionMonitor", {
...
export interface GetConnectionMonitorResult {
     ...
     */
    readonly destination?: types.outputs.network.v20230401.ConnectionMonitorDestinationResponse;
    /**
     * List of connection monitor endpoints.
     */
    readonly endpoints?: types.outputs.network.v20230401.ConnectionMonitorEndpointResponse[];
    /**
     ...
     */
    readonly outputs?: types.outputs.network.v20230401.ConnectionMonitorOutputResponse[];
    /**
     ...
     */
    readonly source?: types.outputs.network.v20230401.ConnectionMonitorSourceResponse;
    /**
     ...
     */
    readonly testConfigurations?: types.outputs.network.v20230401.ConnectionMonitorTestConfigurationResponse[];
    /**
     * List of connection monitor test groups.
     */
    readonly testGroups?: types.outputs.network.v20230401.ConnectionMonitorTestGroupResponse[];
    /**

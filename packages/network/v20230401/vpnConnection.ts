...
export class VpnConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230401:VpnConnection';
     ...
     */
    public readonly remoteVpnSite!: pulumi.Output<types.outputs.network.v20230401.SubResourceResponse | undefined>;
    /**
     ...
     */
    public readonly vpnLinkConnections!: pulumi.Output<types.outputs.network.v20230401.VpnSiteLinkConnectionResponse[] | undefined>;
...
export interface VpnConnectionArgs {
     ...
     * Id of the connected vpn site.
     */
    remoteVpnSite?: pulumi.Input<types.inputs.network.v20230401.SubResourceArgs>;
    /**
     ...
     * Connection protocol used for this connection.
     */
    vpnConnectionProtocolType?: pulumi.Input<string | types.enums.v20230401.VirtualNetworkGatewayConnectionProtocol>;
    /**
     * List of all vpn site link connections to the gateway.
     */
    vpnLinkConnections?: pulumi.Input<pulumi.Input<types.inputs.network.v20230401.VpnSiteLinkConnectionArgs>[]>;
}

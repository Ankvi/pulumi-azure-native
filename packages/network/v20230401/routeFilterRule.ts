...
export class RouteFilterRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230401:RouteFilterRule';
...
export interface RouteFilterRuleArgs {
     ...
     * The access type of the rule.
     */
    access: pulumi.Input<string | types.enums.v20230401.Access>;
    /**
     * The collection for bgp community values to filter on. e.g. ['12076:5010','12076:5020'].
     */
     ...
     * The rule type of the rule.
     */
    routeFilterRuleType: pulumi.Input<string | types.enums.v20230401.RouteFilterRuleType>;
    /**

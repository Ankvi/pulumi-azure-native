...
export class PacketCapture extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230401:PacketCapture';
     ...
     */
    public readonly filters!: pulumi.Output<types.outputs.network.v20230401.PacketCaptureFilterResponse[] | undefined>;
    /**
     ...
     */
    public readonly scope!: pulumi.Output<types.outputs.network.v20230401.PacketCaptureMachineScopeResponse | undefined>;
    /**
     * The storage location for a packet capture session.
     */
    public readonly storageLocation!: pulumi.Output<types.outputs.network.v20230401.PacketCaptureStorageLocationResponse>;
    /**
...
export interface PacketCaptureArgs {
     ...
     * A list of packet capture filters.
     */
    filters?: pulumi.Input<pulumi.Input<types.inputs.network.v20230401.PacketCaptureFilterArgs>[]>;
    /**
     ...
     * A list of AzureVMSS instances which can be included or excluded to run packet capture. If both included and excluded are empty, then the packet capture will run on all instances of AzureVMSS.
     */
    scope?: pulumi.Input<types.inputs.network.v20230401.PacketCaptureMachineScopeArgs>;
    /**
     * The storage location for a packet capture session.
     */
    storageLocation: pulumi.Input<types.inputs.network.v20230401.PacketCaptureStorageLocationArgs>;
    /**
     * The ID of the targeted resource, only AzureVM and AzureVMSS as target type are currently supported.
     */
     ...
     * Target type of the resource provided.
     */
    targetType?: pulumi.Input<types.enums.v20230401.PacketCaptureTargetType>;
    /**
     * Maximum duration of the capture session in seconds.
     */

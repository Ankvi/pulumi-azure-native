...
export interface GetNatRuleResult {
     ...
     */
    readonly egressVpnSiteLinkConnections: types.outputs.network.v20230401.SubResourceResponse[];
    /**
     ...
     */
    readonly ingressVpnSiteLinkConnections: types.outputs.network.v20230401.SubResourceResponse[];
    /**

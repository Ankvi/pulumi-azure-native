...
export class ServiceEndpointPolicyDefinition extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230401:ServiceEndpointPolicyDefinition';

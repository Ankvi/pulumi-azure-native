...
export class PublicIPAddress extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230401:PublicIPAddress';
     ...
     */
    public readonly ddosSettings!: pulumi.Output<types.outputs.network.v20230401.DdosSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly dnsSettings!: pulumi.Output<types.outputs.network.v20230401.PublicIPAddressDnsSettingsResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly ipConfiguration!: pulumi.Output<types.outputs.network.v20230401.IPConfigurationResponse>;
    /**
     * The list of tags associated with the public IP address.
     */
    public readonly ipTags!: pulumi.Output<types.outputs.network.v20230401.IpTagResponse[] | undefined>;
    /**
     * The linked public IP address of the public IP address resource.
     */
    public readonly linkedPublicIPAddress!: pulumi.Output<types.outputs.network.v20230401.PublicIPAddressResponse | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly natGateway!: pulumi.Output<types.outputs.network.v20230401.NatGatewayResponse | undefined>;
    /**
     ...
     */
    public readonly publicIPPrefix!: pulumi.Output<types.outputs.network.v20230401.SubResourceResponse | undefined>;
    /**
     ...
     */
    public readonly servicePublicIPAddress!: pulumi.Output<types.outputs.network.v20230401.PublicIPAddressResponse | undefined>;
    /**
     * The public IP address SKU.
     */
    public readonly sku!: pulumi.Output<types.outputs.network.v20230401.PublicIPAddressSkuResponse | undefined>;
    /**
     * Resource tags.
     */
...
export interface PublicIPAddressArgs {
     ...
     * The DDoS protection custom policy associated with the public IP address.
     */
    ddosSettings?: pulumi.Input<types.inputs.network.v20230401.DdosSettingsArgs>;
    /**
     * Specify what happens to the public IP address when the VM using it is deleted
     */
    deleteOption?: pulumi.Input<string | types.enums.v20230401.DeleteOptions>;
    /**
     * The FQDN of the DNS record associated with the public IP address.
     */
    dnsSettings?: pulumi.Input<types.inputs.network.v20230401.PublicIPAddressDnsSettingsArgs>;
    /**
     * The extended location of the public ip address.
     */
     ...
     * The list of tags associated with the public IP address.
     */
    ipTags?: pulumi.Input<pulumi.Input<types.inputs.network.v20230401.IpTagArgs>[]>;
    /**
     * The linked public IP address of the public IP address resource.
     */
    linkedPublicIPAddress?: pulumi.Input<types.inputs.network.v20230401.PublicIPAddressArgs>;
    /**
     * Resource location.
     */
     ...
     * Migration phase of Public IP Address.
     */
    migrationPhase?: pulumi.Input<string | types.enums.v20230401.PublicIPAddressMigrationPhase>;
    /**
     * The NatGateway for the Public IP address.
     */
    natGateway?: pulumi.Input<types.inputs.network.v20230401.NatGatewayArgs>;
    /**
     * The public IP address version.
     */
    publicIPAddressVersion?: pulumi.Input<string | types.enums.v20230401.IPVersion>;
    /**
     * The public IP address allocation method.
     */
    publicIPAllocationMethod?: pulumi.Input<string | types.enums.v20230401.IPAllocationMethod>;
    /**
     * The Public IP Prefix this Public IP Address should be allocated from.
     */
    publicIPPrefix?: pulumi.Input<types.inputs.network.v20230401.SubResourceArgs>;
    /**
     ...
     * The service public IP address of the public IP address resource.
     */
    servicePublicIPAddress?: pulumi.Input<types.inputs.network.v20230401.PublicIPAddressArgs>;
    /**
     * The public IP address SKU.
     */
    sku?: pulumi.Input<types.inputs.network.v20230401.PublicIPAddressSkuArgs>;
    /**
     * Resource tags.
     */

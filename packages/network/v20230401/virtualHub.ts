...
export class VirtualHub extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230401:VirtualHub';
     ...
     */
    public readonly azureFirewall!: pulumi.Output<types.outputs.network.v20230401.SubResourceResponse | undefined>;
    /**
     * List of references to Bgp Connections.
     */
    public /*out*/ readonly bgpConnections!: pulumi.Output<types.outputs.network.v20230401.SubResourceResponse[]>;
    /**
     ...
     */
    public readonly expressRouteGateway!: pulumi.Output<types.outputs.network.v20230401.SubResourceResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly ipConfigurations!: pulumi.Output<types.outputs.network.v20230401.SubResourceResponse[]>;
    /**
     ...
     */
    public readonly p2SVpnGateway!: pulumi.Output<types.outputs.network.v20230401.SubResourceResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly routeMaps!: pulumi.Output<types.outputs.network.v20230401.SubResourceResponse[]>;
    /**
     * The routeTable associated with this virtual hub.
     */
    public readonly routeTable!: pulumi.Output<types.outputs.network.v20230401.VirtualHubRouteTableResponse | undefined>;
    /**
     * The routing state.
     */
     ...
     */
    public readonly securityPartnerProvider!: pulumi.Output<types.outputs.network.v20230401.SubResourceResponse | undefined>;
    /**
     ...
     */
    public readonly virtualHubRouteTableV2s!: pulumi.Output<types.outputs.network.v20230401.VirtualHubRouteTableV2Response[] | undefined>;
    /**
     * VirtualRouter ASN.
     */
     ...
     */
    public readonly virtualRouterAutoScaleConfiguration!: pulumi.Output<types.outputs.network.v20230401.VirtualRouterAutoScaleConfigurationResponse | undefined>;
    /**
     * VirtualRouter IPs.
     */
     ...
     */
    public readonly virtualWan!: pulumi.Output<types.outputs.network.v20230401.SubResourceResponse | undefined>;
    /**
     * The VpnGateway associated with this VirtualHub.
     */
    public readonly vpnGateway!: pulumi.Output<types.outputs.network.v20230401.SubResourceResponse | undefined>;
...
export interface VirtualHubArgs {
     ...
     * The azureFirewall associated with this VirtualHub.
     */
    azureFirewall?: pulumi.Input<types.inputs.network.v20230401.SubResourceArgs>;
    /**
     * The expressRouteGateway associated with this VirtualHub.
     */
    expressRouteGateway?: pulumi.Input<types.inputs.network.v20230401.SubResourceArgs>;
    /**
     * The hubRoutingPreference of this VirtualHub.
     */
    hubRoutingPreference?: pulumi.Input<string | types.enums.v20230401.HubRoutingPreference>;
    /**
     * Resource ID.
     */
     ...
     * The P2SVpnGateway associated with this VirtualHub.
     */
    p2SVpnGateway?: pulumi.Input<types.inputs.network.v20230401.SubResourceArgs>;
    /**
     * The preferred gateway to route on-prem traffic
     */
    preferredRoutingGateway?: pulumi.Input<string | types.enums.v20230401.PreferredRoutingGateway>;
    /**
     ...
     * The routeTable associated with this virtual hub.
     */
    routeTable?: pulumi.Input<types.inputs.network.v20230401.VirtualHubRouteTableArgs>;
    /**
     * The securityPartnerProvider associated with this VirtualHub.
     */
    securityPartnerProvider?: pulumi.Input<types.inputs.network.v20230401.SubResourceArgs>;
    /**
     * The Security Provider name.
     */
     ...
     * List of all virtual hub route table v2s associated with this VirtualHub.
     */
    virtualHubRouteTableV2s?: pulumi.Input<pulumi.Input<types.inputs.network.v20230401.VirtualHubRouteTableV2Args>[]>;
    /**
     * VirtualRouter ASN.
     */
     ...
     * The VirtualHub Router autoscale configuration.
     */
    virtualRouterAutoScaleConfiguration?: pulumi.Input<types.inputs.network.v20230401.VirtualRouterAutoScaleConfigurationArgs>;
    /**
     * VirtualRouter IPs.
     */
     ...
     * The VirtualWAN to which the VirtualHub belongs.
     */
    virtualWan?: pulumi.Input<types.inputs.network.v20230401.SubResourceArgs>;
    /**
     * The VpnGateway associated with this VirtualHub.
     */
    vpnGateway?: pulumi.Input<types.inputs.network.v20230401.SubResourceArgs>;
}

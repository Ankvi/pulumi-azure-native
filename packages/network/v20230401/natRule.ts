...
export class NatRule extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly egressVpnSiteLinkConnections!: pulumi.Output<types.outputs.network.v20230401.SubResourceResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly ingressVpnSiteLinkConnections!: pulumi.Output<types.outputs.network.v20230401.SubResourceResponse[]>;
    /**

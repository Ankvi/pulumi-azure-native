...
export class AdminRuleCollection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230401:AdminRuleCollection';
     ...
     */
    public readonly appliesToGroups!: pulumi.Output<types.outputs.network.v20230401.NetworkManagerSecurityGroupItemResponse[]>;
    /**
...
export interface AdminRuleCollectionArgs {
     ...
     * Groups for configuration
     */
    appliesToGroups: pulumi.Input<pulumi.Input<types.inputs.network.v20230401.NetworkManagerSecurityGroupItemArgs>[]>;
    /**

...
export interface ListNetworkManagerEffectiveSecurityAdminRulesResult {
     ...
     */
    readonly value?: (types.outputs.network.v20230401.EffectiveDefaultSecurityAdminRuleResponse | types.outputs.network.v20230401.EffectiveSecurityAdminRuleResponse)[];
}
/**
 * List all effective security admin rules applied on a virtual network.
 */

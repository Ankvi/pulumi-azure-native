...
export class VirtualNetworkGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230401:VirtualNetworkGateway';
     ...
     */
    public readonly bgpSettings!: pulumi.Output<types.outputs.network.v20230401.BgpSettingsResponse | undefined>;
    /**
     * The reference to the address space resource which represents the custom routes address space specified by the customer for virtual network gateway and VpnClient.
     */
    public readonly customRoutes!: pulumi.Output<types.outputs.network.v20230401.AddressSpaceResponse | undefined>;
    /**
     ...
     */
    public readonly extendedLocation!: pulumi.Output<types.outputs.network.v20230401.ExtendedLocationResponse | undefined>;
    /**
     * The reference to the LocalNetworkGateway resource which represents local network site having default routes. Assign Null value in case of removing existing default site setting.
     */
    public readonly gatewayDefaultSite!: pulumi.Output<types.outputs.network.v20230401.SubResourceResponse | undefined>;
    /**
     ...
     */
    public readonly ipConfigurations!: pulumi.Output<types.outputs.network.v20230401.VirtualNetworkGatewayIPConfigurationResponse[] | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly natRules!: pulumi.Output<types.outputs.network.v20230401.VirtualNetworkGatewayNatRuleResponse[] | undefined>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<types.outputs.network.v20230401.VirtualNetworkGatewaySkuResponse | undefined>;
    /**
     * Resource tags.
     */
     ...
     */
    public readonly virtualNetworkGatewayPolicyGroups!: pulumi.Output<types.outputs.network.v20230401.VirtualNetworkGatewayPolicyGroupResponse[] | undefined>;
    /**
     * The reference to the VpnClientConfiguration resource which represents the P2S VpnClient configurations.
     */
    public readonly vpnClientConfiguration!: pulumi.Output<types.outputs.network.v20230401.VpnClientConfigurationResponse | undefined>;
    /**
...
export interface VirtualNetworkGatewayArgs {
     ...
     * Property to indicate if the Express Route Gateway serves traffic when there are multiple Express Route Gateways in the vnet
     */
    adminState?: pulumi.Input<string | types.enums.v20230401.AdminState>;
    /**
     * Configure this gateway to accept traffic from other Azure Virtual Networks. This configuration does not support connectivity to Azure Virtual WAN.
     */
     ...
     * Virtual network gateway's BGP speaker settings.
     */
    bgpSettings?: pulumi.Input<types.inputs.network.v20230401.BgpSettingsArgs>;
    /**
     * The reference to the address space resource which represents the custom routes address space specified by the customer for virtual network gateway and VpnClient.
     */
    customRoutes?: pulumi.Input<types.inputs.network.v20230401.AddressSpaceArgs>;
    /**
     * disableIPSecReplayProtection flag.
     */
     ...
     * The extended location of type local virtual network gateway.
     */
    extendedLocation?: pulumi.Input<types.inputs.network.v20230401.ExtendedLocationArgs>;
    /**
     * The reference to the LocalNetworkGateway resource which represents local network site having default routes. Assign Null value in case of removing existing default site setting.
     */
    gatewayDefaultSite?: pulumi.Input<types.inputs.network.v20230401.SubResourceArgs>;
    /**
     * The type of this virtual network gateway.
     */
    gatewayType?: pulumi.Input<string | types.enums.v20230401.VirtualNetworkGatewayType>;
    /**
     * Resource ID.
     */
     ...
     * IP configurations for virtual network gateway.
     */
    ipConfigurations?: pulumi.Input<pulumi.Input<types.inputs.network.v20230401.VirtualNetworkGatewayIPConfigurationArgs>[]>;
    /**
     * Resource location.
     */
     ...
     */
    natRules?: pulumi.Input<pulumi.Input<types.inputs.network.v20230401.VirtualNetworkGatewayNatRuleArgs>[]>;
    /**
     ...
     * The reference to the VirtualNetworkGatewaySku resource which represents the SKU selected for Virtual network gateway.
     */
    sku?: pulumi.Input<types.inputs.network.v20230401.VirtualNetworkGatewaySkuArgs>;
    /**
     * Resource tags.
     */
     ...
     * The reference to the VirtualNetworkGatewayPolicyGroup resource which represents the available VirtualNetworkGatewayPolicyGroup for the gateway.
     */
    virtualNetworkGatewayPolicyGroups?: pulumi.Input<pulumi.Input<types.inputs.network.v20230401.VirtualNetworkGatewayPolicyGroupArgs>[]>;
    /**
     * The reference to the VpnClientConfiguration resource which represents the P2S VpnClient configurations.
     */
    vpnClientConfiguration?: pulumi.Input<types.inputs.network.v20230401.VpnClientConfigurationArgs>;
    /**
     * The generation for this VirtualNetworkGateway. Must be None if gatewayType is not VPN.
     */
    vpnGatewayGeneration?: pulumi.Input<string | types.enums.v20230401.VpnGatewayGeneration>;
    /**
     * The type of this virtual network gateway.
     */
    vpnType?: pulumi.Input<string | types.enums.v20230401.VpnType>;
}

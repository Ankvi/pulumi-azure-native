...
export function getCustomIPPrefix(args: GetCustomIPPrefixArgs, opts?: pulumi.InvokeOptions): Promise<GetCustomIPPrefixResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230401:getCustomIPPrefix", {
...
export interface GetCustomIPPrefixResult {
     ...
     */
    readonly childCustomIpPrefixes: types.outputs.network.v20230401.SubResourceResponse[];
    /**
     ...
     */
    readonly customIpPrefixParent?: types.outputs.network.v20230401.SubResourceResponse;
    /**

...
export class NetworkManager extends pulumi.CustomResource {
     ...
     */
    public readonly networkManagerScopes!: pulumi.Output<types.outputs.network.v20230401.NetworkManagerPropertiesResponseNetworkManagerScopes>;
    /**
...
export interface NetworkManagerArgs {
     ...
     * Scope Access.
     */
    networkManagerScopeAccesses: pulumi.Input<pulumi.Input<string | types.enums.v20230401.ConfigurationType>[]>;
    /**
     * Scope of Network Manager.
     */
    networkManagerScopes: pulumi.Input<types.inputs.network.v20230401.NetworkManagerPropertiesNetworkManagerScopesArgs>;
    /**

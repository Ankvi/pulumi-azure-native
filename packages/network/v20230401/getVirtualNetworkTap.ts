...
export interface GetVirtualNetworkTapResult {
     ...
     */
    readonly destinationLoadBalancerFrontEndIPConfiguration?: types.outputs.network.v20230401.FrontendIPConfigurationResponse;
    /**
     * The reference to the private IP Address of the collector nic that will receive the tap.
     */
    readonly destinationNetworkInterfaceIPConfiguration?: types.outputs.network.v20230401.NetworkInterfaceIPConfigurationResponse;
    /**
     ...
     */
    readonly networkInterfaceTapConfigurations: types.outputs.network.v20230401.NetworkInterfaceTapConfigurationResponse[];
    /**

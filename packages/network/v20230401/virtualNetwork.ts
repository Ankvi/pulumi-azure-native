...
export class VirtualNetwork extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230401:VirtualNetwork';
     ...
     */
    public readonly addressSpace!: pulumi.Output<types.outputs.network.v20230401.AddressSpaceResponse | undefined>;
    /**
     * Bgp Communities sent over ExpressRoute with each route corresponding to a prefix in this VNET.
     */
    public readonly bgpCommunities!: pulumi.Output<types.outputs.network.v20230401.VirtualNetworkBgpCommunitiesResponse | undefined>;
    /**
     * The DDoS protection plan associated with the virtual network.
     */
    public readonly ddosProtectionPlan!: pulumi.Output<types.outputs.network.v20230401.SubResourceResponse | undefined>;
    /**
     * The dhcpOptions that contains an array of DNS servers available to VMs deployed in the virtual network.
     */
    public readonly dhcpOptions!: pulumi.Output<types.outputs.network.v20230401.DhcpOptionsResponse | undefined>;
    /**
     ...
     */
    public readonly encryption!: pulumi.Output<types.outputs.network.v20230401.VirtualNetworkEncryptionResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly flowLogs!: pulumi.Output<types.outputs.network.v20230401.FlowLogResponse[]>;
    /**
     ...
     */
    public readonly subnets!: pulumi.Output<types.outputs.network.v20230401.SubnetResponse[] | undefined>;
    /**
     * Resource tags.
     */
     ...
     */
    public readonly virtualNetworkPeerings!: pulumi.Output<types.outputs.network.v20230401.VirtualNetworkPeeringResponse[] | undefined>;
...
export interface VirtualNetworkArgs {
     ...
     * The AddressSpace that contains an array of IP address ranges that can be used by subnets.
     */
    addressSpace?: pulumi.Input<types.inputs.network.v20230401.AddressSpaceArgs>;
    /**
     * Bgp Communities sent over ExpressRoute with each route corresponding to a prefix in this VNET.
     */
    bgpCommunities?: pulumi.Input<types.inputs.network.v20230401.VirtualNetworkBgpCommunitiesArgs>;
    /**
     * The DDoS protection plan associated with the virtual network.
     */
    ddosProtectionPlan?: pulumi.Input<types.inputs.network.v20230401.SubResourceArgs>;
    /**
     * The dhcpOptions that contains an array of DNS servers available to VMs deployed in the virtual network.
     */
    dhcpOptions?: pulumi.Input<types.inputs.network.v20230401.DhcpOptionsArgs>;
    /**
     * Indicates if DDoS protection is enabled for all the protected resources in the virtual network. It requires a DDoS protection plan associated with the resource.
     */
     ...
     * Indicates if encryption is enabled on virtual network and if VM without encryption is allowed in encrypted VNet.
     */
    encryption?: pulumi.Input<types.inputs.network.v20230401.VirtualNetworkEncryptionArgs>;
    /**
     * The extended location of the virtual network.
     */
     ...
     */
    subnets?: pulumi.Input<pulumi.Input<types.inputs.network.v20230401.SubnetArgs>[]>;
    /**
     * Resource tags.
     */
     ...
     * These are also available as standalone resources. Do not mix inline and standalone resource as they will conflict with each other, leading to resources deletion.
     */
    virtualNetworkPeerings?: pulumi.Input<pulumi.Input<types.inputs.network.v20230401.VirtualNetworkPeeringArgs>[]>;
}

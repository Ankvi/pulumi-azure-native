...
export function getExpressRouteCircuitPeering(args: GetExpressRouteCircuitPeeringArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRouteCircuitPeeringResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230401:getExpressRouteCircuitPeering", {
...
export interface GetExpressRouteCircuitPeeringResult {
     ...
     */
    readonly connections?: types.outputs.network.v20230401.ExpressRouteCircuitConnectionResponse[];
    /**
     ...
     */
    readonly expressRouteConnection?: types.outputs.network.v20230401.ExpressRouteConnectionIdResponse;
    /**
     ...
     */
    readonly ipv6PeeringConfig?: types.outputs.network.v20230401.Ipv6ExpressRouteCircuitPeeringConfigResponse;
    /**
     ...
     */
    readonly microsoftPeeringConfig?: types.outputs.network.v20230401.ExpressRouteCircuitPeeringConfigResponse;
    /**
     ...
     */
    readonly peeredConnections: types.outputs.network.v20230401.PeerExpressRouteCircuitConnectionResponse[];
    /**
     * The peering type.
     */
     ...
     */
    readonly routeFilter?: types.outputs.network.v20230401.SubResourceResponse;
    /**
     * The secondary port.
     */
     ...
     */
    readonly stats?: types.outputs.network.v20230401.ExpressRouteCircuitStatsResponse;
    /**

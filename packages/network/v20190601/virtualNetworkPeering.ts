...
export class VirtualNetworkPeering extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20190601:VirtualNetworkPeering';

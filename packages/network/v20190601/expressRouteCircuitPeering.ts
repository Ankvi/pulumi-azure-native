...
export class ExpressRouteCircuitPeering extends pulumi.CustomResource {
     ...
     */
    public readonly connections!: pulumi.Output<types.outputs.network.v20190601.ExpressRouteCircuitConnectionResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly expressRouteConnection!: pulumi.Output<types.outputs.network.v20190601.ExpressRouteConnectionIdResponse | undefined>;
    /**
     ...
     */
    public readonly ipv6PeeringConfig!: pulumi.Output<types.outputs.network.v20190601.Ipv6ExpressRouteCircuitPeeringConfigResponse | undefined>;
    /**
     ...
     */
    public readonly microsoftPeeringConfig!: pulumi.Output<types.outputs.network.v20190601.ExpressRouteCircuitPeeringConfigResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly peeredConnections!: pulumi.Output<types.outputs.network.v20190601.PeerExpressRouteCircuitConnectionResponse[]>;
    /**
     * The peering type.
     */
     ...
     */
    public readonly routeFilter!: pulumi.Output<types.outputs.network.v20190601.SubResourceResponse | undefined>;
    /**
     * The secondary port.
     */
     ...
     * Gets peering stats.
     */
    public readonly stats!: pulumi.Output<types.outputs.network.v20190601.ExpressRouteCircuitStatsResponse | undefined>;
    /**
...
export interface ExpressRouteCircuitPeeringArgs {
     ...
     */
    connections?: pulumi.Input<pulumi.Input<types.inputs.network.v20190601.ExpressRouteCircuitConnectionArgs>[]>;
    /**
     * The GatewayManager Etag.
     */
     ...
     * The IPv6 peering configuration.
     */
    ipv6PeeringConfig?: pulumi.Input<types.inputs.network.v20190601.Ipv6ExpressRouteCircuitPeeringConfigArgs>;
    /**
     * Gets whether the provider or the customer last modified the peering.
     */
     ...
     * The Microsoft peering configuration.
     */
    microsoftPeeringConfig?: pulumi.Input<types.inputs.network.v20190601.ExpressRouteCircuitPeeringConfigArgs>;
    /**
     * Gets name of the resource that is unique within a resource group. This name can be used to access the resource.
     */
     ...
     * The peering type.
     */
    peeringType?: pulumi.Input<string | types.enums.v20190601.ExpressRoutePeeringType>;
    /**
     * The primary port.
     */
     ...
     * The reference of the RouteFilter resource.
     */
    routeFilter?: pulumi.Input<types.inputs.network.v20190601.SubResourceArgs>;
    /**
     * The secondary port.
     */
     ...
     * The peering state.
     */
    state?: pulumi.Input<string | types.enums.v20190601.ExpressRoutePeeringState>;
    /**
     * Gets peering stats.
     */
    stats?: pulumi.Input<types.inputs.network.v20190601.ExpressRouteCircuitStatsArgs>;
    /**
     * The VLAN ID.
     */

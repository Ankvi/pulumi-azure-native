...
export interface GetExpressRouteCircuitPeeringResult {
     ...
     */
    readonly connections?: types.outputs.network.v20190601.ExpressRouteCircuitConnectionResponse[];
    /**
     ...
     */
    readonly expressRouteConnection?: types.outputs.network.v20190601.ExpressRouteConnectionIdResponse;
    /**
     ...
     */
    readonly ipv6PeeringConfig?: types.outputs.network.v20190601.Ipv6ExpressRouteCircuitPeeringConfigResponse;
    /**
     ...
     */
    readonly microsoftPeeringConfig?: types.outputs.network.v20190601.ExpressRouteCircuitPeeringConfigResponse;
    /**
     ...
     */
    readonly peeredConnections: types.outputs.network.v20190601.PeerExpressRouteCircuitConnectionResponse[];
    /**
     * The peering type.
     */
     ...
     */
    readonly routeFilter?: types.outputs.network.v20190601.SubResourceResponse;
    /**
     * The secondary port.
     */
     ...
     * Gets peering stats.
     */
    readonly stats?: types.outputs.network.v20190601.ExpressRouteCircuitStatsResponse;
    /**

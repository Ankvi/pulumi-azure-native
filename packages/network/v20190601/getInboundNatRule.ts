...
export interface GetInboundNatRuleResult {
     ...
     */
    readonly backendIPConfiguration: types.outputs.network.v20190601.NetworkInterfaceIPConfigurationResponse;
    /**
     ...
     */
    readonly frontendIPConfiguration?: types.outputs.network.v20190601.SubResourceResponse;
    /**

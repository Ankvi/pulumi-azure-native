...
export class InboundEndpoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20200401preview:InboundEndpoint';
     ...
     */
    public readonly ipConfigurations!: pulumi.Output<types.outputs.network.v20200401preview.InboundEndpointIPConfigurationResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: InboundEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:InboundEndpoint" }, { type: "azure-native:network/v20220701:InboundEndpoint" }] };
...
export interface InboundEndpointArgs {
     ...
     * IP configurations for the inbound endpoint.
     */
    ipConfigurations?: pulumi.Input<pulumi.Input<types.inputs.network.v20200401preview.InboundEndpointIPConfigurationArgs>[]>;
    /**
     * The geo-location where the resource lives
     */

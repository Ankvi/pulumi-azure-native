...
export class OutboundEndpoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20200401preview:OutboundEndpoint';
    ...
    constructor(name: string, args: OutboundEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:OutboundEndpoint" }, { type: "azure-native:network/v20220701:OutboundEndpoint" }] };

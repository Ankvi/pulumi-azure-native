...
export class PrivateDnsZoneGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20210201:PrivateDnsZoneGroup';
     ...
     */
    public readonly privateDnsZoneConfigs!: pulumi.Output<types.outputs.network.v20210201.PrivateDnsZoneConfigResponse[] | undefined>;
    /**
...
export interface PrivateDnsZoneGroupArgs {
     ...
     * A collection of private dns zone configurations of the private dns zone group.
     */
    privateDnsZoneConfigs?: pulumi.Input<pulumi.Input<types.inputs.network.v20210201.PrivateDnsZoneConfigArgs>[]>;
    /**

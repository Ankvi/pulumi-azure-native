...
export class BastionHost extends pulumi.CustomResource {
     ...
     */
    declare public readonly ipConfigurations: pulumi.Output<types.outputs.BastionHostIPConfigurationResponse[] | undefined>;
    /**
     * Resource location.
     */
    ...
    declare public readonly networkAcls: pulumi.Output<types.outputs.BastionHostPropertiesFormatResponseNetworkAcls | undefined>;
    /**

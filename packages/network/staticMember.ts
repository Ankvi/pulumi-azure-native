...
export class StaticMember extends pulumi.CustomResource {
    ...
    constructor(name: string, args: StaticMemberArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["staticMemberName"] = args?.staticMemberName;

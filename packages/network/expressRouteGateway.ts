...
export class ExpressRouteGateway extends pulumi.CustomResource {
     ...
     */
    declare public readonly autoScaleConfiguration: pulumi.Output<types.outputs.ExpressRouteGatewayPropertiesResponseAutoScaleConfiguration | undefined>;
    /**
     ...
     */
    declare public readonly expressRouteConnections: pulumi.Output<types.outputs.ExpressRouteConnectionResponse[] | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    declare public readonly virtualHub: pulumi.Output<types.outputs.VirtualHubIdResponse>;

...
export class ReachabilityAnalysisRun extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.ReachabilityAnalysisRunPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ReachabilityAnalysisRunArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["reachabilityAnalysisRunName"] = args?.reachabilityAnalysisRunName;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20240101preview:ReachabilityAnalysisRun" }, { type: "azure-native:network/v20240501:ReachabilityAnalysisRun" }, { type: "azure-native:network/v20240701:ReachabilityAnalysisRun" }, { type: "azure-native:network/v20241001:ReachabilityAnalysisRun" }] };

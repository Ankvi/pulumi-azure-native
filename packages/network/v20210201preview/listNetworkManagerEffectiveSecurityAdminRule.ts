...
export interface ListNetworkManagerEffectiveSecurityAdminRuleResult {
     ...
     */
    readonly value?: (types.outputs.network.v20210201preview.EffectiveDefaultSecurityAdminRuleResponse | types.outputs.network.v20210201preview.EffectiveSecurityAdminRuleResponse)[];
}
/**
 * List all effective security admin rules applied on a virtual network.
 */

...
export class AdminRuleCollection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20210201preview:AdminRuleCollection';

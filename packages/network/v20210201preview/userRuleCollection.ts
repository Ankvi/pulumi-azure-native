...
export class UserRuleCollection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20210201preview:UserRuleCollection';
     ...
     */
    public readonly appliesToGroups!: pulumi.Output<types.outputs.network.v20210201preview.NetworkManagerSecurityGroupItemResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: UserRuleCollectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:UserRuleCollection" }, { type: "azure-native:network/v20210501preview:UserRuleCollection" }, { type: "azure-native:network/v20220201preview:UserRuleCollection" }, { type: "azure-native:network/v20220401preview:UserRuleCollection" }] };
...
export interface UserRuleCollectionArgs {
     ...
     * Groups for configuration
     */
    appliesToGroups?: pulumi.Input<pulumi.Input<types.inputs.network.v20210201preview.NetworkManagerSecurityGroupItemArgs>[]>;
    /**

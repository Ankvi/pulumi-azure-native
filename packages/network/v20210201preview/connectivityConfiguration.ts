...
export class ConnectivityConfiguration extends pulumi.CustomResource {
     ...
     */
    public readonly appliesToGroups!: pulumi.Output<types.outputs.network.v20210201preview.ConnectivityGroupItemResponse[] | undefined>;
    /**
     ...
     * List of hubItems
     */
    public readonly hubs!: pulumi.Output<types.outputs.network.v20210201preview.HubResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: ConnectivityConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:ConnectivityConfiguration" }, { type: "azure-native:network/v20210501preview:ConnectivityConfiguration" }, { type: "azure-native:network/v20220101:ConnectivityConfiguration" }, { type: "azure-native:network/v20220201preview:ConnectivityConfiguration" }, { type: "azure-native:network/v20220401preview:ConnectivityConfiguration" }, { type: "azure-native:network/v20220501:ConnectivityConfiguration" }, { type: "azure-native:network/v20220701:ConnectivityConfiguration" }, { type: "azure-native:network/v20220901:ConnectivityConfiguration" }, { type: "azure-native:network/v20221101:ConnectivityConfiguration" }, { type: "azure-native:network/v20230201:ConnectivityConfiguration" }, { type: "azure-native:network/v20230401:ConnectivityConfiguration" }, { type: "azure-native:network/v20230501:ConnectivityConfiguration" }] };
...
export interface ConnectivityConfigurationArgs {
     ...
     * Groups for configuration
     */
    appliesToGroups?: pulumi.Input<pulumi.Input<types.inputs.network.v20210201preview.ConnectivityGroupItemArgs>[]>;
    /**
     ...
     * Connectivity topology type.
     */
    connectivityTopology: pulumi.Input<string | types.enums.v20210201preview.ConnectivityTopology>;
    /**
     * Flag if need to remove current existing peerings.
     */
    deleteExistingPeering?: pulumi.Input<string | types.enums.v20210201preview.DeleteExistingPeering>;
    /**
     * A description of the connectivity configuration.
     */
     ...
     * List of hubItems
     */
    hubs?: pulumi.Input<pulumi.Input<types.inputs.network.v20210201preview.HubArgs>[]>;
    /**
     * Flag if global mesh is supported.
     */
    isGlobal?: pulumi.Input<string | types.enums.v20210201preview.IsGlobal>;
    /**

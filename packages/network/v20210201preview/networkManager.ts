...
export class NetworkManager extends pulumi.CustomResource {
     ...
     */
    public readonly networkManagerScopes!: pulumi.Output<types.outputs.NetworkManagerPropertiesResponseNetworkManagerScopes | undefined>;
    /**

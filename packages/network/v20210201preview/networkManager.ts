...
export class NetworkManager extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20210201preview:NetworkManager';
     ...
     */
    public readonly networkManagerScopes!: pulumi.Output<types.outputs.network.v20210201preview.NetworkManagerPropertiesResponseNetworkManagerScopes | undefined>;
    /**
    ...
    constructor(name: string, args: NetworkManagerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:NetworkManager" }, { type: "azure-native:network/v20210501preview:NetworkManager" }, { type: "azure-native:network/v20220101:NetworkManager" }, { type: "azure-native:network/v20220201preview:NetworkManager" }, { type: "azure-native:network/v20220401preview:NetworkManager" }, { type: "azure-native:network/v20220501:NetworkManager" }, { type: "azure-native:network/v20220701:NetworkManager" }, { type: "azure-native:network/v20220901:NetworkManager" }, { type: "azure-native:network/v20221101:NetworkManager" }, { type: "azure-native:network/v20230201:NetworkManager" }, { type: "azure-native:network/v20230401:NetworkManager" }, { type: "azure-native:network/v20230501:NetworkManager" }] };
...
export interface NetworkManagerArgs {
     ...
     * Scope Access.
     */
    networkManagerScopeAccesses?: pulumi.Input<pulumi.Input<string | types.enums.v20210201preview.ConfigurationType>[]>;
    /**
     * Scope of Network Manager.
     */
    networkManagerScopes?: pulumi.Input<types.inputs.network.v20210201preview.NetworkManagerPropertiesNetworkManagerScopesArgs>;
    /**

...
export class NetworkSecurityPerimeter extends pulumi.CustomResource {
    ...
    constructor(name: string, args: NetworkSecurityPerimeterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:NetworkSecurityPerimeter" }, { type: "azure-native:network/v20210301preview:NetworkSecurityPerimeter" }, { type: "azure-native:network/v20230701preview:NetworkSecurityPerimeter" }, { type: "azure-native:network/v20230801preview:NetworkSecurityPerimeter" }] };

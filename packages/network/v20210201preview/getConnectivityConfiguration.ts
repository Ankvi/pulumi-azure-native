...
export interface GetConnectivityConfigurationResult {
     ...
     */
    readonly appliesToGroups?: types.outputs.network.v20210201preview.ConnectivityGroupItemResponse[];
    /**
     ...
     * List of hubItems
     */
    readonly hubs?: types.outputs.network.v20210201preview.HubResponse[];
    /**
     * Resource ID.
     */
    readonly id: string;

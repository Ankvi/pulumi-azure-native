...
export class NetworkVirtualApplianceConnection extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.NetworkVirtualApplianceConnectionPropertiesResponse>;

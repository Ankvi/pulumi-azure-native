...
export class P2sVpnServerConfiguration extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.P2SVpnServerConfigurationPropertiesResponse>;
    ...
    constructor(name: string, args: P2sVpnServerConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            if (args?.virtualWanName === undefined && !opts.urn) {
                throw new Error("Missing required property 'virtualWanName'");
            }
            resourceInputs["id"] = args?.id;
            resourceInputs["name"] = args?.name;
            resourceInputs["p2SVpnServerConfigurationName"] = args?.p2SVpnServerConfigurationName;

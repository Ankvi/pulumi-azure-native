...
export class ExpressRouteGateway extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly expressRouteConnections!: pulumi.Output<types.outputs.ExpressRouteConnectionResponse[]>;
    /**
     * Resource location.
     */

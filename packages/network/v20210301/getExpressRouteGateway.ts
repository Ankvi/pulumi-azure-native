...
export interface GetExpressRouteGatewayResult {
     ...
     */
    readonly autoScaleConfiguration?: types.outputs.network.v20210301.ExpressRouteGatewayPropertiesResponseAutoScaleConfiguration;
    /**
     ...
     */
    readonly expressRouteConnections: types.outputs.network.v20210301.ExpressRouteConnectionResponse[];
    /**
     * Resource ID.
     */
    readonly id?: string;
     ...
     */
    readonly virtualHub: types.outputs.network.v20210301.VirtualHubIdResponse;
}
/**
 * Fetches the details of a ExpressRoute gateway in a resource group.
 */

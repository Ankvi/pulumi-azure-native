...
export class PrivateResolverVirtualNetworkLink extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220701:PrivateResolverVirtualNetworkLink';
    ...
    constructor(name: string, args: PrivateResolverVirtualNetworkLinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:PrivateResolverVirtualNetworkLink" }, { type: "azure-native:network/v20200401preview:PrivateResolverVirtualNetworkLink" }] };

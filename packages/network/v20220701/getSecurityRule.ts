...
export function getSecurityRule(args: GetSecurityRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetSecurityRuleResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20220701:getSecurityRule", {
...
export interface GetSecurityRuleResult {
     ...
     */
    readonly destinationApplicationSecurityGroups?: types.outputs.network.v20220701.ApplicationSecurityGroupResponse[];
    /**
     ...
     */
    readonly sourceApplicationSecurityGroups?: types.outputs.network.v20220701.ApplicationSecurityGroupResponse[];
    /**

...
export class DnsForwardingRuleset extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220701:DnsForwardingRuleset';
     ...
     */
    public readonly dnsResolverOutboundEndpoints!: pulumi.Output<types.outputs.network.v20220701.SubResourceResponse[]>;
    /**
    ...
    constructor(name: string, args: DnsForwardingRulesetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:DnsForwardingRuleset" }, { type: "azure-native:network/v20200401preview:DnsForwardingRuleset" }] };
...
export interface DnsForwardingRulesetArgs {
     ...
     * The reference to the DNS resolver outbound endpoints that are used to route DNS queries matching the forwarding rules in the ruleset to the target DNS servers.
     */
    dnsResolverOutboundEndpoints: pulumi.Input<pulumi.Input<types.inputs.network.v20220701.SubResourceArgs>[]>;
    /**
     * The geo-location where the resource lives
     */

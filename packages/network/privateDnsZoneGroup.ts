...
export class PrivateDnsZoneGroup extends pulumi.CustomResource {
     ...
     */
    declare public readonly privateDnsZoneConfigs: pulumi.Output<types.outputs.PrivateDnsZoneConfigResponse[] | undefined>;
    /**

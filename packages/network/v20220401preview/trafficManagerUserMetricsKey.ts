...
export class TrafficManagerUserMetricsKey extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220401preview:TrafficManagerUserMetricsKey';
    ...
    constructor(name: string, args?: TrafficManagerUserMetricsKeyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:TrafficManagerUserMetricsKey" }, { type: "azure-native:network/v20180401:TrafficManagerUserMetricsKey" }, { type: "azure-native:network/v20180801:TrafficManagerUserMetricsKey" }, { type: "azure-native:network/v20220401:TrafficManagerUserMetricsKey" }] };

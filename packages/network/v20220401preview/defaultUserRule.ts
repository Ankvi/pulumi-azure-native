...
export class DefaultUserRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20220401preview:DefaultUserRule';
     ...
     */
    public /*out*/ readonly destinations!: pulumi.Output<types.outputs.network.v20220401preview.AddressPrefixItemResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly sources!: pulumi.Output<types.outputs.network.v20220401preview.AddressPrefixItemResponse[]>;
    /**
    ...
    constructor(name: string, args: DefaultUserRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:DefaultUserRule" }, { type: "azure-native:network/v20210201preview:DefaultUserRule" }, { type: "azure-native:network/v20210501preview:DefaultUserRule" }, { type: "azure-native:network/v20220201preview:DefaultUserRule" }] };

...
export class Profile extends pulumi.CustomResource {
     ...
     */
    public readonly dnsConfig!: pulumi.Output<types.outputs.network.v20220401preview.DnsConfigResponse | undefined>;
    /**
     * The list of endpoints in the Traffic Manager profile.
     */
    public readonly endpoints!: pulumi.Output<types.outputs.network.v20220401preview.EndpointResponse[] | undefined>;
    /**
     ...
     */
    public readonly monitorConfig!: pulumi.Output<types.outputs.network.v20220401preview.MonitorConfigResponse | undefined>;
    /**
...
export interface ProfileArgs {
     ...
     * The list of allowed endpoint record types.
     */
    allowedEndpointRecordTypes?: pulumi.Input<pulumi.Input<string | types.enums.v20220401preview.AllowedEndpointRecordType>[]>;
    /**
     * The DNS settings of the Traffic Manager profile.
     */
    dnsConfig?: pulumi.Input<types.inputs.network.v20220401preview.DnsConfigArgs>;
    /**
     * The list of endpoints in the Traffic Manager profile.
     */
    endpoints?: pulumi.Input<pulumi.Input<types.inputs.network.v20220401preview.EndpointArgs>[]>;
    /**
     ...
     * The endpoint monitoring settings of the Traffic Manager profile.
     */
    monitorConfig?: pulumi.Input<types.inputs.network.v20220401preview.MonitorConfigArgs>;
    /**
     * The name of the resource
     */
     ...
     * The status of the Traffic Manager profile.
     */
    profileStatus?: pulumi.Input<string | types.enums.v20220401preview.ProfileStatus>;
    /**
     ...
     * The traffic routing method of the Traffic Manager profile.
     */
    trafficRoutingMethod?: pulumi.Input<string | types.enums.v20220401preview.TrafficRoutingMethod>;
    /**
     * Indicates whether Traffic View is 'Enabled' or 'Disabled' for the Traffic Manager profile. Null, indicates 'Disabled'. Enabling this feature will increase the cost of the Traffic Manage profile.
     */
    trafficViewEnrollmentStatus?: pulumi.Input<string | types.enums.v20220401preview.TrafficViewEnrollmentStatus>;
    /**
     * The type of the resource. Ex- Microsoft.Network/trafficManagerProfiles.
     */

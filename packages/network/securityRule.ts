...
export class SecurityRule extends pulumi.CustomResource {
     ...
     */
    declare public readonly destinationApplicationSecurityGroups: pulumi.Output<types.outputs.ApplicationSecurityGroupResponse[] | undefined>;
    /**
     ...
     */
    declare public readonly sourceApplicationSecurityGroups: pulumi.Output<types.outputs.ApplicationSecurityGroupResponse[] | undefined>;
    /**

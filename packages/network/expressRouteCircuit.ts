...
export class ExpressRouteCircuit extends pulumi.CustomResource {
     ...
     */
    public readonly authorizations!: pulumi.Output<types.outputs.network.ExpressRouteCircuitAuthorizationResponse[] | undefined>;
    /**
     ...
     */
    public readonly expressRoutePort!: pulumi.Output<types.outputs.network.SubResourceResponse | undefined>;
    /**
     ...
     */
    public readonly peerings!: pulumi.Output<types.outputs.network.ExpressRouteCircuitPeeringResponse[] | undefined>;
    /**
     ...
     */
    public readonly serviceProviderProperties!: pulumi.Output<types.outputs.network.ExpressRouteCircuitServiceProviderPropertiesResponse | undefined>;
    /**
     ...
     * The SKU.
     */
    public readonly sku!: pulumi.Output<types.outputs.network.ExpressRouteCircuitSkuResponse | undefined>;
    /**
...
export interface ExpressRouteCircuitArgs {
     ...
     * The list of authorizations.
     */
    authorizations?: pulumi.Input<pulumi.Input<types.inputs.network.ExpressRouteCircuitAuthorizationArgs>[]>;
    /**
     * The bandwidth of the circuit when the circuit is provisioned on an ExpressRoutePort resource.
     */
     ...
     * The reference to the ExpressRoutePort resource when the circuit is provisioned on an ExpressRoutePort resource.
     */
    expressRoutePort?: pulumi.Input<types.inputs.network.SubResourceArgs>;
    /**
     * The GatewayManager Etag.
     */
     ...
     * The list of peerings.
     */
    peerings?: pulumi.Input<pulumi.Input<types.inputs.network.ExpressRouteCircuitPeeringArgs>[]>;
    /**
     ...
     * The ServiceProviderProperties.
     */
    serviceProviderProperties?: pulumi.Input<types.inputs.network.ExpressRouteCircuitServiceProviderPropertiesArgs>;
    /**
     * The ServiceProviderProvisioningState state of the resource.
     */
     ...
     * The SKU.
     */
    sku?: pulumi.Input<types.inputs.network.ExpressRouteCircuitSkuArgs>;
    /**
     * Resource tags.
     */

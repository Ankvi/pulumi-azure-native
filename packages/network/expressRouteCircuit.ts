...
export class ExpressRouteCircuit extends pulumi.CustomResource {
     ...
     */
    declare public readonly authorizations: pulumi.Output<types.outputs.ExpressRouteCircuitAuthorizationResponse[] | undefined>;
    /**
     ...
     */
    declare public readonly expressRoutePort: pulumi.Output<types.outputs.SubResourceResponse | undefined>;
    /**
     ...
     */
    declare public readonly peerings: pulumi.Output<types.outputs.ExpressRouteCircuitPeeringResponse[] | undefined>;
    /**
     ...
     */
    declare public readonly serviceProviderProperties: pulumi.Output<types.outputs.ExpressRouteCircuitServiceProviderPropertiesResponse | undefined>;
    /**
     ...
     * The SKU.
     */
    declare public readonly sku: pulumi.Output<types.outputs.ExpressRouteCircuitSkuResponse | undefined>;
    /**

...
export interface GetPublicIPPrefixResult {
     ...
     */
    readonly loadBalancerFrontendIpConfiguration: types.outputs.network.v20190801.SubResourceResponse;
    /**
     * Resource location.
     */
     ...
     */
    readonly publicIPAddresses?: types.outputs.network.v20190801.ReferencedPublicIpAddressResponse[];
    /**
     ...
     */
    readonly sku?: types.outputs.network.v20190801.PublicIPPrefixSkuResponse;
    /**
     * Resource tags.
     */

...
export interface GetNetworkSecurityGroupResult {
     ...
     */
    readonly defaultSecurityRules?: types.outputs.network.v20190801.SecurityRuleResponse[];
    /**
     ...
     */
    readonly securityRules?: types.outputs.network.v20190801.SecurityRuleResponse[];
    /**

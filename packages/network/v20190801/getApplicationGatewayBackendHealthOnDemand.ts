...
export interface GetApplicationGatewayBackendHealthOnDemandArgs {
     ...
     */
    backendAddressPool?: types.inputs.network.v20190801.SubResource;
    /**
     * Reference of backend http setting of application gateway to be used for test probe.
     */
    backendHttpSettings?: types.inputs.network.v20190801.SubResource;
    /**
     ...
     */
    match?: types.inputs.network.v20190801.ApplicationGatewayProbeHealthResponseMatch;
    /**
     ...
     */
    protocol?: string | types.enums.v20190801.ApplicationGatewayProtocol;
    /**
...
export interface GetApplicationGatewayBackendHealthOnDemandResult {
     ...
     */
    readonly backendAddressPool?: types.outputs.network.v20190801.ApplicationGatewayBackendAddressPoolResponse;
    /**
     * Application gateway BackendHealthHttp settings.
     */
    readonly backendHealthHttpSettings?: types.outputs.network.v20190801.ApplicationGatewayBackendHealthHttpSettingsResponse;
}
/**
 * Gets the backend health for given combination of backend pool and http setting of the specified application gateway in a resource group.
 */
...
export interface GetApplicationGatewayBackendHealthOnDemandOutputArgs {
     ...
     * Reference of backend pool of application gateway to which probe request will be sent.
     */
    backendAddressPool?: pulumi.Input<types.inputs.network.v20190801.SubResourceArgs>;
    /**
     * Reference of backend http setting of application gateway to be used for test probe.
     */
    backendHttpSettings?: pulumi.Input<types.inputs.network.v20190801.SubResourceArgs>;
    /**
     * Expands BackendAddressPool and BackendHttpSettings referenced in backend health.
     */
     ...
     * Criterion for classifying a healthy probe response.
     */
    match?: pulumi.Input<types.inputs.network.v20190801.ApplicationGatewayProbeHealthResponseMatchArgs>;
    /**
     * Relative path of probe. Valid path starts from '/'. Probe is sent to <Protocol>://<host>:<port><path>.
     */
     ...
     * The protocol used for the probe.
     */
    protocol?: pulumi.Input<string | types.enums.v20190801.ApplicationGatewayProtocol>;
    /**
     * The name of the resource group.
     */

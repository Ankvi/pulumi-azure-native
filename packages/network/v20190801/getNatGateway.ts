...
export interface GetNatGatewayResult {
     ...
     */
    readonly publicIpAddresses?: types.outputs.network.v20190801.SubResourceResponse[];
    /**
     * An array of public ip prefixes associated with the nat gateway resource.
     */
    readonly publicIpPrefixes?: types.outputs.network.v20190801.SubResourceResponse[];
    /**
     ...
     * The nat gateway SKU.
     */
    readonly sku?: types.outputs.network.v20190801.NatGatewaySkuResponse;
    /**
     * An array of references to the subnets using this nat gateway resource.
     */
    readonly subnets: types.outputs.network.v20190801.SubResourceResponse[];
    /**
     * Resource tags.
     */

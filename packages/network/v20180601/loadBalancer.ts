...
export class LoadBalancer extends pulumi.CustomResource {
     ...
     */
    public readonly outboundNatRules!: pulumi.Output<types.outputs.OutboundNatRuleResponse[] | undefined>;
    /**
...
export interface LoadBalancerArgs {
     ...
     * The outbound NAT rules.
     */
    outboundNatRules?: pulumi.Input<pulumi.Input<types.inputs.OutboundNatRuleArgs>[]>;
    /**
     * Collection of probe objects used in the load balancer
     */

...
export class LoadBalancer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20180601:LoadBalancer';
     ...
     */
    public readonly backendAddressPools!: pulumi.Output<types.outputs.network.v20180601.BackendAddressPoolResponse[] | undefined>;
    /**
     ...
     */
    public readonly frontendIPConfigurations!: pulumi.Output<types.outputs.network.v20180601.FrontendIPConfigurationResponse[] | undefined>;
    /**
     * Defines an external port range for inbound NAT to a single backend port on NICs associated with a load balancer. Inbound NAT rules are created automatically for each NIC associated with the Load Balancer using an external port from this range. Defining an Inbound NAT pool on your Load Balancer is mutually exclusive with defining inbound Nat rules. Inbound NAT pools are referenced from virtual machine scale sets. NICs that are associated with individual virtual machines cannot reference an inbound NAT pool. They have to reference individual inbound NAT rules.
     */
    public readonly inboundNatPools!: pulumi.Output<types.outputs.network.v20180601.InboundNatPoolResponse[] | undefined>;
    /**
     * Collection of inbound NAT Rules used by a load balancer. Defining inbound NAT rules on your load balancer is mutually exclusive with defining an inbound NAT pool. Inbound NAT pools are referenced from virtual machine scale sets. NICs that are associated with individual virtual machines cannot reference an Inbound NAT pool. They have to reference individual inbound NAT rules.
     */
    public readonly inboundNatRules!: pulumi.Output<types.outputs.network.v20180601.InboundNatRuleResponse[] | undefined>;
    /**
     * Object collection representing the load balancing rules Gets the provisioning 
     */
    public readonly loadBalancingRules!: pulumi.Output<types.outputs.network.v20180601.LoadBalancingRuleResponse[] | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public readonly outboundNatRules!: pulumi.Output<types.outputs.network.v20180601.OutboundNatRuleResponse[] | undefined>;
    /**
     * Collection of probe objects used in the load balancer
     */
    public readonly probes!: pulumi.Output<types.outputs.network.v20180601.ProbeResponse[] | undefined>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<types.outputs.network.v20180601.LoadBalancerSkuResponse | undefined>;
    /**
     * Resource tags.
     */
...
export interface LoadBalancerArgs {
     ...
     * Collection of backend address pools used by a load balancer
     */
    backendAddressPools?: pulumi.Input<pulumi.Input<types.inputs.network.v20180601.BackendAddressPoolArgs>[]>;
    /**
     * Object representing the frontend IPs to be used for the load balancer
     */
    frontendIPConfigurations?: pulumi.Input<pulumi.Input<types.inputs.network.v20180601.FrontendIPConfigurationArgs>[]>;
    /**
     * Resource ID.
     */
     ...
     * Defines an external port range for inbound NAT to a single backend port on NICs associated with a load balancer. Inbound NAT rules are created automatically for each NIC associated with the Load Balancer using an external port from this range. Defining an Inbound NAT pool on your Load Balancer is mutually exclusive with defining inbound Nat rules. Inbound NAT pools are referenced from virtual machine scale sets. NICs that are associated with individual virtual machines cannot reference an inbound NAT pool. They have to reference individual inbound NAT rules.
     */
    inboundNatPools?: pulumi.Input<pulumi.Input<types.inputs.network.v20180601.InboundNatPoolArgs>[]>;
    /**
     * Collection of inbound NAT Rules used by a load balancer. Defining inbound NAT rules on your load balancer is mutually exclusive with defining an inbound NAT pool. Inbound NAT pools are referenced from virtual machine scale sets. NICs that are associated with individual virtual machines cannot reference an Inbound NAT pool. They have to reference individual inbound NAT rules.
     */
    inboundNatRules?: pulumi.Input<pulumi.Input<types.inputs.network.v20180601.InboundNatRuleArgs>[]>;
    /**
     ...
     * Object collection representing the load balancing rules Gets the provisioning 
     */
    loadBalancingRules?: pulumi.Input<pulumi.Input<types.inputs.network.v20180601.LoadBalancingRuleArgs>[]>;
    /**
     * Resource location.
     */
     ...
     * The outbound NAT rules.
     */
    outboundNatRules?: pulumi.Input<pulumi.Input<types.inputs.network.v20180601.OutboundNatRuleArgs>[]>;
    /**
     * Collection of probe objects used in the load balancer
     */
    probes?: pulumi.Input<pulumi.Input<types.inputs.network.v20180601.ProbeArgs>[]>;
    /**
     * Gets the provisioning state of the PublicIP resource. Possible values are: 'Updating', 'Deleting', and 'Failed'.
     */
     ...
     * The load balancer SKU.
     */
    sku?: pulumi.Input<types.inputs.network.v20180601.LoadBalancerSkuArgs>;
    /**
     * Resource tags.
     */

...
export class P2sVpnGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230501:P2sVpnGateway';
     ...
     */
    public readonly p2SConnectionConfigurations!: pulumi.Output<types.outputs.network.v20230501.P2SConnectionConfigurationResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly vpnClientConnectionHealth!: pulumi.Output<types.outputs.network.v20230501.VpnClientConnectionHealthResponse>;
    /**
     ...
     */
    public readonly vpnServerConfiguration!: pulumi.Output<types.outputs.network.v20230501.SubResourceResponse | undefined>;
...
export interface P2sVpnGatewayArgs {
     ...
     * List of all p2s connection configurations of the gateway.
     */
    p2SConnectionConfigurations?: pulumi.Input<pulumi.Input<types.inputs.network.v20230501.P2SConnectionConfigurationArgs>[]>;
    /**
     ...
     * The VpnServerConfiguration to which the p2sVpnGateway is attached to.
     */
    vpnServerConfiguration?: pulumi.Input<types.inputs.network.v20230501.SubResourceArgs>;
}

...
export class PrivateLinkService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230501:PrivateLinkService';
     ...
     */
    public readonly autoApproval!: pulumi.Output<types.outputs.network.v20230501.PrivateLinkServicePropertiesResponseAutoApproval | undefined>;
    /**
     ...
     */
    public readonly ipConfigurations!: pulumi.Output<types.outputs.network.v20230501.PrivateLinkServiceIpConfigurationResponse[] | undefined>;
    /**
     * An array of references to the load balancer IP configurations.
     */
    public readonly loadBalancerFrontendIpConfigurations!: pulumi.Output<types.outputs.network.v20230501.FrontendIPConfigurationResponse[] | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<types.outputs.network.v20230501.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public readonly visibility!: pulumi.Output<types.outputs.network.v20230501.PrivateLinkServicePropertiesResponseVisibility | undefined>;
...
export interface PrivateLinkServiceArgs {
     ...
     * The auto-approval list of the private link service.
     */
    autoApproval?: pulumi.Input<types.inputs.network.v20230501.PrivateLinkServicePropertiesAutoApprovalArgs>;
    /**
     * Whether the private link service is enabled for proxy protocol or not.
     */
     ...
     * An array of private link service IP configurations.
     */
    ipConfigurations?: pulumi.Input<pulumi.Input<types.inputs.network.v20230501.PrivateLinkServiceIpConfigurationArgs>[]>;
    /**
     * An array of references to the load balancer IP configurations.
     */
    loadBalancerFrontendIpConfigurations?: pulumi.Input<pulumi.Input<types.inputs.network.v20230501.FrontendIPConfigurationArgs>[]>;
    /**
     * Resource location.
     */
     ...
     * The visibility list of the private link service.
     */
    visibility?: pulumi.Input<types.inputs.network.v20230501.PrivateLinkServicePropertiesVisibilityArgs>;
}

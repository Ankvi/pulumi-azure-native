...
export function getConfigurationPolicyGroup(args: GetConfigurationPolicyGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetConfigurationPolicyGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230501:getConfigurationPolicyGroup", {
...
export interface GetConfigurationPolicyGroupResult {
     ...
     */
    readonly p2SConnectionConfigurations: types.outputs.network.v20230501.SubResourceResponse[];
    /**
     * Multiple PolicyMembers for VpnServerConfigurationPolicyGroup.
     */
    readonly policyMembers?: types.outputs.network.v20230501.VpnServerConfigurationPolicyGroupMemberResponse[];
    /**

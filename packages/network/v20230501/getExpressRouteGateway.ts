...
export interface GetExpressRouteGatewayResult {
     ...
     */
    readonly autoScaleConfiguration?: types.outputs.network.v20230501.ExpressRouteGatewayPropertiesResponseAutoScaleConfiguration;
    /**
     ...
     */
    readonly expressRouteConnections?: types.outputs.network.v20230501.ExpressRouteConnectionResponse[];
    /**
     * Resource ID.
     */
    readonly id?: string;
     ...
     */
    readonly virtualHub: types.outputs.network.v20230501.VirtualHubIdResponse;
}
/**
 * Fetches the details of a ExpressRoute gateway in a resource group.
 */

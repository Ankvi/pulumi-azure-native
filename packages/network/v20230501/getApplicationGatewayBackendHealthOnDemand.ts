...
export function getApplicationGatewayBackendHealthOnDemand(args: GetApplicationGatewayBackendHealthOnDemandArgs, opts?: pulumi.InvokeOptions): Promise<GetApplicationGatewayBackendHealthOnDemandResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230501:getApplicationGatewayBackendHealthOnDemand", {
...
export interface GetApplicationGatewayBackendHealthOnDemandArgs {
     ...
     */
    backendAddressPool?: types.inputs.network.v20230501.SubResource;
    /**
     * Reference to backend http setting of application gateway to be used for test probe.
     */
    backendHttpSettings?: types.inputs.network.v20230501.SubResource;
    /**
     ...
     */
    match?: types.inputs.network.v20230501.ApplicationGatewayProbeHealthResponseMatch;
    /**
     ...
     */
    protocol?: string | types.enums.v20230501.ApplicationGatewayProtocol;
    /**
...
export interface GetApplicationGatewayBackendHealthOnDemandResult {
     ...
     */
    readonly backendAddressPool?: types.outputs.network.v20230501.ApplicationGatewayBackendAddressPoolResponse;
    /**
     * Application gateway BackendHealthHttp settings.
     */
    readonly backendHealthHttpSettings?: types.outputs.network.v20230501.ApplicationGatewayBackendHealthHttpSettingsResponse;
}
/**
 * Gets the backend health for given combination of backend pool and http setting of the specified application gateway in a resource group.
 */
...
export interface GetApplicationGatewayBackendHealthOnDemandOutputArgs {
     ...
     * Reference to backend pool of application gateway to which probe request will be sent.
     */
    backendAddressPool?: pulumi.Input<types.inputs.network.v20230501.SubResourceArgs>;
    /**
     * Reference to backend http setting of application gateway to be used for test probe.
     */
    backendHttpSettings?: pulumi.Input<types.inputs.network.v20230501.SubResourceArgs>;
    /**
     * Expands BackendAddressPool and BackendHttpSettings referenced in backend health.
     */
     ...
     * Criterion for classifying a healthy probe response.
     */
    match?: pulumi.Input<types.inputs.network.v20230501.ApplicationGatewayProbeHealthResponseMatchArgs>;
    /**
     * Relative path of probe. Valid path starts from '/'. Probe is sent to <Protocol>://<host>:<port><path>.
     */
     ...
     * The protocol used for the probe.
     */
    protocol?: pulumi.Input<string | types.enums.v20230501.ApplicationGatewayProtocol>;
    /**
     * The name of the resource group.
     */

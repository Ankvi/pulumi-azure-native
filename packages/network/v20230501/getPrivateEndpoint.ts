...
export function getPrivateEndpoint(args: GetPrivateEndpointArgs, opts?: pulumi.InvokeOptions): Promise<GetPrivateEndpointResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230501:getPrivateEndpoint", {
        "expand": args.expand,
...
export interface GetPrivateEndpointResult {
     ...
     */
    readonly applicationSecurityGroups?: types.outputs.network.v20230501.ApplicationSecurityGroupResponse[];
    /**
     * An array of custom dns configurations.
     */
    readonly customDnsConfigs?: types.outputs.network.v20230501.CustomDnsConfigPropertiesFormatResponse[];
    /**
     ...
     */
    readonly ipConfigurations?: types.outputs.network.v20230501.PrivateEndpointIPConfigurationResponse[];
    /**
     * Resource location.
     */
     ...
     */
    readonly manualPrivateLinkServiceConnections?: types.outputs.network.v20230501.PrivateLinkServiceConnectionResponse[];
    /**
     * Resource name.
     */
     ...
     */
    readonly privateLinkServiceConnections?: types.outputs.network.v20230501.PrivateLinkServiceConnectionResponse[];
    /**
     ...
     */
    readonly subnet?: types.outputs.network.v20230501.SubnetResponse;
    /**
     * Resource tags.
     */

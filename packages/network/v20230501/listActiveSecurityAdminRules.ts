...
export function listActiveSecurityAdminRules(args: ListActiveSecurityAdminRulesArgs, opts?: pulumi.InvokeOptions): Promise<ListActiveSecurityAdminRulesResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230501:listActiveSecurityAdminRules", {
...
export interface ListActiveSecurityAdminRulesResult {
     ...
     */
    readonly value?: (types.outputs.network.v20230501.ActiveDefaultSecurityAdminRuleResponse | types.outputs.network.v20230501.ActiveSecurityAdminRuleResponse)[];
}
/**
 * Lists active security admin rules in a network manager.
 */

...
export class HubRouteTable extends pulumi.CustomResource {
     ...
     * List of all routes.
     */
    public readonly routes!: pulumi.Output<types.outputs.network.v20230501.HubRouteResponse[] | undefined>;
    /**
     * Resource type.
     */
...
export interface HubRouteTableArgs {
     ...
     * List of all routes.
     */
    routes?: pulumi.Input<pulumi.Input<types.inputs.network.v20230501.HubRouteArgs>[]>;
    /**

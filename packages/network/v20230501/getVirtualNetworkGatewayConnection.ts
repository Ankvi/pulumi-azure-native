...
export interface GetVirtualNetworkGatewayConnectionResult {
     ...
     */
    readonly egressNatRules?: types.outputs.network.v20230501.SubResourceResponse[];
    /**
     * EnableBgp flag.
     */
     ...
     */
    readonly gatewayCustomBgpIpAddresses?: types.outputs.network.v20230501.GatewayCustomBgpIpAddressIpConfigurationResponse[];
    /**
     * Resource ID.
     */
    readonly id?: string;
     ...
     */
    readonly ingressNatRules?: types.outputs.network.v20230501.SubResourceResponse[];
    /**
     * The IPSec Policies to be considered by this connection.
     */
    readonly ipsecPolicies?: types.outputs.network.v20230501.IpsecPolicyResponse[];
    /**
     * The reference to local network gateway resource.
     */
    readonly localNetworkGateway2?: types.outputs.network.v20230501.LocalNetworkGatewayResponse;
    /**
     * Resource location.
     */
     ...
     */
    readonly peer?: types.outputs.network.v20230501.SubResourceResponse;
    /**
     ...
     */
    readonly trafficSelectorPolicies?: types.outputs.network.v20230501.TrafficSelectorPolicyResponse[];
    /**
     * Collection of all tunnels' connection health status.
     */
    readonly tunnelConnectionStatus: types.outputs.network.v20230501.TunnelConnectionHealthResponse[];
    /**
     * Resource type.
     */
     ...
     */
    readonly virtualNetworkGateway1: types.outputs.network.v20230501.VirtualNetworkGatewayResponse;
    /**
     * The reference to virtual network gateway resource.
     */
    readonly virtualNetworkGateway2?: types.outputs.network.v20230501.VirtualNetworkGatewayResponse;
}
/**
 * Gets the specified virtual network gateway connection by resource group.
 */

...
export function getFirewallPolicyRuleCollectionGroup(args: GetFirewallPolicyRuleCollectionGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetFirewallPolicyRuleCollectionGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230501:getFirewallPolicyRuleCollectionGroup", {
...
export interface GetFirewallPolicyRuleCollectionGroupResult {
     ...
     */
    readonly ruleCollections?: (types.outputs.network.v20230501.FirewallPolicyFilterRuleCollectionResponse | types.outputs.network.v20230501.FirewallPolicyNatRuleCollectionResponse)[];
    /**

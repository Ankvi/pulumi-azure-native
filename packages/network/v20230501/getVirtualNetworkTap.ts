...
export function getVirtualNetworkTap(args: GetVirtualNetworkTapArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkTapResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230501:getVirtualNetworkTap", {
...
export interface GetVirtualNetworkTapResult {
     ...
     */
    readonly destinationLoadBalancerFrontEndIPConfiguration?: types.outputs.network.v20230501.FrontendIPConfigurationResponse;
    /**
     * The reference to the private IP Address of the collector nic that will receive the tap.
     */
    readonly destinationNetworkInterfaceIPConfiguration?: types.outputs.network.v20230501.NetworkInterfaceIPConfigurationResponse;
    /**
     ...
     */
    readonly networkInterfaceTapConfigurations: types.outputs.network.v20230501.NetworkInterfaceTapConfigurationResponse[];
    /**

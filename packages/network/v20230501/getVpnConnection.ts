...
export function getVpnConnection(args: GetVpnConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetVpnConnectionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230501:getVpnConnection", {
...
export interface GetVpnConnectionResult {
     ...
     */
    readonly remoteVpnSite?: types.outputs.network.v20230501.SubResourceResponse;
    /**
     * The Routing Configuration indicating the associated and propagated route tables on this connection.
     */
    readonly routingConfiguration?: types.outputs.network.v20230501.RoutingConfigurationResponse;
    /**
     ...
     */
    readonly vpnLinkConnections?: types.outputs.network.v20230501.VpnSiteLinkConnectionResponse[];
}
/**
 * Retrieves the details of a vpn connection.
 */

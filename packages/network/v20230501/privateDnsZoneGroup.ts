...
export class PrivateDnsZoneGroup extends pulumi.CustomResource {
     ...
     */
    public readonly privateDnsZoneConfigs!: pulumi.Output<types.outputs.network.v20230501.PrivateDnsZoneConfigResponse[] | undefined>;
    /**
...
export interface PrivateDnsZoneGroupArgs {
     ...
     * A collection of private dns zone configurations of the private dns zone group.
     */
    privateDnsZoneConfigs?: pulumi.Input<pulumi.Input<types.inputs.network.v20230501.PrivateDnsZoneConfigArgs>[]>;
    /**

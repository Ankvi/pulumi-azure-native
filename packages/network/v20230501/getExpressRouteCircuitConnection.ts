...
export function getExpressRouteCircuitConnection(args: GetExpressRouteCircuitConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRouteCircuitConnectionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230501:getExpressRouteCircuitConnection", {
...
export interface GetExpressRouteCircuitConnectionResult {
     ...
     */
    readonly expressRouteCircuitPeering?: types.outputs.network.v20230501.SubResourceResponse;
    /**
     * Resource ID.
     */
    readonly id?: string;
     ...
     */
    readonly ipv6CircuitConnectionConfig?: types.outputs.network.v20230501.Ipv6CircuitConnectionConfigResponse;
    /**
     ...
     */
    readonly peerExpressRouteCircuitPeering?: types.outputs.network.v20230501.SubResourceResponse;
    /**

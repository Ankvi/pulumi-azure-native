...
export class ConnectivityConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230501:ConnectivityConfiguration';
     ...
     */
    public readonly appliesToGroups!: pulumi.Output<types.outputs.network.v20230501.ConnectivityGroupItemResponse[]>;
    /**
     ...
     * List of hubItems
     */
    public readonly hubs!: pulumi.Output<types.outputs.network.v20230501.HubResponse[] | undefined>;
    /**
...
export interface ConnectivityConfigurationArgs {
     ...
     * Groups for configuration
     */
    appliesToGroups: pulumi.Input<pulumi.Input<types.inputs.network.v20230501.ConnectivityGroupItemArgs>[]>;
    /**
     ...
     * Connectivity topology type.
     */
    connectivityTopology: pulumi.Input<string | types.enums.v20230501.ConnectivityTopology>;
    /**
     * Flag if need to remove current existing peerings.
     */
    deleteExistingPeering?: pulumi.Input<string | types.enums.v20230501.DeleteExistingPeering>;
    /**
     * A description of the connectivity configuration.
     */
     ...
     * List of hubItems
     */
    hubs?: pulumi.Input<pulumi.Input<types.inputs.network.v20230501.HubArgs>[]>;
    /**
     * Flag if global mesh is supported.
     */
    isGlobal?: pulumi.Input<string | types.enums.v20230501.IsGlobal>;
    /**

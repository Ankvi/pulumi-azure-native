...
export function getVirtualNetworkGateway(args: GetVirtualNetworkGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkGatewayResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230501:getVirtualNetworkGateway", {
...
export interface GetVirtualNetworkGatewayResult {
     ...
     */
    readonly autoScaleConfiguration?: types.outputs.network.v20230501.VirtualNetworkGatewayAutoScaleConfigurationResponse;
    /**
     * Virtual network gateway's BGP speaker settings.
     */
    readonly bgpSettings?: types.outputs.network.v20230501.BgpSettingsResponse;
    /**
     * The reference to the address space resource which represents the custom routes address space specified by the customer for virtual network gateway and VpnClient.
     */
    readonly customRoutes?: types.outputs.network.v20230501.AddressSpaceResponse;
    /**
     ...
     */
    readonly gatewayDefaultSite?: types.outputs.network.v20230501.SubResourceResponse;
    /**
     ...
     */
    readonly ipConfigurations?: types.outputs.network.v20230501.VirtualNetworkGatewayIPConfigurationResponse[];
    /**
     * Resource location.
     */
     ...
     */
    readonly natRules?: types.outputs.network.v20230501.VirtualNetworkGatewayNatRuleResponse[];
    /**
     ...
     */
    readonly sku?: types.outputs.network.v20230501.VirtualNetworkGatewaySkuResponse;
    /**
     * Resource tags.
     */
     ...
     */
    readonly virtualNetworkGatewayPolicyGroups?: types.outputs.network.v20230501.VirtualNetworkGatewayPolicyGroupResponse[];
    /**
     * The reference to the VpnClientConfiguration resource which represents the P2S VpnClient configurations.
     */
    readonly vpnClientConfiguration?: types.outputs.network.v20230501.VpnClientConfigurationResponse;
    /**

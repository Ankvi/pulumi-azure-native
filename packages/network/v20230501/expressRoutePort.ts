...
export class ExpressRoutePort extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230501:ExpressRoutePort';
     ...
     */
    public /*out*/ readonly circuits!: pulumi.Output<types.outputs.network.v20230501.SubResourceResponse[]>;
    /**
     ...
     */
    public readonly links!: pulumi.Output<types.outputs.network.v20230501.ExpressRouteLinkResponse[] | undefined>;
    /**
     * Resource location.
     */
...
export interface ExpressRoutePortArgs {
     ...
     * The billing type of the ExpressRoutePort resource.
     */
    billingType?: pulumi.Input<string | types.enums.v20230501.ExpressRoutePortsBillingType>;
    /**
     * Encapsulation method on physical ports.
     */
    encapsulation?: pulumi.Input<string | types.enums.v20230501.ExpressRoutePortsEncapsulation>;
    /**
     ...
     * The set of physical links of the ExpressRoutePort resource.
     */
    links?: pulumi.Input<pulumi.Input<types.inputs.network.v20230501.ExpressRouteLinkArgs>[]>;
    /**
     * Resource location.
     */

...
export class VirtualHubBgpConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230501:VirtualHubBgpConnection';
     ...
     */
    public readonly hubVirtualNetworkConnection!: pulumi.Output<types.outputs.network.v20230501.SubResourceResponse | undefined>;
    /**
...
export interface VirtualHubBgpConnectionArgs {
     ...
     * The reference to the HubVirtualNetworkConnection resource.
     */
    hubVirtualNetworkConnection?: pulumi.Input<types.inputs.network.v20230501.SubResourceArgs>;
    /**
     * Resource ID.
     */

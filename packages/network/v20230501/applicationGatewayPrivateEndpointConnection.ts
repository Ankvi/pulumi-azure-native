...
export class ApplicationGatewayPrivateEndpointConnection extends pulumi.CustomResource {
     ...
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<types.outputs.network.v20230501.PrivateLinkServiceConnectionStateResponse | undefined>;
    /**
...
export interface ApplicationGatewayPrivateEndpointConnectionArgs {
     ...
     * A collection of information about the state of the connection between service consumer and provider.
     */
    privateLinkServiceConnectionState?: pulumi.Input<types.inputs.network.v20230501.PrivateLinkServiceConnectionStateArgs>;
    /**

...
export class NetworkVirtualApplianceConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230501:NetworkVirtualApplianceConnection';
    ...
    constructor(name: string, args: NetworkVirtualApplianceConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network:NetworkVirtualApplianceConnection" }, { type: "azure-native:network/v20221101:NetworkVirtualApplianceConnection" }, { type: "azure-native:network/v20230201:NetworkVirtualApplianceConnection" }, { type: "azure-native:network/v20230401:NetworkVirtualApplianceConnection" }] };

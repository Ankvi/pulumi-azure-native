...
export function getExpressRoutePort(args: GetExpressRoutePortArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRoutePortResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230501:getExpressRoutePort", {
...
export interface GetExpressRoutePortResult {
     ...
     */
    readonly circuits: types.outputs.network.v20230501.SubResourceResponse[];
    /**
     ...
     */
    readonly links?: types.outputs.network.v20230501.ExpressRouteLinkResponse[];
    /**
     * Resource location.
     */

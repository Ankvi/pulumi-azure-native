...
export function getLoadBalancerBackendAddressPool(args: GetLoadBalancerBackendAddressPoolArgs, opts?: pulumi.InvokeOptions): Promise<GetLoadBalancerBackendAddressPoolResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230501:getLoadBalancerBackendAddressPool", {
...
export interface GetLoadBalancerBackendAddressPoolResult {
     ...
     */
    readonly backendIPConfigurations: types.outputs.network.v20230501.NetworkInterfaceIPConfigurationResponse[];
    /**
     ...
     */
    readonly inboundNatRules: types.outputs.network.v20230501.SubResourceResponse[];
    /**
     * An array of backend addresses.
     */
    readonly loadBalancerBackendAddresses?: types.outputs.network.v20230501.LoadBalancerBackendAddressResponse[];
    /**
     * An array of references to load balancing rules that use this backend address pool.
     */
    readonly loadBalancingRules: types.outputs.network.v20230501.SubResourceResponse[];
    /**
     ...
     */
    readonly outboundRule: types.outputs.network.v20230501.SubResourceResponse;
    /**
     * An array of references to outbound rules that use this backend address pool.
     */
    readonly outboundRules: types.outputs.network.v20230501.SubResourceResponse[];
    /**
     ...
     */
    readonly tunnelInterfaces?: types.outputs.network.v20230501.GatewayLoadBalancerTunnelInterfaceResponse[];
    /**

...
export function getLocalNetworkGateway(args: GetLocalNetworkGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetLocalNetworkGatewayResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230501:getLocalNetworkGateway", {
...
export interface GetLocalNetworkGatewayResult {
     ...
     */
    readonly localNetworkAddressSpace?: types.outputs.network.v20230501.AddressSpaceResponse;
    /**
     * Resource location.
     */

...
export class ExpressRouteCircuit extends pulumi.CustomResource {
     ...
     */
    public readonly authorizations!: pulumi.Output<types.outputs.network.v20230501.ExpressRouteCircuitAuthorizationResponse[] | undefined>;
    /**
     ...
     */
    public readonly expressRoutePort!: pulumi.Output<types.outputs.network.v20230501.SubResourceResponse | undefined>;
    /**
     ...
     */
    public readonly peerings!: pulumi.Output<types.outputs.network.v20230501.ExpressRouteCircuitPeeringResponse[] | undefined>;
    /**
     ...
     */
    public readonly serviceProviderProperties!: pulumi.Output<types.outputs.network.v20230501.ExpressRouteCircuitServiceProviderPropertiesResponse | undefined>;
    /**
     ...
     * The SKU.
     */
    public readonly sku!: pulumi.Output<types.outputs.network.v20230501.ExpressRouteCircuitSkuResponse | undefined>;
    /**
...
export interface ExpressRouteCircuitArgs {
     ...
     * The reference to the ExpressRoutePort resource when the circuit is provisioned on an ExpressRoutePort resource.
     */
    expressRoutePort?: pulumi.Input<types.inputs.network.v20230501.SubResourceArgs>;
    /**
     * The GatewayManager Etag.
     */
     ...
     * The ServiceProviderProperties.
     */
    serviceProviderProperties?: pulumi.Input<types.inputs.network.v20230501.ExpressRouteCircuitServiceProviderPropertiesArgs>;
    /**
     * The ServiceProviderProvisioningState state of the resource.
     */
    serviceProviderProvisioningState?: pulumi.Input<string | types.enums.v20230501.ServiceProviderProvisioningState>;
    /**
     * The SKU.
     */
    sku?: pulumi.Input<types.inputs.network.v20230501.ExpressRouteCircuitSkuArgs>;
    /**
     * Resource tags.
     */

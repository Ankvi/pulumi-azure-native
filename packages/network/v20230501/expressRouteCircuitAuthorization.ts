...
export interface ExpressRouteCircuitAuthorizationArgs {
     ...
     * The authorization use status.
     */
    authorizationUseStatus?: pulumi.Input<string | types.enums.v20230501.AuthorizationUseStatus>;
    /**

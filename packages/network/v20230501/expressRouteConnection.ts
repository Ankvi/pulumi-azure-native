...
export class ExpressRouteConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230501:ExpressRouteConnection';
     ...
     */
    public readonly expressRouteCircuitPeering!: pulumi.Output<types.outputs.network.v20230501.ExpressRouteCircuitPeeringIdResponse>;
    /**
...
export interface ExpressRouteConnectionArgs {
     ...
     * The ExpressRoute circuit peering.
     */
    expressRouteCircuitPeering: pulumi.Input<types.inputs.network.v20230501.ExpressRouteCircuitPeeringIdArgs>;
    /**
     * Enable FastPath to vWan Firewall hub.
     */

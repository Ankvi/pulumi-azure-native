...
export class LoadBalancer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230501:LoadBalancer';
     ...
     */
    public readonly backendAddressPools!: pulumi.Output<types.outputs.network.v20230501.BackendAddressPoolResponse[] | undefined>;
    /**
     ...
     */
    public readonly frontendIPConfigurations!: pulumi.Output<types.outputs.network.v20230501.FrontendIPConfigurationResponse[] | undefined>;
    /**
     * Defines an external port range for inbound NAT to a single backend port on NICs associated with a load balancer. Inbound NAT rules are created automatically for each NIC associated with the Load Balancer using an external port from this range. Defining an Inbound NAT pool on your Load Balancer is mutually exclusive with defining inbound NAT rules. Inbound NAT pools are referenced from virtual machine scale sets. NICs that are associated with individual virtual machines cannot reference an inbound NAT pool. They have to reference individual inbound NAT rules.
     */
    public readonly inboundNatPools!: pulumi.Output<types.outputs.network.v20230501.InboundNatPoolResponse[] | undefined>;
    /**
     * Collection of inbound NAT Rules used by a load balancer. Defining inbound NAT rules on your load balancer is mutually exclusive with defining an inbound NAT pool. Inbound NAT pools are referenced from virtual machine scale sets. NICs that are associated with individual virtual machines cannot reference an Inbound NAT pool. They have to reference individual inbound NAT rules.
     */
    public readonly inboundNatRules!: pulumi.Output<types.outputs.network.v20230501.InboundNatRuleResponse[] | undefined>;
    /**
     * Object collection representing the load balancing rules Gets the provisioning.
     */
    public readonly loadBalancingRules!: pulumi.Output<types.outputs.network.v20230501.LoadBalancingRuleResponse[] | undefined>;
    /**
     * Resource location.
     */
     ...
     * The outbound rules.
     */
    public readonly outboundRules!: pulumi.Output<types.outputs.network.v20230501.OutboundRuleResponse[] | undefined>;
    /**
     * Collection of probe objects used in the load balancer.
     */
    public readonly probes!: pulumi.Output<types.outputs.network.v20230501.ProbeResponse[] | undefined>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<types.outputs.network.v20230501.LoadBalancerSkuResponse | undefined>;
    /**
     * Resource tags.
     */
...
export interface LoadBalancerArgs {
     ...
     * Collection of backend address pools used by a load balancer.
     */
    backendAddressPools?: pulumi.Input<pulumi.Input<types.inputs.network.v20230501.BackendAddressPoolArgs>[]>;
    /**
     * The extended location of the load balancer.
     */
     ...
     * Object representing the frontend IPs to be used for the load balancer.
     */
    frontendIPConfigurations?: pulumi.Input<pulumi.Input<types.inputs.network.v20230501.FrontendIPConfigurationArgs>[]>;
    /**
     * Resource ID.
     */
     ...
     * Defines an external port range for inbound NAT to a single backend port on NICs associated with a load balancer. Inbound NAT rules are created automatically for each NIC associated with the Load Balancer using an external port from this range. Defining an Inbound NAT pool on your Load Balancer is mutually exclusive with defining inbound NAT rules. Inbound NAT pools are referenced from virtual machine scale sets. NICs that are associated with individual virtual machines cannot reference an inbound NAT pool. They have to reference individual inbound NAT rules.
     */
    inboundNatPools?: pulumi.Input<pulumi.Input<types.inputs.network.v20230501.InboundNatPoolArgs>[]>;
    /**
     * Collection of inbound NAT Rules used by a load balancer. Defining inbound NAT rules on your load balancer is mutually exclusive with defining an inbound NAT pool. Inbound NAT pools are referenced from virtual machine scale sets. NICs that are associated with individual virtual machines cannot reference an Inbound NAT pool. They have to reference individual inbound NAT rules.
     */
    inboundNatRules?: pulumi.Input<pulumi.Input<types.inputs.network.v20230501.InboundNatRuleArgs>[]>;
    /**
     ...
     * Object collection representing the load balancing rules Gets the provisioning.
     */
    loadBalancingRules?: pulumi.Input<pulumi.Input<types.inputs.network.v20230501.LoadBalancingRuleArgs>[]>;
    /**
     * Resource location.
     */
     ...
     * The outbound rules.
     */
    outboundRules?: pulumi.Input<pulumi.Input<types.inputs.network.v20230501.OutboundRuleArgs>[]>;
    /**
     * Collection of probe objects used in the load balancer.
     */
    probes?: pulumi.Input<pulumi.Input<types.inputs.network.v20230501.ProbeArgs>[]>;
    /**
     ...
     * The load balancer SKU.
     */
    sku?: pulumi.Input<types.inputs.network.v20230501.LoadBalancerSkuArgs>;
    /**
     * Resource tags.
     */

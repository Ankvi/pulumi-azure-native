...
export class LocalNetworkGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230501:LocalNetworkGateway';
     ...
     */
    public readonly localNetworkAddressSpace!: pulumi.Output<types.outputs.network.v20230501.AddressSpaceResponse | undefined>;
    /**
     * Resource location.
     */
...
export interface LocalNetworkGatewayArgs {
     ...
     * Local network site address space.
     */
    localNetworkAddressSpace?: pulumi.Input<types.inputs.network.v20230501.AddressSpaceArgs>;
    /**

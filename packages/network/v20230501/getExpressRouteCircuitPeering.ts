...
export function getExpressRouteCircuitPeering(args: GetExpressRouteCircuitPeeringArgs, opts?: pulumi.InvokeOptions): Promise<GetExpressRouteCircuitPeeringResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230501:getExpressRouteCircuitPeering", {
...
export interface GetExpressRouteCircuitPeeringResult {
     ...
     */
    readonly connections?: types.outputs.network.v20230501.ExpressRouteCircuitConnectionResponse[];
    /**
     ...
     */
    readonly expressRouteConnection?: types.outputs.network.v20230501.ExpressRouteConnectionIdResponse;
    /**
     ...
     */
    readonly peeredConnections: types.outputs.network.v20230501.PeerExpressRouteCircuitConnectionResponse[];
    /**
     * The peering type.
     */
     ...
     */
    readonly routeFilter?: types.outputs.network.v20230501.SubResourceResponse;
    /**
     * The secondary port.
     */
     ...
     */
    readonly stats?: types.outputs.network.v20230501.ExpressRouteCircuitStatsResponse;
    /**

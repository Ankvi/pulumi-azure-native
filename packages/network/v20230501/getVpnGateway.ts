...
export function getVpnGateway(args: GetVpnGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetVpnGatewayResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230501:getVpnGateway", {
...
export interface GetVpnGatewayResult {
     ...
     */
    readonly connections?: types.outputs.network.v20230501.VpnConnectionResponse[];
    /**
     ...
     */
    readonly ipConfigurations: types.outputs.network.v20230501.VpnGatewayIpConfigurationResponse[];
    /**
     ...
     */
    readonly natRules?: types.outputs.network.v20230501.VpnGatewayNatRuleResponse[];
    /**

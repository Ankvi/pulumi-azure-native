...
export class InboundNatRule extends pulumi.CustomResource {
     ...
     */
    public readonly backendAddressPool!: pulumi.Output<types.outputs.network.v20230501.SubResourceResponse | undefined>;
    /**
     * A reference to a private IP address defined on a network interface of a VM. Traffic sent to the frontend port of each of the frontend IP configurations is forwarded to the backend IP.
     */
    public /*out*/ readonly backendIPConfiguration!: pulumi.Output<types.outputs.network.v20230501.NetworkInterfaceIPConfigurationResponse>;
    /**
     ...
     */
    public readonly frontendIPConfiguration!: pulumi.Output<types.outputs.network.v20230501.SubResourceResponse | undefined>;
    /**
...
export interface InboundNatRuleArgs {
     ...
     * A reference to frontend IP addresses.
     */
    frontendIPConfiguration?: pulumi.Input<types.inputs.network.v20230501.SubResourceArgs>;
    /**
     * The port for the external endpoint. Port numbers for each rule must be unique within the Load Balancer. Acceptable values range from 1 to 65534.
     */
     ...
     * The reference to the transport protocol used by the load balancing rule.
     */
    protocol?: pulumi.Input<string | types.enums.v20230501.TransportProtocol>;
    /**

...
export class NetworkManager extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230501:NetworkManager';
     ...
     */
    public readonly networkManagerScopes!: pulumi.Output<types.outputs.network.v20230501.NetworkManagerPropertiesResponseNetworkManagerScopes>;
    /**
...
export interface NetworkManagerArgs {
     ...
     * Scope Access.
     */
    networkManagerScopeAccesses: pulumi.Input<pulumi.Input<string | types.enums.v20230501.ConfigurationType>[]>;
    /**
     * Scope of Network Manager.
     */
    networkManagerScopes: pulumi.Input<types.inputs.network.v20230501.NetworkManagerPropertiesNetworkManagerScopesArgs>;
    /**

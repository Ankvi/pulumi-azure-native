...
export function getVirtualNetworkPeering(args: GetVirtualNetworkPeeringArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualNetworkPeeringResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230501:getVirtualNetworkPeering", {
...
export interface GetVirtualNetworkPeeringResult {
     ...
     */
    readonly remoteAddressSpace?: types.outputs.network.v20230501.AddressSpaceResponse;
    /**
     * The reference to the remote virtual network's Bgp Communities.
     */
    readonly remoteBgpCommunities?: types.outputs.network.v20230501.VirtualNetworkBgpCommunitiesResponse;
    /**
     * The reference to the remote virtual network. The remote virtual network can be in the same or different region (preview). See here to register for the preview and learn more (https://docs.microsoft.com/en-us/azure/virtual-network/virtual-network-create-peering).
     */
    readonly remoteVirtualNetwork?: types.outputs.network.v20230501.SubResourceResponse;
    /**
     * The reference to the current address space of the remote virtual network.
     */
    readonly remoteVirtualNetworkAddressSpace?: types.outputs.network.v20230501.AddressSpaceResponse;
    /**
     * The reference to the remote virtual network's encryption
     */
    readonly remoteVirtualNetworkEncryption: types.outputs.network.v20230501.VirtualNetworkEncryptionResponse;
    /**

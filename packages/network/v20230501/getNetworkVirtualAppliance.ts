...
export interface GetNetworkVirtualApplianceResult {
     ...
     */
    readonly additionalNics?: types.outputs.network.v20230501.VirtualApplianceAdditionalNicPropertiesResponse[];
    /**
     * Address Prefix.
     */
     ...
     */
    readonly delegation?: types.outputs.network.v20230501.DelegationPropertiesResponse;
    /**
     ...
     */
    readonly inboundSecurityRules: types.outputs.network.v20230501.SubResourceResponse[];
    /**
     * Resource location.
     */
     ...
     */
    readonly nvaSku?: types.outputs.network.v20230501.VirtualApplianceSkuPropertiesResponse;
    /**
     * The delegation for the Virtual Appliance
     */
    readonly partnerManagedResource?: types.outputs.network.v20230501.PartnerManagedResourcePropertiesResponse;
    /**
     ...
     */
    readonly virtualApplianceConnections: types.outputs.network.v20230501.SubResourceResponse[];
    /**
     * List of Virtual Appliance Network Interfaces.
     */
    readonly virtualApplianceNics: types.outputs.network.v20230501.VirtualApplianceNicPropertiesResponse[];
    /**
     * List of references to VirtualApplianceSite.
     */
    readonly virtualApplianceSites: types.outputs.network.v20230501.SubResourceResponse[];
    /**

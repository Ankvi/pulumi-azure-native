...
export class VirtualRouter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230501:VirtualRouter';
     ...
     */
    public readonly hostedGateway!: pulumi.Output<types.outputs.network.v20230501.SubResourceResponse | undefined>;
    /**
     * The Subnet on which VirtualRouter is hosted.
     */
    public readonly hostedSubnet!: pulumi.Output<types.outputs.network.v20230501.SubResourceResponse | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    public /*out*/ readonly peerings!: pulumi.Output<types.outputs.network.v20230501.SubResourceResponse[]>;
    /**
...
export interface VirtualRouterArgs {
     ...
     * The Gateway on which VirtualRouter is hosted.
     */
    hostedGateway?: pulumi.Input<types.inputs.network.v20230501.SubResourceArgs>;
    /**
     * The Subnet on which VirtualRouter is hosted.
     */
    hostedSubnet?: pulumi.Input<types.inputs.network.v20230501.SubResourceArgs>;
    /**
     * Resource ID.
     */

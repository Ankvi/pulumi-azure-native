...
export function getFlowLog(args: GetFlowLogArgs, opts?: pulumi.InvokeOptions): Promise<GetFlowLogResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230501:getFlowLog", {
...
export interface GetFlowLogResult {
     ...
     */
    readonly flowAnalyticsConfiguration?: types.outputs.network.v20230501.TrafficAnalyticsPropertiesResponse;
    /**
     * Parameters that define the flow log format.
     */
    readonly format?: types.outputs.network.v20230501.FlowLogFormatParametersResponse;
    /**
     * Resource ID.
     */
    readonly id?: string;
     ...
     */
    readonly retentionPolicy?: types.outputs.network.v20230501.RetentionPolicyParametersResponse;
    /**

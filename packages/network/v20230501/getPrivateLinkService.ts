...
export function getPrivateLinkService(args: GetPrivateLinkServiceArgs, opts?: pulumi.InvokeOptions): Promise<GetPrivateLinkServiceResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20230501:getPrivateLinkService", {
        "expand": args.expand,
...
export interface GetPrivateLinkServiceResult {
     ...
     */
    readonly autoApproval?: types.outputs.network.v20230501.PrivateLinkServicePropertiesResponseAutoApproval;
    /**
     ...
     */
    readonly ipConfigurations?: types.outputs.network.v20230501.PrivateLinkServiceIpConfigurationResponse[];
    /**
     * An array of references to the load balancer IP configurations.
     */
    readonly loadBalancerFrontendIpConfigurations?: types.outputs.network.v20230501.FrontendIPConfigurationResponse[];
    /**
     * Resource location.
     */
     ...
     */
    readonly privateEndpointConnections: types.outputs.network.v20230501.PrivateEndpointConnectionResponse[];
    /**
     ...
     */
    readonly visibility?: types.outputs.network.v20230501.PrivateLinkServicePropertiesResponseVisibility;
}
/**
 * Gets the specified private link service by resource group.
 */

...
export interface SecurityPartnerProviderArgs {
     ...
     * The security provider name.
     */
    securityProviderName?: pulumi.Input<string | types.enums.v20230501.SecurityProviderName>;
    /**
     * Resource tags.
     */

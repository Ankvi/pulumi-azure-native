...
export interface GetInboundNatRuleResult {
     ...
     */
    readonly backendAddressPool?: types.outputs.network.v20230501.SubResourceResponse;
    /**
     * A reference to a private IP address defined on a network interface of a VM. Traffic sent to the frontend port of each of the frontend IP configurations is forwarded to the backend IP.
     */
    readonly backendIPConfiguration: types.outputs.network.v20230501.NetworkInterfaceIPConfigurationResponse;
    /**
     ...
     */
    readonly frontendIPConfiguration?: types.outputs.network.v20230501.SubResourceResponse;
    /**

...
export class VirtualNetworkTap extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:network/v20230501:VirtualNetworkTap';
     ...
     */
    public readonly destinationLoadBalancerFrontEndIPConfiguration!: pulumi.Output<types.outputs.network.v20230501.FrontendIPConfigurationResponse | undefined>;
    /**
     * The reference to the private IP Address of the collector nic that will receive the tap.
     */
    public readonly destinationNetworkInterfaceIPConfiguration!: pulumi.Output<types.outputs.network.v20230501.NetworkInterfaceIPConfigurationResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly networkInterfaceTapConfigurations!: pulumi.Output<types.outputs.network.v20230501.NetworkInterfaceTapConfigurationResponse[]>;
    /**
    ...
    constructor(name: string, args: VirtualNetworkTapArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["destinationLoadBalancerFrontEndIPConfiguration"] = args ? (args.destinationLoadBalancerFrontEndIPConfiguration ? pulumi.output(args.destinationLoadBalancerFrontEndIPConfiguration).apply(types.inputs.network.v20230501.frontendIPConfigurationArgsProvideDefaults) : undefined) : undefined;
            resourceInputs["destinationNetworkInterfaceIPConfiguration"] = args ? (args.destinationNetworkInterfaceIPConfiguration ? pulumi.output(args.destinationNetworkInterfaceIPConfiguration).apply(types.inputs.network.v20230501.networkInterfaceIPConfigurationArgsProvideDefaults) : undefined) : undefined;
...
export interface VirtualNetworkTapArgs {
     ...
     * The reference to the private IP address on the internal Load Balancer that will receive the tap.
     */
    destinationLoadBalancerFrontEndIPConfiguration?: pulumi.Input<types.inputs.network.v20230501.FrontendIPConfigurationArgs>;
    /**
     * The reference to the private IP Address of the collector nic that will receive the tap.
     */
    destinationNetworkInterfaceIPConfiguration?: pulumi.Input<types.inputs.network.v20230501.NetworkInterfaceIPConfigurationArgs>;
    /**
     * The VXLAN destination port that will receive the tapped traffic.
     */

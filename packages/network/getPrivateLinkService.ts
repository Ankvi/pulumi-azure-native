...
export interface GetPrivateLinkServiceResult {
     ...
     */
    readonly autoApproval?: types.outputs.network.PrivateLinkServicePropertiesResponseAutoApproval;
    /**
     ...
     */
    readonly ipConfigurations?: types.outputs.network.PrivateLinkServiceIpConfigurationResponse[];
    /**
     * An array of references to the load balancer IP configurations.
     */
    readonly loadBalancerFrontendIpConfigurations?: types.outputs.network.FrontendIPConfigurationResponse[];
    /**
     * Resource location.
     */
     ...
     */
    readonly privateEndpointConnections: types.outputs.network.PrivateEndpointConnectionResponse[];
    /**
     ...
     */
    readonly visibility?: types.outputs.network.PrivateLinkServicePropertiesResponseVisibility;
}
/**
 * Gets the specified private link service by resource group.
 * Azure REST API version: 2023-02-01.

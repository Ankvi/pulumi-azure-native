...
export class VirtualNetworkGatewayConnection extends pulumi.CustomResource {
     ...
     */
    declare public readonly egressNatRules: pulumi.Output<types.outputs.SubResourceResponse[] | undefined>;
    /**
     * EnableBgp flag.
     */
     ...
     */
    declare public readonly gatewayCustomBgpIpAddresses: pulumi.Output<types.outputs.GatewayCustomBgpIpAddressIpConfigurationResponse[] | undefined>;
    /**
     ...
     */
    declare public readonly ingressNatRules: pulumi.Output<types.outputs.SubResourceResponse[] | undefined>;
    /**
     ...
     */
    declare public readonly localNetworkGateway2: pulumi.Output<types.outputs.LocalNetworkGatewayResponse | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    declare public readonly peer: pulumi.Output<types.outputs.SubResourceResponse | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly tunnelConnectionStatus: pulumi.Output<types.outputs.TunnelConnectionHealthResponse[]>;
    /**
     * Resource type.
     */
     ...
     */
    declare public readonly virtualNetworkGateway1: pulumi.Output<types.outputs.VirtualNetworkGatewayResponse>;
    /**
     * The reference to virtual network gateway resource.
     */
    declare public readonly virtualNetworkGateway2: pulumi.Output<types.outputs.VirtualNetworkGatewayResponse | undefined>;

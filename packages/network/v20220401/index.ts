...
// Export enums:
export * from "../types/enums/v20220401";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:network/v20220401:Endpoint":
                return new Endpoint(name, <any>undefined, { urn })
            case "azure-native:network/v20220401:Profile":
                return new Profile(name, <any>undefined, { urn })
            case "azure-native:network/v20220401:TrafficManagerUserMetricsKey":
...
pulumi.runtime.registerResourceModule("azure-native", "network/v20220401", _module)

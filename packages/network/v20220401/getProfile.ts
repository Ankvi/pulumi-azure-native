...
export function getProfile(args: GetProfileArgs, opts?: pulumi.InvokeOptions): Promise<GetProfileResult> {
    ...
    return pulumi.runtime.invoke("azure-native:network/v20220401:getProfile", {
...
export interface GetProfileResult {
     ...
     */
    readonly dnsConfig?: types.outputs.network.v20220401.DnsConfigResponse;
    /**
     * The list of endpoints in the Traffic Manager profile.
     */
    readonly endpoints?: types.outputs.network.v20220401.EndpointResponse[];
    /**
     ...
     */
    readonly monitorConfig?: types.outputs.network.v20220401.MonitorConfigResponse;
    /**

...
export class RoutingRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: RoutingRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:network/v20240301:RoutingRule" }, { type: "azure-native:network/v20240501:RoutingRule" }, { type: "azure-native:network/v20240701:RoutingRule" }] };

...
export class GuestConfigurationHCRPAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:guestconfiguration/v20220125:GuestConfigurationHCRPAssignment';

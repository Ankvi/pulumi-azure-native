...
export class GuestConfigurationConnectedVMwarevSphereAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:guestconfiguration/v20220125:GuestConfigurationConnectedVMwarevSphereAssignment';
    ...
    constructor(name: string, args: GuestConfigurationConnectedVMwarevSphereAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:guestconfiguration:GuestConfigurationConnectedVMwarevSphereAssignment" }, { type: "azure-native:guestconfiguration/v20200625:GuestConfigurationConnectedVMwarevSphereAssignment" }] };

...
export namespace guestconfiguration {
    ...
    export namespace v20220125 {
        ...
        export interface AssignmentInfoResponse {
             ...
             * Information about the configuration.
             */
            configuration?: v20220125.ConfigurationInfoResponse;
            /**
             * Name of the guest configuration assignment.
             */
            name: string;
        ...
        export interface AssignmentReportResourceResponse {
             ...
             * Compliance reason and reason code for a resource.
             */
            reasons?: v20220125.AssignmentReportResourceComplianceReasonResponse[];
            /**
             * Name of the guest configuration assignment resource setting.
             */
            resourceId: string;
        ...
        export interface AssignmentReportResponse {
             ...
             * Configuration details of the guest configuration assignment.
             */
            assignment?: v20220125.AssignmentInfoResponse;
            /**
             * A value indicating compliance status of the machine for the assigned guest configuration.
             */
            complianceStatus: string;
             ...
             * The list of resources for which guest configuration assignment compliance is checked.
             */
            resources?: v20220125.AssignmentReportResourceResponse[];
            /**
             * Start date and time of the guest configuration assignment compliance status check.
             */
            startTime: string;
        ...
        export interface GuestConfigurationAssignmentPropertiesResponse {
             ...
             * The guest configuration to assign.
             */
            guestConfiguration?: v20220125.GuestConfigurationNavigationResponse;
            /**
             * Date and time when last compliance status was checked.
             */
            lastComplianceStatusChecked: string;
             ...
             * Last reported guest configuration assignment report.
             */
            latestAssignmentReport?: v20220125.AssignmentReportResponse;
            /**
             * Id of the latest report for the guest configuration assignment. 
             */
            latestReportId: string;
             ...
             * The list of VM Compliance data for VMSS
             */
            vmssVMList?: v20220125.VMSSVMInfoResponse[];
        }
        /**
         * guestConfigurationAssignmentPropertiesResponseProvideDefaults sets the appropriate defaults for GuestConfigurationAssignmentPropertiesResponse
         */
        export function guestConfigurationAssignmentPropertiesResponseProvideDefaults(val: GuestConfigurationAssignmentPropertiesResponse): GuestConfigurationAssignmentPropertiesResponse {
            return {
                ...val,
                guestConfiguration: (val.guestConfiguration ? v20220125.guestConfigurationNavigationResponseProvideDefaults(val.guestConfiguration) : undefined),
            };
        }
        ...
        export interface GuestConfigurationNavigationResponse {
             ...
             * The configuration parameters for the guest configuration.
             */
            configurationParameter?: v20220125.ConfigurationParameterResponse[];
            /**
             * The protected configuration parameters for the guest configuration.
             */
            configurationProtectedParameter?: v20220125.ConfigurationParameterResponse[];
            /**
             * The configuration setting for the guest configuration.
             */
            configurationSetting: v20220125.ConfigurationSettingResponse;
            /**
             * Combined hash of the guest configuration package and configuration parameters.
             */
            contentHash?: string;
        ...
        export function guestConfigurationNavigationResponseProvideDefaults(val: GuestConfigurationNavigationResponse): GuestConfigurationNavigationResponse {
            return {
                ...val,
                configurationSetting: v20220125.configurationSettingResponseProvideDefaults(val.configurationSetting),
            };
        }

...
export class Zone extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:dns:Zone';
     ...
     */
    declare public readonly registrationVirtualNetworks: pulumi.Output<types.outputs.SubResourceResponse[] | undefined>;
    /**
     * A list of references to virtual networks that resolve records in this DNS zone. This is a only when ZoneType is Private.
     */
    declare public readonly resolutionVirtualNetworks: pulumi.Output<types.outputs.SubResourceResponse[] | undefined>;
    /**
     * The list of signing keys.
     */
    declare public /*out*/ readonly signingKeys: pulumi.Output<types.outputs.SigningKeyResponse[]>;
    /**

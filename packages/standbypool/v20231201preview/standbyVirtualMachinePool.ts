...
export class StandbyVirtualMachinePool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:standbypool/v20231201preview:StandbyVirtualMachinePool';
    ...
    constructor(name: string, args: StandbyVirtualMachinePoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:standbypool:StandbyVirtualMachinePool" }] };

...
export class StandbyContainerGroupPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:standbypool/v20231201preview:StandbyContainerGroupPool';
    ...
    constructor(name: string, args: StandbyContainerGroupPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:standbypool:StandbyContainerGroupPool" }] };

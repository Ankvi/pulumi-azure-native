...
export class StandbyContainerGroupPool extends pulumi.CustomResource {
     ...
     */
    declare public readonly containerGroupProperties: pulumi.Output<types.outputs.ContainerGroupPropertiesResponse>;
    /**
     * Specifies elasticity profile of standby container group pools.
     */
    declare public readonly elasticityProfile: pulumi.Output<types.outputs.StandbyContainerGroupPoolElasticityProfileResponse>;
    /**

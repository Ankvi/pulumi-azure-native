...
export class FhirService extends pulumi.CustomResource {
     ...
     */
    declare public readonly acrConfiguration: pulumi.Output<types.outputs.FhirServiceAcrConfigurationResponse | undefined>;
    /**
     * Fhir Service authentication configuration.
     */
    declare public readonly authenticationConfiguration: pulumi.Output<types.outputs.FhirServiceAuthenticationConfigurationResponse | undefined>;
    /**
     ...
     */
    declare public readonly corsConfiguration: pulumi.Output<types.outputs.FhirServiceCorsConfigurationResponse | undefined>;
    /**
     ...
     */
    declare public readonly exportConfiguration: pulumi.Output<types.outputs.FhirServiceExportConfigurationResponse | undefined>;
    /**
     ...
     */
    declare public readonly implementationGuidesConfiguration: pulumi.Output<types.outputs.ImplementationGuidesConfigurationResponse | undefined>;
    /**
     * Fhir Service import configuration.
     */
    declare public readonly importConfiguration: pulumi.Output<types.outputs.FhirServiceImportConfigurationResponse | undefined>;
    /**
     ...
     */
    declare public readonly resourceVersionPolicyConfiguration: pulumi.Output<types.outputs.ResourceVersionPolicyConfigurationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: FhirServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:healthcareapis/v20210601preview:FhirService" }, { type: "azure-native:healthcareapis/v20211101:FhirService" }, { type: "azure-native:healthcareapis/v20220131preview:FhirService" }, { type: "azure-native:healthcareapis/v20220515:FhirService" }, { type: "azure-native:healthcareapis/v20220601:FhirService" }, { type: "azure-native:healthcareapis/v20221001preview:FhirService" }, { type: "azure-native:healthcareapis/v20221201:FhirService" }, { type: "azure-native:healthcareapis/v20230228:FhirService" }, { type: "azure-native:healthcareapis/v20230906:FhirService" }, { type: "azure-native:healthcareapis/v20231101:FhirService" }, { type: "azure-native:healthcareapis/v20231201:FhirService" }, { type: "azure-native:healthcareapis/v20240301:FhirService" }, { type: "azure-native:healthcareapis/v20240331:FhirService" }, { type: "azure-native:healthcareapis/v20250301preview:FhirService" }, { type: "azure-native:healthcareapis/v20250401preview:FhirService" }] };

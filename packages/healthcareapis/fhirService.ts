...
export class FhirService extends pulumi.CustomResource {
     ...
     */
    public readonly accessPolicies!: pulumi.Output<types.outputs.healthcareapis.FhirServiceAccessPolicyEntryResponse[] | undefined>;
    /**
     * Fhir Service Azure container registry configuration.
     */
    public readonly acrConfiguration!: pulumi.Output<types.outputs.healthcareapis.FhirServiceAcrConfigurationResponse | undefined>;
    /**
     * Fhir Service authentication configuration.
     */
    public readonly authenticationConfiguration!: pulumi.Output<types.outputs.healthcareapis.FhirServiceAuthenticationConfigurationResponse | undefined>;
    /**
     * Fhir Service Cors configuration.
     */
    public readonly corsConfiguration!: pulumi.Output<types.outputs.healthcareapis.FhirServiceCorsConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly exportConfiguration!: pulumi.Output<types.outputs.healthcareapis.FhirServiceExportConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly implementationGuidesConfiguration!: pulumi.Output<types.outputs.healthcareapis.ImplementationGuidesConfigurationResponse | undefined>;
    /**
     * Fhir Service import configuration.
     */
    public readonly importConfiguration!: pulumi.Output<types.outputs.healthcareapis.FhirServiceImportConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly resourceVersionPolicyConfiguration!: pulumi.Output<types.outputs.healthcareapis.ResourceVersionPolicyConfigurationResponse | undefined>;
    /**
...
export interface FhirServiceArgs {
     ...
     * Fhir Service access policies.
     */
    accessPolicies?: pulumi.Input<pulumi.Input<types.inputs.healthcareapis.FhirServiceAccessPolicyEntryArgs>[]>;
    /**
     * Fhir Service Azure container registry configuration.
     */
    acrConfiguration?: pulumi.Input<types.inputs.healthcareapis.FhirServiceAcrConfigurationArgs>;
    /**
     * Fhir Service authentication configuration.
     */
    authenticationConfiguration?: pulumi.Input<types.inputs.healthcareapis.FhirServiceAuthenticationConfigurationArgs>;
    /**
     * Fhir Service Cors configuration.
     */
    corsConfiguration?: pulumi.Input<types.inputs.healthcareapis.FhirServiceCorsConfigurationArgs>;
    /**
     * Fhir Service export configuration.
     */
    exportConfiguration?: pulumi.Input<types.inputs.healthcareapis.FhirServiceExportConfigurationArgs>;
    /**
     ...
     * Implementation Guides configuration.
     */
    implementationGuidesConfiguration?: pulumi.Input<types.inputs.healthcareapis.ImplementationGuidesConfigurationArgs>;
    /**
     * Fhir Service import configuration.
     */
    importConfiguration?: pulumi.Input<types.inputs.healthcareapis.FhirServiceImportConfigurationArgs>;
    /**
     * The kind of the service.
     */
     ...
     * Determines tracking of history for resources.
     */
    resourceVersionPolicyConfiguration?: pulumi.Input<types.inputs.healthcareapis.ResourceVersionPolicyConfigurationArgs>;
    /**
     * Resource tags.
     */

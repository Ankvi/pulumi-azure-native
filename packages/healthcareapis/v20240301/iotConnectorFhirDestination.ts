...
export class IotConnectorFhirDestination extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:healthcareapis/v20240301:IotConnectorFhirDestination';

...
export class DicomService extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly authenticationConfiguration: pulumi.Output<types.outputs.DicomServiceAuthenticationConfigurationResponse | undefined>;
    /**
     ...
     */
    declare public readonly corsConfiguration: pulumi.Output<types.outputs.CorsConfigurationResponse | undefined>;
    /**
     ...
     */
    declare public readonly storageConfiguration: pulumi.Output<types.outputs.StorageConfigurationResponse | undefined>;
    /**

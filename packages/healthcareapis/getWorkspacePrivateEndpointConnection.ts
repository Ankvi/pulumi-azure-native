...
export interface GetWorkspacePrivateEndpointConnectionResult {
     ...
     */
    readonly privateEndpoint?: types.outputs.healthcareapis.PrivateEndpointResponse;
    /**
     * A collection of information about the state of the connection between service consumer and provider.
     */
    readonly privateLinkServiceConnectionState: types.outputs.healthcareapis.PrivateLinkServiceConnectionStateResponse;
    /**

...
export namespace healthcareapis {
    ...
    export namespace v20221001preview {
        ...
        export interface AnalyticsConnectorFhirServiceDataSourceArgs {
             ...
             * The kind of FHIR Service.
             */
            kind: pulumi.Input<string | enums.v20221001preview.FhirServiceVersion>;
            /**
             * Type of data source.
             * Expected value is 'fhirservice'.
             */
        ...
        export interface ServiceManagedIdentityIdentityArgs {
             ...
             * Type of identity being specified, currently SystemAssigned and None are allowed.
             */
            type: pulumi.Input<string | enums.v20221001preview.ServiceManagedIdentityType>;
            /**
             * The set of user assigned identities associated with the resource. The userAssignedIdentities dictionary keys will be ARM resource ids in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}. The dictionary values can be empty objects ({}) in requests.
             */
            userAssignedIdentities?: pulumi.Input<pulumi.Input<string>[]>;
    ...
    export namespace v20230228 {
        ...
        export interface FhirServiceAcrConfigurationArgs {
             ...
             * The list of Open Container Initiative (OCI) artifacts.
             */
            ociArtifacts?: pulumi.Input<pulumi.Input<v20230228.ServiceOciArtifactEntryArgs>[]>;
        }
        ...
        export interface PrivateEndpointConnectionArgs {
             ...
             * A collection of information about the state of the connection between service consumer and provider.
             */
            privateLinkServiceConnectionState: pulumi.Input<v20230228.PrivateLinkServiceConnectionStateArgs>;
        }
        ...
        export interface PrivateLinkServiceConnectionStateArgs {
             ...
             * Indicates whether the connection has been Approved/Rejected/Removed by the owner of the service.
             */
            status?: pulumi.Input<string | enums.v20230228.PrivateEndpointServiceConnectionStatus>;
        }
        ...
        export interface ResourceVersionPolicyConfigurationArgs {
             ...
             * The default value for tracking history across all resources.
             */
            default?: pulumi.Input<string | enums.v20230228.FhirResourceVersionPolicy>;
            /**
             * A list of FHIR Resources and their version policy overrides.
             */
            resourceTypeOverrides?: pulumi.Input<{[key: string]: pulumi.Input<string | enums.v20230228.FhirResourceVersionPolicy>}>;
        }
        ...
        export interface ServiceManagedIdentityIdentityArgs {
             ...
             * Type of identity being specified, currently SystemAssigned and None are allowed.
             */
            type: pulumi.Input<string | enums.v20230228.ServiceManagedIdentityType>;
            /**
             * The set of user assigned identities associated with the resource. The userAssignedIdentities dictionary keys will be ARM resource ids in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}. The dictionary values can be empty objects ({}) in requests.
             */
            userAssignedIdentities?: pulumi.Input<pulumi.Input<string>[]>;
        ...
        export interface ServicesPropertiesArgs {
             ...
             * The access policies of the service instance.
             */
            accessPolicies?: pulumi.Input<pulumi.Input<v20230228.ServiceAccessPolicyEntryArgs>[]>;
            /**
             * The azure container registry settings used for convert data operation of the service instance.
             */
            acrConfiguration?: pulumi.Input<v20230228.ServiceAcrConfigurationInfoArgs>;
            /**
             * The authentication configuration for the service instance.
             */
            authenticationConfiguration?: pulumi.Input<v20230228.ServiceAuthenticationConfigurationInfoArgs>;
            /**
             * The settings for the CORS configuration of the service instance.
             */
            corsConfiguration?: pulumi.Input<v20230228.ServiceCorsConfigurationInfoArgs>;
            /**
             * The settings for the Cosmos DB database backing the service.
             */
            cosmosDbConfiguration?: pulumi.Input<v20230228.ServiceCosmosDbConfigurationInfoArgs>;
            /**
             * The settings for the export operation of the service instance.
             */
            exportConfiguration?: pulumi.Input<v20230228.ServiceExportConfigurationInfoArgs>;
            /**
             * The settings for the import operation of the service instance.
             */
            importConfiguration?: pulumi.Input<v20230228.ServiceImportConfigurationInfoArgs>;
            /**
             * The list of private endpoint connections that are set up for this resource.
             */
            privateEndpointConnections?: pulumi.Input<pulumi.Input<v20230228.PrivateEndpointConnectionArgs>[]>;
            /**
             * Control permission for data plane traffic coming from public networks while private endpoint is enabled.
             */
            publicNetworkAccess?: pulumi.Input<string | enums.v20230228.PublicNetworkAccess>;
        }
        ...
        export interface ServicesResourceIdentityArgs {
             ...
             * Type of identity being specified, currently SystemAssigned and None are allowed.
             */
            type?: pulumi.Input<string | enums.v20230228.ManagedServiceIdentityType>;
        }

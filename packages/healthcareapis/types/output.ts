...
export namespace healthcareapis {
    ...
    export namespace v20230228 {
        ...
        export interface FhirServiceAcrConfigurationResponse {
             ...
             * The list of Open Container Initiative (OCI) artifacts.
             */
            ociArtifacts?: v20230228.ServiceOciArtifactEntryResponse[];
        }
        ...
        export interface PrivateEndpointConnectionResponse {
             ...
             * The resource of private end point.
             */
            privateEndpoint?: v20230228.PrivateEndpointResponse;
            /**
             * A collection of information about the state of the connection between service consumer and provider.
             */
            privateLinkServiceConnectionState: v20230228.PrivateLinkServiceConnectionStateResponse;
            /**
             * The provisioning state of the private endpoint connection resource.
             */
            provisioningState: string;
        ...
        export interface ServiceManagedIdentityResponseIdentity {
             ...
             * The set of user assigned identities associated with the resource. The userAssignedIdentities dictionary keys will be ARM resource ids in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}. The dictionary values can be empty objects ({}) in requests.
             */
            userAssignedIdentities?: {[key: string]: v20230228.UserAssignedIdentityResponse};
        }
        ...
        export interface ServicesPropertiesResponse {
             ...
             * The access policies of the service instance.
             */
            accessPolicies?: v20230228.ServiceAccessPolicyEntryResponse[];
            /**
             * The azure container registry settings used for convert data operation of the service instance.
             */
            acrConfiguration?: v20230228.ServiceAcrConfigurationInfoResponse;
            /**
             * The authentication configuration for the service instance.
             */
            authenticationConfiguration?: v20230228.ServiceAuthenticationConfigurationInfoResponse;
            /**
             * The settings for the CORS configuration of the service instance.
             */
            corsConfiguration?: v20230228.ServiceCorsConfigurationInfoResponse;
            /**
             * The settings for the Cosmos DB database backing the service.
             */
            cosmosDbConfiguration?: v20230228.ServiceCosmosDbConfigurationInfoResponse;
            /**
             * The settings for the export operation of the service instance.
             */
            exportConfiguration?: v20230228.ServiceExportConfigurationInfoResponse;
            /**
             * The settings for the import operation of the service instance.
             */
            importConfiguration?: v20230228.ServiceImportConfigurationInfoResponse;
            /**
             * The list of private endpoint connections that are set up for this resource.
             */
            privateEndpointConnections?: v20230228.PrivateEndpointConnectionResponse[];
            /**
             * The provisioning state.
             */
            provisioningState: string;

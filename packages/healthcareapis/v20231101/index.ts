...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:healthcareapis/v20231101:DicomService":
                return new DicomService(name, <any>undefined, { urn })
            case "azure-native:healthcareapis/v20231101:FhirService":
                return new FhirService(name, <any>undefined, { urn })
            case "azure-native:healthcareapis/v20231101:IotConnector":
                return new IotConnector(name, <any>undefined, { urn })
            case "azure-native:healthcareapis/v20231101:IotConnectorFhirDestination":
                return new IotConnectorFhirDestination(name, <any>undefined, { urn })
            case "azure-native:healthcareapis/v20231101:PrivateEndpointConnection":
                return new PrivateEndpointConnection(name, <any>undefined, { urn })
            case "azure-native:healthcareapis/v20231101:Service":
                return new Service(name, <any>undefined, { urn })
            case "azure-native:healthcareapis/v20231101:Workspace":
                return new Workspace(name, <any>undefined, { urn })
            case "azure-native:healthcareapis/v20231101:WorkspacePrivateEndpointConnection":
...
pulumi.runtime.registerResourceModule("azure-native", "healthcareapis/v20231101", _module)
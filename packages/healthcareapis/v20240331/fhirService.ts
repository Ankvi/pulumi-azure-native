...
export class FhirService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:healthcareapis/v20240331:FhirService';
    ...
    constructor(name: string, args: FhirServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:healthcareapis:FhirService" }, { type: "azure-native:healthcareapis/v20210601preview:FhirService" }, { type: "azure-native:healthcareapis/v20211101:FhirService" }, { type: "azure-native:healthcareapis/v20220131preview:FhirService" }, { type: "azure-native:healthcareapis/v20220515:FhirService" }, { type: "azure-native:healthcareapis/v20220601:FhirService" }, { type: "azure-native:healthcareapis/v20221001preview:FhirService" }, { type: "azure-native:healthcareapis/v20221201:FhirService" }, { type: "azure-native:healthcareapis/v20230228:FhirService" }, { type: "azure-native:healthcareapis/v20230906:FhirService" }, { type: "azure-native:healthcareapis/v20231101:FhirService" }, { type: "azure-native:healthcareapis/v20231201:FhirService" }, { type: "azure-native:healthcareapis/v20240301:FhirService" }] };

...
export class IotConnector extends pulumi.CustomResource {
     ...
     * Device Mappings.
     */
    declare public readonly deviceMapping: pulumi.Output<types.outputs.IotMappingPropertiesResponse | undefined>;
    /**
     ...
     */
    declare public readonly ingestionEndpointConfiguration: pulumi.Output<types.outputs.IotEventHubIngestionEndpointConfigurationResponse | undefined>;
    /**

...
export class IotConnectorFhirDestination extends pulumi.CustomResource {
     ...
     * FHIR Mappings
     */
    declare public readonly fhirMapping: pulumi.Output<types.outputs.IotMappingPropertiesResponse>;
    /**
     * Fully qualified resource id of the FHIR service to connect to.
     */
    declare public readonly fhirServiceResourceId: pulumi.Output<string>;
    /**
     ...
     */
    declare public readonly resourceIdentityResolutionType: pulumi.Output<string>;
    /**

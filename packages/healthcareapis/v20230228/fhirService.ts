...
export class FhirService extends pulumi.CustomResource {
    ...
    constructor(name: string, args: FhirServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:healthcareapis:FhirService" }, { type: "azure-native:healthcareapis/v20210601preview:FhirService" }, { type: "azure-native:healthcareapis/v20211101:FhirService" }, { type: "azure-native:healthcareapis/v20220131preview:FhirService" }, { type: "azure-native:healthcareapis/v20220515:FhirService" }, { type: "azure-native:healthcareapis/v20220601:FhirService" }, { type: "azure-native:healthcareapis/v20221001preview:FhirService" }, { type: "azure-native:healthcareapis/v20221201:FhirService" }] };

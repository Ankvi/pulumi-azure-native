...
export class DicomService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:healthcareapis/v20230228:DicomService';
     ...
     */
    public /*out*/ readonly authenticationConfiguration!: pulumi.Output<types.outputs.healthcareapis.v20230228.DicomServiceAuthenticationConfigurationResponse | undefined>;
    /**
     * Dicom Service Cors configuration.
     */
    public readonly corsConfiguration!: pulumi.Output<types.outputs.healthcareapis.v20230228.CorsConfigurationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: DicomServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:healthcareapis:DicomService" }, { type: "azure-native:healthcareapis/v20210601preview:DicomService" }, { type: "azure-native:healthcareapis/v20211101:DicomService" }, { type: "azure-native:healthcareapis/v20220131preview:DicomService" }, { type: "azure-native:healthcareapis/v20220515:DicomService" }, { type: "azure-native:healthcareapis/v20220601:DicomService" }, { type: "azure-native:healthcareapis/v20221001preview:DicomService" }, { type: "azure-native:healthcareapis/v20221201:DicomService" }] };
...
export interface DicomServiceArgs {
     ...
     * Dicom Service Cors configuration.
     */
    corsConfiguration?: pulumi.Input<types.inputs.healthcareapis.v20230228.CorsConfigurationArgs>;
    /**

...
export function getWorkspacePrivateEndpointConnection(args: GetWorkspacePrivateEndpointConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetWorkspacePrivateEndpointConnectionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:healthcareapis/v20230228:getWorkspacePrivateEndpointConnection", {
...
export interface GetWorkspacePrivateEndpointConnectionResult {
     ...
     */
    readonly privateEndpoint?: types.outputs.healthcareapis.v20230228.PrivateEndpointResponse;
    /**
     * A collection of information about the state of the connection between service consumer and provider.
     */
    readonly privateLinkServiceConnectionState: types.outputs.healthcareapis.v20230228.PrivateLinkServiceConnectionStateResponse;
    /**

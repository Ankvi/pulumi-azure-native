...
export function getAgentPool(args: GetAgentPoolArgs, opts?: pulumi.InvokeOptions): Promise<GetAgentPoolResult> {
    ...
    return pulumi.runtime.invoke("azure-native:containerservice/v20230601:getAgentPool", {
...
export interface GetAgentPoolResult {
     ...
     */
    readonly creationData?: types.outputs.containerservice.v20230601.CreationDataResponse;
    /**
     ...
     */
    readonly kubeletConfig?: types.outputs.containerservice.v20230601.KubeletConfigResponse;
    /**
     ...
     */
    readonly linuxOSConfig?: types.outputs.containerservice.v20230601.LinuxOSConfigResponse;
    /**
     ...
     */
    readonly upgradeSettings?: types.outputs.containerservice.v20230601.AgentPoolUpgradeSettingsResponse;
    /**

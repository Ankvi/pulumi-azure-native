...
export class ManagedCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerservice/v20230601:ManagedCluster';
     ...
     */
    public readonly aadProfile!: pulumi.Output<types.outputs.containerservice.v20230601.ManagedClusterAADProfileResponse | undefined>;
    /**
     * The profile of managed cluster add-on.
     */
    public readonly addonProfiles!: pulumi.Output<{[key: string]: types.outputs.containerservice.v20230601.ManagedClusterAddonProfileResponse} | undefined>;
    /**
     * The agent pool properties.
     */
    public readonly agentPoolProfiles!: pulumi.Output<types.outputs.containerservice.v20230601.ManagedClusterAgentPoolProfileResponse[] | undefined>;
    /**
     * The access profile for managed cluster API server.
     */
    public readonly apiServerAccessProfile!: pulumi.Output<types.outputs.containerservice.v20230601.ManagedClusterAPIServerAccessProfileResponse | undefined>;
    /**
     * Parameters to be applied to the cluster-autoscaler when enabled
     */
    public readonly autoScalerProfile!: pulumi.Output<types.outputs.containerservice.v20230601.ManagedClusterPropertiesResponseAutoScalerProfile | undefined>;
    /**
     * The auto upgrade configuration.
     */
    public readonly autoUpgradeProfile!: pulumi.Output<types.outputs.containerservice.v20230601.ManagedClusterAutoUpgradeProfileResponse | undefined>;
    /**
     * Azure Monitor addon profiles for monitoring the managed cluster.
     */
    public readonly azureMonitorProfile!: pulumi.Output<types.outputs.containerservice.v20230601.ManagedClusterAzureMonitorProfileResponse | undefined>;
    /**
     ...
     */
    public readonly extendedLocation!: pulumi.Output<types.outputs.containerservice.v20230601.ExtendedLocationResponse | undefined>;
    /**
     ...
     */
    public readonly httpProxyConfig!: pulumi.Output<types.outputs.containerservice.v20230601.ManagedClusterHTTPProxyConfigResponse | undefined>;
    /**
     * The identity of the managed cluster, if configured.
     */
    public readonly identity!: pulumi.Output<types.outputs.containerservice.v20230601.ManagedClusterIdentityResponse | undefined>;
    /**
     * Identities associated with the cluster.
     */
    public readonly identityProfile!: pulumi.Output<{[key: string]: types.outputs.containerservice.v20230601.UserAssignedIdentityResponse} | undefined>;
    /**
     ...
     */
    public readonly linuxProfile!: pulumi.Output<types.outputs.containerservice.v20230601.ContainerServiceLinuxProfileResponse | undefined>;
    /**
     ...
     */
    public readonly networkProfile!: pulumi.Output<types.outputs.containerservice.v20230601.ContainerServiceNetworkProfileResponse | undefined>;
    /**
     ...
     */
    public readonly oidcIssuerProfile!: pulumi.Output<types.outputs.containerservice.v20230601.ManagedClusterOIDCIssuerProfileResponse | undefined>;
    /**
     * See [use AAD pod identity](https://docs.microsoft.com/azure/aks/use-azure-ad-pod-identity) for more details on AAD pod identity integration.
     */
    public readonly podIdentityProfile!: pulumi.Output<types.outputs.containerservice.v20230601.ManagedClusterPodIdentityProfileResponse | undefined>;
    /**
     * The Power State of the cluster.
     */
    public /*out*/ readonly powerState!: pulumi.Output<types.outputs.containerservice.v20230601.PowerStateResponse>;
    /**
     ...
     */
    public readonly privateLinkResources!: pulumi.Output<types.outputs.containerservice.v20230601.PrivateLinkResourceResponse[] | undefined>;
    /**
     ...
     */
    public readonly securityProfile!: pulumi.Output<types.outputs.containerservice.v20230601.ManagedClusterSecurityProfileResponse | undefined>;
    /**
     * Information about a service principal identity for the cluster to use for manipulating Azure APIs.
     */
    public readonly servicePrincipalProfile!: pulumi.Output<types.outputs.containerservice.v20230601.ManagedClusterServicePrincipalProfileResponse | undefined>;
    /**
     * The managed cluster SKU.
     */
    public readonly sku!: pulumi.Output<types.outputs.containerservice.v20230601.ManagedClusterSKUResponse | undefined>;
    /**
     * Storage profile for the managed cluster.
     */
    public readonly storageProfile!: pulumi.Output<types.outputs.containerservice.v20230601.ManagedClusterStorageProfileResponse | undefined>;
    /**
     ...
     */
    public readonly windowsProfile!: pulumi.Output<types.outputs.containerservice.v20230601.ManagedClusterWindowsProfileResponse | undefined>;
    /**
     * Workload Auto-scaler profile for the managed cluster.
     */
    public readonly workloadAutoScalerProfile!: pulumi.Output<types.outputs.containerservice.v20230601.ManagedClusterWorkloadAutoScalerProfileResponse | undefined>;
    ...
    constructor(name: string, args: ManagedClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["networkProfile"] = args ? (args.networkProfile ? pulumi.output(args.networkProfile).apply(types.inputs.containerservice.v20230601.containerServiceNetworkProfileArgsProvideDefaults) : undefined) : undefined;
            ...
            resourceInputs["securityProfile"] = args ? (args.securityProfile ? pulumi.output(args.securityProfile).apply(types.inputs.containerservice.v20230601.managedClusterSecurityProfileArgsProvideDefaults) : undefined) : undefined;
            ...
            resourceInputs["workloadAutoScalerProfile"] = args ? (args.workloadAutoScalerProfile ? pulumi.output(args.workloadAutoScalerProfile).apply(types.inputs.containerservice.v20230601.managedClusterWorkloadAutoScalerProfileArgsProvideDefaults) : undefined) : undefined;
...
export interface ManagedClusterArgs {
     ...
     * The Azure Active Directory configuration.
     */
    aadProfile?: pulumi.Input<types.inputs.containerservice.v20230601.ManagedClusterAADProfileArgs>;
    /**
     * The profile of managed cluster add-on.
     */
    addonProfiles?: pulumi.Input<{[key: string]: pulumi.Input<types.inputs.containerservice.v20230601.ManagedClusterAddonProfileArgs>}>;
    /**
     * The agent pool properties.
     */
    agentPoolProfiles?: pulumi.Input<pulumi.Input<types.inputs.containerservice.v20230601.ManagedClusterAgentPoolProfileArgs>[]>;
    /**
     * The access profile for managed cluster API server.
     */
    apiServerAccessProfile?: pulumi.Input<types.inputs.containerservice.v20230601.ManagedClusterAPIServerAccessProfileArgs>;
    /**
     * Parameters to be applied to the cluster-autoscaler when enabled
     */
    autoScalerProfile?: pulumi.Input<types.inputs.containerservice.v20230601.ManagedClusterPropertiesAutoScalerProfileArgs>;
    /**
     * The auto upgrade configuration.
     */
    autoUpgradeProfile?: pulumi.Input<types.inputs.containerservice.v20230601.ManagedClusterAutoUpgradeProfileArgs>;
    /**
     * Azure Monitor addon profiles for monitoring the managed cluster.
     */
    azureMonitorProfile?: pulumi.Input<types.inputs.containerservice.v20230601.ManagedClusterAzureMonitorProfileArgs>;
    /**
     * If set to true, getting static credentials will be disabled for this cluster. This must only be used on Managed Clusters that are AAD enabled. For more details see [disable local accounts](https://docs.microsoft.com/azure/aks/managed-aad#disable-local-accounts-preview).
     */
     ...
     * The extended location of the Virtual Machine.
     */
    extendedLocation?: pulumi.Input<types.inputs.containerservice.v20230601.ExtendedLocationArgs>;
    /**
     * This cannot be updated once the Managed Cluster has been created.
     */
     ...
     * Configurations for provisioning the cluster with HTTP proxy servers.
     */
    httpProxyConfig?: pulumi.Input<types.inputs.containerservice.v20230601.ManagedClusterHTTPProxyConfigArgs>;
    /**
     * The identity of the managed cluster, if configured.
     */
    identity?: pulumi.Input<types.inputs.containerservice.v20230601.ManagedClusterIdentityArgs>;
    /**
     * Identities associated with the cluster.
     */
    identityProfile?: pulumi.Input<{[key: string]: pulumi.Input<types.inputs.containerservice.v20230601.UserAssignedIdentityArgs>}>;
    /**
     * Both patch version <major.minor.patch> (e.g. 1.20.13) and <major.minor> (e.g. 1.20) are supported. When <major.minor> is specified, the latest supported GA patch version is chosen automatically. Updating the cluster with the same <major.minor> once it has been created (e.g. 1.14.x -> 1.14) will not trigger an upgrade, even if a newer patch version is available. When you upgrade a supported AKS cluster, Kubernetes minor versions cannot be skipped. All upgrades must be performed sequentially by major version number. For example, upgrades between 1.14.x -> 1.15.x or 1.15.x -> 1.16.x are allowed, however 1.14.x -> 1.16.x is not allowed. See [upgrading an AKS cluster](https://docs.microsoft.com/azure/aks/upgrade-cluster) for more details.
     */
     ...
     * The profile for Linux VMs in the Managed Cluster.
     */
    linuxProfile?: pulumi.Input<types.inputs.containerservice.v20230601.ContainerServiceLinuxProfileArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The network configuration profile.
     */
    networkProfile?: pulumi.Input<types.inputs.containerservice.v20230601.ContainerServiceNetworkProfileArgs>;
    /**
     * The name of the resource group containing agent pool nodes.
     */
     ...
     * The OIDC issuer profile of the Managed Cluster.
     */
    oidcIssuerProfile?: pulumi.Input<types.inputs.containerservice.v20230601.ManagedClusterOIDCIssuerProfileArgs>;
    /**
     * See [use AAD pod identity](https://docs.microsoft.com/azure/aks/use-azure-ad-pod-identity) for more details on AAD pod identity integration.
     */
    podIdentityProfile?: pulumi.Input<types.inputs.containerservice.v20230601.ManagedClusterPodIdentityProfileArgs>;
    /**
     * Private link resources associated with the cluster.
     */
    privateLinkResources?: pulumi.Input<pulumi.Input<types.inputs.containerservice.v20230601.PrivateLinkResourceArgs>[]>;
    /**
     * Allow or deny public network access for AKS
     */
    publicNetworkAccess?: pulumi.Input<string | types.enums.v20230601.PublicNetworkAccess>;
    /**
     ...
     * Security profile for the managed cluster.
     */
    securityProfile?: pulumi.Input<types.inputs.containerservice.v20230601.ManagedClusterSecurityProfileArgs>;
    /**
     * Information about a service principal identity for the cluster to use for manipulating Azure APIs.
     */
    servicePrincipalProfile?: pulumi.Input<types.inputs.containerservice.v20230601.ManagedClusterServicePrincipalProfileArgs>;
    /**
     * The managed cluster SKU.
     */
    sku?: pulumi.Input<types.inputs.containerservice.v20230601.ManagedClusterSKUArgs>;
    /**
     * Storage profile for the managed cluster.
     */
    storageProfile?: pulumi.Input<types.inputs.containerservice.v20230601.ManagedClusterStorageProfileArgs>;
    /**
     * The support plan for the Managed Cluster. If unspecified, the default is 'KubernetesOfficial'.
     */
    supportPlan?: pulumi.Input<string | types.enums.v20230601.KubernetesSupportPlan>;
    /**
     * Resource tags.
     */
     ...
     * The profile for Windows VMs in the Managed Cluster.
     */
    windowsProfile?: pulumi.Input<types.inputs.containerservice.v20230601.ManagedClusterWindowsProfileArgs>;
    /**
     * Workload Auto-scaler profile for the managed cluster.
     */
    workloadAutoScalerProfile?: pulumi.Input<types.inputs.containerservice.v20230601.ManagedClusterWorkloadAutoScalerProfileArgs>;
}

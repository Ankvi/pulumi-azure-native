...
export class MaintenanceConfiguration extends pulumi.CustomResource {
     ...
     */
    declare public readonly notAllowedTime: pulumi.Output<types.outputs.TimeSpanResponse[] | undefined>;
    /**
     ...
     */
    declare public readonly timeInWeek: pulumi.Output<types.outputs.TimeInWeekResponse[] | undefined>;
    /**
     * Resource type
     */
    ...
    constructor(name: string, args: MaintenanceConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["timeInWeek"] = args?.timeInWeek;

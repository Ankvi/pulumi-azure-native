...
export class MaintenanceConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerservice/v20230701:MaintenanceConfiguration';
     ...
     */
    public readonly maintenanceWindow!: pulumi.Output<types.outputs.containerservice.v20230701.MaintenanceWindowResponse | undefined>;
    /**
     ...
     */
    public readonly notAllowedTime!: pulumi.Output<types.outputs.containerservice.v20230701.TimeSpanResponse[] | undefined>;
    /**
     ...
     */
    public readonly timeInWeek!: pulumi.Output<types.outputs.containerservice.v20230701.TimeInWeekResponse[] | undefined>;
    /**
     * Resource type
     */
    ...
    constructor(name: string, args: MaintenanceConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["maintenanceWindow"] = args ? (args.maintenanceWindow ? pulumi.output(args.maintenanceWindow).apply(types.inputs.containerservice.v20230701.maintenanceWindowArgsProvideDefaults) : undefined) : undefined;
...
export interface MaintenanceConfigurationArgs {
     ...
     * Maintenance window for the maintenance configuration.
     */
    maintenanceWindow?: pulumi.Input<types.inputs.containerservice.v20230701.MaintenanceWindowArgs>;
    /**
     * Time slots on which upgrade is not allowed.
     */
    notAllowedTime?: pulumi.Input<pulumi.Input<types.inputs.containerservice.v20230701.TimeSpanArgs>[]>;
    /**
     ...
     * If two array entries specify the same day of the week, the applied configuration is the union of times in both entries.
     */
    timeInWeek?: pulumi.Input<pulumi.Input<types.inputs.containerservice.v20230701.TimeInWeekArgs>[]>;
}

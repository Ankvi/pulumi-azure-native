...
export class MaintenanceConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerservice/v20230502preview:MaintenanceConfiguration';
     ...
     */
    public readonly maintenanceWindow!: pulumi.Output<types.outputs.containerservice.v20230502preview.MaintenanceWindowResponse | undefined>;
    /**
     ...
     */
    public readonly notAllowedTime!: pulumi.Output<types.outputs.containerservice.v20230502preview.TimeSpanResponse[] | undefined>;
    /**
     ...
     */
    public readonly timeInWeek!: pulumi.Output<types.outputs.containerservice.v20230502preview.TimeInWeekResponse[] | undefined>;
    /**
     * Resource type
     */
    ...
    constructor(name: string, args: MaintenanceConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["maintenanceWindow"] = args ? (args.maintenanceWindow ? pulumi.output(args.maintenanceWindow).apply(types.inputs.containerservice.v20230502preview.maintenanceWindowArgsProvideDefaults) : undefined) : undefined;
...
export interface MaintenanceConfigurationArgs {
     ...
     * Maintenance window for the maintenance configuration.
     */
    maintenanceWindow?: pulumi.Input<types.inputs.containerservice.v20230502preview.MaintenanceWindowArgs>;
    /**
     * Time slots on which upgrade is not allowed.
     */
    notAllowedTime?: pulumi.Input<pulumi.Input<types.inputs.containerservice.v20230502preview.TimeSpanArgs>[]>;
    /**
     ...
     * If two array entries specify the same day of the week, the applied configuration is the union of times in both entries.
     */
    timeInWeek?: pulumi.Input<pulumi.Input<types.inputs.containerservice.v20230502preview.TimeInWeekArgs>[]>;
}

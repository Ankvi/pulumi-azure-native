...
export function getMaintenanceConfiguration(args: GetMaintenanceConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetMaintenanceConfigurationResult> {
    ...
    return pulumi.runtime.invoke("azure-native:containerservice/v20230502preview:getMaintenanceConfiguration", {
...
export interface GetMaintenanceConfigurationResult {
     ...
     */
    readonly maintenanceWindow?: types.outputs.containerservice.v20230502preview.MaintenanceWindowResponse;
    /**
     ...
     */
    readonly notAllowedTime?: types.outputs.containerservice.v20230502preview.TimeSpanResponse[];
    /**
     ...
     */
    readonly timeInWeek?: types.outputs.containerservice.v20230502preview.TimeInWeekResponse[];
    /**
     * Resource type
     */

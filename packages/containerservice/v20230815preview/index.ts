...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:containerservice/v20230815preview:Fleet":
                return new Fleet(name, <any>undefined, { urn })
            case "azure-native:containerservice/v20230815preview:FleetMember":
            ...
            case "azure-native:containerservice/v20230815preview:UpdateRun":

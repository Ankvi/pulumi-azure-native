...
export function getMaintenanceConfiguration(args: GetMaintenanceConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetMaintenanceConfigurationResult> {
    ...
    return pulumi.runtime.invoke("azure-native:containerservice/v20230401:getMaintenanceConfiguration", {
...
export interface GetMaintenanceConfigurationResult {
     ...
     */
    readonly notAllowedTime?: types.outputs.containerservice.v20230401.TimeSpanResponse[];
    /**
     ...
     */
    readonly timeInWeek?: types.outputs.containerservice.v20230401.TimeInWeekResponse[];
    /**
     * Resource type
     */

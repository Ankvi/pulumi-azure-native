...
export class MaintenanceConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerservice/v20230901:MaintenanceConfiguration';

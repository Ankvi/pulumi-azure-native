...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:containerservice/v20230901:AgentPool":
                return new AgentPool(name, <any>undefined, { urn })
            case "azure-native:containerservice/v20230901:MaintenanceConfiguration":
                return new MaintenanceConfiguration(name, <any>undefined, { urn })
            case "azure-native:containerservice/v20230901:ManagedCluster":
                return new ManagedCluster(name, <any>undefined, { urn })
            case "azure-native:containerservice/v20230901:PrivateEndpointConnection":
                return new PrivateEndpointConnection(name, <any>undefined, { urn })
            case "azure-native:containerservice/v20230901:Snapshot":
                return new Snapshot(name, <any>undefined, { urn })
            case "azure-native:containerservice/v20230901:TrustedAccessRoleBinding":
...
pulumi.runtime.registerResourceModule("azure-native", "containerservice/v20230901", _module)
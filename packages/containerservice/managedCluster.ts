...
export class ManagedCluster extends pulumi.CustomResource {
     ...
     */
    declare public readonly aadProfile: pulumi.Output<types.outputs.ManagedClusterAADProfileResponse | undefined>;
    /**
     * The profile of managed cluster add-on.
     */
    declare public readonly addonProfiles: pulumi.Output<{[key: string]: types.outputs.ManagedClusterAddonProfileResponse} | undefined>;
    /**
     * The agent pool properties.
     */
    declare public readonly agentPoolProfiles: pulumi.Output<types.outputs.ManagedClusterAgentPoolProfileResponse[] | undefined>;
    /**
     * AI toolchain operator settings that apply to the whole cluster.
     */
    declare public readonly aiToolchainOperatorProfile: pulumi.Output<types.outputs.ManagedClusterAIToolchainOperatorProfileResponse | undefined>;
    /**
     * The access profile for managed cluster API server.
     */
    declare public readonly apiServerAccessProfile: pulumi.Output<types.outputs.ManagedClusterAPIServerAccessProfileResponse | undefined>;
    /**
     * Parameters to be applied to the cluster-autoscaler when enabled
     */
    declare public readonly autoScalerProfile: pulumi.Output<types.outputs.ManagedClusterPropertiesResponseAutoScalerProfile | undefined>;
    /**
     * The auto upgrade configuration.
     */
    declare public readonly autoUpgradeProfile: pulumi.Output<types.outputs.ManagedClusterAutoUpgradeProfileResponse | undefined>;
    /**
     ...
     */
    declare public readonly azureMonitorProfile: pulumi.Output<types.outputs.ManagedClusterAzureMonitorProfileResponse | undefined>;
    /**
     ...
     */
    declare public readonly bootstrapProfile: pulumi.Output<types.outputs.ManagedClusterBootstrapProfileResponse | undefined>;
    /**
     ...
     */
    declare public readonly httpProxyConfig: pulumi.Output<types.outputs.ManagedClusterHTTPProxyConfigResponse | undefined>;
    /**
     * The identity of the managed cluster, if configured.
     */
    declare public readonly identity: pulumi.Output<types.outputs.ManagedClusterIdentityResponse | undefined>;
    /**
     * The user identity associated with the managed cluster. This identity will be used by the kubelet. Only one user assigned identity is allowed. The only accepted key is "kubeletidentity", with value of "resourceId": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}".
     */
    declare public readonly identityProfile: pulumi.Output<{[key: string]: types.outputs.UserAssignedIdentityResponse} | undefined>;
    /**
     * Ingress profile for the managed cluster.
     */
    declare public readonly ingressProfile: pulumi.Output<types.outputs.ManagedClusterIngressProfileResponse | undefined>;
    /**
     ...
     */
    declare public readonly linuxProfile: pulumi.Output<types.outputs.ContainerServiceLinuxProfileResponse | undefined>;
    /**
     ...
     */
    declare public readonly metricsProfile: pulumi.Output<types.outputs.ManagedClusterMetricsProfileResponse | undefined>;
    /**
     ...
     */
    declare public readonly networkProfile: pulumi.Output<types.outputs.ContainerServiceNetworkProfileResponse | undefined>;
    /**
     * Node provisioning settings that apply to the whole cluster.
     */
    declare public readonly nodeProvisioningProfile: pulumi.Output<types.outputs.ManagedClusterNodeProvisioningProfileResponse | undefined>;
    /**
     ...
     */
    declare public readonly nodeResourceGroupProfile: pulumi.Output<types.outputs.ManagedClusterNodeResourceGroupProfileResponse | undefined>;
    /**
     * The OIDC issuer profile of the Managed Cluster.
     */
    declare public readonly oidcIssuerProfile: pulumi.Output<types.outputs.ManagedClusterOIDCIssuerProfileResponse | undefined>;
    /**
     ...
     */
    declare public readonly podIdentityProfile: pulumi.Output<types.outputs.ManagedClusterPodIdentityProfileResponse | undefined>;
    /**
     * The Power State of the cluster.
     */
    declare public /*out*/ readonly powerState: pulumi.Output<types.outputs.PowerStateResponse>;
    /**
     ...
     */
    declare public readonly privateLinkResources: pulumi.Output<types.outputs.PrivateLinkResourceResponse[] | undefined>;
    /**
     ...
     */
    declare public readonly securityProfile: pulumi.Output<types.outputs.ManagedClusterSecurityProfileResponse | undefined>;
    /**
     * Service mesh profile for a managed cluster.
     */
    declare public readonly serviceMeshProfile: pulumi.Output<types.outputs.ServiceMeshProfileResponse | undefined>;
    /**
     * Information about a service principal identity for the cluster to use for manipulating Azure APIs.
     */
    declare public readonly servicePrincipalProfile: pulumi.Output<types.outputs.ManagedClusterServicePrincipalProfileResponse | undefined>;
    /**
     * The managed cluster SKU.
     */
    declare public readonly sku: pulumi.Output<types.outputs.ManagedClusterSKUResponse | undefined>;
    /**
     * Contains read-only information about the Managed Cluster.
     */
    declare public /*out*/ readonly status: pulumi.Output<types.outputs.ManagedClusterStatusResponse | undefined>;
    /**
     * Storage profile for the managed cluster.
     */
    declare public readonly storageProfile: pulumi.Output<types.outputs.ManagedClusterStorageProfileResponse | undefined>;
    /**
     ...
     */
    declare public readonly upgradeSettings: pulumi.Output<types.outputs.ClusterUpgradeSettingsResponse | undefined>;
    /**
     * The profile for Windows VMs in the Managed Cluster.
     */
    declare public readonly windowsProfile: pulumi.Output<types.outputs.ManagedClusterWindowsProfileResponse | undefined>;
    /**
     * Workload Auto-scaler profile for the managed cluster.
     */
    declare public readonly workloadAutoScalerProfile: pulumi.Output<types.outputs.ManagedClusterWorkloadAutoScalerProfileResponse | undefined>;

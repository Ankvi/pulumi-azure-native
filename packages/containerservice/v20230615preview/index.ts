...
// Export enums:
export * from "../types/enums/v20230615preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:containerservice/v20230615preview:Fleet":
                return new Fleet(name, <any>undefined, { urn })
            case "azure-native:containerservice/v20230615preview:FleetMember":
                return new FleetMember(name, <any>undefined, { urn })
            case "azure-native:containerservice/v20230615preview:UpdateRun":
...
pulumi.runtime.registerResourceModule("azure-native", "containerservice/v20230615preview", _module)

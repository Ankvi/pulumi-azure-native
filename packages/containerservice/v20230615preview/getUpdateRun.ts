...
export interface GetUpdateRunResult {
     ...
     */
    readonly managedClusterUpdate: types.outputs.containerservice.v20230615preview.ManagedClusterUpdateResponse;
    /**
     ...
     */
    readonly status: types.outputs.containerservice.v20230615preview.UpdateRunStatusResponse;
    /**
     * The strategy defines the order in which the clusters will be updated. 
     * If not set, all members will be updated sequentially. The UpdateRun status will show a single UpdateStage and a single UpdateGroup targeting all members.
     * The strategy of the UpdateRun can be modified until the run is started.
     */
    readonly strategy?: types.outputs.containerservice.v20230615preview.UpdateRunStrategyResponse;
    /**

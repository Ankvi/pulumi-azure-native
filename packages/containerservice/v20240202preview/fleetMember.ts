...
export class FleetMember extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerservice/v20240202preview:FleetMember';
    ...
    constructor(name: string, args: FleetMemberArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:containerservice:FleetMember" }, { type: "azure-native:containerservice/v20220602preview:FleetMember" }, { type: "azure-native:containerservice/v20220702preview:FleetMember" }, { type: "azure-native:containerservice/v20220902preview:FleetMember" }, { type: "azure-native:containerservice/v20230315preview:FleetMember" }, { type: "azure-native:containerservice/v20230615preview:FleetMember" }, { type: "azure-native:containerservice/v20230815preview:FleetMember" }, { type: "azure-native:containerservice/v20231015:FleetMember" }] };

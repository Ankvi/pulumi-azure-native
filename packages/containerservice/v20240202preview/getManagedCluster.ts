...
export function getManagedCluster(args: GetManagedClusterArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedClusterResult> {
    ...
    return pulumi.runtime.invoke("azure-native:containerservice/v20240202preview:getManagedCluster", {
...
export interface GetManagedClusterResult {
     ...
     */
    readonly aiToolchainOperatorProfile?: types.outputs.ManagedClusterAIToolchainOperatorProfileResponse;
    /**
     ...
     */
    readonly bootstrapProfile?: types.outputs.ManagedClusterBootstrapProfileResponse;
    /**
     ...
     */
    readonly metricsProfile?: types.outputs.ManagedClusterMetricsProfileResponse;
    /**
     ...
     */
    readonly nodeProvisioningProfile?: types.outputs.ManagedClusterNodeProvisioningProfileResponse;
    /**
     ...
     */
    readonly safeguardsProfile?: types.outputs.SafeguardsProfileResponse;
    /**

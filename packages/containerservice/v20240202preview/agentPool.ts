...
export class AgentPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerservice/v20240202preview:AgentPool';
     ...
     */
    public readonly gatewayProfile!: pulumi.Output<types.outputs.AgentPoolGatewayProfileResponse | undefined>;
    /**
    ...
    constructor(name: string, args: AgentPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["gatewayProfile"] = undefined /*out*/;

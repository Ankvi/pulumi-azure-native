...
export class AgentPool extends pulumi.CustomResource {
     ...
     */
    declare public readonly gatewayProfile: pulumi.Output<types.outputs.AgentPoolGatewayProfileResponse | undefined>;
    /**
     ...
     */
    declare public readonly gpuProfile: pulumi.Output<types.outputs.GPUProfileResponse | undefined>;
    /**
     ...
     */
    declare public readonly kubeletConfig: pulumi.Output<types.outputs.KubeletConfigResponse | undefined>;
    /**
     ...
     */
    declare public readonly linuxOSConfig: pulumi.Output<types.outputs.LinuxOSConfigResponse | undefined>;
    /**
     ...
     */
    declare public readonly networkProfile: pulumi.Output<types.outputs.AgentPoolNetworkProfileResponse | undefined>;
    /**
     ...
     */
    declare public readonly podIPAllocationMode: pulumi.Output<string | undefined>;
    /**
     ...
     */
    declare public readonly powerState: pulumi.Output<types.outputs.PowerStateResponse | undefined>;
    /**
     ...
     */
    declare public readonly securityProfile: pulumi.Output<types.outputs.AgentPoolSecurityProfileResponse | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly status: pulumi.Output<types.outputs.AgentPoolStatusResponse | undefined>;
    /**
     ...
     */
    declare public readonly upgradeSettings: pulumi.Output<types.outputs.AgentPoolUpgradeSettingsResponse | undefined>;
    /**
     * The status of nodes in a VirtualMachines agent pool.
     */
    declare public readonly virtualMachineNodesStatus: pulumi.Output<types.outputs.VirtualMachineNodesResponse[] | undefined>;
    /**
     * Specifications on VirtualMachines agent pool.
     */
    declare public readonly virtualMachinesProfile: pulumi.Output<types.outputs.VirtualMachinesProfileResponse | undefined>;
    /**
     ...
     */
    declare public readonly windowsProfile: pulumi.Output<types.outputs.AgentPoolWindowsProfileResponse | undefined>;
    /**
    ...
    constructor(name: string, args: AgentPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["podIPAllocationMode"] = args?.podIPAllocationMode;
            ...
            resourceInputs["virtualMachineNodesStatus"] = args?.virtualMachineNodesStatus;
            resourceInputs["virtualMachinesProfile"] = args?.virtualMachinesProfile;

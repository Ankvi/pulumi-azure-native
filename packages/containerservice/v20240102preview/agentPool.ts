...
export class AgentPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerservice/v20240102preview:AgentPool';
     ...
     */
    public readonly artifactStreamingProfile!: pulumi.Output<types.outputs.AgentPoolArtifactStreamingProfileResponse | undefined>;
    /**
     ...
     */
    public readonly gpuProfile!: pulumi.Output<types.outputs.AgentPoolGPUProfileResponse | undefined>;
    /**
     ...
     */
    public readonly networkProfile!: pulumi.Output<types.outputs.AgentPoolNetworkProfileResponse | undefined>;
    /**
     ...
     */
    public readonly nodeInitializationTaints!: pulumi.Output<string[] | undefined>;
    /**
     ...
     */
    public readonly podIPAllocationMode!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly securityProfile!: pulumi.Output<types.outputs.AgentPoolSecurityProfileResponse | undefined>;
    /**
     ...
     */
    public readonly virtualMachineNodesStatus!: pulumi.Output<types.outputs.VirtualMachineNodesResponse[] | undefined>;
    /**
     * Specifications on VirtualMachines agent pool.
     */
    public readonly virtualMachinesProfile!: pulumi.Output<types.outputs.VirtualMachinesProfileResponse | undefined>;
    /**
     ...
     */
    public readonly windowsProfile!: pulumi.Output<types.outputs.AgentPoolWindowsProfileResponse | undefined>;
    /**
    ...
    constructor(name: string, args: AgentPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["artifactStreamingProfile"] = args ? args.artifactStreamingProfile : undefined;
            ...
            resourceInputs["gpuProfile"] = args ? args.gpuProfile : undefined;
            ...
            resourceInputs["nodeInitializationTaints"] = args ? args.nodeInitializationTaints : undefined;
            ...
            resourceInputs["podIPAllocationMode"] = args ? args.podIPAllocationMode : undefined;
            ...
            resourceInputs["virtualMachineNodesStatus"] = args ? args.virtualMachineNodesStatus : undefined;
            resourceInputs["virtualMachinesProfile"] = args ? args.virtualMachinesProfile : undefined;
            ...
            resourceInputs["artifactStreamingProfile"] = undefined /*out*/;
            ...
            resourceInputs["gpuProfile"] = undefined /*out*/;
            ...
            resourceInputs["nodeImageVersion"] = undefined /*out*/;
            resourceInputs["nodeInitializationTaints"] = undefined /*out*/;
            ...
            resourceInputs["podIPAllocationMode"] = undefined /*out*/;
            ...
            resourceInputs["virtualMachineNodesStatus"] = undefined /*out*/;
            resourceInputs["virtualMachinesProfile"] = undefined /*out*/;
...
export interface AgentPoolArgs {
     ...
     * Configuration for using artifact streaming on AKS.
     */
    artifactStreamingProfile?: pulumi.Input<types.inputs.AgentPoolArtifactStreamingProfileArgs>;
    /**
     * The list of Availability zones to use for nodes. This can only be specified if the AgentPoolType property is 'VirtualMachineScaleSets'.
     */
     ...
     * The GPU settings of an agent pool.
     */
    gpuProfile?: pulumi.Input<types.inputs.AgentPoolGPUProfileArgs>;
    /**
     * This is of the form: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/hostGroups/{hostGroupName}. For more information see [Azure dedicated hosts](https://docs.microsoft.com/azure/virtual-machines/dedicated-hosts).
     */
     ...
     * These taints will not be reconciled by AKS and can be removed with a kubectl call. This field can be modified after node pool is created, but nodes will not be recreated with new taints until another operation that requires recreation (e.g. node image upgrade) happens. These taints allow for required configuration to run before the node is ready to accept workloads, for example 'key1=value1:NoSchedule' that then can be removed with `kubectl taint nodes node1 key1=value1:NoSchedule-`
     */
    nodeInitializationTaints?: pulumi.Input<pulumi.Input<string>[]>;
    /**
     * The node labels to be persisted across all nodes in agent pool.
     */

...
export class AgentPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerservice/v20230602preview:AgentPool';
     ...
     */
    public readonly kubeletConfig!: pulumi.Output<types.outputs.containerservice.v20230602preview.KubeletConfigResponse | undefined>;
    /**
     ...
     */
    public readonly linuxOSConfig!: pulumi.Output<types.outputs.containerservice.v20230602preview.LinuxOSConfigResponse | undefined>;
    /**
     ...
     */
    public readonly networkProfile!: pulumi.Output<types.outputs.containerservice.v20230602preview.AgentPoolNetworkProfileResponse | undefined>;
    /**
     ...
     */
    public readonly powerState!: pulumi.Output<types.outputs.containerservice.v20230602preview.PowerStateResponse | undefined>;
    /**
     ...
     */
    public readonly securityProfile!: pulumi.Output<types.outputs.containerservice.v20230602preview.AgentPoolSecurityProfileResponse | undefined>;
    /**
     ...
     */
    public readonly upgradeSettings!: pulumi.Output<types.outputs.containerservice.v20230602preview.AgentPoolUpgradeSettingsResponse | undefined>;
    /**
     ...
     */
    public readonly windowsProfile!: pulumi.Output<types.outputs.containerservice.v20230602preview.AgentPoolWindowsProfileResponse | undefined>;
    /**
...
export interface AgentPoolArgs {
     ...
     * GPUInstanceProfile to be used to specify GPU MIG instance profile for supported GPU VM SKU.
     */
    gpuInstanceProfile?: pulumi.Input<string | types.enums.v20230602preview.GPUInstanceProfile>;
    /**
     * This is of the form: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/hostGroups/{hostGroupName}. For more information see [Azure dedicated hosts](https://docs.microsoft.com/azure/virtual-machines/dedicated-hosts).
     */
     ...
     * The Kubelet configuration on the agent pool nodes.
     */
    kubeletConfig?: pulumi.Input<types.inputs.containerservice.v20230602preview.KubeletConfigArgs>;
    /**
     * Determines the placement of emptyDir volumes, container runtime data root, and Kubelet ephemeral storage.
     */
    kubeletDiskType?: pulumi.Input<string | types.enums.v20230602preview.KubeletDiskType>;
    /**
     * The OS configuration of Linux agent nodes.
     */
    linuxOSConfig?: pulumi.Input<types.inputs.containerservice.v20230602preview.LinuxOSConfigArgs>;
    /**
     * The maximum number of nodes for auto-scaling
     */
     ...
     * A cluster must have at least one 'System' Agent Pool at all times. For additional information on agent pool restrictions and best practices, see: https://docs.microsoft.com/azure/aks/use-system-pools
     */
    mode?: pulumi.Input<string | types.enums.v20230602preview.AgentPoolMode>;
    /**
     * Network-related settings of an agent pool.
     */
    networkProfile?: pulumi.Input<types.inputs.containerservice.v20230602preview.AgentPoolNetworkProfileArgs>;
    /**
     * The node labels to be persisted across all nodes in agent pool.
     */
     ...
     * The default is 'Ephemeral' if the VM supports it and has a cache disk larger than the requested OSDiskSizeGB. Otherwise, defaults to 'Managed'. May not be changed after creation. For more information see [Ephemeral OS](https://docs.microsoft.com/azure/aks/cluster-configuration#ephemeral-os).
     */
    osDiskType?: pulumi.Input<string | types.enums.v20230602preview.OSDiskType>;
    /**
     * Specifies the OS SKU used by the agent pool. If not specified, the default is Ubuntu if OSType=Linux or Windows2019 if OSType=Windows. And the default Windows OSSKU will be changed to Windows2022 after Windows2019 is deprecated.
     */
    osSKU?: pulumi.Input<string | types.enums.v20230602preview.OSSKU>;
    /**
     * The operating system type. The default is Linux.
     */
    osType?: pulumi.Input<string | types.enums.v20230602preview.OSType>;
    /**
     * If omitted, pod IPs are statically assigned on the node subnet (see vnetSubnetID for more details). This is of the form: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{virtualNetworkName}/subnets/{subnetName}
     */
     ...
     * When an Agent Pool is first created it is initially Running. The Agent Pool can be stopped by setting this field to Stopped. A stopped Agent Pool stops all of its VMs and does not accrue billing charges. An Agent Pool can only be stopped if it is Running and provisioning state is Succeeded
     */
    powerState?: pulumi.Input<types.inputs.containerservice.v20230602preview.PowerStateArgs>;
    /**
     * The ID for Proximity Placement Group.
     */
     ...
     * This also effects the cluster autoscaler behavior. If not specified, it defaults to Delete.
     */
    scaleDownMode?: pulumi.Input<string | types.enums.v20230602preview.ScaleDownMode>;
    /**
     * This cannot be specified unless the scaleSetPriority is 'Spot'. If not specified, the default is 'Delete'.
     */
    scaleSetEvictionPolicy?: pulumi.Input<string | types.enums.v20230602preview.ScaleSetEvictionPolicy>;
    /**
     * The Virtual Machine Scale Set priority. If not specified, the default is 'Regular'.
     */
    scaleSetPriority?: pulumi.Input<string | types.enums.v20230602preview.ScaleSetPriority>;
    /**
     * The security settings of an agent pool.
     */
    securityProfile?: pulumi.Input<types.inputs.containerservice.v20230602preview.AgentPoolSecurityProfileArgs>;
    /**
     * Possible values are any decimal value greater than zero or -1 which indicates the willingness to pay any on-demand price. For more details on spot pricing, see [spot VMs pricing](https://docs.microsoft.com/azure/virtual-machines/spot-vms#pricing)
     */
     ...
     */
    type?: pulumi.Input<string | types.enums.v20230602preview.AgentPoolType>;
    /**
     * Settings for upgrading the agentpool
     */
    upgradeSettings?: pulumi.Input<types.inputs.containerservice.v20230602preview.AgentPoolUpgradeSettingsArgs>;
    /**
     * VM size availability varies by region. If a node contains insufficient compute resources (memory, cpu, etc) pods might fail to run correctly. For more details on restricted VM sizes, see: https://docs.microsoft.com/azure/aks/quotas-skus-regions
     */
     ...
     * The Windows agent pool's specific profile.
     */
    windowsProfile?: pulumi.Input<types.inputs.containerservice.v20230602preview.AgentPoolWindowsProfileArgs>;
    /**
     * Determines the type of workload a node can run.
     */
    workloadRuntime?: pulumi.Input<string | types.enums.v20230602preview.WorkloadRuntime>;
}

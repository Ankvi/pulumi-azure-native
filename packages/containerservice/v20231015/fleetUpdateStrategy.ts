...
export class FleetUpdateStrategy extends pulumi.CustomResource {
    ...
    constructor(name: string, args: FleetUpdateStrategyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:containerservice:FleetUpdateStrategy" }, { type: "azure-native:containerservice/v20230815preview:FleetUpdateStrategy" }] };

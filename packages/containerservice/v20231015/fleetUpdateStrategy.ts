...
export class FleetUpdateStrategy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerservice/v20231015:FleetUpdateStrategy';
    ...
    constructor(name: string, args: FleetUpdateStrategyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:containerservice:FleetUpdateStrategy" }, { type: "azure-native:containerservice/v20230815preview:FleetUpdateStrategy" }, { type: "azure-native:containerservice/v20240202preview:FleetUpdateStrategy" }] };

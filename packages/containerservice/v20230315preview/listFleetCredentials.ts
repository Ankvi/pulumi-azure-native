...
export function listFleetCredentials(args: ListFleetCredentialsArgs, opts?: pulumi.InvokeOptions): Promise<ListFleetCredentialsResult> {
    ...
    return pulumi.runtime.invoke("azure-native:containerservice/v20230315preview:listFleetCredentials", {
...
export interface ListFleetCredentialsResult {
     ...
     */
    readonly kubeconfigs: types.outputs.containerservice.v20230315preview.FleetCredentialResultResponse[];
}
/**
 * Lists the user credentials of a Fleet.
 */

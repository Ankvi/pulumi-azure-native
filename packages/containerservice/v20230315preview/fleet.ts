...
export class Fleet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerservice/v20230315preview:Fleet';
    ...
    constructor(name: string, args: FleetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:containerservice:Fleet" }, { type: "azure-native:containerservice/v20220602preview:Fleet" }, { type: "azure-native:containerservice/v20220702preview:Fleet" }, { type: "azure-native:containerservice/v20220902preview:Fleet" }, { type: "azure-native:containerservice/v20230615preview:Fleet" }, { type: "azure-native:containerservice/v20230815preview:Fleet" }, { type: "azure-native:containerservice/v20231015:Fleet" }, { type: "azure-native:containerservice/v20240202preview:Fleet" }] };

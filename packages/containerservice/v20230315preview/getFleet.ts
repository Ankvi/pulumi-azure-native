...
export function getFleet(args: GetFleetArgs, opts?: pulumi.InvokeOptions): Promise<GetFleetResult> {
    ...
    return pulumi.runtime.invoke("azure-native:containerservice/v20230315preview:getFleet", {
...
export interface GetFleetResult {
     ...
     */
    readonly hubProfile?: types.outputs.containerservice.v20230315preview.FleetHubProfileResponse;
    /**

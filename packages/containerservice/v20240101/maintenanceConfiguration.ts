...
export class MaintenanceConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerservice/v20240101:MaintenanceConfiguration';

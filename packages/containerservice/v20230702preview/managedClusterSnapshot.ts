...
export class ManagedClusterSnapshot extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerservice/v20230702preview:ManagedClusterSnapshot';

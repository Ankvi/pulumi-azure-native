...
export function getManagedClusterSnapshot(args: GetManagedClusterSnapshotArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedClusterSnapshotResult> {
    ...
    return pulumi.runtime.invoke("azure-native:containerservice/v20230702preview:getManagedClusterSnapshot", {
...
export interface GetManagedClusterSnapshotResult {
     ...
     */
    readonly managedClusterPropertiesReadOnly: types.outputs.containerservice.v20230702preview.ManagedClusterPropertiesForSnapshotResponse;
    /**

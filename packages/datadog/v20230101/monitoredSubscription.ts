...
export class MonitoredSubscription extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:datadog/v20230101:MonitoredSubscription';
    ...
    constructor(name: string, args: MonitoredSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:datadog:MonitoredSubscription" }] };

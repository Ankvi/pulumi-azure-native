...
export class ImportJob extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ImportJobArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:storagecache/v20240301:ImportJob" }, { type: "azure-native:storagecache/v20240301:importJob" }, { type: "azure-native:storagecache:importJob" }] };

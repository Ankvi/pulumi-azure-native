...
export class AmlFilesystem extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AmlFilesystemArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:storagecache/v20230501:amlFilesystem" }, { type: "azure-native:storagecache:AmlFilesystem" }, { type: "azure-native:storagecache:amlFilesystem" }, { type: "azure-native:storagecache/v20230301preview:AmlFilesystem" }, { type: "azure-native:storagecache/v20230301preview:amlFilesystem" }, { type: "azure-native:storagecache/v20231101preview:AmlFilesystem" }, { type: "azure-native:storagecache/v20231101preview:amlFilesystem" }] };

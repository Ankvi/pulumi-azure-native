...
export class AmlFilesystem extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:storagecache/v20230501:AmlFilesystem';
    ...
    constructor(name: string, args: AmlFilesystemArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:storagecache/v20230501:amlFilesystem" }, { type: "azure-native:storagecache:AmlFilesystem" }, { type: "azure-native:storagecache:amlFilesystem" }, { type: "azure-native:storagecache/v20230301preview:AmlFilesystem" }, { type: "azure-native:storagecache/v20230301preview:amlFilesystem" }] };

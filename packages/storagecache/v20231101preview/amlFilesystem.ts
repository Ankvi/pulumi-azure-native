...
export class AmlFilesystem extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:storagecache/v20231101preview:AmlFilesystem';

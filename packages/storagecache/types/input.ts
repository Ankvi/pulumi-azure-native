...
export namespace storagecache {
    ...
    export namespace v20210301 {
        ...
        export interface CacheActiveDirectorySettingsArgs {
             ...
             * Active Directory admin credentials used to join the HPC Cache to a domain.
             */
            credentials?: pulumi.Input<v20210301.CacheActiveDirectorySettingsCredentialsArgs>;
            /**
             * The fully qualified domain name of the Active Directory domain controller.
             */
            domainName: pulumi.Input<string>;
        ...
        export interface CacheDirectorySettingsArgs {
             ...
             * Specifies settings for joining the HPC Cache to an Active Directory domain.
             */
            activeDirectory?: pulumi.Input<v20210301.CacheActiveDirectorySettingsArgs>;
            /**
             * Specifies settings for Extended Groups. Extended Groups allows users to be members of more than 16 groups.
             */
            usernameDownload?: pulumi.Input<v20210301.CacheUsernameDownloadSettingsArgs>;
        }
        /**
         * cacheDirectorySettingsArgsProvideDefaults sets the appropriate defaults for CacheDirectorySettingsArgs
         */
        export function cacheDirectorySettingsArgsProvideDefaults(val: CacheDirectorySettingsArgs): CacheDirectorySettingsArgs {
            return {
                ...val,
                usernameDownload: (val.usernameDownload ? pulumi.output(val.usernameDownload).apply(v20210301.cacheUsernameDownloadSettingsArgsProvideDefaults) : undefined),
            };
        }
        ...
        export interface CacheEncryptionSettingsArgs {
             ...
             * Specifies the location of the key encryption key in Key Vault.
             */
            keyEncryptionKey?: pulumi.Input<v20210301.KeyVaultKeyReferenceArgs>;
        }
        ...
        export interface CacheIdentityArgs {
             ...
             * The type of identity used for the cache
             */
            type?: pulumi.Input<enums.v20210301.CacheIdentityType>;
        }
        ...
        export interface CacheSecuritySettingsArgs {
             ...
             * NFS access policies defined for this cache.
             */
            accessPolicies?: pulumi.Input<pulumi.Input<v20210301.NfsAccessPolicyArgs>[]>;
        }
        ...
        export interface CacheUsernameDownloadSettingsArgs {
             ...
             * When present, these are the credentials for the secure LDAP connection.
             */
            credentials?: pulumi.Input<v20210301.CacheUsernameDownloadSettingsCredentialsArgs>;
            /**
             * Whether or not the LDAP connection should be encrypted.
             */
            encryptLdapConnection?: pulumi.Input<boolean>;
             ...
             * This setting determines how the cache gets username and group names for clients.
             */
            usernameSource?: pulumi.Input<string | enums.v20210301.UsernameSource>;
        }
        /**
         * cacheUsernameDownloadSettingsArgsProvideDefaults sets the appropriate defaults for CacheUsernameDownloadSettingsArgs
         */
        ...
        export interface KeyVaultKeyReferenceArgs {
             ...
             * Describes a resource Id to source Key Vault.
             */
            sourceVault: pulumi.Input<v20210301.KeyVaultKeyReferenceSourceVaultArgs>;
        }
        ...
        export interface NfsAccessPolicyArgs {
             ...
             * The set of rules describing client accesses allowed under this policy.
             */
            accessRules: pulumi.Input<pulumi.Input<v20210301.NfsAccessRuleArgs>[]>;
            /**
             * Name identifying this policy. Access Policy names are not case sensitive.
             */
            name: pulumi.Input<string>;
        ...
        export interface NfsAccessRuleArgs {
             ...
             * Access allowed by this rule.
             */
            access: pulumi.Input<string | enums.v20210301.NfsAccessRuleAccess>;
            /**
             * GID value that replaces 0 when rootSquash is true. This will use the value of anonymousUID if not provided.
             */
            anonymousGID?: pulumi.Input<string>;
             ...
             * Scope for this rule. The scope and filter determine which clients match the rule.
             */
            scope: pulumi.Input<string | enums.v20210301.NfsAccessRuleScope>;
            /**
             * For the default policy, allow access to subdirectories under the root export. If this is set to no, clients can only mount the path '/'. If set to yes, clients can mount a deeper path, like '/a/b'.
             */
            submountAccess?: pulumi.Input<boolean>;
    ...
    export namespace v20230301preview {
        ...
        export interface AmlFilesystemEncryptionSettingsArgs {
             ...
             * Specifies the location of the encryption key in Key Vault.
             */
            keyEncryptionKey?: pulumi.Input<v20230301preview.KeyVaultKeyReferenceArgs>;
        }
        ...
        export interface AmlFilesystemHsmArgs {
             ...
             * Specifies HSM settings of the AML file system.
             */
            settings?: pulumi.Input<v20230301preview.AmlFilesystemHsmSettingsArgs>;
        }
        /**
         * amlFilesystemHsmArgsProvideDefaults sets the appropriate defaults for AmlFilesystemHsmArgs
         */
        export function amlFilesystemHsmArgsProvideDefaults(val: AmlFilesystemHsmArgs): AmlFilesystemHsmArgs {
            return {
                ...val,
                settings: (val.settings ? pulumi.output(val.settings).apply(v20230301preview.amlFilesystemHsmSettingsArgsProvideDefaults) : undefined),
            };
        }
        ...
        export interface AmlFilesystemIdentityArgs {
             ...
             * The type of identity used for the resource.
             */
            type?: pulumi.Input<enums.v20230301preview.AmlFilesystemIdentityType>;
            /**
             * A dictionary where each key is a user assigned identity resource ID, and each key's value is an empty dictionary.
             */
            userAssignedIdentities?: pulumi.Input<pulumi.Input<string>[]>;
        ...
        export interface AmlFilesystemMaintenanceWindowArgs {
             ...
             * Day of the week on which the maintenance window will occur.
             */
            dayOfWeek?: pulumi.Input<enums.v20230301preview.MaintenanceDayOfWeekType>;
            /**
             * The time of day (in UTC) to start the maintenance window.
             */
            timeOfDayUTC?: pulumi.Input<string>;
        ...
        export interface CacheActiveDirectorySettingsArgs {
             ...
             * Active Directory admin credentials used to join the HPC Cache to a domain.
             */
            credentials?: pulumi.Input<v20230301preview.CacheActiveDirectorySettingsCredentialsArgs>;
            /**
             * The fully qualified domain name of the Active Directory domain controller.
             */
            domainName: pulumi.Input<string>;
        ...
        export interface CacheDirectorySettingsArgs {
             ...
             * Specifies settings for joining the HPC Cache to an Active Directory domain.
             */
            activeDirectory?: pulumi.Input<v20230301preview.CacheActiveDirectorySettingsArgs>;
            /**
             * Specifies settings for Extended Groups. Extended Groups allows users to be members of more than 16 groups.
             */
            usernameDownload?: pulumi.Input<v20230301preview.CacheUsernameDownloadSettingsArgs>;
        }
        /**
         * cacheDirectorySettingsArgsProvideDefaults sets the appropriate defaults for CacheDirectorySettingsArgs
         */
        export function cacheDirectorySettingsArgsProvideDefaults(val: CacheDirectorySettingsArgs): CacheDirectorySettingsArgs {
            return {
                ...val,
                usernameDownload: (val.usernameDownload ? pulumi.output(val.usernameDownload).apply(v20230301preview.cacheUsernameDownloadSettingsArgsProvideDefaults) : undefined),
            };
        }
        ...
        export interface CacheIdentityArgs {
             ...
             * The type of identity used for the cache
             */
            type?: pulumi.Input<enums.v20230301preview.CacheIdentityType>;
            /**
             * A dictionary where each key is a user assigned identity resource ID, and each key's value is an empty dictionary.
             */
            userAssignedIdentities?: pulumi.Input<pulumi.Input<string>[]>;
        ...
        export interface CacheSecuritySettingsArgs {
             ...
             * NFS access policies defined for this cache.
             */
            accessPolicies?: pulumi.Input<pulumi.Input<v20230301preview.NfsAccessPolicyArgs>[]>;
        }
        ...
        export interface CacheUsernameDownloadSettingsArgs {
             ...
             * When present, these are the credentials for the secure LDAP connection.
             */
            credentials?: pulumi.Input<v20230301preview.CacheUsernameDownloadSettingsCredentialsArgs>;
            /**
             * Whether or not the LDAP connection should be encrypted.
             */
            encryptLdapConnection?: pulumi.Input<boolean>;
             ...
             * This setting determines how the cache gets username and group names for clients.
             */
            usernameSource?: pulumi.Input<string | enums.v20230301preview.UsernameSource>;
        }
        /**
         * cacheUsernameDownloadSettingsArgsProvideDefaults sets the appropriate defaults for CacheUsernameDownloadSettingsArgs
         */
        ...
        export interface KeyVaultKeyReferenceArgs {
             ...
             * Describes a resource Id to source key vault.
             */
            sourceVault: pulumi.Input<v20230301preview.KeyVaultKeyReferenceSourceVaultArgs>;
        }
        ...
        export interface NfsAccessPolicyArgs {
             ...
             * The set of rules describing client accesses allowed under this policy.
             */
            accessRules: pulumi.Input<pulumi.Input<v20230301preview.NfsAccessRuleArgs>[]>;
            /**
             * Name identifying this policy. Access Policy names are not case sensitive.
             */
            name: pulumi.Input<string>;
        ...
        export interface NfsAccessRuleArgs {
             ...
             * Access allowed by this rule.
             */
            access: pulumi.Input<string | enums.v20230301preview.NfsAccessRuleAccess>;
            /**
             * GID value that replaces 0 when rootSquash is true. This will use the value of anonymousUID if not provided.
             */
            anonymousGID?: pulumi.Input<string>;
             ...
             * Scope for this rule. The scope and filter determine which clients match the rule.
             */
            scope: pulumi.Input<string | enums.v20230301preview.NfsAccessRuleScope>;
            /**
             * For the default policy, allow access to subdirectories under the root export. If this is set to no, clients can only mount the path '/'. If set to yes, clients can mount a deeper path, like '/a/b'.
             */
            submountAccess?: pulumi.Input<boolean>;
    ...
    export namespace v20230501 {
        ...
        export interface AmlFilesystemEncryptionSettingsArgs {
             ...
             * Specifies the location of the encryption key in Key Vault.
             */
            keyEncryptionKey?: pulumi.Input<v20230501.KeyVaultKeyReferenceArgs>;
        }
        ...
        export interface AmlFilesystemHsmArgs {
             ...
             * Specifies HSM settings of the AML file system.
             */
            settings?: pulumi.Input<v20230501.AmlFilesystemHsmSettingsArgs>;
        }
        /**
         * amlFilesystemHsmArgsProvideDefaults sets the appropriate defaults for AmlFilesystemHsmArgs
         */
        export function amlFilesystemHsmArgsProvideDefaults(val: AmlFilesystemHsmArgs): AmlFilesystemHsmArgs {
            return {
                ...val,
                settings: (val.settings ? pulumi.output(val.settings).apply(v20230501.amlFilesystemHsmSettingsArgsProvideDefaults) : undefined),
            };
        }
        ...
        export interface AmlFilesystemIdentityArgs {
             ...
             * The type of identity used for the resource.
             */
            type?: pulumi.Input<enums.v20230501.AmlFilesystemIdentityType>;
            /**
             * A dictionary where each key is a user assigned identity resource ID, and each key's value is an empty dictionary.
             */
            userAssignedIdentities?: pulumi.Input<pulumi.Input<string>[]>;
        ...
        export interface AmlFilesystemMaintenanceWindowArgs {
             ...
             * Day of the week on which the maintenance window will occur.
             */
            dayOfWeek?: pulumi.Input<enums.v20230501.MaintenanceDayOfWeekType>;
            /**
             * The time of day (in UTC) to start the maintenance window.
             */
            timeOfDayUTC?: pulumi.Input<string>;
        ...
        export interface CacheActiveDirectorySettingsArgs {
             ...
             * Active Directory admin credentials used to join the HPC Cache to a domain.
             */
            credentials?: pulumi.Input<v20230501.CacheActiveDirectorySettingsCredentialsArgs>;
            /**
             * The fully qualified domain name of the Active Directory domain controller.
             */
            domainName: pulumi.Input<string>;
        ...
        export interface CacheDirectorySettingsArgs {
             ...
             * Specifies settings for joining the HPC Cache to an Active Directory domain.
             */
            activeDirectory?: pulumi.Input<v20230501.CacheActiveDirectorySettingsArgs>;
            /**
             * Specifies settings for Extended Groups. Extended Groups allows users to be members of more than 16 groups.
             */
            usernameDownload?: pulumi.Input<v20230501.CacheUsernameDownloadSettingsArgs>;
        }
        /**
         * cacheDirectorySettingsArgsProvideDefaults sets the appropriate defaults for CacheDirectorySettingsArgs
         */
        export function cacheDirectorySettingsArgsProvideDefaults(val: CacheDirectorySettingsArgs): CacheDirectorySettingsArgs {
            return {
                ...val,
                usernameDownload: (val.usernameDownload ? pulumi.output(val.usernameDownload).apply(v20230501.cacheUsernameDownloadSettingsArgsProvideDefaults) : undefined),
            };
        }
        ...
        export interface CacheIdentityArgs {
             ...
             * The type of identity used for the cache
             */
            type?: pulumi.Input<enums.v20230501.CacheIdentityType>;
            /**
             * A dictionary where each key is a user assigned identity resource ID, and each key's value is an empty dictionary.
             */
            userAssignedIdentities?: pulumi.Input<pulumi.Input<string>[]>;
        ...
        export interface CacheSecuritySettingsArgs {
             ...
             * NFS access policies defined for this cache.
             */
            accessPolicies?: pulumi.Input<pulumi.Input<v20230501.NfsAccessPolicyArgs>[]>;
        }
        ...
        export interface CacheUsernameDownloadSettingsArgs {
             ...
             * When present, these are the credentials for the secure LDAP connection.
             */
            credentials?: pulumi.Input<v20230501.CacheUsernameDownloadSettingsCredentialsArgs>;
            /**
             * Whether or not the LDAP connection should be encrypted.
             */
            encryptLdapConnection?: pulumi.Input<boolean>;
             ...
             * This setting determines how the cache gets username and group names for clients.
             */
            usernameSource?: pulumi.Input<string | enums.v20230501.UsernameSource>;
        }
        /**
         * cacheUsernameDownloadSettingsArgsProvideDefaults sets the appropriate defaults for CacheUsernameDownloadSettingsArgs
         */
        ...
        export interface KeyVaultKeyReferenceArgs {
             ...
             * Describes a resource Id to source key vault.
             */
            sourceVault: pulumi.Input<v20230501.KeyVaultKeyReferenceSourceVaultArgs>;
        }
        ...
        export interface NfsAccessPolicyArgs {
             ...
             * The set of rules describing client accesses allowed under this policy.
             */
            accessRules: pulumi.Input<pulumi.Input<v20230501.NfsAccessRuleArgs>[]>;
            /**
             * Name identifying this policy. Access Policy names are not case sensitive.
             */
            name: pulumi.Input<string>;
        ...
        export interface NfsAccessRuleArgs {
             ...
             * Access allowed by this rule.
             */
            access: pulumi.Input<string | enums.v20230501.NfsAccessRuleAccess>;
            /**
             * GID value that replaces 0 when rootSquash is true. This will use the value of anonymousUID if not provided.
             */
            anonymousGID?: pulumi.Input<string>;
             ...
             * Scope for this rule. The scope and filter determine which clients match the rule.
             */
            scope: pulumi.Input<string | enums.v20230501.NfsAccessRuleScope>;
            /**
             * For the default policy, allow access to subdirectories under the root export. If this is set to no, clients can only mount the path '/'. If set to yes, clients can mount a deeper path, like '/a/b'.
             */
            submountAccess?: pulumi.Input<boolean>;

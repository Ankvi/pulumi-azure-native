...
export class Contact extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly antennaConfiguration: pulumi.Output<types.outputs.ContactsPropertiesResponseAntennaConfiguration>;
    /**
     ...
     */
    declare public readonly contactProfile: pulumi.Output<types.outputs.ContactsPropertiesResponseContactProfile>;
    /**

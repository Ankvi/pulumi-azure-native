...
export class Spacecraft extends pulumi.CustomResource {
     ...
     */
    public readonly links!: pulumi.Output<types.outputs.orbital.v20220301.SpacecraftLinkResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: SpacecraftArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:orbital:Spacecraft" }, { type: "azure-native:orbital/v20221101:Spacecraft" }] };
...
export interface SpacecraftArgs {
     ...
     * Immutable list of Spacecraft links.
     */
    links?: pulumi.Input<pulumi.Input<types.inputs.orbital.v20220301.SpacecraftLinkArgs>[]>;
    /**
     * The geo-location where the resource lives
     */

...
export class ContactProfile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:orbital/v20220301:ContactProfile';
    ...
    constructor(name: string, args: ContactProfileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:orbital:ContactProfile" }, { type: "azure-native:orbital/v20221101:ContactProfile" }] };

...
export class EdgeSite extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:orbital:EdgeSite';
     ...
     */
    declare public readonly globalCommunicationsSite: pulumi.Output<types.outputs.EdgeSitesPropertiesResponseGlobalCommunicationsSite>;
    /**
    ...
    constructor(name: string, args: EdgeSiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["edgeSiteName"] = args?.edgeSiteName;
...
export interface EdgeSiteArgs {
     ...
     * A reference to global communications site.
     */
    globalCommunicationsSite: pulumi.Input<types.inputs.EdgeSitesPropertiesGlobalCommunicationsSiteArgs>;
    /**
     * The geo-location where the resource lives
     */

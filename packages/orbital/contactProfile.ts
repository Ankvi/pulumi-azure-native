...
export class ContactProfile extends pulumi.CustomResource {
     ...
     */
    declare public readonly links: pulumi.Output<types.outputs.ContactProfileLinkResponse[]>;
    /**
     ...
     */
    declare public readonly networkConfiguration: pulumi.Output<types.outputs.ContactProfilesPropertiesResponseNetworkConfiguration>;
    /**
     ...
     */
    declare public readonly thirdPartyConfigurations: pulumi.Output<types.outputs.ContactProfileThirdPartyConfigurationResponse[] | undefined>;
    /**

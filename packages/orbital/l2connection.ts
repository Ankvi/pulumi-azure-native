...
export class L2Connection extends pulumi.CustomResource {
     ...
     */
    declare public readonly edgeSite: pulumi.Output<types.outputs.L2ConnectionsPropertiesResponseEdgeSite>;
    /**
     * A reference to an Microsoft.Orbital/groundStations resource to route traffic for.
     */
    declare public readonly groundStation: pulumi.Output<types.outputs.L2ConnectionsPropertiesResponseGroundStation>;
    /**
     * The name of the partner router to establish a connection to within the ground station.
     */
    declare public readonly groundStationPartnerRouter: pulumi.Output<types.outputs.L2ConnectionsPropertiesResponseGroundStationPartnerRouter>;
    /**
...
export interface L2ConnectionArgs {
     ...
     * The name of the partner router to establish a connection to within the ground station.
     */
    groundStationPartnerRouter: pulumi.Input<types.inputs.L2ConnectionsPropertiesGroundStationPartnerRouterArgs>;
    /**
     * L2 Connection name.
     */

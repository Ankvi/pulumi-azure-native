...
export class GeoCatalog extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): GeoCatalog {
        return new GeoCatalog(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:orbital:GeoCatalog';

    /**
     * Returns true if the given object is an instance of GeoCatalog.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is GeoCatalog {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === GeoCatalog.__pulumiType;
    }
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.GeoCatalogPropertiesResponse>;
    /**
     ...
     */
    constructor(name: string, args: GeoCatalogArgs, opts?: pulumi.CustomResourceOptions) {
 ...
 */
export interface GeoCatalogArgs {
    /**

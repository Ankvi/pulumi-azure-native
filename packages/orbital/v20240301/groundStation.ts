...
export class GroundStation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:orbital/v20240301:GroundStation';
    ...
    constructor(name: string, args: GroundStationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:orbital:GroundStation" }, { type: "azure-native:orbital/v20240301preview:GroundStation" }] };

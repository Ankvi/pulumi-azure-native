...
export class Spacecraft extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:orbital/v20221101:Spacecraft';
    ...
    constructor(name: string, args: SpacecraftArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:orbital:Spacecraft" }, { type: "azure-native:orbital/v20220301:Spacecraft" }] };

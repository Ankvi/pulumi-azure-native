...
export namespace orbital {
    ...
    export namespace v20220301 {
        ...
        export interface ContactProfileLinkArgs {
             ...
             * Contact Profile Link Channel.
             */
            channels: pulumi.Input<pulumi.Input<v20220301.ContactProfileLinkChannelArgs>[]>;
            /**
             * Direction (uplink or downlink).
             */
            direction: pulumi.Input<string | enums.v20220301.Direction>;
            /**
             * Effective Isotropic Radiated Power (EIRP) in dBW. It is the required EIRP by the customer. Not used yet.
             */
            eirpdBW?: pulumi.Input<number>;
             ...
             * Polarization. e.g. (RHCP, LHCP).
             */
            polarization: pulumi.Input<string | enums.v20220301.Polarization>;
        }
        ...
        export interface ContactProfileLinkChannelArgs {
             ...
             */
            endPoint: pulumi.Input<v20220301.EndPointArgs>;
            /**
             * Copy of the modem configuration file such as Kratos QRadio. Only valid for uplink directions. If provided, the modem connects to the customer endpoint and accepts commands from the customer instead of a VITA.49 stream.
             */
            modulationConfiguration?: pulumi.Input<string>;
        ...
        export interface EndPointArgs {
             ...
             * Protocol either UDP or TCP.
             */
            protocol: pulumi.Input<string | enums.v20220301.Protocol>;
        }
    ...
    export namespace v20221101 {
        ...
        export interface ContactProfileLinkArgs {
             ...
             * Contact Profile Link Channel.
             */
            channels: pulumi.Input<pulumi.Input<v20221101.ContactProfileLinkChannelArgs>[]>;
            /**
             * Direction (Uplink or Downlink).
             */
            direction: pulumi.Input<string | enums.v20221101.Direction>;
            /**
             * Effective Isotropic Radiated Power (EIRP) in dBW. It is the required EIRP by the customer. Not used yet.
             */
            eirpdBW?: pulumi.Input<number>;
             ...
             * Polarization. e.g. (RHCP, LHCP).
             */
            polarization: pulumi.Input<string | enums.v20221101.Polarization>;
        }
        ...
        export interface ContactProfileLinkChannelArgs {
             ...
             * Customer end point to store and retrieve data during a contact with the spacecraft.
             */
            endPoint: pulumi.Input<v20221101.EndPointArgs>;
            /**
             * Copy of the modem configuration file such as Kratos QRadio. Only valid for uplink directions. If provided, the modem connects to the customer endpoint and accepts commands from the customer instead of a VITA.49 stream.
             */
            modulationConfiguration?: pulumi.Input<string>;
        ...
        export interface EndPointArgs {
             ...
             * Protocol either UDP or TCP.
             */
            protocol: pulumi.Input<string | enums.v20221101.Protocol>;
        }

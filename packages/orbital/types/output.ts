...
export namespace orbital {
    ...
    export namespace v20220301 {
        ...
        export interface AvailableContactsResponse {
             ...
             * The reference to the spacecraft resource.
             */
            spacecraft?: v20220301.AvailableContactsResponseSpacecraft;
            /**
             * Azimuth of the antenna at the start of the contact in decimal degrees.
             */
            startAzimuthDegrees: number;
        ...
        export interface ContactProfileLinkChannelResponse {
             ...
             */
            endPoint: v20220301.EndPointResponse;
            /**
             * Copy of the modem configuration file such as Kratos QRadio. Only valid for uplink directions. If provided, the modem connects to the customer endpoint and accepts commands from the customer instead of a VITA.49 stream.
             */
            modulationConfiguration?: string;
        ...
        export interface ContactProfileLinkResponse {
             ...
             * Contact Profile Link Channel.
             */
            channels: v20220301.ContactProfileLinkChannelResponse[];
            /**
             * Direction (uplink or downlink).
             */
            direction: string;
        ...
        export interface SpacecraftLinkResponse {
             ...
             * Authorized Ground Stations
             */
            authorizations: v20220301.AuthorizedGroundstationResponse[];
            /**
             * Bandwidth in MHz.
             */
            bandwidthMHz: number;
    ...
    export namespace v20221101 {
        ...
        export interface AvailableContactsResponse {
             ...
             * The reference to the spacecraft resource.
             */
            spacecraft?: v20221101.AvailableContactsResponseSpacecraft;
            /**
             * Azimuth of the antenna at the start of the contact in decimal degrees.
             */
            startAzimuthDegrees: number;
        ...
        export interface ContactProfileLinkChannelResponse {
             ...
             * Customer end point to store and retrieve data during a contact with the spacecraft.
             */
            endPoint: v20221101.EndPointResponse;
            /**
             * Copy of the modem configuration file such as Kratos QRadio. Only valid for uplink directions. If provided, the modem connects to the customer endpoint and accepts commands from the customer instead of a VITA.49 stream.
             */
            modulationConfiguration?: string;
        ...
        export interface ContactProfileLinkResponse {
             ...
             * Contact Profile Link Channel.
             */
            channels: v20221101.ContactProfileLinkChannelResponse[];
            /**
             * Direction (Uplink or Downlink).
             */
            direction: string;
        ...
        export interface SpacecraftLinkResponse {
             ...
             * Authorized Ground Stations
             */
            authorizations: v20221101.AuthorizedGroundstationResponse[];
            /**
             * Bandwidth in MHz.
             */
            bandwidthMHz: number;

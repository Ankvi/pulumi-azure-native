...
export class ConfigurationProfile extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:automanage:ConfigurationProfile';
    ...
    constructor(name: string, args: ConfigurationProfileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:automanage/v20210430preview:ConfigurationProfile" }, { type: "azure-native:automanage/v20220504:ConfigurationProfile" }] };

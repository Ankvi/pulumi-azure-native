...
export class ConfigurationProfileAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:automanage/v20220504:ConfigurationProfileAssignment';
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.automanage.v20220504.ConfigurationProfileAssignmentPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ConfigurationProfileAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:automanage:ConfigurationProfileAssignment" }, { type: "azure-native:automanage/v20200630preview:ConfigurationProfileAssignment" }, { type: "azure-native:automanage/v20210430preview:ConfigurationProfileAssignment" }] };
...
export interface ConfigurationProfileAssignmentArgs {
     ...
     * Properties of the configuration profile assignment.
     */
    properties?: pulumi.Input<types.inputs.automanage.v20220504.ConfigurationProfileAssignmentPropertiesArgs>;
    /**

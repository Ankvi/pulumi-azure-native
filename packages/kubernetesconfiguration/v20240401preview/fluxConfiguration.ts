...
export class FluxConfiguration extends pulumi.CustomResource {
     ...
     */
    public readonly ociRepository!: pulumi.Output<types.outputs.OCIRepositoryDefinitionResponse | undefined>;
    /**
    ...
    constructor(name: string, args: FluxConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["ociRepository"] = args ? (args.ociRepository ? pulumi.output(args.ociRepository).apply(types.inputs.ocirepositoryDefinitionArgsProvideDefaults) : undefined) : undefined;
...
export interface FluxConfigurationArgs {
     ...
     * Parameters to reconcile to the OCIRepository source kind type.
     */
    ociRepository?: pulumi.Input<types.inputs.OCIRepositoryDefinitionArgs>;
    /**
     * Maximum duration to wait for flux configuration reconciliation. E.g PT1H, PT5M, P1D
     */

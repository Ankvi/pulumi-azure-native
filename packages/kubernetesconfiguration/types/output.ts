...
export namespace kubernetesconfiguration {
    ...
    export namespace v20200701preview {
        ...
        export interface ScopeResponse {
             ...
             * Specifies that the scope of the extensionInstance is Cluster
             */
            cluster?: v20200701preview.ScopeClusterResponse;
            /**
             * Specifies that the scope of the extensionInstance is Namespace
             */
            namespace?: v20200701preview.ScopeNamespaceResponse;
        }
    ...
    export namespace v20211101preview {
        ...
        export interface GitRepositoryDefinitionResponse {
             ...
             * The source reference for the GitRepository object.
             */
            repositoryRef?: v20211101preview.RepositoryRefDefinitionResponse;
            /**
             * Base64-encoded known_hosts value containing public SSH keys required to access private git repositories over SSH
             */
            sshKnownHosts?: string;
        ...
        export interface HelmReleasePropertiesDefinitionResponse {
             ...
             * The reference to the HelmChart object used as the source to this HelmRelease
             */
            helmChartRef?: v20211101preview.ObjectReferenceDefinitionResponse;
            /**
             * Number of times that the HelmRelease failed to install
             */
            installFailureCount?: number;
        ...
        export interface KustomizationDefinitionResponse {
             ...
             * Specifies other Kustomizations that this Kustomization depends on. This Kustomization will not reconcile until all dependencies have completed their reconciliation.
             */
            dependsOn?: v20211101preview.DependsOnDefinitionResponse[];
            /**
             * Enable/disable re-creating Kubernetes resources on the cluster when patching fails due to an immutable field change.
             */
            force?: boolean;
        ...
        export interface ObjectStatusDefinitionResponse {
             ...
             * Object reference to the Kustomization that applied this object
             */
            appliedBy?: v20211101preview.ObjectReferenceDefinitionResponse;
            /**
             * Compliance state of the applied object showing whether the applied object has come into a ready state on the cluster.
             */
            complianceState?: string;
             ...
             * Additional properties that are provided from objects of the HelmRelease kind
             */
            helmReleaseProperties?: v20211101preview.HelmReleasePropertiesDefinitionResponse;
            /**
             * Kind of the applied object
             */
            kind?: string;
             ...
             * List of Kubernetes object status conditions present on the cluster
             */
            statusConditions?: v20211101preview.ObjectStatusConditionDefinitionResponse[];
        }
    ...
    export namespace v20220101preview {
        ...
        export interface GitRepositoryDefinitionResponse {
             ...
             * The source reference for the GitRepository object.
             */
            repositoryRef?: v20220101preview.RepositoryRefDefinitionResponse;
            /**
             * Base64-encoded known_hosts value containing public SSH keys required to access private git repositories over SSH
             */
            sshKnownHosts?: string;
        ...
        export interface HelmReleasePropertiesDefinitionResponse {
             ...
             * The reference to the HelmChart object used as the source to this HelmRelease
             */
            helmChartRef?: v20220101preview.ObjectReferenceDefinitionResponse;
            /**
             * Number of times that the HelmRelease failed to install
             */
            installFailureCount?: number;
        ...
        export interface KustomizationDefinitionResponse {
             ...
             * Specifies other Kustomizations that this Kustomization depends on. This Kustomization will not reconcile until all dependencies have completed their reconciliation.
             */
            dependsOn?: v20220101preview.DependsOnDefinitionResponse[];
            /**
             * Enable/disable re-creating Kubernetes resources on the cluster when patching fails due to an immutable field change.
             */
            force?: boolean;
        ...
        export interface ObjectStatusDefinitionResponse {
             ...
             * Object reference to the Kustomization that applied this object
             */
            appliedBy?: v20220101preview.ObjectReferenceDefinitionResponse;
            /**
             * Compliance state of the applied object showing whether the applied object has come into a ready state on the cluster.
             */
            complianceState?: string;
             ...
             * Additional properties that are provided from objects of the HelmRelease kind
             */
            helmReleaseProperties?: v20220101preview.HelmReleasePropertiesDefinitionResponse;
            /**
             * Kind of the applied object
             */
            kind?: string;
             ...
             * List of Kubernetes object status conditions present on the cluster
             */
            statusConditions?: v20220101preview.ObjectStatusConditionDefinitionResponse[];
        }
    ...
    export namespace v20220402preview {
        ...
        export interface ErrorDetailResponse {
             ...
             * The error additional info.
             */
            additionalInfo: v20220402preview.ErrorAdditionalInfoResponse[];
            /**
             * The error code.
             */
            code: string;
             ...
             * The error details.
             */
            details: v20220402preview.ErrorDetailResponse[];
            /**
             * The error message.
             */
            message: string;
        ...
        export interface KubernetesConfigurationPrivateLinkScopePropertiesResponse {
             ...
             * The collection of associated Private Endpoint Connections.
             */
            privateEndpointConnections: v20220402preview.PrivateEndpointConnectionResponse[];
            /**
             * The Guid id of the private link scope.
             */
            privateLinkScopeId: string;
        ...
        export interface PrivateEndpointConnectionResponse {
             ...
             * The resource of private end point.
             */
            privateEndpoint?: v20220402preview.PrivateEndpointResponse;
            /**
             * A collection of information about the state of the connection between service consumer and provider.
             */
            privateLinkServiceConnectionState: v20220402preview.PrivateLinkServiceConnectionStateResponse;
            /**
             * The provisioning state of the private endpoint connection resource.
             */
            provisioningState: string;
             ...
             * Azure Resource Manager metadata containing createdBy and modifiedBy information.
             */
            systemData: v20220402preview.SystemDataResponse;
            /**
             * The type of the resource. E.g. "Microsoft.Compute/virtualMachines" or "Microsoft.Storage/storageAccounts"
             */
            type: string;
        ...
        export interface ScopeResponse {
             ...
             * Specifies that the scope of the extension is Cluster
             */
            cluster?: v20220402preview.ScopeClusterResponse;
            /**
             * Specifies that the scope of the extension is Namespace
             */
            namespace?: v20220402preview.ScopeNamespaceResponse;
        }
    ...
    export namespace v20220701 {
        ...
        export interface ErrorDetailResponse {
             ...
             * The error additional info.
             */
            additionalInfo: v20220701.ErrorAdditionalInfoResponse[];
            /**
             * The error code.
             */
            code: string;
             ...
             * The error details.
             */
            details: v20220701.ErrorDetailResponse[];
            /**
             * The error message.
             */
            message: string;
        ...
        export interface ScopeResponse {
             ...
             * Specifies that the scope of the extension is Cluster
             */
            cluster?: v20220701.ScopeClusterResponse;
            /**
             * Specifies that the scope of the extension is Namespace
             */
            namespace?: v20220701.ScopeNamespaceResponse;
        }
    ...
    export namespace v20230501 {
        ...
        export interface AzureBlobDefinitionResponse {
             ...
             * Parameters to authenticate using a Managed Identity.
             */
            managedIdentity?: v20230501.ManagedIdentityDefinitionResponse;
            /**
             * The Shared Access token to access the storage container
             */
            sasToken?: string;
             ...
             * Parameters to authenticate using Service Principal.
             */
            servicePrincipal?: v20230501.ServicePrincipalDefinitionResponse;
            /**
             * The interval at which to re-reconcile the cluster Azure Blob source with the remote.
             */
            syncIntervalInSeconds?: number;
        ...
        export function azureBlobDefinitionResponseProvideDefaults(val: AzureBlobDefinitionResponse): AzureBlobDefinitionResponse {
            return {
                ...val,
                servicePrincipal: (val.servicePrincipal ? v20230501.servicePrincipalDefinitionResponseProvideDefaults(val.servicePrincipal) : undefined),
                syncIntervalInSeconds: (val.syncIntervalInSeconds) ?? 600,
                timeoutInSeconds: (val.timeoutInSeconds) ?? 600,
            };
        }
        ...
        export interface ErrorDetailResponse {
             ...
             * The error additional info.
             */
            additionalInfo: v20230501.ErrorAdditionalInfoResponse[];
            /**
             * The error code.
             */
            code: string;
             ...
             * The error details.
             */
            details: v20230501.ErrorDetailResponse[];
            /**
             * The error message.
             */
            message: string;
        ...
        export interface GitRepositoryDefinitionResponse {
             ...
             * The source reference for the GitRepository object.
             */
            repositoryRef?: v20230501.RepositoryRefDefinitionResponse;
            /**
             * Base64-encoded known_hosts value containing public SSH keys required to access private git repositories over SSH
             */
            sshKnownHosts?: string;
        ...
        export interface HelmReleasePropertiesDefinitionResponse {
             ...
             * The reference to the HelmChart object used as the source to this HelmRelease
             */
            helmChartRef?: v20230501.ObjectReferenceDefinitionResponse;
            /**
             * Number of times that the HelmRelease failed to install
             */
            installFailureCount?: number;
        ...
        export interface KustomizationDefinitionResponse {
             ...
             * Used for variable substitution for this Kustomization after kustomize build.
             */
            postBuild?: v20230501.PostBuildDefinitionResponse;
            /**
             * Enable/disable garbage collections of Kubernetes objects created by this Kustomization.
             */
            prune?: boolean;
        ...
        export interface ObjectStatusDefinitionResponse {
             ...
             * Object reference to the Kustomization that applied this object
             */
            appliedBy?: v20230501.ObjectReferenceDefinitionResponse;
            /**
             * Compliance state of the applied object showing whether the applied object has come into a ready state on the cluster.
             */
            complianceState?: string;
             ...
             * Additional properties that are provided from objects of the HelmRelease kind
             */
            helmReleaseProperties?: v20230501.HelmReleasePropertiesDefinitionResponse;
            /**
             * Kind of the applied object
             */
            kind?: string;
             ...
             * List of Kubernetes object status conditions present on the cluster
             */
            statusConditions?: v20230501.ObjectStatusConditionDefinitionResponse[];
        }
        ...
        export interface PostBuildDefinitionResponse {
             ...
             * Array of ConfigMaps/Secrets from which the variables are substituted for this Kustomization.
             */
            substituteFrom?: v20230501.SubstituteFromDefinitionResponse[];
        }
        ...
        export interface ScopeResponse {
             ...
             * Specifies that the scope of the extension is Cluster
             */
            cluster?: v20230501.ScopeClusterResponse;
            /**
             * Specifies that the scope of the extension is Namespace
             */
            namespace?: v20230501.ScopeNamespaceResponse;
        }

...
export namespace kubernetesconfiguration {
    ...
    export namespace v20200701preview {
        ...
        export interface ExtensionStatusArgs {
             ...
             * Level of the status.
             */
            level?: pulumi.Input<string | enums.v20200701preview.LevelType>;
            /**
        ...
        export interface ScopeArgs {
             ...
             */
            cluster?: pulumi.Input<v20200701preview.ScopeClusterArgs>;
            /**
             * Specifies that the scope of the extensionInstance is Namespace
             */
            namespace?: pulumi.Input<v20200701preview.ScopeNamespaceArgs>;
        }
    ...
    export namespace v20211101preview {
        ...
        export interface GitRepositoryDefinitionArgs {
             ...
             * The source reference for the GitRepository object.
             */
            repositoryRef?: pulumi.Input<v20211101preview.RepositoryRefDefinitionArgs>;
            /**
             * Base64-encoded known_hosts value containing public SSH keys required to access private git repositories over SSH
             */
            sshKnownHosts?: pulumi.Input<string>;
        ...
        export interface KustomizationDefinitionArgs {
             ...
             * Specifies other Kustomizations that this Kustomization depends on. This Kustomization will not reconcile until all dependencies have completed their reconciliation.
             */
            dependsOn?: pulumi.Input<pulumi.Input<v20211101preview.DependsOnDefinitionArgs>[]>;
            /**
             * Enable/disable re-creating Kubernetes resources on the cluster when patching fails due to an immutable field change.
             */
            force?: pulumi.Input<boolean>;
             ...
             */
            validation?: pulumi.Input<string | enums.v20211101preview.KustomizationValidationType>;
        }
        /**
         * kustomizationDefinitionArgsProvideDefaults sets the appropriate defaults for KustomizationDefinitionArgs
         */
    ...
    export namespace v20220101preview {
        ...
        export interface GitRepositoryDefinitionArgs {
             ...
             * The source reference for the GitRepository object.
             */
            repositoryRef?: pulumi.Input<v20220101preview.RepositoryRefDefinitionArgs>;
            /**
             * Base64-encoded known_hosts value containing public SSH keys required to access private git repositories over SSH
             */
            sshKnownHosts?: pulumi.Input<string>;
        ...
        export interface KustomizationDefinitionArgs {
             ...
             * Specifies other Kustomizations that this Kustomization depends on. This Kustomization will not reconcile until all dependencies have completed their reconciliation.
             */
            dependsOn?: pulumi.Input<pulumi.Input<v20220101preview.DependsOnDefinitionArgs>[]>;
            /**
             * Enable/disable re-creating Kubernetes resources on the cluster when patching fails due to an immutable field change.
             */
            force?: pulumi.Input<boolean>;
    ...
    export namespace v20220402preview {
        ...
        export interface ExtensionAksAssignedIdentityArgs {
             ...
             * The identity type.
             */
            type?: pulumi.Input<enums.v20220402preview.AKSIdentityType>;
        }
        ...
        export interface ExtensionStatusArgs {
             ...
             * Level of the status.
             */
            level?: pulumi.Input<string | enums.v20220402preview.LevelType>;
            /**
             * Detailed message of the status from the Extension.
             */
            message?: pulumi.Input<string>;
        ...
        export interface IdentityArgs {
             ...
             * The identity type.
             */
            type?: pulumi.Input<enums.v20220402preview.ResourceIdentityType>;
        }
        ...
        export interface KubernetesConfigurationPrivateLinkScopePropertiesArgs {
             ...
             * Indicates whether machines associated with the private link scope can also use public Azure Arc service endpoints.
             */
            publicNetworkAccess?: pulumi.Input<string | enums.v20220402preview.PublicNetworkAccessType>;
        }
        ...
        export interface PrivateLinkServiceConnectionStateArgs {
             ...
             * Indicates whether the connection has been Approved/Rejected/Removed by the owner of the service.
             */
            status?: pulumi.Input<string | enums.v20220402preview.PrivateEndpointServiceConnectionStatus>;
        }
        ...
        export interface ScopeArgs {
             ...
             * Specifies that the scope of the extension is Cluster
             */
            cluster?: pulumi.Input<v20220402preview.ScopeClusterArgs>;
            /**
             * Specifies that the scope of the extension is Namespace
             */
            namespace?: pulumi.Input<v20220402preview.ScopeNamespaceArgs>;
        }
    ...
    export namespace v20220701 {
        ...
        export interface ExtensionAksAssignedIdentityArgs {
             ...
             * The identity type.
             */
            type?: pulumi.Input<enums.v20220701.AKSIdentityType>;
        }
        ...
        export interface ExtensionStatusArgs {
             ...
             * Level of the status.
             */
            level?: pulumi.Input<string | enums.v20220701.LevelType>;
            /**
             * Detailed message of the status from the Extension.
             */
            message?: pulumi.Input<string>;
        ...
        export interface IdentityArgs {
             ...
             * The identity type.
             */
            type?: pulumi.Input<enums.v20220701.ResourceIdentityType>;
        }
        ...
        export interface ScopeArgs {
             ...
             * Specifies that the scope of the extension is Cluster
             */
            cluster?: pulumi.Input<v20220701.ScopeClusterArgs>;
            /**
             * Specifies that the scope of the extension is Namespace
             */
            namespace?: pulumi.Input<v20220701.ScopeNamespaceArgs>;
        }
    ...
    export namespace v20230501 {
        ...
        export interface AzureBlobDefinitionArgs {
             ...
             * Parameters to authenticate using a Managed Identity.
             */
            managedIdentity?: pulumi.Input<v20230501.ManagedIdentityDefinitionArgs>;
            /**
             * The Shared Access token to access the storage container
             */
            sasToken?: pulumi.Input<string>;
             ...
             * Parameters to authenticate using Service Principal.
             */
            servicePrincipal?: pulumi.Input<v20230501.ServicePrincipalDefinitionArgs>;
            /**
             * The interval at which to re-reconcile the cluster Azure Blob source with the remote.
             */
            syncIntervalInSeconds?: pulumi.Input<number>;
        ...
        export function azureBlobDefinitionArgsProvideDefaults(val: AzureBlobDefinitionArgs): AzureBlobDefinitionArgs {
            return {
                ...val,
                servicePrincipal: (val.servicePrincipal ? pulumi.output(val.servicePrincipal).apply(v20230501.servicePrincipalDefinitionArgsProvideDefaults) : undefined),
                syncIntervalInSeconds: (val.syncIntervalInSeconds) ?? 600,
                timeoutInSeconds: (val.timeoutInSeconds) ?? 600,
            };
        }
        ...
        export interface ExtensionAksAssignedIdentityArgs {
             ...
             * The identity type.
             */
            type?: pulumi.Input<enums.v20230501.AKSIdentityType>;
        }
        ...
        export interface ExtensionStatusArgs {
             ...
             * Level of the status.
             */
            level?: pulumi.Input<string | enums.v20230501.LevelType>;
            /**
             * Detailed message of the status from the Extension.
             */
            message?: pulumi.Input<string>;
        ...
        export interface GitRepositoryDefinitionArgs {
             ...
             * The source reference for the GitRepository object.
             */
            repositoryRef?: pulumi.Input<v20230501.RepositoryRefDefinitionArgs>;
            /**
             * Base64-encoded known_hosts value containing public SSH keys required to access private git repositories over SSH
             */
            sshKnownHosts?: pulumi.Input<string>;
        ...
        export interface KustomizationDefinitionArgs {
             ...
             * Used for variable substitution for this Kustomization after kustomize build.
             */
            postBuild?: pulumi.Input<v20230501.PostBuildDefinitionArgs>;
            /**
             * Enable/disable garbage collections of Kubernetes objects created by this Kustomization.
             */
            prune?: pulumi.Input<boolean>;
        ...
        export interface PostBuildDefinitionArgs {
             ...
             * Array of ConfigMaps/Secrets from which the variables are substituted for this Kustomization.
             */
            substituteFrom?: pulumi.Input<pulumi.Input<v20230501.SubstituteFromDefinitionArgs>[]>;
        }
        ...
        export interface ScopeArgs {
             ...
             * Specifies that the scope of the extension is Cluster
             */
            cluster?: pulumi.Input<v20230501.ScopeClusterArgs>;
            /**
             * Specifies that the scope of the extension is Namespace
             */
            namespace?: pulumi.Input<v20230501.ScopeNamespaceArgs>;
        }

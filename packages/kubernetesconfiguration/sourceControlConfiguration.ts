...
export class SourceControlConfiguration extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly complianceStatus: pulumi.Output<types.outputs.ComplianceStatusResponse>;
    /**
     ...
     */
    declare public readonly helmOperatorProperties: pulumi.Output<types.outputs.HelmOperatorPropertiesResponse | undefined>;
    /**

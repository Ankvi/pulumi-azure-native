...
export interface GetDiscoveryRuleResult {
     ...
     */
    readonly properties: types.outputs.ApplicationInsightsTopologyDiscoveryRulePropertiesResponse | types.outputs.ResourceGraphQueryDiscoveryRulePropertiesResponse;
    /**

...
export class Entity extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:monitor:Entity';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.EntityPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: EntityArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:monitor/v20250503preview:Entity" }] };

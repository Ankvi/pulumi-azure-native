...
export class ActivityLogAlert extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:monitor:ActivityLogAlert';
     ...
     */
    declare public readonly actions: pulumi.Output<types.outputs.ActionListResponse>;
    /**
     ...
     */
    declare public readonly condition: pulumi.Output<types.outputs.AlertRuleAllOfConditionResponse>;
    /**
    ...
    constructor(name: string, args: ActivityLogAlertArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["activityLogAlertName"] = args?.activityLogAlertName;

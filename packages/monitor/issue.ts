...
export class Issue extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.IssuePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: IssueArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["startInvestigation"] = args ? args.startInvestigation : undefined;

...
export class MetricAlert extends pulumi.CustomResource {
     ...
     */
    declare public readonly actions: pulumi.Output<types.outputs.MetricAlertActionResponse[] | undefined>;
    /**
     ...
     */
    declare public readonly criteria: pulumi.Output<types.outputs.MetricAlertMultipleResourceMultipleMetricCriteriaResponse | types.outputs.MetricAlertSingleResourceMultipleMetricCriteriaResponse | types.outputs.WebtestLocationAvailabilityCriteriaResponse>;
    /**

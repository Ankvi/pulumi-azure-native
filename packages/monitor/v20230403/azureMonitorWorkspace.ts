...
export class AzureMonitorWorkspace extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:monitor/v20230403:AzureMonitorWorkspace';
    ...
    constructor(name: string, args: AzureMonitorWorkspaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:monitor:AzureMonitorWorkspace" }, { type: "azure-native:monitor/v20210603preview:AzureMonitorWorkspace" }] };

...
export class AuthenticationSetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:monitor:AuthenticationSetting';
    ...
    constructor(name: string, args: AuthenticationSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:monitor/v20250503preview:AuthenticationSetting" }] };

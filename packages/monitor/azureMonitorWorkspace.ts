...
export class AzureMonitorWorkspace extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly defaultIngestionSettings!: pulumi.Output<types.outputs.IngestionSettingsResponse>;
    /**
     ...
     */
    public /*out*/ readonly metrics!: pulumi.Output<types.outputs.MetricsResponse | undefined>;
    /**

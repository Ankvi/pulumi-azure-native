...
export class ScheduledQueryRule extends pulumi.CustomResource {
     ...
     */
    declare public readonly actions: pulumi.Output<types.outputs.ActionsResponse | undefined>;
    /**
     ...
     */
    declare public readonly resolveConfiguration: pulumi.Output<types.outputs.RuleResolveConfigurationResponse | undefined>;
    /**

...
export class TableResourceTable extends pulumi.CustomResource {
    ...
    public readonly options!: pulumi.Output<types.outputs.documentdb.v20230415.TableGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<types.outputs.documentdb.v20230415.TableGetPropertiesResponseResource | undefined>;
    /**
...
export interface TableResourceTableArgs {
     ...
     */
    resource: pulumi.Input<types.inputs.documentdb.v20230415.TableResourceArgs>;
    /**

...
export class MongoDBResourceMongoDBCollection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20230415:MongoDBResourceMongoDBCollection';
    ...
    public readonly options!: pulumi.Output<types.outputs.documentdb.v20230415.MongoDBCollectionGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<types.outputs.documentdb.v20230415.MongoDBCollectionGetPropertiesResponseResource | undefined>;
    /**
...
export interface MongoDBResourceMongoDBCollectionArgs {
     ...
     */
    resource: pulumi.Input<types.inputs.documentdb.v20230415.MongoDBCollectionResourceArgs>;
    /**

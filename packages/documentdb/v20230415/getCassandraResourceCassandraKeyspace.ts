...
export function getCassandraResourceCassandraKeyspace(args: GetCassandraResourceCassandraKeyspaceArgs, opts?: pulumi.InvokeOptions): Promise<GetCassandraResourceCassandraKeyspaceResult> {
    ...
    return pulumi.runtime.invoke("azure-native:documentdb/v20230415:getCassandraResourceCassandraKeyspace", {
...
export interface GetCassandraResourceCassandraKeyspaceResult {
    ...
    readonly options?: types.outputs.documentdb.v20230415.CassandraKeyspaceGetPropertiesResponseOptions;
    readonly resource?: types.outputs.documentdb.v20230415.CassandraKeyspaceGetPropertiesResponseResource;
    /**

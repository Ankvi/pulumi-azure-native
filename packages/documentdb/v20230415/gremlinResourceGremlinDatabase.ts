...
export class GremlinResourceGremlinDatabase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20230415:GremlinResourceGremlinDatabase';
    ...
    public readonly options!: pulumi.Output<types.outputs.documentdb.v20230415.GremlinDatabaseGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<types.outputs.documentdb.v20230415.GremlinDatabaseGetPropertiesResponseResource | undefined>;
    /**
...
export interface GremlinResourceGremlinDatabaseArgs {
     ...
     */
    resource: pulumi.Input<types.inputs.documentdb.v20230415.GremlinDatabaseResourceArgs>;
    /**

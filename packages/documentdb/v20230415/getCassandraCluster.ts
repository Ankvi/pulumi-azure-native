...
export function getCassandraCluster(args: GetCassandraClusterArgs, opts?: pulumi.InvokeOptions): Promise<GetCassandraClusterResult> {
    ...
    return pulumi.runtime.invoke("azure-native:documentdb/v20230415:getCassandraCluster", {
...
export interface GetCassandraClusterResult {
     ...
     */
    readonly identity?: types.outputs.documentdb.v20230415.ManagedCassandraManagedServiceIdentityResponse;
    /**
     ...
     */
    readonly properties: types.outputs.documentdb.v20230415.ClusterResourceResponseProperties;
    /**

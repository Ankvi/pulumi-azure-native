...
export function getCassandraResourceCassandraTable(args: GetCassandraResourceCassandraTableArgs, opts?: pulumi.InvokeOptions): Promise<GetCassandraResourceCassandraTableResult> {
    ...
    return pulumi.runtime.invoke("azure-native:documentdb/v20230415:getCassandraResourceCassandraTable", {
...
export interface GetCassandraResourceCassandraTableResult {
    ...
    readonly options?: types.outputs.documentdb.v20230415.CassandraTableGetPropertiesResponseOptions;
    readonly resource?: types.outputs.documentdb.v20230415.CassandraTableGetPropertiesResponseResource;
    /**

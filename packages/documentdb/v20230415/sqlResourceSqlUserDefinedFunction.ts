...
export class SqlResourceSqlUserDefinedFunction extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20230415:SqlResourceSqlUserDefinedFunction';
    ...
    public readonly resource!: pulumi.Output<types.outputs.documentdb.v20230415.SqlUserDefinedFunctionGetPropertiesResponseResource | undefined>;
    /**
...
export interface SqlResourceSqlUserDefinedFunctionArgs {
     ...
     */
    resource: pulumi.Input<types.inputs.documentdb.v20230415.SqlUserDefinedFunctionResourceArgs>;
    /**

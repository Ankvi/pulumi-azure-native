...
export function getGremlinResourceGremlinDatabase(args: GetGremlinResourceGremlinDatabaseArgs, opts?: pulumi.InvokeOptions): Promise<GetGremlinResourceGremlinDatabaseResult> {
    ...
    return pulumi.runtime.invoke("azure-native:documentdb/v20230415:getGremlinResourceGremlinDatabase", {
...
export interface GetGremlinResourceGremlinDatabaseResult {
    ...
    readonly options?: types.outputs.documentdb.v20230415.GremlinDatabaseGetPropertiesResponseOptions;
    readonly resource?: types.outputs.documentdb.v20230415.GremlinDatabaseGetPropertiesResponseResource;
    /**

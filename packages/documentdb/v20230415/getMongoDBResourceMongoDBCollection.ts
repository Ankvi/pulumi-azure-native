...
export function getMongoDBResourceMongoDBCollection(args: GetMongoDBResourceMongoDBCollectionArgs, opts?: pulumi.InvokeOptions): Promise<GetMongoDBResourceMongoDBCollectionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:documentdb/v20230415:getMongoDBResourceMongoDBCollection", {
...
export interface GetMongoDBResourceMongoDBCollectionResult {
    ...
    readonly options?: types.outputs.documentdb.v20230415.MongoDBCollectionGetPropertiesResponseOptions;
    readonly resource?: types.outputs.documentdb.v20230415.MongoDBCollectionGetPropertiesResponseResource;
    /**

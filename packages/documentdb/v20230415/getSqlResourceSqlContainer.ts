...
export function getSqlResourceSqlContainer(args: GetSqlResourceSqlContainerArgs, opts?: pulumi.InvokeOptions): Promise<GetSqlResourceSqlContainerResult> {
    ...
    return pulumi.runtime.invoke("azure-native:documentdb/v20230415:getSqlResourceSqlContainer", {
...
export interface GetSqlResourceSqlContainerResult {
    ...
    readonly options?: types.outputs.documentdb.v20230415.SqlContainerGetPropertiesResponseOptions;
    readonly resource?: types.outputs.documentdb.v20230415.SqlContainerGetPropertiesResponseResource;
    /**

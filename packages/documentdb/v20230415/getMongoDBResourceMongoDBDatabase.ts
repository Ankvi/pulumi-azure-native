...
export function getMongoDBResourceMongoDBDatabase(args: GetMongoDBResourceMongoDBDatabaseArgs, opts?: pulumi.InvokeOptions): Promise<GetMongoDBResourceMongoDBDatabaseResult> {
    ...
    return pulumi.runtime.invoke("azure-native:documentdb/v20230415:getMongoDBResourceMongoDBDatabase", {
...
export interface GetMongoDBResourceMongoDBDatabaseResult {
    ...
    readonly options?: types.outputs.documentdb.v20230415.MongoDBDatabaseGetPropertiesResponseOptions;
    readonly resource?: types.outputs.documentdb.v20230415.MongoDBDatabaseGetPropertiesResponseResource;
    /**

...
export interface GetTableResourceTableResult {
    ...
    readonly options?: types.outputs.documentdb.v20230415.TableGetPropertiesResponseOptions;
    readonly resource?: types.outputs.documentdb.v20230415.TableGetPropertiesResponseResource;
    /**

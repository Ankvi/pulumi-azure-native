...
export class SqlResourceSqlTrigger extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20230415:SqlResourceSqlTrigger';
    ...
    public readonly resource!: pulumi.Output<types.outputs.documentdb.v20230415.SqlTriggerGetPropertiesResponseResource | undefined>;
    /**
...
export interface SqlResourceSqlTriggerArgs {
     ...
     */
    resource: pulumi.Input<types.inputs.documentdb.v20230415.SqlTriggerResourceArgs>;
    /**

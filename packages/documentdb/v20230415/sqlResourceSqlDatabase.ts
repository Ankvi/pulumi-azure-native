...
export class SqlResourceSqlDatabase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20230415:SqlResourceSqlDatabase';
    ...
    public readonly options!: pulumi.Output<types.outputs.documentdb.v20230415.SqlDatabaseGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<types.outputs.documentdb.v20230415.SqlDatabaseGetPropertiesResponseResource | undefined>;
    /**
...
export interface SqlResourceSqlDatabaseArgs {
     ...
     */
    resource: pulumi.Input<types.inputs.documentdb.v20230415.SqlDatabaseResourceArgs>;
    /**

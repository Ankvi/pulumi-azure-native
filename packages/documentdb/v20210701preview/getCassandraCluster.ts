...
export interface GetCassandraClusterResult {
     ...
     */
    readonly identity?: types.outputs.documentdb.v20210701preview.ManagedServiceIdentityResponse;
    /**
     ...
     */
    readonly properties: types.outputs.documentdb.v20210701preview.ClusterResourceResponseProperties;
    /**

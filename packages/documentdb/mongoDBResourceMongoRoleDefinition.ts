...
export class MongoDBResourceMongoRoleDefinition extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb:MongoDBResourceMongoRoleDefinition';

...
export class MongoDBResourceMongoDBDatabase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb:MongoDBResourceMongoDBDatabase';
    ...
    public readonly options!: pulumi.Output<types.outputs.documentdb.MongoDBDatabaseGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<types.outputs.documentdb.MongoDBDatabaseGetPropertiesResponseResource | undefined>;
    /**
...
export interface MongoDBResourceMongoDBDatabaseArgs {
     ...
     */
    resource: pulumi.Input<types.inputs.documentdb.MongoDBDatabaseResourceArgs>;
    /**

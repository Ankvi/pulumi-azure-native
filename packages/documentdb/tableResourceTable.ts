...
export class TableResourceTable extends pulumi.CustomResource {
    ...
    public readonly options!: pulumi.Output<types.outputs.documentdb.TableGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<types.outputs.documentdb.TableGetPropertiesResponseResource | undefined>;
    /**
...
export interface TableResourceTableArgs {
     ...
     */
    resource: pulumi.Input<types.inputs.documentdb.TableResourceArgs>;
    /**

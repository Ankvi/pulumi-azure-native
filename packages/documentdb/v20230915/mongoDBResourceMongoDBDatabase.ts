...
export class MongoDBResourceMongoDBDatabase extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20230915:MongoDBResourceMongoDBDatabase';

...
export interface GetCassandraClusterResult {
     ...
     */
    readonly identity?: types.outputs.documentdb.ManagedCassandraManagedServiceIdentityResponse;
    /**
     ...
     */
    readonly properties: types.outputs.documentdb.ClusterResourceResponseProperties;
    /**

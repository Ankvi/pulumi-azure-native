...
export interface GetTableResourceTableResult {
    ...
    readonly options?: types.outputs.documentdb.TableGetPropertiesResponseOptions;
    readonly resource?: types.outputs.documentdb.TableGetPropertiesResponseResource;
    /**

...
export class SqlResourceSqlTrigger extends pulumi.CustomResource {
    ...
    public readonly resource!: pulumi.Output<types.outputs.documentdb.SqlTriggerGetPropertiesResponseResource | undefined>;
    /**
...
export interface SqlResourceSqlTriggerArgs {
     ...
     */
    resource: pulumi.Input<types.inputs.documentdb.SqlTriggerResourceArgs>;
    /**

...
export class GremlinResourceGremlinDatabase extends pulumi.CustomResource {
    ...
    public readonly options!: pulumi.Output<types.outputs.documentdb.GremlinDatabaseGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<types.outputs.documentdb.GremlinDatabaseGetPropertiesResponseResource | undefined>;
    /**
...
export interface GremlinResourceGremlinDatabaseArgs {
     ...
     */
    resource: pulumi.Input<types.inputs.documentdb.GremlinDatabaseResourceArgs>;
    /**

...
export interface GetGremlinResourceGremlinDatabaseResult {
    ...
    readonly options?: types.outputs.documentdb.GremlinDatabaseGetPropertiesResponseOptions;
    readonly resource?: types.outputs.documentdb.GremlinDatabaseGetPropertiesResponseResource;
    /**

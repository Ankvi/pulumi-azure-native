...
export interface GetSqlResourceSqlContainerResult {
    ...
    readonly options?: types.outputs.documentdb.SqlContainerGetPropertiesResponseOptions;
    readonly resource?: types.outputs.documentdb.SqlContainerGetPropertiesResponseResource;
    /**

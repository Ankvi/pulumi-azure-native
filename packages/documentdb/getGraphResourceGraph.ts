...
export interface GetGraphResourceGraphResult {
    ...
    readonly options?: types.outputs.documentdb.GraphResourceGetPropertiesResponseOptions;
    readonly resource?: types.outputs.documentdb.GraphResourceGetPropertiesResponseResource;
    /**

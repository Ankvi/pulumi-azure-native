...
export class ThroughputPoolAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20231115preview:ThroughputPoolAccount';
    ...
    constructor(name: string, args: ThroughputPoolAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:documentdb:ThroughputPoolAccount" }, { type: "azure-native:documentdb/v20240215preview:ThroughputPoolAccount" }] };

...
export class SqlResourceSqlStoredProcedure extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20231115preview:SqlResourceSqlStoredProcedure';

...
export class GraphResourceGraph extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20231115preview:GraphResourceGraph';

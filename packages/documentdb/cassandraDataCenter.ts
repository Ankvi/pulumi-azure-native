...
export class CassandraDataCenter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb:CassandraDataCenter';

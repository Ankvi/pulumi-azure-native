...
export namespace documentdb {
    ...
    export namespace v20210401preview {
        ...
        export interface ManagedServiceIdentityResponse {
             ...
             * The list of user identities associated with resource. The user identity dictionary key references will be ARM resource ids in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}'.
             */
            userAssignedIdentities?: {[key: string]: v20210401preview.ManagedServiceIdentityResponseUserAssignedIdentities};
        }
        ...
        export interface PeriodicModeBackupPolicyResponse {
             ...
             * Configuration values for periodic mode backup
             */
            periodicModeProperties?: v20210401preview.PeriodicModePropertiesResponse;
            /**
             * Describes the mode of backups.
             * Expected value is 'Periodic'.
             */
        ...
        export interface PrivateEndpointConnectionResponse {
             ...
             * Private endpoint which the connection belongs to.
             */
            privateEndpoint?: v20210401preview.PrivateEndpointPropertyResponse;
            /**
             * Connection State of the Private Endpoint Connection.
             */
            privateLinkServiceConnectionState?: v20210401preview.PrivateLinkServiceConnectionStatePropertyResponse;
            /**
             * Provisioning state of the private endpoint.
             */
            provisioningState?: string;
        ...
        export interface RestoreParametersResponse {
             ...
             * List of specific databases available for restore.
             */
            databasesToRestore?: v20210401preview.DatabaseRestoreResourceResponse[];
            /**
             * Describes the mode of the restore.
             */
            restoreMode?: string;
    ...
    export namespace v20210701preview {
        ...
        export interface ClusterResourceResponseProperties {
             ...
             * List of TLS certificates used to authorize clients connecting to the cluster. All connections are TLS encrypted whether clientCertificates is set or not, but if clientCertificates is set, the managed Cassandra cluster will reject all connections not bearing a TLS client certificate that can be validated from one or more of the public certificates in this property.
             */
            clientCertificates?: v20210701preview.CertificateResponse[];
            /**
             * If you need to set the clusterName property in cassandra.yaml to something besides the resource name of the cluster, set the value to use on this property.
             */
            clusterNameOverride?: string;
             ...
             * List of TLS certificates used to authorize gossip from unmanaged data centers. The TLS certificates of all nodes in unmanaged data centers must be verifiable using one of the certificates provided in this property.
             */
            externalGossipCertificates?: v20210701preview.CertificateResponse[];
            /**
             * List of IP addresses of seed nodes in unmanaged data centers. These will be added to the seed node lists of all managed nodes.
             */
            externalSeedNodes?: v20210701preview.SeedNodeResponse[];
            /**
             * List of TLS certificates that unmanaged nodes must trust for gossip with managed nodes. All managed nodes will present TLS client certificates that are verifiable using one of the certificates provided in this property.
             */
            gossipCertificates: v20210701preview.CertificateResponse[];
            /**
             ...
             * Hostname or IP address where the Prometheus endpoint containing data about the managed Cassandra nodes can be reached.
             */
            prometheusEndpoint?: v20210701preview.SeedNodeResponse;
            /**
             * The status of the resource at the time the operation was called.
             */
            provisioningState?: string;
             ...
             * List of IP addresses of seed nodes in the managed data centers. These should be added to the seed node lists of all unmanaged nodes.
             */
            seedNodes: v20210701preview.SeedNodeResponse[];
        }
        ...
        export interface ManagedServiceIdentityResponse {
             ...
             * The list of user identities associated with resource. The user identity dictionary key references will be ARM resource ids in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}'.
             */
            userAssignedIdentities?: {[key: string]: v20210701preview.ManagedServiceIdentityResponseUserAssignedIdentities};
        }
    ...
    export namespace v20230301preview {
        ...
        export interface PrivilegeResponse {
             ...
             * An Azure Cosmos DB Mongo DB Resource.
             */
            resource?: v20230301preview.PrivilegeResponseResource;
        }
    ...
    export namespace v20230315preview {
        ...
        export interface CassandraKeyspaceGetPropertiesResponseOptions {
             ...
             * Specifies the Autoscale settings.
             */
            autoscaleSettings?: v20230315preview.AutoscaleSettingsResponse;
            /**
             * Value of the Cosmos DB resource throughput or autoscaleSettings. Use the ThroughputSetting resource when retrieving offer details.
             */
            throughput?: number;
        ...
        export interface CassandraSchemaResponse {
             ...
             * List of cluster key.
             */
            clusterKeys?: v20230315preview.ClusterKeyResponse[];
            /**
             * List of Cassandra table columns.
             */
            columns?: v20230315preview.ColumnResponse[];
            /**
             * List of partition key.
             */
            partitionKeys?: v20230315preview.CassandraPartitionKeyResponse[];
        }
        ...
        export interface CassandraTableGetPropertiesResponseResource {
             ...
             * Schema of the Cosmos DB Cassandra table
             */
            schema?: v20230315preview.CassandraSchemaResponse;
            /**
             * A system generated property that denotes the last updated timestamp of the resource.
             */
            ts: number;
        ...
        export interface ClientEncryptionPolicyResponse {
             ...
             * Paths of the item that need encryption along with path-specific settings.
             */
            includedPaths: v20230315preview.ClientEncryptionIncludedPathResponse[];
            /**
             * Version of the client encryption policy definition. Supported versions are 1 and 2. Version 2 supports id and partition key path encryption. 
             */
            policyFormatVersion: number;
        ...
        export interface ContinuousModeBackupPolicyResponse {
             ...
             * Configuration values for continuous mode backup
             */
            continuousModeProperties?: v20230315preview.ContinuousModePropertiesResponse;
            /**
             * The object representing the state of the migration between the backup policies.
             */
            migrationState?: v20230315preview.BackupPolicyMigrationStateResponse;
            /**
             * Describes the mode of backups.
             * Expected value is 'Continuous'.
             */
        ...
        export interface DatabaseAccountKeysMetadataResponse {
             ...
             * The metadata related to the Primary Read-Write Key for the given Cosmos DB database account.
             */
            primaryMasterKey: v20230315preview.AccountKeyMetadataResponse;
            /**
             * The metadata related to the Primary Read-Only Key for the given Cosmos DB database account.
             */
            primaryReadonlyMasterKey: v20230315preview.AccountKeyMetadataResponse;
            /**
             * The metadata related to the Secondary Read-Write Key for the given Cosmos DB database account.
             */
            secondaryMasterKey: v20230315preview.AccountKeyMetadataResponse;
            /**
             * The metadata related to the Secondary Read-Only Key for the given Cosmos DB database account.
             */
            secondaryReadonlyMasterKey: v20230315preview.AccountKeyMetadataResponse;
        }
        ...
        export interface GremlinDatabaseGetPropertiesResponseResource {
             ...
             * Parameters to indicate the information about the restore
             */
            restoreParameters?: v20230315preview.ResourceRestoreParametersResponse;
            /**
             * A system generated property. A unique identifier.
             */
            rid: string;
        ...
        export interface GremlinGraphGetPropertiesResponseResource {
             ...
             * The conflict resolution policy for the graph.
             */
            conflictResolutionPolicy?: v20230315preview.ConflictResolutionPolicyResponse;
            /**
             * Enum to indicate the mode of resource creation.
             */
            createMode?: string;
             ...
             * The configuration of the indexing policy. By default, the indexing is automatic for all document paths within the graph
             */
            indexingPolicy?: v20230315preview.IndexingPolicyResponse;
            /**
             * The configuration of the partition key to be used for partitioning data into multiple partitions
             */
            partitionKey?: v20230315preview.ContainerPartitionKeyResponse;
            /**
             * Parameters to indicate the information about the restore
             */
            restoreParameters?: v20230315preview.ResourceRestoreParametersResponse;
             ...
             * The unique key policy configuration for specifying uniqueness constraints on documents in the collection in the Azure Cosmos DB service.
             */
            uniqueKeyPolicy?: v20230315preview.UniqueKeyPolicyResponse;
        }
        /**
         * gremlinGraphGetPropertiesResponseResourceProvideDefaults sets the appropriate defaults for GremlinGraphGetPropertiesResponseResource
         */
        export function gremlinGraphGetPropertiesResponseResourceProvideDefaults(val: GremlinGraphGetPropertiesResponseResource): GremlinGraphGetPropertiesResponseResource {
            return {
                ...val,
                conflictResolutionPolicy: (val.conflictResolutionPolicy ? v20230315preview.conflictResolutionPolicyResponseProvideDefaults(val.conflictResolutionPolicy) : undefined),
                indexingPolicy: (val.indexingPolicy ? v20230315preview.indexingPolicyResponseProvideDefaults(val.indexingPolicy) : undefined),
                partitionKey: (val.partitionKey ? v20230315preview.containerPartitionKeyResponseProvideDefaults(val.partitionKey) : undefined),
            };
        }
        ...
        export interface IncludedPathResponse {
             ...
             * List of indexes for this path
             */
            indexes?: v20230315preview.IndexesResponse[];
            /**
             * The path for which the indexing behavior applies to. Index paths typically start with root and end with wildcard (/path/*)
             */
            path?: string;
        ...
        export interface IndexingPolicyResponse {
             ...
             * List of composite path list
             */
            compositeIndexes?: v20230315preview.CompositePathResponse[][];
            /**
             * List of paths to exclude from indexing
             */
            excludedPaths?: v20230315preview.ExcludedPathResponse[];
            /**
             * List of paths to include in the indexing
             */
            includedPaths?: v20230315preview.IncludedPathResponse[];
            /**
             * Indicates the indexing mode.
             */
            indexingMode?: string;
             ...
             * List of spatial specifics
             */
            spatialIndexes?: v20230315preview.SpatialSpecResponse[];
        }
        /**
         * indexingPolicyResponseProvideDefaults sets the appropriate defaults for IndexingPolicyResponse
         */
        ...
        export interface ManagedServiceIdentityResponse {
             ...
             * The list of user identities associated with resource. The user identity dictionary key references will be ARM resource ids in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}'.
             */
            userAssignedIdentities?: {[key: string]: v20230315preview.ManagedServiceIdentityResponseUserAssignedIdentities};
        }
        ...
        export interface MongoDBCollectionGetPropertiesResponseResource {
             ...
             * List of index keys
             */
            indexes?: v20230315preview.MongoIndexResponse[];
            /**
             * Parameters to indicate the information about the restore
             */
            restoreParameters?: v20230315preview.ResourceRestoreParametersResponse;
        ...
        export interface MongoIndexResponse {
             ...
             * Cosmos DB MongoDB collection index keys
             */
            key?: v20230315preview.MongoIndexKeysResponse;
            /**
             * Cosmos DB MongoDB collection index key options
             */
            options?: v20230315preview.MongoIndexOptionsResponse;
        }
        ...
        export interface PeriodicModeBackupPolicyResponse {
             ...
             * Configuration values for periodic mode backup
             */
            periodicModeProperties?: v20230315preview.PeriodicModePropertiesResponse;
            /**
             * Describes the mode of backups.
             * Expected value is 'Periodic'.
             */
        ...
        export interface PrivateEndpointConnectionResponse {
             ...
             * Private endpoint which the connection belongs to.
             */
            privateEndpoint?: v20230315preview.PrivateEndpointPropertyResponse;
            /**
             * Connection State of the Private Endpoint Connection.
             */
            privateLinkServiceConnectionState?: v20230315preview.PrivateLinkServiceConnectionStatePropertyResponse;
            /**
             * Provisioning state of the private endpoint.
             */
            provisioningState?: string;
        ...
        export interface RestoreParametersResponse {
             ...
             * List of specific databases available for restore.
             */
            databasesToRestore?: v20230315preview.DatabaseRestoreResourceResponse[];
            /**
             * List of specific gremlin databases available for restore.
             */
            gremlinDatabasesToRestore?: v20230315preview.GremlinDatabaseRestoreResourceResponse[];
            /**
             * Describes the mode of the restore.
             */
            restoreMode?: string;
        ...
        export interface SqlContainerGetPropertiesResponseResource {
             ...
             * The client encryption policy for the container.
             */
            clientEncryptionPolicy?: v20230315preview.ClientEncryptionPolicyResponse;
            /**
             * The conflict resolution policy for the container.
             */
            conflictResolutionPolicy?: v20230315preview.ConflictResolutionPolicyResponse;
             ...
             */
            materializedViewDefinition?: v20230315preview.MaterializedViewDefinitionResponse;
            /**
             * The configuration of the partition key to be used for partitioning data into multiple partitions
             */
            partitionKey?: v20230315preview.ContainerPartitionKeyResponse;
        ...
        export interface UniqueKeyPolicyResponse {
             ...
             * List of unique keys on that enforces uniqueness constraint on documents in the collection in the Azure Cosmos DB service.
             */
            uniqueKeys?: v20230315preview.UniqueKeyResponse[];
        }
    ...
    export namespace v20230415 {
        ...
        export interface AuthenticationMethodLdapPropertiesResponse {
             ...
             */
            searchFilterTemplate?: string;
            serverCertificates?: v20230415.CertificateResponse[];
            /**
             * Hostname of the LDAP server.
             */
            serverHostname?: string;
        ...
        export interface CassandraKeyspaceGetPropertiesResponseOptions {
             ...
             * Specifies the Autoscale settings.
             */
            autoscaleSettings?: v20230415.AutoscaleSettingsResponse;
            /**
             * Value of the Cosmos DB resource throughput or autoscaleSettings. Use the ThroughputSetting resource when retrieving offer details.
             */
            throughput?: number;
        ...
        export interface CassandraSchemaResponse {
             ...
             * List of cluster key.
             */
            clusterKeys?: v20230415.ClusterKeyResponse[];
            /**
             * List of Cassandra table columns.
             */
            columns?: v20230415.ColumnResponse[];
            /**
             * List of partition key.
             */
            partitionKeys?: v20230415.CassandraPartitionKeyResponse[];
        }
        ...
        export interface CassandraTableGetPropertiesResponseResource {
             ...
             * Schema of the Cosmos DB Cassandra table
             */
            schema?: v20230415.CassandraSchemaResponse;
            /**
             * A system generated property that denotes the last updated timestamp of the resource.
             */
            ts: number;
        ...
        export interface ClientEncryptionPolicyResponse {
             ...
             * Paths of the item that need encryption along with path-specific settings.
             */
            includedPaths: v20230415.ClientEncryptionIncludedPathResponse[];
            /**
             * Version of the client encryption policy definition. Supported versions are 1 and 2. Version 2 supports id and partition key path encryption. 
             */
            policyFormatVersion: number;
        ...
        export interface ClusterResourceResponseProperties {
             ...
             * List of TLS certificates used to authorize clients connecting to the cluster. All connections are TLS encrypted whether clientCertificates is set or not, but if clientCertificates is set, the managed Cassandra cluster will reject all connections not bearing a TLS client certificate that can be validated from one or more of the public certificates in this property.
             */
            clientCertificates?: v20230415.CertificateResponse[];
            /**
             * If you need to set the clusterName property in cassandra.yaml to something besides the resource name of the cluster, set the value to use on this property.
             */
            clusterNameOverride?: string;
             ...
             * List of TLS certificates used to authorize gossip from unmanaged data centers. The TLS certificates of all nodes in unmanaged data centers must be verifiable using one of the certificates provided in this property.
             */
            externalGossipCertificates?: v20230415.CertificateResponse[];
            /**
             * List of IP addresses of seed nodes in unmanaged data centers. These will be added to the seed node lists of all managed nodes.
             */
            externalSeedNodes?: v20230415.SeedNodeResponse[];
            /**
             * List of TLS certificates that unmanaged nodes must trust for gossip with managed nodes. All managed nodes will present TLS client certificates that are verifiable using one of the certificates provided in this property.
             */
            gossipCertificates: v20230415.CertificateResponse[];
            /**
             * (Deprecated) Number of hours to wait between taking a backup of the cluster.
             */
            hoursBetweenBackups?: number;
             ...
             * Hostname or IP address where the Prometheus endpoint containing data about the managed Cassandra nodes can be reached.
             */
            prometheusEndpoint?: v20230415.SeedNodeResponse;
            /**
             * Error related to resource provisioning.
             */
            provisionError?: v20230415.CassandraErrorResponse;
            /**
             * The status of the resource at the time the operation was called.
             */
            provisioningState?: string;
             ...
             * List of IP addresses of seed nodes in the managed data centers. These should be added to the seed node lists of all unmanaged nodes.
             */
            seedNodes: v20230415.SeedNodeResponse[];
        }
        ...
        export interface ContinuousModeBackupPolicyResponse {
             ...
             * Configuration values for continuous mode backup
             */
            continuousModeProperties?: v20230415.ContinuousModePropertiesResponse;
            /**
             * The object representing the state of the migration between the backup policies.
             */
            migrationState?: v20230415.BackupPolicyMigrationStateResponse;
            /**
             * Describes the mode of backups.
             * Expected value is 'Continuous'.
             */
        ...
        export interface DataCenterResourceResponseProperties {
             ...
             * Ldap authentication method properties. This feature is in preview.
             */
            authenticationMethodLdapProperties?: v20230415.AuthenticationMethodLdapPropertiesResponse;
            /**
             * If the data center has Availability Zone support, apply it to the Virtual Machine ScaleSet that host the cassandra data center virtual machines.
             */
            availabilityZone?: boolean;
        ...
        export interface DataTransferServiceResourcePropertiesResponse {
             ...
             * An array that contains all of the locations for the service.
             */
            locations: v20230415.DataTransferRegionalServiceResourceResponse[];
            /**
             * ServiceType for the service.
             * Expected value is 'DataTransfer'.
             */
        ...
        export interface DatabaseAccountKeysMetadataResponse {
             ...
             * The metadata related to the Primary Read-Write Key for the given Cosmos DB database account.
             */
            primaryMasterKey: v20230415.AccountKeyMetadataResponse;
            /**
             * The metadata related to the Primary Read-Only Key for the given Cosmos DB database account.
             */
            primaryReadonlyMasterKey: v20230415.AccountKeyMetadataResponse;
            /**
             * The metadata related to the Secondary Read-Write Key for the given Cosmos DB database account.
             */
            secondaryMasterKey: v20230415.AccountKeyMetadataResponse;
            /**
             * The metadata related to the Secondary Read-Only Key for the given Cosmos DB database account.
             */
            secondaryReadonlyMasterKey: v20230415.AccountKeyMetadataResponse;
        }
        ...
        export interface GraphAPIComputeServiceResourcePropertiesResponse {
             ...
             * An array that contains all of the locations for the service.
             */
            locations: v20230415.GraphAPIComputeRegionalServiceResourceResponse[];
            /**
             * ServiceType for the service.
             * Expected value is 'GraphAPICompute'.
             */
        ...
        export interface GremlinGraphGetPropertiesResponseResource {
             ...
             * The conflict resolution policy for the graph.
             */
            conflictResolutionPolicy?: v20230415.ConflictResolutionPolicyResponse;
            /**
             * Default time to live
             */
            defaultTtl?: number;
             ...
             * The configuration of the indexing policy. By default, the indexing is automatic for all document paths within the graph
             */
            indexingPolicy?: v20230415.IndexingPolicyResponse;
            /**
             * The configuration of the partition key to be used for partitioning data into multiple partitions
             */
            partitionKey?: v20230415.ContainerPartitionKeyResponse;
            /**
             * A system generated property. A unique identifier.
             */
            rid: string;
             ...
             * The unique key policy configuration for specifying uniqueness constraints on documents in the collection in the Azure Cosmos DB service.
             */
            uniqueKeyPolicy?: v20230415.UniqueKeyPolicyResponse;
        }
        /**
         * gremlinGraphGetPropertiesResponseResourceProvideDefaults sets the appropriate defaults for GremlinGraphGetPropertiesResponseResource
         */
        export function gremlinGraphGetPropertiesResponseResourceProvideDefaults(val: GremlinGraphGetPropertiesResponseResource): GremlinGraphGetPropertiesResponseResource {
            return {
                ...val,
                conflictResolutionPolicy: (val.conflictResolutionPolicy ? v20230415.conflictResolutionPolicyResponseProvideDefaults(val.conflictResolutionPolicy) : undefined),
                indexingPolicy: (val.indexingPolicy ? v20230415.indexingPolicyResponseProvideDefaults(val.indexingPolicy) : undefined),
                partitionKey: (val.partitionKey ? v20230415.containerPartitionKeyResponseProvideDefaults(val.partitionKey) : undefined),
            };
        }
        ...
        export interface IncludedPathResponse {
             ...
             * List of indexes for this path
             */
            indexes?: v20230415.IndexesResponse[];
            /**
             * The path for which the indexing behavior applies to. Index paths typically start with root and end with wildcard (/path/*)
             */
            path?: string;
        ...
        export interface IndexingPolicyResponse {
             ...
             * List of composite path list
             */
            compositeIndexes?: v20230415.CompositePathResponse[][];
            /**
             * List of paths to exclude from indexing
             */
            excludedPaths?: v20230415.ExcludedPathResponse[];
            /**
             * List of paths to include in the indexing
             */
            includedPaths?: v20230415.IncludedPathResponse[];
            /**
             * Indicates the indexing mode.
             */
            indexingMode?: string;
             ...
             * List of spatial specifics
             */
            spatialIndexes?: v20230415.SpatialSpecResponse[];
        }
        /**
         * indexingPolicyResponseProvideDefaults sets the appropriate defaults for IndexingPolicyResponse
         */
        ...
        export interface ManagedServiceIdentityResponse {
             ...
             * The list of user identities associated with resource. The user identity dictionary key references will be ARM resource ids in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}'.
             */
            userAssignedIdentities?: {[key: string]: v20230415.ManagedServiceIdentityResponseUserAssignedIdentities};
        }
        ...
        export interface MaterializedViewsBuilderServiceResourcePropertiesResponse {
             ...
             * An array that contains all of the locations for the service.
             */
            locations: v20230415.MaterializedViewsBuilderRegionalServiceResourceResponse[];
            /**
             * ServiceType for the service.
             * Expected value is 'MaterializedViewsBuilder'.
             */
        ...
        export interface MongoDBCollectionGetPropertiesResponseResource {
             ...
             * List of index keys
             */
            indexes?: v20230415.MongoIndexResponse[];
            /**
             * A system generated property. A unique identifier.
             */
            rid: string;
        ...
        export interface MongoIndexResponse {
             ...
             * Cosmos DB MongoDB collection index keys
             */
            key?: v20230415.MongoIndexKeysResponse;
            /**
             * Cosmos DB MongoDB collection index key options
             */
            options?: v20230415.MongoIndexOptionsResponse;
        }
        ...
        export interface PeriodicModeBackupPolicyResponse {
             ...
             * Configuration values for periodic mode backup
             */
            periodicModeProperties?: v20230415.PeriodicModePropertiesResponse;
            /**
             * Describes the mode of backups.
             * Expected value is 'Periodic'.
             */
        ...
        export interface PrivateEndpointConnectionResponse {
             ...
             * Private endpoint which the connection belongs to.
             */
            privateEndpoint?: v20230415.PrivateEndpointPropertyResponse;
            /**
             * Connection State of the Private Endpoint Connection.
             */
            privateLinkServiceConnectionState?: v20230415.PrivateLinkServiceConnectionStatePropertyResponse;
            /**
             * Provisioning state of the private endpoint.
             */
            provisioningState?: string;
        ...
        export interface PrivilegeResponse {
             ...
             * An Azure Cosmos DB Mongo DB Resource.
             */
            resource?: v20230415.PrivilegeResponseResource;
        }
        ...
        export interface RestoreParametersResponse {
             ...
             * List of specific databases available for restore.
             */
            databasesToRestore?: v20230415.DatabaseRestoreResourceResponse[];
            /**
             * List of specific gremlin databases available for restore.
             */
            gremlinDatabasesToRestore?: v20230415.GremlinDatabaseRestoreResourceResponse[];
            /**
             * Describes the mode of the restore.
             */
            restoreMode?: string;
        ...
        export interface SqlContainerGetPropertiesResponseResource {
             ...
             * The client encryption policy for the container.
             */
            clientEncryptionPolicy?: v20230415.ClientEncryptionPolicyResponse;
            /**
             * The conflict resolution policy for the container.
             */
            conflictResolutionPolicy?: v20230415.ConflictResolutionPolicyResponse;
        ...
        export interface SqlDedicatedGatewayServiceResourcePropertiesResponse {
             ...
             * An array that contains all of the locations for the service.
             */
            locations: v20230415.SqlDedicatedGatewayRegionalServiceResourceResponse[];
            /**
             * ServiceType for the service.
             * Expected value is 'SqlDedicatedGateway'.
             */
        ...
        export interface UniqueKeyPolicyResponse {
             ...
             * List of unique keys on that enforces uniqueness constraint on documents in the collection in the Azure Cosmos DB service.
             */
            uniqueKeys?: v20230415.UniqueKeyResponse[];
        }

...
export class GremlinResourceGremlinGraph extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb:GremlinResourceGremlinGraph';
    ...
    public readonly options!: pulumi.Output<types.outputs.documentdb.GremlinGraphGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<types.outputs.documentdb.GremlinGraphGetPropertiesResponseResource | undefined>;
    /**
    ...
    constructor(name: string, args: GremlinResourceGremlinGraphArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["resource"] = args ? (args.resource ? pulumi.output(args.resource).apply(types.inputs.documentdb.gremlinGraphResourceArgsProvideDefaults) : undefined) : undefined;
...
export interface GremlinResourceGremlinGraphArgs {
     ...
     */
    resource: pulumi.Input<types.inputs.documentdb.GremlinGraphResourceArgs>;
    /**

...
export interface GetGremlinResourceGremlinGraphResult {
    ...
    readonly options?: types.outputs.documentdb.GremlinGraphGetPropertiesResponseOptions;
    readonly resource?: types.outputs.documentdb.GremlinGraphGetPropertiesResponseResource;
    /**

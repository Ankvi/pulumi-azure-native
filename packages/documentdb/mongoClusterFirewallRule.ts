...
export class MongoClusterFirewallRule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: MongoClusterFirewallRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:documentdb/v20230301preview:MongoClusterFirewallRule" }, { type: "azure-native:documentdb/v20230315preview:MongoClusterFirewallRule" }] };

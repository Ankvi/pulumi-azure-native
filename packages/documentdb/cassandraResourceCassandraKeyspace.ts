...
export class CassandraResourceCassandraKeyspace extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb:CassandraResourceCassandraKeyspace';
    ...
    public readonly options!: pulumi.Output<types.outputs.documentdb.CassandraKeyspaceGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<types.outputs.documentdb.CassandraKeyspaceGetPropertiesResponseResource | undefined>;
    /**
...
export interface CassandraResourceCassandraKeyspaceArgs {
     ...
     */
    options?: pulumi.Input<types.inputs.documentdb.CreateUpdateOptionsArgs>;
    /**
     * The standard JSON format of a Cassandra keyspace
     */
    resource: pulumi.Input<types.inputs.documentdb.CassandraKeyspaceResourceArgs>;
    /**

...
export interface GetDatabaseAccountResult {
     ...
     */
    readonly analyticalStorageConfiguration?: types.outputs.documentdb.AnalyticalStorageConfigurationResponse;
    /**
     * API specific properties.
     */
    readonly apiProperties?: types.outputs.documentdb.ApiPropertiesResponse;
    /**
     * The object representing the policy for taking backups on an account.
     */
    readonly backupPolicy?: types.outputs.documentdb.ContinuousModeBackupPolicyResponse | types.outputs.documentdb.PeriodicModeBackupPolicyResponse;
    /**
     * List of Cosmos DB capabilities for the account
     */
    readonly capabilities?: types.outputs.documentdb.CapabilityResponse[];
    /**
     * The object that represents all properties related to capacity enforcement on an account.
     */
    readonly capacity?: types.outputs.documentdb.CapacityResponse;
    /**
     ...
     */
    readonly consistencyPolicy?: types.outputs.documentdb.ConsistencyPolicyResponse;
    /**
     * The CORS policy for the Cosmos DB database account.
     */
    readonly cors?: types.outputs.documentdb.CorsPolicyResponse[];
    /**
     ...
     */
    readonly failoverPolicies: types.outputs.documentdb.FailoverPolicyResponse[];
    /**
     ...
     * List of IpRules.
     */
    readonly ipRules?: types.outputs.documentdb.IpAddressOrRangeResponse[];
    /**
     ...
     */
    readonly keysMetadata: types.outputs.documentdb.DatabaseAccountKeysMetadataResponse;
    /**
     ...
     */
    readonly locations: types.outputs.documentdb.LocationResponse[];
    /**
     ...
     */
    readonly privateEndpointConnections: types.outputs.documentdb.PrivateEndpointConnectionResponse[];
    /**
     ...
     */
    readonly readLocations: types.outputs.documentdb.LocationResponse[];
    /**
     * Parameters to indicate the information about the restore.
     */
    readonly restoreParameters?: types.outputs.documentdb.RestoreParametersResponse;
    /**
     ...
     */
    readonly virtualNetworkRules?: types.outputs.documentdb.VirtualNetworkRuleResponse[];
    /**
     * An array that contains the write location for the Cosmos DB account.
     */
    readonly writeLocations: types.outputs.documentdb.LocationResponse[];
}
/**
 * Retrieves the properties of an existing Azure Cosmos DB database account.
 * Azure REST API version: 2023-04-15.

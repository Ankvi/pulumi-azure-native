...
export class DatabaseAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20230315preview:DatabaseAccount';
     ...
     */
    public readonly analyticalStorageConfiguration!: pulumi.Output<types.outputs.documentdb.v20230315preview.AnalyticalStorageConfigurationResponse | undefined>;
    /**
     * API specific properties.
     */
    public readonly apiProperties!: pulumi.Output<types.outputs.documentdb.v20230315preview.ApiPropertiesResponse | undefined>;
    /**
     * The object representing the policy for taking backups on an account.
     */
    public readonly backupPolicy!: pulumi.Output<types.outputs.documentdb.v20230315preview.ContinuousModeBackupPolicyResponse | types.outputs.documentdb.v20230315preview.PeriodicModeBackupPolicyResponse | undefined>;
    /**
     * List of Cosmos DB capabilities for the account
     */
    public readonly capabilities!: pulumi.Output<types.outputs.documentdb.v20230315preview.CapabilityResponse[] | undefined>;
    /**
     * The object that represents all properties related to capacity enforcement on an account.
     */
    public readonly capacity!: pulumi.Output<types.outputs.documentdb.v20230315preview.CapacityResponse | undefined>;
    /**
     ...
     */
    public readonly consistencyPolicy!: pulumi.Output<types.outputs.documentdb.v20230315preview.ConsistencyPolicyResponse | undefined>;
    /**
     * The CORS policy for the Cosmos DB database account.
     */
    public readonly cors!: pulumi.Output<types.outputs.documentdb.v20230315preview.CorsPolicyResponse[] | undefined>;
    /**
     ...
     */
    public readonly diagnosticLogSettings!: pulumi.Output<types.outputs.documentdb.v20230315preview.DiagnosticLogSettingsResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly failoverPolicies!: pulumi.Output<types.outputs.documentdb.v20230315preview.FailoverPolicyResponse[]>;
    /**
     ...
     * List of IpRules.
     */
    public readonly ipRules!: pulumi.Output<types.outputs.documentdb.v20230315preview.IpAddressOrRangeResponse[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly keysMetadata!: pulumi.Output<types.outputs.documentdb.v20230315preview.DatabaseAccountKeysMetadataResponse>;
    /**
     ...
     */
    public readonly locations!: pulumi.Output<types.outputs.documentdb.v20230315preview.LocationResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<types.outputs.documentdb.v20230315preview.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly readLocations!: pulumi.Output<types.outputs.documentdb.v20230315preview.LocationResponse[]>;
    /**
     * Parameters to indicate the information about the restore.
     */
    public readonly restoreParameters!: pulumi.Output<types.outputs.documentdb.v20230315preview.RestoreParametersResponse | undefined>;
    /**
     ...
     */
    public readonly virtualNetworkRules!: pulumi.Output<types.outputs.documentdb.v20230315preview.VirtualNetworkRuleResponse[] | undefined>;
    /**
     * An array that contains the write location for the Cosmos DB account.
     */
    public /*out*/ readonly writeLocations!: pulumi.Output<types.outputs.documentdb.v20230315preview.LocationResponse[]>;
...
export interface DatabaseAccountArgs {
     ...
     * Analytical storage specific properties.
     */
    analyticalStorageConfiguration?: pulumi.Input<types.inputs.documentdb.v20230315preview.AnalyticalStorageConfigurationArgs>;
    /**
     * API specific properties. Currently, supported only for MongoDB API.
     */
    apiProperties?: pulumi.Input<types.inputs.documentdb.v20230315preview.ApiPropertiesArgs>;
    /**
     * The object representing the policy for taking backups on an account.
     */
    backupPolicy?: pulumi.Input<types.inputs.documentdb.v20230315preview.ContinuousModeBackupPolicyArgs | types.inputs.documentdb.v20230315preview.PeriodicModeBackupPolicyArgs>;
    /**
     * List of Cosmos DB capabilities for the account
     */
    capabilities?: pulumi.Input<pulumi.Input<types.inputs.documentdb.v20230315preview.CapabilityArgs>[]>;
    /**
     * The object that represents all properties related to capacity enforcement on an account.
     */
    capacity?: pulumi.Input<types.inputs.documentdb.v20230315preview.CapacityArgs>;
    /**
     * The cassandra connector offer type for the Cosmos DB database C* account.
     */
    connectorOffer?: pulumi.Input<string | types.enums.v20230315preview.ConnectorOffer>;
    /**
     * The consistency policy for the Cosmos DB account.
     */
    consistencyPolicy?: pulumi.Input<types.inputs.documentdb.v20230315preview.ConsistencyPolicyArgs>;
    /**
     * The CORS policy for the Cosmos DB database account.
     */
    cors?: pulumi.Input<pulumi.Input<types.inputs.documentdb.v20230315preview.CorsPolicyArgs>[]>;
    /**
     * Enum to indicate the mode of account creation.
     */
     ...
     */
    databaseAccountOfferType: pulumi.Input<types.enums.v20230315preview.DatabaseAccountOfferType>;
    /**
     * The default identity for accessing key vault used in features like customer managed keys. The default identity needs to be explicitly set by the users. It can be "FirstPartyIdentity", "SystemAssignedIdentity" and more.
     */
     ...
     * The Object representing the different Diagnostic log settings for the Cosmos DB Account.
     */
    diagnosticLogSettings?: pulumi.Input<types.inputs.documentdb.v20230315preview.DiagnosticLogSettingsArgs>;
    /**
     * Disable write operations on metadata resources (databases, containers, throughput) via account keys
     */
     ...
     * List of IpRules.
     */
    ipRules?: pulumi.Input<pulumi.Input<types.inputs.documentdb.v20230315preview.IpAddressOrRangeArgs>[]>;
    /**
     * Flag to indicate whether to enable/disable Virtual Network ACL rules.
     */
     ...
     * Indicates the type of database account. This can only be set at database account creation.
     */
    kind?: pulumi.Input<string | types.enums.v20230315preview.DatabaseAccountKind>;
    /**
     * The location of the resource group to which the resource belongs.
     */
     ...
     */
    locations: pulumi.Input<pulumi.Input<types.inputs.documentdb.v20230315preview.LocationArgs>[]>;
    /**
     * Indicates the minimum allowed Tls version. The default is Tls 1.0, except for Cassandra and Mongo API's, which only work with Tls 1.2.
     */
    minimalTlsVersion?: pulumi.Input<string | types.enums.v20230315preview.MinimalTlsVersion>;
    /**
     * Indicates what services are allowed to bypass firewall checks.
     */
    networkAclBypass?: pulumi.Input<types.enums.v20230315preview.NetworkAclBypass>;
    /**
     * An array that contains the Resource Ids for Network Acl Bypass for the Cosmos DB account.
     */
     ...
     * Whether requests from Public Network are allowed
     */
    publicNetworkAccess?: pulumi.Input<string | types.enums.v20230315preview.PublicNetworkAccess>;
    /**
     ...
     * Parameters to indicate the information about the restore.
     */
    restoreParameters?: pulumi.Input<types.inputs.documentdb.v20230315preview.RestoreParametersArgs>;
    /**
     * Tags are a list of key-value pairs that describe the resource. These tags can be used in viewing and grouping this resource (across resource groups). A maximum of 15 tags can be provided for a resource. Each tag must have a key no greater than 128 characters and value no greater than 256 characters. For example, the default experience for a template type is set with "defaultExperience": "Cassandra". Current "defaultExperience" values also include "Table", "Graph", "DocumentDB", and "MongoDB".
     */
     ...
     * List of Virtual Network ACL rules configured for the Cosmos DB account.
     */
    virtualNetworkRules?: pulumi.Input<pulumi.Input<types.inputs.documentdb.v20230315preview.VirtualNetworkRuleArgs>[]>;
}

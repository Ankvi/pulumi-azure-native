...
export class MongoDBResourceMongoDBDatabase extends pulumi.CustomResource {
    ...
    public readonly options!: pulumi.Output<types.outputs.documentdb.v20230315preview.MongoDBDatabaseGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<types.outputs.documentdb.v20230315preview.MongoDBDatabaseGetPropertiesResponseResource | undefined>;
    /**
...
export interface MongoDBResourceMongoDBDatabaseArgs {
     ...
     */
    resource: pulumi.Input<types.inputs.documentdb.v20230315preview.MongoDBDatabaseResourceArgs>;
    /**

...
export function getCassandraResourceCassandraView(args: GetCassandraResourceCassandraViewArgs, opts?: pulumi.InvokeOptions): Promise<GetCassandraResourceCassandraViewResult> {
    ...
    return pulumi.runtime.invoke("azure-native:documentdb/v20230315preview:getCassandraResourceCassandraView", {
...
export interface GetCassandraResourceCassandraViewResult {
    ...
    readonly options?: types.outputs.documentdb.v20230315preview.CassandraViewGetPropertiesResponseOptions;
    readonly resource?: types.outputs.documentdb.v20230315preview.CassandraViewGetPropertiesResponseResource;
    /**

...
export class SqlResourceSqlTrigger extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20230315preview:SqlResourceSqlTrigger';
    ...
    public readonly resource!: pulumi.Output<types.outputs.documentdb.v20230315preview.SqlTriggerGetPropertiesResponseResource | undefined>;
    /**
...
export interface SqlResourceSqlTriggerArgs {
     ...
     */
    resource: pulumi.Input<types.inputs.documentdb.v20230315preview.SqlTriggerResourceArgs>;
    /**

...
export class TableResourceTable extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20230315preview:TableResourceTable';
    ...
    public readonly options!: pulumi.Output<types.outputs.documentdb.v20230315preview.TableGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<types.outputs.documentdb.v20230315preview.TableGetPropertiesResponseResource | undefined>;
    /**
...
export interface TableResourceTableArgs {
     ...
     */
    resource: pulumi.Input<types.inputs.documentdb.v20230315preview.TableResourceArgs>;
    /**

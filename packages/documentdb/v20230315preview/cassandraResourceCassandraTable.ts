...
export class CassandraResourceCassandraTable extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20230315preview:CassandraResourceCassandraTable';
    ...
    public readonly options!: pulumi.Output<types.outputs.documentdb.v20230315preview.CassandraTableGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<types.outputs.documentdb.v20230315preview.CassandraTableGetPropertiesResponseResource | undefined>;
    /**
...
export interface CassandraResourceCassandraTableArgs {
     ...
     */
    resource: pulumi.Input<types.inputs.documentdb.v20230315preview.CassandraTableResourceArgs>;
    /**

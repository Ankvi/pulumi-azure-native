...
export function getSqlResourceSqlDatabase(args: GetSqlResourceSqlDatabaseArgs, opts?: pulumi.InvokeOptions): Promise<GetSqlResourceSqlDatabaseResult> {
    ...
    return pulumi.runtime.invoke("azure-native:documentdb/v20230315preview:getSqlResourceSqlDatabase", {
...
export interface GetSqlResourceSqlDatabaseResult {
    ...
    readonly options?: types.outputs.documentdb.v20230315preview.SqlDatabaseGetPropertiesResponseOptions;
    readonly resource?: types.outputs.documentdb.v20230315preview.SqlDatabaseGetPropertiesResponseResource;
    /**

...
export function getSqlResourceSqlContainer(args: GetSqlResourceSqlContainerArgs, opts?: pulumi.InvokeOptions): Promise<GetSqlResourceSqlContainerResult> {
    ...
    return pulumi.runtime.invoke("azure-native:documentdb/v20230315preview:getSqlResourceSqlContainer", {
...
export interface GetSqlResourceSqlContainerResult {
    ...
    readonly options?: types.outputs.documentdb.v20230315preview.SqlContainerGetPropertiesResponseOptions;
    readonly resource?: types.outputs.documentdb.v20230315preview.SqlContainerGetPropertiesResponseResource;
    /**

...
export class CassandraResourceCassandraView extends pulumi.CustomResource {
    ...
    public readonly options!: pulumi.Output<types.outputs.documentdb.v20230315preview.CassandraViewGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<types.outputs.documentdb.v20230315preview.CassandraViewGetPropertiesResponseResource | undefined>;
    /**
...
export interface CassandraResourceCassandraViewArgs {
     ...
     */
    resource: pulumi.Input<types.inputs.documentdb.v20230315preview.CassandraViewResourceArgs>;
    /**

...
export function getGremlinResourceGremlinGraph(args: GetGremlinResourceGremlinGraphArgs, opts?: pulumi.InvokeOptions): Promise<GetGremlinResourceGremlinGraphResult> {
    ...
    return pulumi.runtime.invoke("azure-native:documentdb/v20230315preview:getGremlinResourceGremlinGraph", {
...
export interface GetGremlinResourceGremlinGraphResult {
    ...
    readonly options?: types.outputs.documentdb.v20230315preview.GremlinGraphGetPropertiesResponseOptions;
    readonly resource?: types.outputs.documentdb.v20230315preview.GremlinGraphGetPropertiesResponseResource;
    /**

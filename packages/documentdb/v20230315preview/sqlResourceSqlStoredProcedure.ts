...
export class SqlResourceSqlStoredProcedure extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20230315preview:SqlResourceSqlStoredProcedure';
    ...
    public readonly resource!: pulumi.Output<types.outputs.documentdb.v20230315preview.SqlStoredProcedureGetPropertiesResponseResource | undefined>;
    /**
...
export interface SqlResourceSqlStoredProcedureArgs {
     ...
     */
    resource: pulumi.Input<types.inputs.documentdb.v20230315preview.SqlStoredProcedureResourceArgs>;
    /**

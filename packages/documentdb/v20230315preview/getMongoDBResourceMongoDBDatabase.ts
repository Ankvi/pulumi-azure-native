...
export function getMongoDBResourceMongoDBDatabase(args: GetMongoDBResourceMongoDBDatabaseArgs, opts?: pulumi.InvokeOptions): Promise<GetMongoDBResourceMongoDBDatabaseResult> {
    ...
    return pulumi.runtime.invoke("azure-native:documentdb/v20230315preview:getMongoDBResourceMongoDBDatabase", {
...
export interface GetMongoDBResourceMongoDBDatabaseResult {
    ...
    readonly options?: types.outputs.documentdb.v20230315preview.MongoDBDatabaseGetPropertiesResponseOptions;
    readonly resource?: types.outputs.documentdb.v20230315preview.MongoDBDatabaseGetPropertiesResponseResource;
    /**

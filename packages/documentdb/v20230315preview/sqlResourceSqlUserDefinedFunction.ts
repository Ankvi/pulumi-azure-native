...
export class SqlResourceSqlUserDefinedFunction extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20230315preview:SqlResourceSqlUserDefinedFunction';
    ...
    public readonly resource!: pulumi.Output<types.outputs.documentdb.v20230315preview.SqlUserDefinedFunctionGetPropertiesResponseResource | undefined>;
    /**
...
export interface SqlResourceSqlUserDefinedFunctionArgs {
     ...
     */
    resource: pulumi.Input<types.inputs.documentdb.v20230315preview.SqlUserDefinedFunctionResourceArgs>;
    /**

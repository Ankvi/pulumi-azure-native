...
export class SqlResourceSqlContainer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20230315preview:SqlResourceSqlContainer';
    ...
    public readonly options!: pulumi.Output<types.outputs.documentdb.v20230315preview.SqlContainerGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<types.outputs.documentdb.v20230315preview.SqlContainerGetPropertiesResponseResource | undefined>;
    /**
    ...
    constructor(name: string, args: SqlResourceSqlContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["resource"] = args ? (args.resource ? pulumi.output(args.resource).apply(types.inputs.documentdb.v20230315preview.sqlContainerResourceArgsProvideDefaults) : undefined) : undefined;
...
export interface SqlResourceSqlContainerArgs {
     ...
     */
    resource: pulumi.Input<types.inputs.documentdb.v20230315preview.SqlContainerResourceArgs>;
    /**

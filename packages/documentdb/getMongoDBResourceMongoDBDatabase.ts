...
export interface GetMongoDBResourceMongoDBDatabaseResult {
    ...
    readonly options?: types.outputs.documentdb.MongoDBDatabaseGetPropertiesResponseOptions;
    readonly resource?: types.outputs.documentdb.MongoDBDatabaseGetPropertiesResponseResource;
    /**

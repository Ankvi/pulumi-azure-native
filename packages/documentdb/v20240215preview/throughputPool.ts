...
export class ThroughputPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20240215preview:ThroughputPool';
    ...
    constructor(name: string, args: ThroughputPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:documentdb:ThroughputPool" }, { type: "azure-native:documentdb/v20231115preview:ThroughputPool" }] };

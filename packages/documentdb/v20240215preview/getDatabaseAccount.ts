...
export function getDatabaseAccount(args: GetDatabaseAccountArgs, opts?: pulumi.InvokeOptions): Promise<GetDatabaseAccountResult> {
    ...
    return pulumi.runtime.invoke("azure-native:documentdb/v20240215preview:getDatabaseAccount", {
...
export interface GetDatabaseAccountResult {
     ...
     */
    readonly defaultPriorityLevel?: string;
    /**
     * The Object representing the different Diagnostic log settings for the Cosmos DB Account.
     */
    readonly diagnosticLogSettings?: types.outputs.DiagnosticLogSettingsResponse;
    /**

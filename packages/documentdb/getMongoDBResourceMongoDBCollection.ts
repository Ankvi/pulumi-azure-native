...
export interface GetMongoDBResourceMongoDBCollectionResult {
    ...
    readonly options?: types.outputs.documentdb.MongoDBCollectionGetPropertiesResponseOptions;
    readonly resource?: types.outputs.documentdb.MongoDBCollectionGetPropertiesResponseResource;
    /**

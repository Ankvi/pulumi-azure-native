...
export class SqlResourceSqlDatabase extends pulumi.CustomResource {
    ...
    public readonly options!: pulumi.Output<types.outputs.documentdb.SqlDatabaseGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<types.outputs.documentdb.SqlDatabaseGetPropertiesResponseResource | undefined>;
    /**
...
export interface SqlResourceSqlDatabaseArgs {
     ...
     */
    resource: pulumi.Input<types.inputs.documentdb.SqlDatabaseResourceArgs>;
    /**

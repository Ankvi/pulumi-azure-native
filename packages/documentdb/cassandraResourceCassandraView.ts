...
export class CassandraResourceCassandraView extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb:CassandraResourceCassandraView';
    ...
    public readonly options!: pulumi.Output<types.outputs.documentdb.CassandraViewGetPropertiesResponseOptions | undefined>;
    public readonly resource!: pulumi.Output<types.outputs.documentdb.CassandraViewGetPropertiesResponseResource | undefined>;
    /**
...
export interface CassandraResourceCassandraViewArgs {
     ...
     */
    resource: pulumi.Input<types.inputs.documentdb.CassandraViewResourceArgs>;
    /**

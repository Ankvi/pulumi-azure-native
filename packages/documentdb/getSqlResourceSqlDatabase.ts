...
export interface GetSqlResourceSqlDatabaseResult {
    ...
    readonly options?: types.outputs.documentdb.SqlDatabaseGetPropertiesResponseOptions;
    readonly resource?: types.outputs.documentdb.SqlDatabaseGetPropertiesResponseResource;
    /**

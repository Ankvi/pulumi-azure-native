...
export class TableResourceTableRoleDefinition extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb:TableResourceTableRoleDefinition';
    ...
    constructor(name: string, args: TableResourceTableRoleDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:documentdb/v20241201preview:TableResourceTableRoleDefinition" }] };

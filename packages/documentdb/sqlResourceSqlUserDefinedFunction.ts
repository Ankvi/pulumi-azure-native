...
export class SqlResourceSqlUserDefinedFunction extends pulumi.CustomResource {
    ...
    public readonly resource!: pulumi.Output<types.outputs.documentdb.SqlUserDefinedFunctionGetPropertiesResponseResource | undefined>;
    /**
...
export interface SqlResourceSqlUserDefinedFunctionArgs {
     ...
     */
    resource: pulumi.Input<types.inputs.documentdb.SqlUserDefinedFunctionResourceArgs>;
    /**

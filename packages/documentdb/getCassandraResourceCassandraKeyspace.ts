...
export interface GetCassandraResourceCassandraKeyspaceResult {
    ...
    readonly options?: types.outputs.documentdb.CassandraKeyspaceGetPropertiesResponseOptions;
    readonly resource?: types.outputs.documentdb.CassandraKeyspaceGetPropertiesResponseResource;
    /**

...
export class MongoDBResourceMongoRoleDefinition extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20230301preview:MongoDBResourceMongoRoleDefinition';
     ...
     */
    public readonly privileges!: pulumi.Output<types.outputs.documentdb.v20230301preview.PrivilegeResponse[] | undefined>;
    /**
     ...
     */
    public readonly roles!: pulumi.Output<types.outputs.documentdb.v20230301preview.RoleResponse[] | undefined>;
    /**
...
export interface MongoDBResourceMongoRoleDefinitionArgs {
     ...
     * A set of privileges contained by the Role Definition. This will allow application of this Role Definition on the entire database account or any underlying Database / Collection. Scopes higher than Database are not enforceable as privilege.
     */
    privileges?: pulumi.Input<pulumi.Input<types.inputs.documentdb.v20230301preview.PrivilegeArgs>[]>;
    /**
     ...
     * The set of roles inherited by this Role Definition.
     */
    roles?: pulumi.Input<pulumi.Input<types.inputs.documentdb.v20230301preview.RoleArgs>[]>;
    /**

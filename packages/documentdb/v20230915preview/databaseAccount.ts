...
export class DatabaseAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:documentdb/v20230915preview:DatabaseAccount';
     ...
     */
    public readonly diagnosticLogSettings!: pulumi.Output<types.outputs.DiagnosticLogSettingsResponse | undefined>;
    /**
...
export interface DatabaseAccountArgs {
     ...
     * Indicates the status of the Customer Managed Key feature on the account. In case there are errors, the property provides troubleshooting guidance.
     */
    customerManagedKeyStatus?: pulumi.Input<string | types.enums.CustomerManagedKeyStatus>;
    /**
     ...
     * The Object representing the different Diagnostic log settings for the Cosmos DB Account.
     */
    diagnosticLogSettings?: pulumi.Input<types.inputs.DiagnosticLogSettingsArgs>;
    /**
     * Disable write operations on metadata resources (databases, containers, throughput) via account keys
     */

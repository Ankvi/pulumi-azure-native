...
export class SqlResourceSqlStoredProcedure extends pulumi.CustomResource {
    ...
    public readonly resource!: pulumi.Output<types.outputs.documentdb.SqlStoredProcedureGetPropertiesResponseResource | undefined>;
    /**
...
export interface SqlResourceSqlStoredProcedureArgs {
     ...
     */
    resource: pulumi.Input<types.inputs.documentdb.SqlStoredProcedureResourceArgs>;
    /**

...
export interface GetCassandraResourceCassandraTableResult {
    ...
    readonly options?: types.outputs.documentdb.CassandraTableGetPropertiesResponseOptions;
    readonly resource?: types.outputs.documentdb.CassandraTableGetPropertiesResponseResource;
    /**

...
export class Share extends pulumi.CustomResource {
     ...
     */
    public readonly azureContainerInfo!: pulumi.Output<types.outputs.databoxedge.AzureContainerInfoResponse | undefined>;
    /**
     * List of IP addresses and corresponding access rights on the share(required for NFS protocol).
     */
    public readonly clientAccessRights!: pulumi.Output<types.outputs.databoxedge.ClientAccessRightResponse[] | undefined>;
    /**
     ...
     */
    public readonly refreshDetails!: pulumi.Output<types.outputs.databoxedge.RefreshDetailsResponse | undefined>;
    /**
     * Share mount point to the role.
     */
    public /*out*/ readonly shareMappings!: pulumi.Output<types.outputs.databoxedge.MountPointMapResponse[]>;
    /**
     ...
     */
    public readonly userAccessRights!: pulumi.Output<types.outputs.databoxedge.UserAccessRightResponse[] | undefined>;
    ...
    constructor(name: string, args: ShareArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:databoxedge/v20190301:Share" }, { type: "azure-native:databoxedge/v20190701:Share" }, { type: "azure-native:databoxedge/v20190801:Share" }, { type: "azure-native:databoxedge/v20200501preview:Share" }, { type: "azure-native:databoxedge/v20200901:Share" }, { type: "azure-native:databoxedge/v20200901preview:Share" }, { type: "azure-native:databoxedge/v20201201:Share" }, { type: "azure-native:databoxedge/v20210201:Share" }, { type: "azure-native:databoxedge/v20210201preview:Share" }, { type: "azure-native:databoxedge/v20210601:Share" }, { type: "azure-native:databoxedge/v20210601preview:Share" }, { type: "azure-native:databoxedge/v20220301:Share" }, { type: "azure-native:databoxedge/v20220401preview:Share" }, { type: "azure-native:databoxedge/v20221201preview:Share" }, { type: "azure-native:databoxedge/v20230101preview:Share" }, { type: "azure-native:databoxedge/v20230701:Share" }] };
...
export interface ShareArgs {
     ...
     * Azure container mapping for the share.
     */
    azureContainerInfo?: pulumi.Input<types.inputs.databoxedge.AzureContainerInfoArgs>;
    /**
     * List of IP addresses and corresponding access rights on the share(required for NFS protocol).
     */
    clientAccessRights?: pulumi.Input<pulumi.Input<types.inputs.databoxedge.ClientAccessRightArgs>[]>;
    /**
     * Data policy of the share.
     */
     ...
     * Details of the refresh job on this share.
     */
    refreshDetails?: pulumi.Input<types.inputs.databoxedge.RefreshDetailsArgs>;
    /**
     ...
     * Mapping of users and corresponding access rights on the share (required for SMB protocol).
     */
    userAccessRights?: pulumi.Input<pulumi.Input<types.inputs.databoxedge.UserAccessRightArgs>[]>;
}

...
export class FileEventTrigger extends pulumi.CustomResource {
     ...
     */
    public readonly sourceInfo!: pulumi.Output<types.outputs.databoxedge.v20230701.FileSourceInfoResponse>;
    /**
...
export interface FileEventTriggerArgs {
     ...
     * File event source details.
     */
    sourceInfo: pulumi.Input<types.inputs.databoxedge.v20230701.FileSourceInfoArgs>;
}

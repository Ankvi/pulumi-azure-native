...
export class MonitoringConfig extends pulumi.CustomResource {
     ...
     */
    public readonly metricConfigurations!: pulumi.Output<types.outputs.databoxedge.v20230701.MetricConfigurationResponse[]>;
    /**
     * The object name.
     */
...
export interface MonitoringConfigArgs {
     ...
     * The metrics configuration details
     */
    metricConfigurations: pulumi.Input<pulumi.Input<types.inputs.databoxedge.v20230701.MetricConfigurationArgs>[]>;
    /**

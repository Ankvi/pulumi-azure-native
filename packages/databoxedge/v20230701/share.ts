...
export class Share extends pulumi.CustomResource {
     ...
     */
    public readonly azureContainerInfo!: pulumi.Output<types.outputs.databoxedge.v20230701.AzureContainerInfoResponse | undefined>;
    /**
     * List of IP addresses and corresponding access rights on the share(required for NFS protocol).
     */
    public readonly clientAccessRights!: pulumi.Output<types.outputs.databoxedge.v20230701.ClientAccessRightResponse[] | undefined>;
    /**
     ...
     */
    public readonly refreshDetails!: pulumi.Output<types.outputs.databoxedge.v20230701.RefreshDetailsResponse | undefined>;
    /**
     * Share mount point to the role.
     */
    public /*out*/ readonly shareMappings!: pulumi.Output<types.outputs.databoxedge.v20230701.MountPointMapResponse[]>;
    /**
     ...
     */
    public readonly userAccessRights!: pulumi.Output<types.outputs.databoxedge.v20230701.UserAccessRightResponse[] | undefined>;
...
export interface ShareArgs {
     ...
     * Access protocol to be used by the share.
     */
    accessProtocol: pulumi.Input<string | types.enums.v20230701.ShareAccessProtocol>;
    /**
     * Azure container mapping for the share.
     */
    azureContainerInfo?: pulumi.Input<types.inputs.databoxedge.v20230701.AzureContainerInfoArgs>;
    /**
     * List of IP addresses and corresponding access rights on the share(required for NFS protocol).
     */
    clientAccessRights?: pulumi.Input<pulumi.Input<types.inputs.databoxedge.v20230701.ClientAccessRightArgs>[]>;
    /**
     * Data policy of the share.
     */
     ...
     * Current monitoring status of the share.
     */
    monitoringStatus: pulumi.Input<string | types.enums.v20230701.MonitoringStatus>;
    /**
     * The share name.
     */
     ...
     * Details of the refresh job on this share.
     */
    refreshDetails?: pulumi.Input<types.inputs.databoxedge.v20230701.RefreshDetailsArgs>;
    /**
     ...
     * Current status of the share.
     */
    shareStatus: pulumi.Input<string | types.enums.v20230701.ShareStatus>;
    /**
     * Mapping of users and corresponding access rights on the share (required for SMB protocol).
     */
    userAccessRights?: pulumi.Input<pulumi.Input<types.inputs.databoxedge.v20230701.UserAccessRightArgs>[]>;
}

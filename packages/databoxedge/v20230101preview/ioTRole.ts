...
export class IoTRole extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:databoxedge/v20230101preview:IoTRole';
     ...
     * Resource allocation
     */
    public readonly computeResource!: pulumi.Output<types.outputs.databoxedge.v20230101preview.ComputeResourceResponse | undefined>;
    /**
     ...
     */
    public readonly ioTDeviceDetails!: pulumi.Output<types.outputs.databoxedge.v20230101preview.IoTDeviceInfoResponse>;
    /**
     * Iot edge agent details to download the agent and bootstrap iot runtime.
     */
    public readonly ioTEdgeAgentInfo!: pulumi.Output<types.outputs.databoxedge.v20230101preview.IoTEdgeAgentInfoResponse | undefined>;
    /**
     * IoT edge device to which the IoT role needs to be configured.
     */
    public readonly ioTEdgeDeviceDetails!: pulumi.Output<types.outputs.databoxedge.v20230101preview.IoTDeviceInfoResponse>;
    /**
     * Role type.
     ...
     */
    public readonly shareMappings!: pulumi.Output<types.outputs.databoxedge.v20230101preview.MountPointMapResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: IoTRoleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:databoxedge:IoTRole" }, { type: "azure-native:databoxedge/v20190301:IoTRole" }, { type: "azure-native:databoxedge/v20190701:IoTRole" }, { type: "azure-native:databoxedge/v20190801:IoTRole" }, { type: "azure-native:databoxedge/v20200501preview:IoTRole" }, { type: "azure-native:databoxedge/v20200901:IoTRole" }, { type: "azure-native:databoxedge/v20200901preview:IoTRole" }, { type: "azure-native:databoxedge/v20201201:IoTRole" }, { type: "azure-native:databoxedge/v20210201:IoTRole" }, { type: "azure-native:databoxedge/v20210201preview:IoTRole" }, { type: "azure-native:databoxedge/v20210601:IoTRole" }, { type: "azure-native:databoxedge/v20210601preview:IoTRole" }, { type: "azure-native:databoxedge/v20220301:IoTRole" }, { type: "azure-native:databoxedge/v20220401preview:IoTRole" }, { type: "azure-native:databoxedge/v20221201preview:IoTRole" }, { type: "azure-native:databoxedge/v20230701:IoTRole" }] };
...
export interface IoTRoleArgs {
     ...
     * Resource allocation
     */
    computeResource?: pulumi.Input<types.inputs.databoxedge.v20230101preview.ComputeResourceArgs>;
    /**
     * The device name.
     */
     ...
     * IoT device metadata to which data box edge device needs to be connected.
     */
    ioTDeviceDetails: pulumi.Input<types.inputs.databoxedge.v20230101preview.IoTDeviceInfoArgs>;
    /**
     * Iot edge agent details to download the agent and bootstrap iot runtime.
     */
    ioTEdgeAgentInfo?: pulumi.Input<types.inputs.databoxedge.v20230101preview.IoTEdgeAgentInfoArgs>;
    /**
     * IoT edge device to which the IoT role needs to be configured.
     */
    ioTEdgeDeviceDetails: pulumi.Input<types.inputs.databoxedge.v20230101preview.IoTDeviceInfoArgs>;
    /**
     * Role type.
     * Expected value is 'IOT'.
     */
     ...
     * Mount points of shares in role(s).
     */
    shareMappings?: pulumi.Input<pulumi.Input<types.inputs.databoxedge.v20230101preview.MountPointMapArgs>[]>;
}

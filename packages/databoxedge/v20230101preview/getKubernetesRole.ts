...
export function getKubernetesRole(args: GetKubernetesRoleArgs, opts?: pulumi.InvokeOptions): Promise<GetKubernetesRoleResult> {
    ...
    return pulumi.runtime.invoke("azure-native:databoxedge/v20230101preview:getKubernetesRole", {
...
export interface GetKubernetesRoleResult {
     ...
     */
    readonly kubernetesClusterInfo: types.outputs.databoxedge.v20230101preview.KubernetesClusterInfoResponse;
    /**
     * Kubernetes role resources
     */
    readonly kubernetesRoleResources: types.outputs.databoxedge.v20230101preview.KubernetesRoleResourcesResponse;
    /**
     * The object name.
     */

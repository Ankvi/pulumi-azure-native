...
export class PeriodicTimerEventTrigger extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:databoxedge/v20230101preview:PeriodicTimerEventTrigger';

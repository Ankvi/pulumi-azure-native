...
export interface StorageAccountArgs {
     ...
     * Current status of the storage account
     */
    storageAccountStatus?: pulumi.Input<string | types.enums.v20230101preview.StorageAccountStatus>;
}

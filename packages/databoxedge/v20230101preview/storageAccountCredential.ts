...
export class StorageAccountCredential extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:databoxedge/v20230101preview:StorageAccountCredential';
     ...
     */
    public readonly accountKey!: pulumi.Output<types.outputs.databoxedge.v20230101preview.AsymmetricEncryptedSecretResponse | undefined>;
    /**
...
export interface StorageAccountCredentialArgs {
     ...
     * Encrypted storage key.
     */
    accountKey?: pulumi.Input<types.inputs.databoxedge.v20230101preview.AsymmetricEncryptedSecretArgs>;
    /**
     * Type of storage accessed on the storage account.
     */
    accountType: pulumi.Input<string | types.enums.v20230101preview.AccountType>;
    /**
     * Alias for the storage account.
     */
     ...
     * Signifies whether SSL needs to be enabled or not.
     */
    sslStatus: pulumi.Input<string | types.enums.v20230101preview.SSLStatus>;
    /**
     * Id of the storage account.
     */

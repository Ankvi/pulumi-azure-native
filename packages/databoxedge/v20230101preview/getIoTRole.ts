...
export function getIoTRole(args: GetIoTRoleArgs, opts?: pulumi.InvokeOptions): Promise<GetIoTRoleResult> {
    ...
    return pulumi.runtime.invoke("azure-native:databoxedge/v20230101preview:getIoTRole", {
...
export interface GetIoTRoleResult {
     ...
     * Resource allocation
     */
    readonly computeResource?: types.outputs.databoxedge.v20230101preview.ComputeResourceResponse;
    /**
     ...
     */
    readonly ioTDeviceDetails: types.outputs.databoxedge.v20230101preview.IoTDeviceInfoResponse;
    /**
     * Iot edge agent details to download the agent and bootstrap iot runtime.
     */
    readonly ioTEdgeAgentInfo?: types.outputs.databoxedge.v20230101preview.IoTEdgeAgentInfoResponse;
    /**
     * IoT edge device to which the IoT role needs to be configured.
     */
    readonly ioTEdgeDeviceDetails: types.outputs.databoxedge.v20230101preview.IoTDeviceInfoResponse;
    /**
     * Role type.

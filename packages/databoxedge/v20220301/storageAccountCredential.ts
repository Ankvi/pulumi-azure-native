...
export class StorageAccountCredential extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:databoxedge/v20220301:StorageAccountCredential';
     ...
     */
    public readonly accountKey!: pulumi.Output<types.outputs.databoxedge.v20220301.AsymmetricEncryptedSecretResponse | undefined>;
    /**
...
export interface StorageAccountCredentialArgs {
     ...
     * Encrypted storage key.
     */
    accountKey?: pulumi.Input<types.inputs.databoxedge.v20220301.AsymmetricEncryptedSecretArgs>;
    /**
     * Type of storage accessed on the storage account.
     */
    accountType: pulumi.Input<string | types.enums.v20220301.AccountType>;
    /**
     * Alias for the storage account.
     */
     ...
     * Signifies whether SSL needs to be enabled or not.
     */
    sslStatus: pulumi.Input<string | types.enums.v20220301.SSLStatus>;
    /**
     * Id of the storage account.
     */

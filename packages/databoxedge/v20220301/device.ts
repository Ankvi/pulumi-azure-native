...
export class Device extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:databoxedge/v20220301:Device';
     ...
     */
    public readonly dataResidency!: pulumi.Output<types.outputs.databoxedge.v20220301.DataResidencyResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly edgeProfile!: pulumi.Output<types.outputs.databoxedge.v20220301.EdgeProfileResponse>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<types.outputs.databoxedge.v20220301.ResourceIdentityResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly resourceMoveDetails!: pulumi.Output<types.outputs.databoxedge.v20220301.ResourceMoveDetailsResponse>;
    /**
     ...
     * The SKU type.
     */
    public readonly sku!: pulumi.Output<types.outputs.databoxedge.v20220301.SkuResponse | undefined>;
    /**
    ...
    constructor(name: string, args: DeviceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:databoxedge:Device" }, { type: "azure-native:databoxedge/v20190301:Device" }, { type: "azure-native:databoxedge/v20190701:Device" }, { type: "azure-native:databoxedge/v20190801:Device" }, { type: "azure-native:databoxedge/v20200501preview:Device" }, { type: "azure-native:databoxedge/v20200901:Device" }, { type: "azure-native:databoxedge/v20200901preview:Device" }, { type: "azure-native:databoxedge/v20201201:Device" }, { type: "azure-native:databoxedge/v20210201:Device" }, { type: "azure-native:databoxedge/v20210201preview:Device" }, { type: "azure-native:databoxedge/v20210601:Device" }, { type: "azure-native:databoxedge/v20210601preview:Device" }, { type: "azure-native:databoxedge/v20220401preview:Device" }, { type: "azure-native:databoxedge/v20221201preview:Device" }, { type: "azure-native:databoxedge/v20230101preview:Device" }, { type: "azure-native:databoxedge/v20230701:Device" }] };
...
export interface DeviceArgs {
     ...
     * The details of data-residency related properties for this resource
     */
    dataResidency?: pulumi.Input<types.inputs.databoxedge.v20220301.DataResidencyArgs>;
    /**
     * The device name.
     */
     ...
     * Msi identity of the resource
     */
    identity?: pulumi.Input<types.inputs.databoxedge.v20220301.ResourceIdentityArgs>;
    /**
     * The location of the device. This is a supported and registered Azure geographical region (for example, West US, East US, or Southeast Asia). The geographical region of a device cannot be changed once it is created, but if an identical geographical region is specified on update, the request will succeed.
     */
     ...
     * The SKU type.
     */
    sku?: pulumi.Input<types.inputs.databoxedge.v20220301.SkuArgs>;
    /**
     * The list of tags that describe the device. These tags can be used to view and group this device (across resource groups).
     */

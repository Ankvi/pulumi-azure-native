...
export interface GetIoTAddonResult {
     ...
     */
    readonly ioTDeviceDetails: types.outputs.databoxedge.v20220301.IoTDeviceInfoResponse;
    /**
     * IoT edge device to which the IoT Addon needs to be configured.
     */
    readonly ioTEdgeDeviceDetails: types.outputs.databoxedge.v20220301.IoTDeviceInfoResponse;
    /**
     * Addon type.

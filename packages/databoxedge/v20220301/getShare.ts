...
export interface GetShareResult {
     ...
     */
    readonly azureContainerInfo?: types.outputs.databoxedge.v20220301.AzureContainerInfoResponse;
    /**
     * List of IP addresses and corresponding access rights on the share(required for NFS protocol).
     */
    readonly clientAccessRights?: types.outputs.databoxedge.v20220301.ClientAccessRightResponse[];
    /**
     ...
     */
    readonly refreshDetails?: types.outputs.databoxedge.v20220301.RefreshDetailsResponse;
    /**
     * Share mount point to the role.
     */
    readonly shareMappings: types.outputs.databoxedge.v20220301.MountPointMapResponse[];
    /**
     ...
     */
    readonly userAccessRights?: types.outputs.databoxedge.v20220301.UserAccessRightResponse[];
}
/**
 * Represents a share on the  Data Box Edge/Gateway device.
 */

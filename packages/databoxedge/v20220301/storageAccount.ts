...
export class StorageAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:databoxedge/v20220301:StorageAccount';
...
export interface StorageAccountArgs {
     ...
     * Current status of the storage account
     */
    storageAccountStatus?: pulumi.Input<string | types.enums.v20220301.StorageAccountStatus>;
}

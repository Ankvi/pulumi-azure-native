...
export class IacProfile extends pulumi.CustomResource {
    ...
    declare public readonly stages: pulumi.Output<types.outputs.StagePropertiesResponse[] | undefined>;
    /**
    ...
    declare public readonly templates: pulumi.Output<types.outputs.IacTemplatePropertiesResponse[] | undefined>;
    /**

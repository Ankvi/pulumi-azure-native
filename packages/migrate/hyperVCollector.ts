...
export class HyperVCollector extends pulumi.CustomResource {
    ...
    constructor(name: string, args: HyperVCollectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate/v20191001:HyperVCollector" }, { type: "azure-native:migrate/v20230315:HyperVCollector" }, { type: "azure-native:migrate/v20230401preview:HyperVCollector" }, { type: "azure-native:migrate/v20230501preview:HyperVCollector" }] };

...
export class BusinessCaseOperation extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly reportStatusDetails: pulumi.Output<types.outputs.ReportDetailsResponse[]>;
    /**
     * Business case settings.
     */
    declare public readonly settings: pulumi.Output<types.outputs.SettingsResponse | undefined>;
    /**
     * Business case state.
     */
    ...
    constructor(name: string, args: BusinessCaseOperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate/v20230401preview:BusinessCaseOperation" }, { type: "azure-native:migrate/v20230501preview:BusinessCaseOperation" }, { type: "azure-native:migrate/v20230909preview:BusinessCaseOperation" }, { type: "azure-native:migrate/v20240101preview:BusinessCaseOperation" }, { type: "azure-native:migrate/v20240303preview:BusinessCaseOperation" }] };

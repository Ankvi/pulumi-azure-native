...
export class Project extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ProjectArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate/v20191001:Project" }, { type: "azure-native:migrate/v20230315:Project" }, { type: "azure-native:migrate/v20230401preview:Project" }] };

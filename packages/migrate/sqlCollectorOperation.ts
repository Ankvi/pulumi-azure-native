...
export class SqlCollectorOperation extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): SqlCollectorOperation {
        return new SqlCollectorOperation(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:migrate:SqlCollectorOperation';

    /**
     * Returns true if the given object is an instance of SqlCollectorOperation.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SqlCollectorOperation {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === SqlCollectorOperation.__pulumiType;
    }

    /**
     * Gets or sets the collector agent properties.
     */
    declare public readonly agentProperties: pulumi.Output<types.outputs.CollectorAgentPropertiesBaseResponse | undefined>;
    /**
     ...
     */
    constructor(name: string, args: SqlCollectorOperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate/v20230315:SqlCollectorOperation" }, { type: "azure-native:migrate/v20230401preview:SqlCollectorOperation" }, { type: "azure-native:migrate/v20230501preview:SqlCollectorOperation" }, { type: "azure-native:migrate/v20230909preview:SqlCollectorOperation" }, { type: "azure-native:migrate/v20240101preview:SqlCollectorOperation" }, { type: "azure-native:migrate/v20240115:SqlCollectorOperation" }, { type: "azure-native:migrate/v20240303preview:SqlCollectorOperation" }] };
 ...
 */
export interface SqlCollectorOperationArgs {
    /**
     * Gets or sets the collector agent properties.
     */

...
export class MigrateAgent extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.MigrateAgentModelPropertiesResponse>;
    declare public /*out*/ readonly systemData: pulumi.Output<types.outputs.MigrateAgentModelResponseSystemData>;
    /**

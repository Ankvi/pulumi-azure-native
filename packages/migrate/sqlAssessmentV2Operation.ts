...
export class SqlAssessmentV2Operation extends pulumi.CustomResource {
     ...
     */
    declare public readonly azureSqlDatabaseSettings: pulumi.Output<types.outputs.SqlDbSettingsResponse | undefined>;
    /**
     * Gets or sets user configurable SQL managed instance settings.
     */
    declare public readonly azureSqlManagedInstanceSettings: pulumi.Output<types.outputs.SqlMiSettingsResponse | undefined>;
    /**
     * Gets or sets user configurable SQL VM settings.
     */
    declare public readonly azureSqlVmSettings: pulumi.Output<types.outputs.SqlVmSettingsResponse | undefined>;
    /**
     ...
     */
    declare public readonly entityUptime: pulumi.Output<types.outputs.EntityUptimeResponse | undefined>;
    /**

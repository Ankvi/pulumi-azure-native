...
export class AssessmentProjectsOperation extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AssessmentProjectsOperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate/v20191001:AssessmentProjectsOperation" }, { type: "azure-native:migrate/v20191001:Project" }, { type: "azure-native:migrate/v20230315:AssessmentProjectsOperation" }, { type: "azure-native:migrate/v20230401preview:AssessmentProjectsOperation" }, { type: "azure-native:migrate/v20230501preview:AssessmentProjectsOperation" }, { type: "azure-native:migrate/v20230909preview:AssessmentProjectsOperation" }, { type: "azure-native:migrate/v20240101preview:AssessmentProjectsOperation" }, { type: "azure-native:migrate/v20240303preview:AssessmentProjectsOperation" }, { type: "azure-native:migrate:Project" }] };
...
export interface AssessmentProjectsOperationArgs {
     ...
     * Assessment project status.
     */
    projectStatus?: pulumi.Input<string | types.enums.ProjectStatus>;
    /**
     * The status of the last operation.
     */

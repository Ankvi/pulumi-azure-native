...
export class ServerCollectorsOperation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:migrate/v20230315:ServerCollectorsOperation';
    ...
    constructor(name: string, args: ServerCollectorsOperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate:ServerCollectorsOperation" }, { type: "azure-native:migrate/v20191001:ServerCollectorsOperation" }, { type: "azure-native:migrate/v20230401preview:ServerCollectorsOperation" }] };

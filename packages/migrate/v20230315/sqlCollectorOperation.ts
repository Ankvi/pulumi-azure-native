...
export class SqlCollectorOperation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:migrate/v20230315:SqlCollectorOperation';
    ...
    constructor(name: string, args: SqlCollectorOperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate:SqlCollectorOperation" }, { type: "azure-native:migrate/v20230401preview:SqlCollectorOperation" }] };

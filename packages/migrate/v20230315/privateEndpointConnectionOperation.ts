...
export class PrivateEndpointConnectionOperation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:migrate/v20230315:PrivateEndpointConnectionOperation';
    ...
    constructor(name: string, args: PrivateEndpointConnectionOperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate:PrivateEndpointConnectionOperation" }, { type: "azure-native:migrate/v20191001:PrivateEndpointConnectionOperation" }, { type: "azure-native:migrate/v20230401preview:PrivateEndpointConnectionOperation" }] };

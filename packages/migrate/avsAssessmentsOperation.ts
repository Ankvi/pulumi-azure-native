...
export class AvsAssessmentsOperation extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly avsEstimatedExternalStorages: pulumi.Output<types.outputs.AvsEstimatedExternalStorageResponse[]>;
    /**
     * Estimated External Storage for Assessment.
     */
    declare public /*out*/ readonly avsEstimatedNetworks: pulumi.Output<types.outputs.AvsEstimatedNetworkResponse[]>;
    /**
     * Estimated AVS SKU for Assessment.
     */
    declare public /*out*/ readonly avsEstimatedNodes: pulumi.Output<types.outputs.AvsEstimatedNodeResponse[]>;
    /**
     ...
     */
    declare public /*out*/ readonly costComponents: pulumi.Output<types.outputs.CostComponentResponse[]>;
    /**
    ...
    constructor(name: string, args: AvsAssessmentsOperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate/v20230315:AvsAssessmentsOperation" }, { type: "azure-native:migrate/v20230401preview:AvsAssessmentsOperation" }, { type: "azure-native:migrate/v20230501preview:AvsAssessmentsOperation" }, { type: "azure-native:migrate/v20230909preview:AvsAssessmentsOperation" }, { type: "azure-native:migrate/v20240101preview:AvsAssessmentsOperation" }, { type: "azure-native:migrate/v20240115:AvsAssessmentsOperation" }] };

...
export class AvsAssessmentsOperation extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly avsEstimatedExternalStorages!: pulumi.Output<types.outputs.AvsEstimatedExternalStorageResponse[]>;
    /**
     * Estimated External Storage for Assessment.
     */
    public /*out*/ readonly avsEstimatedNetworks!: pulumi.Output<types.outputs.AvsEstimatedNetworkResponse[]>;
    /**
     * Estimated AVS SKU for Assessment.
     */
    public /*out*/ readonly avsEstimatedNodes!: pulumi.Output<types.outputs.AvsEstimatedNodeResponse[]>;
    /**

...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:migrate/v20230801:MoveCollection":
                return new MoveCollection(name, <any>undefined, { urn })
            case "azure-native:migrate/v20230801:MoveResource":
...
pulumi.runtime.registerResourceModule("azure-native", "migrate/v20230801", _module)

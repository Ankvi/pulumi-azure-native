...
export class MoveCollection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:migrate/v20230801:MoveCollection';
     ...
     */
    public readonly identity!: pulumi.Output<types.outputs.migrate.v20230801.IdentityResponse | undefined>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.migrate.v20230801.MoveCollectionPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: MoveCollectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate:MoveCollection" }, { type: "azure-native:migrate/v20191001preview:MoveCollection" }, { type: "azure-native:migrate/v20210101:MoveCollection" }, { type: "azure-native:migrate/v20210801:MoveCollection" }, { type: "azure-native:migrate/v20220801:MoveCollection" }] };
...
export interface MoveCollectionArgs {
     ...
     * Defines the MSI properties of the Move Collection.
     */
    identity?: pulumi.Input<types.inputs.migrate.v20230801.IdentityArgs>;
    /**
     * The geo-location where the resource lives.
     */
     ...
     * Defines the move collection properties.
     */
    properties?: pulumi.Input<types.inputs.migrate.v20230801.MoveCollectionPropertiesArgs>;
    /**

...
export class AksAssessmentOperation extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly details: pulumi.Output<types.outputs.AKSAssessmentDetailsResponse>;
    /**
     ...
     */
    declare public readonly scope: pulumi.Output<types.outputs.AssessmentScopeParametersResponse | undefined>;
    /**
     * Gets or sets AKS Assessment Settings.
     */
    declare public readonly settings: pulumi.Output<types.outputs.AKSAssessmentSettingsResponse>;
    /**

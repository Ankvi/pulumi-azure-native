...
export class WorkloadInstance extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.WorkloadInstanceModelPropertiesResponse>;
    declare public /*out*/ readonly systemData: pulumi.Output<types.outputs.WorkloadInstanceModelResponseSystemData>;
    /**

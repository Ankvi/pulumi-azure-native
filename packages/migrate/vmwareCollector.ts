...
export class VMwareCollector extends pulumi.CustomResource {
    ...
    constructor(name: string, args: VMwareCollectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate/v20191001:VMwareCollector" }, { type: "azure-native:migrate/v20230315:VMwareCollector" }, { type: "azure-native:migrate/v20230401preview:VMwareCollector" }, { type: "azure-native:migrate/v20230501preview:VMwareCollector" }, { type: "azure-native:migrate/v20230909preview:VMwareCollector" }] };

...
export class HypervCollectorsOperation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:migrate/v20230401preview:HypervCollectorsOperation';
    ...
    constructor(name: string, args: HypervCollectorsOperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate:HypervCollectorsOperation" }, { type: "azure-native:migrate/v20191001:HypervCollectorsOperation" }, { type: "azure-native:migrate/v20230315:HypervCollectorsOperation" }] };

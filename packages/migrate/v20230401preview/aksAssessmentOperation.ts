...
export class AksAssessmentOperation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:migrate/v20230401preview:AksAssessmentOperation';
    ...
    constructor(name: string, args: AksAssessmentOperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate:AksAssessmentOperation" }] };

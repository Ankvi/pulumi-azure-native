...
export class WebAppCollectorOperation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:migrate/v20230401preview:WebAppCollectorOperation';
    ...
    constructor(name: string, args: WebAppCollectorOperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate:WebAppCollectorOperation" }] };

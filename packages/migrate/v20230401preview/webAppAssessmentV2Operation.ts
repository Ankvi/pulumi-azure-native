...
export class WebAppAssessmentV2Operation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:migrate/v20230401preview:WebAppAssessmentV2Operation';
    ...
    constructor(name: string, args: WebAppAssessmentV2OperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate:WebAppAssessmentV2Operation" }] };

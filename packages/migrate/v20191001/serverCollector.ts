...
export class ServerCollector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:migrate/v20191001:ServerCollector';
    ...
    constructor(name: string, args: ServerCollectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate:ServerCollector" }, { type: "azure-native:migrate/v20230315:ServerCollector" }] };

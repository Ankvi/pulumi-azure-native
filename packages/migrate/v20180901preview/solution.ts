...
export class Solution extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:migrate/v20180901preview:Solution';
    ...
    constructor(name: string, args: SolutionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate:Solution" }, { type: "azure-native:migrate/v20230101:Solution" }] };

...
export class MigrateProject extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:migrate/v20180901preview:MigrateProject';
    ...
    constructor(name: string, args: MigrateProjectArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate:MigrateProject" }, { type: "azure-native:migrate/v20200501:MigrateProject" }, { type: "azure-native:migrate/v20230101:MigrateProject" }] };

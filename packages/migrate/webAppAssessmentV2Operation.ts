...
export class WebAppAssessmentV2Operation extends pulumi.CustomResource {
     ...
     */
    declare public readonly appSvcContainerSettings: pulumi.Output<types.outputs.AppSvcContainerSettingsResponse | undefined>;
    /**
     * Gets or sets user configurable app service native settings.
     */
    declare public readonly appSvcNativeSettings: pulumi.Output<types.outputs.AppSvcNativeSettingsResponse | undefined>;
    /**
     ...
     */
    declare public readonly discoveredEntityLightSummary: pulumi.Output<types.outputs.DiscoveredEntityLightSummaryResponse | undefined>;
    /**

...
export class MoveResource extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.migrate.v20220801.MoveResourcePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: MoveResourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate:MoveResource" }, { type: "azure-native:migrate/v20191001preview:MoveResource" }, { type: "azure-native:migrate/v20210101:MoveResource" }, { type: "azure-native:migrate/v20210801:MoveResource" }, { type: "azure-native:migrate/v20230801:MoveResource" }] };
...
export interface MoveResourceArgs {
     ...
     * Defines the move resource properties.
     */
    properties?: pulumi.Input<types.inputs.migrate.v20220801.MoveResourcePropertiesArgs>;
    /**

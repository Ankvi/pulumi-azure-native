...
export class Assessment extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AssessmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:migrate/v20191001:Assessment" }, { type: "azure-native:migrate/v20230315:Assessment" }, { type: "azure-native:migrate/v20230401preview:Assessment" }] };

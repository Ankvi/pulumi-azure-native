...
export class WorkloadDeployment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:migrate:WorkloadDeployment';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.WorkloadDeploymentModelPropertiesResponse>;
    declare public /*out*/ readonly systemData: pulumi.Output<types.outputs.WorkloadDeploymentModelResponseSystemData>;
    /**
    ...
    constructor(name: string, args: WorkloadDeploymentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["workloadDeploymentName"] = args?.workloadDeploymentName;

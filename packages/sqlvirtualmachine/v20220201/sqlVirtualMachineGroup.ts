...
export class SqlVirtualMachineGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sqlvirtualmachine/v20220201:SqlVirtualMachineGroup';
     ...
     */
    public readonly wsfcDomainProfile!: pulumi.Output<types.outputs.sqlvirtualmachine.v20220201.WsfcDomainProfileResponse | undefined>;
...
export interface SqlVirtualMachineGroupArgs {
     ...
     * SQL image sku.
     */
    sqlImageSku?: pulumi.Input<string | types.enums.v20220201.SqlVmGroupImageSku>;
    /**
     ...
     * Cluster Active Directory domain profile.
     */
    wsfcDomainProfile?: pulumi.Input<types.inputs.sqlvirtualmachine.v20220201.WsfcDomainProfileArgs>;
}

...
export class GlobalParameter extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<{[key: string]: types.outputs.GlobalParameterSpecificationResponse}>;
    /**
     * The resource type.
     */
    ...
    constructor(name: string, args: GlobalParameterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["globalParameterName"] = args?.globalParameterName;

...
export class GlobalParameter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:datafactory/v20180601:GlobalParameter';
    ...
    constructor(name: string, args: GlobalParameterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:datafactory:GlobalParameter" }] };

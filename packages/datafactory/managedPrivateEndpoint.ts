...
export class ManagedPrivateEndpoint extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.ManagedPrivateEndpointResponse>;
    /**
     * The resource type.
     */
    ...
    constructor(name: string, args: ManagedPrivateEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            if (args?.managedVirtualNetworkName === undefined && !opts.urn) {
            ...
            resourceInputs["managedVirtualNetworkName"] = args?.managedVirtualNetworkName;

...
export class ChangeDataCapture extends pulumi.CustomResource {
     ...
     */
    declare public readonly folder: pulumi.Output<types.outputs.ChangeDataCaptureResponseFolder | undefined>;
    /**
     * The resource name.
     */
     ...
     * CDC policy
     */
    declare public readonly policy: pulumi.Output<types.outputs.MapperPolicyResponse>;
    /**
     * List of sources connections that can be used as sources in the CDC.
     */
    declare public readonly sourceConnectionsInfo: pulumi.Output<types.outputs.MapperSourceConnectionsInfoResponse[]>;
    /**
     ...
     */
    declare public readonly targetConnectionsInfo: pulumi.Output<types.outputs.MapperTargetConnectionsInfoResponse[]>;
    /**
     * The resource type.
     */

...
export class TaskHub extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TaskHub {
        return new TaskHub(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:durabletask:TaskHub';

    /**
     * Returns true if the given object is an instance of TaskHub.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TaskHub {
     ...
     */
    declare public /*out*/ readonly properties: pulumi.Output<types.outputs.TaskHubPropertiesResponse>;
    /**
     ...
     */
    constructor(name: string, args: TaskHubArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:durabletask/v20241001preview:TaskHub" }, { type: "azure-native:durabletask/v20250401preview:TaskHub" }, { type: "azure-native:durabletask/v20251101:TaskHub" }] };

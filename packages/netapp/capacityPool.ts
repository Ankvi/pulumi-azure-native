 ...
 */
export class CapacityPool extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CapacityPool {
        return new CapacityPool(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:netapp:CapacityPool';

    /**
     * Returns true if the given object is an instance of CapacityPool.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CapacityPool {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CapacityPool.__pulumiType;
    }
     ...
     */
    declare public /*out*/ readonly totalThroughputMibps: pulumi.Output<number>;
    /**
     ...
     */
    declare public /*out*/ readonly utilizedThroughputMibps: pulumi.Output<number>;
     ...
     */
    constructor(name: string, args: CapacityPoolArgs, opts?: pulumi.CustomResourceOptions) {
 ...
 */
export interface CapacityPoolArgs {
    /**

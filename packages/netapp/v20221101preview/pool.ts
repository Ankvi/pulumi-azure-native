...
export class Pool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:netapp/v20221101preview:Pool';
...
export interface PoolArgs {
     ...
     * Encryption type of the capacity pool, set encryption type for data at rest for this pool and all volumes in it. This value can only be set when creating new pool.
     */
    encryptionType?: pulumi.Input<string | types.enums.v20221101preview.EncryptionType>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The qos type of the pool
     */
    qosType?: pulumi.Input<string | types.enums.v20221101preview.QosType>;
    /**

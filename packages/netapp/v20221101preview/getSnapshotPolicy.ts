...
export function getSnapshotPolicy(args: GetSnapshotPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetSnapshotPolicyResult> {
    ...
    return pulumi.runtime.invoke("azure-native:netapp/v20221101preview:getSnapshotPolicy", {
...
export interface GetSnapshotPolicyResult {
     ...
     */
    readonly dailySchedule?: types.outputs.netapp.v20221101preview.DailyScheduleResponse;
    /**
     ...
     */
    readonly hourlySchedule?: types.outputs.netapp.v20221101preview.HourlyScheduleResponse;
    /**
     ...
     */
    readonly monthlySchedule?: types.outputs.netapp.v20221101preview.MonthlyScheduleResponse;
    /**
     ...
     */
    readonly systemData: types.outputs.netapp.v20221101preview.SystemDataResponse;
    /**
     * Resource tags.
     */
     ...
     */
    readonly weeklySchedule?: types.outputs.netapp.v20221101preview.WeeklyScheduleResponse;
}
/**
 * Get a snapshot Policy
 */

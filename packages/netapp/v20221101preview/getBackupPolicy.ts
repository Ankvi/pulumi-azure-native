...
export function getBackupPolicy(args: GetBackupPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetBackupPolicyResult> {
    ...
    return pulumi.runtime.invoke("azure-native:netapp/v20221101preview:getBackupPolicy", {
...
export interface GetBackupPolicyResult {
     ...
     */
    readonly volumeBackups: types.outputs.netapp.v20221101preview.VolumeBackupsResponse[];
    /**

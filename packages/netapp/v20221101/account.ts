...
export class Account extends pulumi.CustomResource {
     ...
     * Active Directories
     */
    public readonly activeDirectories!: pulumi.Output<types.outputs.netapp.v20221101.ActiveDirectoryResponse[] | undefined>;
    /**
     ...
     * Encryption settings
     */
    public readonly encryption!: pulumi.Output<types.outputs.netapp.v20221101.AccountEncryptionResponse | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<types.outputs.netapp.v20221101.ManagedServiceIdentityResponse | undefined>;
    /**
    ...
    constructor(name: string, args: AccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["encryption"] = args ? (args.encryption ? pulumi.output(args.encryption).apply(types.inputs.netapp.v20221101.accountEncryptionArgsProvideDefaults) : undefined) : undefined;
...
export interface AccountArgs {
     ...
     * Active Directories
     */
    activeDirectories?: pulumi.Input<pulumi.Input<types.inputs.netapp.v20221101.ActiveDirectoryArgs>[]>;
    /**
     * Encryption settings
     */
    encryption?: pulumi.Input<types.inputs.netapp.v20221101.AccountEncryptionArgs>;
    /**
     * The identity used for the resource.
     */
    identity?: pulumi.Input<types.inputs.netapp.v20221101.ManagedServiceIdentityArgs>;
    /**
     * The geo-location where the resource lives
     */

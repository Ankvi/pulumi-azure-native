...
export class Volume extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:netapp/v20221101:Volume';
     ...
     */
    public readonly dataProtection!: pulumi.Output<types.outputs.netapp.v20221101.VolumePropertiesResponseDataProtection | undefined>;
    /**
     ...
     */
    public readonly exportPolicy!: pulumi.Output<types.outputs.netapp.v20221101.VolumePropertiesResponseExportPolicy | undefined>;
    /**
     ...
     */
    public /*out*/ readonly mountTargets!: pulumi.Output<types.outputs.netapp.v20221101.MountTargetPropertiesResponse[]>;
    /**
     ...
     */
    public readonly placementRules!: pulumi.Output<types.outputs.netapp.v20221101.PlacementKeyValuePairsResponse[] | undefined>;
    /**
...
export interface VolumeArgs {
     ...
     * Specifies whether the volume is enabled for Azure VMware Solution (AVS) datastore purpose
     */
    avsDataStore?: pulumi.Input<string | types.enums.v20221101.AvsDataStore>;
    /**
     * UUID v4 or resource identifier used to identify the Backup.
     */
     ...
     * DataProtection type volumes include an object containing details of the replication
     */
    dataProtection?: pulumi.Input<types.inputs.netapp.v20221101.VolumePropertiesDataProtectionArgs>;
    /**
     * Default group quota for volume in KiBs. If isDefaultQuotaEnabled is set, the minimum value of 4 KiBs applies.
     */
     ...
     * Flag indicating whether subvolume operations are enabled on the volume
     */
    enableSubvolumes?: pulumi.Input<string | types.enums.v20221101.EnableSubvolumes>;
    /**
     * Source of key used to encrypt data in volume. Applicable if NetApp account has encryption.keySource = 'Microsoft.KeyVault'. Possible values (case-insensitive) are: 'Microsoft.NetApp, Microsoft.KeyVault'
     */
    encryptionKeySource?: pulumi.Input<string | types.enums.v20221101.EncryptionKeySource>;
    /**
     * Set of export policy rules
     */
    exportPolicy?: pulumi.Input<types.inputs.netapp.v20221101.VolumePropertiesExportPolicyArgs>;
    /**
     * Specifies if default quota is enabled for the volume.
     */
     ...
     * Basic network, or Standard features available to the volume.
     */
    networkFeatures?: pulumi.Input<string | types.enums.v20221101.NetworkFeatures>;
    /**
     * Application specific placement rules for the particular volume
     */
    placementRules?: pulumi.Input<pulumi.Input<types.inputs.netapp.v20221101.PlacementKeyValuePairsArgs>[]>;
    /**
     ...
     * The security style of volume, default unix, defaults to ntfs for dual protocol or CIFS protocol
     */
    securityStyle?: pulumi.Input<string | types.enums.v20221101.SecurityStyle>;
    /**
     * The service level of the file system
     */
     ...
     * Enables access based enumeration share property for SMB Shares. Only applicable for SMB/DualProtocol volume
     */
    smbAccessBasedEnumeration?: pulumi.Input<string | types.enums.v20221101.SmbAccessBasedEnumeration>;
    /**
     * Enables continuously available share property for smb volume. Only applicable for SMB volume
     */
     ...
     * Enables non browsable property for SMB Shares. Only applicable for SMB/DualProtocol volume
     */
    smbNonBrowsable?: pulumi.Input<string | types.enums.v20221101.SmbNonBrowsable>;
    /**
     * If enabled (true) the volume will contain a read-only snapshot directory which provides access to each of the volume's snapshots (defaults to true).
     */

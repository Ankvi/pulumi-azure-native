...
export class CapacityPoolVolume extends pulumi.CustomResource {
     ...
     */
    declare public readonly dataProtection: pulumi.Output<types.outputs.VolumePropertiesResponseDataProtection | undefined>;
    /**
     ...
     */
    declare public readonly exportPolicy: pulumi.Output<types.outputs.VolumePropertiesResponseExportPolicy | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly mountTargets: pulumi.Output<types.outputs.MountTargetPropertiesResponse[]>;
    /**
     ...
     */
    declare public readonly placementRules: pulumi.Output<types.outputs.PlacementKeyValuePairsResponse[] | undefined>;
    /**
...
export interface CapacityPoolVolumeArgs {
     ...
     * coolAccessTieringPolicy determines which cold data blocks are moved to cool tier. The possible values for this field are: Auto - Moves cold user data blocks in both the Snapshot copies and the active file system to the cool tier tier. This policy is the default. SnapshotOnly - Moves user data blocks of the Volume Snapshot copies that are not associated with the active file system to the cool tier.
     */
    coolAccessTieringPolicy?: pulumi.Input<string | types.enums.CoolAccessTieringPolicy>;
    /**
     * Specifies the number of days after which data that is not accessed by clients will be tiered.
     */

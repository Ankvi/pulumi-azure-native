...
export class Backup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:netapp/v20230501preview:Backup';
    ...
    constructor(name: string, args: BackupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:netapp/v20221101preview:Backup" }] };

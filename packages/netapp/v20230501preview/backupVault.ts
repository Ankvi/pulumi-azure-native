...
export class BackupVault extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:netapp/v20230501preview:BackupVault';
    ...
    constructor(name: string, args: BackupVaultArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:netapp:BackupVault" }, { type: "azure-native:netapp/v20221101preview:BackupVault" }] };

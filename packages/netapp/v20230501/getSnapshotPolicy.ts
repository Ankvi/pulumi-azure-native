...
export function getSnapshotPolicy(args: GetSnapshotPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetSnapshotPolicyResult> {
    ...
    return pulumi.runtime.invoke("azure-native:netapp/v20230501:getSnapshotPolicy", {
...
export interface GetSnapshotPolicyResult {
     ...
     */
    readonly dailySchedule?: types.outputs.netapp.v20230501.DailyScheduleResponse;
    /**
     ...
     */
    readonly hourlySchedule?: types.outputs.netapp.v20230501.HourlyScheduleResponse;
    /**
     ...
     */
    readonly monthlySchedule?: types.outputs.netapp.v20230501.MonthlyScheduleResponse;
    /**
     ...
     */
    readonly weeklySchedule?: types.outputs.netapp.v20230501.WeeklyScheduleResponse;
}
/**
 * Get a snapshot Policy
 */

...
export function getVolumeGroup(args: GetVolumeGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetVolumeGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-native:netapp/v20230501:getVolumeGroup", {
...
export interface GetVolumeGroupResult {
     ...
     */
    readonly groupMetaData?: types.outputs.netapp.v20230501.VolumeGroupMetaDataResponse;
    /**
     * Resource Id
     */
    readonly id: string;
     ...
     */
    readonly volumes?: types.outputs.netapp.v20230501.VolumeGroupVolumePropertiesResponse[];
}
/**
 * Get details of the specified volume group
 */

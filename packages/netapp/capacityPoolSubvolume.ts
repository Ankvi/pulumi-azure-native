...
export class CapacityPoolSubvolume extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:netapp:CapacityPoolSubvolume';

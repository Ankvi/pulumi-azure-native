...
export class GroupQuotaSubscription extends pulumi.CustomResource {
    ...
    public /*out*/ readonly properties!: pulumi.Output<types.outputs.quota.GroupQuotaSubscriptionIdResponseProperties>;
    /**
     * Azure Resource Manager metadata containing createdBy and modifiedBy information.
     */
    public /*out*/ readonly systemData!: pulumi.Output<types.outputs.quota.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: GroupQuotaSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:quota/v20230601preview:GroupQuotaSubscription" }] };

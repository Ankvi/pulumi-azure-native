...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:quota/v20230601preview:GroupQuota":
                return new GroupQuota(name, <any>undefined, { urn })
            case "azure-native:quota/v20230601preview:GroupQuotaSubscription":
...
pulumi.runtime.registerResourceModule("azure-native", "quota/v20230601preview", _module)

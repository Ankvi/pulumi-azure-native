...
export class GroupQuotaSubscription extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:quota/v20230601preview:GroupQuotaSubscription';
    ...
    constructor(name: string, args: GroupQuotaSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:quota:GroupQuotaSubscription" }] };

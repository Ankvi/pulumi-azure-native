...
export class Ledger extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:confidentialledger/v20230126preview:Ledger';
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.confidentialledger.v20230126preview.LedgerPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: LedgerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:confidentialledger:Ledger" }, { type: "azure-native:confidentialledger/v20201201preview:Ledger" }, { type: "azure-native:confidentialledger/v20210513preview:Ledger" }, { type: "azure-native:confidentialledger/v20220513:Ledger" }, { type: "azure-native:confidentialledger/v20220908preview:Ledger" }] };
...
export interface LedgerArgs {
     ...
     * Properties of Confidential Ledger Resource.
     */
    properties?: pulumi.Input<types.inputs.confidentialledger.v20230126preview.LedgerPropertiesArgs>;
    /**

...
export class EnergyService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:openenergyplatform/v20220404preview:EnergyService';
    ...
    constructor(name: string, args: EnergyServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:openenergyplatform:EnergyService" }, { type: "azure-native:openenergyplatform/v20210601preview:EnergyService" }] };

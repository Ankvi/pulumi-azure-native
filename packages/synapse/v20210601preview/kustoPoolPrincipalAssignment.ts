...
export class KustoPoolPrincipalAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:synapse/v20210601preview:KustoPoolPrincipalAssignment';
...
export interface KustoPoolPrincipalAssignmentArgs {
     ...
     * Cluster principal role.
     */
    role: pulumi.Input<string | types.enums.v20210601preview.ClusterPrincipalRole>;
    /**
     * The tenant id of the principal
     */

...
export class KustoPoolDatabasePrincipalAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:synapse/v20210601preview:KustoPoolDatabasePrincipalAssignment';
...
export interface KustoPoolDatabasePrincipalAssignmentArgs {
     ...
     * Principal type.
     */
    principalType: pulumi.Input<string | types.enums.v20210601preview.PrincipalType>;
    /**
     ...
     * Database principal role.
     */
    role: pulumi.Input<string | types.enums.v20210601preview.DatabasePrincipalRole>;
    /**
     * The tenant id of the principal
     */

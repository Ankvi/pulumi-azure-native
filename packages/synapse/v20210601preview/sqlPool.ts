...
export class SqlPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:synapse/v20210601preview:SqlPool';
     ...
     * SQL pool SKU
     */
    public readonly sku!: pulumi.Output<types.outputs.synapse.v20210601preview.SkuResponse | undefined>;
    /**
...
export interface SqlPoolArgs {
     ...
     */
    createMode?: pulumi.Input<string | types.enums.v20210601preview.CreateMode>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * SQL pool SKU
     */
    sku?: pulumi.Input<types.inputs.synapse.v20210601preview.SkuArgs>;
    /**
     * Specifies the time that the sql pool was deleted
     */
     ...
     * The storage account type used to store backups for this sql pool.
     */
    storageAccountType?: pulumi.Input<string | types.enums.v20210601preview.StorageAccountType>;
    /**
     * Resource tags.
     */

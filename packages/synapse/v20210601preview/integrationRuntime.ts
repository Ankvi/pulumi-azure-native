...
export class IntegrationRuntime extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:synapse/v20210601preview:IntegrationRuntime';
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.synapse.v20210601preview.ManagedIntegrationRuntimeResponse | types.outputs.synapse.v20210601preview.SelfHostedIntegrationRuntimeResponse>;
    /**
...
export interface IntegrationRuntimeArgs {
     ...
     * Integration runtime properties.
     */
    properties: pulumi.Input<types.inputs.synapse.v20210601preview.ManagedIntegrationRuntimeArgs | types.inputs.synapse.v20210601preview.SelfHostedIntegrationRuntimeArgs>;
    /**

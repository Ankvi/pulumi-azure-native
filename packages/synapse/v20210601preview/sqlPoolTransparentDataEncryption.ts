...
export class SqlPoolTransparentDataEncryption extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:synapse/v20210601preview:SqlPoolTransparentDataEncryption';
...
export interface SqlPoolTransparentDataEncryptionArgs {
     ...
     * The status of the database transparent data encryption.
     */
    status?: pulumi.Input<string | types.enums.v20210601preview.TransparentDataEncryptionStatus>;
    /**

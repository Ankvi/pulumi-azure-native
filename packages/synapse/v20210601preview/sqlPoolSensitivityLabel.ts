...
export class SqlPoolSensitivityLabel extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:synapse/v20210601preview:SqlPoolSensitivityLabel';
...
export interface SqlPoolSensitivityLabelArgs {
    ...
    rank?: pulumi.Input<types.enums.v20210601preview.SensitivityLabelRank>;
    /**

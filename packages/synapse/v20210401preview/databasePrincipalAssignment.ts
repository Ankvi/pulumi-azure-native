...
export class DatabasePrincipalAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:synapse/v20210401preview:DatabasePrincipalAssignment';
...
export interface DatabasePrincipalAssignmentArgs {
     ...
     * Principal type.
     */
    principalType: pulumi.Input<string | types.enums.v20210401preview.PrincipalType>;
    /**
     ...
     * Database principal role.
     */
    role: pulumi.Input<string | types.enums.v20210401preview.DatabasePrincipalRole>;
    /**
     * The tenant id of the principal
     */

...
export class Key extends pulumi.CustomResource {
     ...
     */
    declare public readonly isActiveCMK: pulumi.Output<boolean | undefined>;
    /**
     * The Key Vault Url of the workspace key.
     */
    declare public readonly keyVaultUrl: pulumi.Output<string | undefined>;
    /**
    ...
    constructor(name: string, args: KeyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["isActiveCMK"] = args?.isActiveCMK;
            resourceInputs["keyName"] = args?.keyName;
            resourceInputs["keyVaultUrl"] = args?.keyVaultUrl;

...
export interface GetIntegrationRuntimeResult {
     ...
     */
    readonly properties: types.outputs.synapse.v20210601.ManagedIntegrationRuntimeResponse | types.outputs.synapse.v20210601.SelfHostedIntegrationRuntimeResponse;
    /**

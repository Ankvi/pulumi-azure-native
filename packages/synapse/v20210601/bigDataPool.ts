...
export class BigDataPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:synapse/v20210601:BigDataPool';
     ...
     */
    public readonly autoPause!: pulumi.Output<types.outputs.synapse.v20210601.AutoPausePropertiesResponse | undefined>;
    /**
     * Auto-scaling properties
     */
    public readonly autoScale!: pulumi.Output<types.outputs.synapse.v20210601.AutoScalePropertiesResponse | undefined>;
    /**
     * The cache size
     */
     ...
     */
    public readonly customLibraries!: pulumi.Output<types.outputs.synapse.v20210601.LibraryInfoResponse[] | undefined>;
    /**
     ...
     */
    public readonly dynamicExecutorAllocation!: pulumi.Output<types.outputs.synapse.v20210601.DynamicExecutorAllocationResponse | undefined>;
    /**
     ...
     */
    public readonly libraryRequirements!: pulumi.Output<types.outputs.synapse.v20210601.LibraryRequirementsResponse | undefined>;
    /**
     ...
     */
    public readonly sparkConfigProperties!: pulumi.Output<types.outputs.synapse.v20210601.SparkConfigPropertiesResponse | undefined>;
    /**
...
export interface BigDataPoolArgs {
     ...
     * Auto-pausing properties
     */
    autoPause?: pulumi.Input<types.inputs.synapse.v20210601.AutoPausePropertiesArgs>;
    /**
     * Auto-scaling properties
     */
    autoScale?: pulumi.Input<types.inputs.synapse.v20210601.AutoScalePropertiesArgs>;
    /**
     * Big Data pool name
     */
     ...
     * List of custom libraries/packages associated with the spark pool.
     */
    customLibraries?: pulumi.Input<pulumi.Input<types.inputs.synapse.v20210601.LibraryInfoArgs>[]>;
    /**
     * The default folder where Spark logs will be written.
     */
     ...
     * Dynamic Executor Allocation
     */
    dynamicExecutorAllocation?: pulumi.Input<types.inputs.synapse.v20210601.DynamicExecutorAllocationArgs>;
    /**
     ...
     * Library version requirements
     */
    libraryRequirements?: pulumi.Input<types.inputs.synapse.v20210601.LibraryRequirementsArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The level of compute power that each node in the Big Data pool has.
     */
    nodeSize?: pulumi.Input<string | types.enums.v20210601.NodeSize>;
    /**
     * The kind of nodes that the Big Data pool provides.
     */
    nodeSizeFamily?: pulumi.Input<string | types.enums.v20210601.NodeSizeFamily>;
    /**
     * The state of the Big Data pool.
     */
     ...
     * Spark configuration file to specify additional properties
     */
    sparkConfigProperties?: pulumi.Input<types.inputs.synapse.v20210601.SparkConfigPropertiesArgs>;
    /**
     * The Spark events folder
     */

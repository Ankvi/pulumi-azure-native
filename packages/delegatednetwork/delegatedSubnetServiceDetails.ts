...
export class DelegatedSubnetServiceDetails extends pulumi.CustomResource {
     ...
     */
    declare public readonly controllerDetails: pulumi.Output<types.outputs.ControllerDetailsResponse | undefined>;
    /**
     ...
     * subnet details
     */
    declare public readonly subnetDetails: pulumi.Output<types.outputs.SubnetDetailsResponse | undefined>;
    /**
     * The resource tags.
     */

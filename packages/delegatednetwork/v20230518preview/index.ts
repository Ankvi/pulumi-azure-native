...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:delegatednetwork/v20230518preview:ControllerDetails":
                return new ControllerDetails(name, <any>undefined, { urn })
            case "azure-native:delegatednetwork/v20230518preview:DelegatedSubnetServiceDetails":
                return new DelegatedSubnetServiceDetails(name, <any>undefined, { urn })
            case "azure-native:delegatednetwork/v20230518preview:OrchestratorInstanceServiceDetails":
...
pulumi.runtime.registerResourceModule("azure-native", "delegatednetwork/v20230518preview", _module)

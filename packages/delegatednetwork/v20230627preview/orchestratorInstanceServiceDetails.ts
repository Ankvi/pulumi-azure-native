...
export class OrchestratorInstanceServiceDetails extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:delegatednetwork/v20230627preview:OrchestratorInstanceServiceDetails';
     ...
     */
    public readonly controllerDetails!: pulumi.Output<types.outputs.delegatednetwork.v20230627preview.ControllerDetailsResponse>;
    /**
     * The identity of the orchestrator
     */
    public readonly identity!: pulumi.Output<types.outputs.delegatednetwork.v20230627preview.OrchestratorIdentityResponse | undefined>;
    /**
...
export interface OrchestratorInstanceServiceDetailsArgs {
     ...
     * The identity of the orchestrator
     */
    identity?: pulumi.Input<types.inputs.delegatednetwork.v20230627preview.OrchestratorIdentityArgs>;
    /**
     * The kind of workbook. Choices are user and shared.
     */
    kind: pulumi.Input<string | types.enums.v20230627preview.OrchestratorKind>;
    /**
     * Location of the resource.
     */

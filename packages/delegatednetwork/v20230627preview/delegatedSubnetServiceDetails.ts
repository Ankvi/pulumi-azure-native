...
export class DelegatedSubnetServiceDetails extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:delegatednetwork/v20230627preview:DelegatedSubnetServiceDetails';
     ...
     */
    public readonly controllerDetails!: pulumi.Output<types.outputs.delegatednetwork.v20230627preview.ControllerDetailsResponse | undefined>;
    /**
     ...
     * subnet details
     */
    public readonly subnetDetails!: pulumi.Output<types.outputs.delegatednetwork.v20230627preview.SubnetDetailsResponse | undefined>;
    /**
     * The resource tags.
     */
    ...
    constructor(name: string, args: DelegatedSubnetServiceDetailsArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:delegatednetwork:DelegatedSubnetServiceDetails" }, { type: "azure-native:delegatednetwork/v20200808preview:DelegatedSubnetServiceDetails" }, { type: "azure-native:delegatednetwork/v20210315:DelegatedSubnetServiceDetails" }, { type: "azure-native:delegatednetwork/v20230518preview:DelegatedSubnetServiceDetails" }] };
...
export interface DelegatedSubnetServiceDetailsArgs {
     ...
     * Properties of the controller.
     */
    controllerDetails?: pulumi.Input<types.inputs.delegatednetwork.v20230627preview.ControllerDetailsArgs>;
    /**
     * Location of the resource.
     */
     ...
     * subnet details
     */
    subnetDetails?: pulumi.Input<types.inputs.delegatednetwork.v20230627preview.SubnetDetailsArgs>;
    /**
     * The resource tags.
     */

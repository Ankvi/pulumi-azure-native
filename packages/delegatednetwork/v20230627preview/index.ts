...
// Export enums:
export * from "../types/enums/v20230627preview";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:delegatednetwork/v20230627preview:ControllerDetails":
                return new ControllerDetails(name, <any>undefined, { urn })
            case "azure-native:delegatednetwork/v20230627preview:DelegatedSubnetServiceDetails":
                return new DelegatedSubnetServiceDetails(name, <any>undefined, { urn })
            case "azure-native:delegatednetwork/v20230627preview:OrchestratorInstanceServiceDetails":
...
pulumi.runtime.registerResourceModule("azure-native", "delegatednetwork/v20230627preview", _module)

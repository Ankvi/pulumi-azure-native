...
export class ControllerDetails extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:delegatednetwork/v20210315:ControllerDetails';
    ...
    constructor(name: string, args: ControllerDetailsArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:delegatednetwork:ControllerDetails" }, { type: "azure-native:delegatednetwork/v20200808preview:ControllerDetails" }, { type: "azure-native:delegatednetwork/v20230518preview:ControllerDetails" }, { type: "azure-native:delegatednetwork/v20230627preview:ControllerDetails" }] };

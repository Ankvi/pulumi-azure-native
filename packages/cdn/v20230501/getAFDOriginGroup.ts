...
export function getAFDOriginGroup(args: GetAFDOriginGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetAFDOriginGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-native:cdn/v20230501:getAFDOriginGroup", {
...
export interface GetAFDOriginGroupResult {
     ...
     */
    readonly loadBalancingSettings?: types.outputs.cdn.v20230501.LoadBalancingSettingsParametersResponse;
    /**
     * Resource name.
     */

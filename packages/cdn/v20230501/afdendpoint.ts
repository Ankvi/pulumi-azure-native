...
export class AFDEndpoint extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AFDEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cdn:AFDEndpoint" }, { type: "azure-native:cdn/v20200901:AFDEndpoint" }, { type: "azure-native:cdn/v20210601:AFDEndpoint" }, { type: "azure-native:cdn/v20220501preview:AFDEndpoint" }, { type: "azure-native:cdn/v20221101preview:AFDEndpoint" }] };
...
export interface AFDEndpointArgs {
     ...
     * Indicates the endpoint name reuse scope. The default value is TenantReuse.
     */
    autoGeneratedDomainNameLabelScope?: pulumi.Input<string | types.enums.v20230501.AutoGeneratedDomainNameLabelScope>;
    /**
     * Whether to enable use of this rule. Permitted values are 'Enabled' or 'Disabled'
     */

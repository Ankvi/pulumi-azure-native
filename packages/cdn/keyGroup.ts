...
export class KeyGroup extends pulumi.CustomResource {
     ...
     */
    declare public readonly keyReferences: pulumi.Output<types.outputs.ResourceReferenceResponse[] | undefined>;
    /**
     * Resource name.
     */
    ...
    constructor(name: string, args: KeyGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cdn/v20230701preview:KeyGroup" }, { type: "azure-native:cdn/v20240501preview:KeyGroup" }, { type: "azure-native:cdn/v20240601preview:KeyGroup" }, { type: "azure-native:cdn/v20250901preview:KeyGroup" }] };

...
export class ProfileAgent extends pulumi.CustomResource {
     ...
     */
    public readonly customDomains!: pulumi.Output<types.outputs.ResourceReferenceResponse[]>;
    /**
     ...
     */
    public readonly webAgent!: pulumi.Output<types.outputs.ResourceReferenceResponse>;

...
export class ProfileAgent extends pulumi.CustomResource {
     ...
     */
    declare public readonly customDomains: pulumi.Output<types.outputs.ResourceReferenceResponse[]>;
    /**
     ...
     */
    declare public readonly webAgent: pulumi.Output<types.outputs.ResourceReferenceResponse>;
...
export interface ProfileAgentArgs {
     ...
     * Reference to the web agent resource.
     */
    webAgent: pulumi.Input<types.inputs.ResourceReferenceArgs>;
}
...
export class AFDOriginGroup extends pulumi.CustomResource {
     ...
     */
    declare public readonly authentication: pulumi.Output<types.outputs.OriginAuthenticationPropertiesResponse | undefined>;
    /**
     ...
     */
    declare public readonly loadBalancingSettings: pulumi.Output<types.outputs.LoadBalancingSettingsParametersResponse | undefined>;
    /**

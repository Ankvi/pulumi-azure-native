...
export class AFDOrigin extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cdn/v20230701preview:AFDOrigin';
    ...
    constructor(name: string, args: AFDOriginArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cdn:AFDOrigin" }, { type: "azure-native:cdn/v20200901:AFDOrigin" }, { type: "azure-native:cdn/v20210601:AFDOrigin" }, { type: "azure-native:cdn/v20220501preview:AFDOrigin" }, { type: "azure-native:cdn/v20221101preview:AFDOrigin" }, { type: "azure-native:cdn/v20230501:AFDOrigin" }, { type: "azure-native:cdn/v20240201:AFDOrigin" }] };

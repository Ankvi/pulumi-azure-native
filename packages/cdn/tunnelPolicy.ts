...
export class TunnelPolicy extends pulumi.CustomResource {
     ...
     */
    declare public readonly domains: pulumi.Output<types.outputs.ActivatedResourceReferenceResponse[]>;
    /**
     * Resource name.
     */
     ...
     */
    declare public readonly targetGroups: pulumi.Output<types.outputs.ResourceReferenceResponse[] | undefined>;
    /**

...
export class AFDCustomDomain extends pulumi.CustomResource {
     ...
     */
    public readonly azureDnsZone!: pulumi.Output<types.outputs.cdn.ResourceReferenceResponse | undefined>;
     ...
     */
    public readonly preValidatedCustomDomainResourceId!: pulumi.Output<types.outputs.cdn.ResourceReferenceResponse | undefined>;
    /**
     ...
     */
    public readonly tlsSettings!: pulumi.Output<types.outputs.cdn.AFDDomainHttpsParametersResponse | undefined>;
    /**
     * Resource type.
     */
     ...
     */
    public /*out*/ readonly validationProperties!: pulumi.Output<types.outputs.cdn.DomainValidationPropertiesResponse>;
...
export interface AFDCustomDomainArgs {
     ...
     * Resource reference to the Azure DNS zone
     */
    azureDnsZone?: pulumi.Input<types.inputs.cdn.ResourceReferenceArgs>;
    /**
     ...
     * Resource reference to the Azure resource where custom domain ownership was prevalidated
     */
    preValidatedCustomDomainResourceId?: pulumi.Input<types.inputs.cdn.ResourceReferenceArgs>;
    /**
     ...
     * The configuration specifying how to enable HTTPS for the domain - using AzureFrontDoor managed certificate or user's own certificate. If not specified, enabling ssl uses AzureFrontDoor managed certificate by default.
     */
    tlsSettings?: pulumi.Input<types.inputs.cdn.AFDDomainHttpsParametersArgs>;
}

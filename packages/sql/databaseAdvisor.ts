...
export class DatabaseAdvisor extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql:DatabaseAdvisor';
     ...
     */
    declare public /*out*/ readonly recommendedActions: pulumi.Output<types.outputs.RecommendedActionResponse[]>;
    /**
     * Resource type.
     */

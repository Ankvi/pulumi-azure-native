...
export class JobStep extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql:JobStep';
     ...
     */
    declare public readonly action: pulumi.Output<types.outputs.JobStepActionResponse>;
    /**
     ...
     */
    declare public readonly executionOptions: pulumi.Output<types.outputs.JobStepExecutionOptionsResponse | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    declare public readonly output: pulumi.Output<types.outputs.JobStepOutputResponse | undefined>;
    /**
     * The job step's index within the job. If not specified when creating the job step, it will be created as the last step. If not specified when updating the job step, the step id is not modified.
     */
    declare public readonly stepId: pulumi.Output<number | undefined>;
    /**
     * The resource ID of the target group that the job step will be executed on.
     */
    declare public readonly targetGroup: pulumi.Output<string>;
    /**
     * Resource type.
     */

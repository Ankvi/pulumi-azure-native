...
export interface GetJobStepResult {
     ...
     */
    readonly action: types.outputs.sql.JobStepActionResponse;
    /**
     ...
     */
    readonly executionOptions?: types.outputs.sql.JobStepExecutionOptionsResponse;
    /**
     * Resource ID.
     */
    readonly id: string;
     ...
     */
    readonly output?: types.outputs.sql.JobStepOutputResponse;
    /**

...
export class JobTargetGroup extends pulumi.CustomResource {
     ...
     */
    declare public readonly members: pulumi.Output<types.outputs.JobTargetResponse[]>;
    /**
     * Resource name.
     */

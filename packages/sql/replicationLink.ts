...
export class ReplicationLink extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql:ReplicationLink';
     ...
     */
    declare public /*out*/ readonly isTerminationAllowed: pulumi.Output<boolean>;
    /**
     ...
     */
    declare public /*out*/ readonly partnerDatabase: pulumi.Output<string>;
    /**
     * Resource partner database Id.
     */
    declare public /*out*/ readonly partnerDatabaseId: pulumi.Output<string>;
    /**
     * Resource partner location.
     */
    declare public /*out*/ readonly partnerLocation: pulumi.Output<string>;
    /**
     * Partner replication role.
     */
    declare public /*out*/ readonly partnerRole: pulumi.Output<string>;
    /**
     * Resource partner server.
     */
    declare public /*out*/ readonly partnerServer: pulumi.Output<string>;
    /**
     ...
     * Replication mode.
     */
    declare public /*out*/ readonly replicationMode: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, args: ReplicationLinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:sql/v20230501preview:ReplicationLink" }, { type: "azure-native:sql/v20230801:ReplicationLink" }, { type: "azure-native:sql/v20230801preview:ReplicationLink" }, { type: "azure-native:sql/v20240501preview:ReplicationLink" }, { type: "azure-native:sql/v20241101preview:ReplicationLink" }] };

...
export class ManagedInstance extends pulumi.CustomResource {
     ...
     */
    declare public readonly administrators: pulumi.Output<types.outputs.ManagedInstanceExternalAdministratorResponse | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly privateEndpointConnections: pulumi.Output<types.outputs.ManagedInstancePecPropertyResponse[]>;
    /**
...
export interface ManagedInstanceArgs {
     ...
     * Pricing model of Managed Instance.
     */
    pricingModel?: pulumi.Input<string | types.enums.PricingModel>;
    /**
     * The resource id of a user assigned identity to be used by default.
     */

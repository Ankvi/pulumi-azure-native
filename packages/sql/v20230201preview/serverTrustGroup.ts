...
export class ServerTrustGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20230201preview:ServerTrustGroup';
     ...
     */
    public readonly groupMembers!: pulumi.Output<types.outputs.sql.v20230201preview.ServerInfoResponse[]>;
    /**
     * Resource name.
     */
...
export interface ServerTrustGroupArgs {
     ...
     * Group members information for the server trust group.
     */
    groupMembers: pulumi.Input<pulumi.Input<types.inputs.sql.v20230201preview.ServerInfoArgs>[]>;
    /**

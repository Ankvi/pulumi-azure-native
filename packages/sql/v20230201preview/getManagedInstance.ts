...
export interface GetManagedInstanceResult {
     ...
     */
    readonly administrators?: types.outputs.sql.v20230201preview.ManagedInstanceExternalAdministratorResponse;
    /**
     ...
     */
    readonly privateEndpointConnections: types.outputs.sql.v20230201preview.ManagedInstancePecPropertyResponse[];
    /**
     ...
     */
    readonly servicePrincipal?: types.outputs.sql.v20230201preview.ServicePrincipalResponse;
    /**

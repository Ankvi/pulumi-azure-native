...
export class JobTargetGroup extends pulumi.CustomResource {
     ...
     */
    public readonly members!: pulumi.Output<types.outputs.sql.v20230201preview.JobTargetResponse[]>;
    /**
     * Resource name.
     */
...
export interface JobTargetGroupArgs {
     ...
     * Members of the target group.
     */
    members: pulumi.Input<pulumi.Input<types.inputs.sql.v20230201preview.JobTargetArgs>[]>;
    /**

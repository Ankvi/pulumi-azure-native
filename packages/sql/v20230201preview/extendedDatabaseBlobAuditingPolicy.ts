...
export interface ExtendedDatabaseBlobAuditingPolicyArgs {
     ...
     * Specifies the state of the audit. If state is Enabled, storageEndpoint or isAzureMonitorTargetEnabled are required.
     */
    state: pulumi.Input<types.enums.v20230201preview.BlobAuditingPolicyState>;
    /**

...
export class ManagedInstanceAzureADOnlyAuthentication extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20230201preview:ManagedInstanceAzureADOnlyAuthentication';

...
export class InstanceFailoverGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20230201preview:InstanceFailoverGroup';
     ...
     */
    public readonly managedInstancePairs!: pulumi.Output<types.outputs.sql.v20230201preview.ManagedInstancePairInfoResponse[]>;
    /**
     * Resource name.
     */
     ...
     */
    public readonly partnerRegions!: pulumi.Output<types.outputs.sql.v20230201preview.PartnerRegionInfoResponse[]>;
    /**
     * Read-only endpoint of the failover group instance.
     */
    public readonly readOnlyEndpoint!: pulumi.Output<types.outputs.sql.v20230201preview.InstanceFailoverGroupReadOnlyEndpointResponse | undefined>;
    /**
     * Read-write endpoint of the failover group instance.
     */
    public readonly readWriteEndpoint!: pulumi.Output<types.outputs.sql.v20230201preview.InstanceFailoverGroupReadWriteEndpointResponse>;
    /**
...
export interface InstanceFailoverGroupArgs {
     ...
     * List of managed instance pairs in the failover group.
     */
    managedInstancePairs: pulumi.Input<pulumi.Input<types.inputs.sql.v20230201preview.ManagedInstancePairInfoArgs>[]>;
    /**
     * Partner region information for the failover group.
     */
    partnerRegions: pulumi.Input<pulumi.Input<types.inputs.sql.v20230201preview.PartnerRegionInfoArgs>[]>;
    /**
     * Read-only endpoint of the failover group instance.
     */
    readOnlyEndpoint?: pulumi.Input<types.inputs.sql.v20230201preview.InstanceFailoverGroupReadOnlyEndpointArgs>;
    /**
     * Read-write endpoint of the failover group instance.
     */
    readWriteEndpoint: pulumi.Input<types.inputs.sql.v20230201preview.InstanceFailoverGroupReadWriteEndpointArgs>;
    /**
     ...
     * Type of the geo-secondary instance. Set 'Standby' if the instance is used as a DR option only.
     */
    secondaryType?: pulumi.Input<string | types.enums.v20230201preview.SecondaryInstanceType>;
}

...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20230201preview:PrivateEndpointConnection';
     ...
     */
    public readonly privateEndpoint!: pulumi.Output<types.outputs.sql.v20230201preview.PrivateEndpointPropertyResponse | undefined>;
    /**
     * Connection state of the private endpoint connection.
     */
    public readonly privateLinkServiceConnectionState!: pulumi.Output<types.outputs.sql.v20230201preview.PrivateLinkServiceConnectionStatePropertyResponse | undefined>;
    /**
...
export interface PrivateEndpointConnectionArgs {
     ...
     * Private endpoint which the connection belongs to.
     */
    privateEndpoint?: pulumi.Input<types.inputs.sql.v20230201preview.PrivateEndpointPropertyArgs>;
    privateEndpointConnectionName?: pulumi.Input<string>;
    /**
     * Connection state of the private endpoint connection.
     */
    privateLinkServiceConnectionState?: pulumi.Input<types.inputs.sql.v20230201preview.PrivateLinkServiceConnectionStatePropertyArgs>;
    /**

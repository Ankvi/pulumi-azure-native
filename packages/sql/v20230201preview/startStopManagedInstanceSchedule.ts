...
export class StartStopManagedInstanceSchedule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20230201preview:StartStopManagedInstanceSchedule';
     ...
     * Schedule list.
     */
    public readonly scheduleList!: pulumi.Output<types.outputs.sql.v20230201preview.ScheduleItemResponse[]>;
    /**
    ...
    constructor(name: string, args: StartStopManagedInstanceScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:sql:StartStopManagedInstanceSchedule" }, { type: "azure-native:sql/v20220801preview:StartStopManagedInstanceSchedule" }, { type: "azure-native:sql/v20221101preview:StartStopManagedInstanceSchedule" }] };
...
export interface StartStopManagedInstanceScheduleArgs {
     ...
     * Schedule list.
     */
    scheduleList: pulumi.Input<pulumi.Input<types.inputs.sql.v20230201preview.ScheduleItemArgs>[]>;
    /**

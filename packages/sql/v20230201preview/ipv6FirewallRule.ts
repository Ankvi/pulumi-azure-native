...
export class IPv6FirewallRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20230201preview:IPv6FirewallRule';
    ...
    constructor(name: string, args: IPv6FirewallRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:sql:IPv6FirewallRule" }, { type: "azure-native:sql/v20210801preview:IPv6FirewallRule" }, { type: "azure-native:sql/v20211101:IPv6FirewallRule" }, { type: "azure-native:sql/v20211101preview:IPv6FirewallRule" }, { type: "azure-native:sql/v20220201preview:IPv6FirewallRule" }, { type: "azure-native:sql/v20220501preview:IPv6FirewallRule" }, { type: "azure-native:sql/v20220801preview:IPv6FirewallRule" }, { type: "azure-native:sql/v20221101preview:IPv6FirewallRule" }, { type: "azure-native:sql/v20230501preview:IPv6FirewallRule" }, { type: "azure-native:sql/v20230801preview:IPv6FirewallRule" }] };

...
export class DatabaseAdvisor extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly recommendedActions!: pulumi.Output<types.outputs.sql.v20230201preview.RecommendedActionResponse[]>;
    /**
     * Resource type.
     */
...
export interface DatabaseAdvisorArgs {
     ...
     * Gets the auto-execute status (whether to let the system execute the recommendations) of this advisor. Possible values are 'Enabled' and 'Disabled'
     */
    autoExecuteStatus: pulumi.Input<types.enums.v20230201preview.AutoExecuteStatus>;
    /**

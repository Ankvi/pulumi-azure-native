...
export class JobStep extends pulumi.CustomResource {
     ...
     */
    public readonly action!: pulumi.Output<types.outputs.sql.v20230201preview.JobStepActionResponse>;
    /**
     ...
     */
    public readonly executionOptions!: pulumi.Output<types.outputs.sql.v20230201preview.JobStepExecutionOptionsResponse | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    public readonly output!: pulumi.Output<types.outputs.sql.v20230201preview.JobStepOutputResponse | undefined>;
    /**
    ...
    constructor(name: string, args: JobStepArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["action"] = args ? (args.action ? pulumi.output(args.action).apply(types.inputs.sql.v20230201preview.jobStepActionArgsProvideDefaults) : undefined) : undefined;
            resourceInputs["credential"] = args ? args.credential : undefined;
            resourceInputs["executionOptions"] = args ? (args.executionOptions ? pulumi.output(args.executionOptions).apply(types.inputs.sql.v20230201preview.jobStepExecutionOptionsArgsProvideDefaults) : undefined) : undefined;
            resourceInputs["jobAgentName"] = args ? args.jobAgentName : undefined;
            resourceInputs["jobName"] = args ? args.jobName : undefined;
            resourceInputs["output"] = args ? (args.output ? pulumi.output(args.output).apply(types.inputs.sql.v20230201preview.jobStepOutputArgsProvideDefaults) : undefined) : undefined;
...
export interface JobStepArgs {
     ...
     * The action payload of the job step.
     */
    action: pulumi.Input<types.inputs.sql.v20230201preview.JobStepActionArgs>;
    /**
     * The resource ID of the job credential that will be used to connect to the targets.
     */
     ...
     * Execution options for the job step.
     */
    executionOptions?: pulumi.Input<types.inputs.sql.v20230201preview.JobStepExecutionOptionsArgs>;
    /**
     ...
     * Output destination properties of the job step.
     */
    output?: pulumi.Input<types.inputs.sql.v20230201preview.JobStepOutputArgs>;
    /**

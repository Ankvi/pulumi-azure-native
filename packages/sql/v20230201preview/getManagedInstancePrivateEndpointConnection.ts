...
export function getManagedInstancePrivateEndpointConnection(args: GetManagedInstancePrivateEndpointConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedInstancePrivateEndpointConnectionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:sql/v20230201preview:getManagedInstancePrivateEndpointConnection", {
...
export interface GetManagedInstancePrivateEndpointConnectionResult {
     ...
     */
    readonly privateEndpoint?: types.outputs.sql.v20230201preview.ManagedInstancePrivateEndpointPropertyResponse;
    /**
     * Connection State of the Private Endpoint Connection.
     */
    readonly privateLinkServiceConnectionState?: types.outputs.sql.v20230201preview.ManagedInstancePrivateLinkServiceConnectionStatePropertyResponse;
    /**

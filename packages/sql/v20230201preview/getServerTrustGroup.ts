...
export function getServerTrustGroup(args: GetServerTrustGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetServerTrustGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-native:sql/v20230201preview:getServerTrustGroup", {
...
export interface GetServerTrustGroupResult {
     ...
     */
    readonly groupMembers: types.outputs.sql.v20230201preview.ServerInfoResponse[];
    /**
     * Resource ID.
     */
    readonly id: string;

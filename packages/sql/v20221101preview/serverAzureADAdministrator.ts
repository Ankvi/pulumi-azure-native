...
export class ServerAzureADAdministrator extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20221101preview:ServerAzureADAdministrator';
...
export interface ServerAzureADAdministratorArgs {
     ...
     * Type of the sever administrator.
     */
    administratorType: pulumi.Input<string | types.enums.v20221101preview.AdministratorType>;
    /**
     * Login name of the server administrator.
     */

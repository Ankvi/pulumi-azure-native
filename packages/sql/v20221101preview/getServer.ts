...
export function getServer(args: GetServerArgs, opts?: pulumi.InvokeOptions): Promise<GetServerResult> {
    ...
    return pulumi.runtime.invoke("azure-native:sql/v20221101preview:getServer", {
        "expand": args.expand,
...
export interface GetServerResult {
     ...
     */
    readonly administrators?: types.outputs.sql.v20221101preview.ServerExternalAdministratorResponse;
    /**
     ...
     */
    readonly privateEndpointConnections: types.outputs.sql.v20221101preview.ServerPrivateEndpointConnectionResponse[];
    /**

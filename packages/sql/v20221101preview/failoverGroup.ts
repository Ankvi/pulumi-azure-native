...
export class FailoverGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20221101preview:FailoverGroup';
     ...
     */
    public readonly partnerServers!: pulumi.Output<types.outputs.sql.v20221101preview.PartnerInfoResponse[]>;
    /**
     * Read-only endpoint of the failover group instance.
     */
    public readonly readOnlyEndpoint!: pulumi.Output<types.outputs.sql.v20221101preview.FailoverGroupReadOnlyEndpointResponse | undefined>;
    /**
     * Read-write endpoint of the failover group instance.
     */
    public readonly readWriteEndpoint!: pulumi.Output<types.outputs.sql.v20221101preview.FailoverGroupReadWriteEndpointResponse>;
    /**
...
export interface FailoverGroupArgs {
     ...
     * List of partner server information for the failover group.
     */
    partnerServers: pulumi.Input<pulumi.Input<types.inputs.sql.v20221101preview.PartnerInfoArgs>[]>;
    /**
     * Read-only endpoint of the failover group instance.
     */
    readOnlyEndpoint?: pulumi.Input<types.inputs.sql.v20221101preview.FailoverGroupReadOnlyEndpointArgs>;
    /**
     * Read-write endpoint of the failover group instance.
     */
    readWriteEndpoint: pulumi.Input<types.inputs.sql.v20221101preview.FailoverGroupReadWriteEndpointArgs>;
    /**

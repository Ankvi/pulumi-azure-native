...
export function getDatabaseAdvisor(args: GetDatabaseAdvisorArgs, opts?: pulumi.InvokeOptions): Promise<GetDatabaseAdvisorResult> {
    ...
    return pulumi.runtime.invoke("azure-native:sql/v20221101preview:getDatabaseAdvisor", {
...
export interface GetDatabaseAdvisorResult {
     ...
     */
    readonly recommendedActions: types.outputs.sql.v20221101preview.RecommendedActionResponse[];
    /**
     * Resource type.
     */

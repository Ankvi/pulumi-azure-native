...
export function getManagedInstancePrivateEndpointConnection(args: GetManagedInstancePrivateEndpointConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedInstancePrivateEndpointConnectionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:sql/v20221101preview:getManagedInstancePrivateEndpointConnection", {
...
export interface GetManagedInstancePrivateEndpointConnectionResult {
     ...
     */
    readonly privateEndpoint?: types.outputs.sql.v20221101preview.ManagedInstancePrivateEndpointPropertyResponse;
    /**
     * Connection State of the Private Endpoint Connection.
     */
    readonly privateLinkServiceConnectionState?: types.outputs.sql.v20221101preview.ManagedInstancePrivateLinkServiceConnectionStatePropertyResponse;
    /**

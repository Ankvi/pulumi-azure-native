...
export class ElasticPool extends pulumi.CustomResource {
     ...
     */
    public readonly perDatabaseSettings!: pulumi.Output<types.outputs.sql.v20221101preview.ElasticPoolPerDatabaseSettingsResponse | undefined>;
    /**
...
export interface ElasticPoolArgs {
     ...
     * The license type to apply for this elastic pool.
     */
    licenseType?: pulumi.Input<string | types.enums.v20221101preview.ElasticPoolLicenseType>;
    /**
     * Resource location.
     */
     ...
     * The per database settings for the elastic pool.
     */
    perDatabaseSettings?: pulumi.Input<types.inputs.sql.v20221101preview.ElasticPoolPerDatabaseSettingsArgs>;
    /**
     * Type of enclave requested on the elastic pool.
     */

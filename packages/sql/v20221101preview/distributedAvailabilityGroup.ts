...
export class DistributedAvailabilityGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20221101preview:DistributedAvailabilityGroup';
...
export interface DistributedAvailabilityGroupArgs {
     ...
     * The replication mode of a distributed availability group. Parameter will be ignored during link creation.
     */
    replicationMode?: pulumi.Input<string | types.enums.v20221101preview.ReplicationMode>;
    /**

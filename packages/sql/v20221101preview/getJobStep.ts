...
export function getJobStep(args: GetJobStepArgs, opts?: pulumi.InvokeOptions): Promise<GetJobStepResult> {
    ...
    return pulumi.runtime.invoke("azure-native:sql/v20221101preview:getJobStep", {
...
export interface GetJobStepResult {
     ...
     */
    readonly action: types.outputs.sql.v20221101preview.JobStepActionResponse;
    /**
     ...
     */
    readonly executionOptions?: types.outputs.sql.v20221101preview.JobStepExecutionOptionsResponse;
    /**
     * Resource ID.
     */
    readonly id: string;
     ...
     */
    readonly output?: types.outputs.sql.v20221101preview.JobStepOutputResponse;
    /**

...
export class StartStopManagedInstanceSchedule extends pulumi.CustomResource {
    ...
    constructor(name: string, args: StartStopManagedInstanceScheduleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:sql:StartStopManagedInstanceSchedule" }, { type: "azure-native:sql/v20220801preview:StartStopManagedInstanceSchedule" }, { type: "azure-native:sql/v20230201preview:StartStopManagedInstanceSchedule" }, { type: "azure-native:sql/v20230501preview:StartStopManagedInstanceSchedule" }] };

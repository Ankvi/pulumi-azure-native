...
export interface GetFailoverGroupResult {
     ...
     */
    readonly partnerServers: types.outputs.sql.v20221101preview.PartnerInfoResponse[];
    /**
     * Read-only endpoint of the failover group instance.
     */
    readonly readOnlyEndpoint?: types.outputs.sql.v20221101preview.FailoverGroupReadOnlyEndpointResponse;
    /**
     * Read-write endpoint of the failover group instance.
     */
    readonly readWriteEndpoint: types.outputs.sql.v20221101preview.FailoverGroupReadWriteEndpointResponse;
    /**

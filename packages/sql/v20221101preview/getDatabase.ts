...
export function getDatabase(args: GetDatabaseArgs, opts?: pulumi.InvokeOptions): Promise<GetDatabaseResult> {
    ...
    return pulumi.runtime.invoke("azure-native:sql/v20221101preview:getDatabase", {
...
export interface GetDatabaseResult {
     ...
     */
    readonly currentSku: types.outputs.sql.v20221101preview.SkuResponse;
    /**
     ...
     */
    readonly identity?: types.outputs.sql.v20221101preview.DatabaseIdentityResponse;
    /**
     ...
     */
    readonly keys?: {[key: string]: types.outputs.sql.v20221101preview.DatabaseKeyResponse};
    /**

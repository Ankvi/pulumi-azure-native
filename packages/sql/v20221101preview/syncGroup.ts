...
export class SyncGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20221101preview:SyncGroup';
     ...
     */
    public readonly schema!: pulumi.Output<types.outputs.sql.v20221101preview.SyncGroupSchemaResponse | undefined>;
    /**
...
export interface SyncGroupArgs {
     ...
     * Conflict resolution policy of the sync group.
     */
    conflictResolutionPolicy?: pulumi.Input<string | types.enums.v20221101preview.SyncConflictResolutionPolicy>;
    /**
     ...
     * Sync schema of the sync group.
     */
    schema?: pulumi.Input<types.inputs.sql.v20221101preview.SyncGroupSchemaArgs>;
    /**

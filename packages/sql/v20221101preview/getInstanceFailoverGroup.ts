...
export function getInstanceFailoverGroup(args: GetInstanceFailoverGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetInstanceFailoverGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-native:sql/v20221101preview:getInstanceFailoverGroup", {
...
export interface GetInstanceFailoverGroupResult {
     ...
     */
    readonly managedInstancePairs: types.outputs.sql.v20221101preview.ManagedInstancePairInfoResponse[];
    /**
     * Resource name.
     */
     ...
     */
    readonly partnerRegions: types.outputs.sql.v20221101preview.PartnerRegionInfoResponse[];
    /**
     * Read-only endpoint of the failover group instance.
     */
    readonly readOnlyEndpoint?: types.outputs.sql.v20221101preview.InstanceFailoverGroupReadOnlyEndpointResponse;
    /**
     * Read-write endpoint of the failover group instance.
     */
    readonly readWriteEndpoint: types.outputs.sql.v20221101preview.InstanceFailoverGroupReadWriteEndpointResponse;
    /**

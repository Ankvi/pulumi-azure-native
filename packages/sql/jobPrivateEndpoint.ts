...
export class JobPrivateEndpoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql:JobPrivateEndpoint';
     ...
     */
    declare public readonly targetServerAzureResourceId: pulumi.Output<string>;
    /**
     * Resource type.
     */

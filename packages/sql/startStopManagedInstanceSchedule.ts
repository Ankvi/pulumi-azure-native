...
export class StartStopManagedInstanceSchedule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql:StartStopManagedInstanceSchedule';
     ...
     * Schedule list.
     */
    declare public readonly scheduleList: pulumi.Output<types.outputs.ScheduleItemResponse[]>;
    /**

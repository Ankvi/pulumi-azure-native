...
export class JobPrivateEndpoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20230801preview:JobPrivateEndpoint';
    ...
    constructor(name: string, args: JobPrivateEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:sql:JobPrivateEndpoint" }, { type: "azure-native:sql/v20230501preview:JobPrivateEndpoint" }] };

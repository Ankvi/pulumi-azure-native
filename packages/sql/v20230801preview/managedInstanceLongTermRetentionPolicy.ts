...
export class ManagedInstanceLongTermRetentionPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20230801preview:ManagedInstanceLongTermRetentionPolicy';
    ...
    constructor(name: string, args: ManagedInstanceLongTermRetentionPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:sql:ManagedInstanceLongTermRetentionPolicy" }, { type: "azure-native:sql/v20220501preview:ManagedInstanceLongTermRetentionPolicy" }, { type: "azure-native:sql/v20220801preview:ManagedInstanceLongTermRetentionPolicy" }, { type: "azure-native:sql/v20221101preview:ManagedInstanceLongTermRetentionPolicy" }, { type: "azure-native:sql/v20230201preview:ManagedInstanceLongTermRetentionPolicy" }, { type: "azure-native:sql/v20230501preview:ManagedInstanceLongTermRetentionPolicy" }] };

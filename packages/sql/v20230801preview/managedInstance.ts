...
export class ManagedInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20230801preview:ManagedInstance';
     ...
     */
    public readonly totalMemoryMB!: pulumi.Output<number | undefined>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: ManagedInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["totalMemoryMB"] = args ? args.totalMemoryMB : undefined;
            ...
            resourceInputs["totalMemoryMB"] = undefined /*out*/;
            resourceInputs["type"] = undefined /*out*/;
...
export interface ManagedInstanceArgs {
     ...
     * Total memory in MB. Minimum value: 7168. Maximum value: 891328. Increments of 1 MB allowed only. Maximum value depends on the selected hardware family and number of vCores.
     */
    totalMemoryMB?: pulumi.Input<number>;
    /**
     * The number of vCores. Allowed values: 8, 16, 24, 32, 40, 64, 80.
     */

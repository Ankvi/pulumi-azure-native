...
export interface GetInstanceFailoverGroupResult {
     ...
     */
    readonly managedInstancePairs: types.outputs.sql.v20211101.ManagedInstancePairInfoResponse[];
    /**
     * Resource name.
     */
     ...
     */
    readonly partnerRegions: types.outputs.sql.v20211101.PartnerRegionInfoResponse[];
    /**
     * Read-only endpoint of the failover group instance.
     */
    readonly readOnlyEndpoint?: types.outputs.sql.v20211101.InstanceFailoverGroupReadOnlyEndpointResponse;
    /**
     * Read-write endpoint of the failover group instance.
     */
    readonly readWriteEndpoint: types.outputs.sql.v20211101.InstanceFailoverGroupReadWriteEndpointResponse;
    /**

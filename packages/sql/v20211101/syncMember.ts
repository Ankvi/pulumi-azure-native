...
export interface SyncMemberArgs {
     ...
     * Database type of the sync member.
     */
    databaseType?: pulumi.Input<string | types.enums.v20211101.SyncMemberDbType>;
    /**
     ...
     * Sync direction of the sync member.
     */
    syncDirection?: pulumi.Input<string | types.enums.v20211101.SyncDirection>;
    /**

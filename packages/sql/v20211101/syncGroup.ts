...
export class SyncGroup extends pulumi.CustomResource {
     ...
     */
    public readonly schema!: pulumi.Output<types.outputs.sql.v20211101.SyncGroupSchemaResponse | undefined>;
    /**
...
export interface SyncGroupArgs {
     ...
     * Conflict resolution policy of the sync group.
     */
    conflictResolutionPolicy?: pulumi.Input<string | types.enums.v20211101.SyncConflictResolutionPolicy>;
    /**
     ...
     * Sync schema of the sync group.
     */
    schema?: pulumi.Input<types.inputs.sql.v20211101.SyncGroupSchemaArgs>;
    /**

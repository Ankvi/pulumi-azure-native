...
export class DatabaseSecurityAlertPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20211101:DatabaseSecurityAlertPolicy';
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<types.outputs.sql.v20211101.SystemDataResponse>;
    /**
     * Resource type.
     */
    ...
    constructor(name: string, args: DatabaseSecurityAlertPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:sql:DatabaseSecurityAlertPolicy" }, { type: "azure-native:sql/v20140401:DatabaseSecurityAlertPolicy" }, { type: "azure-native:sql/v20180601preview:DatabaseSecurityAlertPolicy" }, { type: "azure-native:sql/v20200202preview:DatabaseSecurityAlertPolicy" }, { type: "azure-native:sql/v20200801preview:DatabaseSecurityAlertPolicy" }, { type: "azure-native:sql/v20201101preview:DatabaseSecurityAlertPolicy" }, { type: "azure-native:sql/v20210201preview:DatabaseSecurityAlertPolicy" }, { type: "azure-native:sql/v20210501preview:DatabaseSecurityAlertPolicy" }, { type: "azure-native:sql/v20210801preview:DatabaseSecurityAlertPolicy" }, { type: "azure-native:sql/v20211101preview:DatabaseSecurityAlertPolicy" }, { type: "azure-native:sql/v20220201preview:DatabaseSecurityAlertPolicy" }, { type: "azure-native:sql/v20220501preview:DatabaseSecurityAlertPolicy" }, { type: "azure-native:sql/v20220801preview:DatabaseSecurityAlertPolicy" }, { type: "azure-native:sql/v20221101preview:DatabaseSecurityAlertPolicy" }, { type: "azure-native:sql/v20230201preview:DatabaseSecurityAlertPolicy" }] };
...
export interface DatabaseSecurityAlertPolicyArgs {
     ...
     * Specifies the state of the policy, whether it is enabled or disabled or a policy has not been applied yet on the specific database.
     */
    state: pulumi.Input<types.enums.v20211101.SecurityAlertsPolicyState>;
    /**
     * Specifies the identifier key of the Threat Detection audit storage account.
     */

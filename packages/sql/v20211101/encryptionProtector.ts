...
export class EncryptionProtector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20211101:EncryptionProtector';
...
export interface EncryptionProtectorArgs {
     ...
     * The encryption protector type like 'ServiceManaged', 'AzureKeyVault'.
     */
    serverKeyType: pulumi.Input<string | types.enums.v20211101.ServerKeyType>;
    /**

...
export class ManagedInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20211101:ManagedInstance';
     ...
     */
    public readonly administrators!: pulumi.Output<types.outputs.sql.v20211101.ManagedInstanceExternalAdministratorResponse | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<types.outputs.sql.v20211101.ResourceIdentityResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<types.outputs.sql.v20211101.ManagedInstancePecPropertyResponse[]>;
     ...
     */
    public readonly servicePrincipal!: pulumi.Output<types.outputs.sql.v20211101.ServicePrincipalResponse | undefined>;
    /**
...
export interface ManagedInstanceArgs {
     ...
     * The Azure Active Directory administrator of the server.
     */
    administrators?: pulumi.Input<types.inputs.sql.v20211101.ManagedInstanceExternalAdministratorArgs>;
    /**
     * Collation of the managed instance.
     */
     ...
     * The Azure Active Directory identity of the managed instance.
     */
    identity?: pulumi.Input<types.inputs.sql.v20211101.ResourceIdentityArgs>;
    /**
     * The Id of the instance pool this managed server belongs to.
     */
     ...
     * The license type. Possible values are 'LicenseIncluded' (regular price inclusive of a new SQL license) and 'BasePrice' (discounted AHB price for bringing your own SQL licenses).
     */
    licenseType?: pulumi.Input<string | types.enums.v20211101.ManagedInstanceLicenseType>;
    /**
     * Resource location.
     */
     ...
     */
    managedInstanceCreateMode?: pulumi.Input<string | types.enums.v20211101.ManagedServerCreateMode>;
    /**
     ...
     * Connection type used for connecting to the instance.
     */
    proxyOverride?: pulumi.Input<string | types.enums.v20211101.ManagedInstanceProxyOverride>;
    /**
     * Whether or not the public data endpoint is enabled.
     */
     ...
     * The storage account type to be used to store backups for this instance. The options are Local (LocallyRedundantStorage), Zone (ZoneRedundantStorage), Geo (GeoRedundantStorage) and GeoZone(GeoZoneRedundantStorage)
     */
    requestedBackupStorageRedundancy?: pulumi.Input<string | types.enums.v20211101.BackupStorageRedundancy>;
    /**
     ...
     * The managed instance's service principal.
     */
    servicePrincipal?: pulumi.Input<types.inputs.sql.v20211101.ServicePrincipalArgs>;
    /**
     * Managed instance SKU. Allowed values for sku.name: GP_Gen5, GP_G8IM, GP_G8IH, BC_Gen5, BC_G8IM, BC_G8IH
     */

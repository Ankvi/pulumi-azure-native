...
export function getJobStep(args: GetJobStepArgs, opts?: pulumi.InvokeOptions): Promise<GetJobStepResult> {
    ...
    return pulumi.runtime.invoke("azure-native:sql/v20211101:getJobStep", {
...
export interface GetJobStepResult {
     ...
     */
    readonly action: types.outputs.sql.v20211101.JobStepActionResponse;
    /**
     ...
     */
    readonly executionOptions?: types.outputs.sql.v20211101.JobStepExecutionOptionsResponse;
    /**
     * Resource ID.
     */
    readonly id: string;
     ...
     */
    readonly output?: types.outputs.sql.v20211101.JobStepOutputResponse;
    /**

...
export class InstanceFailoverGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20211101:InstanceFailoverGroup';
     ...
     */
    public readonly managedInstancePairs!: pulumi.Output<types.outputs.sql.v20211101.ManagedInstancePairInfoResponse[]>;
    /**
     * Resource name.
     */
     ...
     */
    public readonly partnerRegions!: pulumi.Output<types.outputs.sql.v20211101.PartnerRegionInfoResponse[]>;
    /**
     * Read-only endpoint of the failover group instance.
     */
    public readonly readOnlyEndpoint!: pulumi.Output<types.outputs.sql.v20211101.InstanceFailoverGroupReadOnlyEndpointResponse | undefined>;
    /**
     * Read-write endpoint of the failover group instance.
     */
    public readonly readWriteEndpoint!: pulumi.Output<types.outputs.sql.v20211101.InstanceFailoverGroupReadWriteEndpointResponse>;
    /**
...
export interface InstanceFailoverGroupArgs {
     ...
     * List of managed instance pairs in the failover group.
     */
    managedInstancePairs: pulumi.Input<pulumi.Input<types.inputs.sql.v20211101.ManagedInstancePairInfoArgs>[]>;
    /**
     * Partner region information for the failover group.
     */
    partnerRegions: pulumi.Input<pulumi.Input<types.inputs.sql.v20211101.PartnerRegionInfoArgs>[]>;
    /**
     * Read-only endpoint of the failover group instance.
     */
    readOnlyEndpoint?: pulumi.Input<types.inputs.sql.v20211101.InstanceFailoverGroupReadOnlyEndpointArgs>;
    /**
     * Read-write endpoint of the failover group instance.
     */
    readWriteEndpoint: pulumi.Input<types.inputs.sql.v20211101.InstanceFailoverGroupReadWriteEndpointArgs>;
    /**

...
export function getManagedInstancePrivateEndpointConnection(args: GetManagedInstancePrivateEndpointConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedInstancePrivateEndpointConnectionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:sql/v20211101:getManagedInstancePrivateEndpointConnection", {
...
export interface GetManagedInstancePrivateEndpointConnectionResult {
     ...
     */
    readonly privateEndpoint?: types.outputs.sql.v20211101.ManagedInstancePrivateEndpointPropertyResponse;
    /**
     * Connection State of the Private Endpoint Connection.
     */
    readonly privateLinkServiceConnectionState?: types.outputs.sql.v20211101.ManagedInstancePrivateLinkServiceConnectionStatePropertyResponse;
    /**

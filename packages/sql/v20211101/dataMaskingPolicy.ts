...
export class DataMaskingPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20211101:DataMaskingPolicy';
    ...
    constructor(name: string, args: DataMaskingPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:sql:DataMaskingPolicy" }, { type: "azure-native:sql/v20140401:DataMaskingPolicy" }, { type: "azure-native:sql/v20220201preview:DataMaskingPolicy" }, { type: "azure-native:sql/v20220501preview:DataMaskingPolicy" }, { type: "azure-native:sql/v20220801preview:DataMaskingPolicy" }, { type: "azure-native:sql/v20221101preview:DataMaskingPolicy" }, { type: "azure-native:sql/v20230201preview:DataMaskingPolicy" }] };
...
export interface DataMaskingPolicyArgs {
     ...
     * The state of the data masking policy.
     */
    dataMaskingState: pulumi.Input<types.enums.v20211101.DataMaskingState>;
    /**

...
export class JobStep extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20211101:JobStep';
     ...
     */
    public readonly action!: pulumi.Output<types.outputs.sql.v20211101.JobStepActionResponse>;
    /**
     ...
     */
    public readonly executionOptions!: pulumi.Output<types.outputs.sql.v20211101.JobStepExecutionOptionsResponse | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    public readonly output!: pulumi.Output<types.outputs.sql.v20211101.JobStepOutputResponse | undefined>;
    /**
    ...
    constructor(name: string, args: JobStepArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["action"] = args ? (args.action ? pulumi.output(args.action).apply(types.inputs.sql.v20211101.jobStepActionArgsProvideDefaults) : undefined) : undefined;
            resourceInputs["credential"] = args ? args.credential : undefined;
            resourceInputs["executionOptions"] = args ? (args.executionOptions ? pulumi.output(args.executionOptions).apply(types.inputs.sql.v20211101.jobStepExecutionOptionsArgsProvideDefaults) : undefined) : undefined;
            resourceInputs["jobAgentName"] = args ? args.jobAgentName : undefined;
            resourceInputs["jobName"] = args ? args.jobName : undefined;
            resourceInputs["output"] = args ? (args.output ? pulumi.output(args.output).apply(types.inputs.sql.v20211101.jobStepOutputArgsProvideDefaults) : undefined) : undefined;
...
export interface JobStepArgs {
     ...
     * The action payload of the job step.
     */
    action: pulumi.Input<types.inputs.sql.v20211101.JobStepActionArgs>;
    /**
     * The resource ID of the job credential that will be used to connect to the targets.
     */
     ...
     * Execution options for the job step.
     */
    executionOptions?: pulumi.Input<types.inputs.sql.v20211101.JobStepExecutionOptionsArgs>;
    /**
     ...
     * Output destination properties of the job step.
     */
    output?: pulumi.Input<types.inputs.sql.v20211101.JobStepOutputArgs>;
    /**

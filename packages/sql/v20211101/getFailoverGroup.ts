...
export function getFailoverGroup(args: GetFailoverGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetFailoverGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-native:sql/v20211101:getFailoverGroup", {
...
export interface GetFailoverGroupResult {
     ...
     */
    readonly partnerServers: types.outputs.sql.v20211101.PartnerInfoResponse[];
    /**
     * Read-only endpoint of the failover group instance.
     */
    readonly readOnlyEndpoint?: types.outputs.sql.v20211101.FailoverGroupReadOnlyEndpointResponse;
    /**
     * Read-write endpoint of the failover group instance.
     */
    readonly readWriteEndpoint: types.outputs.sql.v20211101.FailoverGroupReadWriteEndpointResponse;
    /**

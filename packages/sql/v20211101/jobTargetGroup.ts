...
export class JobTargetGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20211101:JobTargetGroup';
     ...
     */
    public readonly members!: pulumi.Output<types.outputs.sql.v20211101.JobTargetResponse[]>;
    /**
     * Resource name.
     */
...
export interface JobTargetGroupArgs {
     ...
     * Members of the target group.
     */
    members: pulumi.Input<pulumi.Input<types.inputs.sql.v20211101.JobTargetArgs>[]>;
    /**

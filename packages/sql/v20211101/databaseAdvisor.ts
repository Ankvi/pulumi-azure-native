...
export class DatabaseAdvisor extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20211101:DatabaseAdvisor';
     ...
     */
    public /*out*/ readonly recommendedActions!: pulumi.Output<types.outputs.sql.v20211101.RecommendedActionResponse[]>;
    /**
     * Resource type.
     */
...
export interface DatabaseAdvisorArgs {
     ...
     * Gets the auto-execute status (whether to let the system execute the recommendations) of this advisor. Possible values are 'Enabled' and 'Disabled'
     */
    autoExecuteStatus: pulumi.Input<types.enums.v20211101.AutoExecuteStatus>;
    /**

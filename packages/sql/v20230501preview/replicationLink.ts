...
export class ReplicationLink extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:sql/v20230501preview:ReplicationLink';
    ...
    constructor(name: string, args: ReplicationLinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:sql:ReplicationLink" }, { type: "azure-native:sql/v20230801preview:ReplicationLink" }] };

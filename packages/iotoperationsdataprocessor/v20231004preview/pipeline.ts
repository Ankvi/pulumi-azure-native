...
export class Pipeline extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:iotoperationsdataprocessor/v20231004preview:Pipeline';
    ...
    constructor(name: string, args: PipelineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:iotoperationsdataprocessor:Pipeline" }] };

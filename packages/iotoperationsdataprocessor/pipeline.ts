...
export class Pipeline extends pulumi.CustomResource {
     ...
     */
    declare public readonly input: pulumi.Output<types.outputs.PipelineInputResponse>;
    /**
     ...
     */
    declare public readonly stages: pulumi.Output<{[key: string]: types.outputs.PipelineStageResponse}>;
    /**

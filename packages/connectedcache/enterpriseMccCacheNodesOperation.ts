...
export class EnterpriseMccCacheNodesOperation extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EnterpriseMccCacheNodesOperation {
        return new EnterpriseMccCacheNodesOperation(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:connectedcache:EnterpriseMccCacheNodesOperation';

    /**
     * Returns true if the given object is an instance of EnterpriseMccCacheNodesOperation.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is EnterpriseMccCacheNodesOperation {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === EnterpriseMccCacheNodesOperation.__pulumiType;
    }
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.CacheNodePropertyResponse>;
    /**
     ...
     */
    constructor(name: string, args: EnterpriseMccCacheNodesOperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["cacheNodeResourceName"] = args?.cacheNodeResourceName;
 ...
 */
export interface EnterpriseMccCacheNodesOperationArgs {
    /**

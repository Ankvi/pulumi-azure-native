...
export function getImportPipeline(args: GetImportPipelineArgs, opts?: pulumi.InvokeOptions): Promise<GetImportPipelineResult> {
    ...
    return pulumi.runtime.invoke("azure-native:containerregistry/v20230601preview:getImportPipeline", {
...
export interface GetImportPipelineResult {
     ...
     */
    readonly source: types.outputs.containerregistry.v20230601preview.ImportPipelineSourcePropertiesResponse;
    /**
     ...
     */
    readonly trigger?: types.outputs.containerregistry.v20230601preview.PipelineTriggerPropertiesResponse;
    /**

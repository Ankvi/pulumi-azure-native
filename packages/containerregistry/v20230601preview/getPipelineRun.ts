...
export interface GetPipelineRunResult {
     ...
     */
    readonly request?: types.outputs.containerregistry.v20230601preview.PipelineRunRequestResponse;
    /**
     * The response of a pipeline run.
     */
    readonly response: types.outputs.containerregistry.v20230601preview.PipelineRunResponseResponse;
    /**

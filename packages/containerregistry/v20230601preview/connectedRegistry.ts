...
export class ConnectedRegistry extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerregistry/v20230601preview:ConnectedRegistry';
     ...
     */
    public /*out*/ readonly activation!: pulumi.Output<types.outputs.containerregistry.v20230601preview.ActivationPropertiesResponse>;
    /**
     ...
     */
    public readonly logging!: pulumi.Output<types.outputs.containerregistry.v20230601preview.LoggingPropertiesResponse | undefined>;
    /**
     * The login server properties of the connected registry.
     */
    public /*out*/ readonly loginServer!: pulumi.Output<types.outputs.containerregistry.v20230601preview.LoginServerPropertiesResponse | undefined>;
    /**
     ...
     */
    public readonly parent!: pulumi.Output<types.outputs.containerregistry.v20230601preview.ParentPropertiesResponse>;
    /**
     ...
     */
    public /*out*/ readonly statusDetails!: pulumi.Output<types.outputs.containerregistry.v20230601preview.StatusDetailPropertiesResponse[]>;
    /**
    ...
    constructor(name: string, args: ConnectedRegistryArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["logging"] = args ? (args.logging ? pulumi.output(args.logging).apply(types.inputs.containerregistry.v20230601preview.loggingPropertiesArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:containerregistry:ConnectedRegistry" }, { type: "azure-native:containerregistry/v20201101preview:ConnectedRegistry" }, { type: "azure-native:containerregistry/v20210601preview:ConnectedRegistry" }, { type: "azure-native:containerregistry/v20210801preview:ConnectedRegistry" }, { type: "azure-native:containerregistry/v20211201preview:ConnectedRegistry" }, { type: "azure-native:containerregistry/v20220201preview:ConnectedRegistry" }, { type: "azure-native:containerregistry/v20230101preview:ConnectedRegistry" }, { type: "azure-native:containerregistry/v20230801preview:ConnectedRegistry" }] };
...
export interface ConnectedRegistryArgs {
     ...
     * The logging properties of the connected registry.
     */
    logging?: pulumi.Input<types.inputs.containerregistry.v20230601preview.LoggingPropertiesArgs>;
    /**
     * The mode of the connected registry resource that indicates the permissions of the registry.
     */
    mode: pulumi.Input<string | types.enums.v20230601preview.ConnectedRegistryMode>;
    /**
     * The list of notifications subscription information for the connected registry.
     */
     ...
     * The parent of the connected registry.
     */
    parent: pulumi.Input<types.inputs.containerregistry.v20230601preview.ParentPropertiesArgs>;
    /**

...
export class ArchiveVersion extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerregistry/v20230601preview:ArchiveVersion';
    ...
    constructor(name: string, args: ArchiveVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:containerregistry:ArchiveVersion" }, { type: "azure-native:containerregistry/v20230801preview:ArchiveVersion" }, { type: "azure-native:containerregistry/v20231101preview:ArchiveVersion" }] };

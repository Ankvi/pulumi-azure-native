...
export class Task extends pulumi.CustomResource {
     ...
     */
    declare public readonly agentConfiguration: pulumi.Output<types.outputs.AgentPropertiesResponse | undefined>;
    /**
     ...
     */
    declare public readonly credentials: pulumi.Output<types.outputs.CredentialsResponse | undefined>;
    /**
     ...
     */
    declare public readonly platform: pulumi.Output<types.outputs.PlatformPropertiesResponse | undefined>;
    /**
     ...
     */
    declare public readonly step: pulumi.Output<types.outputs.DockerBuildStepResponse | types.outputs.EncodedTaskStepResponse | types.outputs.FileTaskStepResponse | undefined>;
    /**
     ...
     */
    declare public readonly trigger: pulumi.Output<types.outputs.TriggerPropertiesResponse | undefined>;
    /**

...
export class Token extends pulumi.CustomResource {
     ...
     */
    declare public readonly credentials: pulumi.Output<types.outputs.TokenCredentialsPropertiesResponse | undefined>;
    /**

...
// Export enums:
export * from "../types/enums/v20221201";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:containerregistry/v20221201:PrivateEndpointConnection":
                return new PrivateEndpointConnection(name, <any>undefined, { urn })
            case "azure-native:containerregistry/v20221201:Registry":
                return new Registry(name, <any>undefined, { urn })
            case "azure-native:containerregistry/v20221201:Replication":
                return new Replication(name, <any>undefined, { urn })
            case "azure-native:containerregistry/v20221201:ScopeMap":
                return new ScopeMap(name, <any>undefined, { urn })
            case "azure-native:containerregistry/v20221201:Token":
                return new Token(name, <any>undefined, { urn })
            case "azure-native:containerregistry/v20221201:Webhook":
...
pulumi.runtime.registerResourceModule("azure-native", "containerregistry/v20221201", _module)

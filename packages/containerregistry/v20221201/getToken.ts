...
export function getToken(args: GetTokenArgs, opts?: pulumi.InvokeOptions): Promise<GetTokenResult> {
    ...
    return pulumi.runtime.invoke("azure-native:containerregistry/v20221201:getToken", {
...
export interface GetTokenResult {
     ...
     */
    readonly credentials?: types.outputs.containerregistry.v20221201.TokenCredentialsPropertiesResponse;
    /**
     * The resource ID.
     */
    readonly id: string;

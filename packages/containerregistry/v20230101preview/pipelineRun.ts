...
export class PipelineRun extends pulumi.CustomResource {
     ...
     */
    public readonly request!: pulumi.Output<types.outputs.containerregistry.v20230101preview.PipelineRunRequestResponse | undefined>;
    /**
     * The response of a pipeline run.
     */
    public /*out*/ readonly response!: pulumi.Output<types.outputs.containerregistry.v20230101preview.PipelineRunResponseResponse>;
    /**
    ...
    constructor(name: string, args: PipelineRunArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["request"] = args ? (args.request ? pulumi.output(args.request).apply(types.inputs.containerregistry.v20230101preview.pipelineRunRequestArgsProvideDefaults) : undefined) : undefined;
...
export interface PipelineRunArgs {
     ...
     * The request parameters for a pipeline run.
     */
    request?: pulumi.Input<types.inputs.containerregistry.v20230101preview.PipelineRunRequestArgs>;
    /**

...
export class ExportPipeline extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerregistry/v20230101preview:ExportPipeline';
     ...
     */
    public readonly target!: pulumi.Output<types.outputs.containerregistry.v20230101preview.ExportPipelineTargetPropertiesResponse>;
    /**
...
export interface ExportPipelineArgs {
     ...
     * The target properties of the export pipeline.
     */
    target: pulumi.Input<types.inputs.containerregistry.v20230101preview.ExportPipelineTargetPropertiesArgs>;
}

...
export class CredentialSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerregistry/v20230101preview:CredentialSet';
     ...
     */
    public readonly authCredentials!: pulumi.Output<types.outputs.containerregistry.v20230101preview.AuthCredentialResponse[] | undefined>;
    /**
...
export interface CredentialSetArgs {
     ...
     * Usually consists of a primary and an optional secondary credential.
     */
    authCredentials?: pulumi.Input<pulumi.Input<types.inputs.containerregistry.v20230101preview.AuthCredentialArgs>[]>;
    /**

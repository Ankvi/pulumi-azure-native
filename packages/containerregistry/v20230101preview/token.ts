...
export class Token extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerregistry/v20230101preview:Token';
     ...
     */
    public readonly credentials!: pulumi.Output<types.outputs.containerregistry.v20230101preview.TokenCredentialsPropertiesResponse | undefined>;
    /**
...
export interface TokenArgs {
     ...
     * The credentials that can be used for authenticating the token.
     */
    credentials?: pulumi.Input<types.inputs.containerregistry.v20230101preview.TokenCredentialsPropertiesArgs>;
    /**
     ...
     * The status of the token example enabled or disabled.
     */
    status?: pulumi.Input<string | types.enums.v20230101preview.TokenStatus>;
    /**

...
export class CredentialSet extends pulumi.CustomResource {
     ...
     */
    public readonly authCredentials!: pulumi.Output<types.outputs.containerregistry.AuthCredentialResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: CredentialSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:containerregistry/v20230101preview:CredentialSet" }, { type: "azure-native:containerregistry/v20230601preview:CredentialSet" }, { type: "azure-native:containerregistry/v20230701:CredentialSet" }, { type: "azure-native:containerregistry/v20230801preview:CredentialSet" }] };
...
export interface CredentialSetArgs {
     ...
     * Usually consists of a primary and an optional secondary credential.
     */
    authCredentials?: pulumi.Input<pulumi.Input<types.inputs.containerregistry.AuthCredentialArgs>[]>;
    /**

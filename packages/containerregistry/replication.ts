...
export class Replication extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerregistry:Replication';
     ...
     */
    declare public readonly regionEndpointEnabled: pulumi.Output<boolean | undefined>;
    /**
     * The status of the replication at the time the operation was called.
     */
    declare public /*out*/ readonly status: pulumi.Output<types.outputs.StatusResponse>;
    /**
    ...
    constructor(name: string, args: ReplicationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["regionEndpointEnabled"] = (args?.regionEndpointEnabled) ?? true;
            resourceInputs["registryName"] = args?.registryName;
            resourceInputs["replicationName"] = args?.replicationName;

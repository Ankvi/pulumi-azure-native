...
export class ConnectedRegistry extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly activation!: pulumi.Output<types.outputs.containerregistry.ActivationPropertiesResponse>;
    /**
     ...
     */
    public readonly logging!: pulumi.Output<types.outputs.containerregistry.LoggingPropertiesResponse | undefined>;
    /**
     * The login server properties of the connected registry.
     */
    public /*out*/ readonly loginServer!: pulumi.Output<types.outputs.containerregistry.LoginServerPropertiesResponse | undefined>;
    /**
     ...
     */
    public readonly parent!: pulumi.Output<types.outputs.containerregistry.ParentPropertiesResponse>;
    /**
     ...
     */
    public /*out*/ readonly statusDetails!: pulumi.Output<types.outputs.containerregistry.StatusDetailPropertiesResponse[]>;
    /**
    ...
    constructor(name: string, args: ConnectedRegistryArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["logging"] = args ? (args.logging ? pulumi.output(args.logging).apply(types.inputs.containerregistry.loggingPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface ConnectedRegistryArgs {
     ...
     * The logging properties of the connected registry.
     */
    logging?: pulumi.Input<types.inputs.containerregistry.LoggingPropertiesArgs>;
    /**
     * The mode of the connected registry resource that indicates the permissions of the registry.
     */
     ...
     * The parent of the connected registry.
     */
    parent: pulumi.Input<types.inputs.containerregistry.ParentPropertiesArgs>;
    /**

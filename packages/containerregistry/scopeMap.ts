...
export class ScopeMap extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerregistry:ScopeMap';
    ...
    constructor(name: string, args: ScopeMapArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["scopeMapName"] = args?.scopeMapName;

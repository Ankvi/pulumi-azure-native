...
export class Registry extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerregistry/v20231101preview:Registry';
     ...
     */
    public readonly metadataSearch!: pulumi.Output<string | undefined>;
    /**
    ...
    constructor(name: string, args: RegistryArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["metadataSearch"] = (args ? args.metadataSearch : undefined) ?? "Disabled";
            ...
            resourceInputs["loginServer"] = undefined /*out*/;
            resourceInputs["metadataSearch"] = undefined /*out*/;
            resourceInputs["name"] = undefined /*out*/;
...
export interface RegistryArgs {
     ...
     * Determines whether registry artifacts are indexed for metadata search.
     */
    metadataSearch?: pulumi.Input<string | types.enums.MetadataSearch>;
    /**
     * Whether to allow trusted Azure services to access a network restricted registry.
     */

...
export class Webhook extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerregistry/v20230701:Webhook';
...
export interface WebhookArgs {
     ...
     * The list of actions that trigger the webhook to post notifications.
     */
    actions: pulumi.Input<pulumi.Input<string | types.enums.v20230701.WebhookAction>[]>;
    /**
     ...
     * The status of the webhook at the time the operation was called.
     */
    status?: pulumi.Input<string | types.enums.v20230701.WebhookStatus>;
    /**

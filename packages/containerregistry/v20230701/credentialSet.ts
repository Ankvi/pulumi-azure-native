...
export class CredentialSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerregistry/v20230701:CredentialSet';
     ...
     */
    public readonly authCredentials!: pulumi.Output<types.outputs.containerregistry.v20230701.AuthCredentialResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: CredentialSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:containerregistry:CredentialSet" }, { type: "azure-native:containerregistry/v20230101preview:CredentialSet" }, { type: "azure-native:containerregistry/v20230601preview:CredentialSet" }, { type: "azure-native:containerregistry/v20230801preview:CredentialSet" }] };
...
export interface CredentialSetArgs {
     ...
     * Usually consists of a primary and an optional secondary credential.
     */
    authCredentials?: pulumi.Input<pulumi.Input<types.inputs.containerregistry.v20230701.AuthCredentialArgs>[]>;
    /**

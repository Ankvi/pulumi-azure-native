...
export function getRegistry(args: GetRegistryArgs, opts?: pulumi.InvokeOptions): Promise<GetRegistryResult> {
    ...
    return pulumi.runtime.invoke("azure-native:containerregistry/v20230701:getRegistry", {
...
export interface GetRegistryResult {
     ...
     */
    readonly encryption?: types.outputs.containerregistry.v20230701.EncryptionPropertyResponse;
    /**
     * The resource ID.
     */
    readonly id: string;
     ...
     */
    readonly networkRuleSet?: types.outputs.containerregistry.v20230701.NetworkRuleSetResponse;
    /**
     * The policies for a container registry.
     */
    readonly policies?: types.outputs.containerregistry.v20230701.PoliciesResponse;
    /**
     * List of private endpoint connections for a container registry.
     */
    readonly privateEndpointConnections: types.outputs.containerregistry.v20230701.PrivateEndpointConnectionResponse[];
    /**
     ...
     */
    readonly sku: types.outputs.containerregistry.v20230701.SkuResponse;
    /**
     * The status of the container registry at the time the operation was called.
     */
    readonly status: types.outputs.containerregistry.v20230701.StatusResponse;
    /**

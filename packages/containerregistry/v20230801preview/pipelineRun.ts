...
export class PipelineRun extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerregistry/v20230801preview:PipelineRun';
     ...
     */
    public readonly request!: pulumi.Output<types.outputs.containerregistry.v20230801preview.PipelineRunRequestResponse | undefined>;
    /**
     * The response of a pipeline run.
     */
    public /*out*/ readonly response!: pulumi.Output<types.outputs.containerregistry.v20230801preview.PipelineRunResponseResponse>;
    /**
    ...
    constructor(name: string, args: PipelineRunArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["request"] = args ? (args.request ? pulumi.output(args.request).apply(types.inputs.containerregistry.v20230801preview.pipelineRunRequestArgsProvideDefaults) : undefined) : undefined;
...
export interface PipelineRunArgs {
     ...
     * The request parameters for a pipeline run.
     */
    request?: pulumi.Input<types.inputs.containerregistry.v20230801preview.PipelineRunRequestArgs>;
    /**

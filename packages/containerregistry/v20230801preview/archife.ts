...
export class Archife extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerregistry/v20230801preview:Archife';
     ...
     */
    public readonly packageSource!: pulumi.Output<types.outputs.containerregistry.v20230801preview.ArchivePackageSourcePropertiesResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ArchifeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:containerregistry:Archife" }, { type: "azure-native:containerregistry/v20230601preview:Archife" }] };
...
export interface ArchifeArgs {
     ...
     * The package source of the archive.
     */
    packageSource?: pulumi.Input<types.inputs.containerregistry.v20230801preview.ArchivePackageSourcePropertiesArgs>;
    /**

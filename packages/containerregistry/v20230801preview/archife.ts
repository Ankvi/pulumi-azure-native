...
export class Archife extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ArchifeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:containerregistry:Archife" }, { type: "azure-native:containerregistry/v20230601preview:Archife" }, { type: "azure-native:containerregistry/v20231101preview:Archife" }] };

...
export function getToken(args: GetTokenArgs, opts?: pulumi.InvokeOptions): Promise<GetTokenResult> {
    ...
    return pulumi.runtime.invoke("azure-native:containerregistry/v20230801preview:getToken", {
...
export interface GetTokenResult {
     ...
     */
    readonly credentials?: types.outputs.containerregistry.v20230801preview.TokenCredentialsPropertiesResponse;
    /**
     * The resource ID.
     */
    readonly id: string;

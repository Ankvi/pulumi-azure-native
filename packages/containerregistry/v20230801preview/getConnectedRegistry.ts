...
export function getConnectedRegistry(args: GetConnectedRegistryArgs, opts?: pulumi.InvokeOptions): Promise<GetConnectedRegistryResult> {
    ...
    return pulumi.runtime.invoke("azure-native:containerregistry/v20230801preview:getConnectedRegistry", {
...
export interface GetConnectedRegistryResult {
     ...
     */
    readonly activation: types.outputs.containerregistry.v20230801preview.ActivationPropertiesResponse;
    /**
     ...
     */
    readonly logging?: types.outputs.containerregistry.v20230801preview.LoggingPropertiesResponse;
    /**
     * The login server properties of the connected registry.
     */
    readonly loginServer?: types.outputs.containerregistry.v20230801preview.LoginServerPropertiesResponse;
    /**
     ...
     */
    readonly parent: types.outputs.containerregistry.v20230801preview.ParentPropertiesResponse;
    /**
     ...
     */
    readonly statusDetails: types.outputs.containerregistry.v20230801preview.StatusDetailPropertiesResponse[];
    /**

...
export function getPipelineRun(args: GetPipelineRunArgs, opts?: pulumi.InvokeOptions): Promise<GetPipelineRunResult> {
    ...
    return pulumi.runtime.invoke("azure-native:containerregistry/v20230801preview:getPipelineRun", {
...
export interface GetPipelineRunResult {
     ...
     */
    readonly request?: types.outputs.containerregistry.v20230801preview.PipelineRunRequestResponse;
    /**
     * The response of a pipeline run.
     */
    readonly response: types.outputs.containerregistry.v20230801preview.PipelineRunResponseResponse;
    /**

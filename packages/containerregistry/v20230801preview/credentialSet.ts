...
export class CredentialSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:containerregistry/v20230801preview:CredentialSet';
    ...
    constructor(name: string, args: CredentialSetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:containerregistry:CredentialSet" }, { type: "azure-native:containerregistry/v20230101preview:CredentialSet" }, { type: "azure-native:containerregistry/v20230601preview:CredentialSet" }, { type: "azure-native:containerregistry/v20230701:CredentialSet" }, { type: "azure-native:containerregistry/v20231101preview:CredentialSet" }] };

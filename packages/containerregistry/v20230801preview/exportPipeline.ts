...
export class ExportPipeline extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ExportPipelineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:containerregistry:ExportPipeline" }, { type: "azure-native:containerregistry/v20191201preview:ExportPipeline" }, { type: "azure-native:containerregistry/v20201101preview:ExportPipeline" }, { type: "azure-native:containerregistry/v20210601preview:ExportPipeline" }, { type: "azure-native:containerregistry/v20210801preview:ExportPipeline" }, { type: "azure-native:containerregistry/v20211201preview:ExportPipeline" }, { type: "azure-native:containerregistry/v20220201preview:ExportPipeline" }, { type: "azure-native:containerregistry/v20230101preview:ExportPipeline" }, { type: "azure-native:containerregistry/v20230601preview:ExportPipeline" }] };

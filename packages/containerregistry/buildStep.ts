...
export class BuildStep extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly properties!: pulumi.Output<types.outputs.containerregistry.DockerBuildStepResponse>;
    /**
    ...
    constructor(name: string, args: BuildStepArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:containerregistry/v20180201preview:BuildStep" }] };

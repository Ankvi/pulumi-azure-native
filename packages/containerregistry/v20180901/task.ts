...
export class Task extends pulumi.CustomResource {
    ...
    constructor(name: string, args: TaskArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:containerregistry:Task" }, { type: "azure-native:containerregistry/v20190401:Task" }, { type: "azure-native:containerregistry/v20190601preview:Task" }] };
...
export interface TaskArgs {
     ...
     * The properties of a task step.
     */
    step: pulumi.Input<types.inputs.TaskStepPropertiesArgs>;
    /**
     * The tags of the resource.
     */

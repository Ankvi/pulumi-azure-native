...
export class BillingRoleAssignmentByDepartment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:billing/v20191001preview:BillingRoleAssignmentByDepartment';
    ...
    constructor(name: string, args: BillingRoleAssignmentByDepartmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:billing:BillingRoleAssignmentByDepartment" }] };

...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:dataprotection/v20230801preview:BackupInstance":
                return new BackupInstance(name, <any>undefined, { urn })
            case "azure-native:dataprotection/v20230801preview:BackupPolicy":
                return new BackupPolicy(name, <any>undefined, { urn })
            case "azure-native:dataprotection/v20230801preview:BackupVault":
                return new BackupVault(name, <any>undefined, { urn })
            case "azure-native:dataprotection/v20230801preview:DppResourceGuardProxy":
                return new DppResourceGuardProxy(name, <any>undefined, { urn })
            case "azure-native:dataprotection/v20230801preview:ResourceGuard":
...
pulumi.runtime.registerResourceModule("azure-native", "dataprotection/v20230801preview", _module)
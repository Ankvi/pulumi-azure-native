...
export class BackupInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:dataprotection/v20231101:BackupInstance';

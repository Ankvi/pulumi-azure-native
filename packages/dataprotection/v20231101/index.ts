...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:dataprotection/v20231101:BackupInstance":
                return new BackupInstance(name, <any>undefined, { urn })
            case "azure-native:dataprotection/v20231101:BackupPolicy":
                return new BackupPolicy(name, <any>undefined, { urn })
            case "azure-native:dataprotection/v20231101:BackupVault":
                return new BackupVault(name, <any>undefined, { urn })
            case "azure-native:dataprotection/v20231101:DppResourceGuardProxy":
                return new DppResourceGuardProxy(name, <any>undefined, { urn })
            case "azure-native:dataprotection/v20231101:ResourceGuard":
...
pulumi.runtime.registerResourceModule("azure-native", "dataprotection/v20231101", _module)

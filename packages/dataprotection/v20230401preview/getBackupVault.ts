...
export function getBackupVault(args: GetBackupVaultArgs, opts?: pulumi.InvokeOptions): Promise<GetBackupVaultResult> {
    ...
    return pulumi.runtime.invoke("azure-native:dataprotection/v20230401preview:getBackupVault", {
...
export interface GetBackupVaultResult {
     ...
     */
    readonly identity?: types.outputs.dataprotection.v20230401preview.DppIdentityDetailsResponse;
    /**
     * Resource location.
     */
     ...
     */
    readonly properties: types.outputs.dataprotection.v20230401preview.BackupVaultResponse;
    /**

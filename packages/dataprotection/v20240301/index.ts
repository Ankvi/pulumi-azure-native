...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:dataprotection/v20240301:BackupInstance":
                return new BackupInstance(name, <any>undefined, { urn })
            case "azure-native:dataprotection/v20240301:BackupPolicy":
                return new BackupPolicy(name, <any>undefined, { urn })
            case "azure-native:dataprotection/v20240301:BackupVault":
                return new BackupVault(name, <any>undefined, { urn })
            case "azure-native:dataprotection/v20240301:DppResourceGuardProxy":
                return new DppResourceGuardProxy(name, <any>undefined, { urn })
            case "azure-native:dataprotection/v20240301:ResourceGuard":
...
pulumi.runtime.registerResourceModule("azure-native", "dataprotection/v20240301", _module)
...
export class DppResourceGuardProxy extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DppResourceGuardProxyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:dataprotection:DppResourceGuardProxy" }, { type: "azure-native:dataprotection/v20220901preview:DppResourceGuardProxy" }, { type: "azure-native:dataprotection/v20221001preview:DppResourceGuardProxy" }, { type: "azure-native:dataprotection/v20221101preview:DppResourceGuardProxy" }, { type: "azure-native:dataprotection/v20230401preview:DppResourceGuardProxy" }, { type: "azure-native:dataprotection/v20230501:DppResourceGuardProxy" }, { type: "azure-native:dataprotection/v20230601preview:DppResourceGuardProxy" }, { type: "azure-native:dataprotection/v20230801preview:DppResourceGuardProxy" }, { type: "azure-native:dataprotection/v20231101:DppResourceGuardProxy" }, { type: "azure-native:dataprotection/v20231201:DppResourceGuardProxy" }, { type: "azure-native:dataprotection/v20240201preview:DppResourceGuardProxy" }, { type: "azure-native:dataprotection/v20240301:DppResourceGuardProxy" }] };

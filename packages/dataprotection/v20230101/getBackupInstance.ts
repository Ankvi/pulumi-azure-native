...
export function getBackupInstance(args: GetBackupInstanceArgs, opts?: pulumi.InvokeOptions): Promise<GetBackupInstanceResult> {
    ...
    return pulumi.runtime.invoke("azure-native:dataprotection/v20230101:getBackupInstance", {
...
export interface GetBackupInstanceResult {
     ...
     */
    readonly properties: types.outputs.dataprotection.v20230101.BackupInstanceResponse;
    /**

...
export function getResourceGuard(args: GetResourceGuardArgs, opts?: pulumi.InvokeOptions): Promise<GetResourceGuardResult> {
    ...
    return pulumi.runtime.invoke("azure-native:dataprotection/v20230501:getResourceGuard", {
...
export interface GetResourceGuardResult {
     ...
     */
    readonly properties: types.outputs.dataprotection.v20230501.ResourceGuardResponse;
    /**

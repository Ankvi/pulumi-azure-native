...
export function getBackupVault(args: GetBackupVaultArgs, opts?: pulumi.InvokeOptions): Promise<GetBackupVaultResult> {
    ...
    return pulumi.runtime.invoke("azure-native:dataprotection/v20230501:getBackupVault", {
...
export interface GetBackupVaultResult {
     ...
     */
    readonly identity?: types.outputs.dataprotection.v20230501.DppIdentityDetailsResponse;
    /**
     * Resource location.
     */
     ...
     */
    readonly properties: types.outputs.dataprotection.v20230501.BackupVaultResponse;
    /**
     * Metadata pertaining to creation and last modification of the resource.
     */
    readonly systemData: types.outputs.dataprotection.v20230501.SystemDataResponse;
    /**
     * Resource tags.
     */

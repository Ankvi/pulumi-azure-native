...
export class ResourceGuard extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:dataprotection/v20230501:ResourceGuard';
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.dataprotection.v20230501.ResourceGuardResponse>;
    /**
...
export interface ResourceGuardArgs {
     ...
     * ResourceGuardResource properties
     */
    properties?: pulumi.Input<types.inputs.dataprotection.v20230501.ResourceGuardArgs>;
    /**

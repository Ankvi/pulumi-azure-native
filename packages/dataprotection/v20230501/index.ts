...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:dataprotection/v20230501:BackupInstance":
                return new BackupInstance(name, <any>undefined, { urn })
            case "azure-native:dataprotection/v20230501:BackupPolicy":
                return new BackupPolicy(name, <any>undefined, { urn })
            case "azure-native:dataprotection/v20230501:BackupVault":
                return new BackupVault(name, <any>undefined, { urn })
            case "azure-native:dataprotection/v20230501:DppResourceGuardProxy":
                return new DppResourceGuardProxy(name, <any>undefined, { urn })
            case "azure-native:dataprotection/v20230501:ResourceGuard":
...
pulumi.runtime.registerResourceModule("azure-native", "dataprotection/v20230501", _module)

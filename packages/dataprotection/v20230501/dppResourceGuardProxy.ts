...
export class DppResourceGuardProxy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:dataprotection/v20230501:DppResourceGuardProxy';

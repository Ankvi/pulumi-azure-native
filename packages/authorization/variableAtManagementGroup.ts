...
export class VariableAtManagementGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:authorization:VariableAtManagementGroup';
     ...
     */
    declare public readonly columns: pulumi.Output<types.outputs.PolicyVariableColumnResponse[]>;
    /**

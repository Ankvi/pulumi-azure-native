...
export namespace authorization {
    ...
    export namespace v20201001 {
        ...
        export interface ApprovalSettingsResponse {
             ...
             * The approval stages of the request.
             */
            approvalStages?: v20201001.ApprovalStageResponse[];
            /**
             * Determines whether approval is required or not.
             */
            isApprovalRequired?: boolean;
        ...
        export interface ApprovalStageResponse {
             ...
             * The escalation approver of the request.
             */
            escalationApprovers?: v20201001.UserSetResponse[];
            /**
             * The time in minutes when the approval request would be escalated if the primary approver does not approve
             */
            escalationTimeInMinutes?: number;
             ...
             * The primary approver of the request.
             */
            primaryApprovers?: v20201001.UserSetResponse[];
        }
        ...
        export interface PolicyAssignmentPropertiesResponse {
             ...
             * Details of the policy
             */
            policy?: v20201001.PolicyAssignmentPropertiesResponsePolicy;
            /**
             * Details of role definition
             */
            roleDefinition?: v20201001.PolicyAssignmentPropertiesResponseRoleDefinition;
            /**
             * Details of the resource scope
             */
            scope?: v20201001.PolicyAssignmentPropertiesResponseScope;
        }
        ...
        export interface PolicyAssignmentPropertiesResponsePolicy {
             ...
             * The name of the entity last modified it
             */
            lastModifiedBy: v20201001.PrincipalResponse;
            /**
             * The last modified date time.
             */
            lastModifiedDateTime?: string;
        ...
        export interface RoleManagementPolicyApprovalRuleResponse {
             ...
             * The approval setting
             */
            setting?: v20201001.ApprovalSettingsResponse;
            /**
             * The target of the current rule.
             */
            target?: v20201001.RoleManagementPolicyRuleTargetResponse;
        }
    ...
    export namespace v20201001preview {
        export interface PolicyAssignmentPropertiesResponse {
             ...
             * Details of the policy
             */
            policy?: v20201001preview.PolicyAssignmentPropertiesResponsePolicy;
            /**
             * Details of role definition
             */
            roleDefinition?: v20201001preview.PolicyAssignmentPropertiesResponseRoleDefinition;
            /**
             * Details of the resource scope
             */
            scope?: v20201001preview.PolicyAssignmentPropertiesResponseScope;
        }
        ...
        export interface PolicyAssignmentPropertiesResponsePolicy {
             ...
             * The name of the entity last modified it
             */
            lastModifiedBy: v20201001preview.PrincipalResponse;
            /**
             * The last modified date time.
             */
            lastModifiedDateTime?: string;
    ...
    export namespace v20210601 {
        ...
        export interface ParameterDefinitionsValueResponse {
             ...
             * General metadata for the parameter.
             */
            metadata?: v20210601.ParameterDefinitionsValueResponseMetadata;
            /**
             * The data type of the parameter.
             */
            type?: string;
        ...
        export interface PolicyDefinitionReferenceResponse {
             ...
             * The parameter values for the referenced policy rule. The keys are the parameter names.
             */
            parameters?: {[key: string]: v20210601.ParameterValuesValueResponse};
            /**
             * The ID of the policy definition or policy set definition.
             */
            policyDefinitionId: string;
    ...
    export namespace v20211201preview {
        ...
        export interface AccessReviewInstanceResponse {
             ...
             * This is the collection of backup reviewers.
             */
            backupReviewers?: v20211201preview.AccessReviewReviewerResponse[];
            /**
             * The DateTime when the review instance is scheduled to end.
             */
            endDateTime?: string;
             ...
             * This is the collection of reviewers.
             */
            reviewers?: v20211201preview.AccessReviewReviewerResponse[];
            /**
             * This field specifies the type of reviewers for a review. Usually for a review, reviewers are explicitly assigned. However, in some cases, the reviewers may not be assigned and instead be chosen dynamically. For example managers review or self review.
             */
            reviewersType: string;
    ...
    export namespace v20220601 {
        ...
        export interface OverrideResponse {
             ...
             * The list of the selector expressions.
             */
            selectors?: v20220601.SelectorResponse[];
            /**
             * The value to override the policy property.
             */
            value?: string;
    ...
    export namespace v20220701preview {
        ...
        export interface ResourceSelectorResponse {
             ...
             * The list of the selector expressions.
             */
            selectors?: v20220701preview.SelectorResponse[];
        }
    ...
    export namespace v20230401 {
        ...
        export interface IdentityResponse {
             ...
             * The user identity associated with the policy. The user identity dictionary key references will be ARM resource ids in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}'.
             */
            userAssignedIdentities?: {[key: string]: v20230401.IdentityResponseUserAssignedIdentities};
        }
        ...
        export interface OverrideResponse {
             ...
             * The list of the selector expressions.
             */
            selectors?: v20230401.SelectorResponse[];
            /**
             * The value to override the policy property.
             */
            value?: string;
        ...
        export interface ParameterDefinitionsValueResponse {
             ...
             * General metadata for the parameter.
             */
            metadata?: v20230401.ParameterDefinitionsValueResponseMetadata;
            /**
             * Provides validation of parameter inputs during assignment using a self-defined JSON schema. This property is only supported for object-type parameters and follows the Json.NET Schema 2019-09 implementation. You can learn more about using schemas at https://json-schema.org/ and test draft schemas at https://www.jsonschemavalidator.net/.
             */
            schema?: any;
        ...
        export interface PolicyDefinitionReferenceResponse {
             ...
             * The parameter values for the referenced policy rule. The keys are the parameter names.
             */
            parameters?: {[key: string]: v20230401.ParameterValuesValueResponse};
            /**
             * The ID of the policy definition or policy set definition.
             */
            policyDefinitionId: string;
        ...
        export interface PolicyDefinitionVersionResponse {
             ...
             * The parameter definitions for parameters used in the policy rule. The keys are the parameter names.
             */
            parameters?: {[key: string]: v20230401.ParameterDefinitionsValueResponse};
            /**
             * The policy rule.
             */
            policyRule?: any;
             ...
             * The system metadata relating to this resource.
             */
            systemData: v20230401.SystemDataResponse;
            /**
             * The type of the resource (Microsoft.Authorization/policyDefinitions/versions).
             */
            type: string;
        ...
        export interface PolicySetDefinitionVersionResponse {
             ...
             * The metadata describing groups of policy definition references within the policy set definition.
             */
            policyDefinitionGroups?: v20230401.PolicyDefinitionGroupResponse[];
            /**
             * An array of policy definition references.
             */
            policyDefinitions: v20230401.PolicyDefinitionReferenceResponse[];
            /**
             * The type of policy definition. Possible values are NotSpecified, BuiltIn, Custom, and Static.
             */
            policyType?: string;

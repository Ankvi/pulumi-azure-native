...
export namespace authorization {
    ...
    export namespace v20200301 {
        ...
        export interface IdentityArgs {
             ...
             */
            type?: pulumi.Input<enums.v20200301.ResourceIdentityType>;
        }
    ...
    export namespace v20200501 {
        ...
        export interface PrivateLinkAssociationPropertiesArgs {
             ...
             */
            privateLink?: pulumi.Input<string>;
            publicNetworkAccess?: pulumi.Input<string | enums.v20200501.PublicNetworkAccessOptions>;
        }
    ...
    export namespace v20210601 {
        ...
        export interface ParameterDefinitionsValueArgs {
             ...
             * General metadata for the parameter.
             */
            metadata?: pulumi.Input<v20210601.ParameterDefinitionsValueMetadataArgs>;
            /**
             * The data type of the parameter.
             */
            type?: pulumi.Input<string | enums.v20210601.ParameterType>;
        }
        ...
        export interface PolicyDefinitionReferenceArgs {
             ...
             * The parameter values for the referenced policy rule. The keys are the parameter names.
             */
            parameters?: pulumi.Input<{[key: string]: pulumi.Input<v20210601.ParameterValuesValueArgs>}>;
            /**
             * The ID of the policy definition or policy set definition.
             */
            policyDefinitionId: pulumi.Input<string>;
    ...
    export namespace v20211201preview {
        ...
        export interface AccessReviewInstanceArgs {
             ...
             * This is the collection of backup reviewers.
             */
            backupReviewers?: pulumi.Input<pulumi.Input<v20211201preview.AccessReviewReviewerArgs>[]>;
            /**
             * The DateTime when the review instance is scheduled to end.
             */
            endDateTime?: pulumi.Input<string>;
             ...
             * This is the collection of reviewers.
             */
            reviewers?: pulumi.Input<pulumi.Input<v20211201preview.AccessReviewReviewerArgs>[]>;
            /**
             * The DateTime when the review instance is scheduled to be start.
             */
            startDateTime?: pulumi.Input<string>;
    ...
    export namespace v20220601 {
        ...
        export interface IdentityArgs {
             ...
             * The identity type. This is the only required field when adding a system or user assigned identity to a resource.
             */
            type?: pulumi.Input<enums.v20220601.ResourceIdentityType>;
            /**
             * The user identity associated with the policy. The user identity dictionary key references will be ARM resource ids in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}'.
             */
            userAssignedIdentities?: pulumi.Input<pulumi.Input<string>[]>;
        ...
        export interface OverrideArgs {
             ...
             * The override kind.
             */
            kind?: pulumi.Input<string | enums.v20220601.OverrideKind>;
            /**
             * The list of the selector expressions.
             */
            selectors?: pulumi.Input<pulumi.Input<v20220601.SelectorArgs>[]>;
            /**
             * The value to override the policy property.
             */
            value?: pulumi.Input<string>;
        ...
        export interface SelectorArgs {
             ...
             * The selector kind.
             */
            kind?: pulumi.Input<string | enums.v20220601.SelectorKind>;
            /**
             * The list of values to filter out.
             */
            notIn?: pulumi.Input<pulumi.Input<string>[]>;
    ...
    export namespace v20220701preview {
        ...
        export interface ResourceSelectorArgs {
             ...
             * The list of the selector expressions.
             */
            selectors?: pulumi.Input<pulumi.Input<v20220701preview.SelectorArgs>[]>;
        }
        ...
        export interface SelectorArgs {
             ...
             * The selector kind.
             */
            kind?: pulumi.Input<string | enums.v20220701preview.SelectorKind>;
            /**
             * The list of values to filter out.
             */
            notIn?: pulumi.Input<pulumi.Input<string>[]>;
    ...
    export namespace v20230401 {
        ...
        export interface OverrideArgs {
             ...
             * The override kind.
             */
            kind?: pulumi.Input<string | enums.v20230401.OverrideKind>;
            /**
             * The list of the selector expressions.
             */
            selectors?: pulumi.Input<pulumi.Input<v20230401.SelectorArgs>[]>;
            /**
             * The value to override the policy property.
             */
            value?: pulumi.Input<string>;
        ...
        export interface ParameterDefinitionsValueArgs {
             ...
             * General metadata for the parameter.
             */
            metadata?: pulumi.Input<v20230401.ParameterDefinitionsValueMetadataArgs>;
            /**
             * Provides validation of parameter inputs during assignment using a self-defined JSON schema. This property is only supported for object-type parameters and follows the Json.NET Schema 2019-09 implementation. You can learn more about using schemas at https://json-schema.org/ and test draft schemas at https://www.jsonschemavalidator.net/.
             */
            schema?: any;
             ...
             * The data type of the parameter.
             */
            type?: pulumi.Input<string | enums.v20230401.ParameterType>;
        }
        ...
        export interface PolicyDefinitionReferenceArgs {
             ...
             * The parameter values for the referenced policy rule. The keys are the parameter names.
             */
            parameters?: pulumi.Input<{[key: string]: pulumi.Input<v20230401.ParameterValuesValueArgs>}>;
            /**
             * The ID of the policy definition or policy set definition.
             */
            policyDefinitionId: pulumi.Input<string>;
        ...
        export interface SelectorArgs {
             ...
             * The selector kind.
             */
            kind?: pulumi.Input<string | enums.v20230401.SelectorKind>;
            /**
             * The list of values to filter out.
             */
            notIn?: pulumi.Input<pulumi.Input<string>[]>;

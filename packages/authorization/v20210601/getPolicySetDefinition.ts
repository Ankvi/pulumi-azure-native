...
export function getPolicySetDefinition(args: GetPolicySetDefinitionArgs, opts?: pulumi.InvokeOptions): Promise<GetPolicySetDefinitionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:authorization/v20210601:getPolicySetDefinition", {
...
export interface GetPolicySetDefinitionResult {
     ...
     */
    readonly parameters?: {[key: string]: types.outputs.authorization.v20210601.ParameterDefinitionsValueResponse};
    /**
     * The metadata describing groups of policy definition references within the policy set definition.
     */
    readonly policyDefinitionGroups?: types.outputs.authorization.v20210601.PolicyDefinitionGroupResponse[];
    /**
     * An array of policy definition references.
     */
    readonly policyDefinitions: types.outputs.authorization.v20210601.PolicyDefinitionReferenceResponse[];
    /**
     ...
     */
    readonly systemData: types.outputs.authorization.v20210601.SystemDataResponse;
    /**

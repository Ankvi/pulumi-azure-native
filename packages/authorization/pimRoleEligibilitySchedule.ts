...
export class PimRoleEligibilitySchedule extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly expandedProperties: pulumi.Output<types.outputs.ExpandedPropertiesResponse>;
    /**
     ...
     */
    declare public readonly scheduleInfo: pulumi.Output<types.outputs.RoleEligibilityScheduleRequestPropertiesResponseScheduleInfo | undefined>;
    /**
     ...
     */
    declare public readonly ticketInfo: pulumi.Output<types.outputs.RoleEligibilityScheduleRequestPropertiesResponseTicketInfo | undefined>;
    /**

...
export class VariableValue extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:authorization/v20220801preview:VariableValue';
    ...
    constructor(name: string, args: VariableValueArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:authorization:VariableValue" }] };

...
export class VariableAtManagementGroup extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): VariableAtManagementGroup {
        return new VariableAtManagementGroup(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:authorization/v20220801preview:VariableAtManagementGroup';

    /**
     * Returns true if the given object is an instance of VariableAtManagementGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is VariableAtManagementGroup {
     ...
     */
    constructor(name: string, args: VariableAtManagementGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:authorization:VariableAtManagementGroup" }] };
 ...
 */
export interface VariableAtManagementGroupArgs {
    /**
     * Variable column definitions.
     */

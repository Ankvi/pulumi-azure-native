...
export class PolicySetDefinitionVersionAtManagementGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:authorization:PolicySetDefinitionVersionAtManagementGroup';
     ...
     */
    declare public readonly policyDefinitionGroups: pulumi.Output<types.outputs.PolicyDefinitionGroupResponse[] | undefined>;
    /**
     * An array of policy definition references.
     */
    declare public readonly policyDefinitions: pulumi.Output<types.outputs.PolicyDefinitionReferenceResponse[]>;
    /**

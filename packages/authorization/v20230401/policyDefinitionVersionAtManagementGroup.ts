...
export class PolicyDefinitionVersionAtManagementGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:authorization/v20230401:PolicyDefinitionVersionAtManagementGroup';
    ...
    constructor(name: string, args: PolicyDefinitionVersionAtManagementGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:authorization:PolicyDefinitionVersionAtManagementGroup" }] };

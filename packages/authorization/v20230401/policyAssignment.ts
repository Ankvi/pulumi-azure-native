...
export class PolicyAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:authorization/v20230401:PolicyAssignment';
     ...
     */
    public readonly identity!: pulumi.Output<types.outputs.authorization.v20230401.IdentityResponse | undefined>;
    /**
     ...
     */
    public readonly nonComplianceMessages!: pulumi.Output<types.outputs.authorization.v20230401.NonComplianceMessageResponse[] | undefined>;
    /**
     ...
     */
    public readonly overrides!: pulumi.Output<types.outputs.authorization.v20230401.OverrideResponse[] | undefined>;
    /**
     * The parameter values for the assigned policy rule. The keys are the parameter names.
     */
    public readonly parameters!: pulumi.Output<{[key: string]: types.outputs.authorization.v20230401.ParameterValuesValueResponse} | undefined>;
    /**
     ...
     */
    public readonly resourceSelectors!: pulumi.Output<types.outputs.authorization.v20230401.ResourceSelectorResponse[] | undefined>;
    /**
...
export interface PolicyAssignmentArgs {
     ...
     * The policy assignment enforcement mode. Possible values are Default and DoNotEnforce.
     */
    enforcementMode?: pulumi.Input<string | types.enums.v20230401.EnforcementMode>;
    /**
     * The managed identity associated with the policy assignment.
     */
    identity?: pulumi.Input<types.inputs.authorization.v20230401.IdentityArgs>;
    /**
     * The location of the policy assignment. Only required when utilizing managed identity.
     */
     ...
     * The messages that describe why a resource is non-compliant with the policy.
     */
    nonComplianceMessages?: pulumi.Input<pulumi.Input<types.inputs.authorization.v20230401.NonComplianceMessageArgs>[]>;
    /**
     * The policy's excluded scopes.
     */
     ...
     * The policy property value override.
     */
    overrides?: pulumi.Input<pulumi.Input<types.inputs.authorization.v20230401.OverrideArgs>[]>;
    /**
     * The parameter values for the assigned policy rule. The keys are the parameter names.
     */
    parameters?: pulumi.Input<{[key: string]: pulumi.Input<types.inputs.authorization.v20230401.ParameterValuesValueArgs>}>;
    /**
     * The name of the policy assignment.
     */
     ...
     * The resource selector list to filter policies by resource properties.
     */
    resourceSelectors?: pulumi.Input<pulumi.Input<types.inputs.authorization.v20230401.ResourceSelectorArgs>[]>;
    /**

...
export function getPolicyAssignment(args: GetPolicyAssignmentArgs, opts?: pulumi.InvokeOptions): Promise<GetPolicyAssignmentResult> {
    ...
    return pulumi.runtime.invoke("azure-native:authorization/v20230401:getPolicyAssignment", {
...
export interface GetPolicyAssignmentResult {
     ...
     */
    readonly identity?: types.outputs.authorization.v20230401.IdentityResponse;
    /**
     ...
     */
    readonly nonComplianceMessages?: types.outputs.authorization.v20230401.NonComplianceMessageResponse[];
    /**
     ...
     */
    readonly overrides?: types.outputs.authorization.v20230401.OverrideResponse[];
    /**
     * The parameter values for the assigned policy rule. The keys are the parameter names.
     */
    readonly parameters?: {[key: string]: types.outputs.authorization.v20230401.ParameterValuesValueResponse};
    /**
     ...
     */
    readonly resourceSelectors?: types.outputs.authorization.v20230401.ResourceSelectorResponse[];
    /**

...
export class PolicyDefinitionAtManagementGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:authorization/v20180501:PolicyDefinitionAtManagementGroup';
...
export interface PolicyDefinitionAtManagementGroupArgs {
     ...
     * The policy definition mode. Possible values are NotSpecified, Indexed, and All.
     */
    mode?: pulumi.Input<string | types.enums.v20180501.PolicyMode>;
    /**
     * Required if a parameter is used in policy rule.
     */
    parameters?: any;
     ...
     * The type of policy definition. Possible values are NotSpecified, BuiltIn, and Custom.
     */
    policyType?: pulumi.Input<string | types.enums.v20180501.PolicyType>;
}

...
export class PolicyAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:authorization/v20190601:PolicyAssignment';

...
export class RoleManagementPolicy extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly lastModifiedBy: pulumi.Output<types.outputs.PrincipalResponse>;
    /**
     ...
     */
    declare public /*out*/ readonly policyProperties: pulumi.Output<types.outputs.PolicyPropertiesResponse>;
    /**

...
export class RoleAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:authorization/v20220401:RoleAssignment';
...
export interface RoleAssignmentArgs {
     ...
     * The principal type of the assigned principal ID.
     */
    principalType?: pulumi.Input<string | types.enums.v20220401.PrincipalType>;
    /**

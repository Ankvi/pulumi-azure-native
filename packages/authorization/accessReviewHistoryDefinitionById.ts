...
export class AccessReviewHistoryDefinitionById extends pulumi.CustomResource {
     ...
     */
    declare public readonly instances: pulumi.Output<types.outputs.AccessReviewHistoryInstanceResponse[] | undefined>;
    /**
     ...
     */
    declare public readonly scopes: pulumi.Output<types.outputs.AccessReviewScopeResponse[] | undefined>;
    /**

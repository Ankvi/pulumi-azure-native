...
export class RoleManagementPolicyAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:authorization/v20201001preview:RoleManagementPolicyAssignment';
    ...
    constructor(name: string, args: RoleManagementPolicyAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:authorization:RoleManagementPolicyAssignment" }, { type: "azure-native:authorization/v20201001:RoleManagementPolicyAssignment" }] };

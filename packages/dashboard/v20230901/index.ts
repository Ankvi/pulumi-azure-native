...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:dashboard/v20230901:Grafana":
                return new Grafana(name, <any>undefined, { urn })
            case "azure-native:dashboard/v20230901:ManagedPrivateEndpoint":
                return new ManagedPrivateEndpoint(name, <any>undefined, { urn })
            case "azure-native:dashboard/v20230901:PrivateEndpointConnection":
...
pulumi.runtime.registerResourceModule("azure-native", "dashboard/v20230901", _module)
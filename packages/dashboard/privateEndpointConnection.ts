...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:dashboard/v20220501preview:PrivateEndpointConnection" }, { type: "azure-native:dashboard/v20220801:PrivateEndpointConnection" }, { type: "azure-native:dashboard/v20221001preview:PrivateEndpointConnection" }, { type: "azure-native:dashboard/v20230901:PrivateEndpointConnection" }] };

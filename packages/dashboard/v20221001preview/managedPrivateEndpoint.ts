...
export class ManagedPrivateEndpoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:dashboard/v20221001preview:ManagedPrivateEndpoint';
    ...
    constructor(name: string, args: ManagedPrivateEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:dashboard:ManagedPrivateEndpoint" }, { type: "azure-native:dashboard/v20230901:ManagedPrivateEndpoint" }] };

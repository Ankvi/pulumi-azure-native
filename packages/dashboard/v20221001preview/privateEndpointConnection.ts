...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:dashboard:PrivateEndpointConnection" }, { type: "azure-native:dashboard/v20220501preview:PrivateEndpointConnection" }, { type: "azure-native:dashboard/v20220801:PrivateEndpointConnection" }] };

...
export class AgriService extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.AgriServiceResourcePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: AgriServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["agriServiceResourceName"] = args?.agriServiceResourceName;

...
export namespace customerinsights {
    ...
    export namespace v20170426 {
        ...
        export interface ConnectorMappingAvailabilityArgs {
             ...
             * The frequency to update.
             */
            frequency?: pulumi.Input<enums.v20170426.FrequencyTypes>;
            /**
             * The interval of the given frequency to use.
             */
            interval: pulumi.Input<number>;
        ...
        export interface ConnectorMappingCompleteOperationArgs {
             ...
             * The type of completion operation.
             */
            completionOperationType?: pulumi.Input<enums.v20170426.CompletionOperationTypes>;
            /**
             * The destination folder where files will be moved to once the import is done.
             */
            destinationFolder?: pulumi.Input<string>;
        ...
        export interface ConnectorMappingErrorManagementArgs {
             ...
             * The type of error management to use for the mapping.
             */
            errorManagementType: pulumi.Input<enums.v20170426.ErrorManagementTypes>;
        }
        ...
        export interface ConnectorMappingFormatArgs {
             ...
             * The type mapping format.
             */
            formatType: pulumi.Input<enums.v20170426.FormatTypes>;
            /**
             * Quote character, used to indicate enquoted fields.
             */
            quoteCharacter?: pulumi.Input<string>;
        ...
        export interface ConnectorMappingPropertiesArgs {
             ...
             * The availability of mapping property.
             */
            availability: pulumi.Input<v20170426.ConnectorMappingAvailabilityArgs>;
            /**
             * The operation after import is done.
             */
            completeOperation: pulumi.Input<v20170426.ConnectorMappingCompleteOperationArgs>;
            /**
             * The error management setting for the mapping.
             */
            errorManagement: pulumi.Input<v20170426.ConnectorMappingErrorManagementArgs>;
            /**
             * The file filter for the mapping.
             */
            fileFilter?: pulumi.Input<string>;
             ...
             * The format of mapping property.
             */
            format: pulumi.Input<v20170426.ConnectorMappingFormatArgs>;
            /**
             * If the file contains a header or not.
             */
            hasHeader?: pulumi.Input<boolean>;
             ...
             * Ingestion mapping information at property level.
             */
            structure: pulumi.Input<pulumi.Input<v20170426.ConnectorMappingStructureArgs>[]>;
        }
        ...
        export interface PropertyDefinitionArgs {
             ...
             * Describes valid values for an enum property.
             */
            enumValidValues?: pulumi.Input<pulumi.Input<v20170426.ProfileEnumValidValuesFormatArgs>[]>;
            /**
             * Name of the property.
             */
            fieldName: pulumi.Input<string>;
        ...
        export interface RelationshipLinkFieldMappingArgs {
             ...
             * Link type.
             */
            linkType?: pulumi.Input<enums.v20170426.LinkTypes>;
            /**
             * The field name on the Relationship metadata.
             */
            relationshipFieldName: pulumi.Input<string>;
        ...
        export interface RelationshipTypeMappingArgs {
             ...
             * Maps a profile property with the StrongId of related profile. This is an array to support StrongIds that are composite key as well.
             */
            fieldMappings: pulumi.Input<pulumi.Input<v20170426.RelationshipTypeFieldMappingArgs>[]>;
        }

...
export class Prediction extends pulumi.CustomResource {
     ...
     */
    declare public readonly grades: pulumi.Output<types.outputs.PredictionResponseGrades[] | undefined>;
    /**
     ...
     */
    declare public readonly mappings: pulumi.Output<types.outputs.PredictionResponseMappings>;
    /**
     * Resource name.
     */
     ...
     */
    declare public /*out*/ readonly systemGeneratedEntities: pulumi.Output<types.outputs.PredictionResponseSystemGeneratedEntities>;
    /**
     * The hub name.
     */

...
export class Hub extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:customerinsights:Hub';
     ...
     */
    declare public readonly hubBillingInfo: pulumi.Output<types.outputs.HubBillingInfoFormatResponse | undefined>;
    /**
     * Resource location.
     */

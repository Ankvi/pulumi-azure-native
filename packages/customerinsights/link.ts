...
export class Link extends pulumi.CustomResource {
     ...
     */
    declare public readonly mappings: pulumi.Output<types.outputs.TypePropertiesMappingResponse[] | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    declare public readonly participantPropertyReferences: pulumi.Output<types.outputs.ParticipantPropertyReferenceResponse[]>;
    /**
     * Provisioning state.
     */

...
export class Relationship extends pulumi.CustomResource {
     ...
     */
    declare public readonly fields: pulumi.Output<types.outputs.PropertyDefinitionResponse[] | undefined>;
    /**
     * Optional property to be used to map fields in profile to their strong ids in related profile.
     */
    declare public readonly lookupMappings: pulumi.Output<types.outputs.RelationshipTypeMappingResponse[] | undefined>;
    /**
     * Resource name.
     */

...
export class RelationshipLink extends pulumi.CustomResource {
     ...
     */
    public readonly mappings!: pulumi.Output<types.outputs.customerinsights.RelationshipLinkFieldMappingResponse[] | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    public readonly profilePropertyReferences!: pulumi.Output<types.outputs.customerinsights.ParticipantProfilePropertyReferenceResponse[]>;
    /**
     * Provisioning state.
     */
     ...
     */
    public readonly relatedProfilePropertyReferences!: pulumi.Output<types.outputs.customerinsights.ParticipantProfilePropertyReferenceResponse[]>;
    /**
...
export interface RelationshipLinkArgs {
     ...
     * The mappings between Interaction and Relationship fields.
     */
    mappings?: pulumi.Input<pulumi.Input<types.inputs.customerinsights.RelationshipLinkFieldMappingArgs>[]>;
    /**
     * The property references for the Profile of the Relationship.
     */
    profilePropertyReferences: pulumi.Input<pulumi.Input<types.inputs.customerinsights.ParticipantProfilePropertyReferenceArgs>[]>;
    /**
     * The property references for the Related Profile of the Relationship.
     */
    relatedProfilePropertyReferences: pulumi.Input<pulumi.Input<types.inputs.customerinsights.ParticipantProfilePropertyReferenceArgs>[]>;
    /**
     * The name of the relationship link.
     */

...
export class RelationshipLink extends pulumi.CustomResource {
     ...
     */
    declare public readonly mappings: pulumi.Output<types.outputs.RelationshipLinkFieldMappingResponse[] | undefined>;
    /**
     * Resource name.
     */
     ...
     */
    declare public readonly profilePropertyReferences: pulumi.Output<types.outputs.ParticipantProfilePropertyReferenceResponse[]>;
    /**
     * Provisioning state.
     */
     ...
     */
    declare public readonly relatedProfilePropertyReferences: pulumi.Output<types.outputs.ParticipantProfilePropertyReferenceResponse[]>;
    /**

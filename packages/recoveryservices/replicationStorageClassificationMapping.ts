...
export class ReplicationStorageClassificationMapping extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.StorageClassificationMappingPropertiesResponse>;
    /**
     * Resource Type
     */

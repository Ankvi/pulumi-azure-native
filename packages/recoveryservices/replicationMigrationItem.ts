...
export class ReplicationMigrationItem extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:recoveryservices:ReplicationMigrationItem';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.MigrationItemPropertiesResponse>;
    /**
     * Resource Type
     */
    ...
    constructor(name: string, args: ReplicationMigrationItemArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["migrationItemName"] = args?.migrationItemName;

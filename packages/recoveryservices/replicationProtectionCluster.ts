...
export class ReplicationProtectionCluster extends pulumi.CustomResource {
     ...
     * The custom data.
     */
    declare public readonly properties: pulumi.Output<types.outputs.ReplicationProtectionClusterPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ReplicationProtectionClusterArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["replicationProtectionClusterName"] = args?.replicationProtectionClusterName;

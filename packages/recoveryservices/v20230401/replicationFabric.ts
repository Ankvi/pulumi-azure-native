...
export class ReplicationFabric extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:recoveryservices/v20230401:ReplicationFabric';
     ...
     * Fabric related data.
     */
    public readonly properties!: pulumi.Output<types.outputs.recoveryservices.v20230401.FabricPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationFabricArgs {
     ...
     */
    properties?: pulumi.Input<types.inputs.recoveryservices.v20230401.FabricCreationInputPropertiesArgs>;
    /**

...
export function getReplicationNetworkMapping(args: GetReplicationNetworkMappingArgs, opts?: pulumi.InvokeOptions): Promise<GetReplicationNetworkMappingResult> {
    ...
    return pulumi.runtime.invoke("azure-native:recoveryservices/v20230401:getReplicationNetworkMapping", {
...
export interface GetReplicationNetworkMappingResult {
     ...
     */
    readonly properties: types.outputs.recoveryservices.v20230401.NetworkMappingPropertiesResponse;
    /**
     * Resource Type
     */

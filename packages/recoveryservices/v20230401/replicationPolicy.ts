...
export class ReplicationPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:recoveryservices/v20230401:ReplicationPolicy';
     ...
     * The custom data.
     */
    public readonly properties!: pulumi.Output<types.outputs.recoveryservices.v20230401.PolicyPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationPolicyArgs {
     ...
     */
    properties?: pulumi.Input<types.inputs.recoveryservices.v20230401.CreatePolicyInputPropertiesArgs>;
    /**

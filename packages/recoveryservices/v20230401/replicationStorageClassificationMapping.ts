...
export class ReplicationStorageClassificationMapping extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.recoveryservices.v20230401.StorageClassificationMappingPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationStorageClassificationMappingArgs {
     ...
     */
    properties?: pulumi.Input<types.inputs.recoveryservices.v20230401.StorageMappingInputPropertiesArgs>;
    /**

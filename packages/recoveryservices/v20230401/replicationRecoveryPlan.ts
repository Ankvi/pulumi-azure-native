...
export class ReplicationRecoveryPlan extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:recoveryservices/v20230401:ReplicationRecoveryPlan';
     ...
     * The custom details.
     */
    public readonly properties!: pulumi.Output<types.outputs.recoveryservices.v20230401.RecoveryPlanPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationRecoveryPlanArgs {
     ...
     */
    properties: pulumi.Input<types.inputs.recoveryservices.v20230401.CreateRecoveryPlanInputPropertiesArgs>;
    /**
     * Recovery plan name.
     */

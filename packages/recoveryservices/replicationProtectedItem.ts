...
export class ReplicationProtectedItem extends pulumi.CustomResource {
     ...
     * The custom data.
     */
    declare public readonly properties: pulumi.Output<types.outputs.ReplicationProtectedItemPropertiesResponse>;
    /**
     * Resource Type
     */
    ...
    constructor(name: string, args: ReplicationProtectedItemArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["replicatedProtectedItemName"] = args?.replicatedProtectedItemName;

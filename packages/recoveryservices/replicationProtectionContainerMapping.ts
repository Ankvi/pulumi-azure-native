...
export class ReplicationProtectionContainerMapping extends pulumi.CustomResource {
     ...
     * The custom data.
     */
    declare public readonly properties: pulumi.Output<types.outputs.ProtectionContainerMappingPropertiesResponse>;
    /**
     * Resource Type
     */

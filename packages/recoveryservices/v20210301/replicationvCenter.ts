...
export class ReplicationvCenter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:recoveryservices/v20210301:ReplicationvCenter';

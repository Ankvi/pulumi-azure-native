...
export interface ProtectedItemArgs {
     ...
     * ProtectedItemResource properties
     */
    properties?: pulumi.Input<types.inputs.recoveryservices.AzureFileshareProtectedItemArgs | types.inputs.recoveryservices.AzureIaaSClassicComputeVMProtectedItemArgs | types.inputs.recoveryservices.AzureIaaSComputeVMProtectedItemArgs | types.inputs.recoveryservices.AzureIaaSVMProtectedItemArgs | types.inputs.recoveryservices.AzureSqlProtectedItemArgs | types.inputs.recoveryservices.AzureVmWorkloadProtectedItemArgs | types.inputs.recoveryservices.AzureVmWorkloadSAPAseDatabaseProtectedItemArgs | types.inputs.recoveryservices.AzureVmWorkloadSAPHanaDBInstanceProtectedItemArgs | types.inputs.recoveryservices.AzureVmWorkloadSAPHanaDatabaseProtectedItemArgs | types.inputs.recoveryservices.AzureVmWorkloadSQLDatabaseProtectedItemArgs | types.inputs.recoveryservices.DPMProtectedItemArgs | types.inputs.recoveryservices.GenericProtectedItemArgs | types.inputs.recoveryservices.MabFileFolderProtectedItemArgs>;
    /**

...
export class ReplicationFabric extends pulumi.CustomResource {
     ...
     * Fabric related data.
     */
    declare public readonly properties: pulumi.Output<types.outputs.FabricPropertiesResponse>;
    /**
     * Resource Type
     */

...
export function getReplicationFabric(args: GetReplicationFabricArgs, opts?: pulumi.InvokeOptions): Promise<GetReplicationFabricResult> {
    ...
    return pulumi.runtime.invoke("azure-native:recoveryservices/v20230601:getReplicationFabric", {
...
export interface GetReplicationFabricResult {
     ...
     * Fabric related data.
     */
    readonly properties: types.outputs.recoveryservices.v20230601.FabricPropertiesResponse;
    /**
     * Resource Type
     */

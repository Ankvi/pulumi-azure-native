...
export class ReplicationProtectionContainerMapping extends pulumi.CustomResource {
     ...
     * The custom data.
     */
    public readonly properties!: pulumi.Output<types.outputs.recoveryservices.v20230601.ProtectionContainerMappingPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationProtectionContainerMappingArgs {
     ...
     */
    properties?: pulumi.Input<types.inputs.recoveryservices.v20230601.CreateProtectionContainerMappingInputPropertiesArgs>;
    /**

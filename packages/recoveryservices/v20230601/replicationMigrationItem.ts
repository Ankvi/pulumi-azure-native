...
export class ReplicationMigrationItem extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:recoveryservices/v20230601:ReplicationMigrationItem';
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.recoveryservices.v20230601.MigrationItemPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationMigrationItemArgs {
     ...
     */
    properties: pulumi.Input<types.inputs.recoveryservices.v20230601.EnableMigrationInputPropertiesArgs>;
    /**

...
export class ReplicationNetworkMapping extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.recoveryservices.v20230601.NetworkMappingPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationNetworkMappingArgs {
     ...
     */
    properties: pulumi.Input<types.inputs.recoveryservices.v20230601.CreateNetworkMappingInputPropertiesArgs>;
    /**

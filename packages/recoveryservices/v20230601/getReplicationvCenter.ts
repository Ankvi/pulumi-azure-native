...
export function getReplicationvCenter(args: GetReplicationvCenterArgs, opts?: pulumi.InvokeOptions): Promise<GetReplicationvCenterResult> {
    ...
    return pulumi.runtime.invoke("azure-native:recoveryservices/v20230601:getReplicationvCenter", {
...
export interface GetReplicationvCenterResult {
     ...
     */
    readonly properties: types.outputs.recoveryservices.v20230601.VCenterPropertiesResponse;
    /**
     * Resource Type
     */

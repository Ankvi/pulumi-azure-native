...
export class ReplicationProtectedItem extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:recoveryservices/v20230601:ReplicationProtectedItem';
     ...
     * The custom data.
     */
    public readonly properties!: pulumi.Output<types.outputs.recoveryservices.v20230601.ReplicationProtectedItemPropertiesResponse>;
    /**
     * Resource Type
     */
...
export interface ReplicationProtectedItemArgs {
     ...
     */
    properties?: pulumi.Input<types.inputs.recoveryservices.v20230601.EnableProtectionInputPropertiesArgs>;
    /**

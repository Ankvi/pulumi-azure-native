...
export class ReplicationRecoveryPlan extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:recoveryservices/v20230801:ReplicationRecoveryPlan';

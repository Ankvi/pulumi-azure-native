...
export namespace iotcentral {
    ...
    export namespace v20210601 {
        ...
        export interface AppSkuInfoArgs {
             ...
             * The name of the SKU.
             */
            name: pulumi.Input<string | enums.v20210601.AppSku>;
        }
        ...
        export interface SystemAssignedServiceIdentityArgs {
             ...
             * Type of managed service identity (either system assigned, or none).
             */
            type: pulumi.Input<string | enums.v20210601.SystemAssignedServiceIdentityType>;
        }
    ...
    export namespace v20211101preview {
        ...
        export interface AppSkuInfoArgs {
             ...
             * The name of the SKU.
             */
            name: pulumi.Input<string | enums.v20211101preview.AppSku>;
        }
        ...
        export interface NetworkRuleSetsArgs {
             ...
             */
            defaultAction?: pulumi.Input<string | enums.v20211101preview.NetworkAction>;
            /**
             * List of IP rules.
             */
            ipRules?: pulumi.Input<pulumi.Input<v20211101preview.NetworkRuleSetIpRuleArgs>[]>;
        }
        /**
        ...
        export interface SystemAssignedServiceIdentityArgs {
             ...
             * Type of managed service identity (either system assigned, or none).
             */
            type: pulumi.Input<string | enums.v20211101preview.SystemAssignedServiceIdentityType>;
        }

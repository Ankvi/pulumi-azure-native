...
export class WorkbookTemplate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:applicationinsights:WorkbookTemplate';
     ...
     */
    declare public readonly galleries: pulumi.Output<types.outputs.WorkbookTemplateGalleryResponse[]>;
    /**
    ...
    constructor(name: string, args: WorkbookTemplateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:applicationinsights/v20191017preview:WorkbookTemplate" }, { type: "azure-native:applicationinsights/v20201120:WorkbookTemplate" }, { type: "azure-native:insights/v20201120:WorkbookTemplate" }, { type: "azure-native:insights:WorkbookTemplate" }] };

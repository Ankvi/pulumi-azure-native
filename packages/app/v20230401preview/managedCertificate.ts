...
export class ManagedCertificate extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ManagedCertificateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:ManagedCertificate" }, { type: "azure-native:app/v20221101preview:ManagedCertificate" }, { type: "azure-native:app/v20230501:ManagedCertificate" }, { type: "azure-native:app/v20230502preview:ManagedCertificate" }, { type: "azure-native:app/v20230801preview:ManagedCertificate" }] };

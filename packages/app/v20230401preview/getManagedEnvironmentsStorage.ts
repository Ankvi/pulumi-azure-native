...
export function getManagedEnvironmentsStorage(args: GetManagedEnvironmentsStorageArgs, opts?: pulumi.InvokeOptions): Promise<GetManagedEnvironmentsStorageResult> {
    ...
    return pulumi.runtime.invoke("azure-native:app/v20230401preview:getManagedEnvironmentsStorage", {
...
export interface GetManagedEnvironmentsStorageResult {
     ...
     * Storage properties
     */
    readonly properties: types.outputs.app.v20230401preview.ManagedEnvironmentStorageResponseProperties;
    /**

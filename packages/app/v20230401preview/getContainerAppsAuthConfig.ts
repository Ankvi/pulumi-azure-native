...
export function getContainerAppsAuthConfig(args: GetContainerAppsAuthConfigArgs, opts?: pulumi.InvokeOptions): Promise<GetContainerAppsAuthConfigResult> {
    ...
    return pulumi.runtime.invoke("azure-native:app/v20230401preview:getContainerAppsAuthConfig", {
...
export interface GetContainerAppsAuthConfigResult {
     ...
     */
    readonly globalValidation?: types.outputs.app.v20230401preview.GlobalValidationResponse;
    /**
     * The configuration settings of the HTTP requests for authentication and authorization requests made against ContainerApp Service Authentication/Authorization.
     */
    readonly httpSettings?: types.outputs.app.v20230401preview.HttpSettingsResponse;
    /**
     ...
     */
    readonly identityProviders?: types.outputs.app.v20230401preview.IdentityProvidersResponse;
    /**
     * The configuration settings of the login flow of users using ContainerApp Service Authentication/Authorization.
     */
    readonly login?: types.outputs.app.v20230401preview.LoginResponse;
    /**
     ...
     */
    readonly platform?: types.outputs.app.v20230401preview.AuthPlatformResponse;
    /**

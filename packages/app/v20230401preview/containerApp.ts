...
export class ContainerApp extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20230401preview:ContainerApp';
     ...
     */
    public readonly configuration!: pulumi.Output<types.outputs.app.v20230401preview.ConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly extendedLocation!: pulumi.Output<types.outputs.app.v20230401preview.ExtendedLocationResponse | undefined>;
    /**
     * managed identities for the Container App to interact with other Azure services without maintaining any secrets or credentials in code.
     */
    public readonly identity!: pulumi.Output<types.outputs.app.v20230401preview.ManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    public readonly template!: pulumi.Output<types.outputs.app.v20230401preview.TemplateResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ContainerAppArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["configuration"] = args ? (args.configuration ? pulumi.output(args.configuration).apply(types.inputs.app.v20230401preview.configurationArgsProvideDefaults) : undefined) : undefined;
            ...
            resourceInputs["template"] = args ? (args.template ? pulumi.output(args.template).apply(types.inputs.app.v20230401preview.templateArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:ContainerApp" }, { type: "azure-native:app/v20220101preview:ContainerApp" }, { type: "azure-native:app/v20220301:ContainerApp" }, { type: "azure-native:app/v20220601preview:ContainerApp" }, { type: "azure-native:app/v20221001:ContainerApp" }, { type: "azure-native:app/v20221101preview:ContainerApp" }, { type: "azure-native:app/v20230501:ContainerApp" }, { type: "azure-native:app/v20230502preview:ContainerApp" }] };
...
export interface ContainerAppArgs {
     ...
     * Non versioned Container App configuration properties.
     */
    configuration?: pulumi.Input<types.inputs.app.v20230401preview.ConfigurationArgs>;
    /**
     ...
     * The complex type of the extended location.
     */
    extendedLocation?: pulumi.Input<types.inputs.app.v20230401preview.ExtendedLocationArgs>;
    /**
     * managed identities for the Container App to interact with other Azure services without maintaining any secrets or credentials in code.
     */
    identity?: pulumi.Input<types.inputs.app.v20230401preview.ManagedServiceIdentityArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Container App versioned application definition.
     */
    template?: pulumi.Input<types.inputs.app.v20230401preview.TemplateArgs>;
    /**
     * Workload profile name to pin for container app execution.
     */

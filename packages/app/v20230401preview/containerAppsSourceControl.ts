...
export class ContainerAppsSourceControl extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20230401preview:ContainerAppsSourceControl';
     ...
     */
    public readonly githubActionConfiguration!: pulumi.Output<types.outputs.app.v20230401preview.GithubActionConfigurationResponse | undefined>;
    /**
...
export interface ContainerAppsSourceControlArgs {
     ...
     * as they were at the creation time
     */
    githubActionConfiguration?: pulumi.Input<types.inputs.app.v20230401preview.GithubActionConfigurationArgs>;
    /**
     * The repo url which will be integrated to ContainerApp.
     */

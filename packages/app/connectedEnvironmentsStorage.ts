...
export class ConnectedEnvironmentsStorage extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ConnectedEnvironmentsStorageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app/v20220601preview:ConnectedEnvironmentsStorage" }, { type: "azure-native:app/v20221001:ConnectedEnvironmentsStorage" }, { type: "azure-native:app/v20221101preview:ConnectedEnvironmentsStorage" }, { type: "azure-native:app/v20230401preview:ConnectedEnvironmentsStorage" }, { type: "azure-native:app/v20230501:ConnectedEnvironmentsStorage" }, { type: "azure-native:app/v20230502preview:ConnectedEnvironmentsStorage" }, { type: "azure-native:app/v20230801preview:ConnectedEnvironmentsStorage" }, { type: "azure-native:app/v20231102preview:ConnectedEnvironmentsStorage" }, { type: "azure-native:app/v20240202preview:ConnectedEnvironmentsStorage" }, { type: "azure-native:app/v20240301:ConnectedEnvironmentsStorage" }, { type: "azure-native:app/v20240802preview:ConnectedEnvironmentsStorage" }, { type: "azure-native:app/v20241002preview:ConnectedEnvironmentsStorage" }, { type: "azure-native:app/v20250101:ConnectedEnvironmentsStorage" }, { type: "azure-native:app/v20250202preview:ConnectedEnvironmentsStorage" }] };

...
export function getDaprComponent(args: GetDaprComponentArgs, opts?: pulumi.InvokeOptions): Promise<GetDaprComponentResult> {
    ...
    return pulumi.runtime.invoke("azure-native:app/v20221001:getDaprComponent", {
...
export interface GetDaprComponentResult {
     ...
     * Component metadata
     */
    readonly metadata?: types.outputs.app.v20221001.DaprMetadataResponse[];
    /**
     ...
     */
    readonly secrets?: types.outputs.app.v20221001.SecretResponse[];
    /**

...
export class ConnectedEnvironmentsStorage extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20221001:ConnectedEnvironmentsStorage';
     ...
     * Storage properties
     */
    public readonly properties!: pulumi.Output<types.outputs.app.v20221001.ConnectedEnvironmentStorageResponseProperties>;
    /**
...
export interface ConnectedEnvironmentsStorageArgs {
     ...
     * Storage properties
     */
    properties?: pulumi.Input<types.inputs.app.v20221001.ConnectedEnvironmentStoragePropertiesArgs>;
    /**

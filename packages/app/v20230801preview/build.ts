...
export class Build extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20230801preview:Build';
    ...
    constructor(name: string, args: BuildArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:Build" }, { type: "azure-native:app/v20231102preview:Build" }] };

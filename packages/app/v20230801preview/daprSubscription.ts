...
export class DaprSubscription extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20230801preview:DaprSubscription';
    ...
    constructor(name: string, args: DaprSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:DaprSubscription" }, { type: "azure-native:app/v20231102preview:DaprSubscription" }] };

...
export class DaprSubscription extends pulumi.CustomResource {
     ...
     */
    declare public readonly bulkSubscribe: pulumi.Output<types.outputs.DaprSubscriptionBulkSubscribeOptionsResponse | undefined>;
    /**
     ...
     * Subscription routes
     */
    declare public readonly routes: pulumi.Output<types.outputs.DaprSubscriptionRoutesResponse | undefined>;
    /**

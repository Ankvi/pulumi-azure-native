...
export function getConnectedEnvironmentsDaprComponent(args: GetConnectedEnvironmentsDaprComponentArgs, opts?: pulumi.InvokeOptions): Promise<GetConnectedEnvironmentsDaprComponentResult> {
    ...
    return pulumi.runtime.invoke("azure-native:app/v20230502preview:getConnectedEnvironmentsDaprComponent", {
...
export interface GetConnectedEnvironmentsDaprComponentResult {
     ...
     * Component metadata
     */
    readonly metadata?: types.outputs.app.v20230502preview.DaprMetadataResponse[];
    /**
     ...
     */
    readonly secrets?: types.outputs.app.v20230502preview.SecretResponse[];
    /**

...
export class ContainerAppsSourceControl extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20230502preview:ContainerAppsSourceControl';

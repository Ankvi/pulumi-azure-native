...
export class ManagedCertificate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20230501:ManagedCertificate';
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.app.v20230501.ManagedCertificateResponseProperties>;
    /**
    ...
    constructor(name: string, args: ManagedCertificateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:ManagedCertificate" }, { type: "azure-native:app/v20221101preview:ManagedCertificate" }, { type: "azure-native:app/v20230401preview:ManagedCertificate" }, { type: "azure-native:app/v20230502preview:ManagedCertificate" }] };
...
export interface ManagedCertificateArgs {
     ...
     * Certificate resource specific properties
     */
    properties?: pulumi.Input<types.inputs.app.v20230501.ManagedCertificatePropertiesArgs>;
    /**

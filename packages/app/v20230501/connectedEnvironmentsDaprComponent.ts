...
export class ConnectedEnvironmentsDaprComponent extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20230501:ConnectedEnvironmentsDaprComponent';
     ...
     * Component metadata
     */
    public readonly metadata!: pulumi.Output<types.outputs.app.v20230501.DaprMetadataResponse[] | undefined>;
    /**
     ...
     */
    public readonly secrets!: pulumi.Output<types.outputs.app.v20230501.SecretResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: ConnectedEnvironmentsDaprComponentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:ConnectedEnvironmentsDaprComponent" }, { type: "azure-native:app/v20220601preview:ConnectedEnvironmentsDaprComponent" }, { type: "azure-native:app/v20221001:ConnectedEnvironmentsDaprComponent" }, { type: "azure-native:app/v20221101preview:ConnectedEnvironmentsDaprComponent" }, { type: "azure-native:app/v20230401preview:ConnectedEnvironmentsDaprComponent" }, { type: "azure-native:app/v20230502preview:ConnectedEnvironmentsDaprComponent" }] };
...
export interface ConnectedEnvironmentsDaprComponentArgs {
     ...
     * Component metadata
     */
    metadata?: pulumi.Input<pulumi.Input<types.inputs.app.v20230501.DaprMetadataArgs>[]>;
    /**
     ...
     * Collection of secrets used by a Dapr component
     */
    secrets?: pulumi.Input<pulumi.Input<types.inputs.app.v20230501.SecretArgs>[]>;
    /**
     * Component version
     */

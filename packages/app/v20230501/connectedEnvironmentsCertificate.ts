...
export class ConnectedEnvironmentsCertificate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20230501:ConnectedEnvironmentsCertificate';
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.app.v20230501.CertificateResponseProperties>;
    /**
    ...
    constructor(name: string, args: ConnectedEnvironmentsCertificateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:ConnectedEnvironmentsCertificate" }, { type: "azure-native:app/v20220601preview:ConnectedEnvironmentsCertificate" }, { type: "azure-native:app/v20221001:ConnectedEnvironmentsCertificate" }, { type: "azure-native:app/v20221101preview:ConnectedEnvironmentsCertificate" }, { type: "azure-native:app/v20230401preview:ConnectedEnvironmentsCertificate" }, { type: "azure-native:app/v20230502preview:ConnectedEnvironmentsCertificate" }] };
...
export interface ConnectedEnvironmentsCertificateArgs {
     ...
     * Certificate resource specific properties
     */
    properties?: pulumi.Input<types.inputs.app.v20230501.CertificatePropertiesArgs>;
    /**

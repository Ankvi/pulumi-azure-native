...
export class ManagedEnvironmentsStorage extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20230501:ManagedEnvironmentsStorage';
     ...
     * Storage properties
     */
    public readonly properties!: pulumi.Output<types.outputs.app.v20230501.ManagedEnvironmentStorageResponseProperties>;
    /**
...
export interface ManagedEnvironmentsStorageArgs {
     ...
     * Storage properties
     */
    properties?: pulumi.Input<types.inputs.app.v20230501.ManagedEnvironmentStoragePropertiesArgs>;
    /**

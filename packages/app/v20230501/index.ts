...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:app/v20230501:Certificate":
                return new Certificate(name, <any>undefined, { urn })
            case "azure-native:app/v20230501:ConnectedEnvironment":
                return new ConnectedEnvironment(name, <any>undefined, { urn })
            case "azure-native:app/v20230501:ConnectedEnvironmentsCertificate":
                return new ConnectedEnvironmentsCertificate(name, <any>undefined, { urn })
            case "azure-native:app/v20230501:ConnectedEnvironmentsDaprComponent":
                return new ConnectedEnvironmentsDaprComponent(name, <any>undefined, { urn })
            case "azure-native:app/v20230501:ConnectedEnvironmentsStorage":
                return new ConnectedEnvironmentsStorage(name, <any>undefined, { urn })
            case "azure-native:app/v20230501:ContainerApp":
                return new ContainerApp(name, <any>undefined, { urn })
            case "azure-native:app/v20230501:ContainerAppsAuthConfig":
                return new ContainerAppsAuthConfig(name, <any>undefined, { urn })
            case "azure-native:app/v20230501:ContainerAppsSourceControl":
                return new ContainerAppsSourceControl(name, <any>undefined, { urn })
            case "azure-native:app/v20230501:DaprComponent":
                return new DaprComponent(name, <any>undefined, { urn })
            case "azure-native:app/v20230501:Job":
                return new Job(name, <any>undefined, { urn })
            case "azure-native:app/v20230501:ManagedCertificate":
                return new ManagedCertificate(name, <any>undefined, { urn })
            case "azure-native:app/v20230501:ManagedEnvironment":
                return new ManagedEnvironment(name, <any>undefined, { urn })
            case "azure-native:app/v20230501:ManagedEnvironmentsStorage":
...
pulumi.runtime.registerResourceModule("azure-native", "app/v20230501", _module)

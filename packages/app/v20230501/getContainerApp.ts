...
export function getContainerApp(args: GetContainerAppArgs, opts?: pulumi.InvokeOptions): Promise<GetContainerAppResult> {
    ...
    return pulumi.runtime.invoke("azure-native:app/v20230501:getContainerApp", {
...
export interface GetContainerAppResult {
     ...
     */
    readonly configuration?: types.outputs.app.v20230501.ConfigurationResponse;
    /**
     ...
     */
    readonly extendedLocation?: types.outputs.app.v20230501.ExtendedLocationResponse;
    /**
     ...
     */
    readonly template?: types.outputs.app.v20230501.TemplateResponse;
    /**

...
export class ManagedEnvironment extends pulumi.CustomResource {
     ...
     * supported
     */
    public readonly appLogsConfiguration!: pulumi.Output<types.outputs.app.v20230501.AppLogsConfigurationResponse | undefined>;
    /**
     * Custom domain configuration for the environment
     */
    public readonly customDomainConfiguration!: pulumi.Output<types.outputs.app.v20230501.CustomDomainConfigurationResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly daprConfiguration!: pulumi.Output<types.outputs.app.v20230501.DaprConfigurationResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly kedaConfiguration!: pulumi.Output<types.outputs.app.v20230501.KedaConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly peerAuthentication!: pulumi.Output<types.outputs.app.v20230501.ManagedEnvironmentResponsePeerAuthentication | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<types.outputs.app.v20230501.SystemDataResponse>;
    /**
     * Resource tags.
     */
     ...
     */
    public readonly vnetConfiguration!: pulumi.Output<types.outputs.app.v20230501.VnetConfigurationResponse | undefined>;
    /**
     * Workload profiles configured for the Managed Environment.
     */
    public readonly workloadProfiles!: pulumi.Output<types.outputs.app.v20230501.WorkloadProfileResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: ManagedEnvironmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:ManagedEnvironment" }, { type: "azure-native:app/v20220101preview:ManagedEnvironment" }, { type: "azure-native:app/v20220301:ManagedEnvironment" }, { type: "azure-native:app/v20220601preview:ManagedEnvironment" }, { type: "azure-native:app/v20221001:ManagedEnvironment" }, { type: "azure-native:app/v20221101preview:ManagedEnvironment" }, { type: "azure-native:app/v20230401preview:ManagedEnvironment" }, { type: "azure-native:app/v20230502preview:ManagedEnvironment" }] };
...
export interface ManagedEnvironmentArgs {
     ...
     * supported
     */
    appLogsConfiguration?: pulumi.Input<types.inputs.app.v20230501.AppLogsConfigurationArgs>;
    /**
     * Custom domain configuration for the environment
     */
    customDomainConfiguration?: pulumi.Input<types.inputs.app.v20230501.CustomDomainConfigurationArgs>;
    /**
     * Application Insights connection string used by Dapr to export Service to Service communication telemetry
     */
     ...
     * Peer authentication settings for the Managed Environment
     */
    peerAuthentication?: pulumi.Input<types.inputs.app.v20230501.ManagedEnvironmentPeerAuthenticationArgs>;
    /**
     ...
     * Vnet configuration for the environment
     */
    vnetConfiguration?: pulumi.Input<types.inputs.app.v20230501.VnetConfigurationArgs>;
    /**
     * Workload profiles configured for the Managed Environment.
     */
    workloadProfiles?: pulumi.Input<pulumi.Input<types.inputs.app.v20230501.WorkloadProfileArgs>[]>;
    /**
     * Whether or not this Managed Environment is zone-redundant.
     */

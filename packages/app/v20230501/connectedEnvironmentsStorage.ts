...
export class ConnectedEnvironmentsStorage extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20230501:ConnectedEnvironmentsStorage';
     ...
     * Storage properties
     */
    public readonly properties!: pulumi.Output<types.outputs.app.v20230501.ConnectedEnvironmentStorageResponseProperties>;
    /**
    ...
    constructor(name: string, args: ConnectedEnvironmentsStorageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:ConnectedEnvironmentsStorage" }, { type: "azure-native:app/v20220601preview:ConnectedEnvironmentsStorage" }, { type: "azure-native:app/v20221001:ConnectedEnvironmentsStorage" }, { type: "azure-native:app/v20221101preview:ConnectedEnvironmentsStorage" }, { type: "azure-native:app/v20230401preview:ConnectedEnvironmentsStorage" }, { type: "azure-native:app/v20230502preview:ConnectedEnvironmentsStorage" }] };
...
export interface ConnectedEnvironmentsStorageArgs {
     ...
     * Storage properties
     */
    properties?: pulumi.Input<types.inputs.app.v20230501.ConnectedEnvironmentStoragePropertiesArgs>;
    /**

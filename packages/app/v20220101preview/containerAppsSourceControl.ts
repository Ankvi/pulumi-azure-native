...
export class ContainerAppsSourceControl extends pulumi.CustomResource {
     ...
     */
    public readonly githubActionConfiguration!: pulumi.Output<types.outputs.app.v20220101preview.GithubActionConfigurationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ContainerAppsSourceControlArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:ContainerAppsSourceControl" }, { type: "azure-native:app/v20220301:ContainerAppsSourceControl" }, { type: "azure-native:app/v20220601preview:ContainerAppsSourceControl" }, { type: "azure-native:app/v20221001:ContainerAppsSourceControl" }, { type: "azure-native:app/v20221101preview:ContainerAppsSourceControl" }, { type: "azure-native:app/v20230401preview:ContainerAppsSourceControl" }, { type: "azure-native:app/v20230501:ContainerAppsSourceControl" }, { type: "azure-native:app/v20230502preview:ContainerAppsSourceControl" }] };
...
export interface ContainerAppsSourceControlArgs {
     ...
     * as they were at the creation time
     */
    githubActionConfiguration?: pulumi.Input<types.inputs.app.v20220101preview.GithubActionConfigurationArgs>;
    /**

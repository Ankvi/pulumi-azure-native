...
export function listContainerAppCustomHostNameAnalysis(args: ListContainerAppCustomHostNameAnalysisArgs, opts?: pulumi.InvokeOptions): Promise<ListContainerAppCustomHostNameAnalysisResult> {
    ...
    return pulumi.runtime.invoke("azure-native:app/v20220101preview:listContainerAppCustomHostNameAnalysis", {
...
export interface ListContainerAppCustomHostNameAnalysisResult {
     ...
     */
    readonly customDomainVerificationFailureInfo: types.outputs.app.v20220101preview.CustomHostnameAnalysisResultResponseCustomDomainVerificationFailureInfo;
    /**

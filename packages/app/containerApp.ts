...
export class ContainerApp extends pulumi.CustomResource {
     ...
     */
    public readonly configuration!: pulumi.Output<types.outputs.app.ConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly template!: pulumi.Output<types.outputs.app.TemplateResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ContainerAppArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["configuration"] = args ? (args.configuration ? pulumi.output(args.configuration).apply(types.inputs.app.configurationArgsProvideDefaults) : undefined) : undefined;
            ...
            resourceInputs["template"] = args ? (args.template ? pulumi.output(args.template).apply(types.inputs.app.templateArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app/v20220101preview:ContainerApp" }, { type: "azure-native:app/v20220301:ContainerApp" }, { type: "azure-native:app/v20220601preview:ContainerApp" }, { type: "azure-native:app/v20221001:ContainerApp" }, { type: "azure-native:app/v20221101preview:ContainerApp" }, { type: "azure-native:app/v20230401preview:ContainerApp" }, { type: "azure-native:app/v20230501:ContainerApp" }, { type: "azure-native:app/v20230502preview:ContainerApp" }] };
...
export interface ContainerAppArgs {
     ...
     * Non versioned Container App configuration properties.
     */
    configuration?: pulumi.Input<types.inputs.app.ConfigurationArgs>;
    /**
     ...
     * Container App versioned application definition.
     */
    template?: pulumi.Input<types.inputs.app.TemplateArgs>;
    /**
     * Workload profile type to pin for container app execution.
     */

...
export class DaprComponentResiliencyPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20231102preview:DaprComponentResiliencyPolicy';
    ...
    constructor(name: string, args: DaprComponentResiliencyPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:DaprComponentResiliencyPolicy" }, { type: "azure-native:app/v20230801preview:DaprComponentResiliencyPolicy" }] };

...
export class Builder extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20231102preview:Builder';
    ...
    constructor(name: string, args: BuilderArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:Builder" }, { type: "azure-native:app/v20230801preview:Builder" }] };

...
export class AppResiliency extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:app/v20231102preview:AppResiliency';
    ...
    constructor(name: string, args: AppResiliencyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app:AppResiliency" }, { type: "azure-native:app/v20230801preview:AppResiliency" }] };

...
export class ManagedEnvironmentsStorage extends pulumi.CustomResource {
     ...
     * Storage properties
     */
    declare public readonly properties: pulumi.Output<types.outputs.ManagedEnvironmentStorageResponseProperties>;
    /**

...
export class AppResiliency extends pulumi.CustomResource {
     ...
     */
    declare public readonly circuitBreakerPolicy: pulumi.Output<types.outputs.CircuitBreakerPolicyResponse | undefined>;
    /**
     * Defines parameters for http connection pooling
     */
    declare public readonly httpConnectionPool: pulumi.Output<types.outputs.HttpConnectionPoolResponse | undefined>;
    /**
     * Policy that defines http request retry conditions
     */
    declare public readonly httpRetryPolicy: pulumi.Output<types.outputs.HttpRetryPolicyResponse | undefined>;
    /**
     ...
     */
    declare public readonly tcpConnectionPool: pulumi.Output<types.outputs.TcpConnectionPoolResponse | undefined>;
    /**
     * Policy that defines tcp request retry conditions
     */
    declare public readonly tcpRetryPolicy: pulumi.Output<types.outputs.TcpRetryPolicyResponse | undefined>;
    /**
     * Policy to set request timeouts
     */
    declare public readonly timeoutPolicy: pulumi.Output<types.outputs.TimeoutPolicyResponse | undefined>;
    /**
    ...
    constructor(name: string, args: AppResiliencyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app/v20230801preview:AppResiliency" }, { type: "azure-native:app/v20231102preview:AppResiliency" }, { type: "azure-native:app/v20240202preview:AppResiliency" }, { type: "azure-native:app/v20240802preview:AppResiliency" }, { type: "azure-native:app/v20241002preview:AppResiliency" }, { type: "azure-native:app/v20250202preview:AppResiliency" }] };

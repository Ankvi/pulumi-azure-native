...
export class Builder extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:app:Builder';
     ...
     */
    declare public readonly containerRegistries: pulumi.Output<types.outputs.ContainerRegistryResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: BuilderArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:app/v20230801preview:Builder" }, { type: "azure-native:app/v20231102preview:Builder" }, { type: "azure-native:app/v20240202preview:Builder" }, { type: "azure-native:app/v20240802preview:Builder" }, { type: "azure-native:app/v20241002preview:Builder" }, { type: "azure-native:app/v20250202preview:Builder" }] };

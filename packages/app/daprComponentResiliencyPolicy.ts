...
export class DaprComponentResiliencyPolicy extends pulumi.CustomResource {
     ...
     */
    declare public readonly inboundPolicy: pulumi.Output<types.outputs.DaprComponentResiliencyPolicyConfigurationResponse | undefined>;
    /**
     ...
     */
    declare public readonly outboundPolicy: pulumi.Output<types.outputs.DaprComponentResiliencyPolicyConfigurationResponse | undefined>;
    /**

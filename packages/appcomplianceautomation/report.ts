...
export class Report extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly certRecords: pulumi.Output<types.outputs.CertSyncRecordResponse[]>;
    /**
     * Report compliance status.
     */
    declare public /*out*/ readonly complianceStatus: pulumi.Output<types.outputs.ReportComplianceStatusResponse>;
    /**
     ...
     */
    declare public readonly resources: pulumi.Output<types.outputs.ResourceMetadataResponse[]>;
    /**
     * Report status.
     */
     ...
     */
    declare public readonly storageInfo: pulumi.Output<types.outputs.StorageInfoResponse | undefined>;
    /**

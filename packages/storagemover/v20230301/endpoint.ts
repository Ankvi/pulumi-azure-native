...
export class Endpoint extends pulumi.CustomResource {
    ...
    constructor(name: string, args: EndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:storagemover:Endpoint" }, { type: "azure-native:storagemover/v20220701preview:Endpoint" }, { type: "azure-native:storagemover/v20230701preview:Endpoint" }, { type: "azure-native:storagemover/v20231001:Endpoint" }] };

...
export class JobDefinition extends pulumi.CustomResource {
    ...
    constructor(name: string, args: JobDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:storagemover:JobDefinition" }, { type: "azure-native:storagemover/v20220701preview:JobDefinition" }, { type: "azure-native:storagemover/v20230701preview:JobDefinition" }, { type: "azure-native:storagemover/v20231001:JobDefinition" }] };

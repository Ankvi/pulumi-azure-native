...
export class Endpoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:storagemover/v20230701preview:Endpoint';
    ...
    constructor(name: string, args: EndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:storagemover:Endpoint" }, { type: "azure-native:storagemover/v20220701preview:Endpoint" }, { type: "azure-native:storagemover/v20230301:Endpoint" }, { type: "azure-native:storagemover/v20231001:Endpoint" }] };

...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:storagemover/v20230701preview:Agent":
                return new Agent(name, <any>undefined, { urn })
            case "azure-native:storagemover/v20230701preview:Endpoint":
                return new Endpoint(name, <any>undefined, { urn })
            case "azure-native:storagemover/v20230701preview:JobDefinition":
                return new JobDefinition(name, <any>undefined, { urn })
            case "azure-native:storagemover/v20230701preview:Project":
                return new Project(name, <any>undefined, { urn })
            case "azure-native:storagemover/v20230701preview:StorageMover":
...
pulumi.runtime.registerResourceModule("azure-native", "storagemover/v20230701preview", _module)

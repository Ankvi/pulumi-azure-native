...
export class Project extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:storagemover/v20231001:Project';
    ...
    constructor(name: string, args: ProjectArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:storagemover:Project" }, { type: "azure-native:storagemover/v20220701preview:Project" }, { type: "azure-native:storagemover/v20230301:Project" }, { type: "azure-native:storagemover/v20230701preview:Project" }] };

 ...
 */
export class NrfDeployment extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NrfDeployment {
        return new NrfDeployment(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:mobilepacketcore:NrfDeployment';

    /**
     * Returns true if the given object is an instance of NrfDeployment.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is NrfDeployment {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === NrfDeployment.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: NrfDeploymentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["nrfDeploymentName"] = args ? args.nrfDeploymentName : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilepacketcore/v20231015preview:NrfDeployment" }] };
        opts = pulumi.mergeOptions(opts, aliasOpts);
        super(NrfDeployment.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface NrfDeploymentArgs {
    /**
     * Reference to cluster where the Network Function is deployed
     */

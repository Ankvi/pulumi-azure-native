...
export class ObservabilityService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:mobilepacketcore/v20231015preview:ObservabilityService';
    ...
    constructor(name: string, args: ObservabilityServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilepacketcore:ObservabilityService" }] };

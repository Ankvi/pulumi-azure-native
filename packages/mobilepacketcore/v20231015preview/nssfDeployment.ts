...
export class NssfDeployment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:mobilepacketcore/v20231015preview:NssfDeployment';
    ...
    constructor(name: string, args: NssfDeploymentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilepacketcore:NssfDeployment" }] };

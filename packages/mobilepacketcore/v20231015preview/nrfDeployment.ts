...
export class NrfDeployment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:mobilepacketcore/v20231015preview:NrfDeployment';
    ...
    constructor(name: string, args: NrfDeploymentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilepacketcore:NrfDeployment" }] };

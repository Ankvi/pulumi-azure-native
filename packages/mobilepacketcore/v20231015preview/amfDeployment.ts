...
export class AmfDeployment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:mobilepacketcore/v20231015preview:AmfDeployment';
    ...
    constructor(name: string, args: AmfDeploymentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilepacketcore:AmfDeployment" }] };

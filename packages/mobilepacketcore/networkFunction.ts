...
export class NetworkFunction extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:mobilepacketcore:NetworkFunction';
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<types.outputs.mobilepacketcore.SystemDataResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: NetworkFunctionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilepacketcore/v20230515preview:NetworkFunction" }] };

 ...
 */
export class NssfDeployment extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): NssfDeployment {
        return new NssfDeployment(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:mobilepacketcore:NssfDeployment';

    /**
     * Returns true if the given object is an instance of NssfDeployment.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is NssfDeployment {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === NssfDeployment.__pulumiType;
    }
    ...
    /**
     * Create a NssfDeployment resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: NssfDeploymentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["nssfDeploymentName"] = args ? args.nssfDeploymentName : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilepacketcore/v20231015preview:NssfDeployment" }] };
        opts = pulumi.mergeOptions(opts, aliasOpts);
        super(NssfDeployment.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface NssfDeploymentArgs {
    /**
     * Reference to cluster where the Network Function is deployed
     */

...
export class UpfDeployment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:mobilepacketcore:UpfDeployment';
    ...
    constructor(name: string, args: UpfDeploymentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilepacketcore/v20231015preview:UpfDeployment" }] };

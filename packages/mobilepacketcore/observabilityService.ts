 ...
 */
export class ObservabilityService extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ObservabilityService {
        return new ObservabilityService(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:mobilepacketcore:ObservabilityService';

    /**
     * Returns true if the given object is an instance of ObservabilityService.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ObservabilityService {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ObservabilityService.__pulumiType;
    }
    ...
    /**
     * Create a ObservabilityService resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ObservabilityServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["observabilityServiceName"] = args ? args.observabilityServiceName : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilepacketcore/v20231015preview:ObservabilityService" }] };
        opts = pulumi.mergeOptions(opts, aliasOpts);
        super(ObservabilityService.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ObservabilityServiceArgs {
    /**
     * Reference to cluster where the observability components are deployed
     */

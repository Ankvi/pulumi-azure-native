 ...
 */
export class AmfDeployment extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AmfDeployment {
        return new AmfDeployment(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:mobilepacketcore:AmfDeployment';

    /**
     * Returns true if the given object is an instance of AmfDeployment.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AmfDeployment {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AmfDeployment.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: AmfDeploymentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["amfDeploymentName"] = args ? args.amfDeploymentName : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilepacketcore/v20231015preview:AmfDeployment" }] };
        opts = pulumi.mergeOptions(opts, aliasOpts);
        super(AmfDeployment.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface AmfDeploymentArgs {
    /**

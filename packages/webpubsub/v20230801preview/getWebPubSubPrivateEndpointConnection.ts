...
export function getWebPubSubPrivateEndpointConnection(args: GetWebPubSubPrivateEndpointConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetWebPubSubPrivateEndpointConnectionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:webpubsub/v20230801preview:getWebPubSubPrivateEndpointConnection", {
...
export interface GetWebPubSubPrivateEndpointConnectionResult {
     ...
     * Private endpoint
     */
    readonly privateEndpoint?: types.outputs.webpubsub.v20230801preview.PrivateEndpointResponse;
    /**
     * Connection state of the private endpoint connection
     */
    readonly privateLinkServiceConnectionState?: types.outputs.webpubsub.v20230801preview.PrivateLinkServiceConnectionStateResponse;
    /**

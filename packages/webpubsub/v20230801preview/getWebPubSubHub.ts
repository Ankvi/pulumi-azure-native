...
export function getWebPubSubHub(args: GetWebPubSubHubArgs, opts?: pulumi.InvokeOptions): Promise<GetWebPubSubHubResult> {
    ...
    return pulumi.runtime.invoke("azure-native:webpubsub/v20230801preview:getWebPubSubHub", {
...
export interface GetWebPubSubHubResult {
     ...
     * Properties of a hub.
     */
    readonly properties: types.outputs.webpubsub.v20230801preview.WebPubSubHubPropertiesResponse;
    /**

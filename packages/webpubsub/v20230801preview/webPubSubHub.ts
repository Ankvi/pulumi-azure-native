...
export class WebPubSubHub extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:webpubsub/v20230801preview:WebPubSubHub';
     ...
     * Properties of a hub.
     */
    public readonly properties!: pulumi.Output<types.outputs.webpubsub.v20230801preview.WebPubSubHubPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: WebPubSubHubArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(types.inputs.webpubsub.v20230801preview.webPubSubHubPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface WebPubSubHubArgs {
     ...
     * Properties of a hub.
     */
    properties: pulumi.Input<types.inputs.webpubsub.v20230801preview.WebPubSubHubPropertiesArgs>;
    /**

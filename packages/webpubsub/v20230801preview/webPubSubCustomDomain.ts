...
export class WebPubSubCustomDomain extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:webpubsub/v20230801preview:WebPubSubCustomDomain';
     ...
     */
    public readonly customCertificate!: pulumi.Output<types.outputs.webpubsub.v20230801preview.ResourceReferenceResponse>;
    /**
...
export interface WebPubSubCustomDomainArgs {
     ...
     * Reference to a resource.
     */
    customCertificate: pulumi.Input<types.inputs.webpubsub.v20230801preview.ResourceReferenceArgs>;
    /**
     * The custom domain name.
     */

...
export class WebPubSubReplica extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WebPubSubReplicaArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:webpubsub:WebPubSubReplica" }, { type: "azure-native:webpubsub/v20230301preview:WebPubSubReplica" }, { type: "azure-native:webpubsub/v20230601preview:WebPubSubReplica" }] };

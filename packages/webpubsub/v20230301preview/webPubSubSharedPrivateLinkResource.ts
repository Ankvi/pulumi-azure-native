...
export class WebPubSubSharedPrivateLinkResource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:webpubsub/v20230301preview:WebPubSubSharedPrivateLinkResource';

...
export class WebPubSub extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:webpubsub/v20230301preview:WebPubSub';
     ...
     */
    public readonly identity!: pulumi.Output<types.outputs.webpubsub.v20230301preview.ManagedIdentityResponse | undefined>;
    /**
     * Live trace configuration of a Microsoft.SignalRService resource.
     */
    public readonly liveTraceConfiguration!: pulumi.Output<types.outputs.webpubsub.v20230301preview.LiveTraceConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly networkACLs!: pulumi.Output<types.outputs.webpubsub.v20230301preview.WebPubSubNetworkACLsResponse | undefined>;
    /**
     * Private endpoint connections to the resource.
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<types.outputs.webpubsub.v20230301preview.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public readonly resourceLogConfiguration!: pulumi.Output<types.outputs.webpubsub.v20230301preview.ResourceLogConfigurationResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly sharedPrivateLinkResources!: pulumi.Output<types.outputs.webpubsub.v20230301preview.SharedPrivateLinkResourceResponse[]>;
    /**
     * The billing information of the resource.
     */
    public readonly sku!: pulumi.Output<types.outputs.webpubsub.v20230301preview.ResourceSkuResponse | undefined>;
    /**
     ...
     */
    public readonly tls!: pulumi.Output<types.outputs.webpubsub.v20230301preview.WebPubSubTlsSettingsResponse | undefined>;
    /**
    ...
    constructor(name: string, args: WebPubSubArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["liveTraceConfiguration"] = args ? (args.liveTraceConfiguration ? pulumi.output(args.liveTraceConfiguration).apply(types.inputs.webpubsub.v20230301preview.liveTraceConfigurationArgsProvideDefaults) : undefined) : undefined;
            ...
            resourceInputs["tls"] = args ? (args.tls ? pulumi.output(args.tls).apply(types.inputs.webpubsub.v20230301preview.webPubSubTlsSettingsArgsProvideDefaults) : undefined) : undefined;
...
export interface WebPubSubArgs {
     ...
     * A class represent managed identities used for request and response
     */
    identity?: pulumi.Input<types.inputs.webpubsub.v20230301preview.ManagedIdentityArgs>;
    /**
     * Live trace configuration of a Microsoft.SignalRService resource.
     */
    liveTraceConfiguration?: pulumi.Input<types.inputs.webpubsub.v20230301preview.LiveTraceConfigurationArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Network ACLs for the resource
     */
    networkACLs?: pulumi.Input<types.inputs.webpubsub.v20230301preview.WebPubSubNetworkACLsArgs>;
    /**
     * Enable or disable public network access. Default to "Enabled".
     * When it's Enabled, network ACLs still apply.
     * When it's Disabled, public network access is always disabled no matter what you set in network ACLs.
     ...
     * Resource log configuration of a Microsoft.SignalRService resource.
     */
    resourceLogConfiguration?: pulumi.Input<types.inputs.webpubsub.v20230301preview.ResourceLogConfigurationArgs>;
    /**
     * The name of the resource.
     */
     ...
     * The billing information of the resource.
     */
    sku?: pulumi.Input<types.inputs.webpubsub.v20230301preview.ResourceSkuArgs>;
    /**
     * Resource tags.
     */
     ...
     * TLS settings for the resource
     */
    tls?: pulumi.Input<types.inputs.webpubsub.v20230301preview.WebPubSubTlsSettingsArgs>;
}

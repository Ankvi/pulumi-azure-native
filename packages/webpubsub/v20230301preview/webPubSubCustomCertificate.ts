...
export class WebPubSubCustomCertificate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:webpubsub/v20230301preview:WebPubSubCustomCertificate';

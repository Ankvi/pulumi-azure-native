...
export class WebPubSubCustomDomain extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WebPubSubCustomDomainArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:webpubsub:WebPubSubCustomDomain" }, { type: "azure-native:webpubsub/v20220801preview:WebPubSubCustomDomain" }, { type: "azure-native:webpubsub/v20230301preview:WebPubSubCustomDomain" }, { type: "azure-native:webpubsub/v20230601preview:WebPubSubCustomDomain" }, { type: "azure-native:webpubsub/v20230801preview:WebPubSubCustomDomain" }] };

...
export class WebPubSubCustomCertificate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:webpubsub/v20230201:WebPubSubCustomCertificate';
    ...
    constructor(name: string, args: WebPubSubCustomCertificateArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:webpubsub:WebPubSubCustomCertificate" }, { type: "azure-native:webpubsub/v20220801preview:WebPubSubCustomCertificate" }, { type: "azure-native:webpubsub/v20230301preview:WebPubSubCustomCertificate" }, { type: "azure-native:webpubsub/v20230601preview:WebPubSubCustomCertificate" }, { type: "azure-native:webpubsub/v20230801preview:WebPubSubCustomCertificate" }, { type: "azure-native:webpubsub/v20240101preview:WebPubSubCustomCertificate" }] };

...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:webpubsub/v20240101preview:WebPubSub":
                return new WebPubSub(name, <any>undefined, { urn })
            case "azure-native:webpubsub/v20240101preview:WebPubSubCustomCertificate":
                return new WebPubSubCustomCertificate(name, <any>undefined, { urn })
            case "azure-native:webpubsub/v20240101preview:WebPubSubCustomDomain":
                return new WebPubSubCustomDomain(name, <any>undefined, { urn })
            case "azure-native:webpubsub/v20240101preview:WebPubSubHub":
                return new WebPubSubHub(name, <any>undefined, { urn })
            case "azure-native:webpubsub/v20240101preview:WebPubSubPrivateEndpointConnection":
                return new WebPubSubPrivateEndpointConnection(name, <any>undefined, { urn })
            case "azure-native:webpubsub/v20240101preview:WebPubSubReplica":
                return new WebPubSubReplica(name, <any>undefined, { urn })
            case "azure-native:webpubsub/v20240101preview:WebPubSubSharedPrivateLinkResource":
...
pulumi.runtime.registerResourceModule("azure-native", "webpubsub/v20240101preview", _module)
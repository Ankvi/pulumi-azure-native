...
export class WebPubSub extends pulumi.CustomResource {
     ...
     */
    declare public readonly networkACLs: pulumi.Output<types.outputs.WebPubSubNetworkACLsResponse | undefined>;
    /**
     ...
     */
    declare public readonly socketIO: pulumi.Output<types.outputs.WebPubSubSocketIOSettingsResponse | undefined>;
    /**
     ...
     */
    declare public readonly tls: pulumi.Output<types.outputs.WebPubSubTlsSettingsResponse | undefined>;
    /**

...
export class WebPubSubCustomDomain extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:webpubsub:WebPubSubCustomDomain';
     ...
     */
    declare public readonly customCertificate: pulumi.Output<types.outputs.ResourceReferenceResponse>;
    /**

...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:maps/v20230801preview:Account":
                return new Account(name, <any>undefined, { urn })
            case "azure-native:maps/v20230801preview:Creator":
...
pulumi.runtime.registerResourceModule("azure-native", "maps/v20230801preview", _module)

...
export class Creator extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:maps/v20211201preview:Creator';
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.maps.v20211201preview.CreatorPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: CreatorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:maps:Creator" }, { type: "azure-native:maps/v20200201preview:Creator" }, { type: "azure-native:maps/v20210201:Creator" }, { type: "azure-native:maps/v20210701preview:Creator" }, { type: "azure-native:maps/v20230601:Creator" }] };
...
export interface CreatorArgs {
     ...
     * The Creator resource properties.
     */
    properties: pulumi.Input<types.inputs.maps.v20211201preview.CreatorPropertiesArgs>;
    /**

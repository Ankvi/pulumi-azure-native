...
export class PrivateAtlase extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly properties: pulumi.Output<types.outputs.PrivateAtlasPropertiesResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: PrivateAtlaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["privateAtlasName"] = args?.privateAtlasName;

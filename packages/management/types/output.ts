...
export namespace management {
    ...
    export namespace v20200501 {
        ...
        export interface EntityInfoResponse {
             ...
             * (Optional) The ID of the parent management group.
             */
            parent?: v20200501.EntityParentGroupInfoResponse;
            /**
             * The parent display name chain from the root group to the immediate parent
             */
            parentDisplayNameChain?: string[];
    ...
    export namespace v20201001 {
        ...
        export interface EntityInfoResponse {
             ...
             * (Optional) The ID of the parent management group.
             */
            parent?: v20201001.EntityParentGroupInfoResponse;
            /**
             * The parent display name chain from the root group to the immediate parent
             */
            parentDisplayNameChain?: string[];
    ...
    export namespace v20210401 {
        ...
        export interface EntityInfoResponse {
             ...
             * (Optional) The ID of the parent management group.
             */
            parent?: v20210401.EntityParentGroupInfoResponse;
            /**
             * The parent display name chain from the root group to the immediate parent
             */
            parentDisplayNameChain?: string[];
        ...
        export interface ManagementGroupChildInfoResponse {
             ...
             * The list of children.
             */
            children?: v20210401.ManagementGroupChildInfoResponse[];
            /**
             * The friendly name of the child resource.
             */
            displayName?: string;
        ...
        export interface ManagementGroupDetailsResponse {
             ...
             * The ancestors of the management group displayed in reversed order, from immediate parent to the root.
             */
            managementGroupAncestorsChain?: v20210401.ManagementGroupPathElementResponse[];
            /**
             * (Optional) The ID of the parent management group.
             */
            parent?: v20210401.ParentGroupInfoResponse;
            /**
             * The path from the root to the current group.
             */
            path?: v20210401.ManagementGroupPathElementResponse[];
            /**
             * The identity of the principal or process that updated the object.
             */
            updatedBy?: string;
    ...
    export namespace v20230401 {
        ...
        export interface EntityInfoResponse {
             ...
             * (Optional) The ID of the parent management group.
             */
            parent?: v20230401.EntityParentGroupInfoResponse;
            /**
             * The parent display name chain from the root group to the immediate parent
             */
            parentDisplayNameChain?: string[];
        ...
        export interface ManagementGroupChildInfoResponse {
             ...
             * The list of children.
             */
            children?: v20230401.ManagementGroupChildInfoResponse[];
            /**
             * The friendly name of the child resource.
             */
            displayName?: string;
        ...
        export interface ManagementGroupDetailsResponse {
             ...
             * The ancestors of the management group displayed in reversed order, from immediate parent to the root.
             */
            managementGroupAncestorsChain?: v20230401.ManagementGroupPathElementResponse[];
            /**
             * (Optional) The ID of the parent management group.
             */
            parent?: v20230401.ParentGroupInfoResponse;
            /**
             * The path from the root to the current group.
             */
            path?: v20230401.ManagementGroupPathElementResponse[];
            /**
             * The identity of the principal or process that updated the object.
             */
            updatedBy?: string;

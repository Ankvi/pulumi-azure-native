...
export class ServiceGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:management:ServiceGroup';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.ServiceGroupPropertiesResponse>;
    /**
    ...
    constructor(name: string, args?: ServiceGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:management/v20240201preview:ServiceGroup" }] };

...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:management/v20230401:HierarchySetting":
                return new HierarchySetting(name, <any>undefined, { urn })
            case "azure-native:management/v20230401:ManagementGroup":
                return new ManagementGroup(name, <any>undefined, { urn })
            case "azure-native:management/v20230401:ManagementGroupSubscription":
...
pulumi.runtime.registerResourceModule("azure-native", "management/v20230401", _module)

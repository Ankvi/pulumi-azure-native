...
export class RaiPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cognitiveservices:RaiPolicy';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.RaiPolicyPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: RaiPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cognitiveservices/v20231001preview:RaiPolicy" }, { type: "azure-native:cognitiveservices/v20240401preview:RaiPolicy" }, { type: "azure-native:cognitiveservices/v20240601preview:RaiPolicy" }, { type: "azure-native:cognitiveservices/v20241001:RaiPolicy" }, { type: "azure-native:cognitiveservices/v20250401preview:RaiPolicy" }, { type: "azure-native:cognitiveservices/v20250601:RaiPolicy" }, { type: "azure-native:cognitiveservices/v20250701preview:RaiPolicy" }, { type: "azure-native:cognitiveservices/v20250901:RaiPolicy" }] };

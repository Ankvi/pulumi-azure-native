...
export class EncryptionScope extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.EncryptionScopePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: EncryptionScopeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["properties"] = args ? (args.properties ? pulumi.output(args.properties).apply(types.inputs.encryptionScopePropertiesArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cognitiveservices/v20231001preview:EncryptionScope" }, { type: "azure-native:cognitiveservices/v20240401preview:EncryptionScope" }, { type: "azure-native:cognitiveservices/v20240601preview:EncryptionScope" }, { type: "azure-native:cognitiveservices/v20241001:EncryptionScope" }, { type: "azure-native:cognitiveservices/v20250401preview:EncryptionScope" }, { type: "azure-native:cognitiveservices/v20250601:EncryptionScope" }] };
...
export interface EncryptionScopeArgs {
     ...
     * Properties of Cognitive Services EncryptionScope.
     */
    properties?: pulumi.Input<types.inputs.EncryptionScopePropertiesArgs>;
    /**

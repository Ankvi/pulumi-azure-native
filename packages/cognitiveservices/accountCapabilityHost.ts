...
export class AccountCapabilityHost extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AccountCapabilityHost {
        return new AccountCapabilityHost(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:cognitiveservices:AccountCapabilityHost';

    /**
     * Returns true if the given object is an instance of AccountCapabilityHost.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AccountCapabilityHost {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AccountCapabilityHost.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: AccountCapabilityHostArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cognitiveservices/v20250401preview:AccountCapabilityHost" }] };
 ...
 */
export interface AccountCapabilityHostArgs {
    /**

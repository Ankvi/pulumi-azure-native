...
export class SharedCommitmentPlan extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cognitiveservices/v20230501:SharedCommitmentPlan';
    ...
    constructor(name: string, args: SharedCommitmentPlanArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cognitiveservices:SharedCommitmentPlan" }, { type: "azure-native:cognitiveservices/v20221201:SharedCommitmentPlan" }, { type: "azure-native:cognitiveservices/v20231001preview:SharedCommitmentPlan" }] };

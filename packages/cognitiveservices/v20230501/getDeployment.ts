...
export function getDeployment(args: GetDeploymentArgs, opts?: pulumi.InvokeOptions): Promise<GetDeploymentResult> {
    ...
    return pulumi.runtime.invoke("azure-native:cognitiveservices/v20230501:getDeployment", {
...
export interface GetDeploymentResult {
     ...
     */
    readonly properties: types.outputs.cognitiveservices.v20230501.DeploymentPropertiesResponse;
    /**

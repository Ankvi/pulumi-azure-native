...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:cognitiveservices/v20231001preview:Account":
                return new Account(name, <any>undefined, { urn })
            case "azure-native:cognitiveservices/v20231001preview:CommitmentPlan":
                return new CommitmentPlan(name, <any>undefined, { urn })
            case "azure-native:cognitiveservices/v20231001preview:CommitmentPlanAssociation":
                return new CommitmentPlanAssociation(name, <any>undefined, { urn })
            case "azure-native:cognitiveservices/v20231001preview:Deployment":
            ...
            case "azure-native:cognitiveservices/v20231001preview:PrivateEndpointConnection":
            ...
            case "azure-native:cognitiveservices/v20231001preview:SharedCommitmentPlan":

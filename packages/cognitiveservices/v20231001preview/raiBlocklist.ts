...
export class RaiBlocklist extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cognitiveservices/v20231001preview:RaiBlocklist';
    ...
    constructor(name: string, args: RaiBlocklistArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cognitiveservices:RaiBlocklist" }] };

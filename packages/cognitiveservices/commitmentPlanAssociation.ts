...
export class CommitmentPlanAssociation extends pulumi.CustomResource {
    ...
    constructor(name: string, args: CommitmentPlanAssociationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["commitmentPlanAssociationName"] = args?.commitmentPlanAssociationName;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cognitiveservices/v20221201:CommitmentPlanAssociation" }, { type: "azure-native:cognitiveservices/v20230501:CommitmentPlanAssociation" }, { type: "azure-native:cognitiveservices/v20231001preview:CommitmentPlanAssociation" }, { type: "azure-native:cognitiveservices/v20240401preview:CommitmentPlanAssociation" }, { type: "azure-native:cognitiveservices/v20240601preview:CommitmentPlanAssociation" }, { type: "azure-native:cognitiveservices/v20241001:CommitmentPlanAssociation" }, { type: "azure-native:cognitiveservices/v20250401preview:CommitmentPlanAssociation" }, { type: "azure-native:cognitiveservices/v20250601:CommitmentPlanAssociation" }, { type: "azure-native:cognitiveservices/v20250701preview:CommitmentPlanAssociation" }, { type: "azure-native:cognitiveservices/v20250901:CommitmentPlanAssociation" }] };

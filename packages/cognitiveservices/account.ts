...
export class Account extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.AccountPropertiesResponse>;
    /**

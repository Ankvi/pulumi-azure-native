...
export class ClientGroup extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ClientGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventgrid/v20230601preview:ClientGroup" }, { type: "azure-native:eventgrid/v20231215preview:ClientGroup" }, { type: "azure-native:eventgrid/v20240601preview:ClientGroup" }, { type: "azure-native:eventgrid/v20241215preview:ClientGroup" }, { type: "azure-native:eventgrid/v20250215:ClientGroup" }, { type: "azure-native:eventgrid/v20250401preview:ClientGroup" }] };

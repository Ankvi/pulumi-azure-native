...
export class PartnerTopic extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PartnerTopicArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventgrid/v20211015preview:PartnerTopic" }, { type: "azure-native:eventgrid/v20220615:PartnerTopic" }, { type: "azure-native:eventgrid/v20230601preview:PartnerTopic" }, { type: "azure-native:eventgrid/v20231215preview:PartnerTopic" }] };

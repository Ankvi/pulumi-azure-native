...
export class Client extends pulumi.CustomResource {
     ...
     */
    declare public readonly clientCertificateAuthentication: pulumi.Output<types.outputs.ClientCertificateAuthenticationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ClientArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventgrid/v20230601preview:Client" }, { type: "azure-native:eventgrid/v20231215preview:Client" }, { type: "azure-native:eventgrid/v20240601preview:Client" }, { type: "azure-native:eventgrid/v20241215preview:Client" }, { type: "azure-native:eventgrid/v20250215:Client" }, { type: "azure-native:eventgrid/v20250401preview:Client" }] };

...
export class PartnerTopic extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventgrid/v20220615:PartnerTopic';
     ...
     */
    public readonly eventTypeInfo!: pulumi.Output<types.outputs.eventgrid.v20220615.EventTypeInfoResponse | undefined>;
    /**
...
export interface PartnerTopicArgs {
     ...
     * Activation state of the partner topic.
     */
    activationState?: pulumi.Input<string | types.enums.v20220615.PartnerTopicActivationState>;
    /**
     * Event Type information from the corresponding event channel.
     */
    eventTypeInfo?: pulumi.Input<types.inputs.eventgrid.v20220615.EventTypeInfoArgs>;
    /**
     * Expiration time of the partner topic. If this timer expires while the partner topic is still never activated,
     * the partner topic and corresponding event channel are deleted.
     */

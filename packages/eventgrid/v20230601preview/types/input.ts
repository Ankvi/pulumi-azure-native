...
import * as pulumi from "@pulumi/pulumi";
    ...
    export interface WebhookPartnerDestinationInfoArgs {
         ...
         */
        clientAuthentication?: pulumi.Input<AzureADPartnerClientAuthenticationArgs>;
        /**
         ...
         */
        resourceMoveChangeHistory?: pulumi.Input<pulumi.Input<ResourceMoveChangeHistoryArgs>[]>;
    }
    /**
    ...
    export function webhookPartnerDestinationInfoArgsProvideDefaults(val: WebhookPartnerDestinationInfoArgs): WebhookPartnerDestinationInfoArgs {
        return {
            ...val,
            clientAuthentication: (val.clientAuthentication ? pulumi.output(val.clientAuthentication).apply(azureADPartnerClientAuthenticationArgsProvideDefaults) : undefined),

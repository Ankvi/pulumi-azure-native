...
export class Client extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventgrid/v20230601preview:Client';
    ...
    constructor(name: string, args: ClientArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventgrid:Client" }, { type: "azure-native:eventgrid/v20231215preview:Client" }] };

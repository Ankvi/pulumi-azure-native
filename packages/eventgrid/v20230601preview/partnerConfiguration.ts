...
export class PartnerConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventgrid/v20230601preview:PartnerConfiguration';
     ...
     */
    public readonly partnerAuthorization!: pulumi.Output<types.outputs.eventgrid.v20230601preview.PartnerAuthorizationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: PartnerConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventgrid:PartnerConfiguration" }, { type: "azure-native:eventgrid/v20211015preview:PartnerConfiguration" }, { type: "azure-native:eventgrid/v20220615:PartnerConfiguration" }] };
...
export interface PartnerConfigurationArgs {
     ...
     * The details of authorized partners.
     */
    partnerAuthorization?: pulumi.Input<types.inputs.eventgrid.v20230601preview.PartnerAuthorizationArgs>;
    /**
     * Provisioning state of the partner configuration.
     */
    provisioningState?: pulumi.Input<string | types.enums.v20230601preview.PartnerConfigurationProvisioningState>;
    /**

...
export class NamespaceTopic extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventgrid/v20230601preview:NamespaceTopic';
    ...
    constructor(name: string, args: NamespaceTopicArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventgrid:NamespaceTopic" }, { type: "azure-native:eventgrid/v20231215preview:NamespaceTopic" }] };

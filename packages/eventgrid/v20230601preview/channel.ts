...
export class Channel extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ChannelArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventgrid:Channel" }, { type: "azure-native:eventgrid/v20211015preview:Channel" }, { type: "azure-native:eventgrid/v20220615:Channel" }, { type: "azure-native:eventgrid/v20231215preview:Channel" }] };

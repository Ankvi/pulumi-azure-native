...
export class TopicSpace extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventgrid/v20230601preview:TopicSpace';
    ...
    constructor(name: string, args: TopicSpaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventgrid:TopicSpace" }, { type: "azure-native:eventgrid/v20231215preview:TopicSpace" }] };

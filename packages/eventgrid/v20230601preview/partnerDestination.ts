...
export class PartnerDestination extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventgrid/v20230601preview:PartnerDestination';
    ...
    constructor(name: string, args: PartnerDestinationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventgrid:PartnerDestination" }, { type: "azure-native:eventgrid/v20211015preview:PartnerDestination" }, { type: "azure-native:eventgrid/v20231215preview:PartnerDestination" }] };

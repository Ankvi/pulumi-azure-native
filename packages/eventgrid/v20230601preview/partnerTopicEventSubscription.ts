...
export class PartnerTopicEventSubscription extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PartnerTopicEventSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventgrid:PartnerTopicEventSubscription" }, { type: "azure-native:eventgrid/v20200401preview:PartnerTopicEventSubscription" }, { type: "azure-native:eventgrid/v20201015preview:PartnerTopicEventSubscription" }, { type: "azure-native:eventgrid/v20210601preview:PartnerTopicEventSubscription" }, { type: "azure-native:eventgrid/v20211015preview:PartnerTopicEventSubscription" }, { type: "azure-native:eventgrid/v20220615:PartnerTopicEventSubscription" }, { type: "azure-native:eventgrid/v20231215preview:PartnerTopicEventSubscription" }] };

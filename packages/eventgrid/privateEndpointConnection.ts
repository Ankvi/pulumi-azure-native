...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventgrid:PrivateEndpointConnection';
     ...
     */
    declare public readonly privateLinkServiceConnectionState: pulumi.Output<types.outputs.ConnectionStateResponse | undefined>;
    /**
    ...
    constructor(name: string, args: PrivateEndpointConnectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (!opts.id) {
            if (args?.parentName === undefined && !opts.urn) {

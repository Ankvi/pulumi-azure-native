...
export class PartnerDestination extends pulumi.CustomResource {
    ...
    constructor(name: string, args: PartnerDestinationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventgrid:PartnerDestination" }, { type: "azure-native:eventgrid/v20230601preview:PartnerDestination" }] };
...
export interface PartnerDestinationArgs {
     ...
     * Activation state of the partner destination.
     */
    activationState?: pulumi.Input<string | types.enums.v20211015preview.PartnerDestinationActivationState>;
    /**
     * Endpoint Base URL of the partner destination
     */
     ...
     * Provisioning state of the partner destination.
     */
    provisioningState?: pulumi.Input<string | types.enums.v20211015preview.PartnerDestinationProvisioningState>;
    /**

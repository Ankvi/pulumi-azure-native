...
export class NamespaceTopicEventSubscription extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventgrid:NamespaceTopicEventSubscription';
     ...
     */
    declare public readonly deliveryConfiguration: pulumi.Output<types.outputs.DeliveryConfigurationResponse | undefined>;
    /**
     ...
     */
    declare public readonly filtersConfiguration: pulumi.Output<types.outputs.FiltersConfigurationResponse | undefined>;
    /**
    ...
    constructor(name: string, args: NamespaceTopicEventSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventgrid/v20230601preview:NamespaceTopicEventSubscription" }, { type: "azure-native:eventgrid/v20231215preview:NamespaceTopicEventSubscription" }, { type: "azure-native:eventgrid/v20240601preview:NamespaceTopicEventSubscription" }, { type: "azure-native:eventgrid/v20241215preview:NamespaceTopicEventSubscription" }, { type: "azure-native:eventgrid/v20250215:NamespaceTopicEventSubscription" }, { type: "azure-native:eventgrid/v20250401preview:NamespaceTopicEventSubscription" }] };

...
export class NamespaceTopicEventSubscription extends pulumi.CustomResource {
    ...
    constructor(name: string, args: NamespaceTopicEventSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventgrid/v20230601preview:NamespaceTopicEventSubscription" }, { type: "azure-native:eventgrid/v20231215preview:NamespaceTopicEventSubscription" }, { type: "azure-native:eventgrid/v20240601preview:NamespaceTopicEventSubscription" }, { type: "azure-native:eventgrid/v20241215preview:NamespaceTopicEventSubscription" }] };

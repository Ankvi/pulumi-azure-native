...
export class ClientGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventgrid/v20231215preview:ClientGroup';
    ...
    constructor(name: string, args: ClientGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventgrid:ClientGroup" }, { type: "azure-native:eventgrid/v20230601preview:ClientGroup" }] };

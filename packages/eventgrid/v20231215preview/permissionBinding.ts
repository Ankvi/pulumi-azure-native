...
export class PermissionBinding extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventgrid/v20231215preview:PermissionBinding';
    ...
    constructor(name: string, args: PermissionBindingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventgrid:PermissionBinding" }, { type: "azure-native:eventgrid/v20230601preview:PermissionBinding" }] };

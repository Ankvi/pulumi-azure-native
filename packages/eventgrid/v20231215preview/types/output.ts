...
import * as pulumi from "@pulumi/pulumi";
     ...
     */
    export interface MonitorAlertEventSubscriptionDestinationResponse {
        /**
     ...
     */
    export interface NamespaceTopicEventSubscriptionDestinationResponse {
        /**
         * Type of the endpoint for the event subscription destination.
    ...
    export interface RoutingEnrichmentsResponse {
        ...
        static?: StaticStringRoutingEnrichmentResponse[];
    }
    ...
    export interface StaticStringRoutingEnrichmentResponse {
        /**
    ...
    export function webhookPartnerDestinationInfoResponseProvideDefaults(val: WebhookPartnerDestinationInfoResponse): WebhookPartnerDestinationInfoResponse {
        return {
            ...val,
            clientAuthentication: (val.clientAuthentication ? azureADPartnerClientAuthenticationResponseProvideDefaults(val.clientAuthentication) : undefined),

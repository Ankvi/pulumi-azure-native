...
export class TopicEventSubscription extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventgrid/v20231215preview:TopicEventSubscription';
    ...
    constructor(name: string, args: TopicEventSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventgrid:TopicEventSubscription" }, { type: "azure-native:eventgrid/v20211015preview:TopicEventSubscription" }, { type: "azure-native:eventgrid/v20220615:TopicEventSubscription" }, { type: "azure-native:eventgrid/v20230601preview:TopicEventSubscription" }] };

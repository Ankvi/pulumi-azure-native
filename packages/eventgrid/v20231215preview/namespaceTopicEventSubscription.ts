...
export class NamespaceTopicEventSubscription extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventgrid/v20231215preview:NamespaceTopicEventSubscription';
    ...
    constructor(name: string, args: NamespaceTopicEventSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventgrid:NamespaceTopicEventSubscription" }, { type: "azure-native:eventgrid/v20230601preview:NamespaceTopicEventSubscription" }] };

...
export interface ListWorkspaceKeysResult {
    ...
    readonly containerRegistryCredentials: types.outputs.machinelearningservices.v20220101preview.RegistryListCredentialsResultResponse;
    readonly notebookAccessKeys: types.outputs.machinelearningservices.v20220101preview.ListNotebookKeysResultResponse;

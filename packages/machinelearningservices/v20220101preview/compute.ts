...
export class Compute extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20220101preview:Compute';
     ...
     * Compute properties
     */
    public readonly properties!: pulumi.Output<types.outputs.machinelearningservices.v20220101preview.AKSResponse | types.outputs.machinelearningservices.v20220101preview.AmlComputeResponse | types.outputs.machinelearningservices.v20220101preview.ComputeInstanceResponse | types.outputs.machinelearningservices.v20220101preview.DataFactoryResponse | types.outputs.machinelearningservices.v20220101preview.DataLakeAnalyticsResponse | types.outputs.machinelearningservices.v20220101preview.DatabricksResponse | types.outputs.machinelearningservices.v20220101preview.HDInsightResponse | types.outputs.machinelearningservices.v20220101preview.KubernetesResponse | types.outputs.machinelearningservices.v20220101preview.SynapseSparkResponse | types.outputs.machinelearningservices.v20220101preview.VirtualMachineResponse>;
    /**
...
export interface ComputeArgs {
     ...
     * Compute properties
     */
    properties?: pulumi.Input<types.inputs.machinelearningservices.v20220101preview.AKSArgs | types.inputs.machinelearningservices.v20220101preview.AmlComputeArgs | types.inputs.machinelearningservices.v20220101preview.ComputeInstanceArgs | types.inputs.machinelearningservices.v20220101preview.DataFactoryArgs | types.inputs.machinelearningservices.v20220101preview.DataLakeAnalyticsArgs | types.inputs.machinelearningservices.v20220101preview.DatabricksArgs | types.inputs.machinelearningservices.v20220101preview.HDInsightArgs | types.inputs.machinelearningservices.v20220101preview.KubernetesArgs | types.inputs.machinelearningservices.v20220101preview.SynapseSparkArgs | types.inputs.machinelearningservices.v20220101preview.VirtualMachineArgs>;
    /**

...
export class InferenceGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices:InferenceGroup';
     ...
     */
    declare public readonly inferenceGroupProperties: pulumi.Output<types.outputs.InferenceGroupResponse>;
    /**
    ...
    constructor(name: string, args: InferenceGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices/v20230801preview:InferenceGroup" }, { type: "azure-native:machinelearningservices/v20240101preview:InferenceGroup" }, { type: "azure-native:machinelearningservices/v20240401preview:InferenceGroup" }, { type: "azure-native:machinelearningservices/v20241001preview:InferenceGroup" }, { type: "azure-native:machinelearningservices/v20250101preview:InferenceGroup" }, { type: "azure-native:machinelearningservices/v20250401preview:InferenceGroup" }, { type: "azure-native:machinelearningservices/v20250701preview:InferenceGroup" }] };

...
export class BatchEndpoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices:BatchEndpoint';
     ...
     */
    declare public readonly batchEndpointProperties: pulumi.Output<types.outputs.BatchEndpointResponse>;
    /**
    ...
    constructor(name: string, args: BatchEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (!opts.id) {
            if (args?.batchEndpointProperties === undefined && !opts.urn) {
            ...
            resourceInputs["batchEndpointProperties"] = args?.batchEndpointProperties;
...
export interface BatchEndpointArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    batchEndpointProperties: pulumi.Input<types.inputs.BatchEndpointArgs>;
    /**

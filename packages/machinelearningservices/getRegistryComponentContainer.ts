...
export function getRegistryComponentContainer(args: GetRegistryComponentContainerArgs, opts?: pulumi.InvokeOptions): Promise<GetRegistryComponentContainerResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices:getRegistryComponentContainer", {
 ...
 * Other available API versions: 2023-04-01-preview, 2023-06-01-preview, 2023-08-01-preview, 2023-10-01, 2024-01-01-preview, 2024-04-01, 2024-04-01-preview, 2024-07-01-preview, 2024-10-01, 2024-10-01-preview, 2025-01-01-preview.
 */
export function getRegistryComponentContainerOutput(args: GetRegistryComponentContainerOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRegistryComponentContainerResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure-native:machinelearningservices:getRegistryComponentContainer", {
        "componentName": args.componentName,
        "registryName": args.registryName,
        "resourceGroupName": args.resourceGroupName,
    }, opts);

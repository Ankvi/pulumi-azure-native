...
export class ComponentVersion extends pulumi.CustomResource {
     ...
     */
    declare public readonly componentVersionProperties: pulumi.Output<types.outputs.ComponentVersionResponse>;
    /**

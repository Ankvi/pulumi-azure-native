...
export class RegistryEnvironmentVersion extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices:RegistryEnvironmentVersion';
     ...
     */
    declare public readonly environmentVersionProperties: pulumi.Output<types.outputs.EnvironmentVersionResponse>;
    /**
    ...
    constructor(name: string, args: RegistryEnvironmentVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            if (args?.environmentVersionProperties === undefined && !opts.urn) {

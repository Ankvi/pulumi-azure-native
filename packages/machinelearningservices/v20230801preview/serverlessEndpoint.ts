...
export class ServerlessEndpoint extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ServerlessEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices:ServerlessEndpoint" }, { type: "azure-native:machinelearningservices/v20240101preview:ServerlessEndpoint" }] };

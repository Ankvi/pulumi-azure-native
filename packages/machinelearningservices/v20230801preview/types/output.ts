...
import * as pulumi from "@pulumi/pulumi";
     ...
     */
    export interface ComponentConfigurationResponse {
        /**
    ...
    export function computeInstancePropertiesResponseProvideDefaults(val: ComputeInstancePropertiesResponse): ComputeInstancePropertiesResponse {
        return {
            ...
            enableNodePublicIp: (val.enableNodePublicIp) ?? true,
            enableOSPatching: (val.enableOSPatching) ?? false,
            enableRootAccess: (val.enableRootAccess) ?? true,
            enableSSO: (val.enableSSO) ?? true,
            releaseQuotaOnStop: (val.releaseQuotaOnStop) ?? false,
     ...
     */
    export interface GenerationTokenUsageMetricThresholdResponse {
        /**
         * [Required] Gets or sets the feature attribution metric to calculate.
         */
        metric: string;
     ...
     */
    export interface GenerationTokenUsageSignalResponse {
        /**
         * [Required] Gets or sets the metrics to calculate and the corresponding thresholds.
         */
        metricThresholds: GenerationTokenUsageMetricThresholdResponse[];
        /**
         * The current notification mode for this signal.
         */
        notificationTypes?: string[];
    ...
    export interface MonitorDefinitionResponse {
         ...
         */
        signals: {[key: string]: CustomMonitoringSignalResponse | DataDriftMonitoringSignalResponse | DataQualityMonitoringSignalResponse | FeatureAttributionDriftMonitoringSignalResponse | GenerationSafetyQualityMonitoringSignalResponse | GenerationTokenUsageSignalResponse | ModelPerformanceSignalResponse | PredictionDriftMonitoringSignalResponse};
    }

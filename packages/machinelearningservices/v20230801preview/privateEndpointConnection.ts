...
export class PrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20230801preview:PrivateEndpointConnection';
...
export interface PrivateEndpointConnectionArgs {
     ...
     * The current provisioning state.
     */
    provisioningState?: pulumi.Input<string | types.enums.PrivateEndpointConnectionProvisioningState>;
    /**

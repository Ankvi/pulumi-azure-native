...
export class DataVersion extends pulumi.CustomResource {
     ...
     */
    declare public readonly dataVersionBaseProperties: pulumi.Output<types.outputs.MLTableDataResponse | types.outputs.UriFileDataVersionResponse | types.outputs.UriFolderDataVersionResponse>;
    /**

...
export interface ListWorkspaceKeysResult {
    ...
    readonly containerRegistryCredentials: types.outputs.machinelearningservices.v20200801.RegistryListCredentialsResultResponse;
    readonly notebookAccessKeys?: types.outputs.machinelearningservices.v20200801.NotebookListCredentialsResultResponse;

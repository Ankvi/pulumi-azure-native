...
export function getEnvironmentContainer(args: GetEnvironmentContainerArgs, opts?: pulumi.InvokeOptions): Promise<GetEnvironmentContainerResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20220201preview:getEnvironmentContainer", {
        "name": args.name,
...
export interface GetEnvironmentContainerResult {
     ...
     */
    readonly environmentContainerDetails: types.outputs.machinelearningservices.v20220201preview.EnvironmentContainerResponse;
    /**

...
export class DataVersion extends pulumi.CustomResource {
     ...
     */
    public readonly dataVersionBaseDetails!: pulumi.Output<types.outputs.MLTableDataResponse | types.outputs.UriFileDataVersionResponse | types.outputs.UriFolderDataVersionResponse>;
    /**
...
export interface DataVersionArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    dataVersionBaseDetails: pulumi.Input<types.inputs.MLTableDataArgs | types.inputs.UriFileDataVersionArgs | types.inputs.UriFolderDataVersionArgs>;
    /**
     * Container name.
     */

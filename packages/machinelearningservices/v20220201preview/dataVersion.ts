...
export class DataVersion extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20220201preview:DataVersion';
     ...
     */
    public readonly dataVersionBaseDetails!: pulumi.Output<types.outputs.machinelearningservices.v20220201preview.MLTableDataResponse | types.outputs.machinelearningservices.v20220201preview.UriFileDataVersionResponse | types.outputs.machinelearningservices.v20220201preview.UriFolderDataVersionResponse>;
    /**
    ...
    constructor(name: string, args: DataVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (!opts.id) {
            if ((!args || args.dataVersionBaseDetails === undefined) && !opts.urn) {
                throw new Error("Missing required property 'dataVersionBaseDetails'");
            }
            ...
            resourceInputs["dataVersionBaseDetails"] = args ? args.dataVersionBaseDetails : undefined;
...
export interface DataVersionArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    dataVersionBaseDetails: pulumi.Input<types.inputs.machinelearningservices.v20220201preview.MLTableDataArgs | types.inputs.machinelearningservices.v20220201preview.UriFileDataVersionArgs | types.inputs.machinelearningservices.v20220201preview.UriFolderDataVersionArgs>;
    /**
     * Container name.
     */

...
export function getComponentContainer(args: GetComponentContainerArgs, opts?: pulumi.InvokeOptions): Promise<GetComponentContainerResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20220201preview:getComponentContainer", {
        "name": args.name,
...
export interface GetComponentContainerResult {
     ...
     */
    readonly componentContainerDetails: types.outputs.machinelearningservices.v20220201preview.ComponentContainerResponse;
    /**

...
export function getComponentVersion(args: GetComponentVersionArgs, opts?: pulumi.InvokeOptions): Promise<GetComponentVersionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20220201preview:getComponentVersion", {
        "name": args.name,
...
export interface GetComponentVersionResult {
     ...
     */
    readonly componentVersionDetails: types.outputs.machinelearningservices.v20220201preview.ComponentVersionResponse;
    /**

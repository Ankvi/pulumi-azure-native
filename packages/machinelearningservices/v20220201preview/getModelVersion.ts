...
export function getModelVersion(args: GetModelVersionArgs, opts?: pulumi.InvokeOptions): Promise<GetModelVersionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20220201preview:getModelVersion", {
        "name": args.name,
...
export interface GetModelVersionResult {
     ...
     */
    readonly modelVersionDetails: types.outputs.machinelearningservices.v20220201preview.ModelVersionResponse;
    /**

...
export class CodeVersion extends pulumi.CustomResource {
     ...
     */
    public readonly codeVersionDetails!: pulumi.Output<types.outputs.CodeVersionResponse>;
    /**
    ...
    constructor(name: string, args: CodeVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["codeVersionDetails"] = args ? (args.codeVersionDetails ? pulumi.output(args.codeVersionDetails).apply(types.inputs.codeVersionArgsProvideDefaults) : undefined) : undefined;
...
export interface CodeVersionArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    codeVersionDetails: pulumi.Input<types.inputs.CodeVersionArgs>;
    /**

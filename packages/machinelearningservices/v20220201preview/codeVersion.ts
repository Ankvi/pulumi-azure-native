...
export class CodeVersion extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20220201preview:CodeVersion';
     ...
     */
    public readonly codeVersionDetails!: pulumi.Output<types.outputs.machinelearningservices.v20220201preview.CodeVersionResponse>;
    /**
    ...
    constructor(name: string, args: CodeVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (!opts.id) {
            if ((!args || args.codeVersionDetails === undefined) && !opts.urn) {
                throw new Error("Missing required property 'codeVersionDetails'");
            }
            ...
            resourceInputs["codeVersionDetails"] = args ? (args.codeVersionDetails ? pulumi.output(args.codeVersionDetails).apply(types.inputs.machinelearningservices.v20220201preview.codeVersionArgsProvideDefaults) : undefined) : undefined;
            ...
            resourceInputs["codeVersionDetails"] = undefined /*out*/;
            resourceInputs["name"] = undefined /*out*/;
            resourceInputs["systemData"] = undefined /*out*/;
            resourceInputs["type"] = undefined /*out*/;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices:CodeVersion" }, { type: "azure-native:machinelearningservices/v20210301preview:CodeVersion" }, { type: "azure-native:machinelearningservices/v20220501:CodeVersion" }, { type: "azure-native:machinelearningservices/v20220601preview:CodeVersion" }, { type: "azure-native:machinelearningservices/v20221001:CodeVersion" }, { type: "azure-native:machinelearningservices/v20221001preview:CodeVersion" }, { type: "azure-native:machinelearningservices/v20221201preview:CodeVersion" }, { type: "azure-native:machinelearningservices/v20230201preview:CodeVersion" }, { type: "azure-native:machinelearningservices/v20230401:CodeVersion" }, { type: "azure-native:machinelearningservices/v20230401preview:CodeVersion" }, { type: "azure-native:machinelearningservices/v20230601preview:CodeVersion" }] };
...
export interface CodeVersionArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    codeVersionDetails: pulumi.Input<types.inputs.machinelearningservices.v20220201preview.CodeVersionArgs>;
    /**

...
export class OnlineDeployment extends pulumi.CustomResource {
     ...
     */
    public readonly onlineDeploymentDetails!: pulumi.Output<types.outputs.machinelearningservices.v20220201preview.KubernetesOnlineDeploymentResponse | types.outputs.machinelearningservices.v20220201preview.ManagedOnlineDeploymentResponse>;
    /**
    ...
    constructor(name: string, args: OnlineDeploymentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices:OnlineDeployment" }, { type: "azure-native:machinelearningservices/v20210301preview:OnlineDeployment" }, { type: "azure-native:machinelearningservices/v20220501:OnlineDeployment" }, { type: "azure-native:machinelearningservices/v20220601preview:OnlineDeployment" }, { type: "azure-native:machinelearningservices/v20221001:OnlineDeployment" }, { type: "azure-native:machinelearningservices/v20221001preview:OnlineDeployment" }, { type: "azure-native:machinelearningservices/v20221201preview:OnlineDeployment" }, { type: "azure-native:machinelearningservices/v20230201preview:OnlineDeployment" }, { type: "azure-native:machinelearningservices/v20230401:OnlineDeployment" }, { type: "azure-native:machinelearningservices/v20230401preview:OnlineDeployment" }, { type: "azure-native:machinelearningservices/v20230601preview:OnlineDeployment" }] };
...
export interface OnlineDeploymentArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    onlineDeploymentDetails: pulumi.Input<types.inputs.machinelearningservices.v20220201preview.KubernetesOnlineDeploymentArgs | types.inputs.machinelearningservices.v20220201preview.ManagedOnlineDeploymentArgs>;
    /**

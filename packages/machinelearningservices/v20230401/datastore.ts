...
export class Datastore extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20230401:Datastore';
    ...
    constructor(name: string, args: DatastoreArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices:Datastore" }, { type: "azure-native:machinelearningservices/v20200501preview:Datastore" }, { type: "azure-native:machinelearningservices/v20210301preview:Datastore" }, { type: "azure-native:machinelearningservices/v20220201preview:Datastore" }, { type: "azure-native:machinelearningservices/v20220501:Datastore" }, { type: "azure-native:machinelearningservices/v20220601preview:Datastore" }, { type: "azure-native:machinelearningservices/v20221001:Datastore" }, { type: "azure-native:machinelearningservices/v20221001preview:Datastore" }, { type: "azure-native:machinelearningservices/v20221201preview:Datastore" }, { type: "azure-native:machinelearningservices/v20230201preview:Datastore" }, { type: "azure-native:machinelearningservices/v20230401preview:Datastore" }, { type: "azure-native:machinelearningservices/v20230601preview:Datastore" }, { type: "azure-native:machinelearningservices/v20230801preview:Datastore" }] };

...
export function listWorkspaceKeys(args: ListWorkspaceKeysArgs, opts?: pulumi.InvokeOptions): Promise<ListWorkspaceKeysResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20230401:listWorkspaceKeys", {
...
export interface ListWorkspaceKeysResult {
    ...
    readonly containerRegistryCredentials: types.outputs.machinelearningservices.v20230401.RegistryListCredentialsResultResponse;
    readonly notebookAccessKeys: types.outputs.machinelearningservices.v20230401.ListNotebookKeysResultResponse;

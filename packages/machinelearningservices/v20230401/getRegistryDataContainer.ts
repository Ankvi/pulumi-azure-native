...
export function getRegistryDataContainer(args: GetRegistryDataContainerArgs, opts?: pulumi.InvokeOptions): Promise<GetRegistryDataContainerResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20230401:getRegistryDataContainer", {
        "name": args.name,
...
export interface GetRegistryDataContainerResult {
     ...
     */
    readonly dataContainerProperties: types.outputs.machinelearningservices.v20230401.DataContainerResponse;
    /**

...
export class BatchDeployment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20230401:BatchDeployment';
     ...
     */
    public readonly batchDeploymentProperties!: pulumi.Output<types.outputs.machinelearningservices.v20230401.BatchDeploymentResponse>;
    /**
    ...
    constructor(name: string, args: BatchDeploymentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["batchDeploymentProperties"] = args ? (args.batchDeploymentProperties ? pulumi.output(args.batchDeploymentProperties).apply(types.inputs.machinelearningservices.v20230401.batchDeploymentArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices:BatchDeployment" }, { type: "azure-native:machinelearningservices/v20210301preview:BatchDeployment" }, { type: "azure-native:machinelearningservices/v20220201preview:BatchDeployment" }, { type: "azure-native:machinelearningservices/v20220501:BatchDeployment" }, { type: "azure-native:machinelearningservices/v20220601preview:BatchDeployment" }, { type: "azure-native:machinelearningservices/v20221001:BatchDeployment" }, { type: "azure-native:machinelearningservices/v20221001preview:BatchDeployment" }, { type: "azure-native:machinelearningservices/v20221201preview:BatchDeployment" }, { type: "azure-native:machinelearningservices/v20230201preview:BatchDeployment" }, { type: "azure-native:machinelearningservices/v20230401preview:BatchDeployment" }, { type: "azure-native:machinelearningservices/v20230601preview:BatchDeployment" }] };
...
export interface BatchDeploymentArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    batchDeploymentProperties: pulumi.Input<types.inputs.machinelearningservices.v20230401.BatchDeploymentArgs>;
    /**

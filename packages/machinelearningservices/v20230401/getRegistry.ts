...
export function getRegistry(args: GetRegistryArgs, opts?: pulumi.InvokeOptions): Promise<GetRegistryResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20230401:getRegistry", {
...
export interface GetRegistryResult {
     ...
     */
    readonly registryProperties: types.outputs.machinelearningservices.v20230401.RegistryResponse;
    /**

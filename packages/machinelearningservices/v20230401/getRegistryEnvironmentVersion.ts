...
export function getRegistryEnvironmentVersion(args: GetRegistryEnvironmentVersionArgs, opts?: pulumi.InvokeOptions): Promise<GetRegistryEnvironmentVersionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20230401:getRegistryEnvironmentVersion", {
...
export interface GetRegistryEnvironmentVersionResult {
     ...
     */
    readonly environmentVersionProperties: types.outputs.machinelearningservices.v20230401.EnvironmentVersionResponse;
    /**

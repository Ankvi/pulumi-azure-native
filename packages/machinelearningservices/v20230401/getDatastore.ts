...
export function getDatastore(args: GetDatastoreArgs, opts?: pulumi.InvokeOptions): Promise<GetDatastoreResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20230401:getDatastore", {
        "name": args.name,
...
export interface GetDatastoreResult {
     ...
     */
    readonly datastoreProperties: types.outputs.machinelearningservices.v20230401.AzureBlobDatastoreResponse | types.outputs.machinelearningservices.v20230401.AzureDataLakeGen1DatastoreResponse | types.outputs.machinelearningservices.v20230401.AzureDataLakeGen2DatastoreResponse | types.outputs.machinelearningservices.v20230401.AzureFileDatastoreResponse;
    /**

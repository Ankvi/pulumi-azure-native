...
export class RegistryEnvironmentVersion extends pulumi.CustomResource {
     ...
     */
    public readonly environmentVersionProperties!: pulumi.Output<types.outputs.machinelearningservices.v20230401.EnvironmentVersionResponse>;
    /**
    ...
    constructor(name: string, args: RegistryEnvironmentVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["environmentVersionProperties"] = args ? (args.environmentVersionProperties ? pulumi.output(args.environmentVersionProperties).apply(types.inputs.machinelearningservices.v20230401.environmentVersionArgsProvideDefaults) : undefined) : undefined;
...
export interface RegistryEnvironmentVersionArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    environmentVersionProperties: pulumi.Input<types.inputs.machinelearningservices.v20230401.EnvironmentVersionArgs>;
    /**

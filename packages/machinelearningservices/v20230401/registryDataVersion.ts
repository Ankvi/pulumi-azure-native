...
export class RegistryDataVersion extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20230401:RegistryDataVersion';
     ...
     */
    public readonly dataVersionBaseProperties!: pulumi.Output<types.outputs.machinelearningservices.v20230401.MLTableDataResponse | types.outputs.machinelearningservices.v20230401.UriFileDataVersionResponse | types.outputs.machinelearningservices.v20230401.UriFolderDataVersionResponse>;
    /**
    ...
    constructor(name: string, args: RegistryDataVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices:RegistryDataVersion" }, { type: "azure-native:machinelearningservices/v20230201preview:RegistryDataVersion" }, { type: "azure-native:machinelearningservices/v20230401preview:RegistryDataVersion" }, { type: "azure-native:machinelearningservices/v20230601preview:RegistryDataVersion" }] };
...
export interface RegistryDataVersionArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    dataVersionBaseProperties: pulumi.Input<types.inputs.machinelearningservices.v20230401.MLTableDataArgs | types.inputs.machinelearningservices.v20230401.UriFileDataVersionArgs | types.inputs.machinelearningservices.v20230401.UriFolderDataVersionArgs>;
    /**
     * Container name.
     */

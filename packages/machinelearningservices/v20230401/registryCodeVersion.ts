...
export class RegistryCodeVersion extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20230401:RegistryCodeVersion';
     ...
     */
    public readonly codeVersionProperties!: pulumi.Output<types.outputs.machinelearningservices.v20230401.CodeVersionResponse>;
    /**
    ...
    constructor(name: string, args: RegistryCodeVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["codeVersionProperties"] = args ? (args.codeVersionProperties ? pulumi.output(args.codeVersionProperties).apply(types.inputs.machinelearningservices.v20230401.codeVersionArgsProvideDefaults) : undefined) : undefined;
...
export interface RegistryCodeVersionArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    codeVersionProperties: pulumi.Input<types.inputs.machinelearningservices.v20230401.CodeVersionArgs>;
    /**

...
export class RegistryCodeContainer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20230401:RegistryCodeContainer';
     ...
     */
    public readonly codeContainerProperties!: pulumi.Output<types.outputs.machinelearningservices.v20230401.CodeContainerResponse>;
    /**
    ...
    constructor(name: string, args: RegistryCodeContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["codeContainerProperties"] = args ? (args.codeContainerProperties ? pulumi.output(args.codeContainerProperties).apply(types.inputs.machinelearningservices.v20230401.codeContainerArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices:RegistryCodeContainer" }, { type: "azure-native:machinelearningservices/v20221001preview:RegistryCodeContainer" }, { type: "azure-native:machinelearningservices/v20221201preview:RegistryCodeContainer" }, { type: "azure-native:machinelearningservices/v20230201preview:RegistryCodeContainer" }, { type: "azure-native:machinelearningservices/v20230401preview:RegistryCodeContainer" }, { type: "azure-native:machinelearningservices/v20230601preview:RegistryCodeContainer" }] };
...
export interface RegistryCodeContainerArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    codeContainerProperties: pulumi.Input<types.inputs.machinelearningservices.v20230401.CodeContainerArgs>;
    /**
     * Container name.
     */

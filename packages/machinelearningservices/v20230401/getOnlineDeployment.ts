...
export interface GetOnlineDeploymentResult {
     ...
     */
    readonly onlineDeploymentProperties: types.outputs.machinelearningservices.v20230401.KubernetesOnlineDeploymentResponse | types.outputs.machinelearningservices.v20230401.ManagedOnlineDeploymentResponse;
    /**

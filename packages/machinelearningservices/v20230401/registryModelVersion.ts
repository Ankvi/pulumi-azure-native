...
export class RegistryModelVersion extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20230401:RegistryModelVersion';
     ...
     */
    public readonly modelVersionProperties!: pulumi.Output<types.outputs.machinelearningservices.v20230401.ModelVersionResponse>;
    /**
    ...
    constructor(name: string, args: RegistryModelVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["modelVersionProperties"] = args ? (args.modelVersionProperties ? pulumi.output(args.modelVersionProperties).apply(types.inputs.machinelearningservices.v20230401.modelVersionArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices:RegistryModelVersion" }, { type: "azure-native:machinelearningservices/v20221001preview:RegistryModelVersion" }, { type: "azure-native:machinelearningservices/v20221201preview:RegistryModelVersion" }, { type: "azure-native:machinelearningservices/v20230201preview:RegistryModelVersion" }, { type: "azure-native:machinelearningservices/v20230401preview:RegistryModelVersion" }, { type: "azure-native:machinelearningservices/v20230601preview:RegistryModelVersion" }] };
...
export interface RegistryModelVersionArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    modelVersionProperties: pulumi.Input<types.inputs.machinelearningservices.v20230401.ModelVersionArgs>;
    /**

...
export class OnlineDeployment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20230401:OnlineDeployment';
     ...
     */
    public readonly onlineDeploymentProperties!: pulumi.Output<types.outputs.machinelearningservices.v20230401.KubernetesOnlineDeploymentResponse | types.outputs.machinelearningservices.v20230401.ManagedOnlineDeploymentResponse>;
    /**
...
export interface OnlineDeploymentArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    onlineDeploymentProperties: pulumi.Input<types.inputs.machinelearningservices.v20230401.KubernetesOnlineDeploymentArgs | types.inputs.machinelearningservices.v20230401.ManagedOnlineDeploymentArgs>;
    /**

...
export interface GetDatastoreResult {
     ...
     */
    readonly datastoreProperties: types.outputs.AzureBlobDatastoreResponse | types.outputs.AzureDataLakeGen1DatastoreResponse | types.outputs.AzureDataLakeGen2DatastoreResponse | types.outputs.AzureFileDatastoreResponse | types.outputs.OneLakeDatastoreResponse;
    /**

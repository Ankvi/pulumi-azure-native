...
export class InferencePool extends pulumi.CustomResource {
     ...
     */
    declare public readonly inferencePoolProperties: pulumi.Output<types.outputs.InferencePoolResponse>;
    /**

...
export class RegistryDataVersion extends pulumi.CustomResource {
    ...
    constructor(name: string, args: RegistryDataVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices:RegistryDataVersion" }, { type: "azure-native:machinelearningservices/v20230201preview:RegistryDataVersion" }, { type: "azure-native:machinelearningservices/v20230401:RegistryDataVersion" }, { type: "azure-native:machinelearningservices/v20230601preview:RegistryDataVersion" }, { type: "azure-native:machinelearningservices/v20230801preview:RegistryDataVersion" }] };

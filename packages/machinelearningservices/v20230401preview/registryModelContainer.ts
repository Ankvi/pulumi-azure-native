...
export class RegistryModelContainer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20230401preview:RegistryModelContainer';
     ...
     */
    public readonly modelContainerProperties!: pulumi.Output<types.outputs.machinelearningservices.v20230401preview.ModelContainerResponse>;
    /**
    ...
    constructor(name: string, args: RegistryModelContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["modelContainerProperties"] = args ? (args.modelContainerProperties ? pulumi.output(args.modelContainerProperties).apply(types.inputs.machinelearningservices.v20230401preview.modelContainerArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices:RegistryModelContainer" }, { type: "azure-native:machinelearningservices/v20221001preview:RegistryModelContainer" }, { type: "azure-native:machinelearningservices/v20221201preview:RegistryModelContainer" }, { type: "azure-native:machinelearningservices/v20230201preview:RegistryModelContainer" }, { type: "azure-native:machinelearningservices/v20230401:RegistryModelContainer" }, { type: "azure-native:machinelearningservices/v20230601preview:RegistryModelContainer" }] };
...
export interface RegistryModelContainerArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    modelContainerProperties: pulumi.Input<types.inputs.machinelearningservices.v20230401preview.ModelContainerArgs>;
    /**
     * Container name.
     */

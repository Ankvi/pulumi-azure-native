...
export function getFeaturestoreEntityContainerEntity(args: GetFeaturestoreEntityContainerEntityArgs, opts?: pulumi.InvokeOptions): Promise<GetFeaturestoreEntityContainerEntityResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20230401preview:getFeaturestoreEntityContainerEntity", {
        "name": args.name,
...
export interface GetFeaturestoreEntityContainerEntityResult {
     ...
     */
    readonly featurestoreEntityContainerProperties: types.outputs.machinelearningservices.v20230401preview.FeaturestoreEntityContainerResponse;
    /**

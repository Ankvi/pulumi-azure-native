...
export function getLabelingJob(args: GetLabelingJobArgs, opts?: pulumi.InvokeOptions): Promise<GetLabelingJobResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20230401preview:getLabelingJob", {
        "id": args.id,
...
export interface GetLabelingJobResult {
     ...
     */
    readonly labelingJobProperties: types.outputs.machinelearningservices.v20230401preview.LabelingJobResponse;
    /**

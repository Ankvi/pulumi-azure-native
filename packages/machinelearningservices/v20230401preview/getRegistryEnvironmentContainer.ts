...
export function getRegistryEnvironmentContainer(args: GetRegistryEnvironmentContainerArgs, opts?: pulumi.InvokeOptions): Promise<GetRegistryEnvironmentContainerResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20230401preview:getRegistryEnvironmentContainer", {
...
export interface GetRegistryEnvironmentContainerResult {
     ...
     */
    readonly environmentContainerProperties: types.outputs.machinelearningservices.v20230401preview.EnvironmentContainerResponse;
    /**

...
export class ManagedNetworkSettingsRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20230401preview:ManagedNetworkSettingsRule';
    ...
    constructor(name: string, args: ManagedNetworkSettingsRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices:ManagedNetworkSettingsRule" }, { type: "azure-native:machinelearningservices/v20230601preview:ManagedNetworkSettingsRule" }, { type: "azure-native:machinelearningservices/v20230801preview:ManagedNetworkSettingsRule" }] };

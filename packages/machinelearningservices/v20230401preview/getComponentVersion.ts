...
export function getComponentVersion(args: GetComponentVersionArgs, opts?: pulumi.InvokeOptions): Promise<GetComponentVersionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20230401preview:getComponentVersion", {
        "name": args.name,
...
export interface GetComponentVersionResult {
     ...
     */
    readonly componentVersionProperties: types.outputs.machinelearningservices.v20230401preview.ComponentVersionResponse;
    /**

...
export class RegistryDataContainer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20230401preview:RegistryDataContainer';
     ...
     */
    public readonly dataContainerProperties!: pulumi.Output<types.outputs.machinelearningservices.v20230401preview.DataContainerResponse>;
    /**
    ...
    constructor(name: string, args: RegistryDataContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["dataContainerProperties"] = args ? (args.dataContainerProperties ? pulumi.output(args.dataContainerProperties).apply(types.inputs.machinelearningservices.v20230401preview.dataContainerArgsProvideDefaults) : undefined) : undefined;
...
export interface RegistryDataContainerArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    dataContainerProperties: pulumi.Input<types.inputs.machinelearningservices.v20230401preview.DataContainerArgs>;
    /**
     * Container name.
     */

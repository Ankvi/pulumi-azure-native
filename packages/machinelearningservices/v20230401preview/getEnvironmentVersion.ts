...
export function getEnvironmentVersion(args: GetEnvironmentVersionArgs, opts?: pulumi.InvokeOptions): Promise<GetEnvironmentVersionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20230401preview:getEnvironmentVersion", {
        "name": args.name,
...
export interface GetEnvironmentVersionResult {
     ...
     */
    readonly environmentVersionProperties: types.outputs.machinelearningservices.v20230401preview.EnvironmentVersionResponse;
    /**

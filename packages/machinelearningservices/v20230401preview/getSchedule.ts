...
export function getSchedule(args: GetScheduleArgs, opts?: pulumi.InvokeOptions): Promise<GetScheduleResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20230401preview:getSchedule", {
        "name": args.name,
...
export interface GetScheduleResult {
     ...
     */
    readonly scheduleProperties: types.outputs.machinelearningservices.v20230401preview.ScheduleResponse;
    /**

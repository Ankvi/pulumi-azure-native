...
export function getBatchDeployment(args: GetBatchDeploymentArgs, opts?: pulumi.InvokeOptions): Promise<GetBatchDeploymentResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20230401preview:getBatchDeployment", {
...
export interface GetBatchDeploymentResult {
     ...
     */
    readonly batchDeploymentProperties: types.outputs.machinelearningservices.v20230401preview.BatchDeploymentResponse;
    /**

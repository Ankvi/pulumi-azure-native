...
export function getRegistryCodeVersion(args: GetRegistryCodeVersionArgs, opts?: pulumi.InvokeOptions): Promise<GetRegistryCodeVersionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20230401preview:getRegistryCodeVersion", {
...
export interface GetRegistryCodeVersionResult {
     ...
     */
    readonly codeVersionProperties: types.outputs.machinelearningservices.v20230401preview.CodeVersionResponse;
    /**

...
export class RegistryCodeContainer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20230401preview:RegistryCodeContainer';
     ...
     */
    public readonly codeContainerProperties!: pulumi.Output<types.outputs.machinelearningservices.v20230401preview.CodeContainerResponse>;
    /**
    ...
    constructor(name: string, args: RegistryCodeContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["codeContainerProperties"] = args ? (args.codeContainerProperties ? pulumi.output(args.codeContainerProperties).apply(types.inputs.machinelearningservices.v20230401preview.codeContainerArgsProvideDefaults) : undefined) : undefined;
...
export interface RegistryCodeContainerArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    codeContainerProperties: pulumi.Input<types.inputs.machinelearningservices.v20230401preview.CodeContainerArgs>;
    /**
     * Container name.
     */

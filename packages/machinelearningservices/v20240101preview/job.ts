...
export class Job extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20240101preview:Job';
     ...
     */
    public readonly jobBaseProperties!: pulumi.Output<types.outputs.AutoMLJobResponse | types.outputs.CommandJobResponse | types.outputs.FineTuningJobResponse | types.outputs.LabelingJobResponse | types.outputs.PipelineJobResponse | types.outputs.SparkJobResponse | types.outputs.SweepJobResponse>;
    /**
...
export interface JobArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    jobBaseProperties: pulumi.Input<types.inputs.AutoMLJobArgs | types.inputs.CommandJobArgs | types.inputs.FineTuningJobArgs | types.inputs.LabelingJobArgs | types.inputs.PipelineJobArgs | types.inputs.SparkJobArgs | types.inputs.SweepJobArgs>;
    /**

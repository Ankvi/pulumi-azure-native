...
export class CapacityReservationGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20240101preview:CapacityReservationGroup';
    ...
    constructor(name: string, args: CapacityReservationGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices:CapacityReservationGroup" }, { type: "azure-native:machinelearningservices/v20230801preview:CapacityReservationGroup" }] };

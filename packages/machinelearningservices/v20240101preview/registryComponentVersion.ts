...
export class RegistryComponentVersion extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20240101preview:RegistryComponentVersion';
    ...
    constructor(name: string, args: RegistryComponentVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices:RegistryComponentVersion" }, { type: "azure-native:machinelearningservices/v20221001preview:RegistryComponentVersion" }, { type: "azure-native:machinelearningservices/v20221201preview:RegistryComponentVersion" }, { type: "azure-native:machinelearningservices/v20230201preview:RegistryComponentVersion" }, { type: "azure-native:machinelearningservices/v20230401:RegistryComponentVersion" }, { type: "azure-native:machinelearningservices/v20230401preview:RegistryComponentVersion" }, { type: "azure-native:machinelearningservices/v20230601preview:RegistryComponentVersion" }, { type: "azure-native:machinelearningservices/v20230801preview:RegistryComponentVersion" }, { type: "azure-native:machinelearningservices/v20231001:RegistryComponentVersion" }] };

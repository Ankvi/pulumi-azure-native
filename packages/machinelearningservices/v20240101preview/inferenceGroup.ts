...
export class InferenceGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20240101preview:InferenceGroup';
    ...
    constructor(name: string, args: InferenceGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices:InferenceGroup" }, { type: "azure-native:machinelearningservices/v20230801preview:InferenceGroup" }] };

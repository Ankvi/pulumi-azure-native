...
export class CapacityReservationGroup extends pulumi.CustomResource {
     ...
     */
    declare public readonly capacityReservationGroupProperties: pulumi.Output<types.outputs.CapacityReservationGroupResponse>;
    /**
    ...
    constructor(name: string, args: CapacityReservationGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["capacityReservationGroupProperties"] = args?.capacityReservationGroupProperties;

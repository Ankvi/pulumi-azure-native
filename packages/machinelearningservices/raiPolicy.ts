...
export class RaiPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, args: RaiPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices/v20240401preview:RaiPolicy" }, { type: "azure-native:machinelearningservices/v20240701preview:RaiPolicy" }, { type: "azure-native:machinelearningservices/v20241001preview:RaiPolicy" }, { type: "azure-native:machinelearningservices/v20250101preview:RaiPolicy" }, { type: "azure-native:machinelearningservices/v20250401preview:RaiPolicy" }, { type: "azure-native:machinelearningservices/v20250701preview:RaiPolicy" }] };

...
export class FeaturestoreEntityContainerEntity extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20231001:FeaturestoreEntityContainerEntity';
    ...
    constructor(name: string, args: FeaturestoreEntityContainerEntityArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices:FeaturestoreEntityContainerEntity" }, { type: "azure-native:machinelearningservices/v20230201preview:FeaturestoreEntityContainerEntity" }, { type: "azure-native:machinelearningservices/v20230401preview:FeaturestoreEntityContainerEntity" }, { type: "azure-native:machinelearningservices/v20230601preview:FeaturestoreEntityContainerEntity" }, { type: "azure-native:machinelearningservices/v20230801preview:FeaturestoreEntityContainerEntity" }, { type: "azure-native:machinelearningservices/v20240101preview:FeaturestoreEntityContainerEntity" }] };

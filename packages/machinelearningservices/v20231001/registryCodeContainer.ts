...
export class RegistryCodeContainer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20231001:RegistryCodeContainer';

...
export class CodeContainer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20210301preview:CodeContainer';
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.CodeContainerResponse>;
    /**
...
export interface CodeContainerArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    properties: pulumi.Input<types.inputs.CodeContainerArgs>;
    /**

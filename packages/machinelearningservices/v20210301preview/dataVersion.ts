...
export class DataVersion extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.machinelearningservices.v20210301preview.DataVersionResponse>;
    /**
...
export interface DataVersionArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    properties: pulumi.Input<types.inputs.machinelearningservices.v20210301preview.DataVersionArgs>;
    /**

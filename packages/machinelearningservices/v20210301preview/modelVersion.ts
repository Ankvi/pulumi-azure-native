...
export class ModelVersion extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.machinelearningservices.v20210301preview.ModelVersionResponse>;
    /**
...
export interface ModelVersionArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    properties: pulumi.Input<types.inputs.machinelearningservices.v20210301preview.ModelVersionArgs>;
    /**

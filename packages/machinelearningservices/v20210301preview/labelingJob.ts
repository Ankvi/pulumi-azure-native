...
export class LabelingJob extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.machinelearningservices.v20210301preview.LabelingJobResponse>;
    /**
    ...
    constructor(name: string, args: LabelingJobArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices:LabelingJob" }, { type: "azure-native:machinelearningservices/v20200901preview:LabelingJob" }, { type: "azure-native:machinelearningservices/v20220601preview:LabelingJob" }, { type: "azure-native:machinelearningservices/v20221001preview:LabelingJob" }, { type: "azure-native:machinelearningservices/v20221201preview:LabelingJob" }, { type: "azure-native:machinelearningservices/v20230201preview:LabelingJob" }, { type: "azure-native:machinelearningservices/v20230401preview:LabelingJob" }, { type: "azure-native:machinelearningservices/v20230601preview:LabelingJob" }] };
...
export interface LabelingJobArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    properties: pulumi.Input<types.inputs.machinelearningservices.v20210301preview.LabelingJobArgs>;
    /**

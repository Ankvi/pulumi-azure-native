...
export function getEnvironmentContainer(args: GetEnvironmentContainerArgs, opts?: pulumi.InvokeOptions): Promise<GetEnvironmentContainerResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20210301preview:getEnvironmentContainer", {
        "name": args.name,
...
export interface GetEnvironmentContainerResult {
     ...
     */
    readonly properties: types.outputs.machinelearningservices.v20210301preview.EnvironmentContainerResponse;
    /**

...
export function getCodeContainer(args: GetCodeContainerArgs, opts?: pulumi.InvokeOptions): Promise<GetCodeContainerResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices:getCodeContainer", {
        "name": args.name,
...
export interface GetCodeContainerResult {
     ...
     */
    readonly codeContainerProperties: types.outputs.machinelearningservices.CodeContainerResponse;
    /**

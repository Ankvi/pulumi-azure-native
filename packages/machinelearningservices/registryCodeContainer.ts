...
export class RegistryCodeContainer extends pulumi.CustomResource {
     ...
     */
    declare public readonly codeContainerProperties: pulumi.Output<types.outputs.CodeContainerResponse>;
    /**
    ...
    constructor(name: string, args: RegistryCodeContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (!opts.id) {
            if (args?.codeContainerProperties === undefined && !opts.urn) {

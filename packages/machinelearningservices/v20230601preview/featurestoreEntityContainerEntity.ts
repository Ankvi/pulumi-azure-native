...
export class FeaturestoreEntityContainerEntity extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20230601preview:FeaturestoreEntityContainerEntity';
     ...
     */
    public readonly featurestoreEntityContainerProperties!: pulumi.Output<types.outputs.machinelearningservices.v20230601preview.FeaturestoreEntityContainerResponse>;
    /**
    ...
    constructor(name: string, args: FeaturestoreEntityContainerEntityArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["featurestoreEntityContainerProperties"] = args ? (args.featurestoreEntityContainerProperties ? pulumi.output(args.featurestoreEntityContainerProperties).apply(types.inputs.machinelearningservices.v20230601preview.featurestoreEntityContainerArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices:FeaturestoreEntityContainerEntity" }, { type: "azure-native:machinelearningservices/v20230201preview:FeaturestoreEntityContainerEntity" }, { type: "azure-native:machinelearningservices/v20230401preview:FeaturestoreEntityContainerEntity" }] };
...
export interface FeaturestoreEntityContainerEntityArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    featurestoreEntityContainerProperties: pulumi.Input<types.inputs.machinelearningservices.v20230601preview.FeaturestoreEntityContainerArgs>;
    /**

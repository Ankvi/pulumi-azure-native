...
export class FeaturestoreEntityContainerEntity extends pulumi.CustomResource {
    ...
    constructor(name: string, args: FeaturestoreEntityContainerEntityArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices:FeaturestoreEntityContainerEntity" }, { type: "azure-native:machinelearningservices/v20230201preview:FeaturestoreEntityContainerEntity" }, { type: "azure-native:machinelearningservices/v20230401preview:FeaturestoreEntityContainerEntity" }, { type: "azure-native:machinelearningservices/v20230801preview:FeaturestoreEntityContainerEntity" }] };

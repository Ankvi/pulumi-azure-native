...
export function getFeaturestoreEntityVersion(args: GetFeaturestoreEntityVersionArgs, opts?: pulumi.InvokeOptions): Promise<GetFeaturestoreEntityVersionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20230601preview:getFeaturestoreEntityVersion", {
        "name": args.name,
...
export interface GetFeaturestoreEntityVersionResult {
     ...
     */
    readonly featurestoreEntityVersionProperties: types.outputs.machinelearningservices.v20230601preview.FeaturestoreEntityVersionResponse;
    /**

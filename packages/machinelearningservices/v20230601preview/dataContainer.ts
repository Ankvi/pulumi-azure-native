...
export class DataContainer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20230601preview:DataContainer';
     ...
     */
    public readonly dataContainerProperties!: pulumi.Output<types.outputs.machinelearningservices.v20230601preview.DataContainerResponse>;
    /**
    ...
    constructor(name: string, args: DataContainerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["dataContainerProperties"] = args ? (args.dataContainerProperties ? pulumi.output(args.dataContainerProperties).apply(types.inputs.machinelearningservices.v20230601preview.dataContainerArgsProvideDefaults) : undefined) : undefined;
...
export interface DataContainerArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    dataContainerProperties: pulumi.Input<types.inputs.machinelearningservices.v20230601preview.DataContainerArgs>;
    /**
     * Container name.
     */

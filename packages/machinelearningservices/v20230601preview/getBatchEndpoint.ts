...
export function getBatchEndpoint(args: GetBatchEndpointArgs, opts?: pulumi.InvokeOptions): Promise<GetBatchEndpointResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20230601preview:getBatchEndpoint", {
...
export interface GetBatchEndpointResult {
     ...
     */
    readonly batchEndpointProperties: types.outputs.machinelearningservices.v20230601preview.BatchEndpointResponse;
    /**

...
export class Registry extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20230601preview:Registry';
     ...
     */
    public readonly registryProperties!: pulumi.Output<types.outputs.machinelearningservices.v20230601preview.RegistryResponse>;
    /**
    ...
    constructor(name: string, args: RegistryArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices:Registry" }, { type: "azure-native:machinelearningservices/v20221001preview:Registry" }, { type: "azure-native:machinelearningservices/v20221201preview:Registry" }, { type: "azure-native:machinelearningservices/v20230201preview:Registry" }, { type: "azure-native:machinelearningservices/v20230401:Registry" }, { type: "azure-native:machinelearningservices/v20230401preview:Registry" }] };
...
export interface RegistryArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    registryProperties: pulumi.Input<types.inputs.machinelearningservices.v20230601preview.RegistryArgs>;
    /**

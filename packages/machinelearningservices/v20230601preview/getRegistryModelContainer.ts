...
export function getRegistryModelContainer(args: GetRegistryModelContainerArgs, opts?: pulumi.InvokeOptions): Promise<GetRegistryModelContainerResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20230601preview:getRegistryModelContainer", {
...
export interface GetRegistryModelContainerResult {
     ...
     */
    readonly modelContainerProperties: types.outputs.machinelearningservices.v20230601preview.ModelContainerResponse;
    /**

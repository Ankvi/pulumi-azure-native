...
export class RegistryEnvironmentVersion extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20230601preview:RegistryEnvironmentVersion';

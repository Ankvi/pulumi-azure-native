...
export class Job extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20230601preview:Job';
     ...
     */
    public readonly jobBaseProperties!: pulumi.Output<types.outputs.machinelearningservices.v20230601preview.AutoMLJobResponse | types.outputs.machinelearningservices.v20230601preview.CommandJobResponse | types.outputs.machinelearningservices.v20230601preview.LabelingJobResponse | types.outputs.machinelearningservices.v20230601preview.PipelineJobResponse | types.outputs.machinelearningservices.v20230601preview.SparkJobResponse | types.outputs.machinelearningservices.v20230601preview.SweepJobResponse>;
    /**
...
export interface JobArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    jobBaseProperties: pulumi.Input<types.inputs.machinelearningservices.v20230601preview.AutoMLJobArgs | types.inputs.machinelearningservices.v20230601preview.CommandJobArgs | types.inputs.machinelearningservices.v20230601preview.LabelingJobArgs | types.inputs.machinelearningservices.v20230601preview.PipelineJobArgs | types.inputs.machinelearningservices.v20230601preview.SparkJobArgs | types.inputs.machinelearningservices.v20230601preview.SweepJobArgs>;
    /**

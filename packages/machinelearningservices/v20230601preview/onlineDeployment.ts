...
export class OnlineDeployment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:machinelearningservices/v20230601preview:OnlineDeployment';
     ...
     */
    public readonly onlineDeploymentProperties!: pulumi.Output<types.outputs.machinelearningservices.v20230601preview.KubernetesOnlineDeploymentResponse | types.outputs.machinelearningservices.v20230601preview.ManagedOnlineDeploymentResponse>;
    /**
...
export interface OnlineDeploymentArgs {
     ...
     * [Required] Additional attributes of the entity.
     */
    onlineDeploymentProperties: pulumi.Input<types.inputs.machinelearningservices.v20230601preview.KubernetesOnlineDeploymentArgs | types.inputs.machinelearningservices.v20230601preview.ManagedOnlineDeploymentArgs>;
    /**

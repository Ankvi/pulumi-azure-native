...
export class ManagedNetworkSettingsRule extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.machinelearningservices.v20230601preview.FqdnOutboundRuleResponse | types.outputs.machinelearningservices.v20230601preview.PrivateEndpointOutboundRuleResponse | types.outputs.machinelearningservices.v20230601preview.ServiceTagOutboundRuleResponse>;
    /**
    ...
    constructor(name: string, args: ManagedNetworkSettingsRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:machinelearningservices:ManagedNetworkSettingsRule" }, { type: "azure-native:machinelearningservices/v20230401preview:ManagedNetworkSettingsRule" }] };
...
export interface ManagedNetworkSettingsRuleArgs {
     ...
     * Outbound Rule for the managed network of a machine learning workspace.
     */
    properties: pulumi.Input<types.inputs.machinelearningservices.v20230601preview.FqdnOutboundRuleArgs | types.inputs.machinelearningservices.v20230601preview.PrivateEndpointOutboundRuleArgs | types.inputs.machinelearningservices.v20230601preview.ServiceTagOutboundRuleArgs>;
    /**

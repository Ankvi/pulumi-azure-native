...
export interface GetManagedNetworkSettingsRuleResult {
     ...
     */
    readonly properties: types.outputs.machinelearningservices.v20230601preview.FqdnOutboundRuleResponse | types.outputs.machinelearningservices.v20230601preview.PrivateEndpointOutboundRuleResponse | types.outputs.machinelearningservices.v20230601preview.ServiceTagOutboundRuleResponse;
    /**

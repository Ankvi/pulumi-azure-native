...
export function getRegistryModelVersion(args: GetRegistryModelVersionArgs, opts?: pulumi.InvokeOptions): Promise<GetRegistryModelVersionResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20230601preview:getRegistryModelVersion", {
...
export interface GetRegistryModelVersionResult {
     ...
     */
    readonly modelVersionProperties: types.outputs.machinelearningservices.v20230601preview.ModelVersionResponse;
    /**

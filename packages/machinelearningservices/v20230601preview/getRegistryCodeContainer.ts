...
export function getRegistryCodeContainer(args: GetRegistryCodeContainerArgs, opts?: pulumi.InvokeOptions): Promise<GetRegistryCodeContainerResult> {
    ...
    return pulumi.runtime.invoke("azure-native:machinelearningservices/v20230601preview:getRegistryCodeContainer", {
...
export interface GetRegistryCodeContainerResult {
     ...
     */
    readonly codeContainerProperties: types.outputs.machinelearningservices.v20230601preview.CodeContainerResponse;
    /**

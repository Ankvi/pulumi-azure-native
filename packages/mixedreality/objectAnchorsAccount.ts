...
export class ObjectAnchorsAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:mixedreality:ObjectAnchorsAccount';
    ...
    declare public readonly identity: pulumi.Output<types.outputs.ObjectAnchorsAccountResponseIdentity | undefined>;
    /**
     * The kind of account, if supported
     */
    declare public readonly kind: pulumi.Output<types.outputs.SkuResponse | undefined>;
    /**
     ...
     */
    declare public readonly plan: pulumi.Output<types.outputs.IdentityResponse | undefined>;
    /**

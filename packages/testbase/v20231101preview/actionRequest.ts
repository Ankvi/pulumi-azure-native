...
export class ActionRequest extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:testbase/v20231101preview:ActionRequest';
    ...
    constructor(name: string, args: ActionRequestArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:testbase:ActionRequest" }] };

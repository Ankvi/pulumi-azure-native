...
export class ImageDefinition extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:testbase/v20231101preview:ImageDefinition';
    ...
    constructor(name: string, args: ImageDefinitionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:testbase:ImageDefinition" }] };

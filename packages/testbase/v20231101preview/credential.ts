...
export class Credential extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:testbase/v20231101preview:Credential';
    ...
    constructor(name: string, args: CredentialArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:testbase:Credential" }] };
...
export interface CredentialArgs {
     ...
     * Credential type.
     */
    credentialType: pulumi.Input<string | types.enums.CredentialType>;
    /**
     * Credential display name.
     */

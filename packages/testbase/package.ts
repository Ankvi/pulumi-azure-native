...
export class Package extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly galleryApps: pulumi.Output<types.outputs.GalleryAppDefinitionResponse[]>;
    /**
     ...
     */
    declare public /*out*/ readonly validationResults: pulumi.Output<types.outputs.PackageValidationResultResponse[]>;
    /**
     * Application version
     */

...
export namespace testbase {
    ...
    export namespace v20220401preview {
        ...
        export interface BillingHubPackageUsageResponse {
            ...
            totalUsedBillableHours?: number;
            totalUsedFreeHours?: number;
            usageEntriesGroupedByUpdateType?: v20220401preview.BillingHubUsageGroupedByUpdateTypeResponse[];
        }

        export interface BillingHubUsageGroupResponse {
            executionUsageDetails?: v20220401preview.BillingHubExecutionUsageDetailResponse[];
            osBuild?: string;
            productFamily?: string;
            release?: string;
            releaseBuildDate?: string;
        ...
        export interface BillingHubUsageGroupedByUpdateTypeResponse {
            ...
            totalUsedFreeHours?: number;
            updateType?: string;
            usageGroups?: v20220401preview.BillingHubUsageGroupResponse[];
        }
        ...
        export interface NotificationEventReceiverResponse {
             ...
             * The notification event receiver value.
             */
            receiverValue?: v20220401preview.NotificationReceiverValueResponse;
        }
        ...
        export interface NotificationReceiverValueResponse {
             ...
             * The user object receiver value.
             */
            distributionGroupListReceiverValue?: v20220401preview.DistributionGroupListReceiverValueResponse;
            /**
             * The user object receiver value.
             */
            subscriptionReceiverValue?: v20220401preview.SubscriptionReceiverValueResponse;
            /**
             * The user object receiver value.
             */
            userObjectReceiverValue?: v20220401preview.UserObjectReceiverValueResponse;
        }
        ...
        export interface TestBaseAccountSKUResponse {
             ...
             * The capabilities of a SKU.
             */
            capabilities: v20220401preview.TestBaseAccountSKUCapabilityResponse[];
            /**
             * The locations that the SKU is available.
             */
            locations?: string[];
        ...
        export interface TestResponse {
             ...
             * The commands used in the test.
             */
            commands: v20220401preview.CommandResponse[];
            /**
             * Indicates if this test is active.It doesn't schedule test for not active Test.
             */
            isActive?: boolean;

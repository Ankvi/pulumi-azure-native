...
export namespace testbase {
    ...
    export namespace v20220401preview {
        ...
        export interface CommandArgs {
             ...
             * The action of the command.
             */
            action: pulumi.Input<string | enums.v20220401preview.Action>;
            /**
             * Specifies whether to run the command even if a previous command is failed.
             */
            alwaysRun?: pulumi.Input<boolean>;
             ...
             * The type of command content.
             */
            contentType: pulumi.Input<string | enums.v20220401preview.ContentType>;
            /**
             * Specifies the max run time of the command.
             */
            maxRunTime?: pulumi.Input<number>;
        ...
        export interface NotificationEventReceiverArgs {
             ...
             * The notification event receiver value.
             */
            receiverValue?: pulumi.Input<v20220401preview.NotificationReceiverValueArgs>;
        }
        ...
        export interface NotificationReceiverValueArgs {
             ...
             * The user object receiver value.
             */
            distributionGroupListReceiverValue?: pulumi.Input<v20220401preview.DistributionGroupListReceiverValueArgs>;
            /**
             * The user object receiver value.
             */
            subscriptionReceiverValue?: pulumi.Input<v20220401preview.SubscriptionReceiverValueArgs>;
            /**
             * The user object receiver value.
             */
            userObjectReceiverValue?: pulumi.Input<v20220401preview.UserObjectReceiverValueArgs>;
        }
        ...
        export interface TestArgs {
             ...
             * The commands used in the test.
             */
            commands: pulumi.Input<pulumi.Input<v20220401preview.CommandArgs>[]>;
            /**
             * Indicates if this test is active.It doesn't schedule test for not active Test.
             */
            isActive?: pulumi.Input<boolean>;
             ...
             * The type of the test.
             */
            testType: pulumi.Input<string | enums.v20220401preview.TestType>;
        }
        ...
        export interface TestBaseAccountSKUArgs {
             ...
             * The tier of this particular SKU.
             */
            tier: pulumi.Input<string | enums.v20220401preview.Tier>;
        }

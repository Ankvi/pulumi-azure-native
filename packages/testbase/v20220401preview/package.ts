...
export class Package extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:testbase/v20220401preview:Package';
    ...
    constructor(name: string, args: PackageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:testbase:Package" }, { type: "azure-native:testbase/v20201216preview:Package" }, { type: "azure-native:testbase/v20231101preview:Package" }] };

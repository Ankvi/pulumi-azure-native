...
export class FavoriteProcess extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:testbase/v20220401preview:FavoriteProcess';
    ...
    constructor(name: string, args: FavoriteProcessArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:testbase:FavoriteProcess" }, { type: "azure-native:testbase/v20201216preview:FavoriteProcess" }, { type: "azure-native:testbase/v20231101preview:FavoriteProcess" }] };

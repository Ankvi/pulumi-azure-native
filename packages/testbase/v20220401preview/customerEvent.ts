...
export class CustomerEvent extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:testbase/v20220401preview:CustomerEvent';
    ...
    constructor(name: string, args: CustomerEventArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:testbase:CustomerEvent" }, { type: "azure-native:testbase/v20201216preview:CustomerEvent" }, { type: "azure-native:testbase/v20231101preview:CustomerEvent" }] };

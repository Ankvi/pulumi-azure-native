...
export class TestBaseAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:testbase/v20220401preview:TestBaseAccount';
    ...
    constructor(name: string, args: TestBaseAccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:testbase:TestBaseAccount" }, { type: "azure-native:testbase/v20201216preview:TestBaseAccount" }, { type: "azure-native:testbase/v20231101preview:TestBaseAccount" }] };

...
export class CloudConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:hybridcloud/v20230101preview:CloudConnector';
    ...
    constructor(name: string, args: CloudConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hybridcloud:CloudConnector" }] };
...
export interface CloudConnectorArgs {
     ...
     * The cloud connector type.
     */
    cloudType?: pulumi.Input<string | types.enums.v20230101preview.CloudType>;
    /**
     * The geo-location where the resource lives
     */

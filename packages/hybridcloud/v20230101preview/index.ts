...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:hybridcloud/v20230101preview:CloudConnection":
                return new CloudConnection(name, <any>undefined, { urn })
            case "azure-native:hybridcloud/v20230101preview:CloudConnector":
...
pulumi.runtime.registerResourceModule("azure-native", "hybridcloud/v20230101preview", _module)

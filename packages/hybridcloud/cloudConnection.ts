...
export class CloudConnection extends pulumi.CustomResource {
     ...
     */
    declare public readonly cloudConnector: pulumi.Output<types.outputs.ResourceReferenceResponse | undefined>;
    /**
     ...
     */
    declare public readonly virtualHub: pulumi.Output<types.outputs.ResourceReferenceResponse | undefined>;

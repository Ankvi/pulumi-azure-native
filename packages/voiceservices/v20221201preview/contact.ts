...
export class Contact extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:voiceservices/v20221201preview:Contact';
    ...
    constructor(name: string, args: ContactArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:voiceservices:Contact" }] };

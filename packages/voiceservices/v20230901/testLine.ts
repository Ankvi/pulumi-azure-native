...
export class TestLine extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:voiceservices/v20230901:TestLine';
    ...
    constructor(name: string, args: TestLineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:voiceservices:TestLine" }, { type: "azure-native:voiceservices/v20221201preview:TestLine" }, { type: "azure-native:voiceservices/v20230131:TestLine" }, { type: "azure-native:voiceservices/v20230403:TestLine" }] };
...
export interface TestLineArgs {
     ...
     * Purpose of this test line, e.g. automated or manual testing
     */
    purpose: pulumi.Input<string | types.enums.TestLinePurpose>;
    /**

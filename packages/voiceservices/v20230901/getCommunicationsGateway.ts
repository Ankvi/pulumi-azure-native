...
export function getCommunicationsGateway(args: GetCommunicationsGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetCommunicationsGatewayResult> {
    ...
    return pulumi.runtime.invoke("azure-native:voiceservices/v20230901:getCommunicationsGateway", {
...
export interface GetCommunicationsGatewayResult {
     ...
     */
    readonly apiBridge?: types.outputs.ApiBridgePropertiesResponse;
    /**
     ...
     */
    readonly customSipHeaders?: types.outputs.CustomSipHeadersPropertiesResponse;
    /**
     * Details of DNS Domains to delegate to the Communications Gateway.
     */
    readonly dnsDelegations?: types.outputs.DnsDelegationsPropertiesResponse;
    /**

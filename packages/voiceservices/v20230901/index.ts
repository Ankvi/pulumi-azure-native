...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:voiceservices/v20230901:CommunicationsGateway":
                return new CommunicationsGateway(name, <any>undefined, { urn })
            case "azure-native:voiceservices/v20230901:TestLine":
...
pulumi.runtime.registerResourceModule("azure-native", "voiceservices/v20230901", _module)
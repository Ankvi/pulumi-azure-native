...
export class TestLine extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): TestLine {
        return new TestLine(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:voiceservices/v20230403:TestLine';

    /**
     * Returns true if the given object is an instance of TestLine.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TestLine {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TestLine.__pulumiType;
    }
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<types.outputs.voiceservices.v20230403.SystemDataResponse>;
    /**
     * Resource tags.
     */
     ...
     */
    constructor(name: string, args: TestLineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:voiceservices:TestLine" }, { type: "azure-native:voiceservices/v20221201preview:TestLine" }, { type: "azure-native:voiceservices/v20230131:TestLine" }] };
...
export interface TestLineArgs {
     ...
     * Purpose of this test line, e.g. automated or manual testing
     */
    purpose: pulumi.Input<string | types.enums.v20230403.TestLinePurpose>;
    /**

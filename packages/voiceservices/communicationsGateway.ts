...
export class CommunicationsGateway extends pulumi.CustomResource {
     ...
     */
    declare public readonly apiBridge: pulumi.Output<types.outputs.ApiBridgePropertiesResponse | undefined>;
    /**
     ...
     */
    declare public readonly customSipHeaders: pulumi.Output<types.outputs.CustomSipHeadersPropertiesResponse | undefined>;
    /**
     * Details of DNS Domains to delegate to the Communications Gateway.
     */
    declare public readonly dnsDelegations: pulumi.Output<types.outputs.DnsDelegationsPropertiesResponse | undefined>;
    /**
     ...
     */
    declare public readonly serviceLocations: pulumi.Output<types.outputs.ServiceRegionPropertiesResponse[]>;
    /**
    ...
    constructor(name: string, args: CommunicationsGatewayArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["apiBridge"] = args ? (args.apiBridge ? pulumi.output(args.apiBridge).apply(types.inputs.apiBridgePropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface CommunicationsGatewayArgs {
     ...
     * Details of API bridge functionality, if required
     */
    apiBridge?: pulumi.Input<types.inputs.ApiBridgePropertiesArgs>;
    /**
     * The scope at which the auto-generated domain name can be re-used
     */
     ...
     * Custom SIP Header to add to any subscriber with a custom_header value, if required.
     */
    customSipHeaders?: pulumi.Input<types.inputs.CustomSipHeadersPropertiesArgs>;
    /**
     * Details of DNS Domains to delegate to the Communications Gateway.
     */
    dnsDelegations?: pulumi.Input<types.inputs.DnsDelegationsPropertiesArgs>;
    /**
     * How to handle 911 calls
     */

...
export class FarmBeatsModel extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:agfoodplatform/v20210901preview:FarmBeatsModel';
    ...
    constructor(name: string, args: FarmBeatsModelArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:agfoodplatform:FarmBeatsModel" }, { type: "azure-native:agfoodplatform/v20200512preview:FarmBeatsModel" }, { type: "azure-native:agfoodplatform/v20230601preview:FarmBeatsModel" }] };

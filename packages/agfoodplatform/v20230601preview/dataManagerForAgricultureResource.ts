...
export class DataManagerForAgricultureResource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:agfoodplatform/v20230601preview:DataManagerForAgricultureResource';
    ...
    constructor(name: string, args: DataManagerForAgricultureResourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:agfoodplatform:DataManagerForAgricultureResource" }, { type: "azure-native:agfoodplatform/v20200512preview:DataManagerForAgricultureResource" }, { type: "azure-native:agfoodplatform/v20210901preview:DataManagerForAgricultureResource" }] };

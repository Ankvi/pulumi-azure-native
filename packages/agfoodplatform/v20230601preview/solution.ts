...
export class Solution extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:agfoodplatform/v20230601preview:Solution';
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.agfoodplatform.v20230601preview.SolutionPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: SolutionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:agfoodplatform:Solution" }, { type: "azure-native:agfoodplatform/v20210901preview:Solution" }] };
...
export interface SolutionArgs {
     ...
     * Solution resource properties.
     */
    properties?: pulumi.Input<types.inputs.agfoodplatform.v20230601preview.SolutionPropertiesArgs>;
    /**

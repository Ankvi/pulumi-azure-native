...
export class Extension extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:agfoodplatform:Extension';
     ...
     */
    declare public readonly additionalApiProperties: pulumi.Output<{[key: string]: types.outputs.ApiPropertiesResponse}>;
    /**

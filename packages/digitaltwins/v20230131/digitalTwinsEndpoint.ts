...
export class DigitalTwinsEndpoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:digitaltwins/v20230131:DigitalTwinsEndpoint';
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.digitaltwins.v20230131.EventGridResponse | types.outputs.digitaltwins.v20230131.EventHubResponse | types.outputs.digitaltwins.v20230131.ServiceBusResponse>;
    /**
    ...
    constructor(name: string, args: DigitalTwinsEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:digitaltwins:DigitalTwinsEndpoint" }, { type: "azure-native:digitaltwins/v20200301preview:DigitalTwinsEndpoint" }, { type: "azure-native:digitaltwins/v20201031:DigitalTwinsEndpoint" }, { type: "azure-native:digitaltwins/v20201201:DigitalTwinsEndpoint" }, { type: "azure-native:digitaltwins/v20210630preview:DigitalTwinsEndpoint" }, { type: "azure-native:digitaltwins/v20220531:DigitalTwinsEndpoint" }, { type: "azure-native:digitaltwins/v20221031:DigitalTwinsEndpoint" }] };
...
export interface DigitalTwinsEndpointArgs {
     ...
     * DigitalTwinsInstance endpoint resource properties.
     */
    properties: pulumi.Input<types.inputs.digitaltwins.v20230131.EventGridArgs | types.inputs.digitaltwins.v20230131.EventHubArgs | types.inputs.digitaltwins.v20230131.ServiceBusArgs>;
    /**

...
export namespace digitaltwins {
    ...
    export namespace v20201201 {
        export interface ConnectionPropertiesPrivateLinkServiceConnectionStateArgs {
             ...
             * The status of a private endpoint connection.
             */
            status: pulumi.Input<string | enums.v20201201.PrivateLinkServiceConnectionStatus>;
        }
        ...
        export interface PrivateEndpointConnectionPropertiesArgs {
             ...
             */
            groupIds?: pulumi.Input<pulumi.Input<string>[]>;
            privateLinkServiceConnectionState?: pulumi.Input<v20201201.ConnectionPropertiesPrivateLinkServiceConnectionStateArgs>;
        }

    }

    export namespace v20230131 {
        /**
         * Properties of a time series database connection to Azure Data Explorer with data being sent via an EventHub.
         */
        export interface AzureDataExplorerConnectionPropertiesArgs {
             ...
             * Managed identity properties for the time series database connection resource.
             */
            identity?: pulumi.Input<v20230131.ManagedIdentityReferenceArgs>;
            /**
             * Specifies whether or not to record twin / relationship property and item removals, including removals of indexed or keyed values (such as map entries, array elements, etc.). This feature is de-activated unless explicitly set to 'true'. Setting this property to 'true' will generate an additional column in the property events table in ADX.
             */
            recordPropertyAndItemRemovals?: pulumi.Input<string | enums.v20230131.RecordPropertyAndItemRemovals>;
        }
        /**
         * azureDataExplorerConnectionPropertiesArgsProvideDefaults sets the appropriate defaults for AzureDataExplorerConnectionPropertiesArgs
         */
        ...
        export interface ConnectionPropertiesArgs {
             ...
             * The connection state.
             */
            privateLinkServiceConnectionState?: pulumi.Input<v20230131.ConnectionPropertiesPrivateLinkServiceConnectionStateArgs>;
        }
        ...
        export interface ConnectionPropertiesPrivateLinkServiceConnectionStateArgs {
             ...
             * The status of a private endpoint connection.
             */
            status: pulumi.Input<string | enums.v20230131.PrivateLinkServiceConnectionStatus>;
        }
        ...
        export interface DigitalTwinsIdentityArgs {
             ...
             * The type of Managed Identity used by the DigitalTwinsInstance.
             */
            type?: pulumi.Input<string | enums.v20230131.DigitalTwinsIdentityType>;
            /**
             * The list of user identities associated with the resource. The user identity dictionary key references will be ARM resource ids in the form:
             * '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}'.
             * .
        ...
        export interface EventGridArgs {
             ...
             * Specifies the authentication type being used for connecting to the endpoint. Defaults to 'KeyBased'. If 'KeyBased' is selected, a connection string must be specified (at least the primary connection string). If 'IdentityBased' is select, the endpointUri and entityPath properties must be specified.
             */
            authenticationType?: pulumi.Input<string | enums.v20230131.AuthenticationType>;
            /**
             * Dead letter storage secret for key-based authentication. Will be obfuscated during read.
             */
            deadLetterSecret?: pulumi.Input<string>;
        ...
        export interface ManagedIdentityReferenceArgs {
             ...
             * The type of managed identity used.
             */
            type?: pulumi.Input<string | enums.v20230131.IdentityType>;
            /**
             * The user identity ARM resource id if the managed identity type is 'UserAssigned'.
             */
            userAssignedIdentity?: pulumi.Input<string>;
        ...
        export interface PrivateEndpointConnectionArgs {
             ...
             * The connection properties.
             */
            properties: pulumi.Input<v20230131.ConnectionPropertiesArgs>;
        }

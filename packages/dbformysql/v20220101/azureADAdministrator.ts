...
export class AzureADAdministrator extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AzureADAdministratorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:dbformysql:AzureADAdministrator" }, { type: "azure-native:dbformysql/v20211201preview:AzureADAdministrator" }, { type: "azure-native:dbformysql/v20230601preview:AzureADAdministrator" }] };

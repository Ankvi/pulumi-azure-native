...
export class AzureADAdministrator extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:dbformysql/v20230630:AzureADAdministrator';
    ...
    constructor(name: string, args: AzureADAdministratorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:dbformysql:AzureADAdministrator" }, { type: "azure-native:dbformysql/v20211201preview:AzureADAdministrator" }, { type: "azure-native:dbformysql/v20220101:AzureADAdministrator" }, { type: "azure-native:dbformysql/v20230601preview:AzureADAdministrator" }] };

...
export class ServiceEndpoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:recommendationsservice/v20220301preview:ServiceEndpoint';
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.recommendationsservice.v20220301preview.ServiceEndpointResourceResponseProperties>;
    /**
    ...
    constructor(name: string, args: ServiceEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:recommendationsservice:ServiceEndpoint" }, { type: "azure-native:recommendationsservice/v20220201:ServiceEndpoint" }] };
...
export interface ServiceEndpointArgs {
     ...
     * ServiceEndpoint resource properties.
     */
    properties?: pulumi.Input<types.inputs.recommendationsservice.v20220301preview.ServiceEndpointResourcePropertiesArgs>;
    /**

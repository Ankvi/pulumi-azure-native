...
export class Account extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:recommendationsservice/v20220301preview:Account';
    ...
    constructor(name: string, args: AccountArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:recommendationsservice:Account" }, { type: "azure-native:recommendationsservice/v20220201:Account" }] };

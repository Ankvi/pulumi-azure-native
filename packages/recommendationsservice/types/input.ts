...
export namespace recommendationsservice {
    /**
    ...
    export namespace v20220201 {
        ...
        export interface AccountResourcePropertiesArgs {
             ...
             * Account configuration. This can only be set at RecommendationsService Account creation.
             */
            configuration?: pulumi.Input<string | enums.v20220201.AccountConfiguration>;
            /**
             * The list of CORS details.
             */
            cors?: pulumi.Input<pulumi.Input<v20220201.CorsRuleArgs>[]>;
            /**
             * The list of service endpoints authentication details.
             */
            endpointAuthentications?: pulumi.Input<pulumi.Input<v20220201.EndpointAuthenticationArgs>[]>;
            /**
             * Connection string to write Accounts reports to.
             */
            reportsConnectionString?: pulumi.Input<string>;
        ...
        export interface EndpointAuthenticationArgs {
             ...
             * AAD principal type.
             */
            principalType?: pulumi.Input<string | enums.v20220201.PrincipalType>;
        }
        ...
        export interface ModelingResourcePropertiesArgs {
             ...
             * Modeling features controls the set of supported scenarios\models being computed. This can only be set at Modeling creation.
             */
            features?: pulumi.Input<string | enums.v20220201.ModelingFeatures>;
            /**
             * Modeling frequency controls the modeling compute frequency.
             */
            frequency?: pulumi.Input<string | enums.v20220201.ModelingFrequency>;
            /**
             * The configuration to raw CDM data to be used as Modeling resource input.
             */
            inputData?: pulumi.Input<v20220201.ModelingInputDataArgs>;
            /**
             * Modeling size controls the maximum supported input data size.
             */
            size?: pulumi.Input<string | enums.v20220201.ModelingSize>;
        }
    ...
    export namespace v20220301preview {
        ...
        export interface AccountResourcePropertiesArgs {
             ...
             * Account configuration. This can only be set at RecommendationsService Account creation.
             */
            configuration?: pulumi.Input<string | enums.v20220301preview.AccountConfiguration>;
            /**
             * The list of CORS details.
             */
            cors?: pulumi.Input<pulumi.Input<v20220301preview.CorsRuleArgs>[]>;
            /**
             * The list of service endpoints authentication details.
             */
            endpointAuthentications?: pulumi.Input<pulumi.Input<v20220301preview.EndpointAuthenticationArgs>[]>;
            /**
             * Connection string to write Accounts reports to.
             */
            reportsConnectionString?: pulumi.Input<string>;
        ...
        export interface EndpointAuthenticationArgs {
             ...
             * AAD principal type.
             */
            principalType?: pulumi.Input<string | enums.v20220301preview.PrincipalType>;
        }
        ...
        export interface ManagedServiceIdentityArgs {
             ...
             */
            type: pulumi.Input<string | enums.v20220301preview.ManagedServiceIdentityType>;
            /**
        ...
        export interface ModelingResourcePropertiesArgs {
             ...
             * Modeling features controls the set of supported scenarios\models being computed. This can only be set at Modeling creation.
             */
            features?: pulumi.Input<string | enums.v20220301preview.ModelingFeatures>;
            /**
             * Modeling frequency controls the modeling compute frequency.
             */
            frequency?: pulumi.Input<string | enums.v20220301preview.ModelingFrequency>;
            /**
             * The configuration to raw CDM data to be used as Modeling resource input.
             */
            inputData?: pulumi.Input<v20220301preview.ModelingInputDataArgs>;
            /**
             * Modeling size controls the maximum supported input data size.
             */
            size?: pulumi.Input<string | enums.v20220301preview.ModelingSize>;
        }

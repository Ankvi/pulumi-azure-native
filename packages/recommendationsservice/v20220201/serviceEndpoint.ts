...
export class ServiceEndpoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:recommendationsservice/v20220201:ServiceEndpoint';
    ...
    constructor(name: string, args: ServiceEndpointArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:recommendationsservice:ServiceEndpoint" }, { type: "azure-native:recommendationsservice/v20220301preview:ServiceEndpoint" }] };

...
// Export enums:
export * from "../types/enums/v20220201";

const _module = {
    version: utilities.getVersion(),
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:recommendationsservice/v20220201:Account":
                return new Account(name, <any>undefined, { urn })
            case "azure-native:recommendationsservice/v20220201:Modeling":
                return new Modeling(name, <any>undefined, { urn })
            case "azure-native:recommendationsservice/v20220201:ServiceEndpoint":
...
pulumi.runtime.registerResourceModule("azure-native", "recommendationsservice/v20220201", _module)

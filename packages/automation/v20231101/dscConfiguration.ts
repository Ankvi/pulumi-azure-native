...
export class DscConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:automation/v20231101:DscConfiguration';
    ...
    constructor(name: string, args: DscConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:automation:DscConfiguration" }, { type: "azure-native:automation/v20151031:DscConfiguration" }, { type: "azure-native:automation/v20190601:DscConfiguration" }, { type: "azure-native:automation/v20220808:DscConfiguration" }, { type: "azure-native:automation/v20230515preview:DscConfiguration" }] };

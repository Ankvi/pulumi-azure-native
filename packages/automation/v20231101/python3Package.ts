...
export class Python3Package extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:automation/v20231101:Python3Package';
    ...
    constructor(name: string, args: Python3PackageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:automation:Python3Package" }, { type: "azure-native:automation/v20220808:Python3Package" }, { type: "azure-native:automation/v20230515preview:Python3Package" }] };

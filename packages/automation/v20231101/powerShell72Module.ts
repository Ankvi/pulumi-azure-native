...
export class PowerShell72Module extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:automation/v20231101:PowerShell72Module';
    ...
    constructor(name: string, args: PowerShell72ModuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:automation:PowerShell72Module" }] };

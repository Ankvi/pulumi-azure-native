...
export class DscConfiguration extends pulumi.CustomResource {
     ...
     */
    declare public readonly parameters: pulumi.Output<{[key: string]: types.outputs.DscConfigurationParameterResponse} | undefined>;
    /**
     ...
     */
    declare public readonly source: pulumi.Output<types.outputs.ContentSourceResponse | undefined>;
    /**

...
export class SoftwareUpdateConfigurationByName extends pulumi.CustomResource {
     ...
     */
    public readonly scheduleInfo!: pulumi.Output<types.outputs.SchedulePropertiesResponse>;
    /**
    ...
    constructor(name: string, args: SoftwareUpdateConfigurationByNameArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["scheduleInfo"] = args ? (args.scheduleInfo ? pulumi.output(args.scheduleInfo).apply(types.inputs.schedulePropertiesArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:automation:SoftwareUpdateConfigurationByName" }, { type: "azure-native:automation/v20190601:SoftwareUpdateConfigurationByName" }, { type: "azure-native:automation/v20230515preview:SoftwareUpdateConfigurationByName" }] };
...
export interface SoftwareUpdateConfigurationByNameArgs {
     ...
     * Schedule information for the Software update configuration
     */
    scheduleInfo: pulumi.Input<types.inputs.SchedulePropertiesArgs>;
    /**

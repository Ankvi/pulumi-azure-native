...
export class SoftwareUpdateConfigurationByName extends pulumi.CustomResource {
     ...
     */
    public readonly error!: pulumi.Output<types.outputs.automation.v20170515preview.ErrorResponseResponse | undefined>;
    /**
     ...
     */
    public readonly scheduleInfo!: pulumi.Output<types.outputs.automation.v20170515preview.SchedulePropertiesResponse>;
    /**
     * Tasks information for the Software update configuration.
     */
    public readonly tasks!: pulumi.Output<types.outputs.automation.v20170515preview.SoftwareUpdateConfigurationTasksResponse | undefined>;
    /**
     * Resource type
     */
     ...
     */
    public readonly updateConfiguration!: pulumi.Output<types.outputs.automation.v20170515preview.UpdateConfigurationResponse>;
    ...
    constructor(name: string, args: SoftwareUpdateConfigurationByNameArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["scheduleInfo"] = args ? (args.scheduleInfo ? pulumi.output(args.scheduleInfo).apply(types.inputs.automation.v20170515preview.schedulePropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface SoftwareUpdateConfigurationByNameArgs {
     ...
     * Details of provisioning error
     */
    error?: pulumi.Input<types.inputs.automation.v20170515preview.ErrorResponseArgs>;
    /**
     ...
     * Schedule information for the Software update configuration
     */
    scheduleInfo: pulumi.Input<types.inputs.automation.v20170515preview.SchedulePropertiesArgs>;
    /**
     ...
     * Tasks information for the Software update configuration.
     */
    tasks?: pulumi.Input<types.inputs.automation.v20170515preview.SoftwareUpdateConfigurationTasksArgs>;
    /**
     * update specific properties for the Software update configuration
     */
    updateConfiguration: pulumi.Input<types.inputs.automation.v20170515preview.UpdateConfigurationArgs>;
}

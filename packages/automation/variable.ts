...
export class Variable extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:automation:Variable';
     ...
     */
    declare public readonly isEncrypted: pulumi.Output<boolean | undefined>;
    /**
    ...
    constructor(name: string, args: VariableArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["isEncrypted"] = args?.isEncrypted;

...
export interface GetSoftwareUpdateConfigurationByNameResult {
     ...
     */
    readonly error?: types.outputs.automation.v20190601.ErrorResponseResponse;
    /**
     * Resource Id.
     */
    readonly id: string;
     ...
     */
    readonly scheduleInfo: types.outputs.automation.v20190601.SUCSchedulePropertiesResponse;
    /**
     * Tasks information for the Software update configuration.
     */
    readonly tasks?: types.outputs.automation.v20190601.SoftwareUpdateConfigurationTasksResponse;
    /**
     * Resource type
     */
     ...
     */
    readonly updateConfiguration: types.outputs.automation.v20190601.UpdateConfigurationResponse;
}
/**
 * Get a single software update configuration by name.
 */

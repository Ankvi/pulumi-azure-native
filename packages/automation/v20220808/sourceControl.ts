...
export class SourceControl extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:automation/v20220808:SourceControl';
    ...
    constructor(name: string, args: SourceControlArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:automation:SourceControl" }, { type: "azure-native:automation/v20170515preview:SourceControl" }, { type: "azure-native:automation/v20190601:SourceControl" }, { type: "azure-native:automation/v20200113preview:SourceControl" }] };

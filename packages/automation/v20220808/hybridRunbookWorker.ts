...
export class HybridRunbookWorker extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:automation/v20220808:HybridRunbookWorker';
    ...
    constructor(name: string, args: HybridRunbookWorkerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:automation:HybridRunbookWorker" }, { type: "azure-native:automation/v20210622:HybridRunbookWorker" }, { type: "azure-native:automation/v20230515preview:HybridRunbookWorker" }, { type: "azure-native:automation/v20231101:HybridRunbookWorker" }] };

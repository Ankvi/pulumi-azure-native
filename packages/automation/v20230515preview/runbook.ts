...
export class Runbook extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:automation/v20230515preview:Runbook';
     ...
     */
    public readonly runtimeEnvironment!: pulumi.Output<string | undefined>;
    /**
    ...
    constructor(name: string, args: RunbookArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:automation:Runbook" }, { type: "azure-native:automation/v20151031:Runbook" }, { type: "azure-native:automation/v20180630:Runbook" }, { type: "azure-native:automation/v20190601:Runbook" }, { type: "azure-native:automation/v20220808:Runbook" }, { type: "azure-native:automation/v20231101:Runbook" }] };

...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:automation/v20230515preview:AutomationAccount":
                return new AutomationAccount(name, <any>undefined, { urn })
            case "azure-native:automation/v20230515preview:Certificate":
                return new Certificate(name, <any>undefined, { urn })
            case "azure-native:automation/v20230515preview:Connection":
                return new Connection(name, <any>undefined, { urn })
            case "azure-native:automation/v20230515preview:ConnectionType":
                return new ConnectionType(name, <any>undefined, { urn })
            case "azure-native:automation/v20230515preview:Credential":
                return new Credential(name, <any>undefined, { urn })
            case "azure-native:automation/v20230515preview:DscConfiguration":
                return new DscConfiguration(name, <any>undefined, { urn })
            case "azure-native:automation/v20230515preview:DscNodeConfiguration":
                return new DscNodeConfiguration(name, <any>undefined, { urn })
            case "azure-native:automation/v20230515preview:HybridRunbookWorker":
                return new HybridRunbookWorker(name, <any>undefined, { urn })
            case "azure-native:automation/v20230515preview:HybridRunbookWorkerGroup":
                return new HybridRunbookWorkerGroup(name, <any>undefined, { urn })
            case "azure-native:automation/v20230515preview:JobSchedule":
                return new JobSchedule(name, <any>undefined, { urn })
            case "azure-native:automation/v20230515preview:Module":
            ...
            case "azure-native:automation/v20230515preview:Python2Package":
                return new Python2Package(name, <any>undefined, { urn })
            case "azure-native:automation/v20230515preview:Python3Package":
                return new Python3Package(name, <any>undefined, { urn })
            case "azure-native:automation/v20230515preview:Runbook":
            ...
            case "azure-native:automation/v20230515preview:Schedule":
            ...
            case "azure-native:automation/v20230515preview:SourceControl":
                return new SourceControl(name, <any>undefined, { urn })
            case "azure-native:automation/v20230515preview:Variable":

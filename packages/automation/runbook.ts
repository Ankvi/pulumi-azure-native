...
export class Runbook extends pulumi.CustomResource {
    ...
    constructor(name: string, args: RunbookArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:automation/v20151031:Runbook" }, { type: "azure-native:automation/v20180630:Runbook" }, { type: "azure-native:automation/v20190601:Runbook" }, { type: "azure-native:automation/v20220808:Runbook" }] };

...
export class Runbook extends pulumi.CustomResource {
     ...
     */
    declare public readonly draft: pulumi.Output<types.outputs.RunbookDraftResponse | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly parameters: pulumi.Output<{[key: string]: types.outputs.RunbookParameterResponse} | undefined>;
    /**

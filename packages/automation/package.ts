...
export class Package extends pulumi.CustomResource {
     ...
     */
    declare public readonly allOf: pulumi.Output<types.outputs.SystemDataResponse>;
    /**
     ...
     */
    declare public readonly contentLink: pulumi.Output<types.outputs.ContentLinkResponse | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly error: pulumi.Output<types.outputs.PackageErrorInfoResponse | undefined>;
    /**

...
export class Python2Package extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly error: pulumi.Output<types.outputs.ModuleErrorInfoResponse | undefined>;
    /**

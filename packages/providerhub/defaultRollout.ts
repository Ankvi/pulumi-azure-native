...
export class DefaultRollout extends pulumi.CustomResource {
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.providerhub.DefaultRolloutResponseProperties>;
    /**
...
export interface DefaultRolloutArgs {
     ...
     * Properties of the rollout.
     */
    properties?: pulumi.Input<types.inputs.providerhub.DefaultRolloutPropertiesArgs>;
    /**

...
export class ResourceTypeRegistration extends pulumi.CustomResource {
    ...
    public readonly properties!: pulumi.Output<types.outputs.providerhub.v20210901preview.ResourceTypeRegistrationResponseProperties>;
    /**
...
export interface ResourceTypeRegistrationArgs {
    properties?: pulumi.Input<types.inputs.providerhub.v20210901preview.ResourceTypeRegistrationPropertiesArgs>;
    /**

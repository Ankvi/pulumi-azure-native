...
export class AccessPolicyAssignment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cache/v20230801:AccessPolicyAssignment';
    ...
    constructor(name: string, args: AccessPolicyAssignmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cache:AccessPolicyAssignment" }, { type: "azure-native:cache/v20230501preview:AccessPolicyAssignment" }] };

...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:cache/v20230801:AccessPolicy":
                return new AccessPolicy(name, <any>undefined, { urn })
            case "azure-native:cache/v20230801:AccessPolicyAssignment":
                return new AccessPolicyAssignment(name, <any>undefined, { urn })
            case "azure-native:cache/v20230801:FirewallRule":
                return new FirewallRule(name, <any>undefined, { urn })
            case "azure-native:cache/v20230801:LinkedServer":
                return new LinkedServer(name, <any>undefined, { urn })
            case "azure-native:cache/v20230801:PatchSchedule":
                return new PatchSchedule(name, <any>undefined, { urn })
            case "azure-native:cache/v20230801:PrivateEndpointConnection":
                return new PrivateEndpointConnection(name, <any>undefined, { urn })
            case "azure-native:cache/v20230801:Redis":
...
pulumi.runtime.registerResourceModule("azure-native", "cache/v20230801", _module)

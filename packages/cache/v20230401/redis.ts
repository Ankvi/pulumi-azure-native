...
export class Redis extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cache/v20230401:Redis';
     ...
     */
    public /*out*/ readonly accessKeys!: pulumi.Output<types.outputs.cache.v20230401.RedisAccessKeysResponse>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<types.outputs.cache.v20230401.ManagedServiceIdentityResponse | undefined>;
    /**
     * List of the Redis instances associated with the cache
     */
    public /*out*/ readonly instances!: pulumi.Output<types.outputs.cache.v20230401.RedisInstanceDetailsResponse[]>;
    /**
     * List of the linked servers associated with the cache
     */
    public /*out*/ readonly linkedServers!: pulumi.Output<types.outputs.cache.v20230401.RedisLinkedServerResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<types.outputs.cache.v20230401.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public readonly redisConfiguration!: pulumi.Output<types.outputs.cache.v20230401.RedisCommonPropertiesResponseRedisConfiguration | undefined>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<types.outputs.cache.v20230401.SkuResponse>;
    /**
     * Redis SSL port.
     */
    ...
    constructor(name: string, args: RedisArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cache:Redis" }, { type: "azure-native:cache/v20150801:Redis" }, { type: "azure-native:cache/v20160401:Redis" }, { type: "azure-native:cache/v20170201:Redis" }, { type: "azure-native:cache/v20171001:Redis" }, { type: "azure-native:cache/v20180301:Redis" }, { type: "azure-native:cache/v20190701:Redis" }, { type: "azure-native:cache/v20200601:Redis" }, { type: "azure-native:cache/v20201201:Redis" }, { type: "azure-native:cache/v20210601:Redis" }, { type: "azure-native:cache/v20220501:Redis" }, { type: "azure-native:cache/v20220601:Redis" }, { type: "azure-native:cache/v20230501preview:Redis" }, { type: "azure-native:cache/v20230801:Redis" }] };
...
export interface RedisArgs {
     ...
     * The identity of the resource.
     */
    identity?: pulumi.Input<types.inputs.cache.v20230401.ManagedServiceIdentityArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * Optional: requires clients to use a specified TLS version (or higher) to connect (e,g, '1.0', '1.1', '1.2')
     */
    minimumTlsVersion?: pulumi.Input<string | types.enums.v20230401.TlsVersion>;
    /**
     ...
     * All Redis Settings. Few possible keys: rdb-backup-enabled,rdb-storage-connection-string,rdb-backup-frequency,maxmemory-delta,maxmemory-policy,notify-keyspace-events,maxmemory-samples,slowlog-log-slower-than,slowlog-max-len,list-max-ziplist-entries,list-max-ziplist-value,hash-max-ziplist-entries,hash-max-ziplist-value,set-max-intset-entries,zset-max-ziplist-entries,zset-max-ziplist-value etc.
     */
    redisConfiguration?: pulumi.Input<types.inputs.cache.v20230401.RedisCommonPropertiesRedisConfigurationArgs>;
    /**
     * Redis version. This should be in the form 'major[.minor]' (only 'major' is required) or the value 'latest' which refers to the latest stable Redis version that is available. Supported versions: 4.0, 6.0 (latest). Default value is 'latest'.
     */
     ...
     * The SKU of the Redis cache to deploy.
     */
    sku: pulumi.Input<types.inputs.cache.v20230401.SkuArgs>;
    /**
     * Static IP address. Optionally, may be specified when deploying a Redis cache inside an existing Azure Virtual Network; auto assigned by default.
     */

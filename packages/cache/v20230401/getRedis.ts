...
export function getRedis(args: GetRedisArgs, opts?: pulumi.InvokeOptions): Promise<GetRedisResult> {
    ...
    return pulumi.runtime.invoke("azure-native:cache/v20230401:getRedis", {
        "name": args.name,
...
export interface GetRedisResult {
     ...
     */
    readonly accessKeys: types.outputs.cache.v20230401.RedisAccessKeysResponse;
    /**
     ...
     */
    readonly identity?: types.outputs.cache.v20230401.ManagedServiceIdentityResponse;
    /**
     * List of the Redis instances associated with the cache
     */
    readonly instances: types.outputs.cache.v20230401.RedisInstanceDetailsResponse[];
    /**
     * List of the linked servers associated with the cache
     */
    readonly linkedServers: types.outputs.cache.v20230401.RedisLinkedServerResponse[];
    /**
     ...
     */
    readonly privateEndpointConnections: types.outputs.cache.v20230401.PrivateEndpointConnectionResponse[];
    /**
     ...
     */
    readonly redisConfiguration?: types.outputs.cache.v20230401.RedisCommonPropertiesResponseRedisConfiguration;
    /**
     ...
     */
    readonly sku: types.outputs.cache.v20230401.SkuResponse;
    /**
     * Redis SSL port.
     */

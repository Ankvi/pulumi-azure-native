...
export class RedisEnterprise extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<types.outputs.cache.v20230701.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<types.outputs.cache.v20230701.EnterpriseSkuResponse>;
    /**
     * Resource tags.
     */
    ...
    constructor(name: string, args: RedisEnterpriseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cache:RedisEnterprise" }, { type: "azure-native:cache/v20201001preview:RedisEnterprise" }, { type: "azure-native:cache/v20210201preview:RedisEnterprise" }, { type: "azure-native:cache/v20210301:RedisEnterprise" }, { type: "azure-native:cache/v20210801:RedisEnterprise" }, { type: "azure-native:cache/v20220101:RedisEnterprise" }, { type: "azure-native:cache/v20221101preview:RedisEnterprise" }, { type: "azure-native:cache/v20230301preview:RedisEnterprise" }, { type: "azure-native:cache/v20230801preview:RedisEnterprise" }] };
...
export interface RedisEnterpriseArgs {
     ...
     * The minimum TLS version for the cluster to support, e.g. '1.2'
     */
    minimumTlsVersion?: pulumi.Input<string | types.enums.v20230701.TlsVersion>;
    /**
     ...
     * The SKU to create, which affects price, performance, and features.
     */
    sku: pulumi.Input<types.inputs.cache.v20230701.EnterpriseSkuArgs>;
    /**
     * Resource tags.
     */

...
export class RedisEnterprise extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cache/v20231101:RedisEnterprise';

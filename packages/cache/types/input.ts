...
export namespace cache {
    ...
    export namespace v20200601 {
        ...
        export interface SkuArgs {
             ...
             * The SKU family to use. Valid values: (C, P). (C = Basic/Standard, P = Premium).
             */
            family: pulumi.Input<string | enums.v20200601.SkuFamily>;
            /**
             * The type of Redis cache to deploy. Valid values: (Basic, Standard, Premium)
             */
            name: pulumi.Input<string | enums.v20200601.SkuName>;
        }
    ...
    export namespace v20201001preview {
        ...
        export interface EnterpriseSkuArgs {
             ...
             * The type of RedisEnterprise cluster to deploy. Possible values: (Enterprise_E10, EnterpriseFlash_F300 etc.)
             */
            name: pulumi.Input<string | enums.v20201001preview.SkuName>;
        }
    ...
    export namespace v20230301preview {
        ...
        export interface ClusterPropertiesCustomerManagedKeyEncryptionArgs {
             ...
             * All identity configuration for Customer-managed key settings defining which identity should be used to auth to Key Vault.
             */
            keyEncryptionKeyIdentity?: pulumi.Input<v20230301preview.ClusterPropertiesKeyEncryptionKeyIdentityArgs>;
            /**
             * Key encryption key Url, versioned only. Ex: https://contosovault.vault.azure.net/keys/contosokek/562a4bb76b524a1493a6afe8e536ee78
             */
            keyEncryptionKeyUrl?: pulumi.Input<string>;
        ...
        export interface ClusterPropertiesEncryptionArgs {
             ...
             * All Customer-managed key encryption properties for the resource. Set this to an empty object to use Microsoft-managed key encryption.
             */
            customerManagedKeyEncryption?: pulumi.Input<v20230301preview.ClusterPropertiesCustomerManagedKeyEncryptionArgs>;
        }
        ...
        export interface ClusterPropertiesKeyEncryptionKeyIdentityArgs {
             ...
             * Only userAssignedIdentity is supported in this API version; other types may be supported in the future
             */
            identityType?: pulumi.Input<string | enums.v20230301preview.CmkIdentityType>;
            /**
             * User assigned identity to use for accessing key encryption key Url. Ex: /subscriptions/<sub uuid>/resourceGroups/<resource group>/providers/Microsoft.ManagedIdentity/userAssignedIdentities/myId.
             */
            userAssignedIdentityResourceId?: pulumi.Input<string>;
        ...
        export interface DatabasePropertiesGeoReplicationArgs {
             ...
             * List of database resources to link with this database
             */
            linkedDatabases?: pulumi.Input<pulumi.Input<v20230301preview.LinkedDatabaseArgs>[]>;
        }
        ...
        export interface PersistenceArgs {
             ...
             * Sets the frequency at which data is written to disk.
             */
            aofFrequency?: pulumi.Input<string | enums.v20230301preview.AofFrequency>;
            /**
             * Sets whether RDB is enabled.
             */
            rdbEnabled?: pulumi.Input<boolean>;
             ...
             * Sets the frequency at which a snapshot of the database is created.
             */
            rdbFrequency?: pulumi.Input<string | enums.v20230301preview.RdbFrequency>;
        }
    ...
    export namespace v20230401 {
        ...
        export interface PrivateLinkServiceConnectionStateArgs {
             ...
             * Indicates whether the connection has been Approved/Rejected/Removed by the owner of the service.
             */
            status?: pulumi.Input<string | enums.v20230401.PrivateEndpointServiceConnectionStatus>;
        }
        ...
        export interface ScheduleEntryArgs {
             ...
             * Day of the week when a cache can be patched.
             */
            dayOfWeek: pulumi.Input<enums.v20230401.DayOfWeek>;
            /**
             * ISO8601 timespan specifying how much time cache patching can take. 
             */
            maintenanceWindow?: pulumi.Input<string>;
        ...
        export interface SkuArgs {
             ...
             * The SKU family to use. Valid values: (C, P). (C = Basic/Standard, P = Premium).
             */
            family: pulumi.Input<string | enums.v20230401.SkuFamily>;
            /**
             * The type of Redis cache to deploy. Valid values: (Basic, Standard, Premium)
             */
    ...
    export namespace v20230501preview {
        ...
        export interface ManagedServiceIdentityArgs {
             ...
             * Type of managed service identity (where both SystemAssigned and UserAssigned types are allowed).
             */
            type: pulumi.Input<string | enums.v20230501preview.ManagedServiceIdentityType>;
            /**
             * The set of user assigned identities associated with the resource. The userAssignedIdentities dictionary keys will be ARM resource ids in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}. The dictionary values can be empty objects ({}) in requests.
             */
            userAssignedIdentities?: pulumi.Input<pulumi.Input<string>[]>;
        ...
        export interface PrivateLinkServiceConnectionStateArgs {
             ...
             * Indicates whether the connection has been Approved/Rejected/Removed by the owner of the service.
             */
            status?: pulumi.Input<string | enums.v20230501preview.PrivateEndpointServiceConnectionStatus>;
        }
        ...
        export interface ScheduleEntryArgs {
             ...
             * Day of the week when a cache can be patched.
             */
            dayOfWeek: pulumi.Input<enums.v20230501preview.DayOfWeek>;
            /**
             * ISO8601 timespan specifying how much time cache patching can take. 
             */
            maintenanceWindow?: pulumi.Input<string>;
        ...
        export interface SkuArgs {
             ...
             * The SKU family to use. Valid values: (C, P). (C = Basic/Standard, P = Premium).
             */
            family: pulumi.Input<string | enums.v20230501preview.SkuFamily>;
            /**
             * The type of Redis cache to deploy. Valid values: (Basic, Standard, Premium)
             */
            name: pulumi.Input<string | enums.v20230501preview.SkuName>;
        }
    ...
    export namespace v20230701 {
        ...
        export interface DatabasePropertiesGeoReplicationArgs {
             ...
             * List of database resources to link with this database
             */
            linkedDatabases?: pulumi.Input<pulumi.Input<v20230701.LinkedDatabaseArgs>[]>;
        }
        ...
        export interface PersistenceArgs {
             ...
             * Sets the frequency at which data is written to disk.
             */
            aofFrequency?: pulumi.Input<string | enums.v20230701.AofFrequency>;
            /**
             * Sets whether RDB is enabled.
             */
            rdbEnabled?: pulumi.Input<boolean>;
             ...
             * Sets the frequency at which a snapshot of the database is created.
             */
            rdbFrequency?: pulumi.Input<string | enums.v20230701.RdbFrequency>;
        }
        ...
        export interface PrivateLinkServiceConnectionStateArgs {
             ...
             * Indicates whether the connection has been Approved/Rejected/Removed by the owner of the service.
             */
            status?: pulumi.Input<string | enums.v20230701.PrivateEndpointServiceConnectionStatus>;
        }
    ...
    export namespace v20230801 {
        ...
        export interface ManagedServiceIdentityArgs {
             ...
             * Type of managed service identity (where both SystemAssigned and UserAssigned types are allowed).
             */
            type: pulumi.Input<string | enums.v20230801.ManagedServiceIdentityType>;
            /**
             * The set of user assigned identities associated with the resource. The userAssignedIdentities dictionary keys will be ARM resource ids in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}. The dictionary values can be empty objects ({}) in requests.
             */
            userAssignedIdentities?: pulumi.Input<pulumi.Input<string>[]>;
        ...
        export interface PrivateLinkServiceConnectionStateArgs {
             ...
             * Indicates whether the connection has been Approved/Rejected/Removed by the owner of the service.
             */
            status?: pulumi.Input<string | enums.v20230801.PrivateEndpointServiceConnectionStatus>;
        }
        ...
        export interface ScheduleEntryArgs {
             ...
             * Day of the week when a cache can be patched.
             */
            dayOfWeek: pulumi.Input<enums.v20230801.DayOfWeek>;
            /**
             * ISO8601 timespan specifying how much time cache patching can take. 
             */
            maintenanceWindow?: pulumi.Input<string>;
        ...
        export interface SkuArgs {
             ...
             * The SKU family to use. Valid values: (C, P). (C = Basic/Standard, P = Premium).
             */
            family: pulumi.Input<string | enums.v20230801.SkuFamily>;
            /**
             * The type of Redis cache to deploy. Valid values: (Basic, Standard, Premium)
             */
            name: pulumi.Input<string | enums.v20230801.SkuName>;
        }
    ...
    export namespace v20230801preview {
        ...
        export interface ClusterPropertiesCustomerManagedKeyEncryptionArgs {
             ...
             * All identity configuration for Customer-managed key settings defining which identity should be used to auth to Key Vault.
             */
            keyEncryptionKeyIdentity?: pulumi.Input<v20230801preview.ClusterPropertiesKeyEncryptionKeyIdentityArgs>;
            /**
             * Key encryption key Url, versioned only. Ex: https://contosovault.vault.azure.net/keys/contosokek/562a4bb76b524a1493a6afe8e536ee78
             */
            keyEncryptionKeyUrl?: pulumi.Input<string>;
        ...
        export interface ClusterPropertiesEncryptionArgs {
             ...
             * All Customer-managed key encryption properties for the resource. Set this to an empty object to use Microsoft-managed key encryption.
             */
            customerManagedKeyEncryption?: pulumi.Input<v20230801preview.ClusterPropertiesCustomerManagedKeyEncryptionArgs>;
        }
        ...
        export interface ClusterPropertiesKeyEncryptionKeyIdentityArgs {
             ...
             * Only userAssignedIdentity is supported in this API version; other types may be supported in the future
             */
            identityType?: pulumi.Input<string | enums.v20230801preview.CmkIdentityType>;
            /**
             * User assigned identity to use for accessing key encryption key Url. Ex: /subscriptions/<sub uuid>/resourceGroups/<resource group>/providers/Microsoft.ManagedIdentity/userAssignedIdentities/myId.
             */
            userAssignedIdentityResourceId?: pulumi.Input<string>;
        ...
        export interface DatabasePropertiesGeoReplicationArgs {
             ...
             * List of database resources to link with this database
             */
            linkedDatabases?: pulumi.Input<pulumi.Input<v20230801preview.LinkedDatabaseArgs>[]>;
        }
        ...
        export interface ManagedServiceIdentityArgs {
             ...
             * Type of managed service identity (where both SystemAssigned and UserAssigned types are allowed).
             */
            type: pulumi.Input<string | enums.v20230801preview.ManagedServiceIdentityType>;
            /**
             * The set of user assigned identities associated with the resource. The userAssignedIdentities dictionary keys will be ARM resource ids in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}. The dictionary values can be empty objects ({}) in requests.
             */
            userAssignedIdentities?: pulumi.Input<pulumi.Input<string>[]>;
        ...
        export interface PersistenceArgs {
             ...
             * Sets the frequency at which data is written to disk.
             */
            aofFrequency?: pulumi.Input<string | enums.v20230801preview.AofFrequency>;
            /**
             * Sets whether RDB is enabled.
             */
            rdbEnabled?: pulumi.Input<boolean>;
             ...
             * Sets the frequency at which a snapshot of the database is created.
             */
            rdbFrequency?: pulumi.Input<string | enums.v20230801preview.RdbFrequency>;
        }
        ...
        export interface PrivateLinkServiceConnectionStateArgs {
             ...
             * Indicates whether the connection has been Approved/Rejected/Removed by the owner of the service.
             */
            status?: pulumi.Input<string | enums.v20230801preview.PrivateEndpointServiceConnectionStatus>;
        }

...
export class EnterprisePrivateEndpointConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cache/v20231001preview:EnterprisePrivateEndpointConnection';

...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:cache/v20240201:Database":
                return new Database(name, <any>undefined, { urn })
            case "azure-native:cache/v20240201:EnterprisePrivateEndpointConnection":
                return new EnterprisePrivateEndpointConnection(name, <any>undefined, { urn })
            case "azure-native:cache/v20240201:RedisEnterprise":
...
pulumi.runtime.registerResourceModule("azure-native", "cache/v20240201", _module)
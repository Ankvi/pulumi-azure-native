...
export class RedisEnterprise extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cache/v20230801preview:RedisEnterprise';
     ...
     */
    public readonly encryption!: pulumi.Output<types.outputs.cache.v20230801preview.ClusterPropertiesResponseEncryption | undefined>;
    /**
     ...
     */
    public readonly identity!: pulumi.Output<types.outputs.cache.v20230801preview.ManagedServiceIdentityResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly privateEndpointConnections!: pulumi.Output<types.outputs.cache.v20230801preview.PrivateEndpointConnectionResponse[]>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<types.outputs.cache.v20230801preview.EnterpriseSkuResponse>;
    /**
...
export interface RedisEnterpriseArgs {
     ...
     * Encryption-at-rest configuration for the cluster.
     */
    encryption?: pulumi.Input<types.inputs.cache.v20230801preview.ClusterPropertiesEncryptionArgs>;
    /**
     * The identity of the resource.
     */
    identity?: pulumi.Input<types.inputs.cache.v20230801preview.ManagedServiceIdentityArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The minimum TLS version for the cluster to support, e.g. '1.2'
     */
    minimumTlsVersion?: pulumi.Input<string | types.enums.v20230801preview.TlsVersion>;
    /**
     ...
     * The SKU to create, which affects price, performance, and features.
     */
    sku: pulumi.Input<types.inputs.cache.v20230801preview.EnterpriseSkuArgs>;
    /**
     * Resource tags.
     */

...
export interface GetEnterprisePrivateEndpointConnectionResult {
     ...
     */
    readonly privateEndpoint?: types.outputs.cache.v20230801preview.PrivateEndpointResponse;
    /**
     * A collection of information about the state of the connection between service consumer and provider.
     */
    readonly privateLinkServiceConnectionState: types.outputs.cache.v20230801preview.PrivateLinkServiceConnectionStateResponse;
    /**

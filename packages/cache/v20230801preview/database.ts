...
export class Database extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cache/v20230801preview:Database';
     ...
     */
    public readonly geoReplication!: pulumi.Output<types.outputs.cache.v20230801preview.DatabasePropertiesResponseGeoReplication | undefined>;
    /**
     * Optional set of redis modules to enable in this database - modules can only be added at creation time.
     */
    public readonly modules!: pulumi.Output<types.outputs.cache.v20230801preview.ModuleResponse[] | undefined>;
    /**
     ...
     */
    public readonly persistence!: pulumi.Output<types.outputs.cache.v20230801preview.PersistenceResponse | undefined>;
    /**
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<types.outputs.cache.v20230801preview.SystemDataResponse>;
    /**
...
export interface DatabaseArgs {
     ...
     * Specifies whether redis clients can connect using TLS-encrypted or plaintext redis protocols. Default is TLS-encrypted.
     */
    clientProtocol?: pulumi.Input<string | types.enums.v20230801preview.Protocol>;
    /**
     ...
     * Clustering policy - default is OSSCluster. Specified at create time.
     */
    clusteringPolicy?: pulumi.Input<string | types.enums.v20230801preview.ClusteringPolicy>;
    /**
     ...
     * Redis eviction policy - default is VolatileLRU
     */
    evictionPolicy?: pulumi.Input<string | types.enums.v20230801preview.EvictionPolicy>;
    /**
     * Optional set of properties to configure geo replication for this database.
     */
    geoReplication?: pulumi.Input<types.inputs.cache.v20230801preview.DatabasePropertiesGeoReplicationArgs>;
    /**
     * Optional set of redis modules to enable in this database - modules can only be added at creation time.
     */
    modules?: pulumi.Input<pulumi.Input<types.inputs.cache.v20230801preview.ModuleArgs>[]>;
    /**
     * Persistence settings
     */
    persistence?: pulumi.Input<types.inputs.cache.v20230801preview.PersistenceArgs>;
    /**
     * TCP port of the database endpoint. Specified at create time. Defaults to an available port.
     */

...
export function getRedisEnterprise(args: GetRedisEnterpriseArgs, opts?: pulumi.InvokeOptions): Promise<GetRedisEnterpriseResult> {
    ...
    return pulumi.runtime.invoke("azure-native:cache/v20230301preview:getRedisEnterprise", {
...
export interface GetRedisEnterpriseResult {
     ...
     */
    readonly encryption?: types.outputs.cache.v20230301preview.ClusterPropertiesResponseEncryption;
    /**
     ...
     */
    readonly identity?: types.outputs.cache.v20230301preview.ManagedServiceIdentityResponse;
    /**
     ...
     */
    readonly privateEndpointConnections: types.outputs.cache.v20230301preview.PrivateEndpointConnectionResponse[];
    /**
     ...
     */
    readonly sku: types.outputs.cache.v20230301preview.EnterpriseSkuResponse;
    /**

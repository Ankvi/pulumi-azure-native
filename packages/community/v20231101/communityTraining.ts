...
export class CommunityTraining extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:community/v20231101:CommunityTraining';
    ...
    constructor(name: string, args: CommunityTrainingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:community:CommunityTraining" }] };

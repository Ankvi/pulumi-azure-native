...
export class IotHubResource extends pulumi.CustomResource {
     ...
     */
    declare public readonly identity: pulumi.Output<types.outputs.ArmIdentityResponse | undefined>;
    /**
     ...
     * IotHub properties
     */
    declare public readonly properties: pulumi.Output<types.outputs.IotHubPropertiesResponse>;
    /**
     * IotHub SKU info
     */
    declare public readonly sku: pulumi.Output<types.outputs.IotHubSkuInfoResponse>;
    /**

...
export class Firmware extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:iotfirmwaredefense/v20240110:Firmware';
    ...
    constructor(name: string, args: FirmwareArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:iotfirmwaredefense:Firmware" }, { type: "azure-native:iotfirmwaredefense/v20230208preview:Firmware" }] };

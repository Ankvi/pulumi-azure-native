...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:iotfirmwaredefense/v20240110:Firmware":
                return new Firmware(name, <any>undefined, { urn })
            case "azure-native:iotfirmwaredefense/v20240110:Workspace":
...
pulumi.runtime.registerResourceModule("azure-native", "iotfirmwaredefense/v20240110", _module)
...
export class GitHubConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securitydevops/v20220901preview:GitHubConnector';
    ...
    constructor(name: string, args: GitHubConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:securitydevops:GitHubConnector" }] };

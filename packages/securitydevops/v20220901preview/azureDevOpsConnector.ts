...
export class AzureDevOpsConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securitydevops/v20220901preview:AzureDevOpsConnector';
    ...
    constructor(name: string, args: AzureDevOpsConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:securitydevops:AzureDevOpsConnector" }] };

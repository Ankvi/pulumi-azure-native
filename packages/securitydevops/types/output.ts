...
export namespace securitydevops {
    ...
    export namespace v20220901preview {
        ...
        export interface AzureDevOpsConnectorPropertiesResponse {
            authorization?: v20220901preview.AuthorizationInfoResponse;
            /**
             * Gets or sets org onboarding information.
             */
            orgs?: v20220901preview.AzureDevOpsOrgMetadataResponse[];
            provisioningState: string;
        }
        ...
        export interface AzureDevOpsOrgMetadataResponse {
             ...
             */
            name?: string;
            projects?: v20220901preview.AzureDevOpsProjectMetadataResponse[];
        }

...
export class GitHubConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:securitydevops:GitHubConnector';
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.securitydevops.GitHubConnectorPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: GitHubConnectorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["gitHubConnectorName"] = args ? args.gitHubConnectorName : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:securitydevops/v20220901preview:GitHubConnector" }] };
...
export interface GitHubConnectorArgs {
     ...
     * Properties of the ARM resource for /subscriptions/xxx/resourceGroups/xxx/providers/Microsoft.SecurityDevOps/gitHubConnectors.
     */
    properties?: pulumi.Input<types.inputs.securitydevops.GitHubConnectorPropertiesArgs>;
    /**

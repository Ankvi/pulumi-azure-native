...
export class OnlineExperimentationWorkspace extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.OnlineExperimentationWorkspacePropertiesResponse>;
    /**
     * The SKU (Stock Keeping Unit) assigned to this resource.
     */
    declare public readonly sku: pulumi.Output<types.outputs.OnlineExperimentationWorkspaceSkuResponse | undefined>;
    /**
    ...
    constructor(name: string, args: OnlineExperimentationWorkspaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:onlineexperimentation/v20250531preview:OnlineExperimentationWorkspace" }, { type: "azure-native:onlineexperimentation/v20250801preview:OnlineExperimentationWorkspace" }] };

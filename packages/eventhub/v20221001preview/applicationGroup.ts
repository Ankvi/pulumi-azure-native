...
export class ApplicationGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventhub/v20221001preview:ApplicationGroup';
     ...
     */
    public readonly policies!: pulumi.Output<types.outputs.eventhub.v20221001preview.ThrottlingPolicyResponse[] | undefined>;
    /**
...
export interface ApplicationGroupArgs {
     ...
     * List of group policies that define the behavior of application group. The policies can support resource governance scenarios such as limiting ingress or egress traffic.
     */
    policies?: pulumi.Input<pulumi.Input<types.inputs.eventhub.v20221001preview.ThrottlingPolicyArgs>[]>;
    /**

...
export function getNamespaceNetworkRuleSet(args: GetNamespaceNetworkRuleSetArgs, opts?: pulumi.InvokeOptions): Promise<GetNamespaceNetworkRuleSetResult> {
    ...
    return pulumi.runtime.invoke("azure-native:eventhub/v20221001preview:getNamespaceNetworkRuleSet", {
...
export interface GetNamespaceNetworkRuleSetResult {
     ...
     * List of IpRules
     */
    readonly ipRules?: types.outputs.eventhub.v20221001preview.NWRuleSetIpRulesResponse[];
    /**
     ...
     */
    readonly virtualNetworkRules?: types.outputs.eventhub.v20221001preview.NWRuleSetVirtualNetworkRulesResponse[];
}
/**
 * Gets NetworkRuleSet for a Namespace.
 */

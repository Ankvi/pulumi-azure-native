...
export class EventHub extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventhub/v20221001preview:EventHub';
     ...
     */
    public readonly captureDescription!: pulumi.Output<types.outputs.eventhub.v20221001preview.CaptureDescriptionResponse | undefined>;
    /**
     ...
     */
    public readonly retentionDescription!: pulumi.Output<types.outputs.eventhub.v20221001preview.RetentionDescriptionResponse | undefined>;
    /**
...
export interface EventHubArgs {
     ...
     * Properties of capture description
     */
    captureDescription?: pulumi.Input<types.inputs.eventhub.v20221001preview.CaptureDescriptionArgs>;
    /**
     * The Event Hub name
     */
     ...
     * Event Hub retention settings
     */
    retentionDescription?: pulumi.Input<types.inputs.eventhub.v20221001preview.RetentionDescriptionArgs>;
    /**
     * Enumerates the possible values for the status of the Event Hub.
     */

...
export class NamespaceNetworkRuleSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventhub:NamespaceNetworkRuleSet';
     ...
     * List of IpRules
     */
    declare public readonly ipRules: pulumi.Output<types.outputs.NWRuleSetIpRulesResponse[] | undefined>;
    /**
     ...
     */
    declare public readonly virtualNetworkRules: pulumi.Output<types.outputs.NWRuleSetVirtualNetworkRulesResponse[] | undefined>;

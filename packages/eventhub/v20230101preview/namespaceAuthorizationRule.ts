...
export class NamespaceAuthorizationRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventhub/v20230101preview:NamespaceAuthorizationRule';
...
export interface NamespaceAuthorizationRuleArgs {
     ...
     * The rights associated with the rule.
     */
    rights: pulumi.Input<pulumi.Input<string | types.enums.v20230101preview.AccessRights>[]>;
}

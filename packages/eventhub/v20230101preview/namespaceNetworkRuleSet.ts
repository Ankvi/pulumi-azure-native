...
export class NamespaceNetworkRuleSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventhub/v20230101preview:NamespaceNetworkRuleSet';
     ...
     * List of IpRules
     */
    public readonly ipRules!: pulumi.Output<types.outputs.eventhub.v20230101preview.NWRuleSetIpRulesResponse[] | undefined>;
    /**
     ...
     */
    public readonly virtualNetworkRules!: pulumi.Output<types.outputs.eventhub.v20230101preview.NWRuleSetVirtualNetworkRulesResponse[] | undefined>;
...
export interface NamespaceNetworkRuleSetArgs {
     ...
     * Default Action for Network Rule Set
     */
    defaultAction?: pulumi.Input<string | types.enums.v20230101preview.DefaultAction>;
    /**
     * List of IpRules
     */
    ipRules?: pulumi.Input<pulumi.Input<types.inputs.eventhub.v20230101preview.NWRuleSetIpRulesArgs>[]>;
    /**
     * The Namespace name
     */
     ...
     * This determines if traffic is allowed over public network. By default it is enabled. If value is SecuredByPerimeter then Inbound and Outbound communication is controlled by the network security perimeter and profile's access rules. 
     */
    publicNetworkAccess?: pulumi.Input<string | types.enums.v20230101preview.PublicNetworkAccessFlag>;
    /**
     ...
     * List VirtualNetwork Rules
     */
    virtualNetworkRules?: pulumi.Input<pulumi.Input<types.inputs.eventhub.v20230101preview.NWRuleSetVirtualNetworkRulesArgs>[]>;
}

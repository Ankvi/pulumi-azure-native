...
export function getNamespaceNetworkRuleSet(args: GetNamespaceNetworkRuleSetArgs, opts?: pulumi.InvokeOptions): Promise<GetNamespaceNetworkRuleSetResult> {
    ...
    return pulumi.runtime.invoke("azure-native:eventhub/v20230101preview:getNamespaceNetworkRuleSet", {
...
export interface GetNamespaceNetworkRuleSetResult {
     ...
     * List of IpRules
     */
    readonly ipRules?: types.outputs.eventhub.v20230101preview.NWRuleSetIpRulesResponse[];
    /**
     ...
     */
    readonly virtualNetworkRules?: types.outputs.eventhub.v20230101preview.NWRuleSetVirtualNetworkRulesResponse[];
}
/**
 * Gets NetworkRuleSet for a Namespace.
 */

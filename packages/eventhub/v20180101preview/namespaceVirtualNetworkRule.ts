...
export class NamespaceVirtualNetworkRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:eventhub/v20180101preview:NamespaceVirtualNetworkRule';
    ...
    constructor(name: string, args: NamespaceVirtualNetworkRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:eventhub:NamespaceVirtualNetworkRule" }] };

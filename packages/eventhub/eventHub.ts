...
export class EventHub extends pulumi.CustomResource {
     ...
     */
    declare public readonly captureDescription: pulumi.Output<types.outputs.CaptureDescriptionResponse | undefined>;
    /**
     ...
     */
    declare public readonly retentionDescription: pulumi.Output<types.outputs.RetentionDescriptionResponse | undefined>;
    /**

...
export namespace eventhub {
    ...
    export namespace v20221001preview {
        ...
        export interface CaptureDescriptionArgs {
             ...
             * Properties of Destination where capture will be stored. (Storage Account, Blob Names)
             */
            destination?: pulumi.Input<v20221001preview.DestinationArgs>;
            /**
             * A value that indicates whether capture description is enabled. 
             */
            enabled?: pulumi.Input<boolean>;
             ...
             * Enumerates the possible values for the encoding format of capture description. Note: 'AvroDeflate' will be deprecated in New API Version
             */
            encoding?: pulumi.Input<enums.v20221001preview.EncodingCaptureDescription>;
            /**
             * The time window allows you to set the frequency with which the capture to Azure Blobs will happen, value should between 60 to 900 seconds
             */
            intervalInSeconds?: pulumi.Input<number>;
        ...
        export interface ClusterSkuArgs {
             ...
             * Name of this SKU.
             */
            name: pulumi.Input<string | enums.v20221001preview.ClusterSkuName>;
        }
        ...
        export interface ConnectionStateArgs {
             ...
             * Status of the connection.
             */
            status?: pulumi.Input<string | enums.v20221001preview.PrivateLinkConnectionStatus>;
        }
        ...
        export interface EncryptionArgs {
             ...
             * Enumerates the possible value of keySource for Encryption
             */
            keySource?: pulumi.Input<enums.v20221001preview.KeySource>;
            /**
             * Properties of KeyVault
             */
            keyVaultProperties?: pulumi.Input<pulumi.Input<v20221001preview.KeyVaultPropertiesArgs>[]>;
            /**
             * Enable Infrastructure Encryption (Double Encryption)
             */
            requireInfrastructureEncryption?: pulumi.Input<boolean>;
        ...
        export interface IdentityArgs {
             ...
             * Type of managed service identity.
             */
            type?: pulumi.Input<enums.v20221001preview.ManagedServiceIdentityType>;
            /**
             * Properties for User Assigned Identities
             */
            userAssignedIdentities?: pulumi.Input<pulumi.Input<string>[]>;
         ...
         */
        export interface KeyVaultPropertiesArgs {
            identity?: pulumi.Input<v20221001preview.UserAssignedIdentityPropertiesArgs>;
            /**
             * Name of the Key from KeyVault
             */
            keyName?: pulumi.Input<string>;
        ...
        export interface NWRuleSetIpRulesArgs {
             ...
             * The IP Filter Action
             */
            action?: pulumi.Input<string | enums.v20221001preview.NetworkRuleIPAction>;
            /**
             * IP Mask
             */
            ipMask?: pulumi.Input<string>;
        ...
        export interface NWRuleSetVirtualNetworkRulesArgs {
             ...
             * Subnet properties
             */
            subnet?: pulumi.Input<v20221001preview.SubnetArgs>;
        }
        ...
        export interface PrivateEndpointConnectionArgs {
             ...
             * The Private Endpoint resource for this Connection.
             */
            privateEndpoint?: pulumi.Input<v20221001preview.PrivateEndpointArgs>;
            /**
             * Details about the state of the connection.
             */
            privateLinkServiceConnectionState?: pulumi.Input<v20221001preview.ConnectionStateArgs>;
            /**
             * Provisioning state of the Private Endpoint Connection.
             */
            provisioningState?: pulumi.Input<string | enums.v20221001preview.EndPointProvisioningState>;
        }
        ...
        export interface RetentionDescriptionArgs {
             ...
             * Enumerates the possible values for cleanup policy
             */
            cleanupPolicy?: pulumi.Input<string | enums.v20221001preview.CleanupPolicyRetentionDescription>;
            /**
             * Number of hours to retain the events for this Event Hub. This value is only used when cleanupPolicy is Delete. If cleanupPolicy is Compact the returned value of this property is Long.MaxValue 
             */
            retentionTimeInHours?: pulumi.Input<number>;
        ...
        export interface SkuArgs {
             ...
             * The billing tier of this particular SKU.
             */
            tier?: pulumi.Input<string | enums.v20221001preview.SkuTier>;
        }
        ...
        export interface ThrottlingPolicyArgs {
             ...
             * Metric Id on which the throttle limit should be set, MetricId can be discovered by hovering over Metric in the Metrics section of Event Hub Namespace inside Azure Portal
             */
            metricId: pulumi.Input<string | enums.v20221001preview.MetricId>;
            /**
             * The Name of this policy
             */
            name: pulumi.Input<string>;
    ...
    export namespace v20230101preview {
        ...
        export interface CaptureDescriptionArgs {
             ...
             * Properties of Destination where capture will be stored. (Storage Account, Blob Names)
             */
            destination?: pulumi.Input<v20230101preview.DestinationArgs>;
            /**
             * A value that indicates whether capture description is enabled. 
             */
            enabled?: pulumi.Input<boolean>;
             ...
             * Enumerates the possible values for the encoding format of capture description. Note: 'AvroDeflate' will be deprecated in New API Version
             */
            encoding?: pulumi.Input<enums.v20230101preview.EncodingCaptureDescription>;
            /**
             * The time window allows you to set the frequency with which the capture to Azure Blobs will happen, value should between 60 to 900 seconds
             */
            intervalInSeconds?: pulumi.Input<number>;
        ...
        export interface CaptureIdentityArgs {
             ...
             */
            type?: pulumi.Input<enums.v20230101preview.CaptureIdentityType>;
            /**
        ...
        export interface ClusterSkuArgs {
             ...
             * Name of this SKU.
             */
            name: pulumi.Input<string | enums.v20230101preview.ClusterSkuName>;
        }
        ...
        export interface DestinationArgs {
             ...
             * A value that indicates whether capture description is enabled.
             */
            identity?: pulumi.Input<v20230101preview.CaptureIdentityArgs>;
            /**
             * Name for capture destination
             */
            name?: pulumi.Input<string>;
        ...
        export interface EncryptionArgs {
             ...
             * Enumerates the possible value of keySource for Encryption
             */
            keySource?: pulumi.Input<enums.v20230101preview.KeySource>;
            /**
             * Properties of KeyVault
             */
            keyVaultProperties?: pulumi.Input<pulumi.Input<v20230101preview.KeyVaultPropertiesArgs>[]>;
            /**
             * Enable Infrastructure Encryption (Double Encryption)
             */
            requireInfrastructureEncryption?: pulumi.Input<boolean>;
        ...
        export interface GeoDataReplicationPropertiesArgs {
             ...
             */
            locations?: pulumi.Input<pulumi.Input<v20230101preview.NamespaceReplicaLocationArgs>[]>;
            /**
             ...
             */
            maxReplicationLagDurationInSeconds?: pulumi.Input<number>;
        }
        ...
        export interface IdentityArgs {
             ...
             * Type of managed service identity.
             */
            type?: pulumi.Input<enums.v20230101preview.ManagedServiceIdentityType>;
            /**
             * Properties for User Assigned Identities
             */
            userAssignedIdentities?: pulumi.Input<pulumi.Input<string>[]>;
         ...
         */
        export interface KeyVaultPropertiesArgs {
            identity?: pulumi.Input<v20230101preview.UserAssignedIdentityPropertiesArgs>;
            /**
             * Name of the Key from KeyVault
             */
            keyName?: pulumi.Input<string>;
        ...
        export interface NWRuleSetIpRulesArgs {
             ...
             * The IP Filter Action
             */
            action?: pulumi.Input<string | enums.v20230101preview.NetworkRuleIPAction>;
            /**
             * IP Mask
             */
            ipMask?: pulumi.Input<string>;
        ...
        export interface NWRuleSetVirtualNetworkRulesArgs {
             ...
             * Subnet properties
             */
            subnet?: pulumi.Input<v20230101preview.SubnetArgs>;
        }
        ...
        export interface NamespaceReplicaLocationArgs {
             ...
             * GeoDR Role Types
             */
            roleType?: pulumi.Input<string | enums.v20230101preview.GeoDRRoleType>;
        }
        ...
        export interface PrivateEndpointConnectionArgs {
             ...
             * The Private Endpoint resource for this Connection.
             */
            privateEndpoint?: pulumi.Input<v20230101preview.PrivateEndpointArgs>;
            /**
             * Details about the state of the connection.
             */
            privateLinkServiceConnectionState?: pulumi.Input<v20230101preview.ConnectionStateArgs>;
            /**
             * Provisioning state of the Private Endpoint Connection.
             */
            provisioningState?: pulumi.Input<string | enums.v20230101preview.EndPointProvisioningState>;
        }
        ...
        export interface RetentionDescriptionArgs {
             ...
             * Enumerates the possible values for cleanup policy
             */
            cleanupPolicy?: pulumi.Input<string | enums.v20230101preview.CleanupPolicyRetentionDescription>;
            /**
             * Number of hours to retain the events for this Event Hub. This value is only used when cleanupPolicy is Delete. If cleanupPolicy is Compact the returned value of this property is Long.MaxValue 
             */
            retentionTimeInHours?: pulumi.Input<number>;
        ...
        export interface ThrottlingPolicyArgs {
             ...
             * Metric Id on which the throttle limit should be set, MetricId can be discovered by hovering over Metric in the Metrics section of Event Hub Namespace inside Azure Portal
             */
            metricId: pulumi.Input<string | enums.v20230101preview.MetricId>;
            /**
             * The Name of this policy
             */
            name: pulumi.Input<string>;

...
export class ApplicationGroup extends pulumi.CustomResource {
     ...
     */
    public readonly policies!: pulumi.Output<types.outputs.eventhub.ThrottlingPolicyResponse[] | undefined>;
    /**
...
export interface ApplicationGroupArgs {
     ...
     * List of group policies that define the behavior of application group. The policies can support resource governance scenarios such as limiting ingress or egress traffic.
     */
    policies?: pulumi.Input<pulumi.Input<types.inputs.eventhub.ThrottlingPolicyArgs>[]>;
    /**

...
export class DnsSecurityRule extends pulumi.CustomResource {
     ...
     */
    declare public readonly action: pulumi.Output<types.outputs.DnsSecurityRuleActionResponse>;
    /**
     ...
     */
    declare public readonly dnsResolverDomainLists: pulumi.Output<types.outputs.SubResourceResponse[]>;
    /**

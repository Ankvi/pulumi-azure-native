...
export class DnsForwardingRuleset extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:dnsresolver:DnsForwardingRuleset';
     ...
     */
    declare public readonly dnsResolverOutboundEndpoints: pulumi.Output<types.outputs.SubResourceResponse[]>;
    /**

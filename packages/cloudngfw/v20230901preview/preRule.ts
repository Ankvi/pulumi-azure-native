...
export class PreRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cloudngfw/v20230901preview:PreRule';
    ...
    constructor(name: string, args: PreRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cloudngfw:PreRule" }, { type: "azure-native:cloudngfw/v20220829:PreRule" }, { type: "azure-native:cloudngfw/v20220829preview:PreRule" }, { type: "azure-native:cloudngfw/v20230901:PreRule" }, { type: "azure-native:cloudngfw/v20231010preview:PreRule" }, { type: "azure-native:cloudngfw/v20240119preview:PreRule" }, { type: "azure-native:cloudngfw/v20240207preview:PreRule" }] };

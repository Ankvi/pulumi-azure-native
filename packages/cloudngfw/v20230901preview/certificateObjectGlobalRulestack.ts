...
export class CertificateObjectGlobalRulestack extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cloudngfw/v20230901preview:CertificateObjectGlobalRulestack';
    ...
    constructor(name: string, args: CertificateObjectGlobalRulestackArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cloudngfw:CertificateObjectGlobalRulestack" }, { type: "azure-native:cloudngfw/v20220829:CertificateObjectGlobalRulestack" }, { type: "azure-native:cloudngfw/v20220829preview:CertificateObjectGlobalRulestack" }, { type: "azure-native:cloudngfw/v20230901:CertificateObjectGlobalRulestack" }, { type: "azure-native:cloudngfw/v20231010preview:CertificateObjectGlobalRulestack" }, { type: "azure-native:cloudngfw/v20240119preview:CertificateObjectGlobalRulestack" }, { type: "azure-native:cloudngfw/v20240207preview:CertificateObjectGlobalRulestack" }] };

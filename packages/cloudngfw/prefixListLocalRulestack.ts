...
export class PrefixListLocalRulestack extends pulumi.CustomResource {
     ...
     * prefix list
     */
    declare public readonly prefixList: pulumi.Output<string[]>;
    /**

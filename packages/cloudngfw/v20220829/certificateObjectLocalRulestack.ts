...
export class CertificateObjectLocalRulestack extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cloudngfw/v20220829:CertificateObjectLocalRulestack';

...
export class CertificateObjectGlobalRulestack extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cloudngfw/v20220829preview:CertificateObjectGlobalRulestack';

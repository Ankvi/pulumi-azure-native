...
export class LocalRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cloudngfw/v20220829preview:LocalRule';
    ...
    constructor(name: string, args: LocalRuleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cloudngfw:LocalRule" }, { type: "azure-native:cloudngfw/v20220829:LocalRule" }, { type: "azure-native:cloudngfw/v20230901:LocalRule" }, { type: "azure-native:cloudngfw/v20230901preview:LocalRule" }, { type: "azure-native:cloudngfw/v20231010preview:LocalRule" }, { type: "azure-native:cloudngfw/v20240119preview:LocalRule" }, { type: "azure-native:cloudngfw/v20240207preview:LocalRule" }] };

...
export class FqdnListGlobalRulestack extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cloudngfw/v20240119preview:FqdnListGlobalRulestack';

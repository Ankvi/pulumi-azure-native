...
export class PrefixListGlobalRulestack extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cloudngfw/v20240207preview:PrefixListGlobalRulestack';
    ...
    constructor(name: string, args: PrefixListGlobalRulestackArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cloudngfw:PrefixListGlobalRulestack" }, { type: "azure-native:cloudngfw/v20220829:PrefixListGlobalRulestack" }, { type: "azure-native:cloudngfw/v20220829preview:PrefixListGlobalRulestack" }, { type: "azure-native:cloudngfw/v20230901:PrefixListGlobalRulestack" }, { type: "azure-native:cloudngfw/v20230901preview:PrefixListGlobalRulestack" }, { type: "azure-native:cloudngfw/v20231010preview:PrefixListGlobalRulestack" }, { type: "azure-native:cloudngfw/v20240119preview:PrefixListGlobalRulestack" }] };

...
export class GlobalRulestack extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cloudngfw:GlobalRulestack';
     ...
     * Security Profile
     */
    declare public readonly securityServices: pulumi.Output<types.outputs.SecurityServicesResponse | undefined>;
    /**

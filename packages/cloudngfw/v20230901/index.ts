...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:cloudngfw/v20230901:CertificateObjectGlobalRulestack":
                return new CertificateObjectGlobalRulestack(name, <any>undefined, { urn })
            case "azure-native:cloudngfw/v20230901:CertificateObjectLocalRulestack":
                return new CertificateObjectLocalRulestack(name, <any>undefined, { urn })
            case "azure-native:cloudngfw/v20230901:Firewall":
                return new Firewall(name, <any>undefined, { urn })
            case "azure-native:cloudngfw/v20230901:FqdnListGlobalRulestack":
                return new FqdnListGlobalRulestack(name, <any>undefined, { urn })
            case "azure-native:cloudngfw/v20230901:FqdnListLocalRulestack":
                return new FqdnListLocalRulestack(name, <any>undefined, { urn })
            case "azure-native:cloudngfw/v20230901:GlobalRulestack":
                return new GlobalRulestack(name, <any>undefined, { urn })
            case "azure-native:cloudngfw/v20230901:LocalRule":
                return new LocalRule(name, <any>undefined, { urn })
            case "azure-native:cloudngfw/v20230901:LocalRulestack":
                return new LocalRulestack(name, <any>undefined, { urn })
            case "azure-native:cloudngfw/v20230901:PostRule":
                return new PostRule(name, <any>undefined, { urn })
            case "azure-native:cloudngfw/v20230901:PreRule":
                return new PreRule(name, <any>undefined, { urn })
            case "azure-native:cloudngfw/v20230901:PrefixListGlobalRulestack":
                return new PrefixListGlobalRulestack(name, <any>undefined, { urn })
            case "azure-native:cloudngfw/v20230901:PrefixListLocalRulestack":
...
pulumi.runtime.registerResourceModule("azure-native", "cloudngfw/v20230901", _module)
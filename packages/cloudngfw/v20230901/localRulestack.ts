...
export class LocalRulestack extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cloudngfw/v20230901:LocalRulestack';

...
export class FqdnListGlobalRulestack extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:cloudngfw/v20230901:FqdnListGlobalRulestack';
    ...
    constructor(name: string, args: FqdnListGlobalRulestackArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:cloudngfw:FqdnListGlobalRulestack" }, { type: "azure-native:cloudngfw/v20220829:FqdnListGlobalRulestack" }, { type: "azure-native:cloudngfw/v20220829preview:FqdnListGlobalRulestack" }, { type: "azure-native:cloudngfw/v20230901preview:FqdnListGlobalRulestack" }, { type: "azure-native:cloudngfw/v20231010preview:FqdnListGlobalRulestack" }, { type: "azure-native:cloudngfw/v20240119preview:FqdnListGlobalRulestack" }, { type: "azure-native:cloudngfw/v20240207preview:FqdnListGlobalRulestack" }] };

...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:cloudngfw/v20231010preview:CertificateObjectGlobalRulestack":
                return new CertificateObjectGlobalRulestack(name, <any>undefined, { urn })
            case "azure-native:cloudngfw/v20231010preview:CertificateObjectLocalRulestack":
                return new CertificateObjectLocalRulestack(name, <any>undefined, { urn })
            case "azure-native:cloudngfw/v20231010preview:Firewall":
                return new Firewall(name, <any>undefined, { urn })
            case "azure-native:cloudngfw/v20231010preview:FqdnListGlobalRulestack":
                return new FqdnListGlobalRulestack(name, <any>undefined, { urn })
            case "azure-native:cloudngfw/v20231010preview:FqdnListLocalRulestack":
                return new FqdnListLocalRulestack(name, <any>undefined, { urn })
            case "azure-native:cloudngfw/v20231010preview:GlobalRulestack":
                return new GlobalRulestack(name, <any>undefined, { urn })
            case "azure-native:cloudngfw/v20231010preview:LocalRule":
                return new LocalRule(name, <any>undefined, { urn })
            case "azure-native:cloudngfw/v20231010preview:LocalRulestack":
                return new LocalRulestack(name, <any>undefined, { urn })
            case "azure-native:cloudngfw/v20231010preview:PostRule":
                return new PostRule(name, <any>undefined, { urn })
            case "azure-native:cloudngfw/v20231010preview:PreRule":
                return new PreRule(name, <any>undefined, { urn })
            case "azure-native:cloudngfw/v20231010preview:PrefixListGlobalRulestack":
                return new PrefixListGlobalRulestack(name, <any>undefined, { urn })
            case "azure-native:cloudngfw/v20231010preview:PrefixListLocalRulestack":
...
pulumi.runtime.registerResourceModule("azure-native", "cloudngfw/v20231010preview", _module)
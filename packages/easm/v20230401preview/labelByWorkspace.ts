...
export class LabelByWorkspace extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:easm/v20230401preview:LabelByWorkspace';
     ...
     */
    public /*out*/ readonly systemData!: pulumi.Output<types.outputs.easm.v20230401preview.SystemDataResponse>;
    /**
    ...
    constructor(name: string, args: LabelByWorkspaceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:easm:LabelByWorkspace" }, { type: "azure-native:easm/v20220401preview:LabelByWorkspace" }] };

...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:easm/v20230401preview:LabelByWorkspace":
                return new LabelByWorkspace(name, <any>undefined, { urn })
            case "azure-native:easm/v20230401preview:Workspace":
...
pulumi.runtime.registerResourceModule("azure-native", "easm/v20230401preview", _module)

...
export class APICollection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:security/v20221120preview:APICollection';
    ...
    constructor(name: string, args: APICollectionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:security:APICollection" }, { type: "azure-native:security/v20231115:APICollection" }] };

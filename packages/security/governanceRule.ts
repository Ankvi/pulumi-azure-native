...
export class GovernanceRule extends pulumi.CustomResource {
     ...
     */
    declare public readonly governanceEmailNotification: pulumi.Output<types.outputs.GovernanceRuleEmailNotificationResponse | undefined>;
    /**
     ...
     */
    declare public readonly ownerSource: pulumi.Output<types.outputs.GovernanceRuleOwnerSourceResponse>;
    /**

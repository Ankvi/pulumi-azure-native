...
export class Automation extends pulumi.CustomResource {
     ...
     */
    declare public readonly actions: pulumi.Output<(types.outputs.AutomationActionEventHubResponse | types.outputs.AutomationActionLogicAppResponse | types.outputs.AutomationActionWorkspaceResponse)[] | undefined>;
    /**
     ...
     */
    declare public readonly scopes: pulumi.Output<types.outputs.AutomationScopeResponse[] | undefined>;
    /**

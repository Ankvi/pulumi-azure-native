...
export class DeviceSecurityGroup extends pulumi.CustomResource {
     ...
     */
    declare public readonly allowlistRules: pulumi.Output<types.outputs.AllowlistCustomAlertRuleResponse[] | undefined>;
    /**
     ...
     */
    declare public readonly thresholdRules: pulumi.Output<types.outputs.ThresholdCustomAlertRuleResponse[] | undefined>;
    /**

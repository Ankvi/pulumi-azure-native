...
export class JitNetworkAccessPolicy extends pulumi.CustomResource {
    ...
    declare public readonly requests: pulumi.Output<types.outputs.JitNetworkAccessRequestResponse[] | undefined>;
    /**
     * Resource type
     */
     ...
     */
    declare public readonly virtualMachines: pulumi.Output<types.outputs.JitNetworkAccessPolicyVirtualMachineResponse[]>;
    ...
    constructor(name: string, args: JitNetworkAccessPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            if (args?.virtualMachines === undefined && !opts.urn) {
                throw new Error("Missing required property 'virtualMachines'");
            }
            resourceInputs["ascLocation"] = args?.ascLocation;
            resourceInputs["jitNetworkAccessPolicyName"] = args?.jitNetworkAccessPolicyName;

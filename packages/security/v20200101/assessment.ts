...
export class Assessment extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly links!: pulumi.Output<types.outputs.security.v20200101.AssessmentLinksResponse>;
    /**
     * Describes properties of an assessment metadata.
     */
    public readonly metadata!: pulumi.Output<types.outputs.security.v20200101.SecurityAssessmentMetadataPropertiesResponse | undefined>;
    /**
     * Resource name
     */
     ...
     */
    public readonly partnersData!: pulumi.Output<types.outputs.security.v20200101.SecurityAssessmentPartnerDataResponse | undefined>;
    /**
     * Details of the resource that was assessed
     */
    public readonly resourceDetails!: pulumi.Output<types.outputs.security.v20200101.AzureResourceDetailsResponse | types.outputs.security.v20200101.OnPremiseResourceDetailsResponse | types.outputs.security.v20200101.OnPremiseSqlResourceDetailsResponse>;
    /**
     * The result of the assessment
     */
    public readonly status!: pulumi.Output<types.outputs.security.v20200101.AssessmentStatusResponse>;
    /**
     * Resource type
     */
...
export interface AssessmentArgs {
     ...
     * Describes properties of an assessment metadata.
     */
    metadata?: pulumi.Input<types.inputs.security.v20200101.SecurityAssessmentMetadataPropertiesArgs>;
    /**
     * Data regarding 3rd party partner integration
     */
    partnersData?: pulumi.Input<types.inputs.security.v20200101.SecurityAssessmentPartnerDataArgs>;
    /**
     * Details of the resource that was assessed
     */
    resourceDetails: pulumi.Input<types.inputs.security.v20200101.AzureResourceDetailsArgs | types.inputs.security.v20200101.OnPremiseResourceDetailsArgs | types.inputs.security.v20200101.OnPremiseSqlResourceDetailsArgs>;
    /**
     ...
     * The result of the assessment
     */
    status: pulumi.Input<types.inputs.security.v20200101.AssessmentStatusArgs>;
}

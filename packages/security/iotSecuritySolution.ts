...
export class IotSecuritySolution extends pulumi.CustomResource {
     ...
     */
    declare public readonly additionalWorkspaces: pulumi.Output<types.outputs.AdditionalWorkspacesPropertiesResponse[] | undefined>;
    /**
     ...
     */
    declare public readonly recommendationsConfiguration: pulumi.Output<types.outputs.RecommendationConfigurationPropertiesResponse[] | undefined>;
    /**
     ...
     */
    declare public readonly userDefinedResources: pulumi.Output<types.outputs.UserDefinedResourcesPropertiesResponse | undefined>;
    /**

...
export class WorkspaceSetting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:security/v20170801preview:WorkspaceSetting';
    ...
    constructor(name: string, args: WorkspaceSettingArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:security:WorkspaceSetting" }] };

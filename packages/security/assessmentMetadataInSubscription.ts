...
export class AssessmentMetadataInSubscription extends pulumi.CustomResource {
     ...
     */
    declare public readonly partnerData: pulumi.Output<types.outputs.SecurityAssessmentMetadataPartnerDataResponse | undefined>;
    declare public readonly plannedDeprecationDate: pulumi.Output<string | undefined>;
    /**
    ...
    declare public readonly publishDates: pulumi.Output<types.outputs.SecurityAssessmentMetadataPropertiesResponseResponsePublishDates | undefined>;
    /**
    ...
    constructor(name: string, args: AssessmentMetadataInSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["partnerData"] = args?.partnerData;
            resourceInputs["plannedDeprecationDate"] = args?.plannedDeprecationDate;
            resourceInputs["preview"] = args?.preview;
            resourceInputs["publishDates"] = args?.publishDates;

...
export class SecurityContact extends pulumi.CustomResource {
     ...
     */
    declare public readonly notificationsSources: pulumi.Output<(types.outputs.NotificationsSourceAlertResponse | types.outputs.NotificationsSourceAttackPathResponse)[] | undefined>;
    /**

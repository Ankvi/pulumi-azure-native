...
export class SecurityConnectorApplication extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:security/v20220701preview:SecurityConnectorApplication';
    ...
    constructor(name: string, args: SecurityConnectorApplicationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:security:SecurityConnectorApplication" }] };

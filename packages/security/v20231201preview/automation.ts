...
export class Automation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:security/v20231201preview:Automation';
    ...
    constructor(name: string, args: AutomationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:security:Automation" }, { type: "azure-native:security/v20190101preview:Automation" }] };

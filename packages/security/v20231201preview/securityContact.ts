...
export class SecurityContact extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:security/v20231201preview:SecurityContact';
     ...
     */
    public readonly notificationsSources!: pulumi.Output<(types.outputs.NotificationsSourceAlertResponse | types.outputs.NotificationsSourceAttackPathResponse)[] | undefined>;
    /**
    ...
    constructor(name: string, args?: SecurityContactArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:security:SecurityContact" }, { type: "azure-native:security/v20170801preview:SecurityContact" }, { type: "azure-native:security/v20200101preview:SecurityContact" }] };

...
export class WorkspaceTagApiLink extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WorkspaceTagApiLinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement/v20220901preview:WorkspaceTagApiLink" }, { type: "azure-native:apimanagement/v20230301preview:WorkspaceTagApiLink" }, { type: "azure-native:apimanagement/v20230501preview:WorkspaceTagApiLink" }] };

...
export class WorkspaceApi extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WorkspaceApiArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement/v20220901preview:WorkspaceApi" }, { type: "azure-native:apimanagement/v20230301preview:WorkspaceApi" }, { type: "azure-native:apimanagement/v20230501preview:WorkspaceApi" }, { type: "azure-native:apimanagement/v20230901preview:WorkspaceApi" }, { type: "azure-native:apimanagement/v20240501:WorkspaceApi" }] };

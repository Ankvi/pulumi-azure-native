...
export class ProductGroupLink extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20230501preview:ProductGroupLink';
    ...
    constructor(name: string, args: ProductGroupLinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:ProductGroupLink" }, { type: "azure-native:apimanagement/v20220901preview:ProductGroupLink" }, { type: "azure-native:apimanagement/v20230301preview:ProductGroupLink" }] };

...
export class TagProductLink extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20230501preview:TagProductLink';
    ...
    constructor(name: string, args: TagProductLinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:TagProductLink" }, { type: "azure-native:apimanagement/v20220901preview:TagProductLink" }, { type: "azure-native:apimanagement/v20230301preview:TagProductLink" }] };

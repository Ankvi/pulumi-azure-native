...
export class WorkspaceProductPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20230501preview:WorkspaceProductPolicy';
    ...
    constructor(name: string, args: WorkspaceProductPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:WorkspaceProductPolicy" }, { type: "azure-native:apimanagement/v20220901preview:WorkspaceProductPolicy" }, { type: "azure-native:apimanagement/v20230301preview:WorkspaceProductPolicy" }] };

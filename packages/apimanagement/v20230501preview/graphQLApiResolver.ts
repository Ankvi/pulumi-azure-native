...
export class GraphQLApiResolver extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20230501preview:GraphQLApiResolver';
    ...
    constructor(name: string, args: GraphQLApiResolverArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:GraphQLApiResolver" }, { type: "azure-native:apimanagement/v20220801:GraphQLApiResolver" }, { type: "azure-native:apimanagement/v20220901preview:GraphQLApiResolver" }, { type: "azure-native:apimanagement/v20230301preview:GraphQLApiResolver" }] };

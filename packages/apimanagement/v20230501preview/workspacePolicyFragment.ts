...
export class WorkspacePolicyFragment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20230501preview:WorkspacePolicyFragment';
    ...
    constructor(name: string, args: WorkspacePolicyFragmentArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:WorkspacePolicyFragment" }, { type: "azure-native:apimanagement/v20220901preview:WorkspacePolicyFragment" }, { type: "azure-native:apimanagement/v20230301preview:WorkspacePolicyFragment" }] };

...
export class WorkspaceSubscription extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20230501preview:WorkspaceSubscription';
    ...
    constructor(name: string, args: WorkspaceSubscriptionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:WorkspaceSubscription" }, { type: "azure-native:apimanagement/v20220901preview:WorkspaceSubscription" }, { type: "azure-native:apimanagement/v20230301preview:WorkspaceSubscription" }] };

...
export class ClientApplicationProductLink extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ClientApplicationProductLink {
        return new ClientApplicationProductLink(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement:ClientApplicationProductLink';
     ...
     */
    public static isInstance(obj: any): obj is ClientApplicationProductLink {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ClientApplicationProductLink.__pulumiType;
    }

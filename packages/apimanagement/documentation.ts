...
export class Documentation extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DocumentationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["documentationId"] = args?.documentationId;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement/v20220801:Documentation" }, { type: "azure-native:apimanagement/v20220901preview:Documentation" }, { type: "azure-native:apimanagement/v20230301preview:Documentation" }, { type: "azure-native:apimanagement/v20230501preview:Documentation" }, { type: "azure-native:apimanagement/v20230901preview:Documentation" }, { type: "azure-native:apimanagement/v20240501:Documentation" }, { type: "azure-native:apimanagement/v20240601preview:Documentation" }, { type: "azure-native:apimanagement/v20241001preview:Documentation" }] };

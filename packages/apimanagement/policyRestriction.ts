...
export class PolicyRestriction extends pulumi.CustomResource {
     ...
     */
    declare public readonly requireBase: pulumi.Output<string | undefined>;
    /**
    ...
    constructor(name: string, args: PolicyRestrictionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["policyRestrictionId"] = args?.policyRestrictionId;
            resourceInputs["requireBase"] = (args?.requireBase) ?? "false";
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement/v20230501preview:PolicyRestriction" }, { type: "azure-native:apimanagement/v20230901preview:PolicyRestriction" }, { type: "azure-native:apimanagement/v20240501:PolicyRestriction" }, { type: "azure-native:apimanagement/v20240601preview:PolicyRestriction" }, { type: "azure-native:apimanagement/v20241001preview:PolicyRestriction" }] };

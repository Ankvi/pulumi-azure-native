...
export class WorkspaceProduct extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WorkspaceProductArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement/v20220901preview:WorkspaceProduct" }, { type: "azure-native:apimanagement/v20230301preview:WorkspaceProduct" }, { type: "azure-native:apimanagement/v20230501preview:WorkspaceProduct" }] };

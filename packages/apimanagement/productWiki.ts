...
export class ProductWiki extends pulumi.CustomResource {
     ...
     */
    declare public readonly documents: pulumi.Output<types.outputs.WikiDocumentationContractResponse[] | undefined>;
    /**

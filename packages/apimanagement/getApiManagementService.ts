...
export interface GetApiManagementServiceResult {
     ...
     */
    readonly additionalLocations?: types.outputs.apimanagement.AdditionalLocationResponse[];
    /**
     * Control Plane Apis version constraint for the API Management service.
     */
    readonly apiVersionConstraint?: types.outputs.apimanagement.ApiVersionConstraintResponse;
    /**
     * List of Certificates that need to be installed in the API Management service. Max supported certificates that can be installed is 10.
     */
    readonly certificates?: types.outputs.apimanagement.CertificateConfigurationResponse[];
    /**
     ...
     */
    readonly hostnameConfigurations?: types.outputs.apimanagement.HostnameConfigurationResponse[];
    /**
     * Resource ID.
     */
    readonly id: string;
     ...
     */
    readonly identity?: types.outputs.apimanagement.ApiManagementServiceIdentityResponse;
    /**
     * Resource location.
     */
     ...
     */
    readonly privateEndpointConnections?: types.outputs.apimanagement.RemotePrivateEndpointConnectionWrapperResponse[];
    /**
     ...
     */
    readonly sku: types.outputs.apimanagement.ApiManagementServiceSkuPropertiesResponse;
    /**
     * Metadata pertaining to creation and last modification of the resource.
     */
    readonly systemData: types.outputs.apimanagement.SystemDataResponse;
    /**
     * Resource tags.
     */
     ...
     */
    readonly virtualNetworkConfiguration?: types.outputs.apimanagement.VirtualNetworkConfigurationResponse;
    /**

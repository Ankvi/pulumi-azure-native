...
export class Gateway extends pulumi.CustomResource {
     ...
     * Gateway location.
     */
    declare public readonly locationData: pulumi.Output<types.outputs.ResourceLocationDataContractResponse | undefined>;
    /**

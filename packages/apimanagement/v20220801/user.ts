...
export class User extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20220801:User';
     ...
     */
    public /*out*/ readonly groups!: pulumi.Output<types.outputs.apimanagement.v20220801.GroupContractPropertiesResponse[]>;
    /**
     * Collection of user identities.
     */
    public readonly identities!: pulumi.Output<types.outputs.apimanagement.v20220801.UserIdentityContractResponse[] | undefined>;
    /**
     * Last name.
     */
...
export interface UserArgs {
     ...
     */
    appType?: pulumi.Input<string | types.enums.v20220801.AppType>;
    /**
     * Determines the type of confirmation e-mail that will be sent to the newly created user.
     */
    confirmation?: pulumi.Input<string | types.enums.v20220801.Confirmation>;
    /**
     ...
     * Collection of user identities.
     */
    identities?: pulumi.Input<pulumi.Input<types.inputs.apimanagement.v20220801.UserIdentityContractArgs>[]>;
    /**
     * Last name.
     */
     ...
     * Account state. Specifies whether the user is active or not. Blocked users are unable to sign into the developer portal or call any APIs of subscribed products. Default state is Active.
     */
    state?: pulumi.Input<string | types.enums.v20220801.UserState>;
    /**

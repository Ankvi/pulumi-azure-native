...
export class GraphQLApiResolverPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20220801:GraphQLApiResolverPolicy';
    ...
    constructor(name: string, args: GraphQLApiResolverPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:GraphQLApiResolverPolicy" }, { type: "azure-native:apimanagement/v20220901preview:GraphQLApiResolverPolicy" }, { type: "azure-native:apimanagement/v20230301preview:GraphQLApiResolverPolicy" }] };
...
export interface GraphQLApiResolverPolicyArgs {
     ...
     * Format of the policyContent.
     */
    format?: pulumi.Input<string | types.enums.v20220801.PolicyContentFormat>;
    /**

...
export class ApiVersionSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20220801:ApiVersionSet';
...
export interface ApiVersionSetArgs {
     ...
     * An value that determines where the API Version identifier will be located in a HTTP request.
     */
    versioningScheme: pulumi.Input<string | types.enums.v20220801.VersioningScheme>;
}

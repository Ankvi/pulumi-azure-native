...
export function getGateway(args: GetGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetGatewayResult> {
    ...
    return pulumi.runtime.invoke("azure-native:apimanagement/v20220801:getGateway", {
...
export interface GetGatewayResult {
     ...
     * Gateway location.
     */
    readonly locationData?: types.outputs.apimanagement.v20220801.ResourceLocationDataContractResponse;
    /**

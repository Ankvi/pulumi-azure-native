...
export class Authorization extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20220801:Authorization';
     ...
     */
    public readonly error!: pulumi.Output<types.outputs.apimanagement.v20220801.AuthorizationErrorResponse | undefined>;
    /**
...
export interface AuthorizationArgs {
     ...
     * Authorization type options
     */
    authorizationType?: pulumi.Input<string | types.enums.v20220801.AuthorizationType>;
    /**
     * Authorization error details.
     */
    error?: pulumi.Input<types.inputs.apimanagement.v20220801.AuthorizationErrorArgs>;
    /**
     * OAuth2 grant type options
     */
    oAuth2GrantType?: pulumi.Input<string | types.enums.v20220801.OAuth2GrantType>;
    /**
     * Authorization parameters
     */

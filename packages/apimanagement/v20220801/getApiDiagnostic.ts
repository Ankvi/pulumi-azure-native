...
export function getApiDiagnostic(args: GetApiDiagnosticArgs, opts?: pulumi.InvokeOptions): Promise<GetApiDiagnosticResult> {
    ...
    return pulumi.runtime.invoke("azure-native:apimanagement/v20220801:getApiDiagnostic", {
        "apiId": args.apiId,
...
export interface GetApiDiagnosticResult {
     ...
     */
    readonly backend?: types.outputs.apimanagement.v20220801.PipelineDiagnosticSettingsResponse;
    /**
     * Diagnostic settings for incoming/outgoing HTTP messages to the Gateway.
     */
    readonly frontend?: types.outputs.apimanagement.v20220801.PipelineDiagnosticSettingsResponse;
    /**
     ...
     */
    readonly sampling?: types.outputs.apimanagement.v20220801.SamplingSettingsResponse;
    /**

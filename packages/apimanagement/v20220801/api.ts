...
export class Api extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20220801:Api';
     ...
     * Version set details
     */
    public readonly apiVersionSet!: pulumi.Output<types.outputs.apimanagement.v20220801.ApiVersionSetContractDetailsResponse | undefined>;
    /**
     ...
     */
    public readonly authenticationSettings!: pulumi.Output<types.outputs.apimanagement.v20220801.AuthenticationSettingsContractResponse | undefined>;
    /**
     * Contact information for the API.
     */
    public readonly contact!: pulumi.Output<types.outputs.apimanagement.v20220801.ApiContactInformationResponse | undefined>;
    /**
     ...
     */
    public readonly license!: pulumi.Output<types.outputs.apimanagement.v20220801.ApiLicenseInformationResponse | undefined>;
    /**
     ...
     */
    public readonly subscriptionKeyParameterNames!: pulumi.Output<types.outputs.apimanagement.v20220801.SubscriptionKeyParameterNamesContractResponse | undefined>;
    /**
...
export interface ApiArgs {
     ...
     * Type of API.
     */
    apiType?: pulumi.Input<string | types.enums.v20220801.ApiType>;
    /**
     * Indicates the version identifier of the API if the API is versioned
     */
     ...
     * Version set details
     */
    apiVersionSet?: pulumi.Input<types.inputs.apimanagement.v20220801.ApiVersionSetContractDetailsArgs>;
    /**
     * A resource identifier for the related ApiVersionSet.
     */
     ...
     * Collection of authentication settings included into this API.
     */
    authenticationSettings?: pulumi.Input<types.inputs.apimanagement.v20220801.AuthenticationSettingsContractArgs>;
    /**
     * Contact information for the API.
     */
    contact?: pulumi.Input<types.inputs.apimanagement.v20220801.ApiContactInformationArgs>;
    /**
     * Description of the API. May include HTML formatting tags.
     */
     ...
     */
    format?: pulumi.Input<string | types.enums.v20220801.ContentFormat>;
    /**
     * Indicates if API revision is current api revision.
     */
     ...
     * License information for the API.
     */
    license?: pulumi.Input<types.inputs.apimanagement.v20220801.ApiLicenseInformationArgs>;
    /**
     * Relative URL uniquely identifying this API and all of its resource paths within the API Management service instance. It is appended to the API endpoint base URL specified during the service instance creation to form a public URL for this API.
     */
     ...
     * Describes on which protocols the operations in this API can be invoked.
     */
    protocols?: pulumi.Input<pulumi.Input<string | types.enums.v20220801.Protocol>[]>;
    /**
     ...
     */
    soapApiType?: pulumi.Input<string | types.enums.v20220801.SoapApiType>;
    /**
     * API identifier of the source API.
     */
     ...
     * Protocols over which API is made available.
     */
    subscriptionKeyParameterNames?: pulumi.Input<types.inputs.apimanagement.v20220801.SubscriptionKeyParameterNamesContractArgs>;
    /**
     * Specifies whether an API or Product subscription is required for accessing the API.
     */
     ...
     */
    translateRequiredQueryParametersConduct?: pulumi.Input<string | types.enums.v20220801.TranslateRequiredQueryParametersConduct>;
    /**
     ...
     */
    wsdlSelector?: pulumi.Input<types.inputs.apimanagement.v20220801.ApiCreateOrUpdatePropertiesWsdlSelectorArgs>;
}

...
export class ApiWiki extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ApiWikiArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:ApiWiki" }, { type: "azure-native:apimanagement/v20220901preview:ApiWiki" }, { type: "azure-native:apimanagement/v20230301preview:ApiWiki" }, { type: "azure-native:apimanagement/v20230501preview:ApiWiki" }] };

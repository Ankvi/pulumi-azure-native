...
export function getAuthorizationProvider(args: GetAuthorizationProviderArgs, opts?: pulumi.InvokeOptions): Promise<GetAuthorizationProviderResult> {
    ...
    return pulumi.runtime.invoke("azure-native:apimanagement/v20220901preview:getAuthorizationProvider", {
...
export interface GetAuthorizationProviderResult {
     ...
     * OAuth2 settings
     */
    readonly oauth2?: types.outputs.apimanagement.v20220901preview.AuthorizationProviderOAuth2SettingsResponse;
    /**

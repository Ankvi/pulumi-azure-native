...
export class Backend extends pulumi.CustomResource {
     ...
     */
    public readonly circuitBreaker!: pulumi.Output<types.outputs.apimanagement.v20220901preview.BackendCircuitBreakerResponse | undefined>;
    /**
     * Backend Credentials Contract Properties
     */
    public readonly credentials!: pulumi.Output<types.outputs.apimanagement.v20220901preview.BackendCredentialsContractResponse | undefined>;
    /**
     * Backend Description.
     */
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.apimanagement.v20220901preview.BackendPropertiesResponse>;
    /**
     ...
     */
    public readonly proxy!: pulumi.Output<types.outputs.apimanagement.v20220901preview.BackendProxyContractResponse | undefined>;
    /**
     ...
     */
    public readonly tls!: pulumi.Output<types.outputs.apimanagement.v20220901preview.BackendTlsPropertiesResponse | undefined>;
    /**
    ...
    constructor(name: string, args: BackendArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["tls"] = args ? (args.tls ? pulumi.output(args.tls).apply(types.inputs.apimanagement.v20220901preview.backendTlsPropertiesArgsProvideDefaults) : undefined) : undefined;
...
export interface BackendArgs {
     ...
     * Backend Circuit Breaker Configuration
     */
    circuitBreaker?: pulumi.Input<types.inputs.apimanagement.v20220901preview.BackendCircuitBreakerArgs>;
    /**
     * Backend Credentials Contract Properties
     */
    credentials?: pulumi.Input<types.inputs.apimanagement.v20220901preview.BackendCredentialsContractArgs>;
    /**
     * Backend Description.
     */
     ...
     * Backend Properties contract
     */
    properties?: pulumi.Input<types.inputs.apimanagement.v20220901preview.BackendPropertiesArgs>;
    /**
     * Backend communication protocol.
     */
    protocol: pulumi.Input<string | types.enums.v20220901preview.BackendProtocol>;
    /**
     * Backend gateway Contract Properties
     */
    proxy?: pulumi.Input<types.inputs.apimanagement.v20220901preview.BackendProxyContractArgs>;
    /**
     ...
     * Backend TLS Properties
     */
    tls?: pulumi.Input<types.inputs.apimanagement.v20220901preview.BackendTlsPropertiesArgs>;
    /**
     * Runtime Url of the Backend.
     */

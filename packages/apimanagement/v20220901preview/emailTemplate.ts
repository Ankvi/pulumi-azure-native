...
export class EmailTemplate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20220901preview:EmailTemplate';
     ...
     */
    public readonly parameters!: pulumi.Output<types.outputs.apimanagement.v20220901preview.EmailTemplateParametersContractPropertiesResponse[] | undefined>;
    /**
...
export interface EmailTemplateArgs {
     ...
     * Email Template Parameter values.
     */
    parameters?: pulumi.Input<pulumi.Input<types.inputs.apimanagement.v20220901preview.EmailTemplateParametersContractPropertiesArgs>[]>;
    /**

...
export class TagOperationLink extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20220901preview:TagOperationLink';
    ...
    constructor(name: string, args: TagOperationLinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:TagOperationLink" }, { type: "azure-native:apimanagement/v20230301preview:TagOperationLink" }, { type: "azure-native:apimanagement/v20230501preview:TagOperationLink" }] };

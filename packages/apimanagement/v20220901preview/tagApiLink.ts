...
export class TagApiLink extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20220901preview:TagApiLink';
    ...
    constructor(name: string, args: TagApiLinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:TagApiLink" }, { type: "azure-native:apimanagement/v20230301preview:TagApiLink" }, { type: "azure-native:apimanagement/v20230501preview:TagApiLink" }] };

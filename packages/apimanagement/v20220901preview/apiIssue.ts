...
export class ApiIssue extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20220901preview:ApiIssue';
...
export interface ApiIssueArgs {
     ...
     * Status of the issue.
     */
    state?: pulumi.Input<string | types.enums.v20220901preview.State>;
    /**
     * The issue title.
     */

...
export class WorkspaceProduct extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20220901preview:WorkspaceProduct';
    ...
    constructor(name: string, args: WorkspaceProductArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:WorkspaceProduct" }, { type: "azure-native:apimanagement/v20230301preview:WorkspaceProduct" }, { type: "azure-native:apimanagement/v20230501preview:WorkspaceProduct" }] };

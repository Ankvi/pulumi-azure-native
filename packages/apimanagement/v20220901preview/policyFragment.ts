...
export class PolicyFragment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20220901preview:PolicyFragment';
...
export interface PolicyFragmentArgs {
     ...
     * Format of the policy fragment content.
     */
    format?: pulumi.Input<string | types.enums.v20220901preview.PolicyFragmentContentFormat>;
    /**

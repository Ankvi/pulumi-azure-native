...
export class WorkspaceTagProductLink extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20220901preview:WorkspaceTagProductLink';
    ...
    constructor(name: string, args: WorkspaceTagProductLinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:WorkspaceTagProductLink" }, { type: "azure-native:apimanagement/v20230301preview:WorkspaceTagProductLink" }, { type: "azure-native:apimanagement/v20230501preview:WorkspaceTagProductLink" }] };

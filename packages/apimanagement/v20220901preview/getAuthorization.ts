...
export function getAuthorization(args: GetAuthorizationArgs, opts?: pulumi.InvokeOptions): Promise<GetAuthorizationResult> {
    ...
    return pulumi.runtime.invoke("azure-native:apimanagement/v20220901preview:getAuthorization", {
...
export interface GetAuthorizationResult {
     ...
     */
    readonly error?: types.outputs.apimanagement.v20220901preview.AuthorizationErrorResponse;
    /**

...
export class ProductWiki extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ProductWikiArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:ProductWiki" }, { type: "azure-native:apimanagement/v20220801:ProductWiki" }, { type: "azure-native:apimanagement/v20230301preview:ProductWiki" }, { type: "azure-native:apimanagement/v20230501preview:ProductWiki" }] };

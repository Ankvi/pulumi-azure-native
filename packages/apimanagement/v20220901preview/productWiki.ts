...
export class ProductWiki extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20220901preview:ProductWiki';
     ...
     */
    public readonly documents!: pulumi.Output<types.outputs.apimanagement.v20220901preview.WikiDocumentationContractResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: ProductWikiArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:ProductWiki" }, { type: "azure-native:apimanagement/v20220801:ProductWiki" }, { type: "azure-native:apimanagement/v20230301preview:ProductWiki" }] };
...
export interface ProductWikiArgs {
     ...
     * Collection wiki documents included into this wiki.
     */
    documents?: pulumi.Input<pulumi.Input<types.inputs.apimanagement.v20220901preview.WikiDocumentationContractArgs>[]>;
    /**

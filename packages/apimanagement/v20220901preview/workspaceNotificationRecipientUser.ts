...
export class WorkspaceNotificationRecipientUser extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20220901preview:WorkspaceNotificationRecipientUser';
    ...
    constructor(name: string, args: WorkspaceNotificationRecipientUserArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:WorkspaceNotificationRecipientUser" }, { type: "azure-native:apimanagement/v20230301preview:WorkspaceNotificationRecipientUser" }, { type: "azure-native:apimanagement/v20230501preview:WorkspaceNotificationRecipientUser" }] };

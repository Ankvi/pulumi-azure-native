...
export function getWorkspaceNamedValue(args: GetWorkspaceNamedValueArgs, opts?: pulumi.InvokeOptions): Promise<GetWorkspaceNamedValueResult> {
    ...
    return pulumi.runtime.invoke("azure-native:apimanagement/v20220901preview:getWorkspaceNamedValue", {
...
export interface GetWorkspaceNamedValueResult {
     ...
     */
    readonly keyVault?: types.outputs.apimanagement.v20220901preview.KeyVaultContractPropertiesResponse;
    /**

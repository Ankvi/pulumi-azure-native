...
export function getAuthorizationServer(args: GetAuthorizationServerArgs, opts?: pulumi.InvokeOptions): Promise<GetAuthorizationServerResult> {
    ...
    return pulumi.runtime.invoke("azure-native:apimanagement/v20220901preview:getAuthorizationServer", {
...
export interface GetAuthorizationServerResult {
     ...
     */
    readonly tokenBodyParameters?: types.outputs.apimanagement.v20220901preview.TokenBodyParameterContractResponse[];
    /**

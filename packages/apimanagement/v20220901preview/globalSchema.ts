...
export interface GlobalSchemaArgs {
     ...
     * Schema Type. Immutable.
     */
    schemaType: pulumi.Input<string | types.enums.v20220901preview.SchemaType>;
    /**

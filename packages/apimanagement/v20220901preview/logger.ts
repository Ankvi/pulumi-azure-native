...
export class Logger extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20220901preview:Logger';
...
export interface LoggerArgs {
     ...
     * Logger type.
     */
    loggerType: pulumi.Input<string | types.enums.v20220901preview.LoggerType>;
    /**

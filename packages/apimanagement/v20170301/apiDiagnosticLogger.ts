...
export class ApiDiagnosticLogger extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20170301:ApiDiagnosticLogger';
    ...
    constructor(name: string, args: ApiDiagnosticLoggerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement/v20180101:ApiDiagnosticLogger" }] };

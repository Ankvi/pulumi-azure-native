...
export class WorkspaceGlobalSchema extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement:WorkspaceGlobalSchema';
    ...
    constructor(name: string, args: WorkspaceGlobalSchemaArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement/v20220901preview:WorkspaceGlobalSchema" }, { type: "azure-native:apimanagement/v20230301preview:WorkspaceGlobalSchema" }, { type: "azure-native:apimanagement/v20230501preview:WorkspaceGlobalSchema" }, { type: "azure-native:apimanagement/v20230901preview:WorkspaceGlobalSchema" }, { type: "azure-native:apimanagement/v20240501:WorkspaceGlobalSchema" }] };

...
export class WorkspaceApiPolicy extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WorkspaceApiPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement/v20220901preview:WorkspaceApiPolicy" }, { type: "azure-native:apimanagement/v20230301preview:WorkspaceApiPolicy" }, { type: "azure-native:apimanagement/v20230501preview:WorkspaceApiPolicy" }, { type: "azure-native:apimanagement/v20230901preview:WorkspaceApiPolicy" }] };

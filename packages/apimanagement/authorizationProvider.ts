...
export class AuthorizationProvider extends pulumi.CustomResource {
     ...
     * OAuth2 settings
     */
    declare public readonly oauth2: pulumi.Output<types.outputs.AuthorizationProviderOAuth2SettingsResponse | undefined>;
    /**

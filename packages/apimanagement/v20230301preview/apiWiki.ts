...
export class ApiWiki extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20230301preview:ApiWiki';
     ...
     */
    public readonly documents!: pulumi.Output<types.outputs.apimanagement.v20230301preview.WikiDocumentationContractResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: ApiWikiArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:ApiWiki" }, { type: "azure-native:apimanagement/v20220801:ApiWiki" }, { type: "azure-native:apimanagement/v20220901preview:ApiWiki" }] };
...
export interface ApiWikiArgs {
     ...
     * Collection wiki documents included into this wiki.
     */
    documents?: pulumi.Input<pulumi.Input<types.inputs.apimanagement.v20230301preview.WikiDocumentationContractArgs>[]>;
    /**

...
export function getProductWiki(args: GetProductWikiArgs, opts?: pulumi.InvokeOptions): Promise<GetProductWikiResult> {
    ...
    return pulumi.runtime.invoke("azure-native:apimanagement/v20230301preview:getProductWiki", {
...
export interface GetProductWikiResult {
     ...
     */
    readonly documents?: types.outputs.apimanagement.v20230301preview.WikiDocumentationContractResponse[];
    /**

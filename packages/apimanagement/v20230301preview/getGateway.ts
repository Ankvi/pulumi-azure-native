...
export function getGateway(args: GetGatewayArgs, opts?: pulumi.InvokeOptions): Promise<GetGatewayResult> {
    ...
    return pulumi.runtime.invoke("azure-native:apimanagement/v20230301preview:getGateway", {
...
export interface GetGatewayResult {
     ...
     * Gateway location.
     */
    readonly locationData?: types.outputs.apimanagement.v20230301preview.ResourceLocationDataContractResponse;
    /**

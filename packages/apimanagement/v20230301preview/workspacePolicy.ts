...
export class WorkspacePolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20230301preview:WorkspacePolicy';
    ...
    constructor(name: string, args: WorkspacePolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:WorkspacePolicy" }, { type: "azure-native:apimanagement/v20220901preview:WorkspacePolicy" }, { type: "azure-native:apimanagement/v20230501preview:WorkspacePolicy" }] };

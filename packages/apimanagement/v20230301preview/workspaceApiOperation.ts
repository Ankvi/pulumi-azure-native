...
export class WorkspaceApiOperation extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WorkspaceApiOperationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:WorkspaceApiOperation" }, { type: "azure-native:apimanagement/v20220901preview:WorkspaceApiOperation" }, { type: "azure-native:apimanagement/v20230501preview:WorkspaceApiOperation" }] };

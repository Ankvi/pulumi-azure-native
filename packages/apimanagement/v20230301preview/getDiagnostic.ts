...
export function getDiagnostic(args: GetDiagnosticArgs, opts?: pulumi.InvokeOptions): Promise<GetDiagnosticResult> {
    ...
    return pulumi.runtime.invoke("azure-native:apimanagement/v20230301preview:getDiagnostic", {
...
export interface GetDiagnosticResult {
     ...
     */
    readonly backend?: types.outputs.apimanagement.v20230301preview.PipelineDiagnosticSettingsResponse;
    /**
     * Diagnostic settings for incoming/outgoing HTTP messages to the Gateway.
     */
    readonly frontend?: types.outputs.apimanagement.v20230301preview.PipelineDiagnosticSettingsResponse;
    /**
     ...
     */
    readonly sampling?: types.outputs.apimanagement.v20230301preview.SamplingSettingsResponse;
    /**

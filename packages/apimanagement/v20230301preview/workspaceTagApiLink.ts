...
export class WorkspaceTagApiLink extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20230301preview:WorkspaceTagApiLink';
    ...
    constructor(name: string, args: WorkspaceTagApiLinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:WorkspaceTagApiLink" }, { type: "azure-native:apimanagement/v20220901preview:WorkspaceTagApiLink" }, { type: "azure-native:apimanagement/v20230501preview:WorkspaceTagApiLink" }] };

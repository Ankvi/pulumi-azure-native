...
export function getAuthorizationServer(args: GetAuthorizationServerArgs, opts?: pulumi.InvokeOptions): Promise<GetAuthorizationServerResult> {
    ...
    return pulumi.runtime.invoke("azure-native:apimanagement/v20230301preview:getAuthorizationServer", {
...
export interface GetAuthorizationServerResult {
     ...
     */
    readonly tokenBodyParameters?: types.outputs.apimanagement.v20230301preview.TokenBodyParameterContractResponse[];
    /**

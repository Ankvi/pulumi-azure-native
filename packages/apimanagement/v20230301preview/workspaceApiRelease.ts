...
export class WorkspaceApiRelease extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20230301preview:WorkspaceApiRelease';
    ...
    constructor(name: string, args: WorkspaceApiReleaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:WorkspaceApiRelease" }, { type: "azure-native:apimanagement/v20220901preview:WorkspaceApiRelease" }, { type: "azure-native:apimanagement/v20230501preview:WorkspaceApiRelease" }] };

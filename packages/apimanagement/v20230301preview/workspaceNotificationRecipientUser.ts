...
export class WorkspaceNotificationRecipientUser extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WorkspaceNotificationRecipientUserArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:WorkspaceNotificationRecipientUser" }, { type: "azure-native:apimanagement/v20220901preview:WorkspaceNotificationRecipientUser" }, { type: "azure-native:apimanagement/v20230501preview:WorkspaceNotificationRecipientUser" }] };

...
export class WorkspaceGlobalSchema extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WorkspaceGlobalSchemaArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:WorkspaceGlobalSchema" }, { type: "azure-native:apimanagement/v20220901preview:WorkspaceGlobalSchema" }, { type: "azure-native:apimanagement/v20230501preview:WorkspaceGlobalSchema" }] };

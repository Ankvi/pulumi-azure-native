...
export class WorkspaceApiPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20230301preview:WorkspaceApiPolicy';
    ...
    constructor(name: string, args: WorkspaceApiPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:WorkspaceApiPolicy" }, { type: "azure-native:apimanagement/v20220901preview:WorkspaceApiPolicy" }, { type: "azure-native:apimanagement/v20230501preview:WorkspaceApiPolicy" }] };

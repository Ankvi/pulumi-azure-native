...
export function getPrivateEndpointConnectionByName(args: GetPrivateEndpointConnectionByNameArgs, opts?: pulumi.InvokeOptions): Promise<GetPrivateEndpointConnectionByNameResult> {
    ...
    return pulumi.runtime.invoke("azure-native:apimanagement/v20230301preview:getPrivateEndpointConnectionByName", {
...
export interface GetPrivateEndpointConnectionByNameResult {
     ...
     */
    readonly privateEndpoint?: types.outputs.apimanagement.v20230301preview.PrivateEndpointResponse;
    /**
     * A collection of information about the state of the connection between service consumer and provider.
     */
    readonly privateLinkServiceConnectionState: types.outputs.apimanagement.v20230301preview.PrivateLinkServiceConnectionStateResponse;
    /**

...
export class ProductWiki extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20230301preview:ProductWiki';
    ...
    constructor(name: string, args: ProductWikiArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:ProductWiki" }, { type: "azure-native:apimanagement/v20220801:ProductWiki" }, { type: "azure-native:apimanagement/v20220901preview:ProductWiki" }, { type: "azure-native:apimanagement/v20230501preview:ProductWiki" }] };

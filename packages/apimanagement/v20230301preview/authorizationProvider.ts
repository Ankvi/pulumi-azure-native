...
export class AuthorizationProvider extends pulumi.CustomResource {
     ...
     * OAuth2 settings
     */
    public readonly oauth2!: pulumi.Output<types.outputs.apimanagement.v20230301preview.AuthorizationProviderOAuth2SettingsResponse | undefined>;
    /**
...
export interface AuthorizationProviderArgs {
     ...
     * OAuth2 settings
     */
    oauth2?: pulumi.Input<types.inputs.apimanagement.v20230301preview.AuthorizationProviderOAuth2SettingsArgs>;
    /**

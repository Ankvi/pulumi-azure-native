...
export class WorkspaceNamedValue extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WorkspaceNamedValueArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:WorkspaceNamedValue" }, { type: "azure-native:apimanagement/v20220901preview:WorkspaceNamedValue" }, { type: "azure-native:apimanagement/v20230501preview:WorkspaceNamedValue" }] };

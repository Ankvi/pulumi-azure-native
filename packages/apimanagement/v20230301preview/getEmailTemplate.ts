...
export function getEmailTemplate(args: GetEmailTemplateArgs, opts?: pulumi.InvokeOptions): Promise<GetEmailTemplateResult> {
    ...
    return pulumi.runtime.invoke("azure-native:apimanagement/v20230301preview:getEmailTemplate", {
...
export interface GetEmailTemplateResult {
     ...
     */
    readonly parameters?: types.outputs.apimanagement.v20230301preview.EmailTemplateParametersContractPropertiesResponse[];
    /**

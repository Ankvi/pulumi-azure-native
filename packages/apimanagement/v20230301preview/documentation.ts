...
export class Documentation extends pulumi.CustomResource {
    ...
    constructor(name: string, args: DocumentationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:Documentation" }, { type: "azure-native:apimanagement/v20220801:Documentation" }, { type: "azure-native:apimanagement/v20220901preview:Documentation" }] };

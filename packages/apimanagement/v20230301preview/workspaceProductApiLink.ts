...
export class WorkspaceProductApiLink extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:apimanagement/v20230301preview:WorkspaceProductApiLink';
    ...
    constructor(name: string, args: WorkspaceProductApiLinkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement:WorkspaceProductApiLink" }, { type: "azure-native:apimanagement/v20220901preview:WorkspaceProductApiLink" }, { type: "azure-native:apimanagement/v20230501preview:WorkspaceProductApiLink" }] };

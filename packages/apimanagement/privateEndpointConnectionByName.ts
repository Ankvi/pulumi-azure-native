...
export class PrivateEndpointConnectionByName extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly privateLinkServiceConnectionState: pulumi.Output<types.outputs.PrivateLinkServiceConnectionStateResponse>;
    /**

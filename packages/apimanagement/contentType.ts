...
export class ContentType extends pulumi.CustomResource {
     ...
     * Content type schema.
     */
    declare public readonly schema: pulumi.Output<any | undefined>;
    /**
    ...
    constructor(name: string, args: ContentTypeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement/v20191201:ContentType" }, { type: "azure-native:apimanagement/v20200601preview:ContentType" }, { type: "azure-native:apimanagement/v20201201:ContentType" }, { type: "azure-native:apimanagement/v20210101preview:ContentType" }, { type: "azure-native:apimanagement/v20210401preview:ContentType" }, { type: "azure-native:apimanagement/v20210801:ContentType" }, { type: "azure-native:apimanagement/v20211201preview:ContentType" }, { type: "azure-native:apimanagement/v20220401preview:ContentType" }, { type: "azure-native:apimanagement/v20220801:ContentType" }, { type: "azure-native:apimanagement/v20220901preview:ContentType" }, { type: "azure-native:apimanagement/v20230301preview:ContentType" }, { type: "azure-native:apimanagement/v20230501preview:ContentType" }, { type: "azure-native:apimanagement/v20230901preview:ContentType" }, { type: "azure-native:apimanagement/v20240501:ContentType" }, { type: "azure-native:apimanagement/v20240601preview:ContentType" }, { type: "azure-native:apimanagement/v20241001preview:ContentType" }] };

...
export class WorkspaceApiSchema extends pulumi.CustomResource {
    ...
    constructor(name: string, args: WorkspaceApiSchemaArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement/v20220901preview:WorkspaceApiSchema" }, { type: "azure-native:apimanagement/v20230301preview:WorkspaceApiSchema" }, { type: "azure-native:apimanagement/v20230501preview:WorkspaceApiSchema" }] };

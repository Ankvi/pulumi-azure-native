...
export class ApiGateway extends pulumi.CustomResource {
     ...
     */
    declare public readonly backend: pulumi.Output<types.outputs.BackendConfigurationResponse | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly configurationApi: pulumi.Output<types.outputs.GatewayConfigurationApiResponse | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly frontend: pulumi.Output<types.outputs.FrontendConfigurationResponse | undefined>;
    /**
     * Resource location.
     */
     ...
     */
    declare public readonly sku: pulumi.Output<types.outputs.ApiManagementGatewaySkuPropertiesResponse>;
    /**
    ...
    constructor(name: string, args: ApiGatewayArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:apimanagement/v20230901preview:ApiGateway" }, { type: "azure-native:apimanagement/v20240501:ApiGateway" }, { type: "azure-native:apimanagement/v20240601preview:ApiGateway" }, { type: "azure-native:apimanagement/v20241001preview:ApiGateway" }] };

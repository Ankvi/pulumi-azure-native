...
export class GroupUser extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly identities: pulumi.Output<types.outputs.UserIdentityContractResponse[] | undefined>;
    /**
     * Last name.
     */

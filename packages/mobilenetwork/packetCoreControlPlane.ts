...
export class PacketCoreControlPlane extends pulumi.CustomResource {
     ...
     */
    declare public readonly controlPlaneAccessInterface: pulumi.Output<types.outputs.InterfacePropertiesResponse>;
    /**
     ...
     */
    declare public readonly diagnosticsUpload: pulumi.Output<types.outputs.DiagnosticsUploadConfigurationResponse | undefined>;
    /**
     * Configuration for sending packet core events to an Azure Event Hub.
     */
    declare public readonly eventHub: pulumi.Output<types.outputs.EventHubConfigurationResponse | undefined>;
    /**
     * The provisioning state of the secret containing private keys and keyIds for SUPI concealment.
     */
    declare public /*out*/ readonly homeNetworkPrivateKeysProvisioning: pulumi.Output<types.outputs.HomeNetworkPrivateKeysProvisioningResponse>;
    /**
     ...
     */
    declare public readonly installation: pulumi.Output<types.outputs.InstallationResponse | undefined>;
    /**
     ...
     */
    declare public readonly localDiagnosticsAccess: pulumi.Output<types.outputs.LocalDiagnosticsAccessConfigurationResponse>;
    /**
     ...
     */
    declare public readonly platform: pulumi.Output<types.outputs.PlatformConfigurationResponse>;
    /**
     ...
     */
    declare public readonly signaling: pulumi.Output<types.outputs.SignalingConfigurationResponse | undefined>;
    /**
     * Site(s) under which this packet core control plane should be deployed. The sites must be in the same location as the packet core control plane.
     */
    declare public readonly sites: pulumi.Output<types.outputs.SiteResourceIdResponse[]>;
    /**
     ...
     */
    declare public readonly userConsent: pulumi.Output<types.outputs.UserConsentConfigurationResponse | undefined>;
    /**

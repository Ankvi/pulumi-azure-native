...
export interface GetSimResult {
     ...
     */
    readonly simPolicy?: types.outputs.mobilenetwork.SimPolicyResourceIdResponse;
    /**
     ...
     */
    readonly staticIpConfiguration?: types.outputs.mobilenetwork.SimStaticIpPropertiesResponse[];
    /**

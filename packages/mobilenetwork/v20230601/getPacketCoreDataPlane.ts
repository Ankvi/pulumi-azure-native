...
export function getPacketCoreDataPlane(args: GetPacketCoreDataPlaneArgs, opts?: pulumi.InvokeOptions): Promise<GetPacketCoreDataPlaneResult> {
    ...
    return pulumi.runtime.invoke("azure-native:mobilenetwork/v20230601:getPacketCoreDataPlane", {
...
export interface GetPacketCoreDataPlaneResult {
     ...
     */
    readonly userPlaneAccessInterface: types.outputs.mobilenetwork.v20230601.InterfacePropertiesResponse;
}
/**
 * Gets information about the specified packet core data plane.
 */

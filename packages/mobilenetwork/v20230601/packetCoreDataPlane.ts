...
export class PacketCoreDataPlane extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:mobilenetwork/v20230601:PacketCoreDataPlane';
     ...
     */
    public readonly userPlaneAccessInterface!: pulumi.Output<types.outputs.mobilenetwork.v20230601.InterfacePropertiesResponse>;
    ...
    constructor(name: string, args: PacketCoreDataPlaneArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilenetwork:PacketCoreDataPlane" }, { type: "azure-native:mobilenetwork/v20220301preview:PacketCoreDataPlane" }, { type: "azure-native:mobilenetwork/v20220401preview:PacketCoreDataPlane" }, { type: "azure-native:mobilenetwork/v20221101:PacketCoreDataPlane" }] };
...
export interface PacketCoreDataPlaneArgs {
     ...
     * The user plane interface on the access network. For 5G networks, this is the N3 interface. For 4G networks, this is the S1-U interface.
     */
    userPlaneAccessInterface: pulumi.Input<types.inputs.mobilenetwork.v20230601.InterfacePropertiesArgs>;
}

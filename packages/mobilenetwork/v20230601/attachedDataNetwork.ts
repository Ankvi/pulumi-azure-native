...
export class AttachedDataNetwork extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:mobilenetwork/v20230601:AttachedDataNetwork';
     ...
     */
    public readonly naptConfiguration!: pulumi.Output<types.outputs.mobilenetwork.v20230601.NaptConfigurationResponse | undefined>;
    /**
     ...
     */
    public readonly userPlaneDataInterface!: pulumi.Output<types.outputs.mobilenetwork.v20230601.InterfacePropertiesResponse>;
    ...
    constructor(name: string, args: AttachedDataNetworkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["naptConfiguration"] = args ? (args.naptConfiguration ? pulumi.output(args.naptConfiguration).apply(types.inputs.mobilenetwork.v20230601.naptConfigurationArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilenetwork:AttachedDataNetwork" }, { type: "azure-native:mobilenetwork/v20220301preview:AttachedDataNetwork" }, { type: "azure-native:mobilenetwork/v20220401preview:AttachedDataNetwork" }, { type: "azure-native:mobilenetwork/v20221101:AttachedDataNetwork" }] };
...
export interface AttachedDataNetworkArgs {
     ...
     * If this is not specified, the attached data network will use a default NAPT configuration with NAPT enabled.
     */
    naptConfiguration?: pulumi.Input<types.inputs.mobilenetwork.v20230601.NaptConfigurationArgs>;
    /**
     ...
     * The user plane interface on the data network. For 5G networks, this is the N6 interface. For 4G networks, this is the SGi interface.
     */
    userPlaneDataInterface: pulumi.Input<types.inputs.mobilenetwork.v20230601.InterfacePropertiesArgs>;
}

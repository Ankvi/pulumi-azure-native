...
export class DataNetwork extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:mobilenetwork/v20230601:DataNetwork';
    ...
    constructor(name: string, args: DataNetworkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilenetwork:DataNetwork" }, { type: "azure-native:mobilenetwork/v20220301preview:DataNetwork" }, { type: "azure-native:mobilenetwork/v20220401preview:DataNetwork" }, { type: "azure-native:mobilenetwork/v20221101:DataNetwork" }, { type: "azure-native:mobilenetwork/v20230901:DataNetwork" }, { type: "azure-native:mobilenetwork/v20240201:DataNetwork" }] };

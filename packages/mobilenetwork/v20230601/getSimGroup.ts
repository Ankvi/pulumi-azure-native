...
export function getSimGroup(args: GetSimGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetSimGroupResult> {
    ...
    return pulumi.runtime.invoke("azure-native:mobilenetwork/v20230601:getSimGroup", {
...
export interface GetSimGroupResult {
     ...
     */
    readonly encryptionKey?: types.outputs.mobilenetwork.v20230601.KeyVaultKeyResponse;
    /**
     ...
     */
    readonly mobileNetwork?: types.outputs.mobilenetwork.v20230601.MobileNetworkResourceIdResponse;
    /**

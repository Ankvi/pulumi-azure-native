...
export function getPacketCoreControlPlane(args: GetPacketCoreControlPlaneArgs, opts?: pulumi.InvokeOptions): Promise<GetPacketCoreControlPlaneResult> {
    ...
    return pulumi.runtime.invoke("azure-native:mobilenetwork/v20230601:getPacketCoreControlPlane", {
...
export interface GetPacketCoreControlPlaneResult {
     ...
     */
    readonly controlPlaneAccessInterface: types.outputs.mobilenetwork.v20230601.InterfacePropertiesResponse;
    /**
     ...
     */
    readonly diagnosticsUpload?: types.outputs.mobilenetwork.v20230601.DiagnosticsUploadConfigurationResponse;
    /**
     ...
     */
    readonly identity?: types.outputs.mobilenetwork.v20230601.ManagedServiceIdentityResponse;
    /**
     * The installation state of the packet core control plane resource.
     */
    readonly installation?: types.outputs.mobilenetwork.v20230601.InstallationResponse;
    /**
     ...
     */
    readonly localDiagnosticsAccess: types.outputs.mobilenetwork.v20230601.LocalDiagnosticsAccessConfigurationResponse;
    /**
     ...
     */
    readonly platform: types.outputs.mobilenetwork.v20230601.PlatformConfigurationResponse;
    /**
     ...
     */
    readonly sites: types.outputs.mobilenetwork.v20230601.SiteResourceIdResponse[];
    /**

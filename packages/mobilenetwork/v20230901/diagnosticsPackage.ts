...
export class DiagnosticsPackage extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:mobilenetwork/v20230901:DiagnosticsPackage';
    ...
    constructor(name: string, args: DiagnosticsPackageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilenetwork:DiagnosticsPackage" }, { type: "azure-native:mobilenetwork/v20230601:DiagnosticsPackage" }, { type: "azure-native:mobilenetwork/v20240201:DiagnosticsPackage" }] };

...
export class Site extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:mobilenetwork/v20230901:Site';
    ...
    constructor(name: string, args: SiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilenetwork:Site" }, { type: "azure-native:mobilenetwork/v20220301preview:Site" }, { type: "azure-native:mobilenetwork/v20220401preview:Site" }, { type: "azure-native:mobilenetwork/v20221101:Site" }, { type: "azure-native:mobilenetwork/v20230601:Site" }, { type: "azure-native:mobilenetwork/v20240201:Site" }] };

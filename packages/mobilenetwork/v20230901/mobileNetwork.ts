...
export class MobileNetwork extends pulumi.CustomResource {
    ...
    constructor(name: string, args: MobileNetworkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilenetwork:MobileNetwork" }, { type: "azure-native:mobilenetwork/v20220301preview:MobileNetwork" }, { type: "azure-native:mobilenetwork/v20220401preview:MobileNetwork" }, { type: "azure-native:mobilenetwork/v20221101:MobileNetwork" }, { type: "azure-native:mobilenetwork/v20230601:MobileNetwork" }] };

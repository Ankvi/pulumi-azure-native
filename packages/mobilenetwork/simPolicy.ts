...
export class SimPolicy extends pulumi.CustomResource {
     ...
     */
    declare public readonly defaultSlice: pulumi.Output<types.outputs.SliceResourceIdResponse>;
    /**
     ...
     */
    declare public readonly sliceConfigurations: pulumi.Output<types.outputs.SliceConfigurationResponse[]>;
    /**
     ...
     */
    declare public readonly ueAmbr: pulumi.Output<types.outputs.AmbrResponse>;

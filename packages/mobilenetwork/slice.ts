...
export class Slice extends pulumi.CustomResource {
     ...
     */
    declare public readonly snssai: pulumi.Output<types.outputs.SnssaiResponse>;
    /**
    ...
    constructor(name: string, args: SliceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            if (args?.snssai === undefined && !opts.urn) {
            ...
            resourceInputs["sliceName"] = args?.sliceName;
            resourceInputs["snssai"] = args?.snssai;

...
export interface GetSimGroupResult {
     ...
     */
    readonly encryptionKey?: types.outputs.mobilenetwork.KeyVaultKeyResponse;
    /**
     ...
     */
    readonly mobileNetwork?: types.outputs.mobilenetwork.MobileNetworkResourceIdResponse;
    /**

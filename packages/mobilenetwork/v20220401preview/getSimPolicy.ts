...
export interface GetSimPolicyResult {
     ...
     */
    readonly defaultSlice: types.outputs.mobilenetwork.v20220401preview.SliceResourceIdResponse;
    /**
     ...
     */
    readonly sliceConfigurations: types.outputs.mobilenetwork.v20220401preview.SliceConfigurationResponse[];
    /**
     ...
     */
    readonly ueAmbr: types.outputs.mobilenetwork.v20220401preview.AmbrResponse;
}
/**
 * Gets information about the specified SIM policy.
 */

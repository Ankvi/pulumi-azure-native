...
export class Service extends pulumi.CustomResource {
    ...
    constructor(name: string, args: ServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilenetwork:Service" }, { type: "azure-native:mobilenetwork/v20220301preview:Service" }, { type: "azure-native:mobilenetwork/v20221101:Service" }, { type: "azure-native:mobilenetwork/v20230601:Service" }] };

...
export interface GetAttachedDataNetworkResult {
     ...
     */
    readonly naptConfiguration?: types.outputs.mobilenetwork.v20220401preview.NaptConfigurationResponse;
    /**
     ...
     */
    readonly userPlaneDataInterface: types.outputs.mobilenetwork.v20220401preview.InterfacePropertiesResponse;
}
/**
 * Gets information about the specified attached data network.
 */

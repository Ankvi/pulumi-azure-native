...
export class Site extends pulumi.CustomResource {
     ...
     */
    public readonly networkFunctions!: pulumi.Output<types.outputs.mobilenetwork.v20220401preview.SubResourceResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: SiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilenetwork:Site" }, { type: "azure-native:mobilenetwork/v20220301preview:Site" }, { type: "azure-native:mobilenetwork/v20221101:Site" }, { type: "azure-native:mobilenetwork/v20230601:Site" }] };
...
export interface SiteArgs {
     ...
     * An array of IDs of the network functions deployed on the site, maintained by the user.
     */
    networkFunctions?: pulumi.Input<pulumi.Input<types.inputs.mobilenetwork.v20220401preview.SubResourceArgs>[]>;
    /**

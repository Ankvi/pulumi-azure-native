...
export class MobileNetwork extends pulumi.CustomResource {
     ...
     */
    declare public readonly publicLandMobileNetworkIdentifier: pulumi.Output<types.outputs.PlmnIdResponse>;
    /**
     ...
     */
    declare public readonly publicLandMobileNetworks: pulumi.Output<types.outputs.PublicLandMobileNetworkResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: MobileNetworkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (!opts.id) {
            if (args?.publicLandMobileNetworkIdentifier === undefined && !opts.urn) {
            ...
            resourceInputs["publicLandMobileNetworkIdentifier"] = args?.publicLandMobileNetworkIdentifier;
            resourceInputs["publicLandMobileNetworks"] = args?.publicLandMobileNetworks;

...
export class Sim extends pulumi.CustomResource {
     ...
     */
    declare public readonly simPolicy: pulumi.Output<types.outputs.SimPolicyResourceIdResponse | undefined>;
    /**
     ...
     */
    declare public readonly staticIpConfiguration: pulumi.Output<types.outputs.SimStaticIpPropertiesResponse[] | undefined>;
    /**

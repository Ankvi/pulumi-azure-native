...
export class PacketCoreDataPlane extends pulumi.CustomResource {
     ...
     */
    declare public readonly userPlaneAccessInterface: pulumi.Output<types.outputs.InterfacePropertiesResponse>;
    /**
     ...
     */
    declare public readonly userPlaneAccessVirtualIpv4Addresses: pulumi.Output<string[] | undefined>;

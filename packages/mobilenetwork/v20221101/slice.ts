...
export class Slice extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SliceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilenetwork:Slice" }, { type: "azure-native:mobilenetwork/v20220301preview:Slice" }, { type: "azure-native:mobilenetwork/v20220401preview:Slice" }, { type: "azure-native:mobilenetwork/v20230601:Slice" }] };

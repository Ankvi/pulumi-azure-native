...
export interface GetAttachedDataNetworkResult {
     ...
     */
    readonly naptConfiguration?: types.outputs.mobilenetwork.v20221101.NaptConfigurationResponse;
    /**
     ...
     */
    readonly userPlaneDataInterface: types.outputs.mobilenetwork.v20221101.InterfacePropertiesResponse;
}
/**
 * Gets information about the specified attached data network.
 */

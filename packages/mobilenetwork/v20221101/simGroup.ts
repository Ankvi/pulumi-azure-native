...
export class SimGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:mobilenetwork/v20221101:SimGroup';
     ...
     */
    public readonly encryptionKey!: pulumi.Output<types.outputs.mobilenetwork.v20221101.KeyVaultKeyResponse | undefined>;
    /**
     ...
     */
    public readonly mobileNetwork!: pulumi.Output<types.outputs.mobilenetwork.v20221101.MobileNetworkResourceIdResponse | undefined>;
    /**
    ...
    constructor(name: string, args: SimGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilenetwork:SimGroup" }, { type: "azure-native:mobilenetwork/v20220401preview:SimGroup" }, { type: "azure-native:mobilenetwork/v20230601:SimGroup" }] };
...
export interface SimGroupArgs {
     ...
     * A key to encrypt the SIM data that belongs to this SIM group.
     */
    encryptionKey?: pulumi.Input<types.inputs.mobilenetwork.v20221101.KeyVaultKeyArgs>;
    /**
     * The identity used to retrieve the encryption key from Azure key vault.
     */
     ...
     * Mobile network that this SIM group belongs to. The mobile network must be in the same location as the SIM group.
     */
    mobileNetwork?: pulumi.Input<types.inputs.mobilenetwork.v20221101.MobileNetworkResourceIdArgs>;
    /**

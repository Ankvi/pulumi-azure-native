...
export interface GetSimPolicyResult {
     ...
     */
    readonly defaultSlice: types.outputs.mobilenetwork.v20221101.SliceResourceIdResponse;
    /**
     ...
     */
    readonly sliceConfigurations: types.outputs.mobilenetwork.v20221101.SliceConfigurationResponse[];
    /**
     ...
     */
    readonly ueAmbr: types.outputs.mobilenetwork.v20221101.AmbrResponse;
}
/**
 * Gets information about the specified SIM policy.
 */

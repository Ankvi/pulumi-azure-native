...
export class AttachedDataNetwork extends pulumi.CustomResource {
    ...
    constructor(name: string, args: AttachedDataNetworkArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilenetwork:AttachedDataNetwork" }, { type: "azure-native:mobilenetwork/v20220301preview:AttachedDataNetwork" }, { type: "azure-native:mobilenetwork/v20220401preview:AttachedDataNetwork" }, { type: "azure-native:mobilenetwork/v20230601:AttachedDataNetwork" }, { type: "azure-native:mobilenetwork/v20230901:AttachedDataNetwork" }, { type: "azure-native:mobilenetwork/v20240201:AttachedDataNetwork" }] };

...
export class SimPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:mobilenetwork/v20221101:SimPolicy';
     ...
     */
    public readonly defaultSlice!: pulumi.Output<types.outputs.mobilenetwork.v20221101.SliceResourceIdResponse>;
    /**
     ...
     */
    public readonly sliceConfigurations!: pulumi.Output<types.outputs.mobilenetwork.v20221101.SliceConfigurationResponse[]>;
    /**
     ...
     */
    public readonly ueAmbr!: pulumi.Output<types.outputs.mobilenetwork.v20221101.AmbrResponse>;
    ...
    constructor(name: string, args: SimPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilenetwork:SimPolicy" }, { type: "azure-native:mobilenetwork/v20220301preview:SimPolicy" }, { type: "azure-native:mobilenetwork/v20220401preview:SimPolicy" }, { type: "azure-native:mobilenetwork/v20230601:SimPolicy" }] };
...
export interface SimPolicyArgs {
     ...
     * The default slice to use if the UE does not explicitly specify it. This slice must exist in the `sliceConfigurations` map. The slice must be in the same location as the SIM policy.
     */
    defaultSlice: pulumi.Input<types.inputs.mobilenetwork.v20221101.SliceResourceIdArgs>;
    /**
     * The geo-location where the resource lives
     */
     ...
     * The allowed slices and the settings to use for them. The list must not contain duplicate items and must contain at least one item.
     */
    sliceConfigurations: pulumi.Input<pulumi.Input<types.inputs.mobilenetwork.v20221101.SliceConfigurationArgs>[]>;
    /**
     * Resource tags.
     */
     ...
     * Aggregate maximum bit rate across all non-GBR QoS flows of all PDU sessions of a given UE. See 3GPP TS23.501 section 5.7.2.6 for a full description of the UE-AMBR.
     */
    ueAmbr: pulumi.Input<types.inputs.mobilenetwork.v20221101.AmbrArgs>;
}

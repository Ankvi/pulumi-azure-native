...
export class Site extends pulumi.CustomResource {
    ...
    constructor(name: string, args: SiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilenetwork:Site" }, { type: "azure-native:mobilenetwork/v20220301preview:Site" }, { type: "azure-native:mobilenetwork/v20220401preview:Site" }, { type: "azure-native:mobilenetwork/v20230601:Site" }] };

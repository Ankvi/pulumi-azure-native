...
export function getSite(args: GetSiteArgs, opts?: pulumi.InvokeOptions): Promise<GetSiteResult> {
    ...
    return pulumi.runtime.invoke("azure-native:mobilenetwork/v20221101:getSite", {
...
export interface GetSiteResult {
     ...
     */
    readonly networkFunctions: types.outputs.mobilenetwork.v20221101.SubResourceResponse[];
    /**

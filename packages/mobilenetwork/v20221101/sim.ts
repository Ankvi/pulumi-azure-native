...
export class Sim extends pulumi.CustomResource {
     ...
     */
    public readonly simPolicy!: pulumi.Output<types.outputs.mobilenetwork.v20221101.SimPolicyResourceIdResponse | undefined>;
    /**
     ...
     */
    public readonly staticIpConfiguration!: pulumi.Output<types.outputs.mobilenetwork.v20221101.SimStaticIpPropertiesResponse[] | undefined>;
    /**
    ...
    constructor(name: string, args: SimArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilenetwork:Sim" }, { type: "azure-native:mobilenetwork/v20220401preview:Sim" }, { type: "azure-native:mobilenetwork/v20230601:Sim" }] };
...
export interface SimArgs {
     ...
     * The SIM policy used by this SIM. The SIM policy must be in the same location as the SIM.
     */
    simPolicy?: pulumi.Input<types.inputs.mobilenetwork.v20221101.SimPolicyResourceIdArgs>;
    /**
     * A list of static IP addresses assigned to this SIM. Each address is assigned at a defined network scope, made up of {attached data network, slice}.
     */
    staticIpConfiguration?: pulumi.Input<pulumi.Input<types.inputs.mobilenetwork.v20221101.SimStaticIpPropertiesArgs>[]>;
}

...
export class Service extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:mobilenetwork/v20221101:Service';
     ...
     */
    public readonly pccRules!: pulumi.Output<types.outputs.mobilenetwork.v20221101.PccRuleConfigurationResponse[]>;
    /**
     ...
     */
    public readonly serviceQosPolicy!: pulumi.Output<types.outputs.mobilenetwork.v20221101.QosPolicyResponse | undefined>;
    /**
    ...
    constructor(name: string, args: ServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["serviceQosPolicy"] = args ? (args.serviceQosPolicy ? pulumi.output(args.serviceQosPolicy).apply(types.inputs.mobilenetwork.v20221101.qosPolicyArgsProvideDefaults) : undefined) : undefined;
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:mobilenetwork:Service" }, { type: "azure-native:mobilenetwork/v20220301preview:Service" }, { type: "azure-native:mobilenetwork/v20220401preview:Service" }, { type: "azure-native:mobilenetwork/v20230601:Service" }] };
...
export interface ServiceArgs {
     ...
     * The set of data flow policy rules that make up this service.
     */
    pccRules: pulumi.Input<pulumi.Input<types.inputs.mobilenetwork.v20221101.PccRuleConfigurationArgs>[]>;
    /**
     ...
     * The QoS policy to use for packets matching this service. This can be overridden for particular flows using the ruleQosPolicy field in a PccRuleConfiguration. If this field is null then the UE's SIM policy will define the QoS settings.
     */
    serviceQosPolicy?: pulumi.Input<types.inputs.mobilenetwork.v20221101.QosPolicyArgs>;
    /**
     * Resource tags.
     */

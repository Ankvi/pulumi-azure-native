...
export class AttachedDataNetwork extends pulumi.CustomResource {
     ...
     */
    declare public readonly naptConfiguration: pulumi.Output<types.outputs.NaptConfigurationResponse | undefined>;
    /**
     ...
     */
    declare public readonly userPlaneDataInterface: pulumi.Output<types.outputs.InterfacePropertiesResponse>;

...
export class SimGroup extends pulumi.CustomResource {
     ...
     */
    declare public readonly encryptionKey: pulumi.Output<types.outputs.KeyVaultKeyResponse | undefined>;
    /**
     ...
     */
    declare public readonly mobileNetwork: pulumi.Output<types.outputs.MobileNetworkResourceIdResponse | undefined>;
    /**

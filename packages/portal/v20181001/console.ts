...
export class Console extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:portal/v20181001:Console';
     ...
     */
    public readonly properties!: pulumi.Output<types.outputs.portal.v20181001.ConsolePropertiesResponse>;
    ...
    constructor(name: string, args: ConsoleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:portal:Console" }] };
...
export interface ConsoleArgs {
     ...
     */
    properties: pulumi.Input<types.inputs.portal.v20181001.ConsoleCreatePropertiesArgs>;
}

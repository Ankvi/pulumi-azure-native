...
export class PrometheusRuleGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:alertsmanagement/v20230301:PrometheusRuleGroup';
    ...
    constructor(name: string, args: PrometheusRuleGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:alertsmanagement:PrometheusRuleGroup" }, { type: "azure-native:alertsmanagement/v20210722preview:PrometheusRuleGroup" }] };

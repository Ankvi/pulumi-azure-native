...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:alertsmanagement/v20230501preview:AlertProcessingRuleByName":
...
pulumi.runtime.registerResourceModule("azure-native", "alertsmanagement/v20230501preview", _module)

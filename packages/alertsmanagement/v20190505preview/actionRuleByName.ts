...
export class ActionRuleByName extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:alertsmanagement/v20190505preview:ActionRuleByName';
    ...
    constructor(name: string, args: ActionRuleByNameArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:alertsmanagement:ActionRuleByName" }, { type: "azure-native:alertsmanagement/v20181102privatepreview:ActionRuleByName" }, { type: "azure-native:alertsmanagement/v20210808:ActionRuleByName" }, { type: "azure-native:alertsmanagement/v20210808preview:ActionRuleByName" }, { type: "azure-native:alertsmanagement/v20230501preview:ActionRuleByName" }] };

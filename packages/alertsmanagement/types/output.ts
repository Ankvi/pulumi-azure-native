...
export namespace alertsmanagement {
    ...
    export namespace v20190505preview {
        ...
        export interface ActionGroupResponse {
             ...
             * conditions on which alerts will be filtered
             */
            conditions?: v20190505preview.ConditionsResponse;
            /**
             * Creation time of action rule. Date-Time in ISO-8601 format.
             */
            createdAt: string;
             ...
             * scope on which action rule will apply
             */
            scope?: v20190505preview.ScopeResponse;
            /**
             * Indicates if the given action rule is enabled or disabled
             */
            status?: string;
        ...
        export interface ConditionsResponse {
             ...
             * filter alerts by alert context (payload)
             */
            alertContext?: v20190505preview.ConditionResponse;
            /**
             * filter alerts by alert rule id
             */
            alertRuleId?: v20190505preview.ConditionResponse;
            /**
             * filter alerts by alert rule name
             */
            alertRuleName?: v20190505preview.ConditionResponse;
            /**
             * filter alerts by alert rule description
             */
            description?: v20190505preview.ConditionResponse;
            /**
             * filter alerts by monitor condition
             */
            monitorCondition?: v20190505preview.ConditionResponse;
            /**
             * filter alerts by monitor service
             */
            monitorService?: v20190505preview.ConditionResponse;
            /**
             * filter alerts by severity
             */
            severity?: v20190505preview.ConditionResponse;
            /**
             * filter alerts by target resource type
             */
            targetResourceType?: v20190505preview.ConditionResponse;
        }
        ...
        export interface SuppressionConfigResponse {
             ...
             * suppression schedule configuration
             */
            schedule?: v20190505preview.SuppressionScheduleResponse;
        }
        ...
        export interface SuppressionResponse {
             ...
             * suppression configuration for the action rule
             */
            suppressionConfig: v20190505preview.SuppressionConfigResponse;
            /**
             * Indicates type of action rule
             * Expected value is 'Suppression'.
             */
    ...
    export namespace v20210401 {
        ...
        export interface DetectorResponse {
             ...
             * The Smart Detector parameters definitions.'
             */
            parameterDefinitions: v20210401.DetectorParameterDefinitionResponse[];
            /**
             * The detector's parameters.'
             */
            parameters?: {[key: string]: any};
    ...
    export namespace v20230301 {
        ...
        export interface PrometheusRuleResponse {
             ...
             * Actions that are performed when the alert rule becomes active, and when an alert condition is resolved.
             */
            actions?: v20230301.PrometheusRuleGroupActionResponse[];
            /**
             * Alert rule name.
             */
            alert?: string;
             ...
             * Defines the configuration for resolving fired alerts. Only relevant for alerts.
             */
            resolveConfiguration?: v20230301.PrometheusRuleResolveConfigurationResponse;
            /**
             * The severity of the alerts fired by the rule. Must be between 0 and 4.
             */
            severity?: number;
    ...
    export namespace v20230401preview {
        ...
        export interface ActionListResponse {
             ...
             */
            actionGroups?: v20230401preview.ActionGroupResponse[];
        }
        ...
        export interface AlertRuleAllOfConditionResponse {
             ...
             */
            allOf: v20230401preview.AlertRuleAnyOfOrLeafConditionResponse[];
        }
        ...
        export interface AlertRuleAnyOfOrLeafConditionResponse {
             ...
             */
            anyOf?: v20230401preview.AlertRuleLeafConditionResponse[];
            /**
    ...
    export namespace v20230501preview {
        ...
        export interface AlertProcessingRulePropertiesResponse {
             ...
             * Actions to be applied.
             */
            actions: (v20230501preview.AddActionGroupsResponse | v20230501preview.CorrelateAlertsResponse | v20230501preview.RemoveAllActionGroupsResponse)[];
            /**
             * Conditions on which alerts will be filtered.
             */
            conditions?: v20230501preview.ConditionResponse[];
            /**
             * Description of alert processing rule.
             */
            description?: string;
             ...
             * Scheduling for alert processing rule.
             */
            schedule?: v20230501preview.ScheduleResponse;
            /**
             * Scopes on which alert processing rule will apply.
             */
            scopes: string[];
        ...
        export interface CorrelateAlertsResponse {
             ...
             * The list of conditions for the alerts correlations.
             */
            correlateBy: v20230501preview.CorrelateByResponse[];
            /**
             * The required duration (in ISO8601 format) for the alerts correlation.
             */
            correlationInterval: string;
        ...
        export interface ScheduleResponse {
             ...
             * List of recurrences.
             */
            recurrences?: (v20230501preview.DailyRecurrenceResponse | v20230501preview.MonthlyRecurrenceResponse | v20230501preview.WeeklyRecurrenceResponse)[];
            /**
             * Scheduling time zone.
             */
            timeZone?: string;

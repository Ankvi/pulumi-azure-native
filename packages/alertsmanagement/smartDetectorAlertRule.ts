...
export class SmartDetectorAlertRule extends pulumi.CustomResource {
     ...
     */
    declare public readonly actionGroups: pulumi.Output<types.outputs.ActionGroupsInformationResponse>;
    /**
     ...
     */
    declare public readonly detector: pulumi.Output<types.outputs.DetectorResponse>;
    /**
     ...
     */
    declare public readonly throttling: pulumi.Output<types.outputs.ThrottlingInformationResponse | undefined>;
    /**
     * The resource type.
     */

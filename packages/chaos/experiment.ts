...
export class Experiment extends pulumi.CustomResource {
     ...
     */
    declare public readonly identity: pulumi.Output<types.outputs.ExperimentIdentityResponse | undefined>;
    /**
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.ExperimentPropertiesResponse>;
    /**

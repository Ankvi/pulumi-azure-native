...
export namespace chaos {
    ...
    export namespace v20230415preview {
        ...
        export interface BranchArgs {
             ...
             * List of actions.
             */
            actions: pulumi.Input<pulumi.Input<v20230415preview.ContinuousActionArgs | v20230415preview.DelayActionArgs | v20230415preview.DiscreteActionArgs>[]>;
            /**
             * String of the branch name.
             */
            name: pulumi.Input<string>;
        ...
        export interface ContinuousActionArgs {
             ...
             * List of key value pairs.
             */
            parameters: pulumi.Input<pulumi.Input<v20230415preview.KeyValuePairArgs>[]>;
            /**
             * String that represents a selector.
             */
            selectorId: pulumi.Input<string>;
        ...
        export interface ExperimentPropertiesArgs {
             ...
             * List of selectors.
             */
            selectors: pulumi.Input<pulumi.Input<v20230415preview.ListSelectorArgs | v20230415preview.QuerySelectorArgs>[]>;
            /**
             * A boolean value that indicates if experiment should be started on creation or not.
             */
            startOnCreation?: pulumi.Input<boolean>;
             ...
             * List of steps.
             */
            steps: pulumi.Input<pulumi.Input<v20230415preview.StepArgs>[]>;
        }
        ...
        export interface ListSelectorArgs {
             ...
             * Model that represents available filter types that can be applied to a targets list.
             */
            filter?: pulumi.Input<v20230415preview.SimpleFilterArgs>;
            /**
             * String of the selector ID.
             */
            id: pulumi.Input<string>;
             ...
             * List of Target references.
             */
            targets: pulumi.Input<pulumi.Input<v20230415preview.TargetReferenceArgs>[]>;
            /**
             * Enum of the selector type.
             * Expected value is 'List'.
             */
        ...
        export interface ResourceIdentityArgs {
             ...
             * String of the resource identity type.
             */
            type: pulumi.Input<enums.v20230415preview.ResourceIdentityType>;
            /**
             * The list of user identities associated with the Experiment. The user identity dictionary key references will be ARM resource ids in the form: '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{identityName}'.
             */
            userAssignedIdentities?: pulumi.Input<pulumi.Input<string>[]>;
        ...
        export interface SimpleFilterArgs {
             ...
             * Model that represents the Simple filter parameters.
             */
            parameters?: pulumi.Input<v20230415preview.SimpleFilterParametersArgs>;
            /**
             * Enum that discriminates between filter types. Currently only `Simple` type is supported.
             * Expected value is 'Simple'.
             */
        ...
        export interface StepArgs {
             ...
             * List of branches.
             */
            branches: pulumi.Input<pulumi.Input<v20230415preview.BranchArgs>[]>;
            /**
             * String of the step name.
             */
            name: pulumi.Input<string>;
        ...
        export interface TargetReferenceArgs {
             ...
             * Enum of the Target reference type.
             */
            type: pulumi.Input<string | enums.v20230415preview.TargetReferenceType>;
        }

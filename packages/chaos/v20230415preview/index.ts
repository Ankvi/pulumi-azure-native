...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "azure-native:chaos/v20230415preview:Capability":
                return new Capability(name, <any>undefined, { urn })
            case "azure-native:chaos/v20230415preview:Experiment":
                return new Experiment(name, <any>undefined, { urn })
            case "azure-native:chaos/v20230415preview:Target":
...
pulumi.runtime.registerResourceModule("azure-native", "chaos/v20230415preview", _module)

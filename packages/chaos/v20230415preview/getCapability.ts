...
export function getCapability(args: GetCapabilityArgs, opts?: pulumi.InvokeOptions): Promise<GetCapabilityResult> {
    ...
    return pulumi.runtime.invoke("azure-native:chaos/v20230415preview:getCapability", {
...
export interface GetCapabilityResult {
     ...
     */
    readonly properties: types.outputs.chaos.v20230415preview.CapabilityPropertiesResponse;
    /**

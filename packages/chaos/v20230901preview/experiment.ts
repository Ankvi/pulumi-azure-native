...
export class Experiment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:chaos/v20230901preview:Experiment';

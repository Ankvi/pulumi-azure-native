...
export class MongoCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:mongocluster:MongoCluster';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.MongoClusterPropertiesResponse>;
    /**

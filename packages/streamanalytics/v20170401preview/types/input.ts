...
import * as pulumi from "@pulumi/pulumi";
    ...
    export interface AzureSqlReferenceInputDataSourceArgs {
         ...
         */
        properties?: pulumi.Input<AzureSqlReferenceInputDataSourcePropertiesArgs>;
        /**
    ...
    export interface ReferenceInputPropertiesArgs {
         ...
         */
        datasource?: pulumi.Input<AzureSqlReferenceInputDataSourceArgs | BlobReferenceInputDataSourceArgs | RawReferenceInputDataSourceArgs>;
        /**
    ...
    export interface StreamInputPropertiesArgs {
         ...
         */
        datasource?: pulumi.Input<BlobStreamInputDataSourceArgs | EventHubStreamInputDataSourceArgs | EventHubV2StreamInputDataSourceArgs | IoTHubStreamInputDataSourceArgs | RawStreamInputDataSourceArgs>;
        /**
         * partitionKey Describes a key in the input data which is used for partitioning the input data
         */
        partitionKey?: pulumi.Input<string>;
    ...
    export interface StreamingJobSkuArgs {
         ...
         */
        name?: pulumi.Input<string | enums.StreamingJobSkuName>;
    }

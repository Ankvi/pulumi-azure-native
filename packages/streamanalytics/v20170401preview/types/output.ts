...
import * as pulumi from "@pulumi/pulumi";
    ...
    export interface AzureSqlReferenceInputDataSourceResponse {
         ...
         * Describes Azure SQL database reference input data source properties.
         */
        properties?: AzureSqlReferenceInputDataSourcePropertiesResponse;
        /**
    ...
    export interface ReferenceInputPropertiesResponse {
         ...
         */
        datasource?: AzureSqlReferenceInputDataSourceResponse | BlobReferenceInputDataSourceResponse | RawReferenceInputDataSourceResponse;
        /**
         * Describes conditions applicable to the Input, Output, or the job overall, that warrant customer attention.
         */
        diagnostics: DiagnosticsResponse;
    ...
    export interface StreamInputPropertiesResponse {
         ...
         */
        datasource?: BlobStreamInputDataSourceResponse | EventHubStreamInputDataSourceResponse | EventHubV2StreamInputDataSourceResponse | IoTHubStreamInputDataSourceResponse | RawStreamInputDataSourceResponse;
        /**
         * Describes conditions applicable to the Input, Output, or the job overall, that warrant customer attention.
         */
        diagnostics: DiagnosticsResponse;

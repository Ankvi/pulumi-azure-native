...
export class Output extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly diagnostics: pulumi.Output<types.outputs.DiagnosticsResponse>;
    /**
     ...
     */
    declare public readonly serialization: pulumi.Output<types.outputs.AvroSerializationResponse | types.outputs.CsvSerializationResponse | types.outputs.JsonSerializationResponse | types.outputs.ParquetSerializationResponse | undefined>;
    /**

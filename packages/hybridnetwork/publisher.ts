...
export class Publisher extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:hybridnetwork:Publisher';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.PublisherPropertiesFormatResponse>;
    /**

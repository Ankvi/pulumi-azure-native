...
export class NetworkServiceDesignVersion extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.NetworkServiceDesignVersionPropertiesFormatResponse>;
    /**
    ...
    constructor(name: string, args: NetworkServiceDesignVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["networkServiceDesignVersionName"] = args?.networkServiceDesignVersionName;

...
export class NetworkFunctionDefinitionVersion extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.ContainerizedNetworkFunctionDefinitionVersionResponse | types.outputs.VirtualNetworkFunctionNetworkFunctionDefinitionVersionResponse>;
    /**

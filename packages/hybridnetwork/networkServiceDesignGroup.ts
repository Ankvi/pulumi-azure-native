...
export class NetworkServiceDesignGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:hybridnetwork:NetworkServiceDesignGroup';
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.NetworkServiceDesignGroupPropertiesFormatResponse>;
    /**
    ...
    constructor(name: string, args: NetworkServiceDesignGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["networkServiceDesignGroupName"] = args?.networkServiceDesignGroupName;

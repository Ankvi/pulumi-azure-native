...
export class SiteNetworkService extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.SiteNetworkServicePropertiesFormatResponse>;
    /**
    ...
    constructor(name: string, args: SiteNetworkServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["siteNetworkServiceName"] = args?.siteNetworkServiceName;

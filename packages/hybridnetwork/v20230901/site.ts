...
export class Site extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:hybridnetwork/v20230901:Site';
     ...
     * Site properties.
     */
    public readonly properties!: pulumi.Output<types.outputs.SitePropertiesFormatResponse>;
    /**
    ...
    constructor(name: string, args: SiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hybridnetwork:Site" }] };
...
export interface SiteArgs {
     ...
     * Site properties.
     */
    properties?: pulumi.Input<types.inputs.SitePropertiesFormatArgs>;
    /**

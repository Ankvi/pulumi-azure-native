...
export class NetworkFunctionDefinitionGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:hybridnetwork/v20230901:NetworkFunctionDefinitionGroup';
    ...
    constructor(name: string, args: NetworkFunctionDefinitionGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hybridnetwork:NetworkFunctionDefinitionGroup" }] };

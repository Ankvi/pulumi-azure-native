...
export class NetworkServiceDesignVersion extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:hybridnetwork/v20230901:NetworkServiceDesignVersion';
    ...
    constructor(name: string, args: NetworkServiceDesignVersionArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:hybridnetwork:NetworkServiceDesignVersion" }] };

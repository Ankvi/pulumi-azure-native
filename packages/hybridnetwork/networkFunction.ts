...
export class NetworkFunction extends pulumi.CustomResource {
     ...
     */
    declare public readonly properties: pulumi.Output<types.outputs.NetworkFunctionValueWithSecretsResponse | types.outputs.NetworkFunctionValueWithoutSecretsResponse>;
    /**

...
export namespace hybridnetwork {
    ...
    export namespace v20220101preview {
        ...
        export interface LinuxConfigurationResponse {
             ...
             * Specifies the ssh key configuration for a Linux OS.
             */
            ssh?: v20220101preview.SshConfigurationResponse;
        }
        ...
        export interface NetworkFunctionRoleConfigurationResponse {
             ...
             * Specifies the custom settings for the virtual machine.
             */
            customProfile?: v20220101preview.CustomProfileResponse;
            /**
             * The network interface configurations.
             */
            networkInterfaces?: v20220101preview.NetworkInterfaceResponse[];
            /**
             * Specifies the operating system settings for the role instance. This value can be updated during the deployment of network function.
             */
            osProfile?: v20220101preview.OsProfileResponse;
            /**
             * The name of the network function role.
             */
            roleName?: string;
             ...
             * Specifies the storage settings for the virtual machine disks.
             */
            storageProfile?: v20220101preview.StorageProfileResponse;
            /**
             * The user parameters for customers. The format of user data parameters has to be matched with the provided user data template.
             */
            userDataParameters?: any;
        ...
        export function networkFunctionRoleConfigurationResponseProvideDefaults(val: NetworkFunctionRoleConfigurationResponse): NetworkFunctionRoleConfigurationResponse {
            return {
                ...val,
                osProfile: (val.osProfile ? v20220101preview.osProfileResponseProvideDefaults(val.osProfile) : undefined),
            };
        }
        ...
        export interface NetworkFunctionTemplateResponse {
             ...
             * An array of network function role definitions.
             */
            networkFunctionRoleConfigurations?: v20220101preview.NetworkFunctionRoleConfigurationResponse[];
        }
        ...
        export interface NetworkFunctionUserConfigurationResponse {
             ...
             * Specifies the operating system settings for the role instance.
             */
            osProfile?: v20220101preview.NetworkFunctionUserConfigurationResponseOsProfile;
            /**
             * The name of the network function role.
             */
            roleName?: string;
        ...
        export interface NetworkInterfaceResponse {
             ...
             * A list of IP configurations of the network interface.
             */
            ipConfigurations?: v20220101preview.NetworkInterfaceIPConfigurationResponse[];
            /**
             * The MAC address of the network interface.
             */
            macAddress?: string;
        ...
        export interface OsProfileResponse {
             ...
             * Specifies the Linux operating system settings on the virtual machine. <br><br>For a list of supported Linux distributions, see [Linux on Azure-Endorsed Distributions](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-linux-endorsed-distros?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) <br><br> For running non-endorsed distributions, see [Information for Non-Endorsed Distributions](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-linux-create-upload-generic?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).
             */
            linuxConfiguration?: v20220101preview.LinuxConfigurationResponse;
        }
        /**
         * osProfileResponseProvideDefaults sets the appropriate defaults for OsProfileResponse
         */
        ...
        export interface SshConfigurationResponse {
             ...
             * The list of SSH public keys used to authenticate with linux based VMs.
             */
            publicKeys?: v20220101preview.SshPublicKeyResponse[];
        }
        ...
        export interface StorageProfileResponse {
             ...
             * Specifies the parameters that are used to add a data disk to a virtual machine.
             */
            dataDisks?: v20220101preview.DataDiskResponse[];
            /**
             * The image reference properties.
             */
            imageReference?: v20220101preview.ImageReferenceResponse;
            /**
             * Specifies information about the operating system disk used by the virtual machine.
             */
            osDisk?: v20220101preview.OsDiskResponse;
        }

...
export namespace hybridnetwork {
    /**
    ...
    export namespace v20220101preview {
        ...
        export interface DataDiskArgs {
             ...
             * Specifies how the virtual machine should be created.
             */
            createOption?: pulumi.Input<string | enums.v20220101preview.DiskCreateOptionTypes>;
            /**
             * Specifies the size of an empty disk in gigabytes. This element can be used to overwrite the size of the disk in a virtual machine image.
             */
            diskSizeGB?: pulumi.Input<number>;
        ...
        export interface LinuxConfigurationArgs {
             ...
             * Specifies the ssh key configuration for a Linux OS.
             */
            ssh?: pulumi.Input<v20220101preview.SshConfigurationArgs>;
        }
        ...
        export interface NetworkFunctionRoleConfigurationArgs {
             ...
             * Specifies the custom settings for the virtual machine.
             */
            customProfile?: pulumi.Input<v20220101preview.CustomProfileArgs>;
            /**
             * The network interface configurations.
             */
            networkInterfaces?: pulumi.Input<pulumi.Input<v20220101preview.NetworkInterfaceArgs>[]>;
            /**
             * Specifies the operating system settings for the role instance. This value can be updated during the deployment of network function.
             */
            osProfile?: pulumi.Input<v20220101preview.OsProfileArgs>;
            /**
             * The name of the network function role.
             */
            roleName?: pulumi.Input<string>;
             ...
             * Role type.
             */
            roleType?: pulumi.Input<string | enums.v20220101preview.NetworkFunctionRoleConfigurationType>;
            /**
             * Specifies the storage settings for the virtual machine disks.
             */
            storageProfile?: pulumi.Input<v20220101preview.StorageProfileArgs>;
            /**
             * The user parameters for customers. The format of user data parameters has to be matched with the provided user data template.
             */
            userDataParameters?: any;
             ...
             * The size of the virtual machine.
             */
            virtualMachineSize?: pulumi.Input<string | enums.v20220101preview.VirtualMachineSizeTypes>;
        }
        /**
         * networkFunctionRoleConfigurationArgsProvideDefaults sets the appropriate defaults for NetworkFunctionRoleConfigurationArgs
         */
        export function networkFunctionRoleConfigurationArgsProvideDefaults(val: NetworkFunctionRoleConfigurationArgs): NetworkFunctionRoleConfigurationArgs {
            return {
                ...val,
                osProfile: (val.osProfile ? pulumi.output(val.osProfile).apply(v20220101preview.osProfileArgsProvideDefaults) : undefined),
            };
        }
        ...
        export interface NetworkFunctionTemplateArgs {
             ...
             * An array of network function role definitions.
             */
            networkFunctionRoleConfigurations?: pulumi.Input<pulumi.Input<v20220101preview.NetworkFunctionRoleConfigurationArgs>[]>;
        }
        ...
        export interface NetworkFunctionUserConfigurationArgs {
             ...
             * Specifies the operating system settings for the role instance.
             */
            osProfile?: pulumi.Input<v20220101preview.NetworkFunctionUserConfigurationOsProfileArgs>;
            /**
             * The name of the network function role.
             */
            roleName?: pulumi.Input<string>;
        ...
        export interface NetworkInterfaceArgs {
             ...
             * A list of IP configurations of the network interface.
             */
            ipConfigurations?: pulumi.Input<pulumi.Input<v20220101preview.NetworkInterfaceIPConfigurationArgs>[]>;
            /**
             * The MAC address of the network interface.
             */
            macAddress?: pulumi.Input<string>;
             ...
             * The type of the VM switch.
             */
            vmSwitchType?: pulumi.Input<string | enums.v20220101preview.VMSwitchType>;
        }
        ...
        export interface NetworkInterfaceIPConfigurationArgs {
             ...
             * IP address allocation method.
             */
            ipAllocationMethod?: pulumi.Input<string | enums.v20220101preview.IPAllocationMethod>;
            /**
             * IP address version.
             */
            ipVersion?: pulumi.Input<string | enums.v20220101preview.IPVersion>;
            /**
             * The value of the subnet.
             */
            subnet?: pulumi.Input<string>;
        ...
        export interface OsDiskArgs {
             ...
             * The OS type.
             */
            osType?: pulumi.Input<string | enums.v20220101preview.OperatingSystemTypes>;
            /**
             * The virtual hard disk.
             */
            vhd?: pulumi.Input<v20220101preview.VirtualHardDiskArgs>;
        }
        ...
        export interface OsProfileArgs {
             ...
             * Specifies the Linux operating system settings on the virtual machine. <br><br>For a list of supported Linux distributions, see [Linux on Azure-Endorsed Distributions](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-linux-endorsed-distros?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) <br><br> For running non-endorsed distributions, see [Information for Non-Endorsed Distributions](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-linux-create-upload-generic?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).
             */
            linuxConfiguration?: pulumi.Input<v20220101preview.LinuxConfigurationArgs>;
        }
        /**
         * osProfileArgsProvideDefaults sets the appropriate defaults for OsProfileArgs
         */
        ...
        export interface SshConfigurationArgs {
             ...
             * The list of SSH public keys used to authenticate with linux based VMs.
             */
            publicKeys?: pulumi.Input<pulumi.Input<v20220101preview.SshPublicKeyArgs>[]>;
        }
        ...
        export interface StorageProfileArgs {
             ...
             * Specifies the parameters that are used to add a data disk to a virtual machine.
             */
            dataDisks?: pulumi.Input<pulumi.Input<v20220101preview.DataDiskArgs>[]>;
            /**
             * The image reference properties.
             */
            imageReference?: pulumi.Input<v20220101preview.ImageReferenceArgs>;
            /**
             * Specifies information about the operating system disk used by the virtual machine.
             */
            osDisk?: pulumi.Input<v20220101preview.OsDiskArgs>;
        }

...
export class EnclaveEndpoint extends pulumi.CustomResource {
     ...
     */
    declare public readonly ruleCollection: pulumi.Output<types.outputs.EnclaveEndpointDestinationRuleResponse[]>;
    /**
...
export interface EnclaveEndpointArgs {
     ...
     * Enclave Endpoint Rule Collection.
     */
    ruleCollection: pulumi.Input<pulumi.Input<types.inputs.EnclaveEndpointDestinationRuleArgs>[]>;
    /**
     * Resource tags.
     */

...
export class CommunityEndpoint extends pulumi.CustomResource {
     ...
     */
    declare public readonly ruleCollection: pulumi.Output<types.outputs.CommunityEndpointDestinationRuleResponse[]>;
    /**
...
export interface CommunityEndpointArgs {
     ...
     * Community Endpoint Rule Collection.
     */
    ruleCollection: pulumi.Input<pulumi.Input<types.inputs.CommunityEndpointDestinationRuleArgs>[]>;
    /**
     * Resource tags.
     */

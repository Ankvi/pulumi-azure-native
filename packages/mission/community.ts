...
export class Community extends pulumi.CustomResource {
     ...
     */
    declare public readonly approvalSettings: pulumi.Output<types.outputs.ApprovalSettingsResponse | undefined>;
    /**
     ...
     */
    declare public readonly communityRoleAssignments: pulumi.Output<types.outputs.RoleAssignmentItemResponse[] | undefined>;
    /**
     * DNS Servers.
     */

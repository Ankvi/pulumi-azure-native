...
export class Approval extends pulumi.CustomResource {
     ...
     */
    declare public readonly approvers: pulumi.Output<types.outputs.ApproverResponse[] | undefined>;
    /**
     ...
     */
    declare public readonly requestMetadata: pulumi.Output<types.outputs.RequestMetadataResponse>;
    /**
...
export interface ApprovalArgs {
     ...
     * Request metadata for the approval request.
     */
    requestMetadata: pulumi.Input<types.inputs.RequestMetadataArgs>;
    /**

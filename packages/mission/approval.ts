...
export class Approval extends pulumi.CustomResource {
     ...
     */
    public readonly approvers!: pulumi.Output<types.outputs.ApproverResponse[] | undefined>;
    /**
     ...
     */
    public readonly requestMetadata!: pulumi.Output<types.outputs.RequestMetadataResponse>;
    /**

...
export class AttestationAtResourceGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure-native:policyinsights/v20220901:AttestationAtResourceGroup';
    ...
    constructor(name: string, args: AttestationAtResourceGroupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:policyinsights:AttestationAtResourceGroup" }, { type: "azure-native:policyinsights/v20210101:AttestationAtResourceGroup" }] };

...
export class RemediationAtResource extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly deploymentStatus: pulumi.Output<types.outputs.RemediationDeploymentSummaryResponse>;
    /**
     ...
     */
    declare public readonly filters: pulumi.Output<types.outputs.RemediationFiltersResponse | undefined>;
    /**
    ...
    constructor(name: string, args: RemediationAtResourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "azure-native:policyinsights/v20180701preview:RemediationAtResource" }, { type: "azure-native:policyinsights/v20190701:RemediationAtResource" }, { type: "azure-native:policyinsights/v20211001:RemediationAtResource" }, { type: "azure-native:policyinsights/v20241001:RemediationAtResource" }] };
